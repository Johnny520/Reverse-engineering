...
public class DialogTitle extends xhss.AbstractC0796 {
    public DialogTitle(android.content.Context r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0)
            return
    ...
    @Override // xhss.AbstractC0796, android.widget.TextView, android.view.View
    public final void onMeasure(int r7, int r8) {
            ...
            r4 = 0
            int[] r5 = xhss.AbstractC0293.f1130
