        ...
        public CLS59(String s1, int v1) {
            ...
            try {
                while(!ٴʼ0.MTH524()) {
                    ...
                    this.FLD377[v7] = s2;
                    if(v6 != -1) {
                        String s3 = new String(new int[]{v4, v6}, 0, 2);
                        CLS60.FLD386.put(s2, s3);
                    }
                    ++v2;
                }
                if(v2 == v1) {
            ...
            throw new CLS37("Unexpected count of entities loaded");
        }
    }

    public static final char[] FLD385;
    public static final HashMap FLD386;

    static {
        CLS60.FLD385 = new char[]{',', ';'};
        CLS60.FLD386 = new HashMap();
        new CLS62();
    }

    public static void MTH1028(Appendable appendable0, CLS59 ˑᵎ$ٴʼ0, int v) {
        Appendable appendable1;
        String s;
        int v1 = Arrays.binarySearch(ˑᵎ$ٴʼ0.FLD382, v);
        if(v1 >= 0) {
            String[] arr_s = ˑᵎ$ٴʼ0.FLD377;
            s = v1 >= arr_s.length - 1 || ˑᵎ$ٴʼ0.FLD382[v1 + 1] != v ? arr_s[v1] : arr_s[v1 + 1];
        }
        else {
            s = "";
        }
        if("".equals(s)) {
            appendable1 = appendable0.append("&#x");
            s = Integer.toHexString(v);
        }
        else {
            appendable1 = appendable0.append('&');
        }
        appendable1.append(s).append(';');
    }

    public static void MTH1029(Appendable appendable0, String s, CLS62 ﾞˈ$ٴʼ0, boolean z, boolean z1, boolean z2, boolean z3) {
        String s1;
        CLS59 ˑᵎ$ٴʼ0 = ﾞˈ$ٴʼ0.FLD406;
        CharsetEncoder charsetEncoder0 = (CharsetEncoder)ﾞˈ$ٴʼ0.FLD408.get();
        if(charsetEncoder0 == null) {
            charsetEncoder0 = ﾞˈ$ٴʼ0.MTH1088();
        }
        int v = ﾞˈ$ٴʼ0.FLD403;
        int v1 = s.length();
        int v2 = 0;
        ...
        while(v2 < v1) {
            ...
            label_26:
                if(v3 >= 0x10000) {
                    s1 = new String(Character.toChars(v3));
                    if(charsetEncoder0.canEncode(s1)) {
                        appendable0.append(s1);
                        goto label_72;
                    }
                }
                else if(((char)v3) != 9 && ((char)v3) != 10) {
                    switch(((char)v3)) {
                        case 13: {
                        ...
                        case 60: {
                            if(z && ˑᵎ$ٴʼ0 != CLS59.FLD379 && ﾞˈ$ٴʼ0.FLD407 != 2) {
                                appendable0.append(((char)v3));
                            }
                            else {
                                appendable0.append("&lt;");
                        ...
                        case 0xA0: {
                            s1 = ˑᵎ$ٴʼ0 == CLS59.FLD379 ? "&#xa0;" : "&nbsp;";
                            appendable0.append(s1);
                            goto label_72;
                        }
                        default: {
                            if(((char)v3) >= 0x20) {
                                int v4 = CLS58.MTH1007(v);
                                boolean z7 = true;
                                if(v4 == 0) {
                                    if(((char)v3) >= 0x80) {
                                        z7 = false;
                                    ...
                                    z7 = charsetEncoder0.canEncode(((char)v3));
                                }
                                if(z7) {
                                    appendable0.append(((char)v3));
                                    goto label_72;
                ...
                CLS60.MTH1028(appendable0, ˑᵎ$ٴʼ0, v3);
            }
            else if(v3 != 9 && v3 != 10 && v3 != 0x20 && v3 != 12 && v3 != 13) {
                if(z4) {
                    appendable0.append(' ');
                    z4 = false;
                }
