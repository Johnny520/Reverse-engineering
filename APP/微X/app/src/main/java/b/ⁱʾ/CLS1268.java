...
public final class CLS1268 implements CLS39 {
    public final int FLD3303;
    public final CLS3 FLD3304;
    public final ContentValues FLD3305;
    public final CLS335 FLD3306;
    public final Set FLD3307;

    public CLS1268(CLS335 ˑٴ0, ContentValues contentValues0, Set set0, CLS1274 ﾞˎ0, int v) {
        this.FLD3303 = v;
        this.FLD3306 = ˑٴ0;
        this.FLD3305 = contentValues0;
        this.FLD3307 = set0;
        this.FLD3304 = ﾞˎ0;
        super();
    }
    ...
    public final void run() {
        ...
        String s2;
        Bitmap bitmap0;
        CLS3 ˆٴ0 = this.FLD3304;
        Set set0 = this.FLD3307;
        CLS335 ˑٴ0 = this.FLD3306;
        ContentValues contentValues0 = this.FLD3305;
        switch(this.FLD3303) {
            case 0: {
                ˑٴ0.getClass();
                try {
                    if(ˑٴ0.MTH5108(contentValues0) == null) {
                        boolean z = contentValues0.containsKey("img");
                        HashMap hashMap0 = ˑٴ0.FLD3332;
                        if(z) {
            ...
            default: {
                ...
                try {
                    if(TextUtils.isEmpty(ˑٴ0.MTH5106(uri0))) {
                        String s = CLS481.MTH6693(CLS31.MTH1028(uri0));
                        ˑٴ0.FLD3335.put(uri0.toString(), s);
                    }
                }
