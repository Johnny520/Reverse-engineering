...
public final class CLS818 implements CLS377 {
    public static CLS117 MTH5076(CLS37 ᴵⁱ0, int v, int v1, int v2) {
        CLS32 ʻᵢ0 = ᴵⁱ0.MTH891();
        if(ʻᵢ0 == null) {
        ...
        int v10 = (v8 - v4 * v9) / 2;
        CLS117 ʻᵢ1 = new CLS117(v7, v8);
        int v11 = 0;
        while(v11 < v4) {
            int v12 = (v7 - v3 * v9) / 2;
            int v13 = 0;
            while(v13 < v3) {
                if(ʻᵢ0.MTH833(v13, v11) == 1) {
                    ʻᵢ1.MTH2326(v12, v10, v9, v9);
                }
                ++v13;
                v12 += v9;
            }
    ...
    @Override  // c.ﾞﹶ.CLS377
    public CLS117 MTH5102(String s, BarcodeFormat barcodeFormat0, int v, int v1, Map map0) {
        if(s.isEmpty()) {
        ...
        return CLS818.MTH5076(CLS36.MTH872(s, errorCorrectionLevel0, map0), v, v1, v2);
    }
}
