...
public final class InterpolatorC1945 implements Interpolator {
    ...
    public InterpolatorC1945(float[] fArr) {
        this.f9787 = fArr;
        this.f9788 = 1.0f / (fArr.length - 1);
    }
}
