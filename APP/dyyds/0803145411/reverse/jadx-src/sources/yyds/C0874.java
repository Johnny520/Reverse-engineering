...
/* JADX INFO: renamed from: yyds.ᛴᛶᛷᛱ, reason: contains not printable characters */
/* JADX INFO: compiled from: r8-map-id-23a4d667e3e8d63d05148f8952801ca86a273fc20b9c1ee5b7e6466f054ed4c9 */
/* JADX INFO: loaded from: classes.dex */
public final class C0874 extends AbstractC0333 {
    public static final Parcelable.Creator<C0874> CREATOR = new C1499(7);
    ...
    public final void mo1022(Activity activity, ArrayList arrayList) {
        if (AbstractC0879.m1962("android.permission.READ_EXTERNAL_STORAGE", arrayList)) {
            C0188.m798("You have added the \"android.permission.READ_MEDIA_IMAGES\" permission, please do not add the \"android.permission.READ_EXTERNAL_STORAGE\" permission, this conflicts with the framework's automatic compatibility policy.");
        }
    }
}
