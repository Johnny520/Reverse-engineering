...
class StructureBuilder {
    ...
    public StructureBuilder(org.simpleframework.xml.core.Scanner r3, org.simpleframework.xml.core.Detail r4, org.simpleframework.xml.core.Support r5) {
            r2 = this;
            r2.<init>()
    ...
    private org.simpleframework.xml.core.Model create(org.simpleframework.xml.core.Expression r4) {
            r3 = this;
            org.simpleframework.xml.core.Model r3 = r3.root
        L2:
            if (r3 == 0) goto L23
            java.lang.String r0 = r4.getPrefix()
            java.lang.String r1 = r4.getFirst()
            int r2 = r4.getIndex()
            if (r1 == 0) goto L16
            org.simpleframework.xml.core.Model r3 = r3.register(r1, r0, r2)
        L16:
            boolean r0 = r4.isPath()
            if (r0 != 0) goto L1d
            return r3
        L1d:
            r0 = 1
            org.simpleframework.xml.core.Expression r4 = r4.getPath(r0)
            goto L2
        L23:
            return r3
    }

    private boolean isAttribute(java.lang.String r3) {
            r2 = this;
            org.simpleframework.xml.core.ExpressionBuilder r0 = r2.builder
            org.simpleframework.xml.core.Expression r0 = r0.build(r3)
            org.simpleframework.xml.core.Model r2 = r2.lookup(r0)
            if (r2 == 0) goto L20
            java.lang.String r1 = r0.getLast()
            boolean r0 = r0.isPath()
            if (r0 != 0) goto L1b
            boolean r2 = r2.isAttribute(r3)
            return r2
        L1b:
            boolean r2 = r2.isAttribute(r1)
            return r2
        L20:
            r2 = 0
            return r2
    ...
    private boolean isElement(java.lang.String r5) {
            r4 = this;
            org.simpleframework.xml.core.ExpressionBuilder r0 = r4.builder
            org.simpleframework.xml.core.Expression r5 = r0.build(r5)
            org.simpleframework.xml.core.Model r4 = r4.lookup(r5)
            r0 = 0
            if (r4 == 0) goto L2f
            java.lang.String r1 = r5.getLast()
            int r5 = r5.getIndex()
            boolean r2 = r4.isElement(r1)
            r3 = 1
            if (r2 == 0) goto L1d
            return r3
        L1d:
            boolean r2 = r4.isModel(r1)
            if (r2 == 0) goto L2f
            org.simpleframework.xml.core.Model r4 = r4.lookup(r1, r5)
    ...
    private boolean isEmpty() {
            ...
            return r1
        L6:
            org.simpleframework.xml.core.Model r1 = r1.root
            boolean r1 = r1.isEmpty()
            return r1
    }

    private org.simpleframework.xml.core.Model lookup(org.simpleframework.xml.core.Expression r3) {
            r2 = this;
            r0 = 0
            r1 = 1
            org.simpleframework.xml.core.Expression r0 = r3.getPath(r0, r1)
            boolean r3 = r3.isPath()
            org.simpleframework.xml.core.Model r2 = r2.root
            if (r3 == 0) goto L12
            org.simpleframework.xml.core.Model r2 = r2.lookup(r0)
        L12:
            return r2
    ...
    private void process(org.simpleframework.xml.core.Contact r3, java.lang.annotation.Annotation r4, org.simpleframework.xml.core.LabelMap r5) {
            r2 = this;
        ...
        L18:
            ...
            java.lang.String r4 = "Duplicate annotation of name '%s' on %s"
            java.lang.Object[] r3 = new java.lang.Object[]{r1, r3}
            r2.<init>(r4, r3)
            throw r2
    }

    private void process(org.simpleframework.xml.core.Contact r4, org.simpleframework.xml.core.Label r5, org.simpleframework.xml.core.LabelMap r6) {
            r3 = this;
        ...
        L14:
            org.simpleframework.xml.core.InstantiatorBuilder r3 = r3.resolver
            r3.register(r5)
            r1.register(r5)
            r6.put(r0, r5)
            return
    ...
    private org.simpleframework.xml.core.Model register(org.simpleframework.xml.core.Expression r2) {
            r1 = this;
            ...
            return r0
        L9:
            org.simpleframework.xml.core.Model r1 = r1.create(r2)
            return r1
    }

    private void text(org.simpleframework.xml.core.Contact r5, java.lang.annotation.Annotation r6) {
            r4 = this;
        ...
        L1a:
            ...
            r6.register(r5)
            r2.register(r5)
            org.simpleframework.xml.core.LabelMap r4 = r4.texts
            r4.put(r1, r5)
            return
        L30:
            org.simpleframework.xml.core.TextException r4 = new org.simpleframework.xml.core.TextException
            java.lang.String r5 = "Multiple text annotations in %s"
            java.lang.Object[] r6 = new java.lang.Object[]{r6}
            r4.<init>(r5, r6)
            throw r4
    }

    private void union(org.simpleframework.xml.core.Contact r4, java.lang.annotation.Annotation r5, org.simpleframework.xml.core.LabelMap r6) {
            r3 = this;
        ...
        L28:
            ...
            java.lang.String r4 = "Duplicate annotation of name '%s' on %s"
            java.lang.Object[] r5 = new java.lang.Object[]{r2, r0}
            r3.<init>(r4, r5)
            throw r3
        L34:
            return
    ...
    private void validateAttributes(java.lang.Class r5, org.simpleframework.xml.Order r6) {
            r4 = this;
            if (r6 == 0) goto L21
        ...
        L15:
            ...
            java.lang.String r6 = "Ordered attribute '%s' missing in %s"
    ...
    private void validateElements(java.lang.Class r5, org.simpleframework.xml.Order r6) {
            r4 = this;
            if (r6 == 0) goto L21
        ...
        L15:
            ...
            java.lang.String r6 = "Ordered element '%s' missing for %s"
            java.lang.Object[] r5 = new java.lang.Object[]{r2, r5}
            r4.<init>(r6, r5)
            throw r4
        L21:
    ...
    private void validateModel(java.lang.Class r2) {
            r1 = this;
            org.simpleframework.xml.core.Model r0 = r1.root
    ...
    private void validateText(java.lang.Class r3) {
            r2 = this;
            org.simpleframework.xml.core.Model r0 = r2.root
            ...
            goto L45
        L1f:
            org.simpleframework.xml.core.TextException r2 = new org.simpleframework.xml.core.TextException
            java.lang.String r1 = "Paths used with %s in %s"
            java.lang.Object[] r3 = new java.lang.Object[]{r0, r3}
            r2.<init>(r1, r3)
            throw r2
        L2b:
            org.simpleframework.xml.core.TextException r2 = new org.simpleframework.xml.core.TextException
            java.lang.String r1 = "Elements used with %s in %s"
            java.lang.Object[] r3 = new java.lang.Object[]{r0, r3}
            r2.<init>(r1, r3)
            throw r2
        L37:
    ...
    private void validateTextList(java.lang.Class r6) {
            r5 = this;
        ...
        L3b:
            ...
            java.lang.String r1 = "Illegal entry of %s with text annotations on %s in %s"
        ...
        L47:
            ...
            throw r5
        L53:
            org.simpleframework.xml.core.Model r5 = r5.root
            boolean r5 = r5.isComposite()
            if (r5 != 0) goto L5c
            goto L68
        L5c:
            org.simpleframework.xml.core.TextException r5 = new org.simpleframework.xml.core.TextException
    ...
    private void validateUnions(java.lang.Class r10) {
            r9 = this;
        ...
        L43:
            ...
            java.lang.String r10 = "Required must be consistent in %s for %s"
            java.lang.Object[] r0 = new java.lang.Object[]{r6, r2}
            r9.<init>(r10, r0)
            throw r9
        L4f:
            org.simpleframework.xml.core.UnionException r9 = new org.simpleframework.xml.core.UnionException
            java.lang.String r10 = "Inline must be consistent in %s for %s"
            java.lang.Object[] r0 = new java.lang.Object[]{r6, r2}
            r9.<init>(r10, r0)
            throw r9
        L5b:
    ...
    private void version(org.simpleframework.xml.core.Contact r2, java.lang.annotation.Annotation r3) {
            r1 = this;
        ...
        Ld:
            ...
            java.lang.String r2 = "Multiple version annotations in %s"
            java.lang.Object[] r3 = new java.lang.Object[]{r3}
            r1.<init>(r2, r3)
            throw r1
    }

    public void assemble(java.lang.Class r2) {
            r1 = this;
            org.simpleframework.xml.core.Scanner r2 = r1.scanner
            org.simpleframework.xml.Order r2 = r2.getOrder()
            if (r2 == 0) goto Lf
            org.simpleframework.xml.core.ModelAssembler r0 = r1.assembler
            org.simpleframework.xml.core.Model r1 = r1.root
            r0.assemble(r1, r2)
        Lf:
            return
    ...
    public org.simpleframework.xml.core.Structure build(java.lang.Class r7) {
            r6 = this;
            org.simpleframework.xml.core.Structure r0 = new org.simpleframework.xml.core.Structure
    ...
    public void commit(java.lang.Class r1) {
            r0 = this;
    ...
    public void process(org.simpleframework.xml.core.Contact r2, java.lang.annotation.Annotation r3) {
            r1 = this;
    ...
    public void validate(java.lang.Class r2) {
            r1 = this;
