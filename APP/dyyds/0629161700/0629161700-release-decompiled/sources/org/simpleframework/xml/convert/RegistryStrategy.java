...
public class RegistryStrategy implements org.simpleframework.xml.strategy.Strategy {
    ...
    private org.simpleframework.xml.convert.Converter lookup(org.simpleframework.xml.strategy.Type r1, java.lang.Object r2) {
            r0 = this;
            java.lang.Class r1 = r1.getType()
            if (r2 == 0) goto La
            java.lang.Class r1 = r2.getClass()
        La:
            org.simpleframework.xml.convert.Registry r0 = r0.registry
            org.simpleframework.xml.convert.Converter r0 = r0.lookup(r1)
            return r0
    }

    private org.simpleframework.xml.convert.Converter lookup(org.simpleframework.xml.strategy.Type r1, org.simpleframework.xml.strategy.Value r2) {
            r0 = this;
            java.lang.Class r1 = r1.getType()
            if (r2 == 0) goto La
    ...
    private org.simpleframework.xml.strategy.Value read(org.simpleframework.xml.strategy.Type r1, org.simpleframework.xml.stream.NodeMap<org.simpleframework.xml.stream.InputNode> r2, org.simpleframework.xml.strategy.Value r3) {
            r0 = this;
            org.simpleframework.xml.convert.Converter r0 = r0.lookup(r1, r3)
    ...
    private boolean write(org.simpleframework.xml.strategy.Type r1, java.lang.Object r2, org.simpleframework.xml.stream.NodeMap<org.simpleframework.xml.stream.OutputNode> r3) {
            r0 = this;
            org.simpleframework.xml.convert.Converter r0 = r0.lookup(r1, r2)
