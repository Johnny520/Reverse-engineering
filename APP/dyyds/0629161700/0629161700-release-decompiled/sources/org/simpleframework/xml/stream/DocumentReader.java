...
class DocumentReader implements org.simpleframework.xml.stream.EventReader {
    ...
    public static class Start extends org.simpleframework.xml.stream.EventElement {
        ...
        public org.w3c.dom.NamedNodeMap getAttributes() {
                r0 = this;
                org.w3c.dom.Element r0 = r0.element
    ...
    private org.simpleframework.xml.stream.DocumentReader.Entry attribute(org.w3c.dom.Node r1) {
            r0 = this;
    ...
    private org.simpleframework.xml.stream.EventNode convert(org.w3c.dom.Node r3) {
            r2 = this;
            ...
            r0.push(r3)
            org.simpleframework.xml.stream.DocumentReader$Start r2 = r2.start(r3)
            return r2
        L11:
            org.simpleframework.xml.stream.DocumentReader$Text r2 = r2.text(r3)
            return r2
    }

    private org.simpleframework.xml.stream.DocumentReader.End end() {
            r1 = this;
            org.simpleframework.xml.stream.DocumentReader$End r1 = new org.simpleframework.xml.stream.DocumentReader$End
            r0 = 0
            r1.<init>(r0)
            return r1
    }
    ...
    private org.simpleframework.xml.stream.EventNode read() {
            ...
            if (r0 != 0) goto Lf
            org.simpleframework.xml.stream.DocumentReader$End r1 = r1.end()
            return r1
        Lf:
            org.simpleframework.xml.stream.EventNode r1 = r1.read(r0)
            return r1
    }

    private org.simpleframework.xml.stream.EventNode read(org.w3c.dom.Node r3) {
            r2 = this;
            ...
            r3.pop()
        L15:
            org.simpleframework.xml.stream.DocumentReader$End r2 = r2.end()
            return r2
        L1a:
            org.simpleframework.xml.stream.NodeExtractor r0 = r2.queue
            r0.poll()
            org.simpleframework.xml.stream.EventNode r2 = r2.convert(r3)
            return r2
    }
    ...
    private org.simpleframework.xml.stream.DocumentReader.Start start(org.w3c.dom.Node r2) {
            ...
            if (r2 == 0) goto L10
            org.simpleframework.xml.stream.DocumentReader$Start r1 = r1.build(r0)
            return r1
        L10:
            return r0
    }

    private org.simpleframework.xml.stream.DocumentReader.Text text(org.w3c.dom.Node r1) {
            r0 = this;
