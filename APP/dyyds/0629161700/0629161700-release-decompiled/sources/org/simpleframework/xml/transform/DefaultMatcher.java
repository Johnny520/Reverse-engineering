...
class DefaultMatcher implements org.simpleframework.xml.transform.Matcher {
    ...
    private org.simpleframework.xml.transform.Transform matchType(java.lang.Class r2) {
            r1 = this;
            boolean r0 = r2.isArray()
            if (r0 == 0) goto Ld
            org.simpleframework.xml.transform.Matcher r1 = r1.array
            org.simpleframework.xml.transform.Transform r1 = r1.match(r2)
            return r1
        Ld:
            boolean r0 = r2.isPrimitive()
            if (r0 == 0) goto L1a
            org.simpleframework.xml.transform.Matcher r1 = r1.primitive
            org.simpleframework.xml.transform.Transform r1 = r1.match(r2)
            return r1
        L1a:
            org.simpleframework.xml.transform.Matcher r1 = r1.stock
            org.simpleframework.xml.transform.Transform r1 = r1.match(r2)
            return r1
    }
    ...
    public org.simpleframework.xml.transform.Transform match(java.lang.Class r2) {
            ...
            return r0
        L9:
            org.simpleframework.xml.transform.Transform r1 = r1.matchType(r2)
            return r1
    }
}
