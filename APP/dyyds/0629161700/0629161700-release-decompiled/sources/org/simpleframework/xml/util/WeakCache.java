...
public class WeakCache<T> implements org.simpleframework.xml.util.Cache<T> {
    ...
    public class SegmentList implements java.lang.Iterable<org.simpleframework.xml.util.WeakCache<T>.Segment> {
        ...
        private int segment(java.lang.Object r1) {
                r0 = this;
                int r1 = r1.hashCode()
                int r0 = r0.size
                int r1 = r1 % r0
        ...
        public org.simpleframework.xml.util.WeakCache<T>.Segment get(java.lang.Object r2) {
                ...
                int r0 = r1.size
                if (r2 >= r0) goto L11
                java.util.List<org.simpleframework.xml.util.WeakCache<T>$Segment> r1 = r1.list
        ...
        public java.util.Iterator<org.simpleframework.xml.util.WeakCache<T>.Segment> iterator() {
                r0 = this;
                java.util.List<org.simpleframework.xml.util.WeakCache<T>$Segment> r0 = r0.list
    ...
    private org.simpleframework.xml.util.WeakCache<T>.Segment map(java.lang.Object r1) {
            r0 = this;
            org.simpleframework.xml.util.WeakCache<T>$SegmentList r0 = r0.list
            org.simpleframework.xml.util.WeakCache$Segment r0 = r0.get(r1)
            return r0
    }
    ...
    public void cache(java.lang.Object r1, T r2) {
            r0 = this;
            org.simpleframework.xml.util.WeakCache$Segment r0 = r0.map(r1)
            r0.cache(r1, r2)
            return
    }
    ...
    public T fetch(java.lang.Object r1) {
            r0 = this;
            org.simpleframework.xml.util.WeakCache$Segment r0 = r0.map(r1)
            java.lang.Object r0 = r0.fetch(r1)
            return r0
    }
    ...
    public boolean isEmpty() {
            r1 = this;
            org.simpleframework.xml.util.WeakCache<T>$SegmentList r1 = r1.list
            java.util.Iterator r1 = r1.iterator()
        L6:
            boolean r0 = r1.hasNext()
            if (r0 == 0) goto L1a
            java.lang.Object r0 = r1.next()
            org.simpleframework.xml.util.WeakCache$Segment r0 = (org.simpleframework.xml.util.WeakCache.Segment) r0
