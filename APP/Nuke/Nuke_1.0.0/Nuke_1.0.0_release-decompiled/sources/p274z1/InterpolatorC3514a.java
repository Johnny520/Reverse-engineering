...
public final class InterpolatorC3514a implements Interpolator {
    ...
    public InterpolatorC3514a(float[] fArr) {
        this.f10957a = fArr;
        this.f10958b = 1.0f / (fArr.length - 1);
    }
