...
public class C3671 {
    ...
    /* JADX INFO: renamed from: ۥۦ۟ۡ, reason: contains not printable characters */
    public static String m6537() {
        if (C3553.m5916() < 0) {
            return "";
        }
        return null;
    ...
    public static int m6538() {
        return 497 ^ C3642.f11104;
    }

    /* JADX INFO: renamed from: ۟ۡۢۥۤ, reason: not valid java name and contains not printable characters */
    public static String m6534(short[] sArr, int i5, int i6, int i7) {
