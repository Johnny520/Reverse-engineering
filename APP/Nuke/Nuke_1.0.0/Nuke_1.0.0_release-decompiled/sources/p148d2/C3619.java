...
public class C3619 {
    ...
    /* JADX INFO: renamed from: ۤ۠ۧ۠, reason: not valid java name and contains not printable characters */
    ...
    public static int m6233() {
        return 736 ^ C3537.f11001;
    }

    /* JADX INFO: renamed from: ۡۨ۟ۥ, reason: not valid java name and contains not printable characters */
    public static String m6231(short[] sArr, int i5, int i6, int i7) {
