...
/* JADX INFO: renamed from: r.۟ۥ۠ۧۤ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C3677 {

    /* JADX INFO: renamed from: ۣۧۥۣ, reason: not valid java name and contains not printable characters */
    public static int f11143 = -448;

    /* JADX INFO: renamed from: ۟ۦۨۤۡ, reason: not valid java name and contains not printable characters */
    public static int m6563() {
        return (-572) ^ C3675.f11141;
    }

    /* JADX INFO: renamed from: ۣۡۡۥ, reason: not valid java name and contains not printable characters */
    public static int m6564(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۦۧۡۡ, reason: contains not printable characters */
    public static String m6565(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    public static String m6562(short[] sArr, int i5, int i6, int i7) {
