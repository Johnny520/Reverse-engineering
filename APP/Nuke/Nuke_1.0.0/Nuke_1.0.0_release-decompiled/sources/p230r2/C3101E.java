...
public class C3101E extends AbstractC2770B {
    ...
    public final Object mo4964b(C3390a c3390a) throws IOException {
        ...
        try {
            ...
            throw new C2789r("Failed parsing '" + strM5628H + "' as BigDecimal; at path " + c3390a.m5646m(true), e5);
        }
    }
