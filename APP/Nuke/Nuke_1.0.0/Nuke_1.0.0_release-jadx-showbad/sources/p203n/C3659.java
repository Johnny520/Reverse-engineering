...
public class C3659 {
    ...
    public static String m6429(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    /* JADX INFO: renamed from: ۡۧۧۤ, reason: not valid java name and contains not printable characters */
    public static String m6427(short[] sArr, int i5, int i6, int i7) {
