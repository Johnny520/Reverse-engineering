...
public class C3600 {
    ...
    public static boolean m6141(Object obj) {
        if (C3625.m6259() > 0) {
    ...
    public static int m6142() {
        return 418 ^ C3613.f11077;
    }

    /* JADX INFO: renamed from: ۟ۦ۠ۨ۟, reason: not valid java name and contains not printable characters */
    public static String m6140(short[] sArr, int i5, int i6, int i7) {
