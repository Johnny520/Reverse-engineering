...
public abstract class AbstractC1924f {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [j1.d.<init>(java.util.concurrent.atomic.AtomicReferenceFieldUpdater, java.util.concurrent.atomic.AtomicReferenceFieldUpdater, java.util.concurrent.atomic.AtomicReferenceFieldUpdater, java.util.concurrent.atomic.AtomicReferenceFieldUpdater, java.util.concurrent.atomic.AtomicReferenceFieldUpdater):void, j1.g.<clinit>():void, q3.b.<clinit>():void, q3.e.<clinit>():void, q3.f.<clinit>():void, q3.g.<clinit>():void] */
    ...
    /* JADX DEBUG: Class process forced to load method for inline: P0.o.j(int, P0.o):java.util.List */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
