...
public abstract class AbstractC1925g {
    ...
    /* JADX DEBUG: Class process forced to load method for inline: d3.d.c0(java.lang.CharSequence, java.lang.String, int, int):int */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    ...
    */
    public static long m3522E(String str, int i5) {
        int iM3536m = m3536m(str, 0, i5, false);
        Matcher matcher = C1701k.f5838n.matcher(str);
        int i6 = -1;
        int i7 = -1;
        int i8 = -1;
        int iM3635c0 = -1;
        ...
        int i10 = -1;
        while (iM3536m < i5) {
            int iM3536m2 = m3536m(str, iM3536m + 1, i5, true);
            matcher.region(iM3536m, iM3536m2);
            if (i7 == -1 && matcher.usePattern(C1701k.f5838n).matches()) {
                String strGroup = matcher.group(1);
                AbstractC1665j.m2984d(strGroup, "group(...)");
                i7 = Integer.parseInt(strGroup);
                String strGroup2 = matcher.group(2);
                AbstractC1665j.m2984d(strGroup2, "group(...)");
                i9 = Integer.parseInt(strGroup2);
                String strGroup3 = matcher.group(3);
                AbstractC1665j.m2984d(strGroup3, "group(...)");
                i10 = Integer.parseInt(strGroup3);
            } else if (i8 == -1 && matcher.usePattern(C1701k.f5837m).matches()) {
                String strGroup4 = matcher.group(1);
                AbstractC1665j.m2984d(strGroup4, "group(...)");
                i8 = Integer.parseInt(strGroup4);
            } else if (iM3635c0 == -1) {
                Pattern pattern = C1701k.f5836l;
                if (matcher.usePattern(pattern).matches()) {
                    String strGroup5 = matcher.group(1);
                    AbstractC1665j.m2984d(strGroup5, "group(...)");
                    Locale locale = Locale.US;
                    AbstractC1665j.m2984d(locale, "US");
                    String lowerCase = strGroup5.toLowerCase(locale);
                    AbstractC1665j.m2984d(lowerCase, "toLowerCase(...)");
                    String strPattern = pattern.pattern();
                    AbstractC1665j.m2984d(strPattern, "pattern(...)");
                    iM3635c0 = AbstractC1976d.m3635c0(strPattern, lowerCase, 0, 6) / 4;
                } else if (i6 == -1 && matcher.usePattern(C1701k.f5835k).matches()) {
                    String strGroup6 = matcher.group(1);
                    AbstractC1665j.m2984d(strGroup6, "group(...)");
                    i6 = Integer.parseInt(strGroup6);
                }
            }
            iM3536m = m3536m(str, iM3536m2 + 1, i5, false);
        }
        if (70 <= i6 && i6 < 100) {
            i6 += 1900;
        }
        ...
        GregorianCalendar gregorianCalendar = new GregorianCalendar(AbstractC1776g.f6076a);
        gregorianCalendar.setLenient(false);
        gregorianCalendar.set(1, i6);
        gregorianCalendar.set(2, iM3635c0 - 1);
