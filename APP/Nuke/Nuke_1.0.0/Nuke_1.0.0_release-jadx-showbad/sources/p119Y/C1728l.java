...
public final class C1728l {
    ...
    */
    public final C0236c m3080u(int i5, int i6, Object obj, Object obj2) {
        C0236c c0236cM3080u;
        int i7 = 1;
        int iM3190D = 1 << AbstractC1784a.m3190D(i5, i6);
        int i8 = 0;
        if (m3068h(iM3190D)) {
            int iM3066f = m3066f(iM3190D);
            if (!AbstractC1665j.m2981a(obj, this.f5980d[iM3066f])) {
                return new C0236c(i7, 2, new C1728l(this.f5977a ^ iM3190D, this.f5978b | iM3190D, m3061a(iM3066f, iM3190D, i5, obj, obj2, i6, null), null));
            }
            if (m3083x(iM3066f) != obj2) {
                Object[] objArr = this.f5980d;
                Object[] objArrCopyOf = Arrays.copyOf(objArr, objArr.length);
                AbstractC1665j.m2984d(objArrCopyOf, "copyOf(...)");
                objArrCopyOf[iM3066f + 1] = obj2;
                return new C0236c(i8, 2, new C1728l(this.f5977a, this.f5978b, objArrCopyOf, null));
            }
        } else {
            if (!m3069i(iM3190D)) {
                return new C0236c(i7, 2, new C1728l(this.f5977a | iM3190D, this.f5978b, AbstractC1784a.m3221g(this.f5980d, m3066f(iM3190D), obj, obj2), null));
            }
            int iM3079t = m3079t(iM3190D);
            C1728l c1728lM3078s = m3078s(iM3079t);
            if (i6 == 30) {
                C1802b c1802bM3552E = AbstractC1926h.m3552E(AbstractC1926h.m3557J(0, c1728lM3078s.f5980d.length), 2);
                int i9 = c1802bM3552E.f6140d;
                int i10 = c1802bM3552E.f6141e;
                int i11 = c1802bM3552E.f6142f;
                if ((i11 > 0 && i9 <= i10) || (i11 < 0 && i10 <= i9)) {
                    while (!AbstractC1665j.m2981a(obj, c1728lM3078s.f5980d[i9])) {
                        if (i9 != i10) {
                            i9 += i11;
                        }
                    }
                    if (obj2 == c1728lM3078s.m3083x(i9)) {
                        c0236cM3080u = null;
                    } else {
                        Object[] objArr2 = c1728lM3078s.f5980d;
                        Object[] objArrCopyOf2 = Arrays.copyOf(objArr2, objArr2.length);
                        ...
                        c0236cM3080u = new C0236c(i8, 2, new C1728l(0, 0, objArrCopyOf2, null));
                    }
                }
                c0236cM3080u = new C0236c(i7, 2, new C1728l(0, 0, AbstractC1784a.m3221g(c1728lM3078s.f5980d, 0, obj, obj2), null));
                break;
            }
            c0236cM3080u = c1728lM3078s.m3080u(i5, i6 + 5, obj, obj2);
        }
        return null;
    }
