...
public final class C1187a {
    ...
    */
    public int m2238d(C2599d c2599d) {
        float fSqrt;
        float f2 = this.f3881b;
        double d5 = f2;
        float f5 = this.f3882c;
        if (d5 != 0.0d) {
            double d6 = f5;
            fSqrt = d6 == 0.0d ? 0.0f : f2 / ((float) Math.sqrt(d6 / 100.0d));
        }
        float f6 = c2599d.f8269f;
        float f7 = c2599d.f8271h;
        float fPow = (float) Math.pow(((double) fSqrt) / Math.pow(1.64d - Math.pow(0.29d, f6), 0.73d), 1.1111111111111112d);
        double d7 = (this.f3880a * 3.1415927f) / 180.0f;
        float fCos = ((float) (Math.cos(2.0d + d7) + 3.8d)) * 0.25f;
        float fPow2 = c2599d.f8264a * ((float) Math.pow(((double) f5) / 100.0d, (1.0d / ((double) c2599d.f8267d)) / ((double) c2599d.f8273j)));
        float f8 = fCos * 3846.1538f * c2599d.f8268e * c2599d.f8266c;
        float f9 = fPow2 / c2599d.f8265b;
        ...
        float f16 = ((f13 - (f11 * 220.0f)) - (f12 * 6300.0f)) / 1403.0f;
        float f17 = 100.0f / f7;
        float fSignum = Math.signum(f14) * f17 * ((float) Math.pow((float) Math.max(0.0d, (((double) Math.abs(f14)) * 27.13d) / (400.0d - ((double) Math.abs(f14)))), 2.380952380952381d));
        ...
        float[] fArr = c2599d.f8270g;
        float f18 = fSignum / fArr[0];
        float f19 = fSignum2 / fArr[1];
        float f20 = fSignum3 / fArr[2];
        float[][] fArr2 = AbstractC2596a.f8258b;
        float[] fArr3 = fArr2[0];
        float f21 = (fArr3[2] * f20) + (fArr3[1] * f19) + (fArr3[0] * f18);
        float[] fArr4 = fArr2[1];
        float f22 = (fArr4[2] * f20) + (fArr4[1] * f19) + (fArr4[0] * f18);
