...
public abstract class AbstractC0435z {
    ...
    */
    public static final float m689b(AbstractC0389a0 abstractC0389a0, boolean z5, C0414n[] c0414nArr, float f2) {
        float f5 = Float.NaN;
        for (C0414n c0414n : c0414nArr) {
            float fMo628d = abstractC0389a0.mo628d(c0414n);
            if (Float.isNaN(f5)) {
                f5 = fMo628d;
            } else if (z5 == (fMo628d > f5)) {
            }
        }
        return Float.isNaN(f5) ? f2 : f5;
    }
