...
public class C3586 {
    ...
    /* JADX INFO: renamed from: ۟۠ۦۨۧ, reason: not valid java name and contains not printable characters */
    public static int m6079(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۤۡۤۧ, reason: not valid java name and contains not printable characters */
    public static int m6080() {
        return 443 ^ C3557.f11021;
    }

    /* JADX INFO: renamed from: ۧۤۤ۟, reason: not valid java name and contains not printable characters */
    public static String m6081(short[] sArr, int i5, int i6, int i7) {
