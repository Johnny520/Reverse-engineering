...
/* JADX INFO: renamed from: X1.ۤۧ۠ۥ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C3591 {

    /* JADX INFO: renamed from: ۦۥ۠ۧ, reason: contains not printable characters */
    public static int f11055 = -603;

    /* JADX INFO: renamed from: ۟۟ۢۦۧ, reason: not valid java name and contains not printable characters */
    public static int m6099(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۣ۟۟ۧۦ, reason: not valid java name and contains not printable characters */
    public static int m6100() {
        return 89 ^ C3669.f11135;
    }

    /* JADX INFO: renamed from: ۣۤۥ۠, reason: not valid java name and contains not printable characters */
    public static String m6101(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    public static String m6102(short[] sArr, int i5, int i6, int i7) {
