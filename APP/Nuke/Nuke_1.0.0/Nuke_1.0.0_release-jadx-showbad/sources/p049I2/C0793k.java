...
public final class C0793k implements InterfaceC2909c {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [f0.n.<clinit>():void] */
    ...
    */
    public C0793k(C1804d c1804d, C3375f c3375f) {
        Object c3424g;
        this.f2536d = 8;
        C0793k c0793k = c3375f.f10490a;
        int i5 = c1804d.f6140d;
        if (i5 < 0) {
            AbstractC3204b.m5477c("negative nearestRange.first");
        }
        int iMin = Math.min(c1804d.f6141e, c0793k.f2537e - 1);
        if (iMin < i5) {
            ...
            this.f2538f = c2444z;
            this.f2539g = new Object[0];
            this.f2537e = 0;
            return;
        }
        int i6 = (iMin - i5) + 1;
        this.f2539g = new Object[i6];
        this.f2537e = i5;
        C2444z c2444z2 = new C2444z(i6);
        C1483e c1483e = (C1483e) c0793k.f2538f;
        if (i5 < 0 || i5 >= c0793k.f2537e) {
            StringBuilder sbM404o = AbstractC0231b.m404o(i5, "Index ", ", size ");
            sbM404o.append(c0793k.f2537e);
            AbstractC3204b.m5479e(sbM404o.toString());
        }
        if (iMin < 0 || iMin >= c0793k.f2537e) {
            StringBuilder sbM404o2 = AbstractC0231b.m404o(iMin, "Index ", ", size ");
            sbM404o2.append(c0793k.f2537e);
            AbstractC3204b.m5479e(sbM404o2.toString());
        }
        if (iMin < i5) {
            AbstractC3204b.m5475a("toIndex (" + iMin + ") should be not smaller than fromIndex (" + i5 + ')');
        }
        int iM5692e = AbstractC3429l.m5692e(i5, c1483e);
        int i7 = ((C3426i) c1483e.f5181d[iM5692e]).f10706a;
        while (i7 <= iMin) {
            C3426i c3426i = (C3426i) c1483e.f5181d[iM5692e];
            InterfaceC1601c interfaceC1601c = (InterfaceC1601c) c3426i.f10708c.f307e;
            int i8 = c3426i.f10706a;
            int iMax = Math.max(i5, i8);
            int iMin2 = Math.min(iMin, (c3426i.f10707b + i8) - 1);
            if (iMax <= iMin2) {
                while (true) {
                    if (interfaceC1601c != null) {
                        c3424g = interfaceC1601c.mo1h(Integer.valueOf(iMax - i8));
                        if (c3424g == null) {
                        }
                        c2444z2.m4367g(iMax, c3424g);
                        ((Object[]) this.f2539g)[iMax - this.f2537e] = c3424g;
                        if (iMax == iMin2) {
                            break;
                        }
                    } else {
                        c3424g = new C3424g(iMax);
                        c2444z2.m4367g(iMax, c3424g);
                        ((Object[]) this.f2539g)[iMax - this.f2537e] = c3424g;
