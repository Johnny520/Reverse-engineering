...
/* JADX INFO: renamed from: x1.۟ۢۢۦۧ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C3698 {

    /* JADX INFO: renamed from: ۤ۠ۥ, reason: not valid java name and contains not printable characters */
    public static int f11164 = -818;

    /* JADX INFO: renamed from: ۣ۟۠ۥۣ, reason: not valid java name and contains not printable characters */
    public static int m6665() {
        return 670 ^ C3623.f11086;
    }

    /* JADX INFO: renamed from: ۟ۥۥ۟ۡ, reason: not valid java name and contains not printable characters */
    public static int m6666(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۤۧۨۤ, reason: not valid java name and contains not printable characters */
    public static String m6668(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    public static String m6667(short[] sArr, int i5, int i6, int i7) {
