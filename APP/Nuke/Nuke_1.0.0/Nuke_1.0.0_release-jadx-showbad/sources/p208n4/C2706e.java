...
public final class C2706e implements InterfaceC2708g, InterfaceC2707f, Cloneable, ByteChannel {
    ...
    */
    public final long m4729w() throws EOFException {
        int i5;
        if (this.f8629e == 0) {
            throw new EOFException();
        }
        ...
        do {
            ...
            while (i7 < i8) {
                ...
                if (((-1152921504606846976L) & j5) != 0) {
                    ...
                    c2706e.m4707I(j5);
                    c2706e.m4705G(b2);
                    throw new NumberFormatException("Number too large: ".concat(c2706e.m4699A()));
                }
                j5 = (j5 << 4) | ((long) i5);
                i7++;
                i6++;
