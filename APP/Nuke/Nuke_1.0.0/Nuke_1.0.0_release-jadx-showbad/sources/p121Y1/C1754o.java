...
public final class C1754o implements InterfaceC1143e {
    ...
    */
    public static int m3124k(InterfaceC1752m interfaceC1752m, int i5) {
        while (true) {
            short sMo3103g = interfaceC1752m.mo3103g();
            if (sMo3103g == 255) {
                short sMo3103g2 = interfaceC1752m.mo3103g();
                if (sMo3103g2 == 218) {
                    break;
                }
                if (sMo3103g2 != 217) {
                    int iMo3104l = interfaceC1752m.mo3104l() - 2;
                    if (sMo3103g2 == i5) {
                        return iMo3104l;
                    }
                    long j5 = iMo3104l;
                    long jSkip = interfaceC1752m.skip(j5);
                    if (jSkip != j5) {
                        if (Log.isLoggable("DfltImageHeaderParser", 3)) {
                            Log.d("DfltImageHeaderParser", "Unable to skip enough data, type: " + ((int) sMo3103g2) + ", wanted to skip: " + iMo3104l + ", but actually skipped: " + jSkip);
                        }
                    }
                } else if (Log.isLoggable("DfltImageHeaderParser", 3)) {
                ...
                Log.d("DfltImageHeaderParser", "Unknown segmentId=" + ((int) sMo3103g));
                return -1;
            }
        }
    }
