...
public final class C1872q {
    ...
    */
    public final C1873r m3367d(C1858c c1858c, List list) {
        C1870o c1870o;
        boolean z5;
        Socket socketM3356m;
        C1871p c1871p = this.f6366b;
        boolean z6 = this.f6376l;
        C1691a c1691a = this.f6373i;
        C1869n c1869n = this.f6375k;
        boolean z7 = c1858c != null && c1858c.mo3330e();
        c1871p.getClass();
        ...
        while (true) {
            ...
            c1870o = (C1870o) it.next();
            AbstractC1665j.m2982b(c1870o);
            synchronized (c1870o) {
                if (z7) {
                    try {
                        if (!(c1870o.f6352i != null)) {
                            z5 = false;
                        } else if (c1870o.m3360e(c1691a, list)) {
                            c1869n.m3349e(c1870o);
                            z5 = true;
                        } else {
                            z5 = false;
                        }
        ...
        if (c1858c != null) {
            this.f6379o = c1858c.f6284j;
            Socket socket = c1858c.f6291q;
            if (socket != null) {
                AbstractC1776g.m3175b(socket);
            }
        }
        this.f6375k.f6329g.getClass();
        return new C1873r(c1870o);
    }
