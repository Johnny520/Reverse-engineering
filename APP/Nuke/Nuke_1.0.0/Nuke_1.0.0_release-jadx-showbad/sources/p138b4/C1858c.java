...
public final class C1858c implements InterfaceC1875t, InterfaceC1914d {
    ...
    */
    public final C1874s mo3328c() throws Throwable {
        C1858c c1858cM3337l;
        C1858c c1858c;
        ...
        List list = this.f6284j.f5763a.f5784j;
        ...
        try {
            try {
                if (this.f6286l != null) {
                    C1874s c1874sM3336k = m3336k();
                    if (c1874sM3336k.f6384c != null) {
                        this.f6282h.f6344v.remove(this);
                        Socket socket2 = this.f6291q;
                        if (socket2 != null) {
                ...
                if (c1691a.f5777c != null) {
                    ...
                    if (((C2716o) c0072l0.f308f).f8651e.m4720m()) {
                        C0072l0 c0072l02 = this.f6294t;
                        if (c0072l02 == null) {
                            AbstractC1665j.m2991k("socket");
                            throw null;
                        }
                        if (((C2715n) c0072l02.f309g).f8648e.m4720m()) {
                            this.f6282h.f6329g.getClass();
                            C1691a c1691a2 = this.f6284j.f5763a;
                            SSLSocketFactory sSLSocketFactory = c1691a2.f5777c;
                            C1709s c1709s = c1691a2.f5782h;
                            Socket socketCreateSocket = sSLSocketFactory.createSocket(socket, c1709s.f5871d, c1709s.f5872e, true);
                            AbstractC1665j.m2983c(socketCreateSocket, "null cannot be cast to non-null type javax.net.ssl.SSLSocket");
                            SSLSocket sSLSocket = (SSLSocket) socketCreateSocket;
                            C1858c c1858cM3338m = m3338m(list, sSLSocket);
                            C1700j c1700j = (C1700j) list.get(c1858cM3338m.f6287m);
                            c1858cM3337l = c1858cM3338m.m3337l(list, sSLSocket);
                            try {
                                c1700j.m3017a(sSLSocket, c1858cM3338m.f6288n);
                                m3335j(sSLSocket, c1700j);
                                this.f6282h.f6329g.getClass();
                                c1858c = c1858cM3337l;
                                ...
                                if (this.f6281g && !(e instanceof ProtocolException) && !(e instanceof InterruptedIOException) && ((!(e instanceof SSLHandshakeException) || !(e.getCause() instanceof CertificateException)) && !(e instanceof SSLPeerUnverifiedException) && (e instanceof SSLException))) {
                                    c1858c2 = c1858cM3337l;
                                }
                                C1874s c1874s = new C1874s(this, c1858c2, e);
                                this.f6282h.f6344v.remove(this);
                                if (!z5) {
                                    Socket socket3 = this.f6291q;
                                    if (socket3 != null) {
                                        AbstractC1776g.m3175b(socket3);
                                    }
                                    AbstractC1776g.m3175b(socket);
                                }
                                return c1874s;
                ...
                this.f6291q = socket;
                List list2 = c1691a.f5783i;
                EnumC1716z enumC1716z = EnumC1716z.f5948j;
                if (!list2.contains(enumC1716z)) {
                    enumC1716z = EnumC1716z.f5945g;
                }
                this.f6293s = enumC1716z;
                c1858c = null;
                try {
                    C1808d c1808d = this.f6275a;
                    C1871p c1871p = this.f6276b;
                    C1688J c1688j = this.f6284j;
                    Socket socket4 = this.f6291q;
                    AbstractC1665j.m2982b(socket4);
                    C1705o c1705o = this.f6292r;
                    EnumC1716z enumC1716z2 = this.f6293s;
                    AbstractC1665j.m2982b(enumC1716z2);
                    ...
                    this.f6276b.getClass();
                    C1870o c1870o = new C1870o(c1808d, c1871p, c1688j, socket, socket4, c1705o, enumC1716z2, c0072l03);
                    this.f6295u = c1870o;
                    c1870o.m3362i();
                    ...
                    try {
                        C1874s c1874s2 = new C1874s(this, (Throwable) null, 6);
                        this.f6282h.f6344v.remove(this);
                        return c1874s2;
                        ...
                        z5 = true;
                        c1858cM3337l = c1858c;
                        AbstractC1703m abstractC1703m3 = this.f6282h.f6329g;
                        InetSocketAddress inetSocketAddress3 = this.f6284j.f5765c;
                        abstractC1703m3.getClass();
                        AbstractC1665j.m2985e(inetSocketAddress3, "inetSocketAddress");
                        this.f6276b.getClass();
                        AbstractC1665j.m2985e(this.f6284j, "route");
                        if (this.f6281g) {
                            c1858c2 = c1858cM3337l;
                        }
                        C1874s c1874s3 = new C1874s(this, c1858c2, e);
                        this.f6282h.f6344v.remove(this);
                        if (!z5) {
                        }
                        return c1874s3;
                        ...
                        this.f6282h.f6344v.remove(this);
                        if (!z5) {
                            Socket socket5 = this.f6291q;
                            if (socket5 != null) {
                                AbstractC1776g.m3175b(socket5);
                            }
                            AbstractC1776g.m3175b(socket);
                        }
                        throw th;
