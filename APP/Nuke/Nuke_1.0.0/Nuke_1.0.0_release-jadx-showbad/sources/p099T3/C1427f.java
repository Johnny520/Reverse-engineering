...
public final class C1427f {
  ...
  (0 int)
  (0 int)
  (wrap:T3.e:0x0003: CONSTRUCTOR (null java.lang.String) A[MD:(java.lang.String):void (m), WRAPPED] (LINE:10) call: T3.e.<init>(java.lang.String):void type: CONSTRUCTOR)
 A[MD:(int, int, T3.e):void (m)] (LINE:11) call: T3.f.<init>(int, int, T3.e):void type: THIS */
