...
public final class C0613q implements List, InterfaceC1766a {
    ...
    */
    public final long m1055a() {
        long jM1025a = AbstractC0601k.m1025a(Float.POSITIVE_INFINITY, false, false);
        int i5 = this.f1968f + 1;
        ...
        while (true) {
            ...
            long j5 = c2441w.f7885a[i5];
            if (AbstractC0601k.m1031g(j5, jM1025a) < 0) {
                jM1025a = j5;
            }
            if ((AbstractC0601k.m1033i(jM1025a) < 0.0f && AbstractC0601k.m1038n(jM1025a)) || i5 == iM4208u) {
                break;
            }
            i5++;
        }
