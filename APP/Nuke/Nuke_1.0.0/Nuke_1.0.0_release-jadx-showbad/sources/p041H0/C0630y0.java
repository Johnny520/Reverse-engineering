...
public class C0630y0 {
    ...
    */
    public long m1071g() {
        boolean z5;
        boolean z6;
        int iM1078o = m1078o(m1079p());
        String str = (String) this.f2004g;
        if (iM1078o < str.length() && iM1078o != -1) {
            if (str.charAt(iM1078o) == '\"') {
                iM1078o++;
                if (iM1078o == str.length()) {
                    m1064l(this, "EOF", 0, 6);
                    throw null;
                }
                z5 = true;
            ...
            while (true) {
                ...
                if ((cCharAt != 'e' && cCharAt != 'E') || z8) {
                    ...
                    if (cCharAt == '-' && z8) {
                        if (i5 == iM1078o) {
                            m1064l(this, "Unexpected symbol '-' in numeric literal", i5, 4);
                            throw null;
                        }
                        i5++;
                        j6 = j8;
                        ...
                        if (cCharAt != '-') {
                            if (AbstractC3341e.m5583b(cCharAt) != 0) {
                                break;
                            }
                            int i6 = i5 + 1;
                            int i7 = cCharAt - '0';
                            ...
                            if (z8) {
                                j5 = (j5 * ((long) 10)) + ((long) i7);
                            } else {
                                j7 = (j7 * ((long) 10)) - ((long) i7);
                                if (j7 > j8) {
                                    m1064l(this, "Numeric value overflow", 0, 6);
                                    throw null;
                                }
                            }
                            j6 = j8;
                    ...
                    if (i5 == iM1078o) {
                        m1064l(this, "Unexpected symbol '" + cCharAt + "' in numeric literal", i5, 4);
                        throw null;
                    }
                    i5++;
                    j6 = j8;
