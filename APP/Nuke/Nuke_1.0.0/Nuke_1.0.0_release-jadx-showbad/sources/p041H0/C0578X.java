...
public final class C0578X {
    ...
    */
    public static boolean m914b(C0564I c0564i, C2005a c2005a) {
        boolean zM912x0;
        ...
        if (c2005a == null) {
            ...
            C2005a c2005a2 = c0576v != null ? c0576v.f1808p : null;
            if (c2005a2 != null && c0564i2 != null) {
                AbstractC1665j.m2982b(c0576v);
                zM912x0 = c0576v.m912x0(c2005a2.f6726a);
            }
        } else if (c0564i2 != null) {
            C0576V c0576v2 = c0568m.f1761q;
            AbstractC1665j.m2982b(c0576v2);
            zM912x0 = c0576v2.m912x0(c2005a.f6726a);
        } else {
            zM912x0 = false;
        }
        C0564I c0564iM839u = c0564i.m839u();
        if (zM912x0 && c0564iM839u != null) {
            if (c0564iM839u.f1719l == null) {
                C0564I.m790V(c0564iM839u, false, 3);
                return zM912x0;
            }
            if (c0564i.m837s() == EnumC0561G.f1682d) {
                C0564I.m789T(c0564iM839u, false, 3);
                return zM912x0;
            }
            if (c0564i.m837s() == EnumC0561G.f1683e) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r8v4, resolved type: H0.I */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m918a(boolean z5) {
        Object[] objArr;
        ...
        if (i5 != 0) {
            AbstractC0972l.m2006d0(c1483e2.f5181d, C0608n0.f1956b, 0, i5);
            int i6 = c1483e2.f5183f;
            C0564I[] c0564iArr = (C0564I[]) c0038t0.f170f;
            if (c0564iArr != null) {
                int length = c0564iArr.length;
                objArr = c0564iArr;
                if (length < i6) {
                    objArr = new C0564I[Math.max(16, i6)];
                }
            }
            c0038t0.f170f = null;
            for (int i7 = 0; i7 < i6; i7++) {
                objArr[i7] = c1483e2.f5181d[i7];
            }
            c1483e2.m2758g();
            for (int i8 = i6 - 1; -1 < i8; i8--) {
                C0564I c0564i2 = objArr[i8];
                AbstractC1665j.m2982b(c0564i2);
                if (c0564i2.f1708S) {
                    C0038T0.m26w(c0564i2);
                }
                objArr[i8] = 0;
            }
            c0038t0.f170f = objArr;
        }
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:122:0x015a */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:126:0x0151 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:91:0x0148 */
