...
public class C3552 {
    ...
    public static int m5913(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۤ۠ۧ۟, reason: not valid java name and contains not printable characters */
    public static int m5915() {
        return (-547) ^ C3612.f11076;
    }

    /* JADX INFO: renamed from: ۤ۟ۧۤ, reason: not valid java name and contains not printable characters */
    public static String m5914(short[] sArr, int i5, int i6, int i7) {
