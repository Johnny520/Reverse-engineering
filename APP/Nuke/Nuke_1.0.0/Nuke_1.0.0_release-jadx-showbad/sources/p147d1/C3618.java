...
/* JADX INFO: renamed from: d1.ۣۧۤ۟, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C3618 {

    /* JADX INFO: renamed from: ۣ۟ۦۢۥ, reason: not valid java name and contains not printable characters */
    public static int f11081 = -100;
    ...
    public static String m6228(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    /* JADX INFO: renamed from: ۨ۠ۥ, reason: not valid java name and contains not printable characters */
    public static int m6229() {
        return 630 ^ C3629.f11092;
    }

    /* JADX INFO: renamed from: ۟ۧۦۧۤ, reason: not valid java name and contains not printable characters */
    public static String m6227(short[] sArr, int i5, int i6, int i7) {
