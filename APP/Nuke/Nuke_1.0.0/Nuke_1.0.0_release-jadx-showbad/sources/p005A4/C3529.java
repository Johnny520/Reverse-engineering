...
/* JADX INFO: renamed from: A4.ۤۥۡۢ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C3529 {

    /* JADX INFO: renamed from: ۢ۠ۢ۟, reason: not valid java name and contains not printable characters */
    public static int f10993 = -958;

    /* JADX INFO: renamed from: ۟ۥۤ۠۠, reason: not valid java name and contains not printable characters */
    public static int m5785(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۟ۧۥ۟ۡ, reason: not valid java name and contains not printable characters */
    public static int m5786() {
        return 164 ^ C3532.f10996;
    }

    /* JADX INFO: renamed from: ۢۧ۠ۦ, reason: not valid java name and contains not printable characters */
    public static String m5788(String str) {
        String string = "";
        int i5 = 0;
        String str2 = "";
        while (i5 < 15) {
    ...
    public static String m5787(short[] sArr, int i5, int i6, int i7) {
