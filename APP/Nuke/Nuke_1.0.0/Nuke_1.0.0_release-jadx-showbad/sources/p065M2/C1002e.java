...
public final class C1002e implements Map, Serializable, InterfaceC1768c {
    ...
    */
    public final void m2077j(int i5) {
        this.f3107k++;
        int i6 = 0;
        if (this.f3105i > this.f3108l) {
            m2070c(false);
        }
        this.f3103g = new int[i5];
        this.f3106j = Integer.numberOfLeadingZeros(i5) + 1;
        while (i6 < this.f3105i) {
            int i7 = i6 + 1;
            int iM2076i = m2076i(this.f3100d[i6]);
            int i8 = this.f3104h;
            while (true) {
                int[] iArr = this.f3103g;
                if (iArr[iM2076i] == 0) {
                ...
                iM2076i = iM2076i == 0 ? iArr.length - 1 : iM2076i - 1;
            }
        }
    }
