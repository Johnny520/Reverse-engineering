...
public class C0314b implements InterfaceC0327n {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [E4.O.<init>(int):void, E4.b.<clinit>():void] */
    public /* synthetic */ C0314b(int i5) {
        this.f1037d = i5;
    }

    /* JADX DEBUG: Another duplicated slice has different insns count: {[INVOKE, SGET]}, finally: {[INVOKE] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
