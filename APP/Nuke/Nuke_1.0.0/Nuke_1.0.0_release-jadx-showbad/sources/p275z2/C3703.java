...
public class C3703 {
    ...
    public static int m6691(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۤۨۥۥ, reason: not valid java name and contains not printable characters */
    public static int m6692() {
        return 446 ^ C3554.f11018;
    }

    /* JADX INFO: renamed from: ۟ۦۦۤۢ, reason: not valid java name and contains not printable characters */
    public static String m6689(short[] sArr, int i5, int i6, int i7) {
