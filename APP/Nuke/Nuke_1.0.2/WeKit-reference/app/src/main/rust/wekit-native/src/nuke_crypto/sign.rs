//! Legacy native client-signer stream transforms retained as offline evidence.
//!
...
//! against direct local native calls in the earlier Unidbg oracle. The current
//! 1.0.2 engine generation binds signing to bridge/module attestation and does
//! not accept this packet as a current cloud signature.
...
/// Static 64-byte root emitted by the legacy native oracle `FUN_00e9bfac`.
pub const DEFAULT_SIGNER_ROOT: &[u8] =
    b"22521becd14f33ebf6ad59aeec80f6354cff1e451a69703d03b7a7cc0243c6fa";
/// Legacy signer companion secret used together with [`DEFAULT_SIGNER_ROOT`].
