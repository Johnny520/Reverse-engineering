...
public final class xj1 {
    ...
    /* JADX INFO: renamed from: a */
    public final void m6152a() {
        this.f13057e = 0;
        long[] jArr = this.f13053a;
        if (jArr != ed2.f2401a) {
            AbstractC0460mg.m3095j0(-9187201950435737472L, jArr);
            long[] jArr2 = this.f13053a;
            int i = this.f13056d;
            int i2 = i >> 3;
            long j = 255 << ((i & 7) << 3);
            jArr2[i2] = (jArr2[i2] & (~j)) | j;
        }
        this.f13058f = ed2.m1336a(this.f13056d) - this.f13057e;
    }

    /* JADX INFO: renamed from: b */
    public final int m6153b(int i) {
        int i2 = this.f13056d;
        int i3 = i & i2;
        int i4 = 0;
        while (true) {
    ...
    public final int m6154c(int i) {
        ...
        while (true) {
            ...
            for (long j3 = (~j2) & (j2 - 72340172838076673L) & (-9187201950435737472L); j3 != 0; j3 &= j3 - 1) {
                ...
                if (this.f13054b[iNumberOfTrailingZeros] == i) {
    ...
    /* JADX INFO: renamed from: d */
    public final int m6155d(int i) {
        int iM6154c = m6154c(i);
        if (iM6154c >= 0) {
            return this.f13055c[iM6154c];
        }
        return -1;
    }

    /* JADX INFO: renamed from: e */
    public final void m6156e(int i) {
        long[] jArr;
        ...
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f13058f = ed2.m1336a(this.f13056d) - this.f13057e;
        this.f13054b = new int[iMax];
        this.f13055c = new int[iMax];
    }
    ...
    */
    public final boolean equals(Object obj) {
        ...
        xj1 xj1Var = (xj1) obj;
        if (xj1Var.f13057e != this.f13057e) {
            return false;
        }
        int[] iArr = this.f13054b;
        int[] iArr2 = this.f13055c;
        long[] jArr = this.f13053a;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            int i5 = iArr[i4];
                            int i6 = iArr2[i4];
                            int iM6154c = xj1Var.m6154c(i5);
                            if (iM6154c < 0 || i6 != xj1Var.f13055c[iM6154c]) {
                                break loop0;
                            }
                        }
                        j >>= 8;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0084, code lost:
        ...
        if (r37.f13058f != 0) goto L16;
     */
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0098, code lost:
    
        if (((r37.f13053a[r2 >> 3] >> ((r2 & 7) << 3)) & 255) != 254) goto L17;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00be, code lost:
        ...
        if (java.lang.Long.compareUnsigned(((long) r37.f13057e) * 32, ((long) r2) * 25) > 0) goto L41;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00ed, code lost:
        ...
        r25 = r11;
        r12 = 7;
        r7 = p000.AbstractC0460mg.m3098m0(r2);
        r8 = r7 - 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x01e5, code lost:
        ...
        r18 = r14;
        r32 = r15;
        r37.f13058f = p000.ed2.m1336a(r37.f13056d) - r37.f13057e;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0206, code lost:
        ...
        r2 = p000.ed2.m1337b(r37.f13056d);
        r3 = r37.f13053a;
        r5 = r37.f13054b;
        r6 = r37.f13055c;
        r7 = r37.f13056d;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m6157f(int i, int i2) {
        int i3;
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                int i17 = i5;
                if (this.f13054b[iNumberOfTrailingZeros] == i4) {
                    break loop0;
                }
                j4 &= j4 - 1;
                i5 = i17;
        ...
        this.f13054b[iNumberOfTrailingZeros] = i;
        this.f13055c[iNumberOfTrailingZeros] = i2;
    }
