...
public class q53 extends q43 {
    ...
    public final Object mo97b(l41 l41Var) throws IOException {
        ...
        try {
            ...
            if (iM2837v <= 255 && iM2837v >= -128) {
                return Byte.valueOf((byte) iM2837v);
            }
            StringBuilder sbM5695n = vi0.m5695n(iM2837v, "Lossy conversion from ", " to byte; at path ");
