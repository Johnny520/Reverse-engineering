...
public final class ub3 {
    ...
    public static final ub3 f11214k;
    ...
    public final float f11222h;

    /* JADX INFO: renamed from: i */
    public final float f11223i;

    /* JADX INFO: renamed from: j */
    public final float f11224j;

    static {
        float[] fArr = xe1.f12994c;
        float fM6138o0 = (float) ((((double) xe1.m6138o0()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = xe1.f12992a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fM6138o0) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f9 = 1.0f / ((5.0f * fM6138o0) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fM6138o0) * 5.0d))) + (f10 * fM6138o0);
        float fM6138o02 = xe1.m6138o0() / fArr[1];
        double d2 = fM6138o02;
        ...
        f11214k = new ub3(fM6138o02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public ub3(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f11220f = f;
        this.f11215a = f2;
        this.f11216b = f3;
        this.f11217c = f4;
