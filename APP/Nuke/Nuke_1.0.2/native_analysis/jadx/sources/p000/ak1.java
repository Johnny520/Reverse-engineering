...
public final class ak1 {
    ...
    public ak1(int i) {
        this.f233a = ed2.f2401a;
        this.f234b = g11.f3247a;
        if (i >= 0) {
            m185d(ed2.m1339d(i));
        } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0089, code lost:
        ...
        if (r37.f237e != 0) goto L16;
     */
    /* JADX WARN: Code restructure failed: missing block: B:15:0x009d, code lost:
    
        if (((r37.f233a[r3 >> 3] >> ((r3 & 7) << 3)) & 255) != 254) goto L17;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00bf, code lost:
        ...
        if (java.lang.Long.compareUnsigned(((long) r37.f236d) * 32, ((long) r3) * 25) > 0) goto L42;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00ec, code lost:
        ...
        r25 = r12;
        r7 = p000.AbstractC0460mg.m3098m0(r3);
        r8 = r7 - 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x01cc, code lost:
        ...
        r29 = r15;
        r37.f237e = p000.ed2.m1336a(r37.f235c) - r37.f236d;
     */
    ...
    */
    public final boolean m182a(int i) {
        int i2;
        boolean z;
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                int i14 = i4;
                if (this.f234b[iNumberOfTrailingZeros] == i) {
                    z = true;
                    break loop0;
                }
                j4 &= j4 - 1;
        ...
        this.f234b[iNumberOfTrailingZeros] = i;
        if (this.f236d != i3) {
            return z;
        }
        return false;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m183b(int i) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(i) * (-862048943);
    ...
    public final void m185d(int i) {
        ...
        long j = 255 << ((iMax & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f237e = ed2.m1336a(this.f235c) - this.f236d;
        this.f234b = new int[iMax];
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m186e(int i) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(i) * (-862048943);
        int i2 = iHashCode ^ (iHashCode << 16);
        int i3 = i2 & 127;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !ak1Var.m183b(iArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
