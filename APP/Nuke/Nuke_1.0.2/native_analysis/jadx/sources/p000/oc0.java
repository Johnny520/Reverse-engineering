...
public final class oc0 extends CharacterStyle implements UpdateAppearance {
    ...
    public final void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            op0 op0Var = this.f7624h;
            if (t11.m5086l(op0Var, xi0Var)) {
            ...
            textPaint.setStrokeWidth(xv2Var.f13195h);
            textPaint.setStrokeMiter(xv2Var.f13196i);
            int i = xv2Var.f13198k;
            textPaint.setStrokeJoin(i == 0 ? Paint.Join.MITER : i == 1 ? Paint.Join.ROUND : i == 2 ? Paint.Join.BEVEL : Paint.Join.MITER);
            int i2 = xv2Var.f13197j;
