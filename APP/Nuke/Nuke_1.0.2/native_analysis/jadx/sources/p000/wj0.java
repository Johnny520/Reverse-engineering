...
public final class wj0 implements sj0 {
    ...
    public final pt2 f12540b;

    public wj0(float f, float f2, float f3) {
        this.f12539a = f3;
        pt2 pt2Var = new pt2();
        pt2Var.f8562a = 1.0f;
        pt2Var.f8563b = Math.sqrt(50.0d);
        pt2Var.f8564c = 1.0f;
        if (f < 0.0f) {
            l22.m2785a("Damping ratio must be non-negative");
        }
        pt2Var.f8564c = f;
        double d = pt2Var.f8563b;
        if (((float) (d * d)) <= 0.0f) {
            l22.m2785a("Spring stiffness constant must be positive.");
        }
        pt2Var.f8563b = Math.sqrt(f2);
        this.f12540b = pt2Var;
    }
    ...
    public final float mo4877b(long j, float f, float f2, float f3) {
        pt2 pt2Var = this.f12540b;
        pt2Var.f8562a = f2;
        return Float.intBitsToFloat((int) (pt2Var.m3984a(f, f3, j / 1000000) >> 32));
    }
    ...
    public final float mo4878c(long j, float f, float f2, float f3) {
        pt2 pt2Var = this.f12540b;
        pt2Var.f8562a = f2;
        return Float.intBitsToFloat((int) (pt2Var.m3984a(f, f3, j / 1000000) & 4294967295L));
    }
    ...
    */
    public final long mo4879d(float f, float f2, float f3) {
        ...
        double d;
        pt2 pt2Var = this.f12540b;
        double d2 = pt2Var.f8563b;
        float f4 = (float) (d2 * d2);
        float f5 = pt2Var.f8564c;
        float f6 = this.f12539a;
        float f7 = (f - f2) / f6;
        float f8 = f3 / f6;
        if (f5 == 0.0f) {
            j = 9223372036854L;
    ...
    public final float mo4880e(float f, float f2, float f3) {
        return 0.0f;
    }
}
