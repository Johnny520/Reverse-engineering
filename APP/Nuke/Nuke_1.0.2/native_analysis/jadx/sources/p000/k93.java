...
public final class k93 implements na0 {
    ...
    public final List mo2618d(String str) throws UnknownHostException {
        str.getClass();
        try {
            InetAddress[] allByName = InetAddress.getAllByName(str);
            allByName.getClass();
            List<InetAddress> listM3105t0 = AbstractC0460mg.m3105t0(allByName);
            if (this.f5411h || listM3105t0.isEmpty()) {
                return listM3105t0;
            }
            for (InetAddress inetAddress : listM3105t0) {
