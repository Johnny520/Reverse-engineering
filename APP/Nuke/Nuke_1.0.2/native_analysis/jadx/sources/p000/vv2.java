...
public abstract class vv2 extends uv2 {
    ...
    */
    public static final boolean m5801U(String str) {
        char c;
        boolean z;
        boolean z2;
        int i;
            ...
            if (i8 > length) {
                ...
                if (str.charAt(i8) == '.') {
                    ...
                    if (!z7 || z3) {
                        ...
                        i2 = (str2 != null && pv2.m4002o0(str, str2, i, false) == i) ? length + 1 : -1;
                    }
                } else {
                    i = i8;
                }
    ...
    public static Double m5802V(String str) {
        str.getClass();
        try {
            if (m5801U(str)) {
