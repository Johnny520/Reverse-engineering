...
public abstract class AbstractC0823vu {

    /* JADX INFO: renamed from: a */
    public static final ThreadLocal f12172a = new ThreadLocal();

    /* JADX INFO: renamed from: a */
    public static ColorStateList m5798a(Resources resources, XmlResourceParser xmlResourceParser, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        ...
        if (next == 2) {
            return m5799b(resources, xmlResourceParser, attributeSetAsAttributeSet, theme);
        }
    ...
    */
    public static ColorStateList m5799b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        int depth;
        int color;
        int i;
        int[] iArr;
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                if (resourceId != -1) {
                    ThreadLocal threadLocal = f12172a;
                    ...
                    if (i6 < 28 || i6 > 31) {
                        try {
                            color = m5798a(r0, r0.getXml(resourceId), theme2).getDefaultColor();
                    ...
                    if (f2 != 1.0f || z) {
                        ...
                        if (z) {
                            C0211fp c0211fpM1708a = C0211fp.m1708a(color);
                            float f5 = c0211fpM1708a.f3086a;
                            float f6 = c0211fpM1708a.f3087b;
                            ub3 ub3Var = ub3.f11214k;
                            if (f6 < 1.0d || Math.round(f3) <= 0.0d || Math.round(f3) >= 100.0d) {
                                iArr = iArrTrimStateSet;
                                i2 = depth2;
                                iM6089G = xe1.m6089G(f3);
                            } else {
                                ...
                                while (true) {
                                    if (Math.abs(f7 - f6) >= 0.4f) {
                                        ...
                                        while (true) {
                                            ...
                                            iArr = iArrTrimStateSet;
                                            int iM1711d = C0211fp.m1709b(f13, f8, fMin).m1711d(ub3.f11214k);
                                            float fM6102T = xe1.m6102T(Color.red(iM1711d));
                                            float fM6102T2 = xe1.m6102T(Color.green(iM1711d));
                                            float fM6102T3 = xe1.m6102T(Color.blue(iM1711d));
                                            float[] fArr = xe1.f12995d[r16 == true ? 1 : 0];
                                            float f14 = ((fM6102T3 * fArr[2]) + ((fM6102T2 * fArr[r16 == true ? 1 : 0]) + (fM6102T * fArr[0]))) / f;
                                            if (f14 <= 0.008856452f) {
                                                fCbrt = f14 * 903.2963f;
                                                i3 = iM1711d;
                                            } else {
                                            ...
                                            if (fAbs < 0.2f) {
                                                C0211fp c0211fpM1708a2 = C0211fp.m1708a(i3);
                                                C0211fp c0211fpM1709b = C0211fp.m1709b(c0211fpM1708a2.f3088c, c0211fpM1708a2.f3087b, fMin);
                                                float f15 = c0211fpM1708a2.f3089d - c0211fpM1709b.f3089d;
                                                float f16 = c0211fpM1708a2.f3090e - c0211fpM1709b.f3090e;
                                                float f17 = c0211fpM1708a2.f3091f - c0211fpM1709b.f3091f;
                                                i2 = depth2;
                                                float fPow = (float) (Math.pow(Math.sqrt((f17 * f17) + (f16 * f16) + (f15 * f15)), 0.63d) * 1.41d);
                                                if (fPow <= 1.0f) {
                                                    f12 = fPow;
                                                    f9 = fAbs;
                                                    c0211fp2 = c0211fpM1708a2;
                                                }
                                            } else {
                                                i2 = depth2;
                                            }
                                        ...
                                        if (!z2) {
                                            ...
                                            if (c0211fp3 != null) {
                                                iM6089G = c0211fp3.m1711d(ub3Var);
                                                break;
                                            }
                                            f8 = ((f6 - f7) / 2.0f) + f7;
                                            f4 = f;
                                        ...
                                        iArr = iArrTrimStateSet;
                                        i2 = depth2;
                                        iM6089G = c0211fp == null ? xe1.m6089G(f3) : c0211fp.m1711d(ub3Var);
                                    }
                                }
                            }
                            color = iM6089G;
