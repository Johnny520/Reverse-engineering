...
public abstract class ex0 {
    ...
    public static final TimeZone f2666a = TimeZone.getTimeZone("UTC");

    /* JADX INFO: renamed from: a */
    public static boolean m1482a(String str, int i, char c) {
    ...
    */
    public static Date m1483b(String str, ParsePosition parsePosition) throws ParseException {
        String message;
        int i;
        int i2;
        int iM1484c;
        ...
        try {
            ...
            int i3 = index + 4;
            int iM1484c3 = m1484c(str, index, i3);
            if (m1482a(str, i3, '-')) {
                i3 = index + 5;
            }
            int i4 = i3 + 2;
            int iM1484c4 = m1484c(str, i3, i4);
            if (m1482a(str, i4, '-')) {
                i4 = i3 + 3;
            }
            int i5 = i4 + 2;
            int iM1484c5 = m1484c(str, i4, i5);
            boolean zM1482a = m1482a(str, i5, 'T');
            if (!zM1482a && str.length() <= i5) {
                GregorianCalendar gregorianCalendar = new GregorianCalendar(iM1484c3, iM1484c4 - 1, iM1484c5);
            ...
            if (zM1482a) {
                int i6 = i4 + 5;
                int iM1484c6 = m1484c(str, i4 + 3, i6);
                if (m1482a(str, i6, ':')) {
                    i6 = i4 + 6;
                }
                int i7 = i6 + 2;
                int iM1484c7 = m1484c(str, i6, i7);
                if (m1482a(str, i7, ':')) {
                    i7 = i6 + 3;
                }
                if (str.length() > i7 && (cCharAt = str.charAt(i7)) != 'Z' && cCharAt != '+' && cCharAt != '-') {
                    int i8 = i7 + 2;
                    iM1484c2 = m1484c(str, i7, i8);
                    if (iM1484c2 > 59 && iM1484c2 < 63) {
                        iM1484c2 = 59;
                    }
                    if (m1482a(str, i8, '.')) {
                        int i9 = i7 + 3;
                    ...
                    gregorianCalendar2.set(1, iM1484c3);
                    gregorianCalendar2.set(2, iM1484c4 - 1);
                    gregorianCalendar2.set(5, iM1484c5);
                    gregorianCalendar2.set(11, i);
                    gregorianCalendar2.set(12, i2);
                    gregorianCalendar2.set(13, iM1484c2);
                    gregorianCalendar2.set(14, iM1484c);
    ...
    public static int m1484c(String str, int i, int i2) {
        int i3;
        int i4;
