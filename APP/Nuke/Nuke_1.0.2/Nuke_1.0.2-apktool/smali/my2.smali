...
.method public final a()Landroid/graphics/Canvas;
    ...
    .line 1
    iget-object p0, p0, Lmy2;->a:Landroid/graphics/Canvas;
    ...
    .line 7
    .line 8
    invoke-static {p0}, Llz0;->c(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lmy2;->a()Landroid/graphics/Canvas;
...
.method public final disableZ()V
    ...
    .line 5
    invoke-static {p0}, Le6;->g(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    .line 13
    invoke-static {p0, p1, p2}, Le6;->h(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    .line 10
    invoke-static {p0, p1, p2}, Le6;->i(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    .line 15
    invoke-static {p0, p1, p2, p3}, Le6;->j(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Le6;->k(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static/range {p0 .. p5}, Le6;->l(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Ll7;->r(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, Ll7;->p(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static {p0, p1, p2, p3}, Ll7;->q(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 5
    invoke-static {p0, p1}, Le6;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {p0 .. p9}, Le6;->n(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 5
    invoke-static {p0}, Le6;->u(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    .line 17
    invoke-static {p0, p1, p2, p3, p4}, Le4;->v(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    .line 14
    invoke-static {p0, p1}, Le4;->w(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    .line 11
    invoke-static {p0, p1}, Le4;->x(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
