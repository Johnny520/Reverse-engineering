...
public final class u51 extends su {
    ...
    public final float e(float f, float f2, float f3) {
        switch (this.d) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * pp0.h[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
    ...
    public final long f(float f, float f2, float f3, float f4, su suVar) {
        switch (this.d) {
            case 0:
                ...
                return sp0.a(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, suVar);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return sp0.a(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, suVar);
        }
    }
}
