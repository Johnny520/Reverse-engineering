...
public final class dp0 implements Handler.Callback {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static void a(Object obj, Object obj2) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException {
        Bundle bundle;
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            case 0:
                ...
                int i2 = message.what;
                if (i2 == 1) {
                    ep0Var.b((cp0) message.obj);
                    return true;
                }
                if (i2 != 2) {
                    return false;
                }
                ep0Var.d.a((cp0) message.obj);
                return false;
            default:
                int i3 = message.what;
                Bundle bundle = null;
