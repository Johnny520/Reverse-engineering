...
public abstract class uu0 {
    ...
    static {
        ...
        cls8.getClass();
        a = we1.q0(ow1Var, ow1Var2, ow1Var3, ow1Var4, ow1Var5, ow1Var6, ow1Var7, new ow1(cls8, Double.class));
    }
    ...
    */
    public static pu0 a(Class[] clsArr, ArrayList arrayList) {
        ou0 ou0Var;
        Object objValueOf;
        ou0 ou0Var2;
        Class cls;
        ...
        while (i < length) {
            ...
            if (obj == null) {
                ...
                if (cls2.isPrimitive() && (cls = (Class) a.get(cls2)) != null) {
                    cls2 = cls;
                }
                if (cls2.equals(obj.getClass())) {
                    ...
                    if (cls2.equals(Byte.class)) {
                        ...
                        if (lC != null) {
                            ...
                            objValueOf = lC != null ? Byte.valueOf((byte) lC.longValue()) : null;
                        ...
                        if (lC2 != null) {
                            ...
                            if (lC2 != null) {
                                objValueOf = Short.valueOf((short) lC2.longValue());
                            }
                            if (objValueOf != null) {
                            }
                            if (ou0Var2 == null) {
                        ...
                        Long lC3 = c(number);
                        if (lC3 != null) {
                            long jLongValue3 = lC3.longValue();
                            if (-2147483648L > jLongValue3 || jLongValue3 >= 2147483648L) {
                                lC3 = null;
                            }
                            if (lC3 != null) {
                                objValueOf = Integer.valueOf((int) lC3.longValue());
                            }
                            if (objValueOf != null) {
                            }
                            if (ou0Var2 == null) {
    ...
    public static Field b(Class cls, String str, boolean z) {
        while (true) {
            ...
            while (true) {
                ...
                if (t11.l(field2.getName(), str) && Modifier.isStatic(field2.getModifiers()) == z) {
                    field = field2;
                    break;
                }
                i++;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static ru0 d(Class cls, String str, ArrayList arrayList, boolean z) {
        Object next;
        ...
        while (cls != null) {
            ...
            for (Method method : declaredMethods) {
                if (t11.l(method.getName(), str) && Modifier.isStatic(method.getModifiers()) == z && method.getParameterCount() == arrayList.size()) {
        ...
        while (true) {
            ...
            pu0 pu0VarA = a(parameterTypes, arrayList);
            tu0 tu0Var = pu0VarA != null ? new tu0(method2, pu0VarA.a, pu0VarA.b) : null;
            if (tu0Var != null) {
        ...
        if (tu0Var2 != null) {
            return new ru0(tu0Var2.a, tu0Var2.b);
        }
        return null;
    }
}
