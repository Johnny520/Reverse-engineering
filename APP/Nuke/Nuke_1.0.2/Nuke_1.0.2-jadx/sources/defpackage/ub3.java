...
public final class ub3 {
    ...
    static {
        float[] fArr = xe1.c;
        float fO0 = (float) ((((double) xe1.o0()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = xe1.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fO0) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f9 = 1.0f / ((5.0f * fO0) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fO0) * 5.0d))) + (f10 * fO0);
        float fO02 = xe1.o0() / fArr[1];
        double d2 = fO02;
        ...
        k = new ub3(fO02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }
