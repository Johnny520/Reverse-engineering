    ...
    public final String d(int i) {
        ...
        if (!byteBuffer.hasArray()) {
            ...
            while (i4 < i5) {
                ...
                if (b2 >= 0) {
                    ...
                    i4 += 2;
                    gg3.d(b2, byteBuffer.get(i8), cArr, i7);
                    i7++;
                } else if (b2 < -16) {
                    if (i8 >= i5 - 1) {
                        s.j("Invalid UTF-8");
                    ...
                    int i10 = i4 + 2;
                    i4 += 3;
                    gg3.c(b2, byteBuffer.get(i8), byteBuffer.get(i10), cArr, i7);
                    i7++;
                } else {
                    if (i8 >= i5 - 2) {
                        s.j("Invalid UTF-8");
                    ...
                    i4 += 4;
                    gg3.b(b2, b4, b5, byteBuffer.get(i11), cArr, i7);
                    i7 += 2;
                }
            }
        ...
        while (iArrayOffset < i12) {
            ...
            if (b7 >= 0) {
                ...
                iArrayOffset += 2;
                gg3.d(b7, bArrArray[i15], cArr2, i14);
                i14++;
            } else if (b7 < -16) {
                if (i15 >= i12 - 1) {
                    s.j("Invalid UTF-8");
                ...
                iArrayOffset += 3;
                gg3.c(b7, bArrArray[i15], bArrArray[i17], cArr2, i14);
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                    s.j("Invalid UTF-8");
                ...
                iArrayOffset += 4;
                gg3.b(b7, b9, b10, bArrArray[i18], cArr2, i14);
                i14 += 2;
            }
        }
