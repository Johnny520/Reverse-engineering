...
public abstract class qa1 {
    ...
    public static void a(Constructor constructor, ha1 ha1Var) {
        try {
    ...
    public static int b(Class cls) {
        ...
        if (cls.getCanonicalName() != null) {
            ...
            try {
                ...
                canonicalName.getClass();
                String strConcat = wv2.b0(canonicalName, ".", "_").concat("_LifecycleAdapter");
                if (name.length() != 0) {
            ...
            if (declaredConstructor != null) {
                map2.put(cls, eu.O(declaredConstructor));
            } else {
                gt gtVar = gt.c;
                HashMap map3 = gtVar.b;
