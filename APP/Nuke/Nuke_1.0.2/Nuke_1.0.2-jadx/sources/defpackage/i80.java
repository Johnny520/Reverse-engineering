...
public abstract class i80 {
    ...
    static {
        ...
        we1.s0(linkedHashMap2, ow1VarArr2);
        b = linkedHashMap2;
    }
    ...
    public static final String a(Method method) {
        ...
        sb.append(mg.p0(parameterTypes, "", v6.F, 30));
        sb.append(")");
    ...
    public static final String b(Class cls) {
        ...
        c80.m("Unknown primitive type: ", cls);
        return null;
    }
    ...
    public static final String c(String str) {
        str.getClass();
        if (str.charAt(0) == '[') {
            return c(str.substring(1)).concat("[]");
        }
        if (str.length() == 1) {
            ...
            s.j("Unknown primitive typeSign: ".concat(str));
            return null;
        }
        if (str.charAt(0) != 'L' || str.charAt(str.length() - 1) != ';') {
            s.l("Unknown class sign: ".concat(str));
            return null;
        }
    ...
    public static final String d(Class cls) {
        ...
        if (!cls.isPrimitive()) {
            if (cls.isArray()) {
                Class<?> componentType = cls.getComponentType();
                componentType.getClass();
                return "[".concat(d(componentType));
            }
            String strReplace = cls.getName().replace('.', '/');
            strReplace.getClass();
            return vi0.j("L", strReplace, ";");
        }
        if (cls.equals(Boolean.TYPE)) {
            return "Z";
        }
    ...
    public static final String e(String str) {
        str.getClass();
        if (wv2.W(str, "[]", false)) {
            return "[".concat(e(str.substring(0, str.length() - 2)));
        }
