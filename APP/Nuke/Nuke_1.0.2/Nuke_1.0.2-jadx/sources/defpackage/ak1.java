...
public final class ak1 {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x01cc, code lost:
        ...
        r29 = r15;
        r37.e = defpackage.ed2.a(r37.c) - r37.d;
     */
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !ak1Var.b(iArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
  ...
  0x005b: PHI (r5v2 int) = (r5v1 int), (r5v3 int) binds: [B:6:0x0024, B:18:0x0059] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0001: CONSTRUCTOR (6 int) A[MD:(int):void (m)] (LINE:34) call: ak1.<init>(int):void type: THIS */
