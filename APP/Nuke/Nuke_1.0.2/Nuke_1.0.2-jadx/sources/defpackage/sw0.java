...
public abstract class sw0 {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static final boolean a(r92 r92Var) {
        if (t11.l(r92Var.h.b, "HEAD")) {
            return false;
        }
        int i = r92Var.k;
        if (((i < 100 || i >= 200) && i != 204 && i != 304) || wg3.e(r92Var) != -1) {
            return true;
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:172:0x01a5 */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r25v6, resolved type: boolean */
    ...
    */
    public static final void b(sn snVar, yw0 yw0Var, js0 js0Var) {
        ...
        Pattern pattern = y00.k;
        int size = js0Var.size();
        int i2 = 0;
        ArrayList arrayList = null;
        for (int i3 = 0; i3 < size; i3++) {
            if ("Set-Cookie".equalsIgnoreCase(js0Var.b(i3))) {
                if (arrayList == null) {
                    arrayList = new ArrayList(2);
                }
                arrayList.add(js0Var.d(i3));
            }
        }
        if (arrayList != null) {
        ...
        while (i4 < size2) {
            ...
            byte[] bArr = ug3.a;
            char c = ';';
            int iC = ug3.c(str2, ';', i2, str2.length());
            char c2 = '=';
            int iC2 = ug3.c(str2, '=', i2, iC);
            if (iC2 == iC) {
                i = i2;
                y00Var = null;
            } else {
                int iG = ug3.g(str2, i2, iC2);
                String strSubstring = str2.substring(iG, ug3.h(str2, iG, iC2));
                if (strSubstring.length() != 0 && ug3.f(strSubstring) == -1) {
                    int iG2 = ug3.g(str2, iC2 + 1, iC);
                    String strSubstring2 = str2.substring(iG2, ug3.h(str2, iG2, iC));
                    if (ug3.f(strSubstring2) == -1) {
                        int i5 = iC + 1;
                        ...
                        while (true) {
                            ...
                            if (i5 < length) {
                                int iC3 = ug3.c(str2, c, i5, length);
                                int iC4 = ug3.c(str2, c2, i5, iC3);
                                int iG3 = ug3.g(str2, i5, iC4);
                                String strSubstring5 = str2.substring(iG3, ug3.h(str2, iG3, iC4));
                                if (iC4 < iC3) {
                                    int iG4 = ug3.g(str2, iC4 + 1, iC3);
                                    strSubstring4 = str2.substring(iG4, ug3.h(str2, iG4, iC3));
                                }
                                if (strSubstring5.equalsIgnoreCase("expires")) {
                                    try {
                                        jG = t11.G(strSubstring4, strSubstring4.length());
                                        z3 = 1;
                                    ...
                                    try {
                                        ...
                                        j2 = wv2.d0(strSubstring4, "-", false) ? Long.MIN_VALUE : Long.MAX_VALUE;
                                    }
                                    z3 = 1;
                                } else if (strSubstring5.equalsIgnoreCase("domain")) {
                                    if (wv2.W(strSubstring4, ".", false)) {
                                        throw new IllegalArgumentException("Failed requirement.");
                                    }
                                    String strB = sg3.b(pv2.y0(strSubstring4, "."));
                                    if (strB == null) {
                                ...
                                String str5 = yw0Var2.d;
                                if (str3 == null) {
                                    str = str5;
                                } else if (t11.l(str5, str3) || (wv2.W(str5, str3, false) && str5.charAt((str5.length() - str3.length()) - 1) == '.' && !sg3.a.b(str5))) {
                                    str = str3;
                                } else {
                                    i = 0;
                                    y00Var2 = null;
                                ...
                                if (str5.length() != str.length()) {
                                    ...
                                    unicode.getClass();
                                    List listC0 = pv2.C0(unicode, new char[]{'.'});
                                    if (t11.l(du.v0(listC0), "")) {
                                        int size3 = listC0.size() - 1;
                                        if (size3 < 0) {
                                            size3 = 0;
                                        }
                                        du.B0(size3, listC0);
                                    ...
                                    kj1 kj1Var = k42Var.a;
                                    AtomicBoolean atomicBoolean = (AtomicBoolean) kj1Var.i;
                                    if (atomicBoolean.get() || !atomicBoolean.compareAndSet(false, true)) {
                                        try {
                                            ((CountDownLatch) kj1Var.j).await();
                                    ...
                                    illegalStateException.initCause((IOException) kj1Var.k);
                                    throw illegalStateException;
                                }
                                i = 0;
                                if (strSubstring3 == null || !wv2.d0(strSubstring3, "/", false)) {
                                    String strB2 = yw0Var2.b();
                                    int iU0 = pv2.u0(strB2, '/', 0, 6);
                                    strSubstring3 = iU0 != 0 ? strB2.substring(0, iU0) : "/";
                                }
