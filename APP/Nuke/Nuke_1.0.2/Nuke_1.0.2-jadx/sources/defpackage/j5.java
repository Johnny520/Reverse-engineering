...
public final class j5 {
    public static final j5 c = new j5(new float[]{0.8951f, -0.7502f, 0.0389f, 0.2664f, 1.7135f, -0.0685f, -0.1614f, 0.0367f, 1.0296f});
    public final /* synthetic */ int a = 1;
    public float[] b;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public j5(float[] fArr) {
        this.b = fArr;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:173:0x01ef */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:184:0x0329 */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r17v4, resolved type: boolean */
    /* JADX DEBUG: Multi-variable search result rejected for r17v5, resolved type: boolean */
    /* JADX DEBUG: Multi-variable search result rejected for r17v6, resolved type: boolean */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r18v4, resolved type: boolean */
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 9201. Try increasing type updates limit count.
    	...
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.runListeners(TypeUpdate.java:241)
     */
    public static ArrayList a(j5 j5Var, String str) {
        int i;
        char cCharAt;
        char c2;
        ...
        char c3 = 0;
        int i2 = 0;
        while (i2 < length && t11.o(str.charAt(i2), 32) <= 0) {
            i2++;
        }
        while (length > i2 && t11.o(str.charAt(length - 1), 32) <= 0) {
            length--;
        }
        int i3 = 0;
        while (i2 < length) {
            ...
            if (cCharAt != 0) {
                int i5 = cCharAt | ' ';
                if (i5 != 122) {
                    while (i < length && t11.o(str.charAt(i), 32) <= 0) {
                        i++;
                    }
                    char c4 = i5 == 97 ? (char) 1 : c3;
                    int i6 = c3;
                    do {
                        long jD = (c4 == 0 || 3 > i6 || i6 >= 5) ? t11.D(str, i, length) : t11.D(str, i, Math.min(i + 1, length));
                        i = (int) (jD >>> 32);
                        ...
                        if (!Float.isNaN(fIntBitsToFloat)) {
                            ...
                            if (i7 >= fArr.length) {
                                ...
                                j5Var.b = fArr2;
                                System.arraycopy(fArr, c3, fArr2, c3, fArr.length);
                            }
                            i6 = i7;
                        }
                        while (i < length && (t11.o(str.charAt(i), 32) <= 0 || str.charAt(i) == ',')) {
                            i++;
                        }
                        if (i < length) {
                        }
                ...
                switch (cCharAt) {
                    case 'A':
                        c2 = c3;
                        int i9 = i3 - 7;
                        for (int i10 = c2; i10 <= i9; i10 += 7) {
                            arrayList.add(new xx1(fArr3[i10], fArr3[i10 + 1], fArr3[i10 + 2], Float.compare(fArr3[i10 + 3], 0.0f) != 0 ? 1 : c2, Float.compare(fArr3[i10 + 4], 0.0f) != 0 ? 1 : c2, fArr3[i10 + 5], fArr3[i10 + 6]));
                        }
                        i2 = i;
                        c3 = c2;
                        break;
                    ...
                    case 'M':
                        ...
                        int i17 = i3 - 2;
                        if (i17 >= 0) {
                            arrayList.add(new cy1(fArr3[c2], fArr3[1]));
                            while (i8 <= i17) {
                    ...
                    case 'a':
                        ...
                        while (i27 <= i26) {
                            char c5 = c3;
                            arrayList.add(new gy1(fArr3[i27], fArr3[i27 + 1], fArr3[i27 + 2], Float.compare(fArr3[i27 + 3], 0.0f) != 0 ? 1 : c5, Float.compare(fArr3[i27 + 4], 0.0f) != 0 ? 1 : c5, fArr3[i27 + 5], fArr3[i27 + 6]));
                            i27 += 7;
                            c3 = c5;
                        }
                        c2 = c3;
                    ...
                    case 'm':
                        int i34 = i3 - 2;
                        if (i34 >= 0) {
                            arrayList.add(new ky1(fArr3[c3], fArr3[1]));
                            while (i8 <= i34) {
