...
final class OpenAIChatModel$OpenAIMessage {
    ...
    public boolean equals(Object obj) {
        ...
        return t11.l(this.role, openAIChatModel$OpenAIMessage.role) && t11.l(this.content, openAIChatModel$OpenAIMessage.content);
    }
    ...
    public String toString() {
        return vi0.k("OpenAIMessage(role=", this.role, ", content=", this.content, ")");
    }
}
