...
public class ci {
    ...
    private static volatile com.tendcloud.tenddata.ci c;
    ...
    static {
            com.tendcloud.tenddata.ci r0 = new com.tendcloud.tenddata.ci
            r0.<init>()
            com.tendcloud.tenddata.ci.c = r0
            return
    }
    ...
    private ci() {
            ...
            r0.<init>(r1)
            r2.a = r0
            com.tendcloud.tenddata.ci$1 r0 = new com.tendcloud.tenddata.ci$1
            r0.<init>(r2)
            r2.d = r0
            return
    }

    private static java.lang.String a(java.lang.String r8, android.content.Context r9, com.tendcloud.tenddata.ci.a r10) {
            java.lang.String r0 = r9.getPackageName()
            java.lang.String r1 = com.tendcloud.tenddata.ci.b
            if (r1 != 0) goto L53
            r1 = 0
        ...
        L51:
            com.tendcloud.tenddata.ci.b = r1
        L53:
            java.lang.String r9 = com.tendcloud.tenddata.ci.b
            java.lang.String r8 = r10.getSerID(r0, r9, r8)
            return r8
    }

    public static /* synthetic */ java.util.concurrent.LinkedBlockingQueue a(com.tendcloud.tenddata.ci r0) {
    ...
    public static boolean a(android.content.Context r2) {
            r0 = 0
            boolean r1 = com.tendcloud.tenddata.bx.e()     // Catch: java.lang.Throwable -> L1c
            if (r1 != 0) goto L8
            return r0
        L8:
    ...
    private void b(android.content.Context r5) {
            ...
            com.tendcloud.tenddata.ci$a r1 = new com.tendcloud.tenddata.ci$a     // Catch: java.lang.Throwable -> L58
    ...
    public static void bindONEPLUSServiceGetOAID(android.content.Context r1) {
            com.tendcloud.tenddata.ci r0 = com.tendcloud.tenddata.ci.c
            r0.b(r1)
            return
    }
}
