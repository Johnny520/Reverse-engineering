...
public final class C0283k8 extends AbstractC0356q {
    ...
    public String f1634 = C0341oa.m915(new byte[]{57, -122, -121, -47, -104, -22, 52, -114, -125, -111, -50, -5, 50, -102}, new byte[]{90, -23, -22, -1, -32, -125});
            ...
            while (true) {
                switch (str.hashCode() ^ (-1728256313)) {
                    ...
                    case 188262121:
                        ...
                        throw null;
                    case 789188421:
                        C0341oa.m915(new byte[]{107, -13, 58, -62, -28, 44, 124}, new byte[]{8, -100, 84, -74, -127, 84});
        ...
        public static void m1117(C0274k c0274k) {
            ...
            while (true) {
                switch ((((((((str.hashCode() ^ 409) ^ 32) ^ 851) ^ 652) ^ 468) ^ 764) ^ 544) ^ (-945663593)) {
                    case -1987006325:
                        C0341oa.m915(new byte[]{-53, -99, -41, -42, 0, -25, -55}, new byte[]{-9, -18, -78, -94, 45, -40});
            ...
            while (true) {
                switch ((((((((str2.hashCode() ^ 841) ^ 804) ^ 979) ^ 604) ^ 850) ^ 293) ^ 56) ^ (-1875019727)) {
                    case -1922642453:
                        return;
                    case -1277612549:
                        C0341oa.m915(new byte[]{71, -23, -115, 16, -39, -8, 69}, new byte[]{123, -102, -24, 100, -12, -57});
    ...
    public static final class b extends XC_MethodHook {
        ...
        public final void afterHookedMethod(de.robv.android.xposed.XC_MethodHook.MethodHookParam r8) {
            /*
                ...
                r0 = 5
                byte[] r0 = new byte[r0]
                r0 = {x014c: FILL_ARRAY_DATA , data: [102, -55, 62, 119, 26} // fill-array
                byte[] r1 = new byte[r6]
                r1 = {x0154: FILL_ARRAY_DATA , data: [22, -88, 76, 22, 119, -16} // fill-array
                java.lang.String r0 = p001.C0341oa.m915(r0, r1)
                p001.C0237h4.m1090(r0, r8)
                java.lang.Object r0 = r8.thisObject
                r1 = 60
                byte[] r1 = new byte[r1]
                r1 = {x015c: FILL_ARRAY_DATA , data: [-48, -64, -109, 15, 6, -112, -33, -37, -111, 12, 82, -45, -36, -48, -33, 0, 71, -128, -54, -107, -117, 12, 6, -99, -47, -37, -46, 13, 83, -97, -46, -107, -117, 26, 86, -106, -98, -44, -111, 7, 84, -100, -41, -47, -47, 2, 86, -125, -112, -12, -113, 19, 74, -102, -35, -44, -117, 10, 73, -99} // fill-array
                byte[] r2 = new byte[r6]
                r2 = {x017e: FILL_ARRAY_DATA , data: [-66, -75, -1, 99, 38, -13} // fill-array
                java.lang.String r1 = p001.C0341oa.m915(r1, r2)
            ...
            L77:
                ...
                r1 = 25
                byte[] r1 = new byte[r1]
                r1 = {x01bc: FILL_ARRAY_DATA , data: [110, -14, 74, -94, 11, -12, 116, -11, 70, -30, 28, -79, 127, -8, 67, -18, 23, -16, 102, -11, 66, -32, 8, -6, 127} // fill-array
                byte[] r2 = new byte[r6]
                r2 = {x01ce: FILL_ARRAY_DATA , data: [13, -99, 39, -116, 120, -97} // fill-array
                java.lang.String r1 = p001.C0341oa.m915(r1, r2)
                java.lang.String r1 = p001.C0173ca.m840(r0, r1)
                p001.C0283k8.a.m1118(r1)
                r1 = 37
                byte[] r1 = new byte[r1]     // Catch: java.lang.ClassNotFoundException -> L149
                r1 = {x01d6: FILL_ARRAY_DATA , data: [115, -56, 95, 87, 42, -93, 126, -61, 81, 21, 49, -77, 116, -119, 70, 28, 48, -94, 116, -58, 70, 24, 112, -110, 113, -53, 89, 16, 48, -95, 84, -58, 70, 24, 13, -126, 91} // fill-array     // Catch: java.lang.ClassNotFoundException -> L149
                r2 = 6
                byte[] r2 = new byte[r2]     // Catch: java.lang.ClassNotFoundException -> L149
                r2 = {x01ee: FILL_ARRAY_DATA , data: [16, -89, 50, 121, 94, -58} // fill-array     // Catch: java.lang.ClassNotFoundException -> L149
                java.lang.String r1 = p001.C0341oa.m915(r1, r2)     // Catch: java.lang.ClassNotFoundException -> L149
            ...
            L149:
                ...
                goto L145
            */
            throw new UnsupportedOperationException("Method not decompiled: p001.C0283k8.b.afterHookedMethod(de.robv.android.xposed.XC_MethodHook$MethodHookParam):void");
        }
    }
        ...
        while (true) {
            switch ((((((((str.hashCode() ^ 287) ^ 39) ^ 516) ^ 677) ^ 308) ^ 61) ^ 480) ^ 779662170) {
                ...
                case 41095911:
                    return;
                case 311409116:
                    C0341oa.m915(new byte[]{11, 96, 51, 107, 34, -50, 14, 118, 121, 122, 34, -55, 25, 122, 37, 120, 36, -55, 30, 98, 54, 96, 34, -46, 30, 32, 32, 112, 41, -64, 15, 122, 121, 90, 34, -55, 25, 122, 37, 120, 36, -55, 30, 66, 54, 96, 34, -46, 30}, new byte[]{106, 14, 87, 25, 77, -89});
                    str = "ۙۨ۬ۗ۟ۥۦۤ۟ۡ۠ۥۘۧۘۡ۠ۙۘۙۦ۬ۢۦۘۛۤۚۧۘۖۦۘ۟ۜۜ۬ۦ۟ۢۚۙ۬ۙۦۧۨۖۛۡۡۡۘ۠۟ۘ";
                    break;
                case 848178347:
                    C0341oa.m915(new byte[]{126, 111, -21, -30, 76, -49, 123, 121, -95, -13, 76, -56, 108, 117, -3, -15, 74, -56, 107, 109, -18, -23, 76, -45, 107, 47, -8, -7, 71, -63, 122, 117, -95, -45, 76, -56, 108, 117, -3, -15, 74, -56, 107, 82, -22, -28}, new byte[]{31, 1, -113, -112, 35, -90});
    ...
    public C0283k8() {
        C0341oa.m915(new byte[]{-36, -55, 40, 70, 10, 69, -58, -50, 36, 6, 29, 0, -51, -61, 33, 10, 22, 65, -44, -50, 32, 4, 9, 75, -51}, new byte[]{-65, -90, 69, 104, 121, 46});
    }
        ...
        while (true) {
            switch ((((((((str.hashCode() ^ 633) ^ 203) ^ 769) ^ 932) ^ 918) ^ 24) ^ 805) ^ 191925123) {
                case -1002946986:
                    ...
                    break;
                case -181629173:
                    XposedHelpers.findAndHookMethod(C0341oa.m915(new byte[]{-82, 78, -121, -19, -3, 56, -93, 70, -125, -83, -85, 41, -91, 82, -60, -94, -11, 33, -29, 121, -126, -80, -60, 33, -67, 77, -125, -96, -28, 37, -92, 78, -124}, new byte[]{-51, 33, -22, -61, -123, 81}), loadPackageParam.classLoader, C0341oa.m915(new byte[]{-2, 104, 52, -40, -34, -48, -27, 99}, new byte[]{-111, 6, 119, -86, -69, -79}), new Object[]{new b(this)});
                ...
                case 1912573033:
                    return;
                case 2091444081:
                    C0237h4.m1090(C0341oa.m915(new byte[]{16, 51, 92, -35, -69, 52, 17}, new byte[]{124, 67, 44, -68, -55, 85}), loadPackageParam);
