...
public final class C0242h9 extends AbstractC0335o4 implements InterfaceC0222g3<C0368qb, Boolean> {
    ...
    public final Boolean mo984(C0368qb c0368qb) {
        ...
        List<C0439w4> list3;
        List<C0439w4> list4;
        C0237h4.m1090(C0341oa.m915(new byte[]{-9, -92, -113, -64, 42, 121, -9, -94, -126, -54, 60, 52, -91, -75, -107}, new byte[]{-45, -48, -25, -87, 89, 93}), c0368qb);
        ...
        if (z2) {
            ...
            if (strM915 == null) {
                strM915 = C0341oa.m915(new byte[]{74, 16, -10}, new byte[]{39, 96, -62, 78, -72, -28});
            }
        } else if (c0426v44 == null || (list2 = c0426v44.f1148) == null || (c0439w42 = list2.get(0)) == null || (strM915 = c0439w42.f1169) == null) {
            strM915 = C0341oa.m915(new byte[]{-59, -72, -25}, new byte[]{-88, -56, -45, 86, 44, 80});
        }
