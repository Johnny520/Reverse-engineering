...
public final class C0479z5 extends AbstractC0335o4 implements InterfaceC0222g3<String, C0433vb> {
    ...
    public final C0433vb mo984(String str) {
        String str2 = str;
        C0237h4.m1090(C0341oa.m915(new byte[]{-52, -70, -3, -26, 27, -35, -52, -73}, new byte[]{-72, -33, -114, -110, 75, -68}), str2);
        if (new File(str2).canWrite()) {
            AlertDialogC0414u5.m947(this.f1227, str2);
        } else {
            int i = C0330o.f1000;
            C0330o.m1173(0, C0341oa.m915(new byte[]{78, -39, -52, -35, 17, -91, 77, -21, -49, -34, 58, -107, 78, -39, -7, -46, 53, -122}, new byte[]{-85, 125, 72, 58, -127, 35}));
        }
