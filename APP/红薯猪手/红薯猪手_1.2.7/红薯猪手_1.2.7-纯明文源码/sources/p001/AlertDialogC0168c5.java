...
public final class AlertDialogC0168c5 extends AbstractAlertDialogC0230gb {
    ...
    public final class a {
        ...
        public final void showLocation(String str, String str2) {
            C0237h4.m1090("lat", str);
            C0237h4.m1090("lng", str2);
            long jCurrentTimeMillis = System.currentTimeMillis();
            if (jCurrentTimeMillis - this.f736 < 500) {
                return;
            }
            this.f736 = jCurrentTimeMillis;
            if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2) || C0237h4.m864(str, "0.0") || C0237h4.m864(str2, "0.0")) {
                return;
            }
            try {
    ...
    public static final class b extends AbstractC0335o4 implements InterfaceC0208f3<Boolean> {
        ...
        */
        public final Boolean mo7() {
            ...
            if (string.length() > 0) {
                string = C0406ta.m1247(string, "，", ",");
                List listM1259 = C0432va.m1259(string, new String[]{","});
                if (listM1259.size() != 2) {
                    int i = C0330o.f1000;
                    strM915 = "输入的位置不正确";
                } else {
    ...
    public final List<View> mo1003() {
        ...
        editText.setHint("输入经纬度，如: 113.3,23.14");
        this.f1405 = editText;
