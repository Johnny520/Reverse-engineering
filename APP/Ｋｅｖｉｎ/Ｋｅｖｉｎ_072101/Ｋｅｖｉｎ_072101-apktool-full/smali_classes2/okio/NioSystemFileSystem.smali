...
.method protected final metadataOrNull(Ljava/nio/file/Path;)Lokio/FileMetadata;
    ...
    .line 40
    invoke-static {v2, v0, v4}, Ljava/nio/file/Files;->readAttributes(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    .line 57
    .local v4, "symlinkTarget":Ljava/nio/file/Path;
    new-instance v16, Lokio/FileMetadata;
    ...
    invoke-static {v5, v4, v8, v9, v3}, Lokio/Path$Companion;->get$default(Lokio/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokio/Path;
    ...
    invoke-direct/range {v5 .. v15}, Lokio/FileMetadata;-><init>(ZZLokio/Path;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-object v16

    .line 47
    .end local v0    # "attributes":Ljava/nio/file/attribute/BasicFileAttributes;
    .end local v4    # "symlinkTarget":Ljava/nio/file/Path;
    :catch_0
    move-exception v0
