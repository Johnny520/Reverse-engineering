...
public final class DexKitBridge$batchFindClassUsingStrings$$inlined$sortBy$1<T> implements java.util.Comparator<T> {
    public DexKitBridge$batchFindClassUsingStrings$$inlined$sortBy$1() {
            r0 = this;
            r0.<init>()
            return
    }
