...
@kotlin.Metadata(m114d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\f\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000 \u00142\u00020\u0001:\u0001\u0014B\u0007\b\u0016¢\u0006\u0002\u0010\u0002B\u0019\b\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0010\u0010\u0011\u001a\u00020\u00042\u0006\u0010\u0012\u001a\u00020\u0013H\u0014R$\u0010\u0005\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR$\u0010\u0003\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u0004@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010¨\u0006\u0015"}, m115d2 = {"Lorg/luckypray/dexkit/query/matchers/base/AccessFlagsMatcher;", "Lorg/luckypray/dexkit/query/base/BaseQuery;", "()V", "modifiers", "", "matchType", "Lorg/luckypray/dexkit/query/enums/MatchType;", "(ILorg/luckypray/dexkit/query/enums/MatchType;)V", "<set-?>", "getMatchType", "()Lorg/luckypray/dexkit/query/enums/MatchType;", "setMatchType", "(Lorg/luckypray/dexkit/query/enums/MatchType;)V", "getModifiers", "()I", "setModifiers", "(I)V", "innerBuild", "fbb", "Lcom/google/flatbuffers/FlatBufferBuilder;", "Companion", "dexkit-android_release"}, m116k = 1, m117mv = {1, 5, 1}, m119xi = 48)
public final class AccessFlagsMatcher extends org.luckypray.dexkit.query.base.BaseQuery {
    ...
    /* JADX INFO: compiled from: AccessFlagsMatcher.kt */
    @kotlin.Metadata(m114d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\b\u0002\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m115d2 = {"Lorg/luckypray/dexkit/query/matchers/base/AccessFlagsMatcher$Companion;", "", "()V", "create", "Lorg/luckypray/dexkit/query/matchers/base/AccessFlagsMatcher;", "modifiers", "", "matchType", "Lorg/luckypray/dexkit/query/enums/MatchType;", "dexkit-android_release"}, m116k = 1, m117mv = {1, 5, 1}, m119xi = 48)
    public static final class Companion {
        ...
        public final org.luckypray.dexkit.query.matchers.base.AccessFlagsMatcher create(int r3) {
                ...
                r0 = 0
                r1 = 2
                org.luckypray.dexkit.query.matchers.base.AccessFlagsMatcher r0 = create$default(r2, r3, r0, r1, r0)
                return r0
        }

        public final org.luckypray.dexkit.query.matchers.base.AccessFlagsMatcher create(int r2, org.luckypray.dexkit.query.enums.MatchType r3) {
                r1 = this;
    ...
    public /* synthetic */ AccessFlagsMatcher(int r1, org.luckypray.dexkit.query.enums.MatchType r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto L6
            org.luckypray.dexkit.query.enums.MatchType r2 = org.luckypray.dexkit.query.enums.MatchType.Contains
    ...
    protected int innerBuild(com.google.flatbuffers.FlatBufferBuilder r4) {
            ...
            int r0 = r3.modifiers
            if (r0 == 0) goto L20
            org.luckypray.dexkit.schema.-AccessFlagsMatcher$Companion r0 = org.luckypray.dexkit.schema.AccessFlagsMatcher.Companion
            int r1 = r3.modifiers
            int r1 = kotlin.UInt.m8764constructorimpl(r1)
            org.luckypray.dexkit.query.enums.MatchType r2 = r3.matchType
            byte r2 = r2.getValue()
            int r0 = r0.m10396createAccessFlagsMatcherOsBMiQA(r4, r1, r2)
            r4.finish(r0)
            return r0
        L20:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
            java.lang.String r1 = "modifiers must not be 0"
            r0.<init>(r1)
            throw r0
    }
