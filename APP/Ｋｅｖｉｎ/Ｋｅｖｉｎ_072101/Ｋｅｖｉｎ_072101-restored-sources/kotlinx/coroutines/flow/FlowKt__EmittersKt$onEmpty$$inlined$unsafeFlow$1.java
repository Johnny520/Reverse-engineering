...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1<T> implements kotlinx.coroutines.flow.Flow<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(m124c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1", m125f = "Emitters.kt", m126i = {0, 0, 0, 1}, m127l = {114, 122}, m128m = "collect", m129n = {"this", "$this$onEmpty_u24lambda_u2d3", "isEmpty", "collector"}, m130s = {"L$0", "L$1", "L$2", "L$0"})
    public static final class C09201 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        ...
        public C09201(kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 r1, kotlin.coroutines.Continuation r2) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>(r2)
                return
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
            r9 = this;
            boolean r0 = r11 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C09201
            if (r0 == 0) goto L14
            r0 = r11
            kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C09201) r0
            int r1 = r0.label
