...
final class SubscribedSharedFlow<T> implements kotlinx.coroutines.flow.SharedFlow<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(m124c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m125f = "Share.kt", m126i = {}, m127l = {409}, m128m = "collect", m129n = {}, m130s = {})
    static final class C09981 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        int label;
        /* synthetic */ java.lang.Object result;
        final /* synthetic */ kotlinx.coroutines.flow.SubscribedSharedFlow<T> this$0;

        C09981(kotlinx.coroutines.flow.SubscribedSharedFlow<T> r1, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.SubscribedSharedFlow.C09981> r2) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>(r2)
                return
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlin.coroutines.Continuation<?> r8) {
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.flow.SubscribedSharedFlow.C09981
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.flow.SubscribedSharedFlow$collect$1 r0 = (kotlinx.coroutines.flow.SubscribedSharedFlow.C09981) r0
            int r1 = r0.label
