...
final /* synthetic */ class FlowKt__ShareKt {
    ...
    private static final <T> kotlinx.coroutines.Job launchSharing$FlowKt__ShareKt(kotlinx.coroutines.CoroutineScope r8, kotlin.coroutines.CoroutineContext r9, kotlinx.coroutines.flow.Flow<? extends T> r10, kotlinx.coroutines.flow.MutableSharedFlow<T> r11, kotlinx.coroutines.flow.SharingStarted r12, T r13) {
        ...
        L11:
            ...
            kotlinx.coroutines.Job r1 = kotlinx.coroutines.BuildersKt.launch(r8, r9, r0, r7)
            return r1
    }
    ...
    public static final <T> kotlinx.coroutines.flow.SharedFlow<T> shareIn(kotlinx.coroutines.flow.Flow<? extends T> r9, kotlinx.coroutines.CoroutineScope r10, kotlinx.coroutines.flow.SharingStarted r11, int r12) {
            ...
            kotlinx.coroutines.flow.MutableSharedFlow r1 = kotlinx.coroutines.flow.SharedFlowKt.MutableSharedFlow(r12, r1, r2)
            ...
            r6 = r1
            r7 = r11
            kotlinx.coroutines.Job r2 = launchSharing$FlowKt__ShareKt(r3, r4, r5, r6, r7, r8)
            kotlinx.coroutines.flow.ReadonlySharedFlow r3 = new kotlinx.coroutines.flow.ReadonlySharedFlow
            r4 = r1
            kotlinx.coroutines.flow.SharedFlow r4 = (kotlinx.coroutines.flow.SharedFlow) r4
            r3.<init>(r4, r2)
            kotlinx.coroutines.flow.SharedFlow r3 = (kotlinx.coroutines.flow.SharedFlow) r3
            return r3
    }
    ...
    public static final <T> kotlinx.coroutines.flow.StateFlow<T> stateIn(kotlinx.coroutines.flow.Flow<? extends T> r8, kotlinx.coroutines.CoroutineScope r9, kotlinx.coroutines.flow.SharingStarted r10, T r11) {
            ...
            r6 = r10
            r7 = r11
            kotlinx.coroutines.Job r2 = launchSharing$FlowKt__ShareKt(r2, r3, r4, r5, r6, r7)
