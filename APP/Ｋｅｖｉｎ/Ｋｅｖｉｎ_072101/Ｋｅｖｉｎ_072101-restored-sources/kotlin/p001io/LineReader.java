...
@kotlin.Metadata(m114d1 = {"\u0000\\\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0014\u001a\u00020\u0004H\u0002J\u0010\u0010\u0015\u001a\u00020\u00042\u0006\u0010\u0016\u001a\u00020\u0010H\u0002J\u0018\u0010\u0017\u001a\u00020\u00042\u0006\u0010\u0018\u001a\u00020\u00042\u0006\u0010\u0019\u001a\u00020\u0004H\u0002J\u0018\u0010\u001a\u001a\u0004\u0018\u00010\u001b2\u0006\u0010\u001c\u001a\u00020\u001d2\u0006\u0010\u001e\u001a\u00020\u001fJ\b\u0010 \u001a\u00020!H\u0002J\b\u0010\"\u001a\u00020!H\u0002J\u0010\u0010#\u001a\u00020!2\u0006\u0010\u001e\u001a\u00020\u001fH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0011\u001a\u00060\u0012j\u0002`\u0013X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006$"}, m115d2 = {"Lkotlin/io/LineReader;", "", "()V", "BUFFER_SIZE", "", "byteBuf", "Ljava/nio/ByteBuffer;", "bytes", "", "charBuf", "Ljava/nio/CharBuffer;", "chars", "", "decoder", "Ljava/nio/charset/CharsetDecoder;", "directEOL", "", "sb", "Ljava/lang/StringBuilder;", "Lkotlin/text/StringBuilder;", "compactBytes", "decode", "endOfInput", "decodeEndOfInput", "nBytes", "nChars", "readLine", "", "inputStream", "Ljava/io/InputStream;", "charset", "Ljava/nio/charset/Charset;", "resetAll", "", "trimStringBuilder", "updateCharset", "kotlin-stdlib"}, m116k = 1, m117mv = {1, 9, 0}, m119xi = 48)
public final class LineReader {
    private static final int BUFFER_SIZE = 32;
    public static final kotlin.p001io.LineReader INSTANCE = null;
    ...
    private static final java.lang.StringBuilder f62sb = null;

    static {
            kotlin.io.LineReader r0 = new kotlin.io.LineReader
            r0.<init>()
            kotlin.p001io.LineReader.INSTANCE = r0
            r0 = 32
            byte[] r1 = new byte[r0]
            kotlin.p001io.LineReader.bytes = r1
            char[] r0 = new char[r0]
            kotlin.p001io.LineReader.chars = r0
            byte[] r0 = kotlin.p001io.LineReader.bytes
            java.nio.ByteBuffer r0 = java.nio.ByteBuffer.wrap(r0)
            java.lang.String r1 = "wrap(bytes)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
            kotlin.p001io.LineReader.byteBuf = r0
            char[] r0 = kotlin.p001io.LineReader.chars
            java.nio.CharBuffer r0 = java.nio.CharBuffer.wrap(r0)
            java.lang.String r1 = "wrap(chars)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
            kotlin.p001io.LineReader.charBuf = r0
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
            kotlin.p001io.LineReader.f62sb = r0
            return
    }
    ...
    private final int compactBytes() {
            r6 = this;
            java.nio.ByteBuffer r0 = kotlin.p001io.LineReader.byteBuf
            r1 = 0
            r0.compact()
            int r2 = r0.position()
            r3 = r2
    ...
    private final int decode(boolean r7) {
            r6 = this;
        L1:
            java.nio.charset.CharsetDecoder r0 = kotlin.p001io.LineReader.decoder
            if (r0 != 0) goto Lc
            java.lang.String r0 = "decoder"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r0)
            r0 = 0
        Lc:
            java.nio.ByteBuffer r1 = kotlin.p001io.LineReader.byteBuf
            java.nio.CharBuffer r2 = kotlin.p001io.LineReader.charBuf
            ...
            r0.throwException()
        L25:
            java.nio.CharBuffer r1 = kotlin.p001io.LineReader.charBuf
            int r1 = r1.position()
            boolean r2 = r0.isOverflow()
            if (r2 != 0) goto L32
            return r1
        L32:
            java.lang.StringBuilder r2 = kotlin.p001io.LineReader.f62sb
            char[] r3 = kotlin.p001io.LineReader.chars
            int r4 = r1 + (-1)
            r5 = 0
            r2.append(r3, r5, r4)
            java.nio.CharBuffer r2 = kotlin.p001io.LineReader.charBuf
    ...
    private final int decodeEndOfInput(int r6, int r7) {
            ...
            java.nio.ByteBuffer r0 = kotlin.p001io.LineReader.byteBuf
            r0.limit(r6)
            java.nio.CharBuffer r0 = kotlin.p001io.LineReader.charBuf
            r0.position(r7)
            r0 = 1
            int r0 = r5.decode(r0)
            r1 = r0
            r2 = 0
            java.nio.charset.CharsetDecoder r3 = kotlin.p001io.LineReader.decoder
            if (r3 != 0) goto L1b
        ...
        L1b:
            r3.reset()
            java.nio.ByteBuffer r3 = kotlin.p001io.LineReader.byteBuf
            r4 = 0
            r3.position(r4)
            return r0
    }
    ...
    private final void resetAll() {
        ...
        La:
            ...
            r1 = 0
            r0.position(r1)
            java.lang.StringBuilder r0 = kotlin.p001io.LineReader.f62sb
            r0.setLength(r1)
            return
    }
    ...
    private final void updateCharset(java.nio.charset.Charset r6) {
            ...
            java.lang.String r1 = "charset.newDecoder()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
            kotlin.p001io.LineReader.decoder = r0
            java.nio.ByteBuffer r0 = kotlin.p001io.LineReader.byteBuf
            r0.clear()
            java.nio.CharBuffer r0 = kotlin.p001io.LineReader.charBuf
            r0.clear()
            ...
            r0 = 0
        L2b:
            java.nio.ByteBuffer r2 = kotlin.p001io.LineReader.byteBuf
            java.nio.CharBuffer r3 = kotlin.p001io.LineReader.charBuf
            r4 = 0
            r0.decode(r2, r3, r4)
            java.nio.CharBuffer r0 = kotlin.p001io.LineReader.charBuf
            int r0 = r0.position()
            ...
            r4 = r2
        L45:
            kotlin.p001io.LineReader.directEOL = r4
            r5.resetAll()
            return
    }
    ...
    public final synchronized java.lang.String readLine(java.io.InputStream r12, java.nio.charset.Charset r13) {
            ...
            java.nio.charset.CharsetDecoder r0 = kotlin.p001io.LineReader.decoder     // Catch: java.lang.Throwable -> Lde
            r1 = 0
            if (r0 == 0) goto L24
            java.nio.charset.CharsetDecoder r0 = kotlin.p001io.LineReader.decoder     // Catch: java.lang.Throwable -> Lde
            if (r0 != 0) goto L1a
        ...
        L29:
            ...
            r8 = 0
            if (r3 != r6) goto L51
            java.lang.StringBuilder r6 = kotlin.p001io.LineReader.f62sb     // Catch: java.lang.Throwable -> Lde
        ...
        L4c:
            ...
            goto L83
        L51:
            byte[] r6 = kotlin.p001io.LineReader.bytes     // Catch: java.lang.Throwable -> Lde
            int r9 = r0 + 1
            byte r10 = (byte) r3     // Catch: java.lang.Throwable -> Lde
            r6[r0] = r10     // Catch: java.lang.Throwable -> Lde
            if (r3 == r5) goto L63
            if (r9 == r4) goto L63
            boolean r0 = kotlin.p001io.LineReader.directEOL     // Catch: java.lang.Throwable -> Lde
            if (r0 != 0) goto L61
            goto L63
        L61:
            r0 = r9
            goto L29
        L63:
            java.nio.ByteBuffer r0 = kotlin.p001io.LineReader.byteBuf     // Catch: java.lang.Throwable -> Lde
            r0.limit(r9)     // Catch: java.lang.Throwable -> Lde
            java.nio.CharBuffer r0 = kotlin.p001io.LineReader.charBuf     // Catch: java.lang.Throwable -> Lde
            r0.position(r2)     // Catch: java.lang.Throwable -> Lde
            int r0 = r11.decode(r8)     // Catch: java.lang.Throwable -> Lde
            r2 = r0
            if (r2 <= 0) goto Ld8
            char[] r0 = kotlin.p001io.LineReader.chars     // Catch: java.lang.Throwable -> Lde
            int r6 = r2 + (-1)
        ...
        L83:
            if (r1 <= 0) goto L9d
            char[] r2 = kotlin.p001io.LineReader.chars     // Catch: java.lang.Throwable -> Lde
            int r3 = r1 + (-1)
            ...
            int r1 = r1 + (-1)
        L9d:
            java.lang.StringBuilder r2 = kotlin.p001io.LineReader.f62sb     // Catch: java.lang.Throwable -> Lde
        ...
        La9:
            ...
            char[] r3 = kotlin.p001io.LineReader.chars     // Catch: java.lang.Throwable -> Lde
        ...
        Lb4:
            ...
            java.lang.StringBuilder r3 = kotlin.p001io.LineReader.f62sb     // Catch: java.lang.Throwable -> Lde
