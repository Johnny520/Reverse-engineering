...
final class DirectoryEntriesReader extends java.nio.file.SimpleFileVisitor<java.nio.file.Path> {
    ...
    public final java.util.List<kotlin.p001io.path.PathNode> readEntries(kotlin.p001io.path.PathNode r5) {
            r4 = this;
            java.lang.String r0 = "directoryNode"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r5, r0)
            r4.directoryNode = r5
            java.nio.file.Path r0 = r5.getPath()
            kotlin.io.path.LinkFollowing r1 = kotlin.p001io.path.LinkFollowing.INSTANCE
