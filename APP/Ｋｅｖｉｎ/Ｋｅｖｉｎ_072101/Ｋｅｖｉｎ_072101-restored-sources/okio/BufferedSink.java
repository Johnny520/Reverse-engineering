...
public interface BufferedSink extends okio.Sink, java.nio.channels.WritableByteChannel {
    ...
    okio.BufferedSink write(okio.ByteString r1, int r2, int r3) throws java.io.IOException;
