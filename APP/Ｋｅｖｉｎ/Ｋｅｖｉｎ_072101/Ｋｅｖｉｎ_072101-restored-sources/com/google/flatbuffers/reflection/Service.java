...
public final class Service extends com.google.flatbuffers.Table {
    ...
    public static final class Vector extends com.google.flatbuffers.BaseVector {
        ...
        public com.google.flatbuffers.reflection.Service.Vector __assign(int r1, int r2, java.nio.ByteBuffer r3) {
                r0 = this;
                r0.__reset(r1, r2, r3)
                return r0
        }

        public com.google.flatbuffers.reflection.Service get(int r2) {
                r1 = this;
                com.google.flatbuffers.reflection.Service r0 = new com.google.flatbuffers.reflection.Service
                r0.<init>()
                com.google.flatbuffers.reflection.Service r0 = r1.get(r0, r2)
                return r0
        }

        public com.google.flatbuffers.reflection.Service get(com.google.flatbuffers.reflection.Service r3, int r4) {
                r2 = this;
                int r0 = r2.__element(r4)
                java.nio.ByteBuffer r1 = r2.f44bb
                int r0 = com.google.flatbuffers.reflection.Service.access$000(r0, r1)
                java.nio.ByteBuffer r1 = r2.f44bb
                com.google.flatbuffers.reflection.Service r0 = r3.__assign(r0, r1)
                return r0
        }

        public com.google.flatbuffers.reflection.Service getByKey(com.google.flatbuffers.reflection.Service r3, java.lang.String r4) {
                r2 = this;
                int r0 = r2.__vector()
                java.nio.ByteBuffer r1 = r2.f44bb
                com.google.flatbuffers.reflection.Service r0 = com.google.flatbuffers.reflection.Service.__lookup_by_key(r3, r0, r4, r1)
                return r0
        }

        public com.google.flatbuffers.reflection.Service getByKey(java.lang.String r4) {
                r3 = this;
                int r0 = r3.__vector()
                java.nio.ByteBuffer r1 = r3.f44bb
                r2 = 0
                com.google.flatbuffers.reflection.Service r0 = com.google.flatbuffers.reflection.Service.__lookup_by_key(r2, r0, r4, r1)
                return r0
        }
    }
    ...
    public static com.google.flatbuffers.reflection.Service __lookup_by_key(com.google.flatbuffers.reflection.Service r7, int r8, java.lang.String r9, java.nio.ByteBuffer r10) {
        ...
        L32:
            if (r7 != 0) goto L3a
            com.google.flatbuffers.reflection.Service r6 = new com.google.flatbuffers.reflection.Service
            r6.<init>()
            goto L3b
        L3a:
            r6 = r7
        L3b:
            com.google.flatbuffers.reflection.Service r6 = r6.__assign(r4, r10)
            return r6
        L40:
            r3 = 0
            return r3
    ...
    public static void addCalls(com.google.flatbuffers.FlatBufferBuilder r2, int r3) {
            r0 = 1
            r1 = 0
            r2.addOffset(r0, r3, r1)
            return
    ...
    public static int createCallsVector(com.google.flatbuffers.FlatBufferBuilder r2, int[] r3) {
            r0 = 4
            int r1 = r3.length
            r2.startVector(r0, r1, r0)
            int r0 = r3.length
    ...
    public static int createService(com.google.flatbuffers.FlatBufferBuilder r1, int r2, int r3, int r4, int r5, int r6) {
            r0 = 5
            r1.startTable(r0)
            addDeclarationFile(r1, r6)
            addDocumentation(r1, r5)
            addAttributes(r1, r4)
            addCalls(r1, r3)
            addName(r1, r2)
            int r0 = endService(r1)
            return r0
    }

    public static int endService(com.google.flatbuffers.FlatBufferBuilder r2) {
            int r0 = r2.endTable()
            r1 = 4
            r2.required(r0, r1)
            return r0
    ...
    public static com.google.flatbuffers.reflection.Service getRootAsService(java.nio.ByteBuffer r1) {
            com.google.flatbuffers.reflection.Service r0 = new com.google.flatbuffers.reflection.Service
            r0.<init>()
            com.google.flatbuffers.reflection.Service r0 = getRootAsService(r1, r0)
            return r0
    }

    public static com.google.flatbuffers.reflection.Service getRootAsService(java.nio.ByteBuffer r2, com.google.flatbuffers.reflection.Service r3) {
            ...
            int r1 = r2.position()
            int r0 = r0 + r1
            com.google.flatbuffers.reflection.Service r0 = r3.__assign(r0, r2)
            return r0
    }
    ...
    public static void startCallsVector(com.google.flatbuffers.FlatBufferBuilder r1, int r2) {
            r0 = 4
            r1.startVector(r0, r2, r0)
            return
    }
    ...
    public static void startService(com.google.flatbuffers.FlatBufferBuilder r1) {
            r0 = 5
            r1.startTable(r0)
            return
    }

    public com.google.flatbuffers.reflection.Service __assign(int r1, java.nio.ByteBuffer r2) {
            r0 = this;
            r0.__init(r1, r2)
            return r0
    }
    ...
    public com.google.flatbuffers.reflection.RPCCall calls(int r2) {
            r1 = this;
            com.google.flatbuffers.reflection.RPCCall r0 = new com.google.flatbuffers.reflection.RPCCall
            r0.<init>()
            com.google.flatbuffers.reflection.RPCCall r0 = r1.calls(r0, r2)
            return r0
    }

    public com.google.flatbuffers.reflection.RPCCall calls(com.google.flatbuffers.reflection.RPCCall r4, int r5) {
            r3 = this;
            r0 = 6
            int r0 = r3.__offset(r0)
            if (r0 == 0) goto L19
            ...
            int r1 = r3.__indirect(r1)
            java.nio.ByteBuffer r2 = r3.f50bb
            com.google.flatbuffers.reflection.RPCCall r1 = r4.__assign(r1, r2)
            goto L1a
        L19:
            r1 = 0
        L1a:
    ...
    public com.google.flatbuffers.reflection.RPCCall callsByKey(com.google.flatbuffers.reflection.RPCCall r4, java.lang.String r5) {
            r3 = this;
            r0 = 6
            int r0 = r3.__offset(r0)
            if (r0 == 0) goto L12
            int r1 = r3.__vector(r0)
            java.nio.ByteBuffer r2 = r3.f50bb
            com.google.flatbuffers.reflection.RPCCall r1 = com.google.flatbuffers.reflection.RPCCall.__lookup_by_key(r4, r1, r5, r2)
            goto L13
        L12:
            r1 = 0
        L13:
    ...
    public com.google.flatbuffers.reflection.RPCCall callsByKey(java.lang.String r5) {
            r4 = this;
            r0 = 6
            int r0 = r4.__offset(r0)
            r1 = 0
            ...
            int r2 = r4.__vector(r0)
            java.nio.ByteBuffer r3 = r4.f50bb
            com.google.flatbuffers.reflection.RPCCall r1 = com.google.flatbuffers.reflection.RPCCall.__lookup_by_key(r1, r2, r5, r3)
        L12:
            return r1
    }
    ...
    public com.google.flatbuffers.reflection.RPCCall.Vector callsVector() {
            r1 = this;
            com.google.flatbuffers.reflection.RPCCall$Vector r0 = new com.google.flatbuffers.reflection.RPCCall$Vector
            r0.<init>()
            com.google.flatbuffers.reflection.RPCCall$Vector r0 = r1.callsVector(r0)
            return r0
    }

    public com.google.flatbuffers.reflection.RPCCall.Vector callsVector(com.google.flatbuffers.reflection.RPCCall.Vector r5) {
            r4 = this;
            r0 = 6
            int r0 = r4.__offset(r0)
            if (r0 == 0) goto L13
            ...
            r2 = 4
            java.nio.ByteBuffer r3 = r4.f50bb
            com.google.flatbuffers.reflection.RPCCall$Vector r1 = r5.__assign(r1, r2, r3)
            goto L14
        L13:
            r1 = 0
        L14:
