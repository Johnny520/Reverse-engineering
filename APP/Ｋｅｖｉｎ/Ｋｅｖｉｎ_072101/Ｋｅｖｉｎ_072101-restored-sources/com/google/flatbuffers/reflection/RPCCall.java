...
public final class RPCCall extends com.google.flatbuffers.Table {
    ...
    public static final class Vector extends com.google.flatbuffers.BaseVector {
        ...
        public com.google.flatbuffers.reflection.RPCCall get(int r2) {
                ...
                r0.<init>()
                com.google.flatbuffers.reflection.RPCCall r0 = r1.get(r0, r2)
                return r0
        }

        public com.google.flatbuffers.reflection.RPCCall get(com.google.flatbuffers.reflection.RPCCall r3, int r4) {
                r2 = this;
                int r0 = r2.__element(r4)
                java.nio.ByteBuffer r1 = r2.f44bb
                int r0 = com.google.flatbuffers.reflection.RPCCall.access$000(r0, r1)
                java.nio.ByteBuffer r1 = r2.f44bb
                com.google.flatbuffers.reflection.RPCCall r0 = r3.__assign(r0, r1)
                return r0
        }
        ...
        public com.google.flatbuffers.reflection.RPCCall getByKey(com.google.flatbuffers.reflection.RPCCall r3, java.lang.String r4) {
                ...
                int r0 = r2.__vector()
                java.nio.ByteBuffer r1 = r2.f44bb
                com.google.flatbuffers.reflection.RPCCall r0 = com.google.flatbuffers.reflection.RPCCall.__lookup_by_key(r3, r0, r4, r1)
                return r0
        }
        ...
        public com.google.flatbuffers.reflection.RPCCall getByKey(java.lang.String r4) {
                ...
                r2 = 0
                com.google.flatbuffers.reflection.RPCCall r0 = com.google.flatbuffers.reflection.RPCCall.__lookup_by_key(r2, r0, r4, r1)
                return r0
        }
    }
    ...
    public static com.google.flatbuffers.reflection.RPCCall __lookup_by_key(com.google.flatbuffers.reflection.RPCCall r7, int r8, java.lang.String r9, java.nio.ByteBuffer r10) {
        ...
        L3a:
            r6 = r7
        L3b:
            com.google.flatbuffers.reflection.RPCCall r6 = r6.__assign(r4, r10)
            return r6
        L40:
            r3 = 0
            return r3
    ...
    public static com.google.flatbuffers.reflection.RPCCall getRootAsRPCCall(java.nio.ByteBuffer r1) {
            com.google.flatbuffers.reflection.RPCCall r0 = new com.google.flatbuffers.reflection.RPCCall
            r0.<init>()
            com.google.flatbuffers.reflection.RPCCall r0 = getRootAsRPCCall(r1, r0)
            return r0
    }
    ...
    public static com.google.flatbuffers.reflection.RPCCall getRootAsRPCCall(java.nio.ByteBuffer r2, com.google.flatbuffers.reflection.RPCCall r3) {
            ...
            int r1 = r2.position()
            int r0 = r0 + r1
            com.google.flatbuffers.reflection.RPCCall r0 = r3.__assign(r0, r2)
            return r0
    }
    ...
    public com.google.flatbuffers.reflection.Object request(com.google.flatbuffers.reflection.Object r4) {
            r3 = this;
            r0 = 6
            int r0 = r3.__offset(r0)
            if (r0 == 0) goto L15
    ...
    public com.google.flatbuffers.reflection.Object response(com.google.flatbuffers.reflection.Object r4) {
            r3 = this;
            r0 = 8
            int r0 = r3.__offset(r0)
            if (r0 == 0) goto L16
