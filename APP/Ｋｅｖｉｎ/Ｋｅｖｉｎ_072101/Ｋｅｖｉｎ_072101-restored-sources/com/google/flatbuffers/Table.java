...
public class Table {
    ...
    protected java.nio.ByteBuffer f50bb;
    ...
    protected static java.lang.String __string(int r2, java.nio.ByteBuffer r3, com.google.flatbuffers.Utf8 r4) {
            int r0 = r3.getInt(r2)
            int r2 = r2 + r0
            int r0 = r3.getInt(r2)
            int r1 = r2 + 4
    ...
    protected static com.google.flatbuffers.Table __union(com.google.flatbuffers.Table r1, int r2, java.nio.ByteBuffer r3) {
    ...
    protected int __indirect(int r2) {
            r1 = this;
            java.nio.ByteBuffer r0 = r1.f50bb
            int r0 = r0.getInt(r2)
            int r0 = r0 + r2
            return r0
    }
    ...
    protected int __offset(int r3) {
            ...
            if (r3 >= r0) goto Le
            java.nio.ByteBuffer r0 = r2.f50bb
    ...
    protected void __reset(int r4, java.nio.ByteBuffer r5) {
            r3 = this;
            r3.f50bb = r5
            java.nio.ByteBuffer r0 = r3.f50bb
            if (r0 == 0) goto L20
            r3.bb_pos = r4
            int r0 = r3.bb_pos
    ...
    protected com.google.flatbuffers.Table __union(com.google.flatbuffers.Table r2, int r3) {
            r1 = this;
            java.nio.ByteBuffer r0 = r1.f50bb
            com.google.flatbuffers.Table r0 = __union(r2, r3, r0)
            return r0
    }
    ...
    protected void sortTables(int[] r4, java.nio.ByteBuffer r5) {
        ...
        L4:
            ...
            goto L4
        L12:
            com.google.flatbuffers.Table$1 r1 = new com.google.flatbuffers.Table$1
            r1.<init>(r3, r5)
