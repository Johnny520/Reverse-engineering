...
@kotlin.Metadata(m114d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, m115d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, m116k = 1, m117mv = {1, 8, 0}, m119xi = 48)
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public static final /* synthetic */ okhttp3.CipherSuite access$init(okhttp3.CipherSuite.Companion r1, java.lang.String r2, int r3) {
                okhttp3.CipherSuite r0 = r1.init(r2, r3)
                return r0
        }

        private final okhttp3.CipherSuite init(java.lang.String r3, int r4) {
                r2 = this;
                okhttp3.CipherSuite r0 = new okhttp3.CipherSuite
                r1 = 0
                r0.<init>(r3, r1)
                java.util.Map r1 = okhttp3.CipherSuite.access$getINSTANCES$cp()
                r1.put(r3, r0)
                return r0
        }
        ...
        public final synchronized okhttp3.CipherSuite forJavaName(java.lang.String r4) {
                r3 = this;
                monitor-enter(r3)
                java.lang.String r0 = "javaName"
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r0)     // Catch: java.lang.Throwable -> L33
                java.util.Map r0 = okhttp3.CipherSuite.access$getINSTANCES$cp()     // Catch: java.lang.Throwable -> L33
                java.lang.Object r0 = r0.get(r4)     // Catch: java.lang.Throwable -> L33
                okhttp3.CipherSuite r0 = (okhttp3.CipherSuite) r0     // Catch: java.lang.Throwable -> L33
                if (r0 != 0) goto L31
                java.util.Map r1 = okhttp3.CipherSuite.access$getINSTANCES$cp()     // Catch: java.lang.Throwable -> L33
                java.lang.String r2 = r3.secondaryName(r4)     // Catch: java.lang.Throwable -> L33
                java.lang.Object r1 = r1.get(r2)     // Catch: java.lang.Throwable -> L33
                okhttp3.CipherSuite r1 = (okhttp3.CipherSuite) r1     // Catch: java.lang.Throwable -> L33
                r0 = r1
                if (r0 != 0) goto L2a
                okhttp3.CipherSuite r1 = new okhttp3.CipherSuite     // Catch: java.lang.Throwable -> L33
                r2 = 0
                r1.<init>(r4, r2)     // Catch: java.lang.Throwable -> L33
                r0 = r1
            L2a:
                java.util.Map r1 = okhttp3.CipherSuite.access$getINSTANCES$cp()     // Catch: java.lang.Throwable -> L33
                r1.put(r4, r0)     // Catch: java.lang.Throwable -> L33
            L31:
                monitor-exit(r3)
                return r0
            L33:
    ...
    static {
            ...
            okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1 r0 = new okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            r0.<init>()
    ...
    public static final synchronized okhttp3.CipherSuite forJavaName(java.lang.String r2) {
            ...
            okhttp3.CipherSuite r1 = r1.forJavaName(r2)     // Catch: java.lang.Throwable -> Lb
            monitor-exit(r0)
            return r1
        Lb:
            r2 = move-exception
    ...
    public final java.lang.String m10259deprecated_javaName() {
            r1 = this;
