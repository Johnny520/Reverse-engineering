...
public final class MetadataRepo {
    ...
    static class Node {
        ...
        final androidx.emoji2.text.EmojiMetadata getData() {
                r1 = this;
                androidx.emoji2.text.EmojiMetadata r0 = r1.mData
                return r0
        }

        void put(androidx.emoji2.text.EmojiMetadata r4, int r5, int r6) {
                r3 = this;
    ...
    private void constructIndex(androidx.emoji2.text.flatbuffer.MetadataList r7) {
        ...
        L5:
            if (r1 >= r0) goto L1d
            androidx.emoji2.text.EmojiMetadata r2 = new androidx.emoji2.text.EmojiMetadata
            r2.<init>(r6, r1)
            int r3 = r2.getId()
    ...
    void put(androidx.emoji2.text.EmojiMetadata r5) {
            r4 = this;
