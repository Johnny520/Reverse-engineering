...
public class FlexBuffers {
    ...
    public static class Blob extends androidx.emoji2.text.flatbuffer.FlexBuffers.Sized {
        ...
        public java.nio.ByteBuffer data() {
                r3 = this;
                androidx.emoji2.text.flatbuffer.ReadBuf r0 = r3.f34bb
                byte[] r0 = r0.data()
        ...
        public byte get(int r3) {
                r2 = this;
                androidx.emoji2.text.flatbuffer.ReadBuf r0 = r2.f34bb
                int r1 = r2.end
                int r1 = r1 + r3
                byte r0 = r0.get(r1)
                return r0
        ...
        public byte[] getBytes() {
            ...
            L7:
                if (r2 >= r0) goto L17
                androidx.emoji2.text.flatbuffer.ReadBuf r3 = r5.f34bb
                int r4 = r5.end
                int r4 = r4 + r2
                byte r3 = r3.get(r4)
                r1[r2] = r3
        ...
        public java.lang.StringBuilder toString(java.lang.StringBuilder r5) {
                ...
                r0 = 34
                r5.append(r0)
                androidx.emoji2.text.flatbuffer.ReadBuf r1 = r4.f34bb
                int r2 = r4.end
                int r3 = r4.size()
    ...
    public static class Key extends androidx.emoji2.text.flatbuffer.FlexBuffers.Object {
        ...
        int compareTo(byte[] r6) {
                ...
                r1 = 0
            L3:
                androidx.emoji2.text.flatbuffer.ReadBuf r2 = r5.f34bb
                byte r2 = r2.get(r0)
                r3 = r6[r1]
                if (r2 != 0) goto L10
                int r4 = r2 - r3
        ...
        public java.lang.String toString() {
                ...
                int r0 = r3.end
            L2:
                androidx.emoji2.text.flatbuffer.ReadBuf r1 = r3.f34bb
                byte r1 = r1.get(r0)
                if (r1 != 0) goto L18
                int r1 = r3.end
                int r1 = r0 - r1
    ...
    public static class KeyVector {
        ...
        public androidx.emoji2.text.flatbuffer.FlexBuffers.Key get(int r7) {
            ...
            Lb:
                ...
                androidx.emoji2.text.flatbuffer.ReadBuf r3 = r3.f34bb
                androidx.emoji2.text.flatbuffer.FlexBuffers$TypedVector r4 = r6.vec
                androidx.emoji2.text.flatbuffer.ReadBuf r4 = r4.f34bb
    ...
    public static class Map extends androidx.emoji2.text.flatbuffer.FlexBuffers.Vector {
        ...
        public androidx.emoji2.text.flatbuffer.FlexBuffers.KeyVector keys() {
                ...
                androidx.emoji2.text.flatbuffer.ReadBuf r4 = r9.f34bb
                androidx.emoji2.text.flatbuffer.ReadBuf r5 = r9.f34bb
                int r6 = r9.byteWidth
                int r5 = androidx.emoji2.text.flatbuffer.FlexBuffers.access$200(r5, r1, r6)
                androidx.emoji2.text.flatbuffer.ReadBuf r6 = r9.f34bb
                int r7 = r9.byteWidth
                int r7 = r7 + r1
                int r8 = r9.byteWidth
    ...
    private static abstract class Object {
        ...
        androidx.emoji2.text.flatbuffer.ReadBuf f34bb;
        int byteWidth;
        int end;
    ...
    public static class Reference {
        ...
        /* JADX INFO: renamed from: bb */
        private androidx.emoji2.text.flatbuffer.ReadBuf f35bb;
        ...
        public androidx.emoji2.text.flatbuffer.FlexBuffers.Blob asBlob() {
            ...
            L12:
                androidx.emoji2.text.flatbuffer.FlexBuffers$Blob r0 = new androidx.emoji2.text.flatbuffer.FlexBuffers$Blob
                androidx.emoji2.text.flatbuffer.ReadBuf r1 = r5.f35bb
                androidx.emoji2.text.flatbuffer.ReadBuf r2 = r5.f35bb
                int r3 = r5.end
        ...
        public boolean asBoolean() {
                ...
                r2 = 0
                if (r0 == 0) goto L15
                androidx.emoji2.text.flatbuffer.ReadBuf r0 = r7.f35bb
                int r3 = r7.end
                byte r0 = r0.get(r3)
                if (r0 == 0) goto L13
                goto L14
        ...
        public double asFloat() {
                ...
                r1 = 3
                if (r0 != r1) goto L10
                androidx.emoji2.text.flatbuffer.ReadBuf r0 = r4.f35bb
                int r1 = r4.end
            ...
            L22:
                androidx.emoji2.text.flatbuffer.ReadBuf r0 = r4.f35bb
                androidx.emoji2.text.flatbuffer.ReadBuf r1 = r4.f35bb
                int r2 = r4.end
        ...
        public java.lang.String asString() {
                ...
                int r1 = (int) r1
                androidx.emoji2.text.flatbuffer.ReadBuf r2 = r4.f35bb
    ...
    public static class TypedVector extends androidx.emoji2.text.flatbuffer.FlexBuffers.Vector {
        ...
        public androidx.emoji2.text.flatbuffer.FlexBuffers.Reference get(int r10) {
            ...
            Lb:
                ...
                int r2 = r2 * r10
                int r1 = r1 + r2
                androidx.emoji2.text.flatbuffer.FlexBuffers$Reference r2 = new androidx.emoji2.text.flatbuffer.FlexBuffers$Reference
                androidx.emoji2.text.flatbuffer.ReadBuf r4 = r9.f34bb
                int r6 = r9.byteWidth
                r7 = 1
                int r8 = r9.elemType
    ...
    public static class Vector extends androidx.emoji2.text.flatbuffer.FlexBuffers.Sized {
        ...
        public androidx.emoji2.text.flatbuffer.FlexBuffers.Reference get(int r8) {
                ...
                return r2
            Lf:
                androidx.emoji2.text.flatbuffer.ReadBuf r2 = r7.f34bb
                int r3 = r7.end
                long r3 = (long) r3
                int r5 = r7.byteWidth
                long r5 = (long) r5
                ...
                androidx.emoji2.text.flatbuffer.ReadBuf r5 = r7.f34bb
                int r6 = r7.byteWidth
                r4.<init>(r5, r3, r6, r2)
                return r4
        }
