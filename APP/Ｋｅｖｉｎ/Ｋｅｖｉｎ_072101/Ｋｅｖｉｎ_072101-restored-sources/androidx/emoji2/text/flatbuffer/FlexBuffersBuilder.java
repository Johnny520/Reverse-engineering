...
public class FlexBuffersBuilder {
    ...
    private final androidx.emoji2.text.flatbuffer.ReadWriteBuf f36bb;
    ...
    static /* synthetic */ androidx.emoji2.text.flatbuffer.ReadWriteBuf access$000(androidx.emoji2.text.flatbuffer.FlexBuffersBuilder r1) {
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r0 = r1.f36bb
            return r0
    }
    ...
    private int align(int r5) {
            ...
            r0 = 1
            int r0 = r0 << r5
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r1 = r4.f36bb
    ...
    private androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value createKeyVector(int r13, int r14) {
            r12 = this;
            long r0 = (long) r14
            ...
            r3 = r13
        Lc:
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r4 = r12.stack
            int r4 = r4.size()
            if (r3 >= r4) goto L34
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r4 = r12.stack
            ...
            int r4 = r4.key
            long r7 = (long) r4
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r4 = r12.f36bb
            int r9 = r4.writePosition()
            int r10 = r3 + r2
            r5 = 4
            r6 = 0
            int r4 = androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value.access$500(r5, r6, r7, r9, r10)
        ...
        L34:
            ...
            r4 = r13
        L43:
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r5 = r12.stack
            int r5 = r5.size()
            if (r4 >= r5) goto L67
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r5 = r12.stack
            ...
            int r5 = r5.key
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r6 = r12.stack
            java.lang.Object r6 = r6.get(r4)
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r6 = (androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value) r6
            int r6 = r6.key
            long r6 = (long) r6
            ...
            goto L43
        L67:
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r11 = new androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value
            r4 = 4
            int r6 = androidx.emoji2.text.flatbuffer.FlexBuffers.toTypedVector(r4, r1)
            long r8 = (long) r10
            r5 = -1
            r4 = r11
            r7 = r0
    ...
    private androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value createVector(int r18, int r19, int r20, boolean r21, boolean r22, androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value r23) {
            r17 = this;
            r0 = r17
            r1 = r20
            r2 = r23
            ...
            r5 = 1
            if (r2 == 0) goto L23
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r6 = r0.f36bb
            int r6 = r6.writePosition()
            int r6 = androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value.access$200(r2, r6, r4)
        ...
        L26:
            ...
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r9 = r0.f36bb
            int r9 = r9.writePosition()
            int r10 = r7 + r5
            int r8 = androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value.access$200(r8, r9, r10)
            ...
            int r6 = r9.type
            boolean r9 = androidx.emoji2.text.flatbuffer.FlexBuffers.isTypedVectorElementType(r6)
            if (r9 == 0) goto L5d
            goto L68
        L5d:
            androidx.emoji2.text.flatbuffer.FlexBuffers$FlexBufferException r4 = new androidx.emoji2.text.flatbuffer.FlexBuffers$FlexBufferException
        ...
        L81:
            ...
            r0.writeInt(r8, r7)
        L87:
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r8 = r0.f36bb
        ...
        La9:
            ...
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r10 = (androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value) r10
            byte r10 = androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value.access$400(r10, r3)
            r9.put(r10)
            int r8 = r8 + 1
            goto La9
        Lc5:
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r16 = new androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value
            if (r2 == 0) goto Lcd
            r4 = 9
            r10 = r4
            goto Lda
        Lcd:
            ...
            r4 = r1
        Ld2:
            int r4 = androidx.emoji2.text.flatbuffer.FlexBuffers.toTypedVector(r6, r4)
            goto Ld9
        Ld7:
            r4 = 10
        Ld9:
    ...
    private int putKey(java.lang.String r7) {
            ...
            return r0
        L4:
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r0 = r6.f36bb
            ...
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r4 = r6.f36bb
            int r5 = r3.length
            r4.put(r3, r2, r5)
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r4 = r6.f36bb
            r4.put(r2)
        ...
        L3b:
            ...
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r3 = r6.f36bb
            int r4 = r1.length
            r3.put(r1, r2, r4)
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r3 = r6.f36bb
            r3.put(r2)
    ...
    private androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.Value writeBlob(int r7, byte[] r8, int r9, boolean r10) {
            ...
            long r2 = (long) r2
            r6.writeInt(r2, r1)
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r2 = r6.f36bb
    ...
    private void writeDouble(double r3, int r5) {
            ...
            r0 = 4
            if (r5 != r0) goto La
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r0 = r2.f36bb
            float r1 = (float) r3
            r0.putFloat(r1)
            goto L13
        La:
    ...
    private void writeOffset(long r4, int r6) {
            r3 = this;
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r0 = r3.f36bb
            int r0 = r0.writePosition()
            long r0 = (long) r0
            long r0 = r0 - r4
            int r0 = (int) r0
    ...
    public int endMap(java.lang.String r10, int r11) {
            ...
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r0 = r9.stack
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r9.stack
            int r1 = r1.size()
            java.util.List r0 = r0.subList(r11, r1)
            java.util.Comparator<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r9.keyComparator
            java.util.Collections.sort(r0, r1)
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r0 = r9.stack
            int r0 = r0.size()
            int r0 = r0 - r11
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r8 = r9.createKeyVector(r11, r0)
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r0 = r9.stack
            int r0 = r0.size()
            int r3 = r0 - r11
            r4 = 0
            ...
            r2 = r11
            r6 = r8
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r0 = r0.createVector(r1, r2, r3, r4, r5, r6)
        L32:
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r9.stack
            int r1 = r1.size()
            if (r1 <= r11) goto L48
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r9.stack
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r2 = r9.stack
            int r2 = r2.size()
            int r2 = r2 + (-1)
            r1.remove(r2)
            goto L32
    ...
    public int endVector(java.lang.String r9, int r10, boolean r11, boolean r12) {
            r8 = this;
            int r7 = r8.putKey(r9)
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r0 = r8.stack
            int r0 = r0.size()
            int r3 = r0 - r10
            r6 = 0
            r0 = r8
            ...
            androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value r0 = r0.createVector(r1, r2, r3, r4, r5, r6)
        L16:
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r8.stack
            int r1 = r1.size()
            if (r1 <= r10) goto L2c
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r1 = r8.stack
            java.util.ArrayList<androidx.emoji2.text.flatbuffer.FlexBuffersBuilder$Value> r2 = r8.stack
            int r2 = r2.size()
            int r2 = r2 + (-1)
            r1.remove(r2)
            goto L16
    ...
    public java.nio.ByteBuffer finish() {
            ...
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r2 = r4.f36bb
            int r2 = r2.writePosition()
            ...
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r2 = r4.f36bb
            byte[] r2 = r2.data()
            androidx.emoji2.text.flatbuffer.ReadWriteBuf r3 = r4.f36bb
