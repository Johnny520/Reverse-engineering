...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int r3, androidx.emoji2.text.flatbuffer.FlatBufferBuilder.ByteBufferFactory r4, java.nio.ByteBuffer r5, androidx.emoji2.text.flatbuffer.Utf8 r6) {
        ...
        L1f:
            ...
            if (r5 == 0) goto L32
            r2.f33bb = r5
            java.nio.ByteBuffer r0 = r2.f33bb
            r0.clear()
            java.nio.ByteBuffer r0 = r2.f33bb
            java.nio.ByteOrder r1 = java.nio.ByteOrder.LITTLE_ENDIAN
            r0.order(r1)
    ...
    public void clear() {
            r4 = this;
            java.nio.ByteBuffer r0 = r4.f33bb
            int r0 = r0.capacity()
            r4.space = r0
            java.nio.ByteBuffer r0 = r4.f33bb
            r0.clear()
    ...
    public int createByteVector(java.nio.ByteBuffer r4) {
            ...
            java.nio.ByteBuffer r1 = r3.f33bb
            int r2 = r3.space
            int r2 = r2 - r0
            r3.space = r2
            r1.position(r2)
    ...
    public <T extends androidx.emoji2.text.flatbuffer.Table> int createSortedVectorOfTables(T r2, int[] r3) {
            r1 = this;
            java.nio.ByteBuffer r0 = r1.f33bb
            r2.sortTables(r3, r0)
    ...
    public int createString(java.lang.CharSequence r4) {
            ...
            java.nio.ByteBuffer r2 = r3.f33bb
            r1.encodeUtf8(r4, r2)
            int r1 = r3.endVector()
            return r1
    }
    ...
    public int endTable() {
        ...
        L4b:
            ...
            if (r2 >= r6) goto L8b
            java.nio.ByteBuffer r6 = r13.f33bb
            int r6 = r6.capacity()
            int[] r7 = r13.vtables
            r7 = r7[r2]
            int r6 = r6 - r7
            int r7 = r13.space
            java.nio.ByteBuffer r8 = r13.f33bb
            short r8 = r8.getShort(r6)
            java.nio.ByteBuffer r9 = r13.f33bb
            short r9 = r9.getShort(r7)
            if (r8 != r9) goto L88
            r9 = 2
        L6b:
            if (r9 >= r8) goto L83
            java.nio.ByteBuffer r10 = r13.f33bb
            int r11 = r6 + r9
            short r10 = r10.getShort(r11)
            java.nio.ByteBuffer r11 = r13.f33bb
            int r12 = r7 + r9
        ...
        Lb3:
            ...
            r6[r7] = r8
            java.nio.ByteBuffer r6 = r13.f33bb
            java.nio.ByteBuffer r7 = r13.f33bb
            int r7 = r7.capacity()
            int r7 = r7 - r1
            int r8 = r13.offset()
            int r8 = r8 - r1
    ...
    protected void finish(int r4, boolean r5) {
        ...
        L8:
            ...
            r3.addOffset(r4)
            if (r5 == 0) goto L1d
            java.nio.ByteBuffer r0 = r3.f33bb
            int r0 = r0.capacity()
            int r1 = r3.space
            int r0 = r0 - r1
            r3.addInt(r0)
    ...
    public void pad(int r5) {
        ...
        L1:
            if (r0 >= r5) goto L12
            java.nio.ByteBuffer r1 = r4.f33bb
            int r2 = r4.space
            int r2 = r2 + (-1)
            r4.space = r2
            r3 = 0
    ...
    public void prep(int r6, int r7) {
            ...
            r5.minalign = r6
        L6:
            java.nio.ByteBuffer r0 = r5.f33bb
            int r0 = r0.capacity()
            int r1 = r5.space
            int r0 = r0 - r1
            int r0 = r0 + r7
        ...
        L16:
            ...
            int r2 = r2 + r7
            if (r1 >= r2) goto L43
            java.nio.ByteBuffer r1 = r5.f33bb
            int r1 = r1.capacity()
            java.nio.ByteBuffer r2 = r5.f33bb
            ...
            r5.f33bb = r3
            java.nio.ByteBuffer r3 = r5.f33bb
            if (r2 == r3) goto L36
            androidx.emoji2.text.flatbuffer.FlatBufferBuilder$ByteBufferFactory r3 = r5.bb_factory
            r3.releaseByteBuffer(r2)
        L36:
            int r3 = r5.space
            java.nio.ByteBuffer r4 = r5.f33bb
            int r4 = r4.capacity()
            int r4 = r4 - r1
            int r3 = r3 + r4
            r5.space = r3
    ...
    public void required(int r7, int r8) {
            r6 = this;
            java.nio.ByteBuffer r0 = r6.f33bb
            int r0 = r0.capacity()
            int r0 = r0 - r7
            java.nio.ByteBuffer r1 = r6.f33bb
            int r1 = r1.getInt(r0)
            int r1 = r0 - r1
            java.nio.ByteBuffer r2 = r6.f33bb
            int r3 = r1 + r8
    ...
    public byte[] sizedByteArray(int r3, int r4) {
            ...
            r2.finished()
            byte[] r0 = new byte[r4]
            java.nio.ByteBuffer r1 = r2.f33bb
            r1.position(r3)
            java.nio.ByteBuffer r1 = r2.f33bb
            r1.get(r0)
            return r0
