...
public class FragmentActivity extends androidx.activity.ComponentActivity implements androidx.core.app.ActivityCompat.OnRequestPermissionsResultCallback, androidx.core.app.ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public boolean onCreatePanelMenu(int r4, android.view.Menu r5) {
            ...
            androidx.fragment.app.FragmentController r1 = r3.mFragments
            android.view.MenuInflater r2 = r3.getMenuInflater()
            boolean r1 = r1.dispatchCreateOptionsMenu(r5, r2)
            r0 = r0 | r1
            return r0
        L12:
            boolean r0 = super.onCreatePanelMenu(r4, r5)
    ...
    public boolean onMenuItemSelected(int r2, android.view.MenuItem r3) {
        ...
        L14:
            androidx.fragment.app.FragmentController r0 = r1.mFragments
            boolean r0 = r0.dispatchOptionsItemSelected(r3)
            return r0
    }
    ...
    protected boolean onPrepareOptionsPanel(android.view.View r2, android.view.Menu r3) {
            r1 = this;
            r0 = 0
            boolean r0 = super.onPreparePanel(r0, r2, r3)
            return r0
    }
    ...
    public boolean onPreparePanel(int r3, android.view.View r4, android.view.Menu r5) {
            r2 = this;
            if (r3 != 0) goto Le
            boolean r0 = r2.onPrepareOptionsPanel(r4, r5)
            androidx.fragment.app.FragmentController r1 = r2.mFragments
            boolean r1 = r1.dispatchPrepareOptionsMenu(r5)
            r0 = r0 | r1
            return r0
        Le:
            boolean r0 = super.onPreparePanel(r3, r4, r5)
            return r0
    }
    ...
    @java.lang.Deprecated
    public void startIntentSenderFromFragment(androidx.fragment.app.Fragment r11, android.content.IntentSender r12, int r13, android.content.Intent r14, int r15, int r16, int r17, android.os.Bundle r18) throws android.content.IntentSender.SendIntentException {
            r10 = this;
            r0 = -1
            r9 = r13
            if (r9 != r0) goto L13
            ...
            return
        L13:
            r11.startIntentSenderForResult(r12, r13, r14, r15, r16, r17, r18)
            return
    }
