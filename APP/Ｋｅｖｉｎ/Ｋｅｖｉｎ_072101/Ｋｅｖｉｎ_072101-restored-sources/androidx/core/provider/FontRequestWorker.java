...
class FontRequestWorker {
    ...
    private static java.lang.String createCacheId(androidx.core.provider.FontRequest r2, int r3) {
    ...
    static androidx.core.provider.FontRequestWorker.TypefaceResult getFontSync(java.lang.String r6, android.content.Context r7, androidx.core.provider.FontRequest r8, int r9) {
            ...
            if (r0 == 0) goto L10
            androidx.core.provider.FontRequestWorker$TypefaceResult r1 = new androidx.core.provider.FontRequestWorker$TypefaceResult
            r1.<init>(r0)
            return r1
        L10:
            r1 = 0
            androidx.core.provider.FontsContractCompat$FontFamilyResult r2 = androidx.core.provider.FontProvider.getFontFamilyResult(r7, r8, r1)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L3f
            int r3 = getFontFamilyResultStatus(r2)
            if (r3 == 0) goto L22
            androidx.core.provider.FontRequestWorker$TypefaceResult r1 = new androidx.core.provider.FontRequestWorker$TypefaceResult
            r1.<init>(r3)
            return r1
        L22:
            androidx.core.provider.FontsContractCompat$FontInfo[] r4 = r2.getFonts()
            android.graphics.Typeface r1 = androidx.core.graphics.TypefaceCompat.createFromFontInfo(r7, r1, r4, r9)
            if (r1 == 0) goto L38
            androidx.collection.LruCache<java.lang.String, android.graphics.Typeface> r4 = androidx.core.provider.FontRequestWorker.sTypefaceCache
            r4.put(r6, r1)
    ...
    static android.graphics.Typeface requestFontAsync(android.content.Context r7, androidx.core.provider.FontRequest r8, int r9, java.util.concurrent.Executor r10, androidx.core.provider.CallbackWithHandler r11) {
        ...
        L17:
            ...
            monitor-enter(r3)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.util.Consumer<androidx.core.provider.FontRequestWorker$TypefaceResult>>> r4 = androidx.core.provider.FontRequestWorker.PENDING_REPLIES     // Catch: java.lang.Throwable -> L53
            java.lang.Object r4 = r4.get(r0)     // Catch: java.lang.Throwable -> L53
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch: java.lang.Throwable -> L53
            r5 = 0
            if (r4 == 0) goto L2f
            r4.add(r2)     // Catch: java.lang.Throwable -> L53
        ...
        L2f:
            ...
            r4 = r6
            r4.add(r2)     // Catch: java.lang.Throwable -> L53
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.util.Consumer<androidx.core.provider.FontRequestWorker$TypefaceResult>>> r6 = androidx.core.provider.FontRequestWorker.PENDING_REPLIES     // Catch: java.lang.Throwable -> L53
            r6.put(r0, r4)     // Catch: java.lang.Throwable -> L53
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L53
    ...
    static android.graphics.Typeface requestFontSync(android.content.Context r6, androidx.core.provider.FontRequest r7, androidx.core.provider.CallbackWithHandler r8, int r9, int r10) {
            java.lang.String r0 = createCacheId(r7, r9)
            androidx.collection.LruCache<java.lang.String, android.graphics.Typeface> r1 = androidx.core.provider.FontRequestWorker.sTypefaceCache
            java.lang.Object r1 = r1.get(r0)
            android.graphics.Typeface r1 = (android.graphics.Typeface) r1
            if (r1 == 0) goto L17
        ...
        L17:
            r2 = -1
            if (r10 != r2) goto L24
            androidx.core.provider.FontRequestWorker$TypefaceResult r2 = getFontSync(r0, r6, r7, r9)
            r8.onTypefaceResult(r2)
        ...
        L24:
            ...
            r2.<init>(r0, r6, r7, r9)
            java.util.concurrent.ExecutorService r3 = androidx.core.provider.FontRequestWorker.DEFAULT_EXECUTOR_SERVICE     // Catch: java.lang.InterruptedException -> L37
            java.lang.Object r3 = androidx.core.provider.RequestExecutor.submit(r3, r2, r10)     // Catch: java.lang.InterruptedException -> L37
            androidx.core.provider.FontRequestWorker$TypefaceResult r3 = (androidx.core.provider.FontRequestWorker.TypefaceResult) r3     // Catch: java.lang.InterruptedException -> L37
            r8.onTypefaceResult(r3)     // Catch: java.lang.InterruptedException -> L37
            android.graphics.Typeface r4 = r3.mTypeface     // Catch: java.lang.InterruptedException -> L37
            return r4
        L37:
            r3 = move-exception
            androidx.core.provider.FontRequestWorker$TypefaceResult r4 = new androidx.core.provider.FontRequestWorker$TypefaceResult
