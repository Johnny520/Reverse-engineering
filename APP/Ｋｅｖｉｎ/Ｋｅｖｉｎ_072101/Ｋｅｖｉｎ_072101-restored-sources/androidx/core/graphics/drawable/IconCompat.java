...
public class IconCompat extends androidx.versionedparcelable.CustomVersionedParcelable {
    ...
    private android.graphics.drawable.Drawable loadDrawableInner(android.content.Context r7) {
        ...
        Lf:
            ...
            r2.<init>(r3, r4)
            android.graphics.drawable.Drawable r1 = androidx.core.graphics.drawable.IconCompat.Api26Impl.createAdaptiveIconDrawable(r1, r2)
            return r1
        L21:
            ...
            r3 = 0
            android.graphics.Bitmap r2 = createLegacyIconFromAdaptiveIcon(r2, r3)
            r0.<init>(r1, r2)
            return r0
        L34:
            java.io.InputStream r0 = r6.getUriInputStream(r7)
        ...
        L6c:
            android.content.res.Resources r2 = getResources(r7, r0)
            int r3 = r6.mInt1     // Catch: java.lang.RuntimeException -> L7b
            android.content.res.Resources$Theme r4 = r7.getTheme()     // Catch: java.lang.RuntimeException -> L7b
            android.graphics.drawable.Drawable r1 = androidx.core.content.res.ResourcesCompat.getDrawable(r2, r3, r4)     // Catch: java.lang.RuntimeException -> L7b
            return r1
        L7b:
            r3 = move-exception
            int r4 = r6.mInt1
    ...
    public void addToShortcutIntent(android.content.Intent r7, android.graphics.drawable.Drawable r8, android.content.Context r9) {
        ...
        L11:
            ...
            goto La7
        L1b:
            java.lang.String r0 = r6.getResPackage()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r1 = 0
            android.content.Context r0 = r9.createPackageContext(r0, r1)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            if (r8 != 0) goto L32
            java.lang.String r1 = "android.intent.extra.shortcut.ICON_RESOURCE"
            int r2 = r6.mInt1     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.content.Intent$ShortcutIconResource r2 = android.content.Intent.ShortcutIconResource.fromContext(r0, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r7.putExtra(r1, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            return
        L32:
            int r2 = r6.mInt1     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.graphics.drawable.Drawable r2 = androidx.core.content.ContextCompat.getDrawable(r0, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            int r3 = r2.getIntrinsicWidth()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            if (r3 <= 0) goto L54
            int r3 = r2.getIntrinsicHeight()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            if (r3 > 0) goto L45
            goto L54
        L45:
            int r3 = r2.getIntrinsicWidth()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            int r4 = r2.getIntrinsicHeight()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.graphics.Bitmap$Config r5 = android.graphics.Bitmap.Config.ARGB_8888     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.graphics.Bitmap r3 = android.graphics.Bitmap.createBitmap(r3, r4, r5)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            goto L68
        L54:
            java.lang.String r3 = "activity"
            java.lang.Object r3 = r0.getSystemService(r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.app.ActivityManager r3 = (android.app.ActivityManager) r3     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            int r3 = r3.getLauncherLargeIconSize()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            ...
            android.graphics.Bitmap r4 = android.graphics.Bitmap.createBitmap(r3, r3, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r3 = r4
        L68:
            int r4 = r3.getWidth()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            int r5 = r3.getHeight()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r2.setBounds(r1, r1, r4, r5)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            android.graphics.Canvas r1 = new android.graphics.Canvas     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r1.<init>(r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r2.draw(r1)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L7d
            r0 = r3
            goto La7
        L7d:
            r0 = move-exception
