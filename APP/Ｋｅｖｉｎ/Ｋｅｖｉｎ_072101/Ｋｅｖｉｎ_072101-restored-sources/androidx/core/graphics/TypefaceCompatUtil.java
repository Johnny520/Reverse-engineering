...
public class TypefaceCompatUtil {
    ...
    static class Api19Impl {
        ...
        static android.os.ParcelFileDescriptor openFileDescriptor(android.content.ContentResolver r1, android.net.Uri r2, java.lang.String r3, android.os.CancellationSignal r4) throws java.io.FileNotFoundException {
                android.os.ParcelFileDescriptor r0 = r1.openFileDescriptor(r2, r3, r4)
                return r0
        }
    }
    ...
    public static java.nio.ByteBuffer mmap(android.content.Context r10, android.os.CancellationSignal r11, android.net.Uri r12) {
            ...
            android.os.ParcelFileDescriptor r2 = androidx.core.graphics.TypefaceCompatUtil.Api19Impl.openFileDescriptor(r0, r12, r2, r11)     // Catch: java.io.IOException -> L4c
            if (r2 != 0) goto L14
        Le:
            if (r2 == 0) goto L13
        ...
        L14:
            ...
            java.io.FileDescriptor r4 = r2.getFileDescriptor()     // Catch: java.lang.Throwable -> L40
            r3.<init>(r4)     // Catch: java.lang.Throwable -> L40
            java.nio.channels.FileChannel r4 = r3.getChannel()     // Catch: java.lang.Throwable -> L36
            long r8 = r4.size()     // Catch: java.lang.Throwable -> L36
            java.nio.channels.FileChannel$MapMode r5 = java.nio.channels.FileChannel.MapMode.READ_ONLY     // Catch: java.lang.Throwable -> L36
            r6 = 0
            java.nio.MappedByteBuffer r5 = r4.map(r5, r6, r8)     // Catch: java.lang.Throwable -> L36
    ...
    private static java.nio.ByteBuffer mmap(java.io.File r7) {
            ...
            r3 = 0
            java.nio.MappedByteBuffer r2 = r1.map(r2, r3, r5)     // Catch: java.lang.Throwable -> L19
        ...
        L1e:
            r2 = move-exception
            r1.addSuppressed(r2)     // Catch: java.io.IOException -> L23
        L22:
