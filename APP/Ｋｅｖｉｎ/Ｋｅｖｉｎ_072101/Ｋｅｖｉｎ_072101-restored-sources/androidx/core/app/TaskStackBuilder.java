...
public final class TaskStackBuilder implements java.lang.Iterable<android.content.Intent> {
    ...
    static class Api16Impl {
        ...
        static android.app.PendingIntent getActivities(android.content.Context r1, int r2, android.content.Intent[] r3, int r4, android.os.Bundle r5) {
    ...
    public android.app.PendingIntent getPendingIntent(int r5, int r6, android.os.Bundle r7) {
            ...
            android.app.PendingIntent r1 = androidx.core.app.TaskStackBuilder.Api16Impl.getActivities(r1, r5, r0, r6, r7)
            return r1
        L2b:
