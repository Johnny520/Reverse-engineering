...
public class AccessibilityDelegateCompat {
    ...
    static class Api16Impl {
        ...
        static android.view.accessibility.AccessibilityNodeProvider getAccessibilityNodeProvider(android.view.View.AccessibilityDelegate r1, android.view.View r2) {
                android.view.accessibility.AccessibilityNodeProvider r0 = r1.getAccessibilityNodeProvider(r2)
                return r0
        }

        static boolean performAccessibilityAction(android.view.View.AccessibilityDelegate r1, android.view.View r2, int r3, android.os.Bundle r4) {
                boolean r0 = r1.performAccessibilityAction(r2, r3, r4)
                return r0
        }
    }
    ...
    public androidx.core.view.accessibility.AccessibilityNodeProviderCompat getAccessibilityNodeProvider(android.view.View r3) {
            ...
            android.view.accessibility.AccessibilityNodeProvider r0 = androidx.core.view.AccessibilityDelegateCompat.Api16Impl.getAccessibilityNodeProvider(r0, r3)
            if (r0 == 0) goto Lf
    ...
    public boolean performAccessibilityAction(android.view.View r6, int r7, android.os.Bundle r8) {
        ...
        L20:
            ...
            boolean r0 = androidx.core.view.AccessibilityDelegateCompat.Api16Impl.performAccessibilityAction(r2, r6, r7, r8)
        L28:
            if (r0 != 0) goto L3c
            int r2 = androidx.core.C0112R.id.accessibility_action_clickable_span
            if (r7 != r2) goto L3c
            if (r8 == 0) goto L3c
        L31:
