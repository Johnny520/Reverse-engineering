...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends androidx.core.view.WindowInsetsAnimationCompat.Impl {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements android.view.View.OnApplyWindowInsetsListener {
            ...
            public android.view.WindowInsets onApplyWindowInsets(android.view.View r19, android.view.WindowInsets r20) {
                    r18 = this;
                    r7 = r18
                    r8 = r19
                    r9 = r20
                    boolean r0 = r19.isLaidOut()
                    if (r0 != 0) goto L17
                    androidx.core.view.WindowInsetsCompat r0 = androidx.core.view.WindowInsetsCompat.toWindowInsetsCompat(r9, r8)
                    r7.mLastInsets = r0
                    android.view.WindowInsets r0 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.forwardToViewIfNeeded(r19, r20)
                    return r0
                L17:
                    ...
                    if (r0 != 0) goto L25
                    androidx.core.view.WindowInsetsCompat r0 = androidx.core.view.ViewCompat.getRootWindowInsets(r19)
                    r7.mLastInsets = r0
                L25:
                    androidx.core.view.WindowInsetsCompat r0 = r7.mLastInsets
                    if (r0 != 0) goto L30
                    ...
                    return r0
                L30:
                    androidx.core.view.WindowInsetsAnimationCompat$Callback r11 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.getCallback(r19)
                    if (r11 == 0) goto L43
                    android.view.WindowInsets r0 = r11.mDispachedInsets
                ...
                L43:
                    androidx.core.view.WindowInsetsCompat r0 = r7.mLastInsets
                    int r12 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.buildAnimationMask(r10, r0)
                    if (r12 != 0) goto L50
                    android.view.WindowInsets r0 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.forwardToViewIfNeeded(r19, r20)
                    return r0
                L50:
                    androidx.core.view.WindowInsetsCompat r13 = r7.mLastInsets
                    android.view.animation.Interpolator r14 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.createInsetInterpolator(r12, r10, r13)
                    ...
                    long r1 = r15.getDurationMillis()
                    android.animation.ValueAnimator r6 = r0.setDuration(r1)
                    androidx.core.view.WindowInsetsAnimationCompat$BoundsCompat r16 = androidx.core.view.WindowInsetsAnimationCompat.Impl21.computeAnimationBounds(r10, r13, r12)
                    r0 = 0
                    androidx.core.view.WindowInsetsAnimationCompat.Impl21.dispatchOnPrepare(r8, r15, r9, r0)
                    androidx.core.view.WindowInsetsAnimationCompat$Impl21$Impl21OnApplyWindowInsetsListener$1 r5 = new androidx.core.view.WindowInsetsAnimationCompat$Impl21$Impl21OnApplyWindowInsetsListener$1
                    r0 = r5
                    r1 = r18
                    r2 = r15
                    r3 = r10
        ...
        static androidx.core.view.WindowInsetsAnimationCompat.BoundsCompat computeAnimationBounds(androidx.core.view.WindowInsetsCompat r8, androidx.core.view.WindowInsetsCompat r9, int r10) {
                ...
                androidx.core.graphics.Insets r2 = androidx.core.graphics.Insets.m12of(r2, r3, r4, r5)
                int r3 = r0.left
                int r4 = r1.left
                ...
                androidx.core.graphics.Insets r3 = androidx.core.graphics.Insets.m12of(r3, r4, r5, r6)
        ...
        static android.view.animation.Interpolator createInsetInterpolator(int r2, androidx.core.view.WindowInsetsCompat r3, androidx.core.view.WindowInsetsCompat r4) {
                r0 = r2 & 8
                if (r0 == 0) goto L20
                int r0 = androidx.core.view.WindowInsetsCompat.Type.ime()
                androidx.core.graphics.Insets r0 = r3.getInsets(r0)
                int r0 = r0.bottom
        ...
        static void dispatchOnPrepare(android.view.View r4, androidx.core.view.WindowInsetsAnimationCompat r5, android.view.WindowInsets r6, boolean r7) {
                androidx.core.view.WindowInsetsAnimationCompat$Callback r0 = getCallback(r4)
                if (r0 == 0) goto L17
        ...
        static void setCallback(android.view.View r3, androidx.core.view.WindowInsetsAnimationCompat.Callback r4) {
                int r0 = androidx.core.C0112R.id.tag_on_apply_window_listener
                java.lang.Object r0 = r3.getTag(r0)
                if (r4 != 0) goto L14
                int r1 = androidx.core.C0112R.id.tag_window_insets_animation_callback
                r2 = 0
                r3.setTag(r1, r2)
                if (r0 != 0) goto L23
                ...
                goto L23
            L14:
                android.view.View$OnApplyWindowInsetsListener r1 = createProxyListener(r3, r4)
                int r2 = androidx.core.C0112R.id.tag_window_insets_animation_callback
                r3.setTag(r2, r1)
                if (r0 != 0) goto L23
