...
public final class AccessibilityEventCompat {
    ...
    static class Api16Impl {
        ...
        static int getAction(android.view.accessibility.AccessibilityEvent r1) {
                int r0 = r1.getAction()
                return r0
        }

        static int getMovementGranularity(android.view.accessibility.AccessibilityEvent r1) {
                int r0 = r1.getMovementGranularity()
                return r0
        }

        static void setAction(android.view.accessibility.AccessibilityEvent r0, int r1) {
                r0.setAction(r1)
                return
        }

        static void setMovementGranularity(android.view.accessibility.AccessibilityEvent r0, int r1) {
    ...
    static class Api19Impl {
        ...
        static int getContentChangeTypes(android.view.accessibility.AccessibilityEvent r1) {
    ...
    public static int getAction(android.view.accessibility.AccessibilityEvent r1) {
            int r0 = androidx.core.view.accessibility.AccessibilityEventCompat.Api16Impl.getAction(r1)
            return r0
    }

    public static int getContentChangeTypes(android.view.accessibility.AccessibilityEvent r1) {
            int r0 = androidx.core.view.accessibility.AccessibilityEventCompat.Api19Impl.getContentChangeTypes(r1)
            return r0
    }

    public static int getMovementGranularity(android.view.accessibility.AccessibilityEvent r1) {
            int r0 = androidx.core.view.accessibility.AccessibilityEventCompat.Api16Impl.getMovementGranularity(r1)
            return r0
    }
    ...
    public static void setAction(android.view.accessibility.AccessibilityEvent r0, int r1) {
            androidx.core.view.accessibility.AccessibilityEventCompat.Api16Impl.setAction(r0, r1)
            return
    }

    public static void setContentChangeTypes(android.view.accessibility.AccessibilityEvent r0, int r1) {
            androidx.core.view.accessibility.AccessibilityEventCompat.Api19Impl.setContentChangeTypes(r0, r1)
            return
    }

    public static void setMovementGranularity(android.view.accessibility.AccessibilityEvent r0, int r1) {
            androidx.core.view.accessibility.AccessibilityEventCompat.Api16Impl.setMovementGranularity(r0, r1)
            return
    }
}
