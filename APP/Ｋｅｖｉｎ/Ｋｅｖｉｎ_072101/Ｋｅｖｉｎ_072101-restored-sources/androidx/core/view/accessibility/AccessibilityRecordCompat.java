...
public class AccessibilityRecordCompat {
    ...
    static class Api15Impl {
        ...
        static int getMaxScrollX(android.view.accessibility.AccessibilityRecord r1) {
                int r0 = r1.getMaxScrollX()
                return r0
        }

        static int getMaxScrollY(android.view.accessibility.AccessibilityRecord r1) {
                int r0 = r1.getMaxScrollY()
                return r0
        }

        static void setMaxScrollX(android.view.accessibility.AccessibilityRecord r0, int r1) {
                r0.setMaxScrollX(r1)
                return
        }

        static void setMaxScrollY(android.view.accessibility.AccessibilityRecord r0, int r1) {
                r0.setMaxScrollY(r1)
                return
        }
    }
    ...
    static class Api16Impl {
        ...
        static void setSource(android.view.accessibility.AccessibilityRecord r0, android.view.View r1, int r2) {
                r0.setSource(r1, r2)
                return
        }
    }
    ...
    public static int getMaxScrollX(android.view.accessibility.AccessibilityRecord r1) {
            int r0 = androidx.core.view.accessibility.AccessibilityRecordCompat.Api15Impl.getMaxScrollX(r1)
            return r0
    }

    public static int getMaxScrollY(android.view.accessibility.AccessibilityRecord r1) {
            int r0 = androidx.core.view.accessibility.AccessibilityRecordCompat.Api15Impl.getMaxScrollY(r1)
            return r0
    }
    ...
    public static void setMaxScrollX(android.view.accessibility.AccessibilityRecord r0, int r1) {
            androidx.core.view.accessibility.AccessibilityRecordCompat.Api15Impl.setMaxScrollX(r0, r1)
            return
    }

    public static void setMaxScrollY(android.view.accessibility.AccessibilityRecord r0, int r1) {
            androidx.core.view.accessibility.AccessibilityRecordCompat.Api15Impl.setMaxScrollY(r0, r1)
            return
    }

    public static void setSource(android.view.accessibility.AccessibilityRecord r0, android.view.View r1, int r2) {
            androidx.core.view.accessibility.AccessibilityRecordCompat.Api16Impl.setSource(r0, r1, r2)
            return
    }
