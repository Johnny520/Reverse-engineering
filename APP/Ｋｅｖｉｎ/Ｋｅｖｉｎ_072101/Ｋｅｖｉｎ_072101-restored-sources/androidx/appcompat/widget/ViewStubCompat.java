...
public final class ViewStubCompat extends android.view.View {
    ...
    public ViewStubCompat(android.content.Context r5, android.util.AttributeSet r6, int r7) {
            ...
            int r2 = androidx.appcompat.C0015R.styleable.ViewStubCompat_android_inflatedId
            r3 = -1
            int r2 = r1.getResourceId(r2, r3)
            r4.mInflatedId = r2
            int r2 = androidx.appcompat.C0015R.styleable.ViewStubCompat_android_layout
            int r0 = r1.getResourceId(r2, r0)
            r4.mLayoutResource = r0
            int r0 = androidx.appcompat.C0015R.styleable.ViewStubCompat_android_id
