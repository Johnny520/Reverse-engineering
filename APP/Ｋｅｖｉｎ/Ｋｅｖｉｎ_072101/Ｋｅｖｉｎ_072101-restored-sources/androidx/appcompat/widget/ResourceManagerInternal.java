...
public final class ResourceManagerInternal {
    ...
    private void checkVectorDrawableSetup(android.content.Context r4) {
        ...
        L5:
            ...
            int r0 = androidx.appcompat.resources.C0045R.drawable.abc_vector_test
    ...
    private android.graphics.drawable.Drawable createDrawableIfNeeded(android.content.Context r6, int r7) {
        ...
        L2c:
            r3 = r4
            if (r3 == 0) goto L37
            int r4 = r0.changingConfigurations
            r3.setChangingConfigurations(r4)
            r5.addDrawableToCache(r6, r1, r3)
        L37:
            return r3
    }
    ...
    private android.graphics.drawable.Drawable tintDrawable(android.content.Context r3, int r4, boolean r5, android.graphics.drawable.Drawable r6) {
            ...
            if (r0 == 0) goto L21
            boolean r1 = androidx.appcompat.widget.DrawableUtils.canSafelyMutateDrawable(r6)
            if (r1 == 0) goto L10
    ...
    static void tintDrawable(android.graphics.drawable.Drawable r4, androidx.appcompat.widget.TintInfo r5, int[] r6) {
            int[] r0 = r4.getState()
            r1 = 0
            boolean r2 = androidx.appcompat.widget.DrawableUtils.canSafelyMutateDrawable(r4)
            r3 = 0
            if (r2 == 0) goto L20
