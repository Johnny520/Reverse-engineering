...
class AppCompatSeekBarHelper extends androidx.appcompat.widget.AppCompatProgressBarHelper {
    ...
    void loadFromAttributes(android.util.AttributeSet r9, int r10) {
            ...
            int r1 = androidx.appcompat.C0015R.styleable.AppCompatSeekBar_android_thumb
            android.graphics.drawable.Drawable r1 = r0.getDrawableIfKnown(r1)
            if (r1 == 0) goto L31
            android.widget.SeekBar r2 = r8.mView
            r2.setThumb(r1)
        L31:
            int r2 = androidx.appcompat.C0015R.styleable.AppCompatSeekBar_tickMark
            android.graphics.drawable.Drawable r2 = r0.getDrawable(r2)
            r8.setTickMark(r2)
            int r3 = androidx.appcompat.C0015R.styleable.AppCompatSeekBar_tickMarkTintMode
            ...
            android.graphics.PorterDuff$Mode r5 = r8.mTickMarkTintMode
            android.graphics.PorterDuff$Mode r3 = androidx.appcompat.widget.DrawableUtils.parseTintMode(r3, r5)
            r8.mTickMarkTintMode = r3
            r8.mHasTickMarkTintMode = r4
        L54:
            int r3 = androidx.appcompat.C0015R.styleable.AppCompatSeekBar_tickMarkTint
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto L66
            int r3 = androidx.appcompat.C0015R.styleable.AppCompatSeekBar_tickMarkTint
            android.content.res.ColorStateList r3 = r0.getColorStateList(r3)
            r8.mTickMarkTintList = r3
            r8.mHasTickMarkTint = r4
        L66:
            r0.recycle()
