...
public class ActivityChooserView extends android.view.ViewGroup implements androidx.appcompat.widget.ActivityChooserModel.ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends android.widget.BaseAdapter {
        ...
        public android.view.View getView(int r9, android.view.View r10, android.view.ViewGroup r11) {
            ...
            L17:
                ...
                int r4 = androidx.appcompat.C0015R.layout.abc_activity_chooser_view_list_item
                ...
                int r3 = androidx.appcompat.C0015R.string.abc_activity_chooser_view_see_all
            ...
            L42:
                if (r10 == 0) goto L4c
                int r3 = r10.getId()
                int r4 = androidx.appcompat.C0015R.id.list_item
                if (r3 == r4) goto L5c
            L4c:
                androidx.appcompat.widget.ActivityChooserView r3 = r8.this$0
                android.content.Context r3 = r3.getContext()
            ...
            L5c:
                ...
                int r4 = androidx.appcompat.C0015R.id.icon
    ...
    public ActivityChooserView(android.content.Context r11, android.util.AttributeSet r12, int r13) {
            ...
            int r2 = androidx.appcompat.C0015R.styleable.ActivityChooserView_initialActivityCount
            int r0 = r1.getInt(r2, r0)
            r10.mInitialActivityCount = r0
            int r0 = androidx.appcompat.C0015R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable
            android.graphics.drawable.Drawable r0 = r1.getDrawable(r0)
            r1.recycle()
            android.content.Context r2 = r10.getContext()
            android.view.LayoutInflater r2 = android.view.LayoutInflater.from(r2)
            int r3 = androidx.appcompat.C0015R.layout.abc_activity_chooser_view
            r4 = 1
            r2.inflate(r3, r10, r4)
            androidx.appcompat.widget.ActivityChooserView$Callbacks r3 = new androidx.appcompat.widget.ActivityChooserView$Callbacks
            r3.<init>(r10)
            r10.mCallbacks = r3
            int r3 = androidx.appcompat.C0015R.id.activity_chooser_view_content
            android.view.View r3 = r10.findViewById(r3)
            r10.mActivityChooserContent = r3
            android.view.View r3 = r10.mActivityChooserContent
            android.graphics.drawable.Drawable r3 = r3.getBackground()
            r10.mActivityChooserContentBackground = r3
            int r3 = androidx.appcompat.C0015R.id.default_activity_button
            android.view.View r3 = r10.findViewById(r3)
            android.widget.FrameLayout r3 = (android.widget.FrameLayout) r3
            r10.mDefaultActivityButton = r3
            android.widget.FrameLayout r3 = r10.mDefaultActivityButton
            androidx.appcompat.widget.ActivityChooserView$Callbacks r4 = r10.mCallbacks
            r3.setOnClickListener(r4)
            android.widget.FrameLayout r3 = r10.mDefaultActivityButton
            androidx.appcompat.widget.ActivityChooserView$Callbacks r4 = r10.mCallbacks
            r3.setOnLongClickListener(r4)
            android.widget.FrameLayout r3 = r10.mDefaultActivityButton
            int r4 = androidx.appcompat.C0015R.id.image
            android.view.View r3 = r3.findViewById(r4)
            android.widget.ImageView r3 = (android.widget.ImageView) r3
            r10.mDefaultActivityButtonImage = r3
            int r3 = androidx.appcompat.C0015R.id.expand_activities_button
            android.view.View r3 = r10.findViewById(r3)
            android.widget.FrameLayout r3 = (android.widget.FrameLayout) r3
            androidx.appcompat.widget.ActivityChooserView$Callbacks r4 = r10.mCallbacks
            r3.setOnClickListener(r4)
            androidx.appcompat.widget.ActivityChooserView$3 r4 = new androidx.appcompat.widget.ActivityChooserView$3
            r4.<init>(r10)
            r3.setAccessibilityDelegate(r4)
            androidx.appcompat.widget.ActivityChooserView$4 r4 = new androidx.appcompat.widget.ActivityChooserView$4
            r4.<init>(r10, r3)
            r3.setOnTouchListener(r4)
            r10.mExpandActivityOverflowButton = r3
            int r4 = androidx.appcompat.C0015R.id.image
            android.view.View r4 = r3.findViewById(r4)
            android.widget.ImageView r4 = (android.widget.ImageView) r4
            r10.mExpandActivityOverflowButtonImage = r4
            android.widget.ImageView r4 = r10.mExpandActivityOverflowButtonImage
            r4.setImageDrawable(r0)
            androidx.appcompat.widget.ActivityChooserView$ActivityChooserViewAdapter r4 = new androidx.appcompat.widget.ActivityChooserView$ActivityChooserViewAdapter
            r4.<init>(r10)
            r10.mAdapter = r4
            androidx.appcompat.widget.ActivityChooserView$ActivityChooserViewAdapter r4 = r10.mAdapter
            androidx.appcompat.widget.ActivityChooserView$5 r5 = new androidx.appcompat.widget.ActivityChooserView$5
            r5.<init>(r10)
            ...
            int r5 = r5 / 2
            int r6 = androidx.appcompat.C0015R.dimen.abc_config_prefDialogWidth
            int r6 = r4.getDimensionPixelSize(r6)
            int r5 = java.lang.Math.max(r5, r6)
            r10.mListPopupMaxWidth = r5
            return
    }
    ...
    void showPopupUnchecked(int r10) {
        ...
        L80:
            ...
            int r8 = androidx.appcompat.C0015R.string.abc_activitychooserview_choose_application
