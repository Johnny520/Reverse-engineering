...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(androidx.appcompat.app.AlertController r10) {
            ...
            L3d:
                ...
                java.lang.String r2 = r9.mLabelColumn
                ...
                goto L6e
            L5c:
                android.widget.ListAdapter r2 = r9.mAdapter
                if (r2 == 0) goto L64
                android.widget.ListAdapter r2 = r9.mAdapter
                r1 = r2
                goto L6e
            L64:
                androidx.appcompat.app.AlertController$CheckedItemAdapter r2 = new androidx.appcompat.app.AlertController$CheckedItemAdapter
                android.content.Context r4 = r9.mContext
                java.lang.CharSequence[] r5 = r9.mItems
                r2.<init>(r4, r1, r3, r5)
                r1 = r2
            L6e:
                androidx.appcompat.app.AlertController$AlertParams$OnPrepareListViewListener r2 = r9.mOnPrepareListViewListener
                if (r2 == 0) goto L77
                androidx.appcompat.app.AlertController$AlertParams$OnPrepareListViewListener r2 = r9.mOnPrepareListViewListener
                r2.onPrepareListView(r0)
            L77:
                r10.mAdapter = r1
                int r2 = r9.mCheckedItem
                r10.mCheckedItem = r2
                android.content.DialogInterface$OnClickListener r2 = r9.mOnClickListener
                if (r2 == 0) goto L8a
                androidx.appcompat.app.AlertController$AlertParams$3 r2 = new androidx.appcompat.app.AlertController$AlertParams$3
                r2.<init>(r9, r10)
                r0.setOnItemClickListener(r2)
                goto L96
            L8a:
                android.content.DialogInterface$OnMultiChoiceClickListener r2 = r9.mOnCheckboxClickListener
                if (r2 == 0) goto L96
                androidx.appcompat.app.AlertController$AlertParams$4 r2 = new androidx.appcompat.app.AlertController$AlertParams$4
                r2.<init>(r9, r0, r10)
                r0.setOnItemClickListener(r2)
            L96:
                android.widget.AdapterView$OnItemSelectedListener r2 = r9.mOnItemSelectedListener
                if (r2 == 0) goto L9f
                android.widget.AdapterView$OnItemSelectedListener r2 = r9.mOnItemSelectedListener
                r0.setOnItemSelectedListener(r2)
            L9f:
                boolean r2 = r9.mIsSingleChoice
                if (r2 == 0) goto La8
                r2 = 1
                r0.setChoiceMode(r2)
                goto Lb0
            La8:
                boolean r2 = r9.mIsMultiChoice
                if (r2 == 0) goto Lb0
                r2 = 2
                r0.setChoiceMode(r2)
            Lb0:
        ...
        public void apply(androidx.appcompat.app.AlertController r8) {
                r7 = this;
    ...
    public static class RecycleListView extends android.widget.ListView {
        ...
        public RecycleListView(android.content.Context r4, android.util.AttributeSet r5) {
                ...
                int r1 = androidx.appcompat.C0015R.styleable.RecycleListView_paddingBottomNoButtons
                r2 = -1
                int r1 = r0.getDimensionPixelOffset(r1, r2)
                r3.mPaddingBottomNoButtons = r1
                int r1 = androidx.appcompat.C0015R.styleable.RecycleListView_paddingTopNoTitle
                int r1 = r0.getDimensionPixelOffset(r1, r2)
    ...
    public AlertController(android.content.Context r5, androidx.appcompat.app.AppCompatDialog r6, android.view.Window r7) {
            ...
            r1.<init>(r6)
            r4.mHandler = r1
            int[] r1 = androidx.appcompat.C0015R.styleable.AlertDialog
            int r2 = androidx.appcompat.C0015R.attr.alertDialogStyle
            r3 = 0
            android.content.res.TypedArray r1 = r5.obtainStyledAttributes(r3, r1, r2, r0)
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_android_layout
            int r2 = r1.getResourceId(r2, r0)
            r4.mAlertDialogLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_buttonPanelSideLayout
            int r2 = r1.getResourceId(r2, r0)
            r4.mButtonPanelSideLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_listLayout
            int r2 = r1.getResourceId(r2, r0)
            r4.mListLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_multiChoiceItemLayout
            int r2 = r1.getResourceId(r2, r0)
            r4.mMultiChoiceItemLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_singleChoiceItemLayout
            int r2 = r1.getResourceId(r2, r0)
            r4.mSingleChoiceItemLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_listItemLayout
            int r2 = r1.getResourceId(r2, r0)
            r4.mListItemLayout = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_showTitle
            r3 = 1
            boolean r2 = r1.getBoolean(r2, r3)
            r4.mShowTitle = r2
            int r2 = androidx.appcompat.C0015R.styleable.AlertDialog_buttonIconDimen
    ...
    private void setupCustomContent(android.view.ViewGroup r8) {
        ...
        L2c:
            if (r1 == 0) goto L5e
            android.view.Window r2 = r7.mWindow
            int r3 = androidx.appcompat.C0015R.id.custom
    ...
    private void setupTitle(android.view.ViewGroup r8) {
            ...
            r8.addView(r2, r3, r0)
            android.view.Window r2 = r7.mWindow
            int r3 = androidx.appcompat.C0015R.id.title_template
            android.view.View r2 = r2.findViewById(r3)
            r2.setVisibility(r1)
            goto L9c
        L20:
            ...
            if (r2 == 0) goto L89
            android.view.Window r2 = r7.mWindow
            int r3 = androidx.appcompat.C0015R.id.alertTitle
            android.view.View r2 = r2.findViewById(r3)
    ...
    private void setupView() {
            ...
            int r2 = androidx.appcompat.C0015R.id.parentPanel
            android.view.View r1 = r1.findViewById(r2)
            int r2 = androidx.appcompat.C0015R.id.topPanel
            android.view.View r2 = r1.findViewById(r2)
            int r3 = androidx.appcompat.C0015R.id.contentPanel
            android.view.View r3 = r1.findViewById(r3)
            int r4 = androidx.appcompat.C0015R.id.buttonPanel
            android.view.View r4 = r1.findViewById(r4)
            int r5 = androidx.appcompat.C0015R.id.customPanel
            android.view.View r5 = r1.findViewById(r5)
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            r0.setupCustomContent(r5)
            int r6 = androidx.appcompat.C0015R.id.topPanel
            android.view.View r6 = r5.findViewById(r6)
            int r7 = androidx.appcompat.C0015R.id.contentPanel
            android.view.View r7 = r5.findViewById(r7)
            int r8 = androidx.appcompat.C0015R.id.buttonPanel
        ...
        L71:
            if (r12 != 0) goto L8a
            if (r10 == 0) goto L87
            int r14 = androidx.appcompat.C0015R.id.textSpacerNoButtons
        ...
        L98:
            ...
            if (r14 == 0) goto La7
        La1:
            int r14 = androidx.appcompat.C0015R.id.titleDividerNoCustom
    ...
    private static boolean shouldCenterSingleButton(android.content.Context r4) {
            ...
            int r2 = androidx.appcompat.C0015R.attr.alertDialogCenterButtons
            r3 = 1
