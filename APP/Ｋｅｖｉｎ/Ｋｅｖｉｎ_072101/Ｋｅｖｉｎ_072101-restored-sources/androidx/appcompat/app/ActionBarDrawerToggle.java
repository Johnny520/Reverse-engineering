...
public class ActionBarDrawerToggle implements androidx.drawerlayout.widget.DrawerLayout.DrawerListener {
    ...
    private static class FrameworkActionBarDelegate implements androidx.appcompat.app.ActionBarDrawerToggle.Delegate {
        ...
        static class Api18Impl {
            ...
            static void setHomeActionContentDescription(android.app.ActionBar r0, int r1) {
                    r0.setHomeActionContentDescription(r1)
                    return
            }

            static void setHomeAsUpIndicator(android.app.ActionBar r0, android.graphics.drawable.Drawable r1) {
        ...
        public void setActionBarDescription(int r2) {
                ...
                android.app.ActionBar r0 = r0.getActionBar()
                if (r0 == 0) goto Lc
                androidx.appcompat.app.ActionBarDrawerToggle.FrameworkActionBarDelegate.Api18Impl.setHomeActionContentDescription(r0, r2)
            Lc:
                return
        }
        ...
        public void setActionBarUpIndicator(android.graphics.drawable.Drawable r2, int r3) {
                ...
                if (r0 == 0) goto Lf
            L9:
                androidx.appcompat.app.ActionBarDrawerToggle.FrameworkActionBarDelegate.Api18Impl.setHomeAsUpIndicator(r0, r2)
                androidx.appcompat.app.ActionBarDrawerToggle.FrameworkActionBarDelegate.Api18Impl.setHomeActionContentDescription(r0, r3)
            Lf:
                return
        }
    }
