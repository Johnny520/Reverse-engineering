...
public class AppCompatViewInflater {
    ...
    private void checkOnClickListener(android.view.View r5, android.util.AttributeSet r6) {
            ...
            if (r1 == 0) goto L28
            boolean r1 = androidx.core.view.ViewCompat.hasOnClickListeners(r5)
            if (r1 != 0) goto Lf
            goto L28
        Lf:
    ...
    private static android.content.Context themifyContext(android.content.Context r4, android.util.AttributeSet r5, boolean r6, boolean r7) {
            ...
            r2 = 0
            if (r6 == 0) goto L10
            int r3 = androidx.appcompat.C0015R.styleable.View_android_theme
            int r2 = r0.getResourceId(r3, r1)
        L10:
            if (r7 == 0) goto L23
            if (r2 != 0) goto L23
            int r3 = androidx.appcompat.C0015R.styleable.View_theme
            int r2 = r0.getResourceId(r3, r1)
            if (r2 == 0) goto L23
