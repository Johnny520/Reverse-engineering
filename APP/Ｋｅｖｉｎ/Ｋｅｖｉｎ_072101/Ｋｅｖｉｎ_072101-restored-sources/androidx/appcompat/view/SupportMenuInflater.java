...
public class SupportMenuInflater extends android.view.MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(android.util.AttributeSet r4) {
                ...
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_id
                r2 = 0
                int r1 = r0.getResourceId(r1, r2)
                r3.groupId = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_menuCategory
                int r1 = r0.getInt(r1, r2)
                r3.groupCategory = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_orderInCategory
                int r1 = r0.getInt(r1, r2)
                r3.groupOrder = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_checkableBehavior
                int r1 = r0.getInt(r1, r2)
                r3.groupCheckable = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_visible
                r2 = 1
                boolean r1 = r0.getBoolean(r1, r2)
                r3.groupVisible = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuGroup_android_enabled
                boolean r1 = r0.getBoolean(r1, r2)
                r3.groupEnabled = r1
                r0.recycle()
                return
        ...
        public void readItem(android.util.AttributeSet r11) {
                ...
                int r1 = androidx.appcompat.C0015R.styleable.MenuItem_android_id
                r2 = 0
                int r1 = r0.getResourceId(r1, r2)
                r10.itemId = r1
                int r1 = androidx.appcompat.C0015R.styleable.MenuItem_android_menuCategory
                int r3 = r10.groupCategory
                int r1 = r0.getInt(r1, r3)
                int r3 = androidx.appcompat.C0015R.styleable.MenuItem_android_orderInCategory
                ...
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_title
                java.lang.CharSequence r4 = r0.getText(r4)
                r10.itemTitle = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_titleCondensed
                java.lang.CharSequence r4 = r0.getText(r4)
                r10.itemTitleCondensed = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_icon
                int r4 = r0.getResourceId(r4, r2)
                r10.itemIconResId = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_alphabeticShortcut
                java.lang.String r4 = r0.getString(r4)
                char r4 = r10.getShortcut(r4)
                r10.itemAlphabeticShortcut = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_alphabeticModifiers
                r5 = 4096(0x1000, float:5.74E-42)
                int r4 = r0.getInt(r4, r5)
                r10.itemAlphabeticModifiers = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_numericShortcut
                java.lang.String r4 = r0.getString(r4)
                char r4 = r10.getShortcut(r4)
                r10.itemNumericShortcut = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_numericModifiers
                int r4 = r0.getInt(r4, r5)
                r10.itemNumericModifiers = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_checkable
            ...
            L80:
                ...
                r10.itemCheckable = r4
            L84:
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_checked
                boolean r4 = r0.getBoolean(r4, r2)
                r10.itemChecked = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_visible
                boolean r5 = r10.groupVisible
                boolean r4 = r0.getBoolean(r4, r5)
                r10.itemVisible = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_enabled
                boolean r5 = r10.groupEnabled
                boolean r4 = r0.getBoolean(r4, r5)
                r10.itemEnabled = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_showAsAction
                r5 = -1
                int r4 = r0.getInt(r4, r5)
                r10.itemShowAsAction = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_android_onClick
                java.lang.String r4 = r0.getString(r4)
                r10.itemListenerMethodName = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_actionLayout
                int r4 = r0.getResourceId(r4, r2)
                r10.itemActionViewLayout = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_actionViewClass
                java.lang.String r4 = r0.getString(r4)
                r10.itemActionViewClassName = r4
                int r4 = androidx.appcompat.C0015R.styleable.MenuItem_actionProviderClass
                java.lang.String r4 = r0.getString(r4)
            ...
            Lf7:
                int r7 = androidx.appcompat.C0015R.styleable.MenuItem_contentDescription
                java.lang.CharSequence r7 = r0.getText(r7)
                r10.itemContentDescription = r7
                int r7 = androidx.appcompat.C0015R.styleable.MenuItem_tooltipText
                java.lang.CharSequence r7 = r0.getText(r7)
                r10.itemTooltipText = r7
                int r7 = androidx.appcompat.C0015R.styleable.MenuItem_iconTintMode
            ...
            L120:
                int r5 = androidx.appcompat.C0015R.styleable.MenuItem_iconTint
    ...
    public void inflate(int r5, android.view.Menu r6) {
            r4 = this;
            java.lang.String r0 = "Error inflating menu XML"
            boolean r1 = r6 instanceof androidx.core.internal.view.SupportMenu
            if (r1 != 0) goto La
            super.inflate(r5, r6)
            return
        La:
            r1 = 0
            android.content.Context r2 = r4.mContext     // Catch: java.lang.Throwable -> L23 java.io.IOException -> L25 org.xmlpull.v1.XmlPullParserException -> L2c
            android.content.res.Resources r2 = r2.getResources()     // Catch: java.lang.Throwable -> L23 java.io.IOException -> L25 org.xmlpull.v1.XmlPullParserException -> L2c
            android.content.res.XmlResourceParser r2 = r2.getLayout(r5)     // Catch: java.lang.Throwable -> L23 java.io.IOException -> L25 org.xmlpull.v1.XmlPullParserException -> L2c
            r1 = r2
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r1)     // Catch: java.lang.Throwable -> L23 java.io.IOException -> L25 org.xmlpull.v1.XmlPullParserException -> L2c
            r4.parseMenu(r1, r2, r6)     // Catch: java.lang.Throwable -> L23 java.io.IOException -> L25 org.xmlpull.v1.XmlPullParserException -> L2c
            if (r1 == 0) goto L22
            r1.close()
        L22:
            return
        ...
        L25:
            r2 = move-exception
            android.view.InflateException r3 = new android.view.InflateException     // Catch: java.lang.Throwable -> L23
            r3.<init>(r0, r2)     // Catch: java.lang.Throwable -> L23
