...
public class MenuBuilder implements androidx.core.internal.view.SupportMenu {
    ...
    @Override // android.view.Menu
    public int addIntentOptions(int r16, int r17, int r18, android.content.ComponentName r19, android.content.Intent[] r20, android.content.Intent r21, int r22, android.view.MenuItem[] r23) {
            r15 = this;
            r0 = r15
            r1 = r20
            ...
            r4 = r19
            r5 = r21
            java.util.List r6 = r2.queryIntentActivityOptions(r4, r1, r5, r3)
            if (r6 == 0) goto L19
            int r3 = r6.size()
        L19:
            r7 = r22 & 1
        ...
        L35:
            ...
            r10.<init>(r11, r12)
            r9.setComponent(r10)
            java.lang.CharSequence r10 = r8.loadLabel(r2)
            r11 = r16
            r12 = r17
            r13 = r18
            android.view.MenuItem r10 = r15.add(r11, r12, r13, r10)
            android.graphics.drawable.Drawable r14 = r8.loadIcon(r2)
            android.view.MenuItem r10 = r10.setIcon(r14)
            android.view.MenuItem r10 = r10.setIntent(r9)
            if (r23 == 0) goto L6e
            int r14 = r8.specificIndex
            if (r14 < 0) goto L6e
            int r14 = r8.specificIndex
            r23[r14] = r10
        L6e:
    ...
    protected android.view.MenuItem addInternal(int r9, int r10, int r11, java.lang.CharSequence r12) {
            ...
            r4 = r7
            r5 = r12
            androidx.appcompat.view.menu.MenuItemImpl r0 = r0.createNewMenuItem(r1, r2, r3, r4, r5, r6)
            android.view.ContextMenu$ContextMenuInfo r1 = r8.mCurrentMenuInfo
            if (r1 == 0) goto L19
            android.view.ContextMenu$ContextMenuInfo r1 = r8.mCurrentMenuInfo
            r0.setMenuInfo(r1)
        L19:
            java.util.ArrayList<androidx.appcompat.view.menu.MenuItemImpl> r1 = r8.mItems
            java.util.ArrayList<androidx.appcompat.view.menu.MenuItemImpl> r2 = r8.mItems
            int r2 = findInsertIndex(r2, r7)
            r1.add(r2, r0)
            r1 = 1
            r8.onItemsChanged(r1)
            return r0
    }
    ...
    void findItemsWithShortcutForKey(java.util.List<androidx.appcompat.view.menu.MenuItemImpl> r18, int r19, android.view.KeyEvent r20) {
            ...
            r2 = r19
            r3 = r20
            boolean r4 = r17.isQwertyMode()
            int r5 = r20.getModifiers()
