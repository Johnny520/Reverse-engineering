...
public final class SubscribedFlowCollector<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(m124c = "kotlinx.coroutines.flow.SubscribedFlowCollector", m125f = "Share.kt", m126i = {0, 0}, m127l = {419, 423}, m128m = "onSubscription", m129n = {"this", "safeCollector"}, m130s = {"L$0", "L$1"})
    static final class C09971 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        ...
        C09971(kotlinx.coroutines.flow.SubscribedFlowCollector<T> r1, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.SubscribedFlowCollector.C09971> r2) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>(r2)
                return
    ...
    public final java.lang.Object onSubscription(kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
            r7 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector.C09971
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.flow.SubscribedFlowCollector$onSubscription$1 r0 = (kotlinx.coroutines.flow.SubscribedFlowCollector.C09971) r0
            int r1 = r0.label
