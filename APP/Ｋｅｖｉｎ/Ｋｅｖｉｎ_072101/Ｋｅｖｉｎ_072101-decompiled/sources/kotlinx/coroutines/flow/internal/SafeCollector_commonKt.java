...
public final class SafeCollector_commonKt {
    ...
    public static final class C10071<T> implements kotlinx.coroutines.flow.Flow<T> {
        ...
        public C10071(kotlin.jvm.functions.Function2<? super kotlinx.coroutines.flow.FlowCollector<? super T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r1) {
                r0 = this;
                r0.$block = r1
                r0.<init>()
                return
    ...
    public static final kotlinx.coroutines.Job transitiveCoroutineParent(kotlinx.coroutines.Job r2, kotlinx.coroutines.Job r3) {
            r0 = r2
        L1:
            if (r0 != 0) goto L5
            r0 = 0
        ...
        L5:
            ...
            return r0
        L8:
            boolean r1 = r0 instanceof kotlinx.coroutines.internal.ScopeCoroutine
            if (r1 != 0) goto Ld
            return r0
        Ld:
            kotlinx.coroutines.internal.ScopeCoroutine r0 = (kotlinx.coroutines.internal.ScopeCoroutine) r0
            kotlinx.coroutines.Job r0 = r0.getParent$kotlinx_coroutines_core()
            goto L1
    }
