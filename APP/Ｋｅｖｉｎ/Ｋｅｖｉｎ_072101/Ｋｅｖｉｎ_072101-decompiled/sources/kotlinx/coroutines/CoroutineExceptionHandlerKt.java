...
public final class CoroutineExceptionHandlerKt {
    ...
    public static final class C08231 extends kotlin.coroutines.AbstractCoroutineContextElement implements kotlinx.coroutines.CoroutineExceptionHandler {
        ...
        public C08231(kotlin.jvm.functions.Function2<? super kotlin.coroutines.CoroutineContext, ? super java.lang.Throwable, kotlin.Unit> r2, kotlinx.coroutines.CoroutineExceptionHandler.Key r3) {
                r1 = this;
                r1.$handler = r2
                r0 = r3
    ...
    public static final void handleCoroutineException(kotlin.coroutines.CoroutineContext r2, java.lang.Throwable r3) {
            kotlinx.coroutines.CoroutineExceptionHandler$Key r0 = kotlinx.coroutines.CoroutineExceptionHandler.Key     // Catch: java.lang.Throwable -> L16
            kotlin.coroutines.CoroutineContext$Key r0 = (kotlin.coroutines.CoroutineContext.Key) r0     // Catch: java.lang.Throwable -> L16
            kotlin.coroutines.CoroutineContext$Element r0 = r2.get(r0)     // Catch: java.lang.Throwable -> L16
            kotlinx.coroutines.CoroutineExceptionHandler r0 = (kotlinx.coroutines.CoroutineExceptionHandler) r0     // Catch: java.lang.Throwable -> L16
            if (r0 != 0) goto L11
            kotlinx.coroutines.CoroutineExceptionHandlerImplKt.handleCoroutineExceptionImpl(r2, r3)
            return
        L11:
            r1 = 0
            r0.handleException(r2, r3)     // Catch: java.lang.Throwable -> L16
            return
        L16:
            r0 = move-exception
            java.lang.Throwable r1 = handlerException(r3, r0)
            kotlinx.coroutines.CoroutineExceptionHandlerImplKt.handleCoroutineExceptionImpl(r2, r1)
            return
    }

    public static final java.lang.Throwable handlerException(java.lang.Throwable r5, java.lang.Throwable r6) {
            if (r5 != r6) goto L3
            return r5
        L3:
