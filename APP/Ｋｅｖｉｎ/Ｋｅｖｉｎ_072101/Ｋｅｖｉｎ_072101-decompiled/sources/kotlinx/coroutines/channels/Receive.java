...
public abstract class Receive<E> extends kotlinx.coroutines.internal.LockFreeLinkedListNode implements kotlinx.coroutines.channels.ReceiveOrClosed<E> {
    ...
    public /* bridge */ /* synthetic */ java.lang.Object getOfferResult() {
            r1 = this;
            kotlinx.coroutines.internal.Symbol r0 = r1.getOfferResult()
            return r0
    }
    ...
    public kotlin.jvm.functions.Function1<java.lang.Throwable, kotlin.Unit> resumeOnCancellationFun(E r2) {
            r1 = this;
            r0 = 0
            return r0
    }

    public abstract void resumeReceiveClosed(kotlinx.coroutines.channels.Closed<?> r1);
}
