...
@kotlin.Metadata(m114d1 = {"\u0000t\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0016\u0018\u0000 /2\u00020\u0001:\u0001/B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\t\u001a\u00020\nH\u0016J-\u0010\r\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\u0010\u000e\u001a\u0004\u0018\u00010\u000f2\u0011\u0010\u0010\u001a\r\u0012\t\u0012\u00070\u0012¢\u0006\u0002\b\u00130\u0011H\u0016J \u0010\u0014\u001a\u00020\u00042\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u00182\u0006\u0010\u0019\u001a\u00020\u001aH\u0016J\u0006\u0010\u001b\u001a\u00020\u000fJ\u0012\u0010\u001c\u001a\u0004\u0018\u00010\u000f2\u0006\u0010\u0005\u001a\u00020\u0006H\u0016J\u0012\u0010\u001d\u001a\u0004\u0018\u00010\u00012\u0006\u0010\u001e\u001a\u00020\u000fH\u0016J\u0010\u0010\u001f\u001a\u00020 2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J&\u0010!\u001a\u00020\u00042\u0006\u0010\"\u001a\u00020\u000f2\b\b\u0002\u0010#\u001a\u00020\u001a2\n\b\u0002\u0010$\u001a\u0004\u0018\u00010%H\u0016J\u001a\u0010&\u001a\u00020\u00042\u0006\u0010\"\u001a\u00020\u000f2\b\u0010'\u001a\u0004\u0018\u00010\u0001H\u0016J\b\u0010(\u001a\u00020)H\u0016J\u0010\u0010*\u001a\u00020+2\u0006\u0010\t\u001a\u00020\nH\u0016J\b\u0010,\u001a\u00020\nH\u0016J\b\u0010-\u001a\u00020\u000fH\u0016J\u0012\u0010\t\u001a\u0004\u0018\u00010\n2\u0006\u0010.\u001a\u00020+H\u0016¨\u00060"}, m115d2 = {"Lokhttp3/internal/platform/Platform;", "", "()V", "afterHandshake", "", "sslSocket", "Ljavax/net/ssl/SSLSocket;", "buildCertificateChainCleaner", "Lokhttp3/internal/tls/CertificateChainCleaner;", "trustManager", "Ljavax/net/ssl/X509TrustManager;", "buildTrustRootIndex", "Lokhttp3/internal/tls/TrustRootIndex;", "configureTlsExtensions", "hostname", "", "protocols", "", "Lokhttp3/Protocol;", "Lkotlin/jvm/JvmSuppressWildcards;", "connectSocket", "socket", "Ljava/net/Socket;", "address", "Ljava/net/InetSocketAddress;", "connectTimeout", "", "getPrefix", "getSelectedProtocol", "getStackTraceForCloseable", "closer", "isCleartextTrafficPermitted", "", "log", "message", "level", "t", "", "logCloseableLeak", "stackTrace", "newSSLContext", "Ljavax/net/ssl/SSLContext;", "newSslSocketFactory", "Ljavax/net/ssl/SSLSocketFactory;", "platformTrustManager", "toString", "sslSocketFactory", "Companion", "okhttp"}, m116k = 1, m117mv = {1, 8, 0}, m119xi = 48)
public class Platform {
    ...
    /* JADX INFO: compiled from: Platform.kt */
    @kotlin.Metadata(m114d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00130\u00122\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00150\u0012J\u0014\u0010\u0016\u001a\u00020\u00172\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00150\u0012J\b\u0010\u0018\u001a\u00020\u0010H\u0002J\b\u0010\u0019\u001a\u00020\u0010H\u0002J\b\u0010\u001a\u001a\u00020\u0010H\u0002J\b\u0010\u001b\u001a\u00020\u0010H\u0007J\u0010\u0010\u001c\u001a\u00020\u001d2\b\b\u0002\u0010\u000f\u001a\u00020\u0010R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u0011\u0010\u0006\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\bR\u0014\u0010\t\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\bR\u0014\u0010\n\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\n\u0010\bR\u0014\u0010\u000b\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u000b\u0010\bR\u0016\u0010\f\u001a\n \u000e*\u0004\u0018\u00010\r0\rX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001e"}, m115d2 = {"Lokhttp3/internal/platform/Platform$Companion;", "", "()V", "INFO", "", "WARN", "isAndroid", "", "()Z", "isBouncyCastlePreferred", "isConscryptPreferred", "isOpenJSSEPreferred", "logger", "Ljava/util/logging/Logger;", "kotlin.jvm.PlatformType", "platform", "Lokhttp3/internal/platform/Platform;", "alpnProtocolNames", "", "", "protocols", "Lokhttp3/Protocol;", "concatLengthPrefixed", "", "findAndroidPlatform", "findJvmPlatform", "findPlatform", "get", "resetForTests", "", "okhttp"}, m116k = 1, m117mv = {1, 8, 0}, m119xi = 48)
    public static final class Companion {
        ...
        public static final /* synthetic */ okhttp3.internal.platform.Platform access$findPlatform(okhttp3.internal.platform.Platform.Companion r1) {
                okhttp3.internal.platform.Platform r0 = r1.findPlatform()
                return r0
        }
        ...
        private final okhttp3.internal.platform.Platform findJvmPlatform() {
                r3 = this;
                boolean r0 = r3.isConscryptPreferred()
                if (r0 == 0) goto L12
                ...
                return r1
            L12:
                boolean r0 = r3.isBouncyCastlePreferred()
                if (r0 == 0) goto L24
                ...
                return r1
            L24:
                boolean r0 = r3.isOpenJSSEPreferred()
                if (r0 == 0) goto L36
            ...
            L36:
                ...
                return r1
            L42:
                okhttp3.internal.platform.Jdk8WithJettyBootPlatform$Companion r1 = okhttp3.internal.platform.Jdk8WithJettyBootPlatform.Companion
                okhttp3.internal.platform.Platform r1 = r1.buildIfSupported()
                if (r1 == 0) goto L4b
                return r1
            L4b:
                okhttp3.internal.platform.Platform r2 = new okhttp3.internal.platform.Platform
                r2.<init>()
                return r2
        }
        ...
        public final java.util.List<java.lang.String> alpnProtocolNames(java.util.List<? extends okhttp3.Protocol> r11) {
                r10 = this;
            ...
            L16:
                ...
                r7 = r6
                okhttp3.Protocol r7 = (okhttp3.Protocol) r7
                r8 = 0
                okhttp3.Protocol r9 = okhttp3.Protocol.HTTP_1_0
                if (r7 == r9) goto L2a
                r9 = 1
                goto L2b
            L2a:
        ...
        public final byte[] concatLengthPrefixed(java.util.List<? extends okhttp3.Protocol> r5) {
                r4 = this;
                java.lang.String r0 = "protocols"
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r5, r0)
                okio.Buffer r0 = new okio.Buffer
                r0.<init>()
                java.util.List r1 = r4.alpnProtocolNames(r5)
    ...
    public okhttp3.internal.tls.CertificateChainCleaner buildCertificateChainCleaner(javax.net.ssl.X509TrustManager r3) {
            r2 = this;
            ...
            okhttp3.internal.tls.TrustRootIndex r1 = r2.buildTrustRootIndex(r3)
            r0.<init>(r1)
    ...
    public okhttp3.internal.tls.TrustRootIndex buildTrustRootIndex(javax.net.ssl.X509TrustManager r4) {
            ...
            java.security.cert.X509Certificate[] r1 = r4.getAcceptedIssuers()
            java.lang.String r2 = "trustManager.acceptedIssuers"
    ...
    public void log(java.lang.String r3, int r4, java.lang.Throwable r5) {
            r2 = this;
        ...
        Ld:
            java.util.logging.Logger r1 = okhttp3.internal.platform.Platform.logger
            r1.log(r0, r3, r5)
            return
    }
    ...
    public javax.net.ssl.SSLSocketFactory newSslSocketFactory(javax.net.ssl.X509TrustManager r6) {
            ...
            javax.net.ssl.SSLContext r0 = r5.newSSLContext()     // Catch: java.security.GeneralSecurityException -> L22
            r1 = r0
            r2 = 0
            r3 = 1
            javax.net.ssl.TrustManager[] r3 = new javax.net.ssl.TrustManager[r3]     // Catch: java.security.GeneralSecurityException -> L22
            r4 = 0
            r3[r4] = r6     // Catch: java.security.GeneralSecurityException -> L22
            r4 = 0
            r1.init(r4, r3, r4)     // Catch: java.security.GeneralSecurityException -> L22
            javax.net.ssl.SSLSocketFactory r0 = r0.getSocketFactory()     // Catch: java.security.GeneralSecurityException -> L22
            java.lang.String r1 = "newSSLContext().apply {\n…ll)\n      }.socketFactory"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)     // Catch: java.security.GeneralSecurityException -> L22
            return r0
        L22:
            r0 = move-exception
            ...
            r2.<init>()
            java.lang.String r3 = "No System TLS: "
    ...
    public javax.net.ssl.X509TrustManager trustManager(javax.net.ssl.SSLSocketFactory r6) {
            ...
            java.lang.Class r1 = java.lang.Class.forName(r1)     // Catch: java.lang.RuntimeException -> L27 java.lang.ClassNotFoundException -> L3a
            java.lang.String r2 = "sslContextClass"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r2)     // Catch: java.lang.RuntimeException -> L27 java.lang.ClassNotFoundException -> L3a
            java.lang.String r2 = "context"
            java.lang.Object r2 = okhttp3.internal.Util.readFieldOrNull(r6, r1, r2)     // Catch: java.lang.RuntimeException -> L27 java.lang.ClassNotFoundException -> L3a
            if (r2 != 0) goto L1b
            return r0
        L1b:
            java.lang.Class<javax.net.ssl.X509TrustManager> r3 = javax.net.ssl.X509TrustManager.class
            java.lang.String r4 = "trustManager"
            java.lang.Object r3 = okhttp3.internal.Util.readFieldOrNull(r2, r3, r4)     // Catch: java.lang.RuntimeException -> L27 java.lang.ClassNotFoundException -> L3a
            javax.net.ssl.X509TrustManager r3 = (javax.net.ssl.X509TrustManager) r3     // Catch: java.lang.RuntimeException -> L27 java.lang.ClassNotFoundException -> L3a
            r0 = r3
            goto L3c
        L27:
            r1 = move-exception
            ...
            java.lang.String r3 = "java.lang.reflect.InaccessibleObjectException"
