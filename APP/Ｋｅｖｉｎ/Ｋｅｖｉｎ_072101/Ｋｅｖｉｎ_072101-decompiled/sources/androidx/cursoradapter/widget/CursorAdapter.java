...
public abstract class CursorAdapter extends android.widget.BaseAdapter implements android.widget.Filterable, androidx.cursoradapter.widget.CursorFilter.CursorFilterClient {
    ...
    void init(android.content.Context r4, android.database.Cursor r5, int r6) {
        ...
        L21:
            ...
            r2 = 2
            if (r1 != r2) goto L37
            androidx.cursoradapter.widget.CursorAdapter$ChangeObserver r1 = new androidx.cursoradapter.widget.CursorAdapter$ChangeObserver
            r1.<init>(r3)
            r3.mChangeObserver = r1
            androidx.cursoradapter.widget.CursorAdapter$MyDataSetObserver r1 = new androidx.cursoradapter.widget.CursorAdapter$MyDataSetObserver
            r1.<init>(r3)
            r3.mDataSetObserver = r1
            goto L3c
        L37:
            r1 = 0
            r3.mChangeObserver = r1
        ...
        L3c:
            if (r0 == 0) goto L50
            androidx.cursoradapter.widget.CursorAdapter$ChangeObserver r1 = r3.mChangeObserver
            if (r1 == 0) goto L47
            androidx.cursoradapter.widget.CursorAdapter$ChangeObserver r1 = r3.mChangeObserver
            r5.registerContentObserver(r1)
        L47:
            android.database.DataSetObserver r1 = r3.mDataSetObserver
            if (r1 == 0) goto L50
            android.database.DataSetObserver r1 = r3.mDataSetObserver
            r5.registerDataSetObserver(r1)
        L50:
            return
    }
