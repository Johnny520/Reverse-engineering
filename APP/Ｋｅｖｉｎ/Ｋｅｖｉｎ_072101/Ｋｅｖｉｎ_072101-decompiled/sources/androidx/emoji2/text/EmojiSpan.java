...
public abstract class EmojiSpan extends android.text.style.ReplacementSpan {
    ...
    EmojiSpan(androidx.emoji2.text.EmojiMetadata r2) {
            r1 = this;
            r1.<init>()
    ...
    public final int getId() {
            r1 = this;
            androidx.emoji2.text.EmojiMetadata r0 = r1.getMetadata()
            int r0 = r0.getId()
            return r0
    }
    ...
    public final androidx.emoji2.text.EmojiMetadata getMetadata() {
            r1 = this;
            androidx.emoji2.text.EmojiMetadata r0 = r1.mMetadata
            return r0
    }
    ...
    public int getSize(android.graphics.Paint r4, java.lang.CharSequence r5, int r6, int r7, android.graphics.Paint.FontMetricsInt r8) {
            ...
            float r1 = r1 * r2
            androidx.emoji2.text.EmojiMetadata r2 = r3.mMetadata
            short r2 = r2.getHeight()
            float r2 = (float) r2
            float r1 = r1 / r2
            r3.mRatio = r1
            androidx.emoji2.text.EmojiMetadata r1 = r3.mMetadata
            short r1 = r1.getHeight()
            float r1 = (float) r1
            float r2 = r3.mRatio
            float r1 = r1 * r2
            int r1 = (int) r1
