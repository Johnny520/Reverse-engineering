...
public class EmojiCompat {
    ...
    private static final class CompatInternal19 extends androidx.emoji2.text.EmojiCompat.CompatInternal {
        ...
        void onMetadataLoadSuccess(androidx.emoji2.text.MetadataRepo r10) {
            ...
            Lf:
                ...
                androidx.emoji2.text.EmojiProcessor r0 = new androidx.emoji2.text.EmojiProcessor
                androidx.emoji2.text.MetadataRepo r4 = r9.mMetadataRepo
                androidx.emoji2.text.EmojiCompat$SpanFactory r5 = new androidx.emoji2.text.EmojiCompat$SpanFactory
                r5.<init>()
                androidx.emoji2.text.EmojiCompat r1 = r9.mEmojiCompat
                androidx.emoji2.text.EmojiCompat$GlyphChecker r6 = androidx.emoji2.text.EmojiCompat.access$000(r1)
                androidx.emoji2.text.EmojiCompat r1 = r9.mEmojiCompat
                boolean r7 = r1.mUseEmojiAsDefaultStyle
                androidx.emoji2.text.EmojiCompat r1 = r9.mEmojiCompat
                int[] r8 = r1.mEmojiAsDefaultStyleExceptions
                r3 = r0
        ...
        java.lang.CharSequence process(java.lang.CharSequence r7, int r8, int r9, int r10, boolean r11) {
                ...
                r4 = r10
                r5 = r11
                java.lang.CharSequence r0 = r0.process(r1, r2, r3, r4, r5)
                return r0
        }
    ...
    static class SpanFactory {
        ...
        androidx.emoji2.text.EmojiSpan createSpan(androidx.emoji2.text.EmojiMetadata r2) {
                r1 = this;
    ...
    private EmojiCompat(androidx.emoji2.text.EmojiCompat.Config r3) {
            ...
            java.util.Set<androidx.emoji2.text.EmojiCompat$InitCallback> r0 = r3.mInitCallbacks
            if (r0 == 0) goto L52
            java.util.Set<androidx.emoji2.text.EmojiCompat$InitCallback> r0 = r3.mInitCallbacks
            boolean r0 = r0.isEmpty()
            if (r0 != 0) goto L52
            java.util.Set<androidx.emoji2.text.EmojiCompat$InitCallback> r0 = r2.mInitCallbacks
            java.util.Set<androidx.emoji2.text.EmojiCompat$InitCallback> r1 = r3.mInitCallbacks
            r0.addAll(r1)
        L52:
            androidx.emoji2.text.EmojiCompat$CompatInternal19 r0 = new androidx.emoji2.text.EmojiCompat$CompatInternal19
            r0.<init>(r2)
            r2.mHelper = r0
            r2.loadMetadata()
            return
    ...
    static /* synthetic */ androidx.emoji2.text.EmojiCompat.GlyphChecker access$000(androidx.emoji2.text.EmojiCompat r1) {
    ...
    public java.lang.CharSequence process(java.lang.CharSequence r8, int r9, int r10, int r11, int r12) {
        ...
        L56:
            ...
            r5 = r11
            r6 = r0
            java.lang.CharSequence r1 = r1.process(r2, r3, r4, r5, r6)
            return r1
        L62:
            return r8
    }
