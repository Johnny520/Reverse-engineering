...
public class Table {
    ...
    protected java.nio.ByteBuffer f38bb;
    ...
    protected int __indirect(int r2) {
            r1 = this;
            java.nio.ByteBuffer r0 = r1.f38bb
            int r0 = r0.getInt(r2)
            int r0 = r0 + r2
            return r0
    }
    ...
    protected int __offset(int r3) {
            ...
            if (r3 >= r0) goto Le
            java.nio.ByteBuffer r0 = r2.f38bb
    ...
    protected void __reset(int r4, java.nio.ByteBuffer r5) {
            r3 = this;
            r3.f38bb = r5
            java.nio.ByteBuffer r0 = r3.f38bb
            if (r0 == 0) goto L20
            r3.bb_pos = r4
            int r0 = r3.bb_pos
            java.nio.ByteBuffer r1 = r3.f38bb
            int r2 = r3.bb_pos
            int r1 = r1.getInt(r2)
            int r0 = r0 - r1
            r3.vtable_start = r0
    ...
    protected java.nio.ByteBuffer __vector_as_bytebuffer(int r5, int r6) {
            ...
            return r1
        L8:
            java.nio.ByteBuffer r1 = r4.f38bb
