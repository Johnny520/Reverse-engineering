...
public abstract class AppCompatDelegate {
    ...
    static {
            androidx.appcompat.app.AppLocalesStorageHelper$SerialExecutor r0 = new androidx.appcompat.app.AppLocalesStorageHelper$SerialExecutor
            androidx.appcompat.app.AppLocalesStorageHelper$ThreadPerTaskExecutor r1 = new androidx.appcompat.app.AppLocalesStorageHelper$ThreadPerTaskExecutor
            r1.<init>()
            r0.<init>(r1)
    ...
    static /* synthetic */ void lambda$syncRequestedAndStoredLocales$1(android.content.Context r1) {
            androidx.appcompat.app.AppLocalesStorageHelper.syncLocalesToFramework(r1)
            r0 = 1
            androidx.appcompat.app.AppCompatDelegate.sIsFrameworkSyncChecked = r0
            return
    }
    ...
    static void syncRequestedAndStoredLocales(android.content.Context r3) {
        ...
        L1c:
            ...
            if (r1 != 0) goto L32
        L28:
            java.lang.String r1 = androidx.appcompat.app.AppLocalesStorageHelper.readLocales(r3)     // Catch: java.lang.Throwable -> L5a
        ...
        L41:
            ...
            androidx.appcompat.app.AppLocalesStorageHelper.persistLocales(r3, r1)     // Catch: java.lang.Throwable -> L5a
        L58:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L5a
        L59:
            return
