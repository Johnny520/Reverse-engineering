...
public class DrawableContainerCompat extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    private void initializeDrawableForDisplay(android.graphics.drawable.Drawable r6) {
        ...
        Lb:
            ...
            r6.setCallback(r0)
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            int r0 = r0.mEnterFadeDuration     // Catch: java.lang.Throwable -> L9d
            if (r0 > 0) goto L27
            boolean r0 = r5.mHasAlpha     // Catch: java.lang.Throwable -> L9d
            if (r0 == 0) goto L27
            int r0 = r5.mAlpha     // Catch: java.lang.Throwable -> L9d
            r6.setAlpha(r0)     // Catch: java.lang.Throwable -> L9d
        L27:
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            boolean r0 = r0.mHasColorFilter     // Catch: java.lang.Throwable -> L9d
            if (r0 == 0) goto L35
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            android.graphics.ColorFilter r0 = r0.mColorFilter     // Catch: java.lang.Throwable -> L9d
            r6.setColorFilter(r0)     // Catch: java.lang.Throwable -> L9d
            goto L4f
        L35:
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            boolean r0 = r0.mHasTintList     // Catch: java.lang.Throwable -> L9d
            if (r0 == 0) goto L42
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            android.content.res.ColorStateList r0 = r0.mTintList     // Catch: java.lang.Throwable -> L9d
            androidx.core.graphics.drawable.DrawableCompat.setTintList(r6, r0)     // Catch: java.lang.Throwable -> L9d
        L42:
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            boolean r0 = r0.mHasTintMode     // Catch: java.lang.Throwable -> L9d
            if (r0 == 0) goto L4f
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            android.graphics.PorterDuff$Mode r0 = r0.mTintMode     // Catch: java.lang.Throwable -> L9d
            androidx.core.graphics.drawable.DrawableCompat.setTintMode(r6, r0)     // Catch: java.lang.Throwable -> L9d
        L4f:
            boolean r0 = r5.isVisible()     // Catch: java.lang.Throwable -> L9d
            r1 = 1
            r6.setVisible(r0, r1)     // Catch: java.lang.Throwable -> L9d
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            boolean r0 = r0.mDither     // Catch: java.lang.Throwable -> L9d
            r6.setDither(r0)     // Catch: java.lang.Throwable -> L9d
            int[] r0 = r5.getState()     // Catch: java.lang.Throwable -> L9d
            r6.setState(r0)     // Catch: java.lang.Throwable -> L9d
            int r0 = r5.getLevel()     // Catch: java.lang.Throwable -> L9d
            r6.setLevel(r0)     // Catch: java.lang.Throwable -> L9d
            android.graphics.Rect r0 = r5.getBounds()     // Catch: java.lang.Throwable -> L9d
            r6.setBounds(r0)     // Catch: java.lang.Throwable -> L9d
            int r0 = androidx.core.graphics.drawable.DrawableCompat.getLayoutDirection(r5)     // Catch: java.lang.Throwable -> L9d
            androidx.core.graphics.drawable.DrawableCompat.setLayoutDirection(r6, r0)     // Catch: java.lang.Throwable -> L9d
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$DrawableContainerState r0 = r5.mDrawableContainerState     // Catch: java.lang.Throwable -> L9d
            boolean r0 = r0.mAutoMirrored     // Catch: java.lang.Throwable -> L9d
            androidx.core.graphics.drawable.DrawableCompat.setAutoMirrored(r6, r0)     // Catch: java.lang.Throwable -> L9d
            android.graphics.Rect r0 = r5.mHotspotBounds     // Catch: java.lang.Throwable -> L9d
            if (r0 == 0) goto L92
            int r1 = r0.left     // Catch: java.lang.Throwable -> L9d
            int r2 = r0.top     // Catch: java.lang.Throwable -> L9d
            int r3 = r0.right     // Catch: java.lang.Throwable -> L9d
            int r4 = r0.bottom     // Catch: java.lang.Throwable -> L9d
            androidx.core.graphics.drawable.DrawableCompat.setHotspotBounds(r6, r1, r2, r3, r4)     // Catch: java.lang.Throwable -> L9d
        L92:
            androidx.appcompat.graphics.drawable.DrawableContainerCompat$BlockInvalidateCallback r0 = r5.mBlockInvalidateCallback
