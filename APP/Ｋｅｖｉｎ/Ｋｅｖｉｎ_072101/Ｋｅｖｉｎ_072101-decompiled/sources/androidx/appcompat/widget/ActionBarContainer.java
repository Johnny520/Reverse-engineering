...
public class ActionBarContainer extends android.widget.FrameLayout {
    ...
    public ActionBarContainer(android.content.Context r6, android.util.AttributeSet r7) {
            ...
            int r2 = androidx.appcompat.C0015R.styleable.ActionBar_background
            android.graphics.drawable.Drawable r2 = r1.getDrawable(r2)
            r5.mBackground = r2
            int r2 = androidx.appcompat.C0015R.styleable.ActionBar_backgroundStacked
            android.graphics.drawable.Drawable r2 = r1.getDrawable(r2)
            r5.mStackedBackground = r2
            int r2 = androidx.appcompat.C0015R.styleable.ActionBar_height
            r3 = -1
            int r2 = r1.getDimensionPixelSize(r2, r3)
            r5.mHeight = r2
            int r2 = r5.getId()
            int r3 = androidx.appcompat.C0015R.id.split_action_bar
            r4 = 1
            if (r2 != r3) goto L3d
            r5.mIsSplit = r4
            int r2 = androidx.appcompat.C0015R.styleable.ActionBar_backgroundSplit
            android.graphics.drawable.Drawable r2 = r1.getDrawable(r2)
    ...
    public void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
            ...
            android.view.View r0 = r8.mTabContainer
            r1 = 8
            r2 = 0
            if (r0 == 0) goto L12
        ...
        L13:
            ...
            int r7 = r4.bottomMargin
            int r7 = r1 - r7
            r0.layout(r10, r6, r12, r7)
        L35:
            r1 = 0
            boolean r4 = r8.mIsSplit
            if (r4 == 0) goto L4e
            android.graphics.drawable.Drawable r4 = r8.mSplitBackground
            if (r4 == 0) goto Lc6
            android.graphics.drawable.Drawable r4 = r8.mSplitBackground
        ...
        L4e:
            ...
            if (r4 == 0) goto La8
            android.view.View r4 = r8.mActionBarView
            int r4 = r4.getVisibility()
            if (r4 != 0) goto L78
            android.graphics.drawable.Drawable r2 = r8.mBackground
            android.view.View r4 = r8.mActionBarView
            int r4 = r4.getLeft()
            android.view.View r5 = r8.mActionBarView
            int r5 = r5.getTop()
            android.view.View r6 = r8.mActionBarView
            int r6 = r6.getRight()
            android.view.View r7 = r8.mActionBarView
            int r7 = r7.getBottom()
            r2.setBounds(r4, r5, r6, r7)
            goto La7
        L78:
            android.view.View r4 = r8.mContextView
            if (r4 == 0) goto La2
            android.view.View r4 = r8.mContextView
            int r4 = r4.getVisibility()
            if (r4 != 0) goto La2
            ...
            android.view.View r4 = r8.mContextView
            int r4 = r4.getLeft()
            android.view.View r5 = r8.mContextView
            int r5 = r5.getTop()
            android.view.View r6 = r8.mContextView
            int r6 = r6.getRight()
            android.view.View r7 = r8.mContextView
            int r7 = r7.getBottom()
            r2.setBounds(r4, r5, r6, r7)
            goto La7
        La2:
            android.graphics.drawable.Drawable r4 = r8.mBackground
            r4.setBounds(r2, r2, r2, r2)
        La7:
            r1 = 1
        La8:
            r8.mIsStacked = r3
            if (r3 == 0) goto Lc6
            android.graphics.drawable.Drawable r2 = r8.mStackedBackground
            if (r2 == 0) goto Lc6
            android.graphics.drawable.Drawable r2 = r8.mStackedBackground
            int r4 = r0.getLeft()
            int r5 = r0.getTop()
