...
public class ActionBarContextView extends androidx.appcompat.widget.AbsActionBarView {
    ...
    public ActionBarContextView(android.content.Context r4, android.util.AttributeSet r5, int r6) {
            ...
            int r2 = androidx.appcompat.C0015R.styleable.ActionMode_background
            android.graphics.drawable.Drawable r2 = r0.getDrawable(r2)
            androidx.core.view.ViewCompat.setBackground(r3, r2)
            int r2 = androidx.appcompat.C0015R.styleable.ActionMode_titleTextStyle
            int r2 = r0.getResourceId(r2, r1)
            r3.mTitleStyleRes = r2
            int r2 = androidx.appcompat.C0015R.styleable.ActionMode_subtitleTextStyle
            int r2 = r0.getResourceId(r2, r1)
            r3.mSubtitleStyleRes = r2
            int r2 = androidx.appcompat.C0015R.styleable.ActionMode_height
            int r1 = r0.getLayoutDimension(r2, r1)
            r3.mContentHeight = r1
            int r1 = androidx.appcompat.C0015R.styleable.ActionMode_closeItemLayout
            int r2 = androidx.appcompat.C0015R.layout.abc_action_mode_close_item_material
    ...
    private void initTitle() {
            ...
            int r2 = androidx.appcompat.C0015R.id.action_bar_title
            android.view.View r1 = r1.findViewById(r2)
            android.widget.TextView r1 = (android.widget.TextView) r1
            r6.mTitleView = r1
            android.widget.LinearLayout r1 = r6.mTitleLayout
            int r2 = androidx.appcompat.C0015R.id.action_bar_subtitle
            android.view.View r1 = r1.findViewById(r2)
            android.widget.TextView r1 = (android.widget.TextView) r1
            r6.mSubtitleView = r1
    ...
    protected void onLayout(boolean r16, int r17, int r18, int r19, int r20) {
            r15 = this;
            r6 = r15
            boolean r7 = androidx.appcompat.widget.ViewUtils.isLayoutRtl(r15)
            if (r7 == 0) goto Lf
            int r0 = r19 - r17
        ...
        L13:
            int r8 = r15.getPaddingTop()
            int r1 = r20 - r18
            int r2 = r15.getPaddingTop()
            int r1 = r1 - r2
            int r2 = r15.getPaddingBottom()
            int r9 = r1 - r2
            android.view.View r1 = r6.mClose
            r10 = 8
            if (r1 == 0) goto L61
            android.view.View r1 = r6.mClose
        ...
        L9c:
            r10 = r0
            androidx.appcompat.widget.ActionMenuView r0 = r6.mMenuView
            if (r0 == 0) goto Lae
            androidx.appcompat.widget.ActionMenuView r1 = r6.mMenuView
            r5 = r7 ^ 1
            r0 = r15
            r2 = r10
            r3 = r8
