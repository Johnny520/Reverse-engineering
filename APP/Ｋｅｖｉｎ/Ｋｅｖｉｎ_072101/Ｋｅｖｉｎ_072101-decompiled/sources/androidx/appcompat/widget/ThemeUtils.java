...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(android.view.View r4, android.content.Context r5) {
            int[] r0 = androidx.appcompat.C0015R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r5.obtainStyledAttributes(r0)
            int r1 = androidx.appcompat.C0015R.styleable.AppCompatTheme_windowActionBar     // Catch: java.lang.Throwable -> L35
