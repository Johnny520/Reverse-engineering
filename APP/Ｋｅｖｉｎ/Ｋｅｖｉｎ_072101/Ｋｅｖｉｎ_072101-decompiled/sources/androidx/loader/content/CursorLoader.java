...
public class CursorLoader extends androidx.loader.content.AsyncTaskLoader<android.database.Cursor> {
    ...
    public android.database.Cursor loadInBackground() {
            r9 = this;
            monitor-enter(r9)
            boolean r0 = r9.isLoadInBackgroundCanceled()     // Catch: java.lang.Throwable -> L50
            if (r0 != 0) goto L4a
            androidx.core.os.CancellationSignal r0 = new androidx.core.os.CancellationSignal     // Catch: java.lang.Throwable -> L50
            r0.<init>()     // Catch: java.lang.Throwable -> L50
            r9.mCancellationSignal = r0     // Catch: java.lang.Throwable -> L50
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L50
            r0 = 0
            android.content.Context r1 = r9.getContext()     // Catch: java.lang.Throwable -> L41
            android.content.ContentResolver r2 = r1.getContentResolver()     // Catch: java.lang.Throwable -> L41
            android.net.Uri r3 = r9.mUri     // Catch: java.lang.Throwable -> L41
            java.lang.String[] r4 = r9.mProjection     // Catch: java.lang.Throwable -> L41
            java.lang.String r5 = r9.mSelection     // Catch: java.lang.Throwable -> L41
            java.lang.String[] r6 = r9.mSelectionArgs     // Catch: java.lang.Throwable -> L41
            java.lang.String r7 = r9.mSortOrder     // Catch: java.lang.Throwable -> L41
            androidx.core.os.CancellationSignal r8 = r9.mCancellationSignal     // Catch: java.lang.Throwable -> L41
            android.database.Cursor r1 = androidx.core.content.ContentResolverCompat.query(r2, r3, r4, r5, r6, r7, r8)     // Catch: java.lang.Throwable -> L41
            if (r1 == 0) goto L38
            r1.getCount()     // Catch: java.lang.RuntimeException -> L33 java.lang.Throwable -> L41
            androidx.loader.content.Loader<android.database.Cursor>$ForceLoadContentObserver r2 = r9.mObserver     // Catch: java.lang.RuntimeException -> L33 java.lang.Throwable -> L41
            r1.registerContentObserver(r2)     // Catch: java.lang.RuntimeException -> L33 java.lang.Throwable -> L41
            goto L38
        L33:
            r2 = move-exception
        ...
        L38:
            monitor-enter(r9)
            r9.mCancellationSignal = r0     // Catch: java.lang.Throwable -> L3e
        ...
        L41:
            r1 = move-exception
            monitor-enter(r9)
            r9.mCancellationSignal = r0     // Catch: java.lang.Throwable -> L47
        ...
        L47:
            ...
            throw r0
        L4a:
            androidx.core.os.OperationCanceledException r0 = new androidx.core.os.OperationCanceledException     // Catch: java.lang.Throwable -> L50
            r0.<init>()     // Catch: java.lang.Throwable -> L50
