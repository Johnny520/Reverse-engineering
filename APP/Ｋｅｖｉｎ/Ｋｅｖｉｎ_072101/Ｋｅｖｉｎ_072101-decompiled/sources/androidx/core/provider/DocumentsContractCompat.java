...
public final class DocumentsContractCompat {
    ...
    private static class DocumentsContractApi19Impl {
        ...
        static boolean deleteDocument(android.content.ContentResolver r1, android.net.Uri r2) throws java.io.FileNotFoundException {
                boolean r0 = android.provider.DocumentsContract.deleteDocument(r1, r2)
                return r0
        }

        static java.lang.String getDocumentId(android.net.Uri r1) {
                java.lang.String r0 = android.provider.DocumentsContract.getDocumentId(r1)
                return r0
        }

        static boolean isDocumentUri(android.content.Context r1, android.net.Uri r2) {
    ...
    public static android.net.Uri buildDocumentUri(java.lang.String r1, java.lang.String r2) {
            android.net.Uri r0 = androidx.core.provider.DocumentsContractCompat.DocumentsContractApi19Impl.buildDocumentUri(r1, r2)
            return r0
    }
    ...
    public static java.lang.String getDocumentId(android.net.Uri r1) {
            java.lang.String r0 = androidx.core.provider.DocumentsContractCompat.DocumentsContractApi19Impl.getDocumentId(r1)
            return r0
    }
    ...
    public static boolean isDocumentUri(android.content.Context r1, android.net.Uri r2) {
            boolean r0 = androidx.core.provider.DocumentsContractCompat.DocumentsContractApi19Impl.isDocumentUri(r1, r2)
            return r0
    }
