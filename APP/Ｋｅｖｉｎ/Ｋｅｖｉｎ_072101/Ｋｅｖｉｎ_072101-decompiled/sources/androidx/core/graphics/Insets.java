...
public final class Insets {
    ...
    static class Api29Impl {
        ...
        static android.graphics.Insets m14of(int r1, int r2, int r3, int r4) {
    ...
    public static androidx.core.graphics.Insets add(androidx.core.graphics.Insets r5, androidx.core.graphics.Insets r6) {
            ...
            int r4 = r6.bottom
            int r3 = r3 + r4
            androidx.core.graphics.Insets r0 = m12of(r0, r1, r2, r3)
            return r0
    }
    ...
    /* JADX INFO: renamed from: of */
    public static androidx.core.graphics.Insets m12of(int r1, int r2, int r3, int r4) {
            if (r1 != 0) goto Lb
            if (r2 != 0) goto Lb
            if (r3 != 0) goto Lb
            if (r4 != 0) goto Lb
    ...
    /* JADX INFO: renamed from: of */
    public static androidx.core.graphics.Insets m13of(android.graphics.Rect r4) {
            int r0 = r4.left
            int r1 = r4.top
            int r2 = r4.right
            int r3 = r4.bottom
    ...
    public android.graphics.Insets toPlatformInsets() {
            ...
            int r2 = r4.right
            int r3 = r4.bottom
            android.graphics.Insets r0 = androidx.core.graphics.Insets.Api29Impl.m14of(r0, r1, r2, r3)
            return r0
    }
