...
public final class DrawableCompat {
    ...
    static class Api19Impl {
        ...
        static int getAlpha(android.graphics.drawable.Drawable r1) {
                int r0 = r1.getAlpha()
                return r0
        }

        static android.graphics.drawable.Drawable getChild(android.graphics.drawable.DrawableContainer.DrawableContainerState r1, int r2) {
                android.graphics.drawable.Drawable r0 = r1.getChild(r2)
                return r0
        }

        static android.graphics.drawable.Drawable getDrawable(android.graphics.drawable.InsetDrawable r1) {
                android.graphics.drawable.Drawable r0 = r1.getDrawable()
                return r0
        }

        static boolean isAutoMirrored(android.graphics.drawable.Drawable r1) {
    ...
    public static int getAlpha(android.graphics.drawable.Drawable r1) {
            int r0 = androidx.core.graphics.drawable.DrawableCompat.Api19Impl.getAlpha(r1)
            return r0
    }
    ...
    public static boolean isAutoMirrored(android.graphics.drawable.Drawable r1) {
            boolean r0 = androidx.core.graphics.drawable.DrawableCompat.Api19Impl.isAutoMirrored(r1)
            return r0
    }
