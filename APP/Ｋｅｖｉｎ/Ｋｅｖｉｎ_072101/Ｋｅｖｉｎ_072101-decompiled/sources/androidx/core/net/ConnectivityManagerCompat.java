...
public final class ConnectivityManagerCompat {
    ...
    static class Api16Impl {
        ...
        static boolean isActiveNetworkMetered(android.net.ConnectivityManager r1) {
    ...
    public static boolean isActiveNetworkMetered(android.net.ConnectivityManager r1) {
            boolean r0 = androidx.core.net.ConnectivityManagerCompat.Api16Impl.isActiveNetworkMetered(r1)
            return r0
    }
}
