...
public final class LocationCompat {
    ...
    private static class Api17Impl {
        ...
        static long getElapsedRealtimeNanos(android.location.Location r2) {
    ...
    private static class Api18Impl {
        ...
        static boolean isMock(android.location.Location r1) {
                boolean r0 = r1.isFromMockProvider()
                return r0
        }
    }
    ...
    private static class Api28Impl {
        ...
        static void removeBearingAccuracy(android.location.Location r25) {
                r0 = r25
                boolean r1 = r25.hasBearingAccuracy()
                if (r1 != 0) goto L9
                return
            L9:
                java.lang.String r1 = r25.getProvider()
                long r2 = r25.getTime()
                long r4 = r25.getElapsedRealtimeNanos()
                double r6 = r25.getLatitude()
                double r8 = r25.getLongitude()
                boolean r10 = r25.hasAltitude()
                double r11 = r25.getAltitude()
                boolean r13 = r25.hasSpeed()
                float r14 = r25.getSpeed()
                boolean r15 = r25.hasBearing()
                r16 = r15
                float r15 = r25.getBearing()
                boolean r17 = r25.hasAccuracy()
                r18 = r15
                float r15 = r25.getAccuracy()
                boolean r19 = r25.hasVerticalAccuracy()
                r20 = r15
                float r15 = r25.getVerticalAccuracyMeters()
                boolean r21 = r25.hasSpeedAccuracy()
                r22 = r15
                float r15 = r25.getSpeedAccuracyMetersPerSecond()
                r23 = r15
                android.os.Bundle r15 = r25.getExtras()
                r25.reset()
                r0.setProvider(r1)
                r0.setTime(r2)
        ...
        static void removeSpeedAccuracy(android.location.Location r25) {
                r0 = r25
                boolean r1 = r25.hasSpeedAccuracy()
                if (r1 != 0) goto L9
                return
            L9:
                java.lang.String r1 = r25.getProvider()
                ...
                r20 = r15
                float r15 = r25.getVerticalAccuracyMeters()
                boolean r21 = r25.hasBearingAccuracy()
                r22 = r15
                float r15 = r25.getBearingAccuracyDegrees()
                r23 = r15
                android.os.Bundle r15 = r25.getExtras()
                r25.reset()
                r0.setProvider(r1)
        ...
        static void removeVerticalAccuracy(android.location.Location r25) {
                r0 = r25
                boolean r1 = r25.hasVerticalAccuracy()
                if (r1 != 0) goto L9
                return
            L9:
                java.lang.String r1 = r25.getProvider()
                ...
                r18 = r15
                float r15 = r25.getAccuracy()
                boolean r19 = r25.hasSpeedAccuracy()
                r20 = r15
                float r15 = r25.getSpeedAccuracyMetersPerSecond()
                boolean r21 = r25.hasBearingAccuracy()
                r22 = r15
    ...
    public static float getBearingAccuracyDegrees(android.location.Location r1) {
            float r0 = androidx.core.location.LocationCompat.Api26Impl.getBearingAccuracyDegrees(r1)
            return r0
    }

    public static long getElapsedRealtimeMillis(android.location.Location r3) {
            java.util.concurrent.TimeUnit r0 = java.util.concurrent.TimeUnit.NANOSECONDS
            long r1 = androidx.core.location.LocationCompat.Api17Impl.getElapsedRealtimeNanos(r3)
            long r0 = r0.toMillis(r1)
            return r0
    }

    public static long getElapsedRealtimeNanos(android.location.Location r2) {
            long r0 = androidx.core.location.LocationCompat.Api17Impl.getElapsedRealtimeNanos(r2)
            return r0
    }
    ...
    public static float getMslAltitudeAccuracyMeters(android.location.Location r2) {
            ...
            return r0
        Lb:
            boolean r0 = hasMslAltitudeAccuracy(r2)
            java.lang.String r1 = "The Mean Sea Level altitude accuracy of the location is not set."
    ...
    public static double getMslAltitudeMeters(android.location.Location r2) {
            ...
            return r0
        Lb:
            boolean r0 = hasMslAltitude(r2)
            java.lang.String r1 = "The Mean Sea Level altitude of the location is not set."
            androidx.core.util.Preconditions.checkState(r0, r1)
            android.os.Bundle r0 = getOrCreateExtras(r2)
    ...
    public static float getSpeedAccuracyMetersPerSecond(android.location.Location r1) {
            float r0 = androidx.core.location.LocationCompat.Api26Impl.getSpeedAccuracyMetersPerSecond(r1)
            return r0
    }

    public static float getVerticalAccuracyMeters(android.location.Location r1) {
            float r0 = androidx.core.location.LocationCompat.Api26Impl.getVerticalAccuracyMeters(r1)
            return r0
    }

    public static boolean hasBearingAccuracy(android.location.Location r1) {
            boolean r0 = androidx.core.location.LocationCompat.Api26Impl.hasBearingAccuracy(r1)
            return r0
    }
    ...
    public static boolean hasSpeedAccuracy(android.location.Location r1) {
            boolean r0 = androidx.core.location.LocationCompat.Api26Impl.hasSpeedAccuracy(r1)
            return r0
    }

    public static boolean hasVerticalAccuracy(android.location.Location r1) {
            boolean r0 = androidx.core.location.LocationCompat.Api26Impl.hasVerticalAccuracy(r1)
            return r0
    }

    public static boolean isMock(android.location.Location r1) {
            boolean r0 = androidx.core.location.LocationCompat.Api18Impl.isMock(r1)
            return r0
    }
    ...
    public static void setMock(android.location.Location r2, boolean r3) {
            java.lang.reflect.Method r0 = getSetIsFromMockProviderMethod()     // Catch: java.lang.reflect.InvocationTargetException -> L12 java.lang.IllegalAccessException -> L19 java.lang.NoSuchMethodException -> L23
            java.lang.Boolean r1 = java.lang.Boolean.valueOf(r3)     // Catch: java.lang.reflect.InvocationTargetException -> L12 java.lang.IllegalAccessException -> L19 java.lang.NoSuchMethodException -> L23
            java.lang.Object[] r1 = new java.lang.Object[]{r1}     // Catch: java.lang.reflect.InvocationTargetException -> L12 java.lang.IllegalAccessException -> L19 java.lang.NoSuchMethodException -> L23
            r0.invoke(r2, r1)     // Catch: java.lang.reflect.InvocationTargetException -> L12 java.lang.IllegalAccessException -> L19 java.lang.NoSuchMethodException -> L23
            return
        L12:
            r0 = move-exception
