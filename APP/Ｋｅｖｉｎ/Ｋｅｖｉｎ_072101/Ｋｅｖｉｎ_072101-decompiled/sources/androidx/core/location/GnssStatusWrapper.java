...
class GnssStatusWrapper extends androidx.core.location.GnssStatusCompat {
    ...
    public float getCarrierFrequencyHz(int r2) {
            r1 = this;
            android.location.GnssStatus r0 = r1.mWrapped
            float r0 = androidx.core.location.GnssStatusWrapper.Api26Impl.getCarrierFrequencyHz(r0, r2)
            return r0
    }
    ...
    public boolean hasCarrierFrequencyHz(int r2) {
            r1 = this;
            android.location.GnssStatus r0 = r1.mWrapped
            boolean r0 = androidx.core.location.GnssStatusWrapper.Api26Impl.hasCarrierFrequencyHz(r0, r2)
            return r0
    }
