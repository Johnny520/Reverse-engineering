...
class MathKt__MathJVMKt extends kotlin.math.MathKt__MathHKt {
    ...
    public static final int getSign(long r3) {
            r0 = 0
    ...
    private static final double m135ln(double r2) {
            double r0 = java.lang.Math.log(r2)
            return r0
    }

    /* JADX INFO: renamed from: ln */
    private static final float m136ln(float r2) {
            double r0 = (double) r2
            double r0 = java.lang.Math.log(r0)
            float r0 = (float) r0
            return r0
