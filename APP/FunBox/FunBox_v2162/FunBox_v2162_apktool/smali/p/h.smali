...
.method constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;Lfun/box001/shared/hook/XHooker$HookCallback;)V
    ...
    iput-object p1, p0, Lp/h;->a:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p2, p0, Lp/h;->b:Lfun/box001/shared/hook/XHooker$HookCallback;
...
.method protected final beforeHookedMethod(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)V
    ...
    invoke-direct {v0, p0, p1}, Lp/g;-><init>(Lp/h;Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)V
    ...
    :try_start_0
    iget-object p1, p0, Lp/h;->b:Lfun/box001/shared/hook/XHooker$HookCallback;
