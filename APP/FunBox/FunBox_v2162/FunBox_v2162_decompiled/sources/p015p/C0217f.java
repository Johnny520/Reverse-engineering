...
public final class C0217f extends XHooker {
    ...
    /* JADX INFO: renamed from: a */
    static Object m543a(C0211a c0211a, Object obj, Object[] objArr) throws Throwable {
        ...
        boolean zContainsKey = concurrentHashMap.containsKey(c0211a.f818a);
        Member member = c0211a.f818a;
        ...
        if (!zArr[0]) {
            try {
                ...
                objArr2[0] = c0211a.f819b.invoke(obj, objArr);
            } catch (Throwable th2) {
                thArr[0] = th2;
            }
        }
    ...
    protected final Object invokeImpl(Member member, Object obj, Object[] objArr) {
        ...
        C0211a c0211a = (C0211a) concurrentHashMap.get(Integer.valueOf(member.hashCode()));
        HashMap map = SHooker.f59a;
