...
public abstract class AbstractC0039p {
    ...
    protected static String m162c(AbstractC0033j abstractC0033j) {
        ...
        return iM90z == ((char) iM90z) ? AbstractC0001b.m11q(iM90z) : AbstractC0001b.m13s(iM90z);
    }
    ...
    protected static String m164j(AbstractC0184n abstractC0184n, int i2) {
        ...
        if (i2 == 4) {
            ...
            str = AbstractC0001b.m10p((int) jMo439i);
        } else if (i2 == 16) {
            str = AbstractC0001b.m11q((int) jMo439i);
        } else if (i2 == 32) {
            str = AbstractC0001b.m13s((int) jMo439i);
        } else {
            if (i2 != 64) {
                throw new RuntimeException("shouldn't happen");
            }
            str = AbstractC0001b.m14t(jMo439i);
        }
        sb.append(str);
        return sb.toString();
    }
