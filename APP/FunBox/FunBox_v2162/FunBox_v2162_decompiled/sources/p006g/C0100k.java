            ...
            if ((abstractC0082E != c0091b && abstractC0082E != c0113x) || !abstractC0082E.mo225f().isEmpty()) {
                ...
                if (abstractC0082E == c0079b) {
                    try {
                        ...
                        throw C0003a.m22b("...while writing section " + i2, e2);
                    }
                }
        ...
        for (int i3 = 0; i3 < length; i3++) {
            try {
                ...
                if ((abstractC0082E2 != c0091b && abstractC0082E2 != c0113x) || !abstractC0082E2.mo225f().isEmpty()) {
                    ...
                    if (iM247e < 0) {
                        throw new C0003a("excess write of " + (-iM247e), null);
                    }
                    c0202d.m501u(iM247e);
                    abstractC0082E2.m252m(c0202d);
                }
            } catch (RuntimeException e3) {
                C0003a c0003a = e3 instanceof C0003a ? (C0003a) e3 : new C0003a(null, e3);
                c0003a.m23a("...while writing section " + i3);
                throw c0003a;
            }
        }
