    ...
    public final void m267e(C0202d c0202d) {
        ...
        if (c0202d.m486d()) {
            ...
            for (int i2 = 0; i2 < iM504B; i2++) {
                ...
                String str = "    try " + AbstractC0001b.m12r(c0027dK.m111d()) + ".." + AbstractC0001b.m12r(c0027dK.m109b());
                String strM106H = c0026cM110c.m106H("    ", "");
                c0202d.m484b(6, str);
                c0202d.m484b(2, strM106H);
            }
            c0202d.m484b(0, "  handlers:");
            c0202d.m484b(this.f338d, "    size: ".concat(AbstractC0001b.m11q(this.f339e.size())));
            C0026c c0026c = null;
            int i3 = 0;
            for (Map.Entry entry : this.f339e.entrySet()) {
                ...
                if (c0026c != null) {
                    c0202d.m484b(iIntValue - i3, c0026c.m106H("    ", AbstractC0001b.m11q(i3).concat(": ")));
                }
                i3 = iIntValue;
                c0026c = c0026c2;
            }
            c0202d.m484b(this.f337c.length - i3, c0026c.m106H("    ", AbstractC0001b.m11q(i3).concat(": ")));
        }
        ...
        for (int i4 = 0; i4 < iM504B2; i4++) {
            ...
            if (i5 >= 65536) {
                throw new UnsupportedOperationException("bogus exception range: " + AbstractC0001b.m13s(iM111d) + ".." + AbstractC0001b.m13s(iM109b));
            }
            c0202d.m497q(iM111d);
            c0202d.m498r(i5);
