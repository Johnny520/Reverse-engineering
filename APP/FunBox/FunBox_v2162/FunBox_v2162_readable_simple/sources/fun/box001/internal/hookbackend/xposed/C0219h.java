...
final class C0219h extends XC_MethodHook {
    ...
    C0219h(AtomicReference r1, XHooker.HookCallback r2) {
        this.f836a = r1;
        this.f837b = r2;
        super(10000);
    }

    protected final void beforeHookedMethod(XC_MethodHook.MethodHookParam r3) {
        C0218g r0 = new C0218g(this, r3);
        r0.method = r3.method;
        r0.obj = r3.thisObject;
        r0.args = r3.args;
        this.f837b.onInvoke(r0);     // Catch: Throwable -> L5
        return;
    L5:
        th = move-exception;
