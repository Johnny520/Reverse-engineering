...
public final class C0066p extends AbstractC0039p {
    ...
    public static final C0066p f295a = null;
    ...
    public final BitSet mo177f(AbstractC0033j r4) {
        C0164o r42 = r4.m140m();
        BitSet r0 = new BitSet(3);
        r0.set(0, AbstractC0039p.m170p(r42.m513p(0).m384i()));
        r0.set(1, AbstractC0039p.m170p(r42.m513p(1).m384i()));
        r0.set(2, AbstractC0039p.m170p(r42.m513p(2).m384i()));
        return r0;
    }
    ...
    public final String mo178g(AbstractC0033j r4) {
        C0164o r42 = r4.m140m();
        return r42.m513p(0).m388o() + ", " + r42.m513p(1).m388o() + ", " + r42.m513p(2).m388o();
    }
    ...
    public final boolean mo180i(AbstractC0033j r4) {
        ...
        return false;
    L5:
        if (r0.m504B() == 3) goto L7;
        return false;
    L7:
        if (AbstractC0039p.m170p(r0.m513p(0).m384i()) == true) goto L9;
        return false;
    L9:
        if (AbstractC0039p.m170p(r0.m513p(1).m384i()) == true) goto L11;
        return false;
    L11:
        if (AbstractC0039p.m170p(r0.m513p(2).m384i()) == true) goto L13;
        return false;
    L13:
        return true;
    }
    ...
    public final void mo181u(C0202d r4, AbstractC0033j r5) {
        C0164o r0 = r5.m140m();
        AbstractC0039p.m173s(r4, AbstractC0039p.m167m(r0.m513p(0).m384i(), r5), AbstractC0039p.m163e(r0.m513p(1).m384i(), r0.m513p(2).m384i()));
    }
}
