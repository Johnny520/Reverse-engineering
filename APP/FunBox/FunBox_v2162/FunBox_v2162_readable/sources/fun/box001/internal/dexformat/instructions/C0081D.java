...
public final class C0081D extends AbstractC0107r {
    ...
    public final void mo233d(C0100k c0100k, C0202d c0202d) {
        ...
        if (c0202d.m486d()) {
            ...
            c0202d.m484b(4, "  shorty_idx:      " + RuntimeDexGenerator.m13s(iM328q) + " // " + c0190t.m448k());
            c0202d.m484b(4, "  return_type_idx: " + RuntimeDexGenerator.m13s(iM331t) + " // " + c0193a.m458e().mo107a());
            c0202d.m484b(4, "  parameters_off:  ".concat(RuntimeDexGenerator.m13s(iM235f)));
        }
        c0202d.m497q(iM328q);
        c0202d.m497q(iM331t);
        c0202d.m497q(iM235f);
