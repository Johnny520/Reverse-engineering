...
public final class C0110u extends AbstractC0080C {
    ...
    protected final void mo241l(C0100k c0100k, C0202d c0202d) {
        ...
        if (zM486d) {
            ...
            sb.append(RuntimeDexGenerator.m11q(iM321b));
            sb.append(" // ");
            sb.append(enumC0109t.toString());
            c0202d.m484b(2, sb.toString());
            c0202d.m484b(2, "  unused: 0");
            c0202d.m484b(4, "  size:   ".concat(RuntimeDexGenerator.m13s(i2)));
            c0202d.m484b(4, "  offset: ".concat(RuntimeDexGenerator.m13s(iM247e)));
        }
        c0202d.m498r(iM321b);
        c0202d.m498r(0);
        c0202d.m497q(i2);
