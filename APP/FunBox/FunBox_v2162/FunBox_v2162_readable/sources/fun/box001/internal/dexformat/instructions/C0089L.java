...
public final class C0089L {
    ...
    */
    public final void m259c(C0173c c0173c, boolean z) {
        ...
        int iM504B = c0172bM429g.m504B();
        if (z2) {
            ((C0202d) interfaceC0199a).m485c("  size: ".concat(RuntimeDexGenerator.m13s(iM504B)));
        }
        ...
        for (int i2 = 0; i2 < iM504B; i2++) {
            ...
            if (iM258b == 0 || iM258b == 6 || iM258b == 2) {
                ...
                if (iM258b == 3) {
                    ...
                    RuntimeDexGenerator.m16v(interfaceC0199a, iM258b, jMo439i2);
                }
                RuntimeDexGenerator.m17w(interfaceC0199a, iM258b, jMo439i);
            }
        }
        if (z2) {
            c0202d.m488f();
