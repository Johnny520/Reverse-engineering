        ...
        while (iM342b != -1) {
            while (true) {
                ...
                for (int i8 = 0; i8 < iM529o; i8++) {
                    ...
                    if (RuntimeDexGenerator.m2g(iArr2, iM526l2)) {
                        break;
                    }
                    if (RuntimeDexGenerator.m2g(iArr, iM526l2) && c0152cM341a.m359K(iM526l2).m352e() == iM342b) {
                        break;
                    }
                }
                int i9 = iM526l2 >> 5;
            ...
            while (true) {
                ...
                if (RuntimeDexGenerator.m2g(iArr, iM350c2)) {
                    iM342b = iM350c2;
                    i10 = i3;
                } else if (iM352e2 == iM350c2 || iM352e2 < 0 || !RuntimeDexGenerator.m2g(iArr, iM352e2)) {
                    ...
                    while (true) {
                        ...
                        if (RuntimeDexGenerator.m2g(iArr, iM526l3)) {
                            i10 = i3;
                            iM342b = iM526l3;
                            break;
                        }
