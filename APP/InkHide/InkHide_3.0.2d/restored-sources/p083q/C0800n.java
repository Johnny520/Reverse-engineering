...
public final class C0800n {
    ...
    public static final C0800n f2657k;
    ...
    static {
        float[] fArr = AbstractC0788b.f2632c;
        float fM1462f = (float) ((((double) AbstractC0788b.m1462f()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC0788b.f2630a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fM1462f) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d2 = fExp;
        if (d2 > 1.0d) {
            fExp = 1.0f;
        } else if (d2 < 0.0d) {
        ...
        float f10 = 1.0f / ((5.0f * fM1462f) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) fM1462f) * 5.0d))) + (f11 * fM1462f);
        float fM1462f2 = AbstractC0788b.m1462f() / fArr[1];
        double d3 = fM1462f2;
        ...
        f2657k = new C0800n(fM1462f2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public C0800n(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f2663f = f;
        this.f2658a = f2;
        this.f2659b = f3;
        this.f2660c = f4;
