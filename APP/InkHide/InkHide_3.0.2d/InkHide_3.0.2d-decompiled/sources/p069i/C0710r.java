...
public final class C0710r extends CheckBox {

    /* JADX INFO: renamed from: b */
    public final C0190d f2402b;

    /* JADX INFO: renamed from: c */
    public final C0704p f2403c;

    /* JADX INFO: renamed from: d */
    public final C0666c0 f2404d;

    /* JADX INFO: renamed from: e */
    public C0723w f2405e;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0710r(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.checkboxStyle);
        AbstractC0673e1.m1303a(context);
        AbstractC0670d1.m1297a(this, getContext());
        C0190d c0190d = new C0190d(this);
        this.f2402b = c0190d;
        c0190d.m397e(attributeSet, R.attr.checkboxStyle);
        C0704p c0704p = new C0704p(this);
        this.f2403c = c0704p;
        c0704p.m1330d(attributeSet, R.attr.checkboxStyle);
        C0666c0 c0666c0 = new C0666c0(this);
        this.f2404d = c0666c0;
        c0666c0.m1284f(attributeSet, R.attr.checkboxStyle);
        getEmojiTextViewHelper().m1372a(attributeSet, R.attr.checkboxStyle);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private C0723w getEmojiTextViewHelper() {
        if (this.f2405e == null) {
            this.f2405e = new C0723w(this);
        }
        return this.f2405e;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C0704p c0704p = this.f2403c;
        if (c0704p != null) {
            c0704p.m1327a();
        }
        C0666c0 c0666c0 = this.f2404d;
        if (c0666c0 != null) {
            c0666c0.m1281b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f2404d.m1282d();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f2404d.m1283e();
    }
