...
class FragmentManager$6 implements InterfaceC0053Ujhhgtgfeyxiexzf {
    ...
    public final void mo0Ujhhgtgfeyxiexzf(InterfaceC0083Ujhhgtgfeyxiexzf interfaceC0083Ujhhgtgfeyxiexzf, Ujhhgtgfeyxiexzf ujhhgtgfeyxiexzf) {
        if (ujhhgtgfeyxiexzf == Ujhhgtgfeyxiexzf.ON_START || ujhhgtgfeyxiexzf == Ujhhgtgfeyxiexzf.ON_DESTROY) {
            throw null;
        }
    }
}
