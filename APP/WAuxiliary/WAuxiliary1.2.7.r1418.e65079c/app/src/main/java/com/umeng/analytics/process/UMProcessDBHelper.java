...
public class UMProcessDBHelper {
                ...
                try {
                    ...
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put(a.InterfaceC0005a.f, aVar.f);
                            contentValues.put("__av", aVar.g);
                            contentValues.put("__vc", aVar.h);
                            contentValues.put("__s", aVar.d);
                            sQLiteDatabaseA.insert(a.InterfaceC0005a.a, null, contentValues);
                        } catch (Exception unused) {
                        }
                    }
        ...
        try {
            try {
                try {
                    ...
                    try {
                        sQLiteDatabaseA.beginTransaction();
                        Cursor cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0005a.a, null, null, null, null, null, null);
                        if (cursorQuery != null) {
                            while (cursorQuery.moveToNext()) {
                                try {
                                    ...
                                    aVar.f = cursorQuery.getString(cursorQuery.getColumnIndex(a.InterfaceC0005a.f));
            ...
            try {
                ...
                if (size > 0) {
                    for (int i = 0; i < size; i++) {
                        sQLiteDatabaseA.delete(a.InterfaceC0005a.a, "rowid=?", new String[]{String.valueOf(list.get(i).a)});
                    }
                } else {
                    sQLiteDatabaseA.delete(a.InterfaceC0005a.a, null, null);
                }
                sQLiteDatabaseA.setTransactionSuccessful();
                sQLiteDatabaseA.endTransaction();
            } catch (Exception unused) {
    ...
    public void deleteMainProcessEventDatasByIds(List<Integer> list) {
        ...
        try {
            ...
            while (it.hasNext()) {
                sQLiteDatabaseA.delete(a.InterfaceC0005a.a, "id=?", new String[]{String.valueOf(it.next())});
            }
            sQLiteDatabaseA.setTransactionSuccessful();
        } catch (Exception unused) {
            if (sQLiteDatabaseA != null) {
    ...
    public JSONObject readMainEvents(long j, List<Integer> list) throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    sQLiteDatabaseA.beginTransaction();
                    cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0005a.a, null, null, null, null, null, null);
                    if (cursorQuery != null) {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            String string3 = cursorQuery.getString(cursorQuery.getColumnIndex(a.InterfaceC0005a.f));
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    sQLiteDatabaseA.beginTransaction();
                    Cursor cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0005a.a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (cursorQuery != null) {
                        try {
                            try {
