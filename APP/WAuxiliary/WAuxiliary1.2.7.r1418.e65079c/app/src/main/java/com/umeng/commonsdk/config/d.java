...
public class d {
    ...
    public static String[] k = new String[EnumC0007d.values().length];
    ...
    static {
        ...
        for (int i5 = 0; i5 < EnumC0007d.values().length; i5++) {
            k[i5] = EnumC0007d.values()[i5].toString();
        }
        Map<String, String[]> map4 = l;
        if (map4 != null) {
            map4.put(EnumC0007d.class.getName(), k);
        }
    }
