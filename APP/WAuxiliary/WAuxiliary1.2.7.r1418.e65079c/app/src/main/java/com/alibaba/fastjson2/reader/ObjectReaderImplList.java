...
public final class ObjectReaderImplList implements ObjectReader {
    ...
    public static List getKotlinEmptyList(Class cls) {
        ...
        try {
            ...
            e = e;
            throw new IllegalStateException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "Failed to get singleton of "), e);
    ...
    public static ObjectReader of(Type type, Class cls, long j) {
        ...
        Class cls2;
        Class cls3;
        Function c1311feyxiexzfUjhhgtg;
        Function c1311feyxiexzfUjhhgtg2;
        Class cls4;
        String typeName;
            ...
            if (cls != null) {
                ...
                if (cls2 != Iterable.class || cls2 == Collection.class || cls2 == List.class || cls2 == AbstractCollection.class || cls2 == AbstractList.class) {
                    ...
                    if (cls2 == EnumSet.class) {
                        c1311feyxiexzfUjhhgtg = new C1292feyxiexzfUjhhgtg(i, type2);
                    } else if (cls2 == NavigableSet.class || cls2 == SortedSet.class) {
                        c1311feyxiexzfUjhhgtg2 = c1311feyxiexzfUjhhgtg;
                        cls4 = TreeSet.class;
                    } else {
                        if (cls2 == CLASS_SINGLETON) {
                            c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(25);
                        } else if (cls2 == CLASS_SINGLETON_LIST) {
                            c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(26);
                        } else {
                            Class cls5 = CLASS_ARRAYS_LIST;
                            if (cls2 == cls5) {
                                c1311feyxiexzfUjhhgtg2 = new C1311feyxiexzfUjhhgtg(27);
                                cls4 = cls5;
                            } else if (cls2 == CLASS_UNMODIFIABLE_COLLECTION) {
                                c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(28);
                            } else if (cls2 == CLASS_UNMODIFIABLE_LIST) {
                                c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(29);
                            } else if (cls2 == CLASS_UNMODIFIABLE_SET) {
                                c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(9);
                                cls3 = LinkedHashSet.class;
                            } else {
                                if (cls2 == CLASS_UNMODIFIABLE_SORTED_SET) {
                                    c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(10);
                                } else if (cls2 == CLASS_UNMODIFIABLE_NAVIGABLE_SET) {
                                    c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(11);
                                } else {
                                    ...
                                    if (!typeName2.equals("java.util.AbstractList$RandomAccessSubList")) {
                                        if (typeName2.equals("java.util.Collections$SynchronizedSortedSet")) {
                                            c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(23);
                                        } else if (typeName2.equals("com.google.common.collect.ImmutableList")) {
                                            c1311feyxiexzfUjhhgtg = GuavaSupport.immutableListConverter();
                                        } else if (typeName2.equals("java.util.Collections$SynchronizedSet")) {
                                            c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(22);
                ...
                switch (b) {
                    ...
                    default:
                        if (type2 == String.class || c1311feyxiexzfUjhhgtg2 != null) {
                            return (type2 == Long.class || c1311feyxiexzfUjhhgtg2 != null) ? new ObjectReaderImplList(type3, cls2, cls4, type2, c1311feyxiexzfUjhhgtg2) : new ObjectReaderImplListInt64(cls2, cls4);
                        }
    ...
    public Object readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j) {
        ...
        Function c1292feyxiexzfUjhhgtg = this.builder;
        ...
        if (objectReaderCheckAutoType2 == null) {
            ...
            if (objectReaderCheckAutoType2 instanceof ObjectReaderImplList) {
                ...
                c1292feyxiexzfUjhhgtg = objectReaderImplList.builder;
            } else {
                objectClass = objectReaderCheckAutoType2.getObjectClass();
            }
            if (objectClass == CLASS_UNMODIFIABLE_COLLECTION) {
                c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(13);
            } else if (objectClass == CLASS_UNMODIFIABLE_LIST) {
                c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(i);
            } else if (objectClass == CLASS_UNMODIFIABLE_SET) {
                c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(15);
                cls = LinkedHashSet.class;
            } else {
                if (objectClass == CLASS_UNMODIFIABLE_SORTED_SET) {
                    c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(16);
                } else if (objectClass == CLASS_UNMODIFIABLE_NAVIGABLE_SET) {
                    c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(17);
                } else if (objectClass == CLASS_SINGLETON) {
                    c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(18);
                } else if (objectClass == CLASS_SINGLETON_LIST) {
                    c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(20);
                } else {
                    String typeName = objectClass.getTypeName();
                    typeName.getClass();
                    if (typeName.equals("上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛳ能不能ᛴᛱUjhhgtgᛱ") || typeName.equals("上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛳᛴ能不能ᛱUjhhgtgᛱ")) {
        ...
        if (cls == ArrayList.class) {
            ...
            if (cls != CLASS_SINGLETON_LIST) {
                if (cls == CLASS_UNMODIFIABLE_LIST) {
                    ...
                    c1311feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(i);
                } else if (cls != null && EnumSet.class.isAssignableFrom(cls)) {
                    HashSet hashSet = new HashSet();
                    c1292feyxiexzfUjhhgtg = new C1292feyxiexzfUjhhgtg(3, this);
                    ...
                    if (name.equals("上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛳ能不能ᛴᛱUjhhgtgᛱ")) {
                        kotlinEmptyList2 = getKotlinEmptyList(cls);
                    } else if (name.equals("上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛳᛴ能不能ᛱUjhhgtgᛱ")) {
                ...
                if (c1311feyxiexzfUjhhgtg != null) {
                    return c1311feyxiexzfUjhhgtg.apply(arrayList);
                }
                return arrayList;
            }
            ArrayList arrayList3 = new ArrayList();
            c1292feyxiexzfUjhhgtg = new C1311feyxiexzfUjhhgtg(21);
            kotlinEmptyList2 = arrayList3;
        }
        c1311feyxiexzfUjhhgtg = c1292feyxiexzfUjhhgtg;
