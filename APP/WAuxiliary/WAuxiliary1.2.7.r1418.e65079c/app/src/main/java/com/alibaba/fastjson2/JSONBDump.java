...
final class JSONBDump {
    ...
    public String getString(int i) {
        ...
        throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "symbol not found : "));
    }
    ...
    public int readLength() {
        ...
        if (b2 >= 64 && b2 <= 71) {
            ...
            if (b2 < 48 || b2 > 63) {
                if (b2 != 72) {
                    throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(b2, "not support length type : "));
                }
                int i6 = i2 + 2;
                this.offset = i6;
                int i7 = bArr[i3] << 24;
