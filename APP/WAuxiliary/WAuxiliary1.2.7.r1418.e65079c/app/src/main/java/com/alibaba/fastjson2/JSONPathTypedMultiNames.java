...
class JSONPathTypedMultiNames extends JSONPathTypedMulti {
    ...
    public JSONPathTypedMultiNames(JSONPath[] jSONPathArr, JSONPath jSONPath, JSONPath[] jSONPathArr2, Type[] typeArr, String[] strArr, long[] jArr, ZoneId zoneId, long j) {
        ...
        ObjectReaderAdapter<Object[]> objectReaderAdapter = (ObjectReaderAdapter) JSONFactory.getDefaultObjectReaderProvider().createObjectReader(this.names, typeArr2, jArr2, new Supplier() { // from class: com.alibaba.fastjson2.上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛲᛴ
            @Override // java.util.function.Supplier
            public final Object get() {
                return JSONPathTypedMultiNames.lambda$new$0(length);
            }
        }, new C0038Ujhhgtgfeyxiexzf());
