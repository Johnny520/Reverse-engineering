...
import p000.C1290feyxiexzfUjhhgtg;
import p000.C1291feyxiexzfUjhhgtg;
import p000.C1292feyxiexzfUjhhgtg;
import p000.C1295feyxiexzfUjhhgtg;
import p000.C1311feyxiexzfUjhhgtg;
import p000.C1312feyxiexzfUjhhgtg;
import p000.C2569Ujhhgtgfeyxiexzf;
...
public class ObjectReaderCreator {
    ...
    */
    ...
    private FieldReader[] toFieldReaderArray(Map<String, List<FieldReader>> map) {
        FieldReader[] fieldReaderArr = new FieldReader[map.values().stream().mapToInt(new C0705Ujhhgtgfeyxiexzf(1)).sum()];
        ((List) map.values().stream().flatMap(new C1311feyxiexzfUjhhgtg(7)).collect(Collectors.toList())).toArray(fieldReaderArr);
    ...
    public <T, R> Function<T, R> createBuildFunction(Method method) {
        try {
            ...
            method.setAccessible(true);
            return new C1292feyxiexzfUjhhgtg(0, method);
        }
    }
    ...
    public FieldReader[] createFieldReaders(ObjectReaderProvider objectReaderProvider, Class cls, Type type, Executable executable, Parameter[] parameterArr, String... strArr) {
        ...
        while (i2 < parameterArr.length) {
            ...
            String str = fieldInfo.fieldName;
            String strM4795Ujhhgtgfeyxiexzf = (str == null || str.isEmpty()) ? name : fieldInfo.fieldName;
            if (strM4795Ujhhgtgfeyxiexzf == null) {
                strM4795Ujhhgtgfeyxiexzf = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i2, "arg");
            }
            String str2 = strM4795Ujhhgtgfeyxiexzf;
            if (name == null) {
                name = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i2, "arg");
            }
            String str3 = name;
    ...
    public <T> ObjectReader<T> createObjectReaderWithBuilder(final Class<T> cls, final Type type, final ObjectReaderProvider objectReaderProvider, final BeanInfo beanInfo) {
        ...
        BeanUtils.setters((Class) cls2, false, (Consumer<Method>) new Consumer() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱ能不能ᛳᛱUjhhgtgᛱᛴ要点脸ᛲ
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                this.f4711Ujhhgtgfeyxiexzf.lambda$createObjectReaderWithBuilder$0(fieldInfo, objectReaderProvider, cls, str2, cls2, beanInfo, length, linkedHashMap, type, (Method) obj);
            }
        });
    ...
    public <T> ObjectReader<T> createObjectReaderWithCreator(Class<T> cls, Type type, ObjectReaderProvider objectReaderProvider, BeanInfo beanInfo) {
        ...
        while (true) {
            ...
            FieldInfo fieldInfo2 = fieldInfo;
            String strM4795Ujhhgtgfeyxiexzf = name;
            Class<?> type2 = parameter3.getType();
            BeanUtils.getters(cls, new C1312feyxiexzfUjhhgtg(type2, objectReaderProvider, cls, beanInfo, strM4795Ujhhgtgfeyxiexzf, fieldInfo2));
            if (strM4795Ujhhgtgfeyxiexzf == null || strM4795Ujhhgtgfeyxiexzf.isEmpty()) {
                strM4795Ujhhgtgfeyxiexzf = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i4, "arg");
            }
            String str = strM4795Ujhhgtgfeyxiexzf;
    ...
    public <T> FieldReader createFieldReaderMethod(Class<T> cls, Type type, String str, int i, long j, String str2, Locale locale, Object obj, String str3, Type type2, Class cls2, Method method, ObjectReader objectReader, String str4, BiConsumer biConsumer) {
        ...
        if (type2 instanceof Class) {
            ...
            if (cls10 != StackTraceElement[].class && method.getDeclaringClass() == Throwable.class) {
                ...
                return new FieldReaderStackTrace(str, type7, cls10, i, j, str2, locale, obj2, jSONSchemaOf, method, null, new C1291feyxiexzfUjhhgtg(i2));
            }
    ...
    public <T> ObjectReader<T> createObjectReader(Class<T> cls, Type type, boolean z, ObjectReaderProvider objectReaderProvider) throws NoSuchMethodException {
        ...
        if (beanInfo.creatorConstructor == null && beanInfo.createMethod == null) {
            ...
            boolean z6 = z3;
            ArrayList arrayList = new ArrayList();
            BeanUtils.constructor(cls, new C2569Ujhhgtgfeyxiexzf(arrayList, 1));
            if (Throwable.class.isAssignableFrom(cls)) {
    ...
    public <T> FieldReader[] createFieldReaders(Class<T> cls, Type type, BeanInfo beanInfo, boolean z, ObjectReaderProvider objectReaderProvider) {
        ...
        if (z) {
            ...
            BeanUtils.declaredFields(cls, new C1295feyxiexzfUjhhgtg(this, fieldInfo, j, str2, cls, type, str, strArr, linkedHashMap3, objectReaderProvider));
        } else {
            if (zIsRecord) {
                ...
                linkedHashMap = linkedHashMap3;
                beanInfo2 = beanInfo4;
                BeanUtils.declaredFields(cls, new C1290feyxiexzfUjhhgtg(this, fieldInfo, j, str2, cls, type, str, strArr, linkedHashMap3, objectReaderProvider2, beanInfo4));
            }
            Class mixIn = objectReaderProvider2.getMixIn(cls);
            linkedHashMap2 = linkedHashMap;
            BeanUtils.setters(cls, beanInfo2, mixIn, new C1290feyxiexzfUjhhgtg(this, fieldInfo, j, str2, cls, type, str, strArr, beanInfo2, linkedHashMap2, objectReaderProvider));
            if (cls.isInterface()) {
                C1295feyxiexzfUjhhgtg c1295feyxiexzfUjhhgtg = new C1295feyxiexzfUjhhgtg(this, fieldInfo, j, cls, type, str, strArr, beanInfo2, linkedHashMap2, objectReaderProvider);
                linkedHashMap2 = linkedHashMap2;
                BeanUtils.getters(cls, c1295feyxiexzfUjhhgtg);
            }
        }
        Class<? super T> superclass = cls.getSuperclass();
        if (BeanUtils.isExtendedMap(cls)) {
            linkedHashMap2.put(BeanUtils.SUPER, listOf(ObjectReaders.fieldReader(BeanUtils.SUPER, cls.getGenericSuperclass(), superclass, new C1291feyxiexzfUjhhgtg(1))));
        }
