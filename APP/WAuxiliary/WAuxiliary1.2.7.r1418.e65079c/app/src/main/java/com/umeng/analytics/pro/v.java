...
public class v {
    ...
    public void a(String str, String str2, long j, int i, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                if (Arrays.asList(g.aM).contains(str)) {
                ...
                if (!TextUtils.isEmpty(str3)) {
                    try {
                        ...
                        if (jSONObject2.length() > 0) {
                            jSONObject.put(g.aA, jSONObject2);
                        }
    ...
    public void a(String str, Map<String, Object> map, long j, String str2, boolean z) {
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (!UMUtils.isMainProgress(g)) {
                    strA = ab.a().a(UMGlobalContext.getAppContext(g), jSONObject.getLong("ts"));
                } else {
                    strA = ab.a().d(UMGlobalContext.getAppContext(g));
                }
                if (TextUtils.isEmpty(strA)) {
        ...
        try {
            if (a(str)) {
                ...
                for (int i = 0; i < 10 && it.hasNext(); i++) {
                    ...
                    if (!g.ae.equals(next.getKey()) && !g.ac.equals(next.getKey()) && !"id".equals(next.getKey()) && !"ts".equals(next.getKey())) {
    ...
    private void a(String str, boolean z) {
        try {
            if (g.ae.equals(str) || g.ac.equals(str) || "id".equals(str) || "ts".equals(str) || this.h.has(str)) {
                return;
            }
            this.h.put(str, z);
        } catch (Exception unused) {
