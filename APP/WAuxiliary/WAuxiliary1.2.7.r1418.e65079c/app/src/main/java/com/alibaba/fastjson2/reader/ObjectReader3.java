...
public class ObjectReader3<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader3(Class cls, Supplier<T> supplier, long j, JSONSchema jSONSchema, Function function, FieldReader fieldReader, FieldReader fieldReader2, FieldReader fieldReader3) {
        this(cls, (String) null, (String) null, j, jSONSchema, supplier, function, fieldReader, fieldReader2, fieldReader3);
    }
    ...
    public T readArrayMappingJSONBObject(JSONReader jSONReader, Type type, Object obj, long j) {
        ...
        if (iStartArray == this.fieldReaders.length) {
            ...
            readArrayMappingJSONBObject0(jSONReader, t, iStartArray);
        }
    ...
    public ObjectReader3(Class cls, String str, String str2, long j, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        this(cls, str, str2, j, (JSONSchema) null, supplier, function, fieldReaderArr);
    }

    public ObjectReader3(Class cls, String str, String str2, long j, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
