...
final class ObjectArrayTypedReader extends ObjectReaderPrimitive {
    ...
    public ObjectArrayTypedReader(Class cls) {
        ...
        String strM2711Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("[", typeName);
        this.typeName = strM2711Ujhhgtgfeyxiexzf;
        this.typeNameHashCode = Fnv.hashCode64(strM2711Ujhhgtgfeyxiexzf);
