    ...
    public void writeDate(JSONWriter jSONWriter, long j) {
        ...
        if (dateFormat == null || this.formatyyyyMMddhhmmss14 || z) {
            ...
            if (zoneId != DateUtils.SHANGHAI_ZONE_ID) {
                ...
                jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j6, 400L, ((j6 / 4) + (j6 * 365)) - (j6 / 100), j5);
                if (jM2692Ujhhgtgfeyxiexzf < j2) {
                    j6--;
                    jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j6, 400L, ((j6 / 4) + (365 * j6)) - (j6 / 100), j5);
                }
                int i = (int) jM2692Ujhhgtgfeyxiexzf;
                int i2 = ((i * 5) + 2) / Opcodes.IFEQ;
                int i3 = ((i2 + 2) % 12) + 1;
                int i4 = (i - (((i2 * 306) + 5) / 10)) + 1;
                j7 = j6 + j4 + ((long) (i2 / 10));
                if (j7 >= -999999999 || j7 > 999999999) {
                    throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j7, "Invalid year "));
                }
                int i5 = (int) j7;
                long j11 = iFloorMod;
                if (j11 < j2 || j11 > 86399) {
                    throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j11, "Invalid secondOfDay "));
                }
                int i6 = (int) (j11 / 3600);
            ...
            int i9 = (int) jM2692Ujhhgtgfeyxiexzf;
