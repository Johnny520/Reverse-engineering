...
class ObjectReaderImplInt16ValueArray extends ObjectReaderPrimitive {
    ...
    public Object createInstance(Collection collection, long j) {
        ...
        for (Object obj : collection) {
            if (obj == null) {
                ...
                if (typeConvert == null) {
                    throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4799Ujhhgtgfeyxiexzf(obj, new StringBuilder("can not cast to short ")));
                }
    ...
    public Object readObject(JSONReader jSONReader, Type type, Object obj, long j) {
        ...
        while (!jSONReader.nextIfArrayEnd()) {
            ...
            sArrCopyOf[i] = (short) jSONReader.readInt32Value();
            i = i2;
        }
