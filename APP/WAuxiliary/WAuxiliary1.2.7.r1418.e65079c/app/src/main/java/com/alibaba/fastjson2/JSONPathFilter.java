...
abstract class JSONPathFilter extends JSONPathSegment implements JSONPathSegment.EvalSegment {
    ...
    public static final class GroupFilter extends JSONPathSegment implements JSONPathSegment.EvalSegment {
        ...
        public void eval(JSONPath.Context context) {
            ...
            if (list != null) {
                arrayList = (List) list.stream().sorted(Comparator.comparing(new Ujhhgtgfeyxiexzf(0))).collect(Collectors.toList());
            }
            boolean z = false;
    ...
    /* JADX INFO: compiled from: obf */
    public static final class NameSubFilterSegment extends NameFilter {
        final JSONPathFilter subFilter;

        public NameSubFilterSegment(String str, long j, String[] strArr, long[] jArr, JSONPathFilter jSONPathFilter) {
            super(str, j, strArr, jArr, null);
            this.subFilter = jSONPathFilter;
        }
        ...
        public boolean apply(JSONPath.Context context, Object obj) {
            ...
            if (obj == null || (objExtractFieldValue = extractFieldValue(context, obj)) == null) {
                return false;
            }
            if (objExtractFieldValue instanceof Iterable) {
                Iterator it = ((Iterable) objExtractFieldValue).iterator();
                while (it.hasNext()) {
                    if (this.subFilter.apply(context, it.next())) {
                        return true;
                    }
                }
                return false;
            }
            if (!(objExtractFieldValue instanceof Object[])) {
                return this.subFilter.apply(context, objExtractFieldValue);
            }
            for (Object obj2 : (Object[]) objExtractFieldValue) {
                if (this.subFilter.apply(context, obj2)) {
                    return true;
                }
            }
            return false;
    ...
    public static final class RangeIndexSegmentFilter extends JSONPathFilter {
        ...
        @Override // com.alibaba.fastjson2.JSONPathSegment
        public void accept(JSONReader jSONReader, JSONPath.Context context) {
            throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(RangeIndexSegmentFilter.class, "UnsupportedOperation "));
        }
        ...
        public void eval(JSONPath.Context context) {
            ...
            Object obj = context2 == null ? context.root : context2.value;
            if (!(obj instanceof List)) {
                throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4799Ujhhgtgfeyxiexzf(obj, new StringBuilder("UnsupportedOperation ")));
            }
            List list = (List) obj;
    ...
    public static final class Segment2Filter extends JSONPathFilter {
        ...
        @Override // com.alibaba.fastjson2.JSONPathSegment
        public void accept(JSONReader jSONReader, JSONPath.Context context) {
            throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(Segment2Filter.class, "UnsupportedOperation "));
        }
    ...
    public static final class SegmentFilter extends JSONPathFilter {
        ...
        @Override // com.alibaba.fastjson2.JSONPathSegment
        public void accept(JSONReader jSONReader, JSONPath.Context context) {
            throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(SegmentFilter.class, "UnsupportedOperation "));
        }
    ...
    public static abstract class NameFilter extends JSONPathFilter {
        ...
        public boolean apply(JSONPath.Context context, Object obj) {
            ...
            boolean z2 = !z ? context.path.getWriterContext().getObjectWriter(obj.getClass()) instanceof ObjectWriterAdapter : false;
            if (!z && !z2) {
                Function function = this.function;
                if (function != null) {
            ...
            Object objExtractFieldValue = extractFieldValue(context, obj);
            if (objExtractFieldValue != null) {
                Function function2 = this.function;
                if (function2 != null) {
                    objExtractFieldValue = function2.apply(objExtractFieldValue);
                }
                return apply(objExtractFieldValue);
            }
            if (z) {
        ...
        public Object extractFieldValue(JSONPath.Context context, Object obj) {
                    ...
                    while (true) {
                        ...
                        if (i < strArr.length) {
                            ...
                            if (obj instanceof Map) {
                                ...
                                if (!(objectWriter instanceof ObjectWriterAdapter) || (fieldWriter3 = objectWriter.getFieldWriter(this.fieldNameNameHash2[i])) == null) {
                                    return null;
                                }
                                obj = fieldWriter3.getFieldValue(obj);
                            }
                            if (obj == null) {
                                return null;
                            }
            ...
            if (!(objectWriter2 instanceof ObjectWriterAdapter) || (fieldWriter = objectWriter2.getFieldWriter(this.fieldNameNameHash)) == null || (fieldValue = fieldWriter.getFieldValue(obj)) == null) {
                return null;
            }
            if (this.fieldName2 != null) {
                while (true) {
                    ...
                    if (i < strArr2.length) {
                        ...
                        if (fieldValue instanceof Map) {
                            ...
                            if (!(objectWriter3 instanceof ObjectWriterAdapter) || (fieldWriter2 = objectWriter3.getFieldWriter(this.fieldNameNameHash2[i])) == null) {
                                return null;
                            }
