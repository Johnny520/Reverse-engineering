...
public abstract class Cdo<T extends Cdo<?, ?>, F extends dl> implements de<T, F> {
    ...
    public String toString() {
        ...
        sbM2707Ujhhgtgfeyxiexzf.append(getClass().getSimpleName());
        sbM2707Ujhhgtgfeyxiexzf.append(" ");
        if (a() != null) {
            Object objB = b();
            sbM2707Ujhhgtgfeyxiexzf.append(c(a()).a);
            sbM2707Ujhhgtgfeyxiexzf.append(":");
            if (objB instanceof ByteBuffer) {
                df.a((ByteBuffer) objB, sbM2707Ujhhgtgfeyxiexzf);
            } else {
                sbM2707Ujhhgtgfeyxiexzf.append(objB.toString());
            }
        }
        sbM2707Ujhhgtgfeyxiexzf.append(">");
