...
public final class ObjectReaderImplMap implements ObjectReader {
    ...
    static final Function ENUM_MAP_BUILDER = new C1297feyxiexzfUjhhgtg(9);
    ...
    /* JADX WARN: Code duplicated, block: B:113:0x0188  */
    ...
    /* JADX WARN: Code duplicated, block: B:127:0x01be A[Catch: IllegalAccessException -> 0x01c2, NoSuchFieldException -> 0x01c4, TryCatch #2 {IllegalAccessException -> 0x01c2, NoSuchFieldException -> 0x01c4, blocks: (B:125:0x01b2, B:127:0x01be, B:132:0x01c6), top: B:144:0x01b2 }] */
    ...
    /* JADX WARN: Code duplicated, block: B:144:0x01b2 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public static ObjectReader of(Type type, Class cls, long j) {
        ...
        Class superclass;
        Class cls2;
        Function c1297feyxiexzfUjhhgtg;
        Function function;
        Type type2;
        Class cls3;
        String name;
            ...
            if (cls != CLASS_UNMODIFIABLE_MAP) {
                    ...
                    if (cls == ConcurrentMap.class) {
                        ...
                        if (typeName.equals("java.util.Collections$SynchronizedSortedMap")) {
                            ...
                            if (typeName.equals("com.google.common.collect.SingletonImmutableBiMap")) {
                                ...
                                c1297feyxiexzfUjhhgtg = new C1297feyxiexzfUjhhgtg(i);
                ...
                if (genericSuperclass instanceof ParameterizedType) {
                    ...
                    if (actualTypeArguments2.length == 2) {
                        ...
                        if (type5 != String.class && type6 == String.class && c1297feyxiexzfUjhhgtg == null) {
                            return new ObjectReaderImplMapString(cls, cls2, j);
                        }
                        return new ObjectReaderImplMapTyped(cls, cls2, type5, type6, 0L, c1297feyxiexzfUjhhgtg);
                    }
                }
                function = c1297feyxiexzfUjhhgtg;
                ...
                if (!name.equals("com.google.common.collect.SingletonImmutableBiMap")) {
                    if (!name.equals("com.alibaba.fastjson.JSONObject")) {
                        ...
                        if (!name.equals("com.google.common.collect.ArrayListMultimap")) {
                            if (!name.equals("上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛳᛱUjhhgtgᛱ能不能ᛴ")) {
                                try {
                                    ...
                                    e = e;
                                    throw new IllegalStateException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls3, "Failed to get singleton of "), e);
                            ...
                            if (name.equals("com.google.common.collect.RegularImmutableMap")) {
                                ...
                                if (cls3 == JSONObject1O.class) {
                                    ...
                                    functionCreateObjectSupplier = new C1297feyxiexzfUjhhgtg(5);
                                } else if (cls == CLASS_UNMODIFIABLE_SORTED_MAP) {
                                    functionCreateObjectSupplier = new C1297feyxiexzfUjhhgtg(6);
                                } else if (cls == CLASS_UNMODIFIABLE_NAVIGABLE_MAP) {
                                    functionCreateObjectSupplier = new C1297feyxiexzfUjhhgtg(7);
                                } else if (cls == CLASS_SINGLETON_MAP) {
                                    functionCreateObjectSupplier = new C1297feyxiexzfUjhhgtg(8);
