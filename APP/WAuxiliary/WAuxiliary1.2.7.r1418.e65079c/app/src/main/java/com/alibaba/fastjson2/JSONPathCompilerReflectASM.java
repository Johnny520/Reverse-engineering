...
final class JSONPathCompilerReflectASM extends JSONPathCompilerReflect {
    ...
    static {
        ...
        METHOD_SINGLE_NAME_PATH_TYPED_INIT = AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(sb, ASMUtils.DESC_FIELD_WRITER, ")V");
    }
    ...
    private void gwGetValue(MethodWriter methodWriter, String str, FieldWriter fieldWriter) {
        ...
        if (method == null) {
            ...
            methodWriter.invokevirtual(str, method.getName(), AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("()", strDesc));
        }
    }
