...
public class c {
    ...
    public byte[] a(byte[] bArr, boolean z, boolean z2, String str) {
        ...
        while (true) {
            ...
            String strM2706Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(AbstractC1225feyxiexzfUjhhgtg.m2707Ujhhgtgfeyxiexzf(str2), File.separator, str);
            if (SdkVersion.SDK_TYPE != 0) {
                bArrA = a(bArr, strM2706Ujhhgtgfeyxiexzf);
            } else if (i == 0) {
                bArrA = b(bArr, strM2706Ujhhgtgfeyxiexzf);
            } else {
                bArrA = c(bArr, strM2706Ujhhgtgfeyxiexzf);
            }
            if (bArrA != null) {
                b bVar = this.b;
                if (bVar != null) {
