...
final class FieldWriterCharValue<T> extends FieldWriterChar<T> {
    public FieldWriterCharValue(String str, int i, long j, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public boolean write(JSONWriter jSONWriter, T t) {
        ...
        try {
            char charValue = this.propertyAccessor.getCharValue(t);
