...
public class dw extends ed {
    ...
    public void d(int i) throws ee {
        if (i < 0) {
            throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "Negative length: "));
        }
        if (this.f) {
            int i2 = this.e - i;
            this.e = i2;
            if (i2 < 0) {
                throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "Message length exceeded: "));
            }
        }
    }
