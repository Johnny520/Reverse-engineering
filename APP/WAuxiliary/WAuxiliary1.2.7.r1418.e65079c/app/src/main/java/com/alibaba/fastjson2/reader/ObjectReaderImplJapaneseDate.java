...
final class ObjectReaderImplJapaneseDate extends ObjectReaderPrimitive<JapaneseDate> {
    ...
    public JapaneseDate readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j) {
    ...
    public JapaneseDate readObject(JSONReader jSONReader, Type type, Object obj, long j) {
        String string = jSONReader.readString();
        if (string == null) {
            return null;
        }
