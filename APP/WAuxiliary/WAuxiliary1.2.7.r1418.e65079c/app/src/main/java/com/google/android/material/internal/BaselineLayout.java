...
public class BaselineLayout extends ViewGroup {
    ...
    public int f802Ujhhgtgfeyxiexzf;

    public BaselineLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        this.f802Ujhhgtgfeyxiexzf = -1;
    }

    @Override // android.view.View
    public int getBaseline() {
        return this.f802Ujhhgtgfeyxiexzf;
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int baseline = (this.f802Ujhhgtgfeyxiexzf == -1 || childAt.getBaseline() == -1) ? paddingTop : (this.f802Ujhhgtgfeyxiexzf + paddingTop) - childAt.getBaseline();
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (iMax3 != -1) {
            ...
            this.f802Ujhhgtgfeyxiexzf = iMax3;
        }
