...
public final class JSONKt {
    ...
    public static /* synthetic */ Object parseObject$default(byte[] bArr, int i, int i2, Charset charset, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            charset = AbstractC2689Ujhhgtgfeyxiexzf.f8581Ujhhgtgfeyxiexzf;
        }
    ...
    public static /* synthetic */ void parseObject$default(Reader reader, char c, InterfaceC3549feyxiexzfUjhhgtg interfaceC3549feyxiexzfUjhhgtg, int i, Object obj) {
        if ((i & 1) != 0) {
            c = '\n';
        }
        JSON.parseObject(reader, c, Object.class, new JSONKt$sam$i$java_util_function_Consumer$0(interfaceC3549feyxiexzfUjhhgtg));
    }
    ...
    public static /* synthetic */ void parseObject$default(InputStream inputStream, Charset charset, char c, JSONReader.Feature[] featureArr, InterfaceC3549feyxiexzfUjhhgtg interfaceC3549feyxiexzfUjhhgtg, int i, Object obj) {
        if ((i & 2) != 0) {
            c = '\n';
        }
        JSON.parseObject(inputStream, charset, c, Object.class, new JSONKt$sam$i$java_util_function_Consumer$0(interfaceC3549feyxiexzfUjhhgtg), (JSONReader.Feature[]) Arrays.copyOf(featureArr, featureArr.length));
    }
    ...
    public static final /* synthetic */ <T> T m580parseObject(String str) {
        return (T) JSON.parseObject(str, Object.class);
    }

    /* JADX INFO: renamed from: parseObject, reason: collision with other method in class */
    public static final /* synthetic */ <T> T m581parseObject(String str, JSONReader.Feature... featureArr) {
    ...
    /* JADX INFO: renamed from: parseObject, reason: collision with other method in class */
    public static final /* synthetic */ <T> T m582parseObject(byte[] bArr) {
        return (T) JSON.parseObject(bArr, Object.class);
    }

    /* JADX INFO: renamed from: parseObject, reason: collision with other method in class */
    public static final /* synthetic */ <T> T m583parseObject(byte[] bArr, JSONReader.Feature... featureArr) {
