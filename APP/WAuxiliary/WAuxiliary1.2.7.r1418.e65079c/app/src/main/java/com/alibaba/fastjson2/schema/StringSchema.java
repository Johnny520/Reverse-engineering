...
public final class StringSchema extends JSONSchema {
    ...
    public StringSchema(JSONObject jSONObject) {
        ...
        switch (string2) {
            case "duration":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(15);
                break;
            case "date-time":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(12);
                break;
            case "uri":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(11);
                break;
            case "date":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(13);
                break;
            case "ipv4":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(9);
                break;
            case "ipv6":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(10);
                break;
            case "time":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(14);
                break;
            case "uuid":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(16);
                break;
            case "email":
                this.formatValidator = new C2574Ujhhgtgfeyxiexzf(i);
                break;
            default:
                this.formatValidator = null;
                break;
