...
final class ObjectReaderImplMinguoDate extends ObjectReaderPrimitive<MinguoDate> {
    static final ObjectReaderImplMinguoDate INSTANCE = new ObjectReaderImplMinguoDate();

    public ObjectReaderImplMinguoDate() {
    ...
    public MinguoDate readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j) {
        String string = jSONReader.readString();
        if (string == null || string.isEmpty()) {
            return null;
        }
        return (MinguoDate) parseChronoLocalDate(string, MinguoChronology.INSTANCE);
    }

    @Override // com.alibaba.fastjson2.reader.ObjectReader
    public MinguoDate readObject(JSONReader jSONReader, Type type, Object obj, long j) {
        String string = jSONReader.readString();
        if (string == null) {
            return null;
        }
