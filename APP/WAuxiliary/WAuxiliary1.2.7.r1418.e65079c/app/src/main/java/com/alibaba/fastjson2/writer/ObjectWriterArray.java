...
final class ObjectWriterArray extends ObjectWriterPrimitiveImpl {
    ...
    public ObjectWriterArray(Type type) {
        String strM2711Ujhhgtgfeyxiexzf;
        this.itemType = type;
        if (type == Object.class) {
            this.typeNameBytes = JSONB.toBytes("[O");
            this.typeNameHash = Fnv.hashCode64("[0");
            strM2711Ujhhgtgfeyxiexzf = "{\"@type\":\"[O";
        } else {
            String str = "[" + TypeUtils.getTypeName((Class) type);
            this.typeNameBytes = JSONB.toBytes(str);
            this.typeNameHash = Fnv.hashCode64(str);
            strM2711Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("{\"@type\":\"", str);
        }
        String strM2703Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2703Ujhhgtgfeyxiexzf(strM2711Ujhhgtgfeyxiexzf, "\",\"@value\":[");
        this.prefixChars = strM2703Ujhhgtgfeyxiexzf.toCharArray();
        this.prefixBytes = strM2703Ujhhgtgfeyxiexzf.getBytes(StandardCharsets.UTF_8);
    }
