...
public final class NumberUtils {
    ...
    static {
        LongBiFunction ujhhgtgfeyxiexzf;
        long j;
        int i;
        int i2;
        if (JDKUtils.JVM_VERSION <= 8 || JDKUtils.ANDROID) {
            ujhhgtgfeyxiexzf = null;
        } else {
            try {
                ...
                ujhhgtgfeyxiexzf = (LongBiFunction) LambdaMetafactory.metafactory(lookupTrustedLookup, "multiplyHigh", MethodType.methodType(LongBiFunction.class), methodType, lookupTrustedLookup.findStatic(Math.class, "multiplyHigh", methodType), methodType).getTarget().invokeExact();
            } catch (Throwable unused) {
                ujhhgtgfeyxiexzf = null;
            }
        }
        if (ujhhgtgfeyxiexzf == null) {
            ujhhgtgfeyxiexzf = new Ujhhgtgfeyxiexzf();
        }
        MULTIPLY_HIGH = ujhhgtgfeyxiexzf;
        ...
        for (int i6 = 0; i6 < length2; i6++) {
            String strM4795Ujhhgtgfeyxiexzf = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i6, "1.0E");
            String strM4795Ujhhgtgfeyxiexzf2 = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i6, "1.0E-");
            POSITIVE_DECIMAL_POWER_CHARS[i6] = strM4795Ujhhgtgfeyxiexzf.toCharArray();
            NEGATIVE_DECIMAL_POWER_CHARS[i6] = strM4795Ujhhgtgfeyxiexzf2.toCharArray();
        }
