...
import p000.C0315Ujhhgtgfeyxiexzf;
...
public class MoneySupport {
    ...
    public static ObjectWriter createNumberValueWriter() {
        ...
        if (FUNC_NUMBER_VALUE == null) {
            try {
                FUNC_NUMBER_VALUE = new C0315Ujhhgtgfeyxiexzf(LambdaMiscCodec.createBiFunction(CLASS_NUMBER_VALUE.getMethod("numberValue", Class.class)), 0);
            } catch (Throwable th) {
