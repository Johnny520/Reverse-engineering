    ...
    static {
        ...
        Gender gender = new Gender("Male", i, i2) { // from class: com.umeng.analytics.Gender.1
            ...
            public String toString() {
                ...
                return AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(this.value, "Male:");
            }
        };
        Male = gender;
        int i3 = 2;
        Gender gender2 = new Gender("Female", i2, i3) { // from class: com.umeng.analytics.Gender.2
            ...
            public String toString() {
                Locale locale = Locale.US;
                return AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(this.value, "Female:");
            }
        };
        Female = gender2;
        Gender gender3 = new Gender("Unknown", i3, i) { // from class: com.umeng.analytics.Gender.3
            ...
            public String toString() {
                Locale locale = Locale.US;
                return AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(this.value, "Unknown:");
            }
        };
        Unknown = gender3;
