...
public abstract class JSONWriter implements Closeable {
    ...
    public static IllegalArgumentException illegalYear(int i) {
        return new IllegalArgumentException(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "Only 4 digits numbers are supported. Provided: "));
    }
    ...
    public final int newCapacity(int i, int i2) {
        ...
        StringBuilder sbM4804Ujhhgtgfeyxiexzf = AbstractC3317feyxiexzfUjhhgtg.m4804Ujhhgtgfeyxiexzf(i, "Maximum array size exceeded. Try enabling LargeObject feature instead. Requested size: ", ", max size: ");
        sbM4804Ujhhgtgfeyxiexzf.append(this.maxArraySize);
        throw new JSONLargeObjectException(sbM4804Ujhhgtgfeyxiexzf.toString());
    }
