...
public class dx extends ed {
    ...
    public eb h() throws ee, es {
        ...
        byte b2 = (byte) (bU2 & j);
        if (b2 != 1) {
            throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(b2, "Expected version 1 but got "));
        }
    ...
    private void f(int i2) throws ee {
        if (i2 < 0) {
            throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i2, "Negative length: "));
        }
        long j2 = this.q;
        if (j2 != -1 && i2 > j2) {
            throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i2, "Length exceeded max allowed: "));
        }
    }
    ...
    private byte d(byte b2) throws ee {
        ...
        switch (b3) {
            ...
            case Opcodes.FCONST_1 /* 12 */:
                return (byte) 12;
            default:
                throw new ee(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(b3, "don't know what type: "));
        }
    }
