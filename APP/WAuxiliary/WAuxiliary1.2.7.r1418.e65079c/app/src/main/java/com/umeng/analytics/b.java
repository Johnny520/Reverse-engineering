...
public class b implements q, w {
    ...
    private p y;
    private static final String s = g.ar;
    private static final String v = g.as;
    ...
    public void h() {
        try {
            ...
            if (context != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, r.a.k, CoreProtocol.getInstance(context2), Long.valueOf(jCurrentTimeMillis));
                Context context3 = a;
                UMWorkDispatch.sendEvent(context3, r.a.g, CoreProtocol.getInstance(context3), Long.valueOf(jCurrentTimeMillis));
            }
    ...
    public void j() {
        try {
            ...
            Context context2 = a;
            UMWorkDispatch.sendEvent(context2, r.a.f, CoreProtocol.getInstance(context2), jSONObject);
            Context context3 = a;
            UMWorkDispatch.sendEvent(context3, r.a.o, CoreProtocol.getInstance(context3), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
        ...
        try {
            ...
            if (UMUtils.isMainProgress(a)) {
                ...
                if (UMConfigure.isDebugLog()) {
                    UMLog.mutlInfo(m.B, 3, "", null, null);
                }
    ...
    public synchronized void f(Context context) {
        try {
            ...
            this.k = new JSONObject();
            Context context2 = a;
            UMWorkDispatch.sendEvent(context2, r.a.u, CoreProtocol.getInstance(context2), null);
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public synchronized void g(Context context) {
        try {
            ...
            if (this.m.length() > 0) {
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, r.a.y, CoreProtocol.getInstance(context2), null);
            }
            this.m = new JSONObject();
        } catch (Throwable th) {
            throw th;
    ...
    public void i() {
        try {
            ...
            if (context != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, r.a.h, CoreProtocol.getInstance(context2), Long.valueOf(System.currentTimeMillis()));
                Context context3 = a;
                UMWorkDispatch.sendEvent(context3, r.a.d, CoreProtocol.getInstance(context3), null);
                Context context4 = a;
                UMWorkDispatch.sendEvent(context4, r.a.c, CoreProtocol.getInstance(context4), null);
                Context context5 = a;
                UMWorkDispatch.sendEvent(context5, r.a.i, CoreProtocol.getInstance(context5), null);
            }
        } catch (Throwable unused) {
        }
        ISysListener iSysListener = this.b;
        ...
        try {
            ...
            if (str != null && str.length() > 0) {
                if (this.m.has(str)) {
                    this.m.remove(str);
                    Context context2 = a;
                    UMWorkDispatch.sendEvent(context2, r.a.x, CoreProtocol.getInstance(context2), this.m.toString());
    ...
    public synchronized void d(Context context, String str) {
        try {
            ...
            if (this.k.has(str)) {
                this.k.remove(str);
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, r.a.v, CoreProtocol.getInstance(context2), str);
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public void b(Context context, String str) {
        try {
            ...
            map.put(g.aK, str);
            a(a, g.aJ, (Map<String, Object>) map, -1L, false);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    public void a(Context context, String str) {
        ...
        try {
            ...
            Context context2 = a;
            UMWorkDispatch.sendEvent(context2, r.a.j, CoreProtocol.getInstance(context2), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    public void a(Throwable th) {
        try {
            ...
            if (AnalyticsConfig.enable) {
                ...
                x xVar = this.f;
                if (xVar != null) {
                    xVar.c(a, Long.valueOf(System.currentTimeMillis()));
                }
                if (th != null) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put("ts", System.currentTimeMillis());
                    jSONObject.put(g.W, 1);
                    jSONObject.put(g.X, DataHelper.convertExceptionToString(th));
                    l.a(a).a(this.f.c(), jSONObject.toString(), 1);
                }
                r.a(a).d();
                y.a(a);
                if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION == MobclickAgent.PageMode.AUTO) {
    ...
    public void a(String str, String str2) {
        try {
            ...
            jSONObject.put("ts", jCurrentTimeMillis);
            Context context2 = a;
            UMWorkDispatch.sendEvent(context2, r.a.e, CoreProtocol.getInstance(context2), jSONObject);
            Context context3 = a;
            UMWorkDispatch.sendEvent(context3, r.a.o, CoreProtocol.getInstance(context3), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
    ...
    public synchronized void a(Context context, String str, Object obj) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str) && obj != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, r.a.t, CoreProtocol.getInstance(context2), this.k.toString());
                return;
            }
            UMLog.aq(m.ag, 0, "\\|");
        } catch (Throwable unused2) {
    ...
    public synchronized void a(Context context, JSONObject jSONObject) {
        ...
        try {
            ...
            if (jSONObject != null && jSONObject.length() > 0) {
                ...
                if (this.m.length() > 0) {
                    Context context2 = a;
                    UMWorkDispatch.sendEvent(context2, r.a.w, CoreProtocol.getInstance(context2), this.m.toString());
                }
                return;
            }
            UMLog.aq(m.am, 0, "\\|");
            ...
            try {
                ...
                if (obj instanceof String) {
                    ...
                    if (!g(strTrim)) {
                        ...
                        jSONObject.put(g.T, strTrim);
                    }
                } else {
                    jSONObject.put(g.T, obj);
                }
                Context context = a;
                UMWorkDispatch.sendEvent(context, r.a.q, CoreProtocol.getInstance(context), jSONObject);
            } catch (Throwable unused) {
            }
        }
    }
