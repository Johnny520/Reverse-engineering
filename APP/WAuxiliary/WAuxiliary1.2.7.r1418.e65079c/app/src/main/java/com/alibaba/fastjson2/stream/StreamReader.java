        ...
        public String getInferSQLType() {
            ...
            if (this.nonAsciiStrings <= 0 && (i = this.nulls) != (i2 = this.values)) {
                ...
                if (i2 == this.integers + i) {
                    ...
                    return i3 < 20 ? "BIGINT" : AbstractC1225feyxiexzfUjhhgtg.m2705Ujhhgtgfeyxiexzf(new StringBuilder("DECIMAL("), this.precision, ", 0)");
                }
                if (i2 == this.numbers + i) {
                    ...
                    return AbstractC1225feyxiexzfUjhhgtg.m2705Ujhhgtgfeyxiexzf(AbstractC3317feyxiexzfUjhhgtg.m4804Ujhhgtgfeyxiexzf(i4, "DECIMAL(", ", "), this.scale, ")");
                }
            }
            return "STRING";
        }
