...
class b extends SQLiteOpenHelper {
    ...
    public static String b(Context context, String str) {
        ...
        StringBuilder sbM2707Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2707Ujhhgtgfeyxiexzf(strB);
        sbM2707Ujhhgtgfeyxiexzf.append(a.e);
        return String.format(sbM2707Ujhhgtgfeyxiexzf.toString(), str);
    }
