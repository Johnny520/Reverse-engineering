...
final class FieldWriterInt32Value<T> extends FieldWriterInt32<T> {
    public FieldWriterInt32Value(String str, int i, long j, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public void writeValue(JSONWriter jSONWriter, T t) {
        jSONWriter.writeInt32(this.propertyAccessor.getIntValue(t));
    }
}
