...
public class a {
    ...
    public static final int D = 32802;
    public static final int E = 32803;
    public static final int F = 32804;
    public static final int G = 32805;
    public static final String H = "umpx_oplus_lbs";
    public static final String I = "umeng_sp_zid";
    public static final String J = "preInitInvoked";
    public static final String K = "policyGrantInvoked";
