...
public abstract class CSVWriter implements Closeable, Flushable {
    ...
    public final void writeDate(long j) {
        ...
        long jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j7, 400L, ((j7 / 4) + (j7 * 365)) - (j7 / 100), j2);
        if (jM2692Ujhhgtgfeyxiexzf < 0) {
            j7--;
            jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j7, 400L, ((j7 / 4) + (365 * j7)) - (j7 / 100), j2);
        }
        long j8 = j7 + j3;
        ...
        if (j9 < -999999999 || j9 > 999999999) {
            throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j9, "Invalid year "));
        }
        int i5 = (int) j9;
        long j10 = iFloorMod;
        if (j10 >= 0 && j10 <= 86399) {
        ...
        throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j10, "Invalid secondOfDay "));
    }
