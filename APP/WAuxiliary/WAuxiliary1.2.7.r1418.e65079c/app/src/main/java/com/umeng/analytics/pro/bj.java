...
public class bj implements bf {
    ...
    private static boolean a(Context context, String str) {
        try {
            ...
            StringBuilder sbM2419Ujhhgtgfeyxiexzf = AbstractC0924feyxiexzfUjhhgtg.m2419Ujhhgtgfeyxiexzf("FreemeDeviceIdSupplier---Package ", str, " not available: ");
            sbM2419Ujhhgtgfeyxiexzf.append(e2.getMessage());
            MLog.w(sbM2419Ujhhgtgfeyxiexzf.toString());
            return false;
        }
    }
}
