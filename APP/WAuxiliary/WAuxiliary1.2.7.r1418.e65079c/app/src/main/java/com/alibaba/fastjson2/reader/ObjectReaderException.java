...
final class ObjectReaderException<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReaderException(Class<T> cls) {
        this(cls, Arrays.asList(BeanUtils.getConstructor(cls)), ObjectReaders.fieldReader("stackTrace", StackTraceElement[].class, new C1291feyxiexzfUjhhgtg(0)));
    }
            ...
            if (jSONReader.isSupportAutoType(j) || context.getContextAutoTypeBeforeHandler() != null) {
                ...
                if (objectReaderAutoType == null) {
                    ...
                    if (objectReaderAutoType2 == null) {
                        StringBuilder sbM2419Ujhhgtgfeyxiexzf = AbstractC0924feyxiexzfUjhhgtg.m2419Ujhhgtgfeyxiexzf("autoType not support : ", string, ", offset ");
                        sbM2419Ujhhgtgfeyxiexzf.append(jSONReader.getOffset());
    ...
    public ObjectReaderException(Class<T> cls, List<Constructor> list, FieldReader... fieldReaderArr) {
        ...
        list.sort(new Ujhhgtgfeyxiexzf());
