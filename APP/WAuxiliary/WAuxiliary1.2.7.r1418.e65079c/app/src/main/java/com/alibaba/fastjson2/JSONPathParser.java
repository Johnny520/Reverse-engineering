...
class JSONPathParser {
        ...
        if (c == '\"') {
            ...
            if (c == '-') {
                ...
                if (!"last".equals(fieldNameUnquote)) {
                    throw new JSONException(AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("not support : ", fieldNameUnquote));
                }
                ...
                if (!"randomIndex".equals(fieldNameUnquote2) || !this.jsonReader.nextIfMatch('(') || !this.jsonReader.nextIfMatch(')') || this.jsonReader.ch != ']') {
                    throw new JSONException(AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("not support : ", fieldNameUnquote2));
                }
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r2v44 ??, new type: java.util.ArrayList
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r2v65 ??, new type: java.util.ArrayList
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v15 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v16 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r7v10 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    /*  JADX ERROR: Types fix failed
        jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v37 ??, new type: byte
        	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
        	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    ...
    public JSONPathSegment parseFilterRest(JSONPathSegment jSONPathSegment) {
        ...
        if (c == '&') {
            ...
            if (!"and".equalsIgnoreCase(fieldNameUnquote)) {
                throw new JSONException(AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("syntax error : ", fieldNameUnquote));
            }
        } else {
            if (c == 'O') {
                fieldNameUnquote2 = jSONReader.readFieldNameUnquote();
                if (!"or".equalsIgnoreCase(fieldNameUnquote2)) {
                    throw new JSONException(AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("syntax error : ", fieldNameUnquote2));
                }
            } else if (c == 'a') {
                fieldNameUnquote = jSONReader.readFieldNameUnquote();
                if (!"and".equalsIgnoreCase(fieldNameUnquote)) {
