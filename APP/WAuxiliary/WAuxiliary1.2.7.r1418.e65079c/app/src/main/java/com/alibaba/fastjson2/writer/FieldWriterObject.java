...
public class FieldWriterObject<T> extends FieldWriter<T> {
    ...
    private boolean writeInternal(JSONWriter jSONWriter, T t) {
        ...
        try {
            ...
            if (objectWriter == null) {
                throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls4, "get objectWriter error : "));
            }
    ...
    public void writeEnumJSONB(JSONWriter jSONWriter, Enum r11) {
        ...
        if (objectWriter2 == null) {
            throw new JSONException(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "get value writer error, valueType : "));
        }
