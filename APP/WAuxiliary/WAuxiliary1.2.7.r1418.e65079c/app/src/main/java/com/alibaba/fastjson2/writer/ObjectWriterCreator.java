    ...
    */
    ...
    public ObjectWriter createObjectWriter(Class cls, long j, final ObjectWriterProvider objectWriterProvider) {
        ...
        if (z2) {
            ...
            BeanUtils.declaredFields(cls2, new Consumer(objectWriterCreator) { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱ能不能ᛳᛴ要点脸ᛲᛱUjhhgtgᛱ

                /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛲᛴᛳ, reason: contains not printable characters */
                public final /* synthetic */ ObjectWriterCreator f4772Ujhhgtgfeyxiexzf;

                {
                    this.f4772Ujhhgtgfeyxiexzf = objectWriterCreator;
                }
                ...
                public final void accept(Object obj) {
                    switch (i) {
                        case 0:
                            this.f4772Ujhhgtgfeyxiexzf.lambda$createObjectWriter$0(fieldInfo, cls2, j4, objectWriterProvider, beanInfoCreateBeanInfo, (TreeMap) treeMap, (Field) obj);
                            break;
                        default:
                            this.f4772Ujhhgtgfeyxiexzf.lambda$createObjectWriter$1(fieldInfo, cls2, j4, objectWriterProvider, beanInfoCreateBeanInfo, (LinkedHashMap) treeMap, (Field) obj);
                            break;
                    }
                }
            });
            ...
            while (true) {
                if (it.hasNext()) {
                    ...
                    if (zIsRecord) {
                        ...
                        final int i2 = 1;
                        Consumer consumer = new Consumer(objectWriterCreator) { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱ能不能ᛳᛴ要点脸ᛲᛱUjhhgtgᛱ
                            ...
                            public final void accept(Object obj) {
                                switch (i2) {
                                    case 0:
                                        this.f4772Ujhhgtgfeyxiexzf.lambda$createObjectWriter$0(fieldInfo, cls2, j4, objectWriterProvider, beanInfoCreateBeanInfo, (TreeMap) linkedHashMap, (Field) obj);
                                        break;
                                    default:
                                        this.f4772Ujhhgtgfeyxiexzf.lambda$createObjectWriter$1(fieldInfo, cls2, j4, objectWriterProvider, beanInfoCreateBeanInfo, (LinkedHashMap) linkedHashMap, (Field) obj);
                                        break;
                                }
                            }
                        };
                    ...
                    Class cls6 = cls3;
                    C1303feyxiexzfUjhhgtg c1303feyxiexzfUjhhgtg = new C1303feyxiexzfUjhhgtg(this, fieldInfo, j4, beanInfoCreateBeanInfo, objectWriterProvider, cls6, zIsRecord, linkedHashMap, 0);
                    objectWriterCreator2 = this;
                    cls4 = cls6;
                    beanInfo = beanInfoCreateBeanInfo;
                    BeanUtils.getters(cls4, mixIn, z3, c1303feyxiexzfUjhhgtg);
