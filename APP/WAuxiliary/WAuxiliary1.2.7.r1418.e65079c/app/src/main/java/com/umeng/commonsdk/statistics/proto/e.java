...
public class e implements de<e, EnumC0015e>, Serializable, Cloneable {
    public static final Map<EnumC0015e, dq> d;
    ...
    static {
        ...
        EnumMap enumMap = new EnumMap(EnumC0015e.class);
        enumMap.put(EnumC0015e.VALUE, new dq("value", (byte) 2, new dr((byte) 11)));
        enumMap.put(EnumC0015e.TS, new dq("ts", (byte) 2, new dr((byte) 10)));
        enumMap.put(EnumC0015e.GUID, new dq("guid", (byte) 2, new dr((byte) 11)));
        Map<EnumC0015e, dq> mapUnmodifiableMap = Collections.unmodifiableMap(enumMap);
    ...
    public e() {
        this.l = (byte) 0;
        this.m = new EnumC0015e[]{EnumC0015e.VALUE, EnumC0015e.TS, EnumC0015e.GUID};
    }
    ...
    /* JADX INFO: compiled from: obf */
    public enum EnumC0015e implements dl {
        VALUE(1, "value"),
        TS(2, "ts"),
        GUID(3, "guid");

        private static final Map<String, EnumC0015e> d = new HashMap();
        private final short e;
        private final String f;

        static {
            for (EnumC0015e enumC0015e : EnumSet.allOf(EnumC0015e.class)) {
                d.put(enumC0015e.b(), enumC0015e);
            }
        }

        EnumC0015e(short s, String str) {
            this.e = s;
            this.f = str;
        }

        public static EnumC0015e a(int i) {
            if (i == 1) {
                return VALUE;
            }
            if (i == 2) {
        ...
        public static EnumC0015e b(int i) {
            EnumC0015e enumC0015eA = a(i);
            if (enumC0015eA != null) {
                return enumC0015eA;
            }
        ...
        public static EnumC0015e a(String str) {
            return d.get(str);
        }
    ...
    @Override // com.umeng.analytics.pro.de
    /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    public EnumC0015e fieldForId(int i2) {
        return EnumC0015e.a(i2);
    }
