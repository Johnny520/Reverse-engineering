...
public class ObjectReader4<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader4(Class cls, long j, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader fieldReader, FieldReader fieldReader2, FieldReader fieldReader3, FieldReader fieldReader4) {
        this(cls, null, null, j, jSONSchema, supplier, function, fieldReader, fieldReader2, fieldReader3, fieldReader4);
    }
    ...
    public ObjectReader4(Class cls, String str, String str2, long j, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        this(cls, str, str2, j, null, supplier, function, fieldReaderArr);
    }

    public ObjectReader4(Class cls, String str, String str2, long j, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        ...
        this.hasDefaultValue = (fieldReader.defaultValue == null && fieldReader2.defaultValue == null && fieldReader3.defaultValue == null && fieldReader4.defaultValue == null) ? false : true;
    }
}
