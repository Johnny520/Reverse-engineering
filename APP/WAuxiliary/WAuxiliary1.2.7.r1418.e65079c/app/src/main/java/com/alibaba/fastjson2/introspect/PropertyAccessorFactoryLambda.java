...
public abstract class PropertyAccessorFactoryLambda extends PropertyAccessorFactory {
    ...
    public ToByteFunction<Object> getByte(final Method method) {
        ...
        return new ToByteFunction() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛲᛴᛳ
            @Override // com.alibaba.fastjson2.function.ToByteFunction
            public final byte applyAsByte(Object obj) {
                return this.f3406Ujhhgtgfeyxiexzf.lambda$getByte$0(method, obj);
            }
        };
    }
    ...
    public ToCharFunction<Object> getChar(final Method method) {
        ...
        return new ToCharFunction() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸ᛲ能不能ᛳᛴ
            @Override // com.alibaba.fastjson2.function.ToCharFunction
            public final char applyAsChar(Object obj) {
                return this.f3360Ujhhgtgfeyxiexzf.lambda$getChar$2(method, obj);
            }
        };
    }
    ...
    public ToFloatFunction<Object> getFloat(Method method) {
        ...
        try {
            ...
            return new ToFloatFunction() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛴᛲᛳ
    ...
    public ToShortFunction<Object> getShort(final Method method) {
        ...
        return new ToShortFunction() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛴᛳᛲ
            @Override // com.alibaba.fastjson2.function.ToShortFunction
            public final short applyAsShort(Object obj) {
                return this.f3413Ujhhgtgfeyxiexzf.lambda$getShort$1(method, obj);
            }
        };
    }
    ...
    public ObjBoolConsumer setBoolean(Method method) {
        ...
        try {
            ...
            Class cls = Void.TYPE;
            return new C3432feyxiexzfUjhhgtg(1, (BiConsumer) LambdaMetafactory.metafactory(lookup, "accept", methodType, MethodType.methodType(cls, Object.class, Object.class), methodHandleUnreflect, MethodType.methodType(cls, method.getDeclaringClass(), Boolean.class)).getTarget().invokeExact());
        } catch (Throwable th) {
            throw new RuntimeException("Failed to create lambda for method: " + method, th);
        }
    }
    ...
    public ObjByteConsumer<Object> setByte(final Method method) {
        ...
        return new ObjByteConsumer() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛳᛴᛲ
            @Override // com.alibaba.fastjson2.function.ObjByteConsumer
            public final void accept(Object obj, byte b) {
                this.f3410Ujhhgtgfeyxiexzf.lambda$setByte$3(method, obj, b);
            }
        };
    }
    ...
    public ObjCharConsumer<Object> setChar(final Method method) {
        ...
        return new ObjCharConsumer() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛲᛳᛴ
            @Override // com.alibaba.fastjson2.function.ObjCharConsumer
            public final void accept(Object obj, char c) {
                this.f3404Ujhhgtgfeyxiexzf.lambda$setChar$4(method, obj, c);
            }
        };
    }
    ...
    public ObjFloatConsumer setFloat(Method method) {
        ...
        try {
            ...
            MethodType methodType = MethodType.methodType(BiConsumer.class);
            Class cls = Void.TYPE;
            return new C3430feyxiexzfUjhhgtg(1, (BiConsumer) LambdaMetafactory.metafactory(lookup, "accept", methodType, MethodType.methodType(cls, Object.class, Object.class), methodHandleUnreflect, MethodType.methodType(cls, method.getDeclaringClass(), Float.class)).getTarget().invokeExact());
        } catch (Throwable th) {
            throw new RuntimeException("Failed to create lambda for method: " + method, th);
        }
    }
    ...
    public ObjShortConsumer<Object> setShort(final Method method) {
        ...
        return new ObjShortConsumer() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ能不能ᛴᛳᛲ要点脸
            @Override // com.alibaba.fastjson2.function.ObjShortConsumer
            public final void accept(Object obj, short s) {
                this.f3340Ujhhgtgfeyxiexzf.lambda$setShort$5(method, obj, s);
            }
        };
    }
    ...
    public BiConsumer<Object, Object> setObject(final String str, Method method) {
        ...
        if (length == 2 && parameterTypes[0].equals(String.class)) {
            try {
                ...
                return new BiConsumer() { // from class: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛱUjhhgtgᛱ要点脸能不能ᛳᛲᛴ
