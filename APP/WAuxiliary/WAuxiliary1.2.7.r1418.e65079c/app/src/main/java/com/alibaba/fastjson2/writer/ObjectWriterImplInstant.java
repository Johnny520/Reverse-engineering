...
final class ObjectWriterImplInstant extends DateTimeCodec implements ObjectWriter {
    ...
    public void write(JSONWriter jSONWriter, Object obj, Object obj2, Type type, long j) {
        ...
        long jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j6, 400L, ((j6 / 4) + (j6 * 365)) - (j6 / 100), j2);
        if (jM2692Ujhhgtgfeyxiexzf < 0) {
            j6--;
            jM2692Ujhhgtgfeyxiexzf = AbstractC1225feyxiexzfUjhhgtg.m2692Ujhhgtgfeyxiexzf(j6, 400L, ((j6 / 4) + (365 * j6)) - (j6 / 100), j2);
        }
        long j7 = j6 + j3;
        ...
        if (j8 < -999999999 || j8 > 999999999) {
            throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j8, "Invalid year "));
        }
        int i5 = (int) j8;
        long j9 = iFloorMod;
        if (j9 < 0 || j9 > 86399) {
            throw new DateTimeException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j9, "Invalid secondOfDay "));
        }
        int i6 = (int) (j9 / 3600);
