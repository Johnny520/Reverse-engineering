...
public class FloatingActionButton$BaseBehavior<T> extends AbstractC3723feyxiexzfUjhhgtg {
    public FloatingActionButton$BaseBehavior() {
    }

    @Override // p000.AbstractC3723feyxiexzfUjhhgtg
    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛲᛳᛴ */
    public final boolean mo823Ujhhgtgfeyxiexzf(View view) {
    ...
    public FloatingActionButton$BaseBehavior(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC0799feyxiexzfUjhhgtg.f3126Ujhhgtgfeyxiexzf);
