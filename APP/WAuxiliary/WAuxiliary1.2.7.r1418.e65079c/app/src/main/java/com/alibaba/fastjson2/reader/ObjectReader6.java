...
public class ObjectReader6<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader6(Class cls, Supplier<T> supplier, long j, JSONSchema jSONSchema, Function function, FieldReader fieldReader, FieldReader fieldReader2, FieldReader fieldReader3, FieldReader fieldReader4, FieldReader fieldReader5, FieldReader fieldReader6) {
        this(cls, null, null, j, jSONSchema, supplier, function, fieldReader, fieldReader2, fieldReader3, fieldReader4, fieldReader5, fieldReader6);
    }
    ...
    public void initDefaultValue(T t) {
        ...
        this.fieldReader5.acceptDefaultValue(t);
    }
    ...
    public ObjectReader6(Class cls, String str, String str2, long j, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        this(cls, str, str2, j, null, supplier, function, fieldReaderArr);
    }

    public ObjectReader6(Class cls, String str, String str2, long j, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
