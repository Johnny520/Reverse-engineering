...
public final class ASMUtils {
    ...
    static {
        ...
        DESC_FIELD_WRITER_ARRAY = AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("[", str);
        String str2 = "L" + FieldReader.class.getName().replace('.', '/') + ';';
        DESC_FIELD_READER = str2;
        DESC_FIELD_READER_ARRAY = AbstractC1225feyxiexzfUjhhgtg.m2711Ujhhgtgfeyxiexzf("[", str2);
        DESC_JSON_READER = AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("L", strReplace, ';');
        DESC_JSON_WRITER = AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("L", strReplace5, ';');
        DESC_OBJECT_READER = AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("L", strReplace2, ';');
        DESC_OBJECT_READER_ADAPTER = AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("L", strReplace3, ';');
        DESC_OBJECT_WRITER = AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("L", strReplace4, ';');
    ...
    public static String[] lookupParameterNames(AccessibleObject accessibleObject) {
        ...
        while (i < parameterCount) {
            strArr3[i] = AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "arg");
            i++;
        }
        return strArr3;
    }
