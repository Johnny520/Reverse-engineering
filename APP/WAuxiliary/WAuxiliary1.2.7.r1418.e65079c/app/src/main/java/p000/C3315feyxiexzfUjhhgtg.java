...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ要点脸ᛲᛱfeyxiexzfᛱᛴᛳᛱUjhhgtgᛱ能不能, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C3315feyxiexzfUjhhgtg extends AbstractC3318feyxiexzfUjhhgtg {

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛴᛲ, reason: contains not printable characters */
    public final int f10352Ujhhgtgfeyxiexzf;

    public C3315feyxiexzfUjhhgtg(int i) {
        this.f10352Ujhhgtgfeyxiexzf = i;
    }
    ...
    public final int mo1527Ujhhgtgfeyxiexzf(C3470Ujhhgtgfeyxiexzf c3470Ujhhgtgfeyxiexzf) {
        ...
        int i = this.f10352Ujhhgtgfeyxiexzf;
        if (i != 0) {
