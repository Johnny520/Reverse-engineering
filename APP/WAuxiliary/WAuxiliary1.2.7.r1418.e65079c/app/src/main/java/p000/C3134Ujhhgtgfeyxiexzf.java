...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ要点脸ᛱUjhhgtgᛱ能不能ᛱfeyxiexzfᛱᛲᛴᛳ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C3134Ujhhgtgfeyxiexzf extends AbstractC3148Ujhhgtgfeyxiexzf {

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛴᛲ, reason: contains not printable characters */
    public static final C3134Ujhhgtgfeyxiexzf f9726Ujhhgtgfeyxiexzf = new C3134Ujhhgtgfeyxiexzf(0);

    @Override // p000.InterfaceC1793feyxiexzfUjhhgtg
    public final C1784feyxiexzfUjhhgtg getType() {
        return C1784feyxiexzfUjhhgtg.f5980Ujhhgtgfeyxiexzf;
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("byte{0x");
        int i = this.f9756Ujhhgtgfeyxiexzf;
        sb.append(AbstractC1264feyxiexzfUjhhgtg.m2808Ujhhgtgfeyxiexzf(i));
        sb.append(" / ");
        sb.append(i);
        sb.append('}');
        return sb.toString();
