...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能ᛱUjhhgtgᛱᛲᛱfeyxiexzfᛱᛴᛳ要点脸, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public class C2343Ujhhgtgfeyxiexzf extends ImageView {

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛲᛴ, reason: contains not printable characters */
    public final C3017Ujhhgtgfeyxiexzf f7645Ujhhgtgfeyxiexzf;

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛴᛲ, reason: contains not printable characters */
    public final C2344Ujhhgtgfeyxiexzf f7646Ujhhgtgfeyxiexzf;

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛴᛲᛳ, reason: contains not printable characters */
    public boolean f7647Ujhhgtgfeyxiexzf;

    public C2343Ujhhgtgfeyxiexzf(Context context) {
        this(context, null, 0);
    }
    ...
    public final void drawableStateChanged() {
        ...
        C3017Ujhhgtgfeyxiexzf c3017Ujhhgtgfeyxiexzf = this.f7645Ujhhgtgfeyxiexzf;
        if (c3017Ujhhgtgfeyxiexzf != null) {
            c3017Ujhhgtgfeyxiexzf.m4464Ujhhgtgfeyxiexzf();
        }
        C2344Ujhhgtgfeyxiexzf c2344Ujhhgtgfeyxiexzf = this.f7646Ujhhgtgfeyxiexzf;
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f7646Ujhhgtgfeyxiexzf.f7649Ujhhgtgfeyxiexzf).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C2344Ujhhgtgfeyxiexzf c2344Ujhhgtgfeyxiexzf = this.f7646Ujhhgtgfeyxiexzf;
        if (c2344Ujhhgtgfeyxiexzf != null && drawable != null && !this.f7647Ujhhgtgfeyxiexzf) {
            c2344Ujhhgtgfeyxiexzf.f7648Ujhhgtgfeyxiexzf = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (c2344Ujhhgtgfeyxiexzf != null) {
            c2344Ujhhgtgfeyxiexzf.m3536Ujhhgtgfeyxiexzf();
            if (this.f7647Ujhhgtgfeyxiexzf) {
                return;
            }
    ...
    public void setImageLevel(int i) {
        ...
        this.f7647Ujhhgtgfeyxiexzf = true;
    }
    ...
    public C2343Ujhhgtgfeyxiexzf(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AbstractC1745Ujhhgtgfeyxiexzf.m3004Ujhhgtgfeyxiexzf(context);
        this.f7647Ujhhgtgfeyxiexzf = false;
        ...
        this.f7645Ujhhgtgfeyxiexzf = c3017Ujhhgtgfeyxiexzf;
        ...
        this.f7646Ujhhgtgfeyxiexzf = c2344Ujhhgtgfeyxiexzf;
