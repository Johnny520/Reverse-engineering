...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱᛴᛳ能不能ᛲ要点脸ᛱUjhhgtgᛱ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1185feyxiexzfUjhhgtg extends AbstractC1182feyxiexzfUjhhgtg {
    ...
    public static final boolean m2675feyxiexzfUjhhgtg(String str) {
        char c;
        boolean z;
        boolean z2;
        int i;
            ...
            if (i8 > length) {
                ...
                if (str.charAt(i8) == '.') {
                    ...
                    if (!z7 || z3) {
                        ...
                        i2 = (str2 != null && AbstractC1152feyxiexzfUjhhgtg.m2626feyxiexzfUjhhgtg(str, str2, i, false) == i) ? length + 1 : -1;
                    }
                } else {
                    i = i8;
                }
    ...
    public static Float m2676feyxiexzfUjhhgtg(String str) {
        try {
            if (m2675feyxiexzfUjhhgtg(str)) {
