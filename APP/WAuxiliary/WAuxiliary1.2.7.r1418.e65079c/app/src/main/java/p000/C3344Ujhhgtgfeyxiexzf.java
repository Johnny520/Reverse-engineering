...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ要点脸ᛲᛳ能不能ᛱUjhhgtgᛱᛴᛱfeyxiexzfᛱ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C3344Ujhhgtgfeyxiexzf extends AbstractC3318feyxiexzfUjhhgtg {

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛱfeyxiexzfᛱᛳᛴᛲ, reason: contains not printable characters */
    public final short f10454Ujhhgtgfeyxiexzf;

    public C3344Ujhhgtgfeyxiexzf(short s) {
        this.f10454Ujhhgtgfeyxiexzf = s;
    }
    ...
    public final int mo1527Ujhhgtgfeyxiexzf(C3470Ujhhgtgfeyxiexzf c3470Ujhhgtgfeyxiexzf) {
        ...
        short s = this.f10454Ujhhgtgfeyxiexzf;
        if (s != 0) {
            c3470Ujhhgtgfeyxiexzf.m4958Ujhhgtgfeyxiexzf(s);
