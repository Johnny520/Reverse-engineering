...
/* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱᛱfeyxiexzfᛱ要点脸能不能ᛴᛳᛱUjhhgtgᛱᛲ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: obf */
/* JADX INFO: loaded from: classes.dex */
public final class C1480feyxiexzfUjhhgtg extends C0866feyxiexzfUjhhgtg {

    /* JADX INFO: renamed from: 上海高中ᛱ谢子非ᛱ能不能要点脸ᛱUjhhgtgᛱᛲᛴᛱfeyxiexzfᛱᛳ, reason: contains not printable characters */
    public int f5135Ujhhgtgfeyxiexzf;
    ...
    public final InterfaceC2876feyxiexzfUjhhgtg mo2267Ujhhgtgfeyxiexzf(InterfaceC1121feyxiexzfUjhhgtg interfaceC1121feyxiexzfUjhhgtg) {
        throw new C0670Ujhhgtgfeyxiexzf("Packing only supports primitive number types. The input type however was a struct: " + interfaceC1121feyxiexzfUjhhgtg);
    }
    ...
    public final int mo1185Ujhhgtgfeyxiexzf(InterfaceC1121feyxiexzfUjhhgtg interfaceC1121feyxiexzfUjhhgtg) {
        ...
        int i = this.f5135Ujhhgtgfeyxiexzf;
        this.f5135Ujhhgtgfeyxiexzf = i + 1;
        return i;
    }
    ...
    public final String mo2294Ujhhgtgfeyxiexzf(long j) {
        throw new C0670Ujhhgtgfeyxiexzf("Packing only supports primitive number types. The actual reading is for string.");
    }
