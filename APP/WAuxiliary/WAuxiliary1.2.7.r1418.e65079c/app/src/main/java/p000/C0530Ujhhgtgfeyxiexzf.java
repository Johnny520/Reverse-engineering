    ...
    public final Object invoke(Object obj) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, "activity")) {
                    Intent intent = new Intent();
                    intent.setClassName(c3164feyxiexzfUjhhgtg.getContext(), str2);
                    c3164feyxiexzfUjhhgtg.getContext().startActivity(intent);
                } else if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, "wauxv")) {
            ...
            case 2:
                ...
                c0290Ujhhgtgfeyxiexzf.f1721Ujhhgtgfeyxiexzf = "删除菜单";
                c0290Ujhhgtgfeyxiexzf.f1722Ujhhgtgfeyxiexzf = "确定删除“" + c3485Ujhhgtgfeyxiexzf2.f10820Ujhhgtgfeyxiexzf + "”吗？";
                c0290Ujhhgtgfeyxiexzf.m1502Ujhhgtgfeyxiexzf("删除", new C2712feyxiexzfUjhhgtg(arrayList, c3476feyxiexzfUjhhgtg, c3485Ujhhgtgfeyxiexzf2, i2));
            ...
            case 4:
                ...
                AbstractC1150feyxiexzfUjhhgtg.m2621Ujhhgtgfeyxiexzf(activity, 2, "复制成功");
                break;
            default:
