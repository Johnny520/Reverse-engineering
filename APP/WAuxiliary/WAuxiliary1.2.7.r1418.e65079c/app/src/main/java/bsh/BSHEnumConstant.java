...
public class BSHEnumConstant extends SimpleNode {
    ...
    public Object eval(C2637feyxiexzfUjhhgtg c2637feyxiexzfUjhhgtg, RunnableC0026Ujhhgtgfeyxiexzf runnableC0026Ujhhgtgfeyxiexzf) {
        ...
        if (!getName().equals("" + c0029UjhhgtgfeyxiexzfM3973Ujhhgtgfeyxiexzf.f553Ujhhgtgfeyxiexzf)) {
            return Primitive.VOID;
        }
        if (hasArguments(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf)) {
            This.CONTEXT_ARGS.get().put(c0029UjhhgtgfeyxiexzfM3973Ujhhgtgfeyxiexzf.f553Ujhhgtgfeyxiexzf.toString(), getArguments(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf));
        }
        for (int i = 0; i < jjtGetNumChildren(); i++) {
            if (jjtGetChild(i) instanceof BSHBlock) {
                ((BSHBlock) jjtGetChild(i)).eval(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf, Boolean.TRUE);
            }
        }
        return Primitive.VOID;
    }
    ...
    public Object[] getArguments(C2637feyxiexzfUjhhgtg c2637feyxiexzfUjhhgtg, RunnableC0026Ujhhgtgfeyxiexzf runnableC0026Ujhhgtgfeyxiexzf) {
        if (this.args == null && jjtGetNumChildren() > 0 && (jjtGetChild(0) instanceof BSHArguments)) {
            this.args = ((BSHArguments) jjtGetChild(0)).getArguments(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf);
        }
        return this.args;
    }
    ...
    public boolean hasArguments(C2637feyxiexzfUjhhgtg c2637feyxiexzfUjhhgtg, RunnableC0026Ujhhgtgfeyxiexzf runnableC0026Ujhhgtgfeyxiexzf) {
        return getArguments(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf) != null;
    }
