...
public class BSHAutoCloseable extends BSHTypedVariableDeclaration {
    ...
    public C1853Ujhhgtgfeyxiexzf varThis;
    ...
    public void close() throws Exception {
        ...
        C1853Ujhhgtgfeyxiexzf c1853Ujhhgtgfeyxiexzf = this.varThis;
        if (c1853Ujhhgtgfeyxiexzf != null) {
            this.ths = (AutoCloseable) c1853Ujhhgtgfeyxiexzf.m3187Ujhhgtgfeyxiexzf();
        }
    ...
    public Object eval(C2637feyxiexzfUjhhgtg c2637feyxiexzfUjhhgtg, RunnableC0026Ujhhgtgfeyxiexzf runnableC0026Ujhhgtgfeyxiexzf) throws C3353Ujhhgtgfeyxiexzf {
        renderTypeNode();
        this.type = evalType(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf);
        if (!AutoCloseable.class.isAssignableFrom(getType())) {
            throw new C3354Ujhhgtgfeyxiexzf("The resource type " + this.type.getName() + " does not implement java.lang.AutoCloseable.", this, c2637feyxiexzfUjhhgtg);
        }
        this.name = getDeclarators()[0].name;
        super.eval(c2637feyxiexzfUjhhgtg, runnableC0026Ujhhgtgfeyxiexzf);
        try {
            this.varThis = c2637feyxiexzfUjhhgtg.m3973Ujhhgtgfeyxiexzf().m376Ujhhgtgfeyxiexzf(getName(), true);
            return Primitive.VOID;
        } catch (C1863Ujhhgtgfeyxiexzf e) {
            throw e.mo2570Ujhhgtgfeyxiexzf("Unable to evaluate the try-with-resource " + getName() + ". With message:" + e.getMessage(), this, c2637feyxiexzfUjhhgtg);
        }
    }
