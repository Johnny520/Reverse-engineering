...
public class Modifiers implements Serializable, Cloneable {
    ...
    private int toModifier(String str) {
        ...
        throw new IllegalStateException(AbstractC3317feyxiexzfUjhhgtg.m4801Ujhhgtgfeyxiexzf("Unknown modifier: '", str, "'"));
    }
    ...
    public void addModifier(int i) {
        if ((this.valid & i) == 0) {
            ...
            throw new IllegalStateException(AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(sb, toModifier(i), "'"));
        }
        if (i < 7) {
            int i2 = this.modifiers;
            if ((i2 & 7) > 0 && (i2 | i) != i2) {
