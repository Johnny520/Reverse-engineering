...
public final class Primitive implements Serializable {
    ...
    private Primitive(Object obj) {
        if (obj == null) {
            throw new C0712Ujhhgtgfeyxiexzf("Use Primitve.NULL instead of Primitive(null)");
        }
        this.value = obj;
    }
    ...
    public static Class<?> boxType(Class<?> cls) {
        ...
        if (cls2 == null || cls2.isPrimitive()) {
            throw new C0712Ujhhgtgfeyxiexzf(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "Not a primitive type: "));
        }
        return cls2;
    }
    ...
    public static Object castNumber(Class<?> cls, Number number) {
        ...
        if (dDoubleValue == 0.0d) {
            ...
            if (cls == BigDecimal.class) {
                ...
                return AbstractC0034Ujhhgtgfeyxiexzf.m569Ujhhgtgfeyxiexzf(number) ? BigDecimal.valueOf(number.doubleValue()) : new BigDecimal(number.longValue()).setScale(1);
            }
            if (number instanceof BigInteger) {
                ...
                bigInteger = AbstractC0034Ujhhgtgfeyxiexzf.m569Ujhhgtgfeyxiexzf(number) ? BigDecimal.valueOf(number.doubleValue()).toBigInteger() : BigInteger.valueOf(number.longValue());
            }
        ...
        throw new C0712Ujhhgtgfeyxiexzf("cannot assign number " + number + " to type " + cls.getSimpleName());
    }
    ...
    public static Primitive castPrimitive(Class<?> cls, Class<?> cls2, Primitive primitive, boolean z, int i) throws C1863Ujhhgtgfeyxiexzf {
        if (cls2 == Void.TYPE) {
            if (z) {
                return AbstractC0034Ujhhgtgfeyxiexzf.f590Ujhhgtgfeyxiexzf;
            }
            throw AbstractC0034Ujhhgtgfeyxiexzf.m557Ujhhgtgfeyxiexzf(AbstractC3594Ujhhgtgfeyxiexzf.m5196feyxiexzfUjhhgtg(cls), "void value", null, i);
        }
        if (!z && primitive.isNumber() && AbstractC0034Ujhhgtgfeyxiexzf.m573Ujhhgtgfeyxiexzf(cls)) {
            return new Primitive(castNumber(cls, primitive.numberValue()));
        }
        if (!cls.isPrimitive()) {
            if (cls2 == null) {
                return z ? AbstractC0034Ujhhgtgfeyxiexzf.f589Ujhhgtgfeyxiexzf : NULL;
            }
            if (z) {
                return AbstractC0034Ujhhgtgfeyxiexzf.f590Ujhhgtgfeyxiexzf;
            }
            throw AbstractC0034Ujhhgtgfeyxiexzf.m557Ujhhgtgfeyxiexzf("object type ".concat(cls.getName()), "primitive value", null, i);
        }
        if (cls2 == null && !VOID.equals(primitive)) {
            return z ? AbstractC0034Ujhhgtgfeyxiexzf.f589Ujhhgtgfeyxiexzf : getDefaultValue(cls);
        }
        Class<?> cls3 = Boolean.TYPE;
        if (cls == cls3) {
            return z ? AbstractC0034Ujhhgtgfeyxiexzf.f589Ujhhgtgfeyxiexzf : new Primitive(castWrapper(cls, primitive));
        }
        if (z && cls2 == cls3) {
            return cls != cls3 ? AbstractC0034Ujhhgtgfeyxiexzf.f590Ujhhgtgfeyxiexzf : AbstractC0034Ujhhgtgfeyxiexzf.f589Ujhhgtgfeyxiexzf;
        }
        if (i != 1 || AbstractC0034Ujhhgtgfeyxiexzf.m571Ujhhgtgfeyxiexzf(cls, cls2) || AbstractC0034Ujhhgtgfeyxiexzf.m572Ujhhgtgfeyxiexzf(cls, cls2) || !z) {
            return z ? AbstractC0034Ujhhgtgfeyxiexzf.f589Ujhhgtgfeyxiexzf : new Primitive(castWrapper(cls, primitive));
        }
        return AbstractC0034Ujhhgtgfeyxiexzf.f590Ujhhgtgfeyxiexzf;
    }
    ...
    public static Object castWrapper(Class<?> cls, Object obj) {
        ...
        if (!isWrapperType(cls) && !cls.isPrimitive()) {
            throw new C0712Ujhhgtgfeyxiexzf(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "invalid type in castWrapper: "));
        }
        ...
        if (objUnwrap instanceof String) {
            try {
                ...
                throw new C0712Ujhhgtgfeyxiexzf("cannot cast string \"" + objUnwrap + "\" to number", e);
            }
        }
        if (objUnwrap instanceof Boolean) {
        ...
        sb.append(AbstractC3594Ujhhgtgfeyxiexzf.m5199feyxiexzfUjhhgtg(objUnwrap) + " :" + AbstractC3594Ujhhgtgfeyxiexzf.m5197feyxiexzfUjhhgtg(objUnwrap));
        throw new C0712Ujhhgtgfeyxiexzf(sb.toString());
    }
    ...
    public static Primitive shrinkWrap(Object obj) {
        if (!(obj instanceof Number)) {
            throw new C0712Ujhhgtgfeyxiexzf("Can only shrink wrap Number types");
        }
        Number number = (Number) obj;
        if (AbstractC0034Ujhhgtgfeyxiexzf.m569Ujhhgtgfeyxiexzf(obj)) {
    ...
    public static Class<?> unboxType(Class<?> cls) {
        ...
        if (cls2 == null || !(cls2.isPrimitive() || cls2 == cls)) {
            throw new C0712Ujhhgtgfeyxiexzf(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "Not a primitive wrapper type: "));
        }
        return cls2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC0034Ujhhgtgfeyxiexzf.m569Ujhhgtgfeyxiexzf(this.value) || AbstractC0034Ujhhgtgfeyxiexzf.m569Ujhhgtgfeyxiexzf(primitive.value)) {
    ...
    public Object getValue() {
        ...
        throw new C0712Ujhhgtgfeyxiexzf("attempt to unwrap void type");
    }
    ...
    public boolean isNumber() {
        Object obj = this.value;
        return ((obj instanceof Boolean) || this == NULL || this == VOID || !AbstractC0034Ujhhgtgfeyxiexzf.m574Ujhhgtgfeyxiexzf(obj)) ? false : true;
    }
    ...
    public Number numberValue() {
        ...
        throw new C0712Ujhhgtgfeyxiexzf("Primitive not a number");
    }
    ...
    public String toString() {
        ...
        return obj == Special.VOID_TYPE ? "void" : obj.toString();
    }
