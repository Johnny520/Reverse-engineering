...
public final class ChatRoomInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (!C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.addtime, chatRoomInfo.addtime) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.modifytime, chatRoomInfo.modifytime) || this.chatroomnoticePublishTime != chatRoomInfo.chatroomnoticePublishTime || this.chatroomfamilystatusmodifytime != chatRoomInfo.chatroomfamilystatusmodifytime || this.roomflag != chatRoomInfo.roomflag || this.isShowname != chatRoomInfo.isShowname || this.style != chatRoomInfo.style || this.chatroomdataflag != chatRoomInfo.chatroomdataflag || this.chatroomStatus != chatRoomInfo.chatroomStatus || this.openIMRoomMigrateStatus != chatRoomInfo.openIMRoomMigrateStatus || this.spamStatus != chatRoomInfo.spamStatus || this.chatroomVersion != chatRoomInfo.chatroomVersion || this.chatroomNoticeNew != chatRoomInfo.chatroomNoticeNew || this.chatroomLocalVersion != chatRoomInfo.chatroomLocalVersion || this.memberCount != chatRoomInfo.memberCount || this.oldChatroomVersion != chatRoomInfo.oldChatroomVersion || this.compactFlag != chatRoomInfo.compactFlag || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.chatroomname, chatRoomInfo.chatroomname) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.memberlist, chatRoomInfo.memberlist) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.displayname, chatRoomInfo.displayname) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.chatroomnick, chatRoomInfo.chatroomnick) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.roomowner, chatRoomInfo.roomowner) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.selfDisplayName, chatRoomInfo.selfDisplayName) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.chatroomnotice, chatRoomInfo.chatroomnotice) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.xmlChatroomnotice, chatRoomInfo.xmlChatroomnotice) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.chatroomnoticeEditor, chatRoomInfo.chatroomnoticeEditor) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.associateOpenIMRoomName, chatRoomInfo.associateOpenIMRoomName) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.saveByteVersion, chatRoomInfo.saveByteVersion) || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.handleByteVersion, chatRoomInfo.handleByteVersion)) {
            return false;
        }
    ...
    public /* synthetic */ ChatRoomInfo(String str, Long l, Long l2, long j, long j2, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, byte[] bArr, byte[] bArr2, byte[] bArr3, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, long j3, int i10, int i11, long j4, int i12, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
