...
public final class FriendInfo {
    ...
    public boolean equals(Object obj) {
        ...
        return C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.wxid, friendInfo.wxid) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.alias, friendInfo.alias) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.remark, friendInfo.remark) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.nickname, friendInfo.nickname) && this.type == friendInfo.type && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.sourceExtInfo, friendInfo.sourceExtInfo) && this.createTime == friendInfo.createTime;
    }
    ...
    public int hashCode() {
        return Long.hashCode(this.createTime) + AbstractC0924feyxiexzfUjhhgtg.m2415Ujhhgtgfeyxiexzf((Integer.hashCode(this.type) + AbstractC0924feyxiexzfUjhhgtg.m2415Ujhhgtgfeyxiexzf(AbstractC0924feyxiexzfUjhhgtg.m2415Ujhhgtgfeyxiexzf(AbstractC0924feyxiexzfUjhhgtg.m2415Ujhhgtgfeyxiexzf(this.wxid.hashCode() * 31, 31, this.alias), 31, this.remark), 31, this.nickname)) * 31, 31, this.sourceExtInfo);
    }
