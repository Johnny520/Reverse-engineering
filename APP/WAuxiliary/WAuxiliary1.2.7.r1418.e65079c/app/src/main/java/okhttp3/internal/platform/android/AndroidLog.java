...
public final class AndroidLog {
    ...
    static {
        ...
        if (size == 0) {
            mapSingletonMap = C3308feyxiexzfUjhhgtg.f10345Ujhhgtgfeyxiexzf;
        } else if (size != 1) {
    ...
    private final String loggerTag(String str) {
        ...
        return str2 == null ? AbstractC1152feyxiexzfUjhhgtg.m2643feyxiexzfUjhhgtg(23, str) : str2;
    }
    ...
    public final void androidLog$okhttp(String str, int i, String str2, Throwable th) {
        ...
        if (Log.isLoggable(strLoggerTag, i)) {
            ...
            int i2 = 0;
            while (i2 < length) {
                int iM2628feyxiexzfUjhhgtg = AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('\n', i2, 4, str2);
                if (iM2628feyxiexzfUjhhgtg == -1) {
                    iM2628feyxiexzfUjhhgtg = length;
                }
                while (true) {
                    iMin = Math.min(iM2628feyxiexzfUjhhgtg, i2 + MAX_LOG_LENGTH);
                    Log.println(i, strLoggerTag, str2.substring(i2, iMin));
                    if (iMin >= iM2628feyxiexzfUjhhgtg) {
                        break;
                    } else {
                        i2 = iMin;
                    }
