...
public final class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers headers) {
            ...
            boolean z = false;
            Integer numM2673feyxiexzfUjhhgtg = null;
            boolean z2 = false;
            Integer numM2673feyxiexzfUjhhgtg2 = null;
            boolean z3 = false;
            boolean z4 = false;
            for (int i = 0; i < size; i++) {
                if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(headers.name(i), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION)) {
                    ...
                    while (i2 < strValue.length()) {
                        ...
                        if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strTrimSubstring2, "permessage-deflate")) {
                            if (z) {
                                z4 = true;
                            }
                            i2 = i3;
                            while (i2 < iDelimiterOffset$default) {
                                ...
                                if (iDelimiterOffset3 < iDelimiterOffset2) {
                                    ...
                                    if (strTrimSubstring.length() >= 2 && strTrimSubstring.startsWith("\"") && strTrimSubstring.endsWith("\"")) {
                                        strTrimSubstring = AbstractC1225feyxiexzfUjhhgtg.m2699Ujhhgtgfeyxiexzf(1, 1, strTrimSubstring);
                                    }
                                } else {
                                    strTrimSubstring = null;
                                }
                                int i4 = iDelimiterOffset2 + 1;
                                if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strTrimSubstring3, "client_max_window_bits")) {
                                    if (numM2673feyxiexzfUjhhgtg != null) {
                                        z4 = true;
                                    }
                                    numM2673feyxiexzfUjhhgtg = strTrimSubstring != null ? AbstractC1184feyxiexzfUjhhgtg.m2673feyxiexzfUjhhgtg(strTrimSubstring) : null;
                                    if (numM2673feyxiexzfUjhhgtg == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strTrimSubstring3, "client_no_context_takeover")) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    ...
                                    z2 = true;
                                } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strTrimSubstring3, "server_max_window_bits")) {
                                    if (numM2673feyxiexzfUjhhgtg2 != null) {
                                        z4 = true;
                                    }
                                    numM2673feyxiexzfUjhhgtg2 = strTrimSubstring != null ? AbstractC1184feyxiexzfUjhhgtg.m2673feyxiexzfUjhhgtg(strTrimSubstring) : null;
                                    if (numM2673feyxiexzfUjhhgtg2 == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strTrimSubstring3, "server_no_context_takeover")) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (strTrimSubstring != null) {
            ...
            return new WebSocketExtensions(z, numM2673feyxiexzfUjhhgtg, z2, numM2673feyxiexzfUjhhgtg2, z3, z4);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.perMessageDeflate == webSocketExtensions.perMessageDeflate && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.clientMaxWindowBits, webSocketExtensions.clientMaxWindowBits) && this.clientNoContextTakeover == webSocketExtensions.clientNoContextTakeover && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.serverMaxWindowBits, webSocketExtensions.serverMaxWindowBits) && this.serverNoContextTakeover == webSocketExtensions.serverNoContextTakeover && this.unknownValues == webSocketExtensions.unknownValues;
    }
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
