...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> cls) {
            ...
            while (superclass != null && !superclass.getSimpleName().equals("OpenSSLSocketImpl")) {
                ...
                if (superclass == null) {
                    throw new AssertionError(AbstractC3317feyxiexzfUjhhgtg.m4798Ujhhgtgfeyxiexzf(cls, "No OpenSSLSocketImpl superclass of socket of type "));
                }
            }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        try {
            ...
            if ((cause instanceof NullPointerException) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e2);
        }
