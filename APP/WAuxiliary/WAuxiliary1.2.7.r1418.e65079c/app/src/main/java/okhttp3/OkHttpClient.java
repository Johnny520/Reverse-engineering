...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m1021addInterceptor(final InterfaceC3549feyxiexzfUjhhgtg interfaceC3549feyxiexzfUjhhgtg) {
            return addInterceptor(new Interceptor() { // from class: okhttp3.OkHttpClient$Builder$addInterceptor$2
                @Override // okhttp3.Interceptor
                public final Response intercept(Interceptor.Chain chain) {
                    return (Response) interfaceC3549feyxiexzfUjhhgtg.invoke(chain);
                }
            });
        }

        /* JADX INFO: renamed from: -addNetworkInterceptor, reason: not valid java name */
        public final Builder m1022addNetworkInterceptor(final InterfaceC3549feyxiexzfUjhhgtg interfaceC3549feyxiexzfUjhhgtg) {
        ...
        public final Builder minWebSocketMessageToCompress(long j) {
            if (j < 0) {
                throw new IllegalArgumentException(AbstractC1225feyxiexzfUjhhgtg.m2701Ujhhgtgfeyxiexzf(j, "minWebSocketMessageToCompress must be positive: ").toString());
            }
        ...
        public final Builder proxy(Proxy proxy) {
            if (!C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(proxy, this.proxy)) {
                this.routeDatabase = null;
            }
            this.proxy = proxy;
            return this;
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            AbstractC2862feyxiexzfUjhhgtg.m4266feyxiexzfUjhhgtg(this.interceptors, okHttpClient.interceptors());
            AbstractC2862feyxiexzfUjhhgtg.m4266feyxiexzfUjhhgtg(this.networkInterceptors, okHttpClient.networkInterceptors());
