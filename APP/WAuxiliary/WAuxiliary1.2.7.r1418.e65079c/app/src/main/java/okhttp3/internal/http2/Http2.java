...
public final class Http2 {
    ...
    public static final C2633Ujhhgtgfeyxiexzf CONNECTION_PREFACE;
    ...
    static {
        C2633Ujhhgtgfeyxiexzf c2633Ujhhgtgfeyxiexzf = new C2633Ujhhgtgfeyxiexzf("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n".getBytes(AbstractC2689Ujhhgtgfeyxiexzf.f8581Ujhhgtgfeyxiexzf));
        c2633Ujhhgtgfeyxiexzf.f8469Ujhhgtgfeyxiexzf = "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n";
        CONNECTION_PREFACE = c2633Ujhhgtgfeyxiexzf;
        ...
        strArr2[8] = "PADDED";
        int i2 = iArr[0];
        strArr2[i2 | 8] = AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(new StringBuilder(), strArr2[i2], "|PADDED");
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            sb.append('|');
            strArr3[i6 | 8] = AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(sb, strArr3[i4], "|PADDED");
        }
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (i != 2 && i != 3) {
            ...
            if (i != 7 && i != 8) {
                String[] strArr = FLAGS;
                String str = i2 < strArr.length ? strArr[i2] : BINARY[i2];
                if (i != 5 || (i2 & 4) == 0) {
                    return (i != 0 || (i2 & 32) == 0) ? str : AbstractC1192feyxiexzfUjhhgtg.m2681feyxiexzfUjhhgtg(str, "PRIORITY", "COMPRESSED");
                }
                return AbstractC1192feyxiexzfUjhhgtg.m2681feyxiexzfUjhhgtg(str, "HEADERS", "PUSH_PROMISE");
            }
        }
        return BINARY[i2];
    }
