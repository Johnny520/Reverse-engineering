...
public final class RouteSelector {
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        ...
        this.proxies = c3312feyxiexzfUjhhgtg;
        this.inetSocketAddresses = c3312feyxiexzfUjhhgtg;
    ...
    public final Selection next() throws SocketException, UnknownHostException {
        ...
        if (arrayList.isEmpty()) {
            AbstractC2862feyxiexzfUjhhgtg.m4266feyxiexzfUjhhgtg(arrayList, this.postponedRoutes);
