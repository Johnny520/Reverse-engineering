...
import p000.C2401Ujhhgtgfeyxiexzf;
...
public final class Http2Stream {
    ...
    /* JADX INFO: compiled from: obf */
    public final class FramingSource implements InterfaceC1227feyxiexzfUjhhgtg {
        private boolean closed;
        private boolean finished;
        private final long maxByteCount;
        private Headers trailers;
        private final C2598feyxiexzfUjhhgtg receiveBuffer = new C2598feyxiexzfUjhhgtg();
        private final C2598feyxiexzfUjhhgtg readBuffer = new C2598feyxiexzfUjhhgtg();
        ...
        public void close() {
            ...
            synchronized (http2Stream) {
                this.closed = true;
                C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = this.readBuffer;
                j = c2598feyxiexzfUjhhgtg.f8401Ujhhgtgfeyxiexzf;
        ...
        public final C2598feyxiexzfUjhhgtg getReadBuffer() {
            return this.readBuffer;
        }

        public final C2598feyxiexzfUjhhgtg getReceiveBuffer() {
            ...
            while (true) {
                ...
                synchronized (http2Stream) {
                    ...
                    try {
                        ...
                        C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg2 = this.readBuffer;
                        long j4 = c2598feyxiexzfUjhhgtg2.f8401Ujhhgtgfeyxiexzf;
                        z = false;
                        if (j4 > j3) {
                            j2 = c2598feyxiexzfUjhhgtg2.read(c2598feyxiexzfUjhhgtg, Math.min(j, j4));
        ...
        public final void receive$okhttp(InterfaceC2595feyxiexzfUjhhgtg interfaceC2595feyxiexzfUjhhgtg, long j) throws EOFException {
            boolean z;
            boolean z2;
            Http2Stream http2Stream = Http2Stream.this;
            if (Util.assertionsEnabled && Thread.holdsLock(http2Stream)) {
            ...
            while (j2 > 0) {
                synchronized (Http2Stream.this) {
                    z = this.finished;
                    z2 = this.readBuffer.f8401Ujhhgtgfeyxiexzf + j2 > this.maxByteCount;
                }
                if (z2) {
                    interfaceC2595feyxiexzfUjhhgtg.skip(j2);
                ...
                long j3 = interfaceC2595feyxiexzfUjhhgtg.read(this.receiveBuffer, j2);
                if (j3 == -1) {
                ...
                synchronized (http2Stream2) {
                    try {
                        if (this.closed) {
                            this.receiveBuffer.m3856Ujhhgtgfeyxiexzf();
                        } else {
                            C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = this.readBuffer;
                            boolean z3 = c2598feyxiexzfUjhhgtg.f8401Ujhhgtgfeyxiexzf == 0;
                            c2598feyxiexzfUjhhgtg.mo2147Ujhhgtgfeyxiexzf(this.receiveBuffer);
                            if (z3) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class StreamTimeout extends C2401Ujhhgtgfeyxiexzf {
    ...
    public final InterfaceC1026feyxiexzfUjhhgtg getSink() {
        synchronized (this) {
    ...
    public final InterfaceC1227feyxiexzfUjhhgtg getSource() {
        return this.source;
    }
    ...
    public final C1744Ujhhgtgfeyxiexzf readTimeout() {
        return this.readTimeout;
    }

    public final void receiveData(InterfaceC2595feyxiexzfUjhhgtg interfaceC2595feyxiexzfUjhhgtg, int i) {
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            this.source.receive$okhttp(interfaceC2595feyxiexzfUjhhgtg, i);
            return;
        }
        throw new AssertionError("Thread " + Thread.currentThread().getName() + " MUST NOT hold lock on " + this);
    }
    ...
    public final synchronized Headers trailers() throws IOException {
        Headers trailers;
        if (!this.source.getFinished$okhttp() || !this.source.getReceiveBuffer().mo2109Ujhhgtgfeyxiexzf() || !this.source.getReadBuffer().mo2109Ujhhgtgfeyxiexzf()) {
            if (this.errorCode == null) {
    ...
    public final C1744Ujhhgtgfeyxiexzf writeTimeout() {
        return this.writeTimeout;
    }

    /* JADX INFO: compiled from: obf */
    public final class FramingSink implements InterfaceC1026feyxiexzfUjhhgtg {
        private boolean closed;
        private boolean finished;
        private final C2598feyxiexzfUjhhgtg sendBuffer;
        private Headers trailers;

        public FramingSink(boolean z) {
            this.finished = z;
            this.sendBuffer = new C2598feyxiexzfUjhhgtg();
        }
        ...
        private final void emitFrame(boolean z) throws IOException {
            ...
            synchronized (http2Stream) {
                ...
                jMin = Math.min(http2Stream.getWriteBytesMaximum() - http2Stream.getWriteBytesTotal(), this.sendBuffer.f8401Ujhhgtgfeyxiexzf);
                http2Stream.setWriteBytesTotal$okhttp(http2Stream.getWriteBytesTotal() + jMin);
                z2 = z && jMin == this.sendBuffer.f8401Ujhhgtgfeyxiexzf;
            }
        ...
        public void close() throws IOException {
            ...
            synchronized (http2Stream2) {
                ...
                if (!Http2Stream.this.getSink$okhttp().finished) {
                    boolean z2 = this.sendBuffer.f8401Ujhhgtgfeyxiexzf > 0;
                    if (this.trailers != null) {
                        while (this.sendBuffer.f8401Ujhhgtgfeyxiexzf > 0) {
                            emitFrame(false);
                        }
        ...
        @Override // p000.InterfaceC1026feyxiexzfUjhhgtg
        public void write(C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg, long j) throws IOException {
            Http2Stream http2Stream = Http2Stream.this;
            if (!Util.assertionsEnabled || !Thread.holdsLock(http2Stream)) {
                this.sendBuffer.write(c2598feyxiexzfUjhhgtg, j);
                while (this.sendBuffer.f8401Ujhhgtgfeyxiexzf >= 16384) {
                    emitFrame(false);
                }
            } else {
                throw new AssertionError("Thread " + Thread.currentThread().getName() + " MUST NOT hold lock on " + http2Stream);
        ...
        public /* synthetic */ FramingSink(Http2Stream http2Stream, boolean z, int i, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
            this((i & 1) != 0 ? false : z);
        }
    }
}
