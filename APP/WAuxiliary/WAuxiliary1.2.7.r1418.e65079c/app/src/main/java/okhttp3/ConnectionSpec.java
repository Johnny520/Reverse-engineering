...
import p000.C0414Ujhhgtgfeyxiexzf;
...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        String[] strArrIntersect2 = this.tlsVersionsAsString != null ? Util.intersect(sSLSocket.getEnabledProtocols(), this.tlsVersionsAsString, C0414Ujhhgtgfeyxiexzf.f2237Ujhhgtgfeyxiexzf) : sSLSocket.getEnabledProtocols();
    ...
    public final List<CipherSuite> m938deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m939deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* JADX INFO: renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m940deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), C0414Ujhhgtgfeyxiexzf.f2237Ujhhgtgfeyxiexzf)) {
            return false;
        }
