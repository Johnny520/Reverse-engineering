...
public final class TaskQueue {
    ...
    public static final class AwaitIdleTask extends Task {
        ...
        public AwaitIdleTask() {
            super(AbstractC1225feyxiexzfUjhhgtg.m2706Ujhhgtgfeyxiexzf(new StringBuilder(), Util.okHttpName, " awaitIdle"), false);
    ...
    public static final class AnonymousClass1 extends Task {
        final /* synthetic */ InterfaceC3545feyxiexzfUjhhgtg $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(String str, boolean z, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
            super(str, z);
            this.$block = interfaceC3545feyxiexzfUjhhgtg;
        }
    ...
    public static final class AnonymousClass2 extends Task {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(String str, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String str, long j, boolean z, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        if ((i & 4) != 0) {
        ...
        taskQueue.schedule(new AnonymousClass1(str, z, interfaceC3545feyxiexzfUjhhgtg), j);
    }
    ...
    public final void execute(String str, long j, boolean z, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
        schedule(new AnonymousClass1(str, z, interfaceC3545feyxiexzfUjhhgtg), j);
    }
    ...
    public final List<Task> getScheduledTasks() {
        List<Task> listM4253feyxiexzfUjhhgtg;
        synchronized (this.taskRunner) {
            listM4253feyxiexzfUjhhgtg = AbstractC2856feyxiexzfUjhhgtg.m4253feyxiexzfUjhhgtg(this.futureTasks);
        }
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String str, long j, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        taskQueue.schedule(new AnonymousClass2(str, interfaceC3545feyxiexzfUjhhgtg), j);
    }

    public final void schedule(String str, long j, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
        schedule(new AnonymousClass2(str, interfaceC3545feyxiexzfUjhhgtg), j);
    }
}
