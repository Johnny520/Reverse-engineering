...
public final class TaskLoggerKt {
    ...
    public static final <T> T logElapsed(Task task, TaskQueue taskQueue, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
        long jNanoTime;
    ...
    public static final void taskLog(Task task, TaskQueue taskQueue, InterfaceC3545feyxiexzfUjhhgtg interfaceC3545feyxiexzfUjhhgtg) {
        if (TaskRunner.Companion.getLogger().isLoggable(Level.FINE)) {
            log(task, taskQueue, (String) interfaceC3545feyxiexzfUjhhgtg.invoke());
        }
    }
}
