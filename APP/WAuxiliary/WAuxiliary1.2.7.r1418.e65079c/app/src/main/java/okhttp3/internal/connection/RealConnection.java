...
import p000.AbstractC1153feyxiexzfUjhhgtg;
...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private InterfaceC2596feyxiexzfUjhhgtg sink;
    private Socket socket;
    private InterfaceC2595feyxiexzfUjhhgtg source;
    ...
    private final void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = new C0789feyxiexzfUjhhgtg(AbstractC1252feyxiexzfUjhhgtg.m2789Ujhhgtgfeyxiexzf(socketCreateSocket));
                this.sink = new C0806feyxiexzfUjhhgtg(AbstractC1252feyxiexzfUjhhgtg.m2787Ujhhgtgfeyxiexzf(socketCreateSocket));
            } catch (NullPointerException e) {
                if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(e.getMessage(), NPE_THROW_WITH_NULL)) {
        ...
        try {
            ...
            try {
                ...
                if (address.hostnameVerifier().verify(address.url().host(), session)) {
                    ...
                    this.source = new C0789feyxiexzfUjhhgtg(AbstractC1252feyxiexzfUjhhgtg.m2789Ujhhgtgfeyxiexzf(sSLSocket2));
                    this.sink = new C0806feyxiexzfUjhhgtg(AbstractC1252feyxiexzfUjhhgtg.m2787Ujhhgtgfeyxiexzf(sSLSocket2));
                ...
                throw new SSLPeerUnverifiedException(AbstractC1153feyxiexzfUjhhgtg.m2645feyxiexzfUjhhgtg("\n              |Hostname " + address.url().host() + " not verified:\n              |    certificate: " + CertificatePinner.Companion.pin(x509Certificate) + "\n              |    DN: " + x509Certificate.getSubjectDN().getName() + "\n              |    subjectAltNames: " + OkHostnameVerifier.INSTANCE.allSubjectAltNames(x509Certificate) + "\n              "));
            } catch (Throwable th) {
                th = th;
    ...
    private final Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            Http1ExchangeCodec http1ExchangeCodec = new Http1ExchangeCodec(null, this, interfaceC2595feyxiexzfUjhhgtg, interfaceC2596feyxiexzfUjhhgtg);
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            interfaceC2595feyxiexzfUjhhgtg.timeout().timeout(i, timeUnit);
            interfaceC2596feyxiexzfUjhhgtg.timeout().timeout(i2, timeUnit);
            ...
            if (iCode == 200) {
                if (interfaceC2595feyxiexzfUjhhgtg.mo2104Ujhhgtgfeyxiexzf().mo2109Ujhhgtgfeyxiexzf() && interfaceC2596feyxiexzfUjhhgtg.mo2145Ujhhgtgfeyxiexzf().mo2109Ujhhgtgfeyxiexzf()) {
                    return null;
                }
    ...
    private final boolean routeMatchesAny(List<Route> list) {
        ...
        for (Route route : list) {
            ...
            if (type == type2 && this.route.proxy().type() == type2 && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.route.socketAddress(), route.socketAddress())) {
                return true;
            }
        }
        return false;
    ...
    private final void startHttp2(int i) throws SocketException {
        ...
        Http2Connection http2ConnectionBuild = new Http2Connection.Builder(true, TaskRunner.INSTANCE).socket(socket, this.route.address().url().host(), interfaceC2595feyxiexzfUjhhgtg, interfaceC2596feyxiexzfUjhhgtg).listener(this).pingIntervalMillis(i).build();
    ...
    private final boolean supportsUrl(HttpUrl httpUrl) {
        ...
        if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(httpUrl.host(), httpUrlUrl.host())) {
            return true;
        }
    ...
    public final void connect(int i, int i2, int i3, int i4, boolean z, Call call, EventListener eventListener) throws Throwable {
        ...
        if (this.route.address().sslSocketFactory() != null) {
            ...
            if (!zIsCleartextTrafficPermitted) {
                ...
                throw new RouteException(new UnknownServiceException(AbstractC3317feyxiexzfUjhhgtg.m4801Ujhhgtgfeyxiexzf("CLEARTEXT communication to ", strHost, " not permitted by network security policy")));
            }
        }
        r1 = protocol;
        r1 = zIsCleartextTrafficPermitted;
    ...
    public final boolean isEligible$okhttp(Address address, List<Route> list) {
        ...
        if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(address.url().host(), route().address().url().host())) {
            return true;
        }
    ...
    public final boolean isHealthy(boolean z) {
        ...
        return Util.isHealthy(socket2, interfaceC2595feyxiexzfUjhhgtg);
    }
    ...
    public final ExchangeCodec newCodec$okhttp(OkHttpClient okHttpClient, RealInterceptorChain realInterceptorChain) throws SocketException {
        ...
        C1744Ujhhgtgfeyxiexzf c1744UjhhgtgfeyxiexzfTimeout = interfaceC2595feyxiexzfUjhhgtg.timeout();
        long readTimeoutMillis$okhttp = realInterceptorChain.getReadTimeoutMillis$okhttp();
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        c1744UjhhgtgfeyxiexzfTimeout.timeout(readTimeoutMillis$okhttp, timeUnit);
        interfaceC2596feyxiexzfUjhhgtg.timeout().timeout(realInterceptorChain.getWriteTimeoutMillis$okhttp(), timeUnit);
        return new Http1ExchangeCodec(okHttpClient, this, interfaceC2595feyxiexzfUjhhgtg, interfaceC2596feyxiexzfUjhhgtg);
    }

    public final RealWebSocket.Streams newWebSocketStreams$okhttp(final Exchange exchange) throws SocketException {
        Socket socket = this.socket;
        final InterfaceC2595feyxiexzfUjhhgtg interfaceC2595feyxiexzfUjhhgtg = this.source;
        final InterfaceC2596feyxiexzfUjhhgtg interfaceC2596feyxiexzfUjhhgtg = this.sink;
        socket.setSoTimeout(0);
        noNewExchanges$okhttp();
        return new RealWebSocket.Streams(interfaceC2595feyxiexzfUjhhgtg, interfaceC2596feyxiexzfUjhhgtg) { // from class: okhttp3.internal.connection.RealConnection$newWebSocketStreams$1
