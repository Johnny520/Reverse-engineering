...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String str, int i, int i2) {
                ...
                char cCharAt = str.charAt(i);
                if ((C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 97) >= 0 && C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 122) <= 0) || (C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 65) >= 0 && C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 90) <= 0)) {
                    while (true) {
                        i++;
                        if (i >= i2) {
                            break;
        ...
        private final boolean isDot(String str) {
            return C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, ".") || AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(str, "%2e");
        }

        private final boolean isDotDot(String str) {
            return C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, "..") || AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(str, "%2e.") || AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(str, ".%2e") || AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(str, "%2e%2e");
        }
        ...
        private final void removeAllCanonicalQueryParameters(String str) {
            ...
            while (true) {
                if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, this.encodedQueryNamesAndValues.get(size))) {
        ...
        public final Builder addEncodedQueryParameter(String str, String str2) {
            ...
            this.encodedQueryNamesAndValues.add(str2 != null ? Companion.canonicalize$okhttp$default(companion, str2, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, 211, null) : null);
            return this;
        }
        ...
        public final HttpUrl build() {
            ...
            if (list2 != null) {
                ArrayList arrayList3 = new ArrayList(AbstractC2851feyxiexzfUjhhgtg.m4190Ujhhgtgfeyxiexzf(list2, 10));
        ...
        public final Builder port(int i) {
            if (1 > i || i >= 65536) {
                throw new IllegalArgumentException(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "unexpected port: ").toString());
            }
            this.port = i;
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            if (list2 != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    list2.set(i2, str2 != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str2, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, false, null, Opcodes.MONITOREXIT, null) : null);
                }
            }
        ...
        public String toString() {
            ...
            String str2 = this.host;
            if (str2 != null) {
                if (AbstractC1152feyxiexzfUjhhgtg.m2624feyxiexzfUjhhgtg(str2, ':')) {
                    sb.append('[');
                    sb.append(this.host);
                    sb.append(']');
                } else {
    ...
    public static final class Companion {
        ...
        private final void writeCanonicalized(C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
            C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg2 = null;
            while (i < i2) {
                ...
                if (!z || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                    if (iCodePointAt == 43 && z3) {
                        ...
                        c2598feyxiexzfUjhhgtg.m3876feyxiexzfUjhhgtg(0, str3.length(), str3);
                    } else if (iCodePointAt < 32 || iCodePointAt == 127 || ((iCodePointAt >= 128 && !z4) || AbstractC1152feyxiexzfUjhhgtg.m2624feyxiexzfUjhhgtg(str2, (char) iCodePointAt) || (iCodePointAt == 37 && (!z || (z2 && !isPercentEncoded(str, i, i2)))))) {
                        if (c2598feyxiexzfUjhhgtg2 == null) {
                            c2598feyxiexzfUjhhgtg2 = new C2598feyxiexzfUjhhgtg();
                        }
                        if (charset == null || charset.equals(StandardCharsets.UTF_8)) {
                            c2598feyxiexzfUjhhgtg2.m3878feyxiexzfUjhhgtg(iCodePointAt);
                        } else {
                            c2598feyxiexzfUjhhgtg2.m3875feyxiexzfUjhhgtg(str, i, Character.charCount(iCodePointAt) + i, charset);
                        }
                        while (!c2598feyxiexzfUjhhgtg2.mo2109Ujhhgtgfeyxiexzf()) {
                            byte b = c2598feyxiexzfUjhhgtg2.readByte();
                            c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(37);
                            c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(HttpUrl.HEX_DIGITS[((b & 255) >> 4) & 15]);
                            c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(HttpUrl.HEX_DIGITS[b & ek.m]);
                        }
                    } else {
                        c2598feyxiexzfUjhhgtg.m3878feyxiexzfUjhhgtg(iCodePointAt);
                    }
                }
        ...
        private final void writePercentDecoded(C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg, String str, int i, int i2, boolean z) {
            int i3;
            while (i < i2) {
                int iCodePointAt = str.codePointAt(i);
                if (iCodePointAt == 37 && (i3 = i + 2) < i2) {
                    ...
                    if (hexDigit == -1 || hexDigit2 == -1) {
                        ...
                        c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg((hexDigit << 4) + hexDigit2);
                        i = Character.charCount(iCodePointAt) + i3;
                    }
                } else if (iCodePointAt == 43 && z) {
                    c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(32);
                    i++;
                } else {
                    c2598feyxiexzfUjhhgtg.m3878feyxiexzfUjhhgtg(iCodePointAt);
                    i += Character.charCount(iCodePointAt);
        ...
        public final HttpUrl m981deprecated_get(String str) {
            return get(str);
        }

        /* JADX INFO: renamed from: -deprecated_parse, reason: not valid java name */
        public final HttpUrl m984deprecated_parse(String str) {
            return parse(str);
        }
        ...
        public final String canonicalize$okhttp(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
            ...
            while (iCharCount < i2) {
                ...
                if (iCodePointAt < 32 || iCodePointAt == 127 || ((iCodePointAt >= 128 && !z4) || AbstractC1152feyxiexzfUjhhgtg.m2624feyxiexzfUjhhgtg(str2, (char) iCodePointAt) || ((iCodePointAt == 37 && (!z || (z2 && !isPercentEncoded(str, iCharCount, i2)))) || (iCodePointAt == 43 && z3)))) {
                    C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = new C2598feyxiexzfUjhhgtg();
                    c2598feyxiexzfUjhhgtg.m3876feyxiexzfUjhhgtg(i, iCharCount, str);
                    writeCanonicalized(c2598feyxiexzfUjhhgtg, str, iCharCount, i2, str2, z, z2, z3, z4, charset);
                    return c2598feyxiexzfUjhhgtg.m3865feyxiexzfUjhhgtg();
                }
        ...
        public final String percentDecode$okhttp(String str, int i, int i2, boolean z) {
            for (int i3 = i; i3 < i2; i3++) {
                ...
                if (cCharAt == '%' || (cCharAt == '+' && z)) {
                    C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = new C2598feyxiexzfUjhhgtg();
                    c2598feyxiexzfUjhhgtg.m3876feyxiexzfUjhhgtg(i, i3, str);
                    writePercentDecoded(c2598feyxiexzfUjhhgtg, str, i3, i2, z);
                    return c2598feyxiexzfUjhhgtg.m3865feyxiexzfUjhhgtg();
                }
            }
            return str.substring(i, i2);
        ...
        public final List<String> toQueryNamesAndValues$okhttp(String str) {
            ...
            while (i <= str.length()) {
                ...
                if (iM2628feyxiexzfUjhhgtg == -1) {
                    iM2628feyxiexzfUjhhgtg = str.length();
                }
                int iM2628feyxiexzfUjhhgtg2 = AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('=', i, 4, str);
                if (iM2628feyxiexzfUjhhgtg2 == -1 || iM2628feyxiexzfUjhhgtg2 > iM2628feyxiexzfUjhhgtg) {
                    arrayList.add(str.substring(i, iM2628feyxiexzfUjhhgtg));
                    arrayList.add(null);
                } else {
                    arrayList.add(str.substring(i, iM2628feyxiexzfUjhhgtg2));
                    arrayList.add(str.substring(iM2628feyxiexzfUjhhgtg2 + 1, iM2628feyxiexzfUjhhgtg));
                }
                i = iM2628feyxiexzfUjhhgtg + 1;
            }
            return arrayList;
        }

        public final void toQueryString$okhttp(List<String> list, StringBuilder sb) {
            C0680Ujhhgtgfeyxiexzf c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf = AbstractC1264feyxiexzfUjhhgtg.m2807Ujhhgtgfeyxiexzf(AbstractC1264feyxiexzfUjhhgtg.m2813feyxiexzfUjhhgtg(0, list.size()), 2);
            int i = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2805Ujhhgtgfeyxiexzf;
            int i2 = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2806Ujhhgtgfeyxiexzf;
            int i3 = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2807Ujhhgtgfeyxiexzf;
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m983deprecated_get(URL url) {
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m982deprecated_get(URI uri) {
            return get(uri);
        }
    ...
    public HttpUrl(String str, String str2, String str3, String str4, int i, List<String> list, List<String> list2, String str5, String str6) {
        ...
        this.fragment = str5;
        this.url = str6;
        this.isHttps = C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(str, "https");
    }
    ...
    public final String encodedFragment() {
        ...
        return this.url.substring(AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('#', 0, 6, this.url) + 1);
    }
    ...
    public final String encodedPassword() {
        ...
        return this.url.substring(AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg(':', this.scheme.length() + 3, 4, this.url) + 1, AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('@', 0, 6, this.url));
    }

    public final String encodedPath() {
        int iM2628feyxiexzfUjhhgtg = AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('/', this.scheme.length() + 3, 4, this.url);
        String str = this.url;
        return this.url.substring(iM2628feyxiexzfUjhhgtg, Util.delimiterOffset(str, "?#", iM2628feyxiexzfUjhhgtg, str.length()));
    }

    public final List<String> encodedPathSegments() {
        int iM2628feyxiexzfUjhhgtg = AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('/', this.scheme.length() + 3, 4, this.url);
        String str = this.url;
        int iDelimiterOffset = Util.delimiterOffset(str, "?#", iM2628feyxiexzfUjhhgtg, str.length());
        ArrayList arrayList = new ArrayList();
        while (iM2628feyxiexzfUjhhgtg < iDelimiterOffset) {
            ...
            iM2628feyxiexzfUjhhgtg = iDelimiterOffset2;
        }
        return arrayList;
    }
    ...
    public final String encodedQuery() {
        ...
        int iM2628feyxiexzfUjhhgtg = AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg('?', 0, 6, this.url) + 1;
        String str = this.url;
        return this.url.substring(iM2628feyxiexzfUjhhgtg, Util.delimiterOffset(str, '#', iM2628feyxiexzfUjhhgtg, str.length()));
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof HttpUrl) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(((HttpUrl) obj).url, this.url);
    }
    ...
    public final Set<String> queryParameterNames() {
        ...
        C0680Ujhhgtgfeyxiexzf c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf = AbstractC1264feyxiexzfUjhhgtg.m2807Ujhhgtgfeyxiexzf(AbstractC1264feyxiexzfUjhhgtg.m2813feyxiexzfUjhhgtg(0, this.queryNamesAndValues.size()), 2);
        int i = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2805Ujhhgtgfeyxiexzf;
        int i2 = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2806Ujhhgtgfeyxiexzf;
        int i3 = c0680UjhhgtgfeyxiexzfM2807Ujhhgtgfeyxiexzf.f2807Ujhhgtgfeyxiexzf;
        if ((i3 > 0 && i <= i2) || (i3 < 0 && i2 <= i)) {
