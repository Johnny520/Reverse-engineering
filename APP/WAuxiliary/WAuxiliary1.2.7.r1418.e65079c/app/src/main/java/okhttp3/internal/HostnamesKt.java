...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 31) <= 0 || C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 127) >= 0 || AbstractC1152feyxiexzfUjhhgtg.m2628feyxiexzfUjhhgtg(cCharAt, 0, 6, " #%/:?@[\\]") != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
        ...
        while (i < i2) {
            ...
            while (i5 < i2) {
                ...
                if (C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 48) < 0 || C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, 57) > 0) {
                    break;
                }
    ...
    private static final String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(58);
                i2 += i4;
                if (i2 == 16) {
                    c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(58);
                }
                ...
                c2598feyxiexzfUjhhgtg.m3871feyxiexzfUjhhgtg((Util.and(bArr[i2], 255) << 8) | Util.and(bArr[i2 + 1], 255));
                i2 += 2;
            }
        }
    ...
    public static final String toCanonicalHost(String str) {
        if (!AbstractC1152feyxiexzfUjhhgtg.m2623feyxiexzfUjhhgtg(str, ":", false)) {
            try {
        ...
        throw new AssertionError(AbstractC1225feyxiexzfUjhhgtg.m2704Ujhhgtgfeyxiexzf("Invalid IPv6 address: '", str, '\''));
    }
}
