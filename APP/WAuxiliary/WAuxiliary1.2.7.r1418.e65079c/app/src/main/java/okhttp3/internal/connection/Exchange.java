...
public final class Exchange {
    ...
    /* JADX INFO: compiled from: obf */
    public final class RequestBodySink extends AbstractC3534Ujhhgtgfeyxiexzf {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;

        public RequestBodySink(InterfaceC1026feyxiexzfUjhhgtg interfaceC1026feyxiexzfUjhhgtg, long j) {
    ...
    /* JADX INFO: compiled from: obf */
    public final class ResponseBodySource extends AbstractC3530Ujhhgtgfeyxiexzf {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;
        ...
        public ResponseBodySource(InterfaceC1227feyxiexzfUjhhgtg interfaceC1227feyxiexzfUjhhgtg, long j) {
        ...
        public long read(C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg, long j) throws IOException {
            ...
            try {
                long j2 = delegate().read(c2598feyxiexzfUjhhgtg, j);
    ...
    public final InterfaceC1026feyxiexzfUjhhgtg createRequestBody(Request request, boolean z) {
        this.isDuplex = z;
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(this.finder.getAddress$okhttp().url().host(), this.connection.route().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        try {
            ...
            return new RealResponseBody(strHeader$default, jReportedContentLength, new C0789feyxiexzfUjhhgtg(new ResponseBodySource(this.codec.openResponseBodySource(response), jReportedContentLength)));
        } catch (IOException e) {
            this.eventListener.responseFailed(this.call, e);
            trackFailure(e);
            throw e;
