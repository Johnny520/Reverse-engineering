...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (lowerCase.equals(Http2ExchangeCodec.TE) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(headers.value(i), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headers, Protocol protocol) throws ProtocolException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(strName, Header.RESPONSE_STATUS_UTF8)) {
    ...
    @Override // okhttp3.internal.http.ExchangeCodec
    public InterfaceC1026feyxiexzfUjhhgtg createRequestBody(Request request, long j) {
    ...
    public void writeRequestHeaders(Request request) throws IOException {
        ...
        C1744Ujhhgtgfeyxiexzf timeout = this.stream.readTimeout();
