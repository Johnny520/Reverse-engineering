...
public final class FormBody extends RequestBody {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(Charset charset, int i, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
    ...
    private final long writeOrCountBytes(InterfaceC2596feyxiexzfUjhhgtg interfaceC2596feyxiexzfUjhhgtg, boolean z) throws EOFException {
        C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = z ? new C2598feyxiexzfUjhhgtg() : interfaceC2596feyxiexzfUjhhgtg.mo2145Ujhhgtgfeyxiexzf();
        int size = this.encodedNames.size();
        for (int i = 0; i < size; i++) {
            if (i > 0) {
                c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(38);
            }
            c2598feyxiexzfUjhhgtg.m3877feyxiexzfUjhhgtg(this.encodedNames.get(i));
            c2598feyxiexzfUjhhgtg.m3869feyxiexzfUjhhgtg(61);
            c2598feyxiexzfUjhhgtg.m3877feyxiexzfUjhhgtg(this.encodedValues.get(i));
        }
        if (!z) {
            return 0L;
        }
    ...
    public final int m951deprecated_size() {
        return size();
    }
