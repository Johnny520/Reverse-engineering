...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String str) {
        for (RealCall.AsyncCall asyncCall : this.runningAsyncCalls) {
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(asyncCall.getHost(), str)) {
                return asyncCall;
            }
        }
        for (RealCall.AsyncCall asyncCall2 : this.readyAsyncCalls) {
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(asyncCall2.getHost(), str)) {
                return asyncCall2;
            }
        }
        return null;
    ...
    public final ExecutorService m950deprecated_executorService() {
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        try {
            ...
            arrayList = new ArrayList(AbstractC2851feyxiexzfUjhhgtg.m4190Ujhhgtgfeyxiexzf(arrayDeque, 10));
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        try {
            ...
            arrayList = new ArrayList(AbstractC2851feyxiexzfUjhhgtg.m4190Ujhhgtgfeyxiexzf(arrayDeque2, 10));
        ...
        return Collections.unmodifiableList(AbstractC2856feyxiexzfUjhhgtg.m4245feyxiexzfUjhhgtg(arrayDeque, arrayList));
    }
    ...
    public final void setMaxRequests(int i) {
        if (i < 1) {
            throw new IllegalArgumentException(AbstractC3317feyxiexzfUjhhgtg.m4795Ujhhgtgfeyxiexzf(i, "max < 1: ").toString());
        }
        synchronized (this) {
            this.maxRequests = i;
        }
