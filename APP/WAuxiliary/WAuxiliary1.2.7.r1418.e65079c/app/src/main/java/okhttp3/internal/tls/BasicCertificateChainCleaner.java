...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        if (!C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (x509CertificateFindByIssuerAndSignature != null) {
                if (arrayList.size() > 1 || !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(x509Certificate2, x509CertificateFindByIssuerAndSignature)) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
