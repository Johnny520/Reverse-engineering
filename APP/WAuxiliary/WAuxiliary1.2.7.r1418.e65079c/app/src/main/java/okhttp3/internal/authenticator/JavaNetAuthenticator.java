...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    private final InetAddress connectToInetAddress(Proxy proxy, HttpUrl httpUrl, Dns dns) {
        ...
        return (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) == 1 ? (InetAddress) AbstractC2856feyxiexzfUjhhgtg.m4238feyxiexzfUjhhgtg(dns.lookup(httpUrl.host())) : ((InetSocketAddress) proxy.address()).getAddress();
    }
    ...
    public /* synthetic */ JavaNetAuthenticator(Dns dns, int i, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
