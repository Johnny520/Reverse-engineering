...
public final class BouncyCastlePlatform extends Platform {
    ...
    public static final class Companion {
        ...
        public final BouncyCastlePlatform buildIfSupported() {
            ...
            if (isSupported()) {
                return new BouncyCastlePlatform(abstractC3100Ujhhgtgfeyxiexzf);
            }
            return null;
        }
    ...
    public /* synthetic */ BouncyCastlePlatform(AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
        this();
    }
