        ...
        public Factory(long j, Request request, Response response) {
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strName, "Date")) {
                        this.servedDate = DatesKt.toHttpDateOrNull(strValue);
                        this.servedDateString = strValue;
                    } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strName, "Expires")) {
                        this.expires = DatesKt.toHttpDateOrNull(strValue);
                    } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strName, "Last-Modified")) {
                        this.lastModified = DatesKt.toHttpDateOrNull(strValue);
                        this.lastModifiedString = strValue;
                    } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strName, "ETag")) {
                        this.etag = strValue;
                    } else if (AbstractC1192feyxiexzfUjhhgtg.m2679feyxiexzfUjhhgtg(strName, "Age")) {
