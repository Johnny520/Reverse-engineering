...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    public static final class AlpnProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "supports") && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(Boolean.TYPE, returnType)) {
                return Boolean.TRUE;
            }
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "unsupported") && C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(Void.TYPE, returnType)) {
                this.unsupported = true;
                return null;
            }
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "protocols") && objArr.length == 0) {
                return this.protocols;
            }
            if ((C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "selectProtocol") || C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "select")) && String.class.equals(returnType) && objArr.length == 1) {
            ...
            if ((!C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "protocolSelected") && !C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(name, "selected")) || objArr.length != 1) {
