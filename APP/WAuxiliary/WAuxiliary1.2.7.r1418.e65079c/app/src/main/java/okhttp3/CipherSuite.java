...
public final class CipherSuite {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < iMin; i++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return C3052Ujhhgtgfeyxiexzf.m4514Ujhhgtgfeyxiexzf(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public /* synthetic */ CipherSuite(String str, AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
        this(str);
    }
    ...
    public final String m937deprecated_javaName() {
