...
public final class RealCall implements Call {
                    ...
                    try {
                        try {
                            ...
                            if (!z) {
                                ...
                                AbstractC1791feyxiexzfUjhhgtg.m3129Ujhhgtgfeyxiexzf(iOException, th);
    ...
    /* JADX WARN: Type inference failed for: r4v5, types: [okhttp3.internal.connection.RealCall$timeout$1, 上海高中ᛱ谢子非ᛱᛲᛳᛱUjhhgtgᛱ要点脸能不能ᛱfeyxiexzfᛱᛴ] */
    public RealCall(OkHttpClient okHttpClient, Request request, boolean z) {
        ...
        ?? r4 = new C2401Ujhhgtgfeyxiexzf() { // from class: okhttp3.internal.connection.RealCall.timeout.1
    ...
    public final Response getResponseWithInterceptorChain$okhttp() {
        ...
        AbstractC2862feyxiexzfUjhhgtg.m4266feyxiexzfUjhhgtg(arrayList, this.client.interceptors());
        ...
        if (!this.forWebSocket) {
            AbstractC2862feyxiexzfUjhhgtg.m4266feyxiexzfUjhhgtg(arrayList, this.client.networkInterceptors());
        }
    ...
    public final Socket releaseConnectionNoEvents$okhttp() {
        ...
        while (true) {
            ...
            if (C3052Ujhhgtgfeyxiexzf.m4512Ujhhgtgfeyxiexzf(it.next().get(), this)) {
                break;
            }
            i++;
        }
    ...
    @Override // okhttp3.Call
    public C2401Ujhhgtgfeyxiexzf timeout() {
        return this.timeout;
    }
