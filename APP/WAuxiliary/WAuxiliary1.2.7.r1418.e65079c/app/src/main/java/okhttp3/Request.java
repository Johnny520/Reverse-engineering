...
public final class Request {
        ...
        public Builder method(String str, RequestBody requestBody) {
            ...
            if (requestBody == null) {
                if (HttpMethod.requiresRequestBody(str)) {
                    throw new IllegalArgumentException(AbstractC3317feyxiexzfUjhhgtg.m4801Ujhhgtgfeyxiexzf("method ", str, " must have a request body.").toString());
                }
            } else if (!HttpMethod.permitsRequestBody(str)) {
                throw new IllegalArgumentException(AbstractC3317feyxiexzfUjhhgtg.m4801Ujhhgtgfeyxiexzf("method ", str, " must not have a request body.").toString());
            }
            this.method = str;
    ...
    public final RequestBody m1023deprecated_body() {
        return this.body;
    }

    /* JADX INFO: renamed from: -deprecated_cacheControl, reason: not valid java name */
    public final CacheControl m1024deprecated_cacheControl() {
        return cacheControl();
    }

    /* JADX INFO: renamed from: -deprecated_headers, reason: not valid java name */
    public final Headers m1025deprecated_headers() {
        return this.headers;
    }

    /* JADX INFO: renamed from: -deprecated_method, reason: not valid java name */
    public final String m1026deprecated_method() {
        return this.method;
    }

    /* JADX INFO: renamed from: -deprecated_url, reason: not valid java name */
    public final HttpUrl m1027deprecated_url() {
        return this.url;
    }
    ...
    public String toString() {
        ...
        if (this.headers.size() != 0) {
            sb.append(", headers=[");
            int i = 0;
            for (C1381feyxiexzfUjhhgtg c1381feyxiexzfUjhhgtg : this.headers) {
                int i2 = i + 1;
                if (i < 0) {
                    AbstractC2852feyxiexzfUjhhgtg.m4193Ujhhgtgfeyxiexzf();
                    throw null;
                }
                C1381feyxiexzfUjhhgtg c1381feyxiexzfUjhhgtg2 = c1381feyxiexzfUjhhgtg;
                String str = (String) c1381feyxiexzfUjhhgtg2.f4874Ujhhgtgfeyxiexzf;
                String str2 = (String) c1381feyxiexzfUjhhgtg2.f4875Ujhhgtgfeyxiexzf;
                if (i > 0) {
                    sb.append(", ");
                }
                sb.append(str);
