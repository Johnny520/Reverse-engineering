...
public final class OpenJSSEPlatform extends Platform {
    ...
    public static final class Companion {
        ...
        public final OpenJSSEPlatform buildIfSupported() {
            ...
            if (isSupported()) {
                return new OpenJSSEPlatform(abstractC3100Ujhhgtgfeyxiexzf);
            }
            return null;
        }
    ...
    public /* synthetic */ OpenJSSEPlatform(AbstractC3100Ujhhgtgfeyxiexzf abstractC3100Ujhhgtgfeyxiexzf) {
        this();
    }
