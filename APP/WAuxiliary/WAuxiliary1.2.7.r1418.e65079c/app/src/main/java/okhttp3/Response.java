...
public final class Response implements Closeable {
    ...
    public final ResponseBody peekBody(long j) throws EOFException {
        C0789feyxiexzfUjhhgtg c0789feyxiexzfUjhhgtgPeek = this.body.source().peek();
        C2598feyxiexzfUjhhgtg c2598feyxiexzfUjhhgtg = new C2598feyxiexzfUjhhgtg();
        c0789feyxiexzfUjhhgtgPeek.mo2115Ujhhgtgfeyxiexzf(j);
        long jMin = Math.min(j, c0789feyxiexzfUjhhgtgPeek.f3097Ujhhgtgfeyxiexzf.f8401Ujhhgtgfeyxiexzf);
        while (jMin > 0) {
            long j2 = c0789feyxiexzfUjhhgtgPeek.read(c2598feyxiexzfUjhhgtg, jMin);
            if (j2 == -1) {
                throw new EOFException();
            }
            jMin -= j2;
        }
        return ResponseBody.Companion.create(c2598feyxiexzfUjhhgtg, this.body.contentType(), c2598feyxiexzfUjhhgtg.f8401Ujhhgtgfeyxiexzf);
    }
        ...
        private final void checkSupportResponse(String str, Response response) {
            if (response != null) {
                if (response.body() != null) {
                    throw new IllegalArgumentException(AbstractC1225feyxiexzfUjhhgtg.m2703Ujhhgtgfeyxiexzf(str, ".body != null").toString());
                }
                if (response.networkResponse() != null) {
                    throw new IllegalArgumentException(AbstractC1225feyxiexzfUjhhgtg.m2703Ujhhgtgfeyxiexzf(str, ".networkResponse != null").toString());
                }
                if (response.cacheResponse() != null) {
                    throw new IllegalArgumentException(AbstractC1225feyxiexzfUjhhgtg.m2703Ujhhgtgfeyxiexzf(str, ".cacheResponse != null").toString());
                }
                if (response.priorResponse() != null) {
                    throw new IllegalArgumentException(AbstractC1225feyxiexzfUjhhgtg.m2703Ujhhgtgfeyxiexzf(str, ".priorResponse != null").toString());
                }
            }
        }
