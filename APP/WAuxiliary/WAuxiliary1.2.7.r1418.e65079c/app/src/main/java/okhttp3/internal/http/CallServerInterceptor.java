    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
            ...
            if (!HttpMethod.permitsRequestBody(request$okhttp.method()) || requestBodyBody == null) {
                ...
                try {
                    if (responseHeaders != null) {
                        ...
                        exchange$okhttp.flushRequest();
                        requestBodyBody.writeTo(new C0806feyxiexzfUjhhgtg(exchange$okhttp.createRequestBody(request$okhttp, true)));
                    } else {
                        C0806feyxiexzfUjhhgtg c0806feyxiexzfUjhhgtg = new C0806feyxiexzfUjhhgtg(exchange$okhttp.createRequestBody(request$okhttp, false));
                        requestBodyBody.writeTo(c0806feyxiexzfUjhhgtg);
        ...
        if (responseHeaders == null) {
            try {
                ...
                AbstractC1791feyxiexzfUjhhgtg.m3129Ujhhgtgfeyxiexzf(e, e4);
                throw e;
            }
        }
