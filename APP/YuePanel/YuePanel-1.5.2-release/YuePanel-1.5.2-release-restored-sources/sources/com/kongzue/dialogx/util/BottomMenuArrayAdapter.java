    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            if (this.bottomMenu.getStyle().overrideBottomDialogRes() != null) {
                iOverrideMenuItemLayout = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMenuItemLayout(this.bottomMenu.isLightTheme(), i, getCount(), false);
                if (iOverrideMenuItemLayout == 0) {
                    ...
                    iOverrideMenuItemLayout = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMenuItemLayout(this.bottomMenu.isLightTheme(), i, getCount(), true);
                }
            }
        ...
        if (this.bottomMenu.isMenuItemEnable(i)) {
            view.setAlpha(1.0f);
        } else {
            view.setAlpha(0.4f);
        }
        if (this.bottomMenu.getSelectMode() == SELECT_MODE.SINGLE) {
            if (viewHolder.imgDialogxMenuSelection != null) {
                if (this.bottomMenu.getSelection() == i) {
                    ...
                    int iOverrideSelectionImage = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideSelectionImage(this.bottomMenu.isLightTheme(), true);
                    if (iOverrideSelectionImage != 0) {
                        viewHolder.imgDialogxMenuSelection.setImageResource(iOverrideSelectionImage);
                    }
                } else {
                    int iOverrideSelectionImage2 = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideSelectionImage(this.bottomMenu.isLightTheme(), false);
        ...
        } else if (this.bottomMenu.getSelectMode() != SELECT_MODE.MULTIPLE) {
            ...
            if (this.bottomMenu.getSelectionList().contains(Integer.valueOf(i))) {
                viewHolder.imgDialogxMenuSelection.setVisibility(0);
                int iOverrideMultiSelectionImage = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMultiSelectionImage(this.bottomMenu.isLightTheme(), true);
                if (iOverrideMultiSelectionImage != 0) {
                    viewHolder.imgDialogxMenuSelection.setImageResource(iOverrideMultiSelectionImage);
                }
            } else {
                int iOverrideMultiSelectionImage2 = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMultiSelectionImage(this.bottomMenu.isLightTheme(), false);
        ...
        int iOverrideSelectionMenuBackgroundColor = this.bottomMenu.getStyle().overrideBottomDialogRes() != null ? this.bottomMenu.getStyle().overrideBottomDialogRes().overrideSelectionMenuBackgroundColor(this.bottomMenu.isLightTheme()) : 0;
        if (this.bottomMenu.getSelection() == i && iOverrideSelectionMenuBackgroundColor != 0) {
        ...
        int iOverrideMenuTextColor = this.bottomMenu.isLightTheme() ? C2413R.color.black90 : C2413R.color.white90;
        if (this.bottomMenu.getStyle().overrideBottomDialogRes() != null && this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMenuTextColor(this.bottomMenu.isLightTheme()) != 0) {
            iOverrideMenuTextColor = this.bottomMenu.getStyle().overrideBottomDialogRes().overrideMenuTextColor(this.bottomMenu.isLightTheme());
        }
        if (charSequence != null) {
            ...
            if (this.bottomMenu.getMenuItemTextInfoInterceptor() != null) {
                TextInfo textInfoMenuItemTextInfo = this.bottomMenu.getMenuItemTextInfoInterceptor().menuItemTextInfo(this.bottomMenu, i, charSequence.toString());
            ...
            if (this.bottomMenu.getOnIconChangeCallBack() != null) {
                if (this.bottomMenu.getOnIconChangeCallBack() instanceof MenuIconAdapter) {
                    boolean zApplyIcon = ((MenuIconAdapter) this.bottomMenu.getOnIconChangeCallBack()).applyIcon(this.bottomMenu, i, charSequence.toString(), viewHolder.imgDialogxMenuIcon);
                    boolean zIsAutoTintIconInLightOrDarkMode = this.bottomMenu.getOnIconChangeCallBack().isAutoTintIconInLightOrDarkMode() == null ? this.bottomMenu.isAutoTintIconInLightOrDarkMode() : this.bottomMenu.getOnIconChangeCallBack().isAutoTintIconInLightOrDarkMode().booleanValue();
                    ...
                    boolean zIsAutoTintIconInLightOrDarkMode2 = this.bottomMenu.getOnIconChangeCallBack().isAutoTintIconInLightOrDarkMode() == null ? this.bottomMenu.isAutoTintIconInLightOrDarkMode() : this.bottomMenu.getOnIconChangeCallBack().isAutoTintIconInLightOrDarkMode().booleanValue();
                    if (icon != 0) {
            ...
            } else if (this.bottomMenu.getIconResIds() != null) {
                int iconResIds = this.bottomMenu.getIconResIds(i);
                boolean zIsAutoTintIconInLightOrDarkMode3 = this.bottomMenu.isAutoTintIconInLightOrDarkMode();
                if (iconResIds != 0) {
                    viewHolder.imgDialogxMenuIcon.setVisibility(0);
        ...
        if (this.bottomMenu.getMenuMenuItemLayoutRefreshCallback() != null) {
            this.bottomMenu.getMenuMenuItemLayoutRefreshCallback().getView(this.bottomMenu, i, view, viewGroup);
        }
        return view;
    }
