...
public final class LayoutDialogxPopnotificationMaterialBinding implements InterfaceC8270 {
    ...
    private LayoutDialogxPopnotificationMaterialBinding(@InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout, @InterfaceC6391 MaxLinearLayout maxLinearLayout, @InterfaceC6391 RelativeLayout relativeLayout, @InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout2, @InterfaceC6391 ImageView imageView, @InterfaceC6391 TextView textView, @InterfaceC6391 TextView textView2, @InterfaceC6391 TextView textView3) {
    ...
    @InterfaceC6391
    public static LayoutDialogxPopnotificationMaterialBinding bind(@InterfaceC6391 View view) {
                ...
                if (imageView != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                return new LayoutDialogxPopnotificationMaterialBinding(dialogXBaseRelativeLayout, maxLinearLayout, relativeLayout, dialogXBaseRelativeLayout, imageView, textView, textView2, textView3);
                            }
                        }
                    }
                }
    ...
    @InterfaceC6391
    public static LayoutDialogxPopnotificationMaterialBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static LayoutDialogxPopnotificationMaterialBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C2413R.layout.layout_dialogx_popnotification_material, viewGroup, false);
        if (z) {
