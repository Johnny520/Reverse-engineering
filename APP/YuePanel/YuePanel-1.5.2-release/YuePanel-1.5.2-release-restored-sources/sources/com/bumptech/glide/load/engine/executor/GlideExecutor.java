...
public final class GlideExecutor implements ExecutorService {
    ...
    public static final class Builder {
        ...
        public Builder setThreadCount(@InterfaceC5459(from = 1) int i) {
            this.corePoolSize = i;
        ...
        @Deprecated
        public Builder setThreadFactory(@InterfaceC6391 ThreadFactory threadFactory) {
        ...
        public Builder setUncaughtThrowableStrategy(@InterfaceC6391 UncaughtThrowableStrategy uncaughtThrowableStrategy) {
    ...
    public static final class DefaultPriorityThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(@InterfaceC6391 Runnable runnable) {
    ...
    public boolean awaitTermination(long j, @InterfaceC6391 TimeUnit timeUnit) throws InterruptedException {
    ...
    @Override // java.util.concurrent.ExecutorService
    @InterfaceC6391
    public <T> List<Future<T>> invokeAll(@InterfaceC6391 Collection<? extends Callable<T>> collection) throws InterruptedException {
    ...
    @Override // java.util.concurrent.ExecutorService
    @InterfaceC6391
    public <T> T invokeAny(@InterfaceC6391 Collection<? extends Callable<T>> collection) throws ExecutionException, InterruptedException {
    ...
    @Override // java.util.concurrent.ExecutorService
    @InterfaceC6391
    public Future<?> submit(@InterfaceC6391 Runnable runnable) {
    ...
    @Override // java.util.concurrent.ExecutorService
    @InterfaceC6391
    public <T> List<Future<T>> invokeAll(@InterfaceC6391 Collection<? extends Callable<T>> collection, long j, @InterfaceC6391 TimeUnit timeUnit) throws InterruptedException {
        return this.delegate.invokeAll(collection, j, timeUnit);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @Override // java.util.concurrent.ExecutorService
    public <T> T invokeAny(@InterfaceC6391 Collection<? extends Callable<T>> collection, long j, @InterfaceC6391 TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
    ...
    @Override // java.util.concurrent.ExecutorService
    @InterfaceC6391
    public <T> Future<T> submit(@InterfaceC6391 Runnable runnable, T t) {
    ...
    @Override // java.util.concurrent.ExecutorService
    public <T> Future<T> submit(@InterfaceC6391 Callable<T> callable) {
