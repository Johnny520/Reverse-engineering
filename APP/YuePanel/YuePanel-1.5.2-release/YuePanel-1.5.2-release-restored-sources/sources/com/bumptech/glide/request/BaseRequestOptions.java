...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    @InterfaceC6391
    private T optionalScaleOnlyTransform(@InterfaceC6391 DownsampleStrategy downsampleStrategy, @InterfaceC6391 Transformation<Bitmap> transformation) {
        return (T) scaleOnlyTransform(downsampleStrategy, transformation, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6391
    private T scaleOnlyTransform(@InterfaceC6391 DownsampleStrategy downsampleStrategy, @InterfaceC6391 Transformation<Bitmap> transformation) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T apply(@InterfaceC6391 BaseRequestOptions<?> baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().apply(baseRequestOptions);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T decode(@InterfaceC6391 Class<?> cls) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().decode(cls);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T diskCacheStrategy(@InterfaceC6391 DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public T dontTransform() {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().dontTransform();
        }
        this.transformations.clear();
        int i = this.fields;
        this.isTransformationRequired = false;
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T downsample(@InterfaceC6391 DownsampleStrategy downsampleStrategy) {
        return (T) set(DownsampleStrategy.OPTION, (DownsampleStrategy) Preconditions.checkNotNull(downsampleStrategy));
    }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T encodeFormat(@InterfaceC6391 Bitmap.CompressFormat compressFormat) {
        return (T) set(BitmapEncoder.COMPRESSION_FORMAT, (Bitmap.CompressFormat) Preconditions.checkNotNull(compressFormat));
    }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T encodeQuality(@InterfaceC5459(from = 0, m2228to = 100) int i) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T error(@InterfaceC6490 Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().error(drawable);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T fallback(@InterfaceC6490 Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().fallback(drawable);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T format(@InterfaceC6391 DecodeFormat decodeFormat) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T frame(@InterfaceC5459(from = 0) long j) {
    ...
    public T onlyRetrieveFromCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().onlyRetrieveFromCache(z);
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6391
    public final T optionalTransform(@InterfaceC6391 DownsampleStrategy downsampleStrategy, @InterfaceC6391 Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    public T override(int i, int i2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().override(i, i2);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T placeholder(@InterfaceC6490 Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().placeholder(drawable);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T priority(@InterfaceC6391 Priority priority) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().priority(priority);
        }
    ...
    public T removeOption(@InterfaceC6391 Option<?> option) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().removeOption(option);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public <Y> T set(@InterfaceC6391 Option<Y> option, @InterfaceC6391 Y y) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().set(option, y);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T signature(@InterfaceC6391 Key key) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().signature(key);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T sizeMultiplier(@InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().sizeMultiplier(f);
        }
        if (f < 0.0f || f > 1.0f) {
    ...
    public T skipMemoryCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().skipMemoryCache(true);
        }
        this.isCacheable = !z;
        this.fields |= 256;
        return (T) selfOrThrowIfLocked();
    ...
    /* JADX DEBUG: Type inference failed for r0v4. Raw type applied. Possible types: com.bumptech.glide.load.Option<android.content.res.Resources$Theme>, com.bumptech.glide.load.Option<Y> */
    @InterfaceC3809
    @InterfaceC6391
    public T theme(@InterfaceC6490 Resources.Theme theme) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().theme(theme);
        }
        this.theme = theme;
        if (theme != null) {
            this.fields |= 32768;
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T timeout(@InterfaceC5459(from = 0) int i) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public final T transform(@InterfaceC6391 DownsampleStrategy downsampleStrategy, @InterfaceC6391 Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    @InterfaceC6391
    @Deprecated
    public T transforms(@InterfaceC6391 Transformation<Bitmap>... transformationArr) {
    ...
    public T useAnimationPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().useAnimationPool(z);
        }
    ...
    public T useUnlimitedSourceGeneratorsPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().useUnlimitedSourceGeneratorsPool(z);
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    private T scaleOnlyTransform(@InterfaceC6391 DownsampleStrategy downsampleStrategy, @InterfaceC6391 Transformation<Bitmap> transformation, boolean z) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T optionalTransform(@InterfaceC6391 Transformation<Bitmap> transformation) {
        return (T) transform(transformation, false);
    }

    @InterfaceC3809
    @InterfaceC6391
    public T transform(@InterfaceC6391 Transformation<Bitmap> transformation) {
        return (T) transform(transformation, true);
    }

    @InterfaceC3809
    @InterfaceC6391
    public <Y> T optionalTransform(@InterfaceC6391 Class<Y> cls, @InterfaceC6391 Transformation<Y> transformation) {
        return (T) transform(cls, transformation, false);
    }

    @InterfaceC3809
    @InterfaceC6391
    public T transform(@InterfaceC6391 Transformation<Bitmap>... transformationArr) {
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T error(@InterfaceC4525 int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().error(i);
        }
        this.errorId = i;
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T fallback(@InterfaceC4525 int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().fallback(i);
        }
        this.fallbackId = i;
    ...
    @InterfaceC3809
    @InterfaceC6391
    public T placeholder(@InterfaceC4525 int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().placeholder(i);
        }
    ...
    @InterfaceC6391
    public T transform(@InterfaceC6391 Transformation<Bitmap> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().transform(transformation, z);
        }
    ...
    @InterfaceC6391
    public <Y> T transform(@InterfaceC6391 Class<Y> cls, @InterfaceC6391 Transformation<Y> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo30832clone().transform(cls, transformation, z);
        }
    ...
    @InterfaceC3809
    @InterfaceC6391
    public <Y> T transform(@InterfaceC6391 Class<Y> cls, @InterfaceC6391 Transformation<Y> transformation) {
