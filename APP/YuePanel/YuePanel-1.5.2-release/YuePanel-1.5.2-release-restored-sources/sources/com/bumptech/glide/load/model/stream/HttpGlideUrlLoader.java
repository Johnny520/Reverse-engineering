...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
    ...
    public boolean handles(@InterfaceC6391 GlideUrl glideUrl) {
        return true;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public HttpGlideUrlLoader(@InterfaceC6490 ModelCache<GlideUrl, GlideUrl> modelCache) {
    ...
    @Override // com.bumptech.glide.load.model.ModelLoader
    public ModelLoader.LoadData<InputStream> buildLoadData(@InterfaceC6391 GlideUrl glideUrl, int i, int i2, @InterfaceC6391 Options options) {
