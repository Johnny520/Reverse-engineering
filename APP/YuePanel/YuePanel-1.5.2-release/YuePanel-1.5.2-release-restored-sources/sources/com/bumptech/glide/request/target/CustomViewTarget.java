...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    @InterfaceC5411
    private static final int VIEW_TAG_ID = C1898R.id.glide_custom_view_target_tag;
    ...
    public CustomViewTarget(@InterfaceC6391 T t) {
    ...
    @Override // com.bumptech.glide.request.target.Target
    public final void onLoadCleared(@InterfaceC6490 Drawable drawable) {
    ...
    @Override // com.bumptech.glide.request.target.Target
    public final void onLoadStarted(@InterfaceC6490 Drawable drawable) {
        maybeAddAttachStateListener();
        onResourceLoading(drawable);
    }

    public abstract void onResourceCleared(@InterfaceC6490 Drawable drawable);

    public void onResourceLoading(@InterfaceC6490 Drawable drawable) {
    }
    ...
    @Deprecated
    public final CustomViewTarget<T, Z> useTagId(@InterfaceC5411 int i) {
        return this;
    }
