...
public final class DefaultOnHeaderDecodedListener implements ImageDecoder$OnHeaderDecodedListener {
    ...
    public DefaultOnHeaderDecodedListener(int i, int i2, @InterfaceC6391 Options options) {
    ...
    public void onHeaderDecoded(@InterfaceC6391 ImageDecoder imageDecoder, @InterfaceC6391 ImageDecoder.ImageInfo imageInfo, @InterfaceC6391 ImageDecoder.Source source) {
        ...
        imageDecoder.setOnPartialImageListener(new ImageDecoder$OnPartialImageListener() { // from class: com.bumptech.glide.load.resource.DefaultOnHeaderDecodedListener.1
            public boolean onPartialImage(@InterfaceC6391 ImageDecoder.DecodeException decodeException) {
                return false;
            }
        });
