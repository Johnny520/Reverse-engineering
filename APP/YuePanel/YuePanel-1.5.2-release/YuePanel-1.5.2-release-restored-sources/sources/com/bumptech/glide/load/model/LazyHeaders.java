...
public final class LazyHeaders implements Headers {
    ...
    public static final class Builder {
        ...
        public Builder addHeader(@InterfaceC6391 String str, @InterfaceC6391 String str2) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public Builder setHeader(@InterfaceC6391 String str, @InterfaceC6490 String str2) {
            return setHeader(str, str2 == null ? null : new StringHeaderFactory(str2));
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public Builder addHeader(@InterfaceC6391 String str, @InterfaceC6391 LazyHeaderFactory lazyHeaderFactory) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public Builder setHeader(@InterfaceC6391 String str, @InterfaceC6490 LazyHeaderFactory lazyHeaderFactory) {
            copyIfNecessary();
    ...
    public static final class StringHeaderFactory implements LazyHeaderFactory {
        ...
        public StringHeaderFactory(@InterfaceC6391 String str) {
            this.value = str;
        }
        ...
        public String toString() {
            return "StringHeaderFactory{value='" + this.value + '\'' + C6193.f1885;
        }
    }
    ...
    @InterfaceC6391
    private String buildHeaderValue(@InterfaceC6391 List<LazyHeaderFactory> list) {
    ...
    public String toString() {
        return "LazyHeaders{headers=" + this.headers + C6193.f1885;
    }
}
