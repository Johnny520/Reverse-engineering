...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>, TranscodeType> implements Cloneable {
    ...
    public final CHILD m30833clone() {
        try {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public final CHILD transition(@InterfaceC6391 ViewPropertyTransition.Animator animator) {
        return (CHILD) transition(new ViewPropertyAnimationFactory(animator));
    }

    @InterfaceC6391
    public final CHILD transition(@InterfaceC6391 TransitionFactory<? super TranscodeType> transitionFactory) {
