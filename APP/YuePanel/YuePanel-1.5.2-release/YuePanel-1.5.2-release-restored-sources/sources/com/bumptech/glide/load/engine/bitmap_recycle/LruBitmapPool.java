...
public class LruBitmapPool implements BitmapPool {
    ...
    @InterfaceC6391
    private static Bitmap createBitmap(int i, int i2, @InterfaceC6490 Bitmap.Config config) {
        if (config == null) {
    ...
    @InterfaceC6490
    private synchronized Bitmap getDirtyOrNull(int i, int i2, @InterfaceC6490 Bitmap.Config config) {
        Bitmap bitmap;
        try {
