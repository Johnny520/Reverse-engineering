...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable, InterfaceC3219 {
    ...
    public boolean unregisterAnimationCallback(@InterfaceC6391 InterfaceC3219.AbstractC0084 abstractC0084) {
        List<InterfaceC3219.AbstractC0084> list = this.animationCallbacks;
        if (list == null || abstractC0084 == null) {
            return false;
        }
        return list.remove(abstractC0084);
    }
