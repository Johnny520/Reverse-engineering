...
public class RecyclableBufferedInputStream extends FilterInputStream {
    ...
    public RecyclableBufferedInputStream(@InterfaceC6391 InputStream inputStream, @InterfaceC6391 ArrayPool arrayPool) {
    ...
    @InterfaceC8392
    public RecyclableBufferedInputStream(@InterfaceC6391 InputStream inputStream, @InterfaceC6391 ArrayPool arrayPool, int i) {
        super(inputStream);
        this.markpos = -1;
    ...
    @Override // java.io.FilterInputStream, java.io.InputStream
    public synchronized int read(@InterfaceC6391 byte[] bArr, int i, int i2) throws IOException {
        int i3;
        int i4;
        byte[] bArr2 = this.buf;
        if (bArr2 == null) {
