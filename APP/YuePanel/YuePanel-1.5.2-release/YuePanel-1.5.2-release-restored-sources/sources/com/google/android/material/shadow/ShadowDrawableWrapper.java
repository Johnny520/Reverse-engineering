...
@Deprecated
public class ShadowDrawableWrapper extends C4535 {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = C4187.m12060(context, C1980R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = C4187.m12060(context, C1980R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = C4187.m12060(context, C1980R.color.design_fab_shadow_end_color);
    ...
    private void buildComponents(@InterfaceC6391 Rect rect) {
    ...
    private void drawShadow(@InterfaceC6391 Canvas canvas) {
        int i;
        float f;
        int i2;
        float f2;
