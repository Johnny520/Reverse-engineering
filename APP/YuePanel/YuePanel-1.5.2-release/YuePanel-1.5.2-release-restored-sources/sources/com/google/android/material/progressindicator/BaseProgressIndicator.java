...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C1980R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    private final InterfaceC3219.AbstractC0084 hideAnimationCallback;
    ...
    private final InterfaceC3219.AbstractC0084 switchIndeterminateModeCallback;
    ...
    public BaseProgressIndicator(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet, @InterfaceC3451 int i, @InterfaceC7651 int i2) {
        ...
        this.switchIndeterminateModeCallback = new InterfaceC3219.AbstractC0084() { // from class: com.google.android.material.progressindicator.BaseProgressIndicator.3
        ...
        this.hideAnimationCallback = new InterfaceC3219.AbstractC0084() { // from class: com.google.android.material.progressindicator.BaseProgressIndicator.4
            @Override // Yue.InterfaceC3219.AbstractC0084
            public void onAnimationEnd(Drawable drawable) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1980R.styleable.BaseProgressIndicator, i, i2, new int[0]);
        this.showDelay = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public abstract S createSpec(@InterfaceC6391 Context context, @InterfaceC6391 AttributeSet attributeSet);
    ...
    @Override // android.widget.ProgressBar, android.view.View
    public synchronized void onDraw(@InterfaceC6391 Canvas canvas) {
        try {
    ...
    @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
    @InterfaceC8392
    public void setAnimatorDurationScaleProvider(@InterfaceC6391 AnimatorDurationScaleProvider animatorDurationScaleProvider) {
    ...
    @Override // android.widget.ProgressBar
    public void setIndeterminateDrawable(@InterfaceC6490 Drawable drawable) {
        if (drawable == null) {
    ...
    public void setIndicatorColor(@InterfaceC3897 int... iArr) {
        if (iArr.length == 0) {
            iArr = new int[]{MaterialColors.getColor(getContext(), C1980R.attr.colorPrimary, -1)};
        }
    ...
    public void setIndicatorTrackGapSize(@InterfaceC6844 int i) {
        S s = this.spec;
    ...
    @Override // android.widget.ProgressBar
    public void setProgressDrawable(@InterfaceC6490 Drawable drawable) {
        if (drawable == null) {
    ...
    public void setTrackColor(@InterfaceC3897 int i) {
        S s = this.spec;
        if (s.trackColor != i) {
            s.trackColor = i;
            invalidate();
    ...
    public void setTrackCornerRadius(@InterfaceC6844 int i) {
        S s = this.spec;
    ...
    public void setTrackThickness(@InterfaceC6844 int i) {
        S s = this.spec;
    ...
    public boolean visibleToUser() {
        return C8273.m27397(this) && getWindowVisibility() == 0 && isEffectivelyVisible();
    }
