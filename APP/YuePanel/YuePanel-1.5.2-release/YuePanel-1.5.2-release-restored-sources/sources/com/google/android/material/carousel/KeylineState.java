...
final class KeylineState {
    ...
    public static final class Builder {
        ...
        public Builder addAnchorKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, boolean z) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeylineRange(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeylineRange(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, int i, boolean z) {
            if (i > 0 && f3 > 0.0f) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2, float f4, float f5, float f6) {
            if (f3 <= 0.0f) {
                return this;
            }
            if (z2) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2, float f4) {
            return addKeyline(f, f2, f3, z, z2, f4, 0.0f, 0.0f);
        }

        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder addKeyline(float f, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f2, float f3, boolean z, boolean z2) {
            float fAbs;
            float f4 = f3 / 2.0f;
            float f5 = f - f4;
            float f6 = f4 + f;
    ...
    public static final class Keyline {
        ...
        public static Keyline lerp(Keyline keyline, Keyline keyline2, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f) {
