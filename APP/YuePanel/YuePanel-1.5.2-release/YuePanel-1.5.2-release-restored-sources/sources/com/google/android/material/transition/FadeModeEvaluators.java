...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f4141IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f4141IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f4141IN;
        }
        if (i == 2) {
            return CROSS;
        }
