...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@InterfaceC4885(from = 0.0d, m1796to = 360.0d) float f, boolean z);
    }

    public interface OnRotateListener {
        void onRotate(@InterfaceC4885(from = 0.0d, m1796to = 360.0d) float f, boolean z);
    }
    ...
    private void setHandRotationInternal(@InterfaceC4885(from = 0.0d, m1796to = 360.0d) float f, boolean z) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
    ...
    public void setCircleRadius(@InterfaceC4399 int i) {
        this.circleRadius = i;
        invalidate();
    }
    ...
    public ClockHandView(Context context, @InterfaceC6490 AttributeSet attributeSet) {
        this(context, attributeSet, C1980R.attr.materialClockStyle);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public void setHandRotation(@InterfaceC4885(from = 0.0d, m1796to = 360.0d) float f, boolean z) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.ۥ
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f4138.lambda$setHandRotation$0(valueAnimator2);
            }
        });
    ...
    public ClockHandView(Context context, @InterfaceC6490 AttributeSet attributeSet, int i) {
        ...
        this.currentLevel = 1;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1980R.styleable.ClockHandView, i, C1980R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.animationDuration = MotionUtils.resolveThemeDuration(context, C1980R.attr.motionDurationLong2, 200);
        this.animationInterpolator = MotionUtils.resolveThemeInterpolator(context, C1980R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        this.circleRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.ClockHandView_selectorSize, 0);
        this.selectorStrokeWidth = getResources().getDimensionPixelSize(C1980R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = r7.getDimensionPixelSize(C1980R.dimen.material_clock_hand_center_dot_radius);
        int color = typedArrayObtainStyledAttributes.getColor(C1980R.styleable.ClockHandView_clockHandColor, 0);
