...
public class MotionUtils {
    ...
    private static TimeInterpolator getLegacyThemeInterpolator(String str) {
        if (!isLegacyEasingType(str, EASING_TYPE_CUBIC_BEZIER)) {
            if (isLegacyEasingType(str, "path")) {
                return C6620.m21053(C6625.m21067(getLegacyEasingContent(str, "path")));
            }
            throw new IllegalArgumentException("Invalid motion easing type: " + str);
        }
        String[] strArrSplit = getLegacyEasingContent(str, EASING_TYPE_CUBIC_BEZIER).split(",");
        if (strArrSplit.length == 4) {
            return C6620.m3092(getLegacyControlPoint(strArrSplit, 0), getLegacyControlPoint(strArrSplit, 1), getLegacyControlPoint(strArrSplit, 2), getLegacyControlPoint(strArrSplit, 3));
        }
    ...
    public static int resolveThemeDuration(@InterfaceC6391 Context context, @InterfaceC3451 int i, int i2) {
        return MaterialAttributes.resolveInteger(context, i, i2);
    }

    @InterfaceC6391
    public static TimeInterpolator resolveThemeInterpolator(@InterfaceC6391 Context context, @InterfaceC3451 int i, @InterfaceC6391 TimeInterpolator timeInterpolator) {
