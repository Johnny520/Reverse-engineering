...
public final class TemperatureCache {
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new Function() { // from class: Yue.ۥۢۡ۟ۦ
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return this.f3056.lambda$getHctsByTemp$0((Hct) obj);
            }
        }, new Comparator() { // from class: Yue.ۥۢۡ۟ۧ
