...
class SearchBarAnimationHelper {
    ...
    private Animator getDefaultCenterViewAnimator(@InterfaceC6490 View view) {
    ...
    private Animator getExpandAnimator(final SearchBar searchBar, View view, @InterfaceC6490 AppBarLayout appBarLayout) {
    ...
    private ExpandCollapseAnimationHelper getExpandCollapseAnimationHelper(SearchBar searchBar, View view, @InterfaceC6490 AppBarLayout appBarLayout) {
    ...
    private ValueAnimator.AnimatorUpdateListener getExpandedViewBackgroundUpdateListener(SearchBar searchBar, final View view) {
        ...
        materialShapeDrawableCreateWithElevationOverlay.setElevation(C8273.m27347(searchBar));
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.ۥ۟۟۟
    ...
    private Animator getFadeOutChildrenAnimator(SearchBar searchBar, final View view) {
        ...
        valueAnimatorOfFloat.addUpdateListener(MultiViewUpdateListener.alphaListener(fadeChildren));
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.ۥ
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(0.0f);
            }
    ...
    private Animator getSecondaryActionMenuItemAnimator(@InterfaceC6490 View view) {
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(MultiViewUpdateListener.alphaListener(view));
        valueAnimatorOfFloat.setInterpolator(AnimationUtils.LINEAR_INTERPOLATOR);
    ...
    private Animator getSecondaryViewAnimator(TextView textView, @InterfaceC6490 View view) {
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    public static /* synthetic */ void lambda$getExpandedViewBackgroundUpdateListener$1(MaterialShapeDrawable materialShapeDrawable, View view, ValueAnimator valueAnimator) {
        ...
        C8273.m27447(view, materialShapeDrawable);
        view.setAlpha(1.0f);
    }
    ...
    public void startCollapseAnimation(SearchBar searchBar, View view, @InterfaceC6490 AppBarLayout appBarLayout, boolean z) {
        Animator animator;
    ...
    public void startExpandAnimation(final SearchBar searchBar, final View view, @InterfaceC6490 final AppBarLayout appBarLayout, final boolean z) {
        Animator animator;
        ...
        view.post(new Runnable() { // from class: com.google.android.material.search.ۥ۟۟
            @Override // java.lang.Runnable
            public final void run() {
                this.f30409.lambda$startExpandAnimation$0(searchBar, view, appBarLayout, z);
            }
        });
    }
    ...
    public void startOnLoadAnimation(SearchBar searchBar) {
        dispatchOnLoadAnimation(new OnLoadAnimationInvocation() { // from class: com.google.android.material.search.ۥ۟
        ...
        secondaryViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.search.SearchBarAnimationHelper.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                SearchBarAnimationHelper.this.dispatchOnLoadAnimation(new OnLoadAnimationInvocation() { // from class: com.google.android.material.search.ۥ۟۟۟۟
                    @Override // com.google.android.material.search.SearchBarAnimationHelper.OnLoadAnimationInvocation
                    public final void invoke(SearchBar.OnLoadAnimationCallback onLoadAnimationCallback) {
        ...
        if (centerView instanceof AnimatableView) {
            ((AnimatableView) centerView).startAnimation(new AnimatableView.Listener() { // from class: Yue.ۥۡۧۦۤ
