...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C1980R.attr.snackbarStyle};
    ...
    static final Handler handler = new Handler(Looper.getMainLooper(), new Handler.Callback() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.1
        ...
        public boolean handleMessage(@InterfaceC6391 Message message) {
            int i = message.what;
            if (i == 0) {
    ...
    public static class Anchor implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
        ...
        private Anchor(@InterfaceC6391 BaseTransientBottomBar baseTransientBottomBar, @InterfaceC6391 View view) {
            this.transientBottomBar = new WeakReference<>(baseTransientBottomBar);
            this.anchorView = new WeakReference<>(view);
        }

        public static Anchor anchor(@InterfaceC6391 BaseTransientBottomBar baseTransientBottomBar, @InterfaceC6391 View view) {
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        public void setBaseTransientBottomBar(@InterfaceC6391 BaseTransientBottomBar<?> baseTransientBottomBar) {
        ...
        @Override // com.google.android.material.behavior.SwipeDismissBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC8792
        public boolean onInterceptTouchEvent(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 View view, @InterfaceC6391 MotionEvent motionEvent) {
    ...
    public static class BehaviorDelegate {
        ...
        public BehaviorDelegate(@InterfaceC6391 SwipeDismissBehavior<?> swipeDismissBehavior) {
        ...
        public void onInterceptTouchEvent(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 View view, @InterfaceC6391 MotionEvent motionEvent) {
    ...
    @InterfaceC5459(from = C8531.f25355)
    @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
    @Retention(RetentionPolicy.SOURCE)
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(@InterfaceC6391 Context context) {
            this(context, null);
        }

        @InterfaceC6391
        private Drawable createThemedBackground() {
            int iLayer = MaterialColors.layer(this, C1980R.attr.colorSurface, C1980R.attr.colorOnSurface, getBackgroundOverlayColorAlpha());
            ...
            if (this.backgroundTint == null) {
                return C4520.m13239(drawableCreateMaterialShapeDrawableBackground);
            }
            Drawable drawableM13239 = C4520.m13239(drawableCreateMaterialShapeDrawableBackground);
            C4520.m13236(drawableM13239, this.backgroundTint);
        ...
        public void setBackground(@InterfaceC6490 Drawable drawable) {
        ...
        public void setBackgroundDrawable(@InterfaceC6490 Drawable drawable) {
            if (drawable != null && this.backgroundTint != null) {
                ...
                C4520.m13236(drawable, this.backgroundTint);
                C4520.m13237(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(@InterfaceC6490 ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                Drawable drawableM13239 = C4520.m13239(getBackground().mutate());
                C4520.m13236(drawableM13239, colorStateList);
                C4520.m13237(drawableM13239, this.backgroundTintMode);
                if (drawableM13239 != getBackground()) {
                    super.setBackgroundDrawable(drawableM13239);
                }
            }
        }
        ...
        public void setBackgroundTintMode(@InterfaceC6490 PorterDuff.Mode mode) {
            ...
            if (getBackground() != null) {
                Drawable drawableM13239 = C4520.m13239(getBackground().mutate());
                C4520.m13237(drawableM13239, mode);
                if (drawableM13239 != getBackground()) {
                    super.setBackgroundDrawable(drawableM13239);
                }
            }
        ...
        public SnackbarBaseLayout(@InterfaceC6391 Context context, AttributeSet attributeSet) {
            super(MaterialThemeOverlay.wrap(context, attributeSet, 0, 0), attributeSet);
            Context context2 = getContext();
            TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C1980R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C1980R.styleable.SnackbarLayout_elevation)) {
                C8273.m27453(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.SnackbarLayout_animationMode, 0);
            if (typedArrayObtainStyledAttributes.hasValue(C1980R.styleable.SnackbarLayout_shapeAppearance) || typedArrayObtainStyledAttributes.hasValue(C1980R.styleable.SnackbarLayout_shapeAppearanceOverlay)) {
                this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attributeSet, 0, 0).build();
            }
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1980R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1980R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1980R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1980R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            this.maxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.SnackbarLayout_android_maxWidth, -1);
            this.maxInlineActionWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
            typedArrayObtainStyledAttributes.recycle();
            setOnTouchListener(consumeAllTouchListener);
            setFocusable(true);
            if (getBackground() == null) {
                C8273.m27447(this, createThemedBackground());
            }
        }
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public BaseTransientBottomBar(@InterfaceC6391 ViewGroup viewGroup, @InterfaceC6391 View view, @InterfaceC6391 com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @InterfaceC6391
    public static GradientDrawable createGradientDrawableBackground(@InterfaceC3897 int i, @InterfaceC6391 Resources resources) {
        float dimension = resources.getDimension(C1980R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @InterfaceC6391
    public static MaterialShapeDrawable createMaterialShapeDrawableBackground(@InterfaceC3897 int i, @InterfaceC6391 ShapeAppearanceModel shapeAppearanceModel) {
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        return (layoutParams instanceof CoordinatorLayout.C8796) && (((CoordinatorLayout.C8796) layoutParams).m29508() instanceof SwipeDismissBehavior);
    }
    ...
    private void setUpBehavior(CoordinatorLayout.C8796 c8796) {
        ...
        newBehavior.setListener(new SwipeDismissBehavior.OnDismissListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.7
            ...
            public void onDismiss(@InterfaceC6391 View view) {
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            C8273.m27415(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.14
            ...
            public void onAnimationUpdate(@InterfaceC6391 ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    C8273.m27415(BaseTransientBottomBar.this.view, iIntValue - this.previousAnimatedIntValue);
                } else {
    ...
    @InterfaceC6391
    public B addCallback(@InterfaceC6490 BaseCallback<B> baseCallback) {
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1980R.layout.mtrl_layout_snackbar : C1980R.layout.design_layout_snackbar;
    }
    ...
    @InterfaceC6391
    public B removeCallback(@InterfaceC6490 BaseCallback<B> baseCallback) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6391
    public B setAnchorView(@InterfaceC6490 View view) {
        Anchor anchor = this.anchor;
        if (anchor != null) {
            anchor.unanchor();
        }
    ...
    public final void showView() {
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.C8796) {
                setUpBehavior((CoordinatorLayout.C8796) layoutParams);
            }
            this.view.addToTargetParent(this.targetParent);
            recalculateAndUpdateMargins();
            this.view.setVisibility(4);
        }
        if (C8273.m27404(this.view)) {
            showViewImpl();
        } else {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public BaseTransientBottomBar(@InterfaceC6391 Context context, @InterfaceC6391 ViewGroup viewGroup, @InterfaceC6391 View view, @InterfaceC6391 com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        C8273.m27441(snackbarBaseLayout, 1);
        C8273.m27457(snackbarBaseLayout, 1);
        C8273.m27454(snackbarBaseLayout, true);
        C8273.m27468(snackbarBaseLayout, new InterfaceC6545() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.3
            @Override // Yue.InterfaceC6545
            @InterfaceC6391
            public C8472 onApplyWindowInsets(View view2, @InterfaceC6391 C8472 c8472) {
                BaseTransientBottomBar.this.extraBottomMarginWindowInset = c8472.m28290();
                BaseTransientBottomBar.this.extraLeftMarginWindowInset = c8472.m28291();
                BaseTransientBottomBar.this.extraRightMarginWindowInset = c8472.m28292();
                BaseTransientBottomBar.this.updateMargins();
                return c8472;
            }
        });
        C8273.m27439(snackbarBaseLayout, new C3024() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.4
            @Override // Yue.C3024
        ...
        this.animationSlideDuration = MotionUtils.resolveThemeDuration(context, C1980R.attr.motionDurationLong2, 250);
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, C1980R.attr.motionDurationLong2, 150);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(context, C1980R.attr.motionDurationMedium1, 75);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context, C1980R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context, C1980R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
        this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context, C1980R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
    }

    @InterfaceC6391
    public B setAnchorView(@InterfaceC5411 int i) {
