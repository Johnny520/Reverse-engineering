...
public class CircularRevealHelper {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.google.android.material.circularreveal.CircularRevealHelper$Delegate */
    ...
    private void drawDebugCircle(@InterfaceC6391 Canvas canvas, int i, float f) {
    ...
    private void drawDebugMode(@InterfaceC6391 Canvas canvas) {
        ...
        if (shouldDrawCircularReveal()) {
            drawDebugCircle(canvas, C8273.f24692, 10.0f);
            drawDebugCircle(canvas, -65536, 5.0f);
        }
        drawOverlayDrawable(canvas);
    }

    private void drawOverlayDrawable(@InterfaceC6391 Canvas canvas) {
    ...
    private float getDistanceToFurthestCorner(@InterfaceC6391 CircularRevealWidget.RevealInfo revealInfo) {
