...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private StateListAnimator createDefaultStateListAnimator(float f, float f2, float f3) {
        ...
        arrayList.add(ObjectAnimator.ofFloat(this.view, AbstractC5616.f13585, f).setDuration(0L));
    ...
    private Animator createElevationAnimator(float f, float f2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.view, AbstractC5616.f13585, f).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, f2).setDuration(100L));
        animatorSet.setInterpolator(FloatingActionButtonImpl.ELEVATION_ANIM_INTERPOLATOR);
        return animatorSet;
    }
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) C6740.m21415(this.shapeAppearance));
        borderDrawable.setGradientColors(C4187.m12060(context, C1980R.color.design_fab_stroke_top_outer_color), C4187.m12060(context, C1980R.color.design_fab_stroke_top_inner_color), C4187.m12060(context, C1980R.color.design_fab_stroke_end_inner_color), C4187.m12060(context, C1980R.color.design_fab_stroke_end_outer_color));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) C6740.m21415(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @InterfaceC6490 PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            layerDrawable = new LayerDrawable(new Drawable[]{(Drawable) C6740.m21415(this.borderDrawable), (Drawable) C6740.m21415(this.shapeDrawable)});
        } else {
