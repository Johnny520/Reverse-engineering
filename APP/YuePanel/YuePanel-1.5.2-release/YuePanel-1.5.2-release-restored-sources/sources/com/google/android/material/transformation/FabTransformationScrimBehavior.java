...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@InterfaceC6391 View view, boolean z, boolean z2, @InterfaceC6391 List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    @InterfaceC6391
    public AnimatorSet onCreateExpandedStateChangeAnimation(@InterfaceC6391 View view, @InterfaceC6391 final View view2, final boolean z, boolean z2) {
    ...
    public boolean onTouchEvent(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 View view, @InterfaceC6391 MotionEvent motionEvent) {
