...
public class MaterialShapeDrawable extends Drawable implements InterfaceC7833, Shapeable {
    ...
    @InterfaceC6490
    private PorterDuffColorFilter calculatePaintColorTintFilter(@InterfaceC6391 Paint paint, boolean z) {
        if (!z) {
            return null;
        }
    ...
    private void calculatePath(@InterfaceC6391 RectF rectF, @InterfaceC6391 Path path) {
    ...
    private void calculateStrokePath() {
        ...
        ShapeAppearanceModel shapeAppearanceModelWithTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.shape.MaterialShapeDrawable.2
            ...
            @InterfaceC6391
            public CornerSize apply(@InterfaceC6391 CornerSize cornerSize) {
    ...
    @InterfaceC6391
    private PorterDuffColorFilter calculateTintColorTintFilter(@InterfaceC6391 ColorStateList colorStateList, @InterfaceC6391 PorterDuff.Mode mode, boolean z) {
    ...
    @InterfaceC6391
    private PorterDuffColorFilter calculateTintFilter(@InterfaceC6490 ColorStateList colorStateList, @InterfaceC6490 PorterDuff.Mode mode, @InterfaceC6391 Paint paint, boolean z) {
    ...
    private void drawCompatShadow(@InterfaceC6391 Canvas canvas) {
    ...
    private void drawFillShape(@InterfaceC6391 Canvas canvas) {
    ...
    private void maybeDrawCompatShadow(@InterfaceC6391 Canvas canvas) {
        if (hasCompatShadow()) {
            canvas.save();
    ...
    private void prepareCanvasForShadow(@InterfaceC6391 Canvas canvas) {
    ...
    private boolean updateTintFilter() {
        ...
        return (C6499.m2995(porterDuffColorFilter, this.tintFilter) && C6499.m2995(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
    ...
    public final void calculatePathForSize(@InterfaceC6391 RectF rectF, @InterfaceC6391 Path path) {
    ...
    @InterfaceC3897
    @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
    public int compositeElevationOverlayIfNeeded(@InterfaceC3897 int i) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
    public void drawShape(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, @InterfaceC6391 Path path, @InterfaceC6391 RectF rectF) {
    ...
    @Deprecated
    public void getPathForSize(int i, int i2, @InterfaceC6391 Path path) {
    ...
    public int getShadowOffsetX() {
        return (int) (((double) this.drawableState.shadowCompatOffset) * Math.sin(Math.toRadians(r0.shadowCompatRotation)));
    }

    public int getShadowOffsetY() {
        return (int) (((double) this.drawableState.shadowCompatOffset) * Math.cos(Math.toRadians(r0.shadowCompatRotation)));
    }
    ...
    public void setFillColor(@InterfaceC6490 ColorStateList colorStateList) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
    ...
    @Deprecated
    public void setShapedViewModel(@InterfaceC6391 ShapePathModel shapePathModel) {
        setShapeAppearanceModel(shapePathModel);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public void setStroke(float f, @InterfaceC3897 int i) {
        setStrokeWidth(f);
    ...
    public MaterialShapeDrawable(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet, @InterfaceC3451 int i, @InterfaceC7651 int i2) {
        this(ShapeAppearanceModel.builder(context, attributeSet, i, i2).build());
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static MaterialShapeDrawable createWithElevationOverlay(@InterfaceC6391 Context context, float f) {
        return createWithElevationOverlay(context, f, null);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    private void drawShape(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, @InterfaceC6391 Path path, @InterfaceC6391 ShapeAppearanceModel shapeAppearanceModel, @InterfaceC6391 RectF rectF) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public void setCornerSize(@InterfaceC6391 CornerSize cornerSize) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.withCornerSize(cornerSize));
    }

    @Deprecated
    public MaterialShapeDrawable(@InterfaceC6391 ShapePathModel shapePathModel) {
        this((ShapeAppearanceModel) shapePathModel);
    }

    @InterfaceC6391
    public static MaterialShapeDrawable createWithElevationOverlay(@InterfaceC6391 Context context, float f, @InterfaceC6490 ColorStateList colorStateList) {
        if (colorStateList == null) {
            colorStateList = ColorStateList.valueOf(MaterialColors.getColor(context, C1980R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName()));
        }
    ...
    public void setStroke(float f, @InterfaceC6490 ColorStateList colorStateList) {
        setStrokeWidth(f);
        setStrokeColor(colorStateList);
    }

    public MaterialShapeDrawable(@InterfaceC6391 ShapeAppearanceModel shapeAppearanceModel) {
        this(new MaterialShapeDrawableState(shapeAppearanceModel, null));
    }

    public void setStrokeTint(@InterfaceC3897 int i) {
        setStrokeTint(ColorStateList.valueOf(i));
    }

    @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
    public MaterialShapeDrawable(@InterfaceC6391 MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(@InterfaceC6391 ShapePath shapePath, Matrix matrix, int i) {
            ...
            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(@InterfaceC6391 ShapePath shapePath, Matrix matrix, int i) {
    ...
    public static class MaterialShapeDrawableState extends Drawable.ConstantState {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public MaterialShapeDrawableState(@InterfaceC6391 ShapeAppearanceModel shapeAppearanceModel, @InterfaceC6490 ElevationOverlayProvider elevationOverlayProvider) {
            this.fillColor = null;
        ...
        public MaterialShapeDrawableState(@InterfaceC6391 MaterialShapeDrawableState materialShapeDrawableState) {
            this.fillColor = null;
            this.strokeColor = null;
            this.strokeTintList = null;
            this.tintList = null;
