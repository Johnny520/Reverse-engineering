...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public ClearTextEndIconDelegate(@InterfaceC6391 EndCompoundLayout endCompoundLayout) {
        super(endCompoundLayout);
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.ۥ
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f30420.lambda$new$0(view);
            }
        };
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ۥ۟
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view, boolean z) {
                this.f4131.lambda$new$1(view, z);
            }
        };
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1980R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1980R.attr.motionDurationShort3, 150);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1980R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    private ValueAnimator getAlphaAnimator(float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ۥ۟۟
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f4132.lambda$getAlphaAnimator$3(valueAnimator);
            }
        });
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ۥ۟۟۟۟
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f4133.lambda$getScaleAnimator$4(valueAnimator);
            }
        });
        return valueAnimatorOfFloat;
    }
    ...
    public void afterEditTextChanged(@InterfaceC6391 Editable editable) {
    ...
    public int getIconContentDescriptionResId() {
        return C1980R.string.clear_text_end_icon_content_description;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconDrawableResId() {
        return C1980R.drawable.mtrl_ic_cancel;
    }
    ...
    public void tearDown() {
        EditText editText = this.editText;
        if (editText != null) {
            editText.post(new Runnable() { // from class: com.google.android.material.textfield.ۥ۟۟۟
                @Override // java.lang.Runnable
                public final void run() {
                    this.f30421.lambda$tearDown$2();
                }
            });
        }
    }
