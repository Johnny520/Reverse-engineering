...
class SnackbarManager {
    ...
    public static class SnackbarRecord {
        ...
        public boolean isSnackbar(@InterfaceC6490 Callback callback) {
    ...
    private boolean cancelSnackbarLocked(@InterfaceC6391 SnackbarRecord snackbarRecord, int i) {
    ...
    private void scheduleTimeoutLocked(@InterfaceC6391 SnackbarRecord snackbarRecord) {
    ...
    public void handleTimeout(@InterfaceC6391 SnackbarRecord snackbarRecord) {
        synchronized (this.lock) {
            try {
