...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.InterfaceC1654 {
    ...
    private static final int DEF_STYLE_RES = C1980R.style.Widget_MaterialComponents_BottomAppBar;
    private static final int FAB_ALIGNMENT_ANIM_DURATION_ATTR = C1980R.attr.motionDurationLong2;
    private static final int FAB_ALIGNMENT_ANIM_EASING_ATTR = C1980R.attr.motionEasingEmphasizedInterpolator;
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        if (bottomAppBar.fabAnchorMode == 1) {
                            ((ViewGroup.MarginLayoutParams) c8796).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C1980R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((view.getMeasuredHeight() - height) / 2));
                        }
                        ((ViewGroup.MarginLayoutParams) c8796).leftMargin = bottomAppBar.getLeftInset();
                        ((ViewGroup.MarginLayoutParams) c8796).rightMargin = bottomAppBar.getRightInset();
                        if (ViewUtils.isLayoutRtl(view)) {
                            ((ViewGroup.MarginLayoutParams) c8796).leftMargin += bottomAppBar.fabOffsetEndMode;
                        } else {
                            ((ViewGroup.MarginLayoutParams) c8796).rightMargin += bottomAppBar.fabOffsetEndMode;
                        }
                    }
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC8792
        public boolean onLayoutChild(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 BottomAppBar bottomAppBar, int i) {
            this.viewRef = new WeakReference<>(bottomAppBar);
            View viewFindDependentView = bottomAppBar.findDependentView();
            if (viewFindDependentView != null && !C8273.m27404(viewFindDependentView)) {
                BottomAppBar.updateFabAnchorGravity(bottomAppBar, viewFindDependentView);
                this.originalBottomMargin = ((ViewGroup.MarginLayoutParams) ((CoordinatorLayout.C8796) viewFindDependentView.getLayoutParams())).bottomMargin;
                if (viewFindDependentView instanceof FloatingActionButton) {
                    ...
                    if (bottomAppBar.fabAnchorMode == 0 && bottomAppBar.removeEmbeddedFabElevation) {
                        C8273.m27453(floatingActionButton, 0.0f);
                        floatingActionButton.setCompatElevation(0.0f);
                    }
                    if (floatingActionButton.getShowMotionSpec() == null) {
                        floatingActionButton.setShowMotionSpecResource(C1980R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (floatingActionButton.getHideMotionSpec() == null) {
                        floatingActionButton.setHideMotionSpecResource(C1980R.animator.mtrl_fab_hide_motion_spec);
                    }
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC8792
        public boolean onStartNestedScroll(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 BottomAppBar bottomAppBar, @InterfaceC6391 View view, @InterfaceC6391 View view2, int i, int i2) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public BottomAppBar(@InterfaceC6391 Context context) {
        this(context, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void addFabAnimationListeners(@InterfaceC6391 FloatingActionButton floatingActionButton) {
    ...
    private void createFabTranslationXAnimation(int i, @InterfaceC6391 List<Animator> list) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(findDependentFab(), AbstractC5616.f13597, getFabTranslationX(i));
        objectAnimatorOfFloat.setDuration(getFabAlignmentAnimationDuration());
        list.add(objectAnimatorOfFloat);
    }

    private void createMenuViewTranslationAnimation(final int i, final boolean z, @InterfaceC6391 List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        float fabAlignmentAnimationDuration = getFabAlignmentAnimationDuration();
        Animator animatorOfFloat = ObjectAnimator.ofFloat(actionMenuView, AbstractC5616.f13584, 1.0f);
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i, z)) <= 1.0f) {
            ...
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(actionMenuView, AbstractC5616.f13584, 0.0f);
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !C8273.m27404(this)) {
            return;
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private void translateActionMenuView(@InterfaceC6391 ActionMenuView actionMenuView, int i, boolean z) {
    ...
    public void addAnimationListener(@InterfaceC6391 AnimationListener animationListener) {
    ...
    public void addOnScrollStateChangedListener(@InterfaceC6391 HideBottomViewOnScrollBehavior.OnScrollStateChangedListener onScrollStateChangedListener) {
    ...
    public void createFabDefaultXAnimation(final int i, List<Animator> list) {
        ...
        floatingActionButtonFindDependentFab.hide(new FloatingActionButton.OnVisibilityChangedListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.5
            ...
            public void onHidden(@InterfaceC6391 FloatingActionButton floatingActionButton) {
    ...
    public int getActionMenuViewTranslationX(@InterfaceC6391 ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if ((childAt.getLayoutParams() instanceof Toolbar.C8734) && (((Toolbar.C8734) childAt.getLayoutParams()).f3618 & C5194.f12286) == 8388611) {
        ...
        if (getNavigationIcon() == null) {
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C1980R.dimen.m3_bottomappbar_horizontal_padding);
            if (!zIsLayoutRtl) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            if (viewFindDependentView != null && C8273.m27404(viewFindDependentView)) {
                viewFindDependentView.post(new Runnable() { // from class: Yue.ۥۣ۟۠ۦ
    ...
    public void removeAnimationListener(@InterfaceC6391 AnimationListener animationListener) {
    ...
    public void removeOnScrollStateChangedListener(@InterfaceC6391 HideBottomViewOnScrollBehavior.OnScrollStateChangedListener onScrollStateChangedListener) {
        getBehavior().removeOnScrollStateChangedListener(onScrollStateChangedListener);
    }

    public void replaceMenu(@InterfaceC6166 int i) {
        if (i != 0) {
    ...
    public void setBackgroundTint(@InterfaceC6490 ColorStateList colorStateList) {
        C4520.m13236(this.materialShapeDrawable, colorStateList);
    }

    public void setCradleVerticalOffset(@InterfaceC4399 float f) {
    ...
    public void setFabAlignmentModeAndReplaceMenu(int i, @InterfaceC6166 int i2) {
    ...
    public void setFabAlignmentModeEndMargin(@InterfaceC6844 int i) {
    ...
    public void setFabCornerSize(@InterfaceC4399 float f) {
    ...
    public void setFabCradleMargin(@InterfaceC4399 float f) {
    ...
    public void setFabCradleRoundedCornerRadius(@InterfaceC4399 float f) {
    ...
    public boolean setFabDiameter(@InterfaceC6844 int i) {
        float f = i;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public BottomAppBar(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet) {
        this(context, attributeSet, C1980R.attr.bottomAppBarStyle);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@InterfaceC6391 final ActionMenuView actionMenuView, final int i, final boolean z, boolean z2) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX DEBUG: Method merged with bridge method: getBehavior()Landroidx/coordinatorlayout/widget/CoordinatorLayout$ۥ۟۟; */
    ...
    public BottomAppBar(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet, int i) {
        ...
        this.fabTransformationCallback = new TransformationCallback<FloatingActionButton>() { // from class: com.google.android.material.bottomappbar.BottomAppBar.2
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
            /* JADX DEBUG: Method merged with bridge method: onScaleChanged(Landroid/view/View;)V */
            @Override // com.google.android.material.animation.TransformationCallback
            public void onScaleChanged(@InterfaceC6391 FloatingActionButton floatingActionButton) {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
            /* JADX DEBUG: Method merged with bridge method: onTranslationChanged(Landroid/view/View;)V */
            @Override // com.google.android.material.animation.TransformationCallback
            public void onTranslationChanged(@InterfaceC6391 FloatingActionButton floatingActionButton) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1980R.styleable.BottomAppBar, i, i2, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1980R.styleable.BottomAppBar_backgroundTint);
        if (typedArrayObtainStyledAttributes.hasValue(C1980R.styleable.BottomAppBar_navigationIconTint)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(C1980R.styleable.BottomAppBar_navigationIconTint, -1));
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1980R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1980R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1980R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1980R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.fabAnchorMode = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BottomAppBar_fabAnchorMode, 1);
        this.removeEmbeddedFabElevation = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_removeEmbeddedFabElevation, true);
        this.menuAlignmentMode = typedArrayObtainStyledAttributes.getInt(C1980R.styleable.BottomAppBar_menuAlignmentMode, 0);
        this.hideOnScroll = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_hideOnScroll, false);
        this.paddingBottomSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_paddingRightSystemWindowInsets, false);
        this.fabAlignmentModeEndMargin = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1980R.styleable.BottomAppBar_fabAlignmentModeEndMargin, -1);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.BottomAppBar_addElevationShadow, true);
        typedArrayObtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C1980R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        ...
        C4520.m13236(materialShapeDrawable, colorStateList);
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i, i2, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public C8472 onApplyWindowInsets(View view, @InterfaceC6391 C8472 c8472, @InterfaceC6391 ViewUtils.RelativePadding relativePadding) {
                ...
                if (BottomAppBar.this.paddingBottomSystemWindowInsets) {
                    BottomAppBar.this.bottomInset = c8472.m28290();
                }
                boolean z3 = false;
                if (BottomAppBar.this.paddingLeftSystemWindowInsets) {
                    z2 = BottomAppBar.this.leftInset != c8472.m28291();
                    BottomAppBar.this.leftInset = c8472.m28291();
                } else {
                    z2 = false;
                }
                if (BottomAppBar.this.paddingRightSystemWindowInsets) {
                    boolean z4 = BottomAppBar.this.rightInset != c8472.m28292();
                    BottomAppBar.this.rightInset = c8472.m28292();
                    z3 = z4;
                }
                if (z2 || z3) {
