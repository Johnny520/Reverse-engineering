...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f4145IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.platform.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f4145IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f4145IN;
        }
        if (i == 2) {
            return CROSS;
        }
