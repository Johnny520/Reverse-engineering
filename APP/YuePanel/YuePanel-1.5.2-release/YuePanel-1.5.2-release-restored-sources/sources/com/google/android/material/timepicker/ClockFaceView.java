...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    private final C3024 valueAccessibilityDelegate;
    private String[] values;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public ClockFaceView(@InterfaceC6391 Context context) {
        this(context, null);
    }
    ...
    private void updateTextViews(@InterfaceC7613 int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, size); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                if (textView == null) {
                    textView = (TextView) layoutInflaterFrom.inflate(C1980R.layout.material_clockface_textview, (ViewGroup) this, false);
                    this.textViewPool.put(i2, textView);
                    addView(textView);
                }
                textView.setText(this.values[i2]);
                textView.setTag(C1980R.id.material_value_index, Integer.valueOf(i2));
                int i3 = (i2 / 12) + 1;
                textView.setTag(C1980R.id.material_clock_level, Integer.valueOf(i3));
                if (i3 > 1) {
                    z = true;
                }
                C8273.m27439(textView, this.valueAccessibilityDelegate);
    ...
    public void onInitializeAccessibilityNodeInfo(@InterfaceC6391 AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        C3055.m5950(accessibilityNodeInfo).m6059(C3055.C3059.m6139(1, this.values.length, false, 1));
    }
    ...
    public void setHandRotation(@InterfaceC4885(from = 0.0d, m1796to = 360.0d) float f) {
    ...
    public ClockFaceView(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet) {
        this(context, attributeSet, C1980R.attr.materialClockStyle);
    }

    @SuppressLint({"ClickableViewAccessibility"})
    public ClockFaceView(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1980R.styleable.ClockFaceView, i, C1980R.style.Widget_MaterialComponents_TimePicker_Clock);
        Resources resources = getResources();
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1980R.styleable.ClockFaceView_clockNumberTextColor);
        this.textColor = colorStateList;
        LayoutInflater.from(context).inflate(C1980R.layout.material_clockface_view, (ViewGroup) this, true);
        ClockHandView clockHandView = (ClockHandView) findViewById(C1980R.id.material_clock_hand);
        this.clockHandView = clockHandView;
        this.clockHandPadding = resources.getDimensionPixelSize(C1980R.dimen.material_clock_hand_padding);
        int colorForState = colorStateList.getColorForState(new int[]{R.attr.state_selected}, colorStateList.getDefaultColor());
        this.gradientColors = new int[]{colorForState, colorForState, colorStateList.getDefaultColor()};
        clockHandView.addOnRotateListener(this);
        int defaultColor = C3323.m395(context, C1980R.color.material_timepicker_clockface).getDefaultColor();
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1980R.styleable.ClockFaceView_clockFaceBackgroundColor);
        ...
        this.valueAccessibilityDelegate = new C3024() { // from class: com.google.android.material.timepicker.ClockFaceView.2
            @Override // Yue.C3024
            public void onInitializeAccessibilityNodeInfo(View view, @InterfaceC6391 C3055 c3055) {
                ...
                int iIntValue = ((Integer) view.getTag(C1980R.id.material_value_index)).intValue();
                if (iIntValue > 0) {
                    c3055.m6109((View) ClockFaceView.this.textViewPool.get(iIntValue - 1));
                }
                c3055.m6060(C3055.C3060.m6143(0, 1, iIntValue, 1, false, view.isSelected()));
                c3055.m6058(true);
        ...
        Arrays.fill(strArr, "");
        setValues(strArr, 0);
        this.minimumHeight = resources.getDimensionPixelSize(C1980R.dimen.material_time_picker_minimum_screen_height);
        this.minimumWidth = resources.getDimensionPixelSize(C1980R.dimen.material_time_picker_minimum_screen_width);
        this.clockSize = resources.getDimensionPixelSize(C1980R.dimen.material_clock_size);
    }
}
