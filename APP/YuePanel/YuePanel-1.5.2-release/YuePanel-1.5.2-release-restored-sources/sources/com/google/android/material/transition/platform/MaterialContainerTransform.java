...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(@InterfaceC6391 TransitionValues transitionValues, @InterfaceC6490 View view, @InterfaceC5411 int i, @InterfaceC6490 ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            transitionValues.view = TransitionUtils.findDescendantOrAncestorById(transitionValues.view, i);
        } else if (view != null) {
            transitionValues.view = view;
        } else if (transitionValues.view.getTag(C1980R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) transitionValues.view.getTag(C1980R.id.mtrl_motion_snapshot_view);
            transitionValues.view.setTag(C1980R.id.mtrl_motion_snapshot_view, null);
    ...
    public void captureEndValues(@InterfaceC6391 TransitionValues transitionValues) {
        captureValues(transitionValues, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    public void captureStartValues(@InterfaceC6391 TransitionValues transitionValues) {
        captureValues(transitionValues, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    @InterfaceC6490
    public Animator createAnimator(@InterfaceC6391 ViewGroup viewGroup, @InterfaceC6490 TransitionValues transitionValues, @InterfaceC6490 TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.platform.MaterialContainerTransform.2
                    ...
                    public void onTransitionEnd(@InterfaceC6391 Transition transition) {
                    ...
                    @Override // com.google.android.material.transition.platform.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                    public void onTransitionStart(@InterfaceC6391 Transition transition) {
    ...
    @Override // android.transition.Transition
    public void setPathMotion(@InterfaceC6490 PathMotion pathMotion) {
