...
final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private C4790 interpolator;
    private int newIndicatorColorIndex;

    public LinearIndeterminateContiguousAnimatorDelegate(@InterfaceC6391 LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        super(3);
    ...
    @Override // com.google.android.material.progressindicator.IndeterminateAnimatorDelegate
    public void registerAnimatorsCompleteCallback(@InterfaceC6490 InterfaceC3219.AbstractC0084 abstractC0084) {
    }
