...
final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    public CircularDrawingDelegate(@InterfaceC6391 CircularProgressIndicatorSpec circularProgressIndicatorSpec) {
        super(circularProgressIndicatorSpec);
    }

    private void drawArc(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, float f, float f2, @InterfaceC3897 int i, @InterfaceC6844 int i2, @InterfaceC6844 int i3) {
    ...
    private void drawRoundedBlock(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, float f, float f2, float f3) {
    ...
    @Override // com.google.android.material.progressindicator.DrawingDelegate
    public void fillIndicator(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, @InterfaceC6391 DrawingDelegate.ActiveIndicator activeIndicator, @InterfaceC5459(from = 0, m2228to = 255) int i) {
    ...
    @Override // com.google.android.material.progressindicator.DrawingDelegate
    public void fillTrack(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, float f, float f2, @InterfaceC3897 int i, @InterfaceC5459(from = 0, m2228to = 255) int i2, int i3) {
    ...
    private void drawRoundedBlock(@InterfaceC6391 Canvas canvas, @InterfaceC6391 Paint paint, float f, float f2, float f3, float f4) {
