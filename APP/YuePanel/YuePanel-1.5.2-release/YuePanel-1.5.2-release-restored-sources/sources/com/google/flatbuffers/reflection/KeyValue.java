...
public final class KeyValue extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public KeyValue getByKey(String str) {
            return KeyValue.__lookup_by_key(null, __vector(), str, this.f4151bb);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public KeyValue get(KeyValue keyValue, int i) {
            return keyValue.__assign(Table.__indirect(__element(i), this.f4151bb), this.f4151bb);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public KeyValue getByKey(KeyValue keyValue, String str) {
            return KeyValue.__lookup_by_key(keyValue, __vector(), str, this.f4151bb);
        }
    }
