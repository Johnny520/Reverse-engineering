...
public class FlexBuffersBuilder {
    ...
    private final ReadWriteBuf f4155bb;
    ...
    public static class Value {
        ...
        public static Value nullValue(int i) {
            return new Value(i, 0, 0, 0L);
        }
        ...
        public static int elemWidth(int i, int i2, long j, int i3, int i4) {
            ...
            for (int i5 = 1; i5 <= 32; i5 *= 2) {
                int iWidthUInBits = FlexBuffersBuilder.widthUInBits(((long) ((paddingBytes(i3, i5) + i3) + (i4 * i5))) - j);
    ...
    private int align(int i) {
        int i2 = 1 << i;
        int iPaddingBytes = Value.paddingBytes(this.f4155bb.writePosition(), i2);
        while (true) {
            int i3 = iPaddingBytes - 1;
            if (iPaddingBytes == 0) {
                return i2;
            }
            this.f4155bb.put((byte) 0);
            iPaddingBytes = i3;
        }
    }
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            iMax = Math.max(iMax, Value.elemWidth(4, 0, this.stack.get(i3).key, this.f4155bb.writePosition(), i3));
        }
        int iAlign = align(iMax);
        writeInt(j, iAlign);
        int iWritePosition = this.f4155bb.writePosition();
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        int iMax = Math.max(0, widthUInBits(j));
        if (value != null) {
            iMax = Math.max(iMax, value.elemWidth(this.f4155bb.writePosition(), 0));
            i4 = 3;
        } else {
            i4 = 1;
        }
        ...
        for (int i7 = i2; i7 < this.stack.size(); i7++) {
            iMax2 = Math.max(iMax2, this.stack.get(i7).elemWidth(this.f4155bb.writePosition(), i7 + i4));
            if (z && i7 == i2) {
        ...
        if (!z) {
            while (i8 < this.stack.size()) {
                this.f4155bb.put(this.stack.get(i8).storedPackedType(iMax2));
                i8++;
            }
        }
        if (value != null) {
    ...
    private int putKey(String str) {
        ...
        if ((this.flags & 1) == 0) {
            ...
            this.f4155bb.put(bytes, 0, bytes.length);
            this.f4155bb.put((byte) 0);
        ...
        this.f4155bb.put(bytes2, 0, bytes2.length);
        this.f4155bb.put((byte) 0);
        this.keyPool.put(str, Integer.valueOf(iWritePosition));
        return iWritePosition;
    }
    ...
    private Value writeBlob(int i, byte[] bArr, int i2, boolean z) {
        ...
        int iWritePosition = this.f4155bb.writePosition();
        this.f4155bb.put(bArr, 0, bArr.length);
        if (z) {
            this.f4155bb.put((byte) 0);
        }
    ...
    private void writeDouble(double d, int i) {
        if (i == 4) {
            this.f4155bb.putFloat((float) d);
        } else if (i == 8) {
            this.f4155bb.putDouble(d);
        }
    }

    private void writeInt(long j, int i) {
        if (i == 1) {
            this.f4155bb.put((byte) j);
            return;
        }
        if (i == 2) {
            this.f4155bb.putShort((short) j);
        } else if (i == 4) {
            this.f4155bb.putInt((int) j);
        } else {
            if (i != 8) {
                return;
            }
            this.f4155bb.putLong(j);
        }
    }

    private void writeOffset(long j, int i) {
        writeInt((int) (((long) this.f4155bb.writePosition()) - j), i);
    }
    ...
    public ByteBuffer finish() {
        int iAlign = align(this.stack.get(0).elemWidth(this.f4155bb.writePosition(), 0));
        writeAny(this.stack.get(0), iAlign);
        this.f4155bb.put(this.stack.get(0).storedPackedType());
        this.f4155bb.put((byte) iAlign);
        this.finished = true;
        return ByteBuffer.wrap(this.f4155bb.data(), 0, this.f4155bb.writePosition());
    }
    ...
    public void putNull(String str) {
        this.stack.add(Value.nullValue(putKey(str)));
    }
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.keyComparator = new Comparator<Value>() { // from class: com.google.flatbuffers.FlexBuffersBuilder.1
            ...
            public int compare(Value value, Value value2) {
                ...
                int i3 = value2.key;
                do {
                    b = FlexBuffersBuilder.this.f4155bb.get(i2);
                    b2 = FlexBuffersBuilder.this.f4155bb.get(i3);
                    if (b == 0) {
                        return b - b2;
                    }
                    i2++;
