...
public final class Type implements TypeBearer, Comparable<Type> {
    ...
    private static final ConcurrentMap<String, Type> internTable = new ConcurrentHashMap(DexFormat.API_SPACES_IN_SIMPLE_NAME, 0.75f);
    ...
    static {
        ...
        LONG = type7;
        Type type8 = new Type(C4750.f10490, 8);
        SHORT = type8;
        VOID = new Type(C4750.f10496, 0);
    ...
    public static Type internReturnType(String str) {
        try {
            return str.equals(C4750.f10496) ? VOID : intern(str);
    ...
    public Type asUninitialized(int i) {
        ...
        Type type = new Type('N' + Hex.m5035u2(i) + this.descriptor, 9, i);
    ...
    public String toHuman() {
        switch (this.basicType) {
            ...
            case 9:
                ...
                return getComponentType().toHuman() + C5385.f13236;
            default:
                return this.descriptor;
        }
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX DEBUG: Method merged with bridge method: getFrameType()Lcom/android/dx/rop/type/TypeBearer; */
    @Override // com.android.p001dx.rop.type.TypeBearer
