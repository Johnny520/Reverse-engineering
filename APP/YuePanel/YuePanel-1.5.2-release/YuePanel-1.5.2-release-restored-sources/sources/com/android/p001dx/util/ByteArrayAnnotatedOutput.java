...
public final class ByteArrayAnnotatedOutput implements AnnotatedOutput, ByteOutput {
    ...
    @Override // com.android.p001dx.util.Output
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // com.android.p001dx.util.AnnotatedOutput
  ...
  0x0017: PHI (r1v3 int) = (r1v0 int), (r1v1 int) binds: [B:9:0x0015, B:12:0x001b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    @Override // com.android.p001dx.util.Output, com.android.dex.util.ByteOutput
    ...
    public void write(byte[] bArr, int i, int i2) {
        ...
        throw new IndexOutOfBoundsException("bytes.length " + bArr.length + C4219.f748 + i + "..!" + i4);
    }
