...
import com.android.p001dx.p004io.instructions.DecodedInstruction;
...
public final class CodeReader {
    ...
    /* JADX INFO: renamed from: com.android.dx.io.CodeReader$1 */
    public static /* synthetic */ class C18251 {
    ...
    private void callVisit(DecodedInstruction[] decodedInstructionArr, DecodedInstruction decodedInstruction) {
        Visitor visitor;
        switch (C18251.$SwitchMap$com$android$dx$io$IndexType[OpcodeInfo.getIndexType(decodedInstruction.getOpcode()).ordinal()]) {
            case 1:
