...
public final class CodeItem extends OffsettedItem {
    ...
    public void debugPrint(PrintWriter printWriter, String str, boolean z) {
        ...
        printWriter.println("regs: " + Hex.m5035u2(getRegistersSize()) + "; ins: " + Hex.m5035u2(getInsSize()) + "; outs: " + Hex.m5035u2(getOutsSize()));
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            sb.append(Hex.m5035u2(registersSize));
            annotatedOutput.annotate(2, sb.toString());
            annotatedOutput.annotate(2, "  ins_size:       " + Hex.m5035u2(insSize));
            annotatedOutput.annotate(2, "  outs_size:      " + Hex.m5035u2(outsSize));
            annotatedOutput.annotate(2, "  tries_size:     " + Hex.m5035u2(iTriesSize));
            annotatedOutput.annotate(4, "  debug_off:      " + Hex.m5037u4(absoluteOffset));
            annotatedOutput.annotate(4, "  insns_size:     " + Hex.m5037u4(iCodeSize));
