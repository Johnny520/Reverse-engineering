...
public class ByteOps {
    ...
    static {
        ...
        while (i2 < 2498) {
            int i3 = 16;
            int iDigit = (Character.digit(OPCODE_DETAILS.charAt(i2), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i2 + 1), 16);
            char cCharAt = OPCODE_DETAILS.charAt(i2 + 3);
            if (cCharAt == '-') {
                i3 = 1;
            } else if (cCharAt == 'I') {
                i3 = 13;
            ...
            int i4 = i2 + 5;
            if (OPCODE_DETAILS.charAt(i2 + 4) == ':') {
                while (true) {
                    char cCharAt2 = OPCODE_DETAILS.charAt(i4);
                    if (cCharAt2 == 'D') {
                        i = i3 | 256;
                    } else if (cCharAt2 == 'F') {
                        i = i3 | 64;
            ...
            int iIndexOf = OPCODE_DETAILS.indexOf(59, i4);
            OPCODE_INFO[iDigit] = i3;
            OPCODE_NAMES[iDigit] = OPCODE_DETAILS.substring(i4, iIndexOf);
            i2 = iIndexOf + 1;
        }
    }
    ...
    public static String opName(int i) {
        ...
        String str2 = "unused_" + Hex.m5034u1(i);
        strArr[i] = str2;
        return str2;
    }
}
