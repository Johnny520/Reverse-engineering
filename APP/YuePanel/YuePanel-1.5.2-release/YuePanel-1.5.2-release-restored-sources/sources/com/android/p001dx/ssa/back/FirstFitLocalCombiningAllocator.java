...
import com.android.p001dx.ssa.InterferenceRegisterMapper;
import com.android.p001dx.ssa.NormalSsaInsn;
import com.android.p001dx.ssa.Optimizer;
import com.android.p001dx.ssa.PhiInsn;
...
import com.android.p001dx.util.IntSet;
            ...
            if (!this.ssaRegsMapped.get(reg) || this.mapper.oldToNew(reg) != i) {
                if (!rangeContainsReserved(i, i4)) {
                    if (!this.ssaRegsMapped.get(reg) && canMapReg(registerSpec, i) && !bitSet2.get(reg)) {
                        i2 += i4;
                    } else if (!this.mapper.areAnyPinned(registerSpecListSsaSetToSpecs, i, i4) && !this.mapper.areAnyPinned(sources, i, i4)) {
                        bitSet.set(i3);
                    }
                }
                return -1;
