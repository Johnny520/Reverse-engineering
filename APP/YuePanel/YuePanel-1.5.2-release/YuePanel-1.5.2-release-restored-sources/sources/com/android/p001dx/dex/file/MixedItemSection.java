...
public final class MixedItemSection extends Section {
    ...
    public static /* synthetic */ class C18242 {
    ...
    public void placeItems() {
        throwIfNotPrepared();
        int i = C18242.$SwitchMap$com$android$dx$dex$file$MixedItemSection$SortType[this.sort.ordinal()];
        if (i == 1) {
    ...
    public void writeHeaderPart(AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(4, name + "_size:" + str + Hex.m5037u4(i));
            annotatedOutput.annotate(4, name + "_off: " + str + Hex.m5037u4(fileOffset));
        }
