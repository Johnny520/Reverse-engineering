...
import com.android.p001dx.rop.cst.CstArray;
...
import com.android.p001dx.util.Writers;
...
public final class ClassDefItem extends IndexedItem {
    ...
    public void debugPrint(Writer writer, boolean z) {
        ...
        printWriterPrintWriterFor.println("  accessFlags: " + Hex.m5035u2(this.accessFlags));
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            sb3.append(Hex.m5037u4(iIndexOf3));
            sb3.append(" // ");
            CstString cstString = this.sourceFile;
            ...
            annotatedOutput.annotate(4, "  class_data_off:      " + Hex.m5037u4(absoluteOffset2));
            annotatedOutput.annotate(4, "  static_values_off:   " + Hex.m5037u4(absoluteOffsetOr02));
        }
