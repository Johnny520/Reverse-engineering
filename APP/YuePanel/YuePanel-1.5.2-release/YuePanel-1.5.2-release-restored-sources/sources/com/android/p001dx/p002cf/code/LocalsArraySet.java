        ...
        for (int i = 0; i < size; i++) {
            ...
            if (localsArray != null) {
                try {
                    ...
                    e.addContext("Merging one locals against caller block " + Hex.m5035u2(i));
    ...
    */
            ...
            if (localsArray != localsArray2) {
                if (localsArray == null) {
                    ...
                    try {
                        ...
                        e.addContext("Merging locals set for caller block " + Hex.m5035u2(i));
                    }
                }
            }
            z = z || localsArray != localsArrayMerge;
    ...
    public void annotate(ExceptionWithContext exceptionWithContext) {
        ...
        for (int i = 0; i < size; i++) {
            LocalsArray localsArray = this.secondaries.get(i);
            if (localsArray != null) {
                exceptionWithContext.addContext("(locals array set: primary for caller " + Hex.m5035u2(i) + ')');
    ...
    @Override // com.android.p001dx.util.MutabilityControl
    ...
    public String toHuman() {
        ...
        for (int i = 0; i < size; i++) {
            LocalsArray localsArray = this.secondaries.get(i);
            if (localsArray != null) {
                sb.append("(locals array set: primary for caller " + Hex.m5035u2(i) + ")\n");
    ...
    /* JADX DEBUG: Method merged with bridge method: merge(Lcom/android/dx/cf/code/LocalsArray;)Lcom/android/dx/cf/code/LocalsArray; */
    @Override // com.android.p001dx.p002cf.code.LocalsArray
