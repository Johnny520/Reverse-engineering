...
public final class PhiInsn extends SsaInsn {
    ...
    @Override // com.android.p001dx.ssa.SsaInsn
    ...
    public final String toHumanWithInline(String str) {
        ...
        if (size == 0) {
            ...
            for (int i = 0; i < size; i++) {
                sb.append(" ");
                sb.append(this.sources.get(i).toHuman() + "[b=" + Hex.m5035u2(this.operands.get(i).ropLabel) + "]");
            }
        }
        return sb.toString();
    }
    ...
    /* JADX DEBUG: Method merged with bridge method: clone()Lcom/android/dx/ssa/SsaInsn; */
    /* JADX DEBUG: Method merged with bridge method: clone()Ljava/lang/Object; */
    @Override // com.android.p001dx.ssa.SsaInsn
    /* JADX INFO: renamed from: clone */
    public PhiInsn mo30831clone() {
