...
import com.android.p001dx.rop.cst.CstAnnotation;
...
public final class AnnotationParser {
    ...
    private final DirectClassFile f4016cf;
    ...
    private Annotations parseAnnotations(AnnotationVisibility annotationVisibility) throws IOException {
        int unsignedShort = this.input.readUnsignedShort();
        if (this.observer != null) {
            parsed(2, "num_annotations: " + Hex.m5035u2(unsignedShort));
        }
    ...
    private AnnotationsList parseAnnotationsList(AnnotationVisibility annotationVisibility) throws IOException {
        ...
        if (this.observer != null) {
            parsed(1, "num_parameters: " + Hex.m5034u1(unsignedByte));
        }
    ...
    private Constant parseValue() throws IOException {
        ...
        if (unsignedByte != 91) {
            switch (unsignedByte) {
                ...
                default:
                    throw new ParseException("unknown annotation tag: " + Hex.m5034u1(unsignedByte));
            }
        }
        requireLength(2);
