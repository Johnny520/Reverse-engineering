...
public enum ItemType implements ToHuman {
    ...
    TYPE_TYPE_LIST(AbstractC8885.f29787, "type_list"),
    TYPE_ANNOTATION_SET_REF_LIST(C5445.f13379, "annotation_set_ref_list"),
    TYPE_ANNOTATION_SET_ITEM(AbstractC8885.f29789, "annotation_set_item"),
    ...
    TYPE_ENCODED_ARRAY_ITEM(AbstractC8885.f29791, "encoded_array_item"),
