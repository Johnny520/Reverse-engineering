...
public final class HeaderItem extends IndexedItem {
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            annotatedOutput.annotate(4, "file_size:       " + Hex.m5037u4(dexFile.getFileSize()));
            annotatedOutput.annotate(4, "header_size:     " + Hex.m5037u4(112));
            annotatedOutput.annotate(4, "endian_tag:      " + Hex.m5037u4(DexFormat.ENDIAN_TAG));
            annotatedOutput.annotate(4, "link_size:       0");
            annotatedOutput.annotate(4, "link_off:        0");
            annotatedOutput.annotate(4, "map_off:         " + Hex.m5037u4(fileOffset));
        }
        for (int i = 0; i < 8; i++) {
        ...
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(4, "data_size:       " + Hex.m5037u4(fileOffset3));
            annotatedOutput.annotate(4, "data_off:        " + Hex.m5037u4(fileOffset2));
        }
