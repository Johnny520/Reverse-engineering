package com.android.p001dx.command.annotool;

import com.android.p001dx.command.annotool.Main;
...
import com.android.p001dx.p002cf.attrib.BaseAnnotations;
...
class AnnotationLister {
    ...
    public static /* synthetic */ class C18112 {
    ...
    public void printMatch(DirectClassFile directClassFile) {
        ...
        while (it.hasNext()) {
            int i = C18112.$SwitchMap$com$android$dx$command$annotool$Main$PrintType[it.next().ordinal()];
            if (i == 1) {
