...
import com.android.p001dx.util.MutabilityControl;
...
public final class StdConstantPool extends MutabilityControl implements ConstantPool {
    ...
    private static Constant throwInvalid(int i) {
        throw new ExceptionWithContext("invalid constant pool index " + Hex.m5035u2(i));
    }

    @Override // com.android.p001dx.rop.cst.ConstantPool
