...
public final class EncodeValueLong extends EncodeValue implements IAnnotationEncodeValue, INumberEncodeValue {
    ...
    public int innerBuild(@InterfaceC6399 FlatBufferBuilder flatBufferBuilder) {
        ...
        int iCreateEncodeValueLong = org.luckypray.dexkit.schema.EncodeValueLong.INSTANCE.createEncodeValueLong(flatBufferBuilder, this.value);
        flatBufferBuilder.finish(iCreateEncodeValueLong);
