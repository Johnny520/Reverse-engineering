...
public final class DexKitBridge$getFieldAnnotations$res$1 extends AbstractC5673 implements InterfaceC5124<Long, byte[]> {
    ...
    public final byte[] invoke(long j) {
        return DexKitBridge.INSTANCE.nativeGetFieldAnnotations(j, this.$fieldId);
    }
}
