...
public final class DexKitBridge$writeFieldMethods$res$1 extends AbstractC5673 implements InterfaceC5124<Long, byte[]> {
    ...
    public final byte[] invoke(long j) {
        return DexKitBridge.INSTANCE.nativeFieldPutMethods(j, this.$encodeId);
    }
}
