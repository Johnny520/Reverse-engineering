...
public final class BatchFindClassUsingStrings extends BaseFinder {
    ...
    @InterfaceC6211(m2698d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0007¨\u0006\u0005"}, m2699d2 = {"Lorg/luckypray/dexkit/query/BatchFindClassUsingStrings$Companion;", "", "()V", "create", "Lorg/luckypray/dexkit/query/BatchFindClassUsingStrings;", "dexkit-android_release"}, m2700k = 1, m2701mv = {1, 5, 1}, m2703xi = 48)
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings addSearchGroup(@InterfaceC6399 String str, @InterfaceC6399 Collection<String> collection) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6399
    public final BatchFindClassUsingStrings excludePackages(@InterfaceC6399 String... excludePackages) {
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings groups(@InterfaceC6399 Map<String, ? extends Collection<String>> map) {
        C5499.m17103(map, "keywordsMap");
        return groups$default(this, map, null, false, 6, null);
    }

    @InterfaceC6399
    public final BatchFindClassUsingStrings ignorePackagesCase(boolean ignorePackagesCase) {
    ...
    */
    public int innerBuild(@InterfaceC6399 FlatBufferBuilder fbb) throws IllegalAccessException {
        ...
        BatchFindClassUsingStrings.Companion companion = org.luckypray.dexkit.schema.BatchFindClassUsingStrings.INSTANCE;
        ...
        if (collection3 != null) {
            ...
            iCreateInClassesVector = jArrM11063 != null ? org.luckypray.dexkit.schema.BatchFindClassUsingStrings.INSTANCE.createInClassesVector(fbb, jArrM11063) : 0;
        }
        List<StringMatchersGroup> list3 = this.searchGroups;
        C5499.m17100(list3);
        ArrayList arrayList5 = new ArrayList(C3881.m10756(list3, 10));
        Iterator<T> it5 = list3.iterator();
        while (it5.hasNext()) {
            arrayList5.add(Integer.valueOf(((StringMatchersGroup) it5.next()).build$dexkit_android_release(fbb)));
        }
        int iCreateBatchFindClassUsingStrings = companion.createBatchFindClassUsingStrings(fbb, iCreateVectorOfTables, iCreateVectorOfTables2, z, iCreateInClassesVector, fbb.createVectorOfTables(C3888.m11061(arrayList5)));
        fbb.finish(iCreateBatchFindClassUsingStrings);
        return iCreateBatchFindClassUsingStrings;
    }

    @InterfaceC6399
    public final BatchFindClassUsingStrings searchIn(@InterfaceC6399 Collection<ClassData> classes) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6399
    public final BatchFindClassUsingStrings searchPackages(@InterfaceC6399 String... searchPackages) {
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings addSearchGroup(@InterfaceC6399 String str, @InterfaceC6399 Collection<String> collection, @InterfaceC6399 StringMatchType stringMatchType) {
        C5499.m17103(str, "groupName");
        C5499.m17103(collection, "usingStrings");
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6399
    public final BatchFindClassUsingStrings excludePackages(@InterfaceC6399 Collection<String> excludePackages) {
        C5499.m17103(excludePackages, "excludePackages");
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings groups(@InterfaceC6399 Map<String, ? extends Collection<String>> map, @InterfaceC6399 StringMatchType stringMatchType) {
        C5499.m17103(map, "keywordsMap");
        C5499.m17103(stringMatchType, "matchType");
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6399
    public final BatchFindClassUsingStrings searchPackages(@InterfaceC6399 Collection<String> searchPackages) {
        C5499.m17103(searchPackages, "searchPackages");
    ...
    @InterfaceC6399
    public final BatchFindClassUsingStrings addSearchGroup(@InterfaceC6399 StringMatchersGroup matcher) {
    ...
    @InterfaceC6399
    public final BatchFindClassUsingStrings groups(@InterfaceC6399 Collection<StringMatchersGroup> groups) {
        C5499.m17103(groups, "groups");
        this.searchGroups = C3888.m11065(groups);
        return this;
    }

    public final /* synthetic */ BatchFindClassUsingStrings groups(InterfaceC5124 init) {
    ...
    public final /* synthetic */ BatchFindClassUsingStrings addSearchGroup(InterfaceC5124 init) {
        C5499.m17103(init, "init");
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings groups(@InterfaceC6399 Map<String, ? extends Collection<String>> keywordsMap, @InterfaceC6399 StringMatchType matchType, boolean ignoreCase) {
    ...
    public final /* synthetic */ BatchFindClassUsingStrings addSearchGroup(String groupName, InterfaceC5124 init) {
    ...
    @InterfaceC6399
    @InterfaceC5573
    public final BatchFindClassUsingStrings addSearchGroup(@InterfaceC6399 String groupName, @InterfaceC6399 Collection<String> usingStrings, @InterfaceC6399 StringMatchType matchType, boolean ignoreCase) {
        C5499.m17103(groupName, "groupName");
