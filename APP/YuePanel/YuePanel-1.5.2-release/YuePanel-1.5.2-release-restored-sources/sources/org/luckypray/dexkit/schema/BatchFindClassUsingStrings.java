...
public final class BatchFindClassUsingStrings extends Table {
    ...
    public static final class Companion {
        ...
        public final void addMatchers(@InterfaceC6399 FlatBufferBuilder builder, int matchers) {
            C5499.m17103(builder, "builder");
            builder.addOffset(4, matchers, 0);
        }
        ...
        public final int createBatchFindClassUsingStrings(@InterfaceC6399 FlatBufferBuilder builder, int searchPackagesOffset, int excludePackagesOffset, boolean ignorePackagesCase, int inClassesOffset, int matchersOffset) {
            C5499.m17103(builder, "builder");
        ...
        public final int endBatchFindClassUsingStrings(@InterfaceC6399 FlatBufferBuilder builder) {
            C5499.m17103(builder, "builder");
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        @InterfaceC6399
        public final BatchFindClassUsingStrings getRootAsBatchFindClassUsingStrings(@InterfaceC6399 ByteBuffer _bb) {
            C5499.m17103(_bb, "_bb");
            return getRootAsBatchFindClassUsingStrings(_bb, new BatchFindClassUsingStrings());
        }

        public final void startBatchFindClassUsingStrings(@InterfaceC6399 FlatBufferBuilder builder) {
            C5499.m17103(builder, "builder");
            builder.startTable(5);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        @InterfaceC6399
        public final BatchFindClassUsingStrings getRootAsBatchFindClassUsingStrings(@InterfaceC6399 ByteBuffer _bb, @InterfaceC6399 BatchFindClassUsingStrings obj) {
            C5499.m17103(_bb, "_bb");
    ...
    @InterfaceC6399
    public final BatchFindClassUsingStrings __assign(int _i, @InterfaceC6399 ByteBuffer _bb) {
        C5499.m17103(_bb, "_bb");
        __init(_i, _bb);
        return this;
    }
