...
public final class ClassData$annotations$2 extends AbstractC5673 implements InterfaceC5122<List<? extends AnnotationData>> {
    ...
    public ClassData$annotations$2(DexKitBridge dexKitBridge, ClassData classData, int i, int i2) {
        super(0);
    ...
    public final List<? extends AnnotationData> invoke() {
        return this.$bridge.getClassAnnotations$dexkit_android_release(this.this$0.getEncodeId(this.$dexId, this.$id));
    }
}
