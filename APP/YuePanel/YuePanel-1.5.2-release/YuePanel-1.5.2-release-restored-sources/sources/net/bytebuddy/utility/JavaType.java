...
public final class JavaType {
    ...
    static {
        ...
        JavaType javaType6 = new JavaType("DYNAMIC_CONSTANT_DESCRIPTION", 5, "java.lang.constant.DynamicConstantDesc", C5445.f13378, TypeDescription.ForLoadedType.m5238of(Object.class), javaType5.getTypeStub());
        ...
        JavaType javaType11 = new JavaType("METHOD_HANDLE", 10, "java.lang.invoke.MethodHandle", C5445.f13378, TypeDescription.ForLoadedType.m5238of(Object.class), javaType.getTypeStub());
        ...
        JavaType javaType13 = new JavaType("METHOD_TYPE", 12, "java.lang.invoke.MethodType", 17, TypeDescription.ForLoadedType.m5238of(Object.class), javaType.getTypeStub(), javaType4.getTypeStub(), TypeDescription.ForLoadedType.m5238of(Serializable.class));
        ...
        JavaType javaType15 = new JavaType("CALL_SITE", 14, "java.lang.invoke.CallSite", C5445.f13378, Object.class, new Type[0]);
        CALL_SITE = javaType15;
        JavaType javaType16 = new JavaType("VAR_HANDLE", 15, "java.lang.invoke.VarHandle", C5445.f13378, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class), javaType.getTypeStub());
        ...
        JavaType javaType18 = new JavaType("EXECUTABLE", 17, "java.lang.reflect.Executable", C5445.f13378, AccessibleObject.class, Member.class, GenericDeclaration.class);
        ...
        JavaType javaType21 = new JavaType("RECORD", 20, "java.lang.Record", C5445.f13378, Object.class, new Type[0]);
        RECORD = javaType21;
    ...
    private JavaType(String str, int i, @MaybeNull String str2, int i2, Type type, Type... typeArr) {
        this(str, i, str2, i2, type == null ? TypeDescription.Generic.UNDEFINED : TypeDefinition.Sort.describe(type), new TypeList.Generic.ForLoadedTypes(typeArr));
    }
    ...
    public TypeDescription loadAsDescription() throws ClassNotFoundException {
        return TypeDescription.ForLoadedType.m5238of(load());
    }

    /* JADX WARN: Illegal instructions before constructor call */
    private JavaType(String str, int i, @MaybeNull String str2, int i2, TypeDefinition typeDefinition, TypeDefinition... typeDefinitionArr) {
        ...
        this(str, i, str2, i2, genericAsGenericType, new TypeList.Generic.Explicit(typeDefinitionArr));
    }
