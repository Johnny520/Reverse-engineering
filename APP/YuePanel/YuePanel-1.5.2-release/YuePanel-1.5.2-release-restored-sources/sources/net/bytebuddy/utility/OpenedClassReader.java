...
public class OpenedClassReader {
    ...
    public static ClassReader m5431of(byte[] bArr) {
        ...
        if (!EXPERIMENTAL) {
            throw new IllegalArgumentException(classFileVersionOfClassFile + " is not supported by the current version of Byte Buddy which officially supports " + classFileVersionLatest + " - update Byte Buddy or set " + EXPERIMENTAL_PROPERTY + " as a VM property");
        }
