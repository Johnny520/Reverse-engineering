...
public class StackAwareMethodVisitor extends MethodVisitor {
    ...
    public static /* synthetic */ class C29101 {
    ...
    private void doDrain(List<StackSize> list) {
        ...
        while (listIterator.hasPrevious()) {
            ...
            int i = C29101.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[stackSizePrevious.ordinal()];
            if (i == 1) {
                super.visitInsn(87);
            } else {
                if (i != 2) {
    ...
    public static MethodVisitor m5437of(MethodVisitor methodVisitor, MethodDescription methodDescription) {
    ...
    */
    ...
    public void visitJumpInsn(int i, Label label) {
        adjustStack(SIZE_CHANGE[i]);
        this.sizes.put(label, new ArrayList(i == 168 ? CompoundList.m5413of(this.current, StackSize.SINGLE) : this.current));
        if (i == 167) {
            this.current.clear();
        }
    ...
    private void adjustStack(int i, int i2) {
        ...
        if (i > 0) {
            ...
            if (i2 >= 0) {
                this.current.add(size, StackSize.m5373of(i));
                return;
            }
