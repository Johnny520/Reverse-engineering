...
public class ClassWriter extends ClassVisitor {
    ...
    private Attribute[] getAttributePrototypes() {
        ...
        for (FieldWriter fieldWriter = this.firstField; fieldWriter != null; fieldWriter = (FieldWriter) fieldWriter.f4227fv) {
            fieldWriter.collectAttributePrototypes(set);
        }
        for (MethodWriter methodWriter = this.firstMethod; methodWriter != null; methodWriter = (MethodWriter) methodWriter.f4228mv) {
    ...
    public byte[] toByteArray() {
        ...
        if (annotationWriter != null) {
            attributeCount++;
            iComputeAttributesSize += annotationWriter.computeAnnotationsSize(AttRuntimeVisibleAnnotations.ATTRIBUTE_NAME);
        }
        AnnotationWriter annotationWriter2 = this.lastRuntimeInvisibleAnnotation;
        if (annotationWriter2 != null) {
            attributeCount++;
            iComputeAttributesSize += annotationWriter2.computeAnnotationsSize(AttRuntimeInvisibleAnnotations.ATTRIBUTE_NAME);
        }
        ...
        for (FieldWriter fieldWriter2 = this.firstField; fieldWriter2 != null; fieldWriter2 = (FieldWriter) fieldWriter2.f4227fv) {
            fieldWriter2.putFieldInfo(byteVector5);
        }
        byteVector5.putShort(i5);
        boolean zHasFrames = false;
        boolean zHasAsmInstructions = false;
        for (MethodWriter methodWriter2 = this.firstMethod; methodWriter2 != null; methodWriter2 = (MethodWriter) methodWriter2.f4228mv) {
        ...
        if (this.sourceFileIndex != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceFile.ATTRIBUTE_NAME)).putInt(i2).putShort(this.sourceFileIndex);
        }
        ByteVector byteVector7 = this.debugExtension;
        if (byteVector7 != null) {
            int i7 = byteVector7.length;
            i3 = 0;
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceDebugExtension.ATTRIBUTE_NAME)).putInt(i7).putByteArray(this.debugExtension.data, 0, i7);
        } else {
            i3 = 0;
        }
        if ((this.accessFlags & 131072) != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttDeprecated.ATTRIBUTE_NAME)).putInt(i3);
        }
    ...
    public final FieldVisitor visitField(int i, String str, String str2, String str3, Object obj) {
        ...
        if (this.firstField == null) {
            ...
            this.lastField.f4227fv = fieldWriter;
        }
    ...
    public final MethodVisitor visitMethod(int i, String str, String str2, String str3, String[] strArr) {
        ...
        if (this.firstMethod == null) {
            ...
            this.lastMethod.f4228mv = methodWriter;
        }
