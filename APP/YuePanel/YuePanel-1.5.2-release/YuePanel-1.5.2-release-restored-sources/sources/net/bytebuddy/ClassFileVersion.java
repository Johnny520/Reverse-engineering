...
import com.android.p001dx.Version;
...
public class ClassFileVersion implements Comparable<ClassFileVersion>, Serializable {
    ...
    public static ClassFileVersion m5114of(Class<?> cls) throws IOException {
        return m5115of(cls, ClassFileLocator.ForClassLoader.m5258of(cls.getClassLoader()));
    }

    public static ClassFileVersion ofClassFile(byte[] bArr) {
        if (bArr.length >= 7) {
            return ofMinorMajor(bArr[7] | (bArr[4] << 24) | (bArr[5] << BaseType.Union) | (bArr[6] << 8));
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX INFO: renamed from: of */
    public static ClassFileVersion m5115of(Class<?> cls, ClassFileLocator classFileLocator) throws IOException {
        return m5116of(TypeDescription.ForLoadedType.m5238of(cls), classFileLocator);
    }
    ...
    /* JADX INFO: renamed from: of */
    public static ClassFileVersion m5116of(TypeDescription typeDescription, ClassFileLocator classFileLocator) throws IOException {
