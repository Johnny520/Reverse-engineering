...
public interface ParameterDescription extends AnnotationSource, NamedElement.WithRuntimeName, NamedElement.WithOptionalName, ModifierReviewable.ForParameterDescription, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static abstract class ForLoadedParameter<T extends AccessibleObject> extends InDefinedShape.AbstractBase {
        ...
        public static class OfConstructor extends ForLoadedParameter<Constructor<?>> {
            ...
            public TypeDescription.Generic getType() {
                if (TypeDescription.AbstractBase.RAW_TYPES) {
                    return TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(((Constructor) this.executable).getParameterTypes()[this.index]);
                }
                T t = this.executable;
        ...
        public static class OfLegacyVmConstructor extends InDefinedShape.AbstractBase {
            ...
            @Override // net.bytebuddy.description.method.ParameterDescription
            public TypeDescription.Generic getType() {
                return TypeDescription.AbstractBase.RAW_TYPES ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(this.parameterType[this.index]) : new TypeDescription.Generic.LazyProjection.OfConstructorParameter(this.constructor, this.index, this.parameterType);
            }
        ...
        public static class OfLegacyVmMethod extends InDefinedShape.AbstractBase {
            ...
            @Override // net.bytebuddy.description.method.ParameterDescription
            public TypeDescription.Generic getType() {
                return TypeDescription.AbstractBase.RAW_TYPES ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(this.parameterType[this.index]) : new TypeDescription.Generic.LazyProjection.OfMethodParameter(this.method, this.index, this.parameterType);
            }
        ...
        public static class OfMethod extends ForLoadedParameter<Method> {
            ...
            public TypeDescription.Generic getType() {
                if (TypeDescription.AbstractBase.RAW_TYPES) {
                    return TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(((Method) this.executable).getParameterTypes()[this.index]);
                }
                T t = this.executable;
        ...
        static {
            ...
            PARAMETER = (Parameter) doPrivileged(JavaDispatcher.m5432of(Parameter.class));
        }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        @Override // net.bytebuddy.description.method.ParameterDescription
        public TypeDescription.Generic getType() {
            return (TypeDescription.Generic) this.parameterType.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m5250of(this));
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                int iHashCode = ((this.type.hashCode() * 31) + this.annotations.hashCode()) * 31;
                String str = this.name;
        ...
        public String toString() {
            return "ParameterDescription.Token{type=" + this.type + ", annotations=" + this.annotations + ", name='" + this.name + "', modifiers=" + this.modifiers + C6193.f1885;
        }
