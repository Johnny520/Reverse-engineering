...
public class NexusAccessor {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (javaModuleOfType != null && !javaModuleOfType.canRead(javaModuleOfType2)) {
                                ...
                                cls2.getMethod("addReads", cls2).invoke(javaModuleOfType.unwrap(), javaModuleOfType2.unwrap());
                            }
                            return new Available(clsLoadClass.getMethod("register", String.class, ClassLoader.class, ReferenceQueue.class, Integer.TYPE, Object.class), clsLoadClass.getMethod("clean", Reference.class));
                        } catch (Exception e2) {
    ...
    public static class InitializationAppender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            try {
                ...
                ArrayFactory arrayFactoryForType = ArrayFactory.forType(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Class.class));
                StackManipulation stackManipulationM5380of = ClassConstant.m5380of(TypeDescription.ForLoadedType.m5238of(Class.class));
                Class cls = Integer.TYPE;
                return new ByteCodeAppender.Simple(new StackManipulation.Compound(withImplicitInvocationTargetTypeInvoke, textConstant, withImplicitInvocationTargetTypeInvoke2, textConstant2, arrayFactoryForType.withValues(Arrays.asList(stackManipulationM5380of, ClassConstant.m5380of(TypeDescription.ForLoadedType.m5238of(cls)))), MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(Class.class.getMethod("getMethod", String.class, Class[].class))), NullConstant.INSTANCE, ArrayFactory.forType(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class)).withValues(Arrays.asList(ClassConstant.m5380of(methodDescription.getDeclaringType().asErasure()), new StackManipulation.Compound(IntegerConstant.forValue(this.identification), MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(Integer.class.getMethod("valueOf", cls)))))), MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(Method.class.getMethod("invoke", Object.class, Object[].class))), Removal.SINGLE)).apply(methodVisitor, context, methodDescription);
    ...
    */
    ...
    public int hashCode() {
        ...
        ReferenceQueue<? super ClassLoader> referenceQueue = this.referenceQueue;
        return referenceQueue != null ? iHashCode + referenceQueue.hashCode() : iHashCode;
    }
