...
public interface RecordComponentRegistry {
    ...
    public static class Default implements RecordComponentRegistry {
        ...
        public static class Entry implements LatentMatcher<RecordComponentDescription> {
            ...
            /* JADX DEBUG: Type inference failed for r2v1. Raw type applied. Possible types: net.bytebuddy.matcher.ElementMatcher<? super ? super net.bytebuddy.description.type.RecordComponentDescription>, net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.RecordComponentDescription> */
