...
public interface ClassInjector {
    ...
    public static class UsingInstrumentation extends AbstractBase {
        ...
        public static ClassInjector m5271of(File file, Target target, Instrumentation instrumentation) {
    ...
    public static class UsingJna extends AbstractBase {
        ...
        public interface Dispatcher {
            ...
            public interface Jvm extends Library {
                Class<?> JVM_DefineClass(JNIEnv jNIEnv, String str, @MaybeNull ClassLoader classLoader, byte[] bArr, int i, @MaybeNull ProtectionDomain protectionDomain) throws LastErrorException;
            }
        ...
        */
        public boolean equals(@MaybeNull Object obj) {
            ...
            UsingJna usingJna = (UsingJna) obj;
            ClassLoader classLoader2 = usingJna.classLoader;
            if (classLoader2 != null) {
                if (classLoader == null || !classLoader.equals(classLoader2)) {
                    return false;
                }
                ProtectionDomain protectionDomain = this.protectionDomain;
                ProtectionDomain protectionDomain2 = usingJna.protectionDomain;
    ...
    public static class UsingLookup extends AbstractBase {
        ...
        /* JADX INFO: renamed from: of */
        public static UsingLookup m5272of(Object obj) {
            if (!isAvailable()) {
        ...
        public UsingLookup m5273in(Class<?> cls) {
            try {
        ...
        @Override // net.bytebuddy.dynamic.loading.ClassInjector
        public Map<String, Class<?>> injectRaw(Map<? extends String, byte[]> map) {
            PackageDescription packageDescription = TypeDescription.ForLoadedType.m5238of(lookupType()).getPackage();
    ...
    public static class UsingReflection extends AbstractBase {
        ...
        public interface Dispatcher {
            ...
            public static class UsingUnsafeInjection implements Dispatcher, Initializable {
                ...
                */
                public static Initializable make() throws Exception {
                    ...
                    DynamicType.Builder builderName = new ByteBuddy().with(TypeValidation.DISABLED).subclass(Object.class, (ConstructorStrategy) ConstructorStrategy.Default.NO_CONSTRUCTORS).name(ClassLoader.class.getName() + "$ByteBuddyAccessor$V1");
                    ...
                    if (declaredMethod != null) {
                        builderIntercept2 = builderIntercept2.defineMethod("getDefinedPackage", Package.class, visibility).withParameters(ClassLoader.class, String.class).intercept(MethodCall.invoke(declaredMethod).onArgument(0).withArgument(1));
                    }
                    try {
                        str = "getClassLoadingLock";
                    } catch (NoSuchMethodException unused2) {
                        str = "getClassLoadingLock";
                    }
                    try {
                        try {
                            builderIntercept = builderIntercept2.defineMethod(str, Object.class, visibility).withParameters(ClassLoader.class, String.class).intercept(MethodCall.invoke(ClassLoader.class.getDeclaredMethod(str, String.class)).onArgument(0).withArgument(1));
                        } catch (NoSuchMethodException unused3) {
                            i = 1;
                            ModifierContributor.ForMethod[] forMethodArr = new ModifierContributor.ForMethod[i];
                            forMethodArr[0] = Visibility.PUBLIC;
                            DynamicType.Builder.MethodDefinition.ParameterDefinition.Initial initialDefineMethod2 = builderIntercept2.defineMethod(str, Object.class, forMethodArr);
                        ...
                        i = 1;
                        ModifierContributor.ForMethod[] forMethodArr2 = new ModifierContributor.ForMethod[i];
                        forMethodArr2[0] = Visibility.PUBLIC;
                        DynamicType.Builder.MethodDefinition.ParameterDefinition.Initial initialDefineMethod22 = builderIntercept2.defineMethod(str, Object.class, forMethodArr2);
                        Type[] typeArr2 = new Type[2];
                        typeArr2[0] = ClassLoader.class;
                        typeArr2[i] = String.class;
                        builderIntercept = initialDefineMethod22.withParameters(typeArr2).intercept(FixedValue.argument(0));
                        ...
                        return new UsingUnsafeInjection(objInvoke, method, loaded.getMethod("defineClass", ClassLoader.class, String.class, byte[].class, cls3, cls3, ProtectionDomain.class), declaredMethod == null ? loaded.getMethod("getDefinedPackage", ClassLoader.class, String.class) : null, loaded.getMethod("getPackage", ClassLoader.class, String.class), loaded.getMethod("definePackage", ClassLoader.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class), loaded.getMethod(str, ClassLoader.class, String.class));
                    }
                    Class loaded2 = builderIntercept.make().load(ClassLoadingStrategy.BOOTSTRAP_LOADER, new ClassLoadingStrategy.ForUnsafeInjection()).getLoaded();
                    Object objInvoke2 = cls.getMethod("allocateInstance", Class.class).invoke(obj, loaded2);
                    Method method2 = loaded2.getMethod("findLoadedClass", ClassLoader.class, String.class);
                    Class cls32 = Integer.TYPE;
                    return new UsingUnsafeInjection(objInvoke2, method2, loaded2.getMethod("defineClass", ClassLoader.class, String.class, byte[].class, cls32, cls32, ProtectionDomain.class), declaredMethod == null ? loaded2.getMethod("getDefinedPackage", ClassLoader.class, String.class) : null, loaded2.getMethod("getPackage", ClassLoader.class, String.class), loaded2.getMethod("definePackage", ClassLoader.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class), loaded2.getMethod(str, ClassLoader.class, String.class));
                }
            ...
            public static abstract class UsingUnsafeOverride implements Dispatcher, Initializable {
                ...
                public static Initializable make() throws Exception {
                    ...
                    Long l = (Long) cls.getMethod("objectFieldOffset", Field.class).invoke(obj, declaredField);
                    l.longValue();
                    ...
                    method3.invoke(obj, declaredMethod2, l, bool);
                    ...
                    method3.invoke(obj, declaredMethod4, l, bool);
                    method3.invoke(obj, declaredMethod3, l, bool);
                    method3.invoke(obj, declaredMethod5, l, bool);
                    try {
                        declaredMethod = ClassLoader.class.getDeclaredMethod("getClassLoadingLock", String.class);
                        method3.invoke(obj, declaredMethod, l, bool);
                        method = declaredMethod5;
                    } catch (NoSuchMethodException unused3) {
                        method = declaredMethod5;
                    }
                    try {
                        return new ForJava7CapableVm(declaredMethod3, declaredMethod4, method2, declaredMethod2, declaredMethod5, declaredMethod);
                    } catch (NoSuchMethodException unused4) {
                        return new ForLegacyVm(declaredMethod3, declaredMethod4, method2, declaredMethod2, method);
                    }
                }
        ...
        static {
            ...
            SYSTEM = (System) doPrivileged(JavaDispatcher.m5432of(System.class));
        ...
        */
        public boolean equals(@MaybeNull Object obj) {
            ...
            if (this.forbidExisting != usingReflection.forbidExisting || !this.classLoader.equals(usingReflection.classLoader)) {
                return false;
            }
            ProtectionDomain protectionDomain = this.protectionDomain;
            ...
            if (protectionDomain2 != null) {
                ...
                return this.packageDefinitionStrategy.equals(usingReflection.packageDefinitionStrategy);
            }
        }

        public int hashCode() {
            int iHashCode = ((getClass().hashCode() * 31) + this.classLoader.hashCode()) * 31;
            ProtectionDomain protectionDomain = this.protectionDomain;
            if (protectionDomain != null) {
        ...
        */
        public Map<String, Class<?>> injectRaw(Map<? extends String, byte[]> map) {
            ...
            String str;
            Dispatcher dispatcherInitialize = DISPATCHER.initialize();
            HashMap map4 = new HashMap();
            Iterator<Map.Entry<? extends String, byte[]>> it2 = map.entrySet().iterator();
            while (it2.hasNext()) {
                Map.Entry<? extends String, byte[]> next = it2.next();
                synchronized (dispatcherInitialize.getClassLoadingLock(this.classLoader, next.getKey())) {
                    Class<?> clsFindClass = dispatcherInitialize.findClass(this.classLoader, next.getKey());
                    if (clsFindClass == null) {
                        int iLastIndexOf = next.getKey().lastIndexOf(46);
                        if (iLastIndexOf != -1) {
                            String strSubstring = next.getKey().substring(0, iLastIndexOf);
                            PackageDefinitionStrategy.Definition definitionDefine = this.packageDefinitionStrategy.define(this.classLoader, strSubstring, next.getKey());
                            if (definitionDefine.isDefined()) {
                                Package definedPackage = dispatcherInitialize.getDefinedPackage(this.classLoader, strSubstring);
                                if (definedPackage == null) {
                                    try {
                                        it = it2;
                                        definition = definitionDefine;
                                        map2 = map4;
                                        str = strSubstring;
                                        try {
                                            dispatcherInitialize.definePackage(this.classLoader, strSubstring, definitionDefine.getSpecificationTitle(), definitionDefine.getSpecificationVersion(), definitionDefine.getSpecificationVendor(), definitionDefine.getImplementationTitle(), definitionDefine.getImplementationVersion(), definitionDefine.getImplementationVendor(), definitionDefine.getSealBase());
                                        } catch (IllegalStateException e) {
                                            e = e;
                                            Package r2 = dispatcherInitialize.getPackage(this.classLoader, str);
                                            if (r2 == null) {
                                                throw e;
                                            }
                                    ...
                                    map2 = map4;
                                    it = it2;
                                    if (!definitionDefine.isCompatibleTo(definedPackage)) {
                                        throw new SecurityException("Sealing violation for package " + strSubstring);
                                    }
                                }
                            } else {
                                map2 = map4;
                            ...
                            clsFindClass = dispatcherInitialize.defineClass(this.classLoader, next.getKey(), next.getValue(), this.protectionDomain);
                        }
                    } else {
                        map2 = map4;
                        it = it2;
                        if (this.forbidExisting) {
                            throw new IllegalStateException("Cannot inject already loaded type: " + clsFindClass);
                        }
                    }
                    map3 = map2;
                    map3.put(next.getKey(), clsFindClass);
                }
                it2 = it;
                map4 = map3;
            }
    ...
    public static class UsingUnsafe extends AbstractBase {
            ...
            public static Factory resolve(Instrumentation instrumentation, boolean z) {
                ...
                try {
                    ...
                    if (z) {
                        ...
                        UsingInstrumentation.redefineModule(instrumentation, javaModuleOfType, Collections.singleton(javaModuleOfType2), Collections.emptyMap(), Collections.singletonMap(forLoadedPackage.getName(), Collections.singleton(javaModuleOfType2)), Collections.emptySet(), Collections.emptyMap());
                        return new Factory();
                    }
                    ...
                    UsingInstrumentation.redefineModule(instrumentation, javaModuleOfType, Collections.singleton(javaModuleOfType3), Collections.emptyMap(), Collections.singletonMap(forLoadedPackage.getName(), Collections.singleton(javaModuleOfType3)), Collections.emptySet(), Collections.emptyMap());
                    return new Factory((AccessResolver) loaded.getConstructor(null).newInstance(null));
                } catch (Exception e) {
        ...
        */
        public boolean equals(@MaybeNull Object obj) {
            ...
            if (classLoader2 != null) {
                ...
                if (protectionDomain2 != null) {
                    ...
                    return this.dispatcher.equals(usingUnsafe.dispatcher);
                }
            }
        }
        ...
        public int hashCode() {
            ...
            return (iHashCode2 * 31) + this.dispatcher.hashCode();
        }
