...
public interface MethodRebaseResolver {
            ...
            for (MethodDescription.InDefinedShape inDefinedShape : typeDescription.getDeclaredMethods()) {
                if (set.contains(inDefinedShape.asSignatureToken())) {
                    if (inDefinedShape.isConstructor()) {
                        ...
                        resolutionM5293of = Resolution.ForRebasedConstructor.m5292of(inDefinedShape, dynamicTypeMake.getTypeDescription());
                    } else {
                        resolutionM5293of = Resolution.ForRebasedMethod.m5293of(typeDescription, inDefinedShape, methodNameTransformer);
                    }
                    map.put(inDefinedShape, resolutionM5293of);
                }
            }
            return dynamicTypeMake == null ? new Default(map, Collections.emptyList()) : new Default(map, Collections.singletonList(dynamicTypeMake));
        }
    ...
    public interface Resolution {
        ...
        public static class ForRebasedConstructor implements Resolution {
            ...
            public static class RebasedConstructor extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
                    return new ParameterList.Explicit.ForTypes(this, (List<? extends TypeDefinition>) CompoundList.m5413of(this.methodDescription.getParameters().asTypeList().asErasures(), this.placeholderType));
                }
            ...
            public static Resolution m5292of(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription) {
        ...
        public static class ForRebasedMethod implements Resolution {
            ...
            /* JADX INFO: renamed from: of */
            public static Resolution m5293of(TypeDescription typeDescription, MethodDescription.InDefinedShape inDefinedShape, MethodNameTransformer methodNameTransformer) {
