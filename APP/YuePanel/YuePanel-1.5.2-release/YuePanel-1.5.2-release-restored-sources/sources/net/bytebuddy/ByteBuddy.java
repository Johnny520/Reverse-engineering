...
public class ByteBuddy {
    ...
    public static class EnumerationImplementation implements Implementation {
        ...
        public static class InitializationAppender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                for (String str : this.values) {
                    ...
                    StackManipulation.Compound compound = new StackManipulation.Compound(stackManipulation, TypeCreation.m5375of(typeDescriptionAsErasure), Duplication.SINGLE, new TextConstant(str), IntegerConstant.forValue(i), MethodInvocation.invoke(methodDescription2), FieldAccess.forField(fieldDescription).write());
        ...
        public static class ValuesMethodAppender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                return new ByteCodeAppender.Size(new StackManipulation.Compound(FieldAccess.forField(fieldDescription).read(), MethodInvocation.invoke((MethodDescription) TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class).getDeclaredMethods().filter(ElementMatchers.named(EnumerationImplementation.CLONE_METHOD_NAME)).getOnly()).virtual(fieldDescription.getType().asErasure()), TypeCasting.m5378to(fieldDescription.getType().asErasure()), MethodReturn.REFERENCE).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
            }
        ...
        public InstrumentedType prepare(InstrumentedType instrumentedType) {
            ...
            return instrumentedType.withField(new FieldDescription.Token(ENUM_VALUES, 4121, TypeDescription.ArrayProjection.m5236of(TargetType.DESCRIPTION).asGenericType())).withInitializer(new InitializationAppender(this.values));
        }
    }
    ...
    public enum RecordConstructorStrategy implements ConstructorStrategy, Implementation {
        ...
        public static class Appender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                for (RecordComponentDescription.InDefinedShape inDefinedShape : this.instrumentedType.getRecordComponents()) {
                    arrayList.add(MethodVariableAccess.loadThis());
                    arrayList.add(MethodVariableAccess.m5387of(inDefinedShape.getType()).loadFrom(size));
        ...
        public List<MethodDescription.Token> extractConstructors(TypeDescription typeDescription) {
            ...
            return Collections.singletonList(new MethodDescription.Token(MethodDescription.CONSTRUCTOR_INTERNAL_NAME, 1, Collections.emptyList(), TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Void.TYPE), arrayList, Collections.emptyList(), Collections.emptyList(), AnnotationValue.UNDEFINED, TypeDescription.Generic.UNDEFINED));
        }
    ...
    public static final class RecordObjectMethod implements Implementation {
        ...
        private RecordObjectMethod(String str, int i, String str2, StackManipulation stackManipulation, Class cls, Class... clsArr) {
            ...
            this.returnType = TypeDescription.ForLoadedType.m5238of(cls);
        ...
        public ByteCodeAppender appender(Implementation.Target target) {
            ...
            return new ByteCodeAppender.Simple(MethodVariableAccess.loadThis(), this.stackManipulation, MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.Latent(JavaType.OBJECT_METHODS.getTypeStub(), new MethodDescription.Token("bootstrap", 9, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class), Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub().asGenericType(), TypeDescription.ForLoadedType.m5238of(String.class).asGenericType(), JavaType.TYPE_DESCRIPTOR.getTypeStub().asGenericType(), TypeDescription.ForLoadedType.m5238of(Class.class).asGenericType(), TypeDescription.ForLoadedType.m5238of(String.class).asGenericType(), TypeDescription.ArrayProjection.m5236of(JavaType.METHOD_HANDLE.getTypeStub()).asGenericType())))).dynamic(this.name, this.returnType, CompoundList.m5412of(target.getInstrumentedType(), this.arguments), CompoundList.m5414of(Arrays.asList(JavaConstant.Simple.m5427of(target.getInstrumentedType()), JavaConstant.Simple.ofLoaded(sb.toString())), (List) arrayList)), MethodReturn.m5386of(this.returnType));
        }
    ...
    public <T> DynamicType.Builder<T> decorate(Class<T> cls) {
        return decorate(cls, ClassFileLocator.ForClassLoader.m5258of(cls.getClassLoader()));
    }
    ...
    public DynamicType.Builder<? extends Annotation> makeAnnotation() {
        return new SubclassDynamicTypeBuilder(this.instrumentedTypeFactory.subclass(this.namingStrategy.subclass(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Annotation.class)), ModifierContributor.Resolver.m5234of(Visibility.PUBLIC, TypeManifestation.ANNOTATION).resolve(), TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class)).withInterfaces((TypeList.Generic) new TypeList.Generic.Explicit(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Annotation.class))), this.classFileVersion, this.auxiliaryTypeNamingStrategy, this.annotationValueFilterFactory, this.annotationRetention, this.implementationContextFactory, this.methodGraphCompiler, this.typeValidation, this.visibilityBridgeStrategy, this.classWriterStrategy, this.ignoredMethods, ConstructorStrategy.Default.NO_CONSTRUCTORS);
    }
    ...
    public DynamicType.Builder<?> makePackage(String str) {
        return new SubclassDynamicTypeBuilder(this.instrumentedTypeFactory.subclass(str + "." + PackageDescription.PACKAGE_CLASS_NAME, PackageDescription.PACKAGE_MODIFIERS, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class)), this.classFileVersion, this.auxiliaryTypeNamingStrategy, this.annotationValueFilterFactory, this.annotationRetention, this.implementationContextFactory, this.methodGraphCompiler, this.typeValidation, this.visibilityBridgeStrategy, this.classWriterStrategy, this.ignoredMethods, ConstructorStrategy.Default.NO_CONSTRUCTORS);
    }

    public DynamicType.Builder<?> makeRecord() {
        TypeDescription.Generic genericAsGenericType = InstrumentedType.Default.m5277of(JavaType.RECORD.getTypeStub().getName(), TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class), Visibility.PUBLIC).withMethod(new MethodDescription.Token(4)).withMethod(new MethodDescription.Token("hashCode", C5445.f13378, TypeDescription.ForLoadedType.m5238of(Integer.TYPE).asGenericType())).withMethod(new MethodDescription.Token("equals", C5445.f13378, TypeDescription.ForLoadedType.m5238of(Boolean.TYPE).asGenericType(), Collections.singletonList(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class)))).withMethod(new MethodDescription.Token("toString", C5445.f13378, TypeDescription.ForLoadedType.m5238of(String.class).asGenericType())).asGenericType();
    ...
    public <T> DynamicType.Builder<T> rebase(Class<T> cls) {
        return rebase(cls, ClassFileLocator.ForClassLoader.m5258of(cls.getClassLoader()));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public <T> DynamicType.Builder<T> redefine(Class<T> cls) {
        return redefine(cls, ClassFileLocator.ForClassLoader.m5258of(cls.getClassLoader()));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public <T> DynamicType.Builder<T> subclass(Class<T> cls) {
        return (DynamicType.Builder<T>) subclass(TypeDescription.ForLoadedType.m5238of(cls));
    }
    ...
    public ByteBuddy(ClassFileVersion classFileVersion) {
        ...
        this(classFileVersion, suffixingRandom, suffixingRandom2, r6, annotationRetention, factory == null ? Implementation.Context.Default.Factory.INSTANCE : factory, MethodGraph.Compiler.DEFAULT, InstrumentedType.Factory.Default.MODIFIABLE, TypeValidation.ENABLED, VisibilityBridgeStrategy.Default.ALWAYS, ClassWriterStrategy.Default.CONSTANT_POOL_RETAINING, new LatentMatcher.Resolved(ElementMatchers.isSynthetic().mo5389or(ElementMatchers.isDefaultFinalizer())));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public <T> DynamicType.Builder<T> decorate(Class<T> cls, ClassFileLocator classFileLocator) {
        return decorate(TypeDescription.ForLoadedType.m5238of(cls), classFileLocator);
    }
    ...
    public <T> DynamicType.Builder<T> rebase(Class<T> cls, ClassFileLocator classFileLocator) {
        return rebase(TypeDescription.ForLoadedType.m5238of(cls), classFileLocator);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public <T> DynamicType.Builder<T> redefine(Class<T> cls, ClassFileLocator classFileLocator) {
        return redefine(TypeDescription.ForLoadedType.m5238of(cls), classFileLocator);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public <T> DynamicType.Builder<T> subclass(Class<T> cls, ConstructorStrategy constructorStrategy) {
        return (DynamicType.Builder<T>) subclass(TypeDescription.ForLoadedType.m5238of(cls), constructorStrategy);
    }
    ...
    public <T> DynamicType.Builder<T> rebase(Class<T> cls, ClassFileLocator classFileLocator, MethodNameTransformer methodNameTransformer) {
        return rebase(TypeDescription.ForLoadedType.m5238of(cls), classFileLocator, methodNameTransformer);
    }
    ...
    /* JADX DEBUG: Type inference failed for r4v2. Raw type applied. Possible types: net.bytebuddy.dynamic.DynamicType$Builder<V>, net.bytebuddy.dynamic.DynamicType$Builder<?> */
    ...
    public DynamicType.Builder<?> subclass(TypeDefinition typeDefinition, ConstructorStrategy constructorStrategy) {
        ...
        if (!typeDefinition.isPrimitive() && !typeDefinition.isArray() && !typeDefinition.isFinal()) {
            if (typeDefinition.isInterface()) {
                genericAsGenericType = TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class);
