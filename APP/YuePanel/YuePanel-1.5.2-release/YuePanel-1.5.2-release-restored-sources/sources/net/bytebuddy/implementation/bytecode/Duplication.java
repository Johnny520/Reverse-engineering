...
public abstract class Duplication implements StackManipulation {
    ...
    public static /* synthetic */ class C28834 {
    ...
    static {
        ...
        Duplication duplication2 = new Duplication("SINGLE", 1, StackSize.SINGLE, 89) { // from class: net.bytebuddy.implementation.bytecode.Duplication.2
            @Override // net.bytebuddy.implementation.bytecode.Duplication
            public StackManipulation flipOver(TypeDefinition typeDefinition) {
                int i2 = C28834.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
                if (i2 == 1) {
    ...
    public static Duplication m5369of(TypeDefinition typeDefinition) {
        int i = C28834.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
        if (i == 1) {
            return SINGLE;
        }
        if (i == 2) {
