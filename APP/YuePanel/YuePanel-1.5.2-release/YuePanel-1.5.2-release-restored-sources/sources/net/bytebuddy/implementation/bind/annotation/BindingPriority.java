...
public @interface BindingPriority {
    ...
    public enum Resolver implements MethodDelegationBinder.AmbiguityResolver {
        ...
        private static final MethodDescription.InDefinedShape VALUE = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(BindingPriority.class).getDeclaredMethods().filter(ElementMatchers.named("value")).getOnly();
