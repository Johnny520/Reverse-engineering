...
public @interface Morph {
    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Morph> {
            ...
            public static class MethodCall implements Implementation {
                ...
                public class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                        ...
                        int i = 0;
                        while (it.hasNext()) {
                            stackManipulationArr[i] = new StackManipulation.Compound(stackManipulationLoadFrom, IntegerConstant.forValue(i), ArrayAccess.REFERENCE.load(), MethodCall.this.assigner.assign(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class), it.next(), Assigner.Typing.DYNAMIC));
                            i++;
                        }
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m5238of(Morph.class).getDeclaredMethods();
