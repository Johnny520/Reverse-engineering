...
public class EqualsMethod implements Implementation {
    private static final MethodDescription.InDefinedShape EQUALS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Object.class).getDeclaredMethods().filter(ElementMatchers.isEquals()).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                arrayList.add(TypeCasting.m5378to(this.instrumentedType));
                arrayList.add(FieldAccess.forField(inDefinedShape).read());
                ...
                arrayList.add(ValueComparator.m5296of(inDefinedShape.getType()));
    ...
    public static class ConditionalReturn extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            context.getFrameGeneration().same(methodVisitor, Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m5238of(Object.class)));
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public class AfterInstruction extends StackManipulation.AbstractBase {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    context.getFrameGeneration().same1(methodVisitor, TypeDescription.ForLoadedType.m5238of(Object.class), Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m5238of(Object.class)));
    ...
    public enum TypeCompatibilityCheck {
        ...
        SUBCLASS { // from class: net.bytebuddy.implementation.EqualsMethod.TypeCompatibilityCheck.2
            @Override // net.bytebuddy.implementation.EqualsMethod.TypeCompatibilityCheck
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(MethodVariableAccess.REFERENCE.loadFrom(1), InstanceCheck.m5377of(typeDescription), ConditionalReturn.onZeroInteger());
            }
        };

        protected static final MethodDescription.InDefinedShape GET_CLASS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Object.class).getDeclaredMethods().filter(ElementMatchers.named("getClass")).getOnly();
    ...
    public enum ValueComparator implements StackManipulation {
        ...
        public static StackManipulation m5296of(TypeDefinition typeDefinition) {
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (!target.getInstrumentedType().isInterface()) {
            ArrayList arrayList = new ArrayList(target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo5389or(this.ignored))));
    ...
    public EqualsMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored.mo5389or(elementMatcher), this.nonNullable, this.comparator);
    }

    public EqualsMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable.mo5389or(elementMatcher), this.comparator);
    }
