    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<DefaultMethod> {
        ...
        public static class DelegationMethod implements StackManipulation {
            ...
            public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                StackManipulation stackManipulationOfPrivileged = this.privileged ? MethodConstant.ofPrivileged(context.registerAccessorFor(this.specialMethodInvocation, MethodAccessorFactory.AccessType.PUBLIC)) : MethodConstant.m5382of(context.registerAccessorFor(this.specialMethodInvocation, MethodAccessorFactory.AccessType.PUBLIC));
                if (this.cached) {
                    stackManipulationOfPrivileged = FieldAccess.forField(context.cache(stackManipulationOfPrivileged, TypeDescription.ForLoadedType.m5238of(Method.class))).read();
                }
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m5238of(DefaultMethod.class).getDeclaredMethods();
