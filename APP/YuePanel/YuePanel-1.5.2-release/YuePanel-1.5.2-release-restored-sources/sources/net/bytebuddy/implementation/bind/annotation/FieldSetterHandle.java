...
public @interface FieldSetterHandle {
    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldSetterHandle> {
        ...
        /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: java.lang.Class<T extends java.lang.annotation.Annotation>, java.lang.Class<net.bytebuddy.implementation.bind.annotation.FieldSetterHandle> */
        @Override // net.bytebuddy.implementation.bind.annotation.TargetMethodAnnotationDrivenBinder.ParameterBinder
        public Class<FieldSetterHandle> getHandledType() {
