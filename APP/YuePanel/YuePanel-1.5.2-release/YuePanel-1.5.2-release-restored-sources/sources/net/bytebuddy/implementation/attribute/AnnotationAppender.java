...
public interface AnnotationAppender {
    ...
    /* JADX INFO: renamed from: net.bytebuddy.implementation.attribute.AnnotationAppender$1 */
    ...
    public static class ForTypeAnnotations implements TypeDescription.Generic.Visitor<AnnotationAppender> {
        ...
        public AnnotationAppender onNonGenericType(TypeDescription.Generic generic) {
            ...
            return (AnnotationAppender) componentType.accept(new ForTypeAnnotations(annotationAppenderApply, this.annotationValueFilter, this.typeReference, this.typePath + '['));
        }
        ...
        public AnnotationAppender onWildcard(TypeDescription.Generic generic) {
            ...
            return (AnnotationAppender) (lowerBounds.isEmpty() ? generic.getUpperBounds().getOnly() : lowerBounds.getOnly()).accept(new ForTypeAnnotations(apply(generic, this.typePath), this.annotationValueFilter, this.typeReference, this.typePath + '*'));
        }
    }
    ...
    public static class Default implements AnnotationAppender {
        ...
        public AnnotationAppender append(AnnotationDescription annotationDescription, AnnotationValueFilter annotationValueFilter) {
            int i = C28591.$SwitchMap$java$lang$annotation$RetentionPolicy[annotationDescription.getRetention().ordinal()];
            if (i == 1) {
        ...
        public AnnotationAppender append(AnnotationDescription annotationDescription, AnnotationValueFilter annotationValueFilter, int i, String str) {
            int i2 = C28591.$SwitchMap$java$lang$annotation$RetentionPolicy[annotationDescription.getRetention().ordinal()];
            if (i2 == 1) {
