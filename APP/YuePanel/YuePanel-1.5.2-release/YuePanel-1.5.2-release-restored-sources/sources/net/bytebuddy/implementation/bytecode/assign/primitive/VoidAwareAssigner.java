...
public class VoidAwareAssigner implements Assigner {
    ...
    public StackManipulation assign(TypeDescription.Generic generic, TypeDescription.Generic generic2, Assigner.Typing typing) {
        Class cls = Void.TYPE;
        return (generic.represents(cls) && generic2.represents(cls)) ? StackManipulation.Trivial.INSTANCE : generic.represents(cls) ? typing.isDynamic() ? DefaultValue.m5381of(generic2) : StackManipulation.Illegal.INSTANCE : generic2.represents(cls) ? Removal.m5370of(generic) : this.chained.assign(generic, generic2, typing);
    }
