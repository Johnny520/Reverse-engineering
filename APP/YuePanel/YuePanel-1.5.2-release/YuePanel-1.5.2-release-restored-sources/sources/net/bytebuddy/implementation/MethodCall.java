...
public class MethodCall implements Implementation.Composable {
    ...
    public interface ArgumentLoader {
        ...
        public static class ForInstance implements ArgumentLoader, ArgumentProvider {
            ...
            public static class Factory implements Factory {
                ...
                @Override // net.bytebuddy.dynamic.scaffold.InstrumentedType.Prepareable
                public InstrumentedType prepare(InstrumentedType instrumentedType) {
                    return instrumentedType.withAuxiliaryField(new FieldDescription.Token(this.name, 4105, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(this.value.getClass())), this.value);
                }
            }
        ...
        public static class ForInstrumentedType implements ArgumentLoader, ArgumentProvider {
            ...
            @Override // net.bytebuddy.implementation.MethodCall.ArgumentLoader
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                StackManipulation.Compound compound = new StackManipulation.Compound(ClassConstant.m5380of(this.instrumentedType), assigner.assign(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Class.class), parameterDescription.getType(), typing));
                if (compound.isValid()) {
                    return compound;
                }
        ...
        public static class ForMethodParameterArray implements ArgumentLoader {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                if (parameterDescription.getType().represents(Object.class)) {
                    componentType = TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class);
                } else {
        ...
        public static class ForMethodParameterArrayElement implements ArgumentLoader {
            ...
            @SuppressFBWarnings(justification = "Assuming component type for array type.", value = {"NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE"})
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                StackManipulation.Compound compound = new StackManipulation.Compound(MethodVariableAccess.load(this.parameterDescription), IntegerConstant.forValue(this.index), ArrayAccess.m5379of(this.parameterDescription.getType().getComponentType()).load(), assigner.assign(this.parameterDescription.getType().getComponentType(), parameterDescription.getType(), typing));
                if (compound.isValid()) {
                    return compound;
                }
        ...
        public static class ForStackManipulation implements ArgumentLoader, ArgumentProvider, Factory {
            ...
            public static Factory m5318of(@MaybeNull Object obj) {
                if (obj == null) {
    ...
    public interface MethodLocator {
        ...
        public static class ForElementMatcher implements MethodLocator {
            ...
            public MethodDescription resolve(TypeDescription typeDescription, MethodDescription methodDescription) {
                ...
                List listM5415of = CompoundList.m5415of(superClass == null ? Collections.emptyList() : superClass.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(this.matcher)), this.instrumentedType.getDeclaredMethods().filter(ElementMatchers.not(ElementMatchers.isVirtual()).and(this.matcher)), this.methodGraphCompiler.compile((TypeDefinition) typeDescription, this.instrumentedType).listNodes().asMethodList().filter(this.matcher));
                if (listM5415of.size() == 1) {
                    return (MethodDescription) listM5415of.get(0);
                }
                throw new IllegalStateException(this.instrumentedType + " does not define exactly one virtual method or constructor for " + this.matcher + " but contained " + listM5415of.size() + " candidates: " + listM5415of);
            }
        }
    ...
    public interface TargetHandler {
        ...
        public static class ForConstructingInvocation implements TargetHandler, Resolved {
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                return new StackManipulation.Compound(TypeCreation.m5375of(methodDescription.getDeclaringType().asErasure()), Duplication.SINGLE);
            }
        }
        ...
        public enum Simple implements TerminationHandler, Factory {
            RETURNING { // from class: net.bytebuddy.implementation.MethodCall.TerminationHandler.Simple.1
                ...
                public StackManipulation toStackManipulation(MethodDescription methodDescription, MethodDescription methodDescription2, Assigner assigner, Assigner.Typing typing) {
                    ...
                    if (stackManipulationAssign.isValid()) {
                        return new StackManipulation.Compound(stackManipulationAssign, MethodReturn.m5386of(methodDescription2.getReturnType()));
                    }
            ...
            DROPPING { // from class: net.bytebuddy.implementation.MethodCall.TerminationHandler.Simple.2
                @Override // net.bytebuddy.implementation.MethodCall.TerminationHandler
                public StackManipulation toStackManipulation(MethodDescription methodDescription, MethodDescription methodDescription2, Assigner assigner, Assigner.Typing typing) {
                    return Removal.m5370of(methodDescription.isConstructor() ? methodDescription.getDeclaringType() : methodDescription.getReturnType());
                }
            },
    ...
    public static class WithoutSpecifiedTarget extends MethodCall {
        ...
        public MethodCall m5319on(Object obj) {
            return m5320on(obj, (Class<? super Object>) obj.getClass());
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: on */
        public <T> MethodCall m5320on(T t, Class<? super T> cls) {
            return new MethodCall(this.methodLocator, new TargetHandler.ForValue.Factory(t, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(cls)), this.argumentLoaders, new MethodInvoker.ForVirtualInvocation.Factory(TypeDescription.ForLoadedType.m5238of(cls)), this.terminationHandler, this.assigner, this.typing);
        }
        ...
        /* JADX INFO: renamed from: on */
        public MethodCall m5321on(StackManipulation stackManipulation, Class<?> cls) {
            return m5322on(stackManipulation, TypeDescription.ForLoadedType.m5238of(cls));
        }

        /* JADX INFO: renamed from: on */
        public MethodCall m5322on(StackManipulation stackManipulation, TypeDescription typeDescription) {
    ...
    public static Implementation.Composable call(Callable<?> callable) {
        try {
            return invoke(Callable.class.getMethod(C6411.f16272, null)).m5320on(callable, (Class<? super Callable<?>>) Callable.class).withAssigner(Assigner.DEFAULT, Assigner.Typing.DYNAMIC);
    ...
    public static Implementation.Composable run(Runnable runnable) {
        try {
            return invoke(Runnable.class.getMethod("run", null)).m5320on(runnable, (Class<? super Runnable>) Runnable.class).withAssigner(Assigner.DEFAULT, Assigner.Typing.DYNAMIC);
        } catch (NoSuchMethodException e) {
    ...
    public MethodCall with(Object... objArr) {
        ...
        for (Object obj : objArr) {
            arrayList.add(ArgumentLoader.ForStackManipulation.m5318of(obj));
        }
    ...
    public MethodCall with(TypeDescription... typeDescriptionArr) {
        ...
        for (TypeDescription typeDescription : typeDescriptionArr) {
            arrayList.add(new ArgumentLoader.ForStackManipulation(ClassConstant.m5380of(typeDescription), Class.class));
        }
        return with(arrayList);
    }
    ...
    public MethodCall with(List<? extends ArgumentLoader.Factory> list) {
        return new MethodCall(this.methodLocator, this.targetHandler, CompoundList.m5414of((List) this.argumentLoaders, (List) list), this.methodInvoker, this.terminationHandler, this.assigner, this.typing);
    }
}
