...
public class JavaConstantValue extends StackManipulation.AbstractBase {
    ...
    public enum Visitor implements JavaConstant.Visitor<Object> {
        ...
        /* JADX DEBUG: Return type fixed from 'net.bytebuddy.jar.asm.ConstantDynamic' to match base method */
        @Override // net.bytebuddy.utility.JavaConstant.Visitor
        ...
        /* JADX DEBUG: Return type fixed from 'net.bytebuddy.jar.asm.Handle' to match base method */
        @Override // net.bytebuddy.utility.JavaConstant.Visitor
        ...
        /* JADX DEBUG: Return type fixed from 'net.bytebuddy.jar.asm.Type' to match base method */
        @Override // net.bytebuddy.utility.JavaConstant.Visitor
