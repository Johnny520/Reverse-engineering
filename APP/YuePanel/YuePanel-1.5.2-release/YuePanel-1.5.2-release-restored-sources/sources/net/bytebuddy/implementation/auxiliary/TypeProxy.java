...
public class TypeProxy implements AuxiliaryType {
    ...
    public enum AbstractMethodErrorThrow implements StackManipulation {
        ...
        AbstractMethodErrorThrow() {
            TypeDescription typeDescriptionM5238of = TypeDescription.ForLoadedType.m5238of(AbstractMethodError.class);
            this.implementation = new StackManipulation.Compound(TypeCreation.m5375of(typeDescriptionM5238of), Duplication.SINGLE, MethodInvocation.invoke((MethodDescription) typeDescriptionM5238of.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments(0))).getOnly()), Throw.INSTANCE);
        }
    ...
    public static class ForDefaultMethod extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            StackManipulation stackManipulationM5375of = TypeCreation.m5375of(typeDescriptionRegister);
            ...
            return new StackManipulation.Compound(stackManipulationM5375of, duplication, withImplicitInvocationTargetTypeInvoke, duplication, stackManipulationLoadThis, stackManipulationWrite).apply(methodVisitor, context);
        }
    ...
    public static class ForSuperMethodByConstructor extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            int i = 0;
            while (it.hasNext()) {
                stackManipulationArr[i] = DefaultValue.m5381of(it.next());
                i++;
            }
            StackManipulation stackManipulationM5375of = TypeCreation.m5375of(typeDescriptionRegister);
            ...
            StackManipulation stackManipulationWrite = FieldAccess.forField((FieldDescription.InDefinedShape) typeDescriptionRegister.getDeclaredFields().filter(ElementMatchers.named("target")).getOnly()).write();
            Duplication duplication = Duplication.SINGLE;
            return new StackManipulation.Compound(stackManipulationM5375of, duplication, compound, withImplicitInvocationTargetTypeInvoke, duplication, stackManipulationLoadThis, stackManipulationWrite).apply(methodVisitor, context);
        }
        ...
        public class Appender implements ByteCodeAppender {
            ...
            public class AccessorMethodInvocation implements StackManipulation {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    return new StackManipulation.Compound(MethodVariableAccess.loadThis(), Appender.this.fieldLoadingInstruction, MethodVariableAccess.allArgumentsOf(this.instrumentedMethod).asBridgeOf(inDefinedShapeRegisterAccessorFor), MethodInvocation.invoke(inDefinedShapeRegisterAccessorFor), MethodReturn.m5386of(this.instrumentedMethod.getReturnType())).apply(methodVisitor, context);
                }
