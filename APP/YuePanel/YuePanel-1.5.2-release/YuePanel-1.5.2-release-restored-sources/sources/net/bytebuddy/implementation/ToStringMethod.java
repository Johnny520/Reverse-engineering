...
public class ToStringMethod implements Implementation {
    private static final MethodDescription.InDefinedShape STRING_BUILDER_CONSTRUCTOR = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(StringBuilder.class).getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments((Class<?>[]) new Class[]{String.class}))).getOnly();
    private static final MethodDescription.InDefinedShape TO_STRING = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(StringBuilder.class).getDeclaredMethods().filter(ElementMatchers.isToString()).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            arrayList.add(TypeCreation.m5375of(TypeDescription.ForLoadedType.m5238of(StringBuilder.class)));
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                arrayList.add(ValueConsumer.m5354of(inDefinedShape.getType().asErasure()));
            }
    ...
    public enum ValueConsumer implements StackManipulation {
        ...
        public static StackManipulation m5354of(TypeDescription typeDescription) {
    ...
    public ToStringMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new ToStringMethod(this.prefixResolver, this.start, this.end, this.separator, this.definer, this.ignored.mo5389or(elementMatcher));
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX DEBUG: Method merged with bridge method: appender(Lnet/bytebuddy/implementation/Implementation$Target;)Lnet/bytebuddy/implementation/bytecode/ByteCodeAppender; */
    ...
    public Appender appender(Implementation.Target target) {
        ...
        if (strResolve != null) {
            return new Appender(strResolve, this.start, this.end, this.separator, this.definer, target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo5389or(this.ignored))));
        }
