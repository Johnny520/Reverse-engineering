...
@InterfaceC7113(29)
public final class C4594 implements InterfaceC4596 {
    ...
    public void mo1552(@InterfaceC6399 C7700 c7700, @InterfaceC6399 C7700 c77002, @InterfaceC6399 Window window, @InterfaceC6399 View view, boolean z, boolean z2) {
        ...
        window.setStatusBarColor(c7700.m24493(z));
        window.setNavigationBarColor(c77002.m24493(z2));
        window.setStatusBarContrastEnforced(false);
        window.setNavigationBarContrastEnforced(c77002.m24491() == 0);
        C8514 c8514 = new C8514(window, view);
        c8514.m28370(!z);
        c8514.m28369(true ^ z2);
    }
}
