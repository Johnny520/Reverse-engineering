...
public class C5703 extends AbstractC4261 {

    /* JADX INFO: renamed from: ۥ۟۟۟ۡ, reason: contains not printable characters */
    public static final String f14084 = "LinearCurveFit";

    /* JADX INFO: renamed from: ۥ۟۟۟, reason: contains not printable characters */
    public double[] f14085;

    /* JADX INFO: renamed from: ۥ۟۟۟۟, reason: contains not printable characters */
    public double[][] f14086;

    /* JADX INFO: renamed from: ۥ۟۟۟۠, reason: contains not printable characters */
    public double f14087;

    public C5703(double[] dArr, double[][] dArr2) {
        this.f14087 = Double.NaN;
    ...
    public double mo6902(double d, int i) {
        double[] dArr = this.f14085;
        int length = dArr.length;
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f14086[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f14086[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f14085;
            double d2 = dArr2[i2];
            if (d == d2) {
                return this.f14086[i2][i];
            }
            int i4 = i2 + 1;
            double d3 = dArr2[i4];
            if (d < d3) {
                double d4 = (d - d2) / (d3 - d2);
                double[][] dArr3 = this.f14086;
    ...
    public void mo6903(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f14086[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f14086[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f14085[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f14086[i4][i5];
                }
            }
            double[] dArr3 = this.f14085;
            int i6 = i4 + 1;
            double d2 = dArr3[i6];
            if (d < d2) {
                double d3 = dArr3[i4];
    ...
    public void mo6904(double d, float[] fArr) {
        ...
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f14086[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f14085[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f14086[i4][i5];
                }
            }
            double[] dArr2 = this.f14085;
            int i6 = i4 + 1;
  ...
  0x000f: PHI (r4v5 double) = (r4v0 double), (r4v2 double) binds: [B:3:0x000d, B:6:0x0017] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final double m17617(double d) {
        if (Double.isNaN(this.f14087)) {
            return 0.0d;
        }
        double[] dArr = this.f14085;
        int length = dArr.length;
