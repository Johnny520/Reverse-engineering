...
import com.android.p001dx.command.UsageException;
...
import com.android.p001dx.merge.CollisionPolicy;
import com.android.p001dx.merge.DexMerger;
import com.android.p001dx.p002cf.code.SimException;
import com.android.p001dx.p002cf.direct.ClassPathOpener;
...
public class Main {
    ...
    private static final String[] JAVAX_CORE = {"accessibility", "crypto", "imageio", "management", "naming", "net", "print", "rmi", "security", "sip", "sound", "sql", "swing", "transaction", C8542.f3549};
    ...
    public class DirectClassFileConsumer implements Callable<Boolean> {
        ...
        public Boolean call(DirectClassFile directClassFile) {
            ...
            if (Main.this.args.multiDex) {
                ...
                int size5 = size3 + directClassFile.getFields().size() + 9;
                synchronized (Main.this.dexRotationLock) {
                    try {
    ...
    private void dumpMethod(DexFile dexFile, String str, OutputStreamWriter outputStreamWriter) {
        boolean zEndsWith = str.endsWith(InterfaceC5949.f14892);
    ...
    private Manifest makeManifest() throws IOException {
        ...
        mainAttributes.put(name, str + "dx 1.16");
    ...
    public boolean processFileBytes(String str, long j, byte[] bArr) {
        ...
        boolean zEquals = str.equals(DexFormat.DEX_IN_JAR_NAME);
    ...
    private int runMonoDex() throws IOException {
        ...
        if (arguments2.jarOutput) {
            ...
            if (bArrMergeLibraryDexBuffers != null) {
                this.outputResources.put(DexFormat.DEX_IN_JAR_NAME, bArrMergeLibraryDexBuffers);
            }
