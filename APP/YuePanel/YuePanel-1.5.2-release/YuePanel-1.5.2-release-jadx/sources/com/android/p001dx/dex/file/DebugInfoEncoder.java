...
public final class DebugInfoEncoder {
    ...
    private void emitHeader(ArrayList<PositionList.Entry> arrayList, ArrayList<LocalList.Entry> arrayList2) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                annotate(this.output.getCursor() - cursor3, "parameter " + ((next == null || next.getSignature() != null) ? "<unnamed>" : next.getName().toHuman()) + " " + RegisterSpec.PREFIX + paramBase);
            }
    ...
    private void emitPosition(PositionList.Entry entry) throws IOException {
        ...
        if ((iComputeOpcode & C5445.f13388) > 0) {
            emitAdvancePc(i2);
