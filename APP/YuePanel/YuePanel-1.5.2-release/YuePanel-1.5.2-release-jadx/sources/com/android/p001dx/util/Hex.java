...
public final class Hex {
    ...
    public static String dump(byte[] bArr, int i, int i2, int i3, int i4, int i5) {
        ...
        if ((i | i2 | i6) < 0 || i6 > bArr.length) {
            throw new IndexOutOfBoundsException("arr.length " + bArr.length + C4219.f748 + i + "..!" + i6);
        }
        if (i3 < 0) {
        ...
        while (i2 > 0) {
            if (i7 == 0) {
                sb.append(i5 != 2 ? i5 != 4 ? i5 != 6 ? m5037u4(i3) : m5036u3(i3) : m5035u2(i3) : m5034u1(i3));
                sb.append(": ");
            } else if ((i7 & 1) == 0) {
                sb.append(' ');
            }
            sb.append(m5034u1(bArr[i]));
            i3++;
            i++;
            i7++;
            if (i7 == i4) {
    ...
    public static String m5030s1(int i) {
    ...
    public static String m5031s2(int i) {
    ...
    public static String m5032s4(int i) {
    ...
    public static String m5033s8(long j) {
    ...
    public static String m5034u1(int i) {
    ...
    public static String m5035u2(int i) {
    ...
    public static String u2or4(int i) {
        return i == ((char) i) ? m5035u2(i) : m5037u4(i);
    }

    /* JADX INFO: renamed from: u3 */
    public static String m5036u3(int i) {
    ...
    public static String m5037u4(int i) {
    ...
    public static String m5038u8(long j) {
