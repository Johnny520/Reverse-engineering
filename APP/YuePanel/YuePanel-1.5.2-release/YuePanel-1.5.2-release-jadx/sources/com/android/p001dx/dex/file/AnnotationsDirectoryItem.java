...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            annotatedOutput.annotate(4, "  class_annotations_off: " + Hex.m5037u4(absoluteOffsetOr0));
            annotatedOutput.annotate(4, "  fields_size:           " + Hex.m5037u4(iListSize));
            annotatedOutput.annotate(4, "  methods_size:          " + Hex.m5037u4(iListSize2));
            annotatedOutput.annotate(4, "  parameters_size:       " + Hex.m5037u4(iListSize3));
        }
