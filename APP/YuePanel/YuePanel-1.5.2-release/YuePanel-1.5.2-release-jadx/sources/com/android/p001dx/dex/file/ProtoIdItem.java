...
public final class ProtoIdItem extends IndexedItem {
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            annotatedOutput.annotate(4, "  shorty_idx:      " + Hex.m5037u4(iIndexOf) + " // " + this.shortForm.toQuoted());
            annotatedOutput.annotate(4, "  return_type_idx: " + Hex.m5037u4(iIndexOf2) + " // " + this.prototype.getReturnType().toHuman());
            StringBuilder sb2 = new StringBuilder();
            sb2.append("  parameters_off:  ");
            sb2.append(Hex.m5037u4(absoluteOffsetOr0));
