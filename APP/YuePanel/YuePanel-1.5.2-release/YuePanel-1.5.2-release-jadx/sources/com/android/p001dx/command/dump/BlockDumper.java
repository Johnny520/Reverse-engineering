package com.android.p001dx.command.dump;

import com.android.p001dx.p002cf.code.BasicBlocker;
import com.android.p001dx.p002cf.code.ByteBlock;
import com.android.p001dx.p002cf.code.ByteBlockList;
...
import com.android.p001dx.p002cf.direct.CodeObserver;
...
public class BlockDumper extends BaseDumper {
    ...
    private void regularDump(ConcreteMethod concreteMethod) {
        ...
        while (i < size) {
            ...
            if (i2 < start) {
                parsed(bytes, i2, start - i2, "dead code " + Hex.m5035u2(i2) + ".." + Hex.m5035u2(start));
            }
            parsed(bytes, start, 0, "block " + Hex.m5035u2(byteBlock.getLabel()) + ": " + Hex.m5035u2(start) + ".." + Hex.m5035u2(end));
            changeIndent(1);
            while (start < end) {
            ...
            if (size2 == 0) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    parsed(bytes, end, 0, "next " + Hex.m5035u2(successors.get(i3)));
                }
            }
            ...
            for (int i4 = 0; i4 < size3; i4++) {
                ...
                sb.append(" -> ");
                sb.append(Hex.m5035u2(item.getHandlerPc()));
        ...
        if (i2 < size4) {
            parsed(bytes, i2, size4 - i2, "dead code " + Hex.m5035u2(i2) + ".." + Hex.m5035u2(size4));
        }
        this.suppressDump = true;
    }
    ...
    @Override // com.android.p001dx.command.dump.BaseDumper, com.android.p001dx.p002cf.iface.ParseObserver
