...
import com.android.p001dx.p002cf.attrib.InnerClassList;
import com.android.p001dx.p002cf.code.BootstrapMethodArgumentsList;
...
public class StdAttributeFactory extends AttributeFactory {
    ...
    private Attribute bootstrapMethods(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "num_boostrap_methods: " + Hex.m5035u2(unsignedShort));
        }
    ...
    private Attribute code(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "max_stack: " + Hex.m5035u2(unsignedShort));
            parseObserver.parsed(bytes, i3, 2, "max_locals: " + Hex.m5035u2(unsignedShort2));
            parseObserver.parsed(bytes, i4, 4, "code_length: " + Hex.m5037u4(i5));
        }
        int i6 = i + 8;
        int i7 = i2 - 8;
        if (i7 < i5 + 4) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i8, 2, "exception_table_length: " + Hex.m5035u2(unsignedShort3));
        }
        int i10 = i8 + 2;
        int i11 = i9 - 2;
        ...
        for (int i12 = 0; i12 < unsignedShort3; i12++) {
            ...
            if (parseObserver != null) {
                ...
                sb.append(Hex.m5035u2(unsignedShort4));
                sb.append("..");
                sb.append(Hex.m5035u2(unsignedShort5));
                sb.append(" -> ");
                sb.append(Hex.m5035u2(unsignedShort6));
                sb.append(" ");
        ...
        return endOffset != i11 ? throwBadLength(endOffset + (i10 - i)) : new AttCode(unsignedShort, unsignedShort2, bytecodeArray, byteCatchList, list);
    }
    ...
    private Attribute exceptions(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "number_of_exceptions: " + Hex.m5035u2(unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute innerClasses(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "number_of_classes: " + Hex.m5035u2(unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute lineNumberTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "line_number_table_length: " + Hex.m5035u2(unsignedShort));
        }
        int i3 = i + 2;
        ...
        for (int i5 = 0; i5 < unsignedShort; i5++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(bytes, i3, 4, Hex.m5035u2(unsignedShort2) + " " + unsignedShort3);
            }
            i3 += 4;
        }
    ...
    private Attribute localVariableTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "local_variable_table_length: " + Hex.m5035u2(unsignedShort));
        }
    ...
    private Attribute localVariableTypeTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, "local_variable_type_table_length: " + Hex.m5035u2(unsignedShort));
        }
    ...
    private BootstrapMethodsList parseBootstrapMethods(ByteArray byteArray, ConstantPool constantPool, CstType cstType, int i, int i2, int i3, ParseObserver parseObserver) throws ParseException {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(byteArray, i4, 2, "bootstrap_method_ref: " + Hex.m5035u2(unsignedShort));
                parseObserver.parsed(byteArray, i7, 2, "num_bootstrap_arguments: " + Hex.m5035u2(unsignedShort2));
            }
            i4 += 4;
            i5 -= 4;
            ...
            while (i8 < unsignedShort2) {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i4, 2, "bootstrap_arguments[" + i8 + "]" + Hex.m5035u2(unsignedShort3));
                }
    ...
    private LocalVariableList parseLocalVariables(ByteArray byteArray, ConstantPool constantPool, ParseObserver parseObserver, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            try {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i3 * 10, 10, Hex.m5035u2(unsignedShort) + ".." + Hex.m5035u2(unsignedShort + unsignedShort2) + " " + Hex.m5035u2(unsignedShort5) + " " + cstString3.toHuman() + " " + cstString4.toHuman());
                }
            } catch (IOException e) {
    ...
    private static Attribute throwBadLength(int i) {
        throw new ParseException("bad attribute length; expected length " + Hex.m5037u4(i));
    }
    ...
    @Override // com.android.p001dx.p002cf.direct.AttributeFactory
