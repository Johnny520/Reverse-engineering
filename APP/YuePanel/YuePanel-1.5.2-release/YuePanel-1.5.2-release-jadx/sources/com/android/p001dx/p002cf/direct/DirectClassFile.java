...
import com.android.p001dx.p002cf.cst.ConstantPoolParser;
import com.android.p001dx.p002cf.iface.Attribute;
import com.android.p001dx.p002cf.iface.AttributeList;
import com.android.p001dx.p002cf.iface.ClassFile;
...
import com.android.p001dx.rop.cst.StdConstantPool;
...
public class DirectClassFile implements ClassFile {
    ...
    public static class DcfTypeList implements TypeList {
        ...
        @Override // com.android.p001dx.rop.type.TypeList
    ...
    private void parse0() {
        ...
        if (parseObserver != null) {
            ...
            this.observer.parsed(this.bytes, 0, 4, "magic: " + Hex.m5037u4(getMagic0()));
            this.observer.parsed(this.bytes, 4, 2, "minor_version: " + Hex.m5035u2(getMinorVersion0()));
            this.observer.parsed(this.bytes, 6, 2, "major_version: " + Hex.m5035u2(getMajorVersion0()));
        }
        if (this.strictParse) {
            if (!isGoodMagic(getMagic0())) {
                throw new ParseException("bad class file magic (" + Hex.m5037u4(getMagic0()) + ")");
            }
        ...
        if (parseObserver2 != null) {
            ...
            this.observer.parsed(this.bytes, i3, 2, "interfaces_count: " + Hex.m5035u2(unsignedShort2));
            if (unsignedShort2 != 0) {
        ...
        if (endOffset2 != this.bytes.size()) {
            throw new ParseException("extra bytes at end of class file, at offset " + Hex.m5037u4(endOffset2));
        }
    ...
    @Override // com.android.p001dx.p002cf.iface.ClassFile
    public int getAccessFlags() {
        parseToInterfacesIfNecessary();
        return this.accessFlags;
    }

    @Override // com.android.p001dx.p002cf.iface.ClassFile, com.android.p001dx.p002cf.iface.HasAttribute
