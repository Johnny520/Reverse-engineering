package com.android.p001dx.command;
    ...
    public static void main(String[] strArr) {
        ...
        while (true) {
            try {
                ...
                try {
                    if (str.equals("--dex")) {
                        com.android.p001dx.command.dexer.Main.main(without(strArr, i));
                        break;
                    }
                    if (str.equals("--dump")) {
                        com.android.p001dx.command.dump.Main.main(without(strArr, i));
                        break;
                    }
                    if (str.equals("--annotool")) {
                        com.android.p001dx.command.annotool.Main.main(without(strArr, i));
                        break;
                    }
                    if (str.equals("--find-usages")) {
                        com.android.p001dx.command.findusages.Main.main(without(strArr, i));
                        break;
                    }
