...
import com.android.p001dx.util.TwoColumnOutput;
...
public abstract class DalvInsn {
    ...
    public final String identifierString() {
        int i = this.address;
        return i != -1 ? String.format("%04x", Integer.valueOf(i)) : Hex.m5037u4(System.identityHashCode(this));
    }
    ...
    public final String listingString(String str, int i, boolean z) {
        ...
        return TwoColumnOutput.toString(str2, length, "", strListingString0, i == 0 ? strListingString0.length() : i - length);
    }
