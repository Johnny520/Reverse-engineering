    ...
    */
    private int parseNewarray(int i, Visitor visitor) {
        ...
        switch (unsignedByte) {
            ...
            case 11:
                ...
                break;
            default:
                throw new SimException("bad newarray code " + Hex.m5034u1(unsignedByte));
        }
    ...
    public int parseInstruction(int i, Visitor visitor) {
        ...
        try {
            ...
            e.addContext("...at bytecode offset " + Hex.m5037u4(i));
            throw e;
        } catch (RuntimeException e2) {
            SimException simException = new SimException(e2);
            simException.addContext("...at bytecode offset " + Hex.m5037u4(i));
            throw simException;
        }
    }
