...
public final class ValueEncoder {
    ...
    public void writeAnnotation(Annotation annotation, boolean z) {
        ...
        if (z2) {
            this.out.annotate("  type_idx: " + Hex.m5037u4(iIndexOf) + " // " + type.toHuman());
        }
        ...
        if (z2) {
            this.out.annotate("  size: " + Hex.m5037u4(size));
        }
        ...
        for (NameValuePair nameValuePair : nameValuePairs) {
            ...
            if (z2) {
                ...
                i++;
                this.out.annotate("    name_idx: " + Hex.m5037u4(iIndexOf2) + " // " + name.toHuman());
            }
