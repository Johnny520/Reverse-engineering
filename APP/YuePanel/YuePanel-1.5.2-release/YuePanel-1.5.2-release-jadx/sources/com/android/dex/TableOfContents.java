...
public final class TableOfContents {
    ...
    public TableOfContents() {
        ...
        Section section11 = new Section(AbstractC8885.f29787);
        this.typeLists = section11;
        Section section12 = new Section(C5445.f13379);
        this.annotationSetRefLists = section12;
        Section section13 = new Section(AbstractC8885.f29789);
        ...
        Section section19 = new Section(AbstractC8885.f29791);
    ...
    public void writeHeader(Dex.Section section, int i) throws IOException {
        section.write(DexFormat.apiToMagic(i).getBytes(Key.STRING_CHARSET_NAME));
