...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @InterfaceC6391 V v, int i, int i2, float f) {
        ...
        C8273.m27427(v, flingRunnable);
        return true;
    }

    public int getMaxDragOffset(@InterfaceC6391 V v) {
        return -v.getHeight();
    }

    public int getScrollRangeForDragFling(@InterfaceC6391 V v) {
        return v.getHeight();
    }
    ...
    */
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (iM18838 = C6132.m18838(i, i2, i3))) {
            return 0;
        }
        setTopAndBottomOffset(iM18838);
        return topAndBottomOffset - iM18838;
    }
