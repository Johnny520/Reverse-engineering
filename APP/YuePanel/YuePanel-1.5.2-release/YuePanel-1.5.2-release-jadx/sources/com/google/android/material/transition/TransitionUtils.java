...
class TransitionUtils {
    ...
    public static ShapeAppearanceModel convertToRelativeCornerSizes(ShapeAppearanceModel shapeAppearanceModel, final RectF rectF) {
        return shapeAppearanceModel.withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.transition.ۥ
    ...
    public static void maybeAddTransition(C7991 c7991, @InterfaceC6490 AbstractC7956 abstractC7956) {
        if (abstractC7956 != null) {
            c7991.m25181(abstractC7956);
        }
    }

    public static boolean maybeApplyThemeDuration(AbstractC7956 abstractC7956, Context context, @InterfaceC3451 int i) {
        int iResolveThemeDuration;
        if (i == 0 || abstractC7956.getDuration() != -1 || (iResolveThemeDuration = MotionUtils.resolveThemeDuration(context, i, -1)) == -1) {
            return false;
        }
        abstractC7956.setDuration(iResolveThemeDuration);
        return true;
    }

    public static boolean maybeApplyThemeInterpolator(AbstractC7956 abstractC7956, Context context, @InterfaceC3451 int i, TimeInterpolator timeInterpolator) {
        if (i == 0 || abstractC7956.getInterpolator() != null) {
            return false;
        }
        abstractC7956.setInterpolator(MotionUtils.resolveThemeInterpolator(context, i, timeInterpolator));
        return true;
    }

    public static boolean maybeApplyThemePath(AbstractC7956 abstractC7956, Context context, @InterfaceC3451 int i) {
        AbstractC6623 abstractC6623ResolveThemePath;
        if (i == 0 || (abstractC6623ResolveThemePath = resolveThemePath(context, i)) == null) {
            return false;
        }
        abstractC7956.setPathMotion(abstractC6623ResolveThemePath);
        return true;
    }

    public static void maybeRemoveTransition(C7991 c7991, @InterfaceC6490 AbstractC7956 abstractC7956) {
        if (abstractC7956 != null) {
            c7991.m25192(abstractC7956);
        }
    }

    @InterfaceC6490
    public static AbstractC6623 resolveThemePath(Context context, @InterfaceC3451 int i) {
        ...
        if (i2 != 16) {
            if (i2 == 3) {
                return new C6644(C6625.m21067(String.valueOf(typedValue.string)));
            }
