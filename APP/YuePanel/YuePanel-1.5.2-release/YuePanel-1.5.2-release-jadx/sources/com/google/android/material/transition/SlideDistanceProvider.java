...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i, @InterfaceC6844 int i2) {
    ...
    private static Animator createTranslationDisappearAnimator(View view, View view2, int i, @InterfaceC6844 int i2) {
        float translationX = view2.getTranslationX();
        float translationY = view2.getTranslationY();
        if (i == 3) {
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return i != -1 ? i : context.getResources().getDimensionPixelSize(C1980R.dimen.mtrl_transition_shared_axis_slide_distance);
    }
    ...
    public void setSlideDistance(@InterfaceC6844 int i) {
        if (i < 0) {
