...
public class InterpolateOnScrollPositionChangeHelper {
    ...
    public void startListeningForScrollChanges(@InterfaceC6391 ViewTreeObserver viewTreeObserver) {
        viewTreeObserver.addOnScrollChangedListener(this.scrollChangedListener);
    }

    public void stopListeningForScrollChanges(@InterfaceC6391 ViewTreeObserver viewTreeObserver) {
