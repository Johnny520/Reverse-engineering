...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public interface ShapeProvider {
        @InterfaceC6490
        ShapeAppearanceModel provideShape(@InterfaceC6391 View view);
    }
    ...
    public static class ShapeableViewShapeProvider implements ShapeProvider {
        ...
        @InterfaceC6490
        public ShapeAppearanceModel provideShape(@InterfaceC6391 View view) {
    ...
    public static void removeWindowBackground(Window window) {
        ...
        windowBackground.mutate().setColorFilter(C3540.m615(0, EnumC3541.CLEAR));
    }
    ...
    @InterfaceC6490
    public Parcelable onCaptureSharedElementSnapshot(@InterfaceC6391 View view, @InterfaceC6391 Matrix matrix, @InterfaceC6391 RectF rectF) {
    ...
    @Override // android.app.SharedElementCallback
    @InterfaceC6490
    public View onCreateSnapshotView(@InterfaceC6391 Context context, @InterfaceC6490 Parcelable parcelable) {
        ...
        if (viewOnCreateSnapshotView != null && (weakReference = capturedSharedElement) != null && this.shapeProvider != null && (view = weakReference.get()) != null && (shapeAppearanceModelProvideShape = this.shapeProvider.provideShape(view)) != null) {
            viewOnCreateSnapshotView.setTag(C1980R.id.mtrl_motion_snapshot_view, shapeAppearanceModelProvideShape);
        }
        return viewOnCreateSnapshotView;
    }

    @Override // android.app.SharedElementCallback
    public void onMapSharedElements(@InterfaceC6391 List<String> list, @InterfaceC6391 Map<String, View> map) {
        View view;
        Activity activity;
    ...
    @Override // android.app.SharedElementCallback
    public void onSharedElementEnd(@InterfaceC6391 List<String> list, @InterfaceC6391 List<View> list2, @InterfaceC6391 List<View> list3) {
        if (!list2.isEmpty() && (list2.get(0).getTag(C1980R.id.mtrl_motion_snapshot_view) instanceof View)) {
            list2.get(0).setTag(C1980R.id.mtrl_motion_snapshot_view, null);
        }
    ...
    @Override // android.app.SharedElementCallback
    public void onSharedElementStart(@InterfaceC6391 List<String> list, @InterfaceC6391 List<View> list2, @InterfaceC6391 List<View> list3) {
        if (!list2.isEmpty() && !list3.isEmpty()) {
            list2.get(0).setTag(C1980R.id.mtrl_motion_snapshot_view, list3.get(0));
        }
    ...
    public void setShapeProvider(@InterfaceC6490 ShapeProvider shapeProvider) {
