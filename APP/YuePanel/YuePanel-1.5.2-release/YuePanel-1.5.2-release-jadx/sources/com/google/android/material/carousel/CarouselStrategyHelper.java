...
final class CarouselStrategyHelper {
    ...
    public static KeylineState createCenterAlignedKeylineState(@InterfaceC6391 Context context, float f, float f2, @InterfaceC6391 Arrangement arrangement) {
        float f3;
        float f4;
    ...
    public static KeylineState createKeylineState(@InterfaceC6391 Context context, float f, float f2, @InterfaceC6391 Arrangement arrangement, int i) {
    ...
    public static KeylineState createLeftAlignedKeylineState(@InterfaceC6391 Context context, float f, float f2, @InterfaceC6391 Arrangement arrangement) {
        float fMin = Math.min(getExtraSmallSize(context) + f, arrangement.largeSize);
        float f3 = fMin / 2.0f;
        float f4 = 0.0f - f3;
    ...
    public static float getExtraSmallSize(@InterfaceC6391 Context context) {
        return context.getResources().getDimension(C1980R.dimen.m3_carousel_gone_size);
    }

    public static float getSmallSizeMax(@InterfaceC6391 Context context) {
        return context.getResources().getDimension(C1980R.dimen.m3_carousel_small_item_size_max);
    }

    public static float getSmallSizeMin(@InterfaceC6391 Context context) {
        return context.getResources().getDimension(C1980R.dimen.m3_carousel_small_item_size_min);
    }
