...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    ...
    public KeylineState onFirstChildMeasuredWithMargins(@InterfaceC6391 Carousel carousel, @InterfaceC6391 View view) {
        ...
        float f2 = ((ViewGroup.MarginLayoutParams) c8922).topMargin + ((ViewGroup.MarginLayoutParams) c8922).bottomMargin;
        float measuredHeight = view.getMeasuredHeight();
        if (carousel.isHorizontal()) {
            float f3 = ((ViewGroup.MarginLayoutParams) c8922).leftMargin + ((ViewGroup.MarginLayoutParams) c8922).rightMargin;
