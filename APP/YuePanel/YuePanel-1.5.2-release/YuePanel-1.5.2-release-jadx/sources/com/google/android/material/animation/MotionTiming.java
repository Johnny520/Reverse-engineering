...
public class MotionTiming {
    ...
    @InterfaceC6391
    public static MotionTiming createFromAnimator(@InterfaceC6391 ValueAnimator valueAnimator) {
    ...
    private static TimeInterpolator getInterpolatorCompat(@InterfaceC6391 ValueAnimator valueAnimator) {
    ...
    public void apply(@InterfaceC6391 Animator animator) {
    ...
    public String toString() {
        return '\n' + getClass().getName() + C6193.f1884 + Integer.toHexString(System.identityHashCode(this)) + " delay: " + getDelay() + " duration: " + getDuration() + " interpolator: " + getInterpolator().getClass() + " repeatCount: " + getRepeatCount() + " repeatMode: " + getRepeatMode() + "}\n";
    }

    public MotionTiming(long j, long j2, @InterfaceC6391 TimeInterpolator timeInterpolator) {
        this.repeatCount = 0;
        this.repeatMode = 1;
        this.delay = j;
        this.duration = j2;
