...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @InterfaceC6490
    private ViewGroup calculateChildContentContainer(@InterfaceC6391 View view) {
        View viewFindViewById = view.findViewById(C1980R.id.mtrl_child_content_container);
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(@InterfaceC6391 View view, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 MotionTiming motionTiming, @InterfaceC6391 MotionTiming motionTiming2, float f, float f2, float f3, float f4, @InterfaceC6391 RectF rectF) {
    ...
    private void calculateDependencyWindowBounds(@InterfaceC6391 View view, @InterfaceC6391 RectF rectF) {
        calculateWindowBounds(view, rectF);
        rectF.offset(this.dependencyOriginalTranslationX, this.dependencyOriginalTranslationY);
    }

    @InterfaceC6391
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f2, boolean z, @InterfaceC6391 FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
    ...
    private float calculateRevealCenterX(@InterfaceC6391 View view, @InterfaceC6391 View view2, @InterfaceC6391 Positioning positioning) {
    ...
    private float calculateRevealCenterY(@InterfaceC6391 View view, @InterfaceC6391 View view2, @InterfaceC6391 Positioning positioning) {
        RectF rectF = this.tmpRectF1;
        RectF rectF2 = this.tmpRectF2;
        calculateDependencyWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
    ...
    private float calculateTranslationX(@InterfaceC6391 View view, @InterfaceC6391 View view2, @InterfaceC6391 Positioning positioning) {
        float fCenterX;
        float fCenterX2;
        float f;
        RectF rectF = this.tmpRectF1;
    ...
    private float calculateTranslationY(@InterfaceC6391 View view, @InterfaceC6391 View view2, @InterfaceC6391 Positioning positioning) {
        float fCenterY;
        float fCenterY2;
        float f;
        RectF rectF = this.tmpRectF1;
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 MotionTiming motionTiming, float f, float f2) {
    ...
    private void calculateWindowBounds(@InterfaceC6391 View view, RectF rectF) {
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createColorAnimation(@InterfaceC6391 View view, View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createDependencyTranslationAnimation(@InterfaceC6391 View view, @InterfaceC6391 View view2, boolean z, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list) {
    ...
    @TargetApi(21)
    private void createElevationAnimation(View view, @InterfaceC6391 View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        float fM27347 = C8273.m27347(view2) - C8273.m27347(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-fM27347);
            }
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, 0.0f);
        } else {
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, -fM27347);
        }
        fabTransformationSpec.timings.getTiming(AbstractC5616.f13585).apply(objectAnimatorOfFloat);
        list.add(objectAnimatorOfFloat);
    }

    /* JADX DEBUG: Multi-variable search result rejected for r19v0, resolved type: android.view.View */
    /* JADX WARN: Multi-variable type inference failed */
    private void createExpansionAnimation(@InterfaceC6391 View view, View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, float f, float f2, @InterfaceC6391 List<Animator> list, @InterfaceC6391 List<Animator.AnimatorListener> list2) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createIconFadeAnimation(View view, final View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list, @InterfaceC6391 List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfInt;
    ...
    private void createPostFillRadialExpansion(View view, long j, long j2, long j3, int i, int i2, float f, @InterfaceC6391 List<Animator> list) {
        long j4 = j + j2;
        if (j4 < j3) {
    ...
    private void createPreFillRadialExpansion(View view, long j, int i, int i2, float f, @InterfaceC6391 List<Animator> list) {
        if (j > 0) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i2, f, f);
    ...
    private void createTranslationAnimation(@InterfaceC6391 View view, @InterfaceC6391 View view2, boolean z, boolean z2, @InterfaceC6391 FabTransformationSpec fabTransformationSpec, @InterfaceC6391 List<Animator> list, List<Animator.AnimatorListener> list2, @InterfaceC6391 RectF rectF) {
        ObjectAnimator objectAnimatorOfFloat;
    ...
    private int getBackgroundTint(@InterfaceC6391 View view) {
        ColorStateList colorStateListM27342 = C8273.m27342(view);
        if (colorStateListM27342 != null) {
            return colorStateListM27342.getColorForState(view.getDrawableState(), colorStateListM27342.getDefaultColor());
        }
        return 0;
    }
    ...
    @Override // com.google.android.material.transformation.ExpandableBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC8792
    @InterfaceC3647
    public boolean layoutDependsOn(@InterfaceC6391 CoordinatorLayout coordinatorLayout, @InterfaceC6391 View view, @InterfaceC6391 View view2) {
    ...
    @InterfaceC6391
    public AnimatorSet onCreateExpandedStateChangeAnimation(@InterfaceC6391 final View view, @InterfaceC6391 final View view2, final boolean z, boolean z2) {
