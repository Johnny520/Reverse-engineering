...
class KeylineStateList {
    ...
    private KeylineStateList(@InterfaceC6391 KeylineState keylineState, List<KeylineState> list, List<KeylineState> list2) {
    ...
    public Map<Integer, KeylineState> getKeylineStateForPositionMap(int i, int i2, int i3, boolean z) {
        ...
        while (true) {
            ...
            if (i6 * itemSize * (z ? -1 : 1) > i3 - this.endShiftRange || i4 >= i - this.endStateSteps.size()) {
                ...
                map.put(numValueOf, list.get(C6132.m18838(i5, 0, list.size() - 1)));
                i5++;
            }
            i4++;
        }
        ...
        for (int i8 = i - 1; i8 >= 0; i8--) {
            ...
            if (i9 * itemSize * (z ? -1 : 1) < i2 + this.startShiftRange || i8 < this.startStateSteps.size()) {
                ...
                map.put(numValueOf2, list2.get(C6132.m18838(i7, 0, list2.size() - 1)));
                i7++;
            }
        }
        return map;
