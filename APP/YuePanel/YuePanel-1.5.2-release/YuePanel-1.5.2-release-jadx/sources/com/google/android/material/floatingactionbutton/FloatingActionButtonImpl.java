...
class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C1980R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C1980R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C1980R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C1980R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    public void calculateImageMatrixFromScale(float f, @InterfaceC6391 Matrix matrix) {
        matrix.reset();
    ...
    @InterfaceC6391
    private AnimatorSet createAnimator(@InterfaceC6391 MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        ObjectAnimator objectAnimatorOfObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.3
            ...
            public Matrix evaluate(float f4, @InterfaceC6391 Matrix matrix, @InterfaceC6391 Matrix matrix2) {
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3, int i, int i2) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), i, this.view.getContext().getResources().getInteger(C1980R.integer.material_motion_duration_long_1)));
    ...
    @InterfaceC6391
    private ValueAnimator createElevationAnimator(@InterfaceC6391 ShadowAnimatorImpl shadowAnimatorImpl) {
    ...
    private boolean shouldAnimateVisibilityChange() {
        return C8273.m27404(this.view) && !this.view.isInEditMode();
    }
    ...
    public void addTransformationCallback(@InterfaceC6391 InternalTransformationCallback internalTransformationCallback) {
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) C6740.m21415(this.shapeAppearance));
    }
    ...
    public void getPadding(@InterfaceC6391 Rect rect) {
    ...
    public void hide(@InterfaceC6490 final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        if (isOrWillBeHidden()) {
            return;
        }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @InterfaceC6490 PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) C6740.m21415(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void onPaddingUpdated(@InterfaceC6391 Rect rect) {
        C6740.m21416(this.contentBackground, "Didn't initialize content background");
        if (!shouldAddPadding()) {
    ...
    public void removeTransformationCallback(@InterfaceC6391 InternalTransformationCallback internalTransformationCallback) {
        ArrayList<InternalTransformationCallback> arrayList = this.transformationCallbacks;
        if (arrayList == null) {
            return;
        }
    ...
    public final void setHideMotionSpec(@InterfaceC6490 MotionSpec motionSpec) {
    ...
    public void setRippleColor(@InterfaceC6490 ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            C4520.m13236(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
    ...
    public final void setShapeAppearance(@InterfaceC6391 ShapeAppearanceModel shapeAppearanceModel) {
    ...
    public final void setShowMotionSpec(@InterfaceC6490 MotionSpec motionSpec) {
    ...
    public void show(@InterfaceC6490 final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        if (isOrWillBeShown()) {
            return;
        }
        Animator animator = this.currentAnimator;
