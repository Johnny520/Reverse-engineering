...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public BottomNavigationMenuView(@InterfaceC6391 Context context) {
        super(context);
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C1980R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C1980R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C1980R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C1980R.dimen.design_bottom_navigation_active_item_min_width);
    }

    @Override // com.google.android.material.navigation.NavigationBarMenuView
    @InterfaceC6391
    public NavigationBarItemView createNavigationBarItemView(@InterfaceC6391 Context context) {
