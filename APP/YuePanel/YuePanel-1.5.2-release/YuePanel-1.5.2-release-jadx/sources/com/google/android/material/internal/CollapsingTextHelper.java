...
public final class CollapsingTextHelper {
    ...
    @InterfaceC3897
    private static int blendARGB(@InterfaceC3897 int i, @InterfaceC3897 int i2, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f) {
        float f2 = 1.0f - f;
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        int iM15901 = C5194.m15901(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        int i = iM15901 & 112;
        if (i == 48) {
        ...
        int iM159012 = C5194.m15901(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = iM159012 & 112;
        if (i3 == 48) {
    ...
    private float calculateFadeModeTextAlpha(@InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f) {
    ...
    private boolean calculateIsRtl(@InterfaceC6391 CharSequence charSequence) {
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z) {
        ...
        return (StaticLayout) C6740.m21415(staticLayoutBuild);
    }

    private void drawMultilineTransition(@InterfaceC6391 Canvas canvas, float f, float f2) {
    ...
    private float getCollapsedTextRightBound(@InterfaceC6391 RectF rectF, int i, int i2) {
    ...
    @InterfaceC3897
    private int getCurrentColor(@InterfaceC6490 ColorStateList colorStateList) {
    ...
    private Layout.Alignment getMultilineTextLayoutAlignment() {
        int iM15901 = C5194.m15901(this.expandedTextGravity, this.isRtl ? 1 : 0) & 7;
        return iM15901 != 1 ? iM15901 != 5 ? this.isRtl ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_NORMAL : this.isRtl ? Layout.Alignment.ALIGN_NORMAL : Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_CENTER;
    }

    private void getTextPaintCollapsed(@InterfaceC6391 TextPaint textPaint) {
        textPaint.setTextSize(this.collapsedTextSize);
        textPaint.setTypeface(this.collapsedTypeface);
        textPaint.setLetterSpacing(this.collapsedLetterSpacing);
    }

    private void getTextPaintExpanded(@InterfaceC6391 TextPaint textPaint) {
    ...
    private boolean isDefaultIsRtl() {
        return C8273.m27356(this.view) == 1;
    }

    private boolean isTextDirectionHeuristicsIsRtl(@InterfaceC6391 CharSequence charSequence, boolean z) {
        return (z ? C7746.f23283 : C7746.f23282).mo3841(charSequence, 0, charSequence.length());
    }

    private static float lerp(float f, float f2, float f3, @InterfaceC6490 TimeInterpolator timeInterpolator) {
    ...
    private static boolean rectEquals(@InterfaceC6391 Rect rect, int i, int i2, int i3, int i4) {
    ...
    public void getCollapsedTextActualBounds(@InterfaceC6391 RectF rectF, int i, int i2) {
    ...
    public void maybeUpdateFontWeightAdjustment(@InterfaceC6391 Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
    ...
    public void setCollapsedAndExpandedTextColor(@InterfaceC6490 ColorStateList colorStateList) {
    ...
    public void setExpansionFraction(float f) {
        ...
        if (fM18837 != this.expandedFraction) {
            this.expandedFraction = fM18837;
    ...
    public void setTitleTextEllipsize(@InterfaceC6391 TextUtils.TruncateAt truncateAt) {
    ...
    public void setCollapsedBounds(@InterfaceC6391 Rect rect) {
        setCollapsedBounds(rect.left, rect.top, rect.right, rect.bottom);
    }

    public void setExpandedBounds(@InterfaceC6391 Rect rect) {
