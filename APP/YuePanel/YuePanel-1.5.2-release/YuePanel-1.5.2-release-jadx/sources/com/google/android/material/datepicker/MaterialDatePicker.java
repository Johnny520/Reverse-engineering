...
public final class MaterialDatePicker<S> extends DialogInterfaceOnCancelListenerC8871 {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, C3323.m396(context, C1980R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], C3323.m396(context, C1980R.drawable.material_ic_edit_black_24dp));
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final View viewFindViewById = requireView().findViewById(C1980R.id.fullscreen_header);
        ...
        C8273.m27468(viewFindViewById, new InterfaceC6545() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            @Override // Yue.InterfaceC6545
            public C8472 onApplyWindowInsets(View view, C8472 c8472) {
                int i2 = c8472.m28281(C8472.C8483.m28360()).f1521;
                if (i >= 0) {
    ...
    @InterfaceC6490
    private static CharSequence getFirstLineBySeparator(@InterfaceC6490 CharSequence charSequence) {
    ...
    private static int getPaddedPickerWidth(@InterfaceC6391 Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1980R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1980R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1980R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        C8273.m27439(this.headerToggleButton, null);
        updateToggleContentDescription(this.headerToggleButton);
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: Yue.ۥۣۡ۟۟
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f14901.lambda$initHeaderToggle$0(view);
            }
        });
    }

    public static boolean isFullscreen(@InterfaceC6391 Context context) {
    ...
    public static boolean isNestedScrollable(@InterfaceC6391 Context context) {
        return readMaterialCalendarStyleBoolean(context, C1980R.attr.nestedScrollable);
    }
    ...
    @InterfaceC6391
    public static <S> MaterialDatePicker<S> newInstance(@InterfaceC6391 Builder<S> builder) {
    ...
    public static boolean readMaterialCalendarStyleBoolean(@InterfaceC6391 Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1980R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private void startPickerFragment() {
        ...
        AbstractC8885 abstractC8885M29749 = getChildFragmentManager().m29749();
        abstractC8885M29749.m30054(C1980R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    private void updateToggleContentDescription(@InterfaceC6391 CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(this.inputMode == 1 ? checkableImageButton.getContext().getString(C1980R.string.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton.getContext().getString(C1980R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final void onCreate(@InterfaceC6490 Bundle bundle) {
    ...
    public final Dialog onCreateDialog(@InterfaceC6490 Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, C1980R.attr.materialCalendarStyle, C1980R.style.Widget_MaterialComponents_MaterialCalendar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C1980R.styleable.MaterialCalendar, C1980R.attr.materialCalendarStyle, C1980R.style.Widget_MaterialComponents_MaterialCalendar);
        int color = typedArrayObtainStyledAttributes.getColor(C1980R.styleable.MaterialCalendar_backgroundTint, 0);
        typedArrayObtainStyledAttributes.recycle();
        this.background.initializeElevationOverlay(context);
        this.background.setFillColor(ColorStateList.valueOf(color));
        this.background.setElevation(C8273.m27347(dialog.getWindow().getDecorView()));
        return dialog;
    }
    ...
    public final View onCreateView(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, @InterfaceC6490 Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C1980R.layout.mtrl_picker_fullscreen : C1980R.layout.mtrl_picker_dialog, viewGroup);
        ...
        if (this.fullscreen) {
            viewInflate.findViewById(C1980R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            viewInflate.findViewById(C1980R.id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) viewInflate.findViewById(C1980R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        C8273.m27441(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C1980R.id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) viewInflate.findViewById(C1980R.id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) viewInflate.findViewById(C1980R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C1980R.id.cancel_button);
    ...
    @Override // androidx.fragment.app.DialogInterfaceOnCancelListenerC8871, androidx.fragment.app.Fragment
    public final void onSaveInstanceState(@InterfaceC6391 Bundle bundle) {
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1980R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public static final class Builder<S> {
        ...
        @InterfaceC6391
        @InterfaceC7144({InterfaceC7144.EnumC1188.LIBRARY_GROUP})
        public static <S> Builder<S> customDatePicker(@InterfaceC6391 DateSelector<S> dateSelector) {
        ...
        @InterfaceC6391
        public static Builder<C6600<Long, Long>> dateRangePicker() {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setDayViewDecorator(@InterfaceC6490 DayViewDecorator dayViewDecorator) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setNegativeButtonContentDescription(@InterfaceC7613 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setNegativeButtonText(@InterfaceC7613 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setPositiveButtonContentDescription(@InterfaceC7613 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setPositiveButtonText(@InterfaceC7613 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setTextInputFormat(@InterfaceC6490 SimpleDateFormat simpleDateFormat) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setTheme(@InterfaceC7651 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setTitleText(@InterfaceC7613 int i) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setNegativeButtonContentDescription(@InterfaceC6490 CharSequence charSequence) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setNegativeButtonText(@InterfaceC6490 CharSequence charSequence) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setPositiveButtonContentDescription(@InterfaceC6490 CharSequence charSequence) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setPositiveButtonText(@InterfaceC6490 CharSequence charSequence) {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder<S> setTitleText(@InterfaceC6490 CharSequence charSequence) {
