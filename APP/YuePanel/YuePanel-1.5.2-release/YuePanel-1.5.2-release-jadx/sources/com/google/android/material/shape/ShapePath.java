...
public class ShapePath {
    ...
    public static class ArcShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @InterfaceC6391 ShadowRenderer shadowRenderer, int i, @InterfaceC6391 Canvas canvas) {
    ...
    public static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f4126x - this.startX, this.operation1.f4127y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f4126x - this.operation1.f4126x, this.operation2.f4127y - this.operation1.f4127y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f4126x, this.operation1.f4127y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f4127y - this.operation1.f4127y) / (this.operation2.f4126x - this.operation1.f4126x)));
        }

        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f4127y - this.startY) / (this.operation1.f4126x - this.startX)));
        }
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @InterfaceC6391 ShadowRenderer shadowRenderer, int i, @InterfaceC6391 Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f4127y - this.startY, this.operation.f4126x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f4127y - this.startY) / (this.operation.f4126x - this.startX)));
        }
    }
    ...
    public static class PathArcOperation extends PathOperation {
        ...
        public void applyToPath(@InterfaceC6391 Matrix matrix, @InterfaceC6391 Path path) {
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f4126x;

        /* JADX INFO: renamed from: y */
        private float f4127y;
        ...
        public void applyToPath(@InterfaceC6391 Matrix matrix, @InterfaceC6391 Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f4126x, this.f4127y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f4126x = f;
        pathLineOperation.f4127y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f4126x = f3;
        pathLineOperation2.f4127y = f4;
