...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f, final float f2, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) final float f3, @InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) final float f4, final float f5) {
    ...
    public void setProgressThreshold(@InterfaceC4885(from = 0.0d, m1796to = Contrast.RATIO_MIN) float f) {
