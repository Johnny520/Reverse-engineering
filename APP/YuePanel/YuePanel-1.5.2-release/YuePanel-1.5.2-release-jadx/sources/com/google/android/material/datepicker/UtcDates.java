...
class UtcDates {
    ...
    private static int findCharactersInDateFormatPattern(@InterfaceC6391 String str, @InterfaceC6391 String str2, int i, int i2) {
    ...
    @InterfaceC6391
    public static String getDatePatternAsInputFormat(@InterfaceC6391 String str) {
    ...
    public static String getDefaultTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        String string = resources.getString(C1980R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C1980R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C1980R.string.mtrl_picker_text_input_day_abbr);
    ...
    public static java.text.DateFormat getNormalizedFormat(@InterfaceC6391 java.text.DateFormat dateFormat) {
    ...
    public static Calendar getUtcCalendarOf(@InterfaceC6490 Calendar calendar) {
    ...
    @InterfaceC6391
    private static String removeYearFromDateFormatPattern(@InterfaceC6391 String str) {
    ...
    public static void setTimeSource(@InterfaceC6490 TimeSource timeSource) {
