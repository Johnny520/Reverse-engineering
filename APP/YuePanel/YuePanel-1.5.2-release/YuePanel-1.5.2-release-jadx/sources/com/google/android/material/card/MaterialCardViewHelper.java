...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(@InterfaceC6391 MaterialCardView materialCardView, AttributeSet attributeSet, int i, @InterfaceC7651 int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = materialCardView.getContext().obtainStyledAttributes(attributeSet, C1980R.styleable.CardView, i, C1980R.style.CardView);
        if (typedArrayObtainStyledAttributes.hasValue(C1980R.styleable.CardView_cardCornerRadius)) {
            builder.setAllCornerSizes(typedArrayObtainStyledAttributes.getDimension(C1980R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(builder.build());
        this.iconFadeAnimInterpolator = MotionUtils.resolveThemeInterpolator(materialCardView.getContext(), C1980R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.iconFadeInAnimDuration = MotionUtils.resolveThemeDuration(materialCardView.getContext(), C1980R.attr.motionDurationShort2, 300);
        this.iconFadeOutAnimDuration = MotionUtils.resolveThemeDuration(materialCardView.getContext(), C1980R.attr.motionDurationShort1, 300);
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            layerDrawable.setId(2, C1980R.id.mtrl_card_checked_layer_id);
        }
    ...
    public void animateCheckedIcon(boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.ۥ
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f4093.lambda$animateCheckedIcon$0(valueAnimator2);
            }
        });
    ...
    public void loadFromAttributes(@InterfaceC6391 TypedArray typedArray) {
        ColorStateList colorStateList = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1980R.styleable.MaterialCardView_strokeColor);
        this.strokeColor = colorStateList;
        if (colorStateList == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C1980R.styleable.MaterialCardView_strokeWidth, 0);
        boolean z = typedArray.getBoolean(C1980R.styleable.MaterialCardView_android_checkable, false);
        this.checkable = z;
        this.materialCardView.setLongClickable(z);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1980R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), typedArray, C1980R.styleable.MaterialCardView_checkedIcon));
        setCheckedIconSize(typedArray.getDimensionPixelSize(C1980R.styleable.MaterialCardView_checkedIconSize, 0));
        setCheckedIconMargin(typedArray.getDimensionPixelSize(C1980R.styleable.MaterialCardView_checkedIconMargin, 0));
        this.checkedIconGravity = typedArray.getInteger(C1980R.styleable.MaterialCardView_checkedIconGravity, 8388661);
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1980R.styleable.MaterialCardView_rippleColor);
        this.rippleColor = colorStateList2;
        if (colorStateList2 == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C1980R.attr.colorControlHighlight));
        }
        setCardForegroundColor(MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1980R.styleable.MaterialCardView_cardForegroundColor));
        updateRippleColor();
        updateElevation();
        updateStroke();
    ...
    public void recalculateCheckedIconPosition(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if (C8273.m27356(this.materialCardView) == 1) {
                i4 = i7;
                i3 = i5;
            } else {
                i3 = i7;
    ...
    public void setCheckedIcon(@InterfaceC6490 Drawable drawable) {
        if (drawable != null) {
            ...
            C4520.m13236(drawableMutate, this.checkedIconTint);
        ...
        if (layerDrawable != null) {
            layerDrawable.setDrawableByLayerId(C1980R.id.mtrl_card_checked_layer_id, this.checkedIcon);
        }
    }
