...
public final class CalendarConstraints implements Parcelable {
    public static final Parcelable.Creator<CalendarConstraints> CREATOR = new Parcelable.Creator<CalendarConstraints>() { // from class: com.google.android.material.datepicker.CalendarConstraints.1
        ...
        @InterfaceC6391
        public CalendarConstraints createFromParcel(@InterfaceC6391 Parcel parcel) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.start.equals(calendarConstraints.start) && this.end.equals(calendarConstraints.end) && C6499.m2995(this.openAt, calendarConstraints.openAt) && this.firstDayOfWeek == calendarConstraints.firstDayOfWeek && this.validator.equals(calendarConstraints.validator);
    }
    ...
    public void setOpenAt(@InterfaceC6490 Month month) {
        this.openAt = month;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    private CalendarConstraints(@InterfaceC6391 Month month, @InterfaceC6391 Month month2, @InterfaceC6391 DateValidator dateValidator, @InterfaceC6490 Month month3, int i) {
    ...
    public static final class Builder {
        ...
        @InterfaceC6391
        @CanIgnoreReturnValue
        public Builder setValidator(@InterfaceC6391 DateValidator dateValidator) {
            Objects.requireNonNull(dateValidator, "validator cannot be null");
            this.validator = dateValidator;
            return this;
        }

        public Builder(@InterfaceC6391 CalendarConstraints calendarConstraints) {
            this.start = DEFAULT_START;
            this.end = DEFAULT_END;
            this.validator = DateValidatorPointForward.from(Long.MIN_VALUE);
