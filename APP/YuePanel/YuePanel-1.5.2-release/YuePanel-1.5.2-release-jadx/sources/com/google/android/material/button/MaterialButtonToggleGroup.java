...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C1980R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @InterfaceC5411 int i, boolean z);
    }
    ...
    public class PressedStateTracker implements MaterialButton.OnPressedChangeListener {
        ...
        public void onPressedChanged(@InterfaceC6391 MaterialButton materialButton, boolean z) {
            MaterialButtonToggleGroup.this.invalidate();
        }
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public MaterialButtonToggleGroup(@InterfaceC6391 Context context) {
        this(context, null);
    }
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
            ...
            if (getOrientation() == 0) {
                C5946.m18703(layoutParamsBuildLayoutParams, 0);
                C5946.m18704(layoutParamsBuildLayoutParams, -iMin);
                ...
                C5946.m18704(layoutParamsBuildLayoutParams, 0);
            }
    ...
    @InterfaceC6391
    private LinearLayout.LayoutParams buildLayoutParams(@InterfaceC6391 View view) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        return layoutParams instanceof LinearLayout.LayoutParams ? (LinearLayout.LayoutParams) layoutParams : new LinearLayout.LayoutParams(layoutParams.width, layoutParams.height);
    }

    private void checkInternal(@InterfaceC5411 int i, boolean z) {
        if (i == -1) {
    ...
    private void dispatchOnButtonChecked(@InterfaceC5411 int i, boolean z) {
    ...
    public int getIndexWithinVisibleButtons(@InterfaceC6490 View view) {
    ...
    private void resetChildMargins(int i) {
        ...
        if (getOrientation() == 1) {
            ...
            C5946.m18703(layoutParams, 0);
            C5946.m18704(layoutParams, 0);
            layoutParams.leftMargin = 0;
            layoutParams.rightMargin = 0;
        }
    }

    private void setCheckedStateForView(@InterfaceC5411 int i, boolean z) {
    ...
    private void setGeneratedIdIfNeeded(@InterfaceC6391 MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(C8273.m27331());
        }
    }

    private void setupButtonChild(@InterfaceC6391 MaterialButton materialButton) {
    ...
    private static void updateBuilderWithCornerData(ShapeAppearanceModel.Builder builder, @InterfaceC6490 CornerData cornerData) {
        if (cornerData == null) {
    ...
    public void addOnButtonCheckedListener(@InterfaceC6391 OnButtonCheckedListener onButtonCheckedListener) {
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        C8273.m27439(materialButton, new C3024() { // from class: com.google.android.material.button.MaterialButtonToggleGroup.2
            @Override // Yue.C3024
            public void onInitializeAccessibilityNodeInfo(View view2, @InterfaceC6391 C3055 c3055) {
                ...
                c3055.m6060(C3055.C3060.m6143(0, 1, MaterialButtonToggleGroup.this.getIndexWithinVisibleButtons(view2), 1, false, ((MaterialButton) view2).isChecked()));
            }
        });
    }
    ...
    public void onButtonCheckedStateChanged(@InterfaceC6391 MaterialButton materialButton, boolean z) {
    ...
    public void onInitializeAccessibilityNodeInfo(@InterfaceC6391 AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        C3055.m5950(accessibilityNodeInfo).m6059(C3055.C3059.m6139(1, getVisibleButtonCount(), false, isSingleSelection() ? 1 : 2));
    }
    ...
    public void removeOnButtonCheckedListener(@InterfaceC6391 OnButtonCheckedListener onButtonCheckedListener) {
    ...
    public MaterialButtonToggleGroup(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet) {
        this(context, attributeSet, C1980R.attr.materialButtonToggleGroupStyle);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public MaterialButtonToggleGroup(@InterfaceC6391 Context context, @InterfaceC6490 AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C1980R.styleable.MaterialButtonToggleGroup, i, i2, new int[0]);
        setSingleSelection(typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.defaultCheckId = typedArrayObtainStyledAttributes.getResourceId(C1980R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
        setChildrenDrawingOrderEnabled(true);
        setEnabled(typedArrayObtainStyledAttributes.getBoolean(C1980R.styleable.MaterialButtonToggleGroup_android_enabled, true));
        typedArrayObtainStyledAttributes.recycle();
        C8273.m27457(this, 1);
    }

    public void setSingleSelection(@InterfaceC3567 int i) {
