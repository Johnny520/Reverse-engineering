...
public final class DynamicColor {
    ...
    public DynamicColor(@InterfaceC6391 String str, @InterfaceC6391 Function<DynamicScheme, TonalPalette> function, @InterfaceC6391 Function<DynamicScheme, Double> function2, boolean z, @InterfaceC6490 Function<DynamicScheme, DynamicColor> function3, @InterfaceC6490 Function<DynamicScheme, DynamicColor> function4, @InterfaceC6490 ContrastCurve contrastCurve, @InterfaceC6490 Function<DynamicScheme, ToneDeltaPair> function5) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6391
    public static DynamicColor fromPalette(@InterfaceC6391 String str, @InterfaceC6391 Function<DynamicScheme, TonalPalette> function, @InterfaceC6391 Function<DynamicScheme, Double> function2) {
    ...
    public int getArgb(@InterfaceC6391 DynamicScheme dynamicScheme) {
        int i = getHct(dynamicScheme).toInt();
        Function<DynamicScheme, Double> function = this.opacity;
        if (function == null) {
            return i;
        }
        return (MathUtils.clampInt(0, 255, (int) Math.round(function.apply(dynamicScheme).doubleValue() * 255.0d)) << 24) | (i & C8273.f24691);
    }

    @InterfaceC6391
    public Hct getHct(@InterfaceC6391 DynamicScheme dynamicScheme) {
    ...
    public double getTone(@InterfaceC6391 DynamicScheme dynamicScheme) {
        double dMin;
        ...
        if (function == null) {
            ...
            double d = (!this.isBackground || 50.0d > dDoubleValue || dDoubleValue >= 60.0d) ? dDoubleValue : Contrast.ratioOfTones(49.0d, tone) >= contrast ? 49.0d : 60.0d;
            ...
            if (Contrast.ratioOfTones(dMax, d) >= contrast && Contrast.ratioOfTones(dMin2, d) >= contrast) {
                return d;
            }
        ...
        double dClampDouble = dDoubleValue2;
        ...
        if (z) {
            dClampDouble = foregroundTone(tone4, contrast2);
            dDoubleValue3 = foregroundTone(tone4, contrast3);
        }
        if ((dDoubleValue3 - dClampDouble) * d2 < delta) {
            double d3 = delta * d2;
            dDoubleValue3 = MathUtils.clampDouble(0.0d, 100.0d, dClampDouble + d3);
            if ((dDoubleValue3 - dClampDouble) * d2 < delta) {
                dClampDouble = MathUtils.clampDouble(0.0d, 100.0d, dDoubleValue3 - d3);
            }
        }
        if (50.0d > dClampDouble || dClampDouble >= 60.0d) {
            if (50.0d > dDoubleValue3 || dDoubleValue3 >= 60.0d) {
                ...
                dMin = Math.max(dDoubleValue3, (delta * d2) + 60.0d);
                dClampDouble = 60.0d;
            } else {
    ...
    @InterfaceC6391
    public static DynamicColor fromPalette(@InterfaceC6391 String str, @InterfaceC6391 Function<DynamicScheme, TonalPalette> function, @InterfaceC6391 Function<DynamicScheme, Double> function2, boolean z) {
        return new DynamicColor(str, function, function2, z, null, null, null, null);
    }

    public DynamicColor(@InterfaceC6391 String str, @InterfaceC6391 Function<DynamicScheme, TonalPalette> function, @InterfaceC6391 Function<DynamicScheme, Double> function2, boolean z, @InterfaceC6490 Function<DynamicScheme, DynamicColor> function3, @InterfaceC6490 Function<DynamicScheme, DynamicColor> function4, @InterfaceC6490 ContrastCurve contrastCurve, @InterfaceC6490 Function<DynamicScheme, ToneDeltaPair> function5, @InterfaceC6490 Function<DynamicScheme, Double> function6) {
        this.hctCache = new HashMap<>();
        this.name = str;
        this.palette = function;
        this.tone = function2;
