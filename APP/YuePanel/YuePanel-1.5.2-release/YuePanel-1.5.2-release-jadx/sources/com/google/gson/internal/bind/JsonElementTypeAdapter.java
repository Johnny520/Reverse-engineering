...
public class JsonElementTypeAdapter extends TypeAdapter<JsonElement> {
    ...
    /* JADX INFO: renamed from: com.google.gson.internal.bind.JsonElementTypeAdapter$1 */
    public static /* synthetic */ class C23611 {
    ...
    private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i = C23611.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
        if (i == 3) {
