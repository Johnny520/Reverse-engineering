    ...
    */
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? '\'' : C8039.f3212);
        } else if (iDoPeek == 10) {
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(C8039.f3212);
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            str = nextQuotedValue(C8039.f3212);
        } else if (iDoPeek == 11) {
