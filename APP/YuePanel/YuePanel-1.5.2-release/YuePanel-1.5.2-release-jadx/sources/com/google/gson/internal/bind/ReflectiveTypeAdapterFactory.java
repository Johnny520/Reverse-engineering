...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        /* JADX DEBUG: Method merged with bridge method: createAccumulator()Ljava/lang/Object; */
        @Override // com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.Adapter
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX DEBUG: Method merged with bridge method: finalize(Ljava/lang/Object;)Ljava/lang/Object; */
        @Override // com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.Adapter
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX DEBUG: Method merged with bridge method: readField(Ljava/lang/Object;Lcom/google/gson/stream/JsonReader;Lcom/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;)V */
        @Override // com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.Adapter
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:74:0x013c */
            ...
            while (i3 < length) {
                ...
                if (zIncludeField || zIncludeField2) {
                    ...
                    if (!z2) {
                        ...
                        Type typeResolve2 = GsonTypes.resolve(typeToken2.getType(), rawType, field.getGenericType());
                        List<String> fieldNames2 = getFieldNames(field);
                        String str3 = fieldNames2.get(r7);
                        i = i3;
                        i2 = length;
                        r22 = r7;
                        BoundField boundFieldCreateBoundField2 = createBoundField(gson, field, method, str3, TypeToken.get(typeResolve2), zIncludeField, z5);
                        if (r18 != 0) {
                        }
                        if (!zIncludeField) {
                            continue;
                        ...
                        Type typeResolve22 = GsonTypes.resolve(typeToken2.getType(), rawType, field.getGenericType());
                        List<String> fieldNames22 = getFieldNames(field);
                        String str32 = fieldNames22.get(r7);
                        i = i3;
                        i2 = length;
                        r22 = r7;
                        BoundField boundFieldCreateBoundField22 = createBoundField(gson, field, method, str32, TypeToken.get(typeResolve22), zIncludeField, z5);
                        if (r18 != 0) {
                        }
                        if (!zIncludeField) {
                        }
