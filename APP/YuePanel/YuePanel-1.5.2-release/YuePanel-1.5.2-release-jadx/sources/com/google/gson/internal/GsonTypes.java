...
public final class GsonTypes {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return GsonTypes.typeToString(this.componentType) + C5385.f13236;
        }
    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:44:0x00a4 */
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (cls2.isArray()) {
                    ...
                    if (type2 instanceof ParameterizedType) {
                        ...
                        boolean z2 = false;
                        for (int i = 0; i < length; i++) {
                            Type typeResolve5 = resolve(type, cls, typeArr[i], map);
                            if (!equal(typeResolve5, typeArr[i])) {
                                if (!z2) {
