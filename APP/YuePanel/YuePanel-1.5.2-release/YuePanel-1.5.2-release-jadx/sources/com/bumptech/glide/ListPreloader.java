...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        @InterfaceC6490
        RequestBuilder<?> getPreloadRequestBuilder(@InterfaceC6391 U u);
    }

    public interface PreloadSizeProvider<T> {
        @InterfaceC6490
        int[] getPreloadSize(@InterfaceC6391 T t, int i, int i2);
    }
    ...
    public ListPreloader(@InterfaceC6391 RequestManager requestManager, @InterfaceC6391 PreloadModelProvider<T> preloadModelProvider, @InterfaceC6391 PreloadSizeProvider<T> preloadSizeProvider, int i) {
    ...
    private void preloadItem(@InterfaceC6490 T t, int i, int i2) {
        int[] preloadSize;
