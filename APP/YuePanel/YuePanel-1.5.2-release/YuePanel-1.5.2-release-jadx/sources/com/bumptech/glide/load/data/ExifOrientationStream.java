...
public final class ExifOrientationStream extends FilterInputStream {
    ...
    static {
        byte[] bArr = {-1, C4750.f10631, 0, 28, 69, 120, 105, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, BaseType.Vector64, 0, 2, 0, 0, 0, 1, 0};
        EXIF_SEGMENT = bArr;
    ...
    @Override // java.io.FilterInputStream, java.io.InputStream
    public int read(@InterfaceC6391 byte[] bArr, int i, int i2) throws IOException {
        int i3;
