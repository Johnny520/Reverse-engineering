...
class StrictLineReader implements Closeable {
    ...
    private static final byte f4038CR = 13;

    /* JADX INFO: renamed from: LF */
    private static final byte f4039LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* JADX INFO: renamed from: in */
    private final InputStream f4040in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f4040in;
        byte[] bArr = this.buf;
