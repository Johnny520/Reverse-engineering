...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private int order;
    private final C6702.InterfaceC1067<DecodeJob<?>> pool;
    ...
    public static /* synthetic */ class C19181 {
    ...
    public final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
        ...
        @InterfaceC6391
        public Resource<Z> onResourceDecoded(@InterfaceC6391 Resource<Z> resource) {
    ...
    public DecodeJob(DiskCacheProvider diskCacheProvider, C6702.InterfaceC1067<DecodeJob<?>> interfaceC1067) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C19181.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage) {
        int i = C19181.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage.ordinal()];
        if (i == 1) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v6, resolved type: com.bumptech.glide.load.engine.LockedResource */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    private void runWrapped() {
        int i = C19181.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    @InterfaceC6391
    public <Z> Resource<Z> onResourceDecoded(DataSource dataSource, @InterfaceC6391 Resource<Z> resource) {
        ...
        int i = C19181.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
        if (i == 1) {
    ...
    public int compareTo(@InterfaceC6391 DecodeJob<?> decodeJob) {
