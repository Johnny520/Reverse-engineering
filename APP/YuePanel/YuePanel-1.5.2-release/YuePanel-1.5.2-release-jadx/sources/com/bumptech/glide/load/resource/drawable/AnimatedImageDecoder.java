...
public final class AnimatedImageDecoder {
    ...
    public static final class AnimatedImageDrawableResource implements Resource<Drawable> {
        ...
        /* JADX DEBUG: Return type fixed from 'android.graphics.drawable.AnimatedImageDrawable' to match base method */
        @Override // com.bumptech.glide.load.engine.Resource
        @InterfaceC6391
        public Drawable get() {
    ...
    public static final class ByteBufferAnimatedImageDecoder implements ResourceDecoder<ByteBuffer, Drawable> {
        ...
        public Resource<Drawable> decode(@InterfaceC6391 ByteBuffer byteBuffer, int i, int i2, @InterfaceC6391 Options options) throws IOException {
    ...
    public static final class StreamAnimatedImageDecoder implements ResourceDecoder<InputStream, Drawable> {
        ...
        /* JADX DEBUG: Method merged with bridge method: decode(Ljava/lang/Object;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/engine/Resource; */
        @Override // com.bumptech.glide.load.ResourceDecoder
        public Resource<Drawable> decode(@InterfaceC6391 InputStream inputStream, int i, int i2, @InterfaceC6391 Options options) throws IOException {
    ...
    public Resource<Drawable> decode(@InterfaceC6391 ImageDecoder.Source source, int i, int i2, @InterfaceC6391 Options options) throws IOException {
        Drawable drawableDecodeDrawable = ImageDecoder.decodeDrawable(source, new DefaultOnHeaderDecodedListener(i, i2, options));
        if (C3223.m303(drawableDecodeDrawable)) {
            return new AnimatedImageDrawableResource(C3224.m304(drawableDecodeDrawable));
        }
