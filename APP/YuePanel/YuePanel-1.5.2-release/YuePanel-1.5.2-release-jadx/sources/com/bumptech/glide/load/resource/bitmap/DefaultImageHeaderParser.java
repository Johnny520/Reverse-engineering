...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    public static final class StreamReader implements Reader {
        ...
        private final InputStream f4056is;

        public StreamReader(InputStream inputStream) {
            this.f4056is = inputStream;
        }
        ...
        public int read(byte[] bArr, int i) throws IOException {
            int i2 = 0;
            int i3 = 0;
            while (i2 < i && (i3 = this.f4056is.read(bArr, i2, i - i2)) != -1) {
                i2 += i3;
            }
            if (i2 == 0 && i3 == -1) {
                throw new Reader.EndOfFileException();
        ...
        public long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                long jSkip = this.f4056is.skip(j2);
                if (jSkip <= 0) {
                    if (this.f4056is.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
    ...
    @Override // com.bumptech.glide.load.ImageHeaderParser
    @InterfaceC6391
    public ImageHeaderParser.ImageType getType(@InterfaceC6391 InputStream inputStream) throws IOException {
    ...
    @Override // com.bumptech.glide.load.ImageHeaderParser
    @InterfaceC6391
    public ImageHeaderParser.ImageType getType(@InterfaceC6391 ByteBuffer byteBuffer) throws IOException {
