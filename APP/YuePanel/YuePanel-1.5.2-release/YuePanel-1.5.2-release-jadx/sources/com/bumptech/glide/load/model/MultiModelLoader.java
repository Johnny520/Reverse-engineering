...
class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
    private final C6702.InterfaceC1067<List<Throwable>> exceptionListPool;
    ...
    public static class MultiFetcher<Data> implements DataFetcher<Data>, DataFetcher.DataCallback<Data> {
        ...
        public MultiFetcher(@InterfaceC6391 List<DataFetcher<Data>> list, @InterfaceC6391 C6702.InterfaceC1067<List<Throwable>> interfaceC1067) {
        ...
        public void onDataReady(@InterfaceC6490 Data data) {
            if (data != null) {
    ...
    public MultiModelLoader(@InterfaceC6391 List<ModelLoader<Model, Data>> list, @InterfaceC6391 C6702.InterfaceC1067<List<Throwable>> interfaceC1067) {
        this.modelLoaders = list;
        this.exceptionListPool = interfaceC1067;
    }

    @Override // com.bumptech.glide.load.model.ModelLoader
    public ModelLoader.LoadData<Data> buildLoadData(@InterfaceC6391 Model model, int i, int i2, @InterfaceC6391 Options options) {
    ...
    public String toString() {
        return "MultiModelLoader{modelLoaders=" + Arrays.toString(this.modelLoaders.toArray()) + C6193.f1885;
    }
}
