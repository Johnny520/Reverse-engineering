...
final class SingletonConnectivityReceiver {
    ...
    public static final class FrameworkConnectivityMonitorPostApi24 implements FrameworkConnectivityMonitor {
        ...
        private final ConnectivityManager.NetworkCallback networkCallback = new C19631();

        /* JADX INFO: renamed from: com.bumptech.glide.manager.SingletonConnectivityReceiver$FrameworkConnectivityMonitorPostApi24$1 */
        public class C19631 extends ConnectivityManager.NetworkCallback {
            public C19631() {
            }
            ...
            private void postOnConnectivityChange(final boolean z) {
                Util.postOnUiThread(new Runnable() { // from class: com.bumptech.glide.manager.SingletonConnectivityReceiver.FrameworkConnectivityMonitorPostApi24.1.1
                    ...
                    public void run() {
                        C19631.this.onConnectivityChange(z);
                    }
                });
            }

            @Override // android.net.ConnectivityManager.NetworkCallback
            public void onAvailable(@InterfaceC6391 Network network) {
            ...
            @Override // android.net.ConnectivityManager.NetworkCallback
            public void onLost(@InterfaceC6391 Network network) {
    ...
    public static final class FrameworkConnectivityMonitorPreApi24 implements FrameworkConnectivityMonitor {
        ...
        final BroadcastReceiver connectivityReceiver = new BroadcastReceiver() { // from class: com.bumptech.glide.manager.SingletonConnectivityReceiver.FrameworkConnectivityMonitorPreApi24.1
            ...
            public void onReceive(@InterfaceC6391 Context context, Intent intent) {
    ...
    private SingletonConnectivityReceiver(@InterfaceC6391 final Context context) {
    ...
    public static SingletonConnectivityReceiver get(@InterfaceC6391 Context context) {
        if (instance == null) {
