...
final class RegistryFactory {
    ...
    public static Registry createAndInitRegistry(Glide glide, List<GlideModule> list, @InterfaceC6490 AppGlideModule appGlideModule) {
    ...
    private static void initializeDefaults(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        registry2.append(cls, InputStream.class, modelLoaderFactoryInputStreamFactory).append(Integer.class, InputStream.class, modelLoaderFactoryInputStreamFactory).append(cls, AssetFileDescriptor.class, modelLoaderFactoryAssetFileDescriptorFactory).append(Integer.class, AssetFileDescriptor.class, modelLoaderFactoryAssetFileDescriptorFactory).append(cls, Drawable.class, modelLoaderFactoryDrawableFactory).append(Integer.class, Drawable.class, modelLoaderFactoryDrawableFactory).append(Uri.class, InputStream.class, ResourceUriLoader.newStreamFactory(context)).append(Uri.class, AssetFileDescriptor.class, ResourceUriLoader.newAssetFileDescriptorFactory(context));
        ResourceLoader.UriFactory uriFactory = new ResourceLoader.UriFactory(resources);
        ResourceLoader.AssetFileDescriptorFactory assetFileDescriptorFactory = new ResourceLoader.AssetFileDescriptorFactory(resources);
        ResourceLoader.StreamFactory streamFactory = new ResourceLoader.StreamFactory(resources);
        Object obj2 = obj;
        registry2.append(Integer.class, Uri.class, uriFactory).append(cls, Uri.class, uriFactory).append(Integer.class, AssetFileDescriptor.class, assetFileDescriptorFactory).append(cls, AssetFileDescriptor.class, assetFileDescriptorFactory).append(Integer.class, InputStream.class, streamFactory).append(cls, InputStream.class, streamFactory);
        ...
        registry2.append(ByteBuffer.class, (Class) obj2, (ResourceDecoder) new BitmapDrawableDecoder(resources, resourceDecoderByteBuffer));
    }

    private static void initializeModules(Context context, Glide glide, Registry registry, List<GlideModule> list, @InterfaceC6490 AppGlideModule appGlideModule) {
    ...
    public static GlideSuppliers.GlideSupplier<Registry> lazilyCreateAndInitializeRegistry(final Glide glide, final List<GlideModule> list, @InterfaceC6490 final AppGlideModule appGlideModule) {
