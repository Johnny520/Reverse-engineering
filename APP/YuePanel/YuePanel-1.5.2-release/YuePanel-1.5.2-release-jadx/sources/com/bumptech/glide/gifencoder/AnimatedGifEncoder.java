...
public class AnimatedGifEncoder {
    ...
    private void writeLSD() throws IOException {
        writeShort(this.width);
        writeShort(this.height);
        this.out.write(this.palSize | C3464.f305);
        this.out.write(0);
        this.out.write(0);
    }
    ...
    public boolean addFrame(@InterfaceC6490 Bitmap bitmap) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public boolean start(@InterfaceC6490 OutputStream outputStream) {
        boolean z = false;
    ...
    public boolean addFrame(@InterfaceC6490 Bitmap bitmap, int i, int i2) {
    ...
    public boolean start(@InterfaceC6391 String str) {
        boolean zStart;
        try {
