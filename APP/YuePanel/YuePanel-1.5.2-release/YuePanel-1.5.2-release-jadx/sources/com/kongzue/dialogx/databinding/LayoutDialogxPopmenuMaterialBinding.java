...
public final class LayoutDialogxPopmenuMaterialBinding implements InterfaceC8270 {
    ...
    private LayoutDialogxPopmenuMaterialBinding(@InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout, @InterfaceC6391 MaxRelativeLayout maxRelativeLayout, @InterfaceC6391 RelativeLayout relativeLayout, @InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout2, @InterfaceC6391 PopMenuListView popMenuListView) {
    ...
    @InterfaceC6391
    public static LayoutDialogxPopmenuMaterialBinding bind(@InterfaceC6391 View view) {
    ...
    @InterfaceC6391
    public static LayoutDialogxPopmenuMaterialBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static LayoutDialogxPopmenuMaterialBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C2413R.layout.layout_dialogx_popmenu_material, viewGroup, false);
        if (z) {
