...
public final class LayoutDialogxPoptipMaterialDarkBinding implements InterfaceC8270 {
    ...
    private LayoutDialogxPoptipMaterialDarkBinding(@InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout, @InterfaceC6391 LinearLayout linearLayout, @InterfaceC6391 RelativeLayout relativeLayout, @InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout2, @InterfaceC6391 ImageView imageView, @InterfaceC6391 TextView textView, @InterfaceC6391 TextView textView2) {
    ...
    @InterfaceC6391
    public static LayoutDialogxPoptipMaterialDarkBinding bind(@InterfaceC6391 View view) {
    ...
    @InterfaceC6391
    public static LayoutDialogxPoptipMaterialDarkBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static LayoutDialogxPoptipMaterialDarkBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C2413R.layout.layout_dialogx_poptip_material_dark, viewGroup, false);
        if (z) {
