...
public final class LayoutDialogxFullscreenBinding implements InterfaceC8270 {
    ...
    private LayoutDialogxFullscreenBinding(@InterfaceC6391 FrameLayout frameLayout, @InterfaceC6391 MaxRelativeLayout maxRelativeLayout, @InterfaceC6391 RelativeLayout relativeLayout, @InterfaceC6391 RelativeLayout relativeLayout2, @InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout, @InterfaceC6391 ActivityScreenShotImageView activityScreenShotImageView) {
    ...
    @InterfaceC6391
    public static LayoutDialogxFullscreenBinding bind(@InterfaceC6391 View view) {
        int i = C2413R.id.bkg;
    ...
    @InterfaceC6391
    public static LayoutDialogxFullscreenBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static LayoutDialogxFullscreenBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C2413R.layout.layout_dialogx_fullscreen, viewGroup, false);
        if (z) {
