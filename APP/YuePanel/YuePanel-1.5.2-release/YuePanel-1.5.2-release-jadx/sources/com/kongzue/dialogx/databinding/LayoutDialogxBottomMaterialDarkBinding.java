...
public final class LayoutDialogxBottomMaterialDarkBinding implements InterfaceC8270 {
    ...
    private LayoutDialogxBottomMaterialDarkBinding(@InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout, @InterfaceC6391 MaxRelativeLayout maxRelativeLayout, @InterfaceC6391 RelativeLayout relativeLayout, @InterfaceC6391 LinearLayout linearLayout, @InterfaceC6391 LinearLayout linearLayout2, @InterfaceC6391 LinearLayout linearLayout3, @InterfaceC6391 RelativeLayout relativeLayout2, @InterfaceC6391 FrameLayout frameLayout, @InterfaceC6391 DialogXBaseRelativeLayout dialogXBaseRelativeLayout2, @InterfaceC6391 TextView textView, @InterfaceC6391 TextView textView2, @InterfaceC6391 TextView textView3, @InterfaceC6391 ImageView imageView, @InterfaceC6391 DialogScrollView dialogScrollView, @InterfaceC6391 Space space, @InterfaceC6391 TextView textView4, @InterfaceC6391 TextView textView5) {
    ...
    @InterfaceC6391
    public static LayoutDialogxBottomMaterialDarkBinding bind(@InterfaceC6391 View view) {
        int i = C2413R.id.bkg;
        ...
        if (maxRelativeLayout != null) {
            ...
            if (relativeLayout != null) {
                i = C2413R.id.box_body;
                LinearLayout linearLayout = (LinearLayout) C8271.m4244(view, i);
                if (linearLayout != null) {
                    i = C2413R.id.box_button;
                    LinearLayout linearLayout2 = (LinearLayout) C8271.m4244(view, i);
                    if (linearLayout2 != null) {
                        i = C2413R.id.box_content;
                        LinearLayout linearLayout3 = (LinearLayout) C8271.m4244(view, i);
                                                    ...
                                                    if (dialogScrollView != null) {
                                                        ...
                                                        if (space != null) {
                                                            ...
                                                            if (textView4 != null) {
                                                                ...
                                                                if (textView5 != null) {
                                                                    return new LayoutDialogxBottomMaterialDarkBinding(dialogXBaseRelativeLayout, maxRelativeLayout, relativeLayout, linearLayout, linearLayout2, linearLayout3, relativeLayout2, frameLayout, dialogXBaseRelativeLayout, textView, textView2, textView3, imageView, dialogScrollView, space, textView4, textView5);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @InterfaceC6391
    public static LayoutDialogxBottomMaterialDarkBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6391
    public static LayoutDialogxBottomMaterialDarkBinding inflate(@InterfaceC6391 LayoutInflater layoutInflater, @InterfaceC6490 ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C2413R.layout.layout_dialogx_bottom_material_dark, viewGroup, false);
        if (z) {
