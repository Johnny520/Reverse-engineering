...
public final class DexKitCacheBridge$RecyclableBridge$innerGetMethod$buildQuery$1$1 extends AbstractC5673 implements InterfaceC5122<FindMethod> {
    final /* synthetic */ FindMethod $query;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DexKitCacheBridge$RecyclableBridge$innerGetMethod$buildQuery$1$1(FindMethod findMethod) {
        super(0);
