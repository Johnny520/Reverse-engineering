...
public final class DexKitBridge$findMethod$res$1 extends AbstractC5673 implements InterfaceC5124<Long, byte[]> {
    final /* synthetic */ byte[] $encodeBytes;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DexKitBridge$findMethod$res$1(byte[] bArr) {
        super(1);
    ...
    public final byte[] invoke(long j) {
        return DexKitBridge.INSTANCE.nativeFindMethod(j, this.$encodeBytes);
    }
}
