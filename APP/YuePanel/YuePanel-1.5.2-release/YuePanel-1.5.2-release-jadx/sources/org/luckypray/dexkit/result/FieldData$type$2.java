...
public final class FieldData$type$2 extends AbstractC5673 implements InterfaceC5122<ClassData> {
    final /* synthetic */ DexKitBridge $bridge;
    final /* synthetic */ int $dexId;
    final /* synthetic */ FieldData this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FieldData$type$2(DexKitBridge dexKitBridge, FieldData fieldData, int i) {
        super(0);
    ...
    public final ClassData invoke() {
        ...
        return dexKitBridge.getTypeByIds$dexkit_android_release(new long[]{fieldData.getEncodeId(this.$dexId, fieldData.typeId)}).first();
    }
}
