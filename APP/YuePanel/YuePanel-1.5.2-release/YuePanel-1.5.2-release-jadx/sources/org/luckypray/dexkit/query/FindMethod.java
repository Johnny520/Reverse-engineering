...
public final class FindMethod extends BaseFinder {
    ...
    @InterfaceC6211(m2698d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0007¨\u0006\u0005"}, m2699d2 = {"Lorg/luckypray/dexkit/query/FindMethod$Companion;", "", "()V", "create", "Lorg/luckypray/dexkit/query/FindMethod;", "dexkit-android_release"}, m2700k = 1, m2701mv = {1, 5, 1}, m2703xi = 48)
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] (LINE:1) call: org.luckypray.dexkit.query.FindMethod.Companion.<init>():void type: THIS */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6399
    public final FindMethod excludePackages(@InterfaceC6399 String... excludePackages) {
    ...
    @InterfaceC6399
    public final FindMethod ignorePackagesCase(boolean ignorePackagesCase) {
    ...
    */
    public int innerBuild(@InterfaceC6399 FlatBufferBuilder fbb) {
        ...
        FindMethod.Companion companion = org.luckypray.dexkit.schema.FindMethod.INSTANCE;
        ...
        if (collection3 != null) {
            ...
            iCreateInClassesVector = jArrM11063 != null ? org.luckypray.dexkit.schema.FindMethod.INSTANCE.createInClassesVector(fbb, jArrM11063) : 0;
        }
        ...
        if (collection4 != null) {
            ...
            iCreateInMethodsVector = jArrM110632 != null ? org.luckypray.dexkit.schema.FindMethod.INSTANCE.createInMethodsVector(fbb, jArrM110632) : 0;
        }
        boolean z2 = this.findFirst;
        MethodMatcher methodMatcher = this.matcher;
        int iCreateFindMethod = companion.createFindMethod(fbb, iCreateVectorOfTables, iCreateVectorOfTables2, z, iCreateInClassesVector, iCreateInMethodsVector, z2, methodMatcher != null ? methodMatcher.build$dexkit_android_release(fbb) : 0);
        fbb.finish(iCreateFindMethod);
        return iCreateFindMethod;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6399
    public final FindMethod matcher(@InterfaceC6399 MethodMatcher matcher) {
    ...
    @InterfaceC6399
    public final FindMethod searchInClass(@InterfaceC6399 Collection<ClassData> classes) {
    ...
    @InterfaceC6399
    public final FindMethod searchInMethod(@InterfaceC6399 Collection<MethodData> methods) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @InterfaceC6399
    public final FindMethod searchPackages(@InterfaceC6399 String... searchPackages) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6399
    public final FindMethod excludePackages(@InterfaceC6399 Collection<String> excludePackages) {
        C5499.m17103(excludePackages, "excludePackages");
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    public final /* synthetic */ FindMethod matcher(InterfaceC5124 init) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    @InterfaceC6399
    public final FindMethod searchPackages(@InterfaceC6399 Collection<String> searchPackages) {
        C5499.m17103(searchPackages, "searchPackages");
