...
public final class DexKitCacheBridge$RecyclableBridge$innerGetField$1$1 extends AbstractC5673 implements InterfaceC5122<FindField> {
    final /* synthetic */ FindField $query;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DexKitCacheBridge$RecyclableBridge$innerGetField$1$1(FindField findField) {
        super(0);
