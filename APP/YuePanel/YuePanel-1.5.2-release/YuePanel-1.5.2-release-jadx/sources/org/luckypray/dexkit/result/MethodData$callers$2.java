...
public final class MethodData$callers$2 extends AbstractC5673 implements InterfaceC5122<MethodDataList> {
    ...
    public MethodData$callers$2(DexKitBridge dexKitBridge, MethodData methodData, int i, int i2) {
        super(0);
    ...
    public final MethodDataList invoke() {
        return this.$bridge.getCallMethods$dexkit_android_release(this.this$0.getEncodeId(this.$dexId, this.$id));
    }
}
