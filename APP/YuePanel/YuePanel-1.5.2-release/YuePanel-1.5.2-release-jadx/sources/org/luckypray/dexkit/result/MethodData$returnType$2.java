...
public final class MethodData$returnType$2 extends AbstractC5673 implements InterfaceC5122<ClassData> {
    final /* synthetic */ DexKitBridge $bridge;
    final /* synthetic */ int $dexId;
    final /* synthetic */ MethodData this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MethodData$returnType$2(DexKitBridge dexKitBridge, MethodData methodData, int i) {
        super(0);
    ...
    public final ClassData invoke() {
        ...
        return dexKitBridge.getTypeByIds$dexkit_android_release(new long[]{methodData.getEncodeId(this.$dexId, methodData.returnTypeId)}).firstOrNull();
    }
}
