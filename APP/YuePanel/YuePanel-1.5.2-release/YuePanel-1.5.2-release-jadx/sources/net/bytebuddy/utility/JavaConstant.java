...
public interface JavaConstant extends ConstantValue {
    ...
    public static /* synthetic */ class C29081 {
        ...
        static {
            ...
            try {
                f4232x3e733a24[MethodHandle.HandleType.GET_STATIC_FIELD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4232x3e733a24[MethodHandle.HandleType.PUT_FIELD.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4232x3e733a24[MethodHandle.HandleType.PUT_STATIC_FIELD.ordinal()] = 4;
    ...
    public static class Dynamic implements JavaConstant {
        ...
        public static JavaConstant ofArrayVarHandle(Class<?> cls) {
            return ofArrayVarHandle(TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        public static Dynamic ofNullConstant() {
            return new Dynamic(DEFAULT_NAME, TypeDescription.ForLoadedType.m5238of(Object.class), new MethodHandle(MethodHandle.HandleType.INVOKE_STATIC, JavaType.CONSTANT_BOOTSTRAPS.getTypeStub(), "nullConstant", TypeDescription.ForLoadedType.m5238of(Object.class), Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), TypeDescription.ForLoadedType.m5238of(String.class), TypeDescription.ForLoadedType.m5238of(Class.class))), Collections.emptyList());
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static JavaConstant ofPrimitiveType(Class<?> cls) {
            return ofPrimitiveType(TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        public Object toDescription() {
            ...
            return ofDynamicConstantDesc.ofCanonical(ofMethodHandleDesc.m5428of(objValueOf, ofClassDesc.ofDescriptor(this.bootstrap.getOwnerType().getDescriptor()), this.bootstrap.getName(), this.bootstrap.getDescriptor()), getName(), ofClassDesc.ofDescriptor(this.typeDescription.getDescriptor()), array);
        }
        ...
        public JavaConstant withType(Class<?> cls) {
            return withType(TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        public static JavaConstant ofEnumeration(EnumerationDescription enumerationDescription) {
            return new Dynamic(enumerationDescription.getValue(), enumerationDescription.getEnumerationType(), new MethodHandle(MethodHandle.HandleType.INVOKE_STATIC, JavaType.CONSTANT_BOOTSTRAPS.getTypeStub(), "enumConstant", TypeDescription.ForLoadedType.m5238of(Enum.class), Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), TypeDescription.ForLoadedType.m5238of(String.class), TypeDescription.ForLoadedType.m5238of(Class.class))), Collections.emptyList());
        }
        ...
        public static Dynamic ofField(FieldDescription.InDefinedShape inDefinedShape) {
            if (inDefinedShape.isStatic() && inDefinedShape.isFinal()) {
                ...
                return new Dynamic(inDefinedShape.getInternalName(), inDefinedShape.getType().asErasure(), new MethodHandle(MethodHandle.HandleType.INVOKE_STATIC, JavaType.CONSTANT_BOOTSTRAPS.getTypeStub(), "getStaticFinal", TypeDescription.ForLoadedType.m5238of(Object.class), zEquals ? Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), TypeDescription.ForLoadedType.m5238of(String.class), TypeDescription.ForLoadedType.m5238of(Class.class)) : Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), TypeDescription.ForLoadedType.m5238of(String.class), TypeDescription.ForLoadedType.m5238of(Class.class), TypeDescription.ForLoadedType.m5238of(Class.class))), zEquals ? Collections.emptyList() : Collections.singletonList(Simple.m5427of(inDefinedShape.getDeclaringType())));
            }
        ...
        public static JavaConstant ofPrimitiveType(TypeDescription typeDescription) {
            if (typeDescription.isPrimitive()) {
                return new Dynamic(typeDescription.getDescriptor(), TypeDescription.ForLoadedType.m5238of(Class.class), new MethodHandle(MethodHandle.HandleType.INVOKE_STATIC, JavaType.CONSTANT_BOOTSTRAPS.getTypeStub(), "primitiveClass", TypeDescription.ForLoadedType.m5238of(Class.class), Arrays.asList(JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), TypeDescription.ForLoadedType.m5238of(String.class), TypeDescription.ForLoadedType.m5238of(Class.class))), Collections.emptyList());
            }
        ...
        public static Dynamic bootstrap(String str, MethodDescription.InDefinedShape inDefinedShape, List<?> list) {
            ...
            if (str.length() != 0 && !str.contains(".")) {
                ...
                if (inDefinedShape.isConstantBootstrap(TypeList.Explicit.m5255of((List<? extends JavaConstant>) arrayList))) {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0083, code lost:
            ...
            r2 = net.bytebuddy.utility.CompoundList.m5412of(r13.getDeclaringType(), r13.getParameters().asTypeList().asErasures());
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:39:0x00aa, code lost:
            ...
            r2 = net.bytebuddy.utility.CompoundList.m5414of(r2.subList(0, r2.size() - 1), java.util.Collections.nCopies((r14.size() - r2.size()) + 1, ((net.bytebuddy.description.type.TypeDescription) r2.get(r2.size() - 1)).getComponentType())).iterator();
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:41:0x00dd, code lost:
            ...
            r5.add(net.bytebuddy.utility.JavaConstant.MethodHandle.m5418of(r13));
            r6 = r14.iterator();
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:54:0x0193, code lost:
            ...
            return new net.bytebuddy.utility.JavaConstant.Dynamic(net.bytebuddy.utility.JavaConstant.Dynamic.DEFAULT_NAME, r13, new net.bytebuddy.utility.JavaConstant.MethodHandle(net.bytebuddy.utility.JavaConstant.MethodHandle.HandleType.INVOKE_STATIC, net.bytebuddy.utility.JavaType.CONSTANT_BOOTSTRAPS.getTypeStub(), "invoke", net.bytebuddy.description.type.TypeDescription.ForLoadedType.m5238of(java.lang.Object.class), java.util.Arrays.asList(net.bytebuddy.utility.JavaType.METHOD_HANDLES_LOOKUP.getTypeStub(), net.bytebuddy.description.type.TypeDescription.ForLoadedType.m5238of(java.lang.String.class), net.bytebuddy.description.type.TypeDescription.ForLoadedType.m5238of(java.lang.Class.class), net.bytebuddy.utility.JavaType.METHOD_HANDLE.getTypeStub(), net.bytebuddy.description.type.TypeDescription.ArrayProjection.m5236of(net.bytebuddy.description.type.TypeDescription.ForLoadedType.m5238of(java.lang.Object.class)))), r5);
         */
    ...
    public static class MethodHandle implements JavaConstant {
        ...
        static {
            ...
            METHOD_HANDLE_INFO = (MethodHandleInfo) doPrivileged(JavaDispatcher.m5432of(MethodHandleInfo.class));
            METHOD_TYPE = (MethodType) doPrivileged(JavaDispatcher.m5432of(MethodType.class));
            METHOD_HANDLES = (MethodHandles) doPrivileged(JavaDispatcher.m5432of(MethodHandles.class));
            METHOD_HANDLES_LOOKUP = (MethodHandles.Lookup) doPrivileged(JavaDispatcher.m5432of(MethodHandles.Lookup.class));
        }
        ...
        public static MethodHandle m5417of(Method method) {
            return m5418of(new MethodDescription.ForLoadedMethod(method));
        }
        ...
        public static MethodHandle ofSpecial(Method method, Class<?> cls) {
            return ofSpecial(new MethodDescription.ForLoadedMethod(method), TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        public String getDescriptor() {
            int i = C29081.f4232x3e733a24[this.handleType.ordinal()];
            if (i == 1 || i == 2) {
        ...
        @Override // net.bytebuddy.utility.JavaConstant
        public Object toDescription() {
            return Simple.METHOD_HANDLE_DESC.m5428of(Simple.DIRECT_METHOD_HANDLE_DESC_KIND.valueOf(this.handleType.getIdentifier(), this.ownerType.isInterface()), Simple.CLASS_DESC.ofDescriptor(this.ownerType.getDescriptor()), this.name, getDescriptor());
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static MethodHandle m5416of(Constructor<?> constructor) {
            return m5418of(new MethodDescription.ForLoadedConstructor(constructor));
        }
        ...
        public static MethodHandle ofLoaded(Object obj, Object obj2) {
            ...
            HandleType handleTypeM5419of = HandleType.m5419of(methodHandleInfo.getReferenceKind(objRevealDirect));
            TypeDescription typeDescriptionM5238of = TypeDescription.ForLoadedType.m5238of(methodHandleInfo.getDeclaringClass(objRevealDirect));
            String name = methodHandleInfo.getName(objRevealDirect);
            MethodType methodType2 = METHOD_TYPE;
            return new MethodHandle(handleTypeM5419of, typeDescriptionM5238of, name, TypeDescription.ForLoadedType.m5238of(methodType2.returnType(methodType)), new TypeList.ForLoadedTypes(methodType2.parameterArray(methodType)));
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public static MethodHandle ofSetter(FieldDescription.InDefinedShape inDefinedShape) {
            return new MethodHandle(HandleType.ofSetter(inDefinedShape), inDefinedShape.getDeclaringType().asErasure(), inDefinedShape.getInternalName(), TypeDescription.ForLoadedType.m5238of(Void.TYPE), Collections.singletonList(inDefinedShape.getType().asErasure()));
        }
        ...
        /* JADX INFO: renamed from: of */
        public static MethodHandle m5418of(MethodDescription.InDefinedShape inDefinedShape) {
            return new MethodHandle(HandleType.m5420of(inDefinedShape), inDefinedShape.getDeclaringType().asErasure(), inDefinedShape.getInternalName(), inDefinedShape.getReturnType().asErasure(), inDefinedShape.getParameters().asTypeList().asErasures());
        }
        ...
        public enum HandleType {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX INFO: renamed from: of */
            public static HandleType m5420of(MethodDescription.InDefinedShape inDefinedShape) {
            ...
            /* JADX INFO: renamed from: of */
            public static HandleType m5419of(int i) {
    ...
    public static class MethodType implements JavaConstant {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static MethodType m5421of(Class<?> cls, Class<?>... clsArr) {
            return m5425of(TypeDescription.ForLoadedType.m5238of(cls), new TypeList.ForLoadedTypes(clsArr));
        }
        ...
        public static MethodType ofLoaded(Object obj) {
            if (JavaType.METHOD_TYPE.isInstance(obj)) {
                ...
                return m5421of(dispatcher.returnType(obj), dispatcher.parameterArray(obj));
            }
        ...
        public Object toDescription() {
            ...
            return Simple.METHOD_TYPE_DESC.m5429of(Simple.CLASS_DESC.ofDescriptor(this.returnType.getDescriptor()), array);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static MethodType m5426of(TypeDescription typeDescription, TypeDescription... typeDescriptionArr) {
            return new MethodType(typeDescription, Arrays.asList(typeDescriptionArr));
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public static MethodType ofConstant(Class<?> cls) {
            return ofConstant(TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        public static MethodType ofSetter(FieldDescription fieldDescription) {
            return new MethodType(TypeDescription.ForLoadedType.m5238of(Void.TYPE), fieldDescription.isStatic() ? Collections.singletonList(fieldDescription.getType().asErasure()) : Arrays.asList(fieldDescription.getDeclaringType().asErasure(), fieldDescription.getType().asErasure()));
        }
        ...
        /* JADX INFO: renamed from: of */
        public static MethodType m5425of(TypeDescription typeDescription, List<? extends TypeDescription> list) {
        ...
        /* JADX INFO: renamed from: of */
        public static MethodType m5423of(Method method) {
            return m5424of(new MethodDescription.ForLoadedMethod(method));
        }

        /* JADX INFO: renamed from: of */
        public static MethodType m5422of(Constructor<?> constructor) {
            return m5424of(new MethodDescription.ForLoadedConstructor(constructor));
        }

        /* JADX INFO: renamed from: of */
        public static MethodType m5424of(MethodDescription methodDescription) {
            List listAsErasures;
            ...
            if (!methodDescription.isStatic() && !methodDescription.isConstructor()) {
                listAsErasures = CompoundList.m5412of(methodDescription.getDeclaringType().asErasure(), methodDescription.getParameters().asTypeList().asErasures());
            } else {
                listAsErasures = methodDescription.getParameters().asTypeList().asErasures();
            }
            return new MethodType(typeDescriptionAsErasure, listAsErasures);
        }
    }
    ...
    public static abstract class Simple<T> implements JavaConstant {
        ...
        public interface Dispatcher {
            ...
            public interface OfMethodHandleDesc extends Dispatcher {
                ...
                /* JADX INFO: renamed from: of */
                Object m5428of(@JavaDispatcher.Proxied("java.lang.constant.DirectMethodHandleDesc$Kind") Object obj, @JavaDispatcher.Proxied("java.lang.constant.ClassDesc") Object obj2, String str, String str2);
            }
            ...
            public interface OfMethodTypeDesc extends Dispatcher {
                ...
                @JavaDispatcher.Proxied("of")
                /* JADX INFO: renamed from: of */
                Object m5429of(@JavaDispatcher.Proxied("java.lang.constant.ClassDesc") Object obj, @JavaDispatcher.Proxied("java.lang.constant.ClassDesc") Object[] objArr);
        ...
        public static abstract class OfTrivialValue<S> extends Simple<S> {
            ...
            public static class ForDouble extends OfTrivialValue<Double> {
                public ForDouble(Double d) {
                    super(d, TypeDescription.ForLoadedType.m5238of(Double.TYPE));
                }
            ...
            public static class ForFloat extends OfTrivialValue<Float> {
                public ForFloat(Float f) {
                    super(f, TypeDescription.ForLoadedType.m5238of(Float.TYPE));
                }
            ...
            public static class ForInteger extends OfTrivialValue<Integer> {
                public ForInteger(Integer num) {
                    super(num, TypeDescription.ForLoadedType.m5238of(Integer.TYPE));
                }
            ...
            public static class ForLong extends OfTrivialValue<Long> {
                public ForLong(Long l) {
                    super(l, TypeDescription.ForLoadedType.m5238of(Long.TYPE));
                }
            ...
            public static class ForString extends OfTrivialValue<String> {
                public ForString(String str) {
                    super(str, TypeDescription.ForLoadedType.m5238of(String.class));
                }
        ...
        public static class OfTypeDescription extends Simple<TypeDescription> {
            public OfTypeDescription(TypeDescription typeDescription) {
                super(typeDescription, TypeDescription.ForLoadedType.m5238of(Class.class));
            }
            ...
            @Override // net.bytebuddy.utility.ConstantValue
            public StackManipulation toStackManipulation() {
                return ClassConstant.m5380of((TypeDescription) this.value);
            }
        }
        ...
        static {
            ...
            CONSTANT_DESC = (Dispatcher) doPrivileged(JavaDispatcher.m5432of(Dispatcher.class));
            CLASS_DESC = (Dispatcher.OfClassDesc) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfClassDesc.class));
            METHOD_TYPE_DESC = (Dispatcher.OfMethodTypeDesc) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfMethodTypeDesc.class));
            METHOD_HANDLE_DESC = (Dispatcher.OfMethodHandleDesc) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfMethodHandleDesc.class));
            DIRECT_METHOD_HANDLE_DESC = (Dispatcher.OfDirectMethodHandleDesc) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfDirectMethodHandleDesc.class));
            DIRECT_METHOD_HANDLE_DESC_KIND = (Dispatcher.OfDirectMethodHandleDesc.ForKind) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfDirectMethodHandleDesc.ForKind.class));
            DYNAMIC_CONSTANT_DESC = (Dispatcher.OfDynamicConstantDesc) doPrivileged(JavaDispatcher.m5432of(Dispatcher.OfDynamicConstantDesc.class));
        }
        ...
        /* JADX INFO: renamed from: of */
        public static JavaConstant m5427of(TypeDescription typeDescription) {
            if (!typeDescription.isPrimitive()) {
        ...
        public static JavaConstant ofDescription(Object obj, @MaybeNull ClassLoader classLoader) {
            return ofDescription(obj, ClassFileLocator.ForClassLoader.m5258of(classLoader));
        }
        ...
        public static JavaConstant ofLoadedOrNull(Object obj) {
            ...
            if (obj instanceof Class) {
                return m5427of(TypeDescription.ForLoadedType.m5238of((Class) obj));
            }
            if (JavaType.METHOD_HANDLE.isInstance(obj)) {
        ...
        public static JavaConstant wrap(Object obj) {
            return obj instanceof JavaConstant ? (JavaConstant) obj : obj instanceof TypeDescription ? m5427of((TypeDescription) obj) : ofLoaded(obj);
        }
        ...
        public static JavaConstant ofDescription(Object obj, ClassFileLocator classFileLocator) {
            return ofDescription(obj, TypePool.Default.WithLazyResolution.m5411of(classFileLocator));
        }
        ...
        public static JavaConstant ofDescription(Object obj, TypePool typePool) {
            ...
            if (ofClassDesc.isInstance(obj)) {
                ...
                return m5427of(typePool.describe(className7).resolve());
            }
            ...
            if (ofMethodTypeDesc.isInstance(obj)) {
                ...
                return MethodType.m5425of(typePool.describe(className5).resolve(), arrayList);
            }
            ...
            if (ofDirectMethodHandleDesc.isInstance(obj)) {
                ...
                MethodHandle.HandleType handleTypeM5419of = MethodHandle.HandleType.m5419of(ofDirectMethodHandleDesc2.refKind(obj));
                ...
                if (ofDirectMethodHandleDesc2.refKind(obj) == 8) {
                    typeDescriptionResolve = TypeDescription.ForLoadedType.m5238of(Void.TYPE);
                } else {
                ...
                return new MethodHandle(handleTypeM5419of, typeDescriptionResolve2, strMethodName, typeDescriptionResolve, arrayList2);
            }
            ...
            if (ofDynamicConstantDesc.isInstance(obj)) {
                ...
                MethodHandle.HandleType handleTypeM5419of2 = MethodHandle.HandleType.m5419of(ofDirectMethodHandleDesc3.refKind(ofDynamicConstantDesc2.bootstrapMethod(obj)));
                ...
                return new Dynamic(strConstantName, typeDescriptionResolve3, new MethodHandle(handleTypeM5419of2, typeDescriptionResolve4, strMethodName2, typePool.describe(className2).resolve(), arrayList3), arrayList4);
            }
    ...
    public interface Visitor<T> {
        ...
        public enum NoOp implements Visitor<JavaConstant> {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: onDynamic(Lnet/bytebuddy/utility/JavaConstant$Dynamic;)Ljava/lang/Object; */
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: onMethodHandle(Lnet/bytebuddy/utility/JavaConstant$MethodHandle;)Ljava/lang/Object; */
            @Override // net.bytebuddy.utility.JavaConstant.Visitor
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: onMethodType(Lnet/bytebuddy/utility/JavaConstant$MethodType;)Ljava/lang/Object; */
            @Override // net.bytebuddy.utility.JavaConstant.Visitor
