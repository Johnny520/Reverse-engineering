...
public class JavaModule implements NamedElement.WithOptionalName, AnnotationSource {
    ...
    static {
        ...
        UNSUPPORTED = null;
        RESOLVER = (Resolver) doPrivileged(JavaDispatcher.m5432of(Resolver.class));
        MODULE = (Module) doPrivileged(JavaDispatcher.m5432of(Module.class));
    }
    ...
    public static JavaModule m5430of(Object obj) {
