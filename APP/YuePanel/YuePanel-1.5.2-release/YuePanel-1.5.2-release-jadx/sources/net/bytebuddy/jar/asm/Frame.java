        ...
        if (i == UNINITIALIZED_THIS || (i3 = (-4194304) & i) == UNINITIALIZED_KIND || i3 == 16777216) {
            for (int i4 = 0; i4 < this.initializationCount; i4++) {
                ...
                if (i7 == LOCAL_KIND) {
                    ...
                    if (i != i5) {
                        return (i == UNINITIALIZED_THIS ? symbolTable.addType(symbolTable.getClassName()) : symbolTable.addType(symbolTable.getType(i & VALUE_MASK).value)) | 8388608;
                    }
                }
                i5 = i2 + i6;
                if (i != i5) {
            ...
            case 18:
                ...
                switch (i3) {
                    ...
                    case 6:
                        ...
                        return;
                    case 7:
                        push(symbolTable.addType(TypeProxy.SilentConstruction.Appender.JAVA_LANG_CLASS_INTERNAL_NAME) | 8388608);
                        return;
                    case 8:
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 189:
                                        ...
                                        push(symbolTable, TypePool.Default.LazyTypeDescription.GenericTypeToken.COMPONENT_TYPE_PATH + str);
                                        return;
                                    case 192:
