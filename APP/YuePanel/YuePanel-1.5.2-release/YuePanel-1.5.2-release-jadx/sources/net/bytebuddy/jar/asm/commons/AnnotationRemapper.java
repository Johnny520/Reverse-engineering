...
public class AnnotationRemapper extends AnnotationVisitor {
    ...
    public final AnnotationVisitor orDeprecatedValue(AnnotationVisitor annotationVisitor) {
        if (annotationVisitor.getClass() == getClass()) {
            ...
            if (annotationRemapper.api == this.api && annotationRemapper.f4224av == this.f4224av && annotationRemapper.remapper == this.remapper) {
                return this;
            }
        }
    ...
    public AnnotationVisitor visitAnnotation(String str, String str2) {
        ...
        return annotationVisitorVisitAnnotation == this.f4224av ? this : createAnnotationRemapper(str2, annotationVisitorVisitAnnotation);
    }
    ...
    public AnnotationVisitor visitArray(String str) {
        ...
        return annotationVisitorVisitArray == this.f4224av ? this : createAnnotationRemapper(null, annotationVisitorVisitArray);
    }
