...
public abstract class Remapper {
    ...
    public Object mapValue(Object obj) {
        ...
        if (obj instanceof Handle) {
            ...
            return new Handle(handle.getTag(), mapType(handle.getOwner()), i != 0 ? mapFieldName(handle.getOwner(), handle.getName(), handle.getDesc()) : mapMethodName(handle.getOwner(), handle.getName(), handle.getDesc()), i != 0 ? mapDesc(handle.getDesc()) : mapMethodDesc(handle.getDesc()), handle.isInterface());
        }
