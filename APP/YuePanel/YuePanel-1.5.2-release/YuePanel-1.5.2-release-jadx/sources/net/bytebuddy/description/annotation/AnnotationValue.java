...
public interface AnnotationValue<T, S> {
    ...
    public static class ForAnnotationDescription<U extends Annotation> extends AbstractBase<AnnotationDescription, U> {
        ...
        public static class Loaded<V extends Annotation> extends Loaded.AbstractBase<V> {
            ...
            /* JADX DEBUG: Method merged with bridge method: resolve()Ljava/lang/Object; */
            @Override // net.bytebuddy.description.annotation.AnnotationValue.Loaded
            public V resolve() {
        ...
        public static <V extends Annotation> AnnotationValue<AnnotationDescription, V> m5200of(TypeDescription typeDescription, Map<String, ? extends AnnotationValue<?, ?>> map) {
    ...
    public static class ForConstant<U> extends AbstractBase<U, U> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Boolean, Boolean> m5210of(boolean z) {
        ...
        public AnnotationValue<U, U> filter(MethodDescription.InDefinedShape inDefinedShape, TypeDefinition typeDefinition) {
            ...
            if (this.value.getClass().isArray()) {
                return new ForMismatchedType(inDefinedShape, RenderingDispatcher.CURRENT.toArrayErrorString(Sort.m5225of(TypeDescription.ForLoadedType.m5238of(this.value.getClass().getComponentType()))));
            }
        ...
        @Override // net.bytebuddy.description.annotation.AnnotationValue
        public Sort getSort() {
            return Sort.m5225of(TypeDescription.ForLoadedType.m5238of(this.value.getClass()).asUnboxed());
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Byte, Byte> m5201of(byte b) {
            return new ForConstant(Byte.valueOf(b), PropertyDelegate.ForNonArrayType.BYTE);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Short, Short> m5209of(short s) {
            return new ForConstant(Short.valueOf(s), PropertyDelegate.ForNonArrayType.SHORT);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Character, Character> m5202of(char c) {
            return new ForConstant(Character.valueOf(c), PropertyDelegate.ForNonArrayType.CHARACTER);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Integer, Integer> m5205of(int i) {
            return new ForConstant(Integer.valueOf(i), PropertyDelegate.ForNonArrayType.INTEGER);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Long, Long> m5206of(long j) {
            return new ForConstant(Long.valueOf(j), PropertyDelegate.ForNonArrayType.LONG);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Float, Float> m5204of(float f) {
            return new ForConstant(Float.valueOf(f), PropertyDelegate.ForNonArrayType.FLOAT);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<Double, Double> m5203of(double d) {
            return new ForConstant(Double.valueOf(d), PropertyDelegate.ForNonArrayType.DOUBLE);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<String, String> m5208of(String str) {
            return new ForConstant(str, PropertyDelegate.ForNonArrayType.STRING);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<boolean[], boolean[]> m5219of(boolean... zArr) {
            return new ForConstant(zArr, PropertyDelegate.ForArrayType.BOOLEAN);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<byte[], byte[]> m5211of(byte... bArr) {
            return new ForConstant(bArr, PropertyDelegate.ForArrayType.BYTE);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<short[], short[]> m5218of(short... sArr) {
            return new ForConstant(sArr, PropertyDelegate.ForArrayType.SHORT);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<char[], char[]> m5212of(char... cArr) {
            return new ForConstant(cArr, PropertyDelegate.ForArrayType.CHARACTER);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<int[], int[]> m5215of(int... iArr) {
            return new ForConstant(iArr, PropertyDelegate.ForArrayType.INTEGER);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<long[], long[]> m5216of(long... jArr) {
            return new ForConstant(jArr, PropertyDelegate.ForArrayType.LONG);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<float[], float[]> m5214of(float... fArr) {
            return new ForConstant(fArr, PropertyDelegate.ForArrayType.FLOAT);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<double[], double[]> m5213of(double... dArr) {
            return new ForConstant(dArr, PropertyDelegate.ForArrayType.DOUBLE);
        }

        /* JADX INFO: renamed from: of */
        public static AnnotationValue<String[], String[]> m5217of(String... strArr) {
            return new ForConstant(strArr, PropertyDelegate.ForArrayType.STRING);
        }

        /* JADX DEBUG: Type inference failed for r3v11. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<int[], int[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v13. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<char[], char[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v15. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<short[], short[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v17. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<byte[], byte[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v19. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<boolean[], boolean[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v3. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<java.lang.String[], java.lang.String[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v5. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<double[], double[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v7. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<float[], float[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX DEBUG: Type inference failed for r3v9. Raw type applied. Possible types: net.bytebuddy.description.annotation.AnnotationValue<long[], long[]>, net.bytebuddy.description.annotation.AnnotationValue<?, ?> */
        /* JADX INFO: renamed from: of */
        public static AnnotationValue<?, ?> m5207of(Object obj) {
            if (obj instanceof Boolean) {
                return m5210of(((Boolean) obj).booleanValue());
            }
            if (obj instanceof Byte) {
                return m5201of(((Byte) obj).byteValue());
            }
            if (obj instanceof Short) {
                return m5209of(((Short) obj).shortValue());
            }
            if (obj instanceof Character) {
                return m5202of(((Character) obj).charValue());
            }
            if (obj instanceof Integer) {
                return m5205of(((Integer) obj).intValue());
            }
            if (obj instanceof Long) {
                return m5206of(((Long) obj).longValue());
            }
            if (obj instanceof Float) {
                return m5204of(((Float) obj).floatValue());
            }
            if (obj instanceof Double) {
                return m5203of(((Double) obj).doubleValue());
            }
            if (obj instanceof String) {
                return m5208of((String) obj);
            }
            if (obj instanceof boolean[]) {
                return m5219of((boolean[]) obj);
            }
            if (obj instanceof byte[]) {
                return m5211of((byte[]) obj);
            }
            if (obj instanceof short[]) {
                return m5218of((short[]) obj);
            }
            if (obj instanceof char[]) {
                return m5212of((char[]) obj);
            }
            if (obj instanceof int[]) {
                return m5215of((int[]) obj);
            }
            if (obj instanceof long[]) {
                return m5216of((long[]) obj);
            }
            if (obj instanceof float[]) {
                return m5214of((float[]) obj);
            }
            if (obj instanceof double[]) {
                return m5213of((double[]) obj);
            }
            if (obj instanceof String[]) {
                return m5217of((String[]) obj);
            }
    ...
    public static class ForEnumerationDescription<U extends Enum<U>> extends AbstractBase<EnumerationDescription, U> {
        ...
        /* JADX INFO: renamed from: of */
        public static <V extends Enum<V>> AnnotationValue<EnumerationDescription, V> m5223of(EnumerationDescription enumerationDescription) {
    ...
    public static class ForMismatchedType<U, V> extends AbstractBase<U, V> {
        ...
        public Loaded<V> load(@MaybeNull ClassLoader classLoader) {
            try {
                ...
                try {
                    return new Loaded(cls.getMethod(this.property.getName(), null), this.value);
    ...
    public static class ForTypeDescription<U extends Class<U>> extends AbstractBase<TypeDescription, U> {
        ...
        public static class Loaded<U extends Class<U>> extends Loaded.AbstractBase<U> {
            ...
            public String toString() {
                return RenderingDispatcher.CURRENT.toSourceString(TypeDescription.ForLoadedType.m5238of(this.type));
            }
        ...
        static {
            ...
            for (int i = 0; i < 9; i++) {
                Class<?> cls = clsArr[i];
                PRIMITIVE_TYPES.put(TypeDescription.ForLoadedType.m5238of(cls), cls);
            }
        }
        ...
        /* JADX INFO: renamed from: of */
        public static <V extends Class<V>> AnnotationValue<TypeDescription, V> m5224of(TypeDescription typeDescription) {
    ...
    public static abstract class RenderingDispatcher {
        ...
        static {
            ...
            RenderingDispatcher renderingDispatcher5 = new RenderingDispatcher("JAVA_19_CAPABLE_VM", 4, c4, c3, classFileVersionOfThisVm.isLessThan(classFileVersion2)) { // from class: net.bytebuddy.description.annotation.AnnotationValue.RenderingDispatcher.5
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                @Override // net.bytebuddy.description.annotation.AnnotationValue.RenderingDispatcher
                public String toSourceString(byte b) {
                    return "(byte)0x" + Integer.toHexString(b & 255);
    ...
    public enum Sort {
        ...
        /* JADX INFO: renamed from: of */
        public static Sort m5225of(TypeDefinition typeDefinition) {
    ...
    public static class ForDescriptionArray<U, V> extends AbstractBase<U, V> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static <W extends Enum<W>> AnnotationValue<EnumerationDescription[], W[]> m5221of(TypeDescription typeDescription, EnumerationDescription[] enumerationDescriptionArr) {
            ...
            for (EnumerationDescription enumerationDescription : enumerationDescriptionArr) {
                ...
                arrayList.add(ForEnumerationDescription.m5223of(enumerationDescription));
            }
        ...
        public AnnotationValue<U, V> filter(MethodDescription.InDefinedShape inDefinedShape, TypeDefinition typeDefinition) {
            if (!typeDefinition.isArray() || !typeDefinition.getComponentType().asErasure().equals(this.componentType)) {
                return new ForMismatchedType(inDefinedShape, RenderingDispatcher.CURRENT.toArrayErrorString(Sort.m5225of(this.componentType)));
            }
            Iterator<? extends AnnotationValue<?, ?>> it = this.values.iterator();
            while (it.hasNext()) {
        ...
        /* JADX INFO: renamed from: of */
        public static <W extends Annotation> AnnotationValue<AnnotationDescription[], W[]> m5220of(TypeDescription typeDescription, AnnotationDescription[] annotationDescriptionArr) {
        ...
        /* JADX INFO: renamed from: of */
        public static AnnotationValue<TypeDescription[], Class<?>[]> m5222of(TypeDescription[] typeDescriptionArr) {
            ArrayList arrayList = new ArrayList(typeDescriptionArr.length);
            for (TypeDescription typeDescription : typeDescriptionArr) {
                arrayList.add(ForTypeDescription.m5224of(typeDescription));
            }
            return new ForDescriptionArray(TypeDescription.class, TypeDescription.ForLoadedType.m5238of(Class.class), arrayList);
        }
    }
}
