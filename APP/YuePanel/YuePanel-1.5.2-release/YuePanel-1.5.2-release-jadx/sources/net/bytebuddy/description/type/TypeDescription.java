...
public interface TypeDescription extends TypeDefinition, ByteCodeElement, TypeVariableSource {
    ...
    @Deprecated
    public static final TypeDescription OBJECT = LazyProxy.m5254of(Object.class);

    @Deprecated
    public static final TypeDescription STRING = LazyProxy.m5254of(String.class);

    @Deprecated
    public static final TypeDescription CLASS = LazyProxy.m5254of(Class.class);

    @Deprecated
    public static final TypeDescription THROWABLE = LazyProxy.m5254of(Throwable.class);

    @Deprecated
    public static final TypeDescription VOID = LazyProxy.m5254of(Void.TYPE);
    ...
    public static abstract class AbstractBase extends TypeVariableSource.AbstractBase implements TypeDescription {
        ...
        public static abstract class OfSimpleType extends AbstractBase {
            ...
            */
            public String getSimpleName() {
                ...
                if (enclosingType != null) {
                    if (internalName.startsWith(enclosingType.getInternalName() + "$")) {
                        ...
                        iLastIndexOf++;
                        if (iLastIndexOf < internalName.length() || Character.isLetter(internalName.charAt(iLastIndexOf))) {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
            /* JADX DEBUG: Method merged with bridge method: getComponentType()Lnet/bytebuddy/description/type/TypeDefinition; */
            @Override // net.bytebuddy.description.type.TypeDefinition
            @MaybeNull
        ...
        public TypeDescription asBoxed() {
            return represents(Boolean.TYPE) ? ForLoadedType.m5238of(Boolean.class) : represents(Byte.TYPE) ? ForLoadedType.m5238of(Byte.class) : represents(Short.TYPE) ? ForLoadedType.m5238of(Short.class) : represents(Character.TYPE) ? ForLoadedType.m5238of(Character.class) : represents(Integer.TYPE) ? ForLoadedType.m5238of(Integer.class) : represents(Long.TYPE) ? ForLoadedType.m5238of(Long.class) : represents(Float.TYPE) ? ForLoadedType.m5238of(Float.class) : represents(Double.TYPE) ? ForLoadedType.m5238of(Double.class) : this;
        }
        ...
        public TypeDescription asUnboxed() {
            return represents(Boolean.class) ? ForLoadedType.m5238of(Boolean.TYPE) : represents(Byte.class) ? ForLoadedType.m5238of(Byte.TYPE) : represents(Short.class) ? ForLoadedType.m5238of(Short.TYPE) : represents(Character.class) ? ForLoadedType.m5238of(Character.TYPE) : represents(Integer.class) ? ForLoadedType.m5238of(Integer.TYPE) : represents(Long.class) ? ForLoadedType.m5238of(Long.TYPE) : represents(Float.class) ? ForLoadedType.m5238of(Float.TYPE) : represents(Double.class) ? ForLoadedType.m5238of(Double.TYPE) : this;
        }
        ...
        public String getGenericSignature() {
            try {
                ...
                if (superClass == null) {
                    superClass = Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class);
                }
        ...
        public AnnotationList getInheritedAnnotations() {
            ...
            return new AnnotationList.Explicit((List<? extends AnnotationDescription>) CompoundList.m5414of((List) declaredAnnotations, (List) superClass.asErasure().getInheritedAnnotations().inherited(hashSet)));
        }
        ...
        public boolean isAssignableFrom(Class<?> cls) {
            return isAssignableFrom(ForLoadedType.m5238of(cls));
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        @Override // net.bytebuddy.description.type.TypeDescription
        public boolean isAssignableTo(Class<?> cls) {
            return isAssignableTo(ForLoadedType.m5238of(cls));
        }
        ...
        public boolean isNestMateOf(Class<?> cls) {
            return isNestMateOf(ForLoadedType.m5238of(cls));
        }
    ...
    public static class ArrayProjection extends AbstractBase {
        ...
        public static TypeDescription m5236of(TypeDescription typeDescription) {
            return m5237of(typeDescription, 1);
        }
        ...
        @MaybeNull
        public Generic getSuperClass() {
            return Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class);
        }
        ...
        @SuppressFBWarnings(justification = "Assuming component type for array type.", value = {"NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE"})
        /* JADX INFO: renamed from: of */
        public static TypeDescription m5237of(TypeDescription typeDescription, int i) {
            if (i < 0) {
    ...
    public static class ForLoadedType extends AbstractBase implements Serializable {
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m5238of(Class<?> cls) {
        ...
        public Generic asGenericType() {
            return Generic.OfNonGenericType.ForLoadedType.m5245of(this.type);
        }
        ...
        @MaybeNull
        public ClassFileVersion getClassFileVersion() {
            ClassFileVersion classFileVersionM5114of = null;
            if (this.classFileVersion == null) {
                try {
                    classFileVersionM5114of = ClassFileVersion.m5114of(this.type);
                } catch (Throwable unused) {
                }
            }
            if (classFileVersionM5114of == null) {
                return this.classFileVersion;
            }
            this.classFileVersion = classFileVersionM5114of;
            return classFileVersionM5114of;
        }
        ...
        public TypeDescription getEnclosingType() {
            ...
            return enclosingClass == null ? TypeDescription.UNDEFINED : m5238of(enclosingClass);
        }
        ...
        public TypeDescription getNestHost() {
            ...
            return nestHost == null ? this : m5238of(nestHost);
        }
        ...
        @Override // net.bytebuddy.description.type.TypeDefinition
        public StackSize getStackSize() {
            return StackSize.m5374of(this.type);
        }

        @Override // net.bytebuddy.description.type.TypeDefinition
        @MaybeNull
        public Generic getSuperClass() {
            return AbstractBase.RAW_TYPES ? this.type.getSuperclass() == null ? Generic.UNDEFINED : Generic.OfNonGenericType.ForLoadedType.m5245of(this.type.getSuperclass()) : Generic.LazyProjection.ForLoadedSuperClass.m5241of(this.type);
        }

        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return AbstractBase.RAW_TYPES ? new TypeList.Generic.Empty() : TypeList.Generic.ForLoadedTypes.OfTypeVariables.m5256of((GenericDeclaration) this.type);
        }
        ...
        @Override // net.bytebuddy.description.type.TypeDescription.AbstractBase, net.bytebuddy.description.type.TypeDescription
        public boolean isNestMateOf(Class<?> cls) {
            return DISPATCHER.isNestmateOf(this.type, cls) || super.isNestMateOf(m5238of(cls));
        }
        ...
        public TypeDescription getComponentType() {
            ...
            return componentType == null ? TypeDescription.UNDEFINED : m5238of(componentType);
        }
        ...
        public TypeDescription getDeclaringType() {
            ...
            return declaringClass == null ? TypeDescription.UNDEFINED : m5238of(declaringClass);
        }
    ...
    public interface Generic extends TypeDefinition, AnnotationSource {
        ...
        @Deprecated
        public static final Generic OBJECT = LazyProxy.m5244of(Object.class);

        @Deprecated
        public static final Generic CLASS = LazyProxy.m5244of(Class.class);

        @Deprecated
        public static final Generic VOID = LazyProxy.m5244of(Void.TYPE);

        @Deprecated
        public static final Generic ANNOTATION = LazyProxy.m5244of(Annotation.class);
        ...
        public interface AnnotationReader {
            ...
            public static abstract class Delegator implements AnnotationReader {
                ...
                public static class ForLoadedExecutableExceptionType extends Delegator {
                    protected static final Dispatcher DISPATCHER = (Dispatcher) Delegator.doPrivileged(JavaDispatcher.m5432of(Dispatcher.class));
            ...
            public static class ForComponentType extends Delegator.Chained {
                private static final AnnotatedParameterizedType ANNOTATED_PARAMETERIZED_TYPE = (AnnotatedParameterizedType) Delegator.doPrivileged(JavaDispatcher.m5432of(AnnotatedParameterizedType.class));
            ...
            public static class ForOwnerType extends Delegator.Chained {
                private static final AnnotatedType ANNOTATED_TYPE = (AnnotatedType) Delegator.doPrivileged(JavaDispatcher.m5432of(AnnotatedType.class));
            ...
            public static class ForTypeVariableBoundType extends Delegator.Chained {
                private static final AnnotatedTypeVariable ANNOTATED_TYPE_VARIABLE = (AnnotatedTypeVariable) Delegator.doPrivileged(JavaDispatcher.m5432of(AnnotatedTypeVariable.class));
                private final int index;
                ...
                public static class OfFormalTypeVariable extends Delegator {
                    private static final FormalTypeVariable TYPE_VARIABLE = (FormalTypeVariable) Delegator.doPrivileged(JavaDispatcher.m5432of(FormalTypeVariable.class));
                    private final int index;
                    private final TypeVariable<?> typeVariable;
            ...
            public static class ForWildcardLowerBoundType extends Delegator.Chained {
                private static final AnnotatedWildcardType ANNOTATED_WILDCARD_TYPE = (AnnotatedWildcardType) Delegator.doPrivileged(JavaDispatcher.m5432of(AnnotatedWildcardType.class));
                private final int index;
        ...
        public static abstract class Builder {
            ...
            public static class OfGenericArrayType extends Builder {
                ...
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfGenericArrayType(this.componentType, CompoundList.m5414of((List) this.annotations, (List) list));
                }
            ...
            public static class OfNonGenericType extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfNonGenericType(this.typeDescription, this.ownerType, CompoundList.m5414of((List) this.annotations, (List) list));
                }
                ...
                */
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iHashCode = ((super.hashCode() * 31) + this.typeDescription.hashCode()) * 31;
                    Generic generic = this.ownerType;
            ...
            public static class OfParameterizedType extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfParameterizedType(this.rawType, this.ownerType, this.parameterTypes, CompoundList.m5414of((List) this.annotations, (List) list));
                }
                ...
                */
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iHashCode = ((super.hashCode() * 31) + this.rawType.hashCode()) * 31;
                    Generic generic = this.ownerType;
                    if (generic != null) {
                        iHashCode += generic.hashCode();
                    }
                    return (iHashCode * 31) + this.parameterTypes.hashCode();
                }
            ...
            public static class OfTypeVariable extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfTypeVariable(this.symbol, CompoundList.m5414of((List) this.annotations, (List) list));
                }
            ...
            public enum Visitor implements Visitor<Builder> {
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: onGenericArray(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Object; */
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: onNonGenericType(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Object; */
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
                @SuppressFBWarnings(justification = "Assuming component type for array type.", value = {"NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE"})
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: onParameterizedType(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Object; */
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: onTypeVariable(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Object; */
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: onWildcard(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Object; */
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX INFO: renamed from: of */
            public static Builder m5239of(Type type) {
                return m5240of(TypeDefinition.Sort.describe(type));
            }
            ...
            public static Builder rawType(Class<?> cls) {
                return rawType(ForLoadedType.m5238of(cls));
            }
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
            /* JADX INFO: renamed from: of */
            public static Builder m5240of(Generic generic) {
            ...
            public static Builder parameterizedType(Class<?> cls, @MaybeNull Type type, List<? extends Type> list) {
                return parameterizedType(ForLoadedType.m5238of(cls), type == null ? null : TypeDefinition.Sort.describe(type), new TypeList.Generic.ForLoadedTypes(list));
            }

            public static Builder rawType(Class<?> cls, @MaybeNull Generic generic) {
                return rawType(ForLoadedType.m5238of(cls), generic);
            }
        ...
        public static abstract class LazyProjection extends AbstractBase {
            ...
            public static class ForLoadedFieldType extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(this.field.getType());
                }
            ...
            public static class ForLoadedReturnType extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(this.method.getReturnType());
                }
            ...
            public static class ForLoadedSuperClass extends WithLazyNavigation.OfAnnotatedElement {
                ...
                @MaybeNull
                /* JADX INFO: renamed from: of */
                public static Generic m5241of(Class<?> cls) {
                    return cls.getSuperclass() == null ? Generic.UNDEFINED : new ForLoadedSuperClass(cls);
                }

                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(this.type.getSuperclass());
                }
            ...
            public static class OfConstructorParameter extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(this.erasure[this.index]);
                }
                ...
                public Generic resolve() {
                    ...
                    if (this.delegate != null) {
                        ...
                        genericDescribe = clsArr.length == genericParameterTypes.length ? TypeDefinition.Sort.describe(genericParameterTypes[this.index], getAnnotationReader()) : OfNonGenericType.ForLoadedType.m5245of(clsArr[this.index]);
                    }
                    if (genericDescribe == null) {
            ...
            public static class OfRecordComponent extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(RecordComponentDescription.ForLoadedRecordComponent.RECORD_COMPONENT.getType(this.recordComponent));
                }
            ...
            public static abstract class WithLazyNavigation extends LazyProjection {
                ...
                public static class LazyInterfaceList extends TypeList.Generic.AbstractBase {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static TypeList.Generic m5242of(LazyProjection lazyProjection) {
                ...
                public static class LazySuperClass extends WithLazyNavigation {
                    ...
                    @MaybeNull
                    /* JADX INFO: renamed from: of */
                    public static Generic m5243of(LazyProjection lazyProjection) {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeList.Generic getInterfaces() {
                    return LazyInterfaceList.m5242of((LazyProjection) this);
                }

                @Override // net.bytebuddy.description.type.TypeDefinition
                @MaybeNull
                public Generic getSuperClass() {
                    return LazySuperClass.m5243of(this);
                }
        ...
        public static class LazyProxy implements InvocationHandler {
            ...
            /* JADX INFO: renamed from: of */
            public static Generic m5244of(Class<?> cls) {
            ...
            public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) throws Throwable {
                try {
                    return method.invoke(OfNonGenericType.ForLoadedType.m5245of(this.type), objArr);
        ...
        public static abstract class OfGenericArray extends AbstractBase {
            ...
            @SuppressFBWarnings(justification = "Assuming component type for array type.", value = {"NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE"})
            public TypeDescription asErasure() {
                return ArrayProjection.m5237of(getComponentType().asErasure(), 1);
            }
            ...
            @MaybeNull
            public Generic getSuperClass() {
                return OfNonGenericType.ForLoadedType.m5245of(Object.class);
            }
            ...
            public String toString() {
                ...
                return getComponentType().getTypeName() + C5385.f13236;
            }
        }
        ...
        public static abstract class OfNonGenericType extends AbstractBase {
            ...
            public static class ForLoadedType extends OfNonGenericType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m5245of(Class<?> cls) {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of(this.type);
                }
            ...
            public static class ForReifiedErasure extends OfNonGenericType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m5246of(TypeDescription typeDescription) {
                ...
                public Generic getOwnerType() {
                    TypeDescription declaringType = this.typeDescription.getDeclaringType();
                    return declaringType == null ? Generic.UNDEFINED : m5246of(declaringType);
                }
                ...
                public Generic getComponentType() {
                    TypeDescription componentType = this.typeDescription.getComponentType();
                    return componentType == null ? Generic.UNDEFINED : m5246of(componentType);
                }
            }
        ...
        public static abstract class OfParameterizedType extends AbstractBase {
            ...
            public static class ForGenerifiedErasure extends OfParameterizedType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m5247of(TypeDescription typeDescription) {
                ...
                public Generic getOwnerType() {
                    TypeDescription declaringType = this.typeDescription.getDeclaringType();
                    return declaringType == null ? Generic.UNDEFINED : m5247of(declaringType);
                }
            ...
            public static class ForLoadedType extends OfParameterizedType {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m5238of((Class) this.parameterizedType.getRawType());
                }
        ...
        public static abstract class OfTypeVariable extends AbstractBase {
            ...
            public static class ForLoadedType extends OfTypeVariable {
                ...
                public TypeVariableSource getTypeVariableSource() {
                    ...
                    if (genericDeclaration instanceof Class) {
                        return ForLoadedType.m5238of((Class) genericDeclaration);
                    }
            ...
            public TypeDescription asErasure() {
                ...
                return upperBounds.isEmpty() ? ForLoadedType.m5238of(Object.class) : upperBounds.get(0).asErasure();
            }
        ...
        public static abstract class OfWildcardType extends AbstractBase {
            ...
            public static class Latent extends OfWildcardType {
                ...
                public static Generic boundedBelow(Generic generic, AnnotationSource annotationSource) {
                    return new Latent(Collections.singletonList(OfNonGenericType.ForLoadedType.m5245of(Object.class)), Collections.singletonList(generic), annotationSource);
                }

                public static Generic unbounded(AnnotationSource annotationSource) {
                    return new Latent(Collections.singletonList(OfNonGenericType.ForLoadedType.m5245of(Object.class)), Collections.emptyList(), annotationSource);
                }
            ...
            public String toString() {
                ...
                if (lowerBounds.isEmpty()) {
                    ...
                    if (lowerBounds.getOnly().equals(OfNonGenericType.ForLoadedType.m5245of(Object.class))) {
                        return SYMBOL;
                    }
                    sb.append(" extends ");
                } else {
        ...
        public interface Visitor<T> {
                ...
                public TypeDescription onGenericArray(Generic generic) {
                    ...
                    for (TypeVariableToken typeVariableToken : this.typeVariableTokens) {
                        if (componentType.getSymbol().equals(typeVariableToken.getSymbol())) {
                            return ArrayProjection.m5237of((TypeDescription) typeVariableToken.getBounds().get(0).accept(this), i);
                        }
                    }
                    return TargetType.resolve(ArrayProjection.m5237of(this.declaringType.findExpectedVariable(componentType.getSymbol()).asErasure(), i), this.declaringType);
                }
            ...
            public static abstract class Substitutor implements Visitor<Generic> {
                ...
                public static class ForAttachment extends Substitutor {
                    ...
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m5252of(TypeDescription typeDescription) {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m5248of(FieldDescription fieldDescription) {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m5249of(MethodDescription methodDescription) {
                        return new ForAttachment(methodDescription.getDeclaringType(), methodDescription);
                    }

                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m5250of(ParameterDescription parameterDescription) {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m5251of(RecordComponentDescription recordComponentDescription) {
                ...
                public static class ForDetachment extends Substitutor {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static Visitor<Generic> m5253of(TypeDefinition typeDefinition) {
                        return new ForDetachment(ElementMatchers.m5390is(typeDefinition));
                    }
    ...
    public static class LazyProxy implements InvocationHandler {
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m5254of(Class<?> cls) {
        ...
        public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) throws Throwable {
            try {
                return method.invoke(ForLoadedType.m5238of(this.type), objArr);
            } catch (InvocationTargetException e) {
                throw e.getTargetException();
            }
        }
        ...
        public static class ClassLoadingTypeProjection extends Generic.LazyProjection {
            ...
            public TypeDescription asErasure() {
                ...
                if (this.erasure != null) {
                    ...
                    try {
                        typeDescriptionAsErasure = ForLoadedType.m5238of(this.classLoadingDelegate.load(this.delegate.asErasure().getName(), this.classLoader));
                    } catch (ClassNotFoundException unused) {
