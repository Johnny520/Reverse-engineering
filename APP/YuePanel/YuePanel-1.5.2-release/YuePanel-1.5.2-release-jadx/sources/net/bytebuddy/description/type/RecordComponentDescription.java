...
public interface RecordComponentDescription extends DeclaredByType.WithMandatoryDeclaration, NamedElement.WithDescriptor, AnnotationSource, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class ForLoadedRecordComponent extends InDefinedShape.AbstractBase {
        ...
        static {
            ...
            RECORD_COMPONENT = (RecordComponent) doPrivileged(JavaDispatcher.m5432of(RecordComponent.class));
        }
        ...
        public static RecordComponentDescription m5235of(Object obj) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX DEBUG: Method merged with bridge method: getAccessor()Lnet/bytebuddy/description/method/MethodDescription; */
        ...
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m5238of(RECORD_COMPONENT.getDeclaringRecord(this.recordComponent));
        }
    }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        @Override // net.bytebuddy.description.type.RecordComponentDescription
        public TypeDescription.Generic getType() {
            return (TypeDescription.Generic) this.type.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m5251of(this));
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            int iHashCode = this.hashCode != 0 ? 0 : (((this.name.hashCode() * 31) + this.type.hashCode()) * 31) + this.annotations.hashCode();
            if (iHashCode == 0) {
