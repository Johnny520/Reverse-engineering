...
public class TypeVariableToken implements ByteCodeElement.Token<TypeVariableToken> {
    ...
    public static TypeVariableToken m5257of(TypeDescription.Generic generic, ElementMatcher<? super TypeDescription> elementMatcher) {
    ...
    public int hashCode() {
        int iHashCode = this.hashCode != 0 ? 0 : (((this.symbol.hashCode() * 31) + this.bounds.hashCode()) * 31) + this.annotations.hashCode();
        if (iHashCode == 0) {
