...
public interface MethodDescription extends TypeVariableSource, ModifierReviewable.ForMethodDescription, DeclaredByType.WithMandatoryDeclaration, ByteCodeElement.Member, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static abstract class AbstractBase extends TypeVariableSource.AbstractBase implements MethodDescription {
        ...
        private boolean isBootstrap(TypeDescription typeDescription) {
            ...
            if (size == 1) {
                return typeListAsErasures.getOnly().represents(Object[].class);
            }
            if (size == 2) {
                return JavaType.METHOD_HANDLES_LOOKUP.getTypeStub().isAssignableTo(typeListAsErasures.get(0)) && typeListAsErasures.get(1).represents(Object[].class);
            }
            if (size != 3) {
                if (JavaType.METHOD_HANDLES_LOOKUP.getTypeStub().isAssignableTo(typeListAsErasures.get(0))) {
                    return (typeListAsErasures.get(1).represents(Object.class) || typeListAsErasures.get(1).represents(String.class)) && typeListAsErasures.get(2).isAssignableFrom(typeDescription);
                }
                return false;
            }
            if (!JavaType.METHOD_HANDLES_LOOKUP.getTypeStub().isAssignableTo(typeListAsErasures.get(0))) {
            ...
            if (typeListAsErasures.get(1).represents(Object.class) || typeListAsErasures.get(1).represents(String.class)) {
                return (typeListAsErasures.get(2).isArray() && typeListAsErasures.get(2).getComponentType().isAssignableFrom(typeDescription)) || typeListAsErasures.get(2).isAssignableFrom(typeDescription);
            }
            return false;
        }
        ...
        public String getGenericSignature() {
            try {
                ...
                for (TypeDescription.Generic generic : getTypeVariables()) {
                    ...
                    boolean z2 = true;
                    while (it.hasNext()) {
                        it.next().accept(new TypeDescription.Generic.Visitor.ForSignatureVisitor(z2 ? signatureWriter.visitClassBound() : signatureWriter.visitInterfaceBound()));
                        z2 = false;
                    }
                    z = true;
                }
                for (TypeDescription.Generic generic2 : getParameters().asTypeList()) {
                    ...
                    z = z || !generic2.getSort().isNonGeneric();
                }
                ...
                return z3 ? signatureWriter.toString() : NamedElement.WithDescriptor.NON_GENERIC_SIGNATURE;
        ...
        public int hashCode() {
            int iHashCode = this.hashCode != 0 ? 0 : ((((((getDeclaringType().hashCode() + 17) * 31) + getInternalName().hashCode()) * 31) + getReturnType().asErasure().hashCode()) * 31) + getParameters().asTypeList().asErasures().hashCode();
            if (iHashCode == 0) {
        ...
        public boolean isBridgeCompatible(TypeToken typeToken) {
            ...
            return typeDescriptionAsErasure.equals(returnType) || !(typeDescriptionAsErasure.isPrimitive() || returnType.isPrimitive());
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        @Override // net.bytebuddy.description.method.MethodDescription
        public boolean isConstantBootstrap() {
            return isBootstrap(TypeDescription.ForLoadedType.m5238of(Class.class));
        }
        ...
        public int getActualModifiers(boolean z, Visibility visibility) {
            return ModifierContributor.Resolver.m5230of(Collections.singleton(getVisibility().expandTo(visibility))).resolve(getActualModifiers(z));
        }
        ...
        public boolean isDefaultValue(AnnotationValue<?, ?> annotationValue) {
            ...
            if (typeDescriptionAsErasure.represents(Boolean.TYPE) && (objResolve instanceof Boolean)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Byte.TYPE) && (objResolve instanceof Byte)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Character.TYPE) && (objResolve instanceof Character)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Short.TYPE) && (objResolve instanceof Short)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Integer.TYPE) && (objResolve instanceof Integer)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Long.TYPE) && (objResolve instanceof Long)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Float.TYPE) && (objResolve instanceof Float)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Double.TYPE) && (objResolve instanceof Double)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(String.class) && (objResolve instanceof String)) {
                return true;
            }
            if (typeDescriptionAsErasure.isAssignableTo(Enum.class) && (objResolve instanceof EnumerationDescription) && isEnumerationType(typeDescriptionAsErasure, (EnumerationDescription) objResolve)) {
                return true;
            }
            if (typeDescriptionAsErasure.isAssignableTo(Annotation.class) && (objResolve instanceof AnnotationDescription) && isAnnotationType(typeDescriptionAsErasure, (AnnotationDescription) objResolve)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(Class.class) && (objResolve instanceof TypeDescription)) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(boolean[].class) && (objResolve instanceof boolean[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(byte[].class) && (objResolve instanceof byte[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(char[].class) && (objResolve instanceof char[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(short[].class) && (objResolve instanceof short[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(int[].class) && (objResolve instanceof int[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(long[].class) && (objResolve instanceof long[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(float[].class) && (objResolve instanceof float[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(double[].class) && (objResolve instanceof double[])) {
                return true;
            }
            if (typeDescriptionAsErasure.represents(String[].class) && (objResolve instanceof String[])) {
                return true;
            }
            if (typeDescriptionAsErasure.isAssignableTo(Enum[].class) && (objResolve instanceof EnumerationDescription[]) && isEnumerationType(typeDescriptionAsErasure.getComponentType(), (EnumerationDescription[]) objResolve)) {
                return true;
            }
            if (typeDescriptionAsErasure.isAssignableTo(Annotation[].class) && (objResolve instanceof AnnotationDescription[]) && isAnnotationType(typeDescriptionAsErasure.getComponentType(), (AnnotationDescription[]) objResolve)) {
                return true;
            }
            return typeDescriptionAsErasure.represents(Class[].class) && (objResolve instanceof TypeDescription[]);
        }
    ...
    public static class ForLoadedConstructor extends InDefinedShape.AbstractBase.ForLoadedExecutable<Constructor<?>> implements ParameterDescription.ForLoadedParameter.ParameterAnnotationSource {
        ...
        public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
            ParameterList<ParameterDescription.InDefinedShape> parameterListM5227of = this.parameters != null ? null : ParameterList.ForLoadedExecutable.m5227of((Constructor<?>) this.executable, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) this);
            if (parameterListM5227of == null) {
                return this.parameters;
            }
            this.parameters = parameterListM5227of;
            return parameterListM5227of;
        }
        ...
        public TypeDescription.Generic getReturnType() {
            return TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Void.TYPE);
        }

        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return TypeList.Generic.ForLoadedTypes.OfTypeVariables.m5256of((GenericDeclaration) this.executable);
        }
        ...
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m5238of(((Constructor) this.executable).getDeclaringClass());
        }
    ...
    public static class ForLoadedMethod extends InDefinedShape.AbstractBase.ForLoadedExecutable<Method> implements ParameterDescription.ForLoadedParameter.ParameterAnnotationSource {
        ...
        @CachedReturnPlugin.Enhance("parameters")
        public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
            ParameterList<ParameterDescription.InDefinedShape> parameterListM5229of = this.parameters != null ? null : ParameterList.ForLoadedExecutable.m5229of((Method) this.executable, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) this);
            if (parameterListM5229of == null) {
                return this.parameters;
            }
            this.parameters = parameterListM5229of;
            return parameterListM5229of;
        }
        ...
        @Override // net.bytebuddy.description.method.MethodDescription
        public TypeDescription.Generic getReturnType() {
            return TypeDescription.AbstractBase.RAW_TYPES ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(((Method) this.executable).getReturnType()) : new TypeDescription.Generic.LazyProjection.ForLoadedReturnType((Method) this.executable);
        }

        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return TypeDescription.AbstractBase.RAW_TYPES ? new TypeList.Generic.Empty() : TypeList.Generic.ForLoadedTypes.OfTypeVariables.m5256of((GenericDeclaration) this.executable);
        }
        ...
        @Nonnull
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m5238of(((Method) this.executable).getDeclaringClass());
        }
    ...
    public interface InDefinedShape extends MethodDescription {
        ...
        public static abstract class AbstractBase extends AbstractBase implements InDefinedShape {
            ...
            public TypeDescription.Generic getReceiverType() {
                ...
                if (!isConstructor()) {
                    return TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m5247of(getDeclaringType());
                }
                TypeDescription declaringType = getDeclaringType();
                TypeDescription enclosingType = getDeclaringType().getEnclosingType();
                return enclosingType == null ? TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m5247of(declaringType) : declaringType.isStatic() ? enclosingType.asGenericType() : TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m5247of(enclosingType);
            }
        }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        public TypeDescription.Generic getReceiverType() {
            ...
            return generic == null ? super.getReceiverType() : (TypeDescription.Generic) generic.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m5249of(this));
        }

        @Override // net.bytebuddy.description.method.MethodDescription
        public TypeDescription.Generic getReturnType() {
            return (TypeDescription.Generic) this.returnType.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m5249of(this));
        }
    ...
    public static class SignatureToken {
        ...
        /* JADX DEBUG: Type inference failed for r0v0. Raw type applied. Possible types: java.util.List<? extends net.bytebuddy.description.type.TypeDescription>, java.util.List<net.bytebuddy.description.type.TypeDescription> */
        ...
        @CachedReturnPlugin.Enhance("hashCode")
        public int hashCode() {
            int iHashCode = this.hashCode != 0 ? 0 : (((this.name.hashCode() * 31) + this.returnType.hashCode()) * 31) + this.parameterTypes.hashCode();
            if (iHashCode == 0) {
                return this.hashCode;
            }
            this.hashCode = iHashCode;
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public Token(int i) {
            this(MethodDescription.CONSTRUCTOR_INTERNAL_NAME, i, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Void.TYPE));
        }
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                int iHashCode = ((((((((((((this.name.hashCode() * 31) + this.modifiers) * 31) + this.typeVariableTokens.hashCode()) * 31) + this.returnType.hashCode()) * 31) + this.parameterTokens.hashCode()) * 31) + this.exceptionTypes.hashCode()) * 31) + this.annotations.hashCode()) * 31;
