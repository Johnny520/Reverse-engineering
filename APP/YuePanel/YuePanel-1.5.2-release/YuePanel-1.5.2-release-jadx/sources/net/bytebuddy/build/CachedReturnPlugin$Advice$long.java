...
class CachedReturnPlugin$Advice$long {
    ...
    public static long enter(@CachedReturnPlugin.CacheField long j) {
        return j;
    }

    @SuppressFBWarnings(justification = "Advice method serves as a template", value = {"UC_USELESS_VOID_METHOD", "DLS_DEAD_LOCAL_STORE"})
    @Advice.OnMethodExit
    public static void exit(@Advice.Return(readOnly = false) long j, @CachedReturnPlugin.CacheField long j2) {
    }
}
