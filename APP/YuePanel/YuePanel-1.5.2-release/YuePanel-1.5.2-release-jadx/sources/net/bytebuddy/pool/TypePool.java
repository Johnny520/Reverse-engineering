...
public interface TypePool {
    ...
    public static abstract class AbstractBase implements TypePool {
        ...
        public static class ArrayTypeResolution implements Resolution {
            ...
            public static Resolution m5401of(Resolution resolution, int i) {
            ...
            public TypeDescription resolve() {
                return TypeDescription.ArrayProjection.m5237of(this.resolution.resolve(), this.arity);
            }
        }
        ...
        static {
            ...
            for (int i = 0; i < 9; i++) {
                Class cls = clsArr[i];
                map.put(cls.getName(), TypeDescription.ForLoadedType.m5238of(cls));
        ...
        public Resolution describe(String str) {
            ...
            return ArrayTypeResolution.m5401of(resolutionFind, i);
        }
    ...
    public interface CacheProvider {
        ...
        public static class Simple implements CacheProvider {
            ...
            public static class UsingSoftReference implements CacheProvider {
                ...
                public Resolution register(String str, Resolution resolution) {
                    ...
                    if (simple == null) {
                        simple = new Simple();
                        while (true) {
                            if (C5696.m2374(this.delegate, softReference, new SoftReference(simple))) {
                                break;
                            }
            ...
            public static CacheProvider withObjectType() {
                ...
                simple.register(Object.class.getName(), new Resolution.Simple(TypeDescription.ForLoadedType.m5238of(Object.class)));
                return simple;
            }
    ...
    public static class ClassLoading extends AbstractBase.Hierarchical {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static TypePool m5402of(@MaybeNull ClassLoader classLoader) {
            return m5403of(classLoader, Empty.INSTANCE);
        }

        public static TypePool ofBootLoader() {
            return m5402of(ClassLoadingStrategy.BOOTSTRAP_LOADER);
        }

        public static TypePool ofPlatformLoader() {
            return m5402of(ClassLoader.getSystemClassLoader().getParent());
        }

        public static TypePool ofSystemLoader() {
            return m5402of(ClassLoader.getSystemClassLoader());
        }

        @Override // net.bytebuddy.pool.TypePool.AbstractBase
        public Resolution doDescribe(String str) {
            try {
                return new Resolution.Simple(TypeDescription.ForLoadedType.m5238of(Class.forName(str, false, this.classLoader)));
        ...
        */
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static TypePool m5403of(@MaybeNull ClassLoader classLoader, TypePool typePool) {
    ...
    public static class Default extends AbstractBase.Hierarchical {
        ...
        public static class GenericTypeExtractor extends GenericTypeRegistrant.RejectingSignatureVisitor implements GenericTypeRegistrant {
            ...
            public static abstract class ForSignature<T extends LazyTypeDescription.GenericTypeToken.Resolution> extends GenericTypeRegistrant.RejectingSignatureVisitor implements GenericTypeRegistrant {
                ...
                public static class OfMethod extends ForSignature<LazyTypeDescription.GenericTypeToken.Resolution.ForMethod> {
                    ...
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                    /* JADX DEBUG: Method merged with bridge method: resolve()Lnet/bytebuddy/pool/TypePool$Default$LazyTypeDescription$GenericTypeToken$Resolution; */
            ...
            public void visitBaseType(char c) {
                this.genericTypeRegistrant.register(LazyTypeDescription.GenericTypeToken.ForPrimitiveType.m5406of(c));
            }
        ...
        public static class LazyTypeDescription extends TypeDescription.AbstractBase.OfSimpleType {
            ...
            public interface GenericTypeToken {
                ...
                public static class ForGenericArray implements GenericTypeToken {
                    ...
                    public static class LazyGenericArray extends TypeDescription.Generic.OfGenericArray {
                        ...
                        public TypeDescription.Generic getComponentType() {
                            return this.componentTypeToken.toGenericType(this.typePool, this.typeVariableSource, this.typePath + GenericTypeToken.COMPONENT_TYPE_PATH, this.annotationTokens);
                        }
                    }
                ...
                public static class ForLowerBoundWildcard implements GenericTypeToken {
                    ...
                    public static class LazyLowerBoundWildcard extends TypeDescription.Generic.OfWildcardType {
                        ...
                        public TypeList.Generic getUpperBounds() {
                            return new TypeList.Generic.Explicit(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m5245of(Object.class));
                        }
                    }
                ...
                public enum ForPrimitiveType implements GenericTypeToken {
                    ...
                    ForPrimitiveType(Class cls) {
                        this.typeDescription = TypeDescription.ForLoadedType.m5238of(cls);
                    }

                    /* JADX INFO: renamed from: of */
                    public static GenericTypeToken m5406of(char c) {
                        if (c == 'F') {
                            return FLOAT;
                        }
                        if (c == 'S') {
                        ...
                        public static class LazyTypeVariable extends TypeDescription.Generic.OfTypeVariable {
                            ...
                            public static class LazyBoundTokenList extends TypeList.Generic.AbstractBase {
                                ...
                                public TypeDescription.Generic get(int i) {
                                    Map<String, List<AnnotationToken>> mapEmptyMap = (this.annotationTokens.containsKey(Integer.valueOf(i)) || this.annotationTokens.containsKey(Integer.valueOf(i + 1))) ? this.annotationTokens.get(Integer.valueOf((!this.boundTypeTokens.get(0).isPrimaryBound(this.typePool) ? 1 : 0) + i)) : Collections.emptyMap();
                                    ...
                                    return genericTypeToken.toGenericType(typePool, typeVariableSource, "", mapEmptyMap);
                                }
                            }
                    ...
                    public interface ForField {
                        ...
                        public static class Tokenized implements ForField {
                            ...
                            public TypeDescription.Generic resolveFieldType(String str, TypePool typePool, Map<String, List<AnnotationToken>> map, FieldDescription.InDefinedShape inDefinedShape) {
                                return TokenizedGenericType.m5409of(typePool, this.fieldTypeToken, str, map, inDefinedShape.getDeclaringType());
                            }
                        }
                    ...
                    public interface ForMethod extends Resolution {
                        ...
                        public static class Tokenized implements ForMethod {
                            ...
                            public TypeDescription.Generic resolveReturnType(String str, TypePool typePool, Map<String, List<AnnotationToken>> map, MethodDescription.InDefinedShape inDefinedShape) {
                                return TokenizedGenericType.m5409of(typePool, this.returnTypeToken, str, map, inDefinedShape);
                            }
                    ...
                    public interface ForRecordComponent {
                        ...
                        public static class Tokenized implements ForRecordComponent {
                            ...
                            public TypeDescription.Generic resolveRecordType(String str, TypePool typePool, Map<String, List<AnnotationToken>> map, RecordComponentDescription.InDefinedShape inDefinedShape) {
                                return TokenizedGenericType.m5409of(typePool, this.recordComponentTypeToken, str, map, inDefinedShape.getDeclaringType());
                            }
                        }
                    ...
                    public interface ForType extends Resolution {
                        ...
                        public static class Tokenized implements ForType {
                            ...
                            public TypeDescription.Generic resolveSuperClass(String str, TypePool typePool, Map<String, List<AnnotationToken>> map, TypeDescription typeDescription) {
                                return TokenizedGenericType.m5409of(typePool, this.superClassToken, str, map, typeDescription);
                            }
                    ...
                    public enum Raw implements ForType, ForField, ForMethod, ForRecordComponent {
                        ...
                        public static class RawAnnotatedType extends TypeDescription.Generic.OfNonGenericType {
                            ...
                            public static class LazyRawAnnotatedTypeList extends TypeList.Generic.AbstractBase {
                                ...
                                /* JADX INFO: renamed from: of */
                                public static TypeList.Generic m5408of(TypePool typePool, @MaybeNull Map<Integer, Map<String, List<AnnotationToken>>> map, List<String> list) {
                                    if (map == null) {
                                        map = Collections.emptyMap();
                                    }
                                ...
                                @Override // java.util.AbstractList, java.util.List
                                public TypeDescription.Generic get(int i) {
                                    return RawAnnotatedType.m5407of(this.typePool, this.annotationTokens.get(Integer.valueOf(i)), this.descriptors.get(i));
                                }
                            }
                            ...
                            /* JADX INFO: renamed from: of */
                            public static TypeDescription.Generic m5407of(TypePool typePool, @MaybeNull Map<String, List<AnnotationToken>> map, String str) {
                                if (map == null) {
                                    map = Collections.emptyMap();
                                }
                            ...
                            public TypeDescription.Generic getComponentType() {
                                ...
                                return new RawAnnotatedType(this.typePool, this.typePath + GenericTypeToken.COMPONENT_TYPE_PATH, this.annotationTokens, componentType);
                            }
                        }

                        @Override // net.bytebuddy.pool.TypePool.Default.LazyTypeDescription.GenericTypeToken.Resolution.ForMethod
                        public TypeList.Generic resolveExceptionTypes(List<String> list, TypePool typePool, Map<Integer, Map<String, List<AnnotationToken>>> map, MethodDescription.InDefinedShape inDefinedShape) {
                            return RawAnnotatedType.LazyRawAnnotatedTypeList.m5408of(typePool, map, list);
                        }

                        @Override // net.bytebuddy.pool.TypePool.Default.LazyTypeDescription.GenericTypeToken.Resolution.ForField
                        public TypeDescription.Generic resolveFieldType(String str, TypePool typePool, Map<String, List<AnnotationToken>> map, FieldDescription.InDefinedShape inDefinedShape) {
                            return RawAnnotatedType.m5407of(typePool, map, str);
                        }
            ...
            public static class LazyAnnotationDescription extends AnnotationDescription.AbstractBase {
                ...
                public static class Loadable<S extends Annotation> extends LazyAnnotationDescription implements AnnotationDescription.Loadable<S> {
                    ...
                    public S load() {
                        return (S) AnnotationDescription.AnnotationInvocationHandler.m5198of(this.annotationType.getClassLoader(), this.annotationType, this.values);
                    }
                    ...
                    private Loadable(TypePool typePool, Class<S> cls, Map<String, AnnotationValue<?, ?>> map) {
                        super(typePool, TypeDescription.ForLoadedType.m5238of(cls), map);
                ...
                public AnnotationValue<?, ?> getValue(MethodDescription.InDefinedShape inDefinedShape) {
                    if (inDefinedShape.getDeclaringType().asErasure().equals(this.annotationType)) {
                        ...
                        AnnotationValue<?, ?> defaultValue = ((MethodDescription.InDefinedShape) getAnnotationType().getDeclaredMethods().filter(ElementMatchers.m5397is(inDefinedShape)).getOnly()).getDefaultValue();
            ...
            public class LazyMethodDescription extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                public class LazyParameterDescription extends ParameterDescription.InDefinedShape.AbstractBase {
                    ...
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                    /* JADX DEBUG: Method merged with bridge method: getDeclaringMethod()Lnet/bytebuddy/description/method/MethodDescription; */
            ...
            public static class LazyPackageDescription extends PackageDescription.AbstractBase {
                ...
                @Override // net.bytebuddy.description.annotation.AnnotationSource
                public AnnotationList getDeclaredAnnotations() {
                    Resolution resolutionDescribe = this.typePool.describe(this.name + "." + PackageDescription.PACKAGE_CLASS_NAME);
            ...
            public static class TokenizedGenericType extends TypeDescription.Generic.LazyProjection.WithEagerNavigation {
                ...
                /* JADX INFO: renamed from: of */
                public static TypeDescription.Generic m5409of(TypePool typePool, GenericTypeToken genericTypeToken, String str, @MaybeNull Map<String, List<AnnotationToken>> map, TypeVariableSource typeVariableSource) {
                    if (map == null) {
                        map = Collections.emptyMap();
                    }
        ...
        public class TypeExtractor extends ClassVisitor {
            ...
            public class AnnotationExtractor extends AnnotationVisitor {
                ...
                public void visit(String str, Object obj) {
                    if (!(obj instanceof Type)) {
                        this.annotationRegistrant.register(str, AnnotationValue.ForConstant.m5207of(obj));
                    } else {
                        Type type = (Type) obj;
            ...
            public class MethodExtractor extends MethodVisitor implements AnnotationRegistrant {
                ...
                public void visitEnd() {
                    ...
                    list.add(new LazyTypeDescription.MethodToken(str, i, str2, str3, strArr, map, map2, map3, map4, map5, map6, list3, map7, listResolve, this.defaultValue));
                }
                ...
                public AnnotationVisitor visitTypeAnnotation(int i, TypePath typePath, String str, boolean z) {
                    ...
                    TypeExtractor typeExtractor = TypeExtractor.this;
                    return typeExtractor.new AnnotationExtractor(withIndex, new ComponentTypeLocator.ForAnnotationProperty(Default.this, str));
                }
            }
            ...
            public TypeDescription toTypeDescription() {
                ...
                if (mapRemove == null) {
                    mapRemove = Collections.emptyMap();
                }
        ...
        public static class WithLazyResolution extends Default {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX INFO: renamed from: of */
            public static TypePool m5410of(@MaybeNull ClassLoader classLoader) {
                return m5411of(ClassFileLocator.ForClassLoader.m5258of(classLoader));
            }

            public static TypePool ofBootLoader() {
                return m5411of(ClassFileLocator.ForClassLoader.ofBootLoader());
            }

            public static TypePool ofPlatformLoader() {
                return m5411of(ClassFileLocator.ForClassLoader.ofPlatformLoader());
            }

            public static TypePool ofSystemLoader() {
                return m5411of(ClassFileLocator.ForClassLoader.ofSystemLoader());
            }
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
            /* JADX INFO: renamed from: of */
            public static TypePool m5411of(ClassFileLocator classFileLocator) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static TypePool m5404of(@MaybeNull ClassLoader classLoader) {
            return m5405of(ClassFileLocator.ForClassLoader.m5258of(classLoader));
        }

        public static TypePool ofBootLoader() {
            return m5405of(ClassFileLocator.ForClassLoader.ofBootLoader());
        }

        public static TypePool ofPlatformLoader() {
            return m5405of(ClassFileLocator.ForClassLoader.ofPlatformLoader());
        }

        public static TypePool ofSystemLoader() {
            return m5405of(ClassFileLocator.ForClassLoader.ofSystemLoader());
        }

        private TypeDescription parse(byte[] bArr) {
            ClassReader classReaderM5431of = OpenedClassReader.m5431of(bArr);
            TypeExtractor typeExtractor = new TypeExtractor();
            classReaderM5431of.accept(typeExtractor, this.readerMode.getFlags());
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static TypePool m5405of(ClassFileLocator classFileLocator) {
