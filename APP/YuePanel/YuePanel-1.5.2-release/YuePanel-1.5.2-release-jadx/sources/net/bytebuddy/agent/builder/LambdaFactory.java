...
public class LambdaFactory {
    ...
    public static boolean register(ClassFileTransformer classFileTransformer, Object obj) {
        boolean zIsEmpty;
        try {
            TypeDescription typeDescriptionM5238of = TypeDescription.ForLoadedType.m5238of(LambdaFactory.class);
            Class<?> cls = ClassInjector.UsingReflection.ofSystemClassLoader().inject(Collections.singletonMap(typeDescriptionM5238of, ClassFileLocator.ForClassLoader.read((Class<?>) LambdaFactory.class))).get(typeDescriptionM5238of);
