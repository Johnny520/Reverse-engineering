...
public class Removal implements StackManipulation {
    ...
    /* JADX INFO: renamed from: net.bytebuddy.implementation.bytecode.Removal$2 */
    public static /* synthetic */ class C28852 {
    ...
    public static StackManipulation m5370of(TypeDefinition typeDefinition) {
        int i = C28852.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
        if (i == 1) {
            return SINGLE;
        }
        if (i == 2) {
