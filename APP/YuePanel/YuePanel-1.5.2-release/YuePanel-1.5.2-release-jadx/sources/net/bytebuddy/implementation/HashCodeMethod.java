...
public class HashCodeMethod implements Implementation {
    ...
    private static final MethodDescription.InDefinedShape HASH_CODE = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Object.class).getDeclaredMethods().filter(ElementMatchers.isHashCode()).getOnly();
    private static final MethodDescription.InDefinedShape GET_CLASS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Object.class).getDeclaredMethods().filter(ElementMatchers.named("getClass").and(ElementMatchers.takesArguments(0))).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                arrayList.add(ValueTransformer.m5305of(inDefinedShape.getType()));
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public class AfterInstruction extends StackManipulation.AbstractBase {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    context.getFrameGeneration().same1(methodVisitor, TypeDescription.ForLoadedType.m5238of(Integer.TYPE), Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m5238of(Object.class)));
    ...
    public interface OffsetProvider {
        ...
        public enum ForDynamicTypeHash implements OffsetProvider {
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(MethodVariableAccess.loadThis(), MethodInvocation.invoke(HashCodeMethod.GET_CLASS).virtual(typeDescription), MethodInvocation.invoke(HashCodeMethod.HASH_CODE).virtual(TypeDescription.ForLoadedType.m5238of(Class.class)));
            }
        }
        ...
        public enum ForStaticTypeHash implements OffsetProvider {
            ...
            @Override // net.bytebuddy.implementation.HashCodeMethod.OffsetProvider
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(ClassConstant.m5380of(typeDescription), MethodInvocation.invoke(HashCodeMethod.HASH_CODE).virtual(TypeDescription.ForLoadedType.m5238of(Class.class)));
            }
        }
    ...
    public enum ValueTransformer implements StackManipulation {
        ...
        public static StackManipulation m5305of(TypeDefinition typeDefinition) {
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (!target.getInstrumentedType().isInterface()) {
            return new Appender(this.offsetProvider.resolve(target.getInstrumentedType()), this.multiplier, target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo5389or(this.ignored))), this.nonNullable);
        }
    ...
    public HashCodeMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new HashCodeMethod(this.offsetProvider, this.multiplier, this.ignored.mo5389or(elementMatcher), this.nonNullable);
    }
    ...
    public HashCodeMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new HashCodeMethod(this.offsetProvider, this.multiplier, this.ignored, this.nonNullable.mo5389or(elementMatcher));
    }
