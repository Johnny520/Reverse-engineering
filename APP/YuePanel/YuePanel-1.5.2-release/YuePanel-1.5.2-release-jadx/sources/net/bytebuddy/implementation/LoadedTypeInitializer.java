    ...
    public static class ForStaticField implements LoadedTypeInitializer, Serializable {
        ...
        public void onLoad(Class<?> cls) {
            try {
                ...
                if (!Modifier.isPublic(declaredField.getModifiers()) || !Modifier.isPublic(declaredField.getDeclaringClass().getModifiers()) || (JavaModule.isSupported() && !JavaModule.ofType(cls).isExported(TypeDescription.ForLoadedType.m5238of(cls).getPackage(), JavaModule.ofType(ForStaticField.class)))) {
