...
public @interface Pipe {
    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Pipe> {
        private static final MethodDescription.InDefinedShape SERIALIZABLE_PROXY = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Pipe.class).getDeclaredMethods().filter(ElementMatchers.named("serializableProxy")).getOnly();
        ...
        public static class RedirectionProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public enum ConstructorCall implements Implementation {
                ...
                private final transient MethodDescription.InDefinedShape objectTypeDefaultConstructor = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(Object.class).getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly();
