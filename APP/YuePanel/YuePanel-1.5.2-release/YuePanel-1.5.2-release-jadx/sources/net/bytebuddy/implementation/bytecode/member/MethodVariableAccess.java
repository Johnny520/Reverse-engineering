...
public final class MethodVariableAccess {
    ...
    public static class MethodLoading extends StackManipulation.AbstractBase {
        ...
        public interface TypeCastingHandler {
            ...
            public static class ForBridgeTarget implements TypeCastingHandler {
                ...
                public StackManipulation ofIndex(TypeDescription typeDescription, int i) {
                    ...
                    return typeDescription.equals(typeDescriptionAsErasure) ? StackManipulation.Trivial.INSTANCE : TypeCasting.m5378to(typeDescriptionAsErasure);
                }
            }
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            while (it.hasNext()) {
                ...
                arrayList.add(MethodVariableAccess.m5387of(typeDescriptionAsErasure).loadFrom(parameterDescription.getOffset()));
    ...
    public static StackManipulation load(ParameterDescription parameterDescription) {
        return m5387of(parameterDescription.getType()).loadFrom(parameterDescription.getOffset());
    }
    ...
    public static MethodVariableAccess m5387of(TypeDefinition typeDefinition) {
    ...
    public static StackManipulation store(ParameterDescription parameterDescription) {
        return m5387of(parameterDescription.getType()).storeAt(parameterDescription.getOffset());
    }
    ...
    public static StackManipulation increment(ParameterDescription parameterDescription, int i) {
        return m5387of(parameterDescription.getType()).increment(parameterDescription.getOffset(), i);
    }
}
