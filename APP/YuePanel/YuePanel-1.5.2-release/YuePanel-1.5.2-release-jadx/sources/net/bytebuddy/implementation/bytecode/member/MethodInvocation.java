...
public enum MethodInvocation {
    ...
    public class DynamicInvocation extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            int size = this.returnType.getStackSize().getSize() - StackSize.m5371of(this.parameterTypes);
    ...
    public class Invocation extends StackManipulation.AbstractBase implements WithImplicitInvocationTargetType {
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation dynamic(String str, TypeDescription typeDescription, List<? extends TypeDescription> list, List<? extends JavaConstant> list2) {
            return this.methodDescription.isInvokeBootstrap(TypeList.Explicit.m5255of(list2)) ? MethodInvocation.this.new DynamicInvocation(str, typeDescription, new TypeList.Explicit(list), this.methodDescription.asDefined(), list2) : StackManipulation.Illegal.INSTANCE;
        }
    ...
    public static class OfGenericMethod implements WithImplicitInvocationTargetType {
        ...
        public static WithImplicitInvocationTargetType m5385of(MethodDescription methodDescription, WithImplicitInvocationTargetType withImplicitInvocationTargetType) {
            return new OfGenericMethod(methodDescription.getReturnType().asErasure(), withImplicitInvocationTargetType);
        }

        @Override // net.bytebuddy.implementation.bytecode.StackManipulation
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            return new StackManipulation.Compound(this.invocation, TypeCasting.m5378to(this.targetType)).apply(methodVisitor, context);
        }
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation onHandle(HandleType handleType) {
            return new StackManipulation.Compound(this.invocation.onHandle(handleType), TypeCasting.m5378to(this.targetType));
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation special(TypeDescription typeDescription) {
            return new StackManipulation.Compound(this.invocation.special(typeDescription), TypeCasting.m5378to(this.targetType));
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation virtual(TypeDescription typeDescription) {
            return new StackManipulation.Compound(this.invocation.virtual(typeDescription), TypeCasting.m5378to(this.targetType));
        }
    }
    ...
    public static WithImplicitInvocationTargetType invoke(MethodDescription methodDescription) {
        ...
        return OfGenericMethod.m5385of(methodDescription, invoke(inDefinedShapeAsDefined));
    }
}
