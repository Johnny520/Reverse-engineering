...
public class MethodDelegation implements Implementation.Composable {
    ...
    public interface ImplementationDelegate extends InstrumentedType.Prepareable {
        ...
        public interface Compiled {
            ...
            public static class ForConstruction implements Compiled {
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    return new StackManipulation.Compound(TypeCreation.m5375of(this.typeDescription), Duplication.SINGLE);
                }
            }
        ...
        public static class ForConstruction implements ImplementationDelegate {
            ...
            public static ImplementationDelegate m5337of(TypeDescription typeDescription, MethodList<?> methodList, MethodDelegationBinder methodDelegationBinder) {
        ...
        public static abstract class ForField implements ImplementationDelegate {
            ...
            public Compiled compile(TypeDescription typeDescription) {
                ...
                MethodDelegationBinder methodDelegationBinderM5365of = TargetMethodAnnotationDrivenBinder.m5365of(this.parameterBinders);
                Iterator<T> it = methodListFilter.iterator();
                while (it.hasNext()) {
                    arrayList.add(methodDelegationBinderM5365of.compile((MethodDescription) it.next()));
                }
        ...
        public static class ForMethodReturn implements ImplementationDelegate {
            ...
            @Override // net.bytebuddy.implementation.MethodDelegation.ImplementationDelegate
            public Compiled compile(TypeDescription typeDescription) {
                MethodList methodListFilter = new MethodList.Explicit(CompoundList.m5414of(typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().mo5389or(ElementMatchers.isPrivate())), (List) this.methodGraphCompiler.compile((TypeDefinition) typeDescription).listNodes().asMethodList())).filter(ElementMatchers.named(this.name).and(ElementMatchers.takesArguments(0)).and(ElementMatchers.not(ElementMatchers.returns(ElementMatchers.isPrimitive().mo5389or(ElementMatchers.isArray())))));
        ...
        public static class ForStaticMethod implements ImplementationDelegate {
            ...
            /* JADX INFO: renamed from: of */
            public static ImplementationDelegate m5338of(MethodList<?> methodList, MethodDelegationBinder methodDelegationBinder) {
                ArrayList arrayList = new ArrayList(methodList.size());
                Iterator<?> it = methodList.iterator();
                while (it.hasNext()) {
                    arrayList.add(methodDelegationBinder.compile((MethodDescription) it.next()));
    ...
    public static class WithCustomProperties {
        ...
        public MethodDelegation m5339to(Class<?> cls) {
            return m5352to(TypeDescription.ForLoadedType.m5238of(cls));
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public MethodDelegation toConstructor(Class<?> cls) {
            return toConstructor(TypeDescription.ForLoadedType.m5238of(cls));
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: to */
        public MethodDelegation m5352to(TypeDescription typeDescription) {
            if (typeDescription.isArray()) {
                throw new IllegalArgumentException("Cannot delegate to array " + typeDescription);
            }
            if (!typeDescription.isPrimitive()) {
                return new MethodDelegation(ImplementationDelegate.ForStaticMethod.m5338of(typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().and(this.matcher)), TargetMethodAnnotationDrivenBinder.m5365of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
            }
        ...
        public MethodDelegation toConstructor(TypeDescription typeDescription) {
            return new MethodDelegation(ImplementationDelegate.ForConstruction.m5337of(typeDescription, typeDescription.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(this.matcher)), TargetMethodAnnotationDrivenBinder.m5365of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
        }
        ...
        public WithCustomProperties withBinders(List<? extends TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> list) {
            return new WithCustomProperties(this.ambiguityResolver, CompoundList.m5414of((List) this.parameterBinders, (List) list), this.bindingResolver, this.matcher);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        public WithCustomProperties withResolvers(List<? extends MethodDelegationBinder.AmbiguityResolver> list) {
            return new WithCustomProperties(new MethodDelegationBinder.AmbiguityResolver.Compound((List<? extends MethodDelegationBinder.AmbiguityResolver>) CompoundList.m5412of(this.ambiguityResolver, list)), this.parameterBinders, this.bindingResolver, this.matcher);
        }
        ...
        /* JADX INFO: renamed from: to */
        public MethodDelegation m5340to(Object obj) {
            return m5351to(obj, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5351to(Object obj, MethodGraph.Compiler compiler) {
            return m5346to(obj, obj.getClass(), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5341to(Object obj, String str) {
            return m5342to(obj, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5342to(Object obj, String str, MethodGraph.Compiler compiler) {
            return m5345to(obj, obj.getClass(), str, compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5343to(Object obj, Type type) {
            return m5346to(obj, type, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5346to(Object obj, Type type, MethodGraph.Compiler compiler) {
            return m5345to(obj, type, "delegate$" + RandomString.hashOf(obj), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5344to(Object obj, Type type, String str) {
            return m5345to(obj, type, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5345to(Object obj, Type type, String str, MethodGraph.Compiler compiler) {
            return m5349to(obj, TypeDefinition.Sort.describe(type), str, compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5347to(Object obj, TypeDefinition typeDefinition) {
            return m5350to(obj, typeDefinition, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5350to(Object obj, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
            return m5349to(obj, typeDefinition, "delegate$" + RandomString.hashOf(obj), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5348to(Object obj, TypeDefinition typeDefinition, String str) {
            return m5349to(obj, typeDefinition, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m5349to(Object obj, TypeDefinition typeDefinition, String str, MethodGraph.Compiler compiler) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5323to(Class<?> cls) {
        return withDefaultConfiguration().m5339to(cls);
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5336to(TypeDescription typeDescription) {
        return withDefaultConfiguration().m5352to(typeDescription);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5324to(Object obj) {
        return withDefaultConfiguration().m5340to(obj);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5335to(Object obj, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5351to(obj, compiler);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5325to(Object obj, String str) {
        return withDefaultConfiguration().m5341to(obj, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5326to(Object obj, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5342to(obj, str, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5327to(Object obj, Type type) {
        return withDefaultConfiguration().m5343to(obj, type);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5330to(Object obj, Type type, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5346to(obj, type, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5328to(Object obj, Type type, String str) {
        return withDefaultConfiguration().m5344to(obj, type, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5329to(Object obj, Type type, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5345to(obj, type, str, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5331to(Object obj, TypeDefinition typeDefinition) {
        return withDefaultConfiguration().m5347to(obj, typeDefinition);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5334to(Object obj, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5350to(obj, typeDefinition, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5332to(Object obj, TypeDefinition typeDefinition, String str) {
        return withDefaultConfiguration().m5348to(obj, typeDefinition, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m5333to(Object obj, TypeDefinition typeDefinition, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m5349to(obj, typeDefinition, str, compiler);
    }
}
