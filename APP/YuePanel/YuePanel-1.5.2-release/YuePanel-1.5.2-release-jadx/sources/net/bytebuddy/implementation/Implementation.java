...
public interface Implementation extends InstrumentedType.Prepareable {
    ...
    public static class Compound implements Implementation {
        ...
        public static class Composable implements Composable {
            ...
            public Implementation andThen(Implementation implementation) {
                return new Compound((List<? extends Implementation>) CompoundList.m5413of(this.implementations, this.composable.andThen(implementation)));
            }
    ...
    public interface Context extends MethodAccessorFactory {
        ...
        public static class Default extends ExtractableView.AbstractBase {
            ...
            public static abstract class DelegationRecord extends TypeWriter.MethodPool.Record.ForDefinedMethod implements ByteCodeAppender {
                ...
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
                /* JADX DEBUG: Method merged with bridge method: getMethod()Lnet/bytebuddy/description/method/MethodDescription; */
                @Override // net.bytebuddy.dynamic.scaffold.TypeWriter.MethodPool.Record
            ...
            public static class FieldGetterDelegation extends DelegationRecord {
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context context, MethodDescription methodDescription) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(this.fieldDescription.isStatic() ? StackManipulation.Trivial.INSTANCE : MethodVariableAccess.loadThis(), FieldAccess.forField(this.fieldDescription).read(), MethodReturn.m5386of(this.fieldDescription.getType())).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
                }
            ...
            public void drain(TypeInitializer.Drain drain, ClassVisitor classVisitor, AnnotationValueFilter.Factory factory) {
                ...
                for (Map.Entry<FieldCacheEntry, FieldDescription.InDefinedShape> entry : this.registeredFieldCacheEntries.entrySet()) {
                    FieldVisitor fieldVisitorVisitField = classVisitor.visitField(entry.getValue().getModifiers(), entry.getValue().getInternalName(), entry.getValue().getDescriptor(), entry.getValue().getGenericSignature(), FieldDescription.NO_DEFAULT_VALUE);
                ...
                drain.apply(classVisitor, typeInitializerExpandWith, this);
            ...
            public static class AccessorMethodDelegation extends DelegationRecord {
                ...
                @Override // net.bytebuddy.implementation.bytecode.ByteCodeAppender
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context context, MethodDescription methodDescription) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.allArgumentsOf(methodDescription).prependThisReference(), this.accessorMethodInvocation, MethodReturn.m5386of(methodDescription.getReturnType())).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
                }
        ...
        public enum FrameGeneration {
            ...
            public void append(MethodVisitor methodVisitor, List<? extends TypeDefinition> list, List<? extends TypeDefinition> list2) {
                Object[] objArr = EMPTY;
                generate(methodVisitor, 1, objArr.length, objArr, list.size(), toStackMapFrames(list), list2.size() + list.size(), toStackMapFrames(CompoundList.m5414of((List) list2, (List) list)));
            }
    ...
    public static class Simple implements Implementation {
        ...
        public static Implementation m5306of(Dispatcher dispatcher) {
            return m5307of(dispatcher, 0);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static Implementation m5307of(Dispatcher dispatcher, int i) {
            return m5309of(dispatcher, InstrumentedType.Prepareable.NoOp.INSTANCE, i);
        }
        ...
        /* JADX INFO: renamed from: of */
        public static Implementation m5308of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable) {
            return m5309of(dispatcher, prepareable, 0);
        }

        /* JADX INFO: renamed from: of */
        public static Implementation m5309of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable, int i) {
            if (i >= 0) {
    ...
    public interface SpecialMethodInvocation extends StackManipulation {
        ...
        public static class Simple extends AbstractBase {
            ...
            /* JADX INFO: renamed from: of */
            public static SpecialMethodInvocation m5310of(MethodDescription methodDescription, TypeDescription typeDescription) {
            ...
            public enum DefaultMethodInvocation {
                ENABLED { // from class: net.bytebuddy.implementation.Implementation.Target.AbstractBase.DefaultMethodInvocation.1
                    ...
                    public SpecialMethodInvocation apply(MethodGraph.Node node, TypeDescription typeDescription) {
                        return node.getSort().isUnique() ? SpecialMethodInvocation.Simple.m5310of(node.getRepresentative(), typeDescription) : SpecialMethodInvocation.Illegal.INSTANCE;
                    }
                },
                ...
                /* JADX INFO: renamed from: of */
                public static DefaultMethodInvocation m5311of(ClassFileVersion classFileVersion) {
