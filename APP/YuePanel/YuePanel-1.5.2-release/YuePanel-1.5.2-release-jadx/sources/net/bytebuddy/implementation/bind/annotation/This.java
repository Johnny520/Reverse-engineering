...
public @interface This {
    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<This> {
        ...
        private static final MethodDescription.InDefinedShape OPTIONAL = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m5238of(This.class).getDeclaredMethods().filter(ElementMatchers.named("optional")).getOnly();
