...
public enum FieldAccess {
    ...
    public static class OfGenericField implements Defined {
        ...
        public static Defined m5384of(FieldDescription fieldDescription, Defined defined) {
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.FieldAccess.Defined
        public StackManipulation read() {
            return new StackManipulation.Compound(this.defined.read(), TypeCasting.m5378to(this.targetType));
        }
    ...
    public static Defined forField(FieldDescription fieldDescription) {
        ...
        return fieldDescription.getType().asErasure().equals(inDefinedShapeAsDefined.getType().asErasure()) ? forField(inDefinedShapeAsDefined) : OfGenericField.m5384of(fieldDescription, forField(inDefinedShapeAsDefined));
    }
}
