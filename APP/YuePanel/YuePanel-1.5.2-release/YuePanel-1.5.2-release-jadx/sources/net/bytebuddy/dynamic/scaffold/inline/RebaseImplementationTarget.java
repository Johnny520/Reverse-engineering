...
public class RebaseImplementationTarget extends Implementation.Target.AbstractBase {
    ...
    public static class Factory implements Implementation.Target.Factory {
        ...
        public Implementation.Target make(TypeDescription typeDescription, MethodGraph.Linked linked, ClassFileVersion classFileVersion) {
            return RebaseImplementationTarget.m5294of(typeDescription, linked, classFileVersion, this.methodRebaseResolver);
        }
    }
    ...
    public static class RebasedMethodInvocation extends Implementation.SpecialMethodInvocation.AbstractBase {
        ...
        public static Implementation.SpecialMethodInvocation m5295of(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription, TypeList typeList) {
            ...
            while (it.hasNext()) {
                arrayList.add(DefaultValue.m5381of(it.next()));
            }
        ...
        public JavaConstant.MethodHandle toMethodHandle() {
            return this.methodDescription.isStatic() ? JavaConstant.MethodHandle.m5418of(this.methodDescription) : JavaConstant.MethodHandle.ofSpecial(this.methodDescription, this.instrumentedType);
        }

        @Override // net.bytebuddy.implementation.Implementation.SpecialMethodInvocation
        public Implementation.SpecialMethodInvocation withCheckedCompatibilityTo(MethodDescription.TypeToken typeToken) {
            return this.methodDescription.asTypeToken().equals(new MethodDescription.TypeToken(typeToken.getReturnType(), CompoundList.m5414of((List) typeToken.getParameterTypes(), (List) this.prependedParameters))) ? this : Implementation.SpecialMethodInvocation.Illegal.INSTANCE;
        }
    }
    ...
    /* JADX INFO: renamed from: of */
    public static Implementation.Target m5294of(TypeDescription typeDescription, MethodGraph.Linked linked, ClassFileVersion classFileVersion, MethodRebaseResolver methodRebaseResolver) {
        return new RebaseImplementationTarget(typeDescription, linked, Implementation.Target.AbstractBase.DefaultMethodInvocation.m5311of(classFileVersion), methodRebaseResolver.asTokenMap());
    }
    ...
    /* JADX DEBUG: Method merged with bridge method: getOriginType()Lnet/bytebuddy/description/type/TypeDefinition; */
    @Override // net.bytebuddy.implementation.Implementation.Target
    ...
    private Implementation.SpecialMethodInvocation invokeSuper(MethodGraph.Node node) {
        ...
        return (!node.getSort().isResolved() || superClass == null) ? Implementation.SpecialMethodInvocation.Illegal.INSTANCE : Implementation.SpecialMethodInvocation.Simple.m5310of(node.getRepresentative(), superClass.asErasure());
    }
    ...
    private Implementation.SpecialMethodInvocation invokeSuper(MethodRebaseResolver.Resolution resolution) {
        if (resolution.isRebased()) {
            return RebasedMethodInvocation.m5295of(resolution.getResolvedMethod(), this.instrumentedType, resolution.getAppendedParameters());
        }
        return Implementation.SpecialMethodInvocation.Simple.m5310of(resolution.getResolvedMethod(), this.instrumentedType);
    }
}
