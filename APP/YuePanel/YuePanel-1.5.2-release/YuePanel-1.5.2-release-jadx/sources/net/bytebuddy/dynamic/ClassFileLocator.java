...
public interface ClassFileLocator extends Closeable {
    ...
    public static class ForClassLoader implements ClassFileLocator {
        ...
        public static class WeaklyReferenced extends WeakReference<ClassLoader> implements ClassFileLocator {
            ...
            public static ClassFileLocator m5259of(@MaybeNull ClassLoader classLoader) {
                return (classLoader == null || classLoader == ClassLoader.getSystemClassLoader() || classLoader == ClassLoader.getSystemClassLoader().getParent()) ? ForClassLoader.m5258of(classLoader) : new WeaklyReferenced(classLoader);
            }
        ...
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5258of(@MaybeNull ClassLoader classLoader) {
            if (classLoader == null) {
        ...
        public static ClassFileLocator ofPlatformLoader() {
            return m5258of(ClassLoader.getSystemClassLoader().getParent());
        }
    ...
    public static class ForInstrumentation implements ClassFileLocator {
        ...
        public interface ClassLoadingDelegate {
            ...
            public static class Default implements ClassLoadingDelegate {
                ...
                /* JADX INFO: renamed from: of */
                public static ClassLoadingDelegate m5261of(@MaybeNull ClassLoader classLoader) {
            ...
            public static class Explicit implements ClassLoadingDelegate {
                ...
                public Explicit(@MaybeNull ClassLoader classLoader, Collection<? extends Class<?>> collection) {
                    this(Default.m5261of(classLoader), collection);
                }

                /* JADX INFO: renamed from: of */
                public static ClassLoadingDelegate m5262of(Class<?> cls) {
        ...
        public ForInstrumentation(Instrumentation instrumentation, @MaybeNull ClassLoader classLoader) {
            this(instrumentation, ClassLoadingDelegate.Default.m5261of(classLoader));
        }
        ...
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5260of(Instrumentation instrumentation, Class<?> cls) {
            return new ForInstrumentation(instrumentation, ClassLoadingDelegate.Explicit.m5262of(cls));
        }
    ...
    public static class ForJarFile implements ClassFileLocator {
        ...
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5263of(File file) throws IOException {
        ...
        public static ClassFileLocator ofRuntimeJar() throws IOException {
            ...
            throw new IllegalStateException("Runtime jar does not exist in " + strReplace + " for any of " + RUNTIME_LOCATIONS);
        }
        ...
        @Override // net.bytebuddy.dynamic.ClassFileLocator
        public Resolution locate(String str) throws IOException {
            ZipEntry entry = this.jarFile.getEntry(str.replace(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH, '/') + ".class");
            if (entry == null) {
                return new Resolution.Illegal(str);
            }
    ...
    public static class ForModule implements ClassFileLocator {
        ...
        public static class WeaklyReferenced extends WeakReference<Object> implements ClassFileLocator {
            ...
            /* JADX INFO: renamed from: of */
            public static ClassFileLocator m5265of(JavaModule javaModule) {
                return javaModule.isNamed() ? (javaModule.getClassLoader() == null || javaModule.getClassLoader() == ClassLoader.getSystemClassLoader() || javaModule.getClassLoader() == ClassLoader.getSystemClassLoader().getParent()) ? new ForModule(javaModule) : new WeaklyReferenced(javaModule.unwrap()) : ForClassLoader.WeaklyReferenced.m5259of(javaModule.getClassLoader());
            }
            ...
            public Resolution locate(String str) throws IOException {
                Object obj = get();
                return obj == null ? new Resolution.Illegal(str) : ForModule.locate(JavaModule.m5430of(obj), str);
            }
        }
        ...
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5264of(JavaModule javaModule) {
            return javaModule.isNamed() ? new ForModule(javaModule) : ForClassLoader.m5258of(javaModule.getClassLoader());
        }
        ...
        public static ClassFileLocator ofBootLayer() {
            try {
                ...
                for (Object obj : (Set) cls.getMethod("modules", null).invoke(cls.getMethod("boot", null).invoke(null, null), null)) {
                    ClassFileLocator classFileLocatorM5264of = m5264of(JavaModule.m5430of(obj));
                    Iterator it = ((Set) method.invoke(obj, NO_ARGUMENT)).iterator();
                    while (it.hasNext()) {
                        map.put((String) it.next(), classFileLocatorM5264of);
                    }
                }
    ...
    public static class Simple implements ClassFileLocator {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5267of(String str, byte[] bArr) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 2 */
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5269of(DynamicType dynamicType) {
            return m5268of(dynamicType.getAllTypes());
        }

        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5268of(Map<TypeDescription, byte[]> map) {
            HashMap map2 = new HashMap();
    ...
    public static class ForModuleFile implements ClassFileLocator {
        ...
        /* JADX INFO: renamed from: of */
        public static ClassFileLocator m5266of(File file) throws IOException {
        ...
        public static ClassFileLocator ofBootPath() throws IOException {
            ...
            throw new IllegalStateException("Boot modules do not exist in " + strReplace + " for any of " + BOOT_LOCATIONS);
        }
        ...
        @Override // net.bytebuddy.dynamic.ClassFileLocator
        public Resolution locate(String str) throws IOException {
            ZipEntry entry = this.zipFile.getEntry("classes/" + str.replace(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH, '/') + ".class");
            if (entry == null) {
                return new Resolution.Illegal(str);
            }
        ...
        public static ClassFileLocator ofModulePath(String str, String str2) throws IOException {
            ClassFileLocator classFileLocatorM5263of;
            ClassFileLocator classFileLocatorM5263of2;
            ArrayList arrayList = new ArrayList();
                        ...
                        for (File file2 : fileArrListFiles) {
                            if (file2.isDirectory()) {
                                ...
                                if (file2.getName().endsWith(JMOD_FILE_EXTENSION)) {
                                    classFileLocatorM5263of2 = m5266of(file2);
                                } else {
                                    classFileLocatorM5263of2 = ForJarFile.m5263of(file2);
                                }
                                arrayList.add(classFileLocatorM5263of2);
                            }
                        }
                    }
                } else if (file.isFile()) {
                    if (file.getName().endsWith(JMOD_FILE_EXTENSION)) {
                        classFileLocatorM5263of = m5266of(file);
                    } else {
                        classFileLocatorM5263of = ForJarFile.m5263of(file);
                    }
                    arrayList.add(classFileLocatorM5263of);
                }
            }
            return new Compound(arrayList);
        }
