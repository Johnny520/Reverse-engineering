...
public class C6266 extends AbstractC4261 {

    /* JADX INFO: renamed from: ۥ۟۟۟ۡ, reason: contains not printable characters */
    public static final String f15464 = "MonotonicCurveFit";

    /* JADX INFO: renamed from: ۥ۟۟۟, reason: contains not printable characters */
    public double[] f15465;

    /* JADX INFO: renamed from: ۥ۟۟۟۟, reason: contains not printable characters */
    public double[][] f15466;

    /* JADX INFO: renamed from: ۥ۟۟۟۠, reason: contains not printable characters */
    public double[][] f15467;

    public C6266(double[] dArr, double[][] dArr2) {
    ...
    public static double m19290(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
        double d9 = 3.0d * d;
    ...
    public static double m19291(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
    ...
    public double mo6902(double d, int i) {
        double[] dArr = this.f15465;
        int length = dArr.length;
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f15466[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f15466[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f15465;
            double d2 = dArr2[i2];
            if (d == d2) {
                return this.f15466[i2][i];
            }
            int i4 = i2 + 1;
            double d3 = dArr2[i4];
            if (d < d3) {
                double d4 = d3 - d2;
                double d5 = (d - d2) / d4;
                double[][] dArr3 = this.f15466;
                double d6 = dArr3[i2][i];
                double d7 = dArr3[i4][i];
                double[][] dArr4 = this.f15467;
                return m19291(d4, d5, d6, d7, dArr4[i2][i], dArr4[i4][i]);
            }
            i2 = i4;
        }
        return 0.0d;
    ...
    public void mo6903(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f15466[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f15466[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f15465[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f15466[i4][i5];
                }
            }
            double[] dArr3 = this.f15465;
            int i6 = i4 + 1;
            double d2 = dArr3[i6];
            if (d < d2) {
                double d3 = dArr3[i4];
                ...
                double d5 = (d - d3) / d4;
                while (i < length2) {
                    double[][] dArr4 = this.f15466;
                    double d6 = dArr4[i4][i];
                    double d7 = dArr4[i6][i];
                    double[][] dArr5 = this.f15467;
                    dArr[i] = m19291(d4, d5, d6, d7, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public void mo6904(double d, float[] fArr) {
        ...
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f15466[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f15465[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f15466[i4][i5];
                }
            }
            double[] dArr2 = this.f15465;
            int i6 = i4 + 1;
            ...
            if (d < d2) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.f15467;
                    fArr[i] = (float) m19291(d4, d5, d6, d7, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public double mo6905(double d, int i) {
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                double[][] dArr4 = this.f15467;
                return m19290(d5, (d2 - d4) / d5, d6, d7, dArr4[i2][i], dArr4[i3][i]) / d5;
            }
            i2 = i3;
        }
        return 0.0d;
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    ...
                    double[][] dArr5 = this.f15467;
                    dArr[i3] = m19290(d5, d6, d7, d8, dArr5[i][i3], dArr5[i2][i3]) / d5;
                }
                return;
            }
            i = i2;
