...
@InterfaceC6211(m2698d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\r\u001a\u00020\f2\u000e\u0010\u000e\u001a\n\u0012\u0006\b\u0001\u0012\u00020\f0\u000b2\u0006\u0010\u000f\u001a\u00020\u0001H\u0002J\u001e\u0010\u0010\u001a\f\u0012\u0006\b\u0001\u0012\u00020\f\u0018\u00010\u000b2\n\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\bH\u0002J\u0010\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0013H\u0007J\u0014\u0010\u0015\u001a\u00020\u00042\n\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\bH\u0002J\u0016\u0010\u0016\u001a\u00020\u00172\f\u0010\u0011\u001a\b\u0012\u0002\b\u0003\u0018\u00010\bH\u0002J\u0010\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u000f\u001a\u00020\u0001H\u0007J\u0014\u0010\u001a\u001a\u00020\u00042\n\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\bH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u001e\u0010\u0006\u001a\u0012\u0012\b\u0012\u0006\u0012\u0002\b\u00030\b\u0012\u0004\u0012\u00020\u00040\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R,\u0010\t\u001a \u0012\b\u0012\u0006\u0012\u0002\b\u00030\b\u0012\u0012\u0012\u0010\u0012\f\u0012\n\u0012\u0006\b\u0001\u0012\u00020\f0\u000b0\n0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001b"}, m2699d2 = {"Landroidx/lifecycle/Lifecycling;", "", "()V", "GENERATED_CALLBACK", "", "REFLECTIVE_CALLBACK", "callbackCache", "", "Ljava/lang/Class;", "classToAdapters", "", "Ljava/lang/reflect/Constructor;", "Landroidx/lifecycle/GeneratedAdapter;", "createGeneratedAdapter", "constructor", "object", "generatedConstructor", "klass", "getAdapterName", "", "className", "getObserverConstructorType", "isLifecycleParent", "", "lifecycleEventObserver", "Landroidx/lifecycle/LifecycleEventObserver;", "resolveObserverCallbackType", "lifecycle-common"}, m2700k = 1, m2701mv = {1, 8, 0}, m2703xi = 48)
...
public final class Lifecycling {
    ...
    private final GeneratedAdapter createGeneratedAdapter(Constructor<? extends GeneratedAdapter> constructor, Object obj) {
        try {
            ...
            C5499.m17102(generatedAdapterNewInstance, "{\n            constructo…tance(`object`)\n        }");
    ...
    private final Constructor<? extends GeneratedAdapter> generatedConstructor(Class<?> cls) {
        try {
            ...
            C5499.m17102(name, "fullPackage");
            if (name.length() != 0) {
                C5499.m17102(canonicalName, "name");
                canonicalName = canonicalName.substring(name.length() + 1);
                C5499.m17102(canonicalName, "this as java.lang.String).substring(startIndex)");
            }
            C5499.m17102(canonicalName, "if (fullPackage.isEmpty(…g(fullPackage.length + 1)");
            ...
            C5499.m17101(cls2, "null cannot be cast to non-null type java.lang.Class<out androidx.lifecycle.GeneratedAdapter>");
    ...
    @InterfaceC6399
    @InterfaceC5578
    public static final String getAdapterName(@InterfaceC6399 String str) {
        C5499.m17103(str, "className");
        return C7627.m23998(str, ".", JavaConstant.Dynamic.DEFAULT_NAME, false, 4, null) + "_LifecycleAdapter";
    }
    ...
    @InterfaceC6399
    @InterfaceC5578
    public static final LifecycleEventObserver lifecycleEventObserver(@InterfaceC6399 Object obj) {
        C5499.m17103(obj, "object");
    ...
    private final int resolveObserverCallbackType(Class<?> cls) {
        ...
        if (constructorGeneratedConstructor != null) {
            classToAdapters.put(cls, C3879.m10715(constructorGeneratedConstructor));
            return 2;
        }
        ...
        if (isLifecycleParent(superclass)) {
            C5499.m17102(superclass, "superclass");
        ...
        C5499.m17102(interfaces, "klass.interfaces");
        for (Class<?> cls2 : interfaces) {
            if (isLifecycleParent(cls2)) {
                C5499.m17102(cls2, "intrface");
