...
public final class KeyValue extends com.google.flatbuffers.Table {
    ...
    public static final class Vector extends com.google.flatbuffers.BaseVector {
        ...
        public com.google.flatbuffers.reflection.KeyValue get(int r2) {
                ...
                r0.<init>()
                com.google.flatbuffers.reflection.KeyValue r2 = r1.get(r0, r2)
                return r2
        }

        public com.google.flatbuffers.reflection.KeyValue get(com.google.flatbuffers.reflection.KeyValue r2, int r3) {
                r1 = this;
                int r3 = r1.__element(r3)
                java.nio.ByteBuffer r0 = r1.bb
                int r3 = com.google.flatbuffers.reflection.KeyValue.access$000(r3, r0)
                java.nio.ByteBuffer r0 = r1.bb
        ...
        public com.google.flatbuffers.reflection.KeyValue getByKey(java.lang.String r4) {
                ...
                r2 = 0
                com.google.flatbuffers.reflection.KeyValue r4 = com.google.flatbuffers.reflection.KeyValue.__lookup_by_key(r2, r0, r4, r1)
                return r4
        }
    }
    ...
    public static com.google.flatbuffers.reflection.KeyValue __lookup_by_key(com.google.flatbuffers.reflection.KeyValue r6, int r7, java.lang.String r8, java.nio.ByteBuffer r9) {
        ...
        L32:
            ...
            r6.<init>()
        L39:
            com.google.flatbuffers.reflection.KeyValue r6 = r6.__assign(r3, r9)
            return r6
        L3e:
            r6 = 0
            return r6
    ...
    public static void addKey(com.google.flatbuffers.FlatBufferBuilder r0, int r1) {
            r0.addOffset(r1)
            r1 = 0
            r0.slot(r1)
            return
    ...
    public static com.google.flatbuffers.reflection.KeyValue getRootAsKeyValue(java.nio.ByteBuffer r1) {
            com.google.flatbuffers.reflection.KeyValue r0 = new com.google.flatbuffers.reflection.KeyValue
            r0.<init>()
            com.google.flatbuffers.reflection.KeyValue r1 = getRootAsKeyValue(r1, r0)
            return r1
    }
    ...
    public static com.google.flatbuffers.reflection.KeyValue getRootAsKeyValue(java.nio.ByteBuffer r2, com.google.flatbuffers.reflection.KeyValue r3) {
            ...
            int r1 = r2.position()
            int r0 = r0 + r1
            com.google.flatbuffers.reflection.KeyValue r2 = r3.__assign(r0, r2)
            return r2
    }
