...
final class SqlTimeTypeAdapter extends com.google.gson.TypeAdapter<java.sql.Time> {
    ...
    public /* synthetic */ SqlTimeTypeAdapter(com.google.gson.internal.sql.SqlTimeTypeAdapter.AnonymousClass1 r1) {
            r0 = this;
            r0.<init>()
            return
    }
    ...
    public java.sql.Time read2(com.google.gson.stream.JsonReader r7) throws java.io.IOException {
            r6 = this;
        ...
        Ld:
            ...
            java.sql.Time r3 = new java.sql.Time     // Catch: java.lang.Throwable -> L30 java.text.ParseException -> L32
