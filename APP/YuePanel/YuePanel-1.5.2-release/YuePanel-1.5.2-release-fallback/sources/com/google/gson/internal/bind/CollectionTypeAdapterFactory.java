...
public final class CollectionTypeAdapterFactory implements com.google.gson.TypeAdapterFactory {
    ...
    public static final class Adapter<E> extends com.google.gson.TypeAdapter<java.util.Collection<E>> {
        ...
        public Adapter(com.google.gson.TypeAdapter<E> r1, com.google.gson.internal.ObjectConstructor<? extends java.util.Collection<E>> r2) {
                r0 = this;
                r0.<init>()
                r0.elementTypeAdapter = r1
                r0.constructor = r2
                return
        }
    ...
    public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r4, com.google.gson.reflect.TypeToken<T> r5) {
            ...
            return r4
        L12:
            java.lang.reflect.Type r0 = com.google.gson.internal.GsonTypes.getCollectionElementType(r0, r1)
            ...
            com.google.gson.internal.bind.TypeAdapterRuntimeTypeWrapper r2 = new com.google.gson.internal.bind.TypeAdapterRuntimeTypeWrapper
            r2.<init>(r4, r1, r0)
            r4 = 0
            com.google.gson.internal.ConstructorConstructor r0 = r3.constructorConstructor
            com.google.gson.internal.ObjectConstructor r4 = r0.get(r5, r4)
