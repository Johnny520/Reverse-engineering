...
class TransitionUtils {
    ...
    public static com.google.android.material.shape.ShapeAppearanceModel convertToRelativeCornerSizes(com.google.android.material.shape.ShapeAppearanceModel r1, android.graphics.RectF r2) {
            com.google.android.material.transition.ۥ r0 = new com.google.android.material.transition.ۥ
            r0.<init>(r2)
    ...
    public static void maybeAddTransition(Yue.C6438 r0, @Yue.InterfaceC4544 Yue.AbstractC6398 r1) {
            if (r1 == 0) goto L5
            r0.m23719(r1)
        L5:
            return
    ...
    public static boolean maybeApplyThemeDuration(Yue.AbstractC6398 r4, android.content.Context r5, @Yue.InterfaceC0642 int r6) {
            if (r6 == 0) goto L19
    ...
    public static boolean maybeApplyThemeInterpolator(Yue.AbstractC6398 r1, android.content.Context r2, @Yue.InterfaceC0642 int r3, android.animation.TimeInterpolator r4) {
            if (r3 == 0) goto L11
    ...
    public static boolean maybeApplyThemePath(Yue.AbstractC6398 r0, android.content.Context r1, @Yue.InterfaceC0642 int r2) {
            if (r2 == 0) goto Ld
            Yue.ۥۣۡۨۡ r1 = resolveThemePath(r1, r2)
            if (r1 == 0) goto Ld
            r0.setPathMotion(r1)
            r0 = 1
            return r0
    ...
    public static void maybeRemoveTransition(Yue.C6438 r0, @Yue.InterfaceC4544 Yue.AbstractC6398 r1) {
            if (r1 == 0) goto L5
            r0.m23730(r1)
        L5:
            return
    ...
    @Yue.InterfaceC4544
    public static Yue.AbstractC4708 resolveThemePath(android.content.Context r3, @Yue.InterfaceC0642 int r4) {
    ...
    public static com.google.android.material.shape.ShapeAppearanceModel transformCornerSizes(com.google.android.material.shape.ShapeAppearanceModel r2, com.google.android.material.shape.ShapeAppearanceModel r3, android.graphics.RectF r4, com.google.android.material.transition.TransitionUtils.CornerSizeBinaryOperator r5) {
    ...
    public static /* synthetic */ com.google.android.material.shape.CornerSize m30636(android.graphics.RectF r0, com.google.android.material.shape.CornerSize r1) {
