...
abstract class MaterialVisibility<P extends com.google.android.material.transition.VisibilityAnimatorProvider> extends Yue.AbstractC6953 {
    ...
    public MaterialVisibility(P r2, @Yue.InterfaceC4544 com.google.android.material.transition.VisibilityAnimatorProvider r3) {
            r1 = this;
            r1.<init>()
    ...
    private static void addAnimatorIfNeeded(java.util.List<android.animation.Animator> r0, @Yue.InterfaceC4544 com.google.android.material.transition.VisibilityAnimatorProvider r1, android.view.ViewGroup r2, android.view.View r3, boolean r4) {
            if (r1 != 0) goto L3
            return
        L3:
            if (r4 == 0) goto La
    ...
    public void addAdditionalAnimatorProvider(@Yue.InterfaceC4410 com.google.android.material.transition.VisibilityAnimatorProvider r2) {
            r1 = this;
    ...
    public android.animation.Animator onAppear(android.view.ViewGroup r1, android.view.View r2, Yue.C6447 r3, Yue.C6447 r4) {
            r0 = this;
            r3 = 1
    ...
    @Override // Yue.AbstractC6953
    public android.animation.Animator onDisappear(android.view.ViewGroup r1, android.view.View r2, Yue.C6447 r3, Yue.C6447 r4) {
            r0 = this;
            r3 = 0
            android.animation.Animator r1 = r0.createAnimator(r1, r2, r3)
            return r1
    ...
    public boolean removeAdditionalAnimatorProvider(@Yue.InterfaceC4410 com.google.android.material.transition.VisibilityAnimatorProvider r2) {
            r1 = this;
            java.util.List<com.google.android.material.transition.VisibilityAnimatorProvider> r0 = r1.additionalAnimatorProviders
    ...
    public void setSecondaryAnimatorProvider(@Yue.InterfaceC4544 com.google.android.material.transition.VisibilityAnimatorProvider r1) {
            r0 = this;
