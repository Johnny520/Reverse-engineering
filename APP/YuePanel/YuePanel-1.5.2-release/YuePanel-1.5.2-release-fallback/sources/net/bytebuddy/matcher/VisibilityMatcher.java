...
public class VisibilityMatcher<T extends net.bytebuddy.description.ByteCodeElement> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.description.type.TypeDescription typeDescription;

    public VisibilityMatcher(net.bytebuddy.description.type.TypeDescription r1) {
            r0 = this;
            r0.<init>()
    ...
    public java.lang.String toString() {
            ...
            r0.<init>()
            java.lang.String r1 = "isVisibleTo("
            r0.append(r1)
            net.bytebuddy.description.type.TypeDescription r1 = r2.typeDescription
            r0.append(r1)
            java.lang.String r1 = ")"
