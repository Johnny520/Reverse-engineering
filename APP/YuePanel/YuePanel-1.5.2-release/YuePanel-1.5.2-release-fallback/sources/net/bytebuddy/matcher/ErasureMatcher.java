...
public class ErasureMatcher<T extends net.bytebuddy.description.type.TypeDefinition> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription> matcher;

    public ErasureMatcher(net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription> r1) {
            r0 = this;
            r0.<init>()
            r0.matcher = r1
            return
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L1a:
            ...
            net.bytebuddy.matcher.ErasureMatcher r5 = (net.bytebuddy.matcher.ErasureMatcher) r5
