...
public class HasSuperClassMatcher<T extends net.bytebuddy.description.type.TypeDescription> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription.Generic> matcher;

    public HasSuperClassMatcher(net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription.Generic> r1) {
            r0 = this;
            r0.<init>()
            r0.matcher = r1
            return
    ...
    public boolean doMatch(T r3) {
            ...
            if (r0 == 0) goto L13
            net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription$Generic> r3 = r2.matcher
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L1a:
            ...
            net.bytebuddy.matcher.HasSuperClassMatcher r5 = (net.bytebuddy.matcher.HasSuperClassMatcher) r5
    ...
    public java.lang.String toString() {
            ...
            r0.<init>()
            java.lang.String r1 = "hasSuperClass("
            r0.append(r1)
            net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription$Generic> r1 = r2.matcher
            r0.append(r1)
            java.lang.String r1 = ")"
