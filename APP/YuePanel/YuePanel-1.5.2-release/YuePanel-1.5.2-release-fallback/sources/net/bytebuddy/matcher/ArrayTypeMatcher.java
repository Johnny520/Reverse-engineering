...
public class ArrayTypeMatcher<T extends net.bytebuddy.description.type.TypeDefinition> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    public ArrayTypeMatcher() {
            r0 = this;
            r0.<init>()
            return
    }
