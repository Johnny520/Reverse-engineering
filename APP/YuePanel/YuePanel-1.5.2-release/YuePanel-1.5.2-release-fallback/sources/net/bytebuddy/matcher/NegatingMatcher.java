...
public class NegatingMatcher<T> extends net.bytebuddy.matcher.ElementMatcher.Junction.AbstractBase<T> {
    private final net.bytebuddy.matcher.ElementMatcher<? super T> matcher;

    public NegatingMatcher(net.bytebuddy.matcher.ElementMatcher<? super T> r1) {
            r0 = this;
            r0.<init>()
            r0.matcher = r1
            return
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L13:
            ...
            net.bytebuddy.matcher.NegatingMatcher r5 = (net.bytebuddy.matcher.NegatingMatcher) r5
