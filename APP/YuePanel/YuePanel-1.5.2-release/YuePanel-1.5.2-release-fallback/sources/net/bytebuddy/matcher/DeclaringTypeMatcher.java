...
public class DeclaringTypeMatcher<T extends net.bytebuddy.description.DeclaredByType> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription.Generic> matcher;

    public DeclaringTypeMatcher(net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription.Generic> r1) {
            r0 = this;
            r0.<init>()
            r0.matcher = r1
            return
    ...
    public /* bridge */ /* synthetic */ boolean doMatch(java.lang.Object r1) {
            r0 = this;
            net.bytebuddy.description.DeclaredByType r1 = (net.bytebuddy.description.DeclaredByType) r1
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L1a:
            ...
            net.bytebuddy.matcher.DeclaringTypeMatcher r5 = (net.bytebuddy.matcher.DeclaringTypeMatcher) r5
    ...
    public java.lang.String toString() {
            ...
            r0.<init>()
            java.lang.String r1 = "declaredBy("
            r0.append(r1)
            net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription$Generic> r1 = r2.matcher
            r0.append(r1)
            java.lang.String r1 = ")"
