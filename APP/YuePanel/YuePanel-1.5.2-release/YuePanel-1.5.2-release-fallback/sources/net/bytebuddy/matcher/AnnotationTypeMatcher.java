...
public class AnnotationTypeMatcher<T extends net.bytebuddy.description.annotation.AnnotationDescription> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription> matcher;

    public AnnotationTypeMatcher(net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription> r1) {
            r0 = this;
            r0.<init>()
            r0.matcher = r1
            return
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L1a:
            ...
            net.bytebuddy.matcher.AnnotationTypeMatcher r5 = (net.bytebuddy.matcher.AnnotationTypeMatcher) r5
    ...
    public java.lang.String toString() {
            ...
            r0.<init>()
            java.lang.String r1 = "ofAnnotationType("
            r0.append(r1)
            net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.TypeDescription> r1 = r2.matcher
            r0.append(r1)
            r1 = 41
