...
public class SubTypeMatcher<T extends net.bytebuddy.description.type.TypeDescription> extends net.bytebuddy.matcher.ElementMatcher.Junction.ForNonNullValues<T> {
    private final net.bytebuddy.description.type.TypeDescription typeDescription;

    public SubTypeMatcher(net.bytebuddy.description.type.TypeDescription r1) {
            r0 = this;
            r0.<init>()
    ...
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L1a:
            ...
            net.bytebuddy.matcher.SubTypeMatcher r5 = (net.bytebuddy.matcher.SubTypeMatcher) r5
    ...
    public java.lang.String toString() {
            ...
            r0.<init>()
            java.lang.String r1 = "isSubTypeOf("
            r0.append(r1)
            net.bytebuddy.description.type.TypeDescription r1 = r2.typeDescription
            r0.append(r1)
            r1 = 41
