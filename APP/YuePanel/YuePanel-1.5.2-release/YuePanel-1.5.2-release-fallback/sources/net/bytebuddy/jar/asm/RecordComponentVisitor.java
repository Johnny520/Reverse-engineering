...
public abstract class RecordComponentVisitor {
    ...
    protected net.bytebuddy.jar.asm.RecordComponentVisitor delegate;

    public RecordComponentVisitor(int r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0)
            return
    ...
    public RecordComponentVisitor(int r3, net.bytebuddy.jar.asm.RecordComponentVisitor r4) {
            r2 = this;
            r2.<init>()
    ...
    public net.bytebuddy.jar.asm.RecordComponentVisitor getDelegate() {
            r1 = this;
            net.bytebuddy.jar.asm.RecordComponentVisitor r0 = r1.delegate
            return r0
    }
