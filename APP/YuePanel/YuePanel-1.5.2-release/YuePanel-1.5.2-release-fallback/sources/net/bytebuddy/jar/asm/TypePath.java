...
public final class TypePath {
    ...
    public static net.bytebuddy.jar.asm.TypePath fromString(java.lang.String r8) {
            if (r8 == 0) goto L7c
            int r0 = r8.length()
            if (r0 != 0) goto La
            goto L7c
    ...
    public static void put(net.bytebuddy.jar.asm.TypePath r2, net.bytebuddy.jar.asm.ByteVector r3) {
            if (r2 != 0) goto L7
            r2 = 0
            r3.putByte(r2)
            goto L14
    ...
    public int getStepArgument(int r3) {
            r2 = this;
            byte[] r0 = r2.typePathContainer
            int r1 = r2.typePathOffset
            int r3 = r3 * 2
