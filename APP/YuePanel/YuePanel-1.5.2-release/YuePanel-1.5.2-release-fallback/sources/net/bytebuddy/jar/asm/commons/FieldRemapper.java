...
public class FieldRemapper extends net.bytebuddy.jar.asm.FieldVisitor {
    protected final net.bytebuddy.jar.asm.commons.Remapper remapper;

    public FieldRemapper(int r1, net.bytebuddy.jar.asm.FieldVisitor r2, net.bytebuddy.jar.asm.commons.Remapper r3) {
            r0 = this;
            r0.<init>(r1, r2)
            r0.remapper = r3
            return
    ...
    public FieldRemapper(net.bytebuddy.jar.asm.FieldVisitor r2, net.bytebuddy.jar.asm.commons.Remapper r3) {
            r1 = this;
