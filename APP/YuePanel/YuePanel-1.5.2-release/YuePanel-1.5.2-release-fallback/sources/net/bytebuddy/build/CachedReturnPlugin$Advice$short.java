...
class CachedReturnPlugin$Advice$short {
    ...
    public static short enter(@net.bytebuddy.build.CachedReturnPlugin.CacheField short r0) {
            return r0
    }
    ...
    public static void exit(@net.bytebuddy.asm.Advice.Return(readOnly = false) short r0, @net.bytebuddy.build.CachedReturnPlugin.CacheField short r1) {
            return
    }
}
