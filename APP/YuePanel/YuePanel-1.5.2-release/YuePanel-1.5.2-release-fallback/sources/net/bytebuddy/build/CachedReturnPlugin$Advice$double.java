...
class CachedReturnPlugin$Advice$double {
    ...
    public static double enter(@net.bytebuddy.build.CachedReturnPlugin.CacheField double r0) {
            return r0
    }
    ...
    public static void exit(@net.bytebuddy.asm.Advice.Return(readOnly = false) double r0, @net.bytebuddy.build.CachedReturnPlugin.CacheField double r2) {
            return
    }
}
