...
class CachedReturnPlugin$Advice$int {
    ...
    public static int enter(@net.bytebuddy.build.CachedReturnPlugin.CacheField int r0) {
            return r0
    }
    ...
    public static void exit(@net.bytebuddy.asm.Advice.Return(readOnly = false) int r0, @net.bytebuddy.build.CachedReturnPlugin.CacheField int r1) {
            return
    }
}
