...
class CachedReturnPlugin$Advice$byte {
    ...
    public static byte enter(@net.bytebuddy.build.CachedReturnPlugin.CacheField byte r0) {
            return r0
    }
    ...
    public static void exit(@net.bytebuddy.asm.Advice.Return(readOnly = false) byte r0, @net.bytebuddy.build.CachedReturnPlugin.CacheField byte r1) {
            return
    }
}
