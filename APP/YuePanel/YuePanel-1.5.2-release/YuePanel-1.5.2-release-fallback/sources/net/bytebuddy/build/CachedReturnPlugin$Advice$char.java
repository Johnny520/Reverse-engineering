...
class CachedReturnPlugin$Advice$char {
    ...
    public static char enter(@net.bytebuddy.build.CachedReturnPlugin.CacheField char r0) {
            return r0
    }
    ...
    public static void exit(@net.bytebuddy.asm.Advice.Return(readOnly = false) char r0, @net.bytebuddy.build.CachedReturnPlugin.CacheField char r1) {
            return
    }
}
