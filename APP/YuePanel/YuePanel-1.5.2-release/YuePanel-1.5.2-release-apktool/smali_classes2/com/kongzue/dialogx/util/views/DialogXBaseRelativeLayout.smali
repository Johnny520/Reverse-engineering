...
.field onBackPressedCallback:LYue/ۥۣۡۡۢ;
...
.method public static synthetic access$000(Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;)Lcom/kongzue/dialogx/interfaces/OnSafeInsetsChangeListener;
    .locals 0
...
.method public static synthetic access$100(Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;)Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$PrivateBackPressedListener;
    .locals 0

    iget-object p0, p0, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;->onBackPressedListener:Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$PrivateBackPressedListener;

    return-object p0
.end method

.method public static synthetic access$200(Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;)Ljava/lang/ref/WeakReference;
    .locals 0

    iget-object p0, p0, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;->parentDialog:Ljava/lang/ref/WeakReference;
...
.method private init(Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v2}, LYue/ۥ۠۟۠ۤ;->ۥ(Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;Z)V
...
.method private setBackPressedDispatcher(Z)V
    ...
    invoke-static {p0}, LYue/ۥۢۤۧۢ;->ۥ(Landroid/view/View;)LYue/ۥۣۡۡۥ;
    ...
    :cond_0
    invoke-interface {p1}, LYue/ۥۣۡۡۥ;->getOnBackPressedDispatcher()Landroidx/activity/OnBackPressedDispatcher;
    ...
    new-instance v1, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$2;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$2;-><init>(Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;Z)V

    iput-object v1, p0, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;->onBackPressedCallback:LYue/ۥۣۡۡۢ;

    invoke-virtual {p1, v0, v1}, Landroidx/activity/OnBackPressedDispatcher;->ۥۣ۟۟۟(Landroidx/lifecycle/LifecycleOwner;LYue/ۥۣۡۡۢ;)V

    goto :goto_0

    :cond_1
    iget-object p1, p0, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;->onBackPressedCallback:LYue/ۥۣۡۡۢ;

    if-eqz p1, :cond_2

    invoke-virtual {p1}, LYue/ۥۣۡۡۢ;->remove()V
...
.method public onAttachedToWindow()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout;->onLifecycleCallBack:Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$OnLifecycleCallBack;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lcom/kongzue/dialogx/util/views/DialogXBaseRelativeLayout$OnLifecycleCallBack;->onShow()V
