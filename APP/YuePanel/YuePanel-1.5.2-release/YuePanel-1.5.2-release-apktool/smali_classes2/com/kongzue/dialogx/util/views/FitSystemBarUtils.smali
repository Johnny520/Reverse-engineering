...
.method public static synthetic access$000(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;LYue/ۥۢۥۦ;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;->formatInsets(LYue/ۥۢۥۦ;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V

    return-void
.end method

.method public static synthetic access$102(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;Z)Z
    .locals 0
...
.method public static synthetic access$200(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;)I
    .locals 0
...
.method public static synthetic access$300(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;)I
    .locals 0
...
.method public static synthetic access$400(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V
    .locals 0
...
.method public static synthetic access$500(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;)Landroid/view/View;
    .locals 0
...
.method public static synthetic access$600(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;)I
    .locals 0
...
.method public static synthetic access$602(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;I)I
    .locals 0
...
.method public static synthetic access$700(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;)V
    .locals 0
...
.method private formatInsets(LYue/ۥۢۥۦ;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V
    .locals 13
    ...
    invoke-virtual {v0}, LYue/ۥۣ۠۟۠;->ۥ۟۟۟۠()I

    move-result v2

    invoke-virtual {v0}, LYue/ۥۣ۠۟۠;->ۥ۟۟۟()I

    move-result v3

    invoke-virtual {v0}, LYue/ۥۣ۠۟۠;->ۥ۟۟۟۟()I
    ...
    invoke-static {}, LYue/ۥۢۥۦ$ۥ۟۟۟ۧ;->ۥۣ۟۟۟()I

    move-result v6

    or-int/2addr v5, v6

    invoke-virtual {p1, v5}, LYue/ۥۢۥۦ;->ۥ۟۟۟۠(I)LYue/ۥ۠ۥۣۡ;

    move-result-object v5

    iget v6, v5, LYue/ۥ۠ۥۣۡ;->ۥ:I

    iget v7, v5, LYue/ۥ۠ۥۣۡ;->ۥ۟۟:I
    ...
    invoke-virtual {p1, v8}, LYue/ۥۢۥۦ;->ۥ۟۟ۡۡ(I)Z

    move-result v8

    if-nez v8, :cond_6

    invoke-static {}, LYue/ۥۢۥۦ$ۥ۟۟۟ۧ;->ۥ۟۟۟ۡ()I
    ...
    :cond_6
    :goto_3
    iget v8, v5, LYue/ۥ۠ۥۣۡ;->ۥ۟۟۟:I

    :goto_4
    if-eqz v12, :cond_7

    invoke-static {}, LYue/ۥۢۥۦ$ۥ۟۟۟ۧ;->ۥ۟۟۟ۢ()I

    move-result v9

    invoke-virtual {p1, v9}, LYue/ۥۢۥۦ;->ۥ۟۟ۡۡ(I)Z

    move-result p1

    if-eqz p1, :cond_7

    iget p1, v5, LYue/ۥ۠ۥۣۡ;->ۥ۟:I
    ...
    :goto_5
    invoke-direct {p0, v5}, Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;->isWrongInsets(LYue/ۥ۠ۥۣۡ;)Z
...
.method private getNavigationBarHeight()I
    ...
    invoke-static {v3}, LYue/ۥۢ۟ۢۧ;->ۥ(Landroid/view/View;)Landroid/view/WindowInsetsController;
    ...
    invoke-static {v3}, LYue/ۥۢۦ۟ۡ;->ۥ(Landroid/view/WindowInsetsController;)I
...
.method private isWrongInsets(LYue/ۥ۠ۥۣۡ;)Z
    .locals 1

    iget v0, p1, LYue/ۥ۠ۥۣۡ;->ۥ۟:I

    if-nez v0, :cond_0

    iget v0, p1, LYue/ۥ۠ۥۣۡ;->ۥ۟۟۟:I
...
.method private synthetic lambda$applyWindowInsets$0(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;Landroid/view/View;LYue/ۥۢۥۦ;)LYue/ۥۢۥۦ;
    .locals 0
    ...
    invoke-direct {p0, p3, p2}, Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;->formatInsets(LYue/ۥۢۥۦ;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V

    return-object p3
.end method

.method public static synthetic ۥ(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;Landroid/view/View;LYue/ۥۢۥۦ;)LYue/ۥۢۥۦ;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;->lambda$applyWindowInsets$0(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;Landroid/view/View;LYue/ۥۢۥۦ;)LYue/ۥۢۥۦ;
...
.method public applyWindowInsets()V
    ...
    invoke-static {v1}, LYue/ۥۢۤۤۦ;->ۥ۟۟ۤۥ(Landroid/view/View;)I
    ...
    new-instance v2, LYue/ۥ۠ۢۡۦ;

    invoke-direct {v2, p0, v0}, LYue/ۥ۠ۢۡۦ;-><init>(Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;Lcom/kongzue/dialogx/util/views/FitSystemBarUtils$RelativePadding;)V

    invoke-static {v1, v2}, LYue/ۥۢۤۤۦ;->ۥۣ۟۠ۦ(Landroid/view/View;LYue/ۥۣۡۡۡ;)V
    ...
    invoke-static {v1, v2}, LYue/ۥۢۤۤۦ;->ۥ۟۠ۥۧ(Landroid/view/View;LYue/ۥۢۥۣۥ$ۥ۟;)V

    :cond_0
    iget-object v1, p0, Lcom/kongzue/dialogx/util/views/FitSystemBarUtils;->contentView:Landroid/view/View;

    invoke-static {v1}, LYue/ۥۢۤۤۦ;->ۥ۟۟ۧۢ(Landroid/view/View;)Z
