...
# static fields
.field public static final ۥ:Ljava/lang/String; = "http://www.slf4j.org/codes.html#null_MDCA"

.field public static final ۥ۟:Ljava/lang/String; = "http://www.slf4j.org/codes.html#no_static_mdc_binder"

.field public static ۥ۟۟:Lorg/slf4j/spi/MDCAdapter;
...
.method static constructor <clinit>()V
    ...
    :try_start_0
    invoke-static {}, LYue/ۥ۠ۨۤۡ;->ۥ()Lorg/slf4j/spi/MDCAdapter;

    move-result-object v0

    sput-object v0, LYue/ۥ۠ۨۤۡ;->ۥ۟۟:Lorg/slf4j/spi/MDCAdapter;
    :try_end_0
    ...
    :goto_1
    new-instance v1, LYue/ۥۡۢ۠;

    invoke-direct {v1}, LYue/ۥۡۢ۠;-><init>()V

    sput-object v1, LYue/ۥ۠ۨۤۡ;->ۥ۟۟:Lorg/slf4j/spi/MDCAdapter;
...
.method public static ۥ()Lorg/slf4j/spi/MDCAdapter;
    .locals 1
...
.method public static ۥ۟()V
    ...
    sget-object v0, LYue/ۥ۠ۨۤۡ;->ۥ۟۟:Lorg/slf4j/spi/MDCAdapter;
...
.method public static ۥ۟۟۟()Ljava/util/Map;
    .locals 2
    ...
    invoke-interface {v0}, Lorg/slf4j/spi/MDCAdapter;->ۥ۟()Ljava/util/Map;
...
.method public static ۥ۟۟۟۟()Lorg/slf4j/spi/MDCAdapter;
    .locals 1
...
.method public static ۥ۟۟۟۠(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalArgumentException;
...
.method public static ۥ۟۟۟ۡ(Ljava/lang/String;Ljava/lang/String;)LYue/ۥ۠ۨۤۡ$ۥ۟;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalArgumentException;
    ...
    invoke-static {p0, p1}, LYue/ۥ۠ۨۤۡ;->ۥ۟۟۟۠(Ljava/lang/String;Ljava/lang/String;)V

    new-instance p1, LYue/ۥ۠ۨۤۡ$ۥ۟;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, LYue/ۥ۠ۨۤۡ$ۥ۟;-><init>(Ljava/lang/String;LYue/ۥ۠ۨۤۡ$ۥ;)V

    return-object p1
.end method

.method public static ۥ۟۟۟ۢ(Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalArgumentException;
...
.method public static ۥۣ۟۟۟(Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p0}, Lorg/slf4j/spi/MDCAdapter;->ۥ(Ljava/util/Map;)V
