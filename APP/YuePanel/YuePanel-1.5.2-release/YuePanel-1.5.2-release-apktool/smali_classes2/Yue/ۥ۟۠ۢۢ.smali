...
# static fields
.field public static final ۥ:LYue/ۥ۟۠ۢۢ;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, LYue/ۥ۟۠ۢۢ;

    invoke-direct {v0}, LYue/ۥ۟۠ۢۢ;-><init>()V

    sput-object v0, LYue/ۥ۟۠ۢۢ;->ۥ:LYue/ۥ۟۠ۢۢ;
    ...
    invoke-virtual {v0}, LYue/ۥ۟ۨۤ۟;->ۥ۟۟۠ۤ()Z

    move-result v0

    :goto_4
    sput-boolean v0, LYue/ۥ۟۠ۢۢ;->ۥ۟:Z
...
.method public static synthetic ۥ(Lsun/misc/Signal;)V
    .locals 0

    invoke-static {p0}, LYue/ۥ۟۠ۢۢ;->ۥ۟۟(Lsun/misc/Signal;)V

    return-void
.end method

.method public static final ۥ۟۟(Lsun/misc/Signal;)V
    .locals 1

    sget-object p0, LYue/ۥ۟ۨۤ۟;->ۥ:LYue/ۥ۟ۨۤ۟;

    invoke-virtual {p0}, LYue/ۥ۟ۨۤ۟;->ۥ۟۟ۡ()Z
    ...
    invoke-virtual {p0, v0}, LYue/ۥ۟ۨۤ۟;->ۥ۟۟۟۠(Ljava/io/PrintStream;)V
...
.method public static final ۥ۟۟۟(Ljava/lang/String;Ljava/lang/instrument/Instrumentation;)V
    .locals 1
    ...
    sget-object p0, LYue/ۥ۟۠ۢ۠;->ۥ:LYue/ۥ۟۠ۢ۠;

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, LYue/ۥ۟۠ۢ۠;->ۥ۟(Z)V

    sget-object p0, LYue/ۥ۟۠ۢۢ$ۥ;->ۥ:LYue/ۥ۟۠ۢۢ$ۥ;
    ...
    sget-boolean p1, LYue/ۥ۟۠ۢۢ;->ۥ۟:Z

    invoke-virtual {p0, p1}, LYue/ۥ۟ۨۤ۟;->ۥ۟۟ۢ(Z)V

    invoke-virtual {p0}, LYue/ۥ۟ۨۤ۟;->ۥ۟۟۠ۧ()V

    sget-object p0, LYue/ۥ۟۠ۢۢ;->ۥ:LYue/ۥ۟۠ۢۢ;

    invoke-virtual {p0}, LYue/ۥ۟۠ۢۢ;->ۥ۟()V
...
.method public final ۥ۟()V
    ...
    new-instance v1, LYue/ۥ۟۠ۢۡ;

    invoke-direct {v1}, LYue/ۥ۟۠ۢۡ;-><init>()V
