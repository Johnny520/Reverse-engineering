...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge;->getInternalSingle-hUnOzRk(Lorg/luckypray/dexkit/DexKitCacheBridge$QueryKind;Ljava/lang/String;Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleResolveMode;LYue/ۥۣ۠۠ۨ;LYue/ۥۣ۠ۢۢ;LYue/ۥۣ۠ۡ۟;)Ljava/lang/Object;
.end annotation
...
# instance fields
.field final synthetic $executor:LYue/ۥۣ۠ۢۢ;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LYue/\u06e5\u06e0\u06e3\u06e2\u06e2<",
...
.field final synthetic $mapper:LYue/ۥۣ۠ۡ۟;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LYue/\u06e5\u06e0\u06e3\u06e1\u06df<",
            "TD;TR;>;"
...
# direct methods
.method public constructor <init>(Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge;LYue/ۥۣ۠ۢۢ;Lorg/luckypray/dexkit/query/base/BaseFinder;LYue/ۥۣ۠ۡ۟;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1;->$executor:LYue/ۥۣ۠ۢۢ;
    ...
    iput-object p4, p0, Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1;->$mapper:LYue/ۥۣ۠ۡ۟;
...
.method public final invoke()Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome;
    ...
    iget-object v1, p0, Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1;->$executor:LYue/ۥۣ۠ۢۢ;
    ...
    iget-object v3, p0, Lorg/luckypray/dexkit/DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1;->$mapper:LYue/ۥۣ۠ۡ۟;
    ...
    invoke-static {v0}, Lorg/luckypray/dexkit/cache/CacheBridgeRuntime;->access$getCreateBridge$p(Lorg/luckypray/dexkit/cache/CacheBridgeRuntime;)LYue/ۥۣ۠۠ۨ;

    move-result-object v5

    invoke-interface {v5}, LYue/ۥۣ۠۠ۨ;->invoke()Ljava/lang/Object;
    ...
    .line 10
    invoke-static {v0}, Lorg/luckypray/dexkit/cache/CacheBridgeRuntime;->access$getNotifyBridgeCreated$p(Lorg/luckypray/dexkit/cache/CacheBridgeRuntime;)LYue/ۥۣ۠۠ۨ;

    move-result-object v4

    invoke-interface {v4}, LYue/ۥۣ۠۠ۨ;->invoke()Ljava/lang/Object;
    ...
    :cond_1
    :goto_1
    invoke-interface {v1, v5, v2}, LYue/ۥۣ۠ۢۢ;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 12
    invoke-static {v1}, LYue/ۥ۟ۥۢ۠;->ۥ۟۠ۥۣ(Ljava/util/List;)Ljava/lang/Object;
    ...
    .line 13
    new-instance v1, Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome$NoResult;

    const/4 v2, 0x0

    invoke-direct {v1, v2, v6, v2}, Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome$NoResult;-><init>(Lorg/luckypray/dexkit/exceptions/NoResultException;ILYue/ۥ۟ۨۥۢ;)V
    ...
    invoke-static {v2, v5}, LYue/ۥ۠ۥۧ۠;->ۥ۟۟۟ۡ(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 16
    new-instance v2, Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome$NonUnique;

    .line 17
    new-instance v3, Lorg/luckypray/dexkit/exceptions/NonUniqueResultException;

    invoke-interface {v1}, Ljava/util/List;->size()I

    move-result v1

    invoke-direct {v3, v1}, Lorg/luckypray/dexkit/exceptions/NonUniqueResultException;-><init>(I)V

    .line 18
    invoke-direct {v2, v3}, Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome$NonUnique;-><init>(Lorg/luckypray/dexkit/exceptions/NonUniqueResultException;)V
    ...
    invoke-interface {v3, v2}, LYue/ۥۣ۠ۡ۟;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lorg/luckypray/dexkit/wrap/ISerializable;

    invoke-direct {v1, v2}, Lorg/luckypray/dexkit/cache/CacheBridgeStore$SingleOutcome$Value;-><init>(Lorg/luckypray/dexkit/wrap/ISerializable;)V
    :try_end_2
