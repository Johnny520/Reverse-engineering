...
.field private reader:LYue/ۥۢۦۣۡ;
...
.method public constructor <init>(LYue/ۥۢۦۣۡ;)V
    ...
    iput-object p1, p0, Lorg/simpleframework/xml/stream/StreamReader;->reader:LYue/ۥۢۦۣۡ;

    return-void
.end method

.method private attribute(LYue/ۥ۟ۢ۠ۡ;)Lorg/simpleframework/xml/stream/StreamReader$Entry;
    .locals 1

    new-instance v0, Lorg/simpleframework/xml/stream/StreamReader$Entry;

    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Entry;-><init>(LYue/ۥ۟ۢ۠ۡ;)V
...
.method private build(Lorg/simpleframework/xml/stream/StreamReader$Start;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    ...
    invoke-direct {p0, v1}, Lorg/simpleframework/xml/stream/StreamReader;->attribute(LYue/ۥ۟ۢ۠ۡ;)Lorg/simpleframework/xml/stream/StreamReader$Entry;
...
.method private read()Lorg/simpleframework/xml/stream/EventNode;
    ...
    iget-object v0, p0, Lorg/simpleframework/xml/stream/StreamReader;->reader:LYue/ۥۢۦۣۡ;

    invoke-interface {v0}, LYue/ۥۢۦۣۡ;->ۥ۟۟۟ۤ()LYue/ۥۢۦ۠ۨ;

    move-result-object v0

    invoke-interface {v0}, LYue/ۥۢۦ۠ۨ;->ۥ۟۟ۤۤ()Z
    ...
    invoke-direct {p0, v0}, Lorg/simpleframework/xml/stream/StreamReader;->start(LYue/ۥۢۦ۠ۨ;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    ...
    invoke-direct {p0, v0}, Lorg/simpleframework/xml/stream/StreamReader;->text(LYue/ۥۢۦ۠ۨ;)Lorg/simpleframework/xml/stream/StreamReader$Text;
...
.method private start(LYue/ۥۢۦ۠ۨ;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    .locals 1

    new-instance v0, Lorg/simpleframework/xml/stream/StreamReader$Start;

    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Start;-><init>(LYue/ۥۢۦ۠ۨ;)V
...
.method private text(LYue/ۥۢۦ۠ۨ;)Lorg/simpleframework/xml/stream/StreamReader$Text;
    .locals 1

    new-instance v0, Lorg/simpleframework/xml/stream/StreamReader$Text;

    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Text;-><init>(LYue/ۥۢۦ۠ۨ;)V
