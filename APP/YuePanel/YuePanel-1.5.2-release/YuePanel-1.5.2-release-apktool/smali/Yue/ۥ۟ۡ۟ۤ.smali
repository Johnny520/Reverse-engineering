...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ:Z
...
.method public mapProperties(Landroid/view/inspector/PropertyMapper;)V
    ...
    sget v1, LYue/ۥۡۥۦۢ$ۥ۟;->ۥ۟۟ۢۧ:I

    invoke-static {p1, v0, v1}, LYue/ۥ۟ۡ۟ۢ;->ۥ(Landroid/view/inspector/PropertyMapper;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟:I

    const-string v0, "autoSizeMinTextSize"

    sget v1, LYue/ۥۡۥۦۢ$ۥ۟;->ۥ۟۟ۢۨ:I

    invoke-static {p1, v0, v1}, LYue/ۥ۟ۡ۟ۢ;->ۥ(Landroid/view/inspector/PropertyMapper;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟:I

    const-string v0, "autoSizeStepGranularity"

    sget v1, LYue/ۥۡۥۦۢ$ۥ۟;->ۥۣ۟۟۟:I

    invoke-static {p1, v0, v1}, LYue/ۥ۟ۡ۟ۢ;->ۥ(Landroid/view/inspector/PropertyMapper;Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟۟:I

    sget v0, LYue/ۥۡۥۦۢ$ۥ۟;->ۥۣ۟۟۠:I

    new-instance v1, LYue/ۥ۟ۡ۟ۤ$ۥ;

    invoke-direct {v1, p0}, LYue/ۥ۟ۡ۟ۤ$ۥ;-><init>(LYue/ۥ۟ۡ۟ۤ;)V

    const-string v2, "autoSizeTextType"

    invoke-static {p1, v2, v0, v1}, LYue/ۥۣ۟ۡ۟;->ۥ(Landroid/view/inspector/PropertyMapper;Ljava/lang/String;ILjava/util/function/IntFunction;)I

    move-result v0

    iput v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟۟۟:I
    ...
    iput p1, p0, LYue/ۥ۟ۡ۟ۤ;->ۥۣ۟۟۟:I

    const/4 p1, 0x1

    iput-boolean p1, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ:Z
...
.method public bridge synthetic readProperties(Ljava/lang/Object;Landroid/view/inspector/PropertyReader;)V
    ...
    check-cast p1, LYue/ۥ۟ۡ۟ۥ;

    invoke-virtual {p0, p1, p2}, LYue/ۥ۟ۡ۟ۤ;->ۥ(LYue/ۥ۟ۡ۟ۥ;Landroid/view/inspector/PropertyReader;)V

    return-void
.end method

.method public ۥ(LYue/ۥ۟ۡ۟ۥ;Landroid/view/inspector/PropertyReader;)V
    .locals 2
    .param p1    # LYue/ۥ۟ۡ۟ۥ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    iget-boolean v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ:Z

    if-eqz v0, :cond_0

    iget v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟:I

    invoke-virtual {p1}, LYue/ۥ۟ۡ۟ۥ;->getAutoSizeMaxTextSize()I

    move-result v1

    invoke-static {p2, v0, v1}, LYue/ۥ۟ۡ۟۠;->ۥ(Landroid/view/inspector/PropertyReader;II)V

    iget v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟:I

    invoke-virtual {p1}, LYue/ۥ۟ۡ۟ۥ;->getAutoSizeMinTextSize()I

    move-result v1

    invoke-static {p2, v0, v1}, LYue/ۥ۟ۡ۟۠;->ۥ(Landroid/view/inspector/PropertyReader;II)V

    iget v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟۟:I

    invoke-virtual {p1}, LYue/ۥ۟ۡ۟ۥ;->getAutoSizeStepGranularity()I

    move-result v1

    invoke-static {p2, v0, v1}, LYue/ۥ۟ۡ۟۠;->ۥ(Landroid/view/inspector/PropertyReader;II)V

    iget v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟۟۟:I

    invoke-virtual {p1}, LYue/ۥ۟ۡ۟ۥ;->getAutoSizeTextType()I

    move-result v1

    invoke-static {p2, v0, v1}, LYue/ۥ۟ۡ۟ۡ;->ۥ(Landroid/view/inspector/PropertyReader;II)V

    iget v0, p0, LYue/ۥ۟ۡ۟ۤ;->ۥ۟۟۟۠:I
