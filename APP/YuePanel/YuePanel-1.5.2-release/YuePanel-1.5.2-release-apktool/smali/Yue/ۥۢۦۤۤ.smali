...
.method static constructor <clinit>()V
    ...
    sput-object v0, LYue/ۥۢۦۤۤ;->ۥ:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, LYue/ۥۢۦۤۤ;->ۥ۟:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, LYue/ۥۢۦۤۤ;->ۥ۟۟:Ljava/util/List;
...
.method public static ۥ۟()V
    ...
    :try_start_0
    invoke-static {v1}, LYue/ۥۢۦۤۤ;->yue_xin_awa(I)Ljava/lang/String;
    ...
    new-instance v2, LYue/ۥۢۦۤۤ$ۥ;

    invoke-direct {v2}, LYue/ۥۢۦۤۤ$ۥ;-><init>()V

    invoke-static {v1, v2}, LYue/ۥ۠ۤۦۢ;->ۥ۟۟۟ۥ(Ljava/lang/Class;Lde/robv/android/xposed/XC_MethodHook;)Ljava/util/Set;
    :try_end_0
    ...
    invoke-static {v2}, LYue/ۥۢۦۤۤ;->yue_xin_awa(I)Ljava/lang/String;

    move-result-object v2

    const-class v3, Landroid/os/Bundle;

    new-instance v4, LYue/ۥۢۦۤۤ$ۥ۟;

    invoke-direct {v4}, LYue/ۥۢۦۤۤ$ۥ۟;-><init>()V

    filled-new-array {v3, v4}, [Ljava/lang/Object;

    move-result-object v3

    invoke-static {v1, v2, v3}, LYue/ۥ۠ۤۦۢ;->ۥ۟۟۟(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)LYue/ۥ۠ۤۦۢ$ۥ۟;
    ...
    new-instance v2, LYue/ۥۢۦۤۤ$ۥ۟۟;

    invoke-direct {v2}, LYue/ۥۢۦۤۤ$ۥ۟۟;-><init>()V
...
.method public static native ۥ۟۟()V
.end method
