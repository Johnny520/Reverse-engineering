...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LYue/ۥۣۡۤۨ;->ۥ۟۟۟ۦ(LYue/ۥ۟ۤۧ۠;Ljava/lang/ClassLoader;)V
.end annotation
...
.method public constructor <init>(LYue/ۥۣۡۤۨ;Ljava/lang/Class;LYue/ۥ۟ۤۧ۠;)V
    ...
    iput-object p1, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۥ:LYue/ۥۣۡۤۨ;

    iput-object p2, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥۣ۟۟۠:Ljava/lang/Class;

    iput-object p3, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۤ:LYue/ۥ۟ۤۧ۠;
...
.method private static synthetic yue_xin_awa(I)Ljava/lang/String;
    ...
    :cond_0
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ۠:Ljava/lang/String;

    if-nez p0, :cond_1

    const-wide v0, -0x5756797a67020611L    # -8.292118214937559E-113

    invoke-static {v0, v1}, LYue/ۥ۠ۥۨۧ;->ۥ(J)Ljava/lang/String;

    move-result-object p0

    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ۠:Ljava/lang/String;

    :cond_1
    return-object p0

    :cond_2
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ۟:Ljava/lang/String;
    ...
    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ۟:Ljava/lang/String;

    :cond_3
    return-object p0

    :cond_4
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ:Ljava/lang/String;

    if-nez p0, :cond_5

    const-wide v0, 0x4d40a83670b65499L    # 1.3704651095819686E64

    invoke-static {v0, v1}, LYue/ۥ۠ۥۨۧ;->ۥ(J)Ljava/lang/String;

    move-result-object p0

    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟ۡ:Ljava/lang/String;

    :cond_5
    return-object p0

    :cond_6
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۨ:Ljava/lang/String;
    ...
    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۨ:Ljava/lang/String;

    :cond_7
    return-object p0

    :cond_8
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۧ:Ljava/lang/String;

    if-nez p0, :cond_9

    const-wide v0, -0x110c26720ea11459L    # -2.938957975357667E226

    invoke-static {v0, v1}, LYue/ۥ۠ۥۨۧ;->ۥ(J)Ljava/lang/String;

    move-result-object p0

    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۧ:Ljava/lang/String;

    :cond_9
    return-object p0

    :cond_a
    sget-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۦ:Ljava/lang/String;

    if-nez p0, :cond_b

    const-wide v0, -0x68b5ba10fc62488cL

    invoke-static {v0, v1}, LYue/ۥ۠ۥۨۧ;->ۥ(J)Ljava/lang/String;

    move-result-object p0

    sput-object p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۦ:Ljava/lang/String;
...
.method public static synthetic ۥ(Ljava/lang/Class;LYue/ۥ۟ۤۧ۠;Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;Lcom/kongzue/dialogx/dialogs/MessageDialog;Landroid/view/View;)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۟(Ljava/lang/Class;LYue/ۥ۟ۤۧ۠;Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;Lcom/kongzue/dialogx/dialogs/MessageDialog;Landroid/view/View;)Z
...
.method public static synthetic ۥ۟۟۟(Ljava/lang/Class;LYue/ۥ۟ۤۧ۠;Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;Lcom/kongzue/dialogx/dialogs/MessageDialog;Landroid/view/View;)Z
    ...
    :try_start_0
    invoke-static {p3}, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->yue_xin_awa(I)Ljava/lang/String;
    ...
    invoke-static {p2}, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->yue_xin_awa(I)Ljava/lang/String;
...
.method public beforeHookedMethod(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)V
    ...
    iget-object v0, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۥ:LYue/ۥۣۡۤۨ;

    const/4 v1, 0x0

    invoke-static {v1}, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->yue_xin_awa(I)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥۣ۟۟۠:Ljava/lang/Class;
    ...
    iget-object p1, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥۣ۟۟۠:Ljava/lang/Class;
    ...
    invoke-static {v0}, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->yue_xin_awa(I)Ljava/lang/String;
    ...
    iget-object v2, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥۣ۟۟۠:Ljava/lang/Class;

    iget-object v3, p0, LYue/ۥۣۡۤۨ$ۥ۟۟۟ۤ;->ۥ۟۟۠ۤ:LYue/ۥ۟ۤۧ۠;

    new-instance v4, LYue/ۥۡۥۣ۟;

    invoke-direct {v4, v2, v3, p1}, LYue/ۥۡۥۣ۟;-><init>(Ljava/lang/Class;LYue/ۥ۟ۤۧ۠;Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)V
