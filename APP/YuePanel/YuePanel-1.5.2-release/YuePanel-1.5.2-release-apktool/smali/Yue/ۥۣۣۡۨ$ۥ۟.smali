...
.method public constructor <init>(C[F)V
    ...
    .line 2
    iput-char p1, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ:C

    .line 3
    iput-object p2, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    return-void
.end method

.method public constructor <init>(LYue/ۥۣۣۡۨ$ۥ۟;)V
    .locals 2
    ...
    .line 5
    iget-char v0, p1, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ:C

    iput-char v0, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ:C

    .line 6
    iget-object p1, p1, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    const/4 v0, 0x0

    array-length v1, p1

    invoke-static {p1, v0, v1}, LYue/ۥۣۣۡۨ;->ۥ۟۟([FII)[F

    move-result-object p1

    iput-object p1, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    return-void
.end method

.method public static synthetic ۥ(LYue/ۥۣۣۡۨ$ۥ۟;)C
    .locals 0

    iget-char p0, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ:C

    return p0
.end method

.method public static synthetic ۥ۟(LYue/ۥۣۣۡۨ$ۥ۟;C)C
    .locals 0
...
.method public static synthetic ۥ۟۟(LYue/ۥۣۣۡۨ$ۥ۟;)[F
    .locals 0

    iget-object p0, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    return-object p0
.end method

.method public static synthetic ۥ۟۟۟(Landroid/graphics/Path;[FCC[F)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟۟۟۟(Landroid/graphics/Path;[FCC[F)V

    return-void
.end method

.method public static ۥ۟۟۟۟(Landroid/graphics/Path;[FCC[F)V
    .locals 25
    ...
    invoke-static/range {v0 .. v9}, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟۟۟ۡ(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static ۥ۟۟۟۠(Landroid/graphics/Path;DDDDDDDDD)V
    .locals 49
...
.method public static ۥ۟۟۟ۡ(Landroid/graphics/Path;FFFFFFFZZ)V
    .locals 41
    ...
    invoke-static/range {v6 .. v24}, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟۟۟۠(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static ۥ۟۟۟ۥ([LYue/ۥۣۣۡۨ$ۥ۟;Landroid/graphics/Path;)V
    .locals 0
    ...
    invoke-static {p0, p1}, LYue/ۥۣۣۡۨ;->ۥ۟۟۟ۦ([LYue/ۥۣۣۡۨ$ۥ۟;Landroid/graphics/Path;)V
...
.method public ۥ۟۟۟ۢ()[F
    ...
    iget-object v0, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    return-object v0
.end method

.method public ۥۣ۟۟۟()C
    .locals 1

    iget-char v0, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ:C

    return v0
.end method

.method public ۥ۟۟۟ۤ(LYue/ۥۣۣۡۨ$ۥ۟;LYue/ۥۣۣۡۨ$ۥ۟;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F

    array-length v2, v1

    if-ge v0, v2, :cond_0

    iget-object v2, p0, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F
    ...
    iget-object v3, p2, LYue/ۥۣۣۡۨ$ۥ۟;->ۥ۟:[F
