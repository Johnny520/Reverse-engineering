...
# static fields
.field public static final ۥۣ۟۟۠:Ljava/lang/String; = "android:clipBounds:clip"

.field public static final ۥ۟۟۠ۤ:Ljava/lang/String; = "android:clipBounds:bounds"

.field public static final ۥ۟۟۠ۥ:[Ljava/lang/String;

.field public static final ۥ۟۟۠ۦ:Landroid/graphics/Rect;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LYue/ۥۣ۟ۤ۠;->ۥ۟۟۠ۥ:[Ljava/lang/String;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, LYue/ۥۣ۟ۤ۠;->ۥ۟۟۠ۦ:Landroid/graphics/Rect;
...
.method public captureEndValues(LYue/ۥۢۢۡۤ;)V
    ...
    invoke-virtual {p0, p1, v0}, LYue/ۥۣ۟ۤ۠;->ۥ۟۟ۡ۟(LYue/ۥۢۢۡۤ;Z)V
...
.method public createAnimator(Landroid/view/ViewGroup;LYue/ۥۢۢۡۤ;LYue/ۥۢۢۡۤ;)Landroid/animation/Animator;
    ...
    new-instance p1, LYue/ۥۡۦۡۤ;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    invoke-direct {p1, v3}, LYue/ۥۡۦۡۤ;-><init>(Landroid/graphics/Rect;)V

    iget-object v3, p3, LYue/ۥۢۢۡۤ;->ۥ۟:Landroid/view/View;

    sget-object v4, LYue/ۥۢۤۨ;->ۥ۟۟۟:Landroid/util/Property;
    ...
    new-instance p3, LYue/ۥۣ۟ۤ۠$ۥ;

    invoke-direct {p3, p2, v0, v1}, LYue/ۥۣ۟ۤ۠$ۥ;-><init>(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    invoke-virtual {p1, p3}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {p0, p3}, LYue/ۥۢۢ۟ۧ;->addListener(LYue/ۥۢۢ۟ۧ$ۥ۟۟۟ۤ;)LYue/ۥۢۢ۟ۧ;
...
.method public getTransitionProperties()[Ljava/lang/String;
    ...
    sget-object v0, LYue/ۥۣ۟ۤ۠;->ۥ۟۟۠ۥ:[Ljava/lang/String;
...
.method public final ۥ۟۟ۡ۟(LYue/ۥۢۢۡۤ;Z)V
    .locals 3
    ...
    :cond_2
    sget-object v2, LYue/ۥۣ۟ۤ۠;->ۥ۟۟۠ۦ:Landroid/graphics/Rect;
    ...
    :goto_1
    iget-object p2, p1, LYue/ۥۢۢۡۤ;->ۥ:Ljava/util/Map;
