...
.method public constructor <init>(LYue/ۥ۠۟ۧۦ;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iput-object p2, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟:Landroid/content/Context;

    iput-object p3, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟۟:Landroid/net/Uri;

    return-void
.end method

.method public static ۥ۟۟۠ۦ(Ljava/lang/AutoCloseable;)V
    .locals 0
...
.method public static ۥ۟۟۠ۧ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 0
    .annotation build LYue/ۥۡۢۧ۠;
    .end annotation
...
.method public ۥ()Z
    ...
    iget-object v0, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟:Landroid/content/Context;

    iget-object v1, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟۟:Landroid/net/Uri;
...
.method public ۥ۟۟(Ljava/lang/String;)LYue/ۥ۠۟ۧۦ;
    ...
    invoke-static {v0, v1, v2, p1}, LYue/ۥۢۢۡۨ;->ۥ۟۟۠ۧ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    if-eqz p1, :cond_0

    new-instance v0, LYue/ۥۢۢۡۨ;

    iget-object v1, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, LYue/ۥۢۢۡۨ;-><init>(LYue/ۥ۠۟ۧۦ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public ۥ۟۟۟(Ljava/lang/String;Ljava/lang/String;)LYue/ۥ۠۟ۧۦ;
    ...
    invoke-static {v0, v1, p1, p2}, LYue/ۥۢۢۡۨ;->ۥ۟۟۠ۧ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    if-eqz p1, :cond_0

    new-instance p2, LYue/ۥۢۢۡۨ;

    iget-object v0, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟:Landroid/content/Context;

    invoke-direct {p2, p0, v0, p1}, LYue/ۥۢۢۡۨ;-><init>(LYue/ۥ۠۟ۧۦ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public ۥ۟۟۟ۨ()Landroid/net/Uri;
    ...
    iget-object v0, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟۟:Landroid/net/Uri;
...
.method public ۥ۟۟۠ۤ()[LYue/ۥ۠۟ۧۦ;
    ...
    iget-object v2, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟۟:Landroid/net/Uri;
    ...
    :cond_0
    :goto_1
    invoke-static {v8}, LYue/ۥۢۢۡۨ;->ۥ۟۟۠ۦ(Ljava/lang/AutoCloseable;)V
    ...
    new-instance v2, LYue/ۥۢۢۡۨ;

    iget-object v3, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟:Landroid/content/Context;

    aget-object v4, v0, v7

    invoke-direct {v2, p0, v3, v4}, LYue/ۥۢۢۡۨ;-><init>(LYue/ۥ۠۟ۧۦ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public ۥ۟۟۠ۥ(Ljava/lang/String;)Z
    ...
    iput-object p1, p0, LYue/ۥۢۢۡۨ;->ۥ۟۟۟:Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
