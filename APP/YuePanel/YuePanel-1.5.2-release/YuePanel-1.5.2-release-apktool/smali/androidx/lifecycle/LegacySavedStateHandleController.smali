...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "create",
        "(Landroidx/savedstate/\u06e5;Landroidx/lifecycle/Lifecycle;Ljava/lang/String;Landroid/os/Bundle;)Landroidx/lifecycle/SavedStateHandleController;",
        "Landroidx/lifecycle/ViewModel;",
        "viewModel",
        "LYue/\u06e5\u06e2\u06e3\u06e0\u06e4;",
        "attachHandleIfNeeded",
        "(Landroidx/lifecycle/ViewModel;Landroidx/savedstate/\u06e5;Landroidx/lifecycle/Lifecycle;)V",
        "tryToAddRecreator",
        "(Landroidx/savedstate/\u06e5;Landroidx/lifecycle/Lifecycle;)V",
...
.method public static final attachHandleIfNeeded(Landroidx/lifecycle/ViewModel;Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/lifecycle/SavedStateHandleController;->attachToLifecycle(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/lifecycle/LegacySavedStateHandleController;->tryToAddRecreator(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V

    :cond_0
    return-void
.end method

.method public static final create(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;Ljava/lang/String;Landroid/os/Bundle;)Landroidx/lifecycle/SavedStateHandleController;
    .locals 2
    .param p0    # Landroidx/savedstate/ۥ;
        .annotation build LYue/ۥۡۢۥ۠;
        .end annotation
    .end param
    ...
    invoke-virtual {p0, p2}, Landroidx/savedstate/ۥ;->ۥ۟(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/lifecycle/SavedStateHandleController;->attachToLifecycle(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V
    ...
    invoke-direct {p2, p0, p1}, Landroidx/lifecycle/LegacySavedStateHandleController;->tryToAddRecreator(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V

    return-object v0
.end method

.method private final tryToAddRecreator(Landroidx/savedstate/ۥ;Landroidx/lifecycle/Lifecycle;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p1}, Landroidx/lifecycle/LegacySavedStateHandleController$tryToAddRecreator$1;-><init>(Landroidx/lifecycle/Lifecycle;Landroidx/savedstate/ۥ;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/savedstate/ۥ;->ۥ۟۟۟ۥ(Ljava/lang/Class;)V
