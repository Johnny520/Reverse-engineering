...
.method private shouldLoadFontSynchronously(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v0}, LYue/ۥۡۦۦۣ;->ۥ۟۟۟(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public getFont(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static {p1, v0}, LYue/ۥۡۦۦۣ;->ۥ۟۟۟ۤ(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public getFontAsync(Landroid/content/Context;Lcom/google/android/material/resources/TextAppearanceFontCallback;)V
    ...
    invoke-static {p1, v0, v2, v3}, LYue/ۥۡۦۦۣ;->ۥ۟۟۟ۦ(Landroid/content/Context;ILYue/ۥۡۦۦۣ$ۥ۟۟۟۠;Landroid/os/Handler;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
