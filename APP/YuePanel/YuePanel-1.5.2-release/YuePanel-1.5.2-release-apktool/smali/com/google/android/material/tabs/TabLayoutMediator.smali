...
# instance fields
.field private adapter:Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;
...
.field private pagerAdapterObserver:Landroidx/recyclerview/widget/RecyclerView$ۥۣ۟۟۟;
    .annotation build LYue/ۥۡۢۧ۠;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lcom/google/android/material/tabs/TabLayout;LYue/ۥۢۤۦۢ;Lcom/google/android/material/tabs/TabLayoutMediator$TabConfigurationStrategy;)V
    .locals 1
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/google/android/material/tabs/TabLayoutMediator;-><init>(Lcom/google/android/material/tabs/TabLayout;LYue/ۥۢۤۦۢ;ZLcom/google/android/material/tabs/TabLayoutMediator$TabConfigurationStrategy;)V

    return-void
.end method

.method public constructor <init>(Lcom/google/android/material/tabs/TabLayout;LYue/ۥۢۤۦۢ;ZLcom/google/android/material/tabs/TabLayoutMediator$TabConfigurationStrategy;)V
    .locals 6
    .param p1    # Lcom/google/android/material/tabs/TabLayout;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    .line 2
    invoke-direct/range {v0 .. v5}, Lcom/google/android/material/tabs/TabLayoutMediator;-><init>(Lcom/google/android/material/tabs/TabLayout;LYue/ۥۢۤۦۢ;ZZLcom/google/android/material/tabs/TabLayoutMediator$TabConfigurationStrategy;)V

    return-void
.end method

.method public constructor <init>(Lcom/google/android/material/tabs/TabLayout;LYue/ۥۢۤۦۢ;ZZLcom/google/android/material/tabs/TabLayoutMediator$TabConfigurationStrategy;)V
    .locals 0
    .param p1    # Lcom/google/android/material/tabs/TabLayout;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    .line 5
    iput-object p2, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->viewPager:LYue/ۥۢۤۦۢ;
...
.method public attach()V
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->viewPager:LYue/ۥۢۤۦۢ;

    invoke-virtual {v0}, LYue/ۥۢۤۦۢ;->getAdapter()Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->adapter:Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;
    ...
    iget-object v2, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->viewPager:LYue/ۥۢۤۦۢ;

    invoke-virtual {v2, v1}, LYue/ۥۢۤۦۢ;->ۥ۟۟۟ۨ(LYue/ۥۢۤۦۢ$ۥ۟۟۟ۤ;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/google/android/material/tabs/TabLayoutMediator$ViewPagerOnTabSelectedListener;-><init>(LYue/ۥۢۤۦۢ;Z)V
    ...
    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->pagerAdapterObserver:Landroidx/recyclerview/widget/RecyclerView$ۥۣ۟۟۟;

    iget-object v2, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->adapter:Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;

    invoke-virtual {v2, v1}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;->registerAdapterDataObserver(Landroidx/recyclerview/widget/RecyclerView$ۥۣ۟۟۟;)V
    ...
    invoke-virtual {v2}, LYue/ۥۢۤۦۢ;->getCurrentItem()I
...
.method public detach()V
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->adapter:Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;

    if-eqz v0, :cond_0

    iget-object v2, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->pagerAdapterObserver:Landroidx/recyclerview/widget/RecyclerView$ۥۣ۟۟۟;

    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;->unregisterAdapterDataObserver(Landroidx/recyclerview/widget/RecyclerView$ۥۣ۟۟۟;)V
    ...
    invoke-virtual {v0, v2}, LYue/ۥۢۤۦۢ;->ۥ۟۟۠ۧ(LYue/ۥۢۤۦۢ$ۥ۟۟۟ۤ;)V

    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->onTabSelectedListener:Lcom/google/android/material/tabs/TabLayout$OnTabSelectedListener;

    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->onPageChangeCallback:Lcom/google/android/material/tabs/TabLayoutMediator$TabLayoutOnPageChangeCallback;

    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->adapter:Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;
...
.method public populateTabsFromPagerAdapter()V
    ...
    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayoutMediator;->viewPager:LYue/ۥۢۤۦۢ;

    invoke-virtual {v1}, LYue/ۥۢۤۦۢ;->getCurrentItem()I
