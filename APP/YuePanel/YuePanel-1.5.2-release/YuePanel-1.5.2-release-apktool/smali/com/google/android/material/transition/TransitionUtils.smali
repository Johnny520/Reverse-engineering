...
.method public static convertToRelativeCornerSizes(Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)Lcom/google/android/material/shape/ShapeAppearanceModel;
    ...
    new-instance v0, Lcom/google/android/material/transition/ۥ;

    invoke-direct {v0, p1}, Lcom/google/android/material/transition/ۥ;-><init>(Landroid/graphics/RectF;)V
...
.method public static maybeAddTransition(LYue/ۥۢۢۡۡ;LYue/ۥۢۢ۟ۧ;)V
    .locals 0
    .param p1    # LYue/ۥۢۢ۟ۧ;
        .annotation build LYue/ۥۡۢۧ۠;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LYue/ۥۢۢۡۡ;->ۥ۟۟ۡۤ(LYue/ۥۢۢ۟ۧ;)LYue/ۥۢۢۡۡ;

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(LYue/ۥۢۢ۟ۧ;Landroid/content/Context;I)Z
    .locals 4
    .param p2    # I
        .annotation build LYue/ۥ۟ۢ۠۟;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, LYue/ۥۢۢ۟ۧ;->setDuration(J)LYue/ۥۢۢ۟ۧ;
...
.method public static maybeApplyThemeInterpolator(LYue/ۥۢۢ۟ۧ;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
    .param p2    # I
        .annotation build LYue/ۥ۟ۢ۠۟;
        .end annotation
...
.method public static maybeApplyThemePath(LYue/ۥۢۢ۟ۧ;Landroid/content/Context;I)Z
    .locals 0
    .param p2    # I
        .annotation build LYue/ۥ۟ۢ۠۟;
        .end annotation
    ...
    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)LYue/ۥۣۡۨۡ;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, LYue/ۥۢۢ۟ۧ;->setPathMotion(LYue/ۥۣۡۨۡ;)V
...
.method public static maybeRemoveTransition(LYue/ۥۢۢۡۡ;LYue/ۥۢۢ۟ۧ;)V
    .locals 0
    .param p1    # LYue/ۥۢۢ۟ۧ;
        .annotation build LYue/ۥۡۢۧ۠;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LYue/ۥۢۢۡۡ;->ۥ۟۟ۢۤ(LYue/ۥۢۢ۟ۧ;)LYue/ۥۢۢۡۡ;

    :cond_0
    return-void
.end method

.method public static resolveThemePath(Landroid/content/Context;I)LYue/ۥۣۡۨۡ;
    .locals 3
    .param p1    # I
        .annotation build LYue/ۥ۟ۢ۠۟;
        .end annotation
    ...
    new-instance p1, LYue/ۥۡۤ۟ۤ;

    invoke-static {p0}, LYue/ۥۣۣۡۨ;->ۥ۟۟۟۟(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, LYue/ۥۡۤ۟ۤ;-><init>(Landroid/graphics/Path;)V
...
.method public static synthetic ۥ(Landroid/graphics/RectF;Lcom/google/android/material/shape/CornerSize;)Lcom/google/android/material/shape/CornerSize;
    .locals 0
