...
.field private callback:Landroidx/appcompat/view/menu/ۥ۟۟۟ۤ$ۥ;
...
.field menu:Landroidx/appcompat/view/menu/ۥ۟۟۟۟;
...
.method public dispatchApplyWindowInsets(LYue/ۥۢۥۦ;)V
    .locals 4
    .param p1    # LYue/ۥۢۥۦ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    invoke-static {v0, p1}, LYue/ۥۢۤۤۦ;->ۥ۟۟۠۟(Landroid/view/View;LYue/ۥۢۥۦ;)LYue/ۥۢۥۦ;
...
.method public getCheckedItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->getCheckedItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
...
.method public getMenuView(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/ۥ۟۟۟ۥ;
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAccessibilityDelegateCompat(Landroidx/recyclerview/widget/ۥ۟۟۠ۢ;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;->setHasStableIds(Z)V
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;)V
...
.method public initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/ۥ۟۟۟۟;)V
    ...
    iput-object p2, p0, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Landroidx/appcompat/view/menu/ۥ۟۟۟۟;
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/ۥ۟۟۟۟;Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuPresenter;->callback:Landroidx/appcompat/view/menu/ۥ۟۟۟ۤ$ۥ;
...
.method public setCallback(Landroidx/appcompat/view/menu/ۥ۟۟۟ۤ$ۥ;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter;->callback:Landroidx/appcompat/view/menu/ۥ۟۟۟ۤ$ۥ;
...
.method public setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
