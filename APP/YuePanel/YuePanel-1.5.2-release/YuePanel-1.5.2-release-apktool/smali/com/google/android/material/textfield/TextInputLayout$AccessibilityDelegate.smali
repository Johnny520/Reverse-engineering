...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;LYue/ۥ۟۟ۥۧ;)V
    ...
    invoke-virtual {v8, p2}, Lcom/google/android/material/textfield/StartCompoundLayout;->setupAccessibilityNodeInfo(LYue/ۥ۟۟ۥۧ;)V

    if-eqz v7, :cond_4

    invoke-virtual {p2, v0}, LYue/ۥ۟۟ۥۧ;->ۥۣ۟۠۟(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LYue/ۥ۟۟ۥۧ;->ۥۣ۟۠۟(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v3}, LYue/ۥ۟۟ۥۧ;->ۥۣ۟۠۟(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LYue/ۥ۟۟ۥۧ;->ۥۣ۟۠۠(Ljava/lang/CharSequence;)V

    invoke-virtual {p2, v6}, LYue/ۥ۟۟ۥۧ;->ۥ۟۠ۢۦ(Z)V
    ...
    :goto_4
    invoke-virtual {p2, v4}, LYue/ۥ۟۟ۥۧ;->ۥ۟۠ۡۡ(I)V
    ...
    :goto_5
    invoke-virtual {p2, v2}, LYue/ۥ۟۟ۥۧ;->ۥ۟۠۠(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v0}, LYue/ۥ۟۟ۥۧ;->ۥ۟۠۠ۦ(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/material/textfield/EndIconDelegate;->onInitializeAccessibilityNodeInfo(Landroid/view/View;LYue/ۥ۟۟ۥۧ;)V
