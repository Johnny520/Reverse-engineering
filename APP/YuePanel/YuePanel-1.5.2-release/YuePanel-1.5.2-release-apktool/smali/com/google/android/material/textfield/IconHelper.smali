...
.method public static applyIconTint(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v0, p0}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    goto :goto_0

    :cond_0
    invoke-static {v0, p2}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    :goto_0
    if-eqz p3, :cond_1

    invoke-static {v0, p3}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠۟(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p1, v0}, LYue/ۥ۟ۡۢ۟;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public static refreshIconDrawableState(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p2, p0}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    invoke-virtual {p1, p2}, LYue/ۥ۟ۡۢ۟;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private static setIconClickable(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {p0}, LYue/ۥۢۤۤۦ;->ۥ۟۟ۧ(Landroid/view/View;)Z
    ...
    :goto_1
    invoke-static {p0, v2}, LYue/ۥۢۤۤۦ;->ۥ۟۠ۢۦ(Landroid/view/View;I)V
