...
# instance fields
.field private checkedItem:Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
...
.method private prepareMenuItems()V
    ...
    iget-object v2, v2, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Landroidx/appcompat/view/menu/ۥ۟۟۟۟;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-object v8, v8, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Landroidx/appcompat/view/menu/ۥ۟۟۟۟;

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->getVisibleItems()Ljava/util/ArrayList;
    ...
    check-cast v8, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->isChecked()Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v0, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V

    :cond_1
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->isCheckable()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v8, v3}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->ۥ۟۟۠ۦ(Z)V

    :cond_2
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->hasSubMenu()Z

    move-result v9

    if-eqz v9, :cond_9

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-direct {v11, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
    ...
    check-cast v14, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;

    invoke-virtual {v14}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->isVisible()Z
    ...
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->isCheckable()Z

    move-result v15

    if-eqz v15, :cond_5

    invoke-virtual {v14, v3}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->ۥ۟۟۠ۦ(Z)V
    ...
    invoke-direct {v1, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
    ...
    :cond_9
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getGroupId()I
    ...
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v4, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
    ...
    invoke-virtual {v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getActionView()Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getItemId()I
...
.method public getCheckedItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
...
.method public getItemViewType(I)I
    ...
    invoke-virtual {p1}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
...
.method public onBindViewHolder(Lcom/google/android/material/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    .line 10
    invoke-virtual {v0}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
    ...
    invoke-static {p1, v0}, LYue/ۥۢۡۡ۟;->ۥ۟۟ۡۢ(Landroid/widget/TextView;I)V
    ...
    .line 25
    :goto_0
    invoke-static {p1, v0}, LYue/ۥۢۤۤۦ;->ۥ۟۠ۡۧ(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/google/android/material/internal/NavigationMenuItemView;->initialize(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;Z)V
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
    ...
    :cond_4
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->getActionView()Landroid/view/View;
...
.method public setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
    .locals 2
    .param p1    # Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    .end param
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->setChecked(Z)Landroid/view/MenuItem;

    :cond_1
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;->setChecked(Z)Landroid/view/MenuItem;
...
.method public update()V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۟ۡ;->notifyDataSetChanged()V
