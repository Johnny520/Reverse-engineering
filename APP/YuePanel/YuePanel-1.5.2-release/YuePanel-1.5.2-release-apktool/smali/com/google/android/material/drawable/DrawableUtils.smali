...
.method private static createTintableMutatedDrawableIfNeeded(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠ۡ(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-static {p0, p2}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠۟(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static getColorStateListOrNull(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, LYue/ۥ۠۠ۡ;->ۥ(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, LYue/ۥ۠۠ۡ۠;->ۥ(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, LYue/ۥ۠۠ۡۢ;->ۥ(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static setTint(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p0, p1}, LYue/ۥ۠۠۠ۥ;->ۥ۟۟۠(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
