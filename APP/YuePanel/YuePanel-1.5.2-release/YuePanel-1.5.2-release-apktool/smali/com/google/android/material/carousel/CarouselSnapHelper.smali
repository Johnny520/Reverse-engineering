...
.method public static synthetic access$100(Lcom/google/android/material/carousel/CarouselSnapHelper;Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;Landroid/view/View;Z)[I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/carousel/CarouselSnapHelper;->calculateDistanceToSnap(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;Landroid/view/View;Z)[I
...
.method private calculateDistanceToSnap(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;Landroid/view/View;Z)[I
    .locals 2
...
.method private distanceToFirstFocalKeyline(Landroid/view/View;Lcom/google/android/material/carousel/CarouselLayoutManager;Z)I
    ...
    invoke-virtual {p2, p1}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;->getPosition(Landroid/view/View;)I
...
.method private findViewNearestFirstKeyline(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Landroid/view/View;
    .locals 8
    ...
    invoke-virtual {p1, v5}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;->getChildAt(I)Landroid/view/View;

    move-result-object v6

    invoke-virtual {p1, v6}, Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;->getPosition(Landroid/view/View;)I
...
.method private isForwardFling(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;II)Z
    .locals 2
...
.method private isReverseLayout(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Z
    .locals 4
...
.method public attachToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-super {p0, p1}, Landroidx/recyclerview/widget/ۥ۟۟۠ۥ;->attachToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public calculateDistanceToFinalSnap(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;Landroid/view/View;)[I
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/carousel/CarouselSnapHelper;->calculateDistanceToSnap(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;Landroid/view/View;Z)[I
...
.method public createScroller(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟ۡ۠;
    ...
    invoke-direct {v0, p0, v1, p1}, Lcom/google/android/material/carousel/CarouselSnapHelper$1;-><init>(Lcom/google/android/material/carousel/CarouselSnapHelper;Landroid/content/Context;Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)V
...
.method public findSnapView(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/material/carousel/CarouselSnapHelper;->findViewNearestFirstKeyline(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Landroid/view/View;
...
.method public findTargetSnapPosition(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;II)I
    ...
    :cond_5
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/carousel/CarouselSnapHelper;->isForwardFling(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;II)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/android/material/carousel/CarouselSnapHelper;->isReverseLayout(Landroidx/recyclerview/widget/RecyclerView$ۥ۟۟۠;)Z
