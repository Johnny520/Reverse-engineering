...
.method public createOnBackInvokedCallback(Lcom/google/android/material/motion/MaterialBackHandler;)Landroid/window/OnBackInvokedCallback;
    ...
    new-instance v0, LYue/ۥۡ۟۟ۡ;

    invoke-direct {v0, p1}, LYue/ۥۡ۟۟ۡ;-><init>(Lcom/google/android/material/motion/MaterialBackHandler;)V
...
.method public startListeningForBackCallbacks(Lcom/google/android/material/motion/MaterialBackHandler;Landroid/view/View;Z)V
    ...
    :cond_0
    invoke-static {p2}, LYue/ۥۡ۟۟۠;->ۥ(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    :goto_0
    invoke-static {p2, p3, p1}, LYue/ۥ۟ۡۡ;->ۥ(Landroid/window/OnBackInvokedDispatcher;ILandroid/window/OnBackInvokedCallback;)V
...
.method public stopListeningForBackCallbacks(Landroid/view/View;)V
    ...
    invoke-static {p1}, LYue/ۥۡ۟۟۠;->ۥ(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    invoke-static {p1, v0}, LYue/ۥ۟ۡ۠ۧ;->ۥ(Landroid/window/OnBackInvokedDispatcher;Landroid/window/OnBackInvokedCallback;)V
