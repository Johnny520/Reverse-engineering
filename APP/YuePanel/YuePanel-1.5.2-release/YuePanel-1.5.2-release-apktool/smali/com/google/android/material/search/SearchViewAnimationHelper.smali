...
.method private addDrawerArrowDrawableAnimatorIfNeeded(Landroid/animation/AnimatorSet;Landroid/graphics/drawable/Drawable;)V
    ...
    instance-of v0, p2, LYue/ۥ۠۠ۡۨ;

    if-eqz v0, :cond_0

    check-cast p2, LYue/ۥ۠۠ۡۨ;
    ...
    new-instance v1, Lcom/google/android/material/search/ۥ۟۟۟ۡ;

    invoke-direct {v1, p2}, Lcom/google/android/material/search/ۥ۟۟۟ۡ;-><init>(LYue/ۥ۠۠ۡۨ;)V
...
.method private addFadeThroughDrawableAnimatorIfNeeded(Landroid/animation/AnimatorSet;Landroid/graphics/drawable/Drawable;)V
    ...
    new-instance v1, Lcom/google/android/material/search/ۥۣ۟۟۟;

    invoke-direct {v1, p2}, Lcom/google/android/material/search/ۥۣ۟۟۟;-><init>(Lcom/google/android/material/internal/FadeThroughDrawable;)V
...
.method private getFromTranslationXEnd(Landroid/view/View;)I
    ...
    invoke-static {p1}, LYue/ۥ۠ۨۨ۟;->ۥ۟(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private getFromTranslationXStart(Landroid/view/View;)I
    ...
    invoke-static {p1}, LYue/ۥ۠ۨۨ۟;->ۥ۟۟(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private getRootViewAnimator(Z)Landroid/animation/Animator;
    ...
    new-instance v1, Lcom/google/android/material/search/ۥ۟۟۟۠;

    invoke-direct {v1, p0, v3, v4, v2}, Lcom/google/android/material/search/ۥ۟۟۟۠;-><init>(Lcom/google/android/material/search/SearchViewAnimationHelper;FFLandroid/graphics/Rect;)V
...
.method private static synthetic lambda$addDrawerArrowDrawableAnimatorIfNeeded$3(LYue/ۥ۠۠ۡۨ;Landroid/animation/ValueAnimator;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, LYue/ۥ۠۠ۡۨ;->ۥ۟۟۠ۢ(F)V
...
.method private setFullDrawableProgressIfNeeded(Landroid/graphics/drawable/Drawable;)V
    ...
    check-cast v0, LYue/ۥ۠۠ۡۨ;

    invoke-virtual {v0, v1}, LYue/ۥ۠۠ۡۨ;->ۥ۟۟۠ۢ(F)V
...
.method private startShowAnimationExpand()V
    ...
    new-instance v1, Lcom/google/android/material/search/ۥ۟۟۟ۢ;

    invoke-direct {v1, p0}, Lcom/google/android/material/search/ۥ۟۟۟ۢ;-><init>(Lcom/google/android/material/search/SearchViewAnimationHelper;)V
...
.method private startShowAnimationTranslate()V
    ...
    new-instance v1, LYue/ۥۡۧۧۨ;

    invoke-direct {v1, v0}, LYue/ۥۡۧۧۨ;-><init>(Lcom/google/android/material/search/SearchView;)V
    ...
    new-instance v1, Lcom/google/android/material/search/ۥ۟۟۟ۤ;

    invoke-direct {v1, p0}, Lcom/google/android/material/search/ۥ۟۟۟ۤ;-><init>(Lcom/google/android/material/search/SearchViewAnimationHelper;)V
...
.method public static synthetic ۥ(Lcom/google/android/material/search/SearchViewAnimationHelper;)V
    .locals 0
...
.method public static synthetic ۥ۟(Lcom/google/android/material/search/SearchViewAnimationHelper;FFLandroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic ۥ۟۟(LYue/ۥ۠۠ۡۨ;Landroid/animation/ValueAnimator;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/android/material/search/SearchViewAnimationHelper;->lambda$addDrawerArrowDrawableAnimatorIfNeeded$3(LYue/ۥ۠۠ۡۨ;Landroid/animation/ValueAnimator;)V

    return-void
.end method

.method public static synthetic ۥ۟۟۟(Lcom/google/android/material/search/SearchViewAnimationHelper;)V
    .locals 0
...
.method public static synthetic ۥ۟۟۟۟(Lcom/google/android/material/internal/FadeThroughDrawable;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public onHandleBackInvoked()LYue/ۥ۟ۢۤۥ;
    .locals 1
    .annotation build LYue/ۥۡۢۧ۠;
    .end annotation
...
.method public startBackProgress(LYue/ۥ۟ۢۤۥ;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/google/android/material/motion/MaterialMainContainerBackHelper;->startBackProgress(LYue/ۥ۟ۢۤۥ;Landroid/view/View;)V
...
.method public updateBackProgress(LYue/ۥ۟ۢۤۥ;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/google/android/material/motion/MaterialMainContainerBackHelper;->updateBackProgress(LYue/ۥ۟ۢۤۥ;Landroid/view/View;F)V
