...
# instance fields
.field private final backDrawerListener:LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, v0, Lcom/google/android/material/navigation/NavigationView;->backDrawerListener:LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;
    ...
    invoke-virtual {v1, v2}, LYue/ۥۢۡۥۦ;->ۥ۟۟ۡۡ(I)Z
    ...
    invoke-virtual {v1, v2}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۢ(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-static {v0, v2}, LYue/ۥۢۤۤۦ;->ۥ۟۠ۡۧ(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 20
    invoke-virtual {v1, v2, v12}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۡ(II)I
    ...
    .line 29
    invoke-static {v0, v4}, LYue/ۥۢۤۤۦ;->ۥ۟۠ۡۧ(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, v2, v12}, LYue/ۥۢۡۥۦ;->ۥ(IZ)Z
    ...
    invoke-virtual {v1, v2}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v4}, LYue/ۥۢۡۥۦ;->ۥ۟۟ۡۡ(I)Z
    ...
    .line 38
    invoke-virtual {v1, v4, v12}, LYue/ۥۢۡۥۦ;->ۥ۟۟۠ۤ(II)I
    ...
    invoke-virtual {v1, v6}, LYue/ۥۢۡۥۦ;->ۥ۟۟ۡۡ(I)Z
    ...
    invoke-virtual {v1, v5}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v6, v12}, LYue/ۥۢۡۥۦ;->ۥ۟۟۠ۤ(II)I
    ...
    .line 46
    invoke-virtual {v1, v7, v11}, LYue/ۥۢۡۥۦ;->ۥ(IZ)Z
    ...
    invoke-virtual {v1, v8}, LYue/ۥۢۡۥۦ;->ۥ۟۟ۡۡ(I)Z
    ...
    invoke-virtual {v1, v8, v12}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۡ(II)I
    ...
    invoke-virtual {v1, v8}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v9}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۢ(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 53
    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->hasShapeAppearance(LYue/ۥۢۡۥۦ;)Z
    ...
    .line 54
    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemBackground(LYue/ۥۢۡۥۦ;)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    invoke-static {v13, v1, v15}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;LYue/ۥۢۡۥۦ;I)Landroid/content/res/ColorStateList;
    ...
    .line 57
    invoke-direct {v0, v1, v3}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(LYue/ۥۢۡۥۦ;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    .line 63
    invoke-virtual {v1, v3, v11}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۡ(II)I
    ...
    .line 82
    invoke-virtual {v1, v3, v12}, LYue/ۥۢۡۥۦ;->ۥ(IZ)Z
    ...
    invoke-virtual {v1, v11, v12}, LYue/ۥۢۡۥۦ;->ۥ۟۟۠(II)I
    ...
    invoke-virtual {v14, v11}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->setCallback(Landroidx/appcompat/view/menu/ۥ۟۟۟۟$ۥ;)V

    .line 91
    invoke-virtual {v10, v12}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setId(I)V

    .line 92
    invoke-virtual {v10, v13, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/ۥ۟۟۟۟;)V
    ...
    .line 102
    invoke-virtual {v14, v10}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->addMenuPresenter(Landroidx/appcompat/view/menu/ۥ۟۟۟ۤ;)V

    .line 103
    invoke-virtual {v10, v0}, Lcom/google/android/material/internal/NavigationMenuPresenter;->getMenuView(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/ۥ۟۟۟ۥ;
    ...
    invoke-virtual {v1, v2, v3}, LYue/ۥۢۡۥۦ;->ۥ۟۟۠ۤ(II)I
...
.method private createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, LYue/ۥۣ۟ۡ۠;->ۥ(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private createDefaultItemBackground(LYue/ۥۢۡۥۦ;)Landroid/graphics/drawable/Drawable;
    .locals 2
    .param p1    # LYue/ۥۢۡۥۦ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    invoke-static {v0, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;LYue/ۥۢۡۥۦ;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(LYue/ۥۢۡۥۦ;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
...
.method private createDefaultItemDrawable(LYue/ۥۢۡۥۦ;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    .locals 9
    .param p1    # LYue/ۥۢۡۥۦ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    invoke-virtual {p1, v2, v1}, LYue/ۥۢۡۥۦ;->ۥ۟۟۠ۤ(II)I
    ...
    invoke-virtual {p1, p2, v1}, LYue/ۥۢۡۥۦ;->ۥ۟۟۟ۡ(II)I
...
.method private hasShapeAppearance(LYue/ۥۢۡۥۦ;)Z
    .locals 1
    .param p1    # LYue/ۥۢۡۥۦ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
...
.method private maybeUpdateCornerSizeForDrawerLayout(II)V
    ...
    instance-of v0, v0, LYue/ۥ۠۠ۢ$ۥ۟۟۟۠;
    ...
    check-cast v0, LYue/ۥ۠۠ۢ$ۥ۟۟۟۠;

    iget v0, v0, LYue/ۥ۠۠ۢ$ۥ۟۟۟۠;->ۥ:I

    invoke-static {p0}, LYue/ۥۢۤۤۦ;->ۥۣ۟۟ۥ(Landroid/view/View;)I

    move-result v1

    invoke-static {v0, v1}, LYue/ۥۣۣ۠ۧ;->ۥ۟۟۟(II)I
...
.method private requireDrawerLayoutParent()Landroid/util/Pair;
    ...
    instance-of v2, v0, LYue/ۥ۠۠ۢ;

    if-eqz v2, :cond_0

    instance-of v2, v1, LYue/ۥ۠۠ۢ$ۥ۟۟۟۠;

    if-eqz v2, :cond_0

    new-instance v2, Landroid/util/Pair;

    check-cast v0, LYue/ۥ۠۠ۢ;

    check-cast v1, LYue/ۥ۠۠ۢ$ۥ۟۟۟۠;
...
.method public static synthetic ۥ(Lcom/google/android/material/navigation/NavigationView;Landroid/graphics/Canvas;)V
    .locals 0
...
.method public dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    new-instance v1, LYue/ۥۡۢۡۤ;

    invoke-direct {v1, p0}, LYue/ۥۡۢۡۤ;-><init>(Lcom/google/android/material/navigation/NavigationView;)V
...
.method public getCheckedItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/internal/NavigationMenuPresenter;->getCheckedItem()Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;
...
.method public handleBackInvoked()V
    ...
    invoke-virtual {v2}, Lcom/google/android/material/motion/MaterialBackAnimationHelper;->onHandleBackInvoked()LYue/ۥ۟ۢۤۥ;
    ...
    invoke-static {v1, p0}, Lcom/google/android/material/navigation/DrawerLayoutUtils;->getScrimCloseAnimatorListener(LYue/ۥ۠۠ۢ;Landroid/view/View;)Landroid/animation/Animator$AnimatorListener;

    move-result-object v3

    invoke-static {v1}, Lcom/google/android/material/navigation/DrawerLayoutUtils;->getScrimCloseAnimatorUpdateListener(LYue/ۥ۠۠ۢ;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    invoke-virtual {v4, v2, v0, v3, v1}, Lcom/google/android/material/motion/MaterialSideContainerBackHelper;->finishBackProgress(LYue/ۥ۟ۢۤۥ;ILandroid/animation/Animator$AnimatorListener;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    return-void

    :cond_1
    :goto_0
    invoke-virtual {v1, p0}, LYue/ۥ۠۠ۢ;->ۥ۟۟۟۠(Landroid/view/View;)V
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/navigation/NavigationView;->backDrawerListener:LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;

    invoke-virtual {v0, v1}, LYue/ۥ۠۠ۢ;->ۥ۟۟ۢۢ(LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;)V

    iget-object v1, p0, Lcom/google/android/material/navigation/NavigationView;->backDrawerListener:LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;

    invoke-virtual {v0, v1}, LYue/ۥ۠۠ۢ;->ۥ(LYue/ۥ۠۠ۢ$ۥ۟۟۟۟;)V

    invoke-virtual {v0, p0}, LYue/ۥ۠۠ۢ;->ۥ۟۟ۡۢ(Landroid/view/View;)Z
...
.method public onInsetsChanged(LYue/ۥۢۥۦ;)V
    .locals 1
    .param p1    # LYue/ۥۢۥۦ;
        .annotation build LYue/ۥۣۡۢۤ;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->dispatchApplyWindowInsets(LYue/ۥۢۥۦ;)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->restorePresenterStates(Landroid/os/Bundle;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v2, v0}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->savePresenterStates(Landroid/os/Bundle;)V
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/ۥ۟۟۟۟;->findItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setCheckedItem(Landroidx/appcompat/view/menu/ۥ۟۟۟ۢ;)V
...
.method public updateBackProgress(LYue/ۥ۟ۢۤۥ;)V
    ...
    invoke-virtual {v1, p1, v0}, Lcom/google/android/material/motion/MaterialSideContainerBackHelper;->updateBackProgress(LYue/ۥ۟ۢۤۥ;I)V
    ...
    invoke-virtual {p1}, LYue/ۥ۟ۢۤۥ;->ۥ()F
