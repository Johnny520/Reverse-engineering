...
.method public merge()Lcom/android/dex/Dex;
    ...
    iget-object v6, p0, Lcom/android/dx/merge/DexMerger;->dexOut:Lcom/android/dex/Dex;

    new-instance v8, Lcom/android/dex/Dex;

    invoke-direct {v8, v3}, Lcom/android/dex/Dex;-><init>(I)V

    filled-new-array {v6, v8}, [Lcom/android/dex/Dex;
    ...
    invoke-direct {v2, v6, v8, v9, v4}, Lcom/android/dx/merge/DexMerger;-><init>([Lcom/android/dex/Dex;Lcom/android/dx/merge/CollisionPolicy;Lcom/android/dx/command/dexer/DxContext;Lcom/android/dx/merge/DexMerger$WriterSizes;)V
    ...
    invoke-virtual {v6}, Lcom/android/dex/Dex;->getLength()I
    ...
    invoke-virtual {v2}, Lcom/android/dex/Dex;->getLength()I
    ...
    iget-object v8, p0, Lcom/android/dx/merge/DexMerger;->dexes:[Lcom/android/dex/Dex;

    aget-object v8, v8, v3

    invoke-virtual {v8}, Lcom/android/dex/Dex;->getTableOfContents()Lcom/android/dex/TableOfContents;

    move-result-object v8

    iget-object v8, v8, Lcom/android/dex/TableOfContents;->classDefs:Lcom/android/dex/TableOfContents$Section;

    iget v8, v8, Lcom/android/dex/TableOfContents$Section;->size:I
    ...
    invoke-virtual {v3}, Lcom/android/dex/Dex;->getLength()I
    ...
    const-string v3, "Result is %d defs/%.1fKiB. Took %.1fs%n"
