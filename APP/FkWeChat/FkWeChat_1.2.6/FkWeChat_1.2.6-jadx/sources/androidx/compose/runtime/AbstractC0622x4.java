...
/* JADX INFO: renamed from: androidx.compose.runtime.x4 */
/* JADX INFO: compiled from: r8-map-id-41ef8b4051cf12c4299b71f89f7150459dca1d84aebb9e505d81ecf50968f600 */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC0622x4 extends AbstractC3160w0 implements InterfaceC0491f2, InterfaceC3116b0 {

    /* JADX INFO: renamed from: r */
    public a f1785r;

    /* JADX INFO: renamed from: androidx.compose.runtime.x4$a */
    /* JADX INFO: compiled from: r8-map-id-41ef8b4051cf12c4299b71f89f7150459dca1d84aebb9e505d81ecf50968f600 */
    public static final class a extends AbstractC3162x0 {
        ...
        public void mo1522c(AbstractC3162x0 abstractC3162x0) {
            ...
            this.f1786c = ((a) abstractC3162x0).f1786c;
        }

        @Override // p119i1.AbstractC3162x0
        /* JADX INFO: renamed from: d */
        public AbstractC3162x0 mo1523d(long j10) {
            return new a(j10, this.f1786c);
        }

        /* JADX INFO: renamed from: i */
        public final float m2433i() {
            return this.f1786c;
        }

        /* JADX INFO: renamed from: j */
        public final void m2434j(float f10) {
            this.f1786c = f10;
        }
    }

    public AbstractC0622x4(float f10) {
        AbstractC3137l abstractC3137lM11882K = AbstractC3159w.m11882K();
        a aVar = new a(abstractC3137lM11882K.mo11678i(), f10);
        if (!(abstractC3137lM11882K instanceof C3115b)) {
            aVar.m11942g(new a(AbstractC3149r.m11861c(1), f10));
        }
        this.f1785r = aVar;
    }

    @Override // androidx.compose.runtime.InterfaceC0491f2, androidx.compose.runtime.InterfaceC0504h1
    /* JADX INFO: renamed from: b */
    public float mo1663b() {
        return ((a) AbstractC3159w.m11897Z(this.f1785r, this)).m2433i();
    }
    ...
    @Override // androidx.compose.runtime.InterfaceC0491f2
    /* JADX INFO: renamed from: h */
    public void mo1664h(float f10) {
        AbstractC3137l abstractC3137lM11764c;
        a aVar = (a) AbstractC3159w.m11880I(this.f1785r);
        if (aVar.m2433i() == f10) {
            return;
        }
        a aVar2 = this.f1785r;
        synchronized (AbstractC3159w.m11883L()) {
            ...
            ((a) AbstractC3159w.m11892U(aVar2, this, abstractC3137lM11764c, aVar)).m2434j(f10);
    ...
    public AbstractC3162x0 mo1520l(AbstractC3162x0 abstractC3162x0, AbstractC3162x0 abstractC3162x02, AbstractC3162x0 abstractC3162x03) {
        ...
        if (((a) abstractC3162x02).m2433i() == ((a) abstractC3162x03).m2433i()) {
    ...
    public void mo1521o(AbstractC3162x0 abstractC3162x0) {
        abstractC3162x0.getClass();
        this.f1785r = (a) abstractC3162x0;
    }

    public String toString() {
        return "MutableFloatState(value=" + ((a) AbstractC3159w.m11880I(this.f1785r)).m2433i() + ")@" + hashCode();
    }
}
