...
/* JADX INFO: renamed from: bsh.z */
/* JADX INFO: compiled from: r8-map-id-41ef8b4051cf12c4299b71f89f7150459dca1d84aebb9e505d81ecf50968f600 */
/* JADX INFO: loaded from: classes.dex */
public class C1292z extends AbstractC1195i4 {

    /* JADX INFO: renamed from: B */
    public static final Class f3890B = null;
    ...
    public boolean m5233o() {
        return this.f3893z || m5231k() > 1;
    }

    @Override // bsh.AbstractC1195i4, bsh.InterfaceC1188h3
    /* JADX INFO: renamed from: p */
    public Object mo4048p(C1174f1 c1174f1, RunnableC1205k2 runnableC1205k2) {
        Class[] clsArr = this.f3891A;
        if (clsArr != null) {
            return clsArr;
        }
        this.f3891A = new Class[m5231k()];
        if (m5234v()) {
            this.f3891A[0] = f3890B;
        } else {
            for (int i10 = 0; i10 < m5231k(); i10++) {
                this.f3891A[i10] = ((C1221n0) mo4051s(i10)).m4927v(c1174f1, runnableC1205k2);
            }
        }
        return this.f3891A;
    }
    ...
    public String toString() {
        return super.toString() + ": " + this.f3892y + ", final=" + this.f3893z;
    }
