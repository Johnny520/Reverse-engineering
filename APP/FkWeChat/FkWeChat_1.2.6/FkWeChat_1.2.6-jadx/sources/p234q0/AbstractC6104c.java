...
public abstract class AbstractC6104c {
    ...
    public static C9516d f19147a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24257a(C5618b c5618b) {
        C9516d c9516d = f19147a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.AccountCircle", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37157m(4.48f, 10.0f, 10.0f, 10.0f);
        c9518f.m37157m(10.0f, -4.48f, 10.0f, -10.0f);
        c9518f.m37156l(17.52f, 2.0f, 12.0f, 2.0f);
        c9518f.m37146b();
        c9518f.m37154j(12.0f, 6.0f);
        c9518f.m37148d(1.93f, 0.0f, 3.5f, 1.57f, 3.5f, 3.5f);
        c9518f.m37156l(13.93f, 13.0f, 12.0f, 13.0f);
        c9518f.m37157m(-3.5f, -1.57f, -3.5f, -3.5f);
        c9518f.m37156l(10.07f, 6.0f, 12.0f, 6.0f);
        c9518f.m37146b();
        c9518f.m37154j(12.0f, 20.0f);
        c9518f.m37148d(-2.03f, 0.0f, -4.43f, -0.82f, -6.14f, -2.88f);
        c9518f.m37147c(7.55f, 15.8f, 9.68f, 15.0f, 12.0f, 15.0f);
        c9518f.m37157m(4.45f, 0.8f, 6.14f, 2.12f);
        c9518f.m37147c(16.43f, 19.18f, 14.03f, 20.0f, 12.0f, 20.0f);
        c9518f.m37146b();
