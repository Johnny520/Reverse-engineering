...
public abstract class AbstractC6176v {

    /* JADX INFO: renamed from: a */
    public static C9516d f19219a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24329a(C5618b c5618b) {
        C9516d c9516d = f19219a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.Check", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37154j(9.0f, 16.17f);
        c9518f.m37152h(5.53f, 12.7f);
        c9518f.m37148d(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        c9518f.m37148d(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        c9518f.m37153i(4.18f, 4.18f);
        c9518f.m37148d(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        c9518f.m37152h(20.29f, 7.71f);
        c9518f.m37148d(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        c9518f.m37148d(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        c9518f.m37152h(9.0f, 16.17f);
        c9518f.m37146b();
