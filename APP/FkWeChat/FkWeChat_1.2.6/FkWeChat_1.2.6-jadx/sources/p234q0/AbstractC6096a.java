...
public abstract class AbstractC6096a {
    ...
    public static C9516d f19139a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24249a(C5618b c5618b) {
        C9516d c9516d = f19139a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.AccessTime", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37147c(6.47f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        c9518f.m37157m(4.47f, 10.0f, 9.99f, 10.0f);
        c9518f.m37147c(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        ...
        c9518f.m37157m(-3.58f, 8.0f, -8.0f, 8.0f);
        c9518f.m37146b();
        c9518f.m37154j(11.78f, 7.0f);
        c9518f.m37151g(-0.06f);
        c9518f.m37148d(-0.4f, 0.0f, -0.72f, 0.32f, -0.72f, 0.72f);
        c9518f.m37159o(4.72f);
        c9518f.m37148d(0.0f, 0.35f, 0.18f, 0.68f, 0.49f, 0.86f);
        c9518f.m37153i(4.15f, 2.49f);
        c9518f.m37148d(0.34f, 0.2f, 0.78f, 0.1f, 0.98f, -0.24f);
        c9518f.m37148d(0.21f, -0.34f, 0.1f, -0.79f, -0.25f, -0.99f);
        c9518f.m37153i(-3.87f, -2.3f);
        c9518f.m37152h(12.5f, 7.72f);
        c9518f.m37148d(0.0f, -0.4f, -0.32f, -0.72f, -0.72f, -0.72f);
        c9518f.m37146b();
