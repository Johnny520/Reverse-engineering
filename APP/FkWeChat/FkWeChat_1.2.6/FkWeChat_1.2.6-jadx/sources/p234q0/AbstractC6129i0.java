...
public abstract class AbstractC6129i0 {

    /* JADX INFO: renamed from: a */
    public static C9516d f19172a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24282a(C5618b c5618b) {
        C9516d c9516d = f19172a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.Edit", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37154j(3.0f, 17.46f);
        c9518f.m37159o(3.04f);
        c9518f.m37148d(0.0f, 0.28f, 0.22f, 0.5f, 0.5f, 0.5f);
        c9518f.m37151g(3.04f);
        c9518f.m37148d(0.13f, 0.0f, 0.26f, -0.05f, 0.35f, -0.15f);
        c9518f.m37152h(17.81f, 9.94f);
        c9518f.m37153i(-3.75f, -3.75f);
        c9518f.m37152h(3.15f, 17.1f);
        c9518f.m37148d(-0.1f, 0.1f, -0.15f, 0.22f, -0.15f, 0.36f);
        c9518f.m37146b();
        c9518f.m37154j(20.71f, 7.04f);
        c9518f.m37148d(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        c9518f.m37153i(-2.34f, -2.34f);
        c9518f.m37148d(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        c9518f.m37153i(-1.83f, 1.83f);
        c9518f.m37153i(3.75f, 3.75f);
        c9518f.m37153i(1.83f, -1.83f);
        c9518f.m37146b();
