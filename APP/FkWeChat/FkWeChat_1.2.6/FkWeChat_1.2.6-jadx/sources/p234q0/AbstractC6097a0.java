...
public abstract class AbstractC6097a0 {

    /* JADX INFO: renamed from: a */
    public static C9516d f19140a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24250a(C5618b c5618b) {
        C9516d c9516d = f19140a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.ContentCopy", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37154j(15.0f, 20.0f);
        c9518f.m37150f(5.0f);
        c9518f.m37158n(7.0f);
        c9518f.m37148d(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        c9518f.m37151g(0.0f);
        c9518f.m37147c(3.45f, 6.0f, 3.0f, 6.45f, 3.0f, 7.0f);
        c9518f.m37159o(13.0f);
        c9518f.m37148d(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        c9518f.m37151g(10.0f);
        c9518f.m37148d(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        c9518f.m37159o(0.0f);
        c9518f.m37147c(16.0f, 20.45f, 15.55f, 20.0f, 15.0f, 20.0f);
        c9518f.m37146b();
        c9518f.m37154j(20.0f, 16.0f);
        c9518f.m37158n(4.0f);
        c9518f.m37148d(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        c9518f.m37150f(9.0f);
        c9518f.m37147c(7.9f, 2.0f, 7.0f, 2.9f, 7.0f, 4.0f);
        c9518f.m37159o(12.0f);
        c9518f.m37148d(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        c9518f.m37151g(9.0f);
        c9518f.m37147c(19.1f, 18.0f, 20.0f, 17.1f, 20.0f, 16.0f);
        c9518f.m37146b();
        c9518f.m37154j(18.0f, 16.0f);
        c9518f.m37150f(9.0f);
        c9518f.m37158n(4.0f);
        c9518f.m37151g(9.0f);
        c9518f.m37158n(16.0f);
        c9518f.m37146b();
