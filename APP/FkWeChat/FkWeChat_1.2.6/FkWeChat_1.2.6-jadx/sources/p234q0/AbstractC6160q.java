...
public abstract class AbstractC6160q {

    /* JADX INFO: renamed from: a */
    public static C9516d f19203a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m24313a(C5618b c5618b) {
        C9516d c9516d = f19203a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("Rounded.Cancel", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c9518f.m37157m(4.47f, 10.0f, 10.0f, 10.0f);
        c9518f.m37157m(10.0f, -4.47f, 10.0f, -10.0f);
        c9518f.m37156l(17.53f, 2.0f, 12.0f, 2.0f);
        c9518f.m37146b();
        c9518f.m37154j(16.3f, 16.3f);
        c9518f.m37148d(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        c9518f.m37152h(12.0f, 13.41f);
        c9518f.m37152h(9.11f, 16.3f);
        c9518f.m37148d(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        c9518f.m37148d(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        c9518f.m37152h(10.59f, 12.0f);
        c9518f.m37152h(7.7f, 9.11f);
        c9518f.m37148d(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        c9518f.m37148d(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        c9518f.m37152h(12.0f, 10.59f);
        c9518f.m37153i(2.89f, -2.89f);
        c9518f.m37148d(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        c9518f.m37148d(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        c9518f.m37152h(13.41f, 12.0f);
        c9518f.m37153i(2.89f, 2.89f);
        c9518f.m37148d(0.38f, 0.38f, 0.38f, 1.02f, 0.0f, 1.41f);
        c9518f.m37146b();
