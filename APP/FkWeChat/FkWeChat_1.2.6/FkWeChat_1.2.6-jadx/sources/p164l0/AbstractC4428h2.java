...
/* JADX INFO: renamed from: l0.h2 */
/* JADX INFO: compiled from: r8-map-id-41ef8b4051cf12c4299b71f89f7150459dca1d84aebb9e505d81ecf50968f600 */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC4428h2 {
    ...
    */
    public static final android.view.inputmethod.CursorAnchorInfo.Builder m17257a(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, p018b3.InterfaceC0956i0 r20, p319w2.C9122q3 r21, p250r1.C6457g r22) {
        /*
            r0 = r19
            r1 = r20
            r2 = r18
        ...
        L8b:
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: p164l0.AbstractC4428h2.m17257a(android.view.inputmethod.CursorAnchorInfo$Builder, int, int, b3.i0, w2.q3, r1.g):android.view.inputmethod.CursorAnchorInfo$Builder");
    }

    /* JADX INFO: renamed from: b */
    public static final CursorAnchorInfo m17258b(CursorAnchorInfo.Builder builder, C0978t0 c0978t0, InterfaceC0956i0 interfaceC0956i0, C9122q3 c9122q3, Matrix matrix, C6457g c6457g, C6457g c6457g2, boolean z10, boolean z11, boolean z12, boolean z13) {
        builder.reset();
        builder.setMatrix(matrix);
        int iM35521l = C9137t3.m35521l(c0978t0.m3585j());
        builder.setSelectionRange(iM35521l, C9137t3.m35520k(c0978t0.m3585j()));
        if (z10) {
            m17260d(builder, iM35521l, interfaceC0956i0, c9122q3, c6457g);
        }
        if (z11) {
            ...
            if (iM35521l2 >= 0 && iM35521l2 < iM35520k) {
                ...
                m17257a(builder, iM35521l2, iM35520k, interfaceC0956i0, c9122q3, c6457g);
            }
        }
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 33 && z12) {
            C4406c0.m17219a(builder, c6457g2);
        }
        if (i10 >= 34 && z13) {
            C4414e0.m17228a(builder, c9122q3, c6457g);
        }
        return builder.build();
    }

    /* JADX INFO: renamed from: c */
    public static final boolean m17259c(C6457g c6457g, float f10, float f11) {
    ...
    public static final CursorAnchorInfo.Builder m17260d(CursorAnchorInfo.Builder builder, int i10, InterfaceC0956i0 interfaceC0956i0, C9122q3 c9122q3, C6457g c6457g) {
        if (i10 < 0) {
            return builder;
        }
        ...
        boolean zM17259c = m17259c(c6457g, fM8585l, c6457gM35386e.m25586o());
        boolean zM17259c2 = m17259c(c6457g, fM8585l, c6457gM35386e.m25580i());
        boolean z10 = c9122q3.m35384c(iMo3268b) == EnumC2856i.f7468r;
        int i11 = (zM17259c || zM17259c2) ? 1 : 0;
        if (!zM17259c || !zM17259c2) {
            i11 |= 2;
        }
        if (z10) {
            i11 |= 4;
