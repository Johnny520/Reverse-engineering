...
public final class C3163y extends AbstractC3165z {
    public C3163y(C3128g0 c3128g0) {
        super(c3128g0);
    }

    @Override // java.util.Set, java.util.Collection
    public /* bridge */ /* synthetic */ boolean add(Object obj) {
        return ((Boolean) m11944e(obj)).booleanValue();
    }

    @Override // java.util.Set, java.util.Collection
    public /* bridge */ /* synthetic */ boolean addAll(Collection collection) {
        return ((Boolean) m11945l(collection)).booleanValue();
    }

    @Override // java.util.Set, java.util.Collection
    public boolean contains(Object obj) {
        return m11949a().containsKey(obj);
    }
    ...
    public boolean containsAll(Collection collection) {
        ...
        while (it.hasNext()) {
            if (!m11949a().containsKey(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public Void m11944e(Object obj) {
        AbstractC3130h0.m11750b();
        throw new C4699i();
    }

    /* JADX INFO: renamed from: l */
    public Void m11945l(Collection collection) {
        AbstractC3130h0.m11750b();
        throw new C4699i();
    }
    ...
    public C3154t0 iterator() {
        return new C3154t0(m11949a(), ((InterfaceC9826d) m11949a().m11740p().m11744i().entrySet()).iterator());
    }

    @Override // java.util.Set, java.util.Collection
    public boolean remove(Object obj) {
        return m11949a().remove(obj) != null;
    }
    ...
    public boolean removeAll(Collection collection) {
        ...
        while (true) {
            boolean z10 = false;
            while (it.hasNext()) {
                if (m11949a().remove(it.next()) != null || z10) {
                    z10 = true;
                }
            }
            return z10;
    ...
    public boolean retainAll(Collection collection) {
        ...
        do {
            ...
            for (Map.Entry entry : c3128g0M11949a.entrySet()) {
                if (!setM20564c1.contains(entry.getKey())) {
