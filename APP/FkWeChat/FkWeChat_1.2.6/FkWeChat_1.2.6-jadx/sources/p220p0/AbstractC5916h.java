...
public abstract class AbstractC5916h {

    /* JADX INFO: renamed from: a */
    public static C9516d f18813a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m23817a(C5617a c5617a) {
        C9516d c9516d = f18813a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("AutoMirrored.Rounded.Send", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c9518f.m37154j(3.4f, 20.4f);
        c9518f.m37153i(17.45f, -7.48f);
        c9518f.m37148d(0.81f, -0.35f, 0.81f, -1.49f, 0.0f, -1.84f);
        c9518f.m37152h(3.4f, 3.6f);
        c9518f.m37148d(-0.66f, -0.29f, -1.39f, 0.2f, -1.39f, 0.91f);
        c9518f.m37152h(2.0f, 9.12f);
        c9518f.m37148d(0.0f, 0.5f, 0.37f, 0.93f, 0.87f, 0.99f);
        c9518f.m37152h(17.0f, 12.0f);
        c9518f.m37152h(2.87f, 13.88f);
        c9518f.m37148d(-0.5f, 0.07f, -0.87f, 0.5f, -0.87f, 1.0f);
        c9518f.m37153i(0.01f, 4.61f);
        c9518f.m37148d(0.0f, 0.71f, 0.73f, 1.2f, 1.39f, 0.91f);
        c9518f.m37146b();
