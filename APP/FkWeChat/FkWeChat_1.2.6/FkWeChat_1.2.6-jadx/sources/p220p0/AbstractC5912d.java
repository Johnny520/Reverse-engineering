...
public abstract class AbstractC5912d {
    ...
    public static C9516d f18809a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m23813a(C5617a c5617a) {
        C9516d c9516d = f18809a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("AutoMirrored.Rounded.Chat", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c9518f.m37157m(-0.45f, 1.0f, -1.0f, 1.0f);
        c9518f.m37146b();
        c9518f.m37154j(17.0f, 8.0f);
        c9518f.m37152h(7.0f, 8.0f);
        c9518f.m37148d(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        c9518f.m37157m(0.45f, -1.0f, 1.0f, -1.0f);
        c9518f.m37151g(10.0f);
        c9518f.m37148d(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
