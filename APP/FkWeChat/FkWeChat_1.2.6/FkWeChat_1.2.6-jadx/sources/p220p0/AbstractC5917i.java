...
public abstract class AbstractC5917i {
    ...
    public static C9516d f18814a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m23818a(C5617a c5617a) {
        C9516d c9516d = f18814a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("AutoMirrored.Rounded.ShortText", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c9518f.m37157m(0.45f, -1.0f, 1.0f, -1.0f);
        c9518f.m37146b();
        c9518f.m37154j(5.0f, 13.0f);
        c9518f.m37151g(8.0f);
        c9518f.m37148d(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        c9518f.m37157m(-0.45f, 1.0f, -1.0f, 1.0f);
        c9518f.m37152h(5.0f, 15.0f);
        c9518f.m37148d(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        c9518f.m37157m(0.45f, -1.0f, 1.0f, -1.0f);
        c9518f.m37146b();
