...
public abstract class AbstractC5910b {

    /* JADX INFO: renamed from: a */
    public static C9516d f18807a;

    /* JADX INFO: renamed from: a */
    public static final C9516d m23811a(C5617a c5617a) {
        C9516d c9516d = f18807a;
        if (c9516d != null) {
            c9516d.getClass();
            return c9516d;
        }
        C9516d.a aVar = new C9516d.a("AutoMirrored.Rounded.ArrowForwardIos", C3179i.m12003k(24.0f), C3179i.m12003k(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c9518f.m37154j(7.38f, 21.01f);
        c9518f.m37148d(0.49f, 0.49f, 1.28f, 0.49f, 1.77f, 0.0f);
        c9518f.m37153i(8.31f, -8.31f);
        c9518f.m37148d(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        c9518f.m37152h(9.15f, 2.98f);
        c9518f.m37148d(-0.49f, -0.49f, -1.28f, -0.49f, -1.77f, 0.0f);
        c9518f.m37157m(-0.49f, 1.28f, 0.0f, 1.77f);
        c9518f.m37152h(14.62f, 12.0f);
        c9518f.m37153i(-7.25f, 7.25f);
        c9518f.m37148d(-0.48f, 0.48f, -0.48f, 1.28f, 0.01f, 1.76f);
        c9518f.m37146b();
