...
final class FieldWriterInt8Value<T> extends FieldWriterInt8<T> {
    public FieldWriterInt8Value(String str, int i10, long j10, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public boolean write(JSONWriter jSONWriter, T t10) {
        ...
        try {
            byte byteValue = this.propertyAccessor.getByteValue(t10);
            if (byteValue == 0 && this.defaultValue == null && (features & JSONWriter.MASK_NOT_WRITE_DEFAULT_VALUE) != 0) {
                return false;
            }
