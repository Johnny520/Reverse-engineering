...
final class FieldWriterCalendar<T> extends FieldWriterDate<T> {
    public FieldWriterCalendar(String str, int i10, long j10, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public boolean write(JSONWriter jSONWriter, T t10) {
        ...
        try {
            Calendar calendar = (Calendar) this.propertyAccessor.getObject(t10);
            if (calendar != null) {
