...
final class FieldReaderInt16<T, V> extends FieldReader<T> {
    public FieldReaderInt16(String str, Class<V> cls, int i10, long j10, String str2, Locale locale, Object obj, JSONSchema jSONSchema, Method method, Field field, BiConsumer<T, V> biConsumer, String str3, Parameter parameter) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t10) throws Exception {
        ...
        this.propertyAccessor.setObject(t10, shValueOf);
    }
