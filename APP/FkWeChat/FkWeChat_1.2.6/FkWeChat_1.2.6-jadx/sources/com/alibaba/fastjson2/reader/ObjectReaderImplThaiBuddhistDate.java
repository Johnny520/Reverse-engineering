...
final class ObjectReaderImplThaiBuddhistDate extends ObjectReaderPrimitive<ThaiBuddhistDate> {
    ...
    public ThaiBuddhistDate readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j10) {
    ...
    public ThaiBuddhistDate readObject(JSONReader jSONReader, Type type, Object obj, long j10) {
        String string = jSONReader.readString();
        if (string == null) {
            return null;
        }
