...
public class ObjectReaders {
    ...
    public static <T> FieldReader fieldReaderListStr(String str, BiConsumer<T, List<String>> biConsumer) {
        return new FieldReaderList(str, List.class, List.class, String.class, String.class, 0, 0L, null, null, null, null, null, null, biConsumer, null, null, new C1742y3(), null);
    }
    ...
    public static <T> ObjectReader<T> m6408of(Supplier<T> supplier, FieldReader... fieldReaderArr) {
    ...
    /* JADX INFO: renamed from: of */
    public static <T> ObjectReader<T> m6407of(Class<T> cls, Supplier<T> supplier, FieldReader... fieldReaderArr) {
        return ObjectReaderCreator.INSTANCE.createObjectReader(cls, supplier, fieldReaderArr);
    }

    /* JADX INFO: renamed from: of */
    public static <T> ObjectReader<T> m6406of(Class<T> cls) {
        return ObjectReaderCreator.INSTANCE.createObjectReader((Class) cls);
    }
    ...
    public static <T, V> FieldReader fieldReaderList(String str, Type type, BiConsumer<T, List<V>> biConsumer) {
        return fieldReaderList(str, type, new C1742y3(), biConsumer);
    }
}
