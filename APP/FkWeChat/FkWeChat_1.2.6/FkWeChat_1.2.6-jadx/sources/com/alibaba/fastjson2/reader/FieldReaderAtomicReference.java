...
public class FieldReaderAtomicReference<T> extends FieldReader<T> {
    ...
    */
    ...
    public void accept(T t10, Object obj) {
        ...
        if (z10) {
            ((AtomicReference) propertyAccessor.getObject(t10)).set(obj);
        } else {
            propertyAccessor.setObject(t10, new AtomicReference(obj));
        }
    }
    ...
    public void readFieldValue(JSONReader jSONReader, T t10) {
        ...
        accept(t10, jSONReader.read(this.referenceType));
    }
