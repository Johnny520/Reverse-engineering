...
public class ObjectReader12<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader12(Class cls, String str, String str2, long j10, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        ...
        FieldReader fieldReader12 = fieldReaderArr[11];
        this.fieldReader11 = fieldReader12;
        ...
        this.hashCode11 = fieldReader12.fieldNameHash;
        ...
        this.hashCode11LCase = fieldReader12.fieldNameHashLCase;
    }
    ...
    public FieldReader getFieldReader(long j10) {
        ...
        if (j10 == this.hashCode3) {
            return this.fieldReader3;
        }
        if (j10 == this.hashCode4) {
            return this.fieldReader4;
        }
        if (j10 == this.hashCode5) {
            return this.fieldReader5;
        }
        if (j10 == this.hashCode6) {
            return this.fieldReader6;
        }
        if (j10 == this.hashCode7) {
            return this.fieldReader7;
        }
        if (j10 == this.hashCode8) {
            return this.fieldReader8;
        }
        if (j10 == this.hashCode9) {
            return this.fieldReader9;
        }
        if (j10 == this.hashCode10) {
            return this.fieldReader10;
        }
        if (j10 == this.hashCode11) {
            return this.fieldReader11;
        }
        return null;
    }
    ...
    public FieldReader getFieldReaderLCase(long j10) {
        ...
        if (j10 == this.hashCode3LCase) {
            return this.fieldReader3;
        }
        if (j10 == this.hashCode4LCase) {
            return this.fieldReader4;
        }
        if (j10 == this.hashCode5LCase) {
            return this.fieldReader5;
        }
        if (j10 == this.hashCode6LCase) {
            return this.fieldReader6;
        }
        if (j10 == this.hashCode7LCase) {
            return this.fieldReader7;
        }
        if (j10 == this.hashCode8LCase) {
            return this.fieldReader8;
        }
        if (j10 == this.hashCode9LCase) {
            return this.fieldReader9;
        }
        if (j10 == this.hashCode10LCase) {
            return this.fieldReader10;
        }
        if (j10 == this.hashCode11LCase) {
            return this.fieldReader11;
        }
        return null;
    }

    public ObjectReader12(Class cls, String str, String str2, long j10, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
