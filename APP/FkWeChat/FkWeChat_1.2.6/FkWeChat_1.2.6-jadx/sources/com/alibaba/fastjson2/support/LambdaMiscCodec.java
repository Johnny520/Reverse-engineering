...
public class LambdaMiscCodec {
    ...
    public static final class ConstructorBiFunction implements BiFunction {
        ...
        public Object apply(Object obj, Object obj2) {
            try {
                ...
                C1565a.m6255a("invoke error", e10);
                return null;
            }
        }
    }
    ...
    public static final class FactoryFunction implements Function {
        ...
        public Object apply(Object obj) {
            try {
                ...
                C1565a.m6255a("createInstance error", e10);
                return null;
            }
        }
    }
    ...
    public static final class ReflectBiFunction implements BiFunction {
        ...
        public Object apply(Object obj, Object obj2) {
            try {
                boolean zIsStatic = Modifier.isStatic(this.method.getModifiers());
                Method method = this.method;
                return zIsStatic ? method.invoke(null, obj, obj2) : method.invoke(obj, obj2);
            } catch (IllegalAccessException e10) {
                e = e10;
                C1565a.m6255a("invoke error", e);
                return null;
    ...
    public static final class ReflectObjIntConsumer implements ObjIntConsumer {
        ...
        public void accept(Object obj, int i10) {
            try {
                this.method.invoke(obj, Integer.valueOf(i10));
    ...
    public static final class ReflectToIntFunction implements ToIntFunction {
        ...
        public int applyAsInt(Object obj) {
            try {
                ...
                C1565a.m6255a("applyAsInt error", e10);
                return 0;
            }
        }
    }
    ...
    public static final class ReflectToLongFunction implements ToLongFunction {
        ...
        public long applyAsLong(Object obj) {
            try {
                ...
                C1565a.m6255a("applyAsLong error", e10);
                return 0L;
            }
        }
    }
    ...
    public static Function createFunction(Method method) {
        ...
        if (parameterTypes.length == 1 && zIsStatic) {
            ...
            if (parameterTypes.length != 0 || zIsStatic) {
                C1605j.m6294a("not support parameters ", method);
                return null;
            }
            cls = declaringClass;
        }
        try {
            MethodHandles.Lookup lookupTrustedLookup = JDKUtils.trustedLookup(declaringClass);
            return (Function) LambdaMetafactory.metafactory(lookupTrustedLookup, "apply", TypeUtils.METHOD_TYPE_FUNCTION, TypeUtils.METHOD_TYPE_OBJECT_OBJECT, zIsStatic ? lookupTrustedLookup.findStatic(declaringClass, method.getName(), MethodType.methodType(returnType, cls)) : lookupTrustedLookup.findVirtual(declaringClass, method.getName(), MethodType.methodType(returnType)), MethodType.methodType(returnType, cls)).getTarget().invokeExact();
        } catch (Throwable th) {
            errorLast = th;
            ...
            if (!name.equals("gnu.trove.set.hash.TShortHashSet")) {
                if (name.equals("com.carrotsearch.hppc.CharHashSet") || name.equals("com.carrotsearch.hppc.CharArrayList")) {
                    try {
                        ...
                        C1565a.m6255a("illegal state", e10);
                        return null;
                    }
                }
                if (!name.equals("com.carrotsearch.hppc.IntArrayList")) {
                    if (!name.equals("gnu.trove.list.array.TLongArrayList")) {
                        if (!name.equals("gnu.trove.list.array.TShortArrayList")) {
                            if (!name.equals("gnu.trove.set.hash.TIntHashSet")) {
                                if (name.equals("com.carrotsearch.hppc.ShortArrayList")) {
                                    try {
                                        ...
                                        C1565a.m6255a("illegal state", e11);
                                        return null;
                                    }
                                }
                                if (name.equals("com.carrotsearch.hppc.DoubleArrayList")) {
                                    try {
                                        ...
                                        C1565a.m6255a("illegal state", e12);
                                        return null;
                                    }
                                }
                                if (name.equals("com.carrotsearch.hppc.ByteArrayList")) {
                                    try {
                                        ...
                                        C1565a.m6255a("illegal state", e13);
                                        return null;
                                    }
                                }
                                if (!name.equals("gnu.trove.set.hash.TLongHashSet")) {
                                    if (name.equals("gnu.trove.list.array.TCharArrayList")) {
                                        try {
                                            ...
                                            C1565a.m6255a("illegal state", e14);
                                            return null;
                                        }
                                    }
                                    if (name.equals("gnu.trove.list.array.TFloatArrayList")) {
                                        try {
                                            ...
                                            C1565a.m6255a("illegal state", e15);
                                            return null;
                                        }
                                    }
                                    if (!name.equals("gnu.trove.stack.array.TByteArrayStack")) {
                                        if (name.equals("com.carrotsearch.hppc.FloatArrayList")) {
                                            try {
                                                ...
                                                C1565a.m6255a("illegal state", e16);
                                                return null;
                                            }
                                        }
                                                ...
                                                if (!name.equals("gnu.trove.list.array.TByteArrayList")) {
                                                    if (name.equals("org.bson.types.Decimal128")) {
                                                        try {
                                                            ...
                                                            C1565a.m6255a("illegal state", e17);
                                                            return null;
                                                        }
                                                    }
                                                    if (!name.equals("gnu.trove.set.hash.TByteHashSet")) {
                                                        if (!name.equals("com.carrotsearch.hppc.LongArrayList")) {
                                                            ...
                                                            try {
                                                                ...
                                                                C1565a.m6255a("illegal state", e18);
                                                                return null;
                                                            }
                                                        }
                                                    }
                                    ...
                                    try {
                                        ...
                                        C1565a.m6255a("illegal state", e19);
                                        return null;
                                    }
                                }
                            }
                            try {
                                ...
                                C1565a.m6255a("illegal state", e20);
                                return null;
                            }
                        }
                    }
                    try {
                        ...
                        C1565a.m6255a("illegal state", e21);
                        return null;
                    }
                }
                try {
                    ...
                    C1565a.m6255a("illegal state", e22);
                    return null;
                }
            }
            try {
                ...
                C1565a.m6255a("illegal state", e23);
                return null;
            }
        }
        try {
            ...
            C1565a.m6255a("illegal state", e24);
            return null;
        }
    }
    ...
    */
    public static com.alibaba.fastjson2.writer.ObjectWriter getObjectWriter(java.lang.reflect.Type r11, java.lang.Class r12) {
        /*
