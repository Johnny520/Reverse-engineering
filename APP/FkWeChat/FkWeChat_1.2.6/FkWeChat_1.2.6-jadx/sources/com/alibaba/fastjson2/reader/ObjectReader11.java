...
public class ObjectReader11<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader11(Class cls, String str, String str2, long j10, JSONSchema jSONSchema, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
    ...
    public ObjectReader11(Class cls, String str, String str2, long j10, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
