...
public class ObjectWriters {
    ...
    public static /* synthetic */ int m6533a(ToLongFunction toLongFunction, Object obj) {
    ...
    public static <T> ObjectWriter<T> m6534of(Class<T> cls, FieldWriter... fieldWriterArr) {
    ...
    public static <T> ObjectWriter ofToBooleanArray(final ToLongFunction toLongFunction, BiFunction<Object, Integer, Boolean> biFunction) {
        return new ObjectWriterImplBoolValueArrayLambda(new ToIntFunction() { // from class: com.alibaba.fastjson2.writer.f0
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
                return ObjectWriters.m6533a(toLongFunction, obj);
            }
        }, biFunction);
    }
    ...
    public static ObjectWriter objectWriter(Class cls, long j10, FieldWriter... fieldWriterArr) {
        return INSTANCE.createObjectWriter(cls, j10, fieldWriterArr);
    }
