...
public class JDKUtils {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:213:0x00c3
    ...
    public static /* synthetic */ int m6497a(String str) {
        return 1;
    }

    public static String asciiStringJDK8(byte[] bArr, int i10, int i11) {
    ...
    public static String latin1StringJDK8(byte[] bArr, int i10, int i11) {
        char[] cArr = new char[i11];
        for (int i12 = 0; i12 < i11; i12++) {
            cArr[i12] = (char) (bArr[i10 + i12] & 255);
        }
        return STRING_CREATOR_JDK8.apply(cArr, Boolean.TRUE);
    }
