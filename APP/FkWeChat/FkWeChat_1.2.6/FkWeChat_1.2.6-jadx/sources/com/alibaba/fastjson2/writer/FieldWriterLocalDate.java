...
final class FieldWriterLocalDate<T> extends FieldWriterObjectFinal<T> {
    public FieldWriterLocalDate(String str, int i10, long j10, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Function function) {
    ...
    public boolean write(JSONWriter jSONWriter, T t10) {
        LocalDate localDate = (LocalDate) this.propertyAccessor.getObject(t10);
        if (localDate == null) {
