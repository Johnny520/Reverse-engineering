...
final class ObjectReaderImplMinguoDate extends ObjectReaderPrimitive<MinguoDate> {
    ...
    public MinguoDate readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j10) {
    ...
    public MinguoDate readObject(JSONReader jSONReader, Type type, Object obj, long j10) {
        String string = jSONReader.readString();
        if (string == null) {
            return null;
        }
