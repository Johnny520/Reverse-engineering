...
public interface ObjectReaderAnnotationProcessor {
    ...
    default void getFieldInfo(FieldInfo fieldInfo, Class cls, Method method, int i10, Parameter parameter) {
    }

    default void getBeanInfo(BeanInfo beanInfo, Class<?> cls) {
    }

    default void getFieldInfo(FieldInfo fieldInfo, Class cls, Constructor constructor, int i10, Parameter parameter) {
    }
}
