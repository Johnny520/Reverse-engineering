...
final class FieldWriterBoolValue<T> extends FieldWriterBool<T> {
    public FieldWriterBoolValue(String str, int i10, long j10, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public boolean write(JSONWriter jSONWriter, T t10) {
        ...
        try {
            boolean booleanValue = this.propertyAccessor.getBooleanValue(t10);
