...
final class FieldWriterInt32Value<T> extends FieldWriterInt32<T> {
    public FieldWriterInt32Value(String str, int i10, long j10, String str2, Locale locale, String str3, Type type, Class cls, Field field, Method method, Object obj) {
    ...
    public boolean write(JSONWriter jSONWriter, T t10) {
        ...
        try {
            int intValue = this.propertyAccessor.getIntValue(t10);
    ...
    public void writeValue(JSONWriter jSONWriter, T t10) {
        jSONWriter.writeInt32(this.propertyAccessor.getIntValue(t10));
    }
}
