...
public final class ASMUtils {
    ...
    static {
        ...
        TYPE_JSONB_IO = JSONB.InterfaceC1562IO.class.getName().replace('.', '/');
        ...
        DESC_JSON_READER = "L" + strReplace + ';';
        DESC_JSON_WRITER = "L" + strReplace5 + ';';
        DESC_OBJECT_READER = "L" + strReplace2 + ';';
        DESC_OBJECT_READER_ADAPTER = "L" + strReplace3 + ';';
        DESC_OBJECT_WRITER = "L" + strReplace4 + ';';
    ...
    public static String desc(Class<?> cls) {
        ...
        AbstractC4284d1.m16830a(descCacheRef, null, andSet);
        return str2;
    }
    ...
    public static final class MethodInfo {
        ...
        public MethodInfo(String str, String str2, Class[] clsArr) {
            ...
            for (int i10 = 0; i10 < clsArr.length; i10++) {
                this.paramTypeNames[i10] = clsArr[i10].getName();
            }
        }
