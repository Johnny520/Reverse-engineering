...
class JSONPathTyped extends JSONPath {
    ...
    public JSONPathTyped(JSONPath jSONPath, Type type) {
    ...
    public static JSONPath m6216of(JSONPath jSONPath, Type type) {
        if (type == null || type == Object.class) {
            return jSONPath;
        }
        if ((jSONPath instanceof JSONPathTyped) && ((JSONPathTyped) jSONPath).type.equals(type)) {
            return jSONPath;
        }
    ...
    public void setInt(Object obj, int i10) {
        this.jsonPath.setInt(obj, i10);
    }

    @Override // com.alibaba.fastjson2.JSONPath
    public void setLong(Object obj, long j10) {
        this.jsonPath.setLong(obj, j10);
    }
