...
final class ObjectReaderImplHijrahDate extends ObjectReaderPrimitive<HijrahDate> {
    ...
    public HijrahDate readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j10) {
    ...
    public HijrahDate readObject(JSONReader jSONReader, Type type, Object obj, long j10) {
        String string = jSONReader.readString();
        if (string == null) {
            return null;
        }
