...
final class FieldReaderAtomicLong<T> extends FieldReader<T> {
    public FieldReaderAtomicLong(String str, Class cls, int i10, JSONSchema jSONSchema, Method method, Field field) {
        super(str, cls, cls, i10, 0L, null, null, null, jSONSchema, method, field);
    }
    ...
    public void accept(T t10, Object obj) {
        if (this.readOnly) {
            if (obj != null) {
                ((AtomicLong) this.propertyAccessor.getObject(t10)).set(((Number) obj).longValue());
            }
        } else {
    ...
    public void readFieldValue(JSONReader jSONReader, T t10) {
        accept(t10, jSONReader.readInt64());
    }
}
