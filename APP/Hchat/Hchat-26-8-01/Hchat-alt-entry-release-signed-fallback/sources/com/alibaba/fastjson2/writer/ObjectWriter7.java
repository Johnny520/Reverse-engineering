...
public class ObjectWriter7<T> extends com.alibaba.fastjson2.writer.ObjectWriterAdapter<T> {
    ...
    public ObjectWriter7(java.lang.Class<T> r1, java.lang.String r2, java.lang.String r3, long r4, java.util.List<com.alibaba.fastjson2.writer.FieldWriter> r6) {
            r0 = this;
