...
final class FieldReaderInt16Func<T, V> extends com.alibaba.fastjson2.reader.FieldReader<T> {
    final java.util.function.BiConsumer<T, V> function;

    public FieldReaderInt16Func(java.lang.String r13, java.lang.Class<V> r14, int r15, long r16, java.lang.String r18, java.util.Locale r19, java.lang.Object r20, java.lang.reflect.Method r21, java.util.function.BiConsumer<T, V> r22) {
            r12 = this;
            r11 = 0
            r3 = r14
            r0 = r12
    ...
    public void accept(T r2, java.lang.Object r3) {
            r1 = this;
            java.lang.Short r3 = com.alibaba.fastjson2.util.TypeUtils.toShort(r3)
    ...
    public void readFieldValue(com.alibaba.fastjson2.JSONReader r7, T r8) {
            ...
            goto L23
        L8:
            short r1 = r1.shortValue()     // Catch: java.lang.Exception -> L11
            java.lang.Short r0 = java.lang.Short.valueOf(r1)     // Catch: java.lang.Exception -> L11
            goto L23
        L11:
            r1 = move-exception
            long r2 = r6.features
