...
final class ObjectWriterImplInt32 extends com.alibaba.fastjson2.writer.ObjectWriterPrimitiveImpl {
    static final com.alibaba.fastjson2.writer.ObjectWriterImplInt32 INSTANCE = null;

    static {
            com.alibaba.fastjson2.writer.ObjectWriterImplInt32 r0 = new com.alibaba.fastjson2.writer.ObjectWriterImplInt32
            r0.<init>()
            com.alibaba.fastjson2.writer.ObjectWriterImplInt32.INSTANCE = r0
            return
    }

    public ObjectWriterImplInt32() {
            r0 = this;
            r0.<init>()
            return
    }
