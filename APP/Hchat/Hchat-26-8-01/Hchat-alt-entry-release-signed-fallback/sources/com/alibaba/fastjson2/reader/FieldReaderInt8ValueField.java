...
final class FieldReaderInt8ValueField<T> extends com.alibaba.fastjson2.reader.FieldReader<T> {
    public FieldReaderInt8ValueField(java.lang.String r13, java.lang.Class r14, int r15, long r16, java.lang.String r18, java.lang.Byte r19, java.lang.reflect.Field r20) {
            r12 = this;
            r8 = 0
            r10 = 0
            r3 = r14
    ...
    public void accept(T r3, int r4) {
            ...
            byte r4 = (byte) r4     // Catch: java.lang.Exception -> L7
            r0.setByte(r3, r4)     // Catch: java.lang.Exception -> L7
            return
        L7:
            r3 = move-exception
    ...
    public void accept(T r2, long r3) {
            ...
            byte r3 = (byte) r3     // Catch: java.lang.Exception -> L8
            r0.setByte(r2, r3)     // Catch: java.lang.Exception -> L8
            return
        L8:
            r2 = move-exception
    ...
    public void accept(T r3, java.lang.Object r4) {
            ...
            byte r4 = com.alibaba.fastjson2.util.TypeUtils.toByteValue(r4)     // Catch: java.lang.Exception -> La
            r0.setByte(r3, r4)     // Catch: java.lang.Exception -> La
            return
        La:
            r3 = move-exception
            java.lang.StringBuilder r4 = new java.lang.StringBuilder
    ...
    public void readFieldValue(com.alibaba.fastjson2.JSONReader r4, T r5) {
            ...
            byte r0 = (byte) r0     // Catch: java.lang.Exception -> Lb
            r1.setByte(r5, r0)     // Catch: java.lang.Exception -> Lb
            return
        Lb:
            r5 = move-exception
