...
final class FieldReaderInt64Func<T, V> extends com.alibaba.fastjson2.reader.FieldReader<T> {
    final java.util.function.BiConsumer<T, V> function;

    public FieldReaderInt64Func(java.lang.String r13, java.lang.Class<V> r14, int r15, long r16, java.lang.String r18, java.util.Locale r19, java.lang.Object r20, java.lang.reflect.Method r21, java.util.function.BiConsumer<T, V> r22) {
            r12 = this;
            r11 = 0
            r3 = r14
            r0 = r12
    ...
    public void readFieldValue(com.alibaba.fastjson2.JSONReader r6, T r7) {
            r5 = this;
            java.lang.Long r6 = r6.readInt64()     // Catch: java.lang.Exception -> L5
            goto L18
        L5:
            r0 = move-exception
            long r1 = r5.features
