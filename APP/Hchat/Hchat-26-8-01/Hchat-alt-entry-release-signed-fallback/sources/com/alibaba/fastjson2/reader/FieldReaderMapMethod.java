...
public class FieldReaderMapMethod<T> extends com.alibaba.fastjson2.reader.FieldReaderObject<T> {
    ...
    public FieldReaderMapMethod(java.lang.String r1, java.lang.reflect.Type r2, java.lang.Class r3, int r4, long r5, java.lang.String r7, java.util.Locale r8, java.lang.Object r9, java.lang.reflect.Method r10, java.lang.reflect.Field r11, java.util.function.BiConsumer r12, java.lang.String r13, java.util.function.BiConsumer r14) {
            r0 = this;
            r0.<init>(r1, r2, r3, r4, r5, r7, r8, r9, r10, r11, r12)
            r1 = r0
            java.lang.reflect.Type r2 = com.alibaba.fastjson2.util.TypeUtils.getMapValueType(r2)
            r1.valueType = r2
            r1.arrayToMapKey = r13
            com.alibaba.fastjson2.PropertyNamingStrategy r2 = com.alibaba.fastjson2.PropertyNamingStrategy.of(r7)
            r1.namingStrategy = r2
            r1.arrayToMapDuplicateHandler = r14
            return
    }
