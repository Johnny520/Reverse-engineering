...
final class FieldReaderBoolMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderBoolMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Boolean bool, Method method) {
        super(str, type, cls, i9, j3, str2, locale, bool, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toBoolean(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, jSONReader.readBool());
        } catch (Exception e6) {
