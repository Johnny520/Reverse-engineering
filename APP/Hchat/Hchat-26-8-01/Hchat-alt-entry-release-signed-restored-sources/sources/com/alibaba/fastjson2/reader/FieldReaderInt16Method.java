...
final class FieldReaderInt16Method<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt16Method(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Short sh2, Method method) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toShort(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        ...
        try {
            this.method.invoke(t9, int32 == null ? null : Short.valueOf(int32.shortValue()));
        } catch (Exception e6) {
