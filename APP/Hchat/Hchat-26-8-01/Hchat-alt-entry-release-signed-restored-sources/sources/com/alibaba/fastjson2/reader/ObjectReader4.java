...
public class ObjectReader4<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader4(Class cls, String str, String str2, long j3, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
            ...
            if (iStartArray > 1) {
                ...
                if (iStartArray > 2) {
                    ...
                    if (iStartArray > 3) {
                        ...
                        for (int i9 = 4; i9 < iStartArray; i9++) {
        ...
        while (true) {
            ...
            if (i9 == 0 && fieldNameHashCode == ObjectReader.HASH_TYPE) {
                ...
                if ((objectReaderAutoType != null || (objectReaderAutoType = context.getObjectReaderAutoType(jSONReader.getString(), this.objectClass)) != null) && objectReaderAutoType != this) {
                    t9 = (T) objectReaderAutoType.readObject(jSONReader, type, obj, j3);
                    break;
                }
