...
class ObjectReaderImplFloatValueArray extends ObjectReaderPrimitive {
    ...
    public Object createInstance(Collection collection, long j3) {
        ...
        for (Object obj : collection) {
            if (obj == null) {
                ...
                Function typeConvert = JSONFactory.defaultObjectReaderProvider.getTypeConvert(obj.getClass(), Float.TYPE);
                if (typeConvert == null) {
    ...
    public Object readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j3) {
        ...
        for (int i9 = 0; i9 < iStartArray; i9++) {
            fArr[i9] = jSONReader.readFloatValue();
        }
        Function<float[], Object> function = this.builder;
        return function != null ? function.apply(fArr) : fArr;
    }
    ...
    public Object readObject(JSONReader jSONReader, Type type, Object obj, long j3) {
        ...
        while (!jSONReader.nextIfArrayEnd()) {
            ...
            int i10 = i9 + 1;
            if (i10 - fArrCopyOf.length > 0) {
                int length = fArrCopyOf.length;
                int i11 = length + (length >> 1);
                if (i11 - i10 < 0) {
                    i11 = i10;
                }
                fArrCopyOf = Arrays.copyOf(fArrCopyOf, i11);
            }
            fArrCopyOf[i9] = jSONReader.readFloatValue();
            i9 = i10;
        }
        jSONReader.nextIfComma();
        float[] fArrCopyOf2 = Arrays.copyOf(fArrCopyOf, i9);
        Function<float[], Object> function = this.builder;
