...
public class ObjectWriter12<T> extends ObjectWriterAdapter<T> {
    ...
    public ObjectWriter12(Class<T> cls, String str, String str2, long j3, List<FieldWriter> list) {
    ...
    public void write(JSONWriter jSONWriter, Object obj, Object obj2, Type type, long j3) {
        ...
        if (z9) {
            writeArrayMapping(jSONWriter, obj, obj2, type, j3 | this.features);
            return;
        }
