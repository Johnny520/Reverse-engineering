...
final class FieldReaderAtomicBooleanFieldReadOnly<T> extends FieldReader<T> {
    ...
    public FieldReaderAtomicBooleanFieldReadOnly(String str, Class cls, int i9, String str2, AtomicBoolean atomicBoolean, Field field) {
        super(str, cls, cls, i9, 0L, str2, null, atomicBoolean, null, field);
    }
    ...
    public void accept(T t9, Object obj) {
        ...
        try {
            AtomicBoolean atomicBoolean = (AtomicBoolean) this.field.get(t9);
