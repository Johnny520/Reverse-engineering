...
final class FieldReaderBoolField<T> extends FieldReader<T> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public FieldReaderBoolField(String str, Class cls, int i9, long j3, String str2, Boolean bool, Field field) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.field.set(t9, TypeUtils.toBoolean(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.field.set(t9, jSONReader.readBool());
        } catch (Exception e6) {
    ...
    public void accept(T t9, int i9) {
        accept(t9, TypeUtils.toBoolean(Integer.valueOf(i9)));
    }
