...
final class FieldReaderBigDecimalMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderBigDecimalMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, BigDecimal bigDecimal, Method method) {
        super(str, type, cls, i9, j3, str2, locale, bigDecimal, method, null, null);
    }
    ...
    public void accept(T t9, int i9) {
        try {
            this.method.invoke(t9, BigDecimal.valueOf(i9));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, jSONReader.readBigDecimal());
        } catch (Exception e6) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toBigDecimal(obj));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
    ...
    public void accept(T t9, long j3) {
        try {
            this.method.invoke(t9, BigDecimal.valueOf(j3));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
