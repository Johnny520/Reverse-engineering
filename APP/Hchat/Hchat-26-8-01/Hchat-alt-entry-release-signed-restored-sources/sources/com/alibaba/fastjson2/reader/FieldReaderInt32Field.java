...
final class FieldReaderInt32Field<T> extends FieldReader<T> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public FieldReaderInt32Field(String str, Class cls, int i9, long j3, String str2, Integer num, Field field) {
        super(str, cls, cls, i9, j3, str2, null, num, null, field);
    }
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.field.set(t9, jSONReader.readInt32());
        } catch (Exception e6) {
