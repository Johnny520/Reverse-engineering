...
abstract class FieldWriterInt8<T> extends FieldWriter<T> {
    ...
    public FieldWriterInt8(String str, int i9, long j3, String str2, String str3, Class cls, Field field, Method method) {
    ...
    public boolean write(JSONWriter jSONWriter, T t9) {
        try {
            Byte b10 = (Byte) getFieldValue(t9);
            if (b10 == null) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final void writeInt8(JSONWriter jSONWriter, byte b10) {
        writeFieldName(jSONWriter);
        if (this.writeNonStringValueAsString) {
            jSONWriter.writeString(b10);
        } else {
