...
public class ObjectReader12<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader12(Class cls, String str, String str2, long j3, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
    ...
    public FieldReader getFieldReader(long j3) {
        ...
        if (j3 == this.hashCode6) {
            return this.fieldReader6;
        }
        if (j3 == this.hashCode7) {
            return this.fieldReader7;
        }
        if (j3 == this.hashCode8) {
            return this.fieldReader8;
        }
        if (j3 == this.hashCode9) {
            return this.fieldReader9;
        }
        if (j3 == this.hashCode10) {
            return this.fieldReader10;
        }
        if (j3 == this.hashCode11) {
    ...
    public FieldReader getFieldReaderLCase(long j3) {
        ...
        if (j3 == this.hashCode6LCase) {
            return this.fieldReader6;
        }
        if (j3 == this.hashCode7LCase) {
            return this.fieldReader7;
        }
        if (j3 == this.hashCode8LCase) {
            return this.fieldReader8;
        }
        if (j3 == this.hashCode9LCase) {
            return this.fieldReader9;
        }
        if (j3 == this.hashCode10LCase) {
            return this.fieldReader10;
        }
        if (j3 == this.hashCode11LCase) {
            return this.fieldReader11;
        }
        return null;
    }
