...
public class ObjectReader3<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader3(Class cls, String str, String str2, long j3, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
        ...
        if (iStartArray > 0) {
            ...
            if (iStartArray > 1) {
                ...
                if (iStartArray > 2) {
                    ...
                    for (int i9 = 3; i9 < iStartArray; i9++) {
                        jSONReader.skipValue();
                    }
                }
            }
        }
        for (int i10 = 3; i10 < iStartArray; i10++) {
            jSONReader.skipValue();
        }
