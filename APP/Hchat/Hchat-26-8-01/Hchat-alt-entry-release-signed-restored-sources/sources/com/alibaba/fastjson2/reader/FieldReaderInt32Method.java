...
final class FieldReaderInt32Method<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt32Method(String str, int i9, long j3, String str2, Locale locale, Integer num, Method method) {
        super(str, Integer.class, Integer.class, i9, j3, str2, locale, num, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toInteger(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, jSONReader.readInt32());
        } catch (Exception e6) {
