...
final class FieldReaderDoubleValueField<T> extends FieldReader<T> {
    ...
    public FieldReaderDoubleValueField(String str, Class cls, int i9, long j3, String str2, Double d10, Field field) {
        super(str, cls, cls, i9, j3, str2, null, d10, null, field);
    }
