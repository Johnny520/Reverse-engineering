...
final class FieldReaderInt8ValueMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt8ValueMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Byte b10, Method method) {
        super(str, type, cls, i9, j3, str2, locale, b10, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, Byte.valueOf(TypeUtils.toByteValue(obj)));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, Byte.valueOf((byte) jSONReader.readInt32Value()));
        } catch (Exception e6) {
    ...
    public void accept(T t9, long j3) {
        try {
            this.method.invoke(t9, Byte.valueOf((byte) j3));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
