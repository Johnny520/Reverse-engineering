...
final class FieldWriterDateFunc<T> extends FieldWriterDate<T> {
    ...
    public FieldWriterDateFunc(String str, int i9, long j3, String str2, String str3, Method method, Function<T, Date> function) {
        super(str, i9, j3, str2, str3, Date.class, Date.class, null, method);
    ...
    public boolean write(JSONWriter jSONWriter, T t9) {
        Date dateApply = this.function.apply(t9);
        if (dateApply != null) {
            writeDate(jSONWriter, dateApply.getTime());
            return true;
        }
    ...
    public void writeValue(JSONWriter jSONWriter, T t9) {
        ...
        if (dateApply == null) {
            ...
            writeDate(jSONWriter, false, dateApply.getTime());
        }
    }
}
