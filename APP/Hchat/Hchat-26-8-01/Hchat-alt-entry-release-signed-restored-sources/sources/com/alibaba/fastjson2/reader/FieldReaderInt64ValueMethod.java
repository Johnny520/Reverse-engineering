...
final class FieldReaderInt64ValueMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt64ValueMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Long l10, Method method) {
        super(str, type, cls, i9, j3, str2, locale, l10, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, Long.valueOf(TypeUtils.toLongValue(obj)));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, Long.valueOf(jSONReader.readInt64Value()));
        } catch (Exception e6) {
