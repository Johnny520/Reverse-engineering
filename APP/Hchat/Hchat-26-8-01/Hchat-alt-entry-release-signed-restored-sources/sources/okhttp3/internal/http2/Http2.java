...
public final class Http2 {
    ...
    static {
        ...
        for (int i9 = 0; i9 < 256; i9++) {
            ...
            strArr[i9] = AbstractC3156t.m6738b0(Util.format("%8s", binaryString), ' ', '0');
        }
        BINARY = strArr;
        ...
        strArr2[8] = "PADDED";
        int i10 = iArr[0];
        strArr2[i10 | 8] = AbstractC0921a.m2255r(new StringBuilder(), strArr2[i10], "|PADDED");
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            ...
            sb2.append('|');
            strArr3[i14 | 8] = AbstractC0921a.m2255r(sb2, strArr3[i12], "|PADDED");
        }
    ...
    public final String formatFlags(int i9, int i10) {
        ...
        if (i9 != 2 && i9 != 3) {
            ...
            if (i9 != 7 && i9 != 8) {
                ...
                return (i9 != 5 || (i10 & 4) == 0) ? (i9 != 0 || (i10 & 32) == 0) ? str : AbstractC3156t.m6737a0(str, "PRIORITY", "COMPRESSED", false) : AbstractC3156t.m6737a0(str, "HEADERS", "PUSH_PROMISE", false);
            }
        }
        return BINARY[i10];
    }
