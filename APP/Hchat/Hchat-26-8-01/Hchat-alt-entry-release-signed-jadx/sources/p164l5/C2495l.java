...
public final class C2495l extends AbstractC2479a0 implements InterfaceC4128k, InterfaceC4122e {
    ...
    public /* synthetic */ C2495l(C2270u c2270u, EnumC1070f enumC1070f, int i9, int i10) {
    ...
    public final int mo5887e() {
        switch (this.f8132d) {
            case 0:
                return this.f8116a.f7532b.m584O(this.f8118c + 2);
            default:
    ...
    public final int mo5886k() {
        switch (this.f8132d) {
            case 0:
                C0119x c0119x = this.f8116a.f7532b;
                return ((byte[]) c0119x.f310h)[this.f8118c + 3];
            default:
