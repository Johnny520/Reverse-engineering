...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i9 = 4; i9 < iMin; i9++) {
                    char cCharAt = str.charAt(i9);
                    char cCharAt2 = str2.charAt(i9);
                    if (cCharAt != cCharAt2) {
                        return AbstractC1416l.m3827c(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public final String m10953deprecated_javaName() {
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] (LINE:1) call: okhttp3.CipherSuite.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        ...
        public final CipherSuite init(String str, int i9) {
        ...
        private final String secondaryName(String str) {
            return AbstractC3156t.m6740d0(str, "TLS_", false) ? "SSL_".concat(str.substring(4)) : AbstractC3156t.m6740d0(str, "SSL_", false) ? "TLS_".concat(str.substring(4)) : str;
        }
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String) A[MD:(java.lang.String):void (m)] (LINE:7) call: okhttp3.CipherSuite.<init>(java.lang.String):void type: THIS */
    public /* synthetic */ CipherSuite(String str, AbstractC1411g abstractC1411g) {
        this(str);
    }
}
