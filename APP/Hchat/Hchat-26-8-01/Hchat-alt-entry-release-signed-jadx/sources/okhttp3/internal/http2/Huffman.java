...
public final class Huffman {
    ...
    static {
        for (int i9 = 0; i9 < 256; i9++) {
            INSTANCE.addCode(i9, CODES[i9], CODE_BIT_COUNTS[i9]);
        }
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private final void addCode(int i9, int i10, int i11) {
        Node node = new Node(i9, i11);
        Node node2 = root;
        while (i11 > 8) {
            i11 -= 8;
            int i12 = (i10 >>> i11) & 255;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final void decode(BufferedSource bufferedSource, long j3, BufferedSink bufferedSink) {
    ...
    public final void encode(ByteString byteString, BufferedSink bufferedSink) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            while (i9 >= 8) {
                i9 -= 8;
                bufferedSink.writeByte((int) (j3 >> i9));
            }
        }
        if (i9 > 0) {
            bufferedSink.writeByte((int) ((j3 << (8 - i9)) | (255 >>> i9)));
        }
    }
    ...
    public final int encodedLength(ByteString byteString) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            j3 += (long) CODE_BIT_COUNTS[Util.and(byteString.getByte(i9), 255)];
        }
    ...
    public static final class Node {
        ...
        public Node() {
            this.children = new Node[Opcodes.ACC_NATIVE];
            this.symbol = 0;
