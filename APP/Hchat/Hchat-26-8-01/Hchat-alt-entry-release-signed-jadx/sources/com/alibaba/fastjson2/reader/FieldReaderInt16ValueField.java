...
final class FieldReaderInt16ValueField<T> extends FieldReader<T> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public FieldReaderInt16ValueField(String str, Class cls, int i9, long j3, String str2, Short sh2, Field field) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.field.setShort(t9, TypeUtils.toShortValue(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.field.setShort(t9, (short) jSONReader.readInt32Value());
        } catch (Exception e6) {
    ...
    public void accept(T t9, int i9) {
        try {
            this.field.setShort(t9, (short) i9);
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
    ...
    public void accept(T t9, long j3) {
        try {
            this.field.setShort(t9, (short) j3);
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
