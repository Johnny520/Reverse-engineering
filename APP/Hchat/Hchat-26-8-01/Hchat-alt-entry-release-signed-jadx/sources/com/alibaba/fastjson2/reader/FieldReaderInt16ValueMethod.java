...
final class FieldReaderInt16ValueMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt16ValueMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Short sh2, Method method) {
        super(str, type, cls, i9, j3, str2, locale, sh2, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, Short.valueOf(TypeUtils.toShortValue(obj)));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, Short.valueOf((short) jSONReader.readInt32Value()));
        } catch (Exception e6) {
