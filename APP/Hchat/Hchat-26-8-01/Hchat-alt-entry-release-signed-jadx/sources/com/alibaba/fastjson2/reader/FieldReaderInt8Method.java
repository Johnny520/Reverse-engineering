...
final class FieldReaderInt8Method<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderInt8Method(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Byte b10, Method method) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toByte(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        ...
        try {
            this.method.invoke(t9, int32 == null ? null : Byte.valueOf(int32.byteValue()));
        } catch (Exception e6) {
