...
final class FieldReaderFloatField<T> extends FieldReader<T> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public FieldReaderFloatField(String str, Class cls, int i9, long j3, String str2, Float f3, Field field) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.field.set(t9, TypeUtils.toFloat(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.field.set(t9, jSONReader.readFloat());
        } catch (Exception e6) {
