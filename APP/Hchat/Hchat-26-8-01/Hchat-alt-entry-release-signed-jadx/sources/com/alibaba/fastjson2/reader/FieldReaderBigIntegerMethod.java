...
final class FieldReaderBigIntegerMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderBigIntegerMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, BigInteger bigInteger, Method method) {
        super(str, type, cls, i9, j3, str2, locale, bigInteger, method, null, null);
    }
    ...
    public void accept(T t9, int i9) {
        try {
            this.method.invoke(t9, BigInteger.valueOf(i9));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, jSONReader.readBigInteger());
        } catch (Exception e6) {
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toBigInteger(obj));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
    ...
    public void accept(T t9, long j3) {
        try {
            this.method.invoke(t9, BigInteger.valueOf(j3));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
