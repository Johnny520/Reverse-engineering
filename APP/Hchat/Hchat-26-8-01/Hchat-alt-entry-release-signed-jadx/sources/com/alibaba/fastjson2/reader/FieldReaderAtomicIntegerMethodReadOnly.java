...
class FieldReaderAtomicIntegerMethodReadOnly<T> extends FieldReader<T> {
    ...
    public FieldReaderAtomicIntegerMethodReadOnly(String str, Class cls, int i9, Method method) {
    ...
    public void accept(T t9, Object obj) {
        ...
        try {
            ((AtomicInteger) this.method.invoke(t9, null)).set(((Number) obj).intValue());
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        accept(t9, jSONReader.readInt32());
    }
}
