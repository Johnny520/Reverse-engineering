...
public class ObjectReader5<T> extends ObjectReaderAdapter<T> {
    ...
    public ObjectReader5(Class cls, String str, String str2, long j3, Supplier<T> supplier, Function function, FieldReader... fieldReaderArr) {
                ...
                if (iStartArray > 2) {
                    ...
                    if (iStartArray > 3) {
                        ...
                        if (iStartArray > 4) {
                            ...
                            for (int i9 = 5; i9 < iStartArray; i9++) {
    ...
    public T readJSONBObject(JSONReader jSONReader, Type type, Object obj, long j3) {
        ...
        if (!jSONReader.nextIfMatch(JSONB.Constants.BC_OBJECT)) {
            C0086a.m450i(JSONB.typeName(jSONReader.getType()), "expect object, but ");
            return null;
        }
