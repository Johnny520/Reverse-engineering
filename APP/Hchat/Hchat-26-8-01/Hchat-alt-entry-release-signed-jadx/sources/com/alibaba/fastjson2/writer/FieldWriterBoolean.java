...
abstract class FieldWriterBoolean extends FieldWriter {
    ...
    public FieldWriterBoolean(String str, int i9, long j3, String str2, String str3, Type type, Class cls, Field field, Method method) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // com.alibaba.fastjson2.writer.FieldWriter
    public final void writeBool(JSONWriter jSONWriter, boolean z9) {
        long features = jSONWriter.getFeatures(this.features);
        if ((JSONWriter.Feature.WriteNonStringValueAsString.mask & features) != 0) {
            writeFieldName(jSONWriter);
            jSONWriter.writeString(z9 ? "true" : "false");
        } else if (jSONWriter.utf8) {
            jSONWriter.writeNameRaw((features & JSONWriter.Feature.WriteBooleanAsNumber.mask) != 0 ? z9 ? this.utf8Value1 : this.utf8Value0 : z9 ? this.utf8ValueTrue : this.utf8ValueFalse);
        } else if (jSONWriter.utf16) {
            jSONWriter.writeNameRaw((features & JSONWriter.Feature.WriteBooleanAsNumber.mask) != 0 ? z9 ? this.utf16Value1 : this.utf16Value0 : z9 ? this.utf16ValueTrue : this.utf16ValueFalse);
        } else {
            writeFieldName(jSONWriter);
            jSONWriter.writeBool(z9);
        }
    }
