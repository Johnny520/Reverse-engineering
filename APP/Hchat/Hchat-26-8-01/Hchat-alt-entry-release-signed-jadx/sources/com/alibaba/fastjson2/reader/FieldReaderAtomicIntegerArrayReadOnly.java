...
final class FieldReaderAtomicIntegerArrayReadOnly<T> extends FieldReader<T> {
    ...
    public FieldReaderAtomicIntegerArrayReadOnly(String str, Class cls, int i9, Method method) {
    ...
    public void accept(T t9, Object obj) {
        ...
        try {
            AtomicIntegerArray atomicIntegerArray = (AtomicIntegerArray) this.method.invoke(t9, null);
            int i9 = 0;
            if (obj instanceof AtomicIntegerArray) {
                AtomicIntegerArray atomicIntegerArray2 = (AtomicIntegerArray) obj;
                while (i9 < atomicIntegerArray2.length()) {
                    atomicIntegerArray.set(i9, atomicIntegerArray2.get(i9));
                    i9++;
                }
                return;
            }
            List list = (List) obj;
            while (i9 < list.size()) {
                atomicIntegerArray.set(i9, TypeUtils.toIntValue(list.get(i9)));
                i9++;
            }
        } catch (Exception e6) {
        ...
        try {
            ...
            if (jSONReader.nextIfArrayStart()) {
                ...
                while (!jSONReader.nextIfArrayEnd()) {
                    ...
                    if (atomicIntegerArray != null && i9 < atomicIntegerArray.length()) {
                        atomicIntegerArray.set(i9, int32Value);
                    }
                    i9++;
                }
            }
