...
final class FieldReaderDoubleField<T> extends FieldReaderObjectField<T> {
    ...
    public FieldReaderDoubleField(String str, Class cls, int i9, long j3, String str2, Double d10, Field field) {
        super(str, cls, cls, i9, j3, str2, d10, field);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.field.set(t9, TypeUtils.toDouble(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.field.set(t9, jSONReader.readDouble());
        } catch (Exception e6) {
