...
final class FieldReaderDoubleValueMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderDoubleValueMethod(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Double d10, Method method) {
        super(str, type, cls, i9, j3, str2, locale, d10, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, Double.valueOf(TypeUtils.toDoubleValue(obj)));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, Double.valueOf(jSONReader.readDoubleValue()));
        } catch (Exception e6) {
    ...
    public void accept(T t9, int i9) {
        try {
            this.method.invoke(t9, Double.valueOf(i9));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), this.fieldName, " error"), e6);
        }
    }
