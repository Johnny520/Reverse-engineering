...
final class FieldWriterMillisFunc<T> extends FieldWriterDate<T> {
    ...
    public FieldWriterMillisFunc(String str, int i9, long j3, String str2, String str3, Method method, ToLongFunction toLongFunction) {
        Class cls = Long.TYPE;
    ...
    public boolean write(JSONWriter jSONWriter, T t9) {
        writeDate(jSONWriter, this.function.applyAsLong(t9));
        return true;
    }
    ...
    public void writeValue(JSONWriter jSONWriter, T t9) {
        writeDate(jSONWriter, false, this.function.applyAsLong(t9));
    }
}
