...
public final class FieldReaderInstant<T> extends FieldReaderDateTimeCodec<T> {
    ...
    public FieldReaderInstant(String str, Type type, Class cls, int i9, long j3, String str2, Locale locale, Object obj, Field field, Method method, BiConsumer<T, Instant> biConsumer) {
        super(str, type, cls, i9, j3, str2, locale, obj, method, field, ObjectReaderImplInstant.m1713of(str2, locale));
    ...
    public void accept(T t9, Instant instant) {
        ...
        if (instant != null || (this.features & JSONReader.Feature.IgnoreSetNullValue.mask) == 0) {
            ...
            if (j3 != -1) {
                JDKUtils.UNSAFE.putObject(t9, j3, instant);
                return;
            }
            try {
                this.field.set(t9, instant);
            } catch (Exception e7) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        accept((Object) t9, (Instant) this.dateReader.readObject(jSONReader, this.fieldType, this.fieldName, this.features));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // com.alibaba.fastjson2.reader.FieldReader
    public void readFieldValueJSONB(JSONReader jSONReader, T t9) {
        accept((Object) t9, jSONReader.readInstant());
    }
    ...
    public void accept(T t9, LocalDateTime localDateTime) {
        accept((Object) t9, localDateTime.toInstant(DateUtils.DEFAULT_ZONE_ID.getRules().getOffset(localDateTime)));
    }

    @Override // com.alibaba.fastjson2.reader.FieldReaderDateTimeCodec
    public void accept(T t9, Date date) {
        accept((Object) t9, date.toInstant());
    }

    @Override // com.alibaba.fastjson2.reader.FieldReaderDateTimeCodec
    public void accept(T t9, ZonedDateTime zonedDateTime) {
        accept((Object) t9, zonedDateTime.toInstant());
    }

    @Override // com.alibaba.fastjson2.reader.FieldReader
    public void accept(T t9, long j3) {
        accept((Object) t9, Instant.ofEpochMilli(j3));
    }
