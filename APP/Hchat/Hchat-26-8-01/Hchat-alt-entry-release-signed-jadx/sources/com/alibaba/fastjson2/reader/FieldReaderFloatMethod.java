...
final class FieldReaderFloatMethod<T> extends FieldReaderObject<T> {
    ...
    public FieldReaderFloatMethod(String str, int i9, long j3, String str2, Locale locale, Float f3, Method method) {
        super(str, Float.class, Float.class, i9, j3, str2, locale, f3, method, null, null);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.method.invoke(t9, TypeUtils.toFloat(obj));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) {
        try {
            this.method.invoke(t9, jSONReader.readFloat());
        } catch (Exception e6) {
