...
final class FieldReaderInt32Func<T, V> extends FieldReader<T> {
    ...
    public FieldReaderInt32Func(String str, Class<V> cls, int i9, long j3, String str2, Locale locale, Object obj, Method method, BiConsumer<T, V> biConsumer) {
    ...
    public void accept(T t9, Object obj) {
        this.function.accept(t9, TypeUtils.toInteger(obj));
    }
