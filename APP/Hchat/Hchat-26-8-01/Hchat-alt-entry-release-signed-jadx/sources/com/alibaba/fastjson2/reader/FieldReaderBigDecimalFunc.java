...
final class FieldReaderBigDecimalFunc<T, V> extends FieldReader<T> {
    ...
    public FieldReaderBigDecimalFunc(String str, Class<V> cls, int i9, long j3, String str2, Locale locale, Object obj, Method method, BiConsumer<T, V> biConsumer) {
    ...
    public void accept(T t9, int i9) {
        try {
            this.function.accept(t9, (V) BigDecimal.valueOf(i9));
        } catch (Exception e6) {
    ...
    public void readFieldValue(JSONReader jSONReader, T t9) throws Exception {
        ...
        this.function.accept(t9, bigDecimal);
    }
    ...
    public void accept(T t9, Object obj) {
        try {
            this.function.accept(t9, TypeUtils.toBigDecimal(obj));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), super.toString(), " error"), e6);
        }
    }
    ...
    public void accept(T t9, long j3) {
        try {
            this.function.accept(t9, (V) BigDecimal.valueOf(j3));
        } catch (Exception e6) {
            C0086a.m465x(AbstractC0921a.m2255r(new StringBuilder("set "), super.toString(), " error"), e6);
        }
    }
