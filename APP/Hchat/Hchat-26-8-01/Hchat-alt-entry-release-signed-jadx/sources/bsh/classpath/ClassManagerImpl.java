...
public class ClassManagerImpl extends BshClassManager {
    ...
    private void initPluginLoader() {
        ...
        this.pluginLoader = new BshPluginLoader(classLoader);
    }
    ...
    public Class<?> classForName(String str) {
        ...
        if (loaderForClass != null) {
            try {
                ...
                Interpreter.debug("overlay loader failed for '", "' - ", e6);
            }
        }
        ...
        if (clsLoadClass == null) {
            try {
                ...
                StringBuilder sbM1026o = AbstractC0255e.m1026o("The class named '", str, "' could not be found, either because it no longer exists or it is not contained in the class file of the same name. Caused by: ");
                sbM1026o.append(e7.getMessage());
                printStream.println(sbM1026o.toString());
            }
        }
        if (clsLoadClass == null) {
    ...
    public Class<?> defineClass(String str, byte[] bArr) {
        ...
        } catch (ClassPathException e6) {
            C0353j.m1306d("defineClass: ", e6);
            return null;
        }
    }
    ...
    public void doSuperImport() throws UtilEvalError {
        try {
            ...
            getClassNameByUnqName(HttpUrl.FRAGMENT_ENCODE_SET);
            this.superImport = true;
        } catch (ClassPathException e6) {
            throw new UtilEvalError("Error importing classpath " + e6, e6);
        }
    }
    ...
    public Class<?> loadGeneratedClass(String str, byte[] bArr) {
        Class<?> classByCode = BshLoaderHelper.getClassByCode(str, bArr, this.pluginLoader);
        this.pluginLoader.putClass(str, classByCode);
        return classByCode;
    }
    ...
    public void reloadClasses(String[] strArr) throws ClassPathException {
        ...
        for (String str : strArr) {
            ...
            if (classSource == null) {
                throw new ClassPathException(AbstractC4855en.m9263g("Nothing known about class: ", str));
            }
    ...
    public void reloadPackage(String str) throws ClassPathException {
        ...
        if (classesForPackage == null) {
            throw new ClassPathException(AbstractC4855en.m9263g("No classes found for package: ", str));
        }
