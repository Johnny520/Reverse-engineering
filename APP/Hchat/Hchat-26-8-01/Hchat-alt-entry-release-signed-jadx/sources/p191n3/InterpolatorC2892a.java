...
public final class InterpolatorC2892a implements Interpolator {
    ...
    public final float getInterpolation(float f3) {
        ...
        int iMin = Math.min((int) (200 * f3), Opcodes.IFNONNULL);
