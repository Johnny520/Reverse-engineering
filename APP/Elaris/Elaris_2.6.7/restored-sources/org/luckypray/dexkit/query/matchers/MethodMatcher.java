...
public final class MethodMatcher extends BaseMatcher implements IAnnotationEncodeValue {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher annotations(InterfaceC0482u5 interfaceC0482u5) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher callerMethods(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
    ...
    public int innerBuild(C0038c5 c0038c5) {
        int iM105k;
        int iM105k2;
        int iM1287createUsingNumbersTypeVectorVUfvBY;
        ...
        ParametersMatcher parametersMatcher = this.paramsMatcher;
        int iBuild$dexkit_android_release5 = parametersMatcher != null ? parametersMatcher.build$dexkit_android_release(c0038c5) : 0;
        AnnotationsMatcher annotationsMatcher = this.annotationsMatcher;
        ...
        int iBuild$dexkit_android_release7 = opCodesMatcher != null ? opCodesMatcher.build$dexkit_android_release(c0038c5) : 0;
        ...
        if (list2 != null) {
            ...
            while (it2.hasNext()) {
                arrayList2.add(Integer.valueOf(((UsingFieldMatcher) it2.next()).build$dexkit_android_release(c0038c5)));
            }
        ...
        if (list3 != null) {
            ...
            while (it3.hasNext()) {
                ...
                type.getClass();
                arrayList3.add(new C0426qd(type.m1233getValuew2LRezQ()));
            }
            iM1287createUsingNumbersTypeVectorVUfvBY = org.luckypray.dexkit.schema.MethodMatcher.Companion.m1287createUsingNumbersTypeVectorVUfvBY(c0038c5, AbstractC0486u9.m1046H(arrayList3));
        } else {
            iM1287createUsingNumbersTypeVectorVUfvBY = 0;
        }
        ...
        if (list4 != null) {
            ...
            while (it4.hasNext()) {
                ...
                value.getClass();
                arrayList4.add(Integer.valueOf(((BaseMatcher) value).build$dexkit_android_release(c0038c5)));
            }
            iCreateUsingNumbersVector = org.luckypray.dexkit.schema.MethodMatcher.Companion.createUsingNumbersVector(c0038c5, AbstractC0241h2.m469l2(arrayList4));
        } else {
        ...
        int iBuild$dexkit_android_release9 = methodsMatcher2 != null ? methodsMatcher2.build$dexkit_android_release(c0038c5) : 0;
        String str = this.protoShortyMatcher;
        int iM104j = str != null ? c0038c5.m104j(str) : 0;
        List<MethodMatcher> list5 = this.allOfMatchers;
        if (list5 != null) {
            i = iBuild$dexkit_android_release;
            ArrayList arrayList5 = new ArrayList(AbstractC0276j2.m703i2(list5));
            for (Iterator it5 = list5.iterator(); it5.hasNext(); it5 = it5) {
                arrayList5.add(Integer.valueOf(((MethodMatcher) it5.next()).build$dexkit_android_release(c0038c5)));
            }
            iM105k3 = c0038c5.m105k(AbstractC0241h2.m469l2(arrayList5));
        } else {
            i = iBuild$dexkit_android_release;
            iM105k3 = 0;
        }
        ...
        if (list6 != null) {
            i2 = iM105k3;
            ArrayList arrayList6 = new ArrayList(AbstractC0276j2.m703i2(list6));
            for (Iterator it6 = list6.iterator(); it6.hasNext(); it6 = it6) {
                arrayList6.add(Integer.valueOf(((MethodMatcher) it6.next()).build$dexkit_android_release(c0038c5)));
            }
            iM105k4 = c0038c5.m105k(AbstractC0241h2.m469l2(arrayList6));
        } else {
            i2 = iM105k3;
            iM105k4 = 0;
        }
        ...
        if (list7 != null) {
            ArrayList arrayList7 = new ArrayList(AbstractC0276j2.m703i2(list7));
            for (Iterator it7 = list7.iterator(); it7.hasNext(); it7 = it7) {
                arrayList7.add(Integer.valueOf(((MethodMatcher) it7.next()).build$dexkit_android_release(c0038c5)));
            }
            i3 = iM104j;
            i4 = iM105k4;
            companion = companion2;
            i5 = i2;
            iM105k5 = c0038c5.m105k(AbstractC0241h2.m469l2(arrayList7));
        } else {
            i3 = iM104j;
            i4 = iM105k4;
            companion = companion2;
        ...
        int iCreateMethodMatcher = companion.createMethodMatcher(c0038c5, i, iBuild$dexkit_android_release2, iBuild$dexkit_android_release3, iBuild$dexkit_android_release4, iBuild$dexkit_android_release5, iBuild$dexkit_android_release6, iBuild$dexkit_android_release7, iM105k, iM105k2, iM1287createUsingNumbersTypeVectorVUfvBY, iCreateUsingNumbersVector, iBuild$dexkit_android_release8, iBuild$dexkit_android_release9, i3, i5, i4, iM105k5);
        c0038c5.m108n(iCreateMethodMatcher);
        return iCreateMethodMatcher;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher invokeMethods(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodsMatcher methodsMatcher = new MethodsMatcher();
        interfaceC0482u5.invoke(methodsMatcher);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher not(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
    ...
    public final MethodMatcher paramTypes(Collection<String> collection) {
        ...
        parametersMatcher.params(C0021b4.f57a);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher params(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        ParametersMatcher parametersMatcher = new ParametersMatcher();
        interfaceC0482u5.invoke(parametersMatcher);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ MethodMatcher usingFields(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        UsingFieldMatcherList usingFieldMatcherList = new UsingFieldMatcherList();
        interfaceC0482u5.invoke(usingFieldMatcherList);
    ...
    public final /* synthetic */ MethodMatcher addAllOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0482u5.invoke(methodMatcher);
    ...
    public final /* synthetic */ MethodMatcher addAnnotation(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
    ...
    public final /* synthetic */ MethodMatcher addAnyOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0482u5.invoke(methodMatcher);
    ...
    public final /* synthetic */ MethodMatcher addNoneOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0482u5.invoke(methodMatcher);
        addNoneOf(methodMatcher);
    ...
    public final MethodMatcher annotationCount(AbstractC0025b8 abstractC0025b8) {
    ...
    public final /* synthetic */ MethodMatcher addCaller(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0482u5.invoke(methodMatcher);
    ...
    public final /* synthetic */ MethodMatcher addInvoke(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0482u5.invoke(methodMatcher);
    ...
    public final /* synthetic */ MethodMatcher allOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcherList methodMatcherList = new MethodMatcherList();
        interfaceC0482u5.invoke(methodMatcherList);
        allOf(methodMatcherList);
        return this;
    }

    public final /* synthetic */ MethodMatcher anyOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcherList methodMatcherList = new MethodMatcherList();
        interfaceC0482u5.invoke(methodMatcherList);
    ...
    public final /* synthetic */ MethodMatcher noneOf(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        MethodMatcherList methodMatcherList = new MethodMatcherList();
        interfaceC0482u5.invoke(methodMatcherList);
    ...
    public final MethodMatcher paramCount(AbstractC0025b8 abstractC0025b8) {
        abstractC0025b8.getClass();
        if (this.paramsMatcher == null) {
            this.paramsMatcher = new ParametersMatcher();
        }
        ParametersMatcher parametersMatcher = this.paramsMatcher;
        parametersMatcher.getClass();
        parametersMatcher.count(abstractC0025b8);
        return this;
    }
    ...
    public final /* synthetic */ MethodMatcher declaredClass(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
    ...
    public final /* synthetic */ MethodMatcher returnType(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        ClassMatcher classMatcher = new ClassMatcher();
        interfaceC0482u5.invoke(classMatcher);
    ...
    public final /* synthetic */ MethodMatcher addParamType(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        ClassMatcher classMatcher = new ClassMatcher();
        interfaceC0482u5.invoke(classMatcher);
    ...
    public final /* synthetic */ MethodMatcher addUsingField(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        UsingFieldMatcher usingFieldMatcher = new UsingFieldMatcher();
    ...
    public final /* synthetic */ MethodMatcher usingNumbers(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
        NumberEncodeValueMatcherList numberEncodeValueMatcherList = new NumberEncodeValueMatcherList();
        interfaceC0482u5.invoke(numberEncodeValueMatcherList);
    ...
    public final /* synthetic */ MethodMatcher usingStrings(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
