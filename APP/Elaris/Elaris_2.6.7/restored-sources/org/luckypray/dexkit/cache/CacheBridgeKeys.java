...
public final class CacheBridgeKeys {
    ...
    public final String cacheKeyOf(String str, String str2, String str3, BaseFinder baseFinder) {
        ...
        if (baseFinder == null) {
            throw new IllegalArgumentException("Either key or query must be provided for auto-generated cache key.");
        }
    ...
    public final String encodeSegment(String str) {
        str.getClass();
        byte[] bytes = str.getBytes(AbstractC0208f1.f244a);
        bytes.getClass();
