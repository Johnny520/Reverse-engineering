...
public final class AccessFlagsMatcher extends AbstractC0367od {
    ...
    public final int m1234getFlagspVg5ArA() {
    ...
    public final boolean m1235mutateFlagsWZ4Q5Ns(int i) {
        int i__offset = __offset(4);
        if (i__offset == 0) {
            return false;
        }
    ...
    public static final class Companion {
        ...
        public final void m1236addFlagsQn1smSk(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m99e(0, i);
        }
        ...
        public final int m1237createAccessFlagsMatcherOsBMiQA(C0038c5 c0038c5, int i, byte b) {
            c0038c5.getClass();
            c0038c5.m112r(2);
            m1236addFlagsQn1smSk(c0038c5, i);
            addMatchType(c0038c5, b);
            return endAccessFlagsMatcher(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAccessFlagsMatcher(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final AccessFlagsMatcher getRootAsAccessFlagsMatcher(ByteBuffer byteBuffer, AccessFlagsMatcher accessFlagsMatcher) {
            ...
            return accessFlagsMatcher.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAccessFlagsMatcher(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(2);
        }
