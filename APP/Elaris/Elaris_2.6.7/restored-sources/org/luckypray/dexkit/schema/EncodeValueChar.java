...
public final class EncodeValueChar extends AbstractC0367od {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final EncodeValueChar __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueChar(C0038c5 c0038c5, short s) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addValue(c0038c5, s);
            return endEncodeValueChar(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueChar(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final EncodeValueChar getRootAsEncodeValueChar(ByteBuffer byteBuffer, EncodeValueChar encodeValueChar) {
            byteBuffer.getClass();
            encodeValueChar.getClass();
            return encodeValueChar.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueChar(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
