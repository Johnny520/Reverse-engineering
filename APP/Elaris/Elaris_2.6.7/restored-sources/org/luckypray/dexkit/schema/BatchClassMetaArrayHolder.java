...
public final class BatchClassMetaArrayHolder extends AbstractC0367od {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createBatchClassMetaArrayHolder(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addItems(c0038c5, i);
            return endBatchClassMetaArrayHolder(c0038c5);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endBatchClassMetaArrayHolder(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final BatchClassMetaArrayHolder getRootAsBatchClassMetaArrayHolder(ByteBuffer byteBuffer, BatchClassMetaArrayHolder batchClassMetaArrayHolder) {
            ...
            return batchClassMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startBatchClassMetaArrayHolder(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
