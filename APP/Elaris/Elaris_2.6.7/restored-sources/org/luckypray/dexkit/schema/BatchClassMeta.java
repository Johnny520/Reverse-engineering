...
public final class BatchClassMeta extends AbstractC0367od {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addClasses(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m102h(1, i);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createBatchClassMeta(C0038c5 c0038c5, int i, int i2) {
            c0038c5.getClass();
            c0038c5.m112r(2);
            addClasses(c0038c5, i2);
            addUnionKey(c0038c5, i);
            return endBatchClassMeta(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Move duplicate insns, count: 1 to block B:3:0x000e */
        public final int createClassesVector(C0038c5 c0038c5, int[] iArr) {
            c0038c5.getClass();
            iArr.getClass();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endBatchClassMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final BatchClassMeta getRootAsBatchClassMeta(ByteBuffer byteBuffer, BatchClassMeta batchClassMeta) {
            ...
            return batchClassMeta.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startBatchClassMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(2);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startClassesVector(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m113s(4, i, 4);
        }
