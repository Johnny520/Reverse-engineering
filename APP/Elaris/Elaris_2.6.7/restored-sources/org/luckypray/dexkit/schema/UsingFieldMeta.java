...
public final class UsingFieldMeta extends AbstractC0367od {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createUsingFieldMeta(C0038c5 c0038c5, int i, byte b) {
            c0038c5.getClass();
            c0038c5.m112r(2);
            addField(c0038c5, i);
            addUsingType(c0038c5, b);
            return endUsingFieldMeta(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endUsingFieldMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final UsingFieldMeta getRootAsUsingFieldMeta(ByteBuffer byteBuffer, UsingFieldMeta usingFieldMeta) {
            ...
            return usingFieldMeta.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startUsingFieldMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(2);
        }
