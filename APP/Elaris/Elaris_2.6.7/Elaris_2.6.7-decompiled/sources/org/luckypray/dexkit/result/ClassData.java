...
public final class ClassData extends BaseData {
    ...
    public static final Companion f1172Companion = new Companion(null);
    private final InterfaceC0200e9 annotations$delegate;
    private final String descriptor;
    private final InterfaceC0200e9 dexClass$delegate;
    private final List<Integer> fieldIds;
    private final InterfaceC0200e9 fields$delegate;
    private final List<Integer> interfaceIds;
    private final InterfaceC0200e9 interfaces$delegate;
    private final List<Integer> methodIds;
    private final InterfaceC0200e9 methods$delegate;
    private final int modifiers;
    private final String sourceFile;
    private final InterfaceC0200e9 superClass$delegate;
    ...
    private ClassData(DexKitBridge dexKitBridge, int i, int i2, String str, int i3, String str2, Integer num, List<Integer> list, List<Integer> list2, List<Integer> list3) {
        ...
        this.fieldIds = list3;
        this.dexClass$delegate = new C0335md(new ClassData$dexClass$2(this));
        this.superClass$delegate = new C0335md(new ClassData$superClass$2(this, dexKitBridge, i2));
        this.interfaces$delegate = new C0335md(new ClassData$interfaces$2(dexKitBridge, this, i2));
        this.methods$delegate = new C0335md(new ClassData$methods$2(dexKitBridge, this, i2));
        this.fields$delegate = new C0335md(new ClassData$fields$2(dexKitBridge, this, i2));
        this.annotations$delegate = new C0335md(new ClassData$annotations$2(dexKitBridge, this, i2, i));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ClassData) && AbstractC0260i5.m643p(this.descriptor, ((ClassData) obj).descriptor);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final FieldDataList findField(FindField findField) {
        findField.getClass();
        findField.searchInClass(AbstractC0260i5.m567S0(this));
    ...
    public final MethodDataList findMethod(FindMethod findMethod) {
        findMethod.getClass();
        findMethod.searchInClass(AbstractC0260i5.m567S0(this));
    ...
    public final List<Class<?>> getInterfaceInstances(ClassLoader classLoader) {
        ...
        ArrayList arrayList = new ArrayList(AbstractC0276j2.m703i2(interfaces));
    ...
    public String toString() {
        ...
        if (getInterfaceCount() > 0) {
            ...
            sb.append(AbstractC0241h2.m468k2(getInterfaces(), ", ", ClassData$toString$1$2.INSTANCE, 30));
        }
        return sb.toString();
    }
    ...
    public static final class Companion {
        ...
        public final ClassData from(DexKitBridge dexKitBridge, ClassMeta classMeta) {
            ...
            classMeta.getClass();
            int iM1258getIdpVg5ArA = classMeta.m1258getIdpVg5ArA();
            int iM1257getDexIdpVg5ArA = classMeta.m1257getDexIdpVg5ArA();
            String sourceFile = classMeta.getSourceFile();
            String str = sourceFile == null ? "" : sourceFile;
            int iM1256getAccessFlagspVg5ArA = classMeta.m1256getAccessFlagspVg5ArA();
            String dexDescriptor = classMeta.getDexDescriptor();
            String str2 = dexDescriptor == null ? "" : dexDescriptor;
            int iM1259getSuperClasspVg5ArA = classMeta.m1259getSuperClasspVg5ArA();
            Integer numValueOf = iM1259getSuperClasspVg5ArA == -1 ? null : Integer.valueOf(iM1259getSuperClasspVg5ArA);
            ...
            return new ClassData(dexKitBridge, iM1258getIdpVg5ArA, iM1257getDexIdpVg5ArA, str, iM1256getAccessFlagspVg5ArA, str2, numValueOf, arrayList, arrayList2, arrayList3, null);
        }
 ...
 A[MD:(org.luckypray.dexkit.DexKitBridge, int, int, java.lang.String, int, java.lang.String, java.lang.Integer, java.util.List<java.lang.Integer>, java.util.List<java.lang.Integer>, java.util.List<java.lang.Integer>):void (m)] (LINE:91) call: org.luckypray.dexkit.result.ClassData.<init>(org.luckypray.dexkit.DexKitBridge, int, int, java.lang.String, int, java.lang.String, java.lang.Integer, java.util.List, java.util.List, java.util.List):void type: THIS */
    public /* synthetic */ ClassData(DexKitBridge dexKitBridge, int i, int i2, String str, int i3, String str2, Integer num, List list, List list2, List list3, AbstractC0431r2 abstractC0431r2) {
