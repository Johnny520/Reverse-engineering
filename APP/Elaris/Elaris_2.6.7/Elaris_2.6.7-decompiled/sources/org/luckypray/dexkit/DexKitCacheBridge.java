...
import p000.ThreadFactoryC0339n1;
...
public final class DexKitCacheBridge {
    ...
    public static final class QueryFailureEvent {
        ...
        public boolean equals(Object obj) {
            ...
            return AbstractC0260i5.m643p(this.appTag, queryFailureEvent.appTag) && this.queryKind == queryFailureEvent.queryKind && AbstractC0260i5.m643p(this.requestKey, queryFailureEvent.requestKey) && this.source == queryFailureEvent.source && AbstractC0260i5.m643p(this.error, queryFailureEvent.error);
        }
    ...
    public static final class QuerySuccessEvent {
        ...
        public boolean equals(Object obj) {
            ...
            return AbstractC0260i5.m643p(this.appTag, querySuccessEvent.appTag) && this.queryKind == querySuccessEvent.queryKind && AbstractC0260i5.m643p(this.requestKey, querySuccessEvent.requestKey) && this.source == querySuccessEvent.source && this.matchCount == querySuccessEvent.matchCount;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03911 extends AbstractC0184d9 implements InterfaceC0279j5 {
        final /* synthetic */ String $appTag;
        final /* synthetic */ String $path;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03911(String str, String str2) {
            super(0);
            this.$appTag = str;
            this.$path = str2;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03922 extends AbstractC0184d9 implements InterfaceC0279j5 {
        final /* synthetic */ String $appTag;
        final /* synthetic */ byte[][] $dexArray;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03922(String str, byte[][] bArr) {
            super(0);
            this.$appTag = str;
            this.$dexArray = bArr;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03933 extends AbstractC0184d9 implements InterfaceC0279j5 {
        final /* synthetic */ String $appTag;
        final /* synthetic */ ClassLoader $classLoader;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03933(String str, ClassLoader classLoader) {
            super(0);
            this.$appTag = str;
    ...
    static {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = new ScheduledThreadPoolExecutor(1, new ThreadFactoryC0339n1(1));
    ...
    public static final RecyclableBridge create(String str, String str2) {
        ...
        str2.getClass();
        INSTANCE.getCache();
        return CacheBridgeRegistry.INSTANCE.obtainBridge(str, new C03911(str, str2));
    }
    ...
    public final Cache getCache() {
        ...
        C0479u2.m1037b("Wrapper must be init(cache) first");
        return null;
    }
    ...
    public static final void init(Cache cache) {
        ...
        while (!atomicReference.compareAndSet(null, cache)) {
            if (atomicReference.get() != null) {
                C0479u2.m1037b("DexKitCacheBridge.init(cache) can only be called once");
                return;
            }
        }
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private final void notifyListeners(InterfaceC0482u5 interfaceC0482u5) {
        for (CacheBridgeListener cacheBridgeListener : listeners) {
            try {
                cacheBridgeListener.getClass();
                interfaceC0482u5.invoke(cacheBridgeListener);
    ...
    public static final class RecyclableBridge implements Closeable {
        ...
        private final InterfaceC0200e9 runtime$delegate;
        ...
        private RecyclableBridge(String str, String str2, byte[][] bArr, ClassLoader classLoader) {
            ...
            this.dexArray = bArr;
            this.classLoader = classLoader;
            DexKitCacheBridge$RecyclableBridge$runtime$2 dexKitCacheBridge$RecyclableBridge$runtime$2 = new DexKitCacheBridge$RecyclableBridge$runtime$2(this);
            C0022b5 c0022b5 = C0022b5.f59c;
            C0554yd c0554yd = new C0554yd();
            c0554yd.f1113a = dexKitCacheBridge$RecyclableBridge$runtime$2;
            c0554yd.f1114b = c0022b5;
            this.runtime$delegate = c0554yd;
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final <R> R acquireBridge(InterfaceC0482u5 interfaceC0482u5) {
        ...
        /* JADX DEBUG: Class process forced to load method for inline: org.luckypray.dexkit.cache.CacheBridgeKeys.cacheKeyOf$default(org.luckypray.dexkit.cache.CacheBridgeKeys, java.lang.String, java.lang.String, java.lang.String, org.luckypray.dexkit.query.base.BaseFinder, int, java.lang.Object):java.lang.String */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: getDirectInternalList-yxL6bBk, reason: not valid java name */
        private final <D, R extends ISerializable> Object m1213getDirectInternalListyxL6bBk(QueryKind queryKind, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, InterfaceC0482u5 interfaceC0482u52) {
            CacheBridgeStore.LoadResult cachedList = CacheBridgeStore.INSTANCE.getCachedList(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "l", str, null, 8, null), z, new DexKitCacheBridge$RecyclableBridge$getDirectInternalList$1(this), interfaceC0482u5 != null ? new C0377x87bd6f8e(this, interfaceC0482u5, interfaceC0482u52) : null);
            ResultSource source = cachedList.getSource();
            Object objM1230getResultd1pmJ48 = cachedList.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        cacheBridgeListener.getClass();
                        cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind, str, source, ((List) objM1230getResultd1pmJ48).size()));
                    } catch (Throwable unused) {
                    }
                }
            } else {
                for (CacheBridgeListener cacheBridgeListener2 : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        ...
                        cacheBridgeListener2.onQueryFailure(new QueryFailureEvent(this.appTag, queryKind, str, source, thM819a));
                    } catch (Throwable unused2) {
                    }
                }
            }
            return objM1230getResultd1pmJ48;
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: getDirectInternalSingle-yxL6bBk, reason: not valid java name */
        private final <D, R extends ISerializable> Object m1214getDirectInternalSingleyxL6bBk(QueryKind queryKind, String str, CacheBridgeStore.SingleResolveMode singleResolveMode, InterfaceC0482u5 interfaceC0482u5, InterfaceC0482u5 interfaceC0482u52) {
            String strCacheKeyOf$default = CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "s", str, null, 8, null);
            C0378x95b222e4 c0378x95b222e4 = interfaceC0482u5 != null ? new C0378x95b222e4(this, interfaceC0482u5, interfaceC0482u52) : null;
            CacheBridgeStore cacheBridgeStore = CacheBridgeStore.INSTANCE;
            CacheBridgeStore.LoadResult cachedSingle = cacheBridgeStore.getCachedSingle(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), strCacheKeyOf$default, singleResolveMode, cacheBridgeStore.shouldCacheFailure(DexKitCacheBridge.getCachePolicy(), false), new DexKitCacheBridge$RecyclableBridge$getDirectInternalSingle$1(this), c0378x95b222e4);
            ResultSource source = cachedSingle.getSource();
            Object objM1230getResultd1pmJ48 = cachedSingle.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    DexKitCacheBridge dexKitCacheBridge = DexKitCacheBridge.INSTANCE;
                    try {
                        cacheBridgeListener.getClass();
                        cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind, str, source, ((ISerializable) objM1230getResultd1pmJ48) == null ? 0 : 1));
                    } catch (Throwable unused) {
                    }
                }
            } else {
        ...
        private final <Q extends BaseFinder, D, R extends ISerializable> Object m1215getInternalListhUnOzRk(QueryKind queryKind, String str, boolean z, InterfaceC0279j5 interfaceC0279j5, InterfaceC0546y5 interfaceC0546y5, InterfaceC0482u5 interfaceC0482u5) {
            BaseFinder baseFinder = interfaceC0279j5 != null ? (BaseFinder) interfaceC0279j5.invoke() : null;
            String str2 = str;
            CacheBridgeStore.LoadResult cachedList = CacheBridgeStore.INSTANCE.getCachedList(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.INSTANCE.cacheKeyOf(this.appTag, "l", str2, baseFinder), z, new DexKitCacheBridge$RecyclableBridge$getInternalList$1(this), baseFinder != null ? new DexKitCacheBridge$RecyclableBridge$getInternalList$loader$1$1(this, interfaceC0546y5, baseFinder, interfaceC0482u5) : null);
            ResultSource source = cachedList.getSource();
            Object objM1230getResultd1pmJ48 = cachedList.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        cacheBridgeListener.getClass();
                        cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind, str2, source, ((List) objM1230getResultd1pmJ48).size()));
                    } catch (Throwable unused) {
                    }
                    str2 = str;
                }
        ...
        private final <Q extends BaseFinder, D, R extends ISerializable> Object m1216getInternalMapyxL6bBk(QueryKind queryKind, String str, InterfaceC0279j5 interfaceC0279j5, InterfaceC0546y5 interfaceC0546y5, InterfaceC0482u5 interfaceC0482u5) {
            BaseFinder baseFinder = interfaceC0279j5 != null ? (BaseFinder) interfaceC0279j5.invoke() : null;
            String str2 = str;
            CacheBridgeStore.LoadResult cachedMap = CacheBridgeStore.INSTANCE.getCachedMap(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.INSTANCE.cacheKeyOf(this.appTag, "b", str2, baseFinder), new DexKitCacheBridge$RecyclableBridge$getInternalMap$1(this), baseFinder != null ? new DexKitCacheBridge$RecyclableBridge$getInternalMap$loader$1$1(this, interfaceC0546y5, baseFinder, interfaceC0482u5) : null);
            ResultSource source = cachedMap.getSource();
            Object objM1230getResultd1pmJ48 = cachedMap.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    DexKitCacheBridge dexKitCacheBridge = DexKitCacheBridge.INSTANCE;
                    try {
                        ...
                        Iterator it = ((Map) objM1230getResultd1pmJ48).values().iterator();
                        int size = 0;
                        while (it.hasNext()) {
        ...
        private final <Q extends BaseFinder, D, R extends ISerializable> Object m1217getInternalSinglehUnOzRk(QueryKind queryKind, String str, CacheBridgeStore.SingleResolveMode singleResolveMode, InterfaceC0279j5 interfaceC0279j5, InterfaceC0546y5 interfaceC0546y5, InterfaceC0482u5 interfaceC0482u5) {
            String str2 = str;
            BaseFinder baseFinder = interfaceC0279j5 != null ? (BaseFinder) interfaceC0279j5.invoke() : null;
            String strCacheKeyOf = CacheBridgeKeys.INSTANCE.cacheKeyOf(this.appTag, "s", str2, baseFinder);
            DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1 dexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1 = baseFinder != null ? new DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1(this, interfaceC0546y5, baseFinder, interfaceC0482u5) : null;
            ...
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        cacheBridgeListener.getClass();
                        cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind, str2, source, ((ISerializable) objM1230getResultd1pmJ48) == null ? 0 : 1));
                    } catch (Throwable unused) {
                    }
                    str2 = str;
                }
        ...
        private final Map<String, List<DexClass>> innerGetBatchUsingStringsClasses(String str, BatchFindClassUsingStrings batchFindClassUsingStrings) {
            ...
            C0379xab6759f c0379xab6759f = batchFindClassUsingStrings != null ? new C0379xab6759f(batchFindClassUsingStrings) : null;
            C0380xd5638d93 c0380xd5638d93 = C0380xd5638d93.INSTANCE;
            C0381xd5638d94 c0381xd5638d94 = C0381xd5638d94.INSTANCE;
            BaseFinder baseFinder = c0379xab6759f != null ? (BaseFinder) c0379xab6759f.invoke() : null;
            String str2 = str;
            CacheBridgeStore.LoadResult cachedMap = CacheBridgeStore.INSTANCE.getCachedMap(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.INSTANCE.cacheKeyOf(this.appTag, "b", str2, baseFinder), new DexKitCacheBridge$RecyclableBridge$getInternalMap$1(this), baseFinder != null ? new DexKitCacheBridge$RecyclableBridge$getInternalMap$loader$1$1(this, c0380xd5638d93, baseFinder, c0381xd5638d94) : null);
            ResultSource source = cachedMap.getSource();
            Object objM1230getResultd1pmJ48 = cachedMap.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
            ...
            AbstractC0486u9.m1044F(objM1230getResultd1pmJ48);
            return (Map) objM1230getResultd1pmJ48;
        }
        ...
        private final Map<String, List<DexMethod>> innerGetBatchUsingStringsMethods(String str, BatchFindMethodUsingStrings batchFindMethodUsingStrings) {
            ...
            C0382xe2bce32b c0382xe2bce32b = batchFindMethodUsingStrings != null ? new C0382xe2bce32b(batchFindMethodUsingStrings) : null;
            C0383xa2ffee1f c0383xa2ffee1f = C0383xa2ffee1f.INSTANCE;
            C0384xa2ffee20 c0384xa2ffee20 = C0384xa2ffee20.INSTANCE;
            BaseFinder baseFinder = c0382xe2bce32b != null ? (BaseFinder) c0382xe2bce32b.invoke() : null;
            String str2 = str;
            CacheBridgeStore.LoadResult cachedMap = CacheBridgeStore.INSTANCE.getCachedMap(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.INSTANCE.cacheKeyOf(this.appTag, "b", str2, baseFinder), new DexKitCacheBridge$RecyclableBridge$getInternalMap$1(this), baseFinder != null ? new DexKitCacheBridge$RecyclableBridge$getInternalMap$loader$1$1(this, c0383xa2ffee1f, baseFinder, c0384xa2ffee20) : null);
            ResultSource source = cachedMap.getSource();
            Object objM1230getResultd1pmJ48 = cachedMap.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
        ...
        private final DexClass innerGetClass(String str, boolean z, FindClass findClass) {
            ...
            AbstractC0486u9.m1044F(objM1230getResultd1pmJ48);
            return (DexClass) objM1230getResultd1pmJ48;
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final DexClass innerGetClassDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind = QueryKind.CLASS_SINGLE;
            CacheBridgeStore.SingleResolveMode singleResolveMode = z ? CacheBridgeStore.SingleResolveMode.NULLABLE : CacheBridgeStore.SingleResolveMode.REQUIRED;
            ...
            String strCacheKeyOf$default = CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "s", str, null, 8, null);
            C0378x95b222e4 c0378x95b222e4 = interfaceC0482u5 != null ? new C0378x95b222e4(this, interfaceC0482u5, dexKitCacheBridge$RecyclableBridge$innerGetClassDirect$1) : null;
            CacheBridgeStore cacheBridgeStore = CacheBridgeStore.INSTANCE;
            CacheBridgeStore.LoadResult cachedSingle = cacheBridgeStore.getCachedSingle(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), strCacheKeyOf$default, singleResolveMode, cacheBridgeStore.shouldCacheFailure(DexKitCacheBridge.getCachePolicy(), false), new DexKitCacheBridge$RecyclableBridge$getDirectInternalSingle$1(this), c0378x95b222e4);
            ResultSource source = cachedSingle.getSource();
            Object objM1230getResultd1pmJ48 = cachedSingle.m1230getResultd1pmJ48();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ DexClass innerGetClassDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetClassDirect(str, z, interfaceC0482u5);
        }
        ...
        private final List<DexClass> innerGetClasses(String str, boolean z, FindClass findClass) {
            ...
            AbstractC0486u9.m1044F(objM1230getResultd1pmJ48);
            return (List) objM1230getResultd1pmJ48;
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final List<DexClass> innerGetClassesDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind = QueryKind.CLASS_LIST;
            CacheBridgeStore.LoadResult cachedList = CacheBridgeStore.INSTANCE.getCachedList(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "l", str, null, 8, null), z, new DexKitCacheBridge$RecyclableBridge$getDirectInternalList$1(this), interfaceC0482u5 != null ? new C0377x87bd6f8e(this, interfaceC0482u5, DexKitCacheBridge$RecyclableBridge$innerGetClassesDirect$1.INSTANCE) : null);
            ResultSource source = cachedList.getSource();
            Object objM1230getResultd1pmJ48 = cachedList.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ List innerGetClassesDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetClassesDirect(str, z, interfaceC0482u5);
        }
        ...
        private final DexField innerGetField(String str, boolean z, FindField findField) {
            ...
            AbstractC0486u9.m1044F(objM1230getResultd1pmJ48);
            return (DexField) objM1230getResultd1pmJ48;
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final DexField innerGetFieldDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind = QueryKind.FIELD_SINGLE;
            CacheBridgeStore.SingleResolveMode singleResolveMode = z ? CacheBridgeStore.SingleResolveMode.NULLABLE : CacheBridgeStore.SingleResolveMode.REQUIRED;
            ...
            String strCacheKeyOf$default = CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "s", str, null, 8, null);
            C0378x95b222e4 c0378x95b222e4 = interfaceC0482u5 != null ? new C0378x95b222e4(this, interfaceC0482u5, dexKitCacheBridge$RecyclableBridge$innerGetFieldDirect$1) : null;
            CacheBridgeStore cacheBridgeStore = CacheBridgeStore.INSTANCE;
            CacheBridgeStore.LoadResult cachedSingle = cacheBridgeStore.getCachedSingle(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), strCacheKeyOf$default, singleResolveMode, cacheBridgeStore.shouldCacheFailure(DexKitCacheBridge.getCachePolicy(), false), new DexKitCacheBridge$RecyclableBridge$getDirectInternalSingle$1(this), c0378x95b222e4);
            ResultSource source = cachedSingle.getSource();
            Object objM1230getResultd1pmJ48 = cachedSingle.m1230getResultd1pmJ48();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ DexField innerGetFieldDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetFieldDirect(str, z, interfaceC0482u5);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final List<DexField> innerGetFieldsDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind = QueryKind.FIELD_LIST;
            CacheBridgeStore.LoadResult cachedList = CacheBridgeStore.INSTANCE.getCachedList(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "l", str, null, 8, null), z, new DexKitCacheBridge$RecyclableBridge$getDirectInternalList$1(this), interfaceC0482u5 != null ? new C0377x87bd6f8e(this, interfaceC0482u5, DexKitCacheBridge$RecyclableBridge$innerGetFieldsDirect$1.INSTANCE) : null);
            ResultSource source = cachedList.getSource();
            Object objM1230getResultd1pmJ48 = cachedList.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ List innerGetFieldsDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetFieldsDirect(str, z, interfaceC0482u5);
        }
        ...
        private final DexMethod innerGetMethod(String str, boolean z, FindMethod findMethod) {
            ...
            if (thM819a == null) {
                ...
                for (CacheBridgeListener cacheBridgeListener2 : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        cacheBridgeListener2.getClass();
                        cacheBridgeListener2.onQueryFailure(new QueryFailureEvent(this.appTag, queryKind2, str, source, thM819a));
                    } catch (Throwable unused3) {
                    }
                }
            }
            AbstractC0486u9.m1044F(objM1230getResultd1pmJ48);
            return (DexMethod) objM1230getResultd1pmJ48;
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final DexMethod innerGetMethodDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            ...
            String strCacheKeyOf$default = CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "s", str, null, 8, null);
            C0378x95b222e4 c0378x95b222e4 = interfaceC0482u5 != null ? new C0378x95b222e4(this, interfaceC0482u5, dexKitCacheBridge$RecyclableBridge$innerGetMethodDirect$1) : null;
            CacheBridgeStore cacheBridgeStore = CacheBridgeStore.INSTANCE;
            CacheBridgeStore.LoadResult cachedSingle = cacheBridgeStore.getCachedSingle(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), strCacheKeyOf$default, singleResolveMode, cacheBridgeStore.shouldCacheFailure(DexKitCacheBridge.getCachePolicy(), false), new DexKitCacheBridge$RecyclableBridge$getDirectInternalSingle$1(this), c0378x95b222e4);
            ResultSource source = cachedSingle.getSource();
            Object objM1230getResultd1pmJ48 = cachedSingle.m1230getResultd1pmJ48();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ DexMethod innerGetMethodDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetMethodDirect(str, z, interfaceC0482u5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final List<DexMethod> innerGetMethods(String str, boolean z, FindMethod findMethod) {
            C0385x24931bbd c0385x24931bbd = findMethod != null ? new C0385x24931bbd(findMethod) : null;
            ...
            BaseFinder baseFinder = c0385x24931bbd != null ? (BaseFinder) c0385x24931bbd.invoke() : null;
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final List<DexMethod> innerGetMethodsDirect(String str, boolean z, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind = QueryKind.METHOD_LIST;
            CacheBridgeStore.LoadResult cachedList = CacheBridgeStore.INSTANCE.getCachedList(DexKitCacheBridge.INSTANCE.getCache(), DexKitCacheBridge.cacheLock, DexKitCacheBridge.getCachePolicy(), CacheBridgeKeys.cacheKeyOf$default(CacheBridgeKeys.INSTANCE, this.appTag, "l", str, null, 8, null), z, new DexKitCacheBridge$RecyclableBridge$getDirectInternalList$1(this), interfaceC0482u5 != null ? new C0377x87bd6f8e(this, interfaceC0482u5, DexKitCacheBridge$RecyclableBridge$innerGetMethodsDirect$1.INSTANCE) : null);
            ResultSource source = cachedList.getSource();
            Object objM1230getResultd1pmJ48 = cachedList.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public static /* synthetic */ List innerGetMethodsDirect$default(RecyclableBridge recyclableBridge, String str, boolean z, InterfaceC0482u5 interfaceC0482u5, int i, Object obj) {
            if ((i & 4) != 0) {
                interfaceC0482u5 = null;
            }
            return recyclableBridge.innerGetMethodsDirect(str, z, interfaceC0482u5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX INFO: renamed from: notifyQueryResult-nnTlf9I, reason: not valid java name */
        private final <T> Object m1218notifyQueryResultnnTlf9I(QueryKind queryKind, String str, ResultSource resultSource, Object obj, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind2;
            String str2;
            ResultSource resultSource2;
            Throwable thM819a = C0425qc.m819a(obj);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    DexKitCacheBridge dexKitCacheBridge = DexKitCacheBridge.INSTANCE;
                    try {
                        ...
                        try {
                            ...
                            try {
                                cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind3, str3, resultSource3, ((Number) interfaceC0482u5.invoke(obj)).intValue()));
                            } catch (Throwable unused) {
                            }
                        } catch (Throwable unused2) {
                            queryKind2 = queryKind3;
                ...
                for (CacheBridgeListener cacheBridgeListener2 : DexKitCacheBridge.listeners) {
                    ...
                    try {
                        cacheBridgeListener2.getClass();
                        cacheBridgeListener2.onQueryFailure(new QueryFailureEvent(this.appTag, queryKind, str, resultSource, thM819a));
        ...
        private final <T> Object m1219observeLoadBWLJW6A(QueryKind queryKind, String str, CacheBridgeStore.LoadResult<T> loadResult, InterfaceC0482u5 interfaceC0482u5) {
            QueryKind queryKind2;
            String str2;
            ResultSource source = loadResult.getSource();
            Object objM1230getResultd1pmJ48 = loadResult.m1230getResultd1pmJ48();
            Throwable thM819a = C0425qc.m819a(objM1230getResultd1pmJ48);
            if (thM819a == null) {
                for (CacheBridgeListener cacheBridgeListener : DexKitCacheBridge.listeners) {
                    DexKitCacheBridge dexKitCacheBridge = DexKitCacheBridge.INSTANCE;
                    try {
                        ...
                        str2 = str;
                        try {
                            cacheBridgeListener.onQuerySuccess(new QuerySuccessEvent(this.appTag, queryKind2, str2, source, ((Number) interfaceC0482u5.invoke(objM1230getResultd1pmJ48)).intValue()));
                        } catch (Throwable unused) {
                        }
                    } catch (Throwable unused2) {
                        queryKind2 = queryKind;
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        private final InterfaceC0482u5 toBridgeQuery(BridgeMethodBuilder bridgeMethodBuilder) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ Map getBatchUsingStringsClasses(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            BatchFindClassUsingStrings batchFindClassUsingStrings = new BatchFindClassUsingStrings();
            interfaceC0482u5.invoke(batchFindClassUsingStrings);
            return innerGetBatchUsingStringsClasses(str, batchFindClassUsingStrings);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ Map getBatchUsingStringsMethods(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            BatchFindMethodUsingStrings batchFindMethodUsingStrings = new BatchFindMethodUsingStrings();
            interfaceC0482u5.invoke(batchFindMethodUsingStrings);
            return innerGetBatchUsingStringsMethods(str, batchFindMethodUsingStrings);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexClass getClass(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexClass getClassOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getClasses(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getClassesOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexField getField(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexField getFieldOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getFields(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getFieldsOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexMethod getMethod(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ DexMethod getMethodOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getMethods(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final /* synthetic */ List getMethodsOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
        ...
        private final InterfaceC0482u5 toBridgeQuery(BridgeClassBuilder bridgeClassBuilder) {
            return new DexKitCacheBridge$RecyclableBridge$toBridgeQuery$2(bridgeClassBuilder);
        }

        private final InterfaceC0482u5 toBridgeQuery(BridgeFieldBuilder bridgeFieldBuilder) {
            return new DexKitCacheBridge$RecyclableBridge$toBridgeQuery$3(bridgeFieldBuilder);
        }

        private final InterfaceC0482u5 toBridgeQuery(BridgeMethodsBuilder bridgeMethodsBuilder) {
            return new DexKitCacheBridge$RecyclableBridge$toBridgeQuery$4(bridgeMethodsBuilder);
        }

        private final InterfaceC0482u5 toBridgeQuery(BridgeClassesBuilder bridgeClassesBuilder) {
        ...
        private final InterfaceC0482u5 toBridgeQuery(BridgeFieldsBuilder bridgeFieldsBuilder) {
        ...
        public final /* synthetic */ DexClass getClassDirectOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetClassDirect(str, true, interfaceC0482u5);
        }

        public final /* synthetic */ List getClassesDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetClassesDirect(str, false, interfaceC0482u5);
        }

        public final /* synthetic */ List getClassesDirectOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetClassesDirect(str, true, interfaceC0482u5);
        }

        public final /* synthetic */ DexField getFieldDirectOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetFieldDirect(str, true, interfaceC0482u5);
        }

        public final /* synthetic */ List getFieldsDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetFieldsDirect(str, false, interfaceC0482u5);
        }

        public final /* synthetic */ List getFieldsDirectOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetFieldsDirect(str, true, interfaceC0482u5);
        }

        public final /* synthetic */ DexMethod getMethodDirectOrNull(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetMethodDirect(str, true, interfaceC0482u5);
        }

        public final /* synthetic */ List getMethodsDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetMethodsDirect(str, false, interfaceC0482u5);
        }

        public final /* synthetic */ List getMethodsDirectOrEmpty(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            return innerGetMethodsDirect(str, true, interfaceC0482u5);
        }
        ...
        public final /* synthetic */ DexClass getClassDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            DexClass dexClassInnerGetClassDirect = innerGetClassDirect(str, false, interfaceC0482u5);
            dexClassInnerGetClassDirect.getClass();
            return dexClassInnerGetClassDirect;
        }

        public final /* synthetic */ DexField getFieldDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            DexField dexFieldInnerGetFieldDirect = innerGetFieldDirect(str, false, interfaceC0482u5);
            dexFieldInnerGetFieldDirect.getClass();
            return dexFieldInnerGetFieldDirect;
        }

        public final /* synthetic */ DexMethod getMethodDirect(String str, InterfaceC0482u5 interfaceC0482u5) {
            str.getClass();
            interfaceC0482u5.getClass();
            DexMethod dexMethodInnerGetMethodDirect = innerGetMethodDirect(str, false, interfaceC0482u5);
            dexMethodInnerGetMethodDirect.getClass();
            return dexMethodInnerGetMethodDirect;
        }
        ...
        public final /* synthetic */ List getClassesOrEmpty(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
            return innerGetClasses(null, true, findClass);
        ...
        public final /* synthetic */ List getFieldsOrEmpty(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
            return innerGetFields(null, true, findField);
        ...
        public final /* synthetic */ List getMethodsOrEmpty(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
            return innerGetMethods(null, true, findMethod);
        ...
        public final /* synthetic */ Map getBatchUsingStringsClasses(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            BatchFindClassUsingStrings batchFindClassUsingStrings = new BatchFindClassUsingStrings();
            interfaceC0482u5.invoke(batchFindClassUsingStrings);
            return innerGetBatchUsingStringsClasses(null, batchFindClassUsingStrings);
        ...
        public final /* synthetic */ Map getBatchUsingStringsMethods(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            BatchFindMethodUsingStrings batchFindMethodUsingStrings = new BatchFindMethodUsingStrings();
            interfaceC0482u5.invoke(batchFindMethodUsingStrings);
            return innerGetBatchUsingStringsMethods(null, batchFindMethodUsingStrings);
        ...
        public final /* synthetic */ DexClass getClassOrNull(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
            return innerGetClass(null, true, findClass);
        ...
        public final /* synthetic */ List getClasses(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
            return innerGetClasses(null, false, findClass);
        ...
        public final /* synthetic */ DexField getFieldOrNull(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
            return innerGetField(null, true, findField);
        ...
        public final /* synthetic */ List getFields(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
            return innerGetFields(null, false, findField);
        ...
        public final /* synthetic */ DexMethod getMethodOrNull(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
            return innerGetMethod(null, true, findMethod);
        ...
        public final /* synthetic */ List getMethods(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
            return innerGetMethods(null, false, findMethod);
        ...
        public final /* synthetic */ DexClass getClass(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindClass findClass = new FindClass();
            interfaceC0482u5.invoke(findClass);
            DexClass dexClassInnerGetClass = innerGetClass(null, false, findClass);
        ...
        public final /* synthetic */ DexField getField(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindField findField = new FindField();
            interfaceC0482u5.invoke(findField);
            DexField dexFieldInnerGetField = innerGetField(null, false, findField);
        ...
        public final /* synthetic */ DexMethod getMethod(InterfaceC0482u5 interfaceC0482u5) {
            interfaceC0482u5.getClass();
            FindMethod findMethod = new FindMethod();
            interfaceC0482u5.invoke(findMethod);
            DexMethod dexMethodInnerGetMethod = innerGetMethod(null, false, findMethod);
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String), (r2v0 java.lang.String), (r3v0 byte[][]), (r4v0 java.lang.ClassLoader) A[MD:(java.lang.String, java.lang.String, byte[][], java.lang.ClassLoader):void (m)] (LINE:31) call: org.luckypray.dexkit.DexKitCacheBridge.RecyclableBridge.<init>(java.lang.String, java.lang.String, byte[][], java.lang.ClassLoader):void type: THIS */
        public /* synthetic */ RecyclableBridge(String str, String str2, byte[][] bArr, ClassLoader classLoader, AbstractC0431r2 abstractC0431r2) {
 ...
 A[MD:(java.lang.String, java.lang.String, byte[][], java.lang.ClassLoader):void (m)] (LINE:32) call: org.luckypray.dexkit.DexKitCacheBridge.RecyclableBridge.<init>(java.lang.String, java.lang.String, byte[][], java.lang.ClassLoader):void type: THIS */
        public /* synthetic */ RecyclableBridge(String str, String str2, byte[][] bArr, ClassLoader classLoader, int i, AbstractC0431r2 abstractC0431r2) {
        ...
        public final /* synthetic */ void withBridge(InterfaceC0482u5 interfaceC0482u5) {
            DexKitBridge dexKitBridge;
            boolean z;
            interfaceC0482u5.getClass();
            CacheBridgeRuntime runtime = getRuntime();
            ...
            try {
                ...
                interfaceC0482u5.invoke(dexKitBridge);
                runtime.endUse();
            } catch (Throwable th) {
                runtime.endUse();
                throw th;
 ...
 A[MD:(boolean, org.luckypray.dexkit.DexKitCacheBridge$CacheFailurePolicy):void (m)] (LINE:12) call: org.luckypray.dexkit.DexKitCacheBridge.CachePolicy.<init>(boolean, org.luckypray.dexkit.DexKitCacheBridge$CacheFailurePolicy):void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public /* synthetic */ CachePolicy(boolean z, CacheFailurePolicy cacheFailurePolicy, int i, AbstractC0431r2 abstractC0431r2) {
    ...
    public static final RecyclableBridge create(String str, byte[][] bArr) {
        ...
        bArr.getClass();
        INSTANCE.getCache();
        return CacheBridgeRegistry.INSTANCE.obtainBridge(str, new C03922(str, bArr));
    }
    ...
    public static final RecyclableBridge create(String str, ClassLoader classLoader) {
        ...
        classLoader.getClass();
        INSTANCE.getCache();
        return CacheBridgeRegistry.INSTANCE.obtainBridge(str, new C03933(str, classLoader));
    }
