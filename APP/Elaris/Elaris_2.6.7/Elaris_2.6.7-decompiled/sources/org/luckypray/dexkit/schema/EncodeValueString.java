...
public final class EncodeValueString extends AbstractC0367od {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final EncodeValueString __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueString(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addValue(c0038c5, i);
            return endEncodeValueString(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueString(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final EncodeValueString getRootAsEncodeValueString(ByteBuffer byteBuffer, EncodeValueString encodeValueString) {
            byteBuffer.getClass();
            encodeValueString.getClass();
            return encodeValueString.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueString(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
