...
public final class FindMethod extends BaseFinder {
    ...
    public int innerBuild(C0038c5 c0038c5) {
        ...
        if (collection3 != null) {
            ...
            iCreateInClassesVector = org.luckypray.dexkit.schema.FindMethod.Companion.createInClassesVector(c0038c5, AbstractC0241h2.m470m2(arrayList3));
        } else {
        ...
        if (collection4 != null) {
            ...
            iCreateInMethodsVector = org.luckypray.dexkit.schema.FindMethod.Companion.createInMethodsVector(c0038c5, AbstractC0241h2.m470m2(arrayList4));
        } else {
            iCreateInMethodsVector = 0;
        }
        boolean z2 = this.findFirst;
        MethodMatcher methodMatcher = this.matcher;
        int iCreateFindMethod = companion.createFindMethod(c0038c5, iM105k, iM105k2, z, iCreateInClassesVector, iCreateInMethodsVector, z2, methodMatcher != null ? methodMatcher.build$dexkit_android_release(c0038c5) : 0);
        c0038c5.m108n(iCreateFindMethod);
        return iCreateFindMethod;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FindMethod matcher(InterfaceC0482u5 interfaceC0482u5) {
