...
public final class EncodeValueFloat extends AbstractC0367od {
    ...
    public final float getValue() {
        ...
        if (i__offset != 0) {
            return this.f662bb.getFloat(i__offset + this.bb_pos);
        }
        return 0.0f;
    }
    ...
    public final boolean mutateValue(float f) {
        ...
        this.f662bb.putFloat(i__offset + this.bb_pos, f);
        return true;
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addValue(C0038c5 c0038c5, float f) {
            c0038c5.getClass();
            if (f != 0.0d) {
                c0038c5.m110p(4, 0);
                ByteBuffer byteBuffer = c0038c5.f86a;
                int i = c0038c5.f87b - 4;
                c0038c5.f87b = i;
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueFloat(C0038c5 c0038c5, float f) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addValue(c0038c5, f);
            return endEncodeValueFloat(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueFloat(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final EncodeValueFloat getRootAsEncodeValueFloat(ByteBuffer byteBuffer, EncodeValueFloat encodeValueFloat) {
            ...
            return encodeValueFloat.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueFloat(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
