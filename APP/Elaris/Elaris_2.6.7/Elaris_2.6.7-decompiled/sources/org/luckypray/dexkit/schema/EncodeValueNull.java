...
public final class EncodeValueNull extends AbstractC0367od {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueNull(C0038c5 c0038c5, byte b) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addValue(c0038c5, b);
            return endEncodeValueNull(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueNull(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final EncodeValueNull getRootAsEncodeValueNull(ByteBuffer byteBuffer, EncodeValueNull encodeValueNull) {
            ...
            return encodeValueNull.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueNull(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
