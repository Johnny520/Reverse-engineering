...
public final class TargetElementTypesMatcher extends BaseMatcher {
    ...
    public int innerBuild(C0038c5 c0038c5) {
        ...
        if (collection != null) {
            ...
            iCreateTypesVector = org.luckypray.dexkit.schema.TargetElementTypesMatcher.Companion.createTypesVector(c0038c5, bArr);
        }
        int iCreateTargetElementTypesMatcher = companion.createTargetElementTypesMatcher(c0038c5, iCreateTypesVector, this.matchType.getValue());
        c0038c5.m108n(iCreateTargetElementTypesMatcher);
    ...
    public final TargetElementTypesMatcher types(TargetElementType... targetElementTypeArr) {
        ...
        this.types = AbstractC0002a1.m7k2(targetElementTypeArr);
        return this;
    }
 ...
 A[MD:(java.util.Collection<? extends org.luckypray.dexkit.query.enums.TargetElementType>, org.luckypray.dexkit.query.enums.MatchType):void (m)] (LINE:20) call: org.luckypray.dexkit.query.matchers.base.TargetElementTypesMatcher.<init>(java.util.Collection, org.luckypray.dexkit.query.enums.MatchType):void type: THIS */
    public /* synthetic */ TargetElementTypesMatcher(Collection collection, MatchType matchType, int i, AbstractC0431r2 abstractC0431r2) {
