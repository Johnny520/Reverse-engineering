...
public final class DexKitBridge implements Closeable {
    ...
    private final Map<String, ClassDataList> batchFindClassUsingStrings(byte[] bArr) {
        ...
        for (int i = 0; i < itemsLength; i++) {
            ...
            for (int i2 = 0; i2 < classesLength; i2++) {
                ClassData.Companion companion2 = ClassData.f1172Companion;
            ...
            if (classDataList.size() > 1) {
                AbstractC0324m2.m758j2(classDataList, new Comparator<T>() { // from class: org.luckypray.dexkit.DexKitBridge$batchFindClassUsingStrings$$inlined$sortBy$1
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                    ...
                    public final int compare(T t, T t2) {
                        return AbstractC0260i5.m548M(((ClassData) t).getDescriptor(), ((ClassData) t2).getDescriptor());
                    }
                });
            }
    ...
    private final Map<String, MethodDataList> batchFindMethodUsingStrings(byte[] bArr) {
        ...
        for (int i = 0; i < itemsLength; i++) {
            ...
            if (methodDataList.size() > 1) {
                AbstractC0324m2.m758j2(methodDataList, new Comparator<T>() { // from class: org.luckypray.dexkit.DexKitBridge$batchFindMethodUsingStrings$$inlined$sortBy$1
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: T */
                    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: T */
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.util.Comparator
                    public final int compare(T t, T t2) {
                        return AbstractC0260i5.m548M(((MethodData) t).getDescriptor(), ((MethodData) t2).getDescriptor());
                    }
                });
            }
    ...
    private final ClassDataList findClass(byte[] bArr) {
        ...
        if (classDataList.size() > 1) {
            AbstractC0324m2.m758j2(classDataList, new Comparator<T>() { // from class: org.luckypray.dexkit.DexKitBridge$findClass$$inlined$sortBy$1
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: T */
                /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: T */
                /* JADX WARN: Multi-variable type inference failed */
    ...
    private final FieldDataList findField(byte[] bArr) {
        ...
        for (int i = 0; i < fieldsLength; i++) {
            FieldData.Companion companion2 = FieldData.f1173Companion;
        ...
        if (fieldDataList.size() > 1) {
            AbstractC0324m2.m758j2(fieldDataList, new Comparator<T>() { // from class: org.luckypray.dexkit.DexKitBridge$findField$$inlined$sortBy$1
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: T */
                /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: T */
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
                    return AbstractC0260i5.m548M(((FieldData) t).getDescriptor(), ((FieldData) t2).getDescriptor());
                }
            });
        }
    ...
    private final MethodDataList findMethod(byte[] bArr) {
        ...
        if (methodDataList.size() > 1) {
            AbstractC0324m2.m758j2(methodDataList, new Comparator<T>() { // from class: org.luckypray.dexkit.DexKitBridge$findMethod$$inlined$sortBy$1
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
                /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: T */
                /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: T */
                /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    private final <T> T withNativeWriteToken(InterfaceC0482u5 interfaceC0482u5) {
        ...
        try {
            long j = this.token;
            if (j != 0) {
                return (T) interfaceC0482u5.invoke(Long.valueOf(j));
            }
    ...
    public final void exportDexFile(String str) {
        str.getClass();
        withNativeReadToken$dexkit_android_release(new C03691(str));
    }
    ...
    public final /* synthetic */ List getClassAnnotations$dexkit_android_release(long j) {
        ...
        for (int i = 0; i < annotationsLength; i++) {
            AnnotationData.Companion companion2 = AnnotationData.f1168Companion;
    ...
    */
    public final ClassData getClassData(String str) {
        ...
        new DexClass(str);
        byte[] bArr = (byte[]) withNativeReadToken$dexkit_android_release(new C03701(str));
        if (bArr == null) {
            return null;
        }
    ...
    public final int getDexNum() {
        return ((Number) withNativeReadToken$dexkit_android_release(C03711.INSTANCE)).intValue();
    }
    ...
    public final FieldData getFieldData(String str) {
        str.getClass();
        new DexField(str);
        byte[] bArr = (byte[]) withNativeReadToken$dexkit_android_release(new C03721(str));
        if (bArr == null) {
            return null;
        }
    ...
    public final MethodData getMethodData(String str) {
        str.getClass();
        new DexMethod(str);
        byte[] bArr = (byte[]) withNativeReadToken$dexkit_android_release(new C03731(str));
        if (bArr == null) {
            return null;
        }
        MethodData.Companion companion = MethodData.f1174Companion;
    ...
    public final /* synthetic */ List getMethodOpCodes$dexkit_android_release(long j) {
        return AbstractC0002a1.m6j2((int[]) withNativeReadToken$dexkit_android_release(new DexKitBridge$getMethodOpCodes$1(j)));
    }
    ...
    public final /* synthetic */ List getMethodUsingFields$dexkit_android_release(long j) {
        ...
        for (int i = 0; i < itemsLength; i++) {
            UsingFieldData.Companion companion2 = UsingFieldData.f1175Companion;
    ...
    public final /* synthetic */ List getMethodUsingStrings$dexkit_android_release(long j) {
        return AbstractC0002a1.m7k2((Object[]) withNativeReadToken$dexkit_android_release(new DexKitBridge$getMethodUsingStrings$1(j)));
    }
    ...
    public final void initFullCache() {
        withNativeReadToken$dexkit_android_release(C03741.INSTANCE);
    }
    ...
    public final void setMaxConcurrentQueries(int i) {
        if (i < 0) {
            throw new IllegalArgumentException("maxConcurrentQueries must be >= 0");
        }
        withNativeWriteToken(new C03752(i));
    }
    ...
    public final void setThreadNum(int i) {
        ...
        withNativeWriteToken(new C03762(i));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ Object withNativeReadToken$dexkit_android_release(InterfaceC0482u5 interfaceC0482u5) {
        ...
        try {
            long j = this.token;
            if (j != 0) {
                return interfaceC0482u5.invoke(Long.valueOf(j));
            }
            throw new IllegalStateException("DexKitBridge is not valid");
        } finally {
            lock.unlock();
    ...
    public static final class Companion {
        ...
        public final DexKitBridge create(ClassLoader classLoader, boolean z) {
            ...
            AbstractC0431r2 abstractC0431r2 = null;
            try {
                if (Class.forName("dalvik.system.BaseDexClassLoader").isInstance(classLoader)) {
                    return new DexKitBridge(classLoader, z, abstractC0431r2);
                }
                C0479u2.m1037b("classLoader must be a BaseDexClassLoader (e.g. PathClassLoader/DexClassLoader)");
                return null;
            } catch (ClassNotFoundException unused) {
                C0479u2.m1037b("This method requires Android runtime");
                return null;
            }
        }
        ...
        public final DexKitBridge create(byte[][] bArr) {
            bArr.getClass();
            return new DexKitBridge(bArr, (AbstractC0431r2) null);
        }

        public final DexKitBridge create(String str) {
            str.getClass();
            return new DexKitBridge(str, (AbstractC0431r2) null);
        }
    }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03701 extends AbstractC0184d9 implements InterfaceC0482u5 {
        final /* synthetic */ String $descriptor;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03701(String str) {
            super(1);
            this.$descriptor = str;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03711 extends AbstractC0184d9 implements InterfaceC0482u5 {
        public static final C03711 INSTANCE = new C03711();
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03721 extends AbstractC0184d9 implements InterfaceC0482u5 {
        final /* synthetic */ String $descriptor;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03721(String str) {
            super(1);
            this.$descriptor = str;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03731 extends AbstractC0184d9 implements InterfaceC0482u5 {
        final /* synthetic */ String $descriptor;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03731(String str) {
            super(1);
            this.$descriptor = str;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03691 extends AbstractC0184d9 implements InterfaceC0482u5 {
        final /* synthetic */ String $outPath;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03691(String str) {
            super(1);
            this.$outPath = str;
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03741 extends AbstractC0184d9 implements InterfaceC0482u5 {
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03752 extends AbstractC0184d9 implements InterfaceC0482u5 {
    ...
    /* JADX INFO: compiled from: r8-map-id-cb25a2bafef54619fff8cdac9d36ff56d89ce0d5459e21e33664152f938f1f39 */
    public static final class C03762 extends AbstractC0184d9 implements InterfaceC0482u5 {
    ...
    public /* synthetic */ DexKitBridge(String str, AbstractC0431r2 abstractC0431r2) {
        this(str);
    }
    ...
    public /* synthetic */ DexKitBridge(byte[][] bArr, AbstractC0431r2 abstractC0431r2) {
        this(bArr);
    }
    ...
    public /* synthetic */ DexKitBridge(ClassLoader classLoader, boolean z, AbstractC0431r2 abstractC0431r2) {
        this(classLoader, z);
    }
    ...
    public final /* synthetic */ Map batchFindClassUsingStrings(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
    ...
    public final /* synthetic */ Map batchFindMethodUsingStrings(InterfaceC0482u5 interfaceC0482u5) {
        interfaceC0482u5.getClass();
