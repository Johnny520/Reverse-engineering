...
public final class ParametersAnnotationMetaArrayHoler extends AbstractC0367od {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addAnnotationsArray(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m102h(0, i);
        }
        ...
        public final int createAnnotationsArrayVector(C0038c5 c0038c5, int[] iArr) {
            c0038c5.getClass();
            iArr.getClass();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createParametersAnnotationMetaArrayHoler(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m112r(1);
            addAnnotationsArray(c0038c5, i);
            return endParametersAnnotationMetaArrayHoler(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endParametersAnnotationMetaArrayHoler(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final ParametersAnnotationMetaArrayHoler getRootAsParametersAnnotationMetaArrayHoler(ByteBuffer byteBuffer, ParametersAnnotationMetaArrayHoler parametersAnnotationMetaArrayHoler) {
            ...
            return parametersAnnotationMetaArrayHoler.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationsArrayVector(C0038c5 c0038c5, int i) {
            c0038c5.getClass();
            c0038c5.m113s(4, i, 4);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startParametersAnnotationMetaArrayHoler(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(1);
        }
