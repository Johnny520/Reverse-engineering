...
public final class DexKitCacheBridge$RecyclableBridge$getInternalMap$loader$1$1 extends AbstractC0184d9 implements InterfaceC0279j5 {
    ...
    public DexKitCacheBridge$RecyclableBridge$getInternalMap$loader$1$1(DexKitCacheBridge.RecyclableBridge recyclableBridge, InterfaceC0546y5 interfaceC0546y5, BaseFinder baseFinder, InterfaceC0482u5 interfaceC0482u5) {
        super(0);
    ...
    public final Map<String, List<R>> invoke() {
        ...
        try {
            ...
            Map map = (Map) interfaceC0546y5.invoke(dexKitBridge, baseFinder);
            LinkedHashMap linkedHashMap = new LinkedHashMap(AbstractC0486u9.m1068u(map.size()));
