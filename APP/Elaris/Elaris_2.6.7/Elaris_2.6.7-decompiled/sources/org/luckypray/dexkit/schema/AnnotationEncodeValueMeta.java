...
public final class AnnotationEncodeValueMeta extends AbstractC0367od {
    ...
    public final byte m1245getValueTypew2LRezQ() {
    ...
    public final boolean m1246mutateValueType7apg3OU(byte b) {
        int i__offset = __offset(6);
        if (i__offset == 0) {
            return false;
        }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addType(C0038c5 c0038c5, byte b) {
            c0038c5.getClass();
            c0038c5.m97c(0, b);
        }
        ...
        public final void m1247addValueTypeEK6454(C0038c5 c0038c5, byte b) {
            c0038c5.getClass();
            c0038c5.m97c(1, b);
        }
        ...
        public final int m1248createAnnotationEncodeValueMetaSpDDLgk(C0038c5 c0038c5, byte b, byte b2, int i) {
            c0038c5.getClass();
            c0038c5.m112r(3);
            addValue(c0038c5, i);
            m1247addValueTypeEK6454(c0038c5, b2);
            addType(c0038c5, b);
            return endAnnotationEncodeValueMeta(c0038c5);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAnnotationEncodeValueMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
        ...
        public final AnnotationEncodeValueMeta getRootAsAnnotationEncodeValueMeta(ByteBuffer byteBuffer, AnnotationEncodeValueMeta annotationEncodeValueMeta) {
            ...
            return annotationEncodeValueMeta.__assign(byteBuffer.position() + AbstractC0000a.m0a(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationEncodeValueMeta(C0038c5 c0038c5) {
            c0038c5.getClass();
            c0038c5.m112r(3);
        }
