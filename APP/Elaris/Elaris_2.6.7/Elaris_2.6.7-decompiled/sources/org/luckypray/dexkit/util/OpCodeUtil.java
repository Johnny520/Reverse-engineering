...
public final class OpCodeUtil {
    ...
    private static final InterfaceC0200e9 opFormatMap$delegate = AbstractC0260i5.m561Q0(OpCodeUtil$opFormatMap$2.INSTANCE);
    ...
    public static final int getOpCode(String str) {
        ...
        throw new IllegalArgumentException("opFormat: " + str + " is not found");
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static final String getOpFormat(int i) {
        if (i >= 0) {
    ...
    private final Map<String, Integer> getOpFormatMap() {
        return (Map) opFormatMap$delegate.getValue();
    }
}
