...
public final class ByteOrder {
    ...
    public static final C6856 Companion;
    public static final ByteOrder LITTLE_ENDIAN;

    /* JADX INFO: renamed from: native, reason: not valid java name */
    private static final ByteOrder f12717native;
    ...
    static {
        ...
        $ENTRIES = AbstractC4364.m8866(byteOrderArr$values);
        Companion = new C6856();
        java.nio.ByteOrder byteOrderNativeOrder = java.nio.ByteOrder.nativeOrder();
        byteOrderNativeOrder.getClass();
        f12717native = byteOrderNativeOrder != byteOrder ? byteOrder4 : byteOrder2;
    }
