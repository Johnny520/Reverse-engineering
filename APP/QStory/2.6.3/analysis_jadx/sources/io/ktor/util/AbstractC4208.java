...
public abstract class AbstractC4208 {
    ...
    public static final /* synthetic */ int f12697 = 0;

    static {
        int[] iArr = new int[256];
        for (int i = 0; i < 256; i++) {
            iArr[i] = AbstractC5144.m10171("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", (char) i, 0, 6);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final String m8591(byte[] bArr) {
        int i;
        int i2;
        int i3 = 3;
        ...
        if (length == 0) {
            return AbstractC5139.m10134(0, i5, cArr);
        }
        if (length == 1) {
