...
@InterfaceC6862(c = "io.ktor.server.http.content.StaticContentKt$staticFileSystem$2", f = "StaticContent.kt", l = {333}, m = "invokeSuspend")
...
final class StaticContentKt$staticFileSystem$2 extends SuspendLambda implements InterfaceC6554 {
    ...
    final /* synthetic */ InterfaceC4116 $fileSystem;
    ...
    public final InterfaceC4357<C5176> create(Object obj, InterfaceC4357<?> interfaceC4357) {
        StaticContentKt$staticFileSystem$2 staticContentKt$staticFileSystem$2 = new StaticContentKt$staticFileSystem$2(null, this.$index, this.$basePath, this.$compressedTypes, this.$contentType, this.$cacheControl, this.$modify, this.$exclude, this.$extensions, this.$defaultPath, interfaceC4357);
    ...
    public final Object invoke(InterfaceC4057 interfaceC4057, InterfaceC4357<? super C5176> interfaceC4357) {
        return ((StaticContentKt$staticFileSystem$2) create(interfaceC4057, interfaceC4357)).invokeSuspend(C5176.f14739);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (AbstractC4122.m8518(interfaceC4057, str, str2, list, interfaceC6558, interfaceC65582, interfaceC6551, interfaceC65583, list2, str3, this) == coroutineSingletons) {
