...
@InterfaceC6862(c = "io.ktor.server.application.hooks.CallSetup$install$1", f = "CommonHooks.kt", l = {26}, m = "invokeSuspend")
...
final class CallSetup$install$1 extends SuspendLambda implements InterfaceC6551 {
    final /* synthetic */ InterfaceC6554 $handler;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CallSetup$install$1(InterfaceC6554 interfaceC6554, InterfaceC4357<? super CallSetup$install$1> interfaceC4357) {
    ...
    public final Object invoke(AbstractC4194 abstractC4194, C5176 c5176, InterfaceC4357<? super C5176> interfaceC4357) {
        CallSetup$install$1 callSetup$install$1 = new CallSetup$install$1(this.$handler, interfaceC4357);
        callSetup$install$1.L$0 = abstractC4194;
        return callSetup$install$1.invokeSuspend(C5176.f14739);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (interfaceC6554.invoke(interfaceC4065, this) == coroutineSingletons) {
