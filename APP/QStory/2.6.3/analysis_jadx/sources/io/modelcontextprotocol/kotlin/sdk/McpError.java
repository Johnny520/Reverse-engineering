...
public final class McpError extends Exception {
    ...
    private final C7152 data;
    private final String message;

    public McpError(int i, String str, C7152 c7152) {
        str.getClass();
        c7152.getClass();
        this.code = i;
        this.data = c7152;
    ...
    public McpError(int i, String str, C7152 c7152, int i2, AbstractC4385 abstractC4385) {
        this(i, str, (i2 & 4) != 0 ? AbstractC6602.f17976 : c7152);
    }
}
