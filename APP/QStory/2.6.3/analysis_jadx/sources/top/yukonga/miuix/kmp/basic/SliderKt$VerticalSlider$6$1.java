...
@InterfaceC6862(c = "top.yukonga.miuix.kmp.basic.SliderKt$VerticalSlider$6$1", f = "Slider.kt", l = {}, m = "invokeSuspend", v = 2)
...
final class SliderKt$VerticalSlider$6$1 extends SuspendLambda implements InterfaceC6551 {
    final /* synthetic */ InterfaceC1397 $dragOffset$delegate;
    final /* synthetic */ InterfaceC6558 $fractionToValueVertical;
    ...
    public /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
        return m11378invoked4ec7I((InterfaceC5401) obj, ((C7329) obj2).f19541, (InterfaceC4357) obj3);
    }

    /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
    public final Object m11378invoked4ec7I(InterfaceC5401 interfaceC5401, long j, InterfaceC4357<? super C5176> interfaceC4357) {
        SliderKt$VerticalSlider$6$1 sliderKt$VerticalSlider$6$1 = new SliderKt$VerticalSlider$6$1(this.$reverseDirection, this.$fractionToValueVertical, null, this.$isDragging$delegate, this.$dragOffset$delegate, this.$layoutHeight$delegate, this.$layoutWidth$delegate, this.$onValueChangeState$delegate, interfaceC4357);
        sliderKt$VerticalSlider$6$1.J$0 = j;
        return sliderKt$VerticalSlider$6$1.invokeSuspend(C5176.f14739);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        float fM2432 = ((AbstractC1346) this.$layoutWidth$delegate).m2432() / 2.0f;
        float fM24322 = ((AbstractC1346) this.$layoutHeight$delegate).m2432() - (2.0f * fM2432);
        if (fM24322 < 0.0f) {
            fM24322 = 0.0f;
        }
        ...
        ((InterfaceC6558) this.$onValueChangeState$delegate.getValue()).invoke(new Float(((Number) this.$fractionToValueVertical.invoke(new Float(fM5071))).floatValue()));
        throw null;
    }
}
