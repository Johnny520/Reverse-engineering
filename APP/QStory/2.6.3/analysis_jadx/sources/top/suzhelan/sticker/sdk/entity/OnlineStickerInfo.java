...
public final /* data */ class OnlineStickerInfo {
    ...
    @InterfaceC8265("archiveFileFormat")
    private final String archiveFileFormat;

    @InterfaceC8265("archiveFileName")
    private final String archiveFileName;

    @InterfaceC8265("archiveFileSize")
    private final int archiveFileSize;

    @InterfaceC8265("archiveUrl")
    private final String archiveUrl;

    @InterfaceC8265("author")
    private final String author;

    @InterfaceC8265("coverFileFormat")
    private final String coverFileFormat;

    @InterfaceC8265("coverFileName")
    private final String coverFileName;

    @InterfaceC8265("coverFileSize")
    private final int coverFileSize;

    @InterfaceC8265("coverHeight")
    private final Integer coverHeight;

    @InterfaceC8265("coverUrl")
    private final String coverUrl;

    @InterfaceC8265("coverWidth")
    private final Integer coverWidth;

    @InterfaceC8265("createdAt")
    private final String createdAt;

    @InterfaceC8265("description")
    private final String description;

    @InterfaceC8265("downloadCount")
    ...
    @InterfaceC8265("stickerCount")
    private final int stickerCount;

    @InterfaceC8265("tags")
    private final List<String> tags;

    @InterfaceC8265("thumbnails")
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4395.m8907(this.id, onlineStickerInfo.id) && AbstractC4395.m8907(this.title, onlineStickerInfo.title) && AbstractC4395.m8907(this.description, onlineStickerInfo.description) && AbstractC4395.m8907(this.uin, onlineStickerInfo.uin) && AbstractC4395.m8907(this.nickname, onlineStickerInfo.nickname) && AbstractC4395.m8907(this.author, onlineStickerInfo.author) && AbstractC4395.m8907(this.archiveFileName, onlineStickerInfo.archiveFileName) && AbstractC4395.m8907(this.archiveFileFormat, onlineStickerInfo.archiveFileFormat) && this.archiveFileSize == onlineStickerInfo.archiveFileSize && this.stickerCount == onlineStickerInfo.stickerCount && AbstractC4395.m8907(this.coverFileName, onlineStickerInfo.coverFileName) && AbstractC4395.m8907(this.coverFileFormat, onlineStickerInfo.coverFileFormat) && this.coverFileSize == onlineStickerInfo.coverFileSize && AbstractC4395.m8907(this.coverWidth, onlineStickerInfo.coverWidth) && AbstractC4395.m8907(this.coverHeight, onlineStickerInfo.coverHeight) && AbstractC4395.m8907(this.archiveUrl, onlineStickerInfo.archiveUrl) && AbstractC4395.m8907(this.coverUrl, onlineStickerInfo.coverUrl) && AbstractC4395.m8907(this.thumbnails, onlineStickerInfo.thumbnails) && AbstractC4395.m8907(this.tags, onlineStickerInfo.tags) && this.downloadCount == onlineStickerInfo.downloadCount && AbstractC4395.m8907(this.createdAt, onlineStickerInfo.createdAt);
    }
    ...
    public int hashCode() {
        int iM11572 = AbstractC6183.m11572(this.id.hashCode() * 31, 31, this.title);
        ...
        int iM144 = AbstractC0053.m144(this.coverFileSize, AbstractC6183.m11572(AbstractC6183.m11572(AbstractC0053.m144(this.stickerCount, AbstractC0053.m144(this.archiveFileSize, AbstractC6183.m11572(AbstractC6183.m11572((iHashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31, 31, this.archiveFileName), 31, this.archiveFileFormat), 31), 31), 31, this.coverFileName), 31, this.coverFileFormat), 31);
        Integer num = this.coverWidth;
        int iHashCode4 = (iM144 + (num == null ? 0 : num.hashCode())) * 31;
        Integer num2 = this.coverHeight;
        return this.createdAt.hashCode() + AbstractC0053.m144(this.downloadCount, AbstractC0053.m160(this.tags, AbstractC0053.m160(this.thumbnails, AbstractC6183.m11572(AbstractC6183.m11572((iHashCode4 + (num2 != null ? num2.hashCode() : 0)) * 31, 31, this.archiveUrl), 31, this.coverUrl), 31), 31), 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbM11582 = AbstractC6183.m11582("OnlineStickerInfo(id=", str, ", title=", str2, ", description=");
        AbstractC6183.m11577(sbM11582, str3, ", uin=", str4, ", nickname=");
        AbstractC6183.m11577(sbM11582, str5, ", author=", str6, ", archiveFileName=");
        AbstractC6183.m11577(sbM11582, str7, ", archiveFileFormat=", str8, ", archiveFileSize=");
        sbM11582.append(i);
        sbM11582.append(", stickerCount=");
        sbM11582.append(i2);
        sbM11582.append(", coverFileName=");
        AbstractC6183.m11577(sbM11582, str9, ", coverFileFormat=", str10, ", coverFileSize=");
        sbM11582.append(i3);
        sbM11582.append(", coverWidth=");
        sbM11582.append(num);
        sbM11582.append(", coverHeight=");
        sbM11582.append(num2);
        sbM11582.append(", archiveUrl=");
        sbM11582.append(str11);
        sbM11582.append(", coverUrl=");
        sbM11582.append(str12);
        sbM11582.append(", thumbnails=");
        sbM11582.append(list);
        sbM11582.append(", tags=");
        sbM11582.append(list2);
        sbM11582.append(", downloadCount=");
        sbM11582.append(i4);
        sbM11582.append(", createdAt=");
        return AbstractC0053.m151(sbM11582, str13, ")");
    }
}
