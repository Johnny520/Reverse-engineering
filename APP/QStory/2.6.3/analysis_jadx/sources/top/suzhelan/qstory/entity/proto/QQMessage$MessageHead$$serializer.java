...
@InterfaceC5169
public final /* synthetic */ class QQMessage$MessageHead$$serializer implements InterfaceC7079 {
    ...
    static {
        ...
        C7129 c7129 = new C7129(AbstractC8405.m13972(1530), qQMessage$MessageHead$$serializer, 5);
        ...
        c7129.m12408(new QQMessage$MessageHead$SenderInfo$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(8));
        descriptor = c7129;
        $stable = 8;
    }
    ...
    public final InterfaceC7184[] childSerializers() {
        ...
        InterfaceC7184 interfaceC7184M8313 = AbstractC3933.m8313(c7135);
        InterfaceC7184 interfaceC7184M83132 = AbstractC3933.m8313(QQMessage$MessageHead$SenderInfo$$serializer.INSTANCE);
        C7072 c7072 = C7072.f18976;
        return new InterfaceC7184[]{c7072, c7135, c7072, interfaceC7184M8313, interfaceC7184M83132};
    }

    @Override // p089.InterfaceC7184
    public final QQMessage.MessageHead deserialize(InterfaceC7187 decoder) {
        ...
        while (z) {
            ...
            if (iMo10718 == -1) {
                ...
                str = (String) interfaceC7189Mo10676.mo10675(interfaceC7191, 3, C7135.f19089, str);
                i |= 8;
            } else {
                if (iMo10718 != 4) {
                ...
                senderInfo = (QQMessage.MessageHead.SenderInfo) interfaceC7189Mo10676.mo10675(interfaceC7191, 4, QQMessage$MessageHead$SenderInfo$$serializer.INSTANCE, senderInfo);
                i |= 16;
            }
        }
        interfaceC7189Mo10676.mo10678(interfaceC7191);
        return new QQMessage.MessageHead(i, jMo10699, strMo10686, jMo106992, str, senderInfo, (AbstractC7137) null);
    }
    ...
    @Override // p089.InterfaceC7184
    public final void serialize(InterfaceC7186 encoder, QQMessage.MessageHead value) {
        ...
        QQMessage.MessageHead.write$Self$app_publishRelease(value, interfaceC7188Mo10710, interfaceC7191);
