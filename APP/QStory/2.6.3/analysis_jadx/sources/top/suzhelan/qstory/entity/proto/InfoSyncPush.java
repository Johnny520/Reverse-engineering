...
public final /* data */ class InfoSyncPush {
    ...
    public /* synthetic */ InfoSyncPush(int i, int i2, int i3, SyncContent syncContent, SyncRecallOperateInfo syncRecallOperateInfo, AbstractC7137 abstractC7137) {
        if ((i & 1) == 0) {
            this.type = 0;
        } else {
            this.type = i2;
    ...
    public static final /* synthetic */ void write$Self$app_publishRelease(InfoSyncPush self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
        if (output.mo10713(serialDesc) || self.type != 0) {
            output.mo10729(0, self.type, serialDesc);
        }
        if (output.mo10713(serialDesc) || self.pushId != 0) {
            output.mo10729(1, self.pushId, serialDesc);
        }
        if (output.mo10713(serialDesc) || self.syncContent != null) {
            output.mo10715(serialDesc, 2, InfoSyncPush$SyncContent$$serializer.INSTANCE, self.syncContent);
        }
        if (!output.mo10713(serialDesc) && self.syncRecallContent == null) {
            return;
        }
        output.mo10715(serialDesc, 3, InfoSyncPush$SyncRecallOperateInfo$$serializer.INSTANCE, self.syncRecallContent);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.type == infoSyncPush.type && this.pushId == infoSyncPush.pushId && AbstractC4395.m8907(this.syncContent, infoSyncPush.syncContent) && AbstractC4395.m8907(this.syncRecallContent, infoSyncPush.syncRecallContent);
    }
    ...
    public int hashCode() {
        int iM144 = AbstractC0053.m144(this.pushId, Integer.hashCode(this.type) * 31, 31);
        SyncContent syncContent = this.syncContent;
        int iHashCode = (iM144 + (syncContent == null ? 0 : syncContent.hashCode())) * 31;
    ...
    public String toString() {
        ...
        sb.append(AbstractC8405.m13972(1395));
        AbstractC6183.m11578(sb, this.type, 1396);
        AbstractC6183.m11578(sb, this.pushId, 1397);
    ...
    public static final /* data */ class SyncContent {
        ...
        public static final Companion INSTANCE = new Companion(null);
        public static final int $stable = 8;
        private static final InterfaceC5184[] $childSerializers = {AbstractC5187.m10215(LazyThreadSafetyMode.PUBLICATION, new C7167(29))};

        public SyncContent(int i, List list, AbstractC7137 abstractC7137) {
            if ((i & 1) == 0) {
        ...
        public static final /* synthetic */ InterfaceC7184 _childSerializers$_anonymous_() {
            return new C7103(InfoSyncPush$SyncContent$GroupSyncContent$$serializer.INSTANCE, 0);
        }
        ...
        public static final void write$Self$app_publishRelease(SyncContent self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
            InterfaceC5184[] interfaceC5184Arr = $childSerializers;
            if (!output.mo10713(serialDesc) && AbstractC4395.m8907(self.groupSyncContent, EmptyList.INSTANCE)) {
                return;
            }
            output.mo10719(serialDesc, 0, (InterfaceC7184) interfaceC5184Arr[0].getValue(), self.groupSyncContent);
        }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SyncContent) && AbstractC4395.m8907(this.groupSyncContent, ((SyncContent) other).groupSyncContent);
        }
        ...
        public String toString() {
            return AbstractC8405.m13972(1379) + this.groupSyncContent + ')';
        }
        ...
        public static final /* data */ class GroupSyncContent {
            ...
            public static final Companion INSTANCE = new Companion(null);
            public static final int $stable = 8;
            private static final InterfaceC5184[] $childSerializers = {null, null, null, AbstractC5187.m10215(LazyThreadSafetyMode.PUBLICATION, new C8787(0))};

            public GroupSyncContent(int i, long j, int i2, int i3, List list, AbstractC7137 abstractC7137) {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public static final /* synthetic */ InterfaceC7184 _childSerializers$_anonymous_() {
                return new C7103(QQMessage$$serializer.INSTANCE, 0);
            }
            ...
            public static final void write$Self$app_publishRelease(GroupSyncContent self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
                InterfaceC5184[] interfaceC5184Arr = $childSerializers;
                if (output.mo10713(serialDesc) || self.groupPeerId != 0) {
                    output.mo10722(serialDesc, 0, self.groupPeerId);
                }
                if (output.mo10713(serialDesc) || self.startSeq != 0) {
                    output.mo10729(1, self.startSeq, serialDesc);
                }
                if (output.mo10713(serialDesc) || self.endSeq != 0) {
                    output.mo10729(2, self.endSeq, serialDesc);
                }
                if (!output.mo10713(serialDesc) && AbstractC4395.m8907(self.qqMessage, EmptyList.INSTANCE)) {
                    return;
                }
                output.mo10719(serialDesc, 3, (InterfaceC7184) interfaceC5184Arr[3].getValue(), self.qqMessage);
            }
            ...
            public boolean equals(Object other) {
                ...
                return this.groupPeerId == groupSyncContent.groupPeerId && this.startSeq == groupSyncContent.startSeq && this.endSeq == groupSyncContent.endSeq && AbstractC4395.m8907(this.qqMessage, groupSyncContent.qqMessage);
            }
            ...
            public int hashCode() {
                return this.qqMessage.hashCode() + AbstractC0053.m144(this.endSeq, AbstractC0053.m144(this.startSeq, Long.hashCode(this.groupPeerId) * 31, 31), 31);
            }

            public String toString() {
                StringBuilder sb = new StringBuilder();
                sb.append(AbstractC8405.m13972(1375));
                sb.append(this.groupPeerId);
                sb.append(AbstractC8405.m13972(1376));
                AbstractC6183.m11578(sb, this.startSeq, 1377);
                AbstractC6183.m11578(sb, this.endSeq, 1378);
            ...
            public GroupSyncContent() {
                this(0L, 0, 0, (List) null, 15, (AbstractC4385) null);
            }
            ...
            public GroupSyncContent(long j, int i, int i2, List list, int i3, AbstractC4385 abstractC4385) {
        ...
        public SyncContent(List list, int i, AbstractC4385 abstractC4385) {
    ...
    public static final /* data */ class SyncRecallOperateInfo {
        ...
        public static final Companion INSTANCE = new Companion(null);
        public static final int $stable = 8;
        private static final InterfaceC5184[] $childSerializers = {null, AbstractC5187.m10215(LazyThreadSafetyMode.PUBLICATION, new C8787(1)), null};

        public SyncRecallOperateInfo(int i, SyncInfoHead syncInfoHead, List list, SyncInfoHead syncInfoHead2, AbstractC7137 abstractC7137) {
            if ((i & 1) == 0) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final /* synthetic */ InterfaceC7184 _childSerializers$_anonymous_() {
            return new C7103(InfoSyncPush$SyncRecallOperateInfo$SyncInfoBody$$serializer.INSTANCE, 0);
        }
        ...
        public static final void write$Self$app_publishRelease(SyncRecallOperateInfo self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
            InterfaceC5184[] interfaceC5184Arr = $childSerializers;
            if (output.mo10713(serialDesc) || self.syncInfoHead != null) {
                output.mo10715(serialDesc, 0, InfoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer.INSTANCE, self.syncInfoHead);
            }
            if (output.mo10713(serialDesc) || !AbstractC4395.m8907(self.syncInfoBodyList, EmptyList.INSTANCE)) {
                output.mo10719(serialDesc, 1, (InterfaceC7184) interfaceC5184Arr[1].getValue(), self.syncInfoBodyList);
            }
            if (!output.mo10713(serialDesc) && self.subHead == null) {
                return;
            }
            output.mo10715(serialDesc, 2, InfoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer.INSTANCE, self.subHead);
        }
        ...
        public boolean equals(Object other) {
            ...
            return AbstractC4395.m8907(this.syncInfoHead, syncRecallOperateInfo.syncInfoHead) && AbstractC4395.m8907(this.syncInfoBodyList, syncRecallOperateInfo.syncInfoBodyList) && AbstractC4395.m8907(this.subHead, syncRecallOperateInfo.subHead);
        }
        ...
        public int hashCode() {
            ...
            int iM160 = AbstractC0053.m160(this.syncInfoBodyList, (syncInfoHead == null ? 0 : syncInfoHead.hashCode()) * 31, 31);
            SyncInfoHead syncInfoHead2 = this.subHead;
            return iM160 + (syncInfoHead2 != null ? syncInfoHead2.hashCode() : 0);
        }

        public String toString() {
            return AbstractC8405.m13972(1392) + this.syncInfoHead + AbstractC8405.m13972(1516) + this.syncInfoBodyList + AbstractC8405.m13972(1394) + this.subHead + ')';
        }
        ...
        public static final /* data */ class SyncInfoBody {
            ...
            public static final Companion INSTANCE = new Companion(null);
            public static final int $stable = 8;
            private static final InterfaceC5184[] $childSerializers = {null, null, null, AbstractC5187.m10215(LazyThreadSafetyMode.PUBLICATION, new C8787(2))};

            public SyncInfoBody(int i, long j, String str, long j2, List list, AbstractC7137 abstractC7137) {
                if ((i & 1) == 0) {
            ...
            public static final void write$Self$app_publishRelease(SyncInfoBody self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
                InterfaceC5184[] interfaceC5184Arr = $childSerializers;
                ...
                if (output.mo10713(serialDesc) || self.eventTime != 0) {
                    output.mo10722(serialDesc, 2, self.eventTime);
                }
                if (!output.mo10713(serialDesc) && AbstractC4395.m8907(self.msgList, EmptyList.INSTANCE)) {
                    return;
                }
                output.mo10719(serialDesc, 3, (InterfaceC7184) interfaceC5184Arr[3].getValue(), self.msgList);
            }
            ...
            public boolean equals(Object other) {
                ...
                return this.senderPeerId == syncInfoBody.senderPeerId && AbstractC4395.m8907(this.senderUid, syncInfoBody.senderUid) && this.eventTime == syncInfoBody.eventTime && AbstractC4395.m8907(this.msgList, syncInfoBody.msgList);
            }
            ...
            public int hashCode() {
                return this.msgList.hashCode() + AbstractC0053.m142(AbstractC6183.m11572(Long.hashCode(this.senderPeerId) * 31, 31, this.senderUid), 31, this.eventTime);
            }

            public String toString() {
                StringBuilder sb = new StringBuilder();
                sb.append(AbstractC8405.m13972(1386));
                sb.append(this.senderPeerId);
                sb.append(AbstractC8405.m13972(1433));
                AbstractC6183.m11579(sb, this.senderUid, 1387);
                sb.append(this.eventTime);
                sb.append(AbstractC8405.m13972(1388));
            ...
            public SyncInfoBody() {
                this(0L, (String) null, 0L, (List) null, 15, (AbstractC4385) null);
            }
            ...
            public SyncInfoBody(long j, String str, long j2, List list, int i, AbstractC4385 abstractC4385) {
        ...
        public static final /* data */ class SyncInfoHead {
            ...
            public /* synthetic */ SyncInfoHead(int i, long j, AbstractC7137 abstractC7137) {
                if ((i & 1) == 0) {
                    this.syncTime = 0L;
                } else {
                    this.syncTime = j;
            ...
            public static final /* synthetic */ void write$Self$app_publishRelease(SyncInfoHead self, InterfaceC7188 output, InterfaceC7191 serialDesc) {
                if (!output.mo10713(serialDesc) && self.syncTime == 0) {
                    return;
                }
                output.mo10722(serialDesc, 0, self.syncTime);
            }
            ...
            public String toString() {
                return AbstractC8405.m13972(1391) + this.syncTime + ')';
            }
            ...
            public /* synthetic */ SyncInfoHead(long j, int i, AbstractC4385 abstractC4385) {
                this((i & 1) != 0 ? 0L : j);
            }
        ...
        public SyncRecallOperateInfo() {
            this((SyncInfoHead) null, (List) null, (SyncInfoHead) null, 7, (AbstractC4385) null);
        }
        ...
        public SyncRecallOperateInfo(SyncInfoHead syncInfoHead, List list, SyncInfoHead syncInfoHead2, int i, AbstractC4385 abstractC4385) {
    ...
    public InfoSyncPush() {
        this(0, 0, (SyncContent) null, (SyncRecallOperateInfo) null, 15, (AbstractC4385) null);
    }
    ...
    public /* synthetic */ InfoSyncPush(int i, int i2, SyncContent syncContent, SyncRecallOperateInfo syncRecallOperateInfo, int i3, AbstractC4385 abstractC4385) {
