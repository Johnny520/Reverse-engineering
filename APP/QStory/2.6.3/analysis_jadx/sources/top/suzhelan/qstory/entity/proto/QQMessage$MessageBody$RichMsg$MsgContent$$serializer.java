...
@InterfaceC5169
public final /* synthetic */ class QQMessage$MessageBody$RichMsg$MsgContent$$serializer implements InterfaceC7079 {
    ...
    static {
        ...
        C7129 c7129 = new C7129(AbstractC8405.m13972(1526), qQMessage$MessageBody$RichMsg$MsgContent$$serializer, 2);
        ...
        c7129.m12408(new QQMessage$MessageHead$SenderInfo$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(16));
        descriptor = c7129;
        $stable = 8;
    }
    ...
    public final InterfaceC7184[] childSerializers() {
        return new InterfaceC7184[]{QQMessage$MessageBody$RichMsg$MsgContent$TextMsg$$serializer.INSTANCE, QQMessage$MessageBody$RichMsg$MsgContent$MsgSender$$serializer.INSTANCE};
    }

    @Override // p089.InterfaceC7184
    public final QQMessage.MessageBody.RichMsg.MsgContent deserialize(InterfaceC7187 decoder) {
        ...
        while (z) {
            ...
            if (iMo10718 == -1) {
                ...
                textMsg = (QQMessage.MessageBody.RichMsg.MsgContent.TextMsg) interfaceC7189Mo10676.mo10674(interfaceC7191, 0, QQMessage$MessageBody$RichMsg$MsgContent$TextMsg$$serializer.INSTANCE, textMsg);
                i |= 1;
            } else {
                if (iMo10718 != 1) {
                ...
                msgSender = (QQMessage.MessageBody.RichMsg.MsgContent.MsgSender) interfaceC7189Mo10676.mo10674(interfaceC7191, 1, QQMessage$MessageBody$RichMsg$MsgContent$MsgSender$$serializer.INSTANCE, msgSender);
                i |= 2;
            }
        }
        interfaceC7189Mo10676.mo10678(interfaceC7191);
        return new QQMessage.MessageBody.RichMsg.MsgContent(i, textMsg, msgSender, (AbstractC7137) null);
    }
    ...
    @Override // p089.InterfaceC7184
    public final void serialize(InterfaceC7186 encoder, QQMessage.MessageBody.RichMsg.MsgContent value) {
        ...
        QQMessage.MessageBody.RichMsg.MsgContent.write$Self$app_publishRelease(value, interfaceC7188Mo10710, interfaceC7191);
