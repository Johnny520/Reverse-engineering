...
@InterfaceC5169
public final /* synthetic */ class InfoSyncPush$SyncRecallOperateInfo$$serializer implements InterfaceC7079 {
    ...
    static {
        ...
        C7129 c7129 = new C7129(AbstractC8405.m13972(1512), infoSyncPush$SyncRecallOperateInfo$$serializer, 3);
        ...
        c7129.m12409(AbstractC8405.m13972(1513), true);
    ...
    public final InterfaceC7184[] childSerializers() {
        InterfaceC5184[] interfaceC5184Arr = InfoSyncPush.SyncRecallOperateInfo.$childSerializers;
        ...
        return new InterfaceC7184[]{AbstractC3933.m8313(infoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer), interfaceC5184Arr[1].getValue(), AbstractC3933.m8313(infoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer)};
    }

    @Override // p089.InterfaceC7184
    public final InfoSyncPush.SyncRecallOperateInfo deserialize(InterfaceC7187 decoder) {
        ...
        while (z) {
            ...
            if (iMo10718 == -1) {
                ...
                syncInfoHead = (InfoSyncPush.SyncRecallOperateInfo.SyncInfoHead) interfaceC7189Mo10676.mo10675(interfaceC7191, 0, InfoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer.INSTANCE, syncInfoHead);
                i |= 1;
            } else if (iMo10718 == 1) {
                list = (List) interfaceC7189Mo10676.mo10674(interfaceC7191, 1, (InterfaceC7184) interfaceC5184Arr[1].getValue(), list);
                i |= 2;
            } else {
                if (iMo10718 != 2) {
                ...
                syncInfoHead2 = (InfoSyncPush.SyncRecallOperateInfo.SyncInfoHead) interfaceC7189Mo10676.mo10675(interfaceC7191, 2, InfoSyncPush$SyncRecallOperateInfo$SyncInfoHead$$serializer.INSTANCE, syncInfoHead2);
                i |= 4;
            }
        }
        interfaceC7189Mo10676.mo10678(interfaceC7191);
        return new InfoSyncPush.SyncRecallOperateInfo(i, syncInfoHead, list, syncInfoHead2, (AbstractC7137) null);
    }
    ...
    @Override // p089.InterfaceC7184
    public final void serialize(InterfaceC7186 encoder, InfoSyncPush.SyncRecallOperateInfo value) {
        ...
        InfoSyncPush.SyncRecallOperateInfo.write$Self$app_publishRelease(value, interfaceC7188Mo10710, interfaceC7191);
