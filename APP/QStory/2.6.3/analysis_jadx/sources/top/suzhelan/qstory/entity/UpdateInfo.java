...
public final /* data */ class UpdateInfo {
    ...
    public UpdateInfo(String str, boolean z, int i, LocalDateTime localDateTime, String str2, int i2, String str3) {
        AbstractC8405.m13972(587);
        str.getClass();
        AbstractC8405.m13973("喵喵喵喵喵呜呜呜~喵喵喵呜呜呜喵喵~喵喵喵呜喵呜呜呜~喵喵喵喵呜呜喵呜");
        localDateTime.getClass();
        AbstractC8405.m13972(1502);
        str2.getClass();
        AbstractC8405.m13972(1503);
        str3.getClass();
        this.fileName = str;
        this.forceUpdate = z;
        this.id = i;
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4395.m8907(this.fileName, updateInfo.fileName) && this.forceUpdate == updateInfo.forceUpdate && this.id == updateInfo.id && AbstractC4395.m8907(this.time, updateInfo.time) && AbstractC4395.m8907(this.updateLog, updateInfo.updateLog) && this.versionCode == updateInfo.versionCode && AbstractC4395.m8907(this.versionName, updateInfo.versionName);
    }
    ...
    public int hashCode() {
        return this.versionName.hashCode() + AbstractC0053.m144(this.versionCode, AbstractC6183.m11572((this.time.hashCode() + AbstractC0053.m144(this.id, AbstractC0053.m141(this.fileName.hashCode() * 31, 31, this.forceUpdate), 31)) * 31, 31, this.updateLog), 31);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(AbstractC8405.m13972(1504));
        AbstractC6183.m11579(sb, this.fileName, 1505);
        sb.append(this.forceUpdate);
        sb.append(AbstractC8405.m13973("喵呜喵呜呜呜呜呜~喵呜喵呜喵呜喵呜~喵喵喵呜喵喵呜呜~喵喵喵喵呜呜喵喵~喵呜喵呜呜喵喵喵"));
        sb.append(this.id);
        sb.append(AbstractC8405.m13973("喵呜喵呜呜呜呜呜~喵呜喵呜喵呜喵呜~喵喵喵喵呜呜呜喵~喵喵喵喵喵喵喵呜~喵喵喵喵呜喵喵喵~喵喵喵喵呜喵喵呜~喵呜喵呜呜呜喵喵"));
        sb.append(this.time);
        sb.append(AbstractC8405.m13972(1506));
        AbstractC6183.m11579(sb, this.updateLog, 1507);
        AbstractC6183.m11578(sb, this.versionCode, 1508);
        return AbstractC0053.m148(sb, this.versionName, ')');
    }
}
