...
public final class InterpolatorC7624 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = this.f20660;
        int iMin = Math.min((int) ((fArr.length - 1) * f), fArr.length - 2);
        float f2 = this.f20659;
        float f3 = (f - (iMin * f2)) / f2;
        float f4 = fArr[iMin];
        return AbstractC0053.m146(fArr[iMin + 1], f4, f3, f4);
    }

    public InterpolatorC7624(float[] fArr) {
        this.f20660 = fArr;
        this.f20659 = 1.0f / (fArr.length - 1);
    }
}
