...
public final class C6362 implements InvocationHandler {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final Context f17517;

    public C6362(Context context) {
        this.f17517 = context;
    }
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) {
        ...
        Context context = this.f17517;
        if (zHasUpdate || Update.mandatoryUpdate()) {
            Update.showUpdateDialog((Activity) context, new ViewOnClickListenerC6363(this));
            return null;
        }
