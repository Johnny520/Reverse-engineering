...
public final class C8536 extends AbstractC8418 {

    /* JADX INFO: renamed from: 飘花落叶言子苏楪兰哲世, reason: contains not printable characters */
    public final Function f23775;

    public C8536(int i, long j, Class cls, String str, String str2, String str3, Field field, Method method, Type type, Function function) {
        super(str, i, j, str2, str3, type, cls, field, method);
        this.f23775 = function;
    }
    ...
    public final boolean mo13999(AbstractC2897 abstractC2897, Object obj) {
        OffsetDateTime offsetDateTime = (OffsetDateTime) this.f23775.apply(obj);
        ...
        m14078(abstractC2897);
        if (this.f23324 == null) {
            this.f23324 = mo13994(abstractC2897, OffsetDateTime.class);
        }
        if (this.f23324 != C8461.f23424) {
            this.f23324.mo5679(abstractC2897, offsetDateTime, this.f23618, this.f23323, this.f23611);
            return true;
        }
