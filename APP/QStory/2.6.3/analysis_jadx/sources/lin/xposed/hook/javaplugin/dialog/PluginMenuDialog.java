...
public class PluginMenuDialog extends AbstractC3781 {
    ...
    public static void showDialog(Context context) {
        ...
        C3764 c3764 = new C3764(context, 1);
        C3784 c3784 = new C3784();
        c3784.f11814 = true;
        PluginMenuDialog pluginMenuDialog = new PluginMenuDialog(c3764);
        pluginMenuDialog.popupInfo = c3784;
    ...
    public int getMaxHeight() {
        return (int) (AbstractC3788.m8102(getContext()) * 0.5f);
    }
