...
public final /* synthetic */ class C5558 implements InvocationHandler {
    ...
    public /* synthetic */ C5558(CompletableFuture completableFuture, Object obj, int i) {
        this.f15325 = i;
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) {
        ...
        switch (i) {
            ...
            case 2:
                if (!AbstractC4395.m8907(method.getReturnType(), cls) || method.getParameterTypes().length != 2) {
                    return method.invoke(obj2, null);
                }
                if (AbstractC4395.m8907(method.getParameterTypes()[0], List.class)) {
                    objArr.getClass();
                ...
                return null;
            default:
                if (AbstractC4395.m8907(method.getReturnType(), cls) && method.getParameterTypes().length == 1) {
                    objArr.getClass();
