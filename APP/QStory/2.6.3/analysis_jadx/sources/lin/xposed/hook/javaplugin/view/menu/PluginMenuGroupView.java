...
public class PluginMenuGroupView extends LinearLayout {
    ...
    public PluginMenuGroupView(Context context, PluginLoader pluginLoader) {
        ...
        textView.setOnClickListener(new ViewOnClickListenerC5544(this, pluginName, pluginLoader, 3));
        initView();
    }
    ...
    private void initView() {
        ...
        while (true) {
            ...
            button.setOnClickListener(new View.OnClickListener(this) { // from class: 飘花落叶言世哲兰子苏楪.飘花落叶言子楪世苏哲兰
                ...
                public final /* synthetic */ PluginMenuGroupView f17417;
                ...
                public final void onClick(View view) {
                    int i2 = i;
                    String str = key;
                    PluginMenuGroupView pluginMenuGroupView = this.f17417;
                    switch (i2) {
                        case 0:
    ...
    public /* synthetic */ void lambda$new$0(PluginLoader pluginLoader, String str) {
        try {
            try {
                ...
                AbstractC6185.m11592(AbstractC8405.m13972(766) + Log.getStackTraceString(e));
    ...
    public /* synthetic */ void lambda$new$1(String str, PluginLoader pluginLoader, View view) {
        ...
        sbM140.append(AbstractC8405.m13972(764));
        ...
        sbM1402.append(AbstractC8405.m13972(765));
        textView2.setText(sbM1402.toString());
