                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public Substitutable make(ResettableClassFileTransformer resettableClassFileTransformer) {
                        try {
                            ...
                            C5554.m10885("Cannot access ", this.substitutable, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C5554.m10885("Cannot instantiate ", this.substitutable.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C8791.m14473("Cannot invoke " + this.substitutable, e3.getTargetException());
                            return null;
                        }
                    }
                }
                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public ResettableClassFileTransformer make(ResettableClassFileTransformer resettableClassFileTransformer, Callback<?> callback) {
                        try {
                            ...
                            C5554.m10885("Cannot access ", this.withCallback, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C5554.m10885("Cannot instantiate ", this.withCallback.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C8791.m14473("Cannot invoke " + this.withCallback, e3.getTargetException());
                            return null;
                        }
                    }
                }
