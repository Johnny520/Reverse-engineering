...
public interface MethodDescription extends TypeVariableSource, ModifierReviewable.ForMethodDescription, DeclaredByType.WithMandatoryDeclaration, ByteCodeElement.Member, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class SignatureToken {
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                iM4584 = AbstractC2442.m4584(this.returnType, this.name.hashCode() * 31, 31) + this.parameterTypes.hashCode();
            }
            if (iM4584 == 0) {
                return this.hashCode;
            }
            this.hashCode = iM4584;
            return iM4584;
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                int iHashCode = (this.annotations.hashCode() + ((this.exceptionTypes.hashCode() + ((this.parameterTokens.hashCode() + AbstractC2442.m4585(this.returnType, (this.typeVariableTokens.hashCode() + (((this.name.hashCode() * 31) + this.modifiers) * 31)) * 31, 31)) * 31)) * 31)) * 31;
                AnnotationValue<?, ?> annotationValue = this.defaultValue;
    ...
    public static class ForLoadedMethod extends InDefinedShape.AbstractBase.ForLoadedExecutable<Method> implements ParameterDescription.ForLoadedParameter.ParameterAnnotationSource {
        ...
        public TypeDescription.Generic getReturnType() {
            ...
            T t = this.executable;
            return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(((Method) t).getReturnType()) : new TypeDescription.Generic.LazyProjection.ForLoadedReturnType((Method) t);
        }
