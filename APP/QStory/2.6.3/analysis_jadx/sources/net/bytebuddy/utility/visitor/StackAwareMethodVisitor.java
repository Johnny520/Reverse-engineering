...
public class StackAwareMethodVisitor extends MethodVisitor {
    ...
    private void adjustStack(int i, int i2) {
        if (i > 2) {
            C5925.m11311(AbstractC6183.m11588(i, "Cannot push multiple values onto the operand stack: "));
            return;
        }
        if (i > 0) {
            ...
            if (i2 >= 0) {
                ...
                C5925.m11311(AbstractC6183.m11588(i2, "Unexpected offset underflow: "));
                return;
            }
        }
        if (i2 != 0) {
            C5925.m11311(AbstractC6183.m11591(i2, i, "Cannot specify non-zero offset ", " for non-incrementing value: "));
            return;
        }
        while (i < 0) {
        ...
        if (i == 1) {
            ...
            C5925.m11311(AbstractC6183.m11588(i, "Unexpected remainder on the operand stack: "));
        }
    }
    ...
    private void doDrain(List<StackSize> list) {
        ...
        while (listIterator.hasPrevious()) {
            ...
            if (i == 1) {
                ...
                if (i != 2) {
                    C7547.m12774(stackSizePrevious, "Unexpected stack size: ");
                    return;
                }
                super.visitInsn(88);
            }
    ...
    public int drainStack(int i, int i2, StackSize stackSize) {
        ...
        if (size == 1) {
            ...
            C5925.m11311(AbstractC6183.m11588(size, "Unexpected remainder on the operand stack: "));
            return 0;
        }
    ...
    public void visitFrame(int i, int i2, @MaybeNull Object[] objArr, int i3, @MaybeNull Object[] objArr2) {
        if (i == -1 || i == 0) {
            ...
            if (i != 4) {
                C5925.m11311(AbstractC6183.m11588(i, "Unknown frame type: "));
                return;
            }
            this.current.clear();
    ...
    */
    ...
    public void visitJumpInsn(int i, Label label) {
        ...
        List<StackSize> listOf = this.current;
        if (i == 168) {
            listOf = CompoundList.of(listOf, StackSize.SINGLE);
        }
        map.put(label, new ArrayList(listOf));
        if (i == 167) {
            this.current.clear();
        }
