...
public interface JavaConstant extends ConstantValue {
    ...
    public static class MethodType implements JavaConstant {
        ...
        public static MethodType ofAsm(TypePool typePool, Type type) {
            ...
            if (type.getSort() != 11) {
                C4211.m8604(type, "Not a method type description: ");
                return null;
            }
        ...
        public static MethodType ofLoaded(Object obj) {
            ...
            C5925.m11310(AbstractC0053.m153(obj, "Expected method type object: "));
            return null;
        }
    ...
    public static class MethodHandle implements JavaConstant {
        ...
        public static MethodHandle ofLoaded(Object obj, Object obj2) {
            if (!JavaType.METHOD_HANDLE.isInstance(obj)) {
                C5925.m11310(AbstractC0053.m153(obj, "Expected method handle object: "));
                return null;
            }
            if (!JavaType.METHOD_HANDLES_LOOKUP.isInstance(obj2)) {
                C5925.m11310(AbstractC0053.m153(obj2, "Expected method handle lookup object: "));
                return null;
            }
        ...
        public static MethodHandle ofSpecial(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription) {
            ...
            C5554.m10874("Cannot specialize ", inDefinedShape, " for ", typeDescription);
            return null;
        }
        ...
        public int hashCode() {
            return this.parameterTypes.hashCode() + AbstractC2442.m4584(this.returnType, AbstractC6183.m11572(AbstractC2442.m4584(this.ownerType, this.handleType.hashCode() * 31, 31), 31, this.name), 31);
        }
        ...
        public enum HandleType {
            ...
            public static HandleType of(MethodDescription.InDefinedShape inDefinedShape) {
                ...
                C4211.m8604(inDefinedShape, "Cannot create handle of type initializer ");
                return null;
            }
            ...
            public static HandleType ofSpecial(MethodDescription.InDefinedShape inDefinedShape) {
                ...
                C8791.m14472(inDefinedShape, "Cannot invoke ", " via invokespecial");
                return null;
            }
            ...
            public static HandleType of(int i) {
                ...
                C5925.m11310(AbstractC6183.m11588(i, "Unknown handle type: "));
                return null;
            }
        }
    ...
    public static abstract class Simple<T> implements JavaConstant {
        ...
        public static JavaConstant of(TypeDescription typeDescription) {
            ...
            C5925.m11310(AbstractC2442.m4572("A primitive type cannot be represented as a type constant: ", typeDescription));
            return null;
        }
        ...
        public static JavaConstant ofAsm(TypePool typePool, Object obj) {
            ...
            if (!(obj instanceof Type)) {
                ...
                C5925.m11310(AbstractC0053.m153(obj, "Not an ASM constant: "));
                return null;
            }
            Type type = (Type) obj;
            if (type.getSort() == 11) {
        ...
        public static JavaConstant ofDescription(Object obj, TypePool typePool) {
            ...
            if (!ofDynamicConstantDesc.isInstance(obj)) {
                C5925.m11310(AbstractC0053.m153(obj, "Not a resolvable constant description or not expressible as a constant pool value: "));
                return null;
            }
        ...
        public static JavaConstant ofLoaded(Object obj) {
            ...
            C5925.m11310(AbstractC0053.m153(obj, "Not a constant: "));
            return null;
        }
    ...
    public static class Dynamic implements JavaConstant {
        ...
        public static Dynamic bootstrap(String str, MethodDescription.InDefinedShape inDefinedShape, List<?> list) {
            if (str.length() == 0 || str.contains(".")) {
                C5925.m11310("Not a valid field name: ".concat(str));
                return null;
            }
            ArrayList arrayList = new ArrayList(list.size());
            Iterator<?> it = list.iterator();
            ...
            C5554.m10874("Not a valid bootstrap method ", inDefinedShape, " for ", list);
            return null;
        }
        ...
        public static JavaConstant ofArrayVarHandle(TypeDescription typeDescription) {
            ...
            C5925.m11310(AbstractC2442.m4572("Not an array type: ", typeDescription));
            return null;
        }
        ...
        public static Dynamic ofField(FieldDescription.InDefinedShape inDefinedShape) {
            ...
            C4211.m8604(inDefinedShape, "Field must be static and final: ");
            return null;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:47:0x0104, code lost:
            ...
            lin.xposed.hook.javaplugin.C5554.m10874("Cannot assign ", r14, " to ", r13);
         */
        ...
        */
        ...
        public static JavaConstant ofPrimitiveType(TypeDescription typeDescription) {
            ...
            C5925.m11310(AbstractC2442.m4572("Not a primitive type: ", typeDescription));
            return null;
        }
        ...
        public int hashCode() {
            return this.arguments.hashCode() + ((this.bootstrap.hashCode() + AbstractC2442.m4584(this.typeDescription, this.name.hashCode() * 31, 31)) * 31);
        }
        ...
        public JavaConstant withType(TypeDescription typeDescription) {
            if (typeDescription.represents(Void.TYPE)) {
                C5925.m11310("Constant value cannot represent void");
                return null;
            }
            ...
            C5554.m10876(sb, " is not compatible with bootstrapped type ", getTypeDescription());
            return null;
        }
