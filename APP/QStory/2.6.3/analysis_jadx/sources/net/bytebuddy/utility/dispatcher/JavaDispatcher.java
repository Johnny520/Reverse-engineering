...
public class JavaDispatcher<T> implements PrivilegedAction<T> {
    ...
    public static class ProxiedInvocationHandler implements InvocationHandler {
        ...
        public int hashCode() {
            return this.targets.hashCode() + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.name);
        }
        ...
        public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) {
            ...
            if (method.getDeclaringClass() == Object.class) {
                ...
                if (!method.getName().equals("toString")) {
                    C7547.m12774(method, "Unexpected object method: ");
                    return null;
                }
            ...
            try {
                ...
                C5554.m10875("Failed to invoke proxy for ", method, th);
                return null;
            }
        }
    }
    ...
    public static <T> PrivilegedAction<T> of(Class<T> cls, @MaybeNull ClassLoader classLoader, boolean z) {
        if (!cls.isInterface()) {
            C5925.m11310(AbstractC0053.m154(cls, "Expected an interface instead of "));
            return null;
        }
        if (!cls.isAnnotationPresent(Proxied.class)) {
            C5554.m10871("Expected ", cls.getName(), " to be annotated with ", Proxied.class.getName());
            return null;
        }
        if (!((Proxied) cls.getAnnotation(Proxied.class)).value().startsWith("java.security.")) {
            return new JavaDispatcher(cls, classLoader, z);
        }
        C5925.m11310("Classes related to Java security cannot be proxied: ".concat(cls.getName()));
        return null;
    }
    ...
    */
    ...
    public int hashCode() {
        int iM4569 = AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.proxy);
        ClassLoader classLoader = this.classLoader;
        if (classLoader != null) {
            iM4569 += classLoader.hashCode();
        }
        return (iM4569 * 31) + (this.generate ? 1 : 0);
    }
    ...
    public static class DynamicClassLoader extends ClassLoader {
        ...
        public static Invoker invoker() {
            ...
            try {
                ...
                C8791.m14473("Failed to create invoker for ".concat(Invoker.class.getName()), e);
                return null;
            }
        }
        ...
        public static Object proxy(Class<?> cls, Map<Method, Dispatcher> map) {
            ...
            try {
                ...
                e = e2;
                C8791.m14473("Failed to create proxy for ".concat(cls2.getName()), e);
                return null;
            }
        }
                ...
                public void accept(@MaybeNull ClassLoader classLoader, Class<?> cls) {
                    ...
                    if (r0 != null) {
                        try {
                            ...
                            C8791.m14473("Failed to adjust module graph for dispatcher", e);
                        }
                    }
                }
