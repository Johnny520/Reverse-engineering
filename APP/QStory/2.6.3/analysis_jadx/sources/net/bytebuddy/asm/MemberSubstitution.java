...
public class MemberSubstitution implements AsmVisitorWrapper.ForDeclaredMethods.MethodVisitorWrapper {
    ...
    public interface Replacement {
        ...
        public interface Binding {
            ...
            public static class ForDynamicInvocation implements Binding {
                ...
                public int hashCode() {
                    return this.substitution.hashCode() + AbstractC0053.m160(this.arguments, AbstractC6183.m11572((this.methodType.hashCode() + (getClass().hashCode() * 31)) * 31, 31, this.name), 31);
                }
            ...
            public static class ForMember implements Binding {
                ...
                public int hashCode() {
                    return this.substitution.hashCode() + ((this.member.hashCode() + AbstractC2442.m4584(this.receiver, getClass().hashCode() * 31, 31)) * 31);
                }
        ...
        public static class ForElementMatchers implements Replacement {
            ...
            public static class Factory implements Factory {
                ...
                public int hashCode() {
                    return this.substitutionFactory.hashCode() + ((((((((AbstractC2442.m4586(this.methodMatcher, AbstractC2442.m4586(this.fieldMatcher, getClass().hashCode() * 31, 31), 31) + (this.matchFieldRead ? 1 : 0)) * 31) + (this.matchFieldWrite ? 1 : 0)) * 31) + (this.includeVirtualCalls ? 1 : 0)) * 31) + (this.includeSuperCalls ? 1 : 0)) * 31);
                }
            ...
            public int hashCode() {
                return this.substitution.hashCode() + ((((((((AbstractC2442.m4586(this.methodMatcher, AbstractC2442.m4586(this.fieldMatcher, getClass().hashCode() * 31, 31), 31) + (this.matchFieldRead ? 1 : 0)) * 31) + (this.matchFieldWrite ? 1 : 0)) * 31) + (this.includeVirtualCalls ? 1 : 0)) * 31) + (this.includeSuperCalls ? 1 : 0)) * 31);
            }
        ...
        public static class ForDynamicInvocation implements Replacement {
            ...
            public static class Factory implements Factory {
                ...
                public int hashCode() {
                    return this.substitutionFactory.hashCode() + ((this.argumentsMatcher.hashCode() + ((this.typeMatcher.hashCode() + ((this.nameMatcher.hashCode() + AbstractC2442.m4586(this.handleMatcher, getClass().hashCode() * 31, 31)) * 31)) * 31)) * 31);
                }
            ...
            public int hashCode() {
                return this.substitution.hashCode() + ((this.argumentsMatcher.hashCode() + ((this.typeMatcher.hashCode() + ((this.nameMatcher.hashCode() + AbstractC2442.m4586(this.handleMatcher, getClass().hashCode() * 31, 31)) * 31)) * 31)) * 31);
            }
    ...
    public enum Source {
        ...
        public static class Value {
            ...
            public int hashCode() {
                return AbstractC2442.m4585(this.typeDescription, getClass().hashCode() * 31, 31) + this.offset;
            }
        }
    ...
    public interface Substitution<T extends Target> {
        ...
        public static class ForFieldAccess implements Substitution<Target> {
            ...
            public interface FieldResolver {
                ...
                public static class ForElementMatcher implements FieldResolver {
                    ...
                    public int hashCode() {
                        return this.matcher.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
                    }
                    ...
                    public FieldDescription resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2) {
                        if (generic.isEmpty()) {
                            C7547.m12774(generic, "Cannot substitute parameterless instruction with ");
                            return null;
                        }
                        if (generic.get(0).isPrimitive() || generic.get(0).isArray()) {
                            C4211.m8605(generic.get(0), "Cannot access field on primitive or array type for ");
                            return null;
                        }
                        ...
                        do {
                            ...
                            if (fieldListFilter.size() > 1) {
                                C7547.m12774(fieldListFilter, "Ambiguous field location of ");
                                return null;
                            }
                            superClass = superClass.getSuperClass();
                        } while (superClass != null);
                        C0276.m847("Cannot locate field matching ", this.matcher, " on ", target);
                        return null;
                    }
                }
            ...
            public int hashCode() {
                return this.fieldResolver.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
            }
            ...
            public StackManipulation resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, int i) {
                ...
                if (!fieldDescriptionResolve.isAccessibleTo(this.instrumentedType)) {
                    C5554.m10866(this.instrumentedType, " cannot access ", fieldDescriptionResolve);
                    return null;
                }
                if (!generic2.represents(Void.TYPE)) {
                    if (generic.size() != (1 ^ (fieldDescriptionResolve.isStatic() ? 1 : 0))) {
                        C5554.m10887("Cannot set ", fieldDescriptionResolve, " with ", generic);
                        return null;
                    }
                    if (fieldDescriptionResolve.isStatic() || generic.get(0).asErasure().isAssignableTo(fieldDescriptionResolve.getDeclaringType().asErasure())) {
                        ...
                        C5554.m10887("Cannot get ", fieldDescriptionResolve, " as ", generic2);
                        return null;
                    }
                    StringBuilder sb = new StringBuilder("Cannot get ");
                    sb.append(fieldDescriptionResolve);
                    C5554.m10881(sb, " on ", generic.get(0));
                    return null;
                }
                ...
                if (!fieldDescriptionResolve.isStatic() && !generic.get(0).asErasure().isAssignableTo(fieldDescriptionResolve.getDeclaringType().asErasure())) {
                    ...
                    C5554.m10881(sb2, " on ", generic.get(0));
                    return null;
                }
                ...
                C5554.m10881(sb3, " to ", generic.get(!fieldDescriptionResolve.isStatic() ? 1 : 0));
                return null;
            }
        }
        ...
        public static class ForMethodInvocation implements Substitution<Target> {
            ...
            public interface MethodResolver {
                ...
                public static class Matching implements MethodResolver {
                    ...
                    public int hashCode() {
                        return this.matcher.hashCode() + ((this.methodGraphCompiler.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31)) * 31);
                    }
                    ...
                    public MethodDescription resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2) {
                        ...
                        if (generic.get(0).isPrimitive() || generic.get(0).isArray()) {
                            C4211.m8605(generic.get(0), "Cannot invoke method on primitive or array type for ");
                            return null;
                        }
                        ...
                        C0276.m847("Not exactly one method that matches ", this.matcher, ": ", listOf);
                        return null;
                    }
                }
            ...
            public static class OfMatchedMethod implements Factory<Target> {
                ...
                public int hashCode() {
                    return this.methodGraphCompiler.hashCode() + AbstractC2442.m4586(this.matcher, getClass().hashCode() * 31, 31);
                }
            ...
            public int hashCode() {
                return this.methodResolver.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
            }
            ...
            public StackManipulation resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, int i) {
                ...
                if (!methodDescriptionResolve.isAccessibleTo(this.instrumentedType)) {
                    C5554.m10866(this.instrumentedType, " cannot access ", methodDescriptionResolve);
                    return null;
                }
                ...
                if (!methodDescriptionResolve.getReturnType().asErasure().isAssignableTo(generic2.asErasure())) {
                    C5554.m10887("Cannot assign return value of ", methodDescriptionResolve, " to ", generic2);
                    return null;
                }
                if (listAsTypeList.size() != generic.size()) {
                    StringBuilder sb = new StringBuilder("Cannot invoke ");
                    sb.append(methodDescriptionResolve);
                    C5554.m10877(sb, " on ", generic.size(), " parameters");
                    return null;
                }
        ...
        public static class Chain<S extends Target> implements Substitution<S> {
            ...
            public int hashCode() {
                return this.steps.hashCode() + ((this.typing.hashCode() + AbstractC2442.m4589(this.assigner, getClass().hashCode() * 31, 31)) * 31);
            }
            ...
            public StackManipulation resolve(S s, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, int i) {
                ...
                C5554.m10887("Failed to assign ", resultType, " to ", generic2);
                return null;
            }
            ...
            public interface Step<U extends Target> {
                ...
                public static class ForDelegation implements Step<Target> {
                    ...
                    public interface BootstrapArgumentResolver {
                        ...
                        public static class ForDefaultValues implements BootstrapArgumentResolver {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public int hashCode() {
                                    return this.instrumentedMethod.hashCode() + AbstractC2442.m4584(this.instrumentedType, AbstractC2442.m4568(this.delegate, getClass().hashCode() * 31, 31), 31);
                                }
                    ...
                    public static class Factory implements Factory<Target> {
                                ...
                                for (AnnotationDescription annotationDescription : inDefinedShape.getDeclaredAnnotations()) {
                                    ...
                                    if (factory2 != null) {
                                        ...
                                        if (offsetMapping != null) {
                                            C5554.m10880(inDefinedShape, offsetMappingMake, offsetMapping);
                                            throw null;
                                        }
                            ...
                            for (int i = 0; i < inDefinedShape.getParameters().size(); i++) {
                                ...
                                for (AnnotationDescription annotationDescription2 : inDefinedShape2.getDeclaredAnnotations()) {
                                    ...
                                    if (factory3 != null) {
                                        ...
                                        if (forArgument != null) {
                                            C5554.m10880(inDefinedShape2, offsetMappingMake2, forArgument);
                                            throw null;
                                        }
                        ...
                        public int hashCode() {
                            return this.offsetMappings.hashCode() + ((this.dispatcher.hashCode() + AbstractC2442.m4568(this.delegate, getClass().hashCode() * 31, 31)) * 31);
                        }
                    ...
                    public static Factory<Target> to(MethodDescription.InDefinedShape inDefinedShape, Dispatcher.Factory factory, List<? extends OffsetMapping.Factory<?>> list) {
                        ...
                        C4211.m8604(inDefinedShape, "Cannot delegate to type initializer: ");
                        return null;
                    }
                    ...
                    public int hashCode() {
                        return this.offsetMappings.hashCode() + ((this.dispatcher.hashCode() + AbstractC2442.m4585(this.returned, getClass().hashCode() * 31, 31)) * 31);
                    }
                    ...
                    public Resolution resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, TypeDescription.Generic generic3, Map<Integer, Integer> map, int i) {
                        ...
                        if (generic4.represents(Void.TYPE)) {
                            ...
                            i2 = i;
                            stackManipulationStoreAt = MethodVariableAccess.of(generic4).storeAt(i2);
                        }
                    ...
                    public interface OffsetMapping {
                        ...
                        public static class ForOrigin implements OffsetMapping {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public StackManipulation apply(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, TypeDescription.Generic generic3, JavaConstant.MethodHandle methodHandle, Map<Integer, Integer> map, int i) {
                                    ...
                                    C5554.m10881(sb, " in ", this.instrumentedMethod);
                                    return null;
                                }
                                    ...
                                    public StackManipulation resolve(ByteCodeElement.Member member, List<TypeDescription> list, TypeDescription typeDescription) {
                                        ...
                                        if (member instanceof MethodDescription) {
                                            ...
                                            if (!(member instanceof FieldDescription)) {
                                                C7547.m12774(member, "Unexpected byte code element: ");
                                                return null;
                                            }
                            ...
                            */
                            public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                                ...
                                L26:
                                    return r1
                                L27:
                                    net.bytebuddy.description.type.TypeDescription$Generic r4 = r4.target
                            ...
                            public int hashCode() {
                                int iM4585 = AbstractC2442.m4585(this.target, getClass().hashCode() * 31, 31);
                                Assigner.Typing typing = this.typing;
                                return typing != null ? typing.hashCode() + iM4585 : iM4585;
                            }
                            ...
                            public static class Resolved extends ForField {
                                ...
                                public static class Factory<T extends Annotation> extends Factory.AbstractBase<T> {
                                    ...
                                    public int hashCode() {
                                        return this.typing.hashCode() + ((this.fieldDescription.hashCode() + AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.annotationType)) * 31);
                                    }
                        ...
                        public static class ForStackManipulation implements OffsetMapping {
                            ...
                            public static class OfAnnotationProperty<T extends Annotation> extends Factory.WithParameterSupportOnly<T> {
                                ...
                                public OffsetMapping make(ParameterDescription.InDefinedShape inDefinedShape, AnnotationDescription.Loadable<T> loadable) {
                                    ...
                                    C4211.m8605(this.property, "Not a constant value property: ");
                                    return null;
                                }
                            }
                            ...
                            public static class OfDynamicInvocation<T extends Annotation> extends Factory.AbstractBase<T> {
                                ...
                                public OffsetMapping make(TypeDescription.Generic generic, AnnotationDescription.Loadable<T> loadable) {
                                    if (!generic.isInterface()) {
                                        C0276.m838(generic, " is not an interface");
                                        return null;
                                    }
                                    if (!generic.getInterfaces().isEmpty()) {
                                        C0276.m838(generic, " must not extend other interfaces");
                                        return null;
                                    }
                                    if (!generic.isPublic()) {
                                        C0276.m838(generic, " is mot public");
                                        return null;
                                    }
                                    ...
                                    C0276.m838(generic, " must declare exactly one abstract method");
                                    return null;
                                }
                            }
                            ...
                            public static class OfSerializedConstant<T extends Annotation> extends Factory.AbstractBase<T> {
                                ...
                                public static Factory of(Class cls, Serializable serializable, Class cls2) {
                                    ...
                                    C5554.m10865(serializable, " is no instance of ", cls2);
                                    return null;
                                }
                                ...
                                public int hashCode() {
                                    return this.typeDescription.hashCode() + AbstractC2442.m4588(this.deserialization, AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.annotationType), 31);
                                }
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public int hashCode() {
                                    return this.targetType.hashCode() + AbstractC2442.m4585(this.typeDescription, AbstractC2442.m4588(this.stackManipulation, (this.typing.hashCode() + AbstractC2442.m4589(this.assigner, getClass().hashCode() * 31, 31)) * 31, 31), 31);
                                }
                            }
                            ...
                            public int hashCode() {
                                return this.targetType.hashCode() + AbstractC2442.m4585(this.typeDescription, AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31), 31);
                            }
                        ...
                        public static class ForCurrent implements OffsetMapping {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public int hashCode() {
                                    return this.typing.hashCode() + AbstractC2442.m4589(this.assigner, AbstractC2442.m4585(this.targetType, getClass().hashCode() * 31, 31), 31);
                                }
                            }
                            ...
                            */
                            public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                                ...
                                L26:
                                    return r1
                                L27:
                                    net.bytebuddy.description.type.TypeDescription$Generic r4 = r4.targetType
                            ...
                            public int hashCode() {
                                int iM4585 = AbstractC2442.m4585(this.targetType, getClass().hashCode() * 31, 31);
                                Assigner.Typing typing = this.typing;
                                return typing != null ? typing.hashCode() + iM4585 : iM4585;
                            }
                        ...
                        public static class ForStubValue implements OffsetMapping {
                            ...
                            public enum Factory implements Factory<StubValue> {
                                ...
                                public OffsetMapping make(ParameterDescription.InDefinedShape inDefinedShape, AnnotationDescription.Loadable<StubValue> loadable) {
                                    ...
                                    C5554.m10883(inDefinedShape, "Expected ", " to declare an Object type");
                                    return null;
                                }
                        ...
                        public static class ForThisReference implements OffsetMapping {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public StackManipulation apply(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, TypeDescription.Generic generic3, JavaConstant.MethodHandle methodHandle, Map<Integer, Integer> map, int i) {
                                    ...
                                    if (valueSelf == null) {
                                        ...
                                        C7547.m12774(target, "No this reference available for ");
                                        return null;
                                    }
                                ...
                                public int hashCode() {
                                    return this.instrumentedMethod.hashCode() + AbstractC2442.m4589(this.assigner, (((this.source.hashCode() + ((this.typing.hashCode() + AbstractC2442.m4585(this.targetType, getClass().hashCode() * 31, 31)) * 31)) * 31) + (this.optional ? 1 : 0)) * 31, 31);
                                }
                            }
                            ...
                            */
                            ...
                            public int hashCode() {
                                ...
                                Assigner.Typing typing = this.typing;
                                if (typing != null) {
                                    iM4585 += typing.hashCode();
                                }
                                return ((this.source.hashCode() + (iM4585 * 31)) * 31) + (this.optional ? 1 : 0);
                            }
                        ...
                        public static class ForAllArguments implements OffsetMapping {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public StackManipulation apply(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, TypeDescription.Generic generic3, JavaConstant.MethodHandle methodHandle, Map<Integer, Integer> map, int i) {
                                    ...
                                    for (Source.Value value : listArguments) {
                                        ...
                                        if (!stackManipulationAssign.isValid()) {
                                            ...
                                            C5554.m10881(sb, " to ", this.targetComponentType);
                                            return null;
                                        }
                                ...
                                public int hashCode() {
                                    return this.instrumentedMethod.hashCode() + AbstractC2442.m4589(this.assigner, (((((this.source.hashCode() + ((this.typing.hashCode() + AbstractC2442.m4585(this.targetComponentType, getClass().hashCode() * 31, 31)) * 31)) * 31) + (this.includeSelf ? 1 : 0)) * 31) + (this.nullIfEmpty ? 1 : 0)) * 31, 31);
                                }
                            }
                            ...
                            */
                            public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                                ...
                                L35:
                                    ...
                                    return r1
                                L40:
                                    net.bytebuddy.description.type.TypeDescription$Generic r4 = r4.targetComponentType
                            ...
                            public int hashCode() {
                                int iM4585 = AbstractC2442.m4585(this.targetComponentType, getClass().hashCode() * 31, 31);
                                Assigner.Typing typing = this.typing;
                                if (typing != null) {
                                    iM4585 += typing.hashCode();
                                }
                                return ((((this.source.hashCode() + (iM4585 * 31)) * 31) + (this.includeSelf ? 1 : 0)) * 31) + (this.nullIfEmpty ? 1 : 0);
                            }
                            ...
                            public enum Factory implements Factory<AllArguments> {
                                ...
                                public OffsetMapping make(ParameterDescription.InDefinedShape inDefinedShape, AnnotationDescription.Loadable<AllArguments> loadable) {
                                    ...
                                    C7547.m12774(inDefinedShape, "Expected array as parameter type for ");
                                    return null;
                                }
                        ...
                        public static class ForArgument implements OffsetMapping {
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public StackManipulation apply(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, TypeDescription.Generic generic3, JavaConstant.MethodHandle methodHandle, Map<Integer, Integer> map, int i) {
                                    ...
                                    if (valueArgument == null) {
                                        ...
                                        C3683.m7926(this.index, " available for ", target, "No argument with index ");
                                        return null;
                                    }
                                ...
                                public int hashCode() {
                                    return this.instrumentedMethod.hashCode() + AbstractC2442.m4589(this.assigner, (((this.source.hashCode() + ((this.typing.hashCode() + ((AbstractC2442.m4585(this.targetType, getClass().hashCode() * 31, 31) + this.index) * 31)) * 31)) * 31) + (this.optional ? 1 : 0)) * 31, 31);
                                }
                            }
                            ...
                            */
                            ...
                            public int hashCode() {
                                int iM4585 = (AbstractC2442.m4585(this.targetType, getClass().hashCode() * 31, 31) + this.index) * 31;
                                Assigner.Typing typing = this.typing;
                                if (typing != null) {
                                    iM4585 += typing.hashCode();
                                }
                    ...
                    public interface Dispatcher {
                        ...
                        public static class ForDynamicInvocation implements Dispatcher {
                            ...
                            public static class Factory implements Factory {
                                ...
                                public int hashCode() {
                                    return this.resolverFactory.hashCode() + AbstractC2442.m4568(this.bootstrapMethod, getClass().hashCode() * 31, 31);
                                }
                            ...
                            public static class Resolved implements Resolved {
                                ...
                                public StackManipulation apply(Target target, JavaConstant.MethodHandle methodHandle) {
                                    ...
                                    boolean zIsInvokeBootstrap = this.bootstrapMethod.isInvokeBootstrap(TypeList.Explicit.of((List<? extends JavaConstant>) listMake));
                                    ...
                                    C5554.m10865(inDefinedShape, " is not accepting advice bootstrap arguments: ", listMake);
                                    return null;
                                }
                                ...
                                public int hashCode() {
                                    return this.resolver.hashCode() + AbstractC2442.m4568(this.delegate, AbstractC2442.m4568(this.bootstrapMethod, getClass().hashCode() * 31, 31), 31);
                                }
                            ...
                            public static Factory of(MethodDescription.InDefinedShape inDefinedShape, BootstrapArgumentResolver.Factory factory) {
                                ...
                                C7547.m12774(inDefinedShape, "Not a bootstrap method: ");
                                return null;
                            }
                    ...
                    public static Factory<Target> to(MethodDescription.InDefinedShape inDefinedShape) {
                        ...
                        C4211.m8604(inDefinedShape, "Cannot delegate to a type initializer: ");
                        return null;
                    }
                ...
                public static abstract class ForField implements Step<Target> {
                    ...
                    public int hashCode() {
                        return this.typing.hashCode() + AbstractC2442.m4589(this.assigner, (this.fieldDescription.hashCode() + (getClass().hashCode() * 31)) * 31, 31);
                    }
                    ...
                    public Resolution resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, TypeDescription.Generic generic3, Map<Integer, Integer> map, int i) {
                        ...
                        if (this.fieldDescription.isStatic()) {
                            ...
                            if (!stackManipulationAssign.isValid()) {
                                StringBuilder sb = new StringBuilder("Cannot assign ");
                                sb.append(generic3);
                                C5554.m10881(sb, " to ", this.fieldDescription.getDeclaringType());
                                return null;
                            }
                            arrayList.add(stackManipulationAssign);
                        }
                    ...
                    public static class Write extends ForField {
                        ...
                        public Resolution doResolve(Target target, TypeList.Generic generic, Map<Integer, Integer> map, StackManipulation stackManipulation) {
                            ...
                            if (i >= generic.size()) {
                                C5925.m11311(AbstractC6183.m11588(i, "Target does not define an argument with index "));
                                return null;
                            }
                            ...
                            C5554.m10881(sb, " to ", this.fieldDescription);
                            return null;
                        }
                ...
                public static class ForInvocation implements Step<Target> {
                    ...
                    public int hashCode() {
                        return this.typing.hashCode() + AbstractC2442.m4589(this.assigner, AbstractC6183.m11571(this.substitutions, AbstractC2442.m4567(this.methodDescription, getClass().hashCode() * 31, 31), 31), 31);
                    }
                    ...
                    public Resolution resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, TypeDescription.Generic generic3, Map<Integer, Integer> map, int i) {
                        ...
                        if (this.methodDescription.isStatic()) {
                            ...
                            if (!stackManipulationAssign.isValid()) {
                                StringBuilder sb = new StringBuilder("Cannot assign ");
                                sb.append(generic3);
                                C5554.m10881(sb, " to ", this.methodDescription.getDeclaringType());
                                return null;
                            }
                            arrayList.add(stackManipulationAssign);
                        }
                        ...
                        for (int i3 = 0; i3 < this.methodDescription.getParameters().size(); i3++) {
                            ...
                            if (!stackManipulationAssign2.isValid()) {
                                StringBuilder sbM150 = AbstractC0053.m150(i3, "Cannot assign parameter with ", " of type ");
                                sbM150.append(generic.get(iIntValue));
                                sbM150.append(" to ");
                                C2942.m6407(this.methodDescription, sbM150);
                                return null;
                            }
                    ...
                    public static class Factory implements Factory<Target> {
                        ...
                        public int hashCode() {
                            return this.substitutions.hashCode() + AbstractC2442.m4567(this.methodDescription, getClass().hashCode() * 31, 31);
                        }
                ...
                public static class Simple implements Step<Target>, Factory<Target>, Resolution {
                    ...
                    public int hashCode() {
                        return this.resultType.hashCode() + AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31);
                    }
                ...
                public static class ForArgumentSubstitution implements Step<Target> {
                    ...
                    public static Factory<Target> of(Object obj, int i) {
                        ...
                        C5925.m11310(AbstractC6183.m11588(i, "Index cannot be negative: "));
                        return null;
                    }
                    ...
                    public int hashCode() {
                        return this.typing.hashCode() + AbstractC2442.m4589(this.assigner, (AbstractC2442.m4585(this.typeDescription, AbstractC2442.m4588(this.substitution, getClass().hashCode() * 31, 31), 31) + this.index) * 31, 31);
                    }
                    ...
                    public Resolution resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, TypeDescription.Generic generic3, Map<Integer, Integer> map, int i) {
                        if (this.index >= generic.size()) {
                            ...
                            sb.append(target);
                            sb.append(" has not ");
                            C5925.m11311(AbstractC0053.m147(sb, " arguments", this.index));
                            return null;
                        }
                        ...
                        C5554.m10881(sb2, " to ", generic.get(this.index));
                        return null;
                    }
                    ...
                    public static class Factory implements Factory<Target> {
                        ...
                        public int hashCode() {
                            return AbstractC2442.m4585(this.typeDescription, AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31), 31) + this.index;
                        }
                        ...
                        */
                        public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                            ...
                            L8:
                                ...
                                return r1
                            L13:
                                net.bytebuddy.description.type.TypeDescription$Generic r4 = r4.result
                    ...
                    */
                    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                        ...
                        L26:
                            return r1
                        L27:
                            net.bytebuddy.implementation.bytecode.assign.Assigner r4 = r4.assigner
                ...
                public static class ForArgumentLoading implements Step<Target>, Factory<Target> {
                    ...
                    public static class OfInstrumentedMethod implements Factory<Target> {
                        ...
                        public Step<Target> make(Assigner assigner, Assigner.Typing typing, TypeDescription typeDescription, MethodDescription methodDescription) {
                            ...
                            C5925.m11311(AbstractC0053.m147(sb, " parameters", this.index));
                            return null;
                        }
                    }
                    ...
                    public enum OfInstrumentedMethodThis implements Factory<Target> {
                        ...
                        public Step<Target> make(Assigner assigner, Assigner.Typing typing, TypeDescription typeDescription, MethodDescription methodDescription) {
                            ...
                            C5554.m10879(methodDescription, " is static and does not define a this reference");
                            return null;
                        }
                    }
                    ...
                    public static Factory<Target> ofInstrumentedMethod(int i) {
                        ...
                        C5925.m11310(AbstractC6183.m11588(i, "Argument index cannot be negative: "));
                        return null;
                    }
                    ...
                    public Resolution resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, TypeDescription.Generic generic3, Map<Integer, Integer> map, int i) {
                        ...
                        if (!(target instanceof Target.ForMember)) {
                            if (!(target instanceof Target.ForDynamicInvocation)) {
                                C7547.m12774(target, "Unexpected target: ");
                                return null;
                            }
                        ...
                        if (!(member instanceof FieldDescription)) {
                            C7547.m12774(member, "Unexpected member: ");
                            return null;
                        }
        ...
        public static class ForValue implements Substitution<Target>, Factory<Target> {
            ...
            public int hashCode() {
                return this.typeDescription.hashCode() + AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31);
            }
            ...
            public StackManipulation resolve(Target target, TypeList.Generic generic, TypeDescription.Generic generic2, JavaConstant.MethodHandle methodHandle, StackManipulation stackManipulation, int i) {
                ...
                C0276.m847("Cannot assign ", this.typeDescription, " to ", generic2);
                return null;
            }
    ...
    public static class SubstitutingMethodVisitor extends LocalVariableAwareMethodVisitor {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public void visitFieldInsn(int r22, java.lang.String r23, java.lang.String r24, java.lang.String r25) {
            /*
        ...
        public void visitInvokeDynamicInsn(String str, String str2, net.bytebuddy.jar.asm.Handle handle, Object... objArr) {
            ...
            try {
                try {
                    ...
                    e = e;
                    if (this.strict) {
                        C0276.m847("Could not resolve ", e.getName(), " using ", this.typePool);
                        return;
                    } else {
                        methodType = null;
                        methodHandle = null;
        ...
        public void visitMaxs(int i, int i2) {
            ...
            C5554.m10881(sb, " of ", this.instrumentedType);
        }
        ...
        public void visitMethodInsn(int i, String str, String str2, String str3, boolean z) {
            ...
            if (resolutionDescribe.isResolved()) {
                ...
                C0276.m847("Could not resolve ", str.replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH), " using ", this.typePool);
                return;
            }
    ...
    public static abstract class WithoutSpecification<T extends Target> {
        ...
        public static class ForMatchedDynamicInvocation extends WithoutSpecification<Target.ForDynamicInvocation> {
            ...
            @Override // net.bytebuddy.asm.MemberSubstitution.WithoutSpecification
            public int hashCode() {
                return this.argumentsMatcher.hashCode() + ((this.typeMatcher.hashCode() + ((this.nameMatcher.hashCode() + AbstractC2442.m4586(this.handleMatcher, super.hashCode() * 31, 31)) * 31)) * 31);
            }
        ...
        public MemberSubstitution replaceWith(MethodDescription methodDescription) {
            ...
            C8791.m14472(methodDescription, "Cannot use ", " as a replacement");
            return null;
        }
        ...
        public static class ForMatchedField extends WithoutSpecification<Target.ForMember> {
            ...
            @Override // net.bytebuddy.asm.MemberSubstitution.WithoutSpecification
            public int hashCode() {
                return ((AbstractC2442.m4586(this.matcher, super.hashCode() * 31, 31) + (this.matchRead ? 1 : 0)) * 31) + (this.matchWrite ? 1 : 0);
            }
        ...
        public static class ForMatchedMethod extends WithoutSpecification<Target.ForMember> {
            ...
            @Override // net.bytebuddy.asm.MemberSubstitution.WithoutSpecification
            public int hashCode() {
                return ((AbstractC2442.m4586(this.matcher, super.hashCode() * 31, 31) + (this.includeVirtualCalls ? 1 : 0)) * 31) + (this.includeSuperCalls ? 1 : 0);
            }
