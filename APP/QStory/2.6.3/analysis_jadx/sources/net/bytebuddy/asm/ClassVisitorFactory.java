...
public abstract class ClassVisitorFactory<T> {
    ...
    public static class AttributeTranslator implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.targetWrapper.hashCode() + AbstractC2442.m4584(this.sourceWrapper, AbstractC2442.m4569(AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.sourceAttribute), 31, this.targetAttribute), 31);
        }
    }
    ...
    public static class ConstantDynamicTranslator implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.targetHandle.hashCode() + AbstractC2442.m4569(AbstractC2442.m4569(AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.sourceConstantDynamic), 31, this.targetConstantDynamic), 31, this.sourceHandle);
        }
    }
    ...
    public static class CreateClassVisitorFactory<S> implements PrivilegedAction<ClassVisitorFactory<S>> {
        ...
        public int hashCode() {
            return this.byteBuddy.hashCode() + AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.classVisitor);
        }
    ...
    public static class FrameTranslator implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.targetLabel.hashCode() + AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.sourceLabel);
        }
    }
    ...
    public static class HandleTranslator implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.targetHandle.hashCode() + AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.sourceHandle);
        }
    }
    ...
    public static class TypePathTranslator implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.targetTypePath.hashCode() + AbstractC2442.m4569(getClass().hashCode() * 31, 31, this.sourceTypePath);
        }
    }
