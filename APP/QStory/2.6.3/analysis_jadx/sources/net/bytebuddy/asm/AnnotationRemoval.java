...
public class AnnotationRemoval extends AsmVisitorWrapper.AbstractBase {
    ...
    public int hashCode() {
        return AbstractC2442.m4586(this.annotationMatcher, AbstractC2442.m4586(this.methodMatcher, AbstractC2442.m4586(this.fieldMatcher, ((getClass().hashCode() * 31) + (this.type ? 1 : 0)) * 31, 31), 31), 31) + this.parameters;
    }
    ...
    public AsmVisitorWrapper onInvokableParameter(ElementMatcher<? super MethodDescription> elementMatcher, int i) {
        ...
        C5925.m11310(AbstractC6183.m11588(i, "Parameter index cannot be negative: "));
        return null;
    }
