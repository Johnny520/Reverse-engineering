...
public interface AsmVisitorWrapper {
    ...
    public static class ForDeclaredFields extends AbstractBase {
        ...
        public static class Entry implements ElementMatcher<FieldDescription.InDefinedShape>, FieldVisitorWrapper {
            ...
            public int hashCode() {
                return this.fieldVisitorWrappers.hashCode() + AbstractC2442.m4586(this.matcher, getClass().hashCode() * 31, 31);
            }
    ...
    public static class ForDeclaredMethods implements AsmVisitorWrapper {
        ...
        public int hashCode() {
            return ((AbstractC0053.m160(this.entries, getClass().hashCode() * 31, 31) + this.writerFlags) * 31) + this.readerFlags;
        }
        ...
        public static class Entry implements ElementMatcher<MethodDescription>, MethodVisitorWrapper {
            ...
            public int hashCode() {
                return this.methodVisitorWrappers.hashCode() + AbstractC2442.m4586(this.matcher, getClass().hashCode() * 31, 31);
            }
