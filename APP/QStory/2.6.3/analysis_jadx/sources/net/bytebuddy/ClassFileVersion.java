...
public class ClassFileVersion implements Comparable<ClassFileVersion>, Serializable {
    ...
    public static ClassFileVersion ofClassFile(byte[] bArr) {
        ...
        C5925.m11310(AbstractC0053.m147(new StringBuilder("Supplied byte array is too short to be a class file with "), " byte", bArr.length));
        return null;
    }

    public static ClassFileVersion ofJavaVersion(int i) {
        if (i < 1) {
            C5925.m11310(AbstractC6183.m11588(i, "Java version must be positive: "));
            return null;
        }
        int i2 = i - 1;
    ...
    public static ClassFileVersion ofJavaVersionString(String str) {
        ...
        try {
            ...
            C8791.m14473("Failed to read Java version from: ".concat(str), e);
            return null;
        }
    }
    ...
    public static ClassFileVersion ofMinorMajor(int i) {
        ...
        C5925.m11310(AbstractC0053.m162(i, "Class version ", " is not valid"));
        return null;
    }
