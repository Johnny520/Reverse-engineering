...
public interface FieldRegistry {
    ...
    public static class Default implements FieldRegistry {
            ...
            */
            public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                ...
                L3c:
                    return r1
                L3d:
                    net.bytebuddy.dynamic.Transformer<net.bytebuddy.description.field.FieldDescription> r4 = r4.transformer
        ...
        public static class Compiled implements Compiled {
            ...
            public int hashCode() {
                return this.entries.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
            }
            ...
            public static class Entry implements ElementMatcher<FieldDescription> {
                ...
                */
                ...
                public int hashCode() {
                    int iHashCode = (this.fieldAttributeAppender.hashCode() + AbstractC2442.m4586(this.matcher, getClass().hashCode() * 31, 31)) * 31;
                    Object obj = this.defaultValue;
                    if (obj != null) {
                        iHashCode += obj.hashCode();
                    }
