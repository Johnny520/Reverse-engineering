...
public class ByteArrayClassLoader extends InjectionClassLoader {
    ...
    public class ClassDefinitionAction implements PrivilegedAction<Class<?>> {
        ...
        public int hashCode() {
            return ByteArrayClassLoader.this.hashCode() + ((Arrays.hashCode(this.binaryRepresentation) + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.name)) * 31);
        }
    ...
    public enum PersistenceHandler {
        ...
        public static class UrlDefinitionAction implements PrivilegedAction<URL> {
            ...
            public int hashCode() {
                return Arrays.hashCode(this.binaryRepresentation) + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.typeName);
            }
            ...
            public URL run() {
                try {
                    ...
                    C8791.m14473("Could not find encoding: UTF-8", e);
                    return null;
                } catch (MalformedURLException e2) {
                    C5554.m10885("Cannot create URL for ", this.typeName, e2);
                    return null;
                }
            }
        }
        ...
        for (TypeDescription typeDescription : map.keySet()) {
            if (!classLoaderDecoratorMake.isSkipped(typeDescription)) {
                try {
                    ...
                    C8791.m14473(AbstractC2442.m4572("Cannot load class ", typeDescription), e);
                    return null;
                }
            }
        }
