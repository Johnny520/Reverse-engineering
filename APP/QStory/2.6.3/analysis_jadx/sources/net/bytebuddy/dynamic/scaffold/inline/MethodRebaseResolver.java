...
public interface MethodRebaseResolver {
    ...
    public static class Default implements MethodRebaseResolver {
        ...
        public int hashCode() {
            return this.dynamicTypes.hashCode() + AbstractC6183.m11571(this.resolutions, getClass().hashCode() * 31, 31);
        }
    ...
    public interface Resolution {
        ...
        public static class ForRebasedConstructor implements Resolution {
            ...
            public int hashCode() {
                return this.placeholderType.hashCode() + AbstractC2442.m4568(this.methodDescription, getClass().hashCode() * 31, 31);
            }
