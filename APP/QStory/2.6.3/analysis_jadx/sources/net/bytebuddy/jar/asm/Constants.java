...
final class Constants {
    ...
    public static void checkIsPreview(InputStream inputStream) {
        if (inputStream == null) {
            C5925.m11311("Bytecode not available, can't check class version");
            return;
        }
        try {
            ...
            try {
                ...
                C5925.m11311("ASM10_EXPERIMENTAL can only be used by classes compiled with --enable-preview");
            } catch (Throwable th) {
                try {
                    dataInputStream.close();
            ...
            C8791.m14473("I/O error, can't check class version", e);
        }
    }
    ...
    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0053.m158("net/bytebuddy/jar/asm/util/Trace", str, "Visitor(\\$.*)?");
    }

    private static /* synthetic */ String stringConcat$2(String str) {
        return AbstractC0053.m158("net/bytebuddy/jar/asm/util/Check", str, "Adapter(\\$.*)?");
    }
}
