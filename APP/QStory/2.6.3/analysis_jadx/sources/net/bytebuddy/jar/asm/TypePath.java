...
public final class TypePath {
    ...
    public int getStep(int i) {
        return this.typePathContainer[AbstractC6183.m11574(i, 2, this.typePathOffset, 1)];
    }

    public int getStepArgument(int i) {
        return this.typePathContainer[AbstractC6183.m11574(i, 2, this.typePathOffset, 2)];
    }
