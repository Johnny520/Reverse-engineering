...
public class ArrayFactory implements CollectionFactory {
    ...
    public class ArrayStackManipulation implements StackManipulation {
        ...
        public int hashCode() {
            return ArrayFactory.this.hashCode() + AbstractC0053.m160(this.stackManipulations, getClass().hashCode() * 31, 31);
        }
    ...
    private static ArrayCreator makeArrayCreatorFor(TypeDefinition typeDefinition) {
        ...
        C4211.m8604(typeDefinition, "Cannot create array of type ");
        return null;
    }
    ...
    public int hashCode() {
        return this.arrayCreator.hashCode() + AbstractC2442.m4585(this.componentType, getClass().hashCode() * 31, 31);
    }
