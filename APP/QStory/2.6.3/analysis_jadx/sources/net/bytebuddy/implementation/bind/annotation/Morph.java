...
public @interface Morph {
    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Morph> {
        ...
        private static MethodDescription onlyMethod(TypeDescription typeDescription) {
            ...
            C0276.m838(methodDescription, " does not take a single argument of type Object[]");
            return null;
        }
        ...
        public static class RedirectionProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public int hashCode() {
                return AbstractC2442.m4589(this.assigner, (this.specialMethodInvocation.hashCode() + AbstractC2442.m4584(this.instrumentedType, AbstractC2442.m4584(this.morphingType, getClass().hashCode() * 31, 31), 31)) * 31, 31) + (this.serializableProxy ? 1 : 0);
            }
            ...
            public static class MethodCall implements Implementation {
                ...
                public class Appender implements ByteCodeAppender {
                    ...
                    public int hashCode() {
                        return MethodCall.this.hashCode() + AbstractC2442.m4584(this.typeDescription, getClass().hashCode() * 31, 31);
                    }
                }
                ...
                public int hashCode() {
                    return this.assigner.hashCode() + AbstractC2442.m4567(this.accessorMethod, getClass().hashCode() * 31, 31);
                }
