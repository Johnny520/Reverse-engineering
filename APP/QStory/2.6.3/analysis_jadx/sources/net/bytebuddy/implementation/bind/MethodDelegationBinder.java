...
public interface MethodDelegationBinder {
    ...
    public interface MethodBinding extends StackManipulation {
        ...
        public static class Builder {
            ...
            public static class Build implements MethodBinding {
                ...
                public int hashCode() {
                    return this.terminatingStackManipulation.hashCode() + AbstractC0053.m160(this.parameterStackManipulations, AbstractC2442.m4588(this.methodInvocation, AbstractC6183.m11571(this.registeredTargetIndices, AbstractC2442.m4567(this.target, getClass().hashCode() * 31, 31), 31), 31), 31);
                }
            ...
            public MethodBinding build(StackManipulation stackManipulation) {
                ...
                C5925.m11311("The number of parameters bound does not equal the target's number of parameters");
                return null;
            }
        }
    ...
    public static class Processor implements Record {
        ...
        public MethodBinding bind(Implementation.Target target, MethodDescription methodDescription, TerminationHandler terminationHandler, MethodInvoker methodInvoker, Assigner assigner) {
            ...
            C5554.m10871("None of ", this.records, " allows for delegation from ", methodDescription3);
            return null;
        }
        ...
        public int hashCode() {
            return this.bindingResolver.hashCode() + ((this.ambiguityResolver.hashCode() + AbstractC0053.m160(this.records, getClass().hashCode() * 31, 31)) * 31);
        }
    }
    ...
    public interface BindingResolver {
        ...
        public enum Default implements BindingResolver {
            ...
            private MethodBinding doResolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                if (size == 2) {
                    ...
                    C5554.m10876(sb, " or ", methodBinding2.getTarget());
                    return null;
                }
                ...
                if (i2 != 3 && i2 != 4) {
                    C5925.m11305(list.size(), "Unexpected amount of targets: ");
                    return null;
                }
                list.remove(1);
                list.remove(0);
                ...
                C5554.m10876(sb2, " or ", methodBinding4.getTarget());
                return null;
            }
        ...
        public enum Unique implements BindingResolver {
            ...
            public MethodBinding resolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                C5554.m10873(methodDescription, " allowed for more than one binding: ", list);
                return null;
            }
        }
