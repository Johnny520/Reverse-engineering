...
public class MethodDelegation implements Implementation.Composable {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.compiled.hashCode() + AbstractC2442.m4589(this.assigner, (this.terminationHandler.hashCode() + ((this.processor.hashCode() + ((this.implementationTarget.hashCode() + (getClass().hashCode() * 31)) * 31)) * 31)) * 31, 31);
        }
    }
    ...
    public int hashCode() {
        return this.assigner.hashCode() + ((this.bindingResolver.hashCode() + ((this.terminationHandler.hashCode() + ((this.ambiguityResolver.hashCode() + AbstractC0053.m160(this.parameterBinders, (this.implementationDelegate.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31)) * 31)) * 31);
    }
    ...
    public static class WithCustomProperties {
        ...
        public int hashCode() {
            return this.matcher.hashCode() + ((this.bindingResolver.hashCode() + AbstractC0053.m160(this.parameterBinders, (this.ambiguityResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31);
        }

        public MethodDelegation to(TypeDescription typeDescription) {
            if (typeDescription.isArray()) {
                C5925.m11310(AbstractC2442.m4572("Cannot delegate to array ", typeDescription));
                return null;
            }
            ...
            C5925.m11310(AbstractC2442.m4572("Cannot delegate to primitive ", typeDescription));
            return null;
        }
        ...
        public MethodDelegation to(Object obj, TypeDefinition typeDefinition, String str, MethodGraph.Compiler compiler) {
            ...
            C5554.m10865(obj, " is not an instance of ", typeDefinition);
            return null;
        }
    }
    ...
    public interface ImplementationDelegate extends InstrumentedType.Prepareable {
        ...
        public interface Compiled {
            ...
            public static class ForConstruction implements Compiled {
                ...
                public int hashCode() {
                    return this.records.hashCode() + AbstractC2442.m4584(this.typeDescription, getClass().hashCode() * 31, 31);
                }
            ...
            public static class ForField implements Compiled {
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    ...
                    C0276.m847("Cannot read ", this.fieldDescription, " from ", methodDescription);
                    return null;
                }
            }
            ...
            public static class ForMethodReturn implements Compiled {
                ...
                public int hashCode() {
                    return this.records.hashCode() + AbstractC2442.m4567(this.methodDescription, getClass().hashCode() * 31, 31);
                }
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    ...
                    C0276.m847("Cannot invoke ", this.methodDescription, " from ", methodDescription);
                    return null;
                }
            }
        ...
        public static abstract class ForField implements ImplementationDelegate {
            ...
            public static class WithInstance extends ForField {
                ...
                public FieldDescription resolve(TypeDescription typeDescription) {
                    ...
                    C5554.m10866(this.fieldType, " is not visible to ", typeDescription);
                    return null;
                }
            }
            ...
            public Compiled compile(TypeDescription typeDescription) {
                ...
                if (!fieldDescriptionResolve.getType().asErasure().isVisibleTo(typeDescription)) {
                    C5554.m10873(fieldDescriptionResolve, " is not visible to ", typeDescription);
                    return null;
                }
            ...
            public int hashCode() {
                return this.matcher.hashCode() + AbstractC0053.m160(this.parameterBinders, (this.methodGraphCompiler.hashCode() + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.fieldName)) * 31, 31);
            }
            ...
            public static class WithLookup extends ForField {
                ...
                public FieldDescription resolve(TypeDescription typeDescription) {
                    ...
                    C0276.m847("Could not locate ", this.fieldName, " on ", typeDescription);
                    return null;
                }
        ...
        public static class ForMethodReturn implements ImplementationDelegate {
            ...
            public Compiled compile(TypeDescription typeDescription) {
                ...
                if (!((MethodDescription) methodListFilter.getOnly()).getReturnType().asErasure().isVisibleTo(typeDescription)) {
                    C5554.m10866(methodListFilter.getOnly(), " is not visible to ", typeDescription);
                    return null;
                }
            ...
            public int hashCode() {
                return this.matcher.hashCode() + AbstractC0053.m160(this.parameterBinders, (this.methodGraphCompiler.hashCode() + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.name)) * 31, 31);
            }
