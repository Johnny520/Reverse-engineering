...
public class InvokeDynamic implements Implementation.Composable {
    ...
    public class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return InvokeDynamic.this.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
        }
    }
    ...
    public enum TerminationHandler {
        RETURNING { // from class: net.bytebuddy.implementation.InvokeDynamic.TerminationHandler.1
            ...
            public StackManipulation resolve(MethodDescription methodDescription, TypeDescription typeDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C5554.m10887("Cannot return ", typeDescription, " from ", methodDescription);
                return null;
            }
        },
    ...
    public static WithImplicitArguments lambda(MethodDescription.InDefinedShape inDefinedShape, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
        if (!typeDefinition.isInterface()) {
            C0276.m838(typeDefinition, " is not an interface type");
            return null;
        }
        ...
        if (methodListFilter.size() != 1) {
            C5554.m10865(typeDefinition, " does not define exactly one abstract method: ", methodListFilter);
            return null;
        }
    ...
    public int hashCode() {
        return this.typing.hashCode() + AbstractC2442.m4589(this.assigner, (this.terminationHandler.hashCode() + ((this.invocationProvider.hashCode() + AbstractC0053.m160(this.arguments, AbstractC2442.m4568(this.bootstrap, getClass().hashCode() * 31, 31), 31)) * 31)) * 31, 31);
    }
    ...
    public InvokeDynamic withArgument(int... iArr) {
        ...
        for (int i : iArr) {
            if (i < 0) {
                C5925.m11310(AbstractC6183.m11588(i, "Method parameter indices cannot be negative: "));
                return null;
            }
    ...
    public InvokeDynamic withNullValue(TypeDescription... typeDescriptionArr) {
        ...
        for (TypeDescription typeDescription : typeDescriptionArr) {
            if (typeDescription.isPrimitive()) {
                C5925.m11310(AbstractC2442.m4572("Cannot assign null to primitive type: ", typeDescription));
                return null;
            }
    ...
    public interface InvocationProvider {
        ...
        public interface Target {
            ...
            public interface Resolved {
                ...
                public static class Simple implements Resolved {
                    ...
                    public int hashCode() {
                        return this.parameterTypes.hashCode() + AbstractC2442.m4584(this.returnType, AbstractC6183.m11572(AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31), 31, this.internalName), 31);
                    }
                }
        ...
        public interface ArgumentProvider {
            ...
            public static class ForInstance implements ArgumentProvider {
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    C5554.m10881(sb, " to ", this.fieldType);
                    return null;
                }
            }
            ...
            public interface Resolved {
                ...
                public static class Simple implements Resolved {
                    ...
                    public int hashCode() {
                        return this.loadedTypes.hashCode() + AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31);
                    }
            ...
            public enum ConstantPoolWrapper {
                ...
                public class WrappingArgumentProvider implements ArgumentProvider {
                    ...
                    public int hashCode() {
                        return ConstantPoolWrapper.this.hashCode() + AbstractC2442.m4588(this.stackManipulation, getClass().hashCode() * 31, 31);
                    }
            ...
            public static class ForField implements ArgumentProvider {
                ...
                public static class WithExplicitType extends ForField {
                    ...
                    public Resolved doResolve(StackManipulation stackManipulation, TypeDescription.Generic generic, Assigner assigner, Assigner.Typing typing) {
                        ...
                        StringBuilder sb = new StringBuilder("Cannot assign ");
                        sb.append(generic);
                        C5554.m10881(sb, " to ", this.typeDescription);
                        return null;
                    }
                ...
                public int hashCode() {
                    return this.fieldLocatorFactory.hashCode() + AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.fieldName);
                }
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    if (!resolutionLocate.isResolved()) {
                        C0276.m847("Cannot find a field ", this.fieldName, " for ", typeDescription);
                        return null;
                    }
                    ...
                    C0276.m847("Cannot access non-static ", resolutionLocate.getField(), " from ", methodDescription);
                    return null;
                }
            ...
            public static class ForThisInstance implements ArgumentProvider {
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    if (methodDescription.isStatic()) {
                        C5925.m11311(AbstractC2442.m4573("Cannot get this instance from static method: ", methodDescription));
                        return null;
                    }
        ...
        public static class Default implements InvocationProvider {
            ...
            public static class Target implements Target {
                ...
                public int hashCode() {
                    return this.instrumentedMethod.hashCode() + AbstractC0053.m160(this.argumentProviders, AbstractC2442.m4584(this.returnType, AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.internalName), 31), 31);
                }
    ...
    public static abstract class WithImplicitType extends AbstractDelegator {
        ...
        public static class OfInstance extends WithImplicitType {
            ...
            public InvokeDynamic as(TypeDescription typeDescription) {
                ...
                C2308.m4355(this.value, " is not of type ", typeDescription);
                return null;
            }
