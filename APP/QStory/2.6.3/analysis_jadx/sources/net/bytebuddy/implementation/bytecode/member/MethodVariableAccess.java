...
public final class MethodVariableAccess {
    ...
    public static class MethodLoading extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return this.typeCastingHandler.hashCode() + AbstractC2442.m4567(this.methodDescription, getClass().hashCode() * 31, 31);
        }
    ...
    public static MethodVariableAccess of(TypeDefinition typeDefinition) {
        ...
        C5925.m11310("Variable type cannot be void");
        return null;
    }
    ...
    public StackManipulation increment(int i, int i2) {
        ...
        C7547.m12774(this, "Cannot increment type: ");
        return null;
    }
