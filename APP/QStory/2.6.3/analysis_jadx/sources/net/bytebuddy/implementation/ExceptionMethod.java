...
public class ExceptionMethod implements Implementation, ByteCodeAppender {
    ...
    public interface ConstructionDelegate {
        ...
        public static class ForDefaultConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.targetConstructor.hashCode() + AbstractC2442.m4584(this.throwableType, getClass().hashCode() * 31, 31);
            }
        ...
        public static class ForStringConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.message.hashCode() + AbstractC2442.m4567(this.targetConstructor, AbstractC2442.m4584(this.throwableType, getClass().hashCode() * 31, 31), 31);
            }
    ...
    public static Implementation throwing(TypeDescription typeDescription) {
        ...
        C5925.m11310(AbstractC2442.m4565(typeDescription, " does not extend throwable"));
        return null;
    }
