    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Pipe> {
        ...
        private static MethodDescription onlyMethod(TypeDescription typeDescription) {
            ...
            if (!typeDescription.isPublic()) {
                C5925.m11310(AbstractC2442.m4565(typeDescription, " is mot public"));
                return null;
            }
            ...
            if (!methodDescription.getReturnType().asErasure().represents(Object.class)) {
                C0276.m838(methodDescription, " does not return an Object-type");
                return null;
            }
            ...
            C0276.m838(methodDescription, " does not take a single Object-typed argument");
            return null;
        }
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Pipe> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
            ...
            C5554.m10881(sb, " which was installed for ", this.forwardingMethod.getDeclaringType());
            return null;
        }
        ...
        public static class RedirectionProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            private static String fieldName(int i) {
                return AbstractC6183.m11588(i, FIELD_NAME_PREFIX);
            }
            ...
            public int hashCode() {
                return AbstractC2442.m4589(this.assigner, AbstractC2442.m4567(this.sourceMethod, AbstractC2442.m4584(this.forwardingType, getClass().hashCode() * 31, 31), 31), 31) + (this.serializableProxy ? 1 : 0);
            }
            ...
            public static class MethodCall implements Implementation {
                ...
                public class Appender implements ByteCodeAppender {
                    ...
                    public int hashCode() {
                        return MethodCall.this.hashCode() + AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31);
                    }
                }
                ...
                public ByteCodeAppender appender(Implementation.Target target) {
                    ...
                    C2308.m4354(this.redirectedMethod, "Cannot invoke ", " from outside of class via @Pipe proxy");
                    return null;
                }
                ...
                public int hashCode() {
                    return this.assigner.hashCode() + AbstractC2442.m4567(this.redirectedMethod, getClass().hashCode() * 31, 31);
                }
