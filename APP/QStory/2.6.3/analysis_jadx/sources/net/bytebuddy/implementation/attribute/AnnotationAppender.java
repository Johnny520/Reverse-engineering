...
public interface AnnotationAppender {
    ...
    public static class ForTypeAnnotations implements TypeDescription.Generic.Visitor<AnnotationAppender> {
        ...
        public AnnotationAppender onGenericArray(TypeDescription.Generic generic) {
            return (AnnotationAppender) generic.getComponentType().accept(new ForTypeAnnotations(apply(generic, this.typePath), this.annotationValueFilter, this.typeReference, AbstractC0053.m148(new StringBuilder(), this.typePath, '[')));
        }
        ...
        public AnnotationAppender onNonGenericType(TypeDescription.Generic generic) {
            ...
            return componentType != null ? (AnnotationAppender) componentType.accept(new ForTypeAnnotations(annotationAppenderApply, this.annotationValueFilter, this.typeReference, AbstractC0053.m148(new StringBuilder(), this.typePath, '['))) : annotationAppenderApply;
        }
        ...
        public AnnotationAppender onWildcard(TypeDescription.Generic generic) {
            ...
            return (AnnotationAppender) (lowerBounds.isEmpty() ? generic.getUpperBounds().getOnly() : lowerBounds.getOnly()).accept(new ForTypeAnnotations(apply(generic, this.typePath), this.annotationValueFilter, this.typeReference, AbstractC0053.m148(new StringBuilder(), this.typePath, '*')));
        }
    ...
    public static class Default implements AnnotationAppender {
        ...
        public AnnotationAppender append(AnnotationDescription annotationDescription, AnnotationValueFilter annotationValueFilter, int i, String str) {
            ...
            C4211.m8605(annotationDescription.getRetention(), "Unexpected retention policy: ");
            return null;
        }
