...
public class EqualsMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            if (methodDescription.isStatic()) {
                C5925.m11311(AbstractC2442.m4573("Hash code method must not be static: ", methodDescription));
                return null;
            }
            ...
            if (!methodDescription.getReturnType().represents(Boolean.TYPE)) {
                C5925.m11311(AbstractC2442.m4573("Hash code method does not return primitive boolean: ", methodDescription));
                return null;
            }
        ...
        public int hashCode() {
            return this.identity.hashCode() + AbstractC2442.m4586(this.nonNullable, AbstractC0053.m160(this.fieldDescriptions, AbstractC2442.m4588(this.baseline, AbstractC2442.m4584(this.instrumentedType, getClass().hashCode() * 31, 31), 31), 31), 31);
        }
    }
    ...
    public interface NullValueGuard {
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public int hashCode() {
                return this.endOfBlock.hashCode() + ((this.secondValueNull.hashCode() + ((this.firstValueNull.hashCode() + AbstractC2442.m4567(this.instrumentedMethod, getClass().hashCode() * 31, 31)) * 31)) * 31);
            }
        }
    ...
    public enum SuperClassCheck {
        ...
        ENABLED { // from class: net.bytebuddy.implementation.EqualsMethod.SuperClassCheck.2
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                ...
                C5925.m11311(AbstractC2442.m4565(typeDescription, " does not declare a super class"));
                return null;
            }
        };
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (target.getInstrumentedType().isInterface()) {
            C4211.m8605(target.getInstrumentedType(), "Cannot implement meaningful equals method for ");
            return null;
        }
