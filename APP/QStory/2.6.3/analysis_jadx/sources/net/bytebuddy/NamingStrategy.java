...
public interface NamingStrategy {
    ...
    public static class Suffixing extends AbstractBase {
        ...
        public interface BaseNameResolver {
            ...
            public static class WithCallerSuffix implements BaseNameResolver {
                ...
                public String resolve(TypeDescription typeDescription) {
                    ...
                    if (str == null) {
                        C5925.m11311(AbstractC0053.m154(ByteBuddy.class, "Base name resolver not invoked via "));
                        return null;
                    }
        ...
        public int hashCode() {
            return this.baseNameResolver.hashCode() + AbstractC6183.m11572(AbstractC6183.m11572(getClass().hashCode() * 31, 31, this.suffix), 31, this.javaLangPackagePrefix);
        }
        ...
        public String name(TypeDescription typeDescription) {
            ...
            StringBuilder sbM11584 = AbstractC6183.m11584(strResolve, "$");
            sbM11584.append(this.suffix);
