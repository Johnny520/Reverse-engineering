...
public class EventListenerSupport<L> implements Serializable {
    ...
    public EventListenerSupport(Class<L> cls, ClassLoader classLoader) {
        ...
        if (!zIsInterface) {
            throw new IllegalArgumentException(AbstractC5686.m11052(objArr) ? "Class %s is not an interface" : String.format("Class %s is not an interface", objArr));
        }
