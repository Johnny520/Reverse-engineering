...
public final class C5602 extends AbstractC8977 {
    ...
    public C5602(C5583 c5583) {
        ...
        this.f15439 = 9;
        this.f15442 = -1;
        this.f15444 = new C8997(c5583, byteOrder);
        this.f15445 = 256;
        if (this.f15439 > 13) {
            C5925.m11310("maxCodeSize 13 is out of bounds.");
            throw null;
        }
    ...
    public final int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        while (true) {
            ...
            if (i5 > 31) {
                boolean z3 = z2;
                C5925.m11310("Code size must not be bigger than 31");
                return z3 ? 1 : 0;
            }
            C8997 c8997 = this.f15444;
            int iM14603 = (int) c8997.m14603(i5);
            int i6 = -1;
            if (iM14603 < 0) {
                z = z2;
            } else {
                ...
                if (iM14603 != i7) {
                    if (zArr[iM14603]) {
                        ...
                        int i8 = this.f15442;
                        if (i8 == -1) {
                            C5925.m11307("The first code can't be a reference to its preceding code");
                            return z ? 1 : 0;
                        }
                        iM14603 = m10972(this.f15438, i8);
                        objArr = 1;
                    }
                    for (int i9 = iM14603; i9 >= 0; i9 = iArr[i9]) {
                    ...
                    int iM146032 = (int) c8997.m14603(i12);
                    if (iM146032 < 0) {
                        C5925.m11307("Unexpected EOF;");
                        return z ? 1 : 0;
                    }
                    if (iM146032 == 1) {
                        int i13 = this.f15439;
                        if (i13 >= 13) {
                            C5925.m11307("Attempt to increase code size beyond maximum");
                            return z ? 1 : 0;
                        }
                        this.f15439 = i13 + 1;
                    } else {
                        if (iM146032 != 2) {
                            C5925.m11307(AbstractC6183.m11588(iM146032, "Invalid clear code subcode "));
                            return z ? 1 : 0;
                        }
    ...
    public final int m10972(byte b, int i) {
        boolean[] zArr;
        int i2 = this.f15443;
        while (true) {
            zArr = this.f15435;
