...
public class FastDateParser implements Serializable {
    ...
    private transient List<C5675> patterns;
    private final int startYear;
    private final TimeZone timeZone;
    static final Locale JAPANESE_IMPERIAL = new Locale("ja", "JP", "JP");
    private static final Comparator<String> LONGER_FIRST_LOWERCASE = Comparator.reverseOrder();
    private static final ConcurrentMap<Locale, AbstractC5678>[] CACHES = new ConcurrentMap[17];
    private static final AbstractC5678 ABBREVIATED_YEAR_STRATEGY = new C5684(1, 0);
    private static final AbstractC5678 NUMBER_MONTH_STRATEGY = new C5684(2, 1);
    private static final AbstractC5678 LITERAL_YEAR_STRATEGY = new C5673(1);
    private static final AbstractC5678 WEEK_OF_YEAR_STRATEGY = new C5673(3);
    private static final AbstractC5678 WEEK_OF_MONTH_STRATEGY = new C5673(4);
    private static final AbstractC5678 DAY_OF_YEAR_STRATEGY = new C5673(6);
    private static final AbstractC5678 DAY_OF_MONTH_STRATEGY = new C5673(5);
    private static final AbstractC5678 DAY_OF_WEEK_STRATEGY = new C5684(7, 2);
    private static final AbstractC5678 DAY_OF_WEEK_IN_MONTH_STRATEGY = new C5673(8);
    private static final AbstractC5678 HOUR_OF_DAY_STRATEGY = new C5673(11);
    private static final AbstractC5678 HOUR24_OF_DAY_STRATEGY = new C5684(11, 3);
    private static final AbstractC5678 HOUR12_STRATEGY = new C5684(10, 4);
    private static final AbstractC5678 HOUR_STRATEGY = new C5673(10);
    private static final AbstractC5678 MINUTE_STRATEGY = new C5673(12);
    private static final AbstractC5678 SECOND_STRATEGY = new C5673(13);
    private static final AbstractC5678 MILLISECOND_STRATEGY = new C5673(14);
    ...
    public static Map<String, Integer> appendDisplayNames(Calendar calendar, final Locale locale, int i, StringBuilder sb) {
        ...
        treeSet.forEach(new C5683(sb, 0));
        return map;
    }

    public static void clear() {
        Stream.of((Object[]) CACHES).filter(new C2603(4)).forEach(new C2605(2));
    }

    private static ConcurrentMap<Locale, AbstractC5678> getCache(int i) {
        ConcurrentMap<Locale, AbstractC5678> concurrentMap;
        ConcurrentMap<Locale, AbstractC5678>[] concurrentMapArr = CACHES;
    ...
    private AbstractC5678 getLocaleSpecificStrategy(final int i, final Calendar calendar) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public AbstractC5678 getStrategy(char c, int i, Calendar calendar) {
        if (c == 'S') {
                            ...
                            default:
                                switch (c) {
                                    ...
                                    case 'X':
                                        ...
                                        C5674 c5674 = C5674.f15596;
                                        C5925.m11310("invalid number of X");
                                        return null;
                                    case 'Y':
                                        break;
                                    case 'Z':
        ...
        while (true) {
            if (i >= this.pattern.length()) {
                ...
                if (AbstractC5703.m11062(cCharAt)) {
                    ...
                    int i3 = i2 - i;
                    C5675 c56752 = new C5675(getStrategy(cCharAt, i3, calendar), i3);
                    i = i2;
                    c5675 = c56752;
                } else {
                    ...
                    if (z) {
                        C5925.m11310("Unterminated quote");
                        return;
                    } else {
                        String string = sb.toString();
                        c5675 = new C5675(new C5682(string), string.length());
                    }
                }
            }
            if (c5675 == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ AbstractC5678 lambda$getLocaleSpecificStrategy$2(int i, Calendar calendar, Locale locale) {
        Locale locale2 = this.locale;
        return i == 15 ? new C5668(locale2) : new C5681(i, calendar, locale2);
    }
    ...
    */
    public boolean parse(java.lang.String r11, java.text.ParsePosition r12, java.util.Calendar r13) {
        ...
        L6:
            ...
            org.apache.commons.lang3.time.飘花落叶言子楪哲兰世苏 r1 = (org.apache.commons.lang3.time.C5675) r1
            org.apache.commons.lang3.time.飘花落叶言子楪哲苏兰世 r2 = r1.f15598
            boolean r2 = r2.mo11051()
            r3 = 0
            if (r2 == 0) goto L37
        ...
        L22:
            ...
            org.apache.commons.lang3.time.飘花落叶言子楪哲兰世苏 r2 = (org.apache.commons.lang3.time.C5675) r2
        ...
        L38:
            ...
            r8 = r12
            r6 = r13
            boolean r10 = r4.mo11050(r5, r6, r7, r8, r9)
            if (r10 != 0) goto L45
            return r3
        L45:
            r10 = r5
    ...
    public Date parse(String str) throws ParseException {
        ...
        throw new ParseException(AbstractC0053.m157("Unparseable date: ", str), parsePosition.getErrorIndex());
    }
