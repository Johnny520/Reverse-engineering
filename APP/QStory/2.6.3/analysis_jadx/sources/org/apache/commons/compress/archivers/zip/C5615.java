...
public final class C5615 {
    ...
    */
    public C5615(java.nio.charset.Charset r4) {
        /*
            r3 = this;
            r3.<init>()
            r3.f15472 = r4
            int r0 = p376.AbstractC8984.f25212
            if (r4 != 0) goto Ld
        ...
        L35:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.C5615.<init>(java.nio.charset.Charset):void");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final String m10976(byte[] bArr) {
