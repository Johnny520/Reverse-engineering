...
public abstract class AbstractC5600 implements InterfaceC5589 {
    ...
    public final void parseFromLocalFileData(byte[] bArr, int i, int i2) throws ZipException {
        ...
        byte b = bArr[i];
        if (b != 1) {
            throw new ZipException(AbstractC0053.m162(b, "Unsupported version [", "] for UniCode path extra data."));
        }
