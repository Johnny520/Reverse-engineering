...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    private StringBuilder appendQuotedString(String str, ParsePosition parsePosition, StringBuilder sb) {
        ...
        C5925.m11310(AbstractC6183.m11588(index, "Unterminated quoted string at position "));
        return null;
    }
    ...
    private boolean containsElements(Collection<?> collection) {
        ...
        return collection.stream().anyMatch(new C2642(5));
    }
    ...
    private String parseFormatDescription(String str, ParsePosition parsePosition) {
        ...
        C5925.m11310(AbstractC6183.m11588(index, "Unterminated format element at position "));
        return null;
    }
    ...
    */
    private int readArgumentIndex(java.lang.String r9, java.text.ParsePosition r10) {
        ...
        L5e:
            ...
            java.lang.String r1 = ": "
            java.lang.StringBuilder r8 = androidx.activity.AbstractC0053.m150(r0, r8, r1)
            int r10 = r10.getIndex()
            java.lang.String r9 = r9.substring(r0, r10)
            io.ktor.util.C4211.m8603(r9, r8)
            return r2
        L74:
            java.lang.String r8 = "Unterminated format element at position "
            java.lang.String r8 = p009.AbstractC6183.m11588(r0, r8)
    ...
    private void seekNonWs(String str, ParsePosition parsePosition) {
        char[] charArray = str.toCharArray();
        do {
            C5642 c5642 = AbstractC5648.f15541;
            int index = parsePosition.getIndex();
            c5642.getClass();
            int length = charArray.length;
            int iMo11032 = c5642.mo11032(index, charArray);
            parsePosition.setIndex(parsePosition.getIndex() + iMo11032);
            if (iMo11032 <= 0) {
                return;
            }
        } while (parsePosition.getIndex() < str.length());
            ...
            if (c != '\'') {
                if (c == '{') {
                    ...
                    if (arrayList.size() != i2) {
                        C5925.m11310("The validated expression is false");
                        return;
                    } else if (arrayList2.size() != i2) {
                        C5925.m11310("The validated expression is false");
                        return;
                    } else if (charArray[parsePosition.getIndex()] != '}') {
                        C5925.m11310(AbstractC6183.m11588(index, "Unreadable format element at position "));
                        return;
                    }
                }
