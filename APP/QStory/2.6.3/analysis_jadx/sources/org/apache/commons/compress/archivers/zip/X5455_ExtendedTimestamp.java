...
public class X5455_ExtendedTimestamp implements InterfaceC5589, Cloneable, Serializable {
    ...
    private static ZipLong unixTimeToZipLong(long j) {
        ...
        C5925.m11310(AbstractC2442.m4583(j, "X5455 timestamps must fit in a signed 32 bit integer: "));
        return null;
    }
    ...
    public void parseFromLocalFileData(byte[] bArr, int i, int i2) throws ZipException {
        ...
        reset();
        if (i2 < 1) {
            throw new ZipException(AbstractC0053.m162(i2, "X5455_ExtendedTimestamp too short, only ", " bytes"));
        }
        int i5 = i2 + i;
        int i6 = i + 1;
        setFlags(bArr[i]);
    ...
    public String toString() {
        ...
        sb.append(Integer.toBinaryString(AbstractC5581.m10941(this.flags)));
        sb.append(" ");
