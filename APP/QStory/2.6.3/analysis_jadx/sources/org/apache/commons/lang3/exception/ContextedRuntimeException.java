...
public class ContextedRuntimeException extends RuntimeException implements InterfaceC8973 {
    private static final long serialVersionUID = 20110706;
    private final InterfaceC8973 exceptionContext;

    public ContextedRuntimeException(String str, Throwable th, InterfaceC8973 interfaceC8973) {
        super(str, th);
