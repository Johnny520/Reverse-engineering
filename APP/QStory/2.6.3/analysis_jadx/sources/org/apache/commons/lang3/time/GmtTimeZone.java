...
final class GmtTimeZone extends TimeZone {
    ...
    public GmtTimeZone(boolean z, int i, int i2) {
        if (i >= 24) {
            C5554.m10869(i, " hours out of range");
            throw null;
        }
        if (i2 >= 60) {
            C5554.m10869(i2, " minutes out of range");
            throw null;
        }
        int iM4571 = AbstractC2442.m4571(i, 60, i2, MILLISECONDS_PER_MINUTE);
        this.offset = z ? -iM4571 : iM4571;
    ...
    public String toString() {
        ...
        sb.append("\",offset=");
        return AbstractC0053.m156(sb, this.offset, ']');
    }
