...
public final class StringMatchersGroupList extends ArrayList<C5711> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StringMatchersGroupList(Collection<C5711> collection) {
        super(collection);
        collection.getClass();
    }
    ...
    public final StringMatchersGroupList add(String groupName, Collection<String> usingStrings, StringMatchType matchType, boolean ignoreCase) {
        ...
        while (it.hasNext()) {
            arrayList.add(new C8926((String) it.next(), matchType, ignoreCase));
        }
        add(new C5711(groupName, arrayList));
        return this;
    }

    @Override // java.util.ArrayList, java.util.AbstractCollection, java.util.Collection, java.util.List
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof C5711) {
            return contains((C5711) obj);
        }
        return false;
    }
    ...
    public final /* bridge */ boolean remove(Object obj) {
        if (obj instanceof C5711) {
            return remove((C5711) obj);
        }
        return false;
    }

    public /* bridge */ C5711 removeAt(int i) {
        return remove(i);
    }
    ...
    public /* bridge */ boolean contains(C5711 c5711) {
        return super.contains((Object) c5711);
    }

    public /* bridge */ int indexOf(C5711 c5711) {
        return super.indexOf((Object) c5711);
    }

    public /* bridge */ int lastIndexOf(C5711 c5711) {
        return super.lastIndexOf((Object) c5711);
    }

    @Override // java.util.ArrayList, java.util.AbstractList, java.util.List
    public final /* bridge */ C5711 remove(int i) {
        return removeAt(i);
    }

    public /* bridge */ boolean remove(C5711 c5711) {
        return super.remove((Object) c5711);
    }
    ...
    public final /* synthetic */ StringMatchersGroupList add(String groupName, InterfaceC6558 init) {
        groupName.getClass();
        init.getClass();
        StringMatcherList stringMatcherList = new StringMatcherList();
        init.invoke(stringMatcherList);
        add(new C5711(groupName, stringMatcherList));
        return this;
    }

    public final StringMatchersGroupList add(InterfaceC6558 init) {
        init.getClass();
        C5711 c5711 = new C5711();
        c5711.f15656 = new ArrayList();
        init.invoke(c5711);
        add(c5711);
        return this;
    }
