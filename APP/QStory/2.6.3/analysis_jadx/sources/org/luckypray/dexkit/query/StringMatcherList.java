...
public final class StringMatcherList extends ArrayList<C8926> {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof C8926) {
            return contains((C8926) obj);
        }
        return false;
    }
    ...
    public final /* bridge */ boolean remove(Object obj) {
        if (obj instanceof C8926) {
            return remove((C8926) obj);
        }
        return false;
    }

    public /* bridge */ C8926 removeAt(int i) {
        return remove(i);
    }
    ...
    public /* bridge */ boolean contains(C8926 c8926) {
        return super.contains((Object) c8926);
    }

    public /* bridge */ int indexOf(C8926 c8926) {
        return super.indexOf((Object) c8926);
    }

    public /* bridge */ int lastIndexOf(C8926 c8926) {
        return super.lastIndexOf((Object) c8926);
    }

    @Override // java.util.ArrayList, java.util.AbstractList, java.util.List
    public final /* bridge */ C8926 remove(int i) {
        return removeAt(i);
    }

    public /* bridge */ boolean remove(C8926 c8926) {
        return super.remove((Object) c8926);
    }
    ...
    public final StringMatcherList add(String usingString, StringMatchType matchType, boolean ignoreCase) {
        ...
        matchType.getClass();
        add(new C8926(usingString, matchType, ignoreCase));
        return this;
    }

    public final StringMatcherList match(C8926 matcher) {
        matcher.getClass();
        add(matcher);
        return this;
    }

    public final /* synthetic */ StringMatcherList add(InterfaceC6558 init) {
        init.getClass();
        C8926 c8926 = new C8926();
        init.invoke(c8926);
        add(c8926);
        return this;
    }
    ...
    public final /* synthetic */ StringMatcherList match(InterfaceC6558 init) {
        init.getClass();
        C8926 c8926 = new C8926();
        init.invoke(c8926);
        add(c8926);
