...
public final class FieldMatcherList extends ArrayList<C5716> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FieldMatcherList(Collection<C5716> collection) {
        super(collection);
        collection.getClass();
    }
    ...
    public final FieldMatcherList add(InterfaceC6558 init) {
        init.getClass();
    ...
    public final FieldMatcherList addForName(String name, StringMatchType matchType, boolean ignoreCase) {
        ...
        matchType.getClass();
        C5716 c5716 = new C5716();
        c5716.f15675 = new C8926(name, matchType, ignoreCase);
        add(c5716);
        return this;
    }
    ...
    public final FieldMatcherList addForType(Class<?> clazz) {
        ...
        c5709.m11121(AbstractC5731.m11132(clazz), StringMatchType.Equals, false);
        c5716.f15672 = c5709;
        add(c5716);
        return this;
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof C5716) {
            return contains((C5716) obj);
        }
        return false;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof C5716) {
            return lastIndexOf((C5716) obj);
        }
        return -1;
    }

    public final FieldMatcherList match(InterfaceC6558 init) {
        init.getClass();
        C5716 c5716 = new C5716();
        init.invoke(c5716);
        add(c5716);
    ...
    public final /* bridge */ boolean remove(Object obj) {
        if (obj instanceof C5716) {
            return remove((C5716) obj);
        }
        return false;
    }

    public /* bridge */ C5716 removeAt(int i) {
        return remove(i);
    }
    ...
    public /* bridge */ boolean contains(C5716 c5716) {
        return super.contains((Object) c5716);
    }

    public /* bridge */ int indexOf(C5716 c5716) {
        return super.indexOf((Object) c5716);
    }

    public /* bridge */ int lastIndexOf(C5716 c5716) {
        return super.lastIndexOf((Object) c5716);
    }

    @Override // java.util.ArrayList, java.util.AbstractList, java.util.List
    public final /* bridge */ C5716 remove(int i) {
        return removeAt(i);
    }

    public /* bridge */ boolean remove(C5716 c5716) {
        return super.remove((Object) c5716);
    }

    public final FieldMatcherList match(C5716 matcher) {
        matcher.getClass();
        add(matcher);
        return this;
    }
    ...
    public final FieldMatcherList addForType(String typeName, StringMatchType matchType, boolean ignoreCase) {
        ...
        C5716 c5716 = new C5716();
        C5709 c5709 = new C5709();
        c5709.m11121(typeName, matchType, ignoreCase);
        c5716.f15672 = c5709;
        add(c5716);
        return this;
    }
