...
public abstract class AbstractC5729 {
    ...
    static {
        AbstractC5187.m10214(new InterfaceC6543() { // from class: org.luckypray.dexkit.util.OpCodeUtil$opFormatMap$2
            @Override // p052.InterfaceC6543
            public final Map<String, Integer> invoke() {
                LinkedHashMap linkedHashMap = new LinkedHashMap();
                String[] strArr = AbstractC5729.f15712;
                int i = 0;
                int i2 = 0;
                while (i < 256) {
