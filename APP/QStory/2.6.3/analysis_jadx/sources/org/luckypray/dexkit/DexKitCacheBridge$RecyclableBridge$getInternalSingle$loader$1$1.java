...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00020\u0005\"\b\b\u0000\u0010\u0001*\u00020\u0000\"\u0004\b\u0001\u0010\u0002\"\b\b\u0002\u0010\u0004*\u00020\u0003H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"L飘花落叶言苏子兰楪哲世/飘花落叶言子楪世苏哲兰;", "Q", "D", "Lorg/luckypray/dexkit/wrap/飘花落叶言子楪世哲兰苏;", "R", "L飘花落叶言苏子哲兰世楪/飘花落叶言子楪苏世哲兰;", "invoke", "()L飘花落叶言苏子哲兰世楪/飘花落叶言子楪苏世哲兰;", "<anonymous>"}, k = 3, mv = {1, 5, 1})
public final class DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1 extends Lambda implements InterfaceC6543 {
    ...
    public DexKitCacheBridge$RecyclableBridge$getInternalSingle$loader$1$1(C5743 c5743, InterfaceC6554 interfaceC6554, AbstractC8955 abstractC8955, InterfaceC6558 interfaceC6558) {
        super(0);
        this.this$0 = c5743;
    ...
    public final InterfaceC8964 invoke() {
        ...
        try {
            ...
            List list = (List) interfaceC6554.invoke(dexKitBridge, abstractC8955);
            Object objM8815 = AbstractC4344.m8815(list);
            if (objM8815 != null) {
                int size = list.size();
                while (true) {
                    if (i >= size) {
                        c8958 = new C8958((InterfaceC5733) interfaceC6558.invoke(objM8815));
                        break;
                    }
                    if (!objM8815.equals(list.get(i))) {
                        c8958 = new C8959(new NonUniqueResultException(list.size()));
                        break;
                    }
                    i++;
                }
