...
public final class SegmentedByteString extends ByteString {
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        target.getClass();
        long j = byteCount;
        AbstractC7739.m13066(size(), offset, j);
        AbstractC7739.m13066(target.length, targetOffset, j);
        int i = byteCount + offset;
        int iM10936 = AbstractC5571.m10936(this, offset);
        while (offset < i) {
            int i2 = iM10936 == 0 ? 0 : getDirectory()[iM10936 - 1];
            int i3 = getDirectory()[iM10936] - i2;
            int i4 = getDirectory()[getSegments().length + iM10936];
            int iMin = Math.min(i, i3 + i2) - offset;
            int i5 = (offset - i2) + i4;
            AbstractC4347.m8844(getSegments()[iM10936], targetOffset, target, i5, i5 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iM10936++;
        }
    ...
    public byte internalGet$okio(int pos) {
        AbstractC7739.m13066(getDirectory()[getSegments().length - 1], pos, 1L);
        int iM10936 = AbstractC5571.m10936(this, pos);
        return getSegments()[iM10936][(pos - (iM10936 == 0 ? 0 : getDirectory()[iM10936 - 1])) + getDirectory()[getSegments().length + iM10936]];
    }
    ...
    public boolean rangeEquals(int offset, byte[] other, int otherOffset, int byteCount) {
        ...
        while (offset < i) {
            ...
            int i4 = getDirectory()[getSegments().length + iM10936];
            int iMin = Math.min(i, i3 + i2) - offset;
            if (!AbstractC7739.m13067(getSegments()[iM10936], (offset - i2) + i4, other, otherOffset, iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        if (beginIndex < 0) {
            C5925.m11314(AbstractC0053.m162(beginIndex, "beginIndex=", " < 0"));
            return null;
        }
        if (endIndex > size()) {
            StringBuilder sbM150 = AbstractC0053.m150(endIndex, "endIndex=", " > length(");
            sbM150.append(size());
            sbM150.append(')');
        ...
        if (i < 0) {
            C5925.m11314(AbstractC6183.m11591(endIndex, beginIndex, "endIndex=", " < beginIndex="));
            return null;
        }
        ...
        int iM10936 = AbstractC5571.m10936(this, beginIndex);
        int iM109362 = AbstractC5571.m10936(this, endIndex - 1);
        byte[][] bArr = (byte[][]) AbstractC4347.m8831(getSegments(), iM10936, iM109362 + 1);
        ...
        int i5 = iM10936 != 0 ? getDirectory()[iM10936 - 1] : 0;
    ...
    public byte[] toByteArray() {
        ...
        while (i < length) {
            ...
            int i5 = getDirectory()[i];
            int i6 = i5 - i2;
            AbstractC4347.m8844(getSegments()[i], i3, bArr, i4, i4 + i6);
            i3 += i6;
            i++;
            i2 = i5;
        }
    ...
    public void write$okio(C6092 buffer, int offset, int byteCount) {
        ...
        while (offset < i) {
            ...
            int iMin = Math.min(i, i3 + i2) - offset;
            int i5 = (offset - i2) + i4;
            C6098 c6098 = new C6098(getSegments()[iM10936], i5, i5 + iMin, true);
            C6098 c60982 = buffer.f16648;
            if (c60982 == null) {
                c6098.f16670 = c6098;
                c6098.f16664 = c6098;
                buffer.f16648 = c6098;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        while (offset < i) {
            ...
            int i4 = getDirectory()[getSegments().length + iM10936];
            int iMin = Math.min(i, i3 + i2) - offset;
            if (!other.rangeEquals(otherOffset, getSegments()[iM10936], (offset - i2) + i4, iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
