...
public final class C8871 extends BaseAdapter {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final /* synthetic */ int f25016 = 0;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final ArrayList f25017;

    public C8871(ArrayList arrayList) {
        AbstractC8405.m13973("喵喵喵呜呜呜呜呜~喵喵喵呜呜呜喵喵~喵喵喵喵呜喵喵呜~喵喵喵呜呜呜喵喵");
        this.f25017 = arrayList;
    }

    @Override // android.widget.Adapter
    public final int getCount() {
        return this.f25017.size();
    }

    @Override // android.widget.Adapter
    public final Object getItem(int i) {
        return (String) this.f25017.get(i);
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ((TextView) viewInflate.findViewById(R.id.tv_text)).setText((String) this.f25017.get(i));
        return viewInflate;
    }
}
