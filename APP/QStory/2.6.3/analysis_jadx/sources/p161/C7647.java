...
public final class C7647 {
    ...
    public static final C7647 f20757;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public final float f20758;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final float f20759;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final float f20760;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final float f20761;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final float f20762;
    ...
    static {
        float[] fArr = AbstractC7642.f20737;
        float fM12903 = (float) ((((double) AbstractC7642.m12903()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC7642.f20739;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fM12903) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f9 = 1.0f / ((5.0f * fM12903) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fM12903) * 5.0d))) + (f10 * fM12903);
        float fM129032 = AbstractC7642.m12903() / fArr[1];
        double d2 = fM129032;
        ...
        f20757 = new C7647(fM129032, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public C7647(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f20758 = f;
        this.f20763 = f2;
        this.f20762 = f3;
        this.f20761 = f4;
