...
public final class Uuid implements Comparable<Uuid>, Serializable {
    public static final C5166 Companion = new C5166();
    ...
    private final <T> T toLongs(InterfaceC6554 action) {
        action.getClass();
        return (T) action.invoke(Long.valueOf(getMostSignificantBits()), Long.valueOf(getLeastSignificantBits()));
    }

    private final <T> T toULongs(InterfaceC6554 action) {
        action.getClass();
        return (T) action.invoke(new C5179(getMostSignificantBits()), new C5179(getLeastSignificantBits()));
    }
    ...
    public final String toHexDashString() {
        ...
        C8667.m14383(0, 0, 4, this.mostSignificantBits, bArr);
        bArr[8] = 45;
        C8667.m14383(9, 4, 6, this.mostSignificantBits, bArr);
        bArr[13] = 45;
        C8667.m14383(14, 6, 8, this.mostSignificantBits, bArr);
        bArr[18] = 45;
        C8667.m14383(19, 0, 2, this.leastSignificantBits, bArr);
        bArr[23] = 45;
        C8667.m14383(24, 2, 8, this.leastSignificantBits, bArr);
        return new String(bArr, AbstractC5132.f14688);
    }

    public final String toHexString() {
        byte[] bArr = new byte[32];
        C8667.m14383(0, 0, 8, this.mostSignificantBits, bArr);
        C8667.m14383(16, 0, 8, this.leastSignificantBits, bArr);
        return new String(bArr, AbstractC5132.f14688);
    }
    ...
    public final byte[] m10208toUByteArrayTcUX1vc() {
        byte[] byteArray = toByteArray();
        byteArray.getClass();
        return byteArray;
    }

    public /* synthetic */ Uuid(long j, long j2, AbstractC4385 abstractC4385) {
        this(j, j2);
    }
