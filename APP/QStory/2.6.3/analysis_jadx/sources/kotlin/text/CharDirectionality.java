...
public final class CharDirectionality {
    ...
    public static final C5133 Companion;
    private static final InterfaceC5184 directionalityMap$delegate;
    ...
    static {
        ...
        $ENTRIES = AbstractC4364.m8866(charDirectionalityArr$values);
        Companion = new C5133();
        directionalityMap$delegate = AbstractC5187.m10214(new C2558(16));
    }
    ...
    public static final Map directionalityMap_delegate$lambda$0() {
        ...
        int iM8772 = AbstractC4339.m8772(AbstractC4345.m8822(entries, 10));
        if (iM8772 < 16) {
            iM8772 = 16;
        }
