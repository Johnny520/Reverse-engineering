...
public final class KotlinClassHeader$Kind {
    ...
    public static final C6924 Companion;
    ...
    static {
        ...
        $ENTRIES = AbstractC4364.m8866(kotlinClassHeader$KindArr$values);
        Companion = new C6924();
        KotlinClassHeader$Kind[] kotlinClassHeader$KindArrValues = values();
        int iM8772 = AbstractC4339.m8772(kotlinClassHeader$KindArrValues.length);
