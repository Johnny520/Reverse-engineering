...
public final class C4889 extends AbstractC4878 {

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public final InterfaceC7254 f14204;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public final boolean f14205;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏世哲, reason: contains not printable characters */
    public final InterfaceC6558 f14206;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public final InterfaceC4873 f14207;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final List f14208;

    public C4889(InterfaceC4873 interfaceC4873, List list, boolean z, InterfaceC7254 interfaceC7254, InterfaceC6558 interfaceC6558) {
        interfaceC4873.getClass();
        list.getClass();
        interfaceC7254.getClass();
        this.f14207 = interfaceC4873;
        this.f14208 = list;
        this.f14205 = z;
        this.f14204 = interfaceC7254;
        this.f14206 = interfaceC6558;
        if (!(interfaceC7254 instanceof C7232) || (interfaceC7254 instanceof C7241)) {
            return;
        }
        throw new IllegalStateException("SimpleTypeImpl should not be created for error type: " + interfaceC7254 + '\n' + interfaceC4873);
    }
    ...
    public final AbstractC4882 mo9721(AbstractC4861 abstractC4861) {
        ...
        AbstractC4878 abstractC4878 = (AbstractC4878) this.f14206.invoke(abstractC4861);
        return abstractC4878 == null ? this : abstractC4878;
    }
    ...
    public final AbstractC4878 mo9770(C4874 c4874) {
        c4874.getClass();
        return c4874.isEmpty() ? this : new C4888(this, c4874);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractC4878
    /* JADX INFO: renamed from: 飘花落叶言子苏世兰楪哲 */
    public final AbstractC4878 mo9731(boolean z) {
        return z == this.f14205 ? this : z ? new C4879(this, 1) : new C4879(this, 0);
    }
