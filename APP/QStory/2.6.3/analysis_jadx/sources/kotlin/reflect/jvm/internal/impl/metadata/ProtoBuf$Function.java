...
public final class ProtoBuf$Function extends GeneratedMessageLite.ExtendableMessage<ProtoBuf$Function> {
    public static InterfaceC4699 PARSER = new C6917(12);
    ...
    */
    private ProtoBuf$Function(kotlin.reflect.jvm.internal.impl.protobuf.C4709 r22, kotlin.reflect.jvm.internal.impl.protobuf.C4726 r23) throws java.lang.Throwable {
        /*
    ...
    public static C6959 newBuilder(ProtoBuf$Function protoBuf$Function) {
        C6959 c6959NewBuilder = newBuilder();
        c6959NewBuilder.m12265(protoBuf$Function);
        return c6959NewBuilder;
    }

    public static ProtoBuf$Function parseFrom(InputStream inputStream, C4726 c4726) throws InvalidProtocolBufferException {
        ...
        try {
            ...
            return (ProtoBuf$Function) interfaceC4701;
    ...
    public int getSerializedSize() {
        ...
        for (int i3 = 0; i3 < this.valueParameter_.size(); i3++) {
            iM9362 += C4708.m9360(6, this.valueParameter_.get(i3));
        }
        if ((this.bitField0_ & 16) == 16) {
            iM9362 += C4708.m9362(7, this.returnTypeId_);
        }
        if ((this.bitField0_ & 64) == 64) {
            iM9362 += C4708.m9362(8, this.receiverTypeId_);
        }
        if ((this.bitField0_ & 1) == 1) {
            iM9362 += C4708.m9362(9, this.flags_);
        }
        for (int i4 = 0; i4 < this.contextReceiverType_.size(); i4++) {
            iM9362 += C4708.m9360(10, this.contextReceiverType_.get(i4));
        }
        int iM9361 = 0;
        for (int i5 = 0; i5 < this.contextReceiverTypeId_.size(); i5++) {
            iM9361 += C4708.m9361(this.contextReceiverTypeId_.get(i5).intValue());
        }
        ...
        for (int i6 = 0; i6 < this.annotation_.size(); i6++) {
            iM9360 += C4708.m9360(12, this.annotation_.get(i6));
        }
        for (int i7 = 0; i7 < this.contextParameter_.size(); i7++) {
            iM9360 += C4708.m9360(13, this.contextParameter_.get(i7));
        }
        ...
        for (int i8 = 0; i8 < this.versionRequirement_.size(); i8++) {
            iM93612 += C4708.m9361(this.versionRequirement_.get(i8).intValue());
        }
        int size = (getVersionRequirementList().size() * 2) + iM9360 + iM93612;
        if ((this.bitField0_ & 256) == 256) {
            size += C4708.m9360(32, this.contract_);
        }
        for (int i9 = 0; i9 < this.compilerPluginData_.size(); i9++) {
            size += C4708.m9360(33, this.compilerPluginData_.get(i9));
        }
        for (int i10 = 0; i10 < this.extensionReceiverAnnotation_.size(); i10++) {
            size += C4708.m9360(34, this.extensionReceiverAnnotation_.get(i10));
        }
    ...
    public void writeTo(C4708 c4708) throws IOException {
        ...
        for (int i2 = 0; i2 < this.valueParameter_.size(); i2++) {
            c4708.m9370(6, this.valueParameter_.get(i2));
        }
        if ((this.bitField0_ & 16) == 16) {
            c4708.m9378(7, this.returnTypeId_);
        }
        if ((this.bitField0_ & 64) == 64) {
            c4708.m9378(8, this.receiverTypeId_);
        }
        if ((this.bitField0_ & 1) == 1) {
            c4708.m9378(9, this.flags_);
        }
        for (int i3 = 0; i3 < this.contextReceiverType_.size(); i3++) {
            c4708.m9370(10, this.contextReceiverType_.get(i3));
        }
        ...
        for (int i4 = 0; i4 < this.contextReceiverTypeId_.size(); i4++) {
            c4708.m9371(this.contextReceiverTypeId_.get(i4).intValue());
        }
        for (int i5 = 0; i5 < this.annotation_.size(); i5++) {
            c4708.m9370(12, this.annotation_.get(i5));
        }
        for (int i6 = 0; i6 < this.contextParameter_.size(); i6++) {
            c4708.m9370(13, this.contextParameter_.get(i6));
        }
        if ((this.bitField0_ & 128) == 128) {
            c4708.m9370(30, this.typeTable_);
        }
        for (int i7 = 0; i7 < this.versionRequirement_.size(); i7++) {
            c4708.m9378(31, this.versionRequirement_.get(i7).intValue());
        }
        if ((this.bitField0_ & 256) == 256) {
            c4708.m9370(32, this.contract_);
        }
        for (int i8 = 0; i8 < this.compilerPluginData_.size(); i8++) {
            c4708.m9370(33, this.compilerPluginData_.get(i8));
        }
        for (int i9 = 0; i9 < this.extensionReceiverAnnotation_.size(); i9++) {
            c4708.m9370(34, this.extensionReceiverAnnotation_.get(i9));
        }
    ...
    private ProtoBuf$Function(AbstractC4721 abstractC4721) {
        super(abstractC4721);
