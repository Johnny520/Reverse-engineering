...
public final class KotlinTarget {
    ...
    public static final C6480 Companion;
    ...
    static {
        ...
        $ENTRIES = AbstractC4364.m8866(kotlinTargetArr$values);
        Companion = new C6480();
        map = new HashMap<>();
        ...
        DEFAULT_TARGET_SET = AbstractC4344.m8788(arrayList);
        ALL_TARGET_SET = AbstractC4344.m8788(getEntries());
        KotlinTarget kotlinTarget2 = ANNOTATION_CLASS;
        KotlinTarget kotlinTarget3 = CLASS;
        ANNOTATION_CLASS_LIST = AbstractC6347.m11931(kotlinTarget2, kotlinTarget3);
        LOCAL_CLASS_LIST = AbstractC6347.m11931(LOCAL_CLASS, kotlinTarget3);
        CLASS_LIST = AbstractC6347.m11931(CLASS_ONLY, kotlinTarget3);
        KotlinTarget kotlinTarget4 = COMPANION_OBJECT;
        KotlinTarget kotlinTarget5 = OBJECT;
        COMPANION_OBJECT_LIST = AbstractC6347.m11931(kotlinTarget4, kotlinTarget5, kotlinTarget3);
        OBJECT_LIST = AbstractC6347.m11931(STANDALONE_OBJECT, kotlinTarget5, kotlinTarget3);
        INTERFACE_LIST = AbstractC6347.m11931(INTERFACE, kotlinTarget3);
        ENUM_LIST = AbstractC6347.m11931(ENUM_CLASS, kotlinTarget3);
        KotlinTarget kotlinTarget6 = ENUM_ENTRY;
        KotlinTarget kotlinTarget7 = PROPERTY;
        KotlinTarget kotlinTarget8 = FIELD;
        ENUM_ENTRY_LIST = AbstractC6347.m11931(kotlinTarget6, kotlinTarget7, kotlinTarget8);
        KotlinTarget kotlinTarget9 = PROPERTY_SETTER;
        PROPERTY_SETTER_LIST = AbstractC6347.m11928(kotlinTarget9);
        KotlinTarget kotlinTarget10 = PROPERTY_GETTER;
        PROPERTY_GETTER_LIST = AbstractC6347.m11928(kotlinTarget10);
        FUNCTION_LIST = AbstractC6347.m11928(FUNCTION);
        KotlinTarget kotlinTarget11 = FILE;
        FILE_LIST = AbstractC6347.m11928(kotlinTarget11);
        AnnotationUseSiteTarget annotationUseSiteTarget = AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER;
        KotlinTarget kotlinTarget12 = VALUE_PARAMETER;
        USE_SITE_MAPPING = AbstractC4339.m8774(new Pair(annotationUseSiteTarget, kotlinTarget12), new Pair(AnnotationUseSiteTarget.FIELD, kotlinTarget8), new Pair(AnnotationUseSiteTarget.PROPERTY, kotlinTarget7), new Pair(AnnotationUseSiteTarget.FILE, kotlinTarget11), new Pair(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget10), new Pair(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget9), new Pair(AnnotationUseSiteTarget.RECEIVER, kotlinTarget12), new Pair(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget12), new Pair(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget8));
    }

    public /* synthetic */ KotlinTarget(String str, int i, String str2, boolean z, int i2, AbstractC4385 abstractC4385) {
