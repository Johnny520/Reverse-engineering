...
public final class ProtoBuf$Contract extends GeneratedMessageLite implements InterfaceC4700 {
    public static InterfaceC4699 PARSER = new C6917(8);
    ...
    private ProtoBuf$Contract(C4709 c4709, C4726 c4726) {
                ...
                try {
                    ...
                    if (iM9387 != 0) {
                        if (iM9387 == 10) {
                            ...
                            this.effect_.add((ProtoBuf$Effect) c4709.m9380(ProtoBuf$Effect.PARSER, c4726));
    ...
    public int getSerializedSize() {
        ...
        for (int i2 = 0; i2 < this.effect_.size(); i2++) {
            iM9360 += C4708.m9360(1, this.effect_.get(i2));
        }
    ...
    public void writeTo(C4708 c4708) throws IOException {
        ...
        for (int i = 0; i < this.effect_.size(); i++) {
            c4708.m9370(1, this.effect_.get(i));
        }
    ...
    public static C6948 newBuilder(ProtoBuf$Contract protoBuf$Contract) {
        C6948 c6948NewBuilder = newBuilder();
        c6948NewBuilder.m12240(protoBuf$Contract);
        return c6948NewBuilder;
    }

    private ProtoBuf$Contract(AbstractC4729 abstractC4729) {
        super(abstractC4729);
        this.memoizedIsInitialized = (byte) -1;
        this.memoizedSerializedSize = -1;
