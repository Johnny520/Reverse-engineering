...
final class KotlinRandom extends Random {
    private static final C4403 Companion = new C4403();
    private static final long serialVersionUID = 0;
    private final AbstractC4401 impl;
    private boolean seedInitialized;

    public KotlinRandom(AbstractC4401 abstractC4401) {
        abstractC4401.getClass();
        this.impl = abstractC4401;
    }

    public final AbstractC4401 getImpl() {
        return this.impl;
    }
    ...
    public void setSeed(long seed) {
        if (this.seedInitialized) {
            C5925.m11308("Setting seed is not supported.");
        } else {
