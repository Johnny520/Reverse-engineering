...
final class SafePublicationLazyImpl<T> implements InterfaceC5184, Serializable {
    public static final C5186 Companion = new C5186();
    private static final AtomicReferenceFieldUpdater<SafePublicationLazyImpl<?>, Object> valueUpdater = AtomicReferenceFieldUpdater.newUpdater(SafePublicationLazyImpl.class, Object.class, "_value");
    private volatile Object _value;
    private final Object final;
    private volatile InterfaceC6543 initializer;

    public SafePublicationLazyImpl(InterfaceC6543 interfaceC6543) {
    ...
    public T getValue() {
        ...
        if (interfaceC6543 != null) {
            T t = (T) interfaceC6543.invoke();
            AtomicReferenceFieldUpdater<SafePublicationLazyImpl<?>, Object> atomicReferenceFieldUpdater = valueUpdater;
            while (!atomicReferenceFieldUpdater.compareAndSet((SafePublicationLazyImpl<?>) this, c5174, t)) {
                if (atomicReferenceFieldUpdater.get((SafePublicationLazyImpl<?>) this) != c5174) {
                }
            }
