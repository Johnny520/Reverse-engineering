...
public final class ListBuilder<E> extends AbstractC4348 implements List<E>, RandomAccess, Serializable {
    private static final C4317 Companion = new C4317();
    ...
    private final boolean contentEquals(List<?> other) {
        ...
        if (i == other.size()) {
            for (int i2 = 0; i2 < i; i2++) {
                if (AbstractC4395.m8907(eArr[i2], other.get(i2))) {
                }
            }
            return true;
        }
    ...
    private final void ensureCapacityInternal(int minCapacity) {
        ...
        if (minCapacity > eArr.length) {
            ...
            c4333.getClass();
            int iM8761 = C4333.m8761(length, minCapacity);
            E[] eArr2 = this.backing;
            eArr2.getClass();
            this.backing = (E[]) Arrays.copyOf(eArr2, iM8761);
        }
    }
    ...
    private final void insertAtInternal(int i, int n) {
        ...
        E[] eArr = this.backing;
        AbstractC4347.m8835(i + n, i, eArr, this.length, eArr);
        this.length += n;
    }
    ...
    public final E removeAtInternal(int i) {
        ...
        E[] eArr = this.backing;
        E e = eArr[i];
        AbstractC4347.m8835(i, i + 1, eArr, this.length, eArr);
        E[] eArr2 = this.backing;
    ...
    public final void removeRangeInternal(int rangeOffset, int rangeLength) {
        ...
        E[] eArr = this.backing;
        AbstractC4347.m8835(rangeOffset, rangeOffset + rangeLength, eArr, this.length, eArr);
        E[] eArr2 = this.backing;
        int i = this.length;
        AbstractC8175.m13628(eArr2, i - rangeLength, i);
    ...
    public final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        AbstractC4347.m8835(rangeOffset + i2, rangeLength + rangeOffset, eArr, this.length, eArr);
        E[] eArr3 = this.backing;
        int i5 = this.length;
        AbstractC8175.m13628(eArr3, i5 - i4, i5);
        if (i4 > 0) {
            registerModification();
        }
        this.length -= i4;
    ...
    public int indexOf(Object element) {
        for (int i = 0; i < this.length; i++) {
            if (AbstractC4395.m8907(this.backing[i], element)) {
                return i;
            }
        }
        return -1;
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        int i = this.length;
        c4333.getClass();
        C4333.m8762(fromIndex, toIndex, i);
    ...
    public <T> T[] toArray(T[] array) {
        ...
        AbstractC4347.m8835(0, 0, eArr, i, array);
        int i2 = this.length;
        if (i2 < array.length) {
            array[i2] = null;
        }
    ...
    public String toString() {
        return AbstractC8175.m13647(this.backing, 0, this.length, this);
    }
    ...
    public /* synthetic */ ListBuilder(int i, int i2, AbstractC4385 abstractC4385) {
        this((i2 & 1) != 0 ? 10 : i);
    }
    ...
    public static final class BuilderSubList<E> extends AbstractC4348 implements List<E>, RandomAccess, Serializable {
        private E[] backing;
        private int length;
        ...
        private final boolean contentEquals(List<?> other) {
            ...
            if (i2 == other.size()) {
                for (int i3 = 0; i3 < i2; i3++) {
                    if (AbstractC4395.m8907(eArr[i + i3], other.get(i3))) {
                    }
                }
                return true;
            }
        ...
        public int indexOf(Object element) {
            checkForComodification();
            for (int i = 0; i < this.length; i++) {
                if (AbstractC4395.m8907(this.backing[this.offset + i], element)) {
                    return i;
                }
            }
            return -1;
        ...
        public <T> T[] toArray(T[] array) {
            ...
            AbstractC4347.m8835(0, i2, eArr, i + i2, array);
            int i3 = this.length;
            if (i3 < array.length) {
                array[i3] = null;
            }
        ...
        public String toString() {
            checkForComodification();
            return AbstractC8175.m13647(this.backing, this.offset, this.length, this);
        }
        ...
        public Object[] toArray() {
            ...
            E[] eArr = this.backing;
            int i = this.offset;
            return AbstractC4347.m8831(eArr, i, this.length + i);
        }
    }
    ...
    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public Object[] toArray() {
        return AbstractC4347.m8831(this.backing, 0, this.length);
    }
}
