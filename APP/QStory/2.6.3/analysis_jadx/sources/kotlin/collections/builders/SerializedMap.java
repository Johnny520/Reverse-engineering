...
final class SerializedMap implements Externalizable {
    public static final C4323 Companion = new C4323();
    ...
    public void readExternal(ObjectInput input) throws IOException {
        ...
        if (b != 0) {
            throw new InvalidObjectException(AbstractC6183.m11588(b, "Unsupported flags value: "));
        }
        int i = input.readInt();
        if (i < 0) {
            C4211.m8598(i, "Illegal size value: ");
            return;
        }
