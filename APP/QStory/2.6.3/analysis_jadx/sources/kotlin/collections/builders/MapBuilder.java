...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, InterfaceC6563 {
    public static final C4316 Companion = new C4316();
    private static final MapBuilder Empty;
    private static final int INITIAL_CAPACITY = 8;
    private static final int INITIAL_MAX_PROBE_DISTANCE = 2;
    private static final int MAGIC = -1640531527;
    private static final int TOMBSTONE = -1;
    private C4320 entriesView;
    private int[] hashArray;
    private int hashShift;
    private boolean isReadOnly;
    private K[] keysArray;
    private C4324 keysView;
    private int length;
    ...
    public MapBuilder(int i) {
        if (i < 0) {
            C5925.m11310("capacity must be non-negative.");
            throw null;
        }
    ...
    private final void compact(boolean updateHashArray) {
        ...
        AbstractC8175.m13628(this.keysArray, i3, i);
        if (vArr != null) {
            AbstractC8175.m13628(vArr, i3, this.length);
        }
        this.length = i3;
    }
    ...
    private final void ensureCapacity(int minCapacity) {
        ...
        if (minCapacity > getCapacity$kotlin_stdlib()) {
            ...
            int capacity$kotlin_stdlib = getCapacity$kotlin_stdlib();
            c4333.getClass();
            int iM8761 = C4333.m8761(capacity$kotlin_stdlib, minCapacity);
            K[] kArr = this.keysArray;
            kArr.getClass();
            this.keysArray = (K[]) Arrays.copyOf(kArr, iM8761);
            V[] vArr = this.valuesArray;
            this.valuesArray = vArr != null ? (V[]) Arrays.copyOf(vArr, iM8761) : null;
            this.presenceArray = Arrays.copyOf(this.presenceArray, iM8761);
            Companion.getClass();
            if (iM8761 < 1) {
                iM8761 = 1;
            }
            int iHighestOneBit = Integer.highestOneBit(iM8761 * 3);
    ...
    private final int findKey(K key) {
        ...
        while (true) {
            ...
            int i3 = i2 - 1;
            if (AbstractC4395.m8907(this.keysArray[i3], key)) {
                return i3;
            }
            i--;
            if (i < 0) {
    ...
    private final int findValue(V value) {
        ...
        while (true) {
            ...
            if (this.presenceArray[i] >= 0) {
                V[] vArr = this.valuesArray;
                vArr.getClass();
                if (AbstractC4395.m8907(vArr[i], value)) {
                    return i;
                }
            }
        }
    ...
    private final boolean putEntry(Map.Entry<? extends K, ? extends V> entry) {
        ...
        if (AbstractC4395.m8907(entry.getValue(), vArrAllocateValuesArray[i])) {
            return false;
        }
    ...
    private final void rehash(int newHashSize) {
        ...
        while (i < this.length) {
            int i2 = i + 1;
            if (!putRehash(i)) {
                C5925.m11311("This cannot happen with fixed magic multiplier and grow-only hash array. Have object hashCodes changed?");
                return;
            }
            i = i2;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i3 == 0) {
                    ...
                    if (AbstractC4395.m8907(this.keysArray[i3 - 1], key)) {
                        return -i3;
                    }
                    i2++;
                    if (i2 > i) {
    ...
    public void clear() {
        ...
        AbstractC8175.m13628(this.keysArray, 0, this.length);
        V[] vArr = this.valuesArray;
        if (vArr != null) {
            AbstractC8175.m13628(vArr, 0, this.length);
        }
        this.size = 0;
        this.length = 0;
        registerModification();
    ...
    public final boolean containsEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        ...
        V[] vArr = this.valuesArray;
        vArr.getClass();
        return AbstractC4395.m8907(vArr[iFindKey], entry.getValue());
    }
    ...
    public final C4315 entriesIterator$kotlin_stdlib() {
        return new C4315(this);
    }
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        C4320 c4320 = this.entriesView;
        if (c4320 != null) {
            return c4320;
        }
        C4320 c43202 = new C4320(this);
        this.entriesView = c43202;
        return c43202;
    }

    public Set<K> getKeys() {
        C4324 c4324 = this.keysView;
        if (c4324 != null) {
            return c4324;
        }
        C4324 c43242 = new C4324(this);
        this.keysView = c43242;
        return c43242;
    }
    ...
    public Collection<V> getValues() {
        C4325 c4325 = this.valuesView;
        if (c4325 != null) {
            return c4325;
        }
        C4325 c43252 = new C4325(this);
        this.valuesView = c43252;
        return c43252;
    }

    @Override // java.util.Map
    public int hashCode() {
        C4315 c4315EntriesIterator$kotlin_stdlib = entriesIterator$kotlin_stdlib();
        int i = 0;
        while (c4315EntriesIterator$kotlin_stdlib.hasNext()) {
            int i2 = c4315EntriesIterator$kotlin_stdlib.f6467;
            MapBuilder mapBuilder = (MapBuilder) c4315EntriesIterator$kotlin_stdlib.f6464;
            if (i2 >= mapBuilder.length) {
                C2633.m5336();
                return 0;
            }
            int i3 = c4315EntriesIterator$kotlin_stdlib.f6467;
            c4315EntriesIterator$kotlin_stdlib.f6467 = i3 + 1;
            c4315EntriesIterator$kotlin_stdlib.f6465 = i3;
            Object obj = mapBuilder.keysArray[c4315EntriesIterator$kotlin_stdlib.f6465];
            int iHashCode = obj != null ? obj.hashCode() : 0;
            Object[] objArr = mapBuilder.valuesArray;
            objArr.getClass();
            Object obj2 = objArr[c4315EntriesIterator$kotlin_stdlib.f6465];
            int iHashCode2 = obj2 != null ? obj2.hashCode() : 0;
            c4315EntriesIterator$kotlin_stdlib.m3997();
    ...
    public final C4313 keysIterator$kotlin_stdlib() {
        return new C4313(this);
    }
    ...
    public final boolean removeEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        ...
        V[] vArr = this.valuesArray;
        vArr.getClass();
        if (!AbstractC4395.m8907(vArr[iFindKey], entry.getValue())) {
            return false;
        }
        removeEntryAt(iFindKey);
        return true;
    ...
    public final C4321 valuesIterator$kotlin_stdlib() {
        return new C4321(this);
    }
