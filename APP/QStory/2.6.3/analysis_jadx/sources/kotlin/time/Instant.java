...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public static final C5153 Companion = new C5153();
    ...
    public Instant(long j, int i) {
        ...
        if (-31557014167219200L > j || j >= 31556889864403200L) {
            C5925.m11310("Instant exceeds minimum or maximum instant");
            throw null;
        }
    }
    ...
    public int compareTo(Instant other) {
        other.getClass();
        int iM8904 = AbstractC4395.m8904(this.epochSeconds, other.epochSeconds);
        return iM8904 != 0 ? iM8904 : AbstractC4395.m8905(this.nanosecondsOfSecond, other.nanosecondsOfSecond);
    }
    ...
    public final Instant m10183minusLRDsOJo(long duration) {
        return m10185plusLRDsOJo(C5157.m10193(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m10184minusUwyO8pc(Instant other) {
        other.getClass();
        C8623 c8623 = C5157.f14712;
        return C5157.m10194(AbstractC5160.m10207(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS), AbstractC5160.m10206(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }

    /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
    public final Instant m10185plusLRDsOJo(long duration) {
        C8623 c8623 = C5157.f14712;
        long jM10196 = C5157.m10196(duration, DurationUnit.SECONDS);
        int iM10188 = C5157.m10188(duration);
        if (jM10196 == 0 && iM10188 == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM10196;
        if ((j ^ j2) < 0 && (jM10196 ^ j) >= 0) {
            return duration > 0 ? MAX : MIN;
        }
        int i = this.nanosecondsOfSecond + iM10188;
        Companion.getClass();
        return C5153.m10186(i, j2);
    }
    ...
    public String toString() {
        ...
        AbstractC5160.m10199(sb, sb, i4);
        sb.append(SignatureVisitor.SUPER);
        AbstractC5160.m10199(sb, sb, i5);
        sb.append('T');
        AbstractC5160.m10199(sb, sb, i7);
        sb.append(':');
        AbstractC5160.m10199(sb, sb, i9);
        sb.append(':');
        AbstractC5160.m10199(sb, sb, i10);
        if (nanosecondsOfSecond != 0) {
            sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
            while (true) {
                int i12 = i11 + 1;
                iArr = AbstractC5160.f14722;
