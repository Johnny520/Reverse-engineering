...
class BSHBinaryExpression extends SimpleNode implements InterfaceC2615 {
    public int kind;
    ...
    private Variable getVariableAtNode(int i, CallStack callStack) {
        ...
        InterfaceC2619 interfaceC2619JjtGetChild = jjtGetChild(i).jjtGetChild(0);
        if (interfaceC2619JjtGetChild instanceof BSHAmbiguousName) {
            return callStack.top().getVariableImpl(((BSHAmbiguousName) interfaceC2619JjtGetChild).text, true);
        }
        return null;
    }
    ...
    private boolean isComparableTypes(Class<?> cls, Class<?> cls2, CallStack callStack) throws EvalException {
        ...
        throw new EvalException("incomparable types: " + AbstractC2629.m5325(cls) + " and " + AbstractC2629.m5325(cls2), this, callStack);
    }
