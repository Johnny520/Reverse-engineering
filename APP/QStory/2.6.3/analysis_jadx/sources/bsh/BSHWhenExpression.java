...
class BSHWhenExpression extends SimpleNode implements InterfaceC2615 {
        ...
        if (obj != primitive && obj2 != primitive) {
            ...
            if (obj != null && obj2 != null) {
                ...
                try {
                    ...
                    throw e.toEvalError("When value: " + interfaceC2619.getText() + ": ", this, callStack);
                }
            }
            if (obj == obj2) {
                return true;
    ...
    public Object eval(CallStack callStack, Interpreter interpreter) throws EvalException {
        ...
        for (int i2 = 1; i2 < iJjtGetNumChildren; i2++) {
            ...
            for (int i3 = 0; i3 < bSHWhenEntry.numConditions; i3++) {
                if (primitiveEquals(objEval, bSHWhenEntry.jjtGetChild(i3).eval(callStack, interpreter), callStack, interfaceC2619JjtGetChild)) {
                    return bSHWhenEntry.evalResult(callStack, interpreter);
                }
            }
        }
    ...
    public String toString() {
        return AbstractC0053.m151(new StringBuilder(), super.toString(), ": when");
    }
}
