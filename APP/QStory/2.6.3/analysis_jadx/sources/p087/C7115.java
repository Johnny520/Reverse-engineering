...
public final class C7115 extends AbstractC7128 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public int f19050;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public double[] f19051;
    ...
    public final void mo12395(int i) {
        double[] dArr = this.f19051;
        if (dArr.length < i) {
            int length = dArr.length * 2;
            if (i < length) {
                i = length;
            }
            this.f19051 = Arrays.copyOf(dArr, i);
        }
    }
    ...
    public final Object mo12396() {
        return Arrays.copyOf(this.f19051, this.f19050);
    }
}
