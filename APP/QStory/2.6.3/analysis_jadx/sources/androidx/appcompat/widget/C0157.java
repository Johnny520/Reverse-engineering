    ...
    public final void mo324() {
        ...
        switch (i) {
            ...
            default:
                int i2 = this.f640 + 1;
                this.f640 = i2;
                C7818 c7818 = (C7818) obj;
                if (i2 == c7818.f21337.size()) {
                    InterfaceC2283 interfaceC2283 = c7818.f21334;
    ...
    public final void mo325() {
        ...
        switch (i) {
            ...
            default:
                if (!this.f637) {
                    this.f637 = true;
                    InterfaceC2283 interfaceC2283 = ((C7818) obj).f21334;
                    if (interfaceC2283 != null) {
                        interfaceC2283.mo325();
                    }
                    break;
                }
                break;
