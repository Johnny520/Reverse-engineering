...
public final class C0115 extends C0182 implements InterfaceC0228 {
    ...
    public final void m515() {
        ...
        int i2 = c0227.f856;
        if (i2 == -2) {
            int iM731 = c0227.m731(this.f537, c0134.getBackground());
            int i3 = (c0227.getContext().getResources().getDisplayMetrics().widthPixels - rect.left) - rect.right;
            if (iM731 > i3) {
                iM731 = i3;
            }
            m647(Math.max(iM731, (width - paddingLeft) - paddingRight));
        } else if (i2 == -1) {
            m647((width - paddingLeft) - paddingRight);
        } else {
            m647(i2);
        }
