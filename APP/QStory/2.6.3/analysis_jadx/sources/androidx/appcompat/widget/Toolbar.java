...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = AbstractC7773.f21092;
        C0108 c0108M354 = C0108.m354(R.attr.toolbarStyle, 0, context2, attributeSet, iArr);
        AbstractC2270.m4243(this, context, iArr, attributeSet, (TypedArray) c0108M354.f320, R.attr.toolbarStyle);
        ...
        if (dimensionPixelOffset6 != Integer.MIN_VALUE || dimensionPixelOffset7 != Integer.MIN_VALUE) {
            c0149.m603(dimensionPixelOffset6, dimensionPixelOffset7);
        }
        ...
        Drawable drawableM390 = c0108M354.m390(16);
        if (drawableM390 != null) {
            setNavigationIcon(drawableM390);
        }
        CharSequence text3 = typedArray.getText(15);
        if (!TextUtils.isEmpty(text3)) {
            setNavigationContentDescription(text3);
        }
        Drawable drawableM3902 = c0108M354.m390(11);
        if (drawableM3902 != null) {
            setLogo(drawableM3902);
        }
        ...
        if (typedArray.hasValue(29)) {
            setTitleTextColor(c0108M354.m385(29));
        }
        if (typedArray.hasValue(20)) {
            setSubtitleTextColor(c0108M354.m385(20));
        }
    ...
    private MenuInflater getMenuInflater() {
        return new C7817(getContext());
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public static C0160 m489() {
    ...
    public static int m491(View view) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        return marginLayoutParams.topMargin + marginLayoutParams.bottomMargin;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰, reason: contains not printable characters */
    public static C0160 m492(ViewGroup.LayoutParams layoutParams) {
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        c0160.f647 = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC7773.f21088);
    ...
    public int getCurrentContentInsetEnd() {
        ...
        return (actionMenuView == null || (menuC7802 = actionMenuView.f461) == null || !menuC7802.hasVisibleItems()) ? getContentInsetEnd() : Math.max(getContentInsetEnd(), Math.max(this.f488, 0));
    }
    ...
    */
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (m499(this.f504)) {
            m500(this.f504, i, 0, i2, this.f491);
            iM490 = m490(this.f504) + this.f504.getMeasuredWidth();
            iMax = Math.max(0, m491(this.f504) + this.f504.getMeasuredHeight());
        ...
        if (m499(this.f505)) {
            m500(this.f505, i, 0, i2, this.f491);
            iM490 = m490(this.f505) + this.f505.getMeasuredWidth();
            iMax = Math.max(iMax, m491(this.f505) + this.f505.getMeasuredHeight());
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, this.f505.getMeasuredState());
        }
        int currentContentInsetStart = getCurrentContentInsetStart();
        int iMax3 = Math.max(currentContentInsetStart, iM490);
        int iMax4 = Math.max(0, currentContentInsetStart - iM490);
        Object[] objArr2 = objArr;
        int[] iArr = this.f479;
        iArr[objArr2 == true ? 1 : 0] = iMax4;
        if (m499(this.f511)) {
            m500(this.f511, i, iMax3, i2, this.f491);
            iM4902 = m490(this.f511) + this.f511.getMeasuredWidth();
            iMax = Math.max(iMax, m491(this.f511) + this.f511.getMeasuredHeight());
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, this.f511.getMeasuredState());
        } else {
            iM4902 = 0;
        }
        int currentContentInsetEnd = getCurrentContentInsetEnd();
        int iMax5 = iMax3 + Math.max(currentContentInsetEnd, iM4902);
        iArr[c] = Math.max(0, currentContentInsetEnd - iM4902);
        if (m499(this.f506)) {
            iMax5 += m506(this.f506, i, iMax5, i2, 0, iArr);
            iMax = Math.max(iMax, m491(this.f506) + this.f506.getMeasuredHeight());
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, this.f506.getMeasuredState());
        }
        if (m499(this.f503)) {
            iMax5 += m506(this.f503, i, iMax5, i2, 0, iArr);
            iMax = Math.max(iMax, m491(this.f503) + this.f503.getMeasuredHeight());
            iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, this.f503.getMeasuredState());
        }
        int childCount = getChildCount();
        for (int i4 = 0; i4 < childCount; i4++) {
            View childAt = getChildAt(i4);
            if (((C0160) childAt.getLayoutParams()).f646 == 0 && m499(childAt)) {
                iMax5 += m506(childAt, i, iMax5, i2, 0, iArr);
                int iMax6 = Math.max(iMax, m491(childAt) + childAt.getMeasuredHeight());
        ...
        if (m499(this.f509)) {
            m506(this.f509, i, i5 + i7, i2, i6, iArr);
            int iM4903 = m490(this.f509) + this.f509.getMeasuredWidth();
            iM491 = m491(this.f509) + this.f509.getMeasuredHeight();
        ...
        if (m499(this.f510)) {
            iMax2 = Math.max(iMax2, m506(this.f510, i, i5 + i7, i2, i6 + iM491, iArr));
            iM491 += m491(this.f510) + this.f510.getMeasuredHeight();
            iCombineMeasuredStates2 = View.combineMeasuredStates(iCombineMeasuredStates2, this.f510.getMeasuredState());
        }
        int iMax7 = Math.max(iMax, iM491);
        ...
        for (int i8 = 0; i8 < childCount2; i8++) {
            ...
            if (m499(childAt2) && childAt2.getMeasuredWidth() > 0 && childAt2.getMeasuredHeight() > 0) {
                i3 = iResolveSizeAndState2;
                break;
            }
        }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        ActionMenuView actionMenuView = this.f511;
        MenuC7802 menuC7802 = actionMenuView != null ? actionMenuView.f461 : null;
        int i = savedState.f526;
        if (i != 0 && this.f522 != null && menuC7802 != null && (menuItemFindItem = menuC7802.findItem(i)) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        if (c0159 != null && (c7800 = c0159.f643) != null) {
            savedState.f526 = c7800.f21244;
        }
        savedState.f525 = m507();
        return savedState;
    }
    ...
    public void setNavigationContentDescription(CharSequence charSequence) {
        ...
        if (c0126 != null) {
            c0126.setContentDescription(charSequence);
            AbstractC0147.m601(this.f504, charSequence);
        }
    }
    ...
    public final void m493() {
        if (this.f511 == null) {
            ...
            C0160 c0160M489 = m489();
            c0160M489.f647 = (this.f492 & 112) | 8388613;
            this.f511.setLayoutParams(c0160M489);
            m497(this.f511, false);
        }
    }
    ...
    public final void m494() {
        ...
        if (actionMenuView.f461 == null) {
            MenuC7802 menuC7802 = (MenuC7802) actionMenuView.getMenu();
            if (this.f522 == null) {
                this.f522 = new C0159(this);
            }
            this.f511.setExpandedActionViewsExclusive(true);
            menuC7802.m13155(this.f522, this.f496);
            m502();
        }
    }
    ...
    public final void m496() {
        if (this.f505 == null) {
            ...
            C0160 c0160M489 = m489();
            c0160M489.f647 = (this.f492 & 112) | 8388611;
            c0160M489.f646 = 2;
            this.f505.setLayoutParams(c0160M489);
            this.f505.setOnClickListener(new ViewOnClickListenerC0086(this, 2));
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final void m497(View view, boolean z) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        C0160 c0160M489 = layoutParams == null ? m489() : !checkLayoutParams(layoutParams) ? m492(layoutParams) : (C0160) layoutParams;
        c0160M489.f646 = 1;
        if (!z || this.f506 == null) {
            addView(view, c0160M489);
        } else {
            view.setLayoutParams(c0160M489);
            this.f483.add(view);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final void m498(int i, ArrayList arrayList) {
        ...
        for (int i4 = childCount - 1; i4 >= 0; i4--) {
            ...
            if (c01602.f646 == 0 && m499(childAt2)) {
                int i5 = c01602.f647;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public final boolean m499(View view) {
        return (view == null || view.getParent() != this || view.getVisibility() == 8) ? false : true;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public final void m500(View view, int i, int i2, int i3, int i4) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public final boolean m501() {
        C0197 c0197;
        ActionMenuView actionMenuView = this.f511;
        return (actionMenuView == null || (c0197 = actionMenuView.f457) == null || !c0197.m703()) ? false : true;
    }
    ...
    public final void m502() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            OnBackInvokedDispatcher onBackInvokedDispatcherM589 = AbstractC0139.m589(this);
            C0159 c0159 = this.f522;
            int i = 0;
            boolean z = (c0159 == null || c0159.f643 == null || onBackInvokedDispatcherM589 == null || !isAttachedToWindow() || !this.f512) ? false : true;
            if (z && this.f513 == null) {
                if (this.f514 == null) {
                    this.f514 = AbstractC0139.m588(new RunnableC0142(this, i));
                }
                AbstractC0139.m587(onBackInvokedDispatcherM589, this.f514);
                this.f513 = onBackInvokedDispatcherM589;
                return;
            }
            if (z || (onBackInvokedDispatcher = this.f513) == null) {
                return;
            }
            AbstractC0139.m586(onBackInvokedDispatcher, this.f514);
            this.f513 = null;
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪哲世兰苏, reason: contains not printable characters */
    public final boolean m503(View view) {
    ...
    public final void m504() {
        ...
        getMenuInflater();
        Iterator it2 = this.f480.f6559.iterator();
        while (it2.hasNext()) {
            ((C2325) ((InterfaceC2253) it2.next())).f6826.m4407();
        }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public final int m505(View view, int i, int i2, int[] iArr) {
        C0160 c0160 = (C0160) view.getLayoutParams();
        int i3 = ((ViewGroup.MarginLayoutParams) c0160).rightMargin - iArr[1];
        int iMax = i - Math.max(0, i3);
        iArr[1] = Math.max(0, -i3);
        int iM510 = m510(view, i2);
        int measuredWidth = view.getMeasuredWidth();
        view.layout(iMax - measuredWidth, iM510, iMax, view.getMeasuredHeight() + iM510);
        return iMax - (measuredWidth + ((ViewGroup.MarginLayoutParams) c0160).leftMargin);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final int m506(View view, int i, int i2, int i3, int i4, int[] iArr) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final int m508(View view, int i, int i2, int[] iArr) {
        C0160 c0160 = (C0160) view.getLayoutParams();
        ...
        int iM510 = m510(view, i2);
        int measuredWidth = view.getMeasuredWidth();
        view.layout(iMax, iM510, iMax + measuredWidth, view.getMeasuredHeight() + iM510);
    ...
    public final void m509() {
        if (this.f504 == null) {
            ...
            C0160 c0160M489 = m489();
            c0160M489.f647 = (this.f492 & 112) | 8388611;
            this.f504.setLayoutParams(c0160M489);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public final int m510(View view, int i) {
        C0160 c0160 = (C0160) view.getLayoutParams();
    ...
    public void setCollapseIcon(int i) {
        setCollapseIcon(AbstractC3933.m8312(getContext(), i));
    }
    ...
    public void setNavigationIcon(int i) {
        setNavigationIcon(AbstractC3933.m8312(getContext(), i));
    }

    public void setLogo(int i) {
        setLogo(AbstractC3933.m8312(getContext(), i));
    }
