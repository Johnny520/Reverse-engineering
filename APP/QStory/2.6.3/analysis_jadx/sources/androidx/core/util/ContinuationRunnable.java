...
final class ContinuationRunnable extends AtomicBoolean implements Runnable {
    private final InterfaceC4357<C5176> continuation;

    /* JADX WARN: Multi-variable type inference failed */
    public ContinuationRunnable(InterfaceC4357<? super C5176> interfaceC4357) {
        super(false);
    ...
    public void run() {
        if (compareAndSet(false, true)) {
            this.continuation.resumeWith(Result.m8745constructorimpl(C5176.f14739));
        }
    }
