...
public final class C0350 implements InterfaceC1333 {
    ...
    public C0350(InterfaceC0358 interfaceC0358, Object obj, AbstractC0343 abstractC0343, long j, long j2, boolean z) {
        AbstractC0343 abstractC0343M1026;
        this.f1201 = interfaceC0358;
        this.f1199 = AbstractC1367.m2474(obj);
        if (abstractC0343 != null) {
            abstractC0343M1026 = AbstractC0330.m1026(abstractC0343);
        } else {
            abstractC0343M1026 = (AbstractC0343) interfaceC0358.mo1062().invoke(obj);
            abstractC0343M1026.mo1038();
        }
        this.f1200 = abstractC0343M1026;
        this.f1197 = j;
        this.f1196 = j2;
        this.f1198 = z;
    }
    ...
    public final String toString() {
        return "AnimationState(value=" + ((AbstractC1347) this.f1199).getValue() + ", velocity=" + m1047() + ", isRunning=" + this.f1198 + ", lastFrameTimeNanos=" + this.f1197 + ", finishedTimeNanos=" + this.f1196 + ')';
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final Object m1047() {
        return this.f1201.mo1061().invoke(this.f1200);
    }
