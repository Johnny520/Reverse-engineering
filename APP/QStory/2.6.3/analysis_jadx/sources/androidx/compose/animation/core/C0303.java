...
public final class C0303 implements InterfaceC0338 {
    ...
    public final C0319 mo927(InterfaceC0358 interfaceC0358) {
        int[] iArr;
        Object[] objArr;
        int[] iArr2;
        Object[] objArr2;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            iArr2 = iArr3;
                            objArr2 = objArr3;
                            c02462.m790(i7, new C0324((AbstractC0343) interfaceC0358.mo1062().invoke(c0313.f1052), c0313.f1051));
                        } else {
                            iArr2 = iArr3;
                            objArr2 = objArr3;
                            i = i3;
        ...
        if (!c0246.m834(0)) {
            ...
            int i9 = c0247.f985;
            if (i9 != 0) {
                AbstractC4347.m8836(1, 0, i9, iArr4, iArr4);
            }
            iArr4[0] = 0;
            c0247.f985++;
        }
        if (!c0246.m834(c0312.f1050)) {
            c0247.m795(c0312.f1050);
        }
        int i10 = c0247.f985;
        if (i10 != 0) {
