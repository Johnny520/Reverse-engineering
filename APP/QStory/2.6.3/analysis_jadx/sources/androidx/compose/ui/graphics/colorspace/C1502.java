...
public final class C1502 extends AbstractC1490 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final /* synthetic */ int f4280;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ C1502(int i, int i2, long j, String str) {
        super(i, j, str);
        this.f4280 = i2;
    }
    ...
    public final long mo2661(float f, float f2, float f3, float f4, AbstractC1490 abstractC1490) {
        switch (this.f4280) {
            case 0:
                float[] fArr = AbstractC1501.f4275;
                float f5 = f / fArr[0];
                float f6 = f2 / fArr[1];
                float f7 = f3 / fArr[2];
                ...
                return AbstractC1581.m2883(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, abstractC1490);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return AbstractC1581.m2883(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, abstractC1490);
        }
    }
    ...
    public final float mo2662(float f, float f2, float f3) {
        switch (this.f4280) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * AbstractC1501.f4275[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
