...
@InterfaceC6862(c = "androidx.compose.foundation.gestures.DragGestureDetectorKt$awaitLongPressOrCancellation$2", f = "DragGestureDetector.kt", l = {1079, 1101}, m = "invokeSuspend", v = 1)
...
final class DragGestureDetectorKt$awaitLongPressOrCancellation$2 extends RestrictedSuspendLambda implements InterfaceC6554 {
    ...
    public DragGestureDetectorKt$awaitLongPressOrCancellation$2(Ref$BooleanRef ref$BooleanRef, Ref$ObjectRef<C1643> ref$ObjectRef, Ref$ObjectRef<C1643> ref$ObjectRef2, InterfaceC4357<? super DragGestureDetectorKt$awaitLongPressOrCancellation$2> interfaceC4357) {
    ...
    public final InterfaceC4357<C5176> create(Object obj, InterfaceC4357<?> interfaceC4357) {
        DragGestureDetectorKt$awaitLongPressOrCancellation$2 dragGestureDetectorKt$awaitLongPressOrCancellation$2 = new DragGestureDetectorKt$awaitLongPressOrCancellation$2(this.$deepPress, this.$currentDown, this.$longPress, interfaceC4357);
    ...
    public final Object invoke(InterfaceC1633 interfaceC1633, InterfaceC4357<? super C5176> interfaceC4357) {
        return ((DragGestureDetectorKt$awaitLongPressOrCancellation$2) create(interfaceC1633, interfaceC4357)).invokeSuspend(C5176.f14739);
    }
