...
final class C0816 extends AbstractC1736 {
    ...
    public final InterfaceC6554 f2331;

    public C0816(InterfaceC6554 interfaceC6554) {
        this.f2331 = interfaceC6554;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0816) {
            return this.f2331 == ((C0816) obj).f2331;
        }
        return false;
    }

    public final int hashCode() {
        return this.f2331.hashCode();
    }

    @Override // androidx.compose.ui.node.AbstractC1736
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰 */
    public final void mo1096(AbstractC2128 abstractC2128) {
        ((C0821) abstractC2128).f2337 = this.f2331;
    }

    @Override // androidx.compose.ui.node.AbstractC1736
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲 */
    public final AbstractC2128 mo1097() {
        return new C0821(this.f2331);
    }
}
