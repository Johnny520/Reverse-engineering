...
public final class ToggleableKt$toggleableXHw0xAI$$inlined$debugInspectorInfo$1 extends Lambda implements InterfaceC6558 {
    final /* synthetic */ boolean $enabled$inlined;
    final /* synthetic */ InterfaceC6558 $onValueChange$inlined;
    final /* synthetic */ C1954 $role$inlined;
    final /* synthetic */ boolean $value$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ToggleableKt$toggleableXHw0xAI$$inlined$debugInspectorInfo$1(boolean z, boolean z2, C1954 c1954, InterfaceC6558 interfaceC6558) {
        super(1);
        this.$value$inlined = z;
        this.$enabled$inlined = z2;
        this.$role$inlined = c1954;
        this.$onValueChange$inlined = interfaceC6558;
    }
