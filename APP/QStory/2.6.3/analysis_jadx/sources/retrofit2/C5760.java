...
public final class C5760 {
    ...
    public C5760(C0131 c0131, Class cls, Method method) {
        this.f15793 = c0131;
        this.f15792 = cls;
        this.f15791 = method;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static Class m11148(Class cls) {
        return Boolean.TYPE == cls ? Boolean.class : Byte.TYPE == cls ? Byte.class : Character.TYPE == cls ? Character.class : Double.TYPE == cls ? Double.class : Float.TYPE == cls ? Float.class : Integer.TYPE == cls ? Integer.class : Long.TYPE == cls ? Long.class : Short.TYPE == cls ? Short.class : cls;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final void m11149(int i, Type type) {
        if (AbstractC5785.m11192(type)) {
            throw AbstractC5785.m11181(this.f15791, i, "Parameter type must not include a type variable or wildcard: %s", type);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final void m11150(String str, String str2, boolean z) {
        String str3 = this.f15804;
        Method method = this.f15791;
        if (str3 != null) {
            throw AbstractC5785.m11182(method, null, "Only one HTTP method is allowed. Found: %s and %s.", str3, str);
        }
        this.f15804 = str;
        this.f15805 = z;
        if (str2.isEmpty()) {
        ...
        if (iIndexOf != -1 && iIndexOf < str2.length() - 1) {
            ...
            if (pattern.matcher(strSubstring).find()) {
                throw AbstractC5785.m11182(method, null, "URL query string \"%s\" must not have replace block. For dynamic query parameters use @Query.", strSubstring);
            }
        }
        this.f15795 = str2;
