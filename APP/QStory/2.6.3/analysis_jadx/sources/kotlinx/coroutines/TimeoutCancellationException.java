...
public final class TimeoutCancellationException extends CancellationException implements InterfaceC5434 {
    public final transient InterfaceC5452 coroutine;

    public TimeoutCancellationException(String str, InterfaceC5452 interfaceC5452) {
        super(str);
        this.coroutine = interfaceC5452;
    }
