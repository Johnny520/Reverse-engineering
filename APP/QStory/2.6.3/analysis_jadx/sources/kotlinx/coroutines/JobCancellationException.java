...
public final class JobCancellationException extends CancellationException implements InterfaceC5434 {
    private final transient InterfaceC5452 _job;

    public JobCancellationException(String str, Throwable th, InterfaceC5452 interfaceC5452) {
        super(str);
        this._job = interfaceC5452;
        if (th != null) {
            initCause(th);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4395.m8907(jobCancellationException.getMessage(), getMessage()) && AbstractC4395.m8907(jobCancellationException.getJob$kotlinx_coroutines_core(), getJob$kotlinx_coroutines_core()) && AbstractC4395.m8907(jobCancellationException.getCause(), getCause());
    }
    ...
    public final InterfaceC5452 getJob$kotlinx_coroutines_core() {
        InterfaceC5452 interfaceC5452 = this._job;
        return interfaceC5452 == null ? C5459.f15108 : interfaceC5452;
    }
