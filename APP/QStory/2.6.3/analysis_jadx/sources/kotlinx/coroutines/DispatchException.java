...
public final class DispatchException extends Exception {
    ...
    public DispatchException(Throwable th, AbstractC5432 abstractC5432, InterfaceC4360 interfaceC4360) {
        super("Coroutine dispatcher " + abstractC5432 + " threw an exception, context = " + interfaceC4360, th);
        this.cause = th;
    }
