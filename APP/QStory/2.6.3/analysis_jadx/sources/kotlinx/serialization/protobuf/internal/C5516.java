...
public final class C5516 {
    ...
    public final void m10762(long j) {
        m10764(8);
        for (int i = 7; -1 < i; i--) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final void m10763(int i) {
        m10764(4);
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final void m10764(int i) {
        int i2 = this.f15244 + i;
        if (i2 <= this.f15245.length) {
            return;
        }
        byte[] bArr = new byte[Integer.highestOneBit(i2) << 1];
        AbstractC4347.m8839(this.f15245, 0, bArr, 0, 14);
        this.f15245 = bArr;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final void m10765(int i, long j) {
        int i2 = 0;
        while (true) {
            byte[] bArr = this.f15245;
            int i3 = this.f15244;
