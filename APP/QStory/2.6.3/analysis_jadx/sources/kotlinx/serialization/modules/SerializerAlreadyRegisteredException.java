...
final class SerializerAlreadyRegisteredException extends IllegalArgumentException {
    ...
    public SerializerAlreadyRegisteredException(InterfaceC5093 interfaceC5093, InterfaceC5093 interfaceC50932) {
        this("Serializer for " + interfaceC50932 + " already registered in the scope of " + interfaceC5093);
