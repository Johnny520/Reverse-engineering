...
public final class MissingFieldException extends SerializationException {
    ...
    public MissingFieldException(String str, String str2) {
        this("Field '" + str + "' is required for type with serial name '" + str2 + "', but it was missing", null, AbstractC6347.m11928(str), str2);
        str.getClass();
        str2.getClass();
    }
    ...
    public /* synthetic */ MissingFieldException(String str) {
        this("Field '" + str + "' is required, but it was missing", null, AbstractC6347.m11928(str), null);
        str.getClass();
    }
}
