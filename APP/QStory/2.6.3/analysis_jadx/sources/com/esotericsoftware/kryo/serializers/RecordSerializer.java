...
public class RecordSerializer<T> extends ImmutableSerializer<T> {
    ...
    static {
        ...
        CONSTRUCTOR = new ClassValue<Constructor<?>>() { // from class: com.esotericsoftware.kryo.serializers.RecordSerializer.1
            ...
            public Constructor<?> computeValue2(Class<?> cls2) {
                return RecordSerializer.getCanonicalConstructor(cls2, RecordSerializer.recordComponents(cls2, Comparator.comparing(new C3073(1))));
            }
        ...
        RECORD_COMPONENTS = new ClassValue<RecordComponent[]>() { // from class: com.esotericsoftware.kryo.serializers.RecordSerializer.2
            ...
            public RecordComponent[] computeValue2(Class<?> cls2) {
                return RecordSerializer.recordComponents(cls2, Comparator.comparing(new C3073(2)));
            }
    ...
    public static <T> Constructor<T> getCanonicalConstructor(Class<T> cls, RecordComponent[] recordComponentArr) {
        try {
            return getCanonicalConstructor(cls, (Class<?>[]) Arrays.stream(recordComponentArr).map(new C3073(0)).toArray(new C3072()));
        } catch (Throwable th) {
    ...
    public T read(Kryo kryo, Input input, Class<? extends T> cls) {
        ...
        for (RecordComponent recordComponent : recordComponentArr) {
            ...
            try {
                ...
                StringBuilder sbM11584 = AbstractC6183.m11584(strName, " (");
                sbM11584.append(cls.getName());
                sbM11584.append(")");
                e.addTrace(sbM11584.toString());
                throw e;
            } catch (Throwable th) {
                KryoException kryoException = new KryoException(th);
                StringBuilder sbM115842 = AbstractC6183.m11584(strName, " (");
                sbM115842.append(cls.getName());
                sbM115842.append(")");
                kryoException.addTrace(sbM115842.toString());
                throw kryoException;
            }
        }
    ...
    public void write(Kryo kryo, Output output, T t) {
        for (RecordComponent recordComponent : (RecordComponent[]) RECORD_COMPONENTS.get(t.getClass())) {
            ...
            try {
                ...
                StringBuilder sbM11584 = AbstractC6183.m11584(strName, " (");
                sbM11584.append(clsType.getName());
                sbM11584.append(")");
                e.addTrace(sbM11584.toString());
                throw e;
            } catch (Throwable th) {
                KryoException kryoException = new KryoException(th);
                StringBuilder sbM115842 = AbstractC6183.m11584(strName, " (");
                sbM115842.append(clsType.getName());
                sbM115842.append(")");
                kryoException.addTrace(sbM115842.toString());
                throw kryoException;
            }
