...
public final class C2702 extends AbstractC8364 implements InterfaceC2788 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public static final C2702 f8202 = new C2702(null, null);
    ...
    public final Object mo5463(AbstractC2899 abstractC2899, Type type, Object obj, long j) {
        ...
        if (zMo6181) {
            ...
            return OffsetTime.of(LocalDateTime.ofInstant(instantOfEpochMilli, zoneIdM6409).toLocalTime(), zoneIdM6409.getRules().getOffset(instantOfEpochMilli));
        }
        if (abstractC2899.mo6119()) {
            return null;
        }
        if (this.f23070 == null) {
            return abstractC2899.mo6187();
        }
        ...
        if (this.f23068 || z) {
            ...
            return OffsetDateTime.of(LocalDateTime.ofInstant(instantOfEpochMilli2, zoneIdM64092), zoneIdM64092.getRules().getOffset(instantOfEpochMilli2)).toOffsetTime();
        }
        abstractC2899.m6107();
        ...
        if (!this.f23076) {
            ...
            return OffsetDateTime.of(localDateTimeOf, zoneIdM64092.getRules().getOffset(localDateTimeOf)).toOffsetTime();
        }
        if (!this.f23066) {
            return ZonedDateTime.of(LocalDate.of(1970, 1, 1), LocalTime.parse(strMo6184, dateTimeFormatterM13868), zoneIdM64092).toOffsetDateTime().toOffsetTime();
        }
        LocalDateTime localDateTime = LocalDateTime.parse(strMo6184, dateTimeFormatterM13868);
        return OffsetDateTime.of(localDateTime, zoneIdM64092.getRules().getOffset(localDateTime)).toOffsetTime();
    }
