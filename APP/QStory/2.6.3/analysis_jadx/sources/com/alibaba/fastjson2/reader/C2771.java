...
public final /* synthetic */ class C2771 implements Consumer {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public final /* synthetic */ Annotation f8443;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final /* synthetic */ C8365 f8444;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final /* synthetic */ int f8445;

    public /* synthetic */ C2771(C8049 c8049, Annotation annotation, C8365 c8365) {
        this.f8445 = 11;
        this.f8443 = annotation;
        this.f8444 = c8365;
    }
    ...
    public final void accept(Object obj) {
        ...
        int i = this.f8445;
        final int i2 = 0;
        final C8365 c8365 = this.f8444;
        Annotation annotation = this.f8443;
        ...
        switch (i) {
            ...
            case 3:
                ...
                try {
                    ...
                    if ("value".equals(name)) {
                        ...
                        if (objArr.length != 0) {
                            c8365.f23087 = new Class[objArr.length];
                            c8365.f23106 = new String[objArr.length];
                            while (i2 < objArr.length) {
                                final Annotation annotation2 = (Annotation) objArr[i2];
                                Type[] typeArr = AbstractC2865.f9017;
                                AbstractC2865.m5811(annotation2.getClass(), new Consumer() { // from class: com.alibaba.fastjson2.util.飘花落叶言子楪世兰苏哲
                                    @Override // java.util.function.Consumer
                                        ...
                                        try {
                                            ...
                                            if (iHashCode == 3373707) {
                                                if (name2.equals("name")) {
                                                    c83652.f23106[i3] = (String) objInvoke2;
                                                    return;
                                                }
                                                return;
                                            }
                                            if (iHashCode == 111972721 && name2.equals("value")) {
                                                c83652.f23087[i3] = (Class) objInvoke2;
                                            }
                    ...
                    if ("value".equals(name4)) {
                        ...
                        if (iHashCode != -7755493) {
                            if (iHashCode != 10566287) {
                                ...
                                c8365.f23099 |= JSONWriter$Feature.NotWriteDefaultValue.mask;
                            }
                        } else if (strName.equals("NON_EMPTY")) {
                            c8365.f23099 |= JSONWriter$Feature.NotWriteEmptyArray.mask;
                        }
                    }
            ...
            case 8:
                ...
                try {
                    ...
                    if (iHashCode2 != -1097462182) {
                        ...
                        if (!str5.isEmpty() && !"##default".equals(str5)) {
                            c8365.f23085 = Locale.forLanguageTag(str5);
                        }
                    }
                ...
                break;
            case 9:
                AbstractC2865.m5792(c8365, annotation, method);
                break;
            case 10:
                AbstractC2865.m5792(c8365, annotation, method);
                break;
            case 11:
                ...
                try {
                    ...
                    if (iHashCode3 != 111582340) {
                        if (iHashCode3 == 491860325 && name7.equals("keyUsing") && (clsM135282 = C8049.m13528((Class) objInvoke7)) != null) {
                            c8365.f23097 = clsM135282;
                        }
                    } else if (name7.equals("using") && (clsM13528 = C8049.m13528((Class) objInvoke7)) != null) {
                        c8365.f23097 = clsM13528;
                    }
                ...
                try {
                    ...
                    if ("value".equals(name9)) {
                        ...
                        if (annotationArr.length != 0) {
                            c8365.f23087 = new Class[annotationArr.length];
                            c8365.f23106 = new String[annotationArr.length];
                            while (i2 < annotationArr.length) {
                                final Annotation annotation3 = annotationArr[i2];
                                Type[] typeArr2 = AbstractC2865.f9017;
                                AbstractC2865.m5811(annotation3.getClass(), new Consumer() { // from class: com.alibaba.fastjson2.util.飘花落叶言子楪世兰苏哲
                                    @Override // java.util.function.Consumer
                                    public final void accept(Object obj2) {
                                        ...
                                        try {
                                            ...
                                            if (iHashCode4 == 3373707) {
                                                if (name22.equals("name")) {
                                                    c83652.f23106[i3] = (String) objInvoke22;
                                                    return;
                                                }
                                                return;
                                            }
                                            if (iHashCode4 == 111972721 && name22.equals("value")) {
                                                c83652.f23087[i3] = (Class) objInvoke22;
                                            }
    ...
    public /* synthetic */ C2771(Annotation annotation, C8365 c8365, int i) {
        this.f8445 = i;
        this.f8443 = annotation;
        this.f8444 = c8365;
    }

    public /* synthetic */ C2771(C8365 c8365, Annotation annotation, int i) {
        this.f8445 = i;
        this.f8444 = c8365;
        this.f8443 = annotation;
    }
