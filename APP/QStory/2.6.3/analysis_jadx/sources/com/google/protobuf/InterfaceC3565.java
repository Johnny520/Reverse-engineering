...
/* JADX INFO: renamed from: com.google.protobuf.飘花落叶言子苏哲世兰楪, reason: contains not printable characters */
/* JADX INFO: compiled from: r8-map-id-447c03deab370cabd87f71de7ff996ccc1a6dc9764ce389c731d875d052048e4 */
/* JADX INFO: loaded from: classes.dex */
public interface InterfaceC3565 extends InterfaceC3627 {
    ...
    DescriptorProtos$ExtensionRangeOptions.Declaration getDeclaration(int i);

    int getDeclarationCount();

    List<DescriptorProtos$ExtensionRangeOptions.Declaration> getDeclarationList();

    InterfaceC3570 getDeclarationOrBuilder(int i);

    List<? extends InterfaceC3570> getDeclarationOrBuilderList();
