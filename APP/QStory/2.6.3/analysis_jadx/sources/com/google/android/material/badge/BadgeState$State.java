...
public final class BadgeState$State implements Parcelable {
    public static final Parcelable.Creator<BadgeState$State> CREATOR = new C3163(6);
    ...
    public Integer f9957;

    /* JADX INFO: renamed from: 飘花落叶言子世哲楪兰苏, reason: contains not printable characters */
    public Integer f9958;

    /* JADX INFO: renamed from: 飘花落叶言子世哲楪苏兰, reason: contains not printable characters */
    public Integer f9959;

    /* JADX INFO: renamed from: 飘花落叶言子世哲苏兰楪, reason: contains not printable characters */
    public Integer f9960;

    /* JADX INFO: renamed from: 飘花落叶言子世哲苏楪兰, reason: contains not printable characters */
    public Integer f9961;
    ...
    public Integer f9978;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏哲世, reason: contains not printable characters */
    public Integer f9979;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public Integer f9980;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public Integer f9981;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeSerializable(this.f9980);
        parcel.writeSerializable(this.f9981);
        parcel.writeSerializable(this.f9975);
        parcel.writeSerializable(this.f9974);
        parcel.writeSerializable(this.f9978);
        parcel.writeSerializable(this.f9979);
        ...
        parcel.writeSerializable(this.f9968);
        parcel.writeSerializable(this.f9959);
        parcel.writeSerializable(this.f9958);
        parcel.writeSerializable(this.f9961);
        parcel.writeSerializable(this.f9960);
        parcel.writeSerializable(this.f9954);
        parcel.writeSerializable(this.f9956);
        parcel.writeSerializable(this.f9957);
