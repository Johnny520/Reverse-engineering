...
public final class ConstantPoolParser {
    ...
    private static int getMethodHandleTypeForKind(int i) {
        switch (i) {
            ...
            case 9:
                return 8;
            default:
                C5925.m11310(AbstractC6183.m11588(i, "invalid kind: "));
                return 0;
        }
    }
    ...
    private void parse() {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(this.bytes, 8, 2, AbstractC2442.m4560(new StringBuilder("constant_pool_count: "), this.offsets.length));
