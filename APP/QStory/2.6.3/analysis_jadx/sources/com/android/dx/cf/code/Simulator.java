...
public class Simulator {
    ...
    public void fail(String str) {
        StringBuilder sbM11582 = AbstractC6183.m11582("ERROR in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM11582.append(str);
        throw new SimException(sbM11582.toString());
    }
    ...
    private void warn(String str) {
        StringBuilder sbM11582 = AbstractC6183.m11582("WARNING in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM11582.append(str);
        this.dexOptions.err.println(sbM11582.toString());
    }
