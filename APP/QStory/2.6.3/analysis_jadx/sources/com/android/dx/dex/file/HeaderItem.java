...
public final class HeaderItem extends IndexedItem {
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            AbstractC2442.m4563(305419896, new StringBuilder("endian_tag:      "), annotatedOutput, 4);
            annotatedOutput.annotate(4, "link_size:       0");
            annotatedOutput.annotate(4, "link_off:        0");
            AbstractC2442.m4563(fileOffset, new StringBuilder("map_off:         "), annotatedOutput, 4);
        }
        for (int i = 0; i < 8; i++) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            AbstractC2442.m4563(fileOffset2, new StringBuilder("data_off:        "), annotatedOutput, 4);
        }
