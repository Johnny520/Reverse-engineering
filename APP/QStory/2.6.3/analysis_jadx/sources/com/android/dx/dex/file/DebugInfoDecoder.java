...
public class DebugInfoDecoder {
    ...
    private void decode0() {
        C8382 c8382 = new C8382(this.encoded);
        this.line = AbstractC3055.m6644(c8382);
        int iM6644 = AbstractC3055.m6644(c8382);
        StdTypeList parameterTypes = this.desc.getParameterTypes();
        int paramBase = getParamBase();
        if (iM6644 != parameterTypes.size()) {
            C2633.m5339("Mismatch between parameters_size and prototype");
            return;
        }
        if (!this.isStatic) {
        ...
        for (int i = 0; i < iM6644; i++) {
            ...
            int stringIndex = readStringIndex(c8382);
        ...
        while (true) {
            int i2 = c8382.readByte() & DefaultClassResolver.NAME;
            switch (i2) {
                case 0:
                    return;
                case 1:
                    this.address = AbstractC3055.m6644(c8382) + this.address;
                    break;
                case 2:
                    this.line = AbstractC3055.m6645(c8382) + this.line;
                    break;
                case 3:
                    int iM66442 = AbstractC3055.m6644(c8382);
                    LocalEntry localEntry3 = new LocalEntry(this.address, true, iM66442, readStringIndex(c8382), readStringIndex(c8382), 0);
                    this.locals.add(localEntry3);
                    this.lastEntryForReg[iM66442] = localEntry3;
                    break;
                case 4:
                    int iM66443 = AbstractC3055.m6644(c8382);
                    LocalEntry localEntry4 = new LocalEntry(this.address, true, iM66443, readStringIndex(c8382), readStringIndex(c8382), readStringIndex(c8382));
                    this.locals.add(localEntry4);
                    this.lastEntryForReg[iM66443] = localEntry4;
                    break;
                case 5:
                    int iM66444 = AbstractC3055.m6644(c8382);
                    try {
                        LocalEntry localEntry5 = this.lastEntryForReg[iM66444];
                        if (!localEntry5.isStart) {
                            throw new RuntimeException("nonsensical END_LOCAL on dead register v" + iM66444);
                        }
                        LocalEntry localEntry6 = new LocalEntry(this.address, false, iM66444, localEntry5.nameIndex, localEntry5.typeIndex, localEntry5.signatureIndex);
                        this.locals.add(localEntry6);
                        this.lastEntryForReg[iM66444] = localEntry6;
                    } catch (NullPointerException unused) {
                        C2633.m5339(AbstractC6183.m11588(iM66444, "Encountered END_LOCAL on new v"));
                        return;
                    }
                    break;
                case 6:
                    int iM66445 = AbstractC3055.m6644(c8382);
                    try {
                        LocalEntry localEntry7 = this.lastEntryForReg[iM66445];
                        if (localEntry7.isStart) {
                            throw new RuntimeException("nonsensical RESTART_LOCAL on live register v" + iM66445);
                        }
                        LocalEntry localEntry8 = new LocalEntry(this.address, true, iM66445, localEntry7.nameIndex, localEntry7.typeIndex, 0);
                        this.locals.add(localEntry8);
                        this.lastEntryForReg[iM66445] = localEntry8;
                    } catch (NullPointerException unused2) {
                        C2633.m5339(AbstractC6183.m11588(iM66445, "Encountered RESTART_LOCAL on new v"));
                        return;
                    }
                    break;
                case 7:
                ...
                default:
                    if (i2 < 10) {
                        C2633.m5339(AbstractC6183.m11588(i2, "Invalid extended opcode encountered "));
                        return;
                    }
    ...
    private int readStringIndex(InterfaceC8386 interfaceC8386) {
        return AbstractC3055.m6644(interfaceC8386) - 1;
    }
    ...
    private static void validateEncode0(byte[] bArr, int i, int i2, boolean z, CstMethodRef cstMethodRef, DexFile dexFile, PositionList positionList, LocalList localList) {
        ...
        if (positionList2.size() != positionList.size()) {
            C2942.m6405("Decoded positions table not same size was ", positionList2.size(), " expected ", positionList.size());
            return;
        }
        for (PositionEntry positionEntry : positionList2) {
            ...
            C2942.m6405("Could not match position entry: ", positionEntry.address, ", ", positionEntry.line);
            return;
        }
        ...
        for (int i8 = 0; i8 < size3; i8++) {
            ...
            if (entry2.getDisposition() != LocalList.Disposition.END_REPLACED) {
                ...
                C2633.m5339("local table problem");
                return;
            }
        }
    }
