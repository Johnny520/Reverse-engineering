...
public final class StringDataItem extends OffsettedItem {
    ...
    private static int writeSize(CstString cstString) {
        return cstString.getUtf8Size() + AbstractC3055.m6637(cstString.getUtf16Size()) + 1;
    }
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(AbstractC3055.m6637(utf16Size), "utf16_size: " + Hex.u4(utf16Size));
