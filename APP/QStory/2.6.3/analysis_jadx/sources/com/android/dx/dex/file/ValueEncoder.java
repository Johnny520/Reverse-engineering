    ...
    public void writeConstant(Constant constant) {
        ...
        if (iConstantToValueType != 0 && iConstantToValueType != 6 && iConstantToValueType != 2) {
            if (iConstantToValueType == 3) {
                AbstractC3056.m6723(this.out, iConstantToValueType, ((CstLiteralBits) constant).getLongBits());
                return;
            }
            if (iConstantToValueType != 4) {
                if (iConstantToValueType == 16) {
                    AbstractC3056.m6728(this.out, iConstantToValueType, ((CstFloat) constant).getLongBits() << 32);
                    return;
                }
                if (iConstantToValueType == 17) {
                    AbstractC3056.m6728(this.out, iConstantToValueType, ((CstDouble) constant).getLongBits());
                    return;
                }
                switch (iConstantToValueType) {
                    case 21:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getProtoIds().indexOf(((CstProtoRef) constant).getPrototype()));
                        break;
                    case 22:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getMethodHandles().indexOf((CstMethodHandle) constant));
                        break;
                    case 23:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getStringIds().indexOf((CstString) constant));
                        break;
                    case 24:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getTypeIds().indexOf((CstType) constant));
                        break;
                    case 25:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getFieldIds().indexOf((CstFieldRef) constant));
                        break;
                    case 26:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getMethodIds().indexOf((CstMethodRef) constant));
                        break;
                    case 27:
                        AbstractC3056.m6723(this.out, iConstantToValueType, this.file.getFieldIds().indexOf(((CstEnumRef) constant).getFieldRef()));
                        break;
                    case 28:
        ...
        AbstractC3056.m6729(this.out, iConstantToValueType, ((CstLiteralBits) constant).getLongBits());
    }
