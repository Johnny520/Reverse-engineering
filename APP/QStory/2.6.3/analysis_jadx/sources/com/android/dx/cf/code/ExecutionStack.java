...
public final class ExecutionStack extends MutabilityControl {
    ...
    private static TypeBearer throwSimException(String str) {
        throw new SimException(AbstractC0053.m157("stack: ", str));
    }
    ...
    public void annotate(ExceptionWithContext exceptionWithContext) {
        ...
        int i2 = 0;
        while (i2 <= i) {
            StringBuilder sbM11585 = AbstractC6183.m11585("stack[", i2 == i ? "top0" : Hex.u2(i - i2), "]: ");
            sbM11585.append(stackElementString(this.stack[i2]));
            exceptionWithContext.addContext(sbM11585.toString());
            i2++;
        }
    }
