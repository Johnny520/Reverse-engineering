...
public class CodeObserver implements BytecodeArray.Visitor {
    ...
    private String header(int i) {
        ...
        if (unsignedByte == 196) {
            ...
            StringBuilder sbM11584 = AbstractC6183.m11584(strOpName, " ");
            sbM11584.append(ByteOps.opName(unsignedByte2));
            strOpName = sbM11584.toString();
        }
    ...
    public void visitConstant(int i, int i2, int i3, Constant constant, int i4) {
        ...
        if (i4 == 0) {
            ...
            strM4560 = AbstractC2442.m4560(new StringBuilder(", "), i4);
        }
        this.observer.parsed(this.bytes, i2, i3, header(i2) + " " + constant + strM4560);
    }
