...
public final class AnnotationParser {
    ...
    private Annotation parseAnnotation(AnnotationVisibility annotationVisibility) throws IOException {
        ...
        if (this.observer != null) {
            ...
            parsed(2, AbstractC6183.m11588(unsignedShort2, "num_elements: "));
        }
        Annotation annotation = new Annotation(cstType, annotationVisibility);
        for (int i = 0; i < unsignedShort2; i++) {
            if (this.observer != null) {
                parsed(0, AbstractC0053.m162(i, "elements[", "]:"));
                changeIndent(1);
            }
    ...
    private Annotations parseAnnotations(AnnotationVisibility annotationVisibility) throws IOException {
        int unsignedShort = this.input.readUnsignedShort();
        if (this.observer != null) {
            parsed(2, AbstractC2442.m4560(new StringBuilder("num_annotations: "), unsignedShort));
        }
        Annotations annotations = new Annotations();
        for (int i = 0; i < unsignedShort; i++) {
            if (this.observer != null) {
                parsed(0, AbstractC0053.m162(i, "annotations[", "]:"));
                changeIndent(1);
            }
    ...
    private AnnotationsList parseAnnotationsList(AnnotationVisibility annotationVisibility) throws IOException {
        ...
        for (int i = 0; i < unsignedByte; i++) {
            if (this.observer != null) {
                parsed(0, AbstractC0053.m162(i, "parameter_annotations[", "]:"));
                changeIndent(1);
            }
    ...
    private Constant parseConstant() {
        ...
        if (this.observer != null) {
            parsed(2, AbstractC0053.m157("constant_value: ", constant instanceof CstString ? ((CstString) constant).toQuoted() : constant.toHuman()));
        }
        return constant;
    }
    ...
    private Constant parseValue() throws IOException {
        ...
        if (this.observer != null) {
            parsed(2, AbstractC6183.m11588(unsignedShort3, "num_values: "));
            changeIndent(1);
        }
        int i = 0;
        while (true) {
            ...
            if (parseObserver != null) {
                changeIndent(-1);
                parsed(0, AbstractC0053.m162(i, "element_value[", "]:"));
                changeIndent(1);
            }
