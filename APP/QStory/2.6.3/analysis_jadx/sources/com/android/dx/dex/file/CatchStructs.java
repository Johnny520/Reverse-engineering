...
public final class CatchStructs {
    ...
    private void annotateEntries(String str, PrintWriter printWriter, AnnotatedOutput annotatedOutput) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            StringBuilder sbM11584 = AbstractC6183.m11584(strM136, "try ");
            sbM11584.append(Hex.u2or4(entry.getStart()));
            sbM11584.append("..");
            sbM11584.append(Hex.u2or4(entry.getEnd()));
            String string = sbM11584.toString();
        ...
        StringBuilder sbM115842 = AbstractC6183.m11584(strM136, "size: ");
        sbM115842.append(Hex.u2(this.handlerOffsets.size()));
        annotatedOutput.annotate(i4, sbM115842.toString());
    ...
    public void encode(DexFile dexFile) {
        ...
        if (treeMap.size() > 65535) {
            C5925.m11308("too many catch handlers");
            return;
        }
