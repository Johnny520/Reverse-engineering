...
public final class Type implements TypeBearer, Comparable<Type> {
    ...
    private Type(String str, int i, int i2) {
        if (str == null) {
            C2633.m5343("descriptor == null");
            throw null;
        }
        if (i < 0 || i >= 11) {
            C5925.m11310("bad basicType");
            throw null;
        }
        if (i2 < -1) {
            C5925.m11310("newAt < -1");
            throw null;
        }
        this.descriptor = str;
        this.basicType = i;
    ...
    public static Type intern(String str) {
        ...
        try {
                        ...
                        if (cCharAt2 != '(' && cCharAt2 != ')' && cCharAt2 != '.') {
                            if (cCharAt2 == '/') {
                                if (i2 == 1 || i2 == i || str.charAt(i2 - 1) == '/') {
                                    C5925.m11310("bad descriptor: ".concat(str));
                                    return null;
                                }
            ...
            C5925.m11310("descriptor is empty");
            return null;
    ...
    public Type asUninitialized(int i) {
        if (i < 0) {
            C5925.m11310("newAt < 0");
            return null;
        }
        if (!isReference()) {
            C7547.m12764(this.descriptor, "not a reference type: ");
            return null;
        }
        if (isUninitialized()) {
            C7547.m12764(this.descriptor, "already uninitialized: ");
            return null;
        }
    ...
    public String getClassName() {
        if (this.className == null) {
            ...
            if (!zIsReference) {
                C5925.m11310(AbstractC0053.m157("not an object type: ", str));
                return null;
            }
            char cCharAt = str.charAt(0);
            ...
            if (cCharAt == '[') {
                ...
                this.className = AbstractC0053.m161(1, 1, str2);
            }
        }
    ...
    public Type getComponentType() {
        if (this.componentType == null) {
            ...
            String str = this.descriptor;
            if (cCharAt != '[') {
                C5925.m11310(AbstractC0053.m157("not an array type: ", str));
                return null;
            }
    ...
    public Type getInitializedType() {
        ...
        C7547.m12764(this.descriptor, "initialized type: ");
        return null;
    }
