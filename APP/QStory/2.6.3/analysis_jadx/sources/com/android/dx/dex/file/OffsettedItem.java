...
public abstract class OffsettedItem extends Item implements Comparable<OffsettedItem> {
    ...
    public final int getAbsoluteOffset() {
        ...
        C2633.m5339("offset not yet known");
        return 0;
    }
    ...
    public final void setWriteSize(int i) {
        if (i < 0) {
            C5925.m11310("writeSize < 0");
        } else if (this.writeSize < 0) {
            this.writeSize = i;
        } else {
            C5925.m11308("writeSize already set");
        }
    }
    ...
    public final int writeSize() {
        ...
        C5925.m11308("writeSize is unknown");
        return 0;
    }
