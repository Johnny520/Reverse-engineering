...
public class Main {
    ...
    private void dumpMethod(DexFile dexFile, String str, OutputStreamWriter outputStreamWriter) {
        ...
        if (zEndsWith) {
            strSubstring = AbstractC0053.m161(1, 0, strSubstring);
        }
    ...
    private byte[] mergeIncremental(byte[] bArr, File file) throws IOException {
        C8558 c8558 = bArr != null ? new C8558(bArr) : null;
        C8558 c85582 = file.exists() ? new C8558(file) : null;
        if (c8558 == null && c85582 == null) {
            return null;
        }
        if (c8558 == null) {
            c8558 = c85582;
        } else if (c85582 != null) {
            c8558 = new DexMerger(new C8558[]{c8558, c85582}, CollisionPolicy.KEEP_FIRST, this.context).merge();
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        c8558.m14136(byteArrayOutputStream);
    ...
    private byte[] mergeLibraryDexBuffers(byte[] bArr) {
        ...
        if (bArr != null) {
            arrayList.add(new C8558(bArr));
        }
        Iterator<byte[]> it = this.libraryDexBuffers.iterator();
        while (it.hasNext()) {
            arrayList.add(new C8558(it.next()));
        }
        if (arrayList.isEmpty()) {
            return null;
        }
        ByteBuffer byteBufferDuplicate = new DexMerger((C8558[]) arrayList.toArray(new C8558[arrayList.size()]), CollisionPolicy.FAIL, this.context).merge().f23890.duplicate();
    ...
    private boolean processAllFiles() {
        ...
        try {
            ...
            C0276.m848("Translation has been interrupted", e2);
            return false;
        } catch (Exception e3) {
            this.classTranslatorPool.shutdownNow();
            this.classDefItemConsumer.shutdownNow();
            e3.printStackTrace(this.context.out);
            C0276.m848("Unexpected exception in translator thread.", e3);
            return false;
        }
    }
    ...
    private boolean processClass(String str, byte[] bArr) {
        ...
        try {
            ...
            C0276.m848("Exception parsing classes", e2);
            return false;
        }
    }
    ...
    private int runMultiDex() throws Throwable {
        ...
        try {
            ...
            C2633.m5339("A dex writer thread has been interrupted.");
            return 0;
        } catch (Exception unused2) {
            this.dexOutPool.shutdownNow();
            C2633.m5339("Unexpected exception in dex writer thread");
            return 0;
        }
    }
