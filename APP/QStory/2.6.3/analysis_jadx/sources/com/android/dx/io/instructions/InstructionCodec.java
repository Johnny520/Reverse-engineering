...
public enum InstructionCodec {
    ...
    FORMAT_45CC { // from class: com.android.dx.io.instructions.InstructionCodec.32
        ...
        public DecodedInstruction decode(int i, CodeInput codeInput) {
            int iByte0 = InstructionCodec.byte0(i);
            if (iByte0 != 250) {
                C5925.m11308(String.valueOf(iByte0));
                return null;
            }
            ...
            C7547.m12770(Hex.uNibble(iNibble3), "bogus registerCount: ");
            return null;
        }
    ...
    FORMAT_FILL_ARRAY_DATA_PAYLOAD { // from class: com.android.dx.io.instructions.InstructionCodec.36
        ...
        public DecodedInstruction decode(int i, CodeInput codeInput) {
            ...
            if (i2 != 8) {
                throw new DexException(AbstractC2442.m4560(new StringBuilder("bogus element_width: "), i2));
            }
        ...
        public void encode(DecodedInstruction decodedInstruction, CodeOutput codeOutput) {
            ...
            if (elementWidthUnit == 2) {
                ...
                if (elementWidthUnit != 8) {
                    throw new DexException(AbstractC2442.m4560(new StringBuilder("bogus element_width: "), elementWidthUnit));
                }
    ...
    public static short asUnsignedUnit(int i) {
        ...
        C5925.m11310("bogus unsigned code unit");
        return (short) 0;
    }
    ...
    public static short codeUnit(int i, int i2, int i3, int i4) {
        if ((i & (-16)) != 0) {
            C5925.m11310("bogus nibble0");
            return (short) 0;
        }
        if ((i2 & (-16)) != 0) {
            C5925.m11310("bogus nibble1");
            return (short) 0;
        }
        if ((i3 & (-16)) != 0) {
            C5925.m11310("bogus nibble2");
            return (short) 0;
        }
        if ((i4 & (-16)) == 0) {
            return (short) (i | (i2 << 4) | (i3 << 8) | (i4 << 12));
        }
        C5925.m11310("bogus nibble3");
        return (short) 0;
    }
    ...
    public static int makeByte(int i, int i2) {
        if ((i & (-16)) != 0) {
            C5925.m11310("bogus lowNibble");
            return 0;
        }
        if ((i2 & (-16)) == 0) {
            return i | (i2 << 4);
        }
        C5925.m11310("bogus highNibble");
        return 0;
    }
    ...
    public static short codeUnit(int i, int i2) {
        if ((i & (-256)) != 0) {
            C5925.m11310("bogus lowByte");
            return (short) 0;
        }
        if ((i2 & (-256)) == 0) {
            return (short) (i | (i2 << 8));
        }
        C5925.m11310("bogus highByte");
        return (short) 0;
    }
}
