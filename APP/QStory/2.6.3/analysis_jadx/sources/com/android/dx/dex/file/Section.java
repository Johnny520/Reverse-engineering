...
public abstract class Section {
    ...
    public static void validateAlignment(int i) {
        if (i <= 0 || (i & (i - 1)) != 0) {
            C5925.m11310("invalid alignment");
        }
    }
    ...
    public final int getAbsoluteOffset(int i) {
        ...
        C2633.m5339("fileOffset not yet set");
        return 0;
    }
    ...
    public final int getFileOffset() {
        ...
        C2633.m5339("fileOffset not set");
        return 0;
    }
    ...
    public final int setFileOffset(int i) {
        if (i < 0) {
            C5925.m11310("fileOffset < 0");
            return 0;
        }
        if (this.fileOffset >= 0) {
            C2633.m5339("fileOffset already set");
            return 0;
        }
    ...
    public final void throwIfNotPrepared() {
        ...
        C2633.m5339("not prepared");
    }

    public final void throwIfPrepared() {
        if (this.prepared) {
            C2633.m5339("already prepared");
        }
    }
