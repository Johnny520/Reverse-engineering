...
public class C0182 implements InterfaceC7777 {
    ...
    public C0182(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC7773.f21100, i, i2);
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, AbstractC7773.f21091, i, i2);
        if (typedArrayObtainStyledAttributes2.hasValue(2)) {
            c0134.setOverlapAnchor(typedArrayObtainStyledAttributes2.getBoolean(2, false));
        }
        c0134.setBackgroundDrawable((!typedArrayObtainStyledAttributes2.hasValue(0) || (resourceId = typedArrayObtainStyledAttributes2.getResourceId(0, 0)) == 0) ? typedArrayObtainStyledAttributes2.getDrawable(0) : AbstractC3933.m8312(context, resourceId));
    ...
    public final void show() {
        ...
        C0134 c0134 = this.f709;
        if (c01772 == null) {
            C0177 c0177Mo625 = mo625(context, !this.f712);
            this.f733 = c0177Mo625;
            c0177Mo625.setAdapter(this.f732);
        ...
        int iM616 = AbstractC0161.m616(c0134, this.f714, this.f731, c0134.getInputMethodMode() == 2);
        int i3 = this.f727;
        if (i3 == -1) {
            paddingBottom = iM616 + i;
        } else {
            int i4 = this.f726;
            int iM642 = this.f733.m642(i4 != -2 ? i4 != -1 ? View.MeasureSpec.makeMeasureSpec(i4, 1073741824) : View.MeasureSpec.makeMeasureSpec(context.getResources().getDisplayMetrics().widthPixels - (rect.left + rect.right), 1073741824) : View.MeasureSpec.makeMeasureSpec(context.getResources().getDisplayMetrics().widthPixels - (rect.left + rect.right), Integer.MIN_VALUE), iM616);
            paddingBottom = iM642 + (iM642 > 0 ? this.f733.getPaddingBottom() + this.f733.getPaddingTop() + i : 0);
        }
        ...
        if (Build.VERSION.SDK_INT <= 28) {
            ...
            AbstractC0162.m618(c0134, this.f713);
        }
    ...
    public C0177 mo625(Context context, boolean z) {
        return new C0177(context, z);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪哲世苏兰 */
    public void mo514(ListAdapter listAdapter) {
    ...
    public final void m649(Drawable drawable) {
