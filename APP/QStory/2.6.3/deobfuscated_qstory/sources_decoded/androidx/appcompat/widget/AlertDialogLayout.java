...
public class AlertDialogLayout extends AbstractC0166 {
    ...
    public static int m488(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m488(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM488 = m488(view2);
            measuredHeight = view2.getMeasuredHeight() - iM488;
            paddingBottom += iM488;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM488;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM488 += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM488, 1073741824));
