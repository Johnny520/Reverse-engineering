...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f872 = rect;
        this.f870 = new Rect();
        C4871 c4871 = new C4871(this, 22);
        this.f869 = c4871;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC7761.f21050, i, com.davemorrissey.labs.subscaleview.R.style.CardView);
        ...
        C7771 c7771 = new C7771(colorStateListValueOf, dimension);
        c4871.f14164 = c7771;
        setBackgroundDrawable(c7771);
        setClipToOutline(true);
        setElevation(dimension2);
        AbstractC3066.m6846(c4871, dimension3);
    }

    public ColorStateList getCardBackgroundColor() {
        return ((C7771) this.f869.f14164).f21074;
    }

    public float getCardElevation() {
        return ((CardView) this.f869.f14165).getElevation();
    }
    ...
    public float getMaxCardElevation() {
        return ((C7771) this.f869.f14164).f21069;
    }
    ...
    public float getRadius() {
        return ((C7771) this.f869.f14164).f21073;
    }
    ...
    public void setCardBackgroundColor(int i) {
        ...
        C7771 c7771 = (C7771) this.f869.f14164;
        if (colorStateListValueOf == null) {
            c7771.getClass();
            colorStateListValueOf = ColorStateList.valueOf(0);
        }
        c7771.f21074 = colorStateListValueOf;
        c7771.f21072.setColor(colorStateListValueOf.getColorForState(c7771.getState(), c7771.f21074.getDefaultColor()));
        c7771.invalidateSelf();
    }

    public void setCardElevation(float f) {
        ((CardView) this.f869.f14165).setElevation(f);
    }

    public void setMaxCardElevation(float f) {
        AbstractC3066.m6846(this.f869, f);
    }
    ...
    public void setPreventCornerOverlap(boolean z) {
        if (z != this.f871) {
            this.f871 = z;
            C4871 c4871 = this.f869;
            AbstractC3066.m6846(c4871, ((C7771) c4871.f14164).f21069);
        }
    }
    ...
    public void setCardBackgroundColor(ColorStateList colorStateList) {
        ...
        c7771.f21074 = colorStateList;
        c7771.f21072.setColor(colorStateList.getColorForState(c7771.getState(), c7771.f21074.getDefaultColor()));
        c7771.invalidateSelf();
    }
