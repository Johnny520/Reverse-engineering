        ...
        switch (this.f6950) {
            ...
            case 4:
                ...
                try {
                    ...
                    String string = jSONObjectM6374.getString(AbstractC8405.m13972(477)); /* decoded: m13972(477)=pre_grap_token */
                    c8807.f24791 = string;
                    if (string == null) {
                        return;
                    }
                    long j = Long.parseLong(String.valueOf(c5928.f16116.m11840(0, AbstractC8405.m13972(1060)))); /* decoded: m13972(1060)=expectAmount */
                    if (j > 0) {
                        JSONObject jSONObject = jSONObjectM6374.getJSONObject(AbstractC8405.m13972(478)); /* decoded: m13972(478)=send_object */
                        if (Integer.parseInt(jSONObject.getString(AbstractC8405.m13972(1079))) / Integer.parseInt(jSONObject.getString(AbstractC8405.m13972(1078))) < j) { /* decoded: m13972(1079)=total_amount ; m13972(1078)=total_num */
                            return;
                        }
                    }
                    TimeUnit.MILLISECONDS.sleep(Long.parseLong(String.valueOf(c5928.f16116.m11840(0, AbstractC8405.m13973("喵喵喵呜喵呜呜呜~喵喵喵呜喵喵喵喵~喵喵喵呜喵呜呜喵~喵喵喵喵呜喵喵呜~喵喵喵呜呜呜喵喵"))))); /* decoded-inline: delay */
            ...
            case 9:
                ...
                try {
                    AbstractC6336.m11863(obj, AbstractC8405.m13973("喵喵呜呜呜喵呜喵"), Boolean.TYPE, Boolean.TRUE); /* decoded-inline: I */
                    method.invoke(obj, null);
                    return;
                } catch (Exception e2) {
                    AbstractC6185.m11592(AbstractC8405.m13972(260) + e2); /* decoded: m13972(260)=跳广告错误: */
            ...
            case 12:
                ...
                if (((ArrayList) ref$ObjectRef.element).isEmpty()) {
                    AbstractC8211.m13735(AbstractC8405.m13972(3110), WaitDialog$TYPE.WARNING); /* decoded: m13972(3110)=好友列表为空 */
                    return;
                }
                ArrayList arrayList = (ArrayList) ref$ObjectRef.element;
                Map map = (Map) ref$ObjectRef2.element;
                C8208 c8208 = new C8208();
                c8208.f22614 = AbstractC8405.m13972(3102) + arrayList.size() + ')'; /* decoded: m13972(3102)=批量管理好友 ( */
                c8208.mo13721();
                c8208.f22626 = AbstractC8405.m13972(3103); /* decoded: m13972(3103)=勾选需要删除的好友 */
                c8208.mo13721();
                c8208.mo13720(true);
                c8208.mo13723(new C8891(c8890, arrayList, map));
                c8208.f22625 = AbstractC8405.m13973("呜喵喵呜喵呜呜喵~呜呜呜呜喵喵喵喵~呜呜喵喵呜喵喵呜~呜喵喵喵喵喵喵呜~呜呜呜呜喵喵呜喵~呜呜喵喵喵喵喵呜"); /* decoded-inline: 关闭 */
                c8208.mo13721();
                c8208.m13731();
                c8890.f25061 = c8208;
                return;
