    ...
    public void mo4484(List list) {
        ...
        switch (i) {
            case 23:
                ...
                c8679.f24485.m14677(list, AbstractC8405.m13972(1207)); /* decoded: m13972(1207)=TroopUinList */
                AbstractC6185.m11592(AbstractC8405.m13972(1208) + list.size() + AbstractC8405.m13972(1209)); /* decoded: m13972(1208)=已保存  ; m13972(1209)= 个群聊 */
                c8679.f24484.execute(new RunnableC0099(c8679, 24, list));
                break;
            case 24:
                C8677 c8677 = (C8677) obj;
                c8677.f24479.m14677(list, AbstractC8405.m13972(1207)); /* decoded: m13972(1207)=TroopUinList */
                AbstractC6185.m11592(AbstractC8405.m13972(1208) + list.size() + AbstractC8405.m13972(1209)); /* decoded: m13972(1208)=已保存  ; m13972(1209)= 个群聊 */
                new Thread(new RunnableC0099(c8677, 25, list)).start();
                break;
            default:
                C8675 c8675 = (C8675) obj;
                c8675.f24475.m14677(list, AbstractC8405.m13972(1207)); /* decoded: m13972(1207)=TroopUinList */
                AbstractC6185.m11592(AbstractC8405.m13972(1208) + list.size() + AbstractC8405.m13972(1209)); /* decoded: m13972(1208)=已保存  ; m13972(1209)= 个群聊 */
