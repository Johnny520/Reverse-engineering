...
public abstract class AbstractC1481 {
    ...
    public static final int[] f4202 = new int[2];

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final Rect f4201 = new Rect();

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public static final C1464 m2650(int i) {
        if (i == 1) {
            return new C1464(2);
        }
        if (i == 2) {
    ...
    public static final Integer m2651(int i) {
        if (i == 5) {
            return 33;
        }
        if (i == 6) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final boolean m2652(View view, Integer num, Rect rect) {
        if (num == null) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final C7328 m2653(View view, View view2) {
        int[] iArr = f4202;
        ...
        int i3 = iArr[0];
        float f = i2 - iArr[1];
        view.getFocusedRect(f4201);
        float f2 = (i - i3) + r1.left;
        return new C7328(f2, r1.top + f, r1.width() + f2, f + r1.top + r1.height());
    }
}
