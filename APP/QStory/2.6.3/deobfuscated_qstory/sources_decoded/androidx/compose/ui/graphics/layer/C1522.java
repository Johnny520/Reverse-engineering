...
public final class C1522 implements InterfaceC1514 {
    ...
    public static final C1523 f4388 = new C1523();
    ...
    public final Rect f4392;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final Resources f4393;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final C1519 f4394;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final C1602 f4395;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final AbstractC7332 f4396;
    ...
    public C1522(AbstractC7332 abstractC7332) {
        C1602 c1602 = new C1602();
        C1507 c1507 = new C1507();
        this.f4396 = abstractC7332;
        this.f4395 = c1602;
        C1519 c1519 = new C1519(abstractC7332, c1602, c1507);
        this.f4394 = c1519;
        this.f4393 = abstractC7332.getResources();
        this.f4392 = new Rect();
        abstractC7332.addView(c1519);
    ...
    public final void mo2717(InterfaceC1601 interfaceC1601) {
        Rect rect;
        boolean z = this.f4411;
        C1519 c1519 = this.f4394;
        if (z) {
            if ((this.f4404 || c1519.getClipToOutline()) && !this.f4412) {
                rect = this.f4392;
                rect.left = 0;
                rect.top = 0;
        ...
        if (AbstractC1594.m2915(interfaceC1601).isHardwareAccelerated()) {
            this.f4396.m12536(interfaceC1601, c1519, c1519.getDrawingTime());
        }
    }
    ...
    public final void m2805(int i) {
        ...
        boolean z = true;
        if (i == 1) {
            c1519.setLayerType(2, this.f4410);
        } else {
            Paint paint = this.f4410;
            if (i == 2) {
    ...
    public final void mo2720(InterfaceC7896 interfaceC7896, LayoutDirection layoutDirection, C1516 c1516, InterfaceC6558 interfaceC6558) {
        ...
        AbstractC7332 abstractC7332 = this.f4396;
        if (parent == null) {
            abstractC7332.addView(c1519);
        }
        c1519.f4383 = interfaceC7896;
        c1519.f4380 = layoutDirection;
        c1519.f4381 = interfaceC6558;
        c1519.f4377 = c1516;
        if (c1519.isAttachedToWindow()) {
            c1519.setVisibility(4);
            c1519.setVisibility(0);
            try {
                C1602 c1602 = this.f4395;
                C1523 c1523 = f4388;
                C1595 c1595 = c1602.f4703;
                Canvas canvas = c1595.f4690;
                c1595.f4690 = c1523;
                abstractC7332.m12536(c1595, c1519, c1519.getDrawingTime());
    ...
    public final void mo2722(float f) {
        this.f4391 = f;
        this.f4394.setRotationX(f);
    }

    @Override // androidx.compose.ui.graphics.layer.InterfaceC1514
    /* JADX INFO: renamed from: 飘花落叶言子世楪兰哲苏 */
    public final void mo2723() {
        this.f4394.setRotation(0.0f);
    }
    ...
    public final void mo2726(boolean z) {
        boolean z2 = false;
        this.f4404 = z && !this.f4412;
        this.f4411 = true;
        if (z && this.f4412) {
            z2 = true;
        }
        this.f4394.setClipToOutline(z2);
    }
    ...
    public final float mo2728() {
        return this.f4394.getCameraDistance() / this.f4393.getDisplayMetrics().densityDpi;
    }
    ...
    public final void mo2729(C1606 c1606) {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f4394.setRenderEffect(c1606 != null ? c1606.m2958() : null);
        }
    }
    ...
    public final void mo2731(float f) {
        this.f4394.setCameraDistance(f * this.f4393.getDisplayMetrics().densityDpi);
    }

    @Override // androidx.compose.ui.graphics.layer.InterfaceC1514
    /* JADX INFO: renamed from: 飘花落叶言子世苏哲楪兰 */
    public final Matrix mo2732() {
        return this.f4394.getMatrix();
    }
    ...
    public final void mo2733(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.f4400 = j;
            this.f4394.setOutlineSpotShadowColor(AbstractC1581.m2873(j));
        }
    }
    ...
    public final void mo2746(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.f4399 = j;
            this.f4394.setOutlineAmbientShadowColor(AbstractC1581.m2873(j));
        }
    }
    ...
    public final void mo2748(int i, int i2, long j) {
        boolean zM13357 = C7906.m13357(this.f4414, j);
        C1519 c1519 = this.f4394;
        if (zM13357) {
            int i3 = this.f4409;
            if (i3 != i) {
            ...
            if (this.f4404 || c1519.getClipToOutline()) {
                this.f4411 = true;
            }
            int i5 = (int) (j >> 32);
    ...
    public final void mo2749(long j) {
        ...
        if (j2 != 9205357640488583168L) {
            ...
            this.f4405 = true;
            c1519.setPivotX(((int) (this.f4414 >> 32)) / 2.0f);
            c1519.setPivotY(((int) (this.f4414 & 4294967295L)) / 2.0f);
        }
    }
    ...
    public final void mo2754(Outline outline, long j) {
        ...
        if ((this.f4404 || c1519.getClipToOutline()) && outline != null) {
    ...
    public final void mo2756(float f) {
        this.f4398 = f;
        this.f4394.setScaleY(f);
    }

    @Override // androidx.compose.ui.graphics.layer.InterfaceC1514
    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰 */
    public final void mo2757() {
        this.f4396.removeViewInLayout(this.f4394);
    }
