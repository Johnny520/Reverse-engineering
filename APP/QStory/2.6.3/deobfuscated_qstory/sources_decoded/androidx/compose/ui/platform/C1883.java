...
public final class C1883 extends C5856 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final /* synthetic */ ViewOnAttachStateChangeListenerC1885 f5411;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1883(ViewOnAttachStateChangeListenerC1885 viewOnAttachStateChangeListenerC1885) {
        super(15);
        this.f5411 = viewOnAttachStateChangeListenerC1885;
    }

    @Override // top.suzhelan.qstory.hook.item.chat.C5856
    /* JADX INFO: renamed from: 飘花落叶言子世楪哲苏兰, reason: contains not printable characters */
    public final C7607 mo3505(int i) {
        ViewOnAttachStateChangeListenerC1885 viewOnAttachStateChangeListenerC1885 = this.f5411;
        if (i != 1) {
            if (i == 2) {
                return mo3506(viewOnAttachStateChangeListenerC1885.f5523);
            }
            C5925.m11310(AbstractC6183.m11588(i, "Unknown focus type: "));
            return null;
        }
        int i2 = viewOnAttachStateChangeListenerC1885.f5522;
    ...
    */
    public final p155.C7607 mo3506(int r48) {
        /*
            Method dump skipped, instruction units count: 3253
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C1883.mo3506(int):飘花落叶言子哲世苏楪兰.飘花落叶言子楪世兰哲苏");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean mo3507(int r25, int r26, android.os.Bundle r27) {
        /*
            Method dump skipped, instruction units count: 2150
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C1883.mo3507(int, int, android.os.Bundle):boolean");
    }

    @Override // top.suzhelan.qstory.hook.item.chat.C5856
    /* JADX INFO: renamed from: 飘花落叶言子楪兰哲苏世, reason: contains not printable characters */
    public final void mo3508(int i, C7607 c7607, String str, Bundle bundle) {
        this.f5411.m3589(i, c7607, str, bundle);
    }
}
