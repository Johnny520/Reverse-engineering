...
public final class C0386 implements InterfaceC0309 {
    ...
    public double m1078(float f) {
        float[] fArr = AbstractC0403.f1345;
        return Math.log(((double) (Math.abs(f) * 0.35f)) / ((double) (this.f1298 * this.f1297)));
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public C0383 m1079(float f) {
        double dM1078 = m1078(f);
        double d = AbstractC0385.f1296;
        double d2 = d - 1.0d;
        return new C0383(f, (float) (Math.exp((d / d2) * dM1078) * ((double) (this.f1298 * this.f1297))), (long) (Math.exp(dM1078 / d2) * 1000.0d));
    }
