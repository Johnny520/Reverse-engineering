...
public final class C0596 extends AbstractC1736 {
    ...
    public final float f1674;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final Direction f1675;

    public C0596(Direction direction, float f) {
        this.f1675 = direction;
        this.f1674 = f;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f1675 == c0596.f1675 && this.f1674 == c0596.f1674;
    }

    public final int hashCode() {
        return Float.hashCode(this.f1674) + (this.f1675.hashCode() * 31);
    }
    ...
    public final void mo1096(AbstractC2128 abstractC2128) {
        ...
        c0606.f1698 = this.f1675;
        c0606.f1699 = this.f1674;
    }
