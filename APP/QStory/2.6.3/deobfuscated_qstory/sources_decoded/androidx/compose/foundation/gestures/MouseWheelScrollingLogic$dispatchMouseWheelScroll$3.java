...
@InterfaceC6862(c = "androidx.compose.foundation.gestures.MouseWheelScrollingLogic$dispatchMouseWheelScroll$3", f = "MouseWheelScrollingLogic.kt", l = {228, 241, 261}, m = "invokeSuspend", v = 1)
...
final class MouseWheelScrollingLogic$dispatchMouseWheelScroll$3 extends SuspendLambda implements InterfaceC6554 {
    ...
    public MouseWheelScrollingLogic$dispatchMouseWheelScroll$3(Ref$FloatRef ref$FloatRef, Ref$ObjectRef<C0350> ref$ObjectRef, Ref$ObjectRef<C0559> ref$ObjectRef2, float f, C0554 c0554, float f2, C0502 c0502, InterfaceC4357<? super MouseWheelScrollingLogic$dispatchMouseWheelScroll$3> interfaceC4357) {
    ...
    public static final boolean invokeSuspend$lambda$0(C0554 c0554, Ref$ObjectRef ref$ObjectRef, Ref$FloatRef ref$FloatRef, C0502 c0502, Ref$BooleanRef ref$BooleanRef, float f) {
        C0559 c0559M1347 = C0554.m1347(c0554.f1595);
        if (c0559M1347 != null) {
            C0076 c0076 = c0554.f1601;
            long j = c0559M1347.f1609;
            long j2 = c0559M1347.f1610;
            ((C7312) c0076.f227).m12508(Float.intBitsToFloat((int) (j2 >> 32)), j);
            ((C7312) c0076.f228).m12508(Float.intBitsToFloat((int) (j2 & 4294967295L)), j);
            ?? M1352 = ((C0559) ref$ObjectRef.element).m1352(c0559M1347);
            ref$ObjectRef.element = M1352;
            ref$FloatRef.element = c0502.m1270(c0502.m1263(M1352.f1610));
            ref$BooleanRef.element = !AbstractC0521.m1297(r9 - f);
        }
        return c0559M1347 != null;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final InterfaceC4357<C5176> create(Object obj, InterfaceC4357<?> interfaceC4357) {
        MouseWheelScrollingLogic$dispatchMouseWheelScroll$3 mouseWheelScrollingLogic$dispatchMouseWheelScroll$3 = new MouseWheelScrollingLogic$dispatchMouseWheelScroll$3(this.$targetValue, this.$animationState, this.$targetScrollDelta, this.$threshold, this.this$0, this.$speed, this.$this_dispatchMouseWheelScroll, interfaceC4357);
    ...
    public final Object invoke(InterfaceC0557 interfaceC0557, InterfaceC4357<? super C5176> interfaceC4357) {
        return ((MouseWheelScrollingLogic$dispatchMouseWheelScroll$3) create(interfaceC0557, interfaceC4357)).invokeSuspend(C5176.f14739);
    }

    /* JADX WARN: Code restructure failed: missing block: B:20:0x009c, code lost:
    
        r0 = java.lang.Math.signum(r0) * r7.$threshold;
        r7.this$0.m1349(r6, r0);
        r2 = r7.$animationState;
        r3 = r2.element;
        r2.element = androidx.compose.animation.core.AbstractC0330.m1018(r3, ((java.lang.Number) ((androidx.compose.runtime.AbstractC1347) r3.f1199).getValue()).floatValue() + r0, 0.0f, 30);
        r0 = p053.AbstractC6561.m12058(java.lang.Math.abs(r7.$targetValue.element - ((java.lang.Number) ((androidx.compose.runtime.AbstractC1347) r7.$animationState.element.f1199).getValue()).floatValue()) / r7.$speed);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00ef, code lost:
        ...
        r15 = r0;
        r0 = androidx.compose.animation.core.AbstractC0330.m1028(r2, new java.lang.Float(r4), androidx.compose.animation.core.AbstractC0330.m1013(r0, r11, androidx.compose.animation.core.AbstractC0336.f1141), true, new androidx.compose.foundation.gestures.C0533(r3, r14, r6, r13), r7);
     */
