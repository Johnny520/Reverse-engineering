...
public final class HeightInLinesModifierKt$legacyHeightInLines$$inlined$debugInspectorInfo$1 extends Lambda implements InterfaceC6558 {
    final /* synthetic */ int $maxLines$inlined;
    final /* synthetic */ int $minLines$inlined;
    final /* synthetic */ C2031 $textStyle$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HeightInLinesModifierKt$legacyHeightInLines$$inlined$debugInspectorInfo$1(int i, int i2, C2031 c2031) {
        super(1);
        this.$minLines$inlined = i;
        this.$maxLines$inlined = i2;
        this.$textStyle$inlined = c2031;
    }
