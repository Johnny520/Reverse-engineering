...
public final class C0243 extends AbstractC0291 {
    ...
    public final void m762(int i) {
        ...
        long j = 255 << ((iMax & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f896 = AbstractC0290.m886(this.f1008) - this.f1014;
        this.f1012 = iMax == 0 ? AbstractC7772.f21079 : new Object[iMax];
        if (iMax == 0) {
    ...
    public final int m764(Object obj) {
        int i;
        long j;
        long j2;
        long j3;
        ...
        while (true) {
            ...
            while (j8 != 0) {
                ...
                int i11 = i2;
                if (AbstractC4395.m8907(this.f1012[iNumberOfTrailingZeros], obj)) {
            ...
            if ((j5 & ((~j5) << 6) & (-9187201950435737472L)) != 0) {
                int iM763 = m763(i4);
                long j9 = 255;
                if (this.f896 != 0 || ((this.f1013[iM763 >> 3] >> ((iM763 & 7) << 3)) & 255) == 254) {
                    i = 0;
                    j = j6;
                    j2 = 255;
                    j3 = 128;
                            ...
                            if (jArr4 == null) {
                                ...
                                while (i20 != i14) {
                                    ...
                                    if (j12 != 128 && j12 == 254) {
                                        ...
                                        int iM7632 = m763(i24);
                                        int i25 = i24 & i14;
                                        if (((iM7632 - i25) & i14) / 8 == ((i20 - i25) & i14) / 8) {
                                            int i26 = i14;
                                            ...
                                            if (((j14 >> i29) & j2) == 128) {
                                                ...
                                                objArr3[iM7632] = objArr3[i20];
                                                objArr3[i20] = null;
                                                jArr5[iM7632] = jArr5[i20];
                                                jArr5[i20] = 4611686018427387903L;
                                                int i30 = (int) ((jArr6[i20] >> 32) & 4294967295L);
                                                if (i30 != Integer.MAX_VALUE) {
                                                    j4 = j6;
                                                    jArr6[i30] = ((long) iM7632) | (jArr6[i30] & (-4294967296L));
                                                    jArr6[i20] = (jArr6[i20] & 4294967295L) | (-4294967296L);
                                                } else {
                                                    j4 = j6;
                                                    jArr6[i20] = 9223372032559808512L | ((long) iM7632);
                                                }
                                                jArr6[iM7632] = (((long) i20) << 32) | 2147483647L;
                                            } else {
                                                j4 = j6;
                                                jArr4[i28] = (((long) (i23 & 127)) << i29) | (j14 & (~(j2 << i29)));
                                                Object obj3 = objArr3[iM7632];
                                                objArr3[iM7632] = objArr3[i20];
                                                objArr3[i20] = obj3;
                                                long j15 = jArr5[iM7632];
                                                jArr5[iM7632] = jArr5[i20];
                                                jArr5[i20] = j15;
                                                ...
                                                jArr6[iM7632] = (((long) i31) << 32) | ((long) i20);
                                                i20--;
                                            }
                                            jArr4[jArr4.length - 1] = jArr4[0];
                                            i20++;
                    ...
                    j = j6;
                    j2 = 255;
                    int iM885 = AbstractC0290.m885(this.f1008);
                    ...
                    while (i39 < i37) {
                        if (((jArr8[i39 >> 3] >> ((i39 & 7) << 3)) & 255) < j3) {
                            ...
                            jArr[i41] = j20;
                            jArr[(((iM7633 - 7) & i38) + (i38 & 7)) >> 3] = j20;
                            objArr5[iM7633] = obj4;
                            jArr11[iM7633] = jArr9[i39];
                            iArr[i39] = iM7633;
                        } else {
                            jArr = jArr10;
                            jArr2 = jArr8;
                ...
                jArr13[i49] = j23;
                jArr13[(((iM763 - 7) & i51) + (i51 & 7)) >> 3] = j23;
                return iM763;
            }
            i8 += 8;
            i7 = (i7 + i8) & i6;
    ...
    public final void m765() {
        ...
        AbstractC4347.m8834(0, this.f1008, null, this.f1012);
        AbstractC4347.m8833(4611686018427387903L, this.f1011);
        this.f1010 = Integer.MAX_VALUE;
        this.f1009 = Integer.MAX_VALUE;
        this.f896 = AbstractC0290.m886(this.f1008) - this.f1014;
    }
    ...
    public final boolean m766(Object obj) {
        int i = this.f1014;
        int iM764 = m764(obj);
        this.f1012[iM764] = obj;
    ...
    */
    public final boolean m768(java.lang.Object r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L7a:
            ...
            goto L1c
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.C0243.m768(java.lang.Object):boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean m769(java.util.Collection r17) {
        /*
            r16 = this;
            r0 = r16
            r17.getClass()
        ...
        L5a:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.C0243.m769(java.util.Collection):boolean");
    }
}
