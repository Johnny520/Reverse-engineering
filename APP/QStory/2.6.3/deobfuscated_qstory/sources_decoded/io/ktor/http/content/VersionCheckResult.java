...
public final class VersionCheckResult {
    ...
    private final C8097 statusCode;
    ...
    static {
        ...
        OK = new VersionCheckResult("OK", 0, C8097.f22351);
        NOT_MODIFIED = new VersionCheckResult("NOT_MODIFIED", 1, C8097.f22356);
        PRECONDITION_FAILED = new VersionCheckResult("PRECONDITION_FAILED", 2, C8097.f22341);
        VersionCheckResult[] versionCheckResultArr$values = $values();
        $VALUES = versionCheckResultArr$values;
        $ENTRIES = AbstractC4364.m8866(versionCheckResultArr$values);
    }

    private VersionCheckResult(String str, int i, C8097 c8097) {
        this.statusCode = c8097;
    }
    ...
    public final C8097 getStatusCode() {
