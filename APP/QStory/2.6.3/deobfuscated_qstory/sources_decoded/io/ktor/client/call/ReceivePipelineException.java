...
public final class ReceivePipelineException extends IllegalStateException {
    ...
    private final C6857 info;
    private final C3868 request;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReceivePipelineException(C3868 c3868, C6857 c6857, Throwable th) {
    ...
    public final C6857 getInfo() {
        return this.info;
    }

    public final C3868 getRequest() {
        return this.request;
    }
}
