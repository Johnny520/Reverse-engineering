...
public final class CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1 extends SuspendLambda implements InterfaceC6558 {
    final /* synthetic */ Object $context;
    final /* synthetic */ AbstractC4195 $this_execute;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1(AbstractC4195 abstractC4195, Object obj, InterfaceC4357 interfaceC4357) {
    ...
    public final InterfaceC4357<C5176> create(InterfaceC4357<?> interfaceC4357) {
        return new CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1(this.$this_execute, this.$context, interfaceC4357);
    }

    @Override // p052.InterfaceC6558
    public final Object invoke(InterfaceC4357<? super C5176> interfaceC4357) {
        return ((CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1) create(interfaceC4357)).invokeSuspend(C5176.f14739);
    }
