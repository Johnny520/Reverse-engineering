...
public final class BaseApplicationResponse$BodyLengthIsTooLong extends IllegalStateException implements InterfaceC5434 {
    private final long expected;

    public BaseApplicationResponse$BodyLengthIsTooLong(long j) {
        super(AbstractC2442.m4583(j, "Body.size is too long. Expected "));
        this.expected = j;
    }
