...
class BSHPrimarySuffix extends SimpleNode {
  ...
  0x013c: PHI (r3v5 int) = (r3v4 int), (r3v18 int) binds: [B:64:0x00e2, B:85:0x0127] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private AbstractC2651 doMethodRef(Object obj) {
        String str = this.field;
        C3763 c3763 = AbstractC2651.f7934;
        return new C2659(this, obj, str);
    }
    ...
    private Object doName(Object obj, boolean z, CallStack callStack, Interpreter interpreter) throws EvalError {
        ...
        if (jjtGetNumChildren() == 0) {
            ...
            if (z) {
                try {
                    this = AbstractC2667.m5459(obj, str);
                    return this;
            ...
            try {
                try {
                    return AbstractC2667.m5455(obj, str);
                } catch (Throwable unused2) {
                    this = AbstractC2667.m5453(obj, this.field);
                    return this;
                }
        ...
        Interpreter.mainSecurityGuard.m13873(obj, this.field, arguments);
        r5 = this;
        callStack2 = callStack;
        try {
            return AbstractC2667.m5447(obj, this.field, arguments, interpreter, callStack2, r5);
    ...
    private Object doProperty(boolean z, Object obj, CallStack callStack, Interpreter interpreter) throws EvalError {
        ...
        try {
            Object objM5453 = AbstractC2667.m5453(obj, (String) objEval);
            return objM5453 == null ? Primitive.NULL : Primitive.unwrap(objM5453);
        } catch (ReflectError e) {
            throw new EvalError(AbstractC0053.m153(objEval, "No such property: "), this, callStack, e);
        }
    }

    public static int getIndexAux(Object obj, int i, CallStack callStack, Interpreter interpreter, InterfaceC2619 interfaceC2619) throws EvalError {
        try {
            Object objEval = interfaceC2619.jjtGetChild(i).eval(callStack, interpreter);
            boolean z = objEval instanceof Primitive;
            Class cls = Integer.TYPE;
            if (!z) {
                objEval = AbstractC2662.m5373(objEval, cls, 1);
            }
            return ((Integer) Primitive.castWrapper(cls, objEval)).intValue();
        } catch (Exception e) {
            Interpreter.debug("doIndex: " + e);
            throw new EvalError("Array index does not evaluate to an integer.", interfaceC2619, callStack, e);
        }
    }
    ...
    public Object doSuffix(Object obj, boolean z, CallStack callStack, Interpreter interpreter) {
        ...
        if (obj instanceof InterfaceC2619) {
            obj = obj instanceof BSHAmbiguousName ? ((BSHAmbiguousName) obj).toObject(callStack, interpreter) : ((InterfaceC2619) obj).eval(callStack, interpreter);
    ...
    public String toString() {
        ...
        if (i != 1) {
            if (i != 2) {
                return i == 3 ? AbstractC0053.m151(new StringBuilder(), super.toString(), ":PROPERTY {}") : i == 4 ? AbstractC0053.m151(new StringBuilder(), super.toString(), ":NEW new") : i == 6 ? AbstractC0053.m151(new StringBuilder(), super.toString(), ":CLASS class") : AbstractC0053.m151(new StringBuilder(), super.toString(), ":NO OPERATION");
            }
