            ...
            if (!this.staticImport) {
                ...
                if (!this.importPackage) {
                    ...
                    try {
                        ...
                        try {
                            object = AbstractC2667.m5435(cls, strSuffix);
                    ...
                    if (cls != null && object == null) {
                        try {
                            object = AbstractC2667.m5451(cls, strSuffix);
                    ...
                    throw new EvalException(AbstractC0053.m151(new StringBuilder(), bSHAmbiguousName.text, " is not a static member of a class"), this, callStack);
                }
