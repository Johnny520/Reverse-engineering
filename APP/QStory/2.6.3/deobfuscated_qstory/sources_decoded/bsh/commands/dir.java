...
public class dir {
    ...
    public static final String[] f7822 = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
    ...
    public static void invoke(Interpreter interpreter, CallStack callStack, String str) {
        try {
            ...
            for (String str2 : list) {
                StringBuilder sbM140 = AbstractC0053.m140(absolutePath);
                sbM140.append(File.separator);
                sbM140.append(str2);
                File file = new File(sbM140.toString());
                ...
                sb.append(f7822[gregorianCalendar.get(2)] + " " + i);
                if (i < 10) {
                    sb.append(" ");
                }
                sb.append(" ");
