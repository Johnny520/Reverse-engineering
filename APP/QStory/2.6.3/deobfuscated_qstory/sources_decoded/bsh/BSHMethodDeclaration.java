...
class BSHMethodDeclaration extends SimpleNode {
    ...
    public Object eval(CallStack callStack, Interpreter interpreter) throws EvalException {
        ...
        if (!z && !pVar.isClass) {
            interpreter.getClassManager().mo5135(bshMethod);
        } else if (z && !this.paramsNode.isListener()) {
            interpreter.getClassManager().mo5135(this.paramsNode);
    ...
    */
    ...
    public synchronized void insureNodesParsed() {
        ...
        try {
            ...
            if (interfaceC2619JjtGetChild instanceof BSHReturnType) {
                this.returnTypeNode = (BSHReturnType) interfaceC2619JjtGetChild;
                interfaceC2619JjtGetChild = jjtGetChild(1);
                i = 1;
            } else {
                i = 0;
            }
            if (interfaceC2619JjtGetChild instanceof BSHAmbiguousName) {
                String str = ((BSHAmbiguousName) interfaceC2619JjtGetChild).text;
            ...
            if (bSHBlock != null && bSHBlock.jjtGetNumChildren() > 0) {
                ...
                InterfaceC2619 interfaceC2619JjtGetChild2 = bSHBlock2.jjtGetChild(bSHBlock2.jjtGetNumChildren() - 1);
                if (interfaceC2619JjtGetChild2 instanceof BSHReturnStatement) {
                    while (interfaceC2619JjtGetChild2.hasNext()) {
                        interfaceC2619JjtGetChild2 = (InterfaceC2619) interfaceC2619JjtGetChild2.next();
                        if (interfaceC2619JjtGetChild2 instanceof BSHAmbiguousName) {
                            this.isScriptedObject = ((BSHAmbiguousName) interfaceC2619JjtGetChild2).text.startsWith("this");
                        }
                    }
                }
            }
