...
class BSHArrayInitializer extends SimpleNode {
    ...
    private Object buildArray(int i, Class<?> cls, CallStack callStack, Interpreter interpreter) throws EvalException {
        ...
        for (int i2 = 0; i2 < jjtGetNumChildren(); i2++) {
            InterfaceC2619 interfaceC2619JjtGetChild = jjtGetChild(i2);
            if (!(interfaceC2619JjtGetChild instanceof BSHArrayInitializer)) {
                objEval = interfaceC2619JjtGetChild.eval(callStack, interpreter);
            } else if (i < 2) {
                BSHArrayInitializer bSHArrayInitializer = (BSHArrayInitializer) interfaceC2619JjtGetChild;
                ...
                objEval = ((BSHArrayInitializer) interfaceC2619JjtGetChild).eval(cls, i - 1, callStack, interpreter);
            }
            if (objEval == Primitive.VOID) {
                throw new EvalException(AbstractC6183.m11588(i2, "Void in array initializer, position "), this, callStack);
            }
            try {
    ...
    private Class<?> inferCommonType(Class<?> cls, InterfaceC2619 interfaceC2619, CallStack callStack, Interpreter interpreter) {
        if (Object.class != cls && Types$MapEntry.class != cls) {
            if (interfaceC2619 instanceof BSHAssignment) {
                return AbstractC2662.m5391(cls, AbstractC2662.m5376(AbstractC2662.m5395(interfaceC2619.eval(callStack, interpreter), Primitive.isWrapperType(cls))));
            }
            if ((interfaceC2619 instanceof BSHArrayInitializer) && isMapInArray((BSHArrayInitializer) interfaceC2619)) {
                return AbstractC2662.m5391(cls, Map.class);
            }
            for (InterfaceC2619 interfaceC26192 : interfaceC2619.jjtGetChildren()) {
                cls = inferCommonType(cls, interfaceC26192, callStack, interpreter);
            }
        }
        return cls;
    }

    private int inferDimensions(int i, int i2, InterfaceC2619 interfaceC2619, CallStack callStack, Interpreter interpreter) {
        while (interfaceC2619.jjtGetNumChildren() > i2) {
            interfaceC2619 = interfaceC2619.jjtGetChild(i2);
            if (!(interfaceC2619 instanceof BSHArrayInitializer) || isMapInArray((BSHArrayInitializer) interfaceC2619) || interfaceC2619.jjtGetNumChildren() <= 0) {
                break;
            }
            i++;
            i2 = 0;
        }
        if (interfaceC2619 instanceof BSHArrayInitializer) {
            return interfaceC2619.jjtGetNumChildren() == 0 ? inferDimensions(i, i2 + 1, interfaceC2619.jjtGetParent(), callStack, interpreter) : i;
        }
        Object objEval = interfaceC2619.eval(callStack, interpreter);
        return objEval == Primitive.NULL ? inferDimensions(i, i2 + 1, interfaceC2619.jjtGetParent(), callStack, interpreter) : AbstractC2662.m5377(AbstractC2662.m5395(objEval, false)) + i;
    }

    private boolean isBeanType(Class<?> cls) {
        return Void.TYPE != cls && !AbstractC2662.m5389(cls) && (jjtGetChild(0) instanceof BSHAssignment) && (jjtGetChild(0).jjtGetChild(0) instanceof BSHPrimaryExpression) && ((BSHPrimaryExpression) jjtGetChild(0).jjtGetChild(0)).isMapExpression && (jjtGetChild(0).jjtGetChild(0).jjtGetChild(0) instanceof BSHAmbiguousName);
    }
    ...
    private Object normalizeEntry(Object obj, Class<?> cls, int i, CallStack callStack) throws EvalException {
        ...
        try {
            return Primitive.unwrap(AbstractC2662.m5373(obj, cls, 0));
    ...
    private void throwTypeError(Class<?> cls, Object obj, int i, CallStack callStack) throws EvalException {
        StringBuilder sbM11585 = AbstractC6183.m11585("Incompatible type: ", AbstractC2629.m5328(obj), " in initializer of array type: ");
        sbM11585.append(cls.getSimpleName());
        sbM11585.append(" at position: ");
        sbM11585.append(i);
        throw new EvalException(sbM11585.toString(), this, callStack);
    }

    private Object toCollection(Object obj, Class<?> cls, CallStack callStack) {
        Class<?> cls2 = obj.getClass();
        Class clsM5376 = AbstractC2662.m5376(cls2);
        if (AbstractC2662.m5389(cls) && (!cls2.isArray() || (!Map.class.isAssignableFrom(clsM5376) && !Collection.class.isAssignableFrom(clsM5376)))) {
            try {
                return AbstractC2662.m5373(obj, cls, 0);
            } catch (UtilEvalError e) {
    ...
    */
    public java.lang.Object eval(java.lang.Class<?> r10, int r11, bsh.CallStack r12, bsh.Interpreter r13) throws bsh.EvalException {
        ...
        L8:
            ...
            if (r11 != 0) goto L21
            if (r10 == r2) goto L18
            boolean r11 = bsh.AbstractC2662.m5389(r10)
            if (r11 == 0) goto L17
            goto L18
        L17:
            r0 = r10
        ...
        L35:
            ...
            boolean r9 = bsh.AbstractC2662.m5389(r10)
            if (r9 == 0) goto L47
            r9 = r2
            goto L57
        L47:
    ...
    public void jjtSetParent(InterfaceC2619 interfaceC2619) {
        ...
        if (interfaceC2619Arr != null) {
            for (InterfaceC2619 interfaceC26192 : interfaceC2619Arr) {
                if (interfaceC26192.jjtGetNumChildren() > 0 && (interfaceC26192.jjtGetChild(0) instanceof BSHPrimaryExpression)) {
                    this.expressionQueue.push((BSHPrimaryExpression) interfaceC26192.jjtGetChild(0));
