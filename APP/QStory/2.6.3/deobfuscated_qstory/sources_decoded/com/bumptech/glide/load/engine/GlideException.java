...
public final class GlideException extends Exception {
    ...
    private void printStackTrace(Appendable appendable) {
        ...
        appendCauses(getCauses(), new C3003(appendable));
    }
    ...
    public void setLoggingDetails(InterfaceC8393 interfaceC8393, DataSource dataSource, Class<?> cls) {
        this.key = interfaceC8393;
    ...
    public void setLoggingDetails(InterfaceC8393 interfaceC8393, DataSource dataSource) {
        setLoggingDetails(interfaceC8393, dataSource, null);
    }
