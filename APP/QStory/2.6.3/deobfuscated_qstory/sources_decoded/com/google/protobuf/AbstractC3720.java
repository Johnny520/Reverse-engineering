...
public abstract class AbstractC3720 {
    ...
    static {
        Logger.getLogger(AbstractC3720.class.getName());
        f11542 = System.getenv().getOrDefault("SILENT_MARKER_INSERTION_ENABLED", "false").equals("true");
    ...
    public static ByteString m7980(String str) throws IOException {
        int i;
        int i2;
        int length;
        int i3;
            ...
            if (bByteAt3 == 92) {
                ...
                if (48 > bByteAt4 || bByteAt4 > 55) {
                        ...
                        if (bByteAt4 == 85) {
                            ...
                            while (true) {
                                ...
                                if (i8 < i9) {
                                    ...
                                    iM7983 = (iM7983 << 4) | m7983(bByteAt5);
                                    i8++;
                                } else {
                                    if (!Character.isValidCodePoint(iM7983)) {
                                    ...
                                    Character.UnicodeBlock unicodeBlockOf = Character.UnicodeBlock.of(iM7983);
                                    ...
                                    byte[] bytes = new String(new int[]{iM7983}, 0, 1).getBytes(AbstractC3402.f11059);
                            ...
                            int i10 = i4 + 2;
                            if (i10 >= byteStringCopyFromUtf8.size() || !m7982(byteStringCopyFromUtf8.byteAt(i10))) {
                            ...
                            int iM79832 = m7983(byteStringCopyFromUtf8.byteAt(i10));
                            i4 += 3;
                            if (i4 >= byteStringCopyFromUtf8.size() || !m7982(byteStringCopyFromUtf8.byteAt(i4))) {
                                i4 = i10;
                            } else {
                                iM79832 = (iM79832 * 16) + m7983(byteStringCopyFromUtf8.byteAt(i4));
                            }
                            i3 = i5 + 1;
                            bArr[i5] = (byte) iM79832;
                        } else if (bByteAt4 == 97) {
                            i = i5 + 1;
                            bArr[i5] = 7;
                        } else if (bByteAt4 != 98) {
                            switch (bByteAt4) {
                                ...
                                case 117:
                                    int i11 = i4 + 2;
                                    i2 = i4 + 5;
                                    if (i2 < byteStringCopyFromUtf8.size() && m7982(byteStringCopyFromUtf8.byteAt(i11))) {
                                        int i12 = i4 + 3;
                                        if (m7982(byteStringCopyFromUtf8.byteAt(i12))) {
                                            int i13 = i4 + 4;
                                            if (m7982(byteStringCopyFromUtf8.byteAt(i13)) && m7982(byteStringCopyFromUtf8.byteAt(i2))) {
                                                char cM7983 = (char) ((m7983(byteStringCopyFromUtf8.byteAt(i13)) << 4) | (m7983(byteStringCopyFromUtf8.byteAt(i11)) << 12) | (m7983(byteStringCopyFromUtf8.byteAt(i12)) << 8) | m7983(byteStringCopyFromUtf8.byteAt(i2)));
                                                if (cM7983 >= 55296 && cM7983 <= 57343) {
                                                ...
                                                byte[] bytes2 = Character.toString(cM7983).getBytes(AbstractC3402.f11059);
                    ...
                    if (i4 >= byteStringCopyFromUtf8.size() || 48 > (bByteAt = byteStringCopyFromUtf8.byteAt(i4)) || bByteAt > 55) {
                        ...
                        iM79833 = (iM79833 * 8) + m7983(byteStringCopyFromUtf8.byteAt(i4));
                    }
                    i3 = i5 + 1;
                    bArr[i5] = (byte) iM79833;
                }
                i5 = i3;
            } else {
                bArr[i5] = bByteAt3;
    ...
    public static long m7981(String str, boolean z, boolean z2) {
        int i;
        int i2 = 0;
        if (str.startsWith("-", 0)) {
            if (!z) {
    ...
    public static boolean m7982(byte b) {
        if (48 <= b && b <= 57) {
            return true;
        }
        if (97 > b || b > 102) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static int m7983(byte b) {
