...
public final class C3344 implements Iterator {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public ByteString.LeafByteString f10979;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final ArrayDeque f10980;

    public C3344(ByteString byteString) {
        if (!(byteString instanceof RopeByteString)) {
            this.f10980 = null;
            this.f10979 = (ByteString.LeafByteString) byteString;
            return;
        }
        RopeByteString ropeByteString = (RopeByteString) byteString;
        ArrayDeque arrayDeque = new ArrayDeque(ropeByteString.getTreeDepth());
        this.f10980 = arrayDeque;
        arrayDeque.push(ropeByteString);
        ByteString byteString2 = ropeByteString.left;
        while (byteString2 instanceof RopeByteString) {
            RopeByteString ropeByteString2 = (RopeByteString) byteString2;
            this.f10980.push(ropeByteString2);
            byteString2 = ropeByteString2.left;
        }
        this.f10979 = (ByteString.LeafByteString) byteString2;
    }
    ...
    public final ByteString.LeafByteString next() {
        ByteString.LeafByteString leafByteString = this.f10979;
        ...
        while (true) {
            ArrayDeque arrayDeque = this.f10980;
