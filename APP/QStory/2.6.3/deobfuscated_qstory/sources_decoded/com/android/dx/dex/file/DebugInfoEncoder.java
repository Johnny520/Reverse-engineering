...
public final class DebugInfoEncoder {
    ...
    private void annotate(int i, String str) {
        if (this.prefix != null) {
            str = AbstractC0053.m151(new StringBuilder(), this.prefix, str);
        }
    ...
    private static int computeOpcode(int i, int i2) {
        if (i >= -4 && i <= 10) {
            return AbstractC6183.m11574(i2, 15, i - (-4), 10);
        }
        C2633.m5339("Parameter out of range");
        return 0;
    }
    ...
    private void emitPosition(PositionList.Entry entry) {
        ...
        if (i2 < 0) {
            C2633.m5339("Position entries must be in ascending address order");
            return;
        }
        int i3 = 0;
        if (i < -4 || i > 10) {
    ...
    private void emitUnsignedLeb128(int i) {
        if (i >= 0) {
            ...
            C2633.m5339(AbstractC6183.m11588(i, "Signed value where unsigned required: "));
        }
    }
