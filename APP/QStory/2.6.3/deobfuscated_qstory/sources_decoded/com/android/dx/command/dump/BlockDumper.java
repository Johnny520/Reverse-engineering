...
public class BlockDumper extends BaseDumper {
    ...
    private void regularDump(ConcreteMethod concreteMethod) {
        ...
        while (i < size) {
            ...
            sb.append("..");
            parsed(bytes, start, 0, AbstractC2442.m4560(sb, end));
            changeIndent(1);
            while (start < end) {
            ...
            if (size2 == 0) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    parsed(bytes, end, 0, AbstractC2442.m4560(new StringBuilder("next "), successors.get(i3)));
                }
            }
    ...
    public void startParsingMember(ByteArray byteArray, int i, String str, String str2) {
        if (str2.indexOf(40) >= 0 && shouldDumpMethod(str)) {
            ...
            parsed(byteArray, i, 0, AbstractC6183.m11581("method ", str, " ", str2));
            this.suppressDump = true;
        }
    }
