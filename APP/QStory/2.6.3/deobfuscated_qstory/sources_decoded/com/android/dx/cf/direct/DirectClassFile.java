...
public class DirectClassFile implements ClassFile {
    ...
    private void parse0() {
        ...
        if (parseObserver2 != null) {
            ...
            this.observer.parsed(this.bytes, i3, 2, AbstractC2442.m4560(new StringBuilder("interfaces_count: "), unsignedShort2));
            if (unsignedShort2 != 0) {
        ...
        if (this.strictParse) {
            ...
            if (!this.filePath.endsWith(ClassFileLocator.CLASS_FILE_EXTENSION) || !this.filePath.startsWith(className) || this.filePath.length() != className.length() + 6) {
                throw new ParseException(AbstractC0053.m151(AbstractC6183.m11585("class name (", className, ") does not match path ("), this.filePath, ")"));
            }
        }
    ...
    public TypeList makeTypeList(int i, int i2) {
        ...
        C5925.m11311("pool not yet initialized");
        return null;
    }
