...
public final class EncodedMethod extends EncodedMember implements Comparable<EncodedMethod> {
    ...
    public int encode(DexFile dexFile, AnnotatedOutput annotatedOutput, int i, int i2) {
        ...
        if ((absoluteOffsetOr0 != 0) != ((accessFlags & 1280) == 0)) {
            C5925.m11308("code vs. access_flags mismatch");
            return 0;
        }
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(0, String.format("  [%x] %s", Integer.valueOf(i2), this.method.toHuman()));
            annotatedOutput.annotate(AbstractC3055.m6637(i3), "    method_idx:   " + Hex.u4(iIndexOf));
            annotatedOutput.annotate(AbstractC3055.m6637(accessFlags), "    access_flags: " + AccessFlags.methodString(accessFlags));
            AbstractC2442.m4563(absoluteOffsetOr0, new StringBuilder("    code_off:     "), annotatedOutput, AbstractC3055.m6637(absoluteOffsetOr0));
        }
