...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    public int compareTo0(OffsettedItem offsettedItem) {
        ...
        C5925.m11308("uninternable instance");
        return 0;
    }
    ...
    public void setClassAnnotations(Annotations annotations, DexFile dexFile) {
        if (annotations == null) {
            ...
            C5925.m11308("class annotations already set");
        }
    }
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            AbstractC2442.m4563(iListSize3, new StringBuilder("  parameters_size:       "), annotatedOutput, 4);
        }
