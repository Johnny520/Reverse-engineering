...
public final class CstInvokeDynamic extends Constant {
    ...
    public void setCallSite(CstCallSite cstCallSite) {
        if (this.callSite != null) {
            C5925.m11310("already added call site");
    ...
    public void setDeclaringClass(CstType cstType) {
        if (this.declaringClass != null) {
            C5925.m11310("already added declaring class");
    ...
    public String toHuman() {
        ...
        StringBuilder sbM11585 = AbstractC6183.m11585("InvokeDynamic(", cstType != null ? cstType.toHuman() : "Unknown", ":");
        sbM11585.append(this.bootstrapMethodIndex);
        sbM11585.append(", ");
        sbM11585.append(this.nat.toHuman());
        sbM11585.append(")");
