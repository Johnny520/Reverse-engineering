...
public abstract class InsnFormat {
    ...
    public static short codeUnit(int i, int i2, int i3, int i4) {
        if ((i & 15) != i) {
            C5925.m11310("n0 out of range 0..15");
            return (short) 0;
        }
        if ((i2 & 15) != i2) {
            C5925.m11310("n1 out of range 0..15");
            return (short) 0;
        }
        if ((i3 & 15) != i3) {
            C5925.m11310("n2 out of range 0..15");
            return (short) 0;
        }
        if ((i4 & 15) == i4) {
            return (short) (i | (i2 << 4) | (i3 << 8) | (i4 << 12));
        }
        C5925.m11310("n3 out of range 0..15");
        return (short) 0;
    }
    ...
    public static int makeByte(int i, int i2) {
        if ((i & 15) != i) {
            C5925.m11310("low out of range 0..15");
            return 0;
        }
        if ((i2 & 15) == i2) {
            return i | (i2 << 4);
        }
        C5925.m11310("high out of range 0..15");
        return 0;
    }

    public static short opcodeUnit(DalvInsn dalvInsn, int i) {
        if ((i & Opcodes.CONST_METHOD_TYPE) != i) {
            C5925.m11310("arg out of range 0..255");
            return (short) 0;
        }
        ...
        C5925.m11310("opcode out of range 0..255");
        return (short) 0;
    }
    ...
    public static short opcodeUnit(DalvInsn dalvInsn) {
        ...
        C5925.m11310("opcode out of range 0..65535");
        return (short) 0;
    }
    ...
    public static short codeUnit(int i, int i2) {
        if ((i & Opcodes.CONST_METHOD_TYPE) != i) {
            C5925.m11310("low out of range 0..255");
            return (short) 0;
        }
        if ((i2 & Opcodes.CONST_METHOD_TYPE) == i2) {
            return (short) (i | (i2 << 8));
        }
        C5925.m11310("high out of range 0..255");
        return (short) 0;
    }
}
