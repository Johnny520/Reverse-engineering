...
public final class OutputFinisher {
    ...
    private Dop findExpandedOpcodeForInsn(DalvInsn dalvInsn) {
        ...
        C7547.m12768(dalvInsn, "No expanded opcode for ");
        return null;
    }
                ...
                if (opcode.getFormat().branchFits(targetInsn)) {
                    ...
                    if (opcode.getFamily() == 40) {
                        ...
                        try {
                            ...
                            C5925.m11311("unpaired TargetInsn");
                            return false;
                        } catch (IndexOutOfBoundsException unused2) {
                            C5925.m11311("unpaired TargetInsn (dangling)");
                            return false;
                        }
                    }
                    z = true;
    ...
    */
    ...
    public DalvInsnList finishProcessingAndGetList() {
        if (this.reservedCount >= 0) {
            C5925.m11308("already processed");
            return null;
        }
    ...
    public void reverseBranch(int i, CodeAddress codeAddress) {
        ...
        try {
            ...
            C5925.m11310("non-reversible instruction");
        } catch (IndexOutOfBoundsException unused2) {
            C5925.m11310("too few instructions");
        }
    }
