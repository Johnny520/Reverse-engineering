...
public final class ClassDataItem extends OffsettedItem {
    ...
    public void addStaticField(EncodedField encodedField, Constant constant) {
        if (encodedField == null) {
            ...
            C5925.m11308("static fields already sorted");
        } else {
    ...
    public void debugPrint(Writer writer, boolean z) {
        ...
        int size = this.staticFields.size();
        for (int i = 0; i < size; i++) {
            StringBuilder sbM150 = AbstractC0053.m150(i, "  sfields[", "]: ");
            sbM150.append(this.staticFields.get(i));
            printWriterPrintWriterFor.println(sbM150.toString());
        }
        int size2 = this.instanceFields.size();
        for (int i2 = 0; i2 < size2; i2++) {
            StringBuilder sbM1502 = AbstractC0053.m150(i2, "  ifields[", "]: ");
            sbM1502.append(this.instanceFields.get(i2));
            printWriterPrintWriterFor.println(sbM1502.toString());
        }
