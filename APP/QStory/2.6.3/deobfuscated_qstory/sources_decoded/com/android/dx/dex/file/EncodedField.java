...
public final class EncodedField extends EncodedMember implements Comparable<EncodedField> {
    ...
    public int encode(DexFile dexFile, AnnotatedOutput annotatedOutput, int i, int i2) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            annotatedOutput.annotate(AbstractC3055.m6637(i3), "    field_idx:    " + Hex.u4(iIndexOf));
            annotatedOutput.annotate(AbstractC3055.m6637(accessFlags), "    access_flags: " + AccessFlags.fieldString(accessFlags));
        }
