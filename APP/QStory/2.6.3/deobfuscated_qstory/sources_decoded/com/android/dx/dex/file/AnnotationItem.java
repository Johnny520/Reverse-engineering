...
public final class AnnotationItem extends OffsettedItem {
    ...
    public void annotateTo(AnnotatedOutput annotatedOutput, String str) {
        StringBuilder sbM11584 = AbstractC6183.m11584(str, "visibility: ");
        sbM11584.append(this.annotation.getVisibility().toHuman());
        annotatedOutput.annotate(0, sbM11584.toString());
        ...
        for (NameValuePair nameValuePair : this.annotation.getNameValuePairs()) {
            ...
            sbM140.append(name.toHuman());
            sbM140.append(": ");
            sbM140.append(ValueEncoder.constantToHuman(value));
            annotatedOutput.annotate(0, sbM140.toString());
        }
    }
