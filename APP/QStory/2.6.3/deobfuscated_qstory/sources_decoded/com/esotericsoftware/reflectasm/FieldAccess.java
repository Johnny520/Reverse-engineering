...
public abstract class FieldAccess {
    ...
    public static FieldAccess get(Class cls) {
        ...
        if (cls.getSuperclass() == null) {
            C5925.m11310("The type must not be the Object class, an interface, a primitive type, or void.");
            return null;
        }
        ...
        try {
            ...
            C0276.m848("Error constructing field access class: ".concat(strConcat), th2);
            return null;
        }
    }
    ...
    private static void insertGetPrimitive(ClassWriter classWriter, String str, ArrayList<Field> arrayList, Type type) {
        ...
        MethodVisitor methodVisitorVisitMethod = classWriter.visitMethod(1, str2, AbstractC0053.m157("(Ljava/lang/Object;I)", descriptor), null, null);
        methodVisitorVisitMethod.visitCode();
        methodVisitorVisitMethod.visitVarInsn(21, 2);
        if (arrayList.isEmpty()) {
            i = 6;
    ...
    private static void insertSetPrimitive(ClassWriter classWriter, String str, ArrayList<Field> arrayList, Type type) {
        ...
        MethodVisitor methodVisitorVisitMethod = classWriter.visitMethod(1, str3, AbstractC0053.m158("(Ljava/lang/Object;I", descriptor, ")V"), null, null);
        methodVisitorVisitMethod.visitCode();
        methodVisitorVisitMethod.visitVarInsn(21, 2);
        if (arrayList.isEmpty()) {
            i3 = 6;
    ...
    public int getIndex(String str) {
        ...
        C5925.m11310(AbstractC0053.m157("Unable to find non-private field: ", str));
        return 0;
    }
    ...
    public int getIndex(Field field) {
        ...
        C4211.m8604(field, "Unable to find non-private field: ");
        return 0;
    }
