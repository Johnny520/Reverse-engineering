...
class CachedFields implements Comparator<FieldSerializer.CachedField> {
    ...
    */
    ...
    private void applyAnnotations(FieldSerializer.CachedField cachedField) {
        ...
        if (field.isAnnotationPresent(FieldSerializer.Bind.class)) {
            if (cachedField.serializer != null) {
                C3074.m6897(cachedField.field.getDeclaringClass().getName(), "@Bind applied to a field that already has a serializer: ", cachedField.field.getName());
                return;
            }
        ...
        if (field.isAnnotationPresent(CollectionSerializer.BindCollection.class)) {
            if (cachedField.serializer != null) {
                C3074.m6897(cachedField.field.getDeclaringClass().getName(), "@BindCollection applied to a field that already has a serializer: ", cachedField.field.getName());
                return;
            }
        ...
        if (field.isAnnotationPresent(MapSerializer.BindMap.class)) {
            if (cachedField.serializer != null) {
                C3074.m6897(cachedField.field.getDeclaringClass().getName(), "@BindMap applied to a field that already has a serializer: ", cachedField.field.getName());
                return;
            }
    ...
    public void removeField(String str) {
        ...
        C5925.m11310(AbstractC6183.m11589(this.serializer.type, AbstractC6183.m11585("Field \"", str, "\" not found on class: ")));
    }
    ...
    public void removeField(FieldSerializer.CachedField cachedField) {
        ...
        C5925.m11310(AbstractC6183.m11589(this.serializer.type, sb));
    }
}
