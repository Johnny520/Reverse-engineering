...
public class Util {
    ...
    private static Class<?> getPrimitiveWrapper(Class<?> cls) {
        ...
        C5925.m11310("Argument has to be primitive type");
        return null;
    }
    ...
    public static void log(String str, Object obj, int i) {
        if (obj == null) {
            if (Log.TRACE) {
                StringBuilder sbM11584 = AbstractC6183.m11584(str, ": null");
                sbM11584.append(pos(i));
                Log.trace("kryo", sbM11584.toString());
                return;
            }
            return;
        }
        ...
        if (!cls.isPrimitive() && !isWrapperClass(cls) && cls != String.class) {
            StringBuilder sbM115842 = AbstractC6183.m11584(str, ": ");
            sbM115842.append(string(obj));
            sbM115842.append(pos(i));
            Log.debug("kryo", sbM115842.toString());
            return;
        }
        if (Log.TRACE) {
            StringBuilder sbM115843 = AbstractC6183.m11584(str, ": ");
            sbM115843.append(string(obj));
            sbM115843.append(pos(i));
            Log.trace("kryo", sbM115843.toString());
        }
    }
    ...
    public static <T extends SerializerFactory> T newFactory(Class<T> cls, Class<? extends Serializer> cls2) {
        if (cls2 != null) {
            try {
                ...
                C3076.m6900("Unable to create serializer factory \"", cls.getName(), "\" for serializer class: ", className(cls2), e);
                return null;
            }
        }
        return cls.newInstance();
    ...
    public static String pos(int i) {
        return i == -1 ? "" : AbstractC0053.m162(i, " [", "]");
    }
