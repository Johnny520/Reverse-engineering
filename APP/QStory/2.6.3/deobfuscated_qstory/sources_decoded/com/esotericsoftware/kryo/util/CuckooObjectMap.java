...
public class CuckooObjectMap<K, V> {
    ...
    public CuckooObjectMap(int i, float f) {
        if (i < 0) {
            C5925.m11310(AbstractC6183.m11588(i, "initialCapacity must be >= 0: "));
            throw null;
        }
        if (i > 1073741824) {
            C5925.m11310(AbstractC6183.m11588(i, "initialCapacity is too large: "));
            throw null;
        }
        int iNextPowerOfTwo = nextPowerOfTwo(i);
        this.capacity = iNextPowerOfTwo;
        if (f <= 0.0f) {
            C3076.m6901("loadFactor must be > 0: ", f);
            throw null;
        }
        this.loadFactor = f;
