...
public class FieldSerializer<T> extends Serializer<T> {
    ...
    public static class FieldSerializerConfig implements Cloneable {
        ...
        public FieldSerializerConfig mo6893clone() {
            try {
    ...
    public FieldSerializer(Kryo kryo, Class cls, FieldSerializerConfig fieldSerializerConfig) {
        ...
        if (cls.isPrimitive()) {
            C5925.m11310(AbstractC0053.m154(cls, "type cannot be a primitive class: "));
            throw null;
        }
        if (fieldSerializerConfig == null) {
            C5925.m11310("config cannot be null.");
            throw null;
        }
        this.kryo = kryo;
        this.type = cls;
    ...
    public CachedField getField(String str) {
        ...
        C5925.m11310(AbstractC6183.m11589(this.type, AbstractC6183.m11585("Field \"", str, "\" not found on class: ")));
        return null;
    }
