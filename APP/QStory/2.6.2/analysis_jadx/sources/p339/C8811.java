...
public final class C8811 extends AbstractC6296 {
    ...
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        Class<?> clsLoadClass = classLoader.loadClass(AbstractC3056.m6668(-3937715313723049383L));
        String strM6668 = AbstractC3056.m6668(-3937715154809259431L);
        ...
        XposedHelpers.findAndHookMethod(clsLoadClass, AbstractC3056.m6668(-3937634001402201511L), new Object[]{View.class, new C6356(14)});
        int i = 25;
        XposedHelpers.findAndHookMethod(clsLoadClass, AbstractC3056.m6668(-3937715154809259431L), new Object[]{Activity.class, List.class, LinearLayout.class, cls, new C6356(i, 15)});
        XposedHelpers.findAndHookMethod(clsLoadClass, AbstractC3056.m6668(-3937634001402201511L), new Object[]{View.class, new C6356(i, 16)});
    }
}
