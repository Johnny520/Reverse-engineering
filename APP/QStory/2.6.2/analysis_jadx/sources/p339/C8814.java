...
public final class C8814 {
    ...
    public static void m14459(Context context) {
        AbstractC3056.m6668(-3937716748242126247L);
        ...
        try {
            ...
            String str3 = context.getDataDir().getAbsolutePath() + AbstractC3056.m6668(-3937554368413566375L);
            ...
            try {
                ...
                C9114.f25484 = AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937554381298468263L));
                ...
                String strM6668 = AbstractC3056.m6668(-3937676641837516199L);
                c91142.getClass();
                if (c91142.f25485.getBoolean(strM6668, false)) {
                    return;
                }
                System.loadLibrary(AbstractC3056.m6668(-3937716658047813031L));
                if (!AbstractC6291.m11801()) {
                    if (AbstractC6340.m11895()) {
                        String strConcat = AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937555227407025575L));
                        AbstractC0455.m1161(new File(AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937555120032843175L))));
                        AbstractC0455.m1161(new File(strConcat));
                        XposedHelpers.findAndHookMethod(Activity.class, AbstractC3056.m6668(-3937555107147941287L), new Object[]{new C5909(26)});
                        return;
                    }
                    return;
                }
                XposedHelpers.findAndHookMethod(Activity.class, AbstractC3056.m6668(-3937555107147941287L), new Object[]{new C5909(27)});
                try {
                    File file = new File(AbstractC3932.m8313(), AbstractC3056.m6668(-3937554553097160103L));
                    if (!file.exists()) {
                        file.createNewFile();
                    }
                ...
                if (AbstractC6560.m12011()) {
                    try {
                        XposedBridge.hookMethod(XposedHelpers.findMethodBestMatch(AbstractC6318.m11838(AbstractC3056.m6668(-3937555034133497255L)), AbstractC3056.m6668(-3937554879514674599L), new Class[0]), new C6160(new C6267(1), 1));
                    } catch (Exception e3) {
                        String strM66682 = AbstractC3056.m6668(-3937554772140492199L);
                        String str5 = AbstractC6157.f16779;
                        AbstractC6157.m11574(strM66682, e3.toString(), e3, true);
                    }
                } else {
                    try {
                        Method methodFindMethodBestMatch = XposedHelpers.findMethodBestMatch(AbstractC6318.m11838(AbstractC3056.m6668(-3937554815090165159L)), AbstractC3056.m6668(-3937554879514674599L), new Class[0]);
                        ...
                        String strM66683 = AbstractC3056.m6668(-3937554772140492199L);
                ...
                if (AbstractC6340.m11895()) {
                    ...
                    AbstractC6157.m11573(string, AbstractC3056.m6668(-3937555145802646951L));
                }
