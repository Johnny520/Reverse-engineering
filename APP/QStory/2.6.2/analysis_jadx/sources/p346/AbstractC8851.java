...
public abstract class AbstractC8851 {
    ...
    public static final C9114 f24959 = new C9114(AbstractC3056.m6668(-3937678608932537767L), 0);
    ...
    public static void m14489(String str, ArrayList arrayList) {
        ...
        c9114.m14640(Long.valueOf(System.currentTimeMillis()), strM11557.concat(AbstractC3056.m6668(-3937678720601687463L)));
    }
    ...
    public static boolean m14491(String str) {
        String strM11557 = AbstractC6136.m11557(-3937678772141295015L, new StringBuilder(), str);
        String strConcat = strM11557.concat(AbstractC3056.m6668(-3937678720601687463L));
        C9114 c9114 = f24959;
        c9114.getClass();
        SharedPreferencesC8175 sharedPreferencesC8175 = c9114.f25485;
        if (sharedPreferencesC8175.contains(strConcat)) {
            return System.currentTimeMillis() - sharedPreferencesC8175.getLong(strM11557.concat(AbstractC3056.m6668(-3937678720601687463L)), 0L) < 1800000;
        }
        return false;
    }
}
