...
public class EqualsMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            if (methodDescription.isStatic()) {
                C5919.m11250(AbstractC2442.m4562("Hash code method must not be static: ", methodDescription));
                return null;
            }
            ...
            if (!methodDescription.getReturnType().represents(Boolean.TYPE)) {
                C5919.m11250(AbstractC2442.m4562("Hash code method does not return primitive boolean: ", methodDescription));
                return null;
            }
        ...
        public int hashCode() {
            return this.identity.hashCode() + AbstractC2442.m4576(this.nonNullable, AbstractC0053.m159(this.fieldDescriptions, AbstractC2442.m4578(this.baseline, AbstractC2442.m4574(this.instrumentedType, getClass().hashCode() * 31, 31), 31), 31), 31);
        }
    }
    ...
    public interface NullValueGuard {
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public int hashCode() {
                return this.endOfBlock.hashCode() + ((this.secondValueNull.hashCode() + ((this.firstValueNull.hashCode() + AbstractC2442.m4557(this.instrumentedMethod, getClass().hashCode() * 31, 31)) * 31)) * 31);
            }
        }
    ...
    public enum SuperClassCheck {
        ...
        ENABLED { // from class: net.bytebuddy.implementation.EqualsMethod.SuperClassCheck.2
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                ...
                C5919.m11250(AbstractC2442.m4554(typeDescription, " does not declare a super class"));
                return null;
            }
        };
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (target.getInstrumentedType().isInterface()) {
            C4210.m8615(target.getInstrumentedType(), "Cannot implement meaningful equals method for ");
            return null;
        }
    ...
    public EqualsMethod withIdentityFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable, this.identity.or(elementMatcher), this.comparator);
    }

    public EqualsMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored.or(elementMatcher), this.nonNullable, this.identity, this.comparator);
    }

    public EqualsMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable.or(elementMatcher), this.identity, this.comparator);
    }
