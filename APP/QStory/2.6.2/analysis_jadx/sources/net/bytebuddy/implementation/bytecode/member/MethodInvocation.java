...
public enum MethodInvocation {
    ...
    public static class HandleInvocation extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return this.type.hashCode() + AbstractC2442.m4558(this.methodDescription, getClass().hashCode() * 31, 31);
        }
    }
    ...
    public static class OfGenericMethod implements WithImplicitInvocationTargetType {
        ...
        public int hashCode() {
            return this.invocation.hashCode() + AbstractC2442.m4574(this.targetType, getClass().hashCode() * 31, 31);
        }
    ...
    public class Invocation extends StackManipulation.AbstractBase implements WithImplicitInvocationTargetType {
        ...
        public int hashCode() {
            return MethodInvocation.this.hashCode() + AbstractC2442.m4558(this.methodDescription, AbstractC2442.m4574(this.typeDescription, getClass().hashCode() * 31, 31), 31);
        }
