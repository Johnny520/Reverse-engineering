...
public class MethodCall implements Implementation.Composable {
    ...
    public class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return MethodCall.this.hashCode() + ((this.terminationHandler.hashCode() + ((this.targetHandler.hashCode() + ((this.methodInvoker.hashCode() + AbstractC0053.m159(this.argumentProviders, (this.methodLocator.hashCode() + ((this.implementationTarget.hashCode() + (getClass().hashCode() * 31)) * 31)) * 31, 31)) * 31)) * 31)) * 31);
        }
        ...
        public StackManipulation toStackManipulation(MethodDescription methodDescription, MethodDescription methodDescription2, TargetHandler.Resolved resolved) {
            ...
            if (parameters.size() != arrayList.size()) {
                ...
                C5553.m10820(sb, " does not accept ", arrayList.size(), " arguments");
                return null;
            }
    ...
    public static Implementation.Composable call(Callable<?> callable) {
        try {
            ...
            C8796.m14449("Could not locate Callable::call method", e);
            return null;
        }
    }
    ...
    public static MethodCall construct(MethodDescription methodDescription) {
        ...
        C5919.m11249(AbstractC2442.m4562("Not a constructor: ", methodDescription));
        return null;
    }
    ...
    public static Implementation.Composable run(Runnable runnable) {
        try {
            ...
            C8796.m14449("Could not locate Runnable::run method", e);
            return null;
        }
    }
    ...
    public int hashCode() {
        return this.typing.hashCode() + AbstractC2442.m4579(this.assigner, (this.terminationHandler.hashCode() + ((this.methodInvoker.hashCode() + AbstractC0053.m159(this.argumentLoaders, (this.targetHandler.hashCode() + ((this.methodLocator.hashCode() + (getClass().hashCode() * 31)) * 31)) * 31, 31)) * 31)) * 31, 31);
    }
    ...
    public MethodCall withArgument(int... iArr) {
        ...
        for (int i : iArr) {
            if (i < 0) {
                C5919.m11249(AbstractC6136.m11556(i, "Negative index: "));
                return null;
            }
    ...
    public MethodCall withArgumentArrayElements(int i, int i2, int i3) {
        ...
        if (i2 < 0) {
            C5919.m11249(AbstractC6136.m11556(i2, "An array index cannot be negative: "));
            return null;
        }
        if (i3 == 0) {
            return this;
        ...
        if (i3 < 0) {
            C5919.m11249(AbstractC6136.m11556(i3, "Size cannot be negative: "));
            return null;
        }
    ...
    public interface ArgumentLoader {
        ...
        public static class ForInstance implements ArgumentLoader, ArgumentProvider {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C0276.m846("Cannot assign ", this.fieldDescription.getType(), " to ", parameterDescription);
                return null;
            }
        }
        ...
        public static class ForMethodCall implements ArgumentLoader {
            ...
            public int hashCode() {
                return this.targetHandler.hashCode() + AbstractC2442.m4557(this.instrumentedMethod, AbstractC2442.m4557(this.methodDescription, (this.appender.hashCode() + (getClass().hashCode() * 31)) * 31, 31), 31);
            }
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C0276.m846("Cannot assign return type of ", this.methodDescription, " to ", parameterDescription);
                return null;
            }
        }
        ...
        public static class ForStackManipulation implements ArgumentLoader, ArgumentProvider, Factory {
            ...
            public int hashCode() {
                return this.typeDefinition.hashCode() + AbstractC2442.m4578(this.stackManipulation, getClass().hashCode() * 31, 31);
            }
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C5553.m10824(sb, " to ", this.typeDefinition);
                return null;
            }
        ...
        public static class ForField implements ArgumentLoader {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                if (!this.fieldDescription.isStatic() && this.instrumentedMethod.isStatic()) {
                    ...
                    C5553.m10824(sb, " from ", this.instrumentedMethod);
                    return null;
                }
                ...
                C0276.m846("Cannot assign ", this.fieldDescription, " to ", parameterDescription);
                return null;
            }
            ...
            public static class Factory implements Factory {
                ...
                public int hashCode() {
                    return this.fieldLocatorFactory.hashCode() + AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.name);
                }
                ...
                public ArgumentProvider make(Implementation.Target target) {
                    ...
                    C0276.m846("Could not locate field '", this.name, "' on ", target.getInstrumentedType());
                    return null;
                }
        ...
        public static class ForInstrumentedType implements ArgumentLoader, ArgumentProvider {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C7546.m12745(parameterDescription, "Cannot assign Class value to ");
                return null;
            }
        ...
        public static class ForMethodParameter implements ArgumentLoader {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                sb.append(" to ");
                sb.append(parameterDescription);
                C5553.m10824(sb, " for ", this.instrumentedMethod);
                return null;
            }
            ...
            public static class Factory implements Factory, ArgumentProvider {
                ...
                public List<ArgumentLoader> resolve(MethodDescription methodDescription, MethodDescription methodDescription2) {
                    ...
                    C5553.m10821(sb, " does not have a parameter with index ", this.index, methodDescription.getParameters().size());
                    return null;
                }
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                if (parameterDescription.getType().represents(Object.class)) {
                    ...
                    if (!parameterDescription.getType().isArray()) {
                        C7546.m12745(parameterDescription, "Cannot set method parameter array for non-array type: ");
                        return null;
                    }
                ...
                while (it.hasNext()) {
                    ...
                    if (!compound.isValid()) {
                        C5553.m10830("Cannot assign ", parameterDescription2, " to ", componentType);
                        return null;
                    }
        ...
        public static class ForMethodParameterArrayElement implements ArgumentLoader {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C0276.m846("Cannot assign ", this.parameterDescription.getType().getComponentType(), " to ", parameterDescription);
                return null;
            }
            ...
            public static class OfInvokedMethod implements Factory, ArgumentProvider {
                ...
                public List<ArgumentLoader> resolve(MethodDescription methodDescription, MethodDescription methodDescription2) {
                    if (methodDescription.getParameters().size() <= this.index) {
                        StringBuilder sb = new StringBuilder();
                        sb.append(methodDescription);
                        C5553.m10821(sb, " does not declare a parameter with index ", this.index, methodDescription.getParameters().size());
                        return null;
                    }
                    if (!((ParameterDescription) methodDescription.getParameters().get(this.index)).getType().isArray()) {
                        ...
                        C5553.m10829(sb2, " at index ", this.index);
                        return null;
                    }
        ...
        public static class ForThisReference implements ArgumentLoader, ArgumentProvider {
            ...
            public List<ArgumentLoader> resolve(MethodDescription methodDescription, MethodDescription methodDescription2) {
                ...
                C5553.m10822(methodDescription, " is static and cannot supply an invoker instance");
                return null;
            }
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C0276.m846("Cannot assign ", this.instrumentedType, " to ", parameterDescription);
                return null;
            }
        ...
        public enum ForNullConstant implements ArgumentLoader, ArgumentProvider, Factory {
            ...
            public StackManipulation toStackManipulation(ParameterDescription parameterDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                C7546.m12745(parameterDescription, "Cannot assign null to ");
                return null;
            }
    ...
    public static class FieldSetting implements Implementation.Composable {
        ...
        public enum Appender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                C5553.m10826(methodDescription, "Instrumented method ", " does not return void for field setting method call");
                return null;
            }
        }
    ...
    public interface MethodInvoker {
        ...
        public static class ForContextualInvocation implements MethodInvoker {
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Implementation.Target target) {
                ...
                sb.append(methodDescription);
                C5553.m10824(sb, " on ", this.instrumentedType);
                return null;
            }
        }
        ...
        public static class ForDefaultMethodInvocation implements MethodInvoker {
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Implementation.Target target) {
                if (!methodDescription.isInvokableOn(this.instrumentedType)) {
                    StringBuilder sb = new StringBuilder("Cannot invoke ");
                    sb.append(methodDescription);
                    C5553.m10824(sb, " as default method of ", this.instrumentedType);
                    return null;
                }
                ...
                C5553.m10824(sb2, " on ", this.instrumentedType);
                return null;
            }
        }
        ...
        public static class ForSuperMethodInvocation implements MethodInvoker {
            ...
            public enum Factory implements Factory {
                ...
                public MethodInvoker make(TypeDescription typeDescription) {
                    ...
                    C5919.m11250(AbstractC2442.m4566("Cannot invoke super method for ", typeDescription));
                    return null;
                }
            }
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Implementation.Target target) {
                if (!methodDescription.isInvokableOn(target.getOriginType().asErasure())) {
                    StringBuilder sb = new StringBuilder("Cannot invoke ");
                    sb.append(methodDescription);
                    C5553.m10824(sb, " as super method of ", this.instrumentedType);
                    return null;
                }
                ...
                C5553.m10826(methodDescription, "Cannot invoke ", " as a super method");
                return null;
            }
        }
        ...
        public static class ForVirtualInvocation implements MethodInvoker {
            ...
            public static class Factory implements Factory {
                ...
                public MethodInvoker make(TypeDescription typeDescription) {
                    ...
                    C5553.m10816(typeDescription2, " is not accessible to ", typeDescription);
                    return null;
                }
            }
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Implementation.Target target) {
                ...
                StringBuilder sb = new StringBuilder("Cannot invoke ");
                sb.append(methodDescription);
                C5553.m10824(sb, " on ", this.typeDescription);
                return null;
            }
            ...
            public enum WithImplicitType implements MethodInvoker, Factory {
                ...
                public StackManipulation toStackManipulation(MethodDescription methodDescription, Implementation.Target target) {
                    ...
                    C5553.m10826(methodDescription, "Cannot invoke ", " virtually");
                    return null;
                }
    ...
    public interface TargetHandler {
        ...
        public static class ForField implements TargetHandler, Resolved {
            ...
            public interface Location {
                ...
                public static class ForImplicitField implements Location {
                    ...
                    public FieldDescription resolve(TypeDescription typeDescription) {
                        ...
                        C0276.m846("Could not locate field name ", this.name, " on ", typeDescription);
                        return null;
                    }
                }
            ...
            public StackManipulation toStackManipulation(MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                if (!methodDescription.isMethod() || !methodDescription.isVirtual() || !methodDescription.isVisibleTo(this.fieldDescription.getType().asErasure())) {
                    StringBuilder sb = new StringBuilder("Cannot invoke ");
                    sb.append(methodDescription);
                    C5553.m10824(sb, " on ", this.fieldDescription);
                    return null;
                }
                ...
                StringBuilder sb2 = new StringBuilder("Cannot invoke ");
                sb2.append(methodDescription);
                C5553.m10824(sb2, " on ", this.fieldDescription);
                return null;
            }
            ...
            public static class Factory implements Factory {
                ...
                public TargetHandler make(Implementation.Target target) {
                    ...
                    C5553.m10824(sb, " from ", target.getInstrumentedType());
                    return null;
                }
        ...
        public static class ForSelfOrStaticInvocation implements TargetHandler {
            ...
            public static class Resolved implements Resolved {
                ...
                public int hashCode() {
                    return this.instrumentedMethod.hashCode() + AbstractC2442.m4574(this.instrumentedType, getClass().hashCode() * 31, 31);
                }
                ...
                public StackManipulation toStackManipulation(MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    C5553.m10824(sb2, " in ", this.instrumentedType);
                    return null;
                }
            }
        ...
        public static class ForMethodParameter implements TargetHandler, Factory {
            ...
            public static class Resolved implements Resolved {
                ...
                public StackManipulation toStackManipulation(MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    StringBuilder sb = new StringBuilder("Cannot invoke ");
                    sb.append(methodDescription);
                    C5553.m10824(sb, " on ", this.parameterDescription.getType());
                    return null;
                }
            }
        ...
        public static class Simple implements TargetHandler, Factory, Resolved {
            ...
            public int hashCode() {
                return this.stackManipulation.hashCode() + AbstractC2442.m4574(this.typeDescription, getClass().hashCode() * 31, 31);
            }
    ...
    public static class WithoutSpecifiedTarget extends MethodCall {
        ...
        public MethodCall onArgument(int i) {
            ...
            C5919.m11249(AbstractC6136.m11556(i, "An argument index cannot be negative: "));
            return null;
        }
    ...
    public interface MethodLocator {
        ...
        public static class ForElementMatcher implements MethodLocator {
            ...
            public int hashCode() {
                return this.methodGraphCompiler.hashCode() + AbstractC2442.m4576(this.matcher, AbstractC2442.m4574(this.instrumentedType, getClass().hashCode() * 31, 31), 31);
            }
            ...
            public static class Explicit implements Factory {
                ...
                public TerminationHandler make(TypeDescription typeDescription) {
                    if (!this.fieldDescription.isStatic() && !typeDescription.isAssignableTo(this.fieldDescription.getDeclaringType().asErasure())) {
                        C0276.m846("Cannot set ", this.fieldDescription, " from ", typeDescription);
                        return null;
                    }
                ...
                public TerminationHandler make(TypeDescription typeDescription) {
                    ...
                    do {
                        ...
                        if (fieldListFilter.size() == 2) {
                            C5553.m10809(this.matcher, " is ambiguous and resolved: ", fieldListFilter);
                            return null;
                        }
                        superClass = superClass.getSuperClass();
                    } while (superClass != null);
                    C5553.m10809(this.matcher, " does not locate any accessible fields for ", typeDescription);
                    return null;
                }
            }
        ...
        public enum Simple implements TerminationHandler, Factory {
            RETURNING { // from class: net.bytebuddy.implementation.MethodCall.TerminationHandler.Simple.1
                ...
                public StackManipulation toStackManipulation(MethodDescription methodDescription, MethodDescription methodDescription2, Assigner assigner, Assigner.Typing typing) {
                    ...
                    C0276.m846("Cannot return ", methodDescription.getReturnType(), " from ", methodDescription2);
                    return null;
                }
            },
