...
public class TypeProxy implements AuxiliaryType {
    ...
    public static class ForDefaultMethod extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return ((this.implementationTarget.hashCode() + AbstractC2442.m4574(this.proxiedType, getClass().hashCode() * 31, 31)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
    ...
    public static class ForSuperMethodByConstructor extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return ((((this.implementationTarget.hashCode() + AbstractC2442.m4558(this.constructor, AbstractC2442.m4574(this.proxiedType, getClass().hashCode() * 31, 31), 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
    ...
    public static class ForSuperMethodByReflectionFactory extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return ((((this.implementationTarget.hashCode() + AbstractC2442.m4574(this.proxiedType, getClass().hashCode() * 31, 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
    ...
    public class MethodCall implements Implementation {
        ...
        public class Appender implements ByteCodeAppender {
            ...
            public class AccessorMethodInvocation implements StackManipulation {
                ...
                public int hashCode() {
                    return Appender.this.hashCode() + ((this.specialMethodInvocation.hashCode() + AbstractC2442.m4557(this.instrumentedMethod, getClass().hashCode() * 31, 31)) * 31);
                }
            ...
            public int hashCode() {
                return MethodCall.this.hashCode() + AbstractC2442.m4578(this.fieldLoadingInstruction, getClass().hashCode() * 31, 31);
            }
        }
    ...
    public int hashCode() {
        return ((((this.invocationFactory.hashCode() + ((this.implementationTarget.hashCode() + AbstractC2442.m4574(this.proxiedType, getClass().hashCode() * 31, 31)) * 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
    }
