...
public interface MethodDelegationBinder {
    ...
    public interface MethodBinding extends StackManipulation {
        ...
        public static class Builder {
            ...
            public static class Build implements MethodBinding {
                ...
                public int hashCode() {
                    return this.terminatingStackManipulation.hashCode() + AbstractC0053.m159(this.parameterStackManipulations, AbstractC2442.m4578(this.methodInvocation, AbstractC6136.m11538(this.registeredTargetIndices, AbstractC2442.m4557(this.target, getClass().hashCode() * 31, 31), 31), 31), 31);
                }
            ...
            public MethodBinding build(StackManipulation stackManipulation) {
                ...
                C5919.m11250("The number of parameters bound does not equal the target's number of parameters");
                return null;
            }
        }
    ...
    public static class Processor implements Record {
        ...
        public MethodBinding bind(Implementation.Target target, MethodDescription methodDescription, TerminationHandler terminationHandler, MethodInvoker methodInvoker, Assigner assigner) {
            ...
            C5553.m10814("None of ", this.records, " allows for delegation from ", methodDescription3);
            return null;
        }
        ...
        public int hashCode() {
            return this.bindingResolver.hashCode() + ((this.ambiguityResolver.hashCode() + AbstractC0053.m159(this.records, getClass().hashCode() * 31, 31)) * 31);
        }
    }
    ...
    public interface BindingResolver {
        ...
        public enum Default implements BindingResolver {
            ...
            private MethodBinding doResolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                if (size == 2) {
                    ...
                    C5553.m10819(sb, " or ", methodBinding2.getTarget());
                    return null;
                }
                ...
                if (i2 != 3 && i2 != 4) {
                    C5919.m11244(list.size(), "Unexpected amount of targets: ");
                    return null;
                }
                list.remove(1);
                list.remove(0);
                ...
                C5553.m10819(sb2, " or ", methodBinding4.getTarget());
                return null;
            }
        ...
        public enum Unique implements BindingResolver {
            ...
            public MethodBinding resolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                C5553.m10816(methodDescription, " allowed for more than one binding: ", list);
                return null;
            }
        }
