...
public final class MethodVariableAccess {
    ...
    public static class MethodLoading extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return this.typeCastingHandler.hashCode() + AbstractC2442.m4557(this.methodDescription, getClass().hashCode() * 31, 31);
        }
    ...
    public static MethodVariableAccess of(TypeDefinition typeDefinition) {
        ...
        C5919.m11249("Variable type cannot be void");
        return null;
    }
    ...
    public StackManipulation increment(int i, int i2) {
        ...
        C7546.m12745(this, "Cannot increment type: ");
        return null;
    }
