...
public class ExceptionMethod implements Implementation, ByteCodeAppender {
    ...
    public interface ConstructionDelegate {
        ...
        public static class ForDefaultConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.targetConstructor.hashCode() + AbstractC2442.m4574(this.throwableType, getClass().hashCode() * 31, 31);
            }
        ...
        public static class ForStringConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.message.hashCode() + AbstractC2442.m4557(this.targetConstructor, AbstractC2442.m4574(this.throwableType, getClass().hashCode() * 31, 31), 31);
            }
    ...
    public static Implementation throwing(TypeDescription typeDescription) {
        ...
        C5919.m11249(AbstractC2442.m4554(typeDescription, " does not extend throwable"));
        return null;
    }
