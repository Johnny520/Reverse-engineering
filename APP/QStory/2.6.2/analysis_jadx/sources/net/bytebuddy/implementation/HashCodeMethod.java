...
public class HashCodeMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            if (!methodDescription.getReturnType().represents(Integer.TYPE)) {
                C5919.m11250(AbstractC2442.m4562("Hash code method does not return primitive integer: ", methodDescription));
                return null;
            }
        ...
        public int hashCode() {
            return this.identity.hashCode() + AbstractC2442.m4576(this.nonNullable, AbstractC0053.m159(this.fieldDescriptions, (AbstractC2442.m4578(this.initialValue, getClass().hashCode() * 31, 31) + this.multiplier) * 31, 31), 31);
        }
    }
    ...
    public interface NullValueGuard {
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public int hashCode() {
                return this.label.hashCode() + AbstractC2442.m4557(this.instrumentedMethod, getClass().hashCode() * 31, 31);
            }
        }
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        ...
        C4210.m8615(target.getInstrumentedType(), "Cannot implement meaningful hash code method for ");
        return null;
    }
    ...
    public HashCodeMethod withMultiplier(int i) {
        ...
        C5919.m11249("Hash code multiplier must not be zero");
        return null;
    }
