...
public interface ConstructorStrategy {
    ...
    public static class ForDefaultConstructor implements ConstructorStrategy {
        ...
        public List<MethodDescription.Token> extractConstructors(TypeDescription typeDescription) {
            ...
            if (superClass == null) {
                C5919.m11249(AbstractC2442.m4566("Cannot extract constructors for ", typeDescription));
                return null;
            }
            ...
            C5919.m11250("Cannot define default constructor for class without super class constructor");
            return null;
        }

        public int hashCode() {
            return this.methodAttributeAppenderFactory.hashCode() + AbstractC2442.m4576(this.elementMatcher, getClass().hashCode() * 31, 31);
        }
        ...
        public MethodRegistry inject(TypeDescription typeDescription, MethodRegistry methodRegistry) {
            TypeDescription.Generic superClass = typeDescription.getSuperClass();
            if (superClass == null) {
                C5919.m11249(AbstractC2442.m4566("Cannot inject constructors for ", typeDescription));
                return null;
            }
            ...
            if (methodListFilter.isEmpty()) {
                C7546.m12745(superClass, "No possible candidate for super constructor invocation in ");
                return null;
            }
            if (!methodListFilter.filter(ElementMatchers.takesArguments(0)).isEmpty()) {
                ...
                C7546.m12745(methodListFilter, "More than one possible super constructor for constructor delegation: ");
                return null;
            }
    ...
    public enum Default implements ConstructorStrategy {
        ...
        DEFAULT_CONSTRUCTOR { // from class: net.bytebuddy.dynamic.scaffold.subclass.ConstructorStrategy.Default.2
            ...
            public List<MethodDescription.Token> doExtractConstructors(TypeDescription typeDescription) {
                ...
                C2308.m4345(typeDescription.getSuperClass(), " declares no constructor that is visible to ", typeDescription);
                return null;
            }
