...
public class ByteArrayClassLoader extends InjectionClassLoader {
    ...
    public class ClassDefinitionAction implements PrivilegedAction<Class<?>> {
        ...
        public int hashCode() {
            return ByteArrayClassLoader.this.hashCode() + ((Arrays.hashCode(this.binaryRepresentation) + AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.name)) * 31);
        }
    ...
    public enum PersistenceHandler {
        ...
        public static class UrlDefinitionAction implements PrivilegedAction<URL> {
            ...
            public int hashCode() {
                return Arrays.hashCode(this.binaryRepresentation) + AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.typeName);
            }
            ...
            public URL run() {
                try {
                    ...
                    C8796.m14449("Could not find encoding: UTF-8", e);
                    return null;
                } catch (MalformedURLException e2) {
                    C5553.m10828("Cannot create URL for ", this.typeName, e2);
                    return null;
                }
            }
        }
        ...
        for (TypeDescription typeDescription : map.keySet()) {
            if (!classLoaderDecoratorMake.isSkipped(typeDescription)) {
                try {
                    ...
                    C8796.m14449(AbstractC2442.m4566("Cannot load class ", typeDescription), e);
                    return null;
                }
            }
        }
