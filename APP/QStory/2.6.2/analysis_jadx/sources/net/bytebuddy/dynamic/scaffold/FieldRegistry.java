...
public interface FieldRegistry {
    ...
    public static class Default implements FieldRegistry {
        ...
        public static class Compiled implements Compiled {
            ...
            public int hashCode() {
                return this.entries.hashCode() + AbstractC2442.m4574(this.instrumentedType, getClass().hashCode() * 31, 31);
            }
            ...
            public static class Entry implements ElementMatcher<FieldDescription> {
                ...
                */
                ...
                public int hashCode() {
                    int iHashCode = (this.fieldAttributeAppender.hashCode() + AbstractC2442.m4576(this.matcher, getClass().hashCode() * 31, 31)) * 31;
                    Object obj = this.defaultValue;
                    if (obj != null) {
                        iHashCode += obj.hashCode();
                    }
