...
public class ModifierAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public static class Adjustment<T> implements ElementMatcher<T> {
        ...
        public int hashCode() {
            return this.resolver.hashCode() + AbstractC2442.m4576(this.matcher, getClass().hashCode() * 31, 31);
        }
    ...
    public int hashCode() {
        return this.methodAdjustments.hashCode() + AbstractC0053.m159(this.fieldAdjustments, AbstractC0053.m159(this.typeAdjustments, getClass().hashCode() * 31, 31), 31);
    }
