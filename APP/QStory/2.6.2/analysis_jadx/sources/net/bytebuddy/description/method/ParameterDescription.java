    ...
    public static abstract class ForLoadedParameter<T extends AccessibleObject> extends InDefinedShape.AbstractBase {
        ...
        public static class OfConstructor extends ForLoadedParameter<Constructor<?>> {
            ...
            public TypeDescription.Generic getType() {
                ...
                T t = this.executable;
                return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(((Constructor) t).getParameterTypes()[this.index]) : new TypeDescription.Generic.LazyProjection.OfConstructorParameter((Constructor) t, this.index, ((Constructor) t).getParameterTypes());
            }
        }
        ...
        public static class OfMethod extends ForLoadedParameter<Method> {
            ...
            public TypeDescription.Generic getType() {
                boolean z = TypeDescription.AbstractBase.RAW_TYPES;
                T t = this.executable;
                return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(((Method) t).getParameterTypes()[this.index]) : new TypeDescription.Generic.LazyProjection.OfMethodParameter((Method) t, this.index, ((Method) t).getParameterTypes());
            }
        }
