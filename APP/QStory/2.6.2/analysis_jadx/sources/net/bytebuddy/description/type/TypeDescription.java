...
public interface TypeDescription extends TypeDefinition, ByteCodeElement, TypeVariableSource {
        ...
        public interface Visitor<T> {
            ...
            public enum Generalizing implements Visitor<Generic> {
                ...
                public Generic onGenericArray(Generic generic) {
                    ...
                    return ArrayProjection.of(ForLoadedType.of(Object.class), i).asGenericType();
                }
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
                public Generic onParameterizedType(Generic generic) {
                    return ForLoadedType.of(Object.class).asGenericType();
                }
                    ...
                    public static class ForParameterizedType extends AbstractBase {
                        ...
                        public Boolean onParameterizedType(Generic generic) {
                            ...
                            if (typeArguments.size() != typeArguments2.size()) {
                                ...
                                sb.append(generic);
                                C5553.m10819(sb, " and ", this.parameterizedType);
                                return null;
                            }
            ...
            public static abstract class Substitutor implements Visitor<Generic> {
                ...
                public static class ForTypeVariableBinding extends WithoutTypeSubstitution {
                    ...
                    public class TypeVariableSubstitutor implements TypeVariableSource.Visitor<Generic> {
                        ...
                        public int hashCode() {
                            return ForTypeVariableBinding.this.hashCode() + AbstractC2442.m4575(this.typeVariable, getClass().hashCode() * 31, 31);
                        }
                ...
                public static class ForAttachment extends Substitutor {
                    ...
                    public int hashCode() {
                        return this.typeVariableSource.hashCode() + AbstractC2442.m4574(this.declaringType, getClass().hashCode() * 31, 31);
                    }
            ...
            public static class Reducing implements Visitor<TypeDescription> {
                ...
                public int hashCode() {
                    return this.typeVariableTokens.hashCode() + AbstractC2442.m4574(this.declaringType, getClass().hashCode() * 31, 31);
                }
        ...
        public static abstract class Builder {
            ...
            public static Builder parameterizedType(TypeDescription typeDescription, @MaybeNull Generic generic, Collection<? extends TypeDefinition> collection) {
                ...
                if (!typeDescription.represents(TargetType.class)) {
                    if (!typeDescription.isGenerified()) {
                        C5919.m11249(AbstractC2442.m4554(typeDescription, " is not a parameterized type"));
                        return null;
                    }
                    if (generic == null && declaringType != null && !typeDescription.isStatic()) {
                        C5919.m11249(AbstractC2442.m4554(typeDescription, " requires an owner type"));
                        return null;
                    }
                    if (generic != null && !generic.asErasure().equals(declaringType)) {
                        C5553.m10808(generic, " does not represent required owner for ", typeDescription);
                        return null;
                    }
                    if (generic != null && (typeDescription.isStatic() ^ generic.getSort().isNonGeneric())) {
                        C5553.m10808(generic, " does not define the correct parameters for owning ", typeDescription);
                        return null;
                    }
                    if (typeDescription.getTypeVariables().size() != collection.size()) {
                        C5553.m10808(collection, " does not contain number of required parameters for ", typeDescription);
                        return null;
                    }
                }
            ...
            public static Builder rawType(TypeDescription typeDescription, @MaybeNull Generic generic) {
                ...
                if (declaringType == null && generic != null) {
                    C5553.m10808(typeDescription, " does not have a declaring type: ", generic);
                    return null;
                }
                ...
                C5553.m10808(generic, " is not the declaring type of ", typeDescription);
                return null;
            }
            ...
            public Builder asArray(int i) {
                if (i < 1) {
                    C5919.m11249(AbstractC6136.m11556(i, "Cannot define an array of a non-positive arity: "));
                    return null;
                }
                ...
                */
                public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                    ...
                    L38:
                        return r1
                    L39:
                        java.util.List<? extends net.bytebuddy.description.type.TypeDescription$Generic> r4 = r4.parameterTypes
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iM4574 = AbstractC2442.m4574(this.rawType, super.hashCode() * 31, 31);
                    Generic generic = this.ownerType;
                    if (generic != null) {
                        iM4574 += generic.hashCode();
                    }
                    return this.parameterTypes.hashCode() + (iM4574 * 31);
                }
            ...
            public static class OfNonGenericType extends Builder {
                ...
                public Generic doBuild() {
                    ...
                    C5919.m11249("The void non-type cannot be annotated");
                    return null;
                }
                ...
                */
                public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
                    ...
                    L1a:
                        ...
                        return r1
                    L27:
                        net.bytebuddy.description.type.TypeDescription$Generic r4 = r4.ownerType
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iM4574 = AbstractC2442.m4574(this.typeDescription, super.hashCode() * 31, 31);
                    Generic generic = this.ownerType;
                    return generic != null ? generic.hashCode() + iM4574 : iM4574;
                }
        ...
        public static abstract class OfTypeVariable extends AbstractBase {
            ...
            public static class ForLoadedType extends OfTypeVariable {
                ...
                public TypeVariableSource getTypeVariableSource() {
                    ...
                    C7546.m12745(genericDeclaration, "Unknown declaration: ");
                    return null;
                }
            ...
            public static class OfConstructorParameter extends WithEagerNavigation.OfAnnotatedElement {
                ...
                public Generic resolve() {
                    ...
                    if (this.delegate != null) {
                        ...
                        int i = this.index;
                        genericDescribeOrNull = length == length2 ? TypeDefinition.Sort.describeOrNull(genericParameterTypes[i], getAnnotationReader()) : OfNonGenericType.ForLoadedType.of(clsArr[i]);
                    }
                    if (genericDescribeOrNull == null) {
        ...
        public interface AnnotationReader {
            ...
            public static abstract class Delegator implements AnnotationReader {
                ...
                public static class ForLoadedInterface extends Delegator {
                    ...
                    public int hashCode() {
                        return AbstractC2442.m4559(getClass().hashCode() * 31, 31, this.type) + this.index;
                    }
    ...
    public static class ArrayProjection extends AbstractBase {
        ...
        public static TypeDescription of(TypeDescription typeDescription, int i) {
            if (i < 0) {
                C5919.m11249("Arrays cannot have a negative arity");
                return null;
            }
    ...
    public static class ForLoadedType extends AbstractBase implements Serializable {
        ...
        public Generic getSuperClass() {
            ...
            Class<?> cls = this.type;
            return z ? cls.getSuperclass() == null ? Generic.UNDEFINED : Generic.OfNonGenericType.ForLoadedType.of(this.type.getSuperclass()) : Generic.LazyProjection.ForLoadedSuperClass.of(cls);
        }
