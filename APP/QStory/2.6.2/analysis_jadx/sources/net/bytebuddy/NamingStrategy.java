...
public interface NamingStrategy {
    ...
    public static class Suffixing extends AbstractBase {
        ...
        public interface BaseNameResolver {
            ...
            public static class WithCallerSuffix implements BaseNameResolver {
                ...
                public String resolve(TypeDescription typeDescription) {
                    ...
                    if (str == null) {
                        C5919.m11250(AbstractC9032.m14590(ByteBuddy.class, "Base name resolver not invoked via "));
                        return null;
                    }
        ...
        public int hashCode() {
            return this.baseNameResolver.hashCode() + AbstractC6136.m11539(AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.suffix), 31, this.javaLangPackagePrefix);
        }
        ...
        public String name(TypeDescription typeDescription) {
            ...
            StringBuilder sbM11553 = AbstractC6136.m11553(strResolve, "$");
            sbM11553.append(this.suffix);
