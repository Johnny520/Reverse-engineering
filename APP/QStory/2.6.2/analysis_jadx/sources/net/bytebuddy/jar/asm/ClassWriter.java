...
public class ClassWriter extends ClassVisitor {
    ...
    public byte[] toByteArray() {
        ...
        if ((this.accessFlags & 4096) != 0 && (this.version & com.android.dx.io.Opcodes.MAX_VALUE) < 49) {
            attributeCount++;
        ...
        byteVector5.putShort((~((this.version & com.android.dx.io.Opcodes.MAX_VALUE) < 49 ? 4096 : 0)) & this.accessFlags).putShort(this.thisClass).putShort(this.superClass);
    ...
    public final void visit(int i, int i2, String str, String str2, String str3, String[] strArr) {
        ...
        int i3 = i & com.android.dx.io.Opcodes.MAX_VALUE;
