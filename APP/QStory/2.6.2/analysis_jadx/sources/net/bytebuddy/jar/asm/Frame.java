...
class Frame {
    ...
    private static int getAbstractTypeFromDescriptor(SymbolTable symbolTable, String str, int i) {
        ...
        if (cCharAt == 'L') {
            return symbolTable.addType(AbstractC0053.m160(1, i + 1, str)) | REFERENCE_KIND;
        }
        if (cCharAt != 'S') {
            if (cCharAt == 'V') {
                return 0;
                ...
                if (cCharAt != 'Z') {
                    if (cCharAt == '[') {
                        ...
                        if (cCharAt2 == 'F') {
                            ...
                            iAddType = symbolTable.addType(AbstractC0053.m160(1, i2 + 1, str)) | REFERENCE_KIND;
                        } else if (cCharAt2 == 'S') {
                            iAddType = SHORT;
                        } else if (cCharAt2 == 'Z') {
                            iAddType = BOOLEAN;
                            ...
                            switch (cCharAt2) {
                                ...
                                case 'D':
                                    ...
                                    break;
                                default:
                                    C5919.m11249(stringConcat$0(str.substring(i2)));
                                    return 0;
                            }
                        } else {
                            iAddType = LONG;
                    ...
                    switch (cCharAt) {
                        ...
                        case 'D':
                            return DOUBLE;
                        default:
                            C5919.m11249(stringConcat$1(str.substring(i)));
                            return 0;
                    }
                }
            }
    ...
    */
    ...
    private static /* synthetic */ String stringConcat$0(String str) {
        return AbstractC0053.m152("Invalid descriptor fragment: ", str);
    }

    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0053.m152("Invalid descriptor: ", str);
    }

    private static /* synthetic */ String stringConcat$2(String str) {
        return AbstractC0053.m152("[", str);
    }
