...
final class Constants {
    ...
    public static void checkIsPreview(InputStream inputStream) {
        if (inputStream == null) {
            C5919.m11250("Bytecode not available, can't check class version");
            return;
        }
        try {
            ...
            try {
                ...
                C5919.m11250("ASM10_EXPERIMENTAL can only be used by classes compiled with --enable-preview");
            } catch (Throwable th) {
                try {
                    dataInputStream.close();
            ...
            C8796.m14449("I/O error, can't check class version", e);
        }
    }
    ...
    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0053.m156("net/bytebuddy/jar/asm/util/Trace", str, "Visitor(\\$.*)?");
    }

    private static /* synthetic */ String stringConcat$2(String str) {
        return AbstractC0053.m156("net/bytebuddy/jar/asm/util/Check", str, "Adapter(\\$.*)?");
    }
}
