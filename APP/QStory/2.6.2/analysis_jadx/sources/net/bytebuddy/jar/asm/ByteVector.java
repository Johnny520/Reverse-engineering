        ...
        while (i < length) {
            ...
            if (cCharAt2 < 1 || cCharAt2 > 127) {
                ...
                if (cCharAt2 <= 2047) {
                    ...
                    bArr2[i8] = (byte) (((cCharAt2 >> '\f') & 15) | com.android.dx.io.Opcodes.SHL_INT_LIT8);
                    int i10 = i8 + 2;
    ...
    public ByteVector putUTF8(String str) {
        ...
        while (i4 < length) {
            ...
            if (cCharAt < 1 || cCharAt > 127) {
                this.length = i3;
                return encodeUtf8(str, i4, com.android.dx.io.Opcodes.MAX_VALUE);
            }
