...
public class JavaDispatcher<T> implements PrivilegedAction<T> {
    ...
    public static class ProxiedInvocationHandler implements InvocationHandler {
        ...
        public int hashCode() {
            return this.targets.hashCode() + AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.name);
        }
        ...
        public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) {
            ...
            if (method.getDeclaringClass() == Object.class) {
                ...
                if (!method.getName().equals("toString")) {
                    C7546.m12745(method, "Unexpected object method: ");
                    return null;
                }
            ...
            try {
                ...
                C5553.m10818("Failed to invoke proxy for ", method, th);
                return null;
            }
        }
    }
    ...
    public static <T> PrivilegedAction<T> of(Class<T> cls, @MaybeNull ClassLoader classLoader, boolean z) {
        if (!cls.isInterface()) {
            C5919.m11249(AbstractC9032.m14590(cls, "Expected an interface instead of "));
            return null;
        }
        if (!cls.isAnnotationPresent(Proxied.class)) {
            C5553.m10814("Expected ", cls.getName(), " to be annotated with ", Proxied.class.getName());
            return null;
        }
        if (!((Proxied) cls.getAnnotation(Proxied.class)).value().startsWith("java.security.")) {
            return new JavaDispatcher(cls, classLoader, z);
        }
        C5919.m11249("Classes related to Java security cannot be proxied: ".concat(cls.getName()));
        return null;
    }
    ...
    */
    ...
    public int hashCode() {
        int iM4559 = AbstractC2442.m4559(getClass().hashCode() * 31, 31, this.proxy);
        ClassLoader classLoader = this.classLoader;
        if (classLoader != null) {
            iM4559 += classLoader.hashCode();
        }
        return (iM4559 * 31) + (this.generate ? 1 : 0);
    }
    ...
    public static class DynamicClassLoader extends ClassLoader {
        ...
        public static Invoker invoker() {
            ...
            try {
                ...
                C8796.m14449("Failed to create invoker for ".concat(Invoker.class.getName()), e);
                return null;
            }
        }
        ...
        public static Object proxy(Class<?> cls, Map<Method, Dispatcher> map) {
            ...
            try {
                ...
                e = e2;
                C8796.m14449("Failed to create proxy for ".concat(cls2.getName()), e);
                return null;
            }
        }
                ...
                public void accept(@MaybeNull ClassLoader classLoader, Class<?> cls) {
                    ...
                    if (r0 != null) {
                        try {
                            ...
                            C8796.m14449("Failed to adjust module graph for dispatcher", e);
                        }
                    }
                }
