...
public class ByteBuddy {
        ...
        public static class InitializationAppender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                for (String str : this.values) {
                    ...
                    StackManipulation stackManipulationOf = TypeCreation.of(typeDescriptionAsErasure);
                    TextConstant textConstant = new TextConstant(str);
                    StackManipulation.Compound compound = new StackManipulation.Compound(stackManipulation, stackManipulationOf, Duplication.SINGLE, textConstant, IntegerConstant.forValue(i), MethodInvocation.invoke(methodDescription2), FieldAccess.forField(fieldDescription).write());
    ...
    static {
        ...
        if (str2 == null) {
            ...
            try {
                ...
                C5919.m11250("'net.bytebuddy.naming' is set to an unknown, non-numeric value: ".concat(str2));
                return;
            }
        }
    ...
    public ByteBuddy(ClassFileVersion classFileVersion) {
        ...
        this(classFileVersion, suffixingRandom, suffixingRandom2, r6, annotationRetention, factory == null ? Implementation.Context.Default.Factory.INSTANCE : factory, MethodGraph.Compiler.DEFAULT, InstrumentedType.Factory.Default.MODIFIABLE, DEFAULT_TYPE_VALIDATION, VisibilityBridgeStrategy.Default.ALWAYS, AsmClassReader.Factory.Default.IMPLICIT, AsmClassWriter.Factory.Default.IMPLICIT, new LatentMatcher.Resolved(ElementMatchers.isSynthetic().or(ElementMatchers.isDefaultFinalizer())));
    }
    ...
    public <T> DynamicType.Builder<T> decorate(TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        ...
        C5919.m11249(AbstractC2442.m4566("Cannot decorate array or primitive type: ", typeDescription));
        return null;
    }
    ...
    public DynamicType.Builder<? extends Enum<?>> makeEnumeration(Collection<? extends String> collection) {
        if (collection.isEmpty()) {
            C5919.m11249("Require at least one enumeration constant");
            return null;
        }
    ...
    public DynamicType.Builder<?> makePackage(String str) {
        return new SubclassDynamicTypeBuilder(this.instrumentedTypeFactory.subclass(AbstractC0053.m136(str, ".package-info"), PackageDescription.PACKAGE_MODIFIERS, TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(Object.class)), this.classFileVersion, this.auxiliaryTypeNamingStrategy, this.annotationValueFilterFactory, this.annotationRetention, this.implementationContextFactory, this.methodGraphCompiler, this.typeValidation, this.visibilityBridgeStrategy, this.classReaderFactory, this.classWriterFactory, this.ignoredMethods, ConstructorStrategy.Default.NO_CONSTRUCTORS);
    }

    public DynamicType.Builder<?> makeRecord() {
        TypeDescription.Generic genericAsGenericType = InstrumentedType.Default.of(JavaType.RECORD.getTypeStub().getName(), TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(Object.class), Visibility.PUBLIC).withMethod(new MethodDescription.Token(4)).withMethod(new MethodDescription.Token("hashCode", 1025, TypeDescription.ForLoadedType.of(Integer.TYPE).asGenericType())).withMethod(new MethodDescription.Token("equals", 1025, TypeDescription.ForLoadedType.of(Boolean.TYPE).asGenericType(), Collections.singletonList(TypeDescription.Generic.OfNonGenericType.ForLoadedType.of(Object.class)))).withMethod(new MethodDescription.Token("toString", 1025, TypeDescription.ForLoadedType.of(String.class).asGenericType())).asGenericType();
    ...
    public <T> DynamicType.Builder<T> rebase(TypeDescription typeDescription, ClassFileLocator classFileLocator, MethodNameTransformer methodNameTransformer) {
        ...
        C5919.m11249(AbstractC2442.m4566("Cannot rebase array or primitive type: ", typeDescription));
        return null;
    }
    ...
    public <T> DynamicType.Builder<T> redefine(TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        ...
        C5919.m11249(AbstractC2442.m4566("Cannot redefine array or primitive type: ", typeDescription));
        return null;
    }
    ...
    public DynamicType.Builder<?> subclass(TypeDefinition typeDefinition, ConstructorStrategy constructorStrategy) {
        ...
        if (typeDefinition.isPrimitive() || typeDefinition.isArray() || typeDefinition.isFinal()) {
            C4210.m8614(typeDefinition, "Cannot subclass primitive, array or final types: ");
            return null;
        }
