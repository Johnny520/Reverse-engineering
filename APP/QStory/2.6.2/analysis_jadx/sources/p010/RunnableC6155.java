        ...
        switch (i) {
            case 0:
                ...
                try {
                    ...
                    try {
                        WindowManager windowManager = (WindowManager) context.getSystemService(AbstractC3056.m6668(-3937647036627944871L));
                ...
                try {
                    try {
                        ...
                        while (it.hasNext()) {
                            ...
                            AbstractC3056.m6668(-3937276088892523943L);
                            str3.getClass();
                        ...
                        String strConcat = C8849.m14484(str).concat(AbstractC3056.m6668(-3937678720601687463L));
                        String str4 = new SimpleDateFormat(AbstractC3056.m6668(-3937683122943165863L), Locale.getDefault()).format(new Date());
                        AbstractC3056.m6668(-3937275985813308839L);
                        str4.getClass();
            ...
            default:
                try {
                    ...
                    jSONObjectM10039.put(AbstractC3056.m6668(-3937274332250899879L), QQEnvTool.getCurrentUin());
                    jSONObjectM10039.put(AbstractC3056.m6668(-3937274315071030695L), QQEnvTool.getCurrentAccountNickName());
                    Pair pairM8323 = AbstractC3932.m8323();
                    if (pairM8323 != null) {
                        jSONObjectM10039.put(AbstractC3056.m6668(-3937274353725736359L), pairM8323.first);
                        jSONObjectM10039.put(AbstractC3056.m6668(-3937274263531423143L), pairM8323.second);
                    }
                    if (str.length() > 0) {
                        jSONObjectM10039.put(AbstractC3056.m6668(-3937274276416325031L), str);
                        jSONObjectM10039.put(AbstractC3056.m6668(-3937274177632077223L), AbstractC3056.m6668(-3937274224876717479L));
                    }
                    C8865.m14507().m14496(jSONObjectM10039).execute();
                    return;
                } catch (Exception e2) {
                    AbstractC6157.m11574(AbstractC3056.m6668(-3937274130387436967L), e2.toString(), e2, true);
                    return;
                }
        }
    }
