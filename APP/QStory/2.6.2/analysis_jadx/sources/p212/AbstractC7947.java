...
public abstract class AbstractC7947 {
    ...
    public static final C0707 f22000 = new C0707(9);

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public static final boolean m13402(Spanned spanned, Class cls) {
    ...
    */
    public static final int m13403(p212.C7950 r19, android.text.Layout r20, androidx.compose.runtime.internal.C1245 r21, int r22, android.graphics.RectF r23, p197.InterfaceC7845 r24, androidx.compose.foundation.layout.C0640 r25, boolean r26) {
        /*
            Method dump skipped, instruction units count: 714
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: p212.AbstractC7947.m13403(飘花落叶言子苏楪兰哲世.飘花落叶言子楪苏哲兰世, android.text.Layout, androidx.compose.runtime.internal.飘花落叶言子楪世苏兰哲, int, android.graphics.RectF, 飘花落叶言子苏世楪哲兰.飘花落叶言子楪世哲兰苏, androidx.compose.foundation.layout.飘花落叶言子楪哲世苏兰, boolean):int");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public static final int m13404(Layout layout, int i, boolean z) {
        if (i <= 0) {
            return 0;
        }
    ...
    public static final float m13405(float[] fArr, int i, int i2) {
        return fArr[AbstractC0053.m142(i, i2, 2, 1)];
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final Rect m13406(TextPaint textPaint, CharSequence charSequence, int i, int i2) {
        int i3 = i;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static StaticLayout m13407(CharSequence charSequence, TextPaint textPaint, int i, int i2, TextDirectionHeuristic textDirectionHeuristic, Layout.Alignment alignment, int i3, TextUtils.TruncateAt truncateAt, int i4, int i5, boolean z, int i6, int i7, int i8, int i9) {
        if (i2 < 0) {
            AbstractC7833.m13170("invalid start value");
        }
        int length = charSequence.length();
        if (i2 < 0 || i2 > length) {
            AbstractC7833.m13170("invalid end value");
        }
        if (i3 < 0) {
            AbstractC7833.m13170("invalid maxLines value");
        }
        if (i < 0) {
            AbstractC7833.m13170("invalid width value");
        }
        if (i4 < 0) {
            AbstractC7833.m13170("invalid ellipsizedWidth value");
        }
