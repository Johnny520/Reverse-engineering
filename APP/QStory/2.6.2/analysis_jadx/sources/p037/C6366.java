...
public class C6366 extends AbstractC6298 implements InterfaceC6292 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (((Boolean) c6301.m11812(bool, strM6668)).booleanValue()) {
            ((Integer) c6301.m11812(0, AbstractC3056.m6668(-3937592030981784999L))).getClass();
            return;
        }
        C6316 c6316M11826 = C6316.m11826(AbstractC6318.m11838(AbstractC3056.m6668(-3937594028141577639L)));
    ...
    public final void m11914(ViewGroup viewGroup) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            ...
            if (childAt.getClass().getName().equals(AbstractC3056.m6668(-3937592009506948519L))) {
                ...
                AbstractC6154.m11561(AbstractC3056.m6668(-3937591756103878055L));
                return;
            }
        }
    }
