...
public final class InterpolatorC7623 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = this.f20665;
        int iMin = Math.min((int) ((fArr.length - 1) * f), fArr.length - 2);
        float f2 = this.f20664;
        float f3 = (f - (iMin * f2)) / f2;
        float f4 = fArr[iMin];
        return AbstractC0053.m145(fArr[iMin + 1], f4, f3, f4);
    }

    public InterpolatorC7623(float[] fArr) {
        this.f20665 = fArr;
        this.f20664 = 1.0f / (fArr.length - 1);
    }
}
