...
public final class C7090 extends AbstractC7127 {
    ...
    public final void mo12368(int i) {
        short[] sArr = this.f19014;
        if (sArr.length < i) {
            int length = sArr.length * 2;
            if (i < length) {
                i = length;
            }
            this.f19014 = Arrays.copyOf(sArr, i);
        }
    }
    ...
    public final Object mo12369() {
        return new C5174(Arrays.copyOf(this.f19014, this.f19013));
    }
}
