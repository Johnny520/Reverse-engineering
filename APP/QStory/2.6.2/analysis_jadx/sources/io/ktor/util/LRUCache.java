...
public final class LRUCache<K, V> extends LinkedHashMap<K, V> {
    private final InterfaceC6557 close;
    private final int maxSize;
    private final InterfaceC6557 supplier;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LRUCache(InterfaceC6557 interfaceC6557, InterfaceC6557 interfaceC65572, int i) {
        super(10, 0.75f, true);
        interfaceC6557.getClass();
        interfaceC65572.getClass();
        this.supplier = interfaceC6557;
        this.close = interfaceC65572;
        this.maxSize = i;
    }
