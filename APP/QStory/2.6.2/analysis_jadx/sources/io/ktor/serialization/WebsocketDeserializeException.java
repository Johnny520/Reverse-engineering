...
public final class WebsocketDeserializeException extends WebsocketContentConvertException {
    private final AbstractC4279 frame;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebsocketDeserializeException(String str, Throwable th, AbstractC4279 abstractC4279) {
        super(str, th);
        str.getClass();
        abstractC4279.getClass();
        this.frame = abstractC4279;
    }

    public final AbstractC4279 getFrame() {
        return this.frame;
    }

    public /* synthetic */ WebsocketDeserializeException(String str, Throwable th, AbstractC4279 abstractC4279, int i, AbstractC4384 abstractC4384) {
        this(str, (i & 2) != 0 ? null : th, abstractC4279);
    }
}
