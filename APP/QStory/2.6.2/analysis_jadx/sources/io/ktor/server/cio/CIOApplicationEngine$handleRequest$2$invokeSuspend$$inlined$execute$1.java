...
public final class CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1 extends SuspendLambda implements InterfaceC6557 {
    final /* synthetic */ Object $context;
    final /* synthetic */ AbstractC4194 $this_execute;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1(AbstractC4194 abstractC4194, Object obj, InterfaceC4356 interfaceC4356) {
    ...
    public final InterfaceC4356<C5175> create(InterfaceC4356<?> interfaceC4356) {
        return new CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1(this.$this_execute, this.$context, interfaceC4356);
    }

    @Override // p052.InterfaceC6557
    public final Object invoke(InterfaceC4356<? super C5175> interfaceC4356) {
        return ((CIOApplicationEngine$handleRequest$2$invokeSuspend$$inlined$execute$1) create(interfaceC4356)).invokeSuspend(C5175.f14739);
    }
