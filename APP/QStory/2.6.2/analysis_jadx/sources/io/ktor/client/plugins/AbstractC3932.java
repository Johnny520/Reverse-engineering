...
public abstract class AbstractC3932 implements InterfaceC7845 {
    ...
    */
    ...
    public static String m8313() {
        String str = Environment.getExternalStorageDirectory().getAbsolutePath() + AbstractC3056.m6668(-3937648509801727399L) + AbstractC6340.f17465 + AbstractC3056.m6668(-3937648436787283367L);
    ...
    public static String m8321(String str) {
        File file = new File(m8313() + AbstractC3056.m6668(-3937648471147021735L) + str);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static Pair m8323() {
        ...
        try {
            jSONObjectM6316 = InterfaceC2915.m6316(AbstractC6353.m11902(AbstractC3056.m6668(-3937677367686989223L)));
        ...
        JSONObject jSONObject = jSONObjectM6316.getJSONObject(AbstractC3056.m6668(-3937589565670557095L));
        JSONArray jSONArray = jSONObject.getJSONArray(AbstractC3056.m6668(-3937677419226596775L));
        String string = jSONObject.getString(AbstractC3056.m6668(-3937677457881302439L));
        for (int i = 0; i < jSONArray.size(); i++) {
            sb.append(jSONArray.getString(i));
            if (i != jSONArray.size() - 1) {
                sb.append(AbstractC3056.m6668(-3937630191766209959L));
            }
        }
