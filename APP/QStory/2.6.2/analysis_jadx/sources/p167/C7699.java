...
public final class C7699 extends ReplacementSpan {

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public TextPaint f20892;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public final C7698 f20894;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final Paint.FontMetricsInt f20896 = new Paint.FontMetricsInt();

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public short f20895 = -1;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public float f20893 = 1.0f;

    public C7699(C7698 c7698) {
        AbstractC6560.m12036(c7698, "rasterizer cannot be null");
        this.f20894 = c7698;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L46
        L26:
            android.text.TextPaint r3 = r0.f20892
            if (r3 != 0) goto L31
        ...
        L93:
            r10 = r2
        L94:
            飘花落叶言子哲苏兰楪世.飘花落叶言子楪兰哲世苏 r0 = r0.f20894
            androidx.compose.animation.core.飘花落叶言子哲楪苏世兰 r2 = r0.f20890
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p167.C7699.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }

    @Override // android.text.style.ReplacementSpan
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        Paint.FontMetricsInt fontMetricsInt2 = this.f20896;
        paint.getFontMetricsInt(fontMetricsInt2);
        float fAbs = Math.abs(fontMetricsInt2.descent - fontMetricsInt2.ascent) * 1.0f;
        C7698 c7698 = this.f20894;
        this.f20893 = fAbs / (c7698.m12965().m3991(14) != 0 ? ((ByteBuffer) r8.f6463).getShort(r1 + r8.f6466) : (short) 0);
        C2302 c2302M12965 = c7698.m12965();
        int iM3991 = c2302M12965.m3991(14);
        if (iM3991 != 0) {
            ((ByteBuffer) c2302M12965.f6463).getShort(iM3991 + c2302M12965.f6466);
        }
        short s = (short) ((c7698.m12965().m3991(12) != 0 ? ((ByteBuffer) r5.f6463).getShort(r7 + r5.f6466) : (short) 0) * this.f20893);
        this.f20895 = s;
