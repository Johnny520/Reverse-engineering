...
@InterfaceC6861(c = "top.yukonga.miuix.kmp.extra.BottomSheetContentLayoutKt$DragHandleArea$4$1", f = "BottomSheetContentLayout.kt", l = {}, m = "invokeSuspend", v = 2)
...
final class BottomSheetContentLayoutKt$DragHandleArea$4$1 extends SuspendLambda implements InterfaceC6550 {
    final /* synthetic */ InterfaceC5400 $coroutineScope;
    final /* synthetic */ InterfaceC1397 $isPressing;
    final /* synthetic */ InterfaceC6557 $onSettle;
    ...
    @InterfaceC6861(c = "top.yukonga.miuix.kmp.extra.BottomSheetContentLayoutKt$DragHandleArea$4$1$1", f = "BottomSheetContentLayout.kt", l = {690}, m = "invokeSuspend", v = 2)
    ...
    /* JADX INFO: compiled from: r8-map-id-cb39a6809a634dd4ad3d163e22b2e3b526599fa3253f8854b17de2b335a1a776 */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lkotlinx/coroutines/飘花落叶言子世楪哲兰苏;", "Lkotlin/飘花落叶言子楪兰苏哲世;", "<anonymous>", "(Lkotlinx/coroutines/飘花落叶言子世楪哲兰苏;)V"}, k = 3, mv = {2, 3, 0})
    @InterfaceC6861(c = "top.yukonga.miuix.kmp.extra.BottomSheetContentLayoutKt$DragHandleArea$4$1$2", f = "BottomSheetContentLayout.kt", l = {693}, m = "invokeSuspend", v = 2)
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomSheetContentLayoutKt$DragHandleArea$4$1(InterfaceC1397 interfaceC1397, InterfaceC5400 interfaceC5400, InterfaceC6557 interfaceC6557, C0331 c0331, C0331 c03312, InterfaceC4356<? super BottomSheetContentLayoutKt$DragHandleArea$4$1> interfaceC4356) {
        super(3, interfaceC4356);
        this.$isPressing = interfaceC1397;
        this.$coroutineScope = interfaceC5400;
        this.$onSettle = interfaceC6557;
        this.$pressScale = c0331;
    ...
    public final Object invoke(InterfaceC5400 interfaceC5400, float f, InterfaceC4356<? super C5175> interfaceC4356) {
        BottomSheetContentLayoutKt$DragHandleArea$4$1 bottomSheetContentLayoutKt$DragHandleArea$4$1 = new BottomSheetContentLayoutKt$DragHandleArea$4$1(this.$isPressing, this.$coroutineScope, this.$onSettle, this.$pressScale, this.$pressWidth, interfaceC4356);
        bottomSheetContentLayoutKt$DragHandleArea$4$1.F$0 = f;
        return bottomSheetContentLayoutKt$DragHandleArea$4$1.invokeSuspend(C5175.f14739);
    }
