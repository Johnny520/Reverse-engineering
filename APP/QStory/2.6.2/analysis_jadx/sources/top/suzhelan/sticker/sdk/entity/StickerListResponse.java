...
public final /* data */ class StickerListResponse {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4394.m8917(this.list, stickerListResponse.list) && this.total == stickerListResponse.total && this.page == stickerListResponse.page && this.pageSize == stickerListResponse.pageSize;
    }
    ...
    public int hashCode() {
        return Integer.hashCode(this.pageSize) + AbstractC0053.m143(this.page, AbstractC0053.m143(this.total, this.list.hashCode() * 31, 31), 31);
    }
