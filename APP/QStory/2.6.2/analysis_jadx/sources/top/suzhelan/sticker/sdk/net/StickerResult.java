...
public final /* data */ class StickerResult<T> {
    ...
    public boolean equals(Object other) {
        ...
        return this.status == stickerResult.status && AbstractC4394.m8917(this.message, stickerResult.message) && this.timestamp == stickerResult.timestamp && AbstractC4394.m8917(this.data, stickerResult.data);
    }
    ...
    public int hashCode() {
        int iM141 = AbstractC0053.m141(AbstractC6136.m11539(Integer.hashCode(this.status) * 31, 31, this.message), 31, this.timestamp);
        T t = this.data;
        return iM141 + (t == null ? 0 : t.hashCode());
    }
