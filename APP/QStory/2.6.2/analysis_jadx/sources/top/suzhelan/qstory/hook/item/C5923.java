    ...
    public final void m11258(String str) {
        ...
        switch (i) {
            ...
            default:
                ...
                if (jSONObjectM6316.getIntValue(AbstractC3056.m6668(-3937648213448983975L)) == 0) {
                    String string = jSONObjectM6316.getJSONObject(AbstractC3056.m6668(-3937611727701804455L)).getString(AbstractC3056.m6668(-3937661463423092135L));
                    String string2 = jSONObjectM6316.getJSONObject(AbstractC3056.m6668(-3937661368933811623L)).getString(AbstractC3056.m6668(-3937661386113680807L));
                    String str2 = c8809.f24787;
                    String strReplace = c8809.f24788.replace(AbstractC3056.m6668(-3937611487183635879L), AbstractC3056.m6668(-3937561979095614887L));
                    ...
                    if (!TextUtils.isEmpty((CharSequence) c5922.f16107.m11812(null, AbstractC3056.m6668(-3937662485625308583L)))) {
                        new Thread(new RunnableC0099(c5922, 6, str2)).start();
                    }
                    if (((Boolean) c5922.f16107.m11812(bool, AbstractC3056.m6668(-3937661184250217895L))).booleanValue()) {
