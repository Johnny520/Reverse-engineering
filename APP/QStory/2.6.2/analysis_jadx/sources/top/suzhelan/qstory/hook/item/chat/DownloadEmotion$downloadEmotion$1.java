...
final class DownloadEmotion$downloadEmotion$1 extends SuspendLambda implements InterfaceC6553 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            AbstractC3056.m6668(-3937787104101402023L);
            ...
            while (it.hasNext()) {
                ...
                next.getClass();
                String str = next;
                File file = new File(externalStoragePublicDirectory + AbstractC3056.m6668(-3937786996727219623L), arrayList2.get(arrayList.indexOf(str)) + AbstractC8174.m13614(str));
                if (file.exists()) {
                    file.delete();
                }
        ...
        if (Result.m8758exceptionOrNullimpl(objM162) != null) {
            AbstractC8210.m13718(AbstractC3056.m6668(-3937786910827873703L), WaitDialog$TYPE.ERROR);
        }
        if (Result.m8762isSuccessimpl(objM162)) {
            AbstractC8210.m13719(AbstractC3056.m6668(-3937786902237939111L), WaitDialog$TYPE.SUCCESS, 500L);
        }
        return c5175;
    }
