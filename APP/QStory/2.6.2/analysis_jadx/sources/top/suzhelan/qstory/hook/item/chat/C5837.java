...
public final class C5837 extends AbstractC6293 {
    ...
    public static Drawable m11189() {
        try {
            ...
            int identifier = context.getResources().getIdentifier(AbstractC3056.m6668(-3937799318988391847L), AbstractC3056.m6668(-3937715627255661991L), context.getPackageName());
            if (identifier != 0) {
    ...
    public static final Bitmap m11190(C5837 c5837) {
        ...
        try {
            File file = new File(AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937782302327965095L)));
            if (file.exists() && (bitmapDrawableM14665 = AbstractC9124.m14665(AbstractC6340.f17460, file.getAbsolutePath())) != null) {
                ...
                AbstractC3056.m6668(-3937799379117933991L);
    ...
    public static final void m11191(C5837 c5837, Object obj) {
        ...
        try {
            try {
                objM11831 = obj.getClass().getMethod(AbstractC3056.m6668(-3937563495219070375L), null).invoke(obj, null);
            } catch (Exception unused) {
                objM11831 = AbstractC6317.m11831(Object.class, AbstractC3056.m6668(-3937747568927442343L), obj);
            }
            if (objM11831 == null) {
                return;
            }
            ArrayList arrayList = (ArrayList) AbstractC6317.m11831(ArrayList.class, AbstractC3056.m6668(-3937563413614691751L), objM11831);
            ...
            boolean z2 = false;
            while (it.hasNext()) {
                Integer num = (Integer) AbstractC6317.m11831(Integer.TYPE, AbstractC3056.m6668(-3937563452269397415L), it.next());
            ...
            Long l = (Long) AbstractC6317.m11831(Long.TYPE, AbstractC3056.m6668(-3937565221795923367L), objM11831);
    ...
    public static final ImageView m11192(C5837 c5837, Object obj) {
        try {
            ...
            for (Field field : declaredFields) {
                ...
                if (name.equals(AbstractC3056.m6668(-3937782508486395303L)) || AbstractC5143.m10171(name, AbstractC3056.m6668(-3937782525666264487L), false)) {
                    field.setAccessible(true);
                    Object obj2 = field.get(obj);
                    if (obj2 != null) {
                        Method[] methods = obj2.getClass().getMethods();
                        AbstractC3056.m6668(-3937782444061885863L);
                        methods.getClass();
                        for (Method method : methods) {
                            if (AbstractC4394.m8917(method.getName(), AbstractC3056.m6668(-3937782375342409127L)) && method.getParameterCount() == 0) {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        this.f15985 = new C6301(AbstractC3056.m6668(-3937799452132378023L));
        new Thread(new RunnableC5840()).start();
        Method[] declaredMethods = classLoader.loadClass(AbstractC3056.m6668(-3937782946573059495L)).getDeclaredMethods();
    ...
    public final String mo11178() {
        return AbstractC3056.m6668(-3937799653995840935L);
    }
