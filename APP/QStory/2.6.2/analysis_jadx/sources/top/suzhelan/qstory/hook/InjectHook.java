...
public final class InjectHook implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    public static final String BASE_APPLICATION_IMPL = AbstractC3056.m6668(-3937554308284024231L);
    public static final C8813 Companion = new C8813();
    public static final int $stable = 8;
    private static final Set<String> ALLOWED_PROCESS = AbstractC4346.m8852(new String[]{AbstractC3056.m6668(-3937555476515128743L), AbstractC3056.m6668(-3937555257471796647L)});
    ...
    private final Method getApplicationCreateMethod(XC_LoadPackage.LoadPackageParam loadPackageParam) {
        ...
        try {
            try {
                ...
                try {
                    declaredMethod = clsLoadClass.getDeclaredMethod(AbstractC3056.m6668(-3937554003341346215L), declaredMethod);
                    return declaredMethod;
                } catch (Throwable unused) {
                    try {
                        try {
                            return clsLoadClass.getDeclaredMethod(AbstractC3056.m6668(-3937554080650757543L), null);
                        } catch (Throwable unused2) {
                            declaredMethod = clsLoadClass.getSuperclass().getDeclaredMethod(AbstractC3056.m6668(-3937554003341346215L), declaredMethod);
                            return declaredMethod;
                        }
                    } catch (Throwable unused3) {
                        return clsLoadClass.getSuperclass().getDeclaredMethod(AbstractC3056.m6668(-3937554080650757543L), null);
                    }
                }
            ...
            return ContextWrapper.class.getDeclaredMethod(AbstractC3056.m6668(-3937554003341346215L), declaredMethod);
        }
    }
    ...
    public final void injectOnce(XC_MethodHook.MethodHookParam param) {
        ...
        XposedBridge.log(AbstractC3056.m6668(-3937554591751865767L) + param.method.getName() + AbstractC3056.m6668(-3937554531622323623L));
        Utils.MTimer mTimer = new Utils.MTimer();
        try {
            Object obj = param.thisObject;
            AbstractC3056.m6668(-3937716426119579047L);
            obj.getClass();
            C8814 c8814 = this.hookEnter;
            Context baseContext = ((ContextWrapper) obj).getBaseContext();
            AbstractC3056.m6668(-3937716065342326183L);
            ...
            try {
                ...
                XposedBridge.log(AbstractC3056.m6668(-3937554591751865767L) + param.method.getName() + AbstractC3056.m6668(-3937554441428010407L) + mTimer.get());
                throw th2;
            }
        }
        sb.append(AbstractC3056.m6668(-3937554591751865767L));
        sb.append(param.method.getName());
        sb.append(AbstractC3056.m6668(-3937554441428010407L));
        sb.append(mTimer.get());
        XposedBridge.log(sb.toString());
    }

    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) {
        AbstractC3056.m6668(-3937716722472322471L);
        ...
        try {
            ...
            if (loadPackageParam.isFirstApplication) {
                ...
                String strM6668 = AbstractC3056.m6668(-3937555592479245735L);
                AbstractC3056.m6668(-3937716623688074663L);
                if (new Regex(strM6668).matches(str)) {
                    ...
                    if (ALLOWED_PROCESS.contains(str2)) {
                        ...
                        XposedHelpers.findAndHookMethod(loadPackageParam.classLoader.loadClass(AbstractC3056.m6668(-3937554308284024231L)), AbstractC3056.m6668(-3937554080650757543L), new Object[]{new C8812(this, i)});
                    }
                }
            }
        } catch (Throwable th) {
            String strM66682 = AbstractC3056.m6668(-3937554016226248103L);
    ...
    public void initZygote(IXposedHookZygoteInit.StartupParam startupParam) {
        AbstractC3056.m6668(-3937716460479317415L);
        startupParam.getClass();
        C8814 c8814 = this.hookEnter;
        String str = startupParam.modulePath;
        AbstractC3056.m6668(-3937716413234677159L);
        str.getClass();
        c8814.getClass();
        AbstractC3056.m6668(-3937716808371668391L);
