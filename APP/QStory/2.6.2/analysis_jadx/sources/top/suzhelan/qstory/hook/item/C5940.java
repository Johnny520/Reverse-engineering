        ...
        switch (i) {
            case 0:
                if (this.f16131.f17376.booleanValue() && (result = methodHookParam.getResult()) != null) {
                    try {
                        try {
                            XposedHelpers.setIntField(result, AbstractC3056.m6668(-3937767175453148583L), 0);
                        } catch (NoSuchFieldError unused) {
                            XposedHelpers.setLongField(result, AbstractC3056.m6668(-3937767175453148583L), 0L);
                        }
            ...
            default:
                if (this.f16131.f17376.booleanValue()) {
                    ...
                    if (AbstractC4394.m8917(str, AbstractC3056.m6668(-3937750004173899175L)) && classLoader != null && !this.f16131.f16133) {
                        this.f16131.f16133 = true;
                        C5943 c5943 = this.f16131;
                        try {
                            Class clsFindClassIfExists = XposedHelpers.findClassIfExists(AbstractC3056.m6668(-3937766836150732199L), classLoader);
                            if (clsFindClassIfExists != null) {
                                ...
                                for (Method method : declaredMethods) {
                                    ...
                                    if (method.getReturnType().getName().equals(AbstractC3056.m6668(-3937766707301713319L)) && parameterTypes.length == 2) {
