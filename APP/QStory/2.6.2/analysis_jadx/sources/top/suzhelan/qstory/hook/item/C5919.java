    ...
    public void mo1469(XC_MethodHook.MethodHookParam methodHookParam) throws IOException {
        ...
        switch (this.f16105) {
            case 0:
                ...
                if (str.startsWith(Environment.getExternalStorageDirectory().getAbsolutePath() + AbstractC3056.m6668(-3937648509801727399L) + AbstractC6340.f17465 + AbstractC3056.m6668(-3937660892192441767L))) {
                    methodHookParam.setResult(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + AbstractC3056.m6668(-3937660973796820391L), file.getName()).getAbsolutePath());
                    return;
                }
                return;
            case 1:
                String str2 = AbstractC6156.f16778;
                if (Modifier.toString(methodHookParam.method.getModifiers()).contains(AbstractC3056.m6668(-3937650116119496103L))) {
                        ...
                        try {
                            ...
                            try {
                                if (Modifier.toString(field.getModifiers()).contains(AbstractC3056.m6668(-3937650116119496103L))) {
                                    ...
                                    if (obj == null || !obj.getClass().getSimpleName().matches(AbstractC3056.m6668(-3937650008745313703L))) {
                                        sb.append(obj);
                                    } else {
                                ...
                                } else if (field.getType().getSimpleName().matches(AbstractC3056.m6668(-3937650008745313703L))) {
                                    sb.append(AbstractC3056.m6668(-3937557258926556583L));
                                    sb.append(AbstractC3056.m6668(-3937649480464336295L));
                                    sb.append(AbstractC3056.m6668(-3937557258926556583L));
                                } else {
                                    sb.append(AbstractC3056.m6668(-3937649398859957671L));
                                }
                            } catch (Exception e) {
                                e = e;
                                sb.append(AbstractC3056.m6668(-3937649446104597927L));
                                sb.append(e);
                            }
                        } catch (Exception e2) {
                            e = e2;
                    ...
                    sb.append(AbstractC3056.m6668(-3937649317255579047L));
                    ...
                    for (Field field2 : cls.getDeclaredFields()) {
                        ...
                        try {
                            if (Modifier.toString(field2.getModifiers()).contains(AbstractC3056.m6668(-3937650116119496103L))) {
                                Object obj2 = field2.get(null);
                                if (obj2 == null || !obj2.getClass().getSimpleName().matches(AbstractC3056.m6668(-3937650008745313703L))) {
                                    sb2.append(obj2);
                                } else {
                                    sb2.append(AbstractC3056.m6668(-3937557258926556583L));
                                    sb2.append(obj2);
                                    sb2.append(AbstractC3056.m6668(-3937557258926556583L));
                                }
                            } else {
                            ...
                            sb2.append(AbstractC3056.m6668(-3937649888486229415L));
                            sb2.append(e3);
                        }
                        sb2.append(AbstractC3056.m6668(-3937603678933091751L));
                        sb2.append(AbstractC3056.m6668(-3937560690605426087L));
                    }
                    AbstractC6156.m11566(methodHookParam, sb2);
                    sb2.append(AbstractC3056.m6668(-3937648720255124903L));
                    AbstractC6156.m11568(methodHookParam, stackTrace2, sb2, cls);
                }
                Object obj4 = methodHookParam.thisObject;
                AbstractC3056.m6668(-3937749621921809831L);
                obj4.getClass();
                Class clsM14657 = AbstractC9121.m14657(AbstractC3056.m6668(-3937749566087234983L));
                clsM14657.getClass();
                AbstractC6156.m11569(AbstractC5061.m10024(clsM14657, null, obj4));
                return;
            case 2:
                Object obj5 = methodHookParam.args[0];
                String str3 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937619432873133479L), obj5);
                String str4 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937747775085872551L), obj5);
                if (str3 == null || str4 == null || !C5877.m11223(str3, str4)) {
                    return;
                }
                AbstractC6317.m11835(obj5, AbstractC3056.m6668(-3937619432873133479L), String.class, C5877.m11224(str4));
                return;
            case 3:
                Object obj6 = methodHookParam.args[1];
                String str5 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937747654826788263L), obj6);
                String str6 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937747693481493927L), obj6);
                if (str5 == null || str6 == null || !C5877.m11223(str5, str6)) {
                    return;
                }
                AbstractC6317.m11835(obj6, AbstractC3056.m6668(-3937747654826788263L), String.class, C5877.m11224(str6));
                return;
            case 4:
                Object obj7 = methodHookParam.args[0];
                String str7 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937619432873133479L), obj7);
                if (str7 == null || !str7.endsWith(AbstractC3056.m6668(-3937747981244302759L))) {
                    return;
                }
                AbstractC6317.m11835(obj7, AbstractC3056.m6668(-3937619432873133479L), String.class, AbstractC5138.m10128(str7, AbstractC3056.m6668(-3937747981244302759L), AbstractC3056.m6668(-3937747633351951783L)));
                return;
            case 5:
                Object obj8 = methodHookParam.args[1];
                String str8 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937747654826788263L), obj8);
                if (str8 == null || !str8.endsWith(AbstractC3056.m6668(-3937747981244302759L))) {
                    return;
                }
                AbstractC6317.m11835(obj8, AbstractC3056.m6668(-3937747654826788263L), String.class, AbstractC5138.m10128(str8, AbstractC3056.m6668(-3937747981244302759L), AbstractC3056.m6668(-3937747633351951783L)));
                return;
            case 6:
            ...
            case 7:
                ...
                JSONArray jSONArray = jSONObjectM6316.getJSONArray(AbstractC3056.m6668(-3937645464669914535L));
                if (jSONArray == null) {
                    return;
                }
                ...
                while (i < size) {
                    ...
                    if (jSONObject == null || (string = jSONObject.getString(AbstractC3056.m6668(-3937627417217336743L))) == null) {
                        return;
                    }
                    if (string.equals(AbstractC3056.m6668(-3937761480326514087L))) {
                        String string2 = jSONObject.getString(AbstractC3056.m6668(-3937586675157566887L));
                        if (string2 == null || string2.length() == 0) {
                            string2 = QQEnvTool.getUinFromUid(jSONObject.getString(AbstractC3056.m6668(-3937636127411013031L)));
                        }
                        String string3 = jSONObject.getString(AbstractC3056.m6668(-3937761493211415975L));
                        jSONObject.remove(AbstractC3056.m6668(-3937761493211415975L));
                        jSONObject.put(AbstractC3056.m6668(-3937761493211415975L), string3 + '(' + string2 + ')');
                    }
                    i++;
                }
            ...
            case 8:
                ...
                return;
            case 9:
                Object objM11830 = AbstractC6317.m11830(AbstractC6318.m11838(AbstractC3056.m6668(-3937757077985035687L)), methodHookParam.thisObject);
                if (objM11830 == null) {
                    return;
                }
                Object objM11818 = AbstractC6314.m11818(ViewParent.class, AbstractC3056.m6668(-3937756850351768999L), objM11830);
                LinearLayout linearLayout = objM11818 instanceof LinearLayout ? (LinearLayout) objM11818 : null;
                if (linearLayout == null) {
                    C2632.m5294(AbstractC3056.m6668(-3937756721502750119L));
                    return;
                }
            ...
            case 13:
                ...
                AbstractC3056.m6668(-3937749621921809831L);
                obj13.getClass();
                String str10 = (String) AbstractC5061.m10024(null, AbstractC3056.m6668(-3937586589258220967L), obj13);
                if (iIntValue == 9) {
                    Object obj14 = methodHookParam.thisObject;
                    AbstractC3056.m6668(-3937749621921809831L);
                    obj14.getClass();
                    String strM6668 = AbstractC3056.m6668(-3937586589258220967L);
                    StringBuilder sb3 = new StringBuilder();
                    sb3.append(AbstractC3056.m6668(-3937779837016737191L));
                    sb3.append(obj12);
            ...
            case 14:
                ...
                AbstractC3056.m6668(-3937777968705963431L);
                try {
