...
public final class C8544 extends AbstractC8426 {

    /* JADX INFO: renamed from: 飘花落叶言子苏楪兰哲世, reason: contains not printable characters */
    public final Function f23784;

    public C8544(int i, long j, Class cls, String str, String str2, String str3, Field field, Method method, Type type, Function function) {
        super(str, i, j, str2, str3, type, cls, field, method);
        this.f23784 = function;
    }
    ...
    public final boolean mo13980(AbstractC2896 abstractC2896, Object obj) {
        OffsetDateTime offsetDateTime = (OffsetDateTime) this.f23784.apply(obj);
        ...
        m14059(abstractC2896);
        if (this.f23333 == null) {
            this.f23333 = mo13975(abstractC2896, OffsetDateTime.class);
        }
        if (this.f23333 != C8469.f23433) {
            this.f23333.mo5634(abstractC2896, offsetDateTime, this.f23627, this.f23332, this.f23620);
            return true;
        }
