...
public final class C8542 extends AbstractC8426 {

    /* JADX INFO: renamed from: 飘花落叶言子苏楪兰哲世, reason: contains not printable characters */
    public final Function f23783;

    public C8542(int i, long j, Class cls, String str, String str2, String str3, Field field, Method method, Type type, Function function) {
        super(str, i, j, str2, str3, type, cls, field, method);
        this.f23783 = function;
    }
    ...
    public final boolean mo13980(AbstractC2896 abstractC2896, Object obj) {
        UUID uuid = (UUID) this.f23783.apply(obj);
        if (uuid == null) {
        ...
        m14059(abstractC2896);
        if (this.f23333 == null) {
            this.f23333 = mo13975(abstractC2896, UUID.class);
        }
        if (this.f23333 != C8496.f23581) {
            this.f23333.mo5634(abstractC2896, uuid, this.f23627, this.f23332, this.f23620);
            return true;
        }
        abstractC2896.mo5957(uuid);
        return true;
    }
}
