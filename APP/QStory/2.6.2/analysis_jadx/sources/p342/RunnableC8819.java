...
public final /* synthetic */ class RunnableC8819 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ((C7067) obj).invoke(AbstractC3056.m6668(-3937561979095614887L));
                return;
            case 1:
                ...
                try {
                    ...
                    if (((ArrayList) ref$ObjectRef.element).isEmpty()) {
                        ...
                        AbstractC3056.m6668(-3937297215836652967L);
                        r4.getClass();
                        ref$ObjectRef.element = r4;
                        ?? r3 = allFriendWithCategories.categories;
                        AbstractC3056.m6668(-3937328319989810599L);
                        r3.getClass();
                    ...
                    handler.post(new Runnable() { // from class: 飘花落叶言苏哲楪世子兰.飘花落叶言子楪世苏哲兰
                        ...
                        public final void run() {
                            ...
                            switch (i4) {
                                case 0:
                                    C8197.m13693();
                                    AbstractC8210.m13718(AbstractC3056.m6668(-3937327903377982887L) + exc.getMessage(), WaitDialog$TYPE.ERROR);
                                    break;
                                default:
                                    C8197.m13693();
                                    AbstractC8210.m13718(AbstractC3056.m6668(-3937327903377982887L) + exc.getMessage(), WaitDialog$TYPE.ERROR);
            ...
            case 2:
                ...
                try {
                    ...
                    String str = AbstractC3056.m6668(-3937327697219552679L) + arrayListM14671;
                    String str2 = AbstractC6157.f16779;
                    AbstractC6157.m11573(str, AbstractC3056.m6668(-3937633150998676903L));
