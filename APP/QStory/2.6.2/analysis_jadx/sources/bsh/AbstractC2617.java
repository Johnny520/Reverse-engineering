...
public abstract class AbstractC2617 implements InterfaceC2614 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public static final List f7848 = Arrays.asList(104, 105, 106, 116);

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public static final List f7847 = Arrays.asList(88, 89, 86, 87, 92, 93, 94, 95, 96, 97);

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public static Number m5241(Object obj) {
    ...
    public static Object m5242(Object obj, int i, Object obj2) throws UtilEvalError {
        if (i == 145) {
                ...
                default:
                    switch (i) {
                        ...
                        case 113:
                            return Boolean.valueOf(zBooleanValue ^ zBooleanValue2);
                        default:
                            C2632.m5297("unimplemented binary operator");
                            return null;
                    }
            }
        }
        if (f7847.contains(Integer.valueOf(i))) {
        ...
        if (obj instanceof BigInteger) {
            return m5244((BigInteger) obj, (BigInteger) obj2, i);
        }
        if (obj instanceof BigDecimal) {
            return m5245((BigDecimal) obj, (BigDecimal) obj2, i);
        }
        boolean zM5345 = AbstractC2661.m5345(obj);
        List list = f7848;
        if (!zM5345) {
            ...
            if (list.contains(Integer.valueOf(i))) {
                return m5244(BigInteger.valueOf(jLongValue), BigInteger.valueOf(jLongValue2), i);
            }
            C2632.m5297("Unimplemented binary long operator");
            return null;
        }
        if (obj instanceof Float) {
            ...
            if (list.contains(Integer.valueOf(i))) {
                return m5245(BigDecimal.valueOf(fFloatValue), BigDecimal.valueOf(fFloatValue2), i);
            }
            C2632.m5297("Unimplemented binary double operator");
            return null;
        }
        ...
        if (list.contains(Integer.valueOf(i))) {
            return m5245(BigDecimal.valueOf(dDoubleValue), BigDecimal.valueOf(dDoubleValue2), i);
        }
        C2632.m5297("Unimplemented binary double operator");
        return null;
    }
    ...
    public static Object m5243(Object obj, int i, Object obj2) throws UtilEvalError {
        Object objUnwrap = Primitive.unwrap(obj);
        Object objUnwrap2 = Primitive.unwrap(obj2);
        if (AbstractC2661.m5338(objUnwrap) && AbstractC2661.m5338(objUnwrap2)) {
            Number numberM5241 = m5241(objUnwrap);
            Number numberM52412 = m5241(objUnwrap2);
            if (objUnwrap instanceof BigDecimal) {
                if (!(objUnwrap2 instanceof BigDecimal)) {
                    objUnwrap2 = Primitive.castNumber(BigDecimal.class, numberM52412);
                }
            } else if (objUnwrap2 instanceof BigDecimal) {
                objUnwrap = Primitive.castNumber(BigDecimal.class, numberM5241);
            } else if (AbstractC2661.m5345(objUnwrap) || AbstractC2661.m5345(objUnwrap2)) {
                if (!(objUnwrap instanceof Float) || !(objUnwrap2 instanceof Float)) {
                    if (!(objUnwrap instanceof Double)) {
                        objUnwrap = Double.valueOf(numberM5241.doubleValue());
                    }
                    if (!(objUnwrap2 instanceof Double)) {
                        objUnwrap2 = Double.valueOf(numberM52412.doubleValue());
                    }
                }
            } else if (objUnwrap instanceof BigInteger) {
                if (!(objUnwrap2 instanceof BigInteger)) {
                    objUnwrap2 = Primitive.castNumber(BigInteger.class, numberM52412);
                }
            } else if (objUnwrap2 instanceof BigInteger) {
                objUnwrap = Primitive.castNumber(BigInteger.class, numberM5241);
            } else {
                if (!(objUnwrap instanceof Long)) {
                    objUnwrap = Long.valueOf(numberM5241.longValue());
                }
                if (!(objUnwrap2 instanceof Long)) {
                    objUnwrap2 = Long.valueOf(numberM52412.longValue());
                }
            }
        ...
        if (objUnwrap.getClass() == objUnwrap2.getClass()) {
            try {
                Object objM5242 = m5242(objUnwrap, i, objUnwrap2);
                return objM5242 instanceof Boolean ? ((Boolean) objM5242).booleanValue() ? Primitive.TRUE : Primitive.FALSE : ((obj instanceof Primitive) && (obj2 instanceof Primitive)) ? (AbstractC2661.m5345(objM5242) && objUnwrap.getClass() == BigDecimal.class) ? Primitive.wrap(objM5242, objM5242.getClass()) : Primitive.shrinkWrap(objM5242) : Primitive.shrinkWrap(objM5242).getValue();
    ...
    public static BigInteger m5244(BigInteger bigInteger, BigInteger bigInteger2, int i) {
        switch (i) {
            case 104:
            ...
            default:
                C2632.m5297("Unimplemented binary integer operator");
                return null;
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static BigDecimal m5245(BigDecimal bigDecimal, BigDecimal bigDecimal2, int i) throws UtilEvalError {
        switch (i) {
            case 104:
            ...
            default:
                switch (i) {
                    ...
                    case 123:
                        throw new UtilEvalError("Can't shift floatingpoint values");
                    default:
                        C2632.m5297("Unimplemented binary float operator");
                        return null;
                }
        }
    }
    ...
    public static Object m5246(Object obj, int i, Object obj2) throws UtilEvalError {
        String[] strArr = InterfaceC2614.f7846;
        if (i == 92) {
        ...
        if (i == 145) {
            int iCompare = ((obj instanceof Comparable) || (obj2 instanceof Comparable)) ? Comparator.nullsFirst(Comparator.naturalOrder()).compare((Comparable) Primitive.unwrap(obj), (Comparable) Primitive.unwrap(obj2)) : Comparator.nullsFirst(Comparator.comparing(new C2640(13))).compare(Primitive.unwrap(obj), Primitive.unwrap(obj2));
            if (iCompare < 0) {
                i2 = -1;
            } else if (iCompare > 0) {
                i2 = 1;
        ...
        if (i == 104) {
            ...
            if (obj.getClass().isArray() && obj2.getClass().isArray()) {
                ...
                if (AbstractC2661.m5332(cls2) == AbstractC2661.m5332(cls3)) {
                    Class clsM5346 = AbstractC2661.m5346(AbstractC2661.m5331(cls2), AbstractC2661.m5331(cls3));
                    int[] iArrM5277 = AbstractC2628.m5277(obj);
                    iArrM5277[0] = Array.getLength(obj2) + Array.getLength(obj);
                    Object objNewInstance = Array.newInstance((Class<?>) clsM5346, iArrM5277);
                    AbstractC2628.m5278(clsM5346, objNewInstance, obj, obj2);
                    return objNewInstance;
                }
                throw new UtilEvalError("Cannot concat arrays with inconsistent dimensions. Attempting to concat array of type " + AbstractC2628.m5283(obj) + " with array of type " + AbstractC2628.m5283(obj2) + ".");
            }
            boolean z = obj instanceof List;
            if (z && obj2.getClass().isArray()) {
                obj2 = AbstractC2661.m5328(obj2, List.class, 0);
            }
        ...
        if (i == 106) {
            if (obj.getClass().isArray()) {
                return AbstractC2628.m5287(((Integer) Primitive.castWrapper(cls, obj2)).intValue(), obj);
            }
            if (obj2.getClass().isArray()) {
                return AbstractC2628.m5287(((Integer) Primitive.castWrapper(cls, obj)).intValue(), obj2);
            }
            if (obj instanceof List) {
                return AbstractC2628.m5288(((Integer) Primitive.castWrapper(cls, obj2)).intValue(), (List) obj);
            }
            if (obj2 instanceof List) {
                return AbstractC2628.m5288(((Integer) Primitive.castWrapper(cls, obj)).intValue(), (List) obj2);
            }
            try {
        ...
        if (obj.getClass().isArray() || obj2.getClass().isArray() || (obj instanceof List) || (obj2 instanceof List)) {
            throw new UtilEvalError(AbstractC0053.m146(new StringBuilder("Use of invalid operator "), strArr[i], " with array or List type"));
        }
        ...
        throw new UtilEvalError(AbstractC0053.m146(new StringBuilder("Operator: "), strArr[i], " inappropriate for objects"));
    }
}
