...
public class dir {
    ...
    public static final String[] f7820 = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
    ...
    public static void invoke(Interpreter interpreter, CallStack callStack, String str) {
        try {
            ...
            for (String str2 : list) {
                StringBuilder sbM149 = AbstractC0053.m149(absolutePath);
                sbM149.append(File.separator);
                sbM149.append(str2);
                File file = new File(sbM149.toString());
                ...
                sb.append(f7820[gregorianCalendar.get(2)] + " " + i);
                if (i < 10) {
                    sb.append(" ");
                }
                sb.append(" ");
