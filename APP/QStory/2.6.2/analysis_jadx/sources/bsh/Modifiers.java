...
public class Modifiers implements Serializable, Cloneable {
    ...
    public void addModifier(int i) {
        if ((this.valid & i) == 0) {
            ...
            C5919.m11250(AbstractC0053.m146(sb, toModifier(i), "'"));
            return;
        }
        if (i < 7) {
            int i2 = this.modifiers;
            if ((i2 & 7) > 0 && (i2 | i) != i2) {
                C5919.m11250("public/private/protected cannot be used in combination.");
                return;
            }
        }
    ...
    private int toModifier(String str) {
        ...
        C5919.m11250(AbstractC0053.m156("Unknown modifier: '", str, "'"));
        return 0;
    }
