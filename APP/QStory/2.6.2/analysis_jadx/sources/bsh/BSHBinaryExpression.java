...
class BSHBinaryExpression extends SimpleNode implements InterfaceC2614 {
    public int kind;
    ...
    private Variable getVariableAtNode(int i, CallStack callStack) {
        ...
        InterfaceC2618 interfaceC2618JjtGetChild = jjtGetChild(i).jjtGetChild(0);
        if (interfaceC2618JjtGetChild instanceof BSHAmbiguousName) {
            return callStack.top().getVariableImpl(((BSHAmbiguousName) interfaceC2618JjtGetChild).text, true);
        }
        return null;
    }
    ...
    private boolean isComparableTypes(Class<?> cls, Class<?> cls2, CallStack callStack) throws EvalException {
        ...
        throw new EvalException("incomparable types: " + AbstractC2628.m5280(cls) + " and " + AbstractC2628.m5280(cls2), this, callStack);
    }
