...
public class DelayedEvalBshMethod extends BshMethod {
    ...
    private AbstractC2624 constructor;
    ...
    public DelayedEvalBshMethod(String str, AbstractC2624 abstractC2624, NameSpace nameSpace) {
        this(str, BSHType.getTypeDescriptor(abstractC2624.mo5251()), null, new String[abstractC2624.mo5265()], abstractC2624.m5266(), null, new BSHBlock(0), nameSpace, null, abstractC2624.mo5269(), null, null);
        this.constructor = abstractC2624;
    ...
    public String getAltConstructor() {
        ...
        InterfaceC2618 interfaceC2618JjtGetChild = this.methodBody.jjtGetChild(0);
        while (true) {
            z = interfaceC2618JjtGetChild instanceof BSHMethodInvocation;
            if (z || interfaceC2618JjtGetChild.jjtGetNumChildren() <= 0) {
                break;
            }
            interfaceC2618JjtGetChild = interfaceC2618JjtGetChild.jjtGetChild(0);
        }
        if (z) {
            BSHMethodInvocation bSHMethodInvocation = (BSHMethodInvocation) interfaceC2618JjtGetChild;
    ...
    public Class<?>[] getParameterTypes() {
        AbstractC2624 abstractC2624 = this.constructor;
        ...
        try {
            ...
            C2632.m5293("can't eval param types: ", e);
            return null;
        }
    }
    ...
    public Class<?> getReturnType() {
        ...
        try {
            ...
            C2632.m5293("can't eval return type: ", e);
            return null;
        }
    }
    ...
    @Override // bsh.BshMethod
    public int hashCode() {
        int iM140 = AbstractC0053.m140((getClass().hashCode() + getName().hashCode()) * 31, 31, this.isExtension);
        Class<?> cls = this.receiverType;
        int iHashCode = Boolean.hashCode(this.isVarArgs) + ((iM140 + (cls == null ? 0 : cls.hashCode())) * 31);
