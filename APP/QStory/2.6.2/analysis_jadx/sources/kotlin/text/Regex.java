...
public final class Regex implements Serializable {
    ...
    public static final class Serialized implements Serializable {
        public static final C5139 Companion = new C5139();
    ...
    public static final /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements InterfaceC6557 {
        public static final AnonymousClass2 INSTANCE = new AnonymousClass2();

        public AnonymousClass2() {
            super(1, InterfaceC5149.class, "next", "next()Lkotlin/text/MatchResult;", 0);
        }

        @Override // p052.InterfaceC6557
        public final InterfaceC5149 invoke(InterfaceC5149 interfaceC5149) {
            interfaceC5149.getClass();
            return ((C5147) interfaceC5149).m10175();
        }
    }
    ...
    @InterfaceC6861(c = "kotlin.text.Regex$splitToSequence$1", f = "Regex.kt", l = {296, 304, 308}, m = "invokeSuspend", v = 2)
    public static final class AnonymousClass1 extends RestrictedSuspendLambda implements InterfaceC6553 {
        ...
        public AnonymousClass1(CharSequence charSequence, int i, InterfaceC4356<? super AnonymousClass1> interfaceC4356) {
        ...
        public final InterfaceC4356<C5175> create(Object obj, InterfaceC4356<?> interfaceC4356) {
            AnonymousClass1 anonymousClass1 = Regex.this.new AnonymousClass1(this.$input, this.$limit, interfaceC4356);
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r13) {
            ...
            L4b:
                ...
                r12.I$1 = r13
                r12.label = r5
                kotlin.coroutines.intrinsics.CoroutineSingletons r2 = r0.mo10117(r9, r12)
                if (r2 != r1) goto L6a
                goto Lb1
            L6a:
                r2 = r13
            ...
            L80:
                ...
                r12.I$1 = r2
                r12.label = r4
                kotlin.coroutines.intrinsics.CoroutineSingletons r12 = r0.mo10117(r5, r12)
                if (r12 != r1) goto Lb2
                goto Lb1
            L9f:
                ...
                r12.L$1 = r6
                r12.label = r7
                kotlin.coroutines.intrinsics.CoroutineSingletons r12 = r0.mo10117(r13, r12)
                if (r12 != r1) goto Lb2
            Lb1:
                return r1
            Lb2:
    ...
    public static /* synthetic */ InterfaceC5149 find$default(Regex regex, CharSequence charSequence, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
    ...
    public static /* synthetic */ InterfaceC5126 findAll$default(Regex regex, CharSequence charSequence, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
    ...
    public static /* synthetic */ InterfaceC5126 splitToSequence$default(Regex regex, CharSequence charSequence, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
    ...
    public final InterfaceC5149 find(CharSequence input, int startIndex) {
        input.getClass();
        Matcher matcher = this.nativePattern.matcher(input);
        matcher.getClass();
        if (matcher.find(startIndex)) {
            return new C5147(matcher, input);
        }
        return null;
    }

    public final InterfaceC5126 findAll(CharSequence input, int startIndex) {
        input.getClass();
        if (startIndex < 0 || startIndex > input.length()) {
            C4210.m8624(AbstractC0053.m148(startIndex, "Start index out of bounds: ", ", input length: "), input.length());
            return null;
        }
        C5148 c5148 = new C5148(this, input, startIndex);
        AnonymousClass2 anonymousClass2 = AnonymousClass2.INSTANCE;
        anonymousClass2.getClass();
        return new C4379(c5148, anonymousClass2);
    }
    ...
    public final InterfaceC5149 matchAt(CharSequence input, int index) {
        input.getClass();
        ...
        if (matcherRegion.lookingAt()) {
            return new C5147(matcherRegion, input);
        }
        return null;
    }

    public final InterfaceC5149 matchEntire(CharSequence input) {
        input.getClass();
        Matcher matcher = this.nativePattern.matcher(input);
        matcher.getClass();
        if (matcher.matches()) {
    ...
    public final String replace(CharSequence input, InterfaceC6557 transform) {
        input.getClass();
        transform.getClass();
        int i = 0;
        ...
        do {
            C5147 c5147 = (C5147) objFind$default;
            sb.append(input, i, c5147.m10176().f17822);
            sb.append((CharSequence) transform.invoke(objFind$default));
            i = c5147.m10176().f17820 + 1;
            objFind$default = c5147.m10175();
            if (i >= length) {
                break;
            }
    ...
    public final List<String> split(CharSequence input, int limit) {
        input.getClass();
        AbstractC5143.m10144(limit);
        Matcher matcher = this.nativePattern.matcher(input);
        if (limit == 1 || !matcher.find()) {
            return AbstractC8189.m13660(input.toString());
        }
        int i = 10;
        if (limit > 0 && limit <= 10) {
            i = limit;
    ...
    public final InterfaceC5126 splitToSequence(CharSequence input, int limit) {
        input.getClass();
        AbstractC5143.m10144(limit);
        return new C4345(new AnonymousClass1(input, limit, null), 2);
    }
