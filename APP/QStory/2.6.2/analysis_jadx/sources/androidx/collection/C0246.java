...
public final class C0246 extends AbstractC0269 {
    ...
    public C0246(int i) {
        ...
        this.f972 = AbstractC7771.f21082;
        if (i >= 0) {
            m785(AbstractC0290.m882(i));
        } else {
    ...
    public final void m785(int i) {
        ...
        long j = 255 << ((iMax & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f903 = AbstractC0290.m885(this.f971) - this.f970;
        this.f973 = new int[iMax];
        this.f972 = new Object[iMax];
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final int m786(int i) {
        int i2 = this.f971;
        int i3 = i & i2;
        int i4 = 0;
        while (true) {
    ...
    public final int m787(int i) {
        ...
        while (true) {
            ...
            if ((((~j4) << 6) & j4 & (-9187201950435737472L)) != 0) {
                int iM786 = m786(i6);
                long j8 = 255;
                if (this.f903 != 0 || ((this.f974[iM786 >> 3] >> ((iM786 & 7) << 3)) & 255) == 254) {
                    j = 255;
                    j2 = j5;
                    i2 = 1;
                    j3 = 128;
                        ...
                        if (Long.compareUnsigned(((long) this.f970) * 32, ((long) i20) * 25) <= 0) {
                            ...
                            while (i25 != i21) {
                                ...
                                if (j12 != 128 && j12 == 254) {
                                    ...
                                    int iM7862 = m786(i29);
                                    int i30 = i29 & i21;
                                    if (((iM7862 - i30) & i21) / 8 == ((i25 - i30) & i21) / 8) {
                                        long j13 = j11;
                                        ...
                                        if (((j15 >> i32) & j) == 128) {
                                            ...
                                            iArr[iM7862] = iArr[i25];
                                            iArr[i25] = i19;
                                            objArr[iM7862] = objArr[i25];
                                            objArr[i25] = null;
                                        } else {
                                            iArr = iArr2;
                                            objArr = objArr2;
                    ...
                    j2 = j5;
                    i2 = 1;
                    int iM884 = AbstractC0290.m884(this.f971);
                    ...
                    while (i36 < i34) {
                        if (((jArr5[i36 >> 3] >> ((i36 & 7) << 3)) & 255) < j3) {
                            ...
                            jArr[i39] = j17;
                            jArr[(((iM7863 - 7) & i35) + (i35 & 7)) >> 3] = j17;
                            iArr4[iM7863] = i37;
                            objArr4[iM7863] = objArr3[i36];
                        } else {
                            jArr = jArr6;
                            jArr2 = jArr5;
                        }
    ...
    public final void m788() {
        ...
        AbstractC4346.m8861(0, this.f971, null, this.f972);
        this.f903 = AbstractC0290.m885(this.f971) - this.f970;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public final void m789(int i, Object obj) {
        int iM787 = m787(i);
        this.f973[iM787] = i;
        this.f972[iM787] = obj;
    }
    ...
    */
    public final java.lang.Object m790(int r14) {
        /*
            r13 = this;
        ...
        L97:
            ...
            goto L13
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.C0246.m790(int):java.lang.Object");
    }
