...
public final class C0279 implements Set, InterfaceC6566 {
    ...
    public final boolean contains(Object obj) {
        ...
        return AbstractC4394.m8917(this.f987.m756(entry.getKey()), entry.getValue());
    }
    ...
    public final boolean containsAll(Collection collection) {
        ...
        for (Map.Entry entry : collection2) {
            if (!AbstractC4394.m8917(this.f987.m756(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public final boolean isEmpty() {
        return this.f987.m759();
    }

    @Override // java.util.Set, java.util.Collection, java.lang.Iterable
    public final Iterator iterator() {
        return AbstractC2904.m6249(new Entries$iterator$1(this, null));
    }
