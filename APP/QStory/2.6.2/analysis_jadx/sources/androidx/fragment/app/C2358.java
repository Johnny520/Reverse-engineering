    ...
    public void mo4474(List list) {
        ...
        switch (i) {
            case 23:
                ...
                c8712.f24575.m14640(list, AbstractC3056.m6668(-3937679751393838503L));
                AbstractC6154.m11561(AbstractC3056.m6668(-3937679669789459879L) + list.size() + AbstractC3056.m6668(-3937679656904557991L));
                c8712.f24574.execute(new RunnableC0099(c8712, 24, list));
                break;
            case 24:
                C8710 c8710 = (C8710) obj;
                c8710.f24569.m14640(list, AbstractC3056.m6668(-3937679751393838503L));
                AbstractC6154.m11561(AbstractC3056.m6668(-3937679669789459879L) + list.size() + AbstractC3056.m6668(-3937679656904557991L));
                new Thread(new RunnableC0099(c8710, 25, list)).start();
                break;
            default:
                C8708 c8708 = (C8708) obj;
                c8708.f24565.m14640(list, AbstractC3056.m6668(-3937679751393838503L));
                AbstractC6154.m11561(AbstractC3056.m6668(-3937679669789459879L) + list.size() + AbstractC3056.m6668(-3937679656904557991L));
