...
public final class C2499 implements Comparator {
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        RecyclerView recyclerView = c2498.f7481;
        if ((recyclerView == null) == (c24982.f7481 == null)) {
            boolean z = c2498.f7484;
            if (z == c24982.f7484) {
                int i = c24982.f7483 - c2498.f7483;
                if (i != 0) {
                    return i;
                }
                int i2 = c2498.f7482 - c24982.f7482;
                if (i2 != 0) {
                    return i2;
                }
                return 0;
