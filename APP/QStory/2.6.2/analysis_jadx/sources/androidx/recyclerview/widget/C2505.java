...
public final class C2505 extends AbstractC2536 {
    ...
    public static TimeInterpolator f7497;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲世兰苏, reason: contains not printable characters */
    public ArrayList f7498;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public static void m4956(ArrayList arrayList) {
    ...
    public final boolean mo4957() {
        return (this.f7508.isEmpty() && this.f7506.isEmpty() && this.f7509.isEmpty() && this.f7504.isEmpty() && this.f7503.isEmpty() && this.f7500.isEmpty() && this.f7502.isEmpty() && this.f7501.isEmpty() && this.f7499.isEmpty() && this.f7507.isEmpty() && this.f7498.isEmpty()) ? false : true;
    }

    @Override // androidx.recyclerview.widget.AbstractC2536
    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final void mo4958() {
        ArrayList arrayList = this.f7506;
        ArrayList arrayList2 = this.f7498;
        ArrayList arrayList3 = this.f7507;
        ArrayList arrayList4 = this.f7499;
        ArrayList arrayList5 = this.f7508;
        ArrayList arrayList6 = this.f7504;
        ArrayList arrayList7 = this.f7509;
        ...
        while (true) {
            ...
            View view = c2513.f7563.itemView;
        ...
        for (int size2 = arrayList6.size() - 1; size2 >= 0; size2--) {
            m5035((AbstractC2484) arrayList6.get(size2));
        ...
        if (mo4957()) {
            for (int size5 = arrayList4.size() - 1; size5 >= 0; size5--) {
                ...
                for (int size6 = arrayList8.size() - 1; size6 >= 0; size6--) {
                    ...
                    View view2 = c25132.f7563.itemView;
            ...
            for (int size9 = arrayList2.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                    ...
                    AbstractC2484 abstractC24845 = c25122.f7558;
                    if (abstractC24845 != null) {
                        m4962(c25122, abstractC24845);
                    }
                    AbstractC2484 abstractC24846 = c25122.f7557;
                    if (abstractC24846 != null) {
                        m4962(c25122, abstractC24846);
                    }
            ...
            m4956(this.f7502);
            m4956(this.f7501);
            ArrayList arrayList11 = this.f7641;
    ...
    public final void mo4959(AbstractC2484 abstractC2484) {
        ArrayList arrayList = this.f7507;
        ArrayList arrayList2 = this.f7499;
        ArrayList arrayList3 = this.f7498;
        View view = abstractC2484.itemView;
        view.animate().cancel();
        ArrayList arrayList4 = this.f7509;
        ...
        while (true) {
            ...
            if (((C2513) arrayList4.get(size)).f7563 == abstractC2484) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                m5035(abstractC2484);
        ...
        m4965(this.f7506, abstractC2484);
        if (this.f7504.remove(abstractC2484)) {
            view.setAlpha(1.0f);
            m5035(abstractC2484);
        }
        if (this.f7508.remove(abstractC2484)) {
            view.setAlpha(1.0f);
            m5035(abstractC2484);
        }
        for (int size2 = arrayList3.size() - 1; size2 >= 0; size2--) {
            ArrayList arrayList5 = (ArrayList) arrayList3.get(size2);
            m4965(arrayList5, abstractC2484);
        ...
        for (int size3 = arrayList2.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((C2513) arrayList6.get(size4)).f7563 == abstractC2484) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    m5035(abstractC2484);
        ...
        this.f7500.remove(abstractC2484);
    ...
    public final boolean mo4960(AbstractC2484 abstractC2484, AbstractC2484 abstractC24842, C0966 c0966, C0966 c09662) {
        int i;
        int i2;
        int i3 = c0966.f2755;
        int i4 = c0966.f2754;
        ...
        if (abstractC2484 == abstractC24842) {
            return m4961(abstractC2484, i3, i4, i, i2);
        }
        ...
        c2512.f7558 = abstractC2484;
        c2512.f7557 = abstractC24842;
        c2512.f7556 = i3;
        c2512.f7555 = i4;
        c2512.f7554 = i;
        c2512.f7553 = i2;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final boolean m4961(AbstractC2484 abstractC2484, int i, int i2, int i3, int i4) {
        View view = abstractC2484.itemView;
        ...
        ArrayList arrayList = this.f7509;
        C2513 c2513 = new C2513();
        c2513.f7563 = abstractC2484;
        c2513.f7562 = translationX;
        c2513.f7561 = translationY;
        c2513.f7560 = i3;
        c2513.f7559 = i4;
        arrayList.add(c2513);
        return true;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰世哲, reason: contains not printable characters */
    public final boolean m4962(C2512 c2512, AbstractC2484 abstractC2484) {
        if (c2512.f7557 == abstractC2484) {
            c2512.f7557 = null;
        } else {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰哲世, reason: contains not printable characters */
    public final void m4963(AbstractC2484 abstractC2484) {
        if (f7497 == null) {
            f7497 = new ValueAnimator().getInterpolator();
        }
        abstractC2484.itemView.animate().setInterpolator(f7497);
        mo4959(abstractC2484);
    }
    ...
    public final void m4964() {
        ...
        ArrayList arrayList = this.f7641;
        if (arrayList.size() <= 0) {
            arrayList.clear();
        } else {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public final void m4965(ArrayList arrayList, AbstractC2484 abstractC2484) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            C2512 c2512 = (C2512) arrayList.get(size);
            if (m4962(c2512, abstractC2484) && c2512.f7558 == null && c2512.f7557 == null) {
