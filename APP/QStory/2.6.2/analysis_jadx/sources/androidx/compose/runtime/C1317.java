...
public final class C1317 implements InterfaceC1325 {
    ...
    public final InterfaceC1395 f3820;

    public C1317(InterfaceC1395 interfaceC1395) {
        this.f3820 = interfaceC1395;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof C1317) && this.f3820 == ((C1317) obj).f3820;
    }

    public final int hashCode() {
        return this.f3820.hashCode();
    }

    public final String toString() {
        return "DynamicValueHolder(state=" + this.f3820 + ')';
    }

    @Override // androidx.compose.runtime.InterfaceC1325
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰 */
    public final Object mo2296(C1253 c1253) {
        return ((AbstractC1347) this.f3820).getValue();
    }
}
