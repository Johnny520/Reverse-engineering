...
@InterfaceC6861(c = "androidx.compose.runtime.Recomposer$runRecomposeAndApplyChanges$2", f = "Recomposer.kt", l = {615, 626}, m = "invokeSuspend", v = 1)
...
final class Recomposer$runRecomposeAndApplyChanges$2 extends SuspendLambda implements InterfaceC6550 {
    ...
    public Recomposer$runRecomposeAndApplyChanges$2(C1383 c1383, InterfaceC4356<? super Recomposer$runRecomposeAndApplyChanges$2> interfaceC4356) {
    ...
    */
    ...
    private static final void invokeSuspend$fillToInsert(List<AbstractC1305> list, C1383 c1383) {
        ...
        synchronized (c1383.f3995) {
            try {
                ArrayList arrayList = c1383.f4012;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final kotlin.C5175 invokeSuspend$lambda$2(androidx.compose.runtime.C1383 r22, androidx.collection.C0235 r23, androidx.collection.C0235 r24, java.util.List r25, java.util.List r26, androidx.collection.C0235 r27, java.util.List r28, androidx.collection.C0235 r29, java.util.Set r30, long r31) {
        /*
    ...
    public final Object invoke(InterfaceC5400 interfaceC5400, InterfaceC1304 interfaceC1304, InterfaceC4356<? super C5175> interfaceC4356) {
        Recomposer$runRecomposeAndApplyChanges$2 recomposer$runRecomposeAndApplyChanges$2 = new Recomposer$runRecomposeAndApplyChanges$2(this.this$0, interfaceC4356);
        recomposer$runRecomposeAndApplyChanges$2.L$0 = interfaceC1304;
        return recomposer$runRecomposeAndApplyChanges$2.invokeSuspend(C5175.f14739);
    }
