...
public final class C1502 extends AbstractC1490 {
    ...
    public final long mo2651(float f, float f2, float f3, float f4, AbstractC1490 abstractC1490) {
        switch (this.f4279) {
            case 0:
                float[] fArr = AbstractC1501.f4274;
                float f5 = f / fArr[0];
                float f6 = f2 / fArr[1];
                float f7 = f3 / fArr[2];
                ...
                return AbstractC1581.m2873(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, abstractC1490);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return AbstractC1581.m2873(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, abstractC1490);
        }
    }
    ...
    public final float mo2652(float f, float f2, float f3) {
        switch (this.f4279) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * AbstractC1501.f4274[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
