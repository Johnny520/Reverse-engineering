...
public final class C1753 extends AbstractC1794 {
    ...
    public static final C1609 f5138;

    /* JADX INFO: renamed from: 飘花落叶言子苏哲世兰楪, reason: contains not printable characters */
    public C1774 f5139;

    /* JADX INFO: renamed from: 飘花落叶言子苏哲世楪兰, reason: contains not printable characters */
    public InterfaceC1773 f5140;
    ...
    public C1753(C1748 c1748, InterfaceC1773 interfaceC1773) {
        super(c1748);
        this.f5140 = interfaceC1773;
        this.f5139 = c1748.f5119 != null ? new C1774(this) : null;
        this.f5141 = (((AbstractC2128) interfaceC1773).f6291.f6290 & 512) != 0 ? new C1684(this, (InterfaceC1687) interfaceC1773) : null;
    }
    ...
    public final int mo3044(int i) {
        ...
        InterfaceC1773 interfaceC1773 = this.f5140;
    ...
    public final AbstractC1724 mo3045(long j) {
        m3130(j);
        C1684 c1684 = this.f5141;
        if (c1684 == null) {
            InterfaceC1773 interfaceC1773 = this.f5140;
            AbstractC1794 abstractC1794 = this.f5256;
            abstractC1794.getClass();
            m3376(interfaceC1773.mo1101(this, abstractC1794, j));
            m3370();
            return this;
        }
        C1774 c1774 = c1684.f4942.f5139;
        c1774.getClass();
        InterfaceC1657 interfaceC1657Mo3191 = c1774.mo3191();
        interfaceC1657Mo3191.mo1463();
        interfaceC1657Mo3191.mo1464();
        throw null;
    }
    ...
    public final AbstractC2128 mo3272() {
        return ((AbstractC2128) this.f5140).f6291;
    }

    @Override // androidx.compose.ui.node.AbstractC1794
    /* JADX INFO: renamed from: 飘花落叶言子兰苏世楪哲, reason: contains not printable characters */
    public final void mo3273(InterfaceC1601 interfaceC1601, C1516 c1516) {
        AbstractC1794 abstractC1794;
        AbstractC1794 abstractC17942 = this.f5256;
        abstractC17942.getClass();
        abstractC17942.m3396(interfaceC1601, c1516);
        if (!((ViewTreeObserverOnGlobalLayoutListenerC1884) AbstractC1757.m3296(this.f5258)).getShowLayoutBounds() || (abstractC1794 = this.f5256) == null) {
            return;
        }
        if (C7905.m13329(this.f4997, abstractC1794.f4997) && C7907.m13336(abstractC1794.f5244, 0L)) {
            return;
        }
        long j = this.f4997;
        interfaceC1601.mo2682(0.5f, 0.5f, ((int) (j >> 32)) - 0.5f, ((int) (j & 4294967295L)) - 0.5f, f5138);
    }
    ...
    public final int mo3047(int i) {
        ...
        AbstractC1794 abstractC1794 = this.f5256;
        abstractC1794.getClass();
        return interfaceC1773.mo1073(this, abstractC1794, i);
    }
    ...
    public final int mo3276(AbstractC1689 abstractC1689) {
        C1774 c1774 = this.f5139;
        if (c1774 == null) {
            return AbstractC1785.m3331(this, abstractC1689);
        }
        C0252 c0252 = c1774.f5057;
        int iM803 = c0252.m803(abstractC1689);
        if (iM803 >= 0) {
    ...
    */
    public final void mo3118(long r5, float r7, p052.InterfaceC6557 r8) {
        /*
            r4 = this;
            boolean r0 = r4.f5257
            if (r0 == 0) goto L11
            androidx.compose.ui.node.飘花落叶言子世哲楪苏兰 r5 = r4.mo3275()
            r5.getClass()
            long r5 = r5.f5061
            r4.m3385(r5, r7, r8)
            goto L14
        ...
        L19:
            r4.m3371()
            androidx.compose.ui.node.飘花落叶言子苏世楪哲兰 r5 = r4.f5256
            r5.getClass()
            androidx.compose.ui.layout.飘花落叶言子楪世兰哲苏 r6 = r4.f5141
            r7 = 0
            if (r6 == 0) goto L5f
            androidx.compose.ui.node.飘花落叶言子楪兰哲苏世 r6 = r4.f5139
            r6.getClass()
            long r0 = r4.f4997
            androidx.compose.ui.node.飘花落叶言子楪兰哲苏世 r6 = r4.f5139
            r8 = 0
        ...
        L3c:
            r6 = r8
        L3d:
            boolean r6 = p205.C7905.m13330(r6, r0)
            if (r6 == 0) goto L5c
            long r0 = r5.f4997
            androidx.compose.ui.node.飘花落叶言子世哲楪苏兰 r6 = r5.mo3275()
            if (r6 == 0) goto L54
            long r2 = r6.m3198()
            飘花落叶言子苏哲世楪兰.飘花落叶言子楪苏兰哲世 r8 = new 飘花落叶言子苏哲世楪兰.飘花落叶言子楪苏兰哲世
            r8.<init>(r2)
        L54:
            boolean r6 = p205.C7905.m13330(r8, r0)
            if (r6 == 0) goto L5c
            r6 = 1
            goto L5d
        L5c:
        ...
        L5f:
            boolean r6 = r4.f5146
            r5.f5146 = r6
            androidx.compose.ui.layout.飘花落叶言子世兰苏哲楪 r4 = r4.mo3191()
            r4.mo1461()
            r5.f5146 = r7
            r5.f5257 = r7
        L6e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.C1753.mo3118(long, float, 飘花落叶言世子哲楪兰苏.飘花落叶言子楪苏兰哲世):void");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: 飘花落叶言楪子世哲兰苏, reason: contains not printable characters */
    public final void m3277(InterfaceC1773 interfaceC1773) {
        if (!interfaceC1773.equals(this.f5140)) {
            if ((((AbstractC2128) interfaceC1773).f6291.f6290 & 512) != 0) {
