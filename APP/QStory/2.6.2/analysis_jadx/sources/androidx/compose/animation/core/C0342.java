...
public final class C0342 implements InterfaceC0327 {
    ...
    public C0342(InterfaceC0334 interfaceC0334, InterfaceC0358 interfaceC0358, Object obj, AbstractC0343 abstractC0343) {
        ...
        this.f1157 = AbstractC0330.m1025(abstractC0343);
        InterfaceC6557 interfaceC6557Mo1060 = interfaceC0358.mo1060();
        if (c0326.f1099 == null) {
            c0326.f1099 = abstractC03432.mo1038();
        }
        AbstractC0343 abstractC03433 = c0326.f1099;
        if (abstractC03433 == null) {
            AbstractC4394.m8918("targetVector");
            throw null;
        }
        ...
        while (true) {
            ...
            if (i >= iMo1039) {
                ...
                this.f1163 = interfaceC6557Mo1060.invoke(abstractC03434);
                if (c0326.f1100 == null) {
                    c0326.f1100 = abstractC03432.mo1038();
                }
                ...
                int iMo10392 = abstractC03435.mo1039();
                long jMax = 0;
                for (int i2 = 0; i2 < iMo10392; i2++) {
                    abstractC03432.getClass();
                    jMax = Math.max(jMax, interfaceC0309.mo450(abstractC0343.mo1040(i2)));
                }
                this.f1162 = jMax;
                AbstractC0343 abstractC0343M1025 = AbstractC0330.m1025(this.f1161.m997(jMax, this.f1158, abstractC0343));
                this.f1156 = abstractC0343M1025;
                int iMo10393 = abstractC0343M1025.mo1039();
                for (int i3 = 0; i3 < iMo10393; i3++) {
                    AbstractC0343 abstractC03436 = this.f1156;
                    float fMo1040 = abstractC03436.mo1040(i3);
                    float f = this.f1161.f1098;
                    abstractC03436.mo1036(AbstractC6087.m11419(fMo1040, -f, f), i3);
                }
                return;
            }
            if (abstractC03434 == null) {
            ...
            abstractC03434.mo1036(interfaceC0309.mo445(abstractC03432.mo1040(i), abstractC0343.mo1040(i)), i);
            i++;
        }
    }
    ...
    public final Object mo998(long j) {
        ...
        InterfaceC6557 interfaceC6557Mo1060 = this.f1160.mo1060();
        ...
        if (abstractC0343 == null) {
            c0326.f1101 = abstractC03432.mo1038();
        }
        ...
        while (true) {
            ...
            if (i >= iMo1039) {
                if (abstractC03434 != null) {
                    return interfaceC6557Mo1060.invoke(abstractC03434);
                }
                AbstractC4394.m8918("valueVector");
                throw null;
            }
            ...
            abstractC03434.mo1036(c0326.f1102.mo449(abstractC03432.mo1040(i), this.f1157.mo1040(i), j), i);
            i++;
        }
    }
    ...
    public final AbstractC0343 mo1000(long j) {
        ...
        return this.f1161.m997(j, this.f1158, this.f1157);
    }
