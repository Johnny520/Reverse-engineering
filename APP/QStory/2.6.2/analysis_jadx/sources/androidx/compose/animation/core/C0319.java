...
public final class C0319 implements InterfaceC0322 {
    ...
    public final void m950(AbstractC0343 abstractC0343, AbstractC0343 abstractC03432, AbstractC0343 abstractC03433) {
        float[] fArr;
        ...
        if (abstractC03434 == null) {
            this.f1082 = abstractC0343.mo1038();
            this.f1079 = abstractC03433.mo1038();
            int i = c0247.f985;
            float[] fArr2 = new float[i];
            for (int i2 = 0; i2 < i; i2++) {
                fArr2[i2] = c0247.m855(i2) / 1000.0f;
            }
            this.f1081 = fArr2;
            int i3 = c0247.f985;
            int[] iArr = new int[i3];
        ...
        if (z) {
            if (this.f1073 != AbstractC0359.f1230 && AbstractC4394.m8917(this.f1080, abstractC0343) && AbstractC4394.m8917(this.f1076, abstractC03432)) {
                return;
            }
            this.f1080 = abstractC0343;
            this.f1076 = abstractC03432;
            int iMo1039 = abstractC0343.mo1039() + (abstractC0343.mo1039() % 2);
            this.f1075 = new float[iMo1039];
            this.f1074 = new float[iMo1039];
            int i5 = c0247.f985;
            float[][] fArr3 = new float[i5][];
            for (int i6 = 0; i6 < i5; i6++) {
                int iM855 = c0247.m855(i6);
                C0324 c0324 = (C0324) c0246.m832(iM855);
                if (iM855 == 0 && c0324 == null) {
                    fArr = new float[iMo1039];
                    for (int i7 = 0; i7 < iMo1039; i7++) {
                        fArr[i7] = abstractC0343.mo1040(i7);
                    }
                } else if (iM855 == this.f1084 && c0324 == null) {
                    fArr = new float[iMo1039];
                    for (int i8 = 0; i8 < iMo1039; i8++) {
                        fArr[i8] = abstractC03432.mo1040(i8);
                    }
                } else {
                    c0324.getClass();
                    AbstractC0343 abstractC03435 = c0324.f1092;
                    float[] fArr4 = new float[iMo1039];
                    for (int i9 = 0; i9 < iMo1039; i9++) {
                        fArr4[i9] = abstractC03435.mo1040(i9);
                    }
                    fArr = fArr4;
                }
                fArr3[i6] = fArr;
    ...
    public final float m951(int i, int i2, boolean z) {
        ...
        if (i >= c0247.f985 - 1) {
            ...
            int iM855 = c0247.m855(i);
            int iM8552 = c0247.m855(i + 1);
            if (i2 != iM855) {
                int i3 = iM8552 - iM855;
                C0324 c0324 = (C0324) this.f1083.m832(iM855);
                if (c0324 == null || (interfaceC0335 = c0324.f1091) == null) {
                    interfaceC0335 = this.f1078;
                }
                float f2 = i3;
                float fMo850 = interfaceC0335.mo850((i2 - iM855) / f2);
                return z ? fMo850 : ((f2 * fMo850) + iM855) / 1000.0f;
            }
            f = iM855;
        }
        return f / 1000.0f;
    ...
    public final AbstractC0343 mo444(long j, AbstractC0343 abstractC0343, AbstractC0343 abstractC03432, AbstractC0343 abstractC03433) {
        ...
        int i2 = (int) j3;
        C0246 c0246 = this.f1083;
        C0324 c0324 = (C0324) c0246.m832(i2);
        if (c0324 != null) {
            return c0324.f1092;
        }
        if (i2 >= i) {
        ...
        if (this.f1073 != AbstractC0359.f1230) {
            ...
            if (fM951 < f || fM951 > f2) {
                ...
                while (i4 < length2 - 1) {
                    ...
                    if (z) {
                        ...
                        c0344Arr = c0344Arr2;
                        fArr[i4] = (f5 * f3) + AbstractC0053.m145(c0344.f1165, f8, (f - f6) * f7, f8);
                        float f9 = (f - f6) * f7;
                        float f10 = c0344.f1166;
                        fArr[i4 + 1] = (f4 * f3) + AbstractC0053.m145(c0344.f1164, f10, f9, f10);
                    } else {
                        c0344Arr = c0344Arr2;
                        c0344.m1041(f);
                        fArr[i4] = (c0344.m1043() * f3) + (c0344.f1170 * c0344.f1176) + f5;
                        fArr[i4 + 1] = (c0344.m1042() * f3) + (c0344.f1174 * c0344.f1180) + f4;
                    }
                    i4 += 2;
                    i5++;
                    c0344Arr2 = c0344Arr;
                ...
                while (i6 < length3) {
                    ...
                    while (i7 < length2 - 1) {
                        ...
                        if (fM951 <= c03442.f1168) {
                            if (c03442.f1175) {
                                float f11 = c03442.f1169;
                                float f12 = c03442.f1178;
                                float f13 = c03442.f1167;
                                fArr[i7] = AbstractC0053.m145(c03442.f1165, f13, (fM951 - f11) * f12, f13);
                                float f14 = c03442.f1166;
                                fArr[i7 + 1] = AbstractC0053.m145(c03442.f1164, f14, (fM951 - f11) * f12, f14);
                            } else {
                                c03442.m1041(fM951);
            ...
            for (int i9 = 0; i9 < length4; i9++) {
                abstractC03437.mo1036(fArr[i9], i9);
            }
        } else {
            int iM952 = m952(i2);
            float fM9512 = m951(iM952, i2, true);
            C0247 c0247 = this.f1085;
            C0324 c03242 = (C0324) c0246.m832(c0247.m855(iM952));
            if (c03242 != null && (abstractC03435 = c03242.f1092) != null) {
                abstractC03436 = abstractC03435;
            }
            C0324 c03243 = (C0324) c0246.m832(c0247.m855(iM952 + 1));
            if (c03243 == null || (abstractC03434 = c03243.f1092) == null) {
                abstractC03434 = abstractC03432;
            }
            int iMo1039 = abstractC03437.mo1039();
            for (int i10 = 0; i10 < iMo1039; i10++) {
                abstractC03437.mo1036((abstractC03434.mo1040(i10) * fM9512) + ((1.0f - fM9512) * abstractC03436.mo1040(i10)), i10);
            }
        }
    ...
    public final AbstractC0343 mo451(long j, AbstractC0343 abstractC0343, AbstractC0343 abstractC03432, AbstractC0343 abstractC03433) {
        ...
        m950(abstractC0343, abstractC03432, abstractC03433);
        ...
        if (this.f1073 != AbstractC0359.f1230) {
            ...
            int length2 = fArr.length;
            while (i < length2) {
                abstractC03434.mo1036(fArr[i], i);
                i++;
            }
        } else {
            AbstractC0343 abstractC0343Mo444 = mo444((j4 - 1) * 1000000, abstractC0343, abstractC03432, abstractC03433);
            AbstractC0343 abstractC0343Mo4442 = mo444(j4 * 1000000, abstractC0343, abstractC03432, abstractC03433);
            int iMo1039 = abstractC0343Mo444.mo1039();
            while (i < iMo1039) {
                abstractC03434.mo1036((abstractC0343Mo444.mo1040(i) - abstractC0343Mo4442.mo1040(i)) * 1000.0f, i);
                i++;
            }
        }
