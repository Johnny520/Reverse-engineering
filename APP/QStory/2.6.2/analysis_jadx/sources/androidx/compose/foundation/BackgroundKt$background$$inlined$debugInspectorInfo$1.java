...
public final class BackgroundKt$background$$inlined$debugInspectorInfo$1 extends Lambda implements InterfaceC6557 {
    final /* synthetic */ float $alpha$inlined;
    final /* synthetic */ AbstractC1598 $brush$inlined;
    final /* synthetic */ InterfaceC1569 $shape$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BackgroundKt$background$$inlined$debugInspectorInfo$1(float f, AbstractC1598 abstractC1598, InterfaceC1569 interfaceC1569) {
        super(1);
        this.$alpha$inlined = f;
        this.$brush$inlined = abstractC1598;
        this.$shape$inlined = interfaceC1569;
    }
