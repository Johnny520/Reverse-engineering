...
public final /* synthetic */ class C0679 implements InterfaceC1342, InterfaceC2170, InterfaceC2205, InterfaceC6294, InterfaceC7963, InterfaceC8915 {
    ...
    public void mo1468(AbstractC7968 abstractC7968, View view, int i) {
        ...
        try {
            ...
            int i2 = 1;
            AbstractC6317.m11837(objM11831, AbstractC3056.m6668(-3937831153285989799L), 1);
            ...
            AbstractC6154.m11561(AbstractC3056.m6668(-3937831187645728167L) + e.getMessage());
        }
        C8746.f24650.getClass();
        if (C8746.m14413()) {
            return;
    ...
    public void mo1469(XC_MethodHook.MethodHookParam methodHookParam) throws IllegalAccessException, InvocationTargetException {
        ...
        switch (i) {
            case 3:
                ...
                Object objM11913 = C6360.m11913(objInvoke, AbstractC3056.m6668(-3937563508103972263L), R.mipmap.ic_launcher_round, new CallableC6393((C6415) obj2, objInvoke, 0));
