...
public final class C0060 extends AbstractC0088 {
    ...
    public final boolean mo180(int i, KeyEvent keyEvent) {
        ...
        menuM175.setQwertyMode(KeyCharacterMap.load(keyEvent.getDeviceId()).getKeyboardType() != 1);
        return menuM175.performShortcut(i, keyEvent, 0);
    }
