...
public final class ViewOnClickListenerC0070 implements View.OnClickListener {
    ...
    public ViewOnClickListenerC0070(C5841 c5841, Object obj, Object obj2) {
        ...
        this.f222 = obj2;
        try {
            Object objM11831 = AbstractC6317.m11831(ArrayList.class, AbstractC3056.m6668(-3937563413614691751L), obj);
    ...
    */
    ...
    public boolean m244() {
        try {
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Integer num = (Integer) AbstractC6317.m11831(Integer.TYPE, AbstractC3056.m6668(-3937563452269397415L), next);
