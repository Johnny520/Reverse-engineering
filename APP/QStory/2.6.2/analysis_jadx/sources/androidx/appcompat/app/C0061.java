...
public final class C0061 {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public static void m182(C0061 c0061, long j, long j2, int i) {
        if ((i & 1) != 0) {
            j = 0;
        }
        if ((i & 2) != 0) {
    ...
    public String toString() {
        switch (this.f134) {
            case 1:
                return "WindowCounter(streamId=" + this.f133 + ", total=" + this.f132 + ", acknowledged=" + this.f131 + ", unacknowledged=" + m183() + ')';
            default:
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public synchronized long m183() {
        return this.f132 - this.f131;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public void m184(double d, double d2, long j) {
