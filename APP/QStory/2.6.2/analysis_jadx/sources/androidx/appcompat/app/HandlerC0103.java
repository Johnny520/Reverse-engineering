...
public final class HandlerC0103 extends Handler {
    ...
    public HandlerC0103(DialogC6312 dialogC6312, Looper looper) {
        ...
        new SimpleDateFormat(AbstractC3056.m6668(-3937562129419470247L));
    }
        ...
        switch (this.f285) {
            ...
            case 1:
                ...
                if (obj instanceof String) {
                    ...
                    if (iHashCode == 68795) {
                        if (str.equals(AbstractC3056.m6668(-3937638300664464807L))) {
                            dialogC6313.dismiss();
                        }
                    } else if (iHashCode == 79219778 && str.equals(AbstractC3056.m6668(-3937638283484595623L))) {
                        dialogC6313.show();
                    }
            ...
            default:
                ...
                long j2 = j / 1000;
                dialogC6312.f17403.setText(Math.abs(j2) + AbstractC3056.m6668(-3937562159484241319L) + Math.abs(j - (1000 * j2)) + AbstractC3056.m6668(-3937562168074175911L));
                break;
        }
    }
