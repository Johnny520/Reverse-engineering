...
public class AlertDialogLayout extends AbstractC0166 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public static int m487(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m487(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            androidx.appcompat.widget.飘花落叶言子哲世楪兰苏 r6 = (androidx.appcompat.widget.C0163) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM487 = m487(view2);
            measuredHeight = view2.getMeasuredHeight() - iM487;
            paddingBottom += iM487;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM487;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM487 += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM487, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0163).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c0163).height;
                        ((LinearLayout.LayoutParams) c0163).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c0163).height = i9;
                    }
                }
                i8++;
