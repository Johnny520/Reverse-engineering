...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet) {
        ...
        this.f530 = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC7772.f21085, 0, 0);
    ...
    public void setVisibility(int i) {
        ...
        if (weakReference != null) {
            ...
            if (view != null) {
                ...
                C5919.m11250("setVisibility called on un-referenced view");
                return;
            }
        }
    ...
    public final View m510() {
        ViewParent parent = getParent();
        if (!(parent instanceof ViewGroup)) {
            C5919.m11250("ViewStub must have a non-null ViewGroup viewParent");
            return null;
        }
        if (this.f530 == 0) {
            C5919.m11249("ViewStub must have a valid layoutResource");
            return null;
        }
