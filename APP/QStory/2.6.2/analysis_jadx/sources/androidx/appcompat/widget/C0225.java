...
public class C0225 extends TextView {
    ...
    public TextClassifier getTextClassifier() {
        ...
        return textClassifier == null ? AbstractC0231.m733((TextView) c0133.f585) : textClassifier;
    }

    public C7592 getTextMetricsParamsCompat() {
        return AbstractC8174.m13609(this);
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        if (Build.VERSION.SDK_INT < 30 && inputConnectionOnCreateInputConnection != null) {
            AbstractC3054.m6593(editorInfo, getText());
        }
    ...
    public final void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i2, int i3, int i4) {
        ...
        setCompoundDrawablesRelativeWithIntrinsicBounds(i != 0 ? AbstractC3054.m6607(context, i) : null, i2 != 0 ? AbstractC3054.m6607(context, i2) : null, i3 != 0 ? AbstractC3054.m6607(context, i3) : null, i4 != 0 ? AbstractC3054.m6607(context, i4) : null);
        C0212 c0212 = this.f848;
        if (c0212 != null) {
            c0212.m709();
        }
    ...
    public final void setCompoundDrawablesWithIntrinsicBounds(int i, int i2, int i3, int i4) {
        Context context = getContext();
        setCompoundDrawablesWithIntrinsicBounds(i != 0 ? AbstractC3054.m6607(context, i) : null, i2 != 0 ? AbstractC3054.m6607(context, i2) : null, i3 != 0 ? AbstractC3054.m6607(context, i3) : null, i4 != 0 ? AbstractC3054.m6607(context, i4) : null);
        C0212 c0212 = this.f848;
        if (c0212 != null) {
            c0212.m709();
        }
    ...
    public void setFirstBaselineToTopHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            getSuperCaller().mo447(i);
        } else {
            AbstractC8174.m13601(this, i);
        }
    }
    ...
    public void setLastBaselineToBottomHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            getSuperCaller().mo452(i);
        } else {
            AbstractC8174.m13600(this, i);
        }
    }
    ...
    public final void setLineHeight(int i, float f) {
        ...
        if (i2 >= 34) {
            getSuperCaller().mo441(i, f);
        } else if (i2 >= 34) {
            AbstractC2296.m4311(this, i, f);
        } else {
            AbstractC8174.m13599(this, Math.round(TypedValue.applyDimension(i, f, getResources().getDisplayMetrics())));
        }
    }

    public void setPrecomputedText(AbstractC7591 abstractC7591) {
        if (Build.VERSION.SDK_INT >= 29) {
            throw null;
        }
        AbstractC8174.m13609(this);
    ...
    public void setTextFuture(Future<AbstractC7591> future) {
        this.f847 = future;
        if (future != null) {
            requestLayout();
        }
    ...
    public void setTextMetricsParamsCompat(C7592 c7592) {
        TextDirectionHeuristic textDirectionHeuristic;
        TextDirectionHeuristic textDirectionHeuristic2 = c7592.f20585;
        ...
        setTextDirection(i);
        getPaint().set(c7592.f20586);
        setBreakStrategy(c7592.f20584);
        setHyphenationFrequency(c7592.f20583);
    }
    ...
    public final void setTypeface(Typeface typeface, int i) {
        ...
        if (typeface == null || i <= 0) {
            ...
            Context context = getContext();
            AbstractC4921 abstractC4921 = AbstractC7662.f20808;
            if (context == null) {
                C5919.m11249("Context cannot be null");
                return;
            }
