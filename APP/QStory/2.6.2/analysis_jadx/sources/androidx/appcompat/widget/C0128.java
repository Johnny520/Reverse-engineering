...
public class C0128 extends EditText implements InterfaceC2204 {
    ...
    public C0128(Context context, AttributeSet attributeSet) {
        ...
        this.f568 = c0191;
        c0191.m665(attributeSet, R.attr.editTextStyle);
        C0212 c0212 = new C0212(this);
        this.f566 = c0212;
        c0212.m706(attributeSet, R.attr.editTextStyle);
        c0212.m709();
        ...
        this.f563 = c01332;
        c01332.mo530(attributeSet, R.attr.editTextStyle);
        ...
        KeyListener keyListenerM558 = c01332.m558(keyListener);
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        if (inputConnectionOnCreateInputConnection != null && i <= 30 && (strArrM4235 = AbstractC2270.m4235(this)) != null) {
            editorInfo.contentMimeTypes = strArrM4235;
            inputConnectionOnCreateInputConnection = new C7605(inputConnectionOnCreateInputConnection, new C2358(this, 22));
        }
        return this.f563.m557(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public final boolean onDragEvent(DragEvent dragEvent) {
        Activity activity;
        boolean zM528 = false;
        if (Build.VERSION.SDK_INT < 31 && dragEvent.getLocalState() == null && AbstractC2270.m4235(this) != null) {
            ...
            if (activity == null) {
                ...
                zM528 = AbstractC0122.m528(dragEvent, this, activity);
            }
        }
        if (zM528) {
            return true;
    ...
    public final boolean onTextContextMenuItem(int i) {
        ...
        if (i2 >= 31 || AbstractC2270.m4235(this) == null || !(i == 16908322 || i == 16908337)) {
        ...
        if (primaryClip != null && primaryClip.getItemCount() > 0) {
            if (i2 >= 31) {
                ...
                c2244.f6541 = primaryClip;
                c2244.f6542 = 1;
                c0113 = c2244;
            }
            c0113.mo448(i == 16908322 ? 0 : 1);
            AbstractC2270.m4237(this, c0113.build());
        }
        return true;
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f563.m558(keyListener));
    }
    ...
    public final C2260 mo535(C2260 c2260) {
        this.f564.getClass();
        return C2300.m4313(this, c2260);
    }
}
