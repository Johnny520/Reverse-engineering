...
public final class C2292 extends C2246 {
    ...
    public C2292(AbstractC7582 abstractC7582) {
        this.f6663 = 5;
    }
    ...
    public final void mo3581(View view, C7606 c7606) {
        ...
        switch (i) {
            case 0:
                ...
                c7606.m12814(ScrollView.class.getName());
                if (nestedScrollView.isEnabled() && (scrollRange = nestedScrollView.getScrollRange()) > 0) {
                    c7606.m12808(true);
                    if (nestedScrollView.getScrollY() > 0) {
                        c7606.m12805(C7609.f20647);
                        c7606.m12805(C7609.f20639);
                    }
                    if (nestedScrollView.getScrollY() < scrollRange) {
                        c7606.m12805(C7609.f20643);
                        c7606.m12805(C7609.f20641);
                    }
                    break;
                }
                break;
            ...
            default:
                accessibilityDelegate.onInitializeAccessibilityNodeInfo(view, c7606.f20635);
                c7606.m12814(AbstractC7582.class.getName());
                c7606.m12808(false);
                break;
        }
    }
    ...
    public void mo4187(View view, AccessibilityEvent accessibilityEvent) {
        switch (this.f6663) {
            ...
            case 5:
                super.mo4187(view, accessibilityEvent);
                accessibilityEvent.setClassName(AbstractC7582.class.getName());
    ...
    */
    public boolean mo4190(android.view.View r4, int r5, android.os.Bundle r6) {
        /*
            r3 = this;
            int r0 = r3.f6663
            r1 = 1
        ...
        L7:
            boolean r3 = super.mo4190(r4, r5, r6)
            return r3
        Lc:
            boolean r3 = super.mo4190(r4, r5, r6)
            return r3
        ...
        La6:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.C2292.mo4190(android.view.View, int, android.os.Bundle):boolean");
    }
