...
final class ContinuationRunnable extends AtomicBoolean implements Runnable {
    private final InterfaceC4356<C5175> continuation;

    /* JADX WARN: Multi-variable type inference failed */
    public ContinuationRunnable(InterfaceC4356<? super C5175> interfaceC4356) {
        super(false);
    ...
    public void run() {
        if (compareAndSet(false, true)) {
            this.continuation.resumeWith(Result.m8755constructorimpl(C5175.f14739));
        }
    }
