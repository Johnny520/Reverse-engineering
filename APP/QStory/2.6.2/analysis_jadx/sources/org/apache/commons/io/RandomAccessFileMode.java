    ...
    */
    public static org.apache.commons.io.RandomAccessFileMode valueOf(java.nio.file.OpenOption... r5) {
        ...
        L4:
            ...
            if (r4 == 0) goto L3c
            int[] r4 = p377.AbstractC8987.f25238
    ...
    public void accept(Path path, InterfaceC8918 interfaceC8918) throws IOException {
        RandomAccessFile randomAccessFileCreate = create(path);
        try {
            interfaceC8918.accept(randomAccessFileCreate);
    ...
    public <T> T apply(Path path, InterfaceC8917 interfaceC8917) throws IOException {
        RandomAccessFile randomAccessFileCreate = create(path);
        try {
            T t = (T) interfaceC8917.mo14445(randomAccessFileCreate);
            if (randomAccessFileCreate != null) {
                randomAccessFileCreate.close();
            }
            return t;
