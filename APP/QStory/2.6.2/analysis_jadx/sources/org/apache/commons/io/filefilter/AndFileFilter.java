...
public class AndFileFilter extends AbstractC8925 implements Serializable {
    private static final long serialVersionUID = 7215974688563965257L;
    private final List<InterfaceC8921> fileFilters;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AndFileFilter(InterfaceC8921... interfaceC8921Arr) {
    ...
    public FileVisitResult accept(Path path, BasicFileAttributes basicFileAttributes) {
        return isEmpty() ? FileVisitResult.TERMINATE : AbstractC8925.toDefaultFileVisitResult(this.fileFilters.stream().allMatch(new C8924(path, basicFileAttributes, 0)));
    }

    public void addFileFilter(InterfaceC8921... interfaceC8921Arr) {
        Objects.requireNonNull(interfaceC8921Arr, "fileFilters");
        Stream.of((Object[]) interfaceC8921Arr).forEach(new C2663(this, 5));
    }
    ...
    private AndFileFilter(ArrayList<InterfaceC8921> arrayList) {
    ...
    public AndFileFilter(InterfaceC8921 interfaceC8921, InterfaceC8921 interfaceC89212) {
        this(2);
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AndFileFilter(List<InterfaceC8921> list) {
    ...
    public boolean accept(File file, String str) {
        return !isEmpty() && this.fileFilters.stream().allMatch(new C8922(str, file, 0));
    }

    @Override // p359.AbstractC8925, p359.InterfaceC8921, java.io.FileFilter
    public boolean accept(File file) {
        return !isEmpty() && this.fileFilters.stream().allMatch(new C8923(file, 0));
    }
}
