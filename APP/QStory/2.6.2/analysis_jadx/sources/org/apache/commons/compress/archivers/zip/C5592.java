...
public final class C5592 extends AbstractC8976 {
    ...
    public C5592(BufferedInputStream bufferedInputStream) {
        ...
        C5614 c5614 = AbstractC5589.f15378;
        try {
        ...
        this.f15401 = new C5614(charsetDefaultCharset);
        this.f15396 = true;
        this.f15399.limit(0);
    }
    ...
    */
    public final int read(byte[] r21, int r22, int r23) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.C5592.read(byte[], int, int):int");
    }
    ...
    public final long skip(long j) throws IOException {
        long j2 = 0;
        if (j < 0) {
            C5919.m11249("Negative skip value");
            return 0L;
        }
        while (j2 < j) {
            long length = j - j2;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final org.apache.commons.compress.archivers.zip.C5584 m10900() throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 1122
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.C5592.m10900():org.apache.commons.compress.archivers.zip.飘花落叶言子世楪哲兰苏");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final void m10901() throws EOFException {
    ...
    public final void m10902(long j) throws IOException {
        long j2 = 0;
        if (j < 0) {
            C5919.m11245();
            return;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x0066, code lost:
        ...
        top.suzhelan.qstory.hook.item.C5919.m11246("Truncated ZIP file");
     */
  ...
  0x001a: PHI (r3v2 int) = (r3v1 int), (r3v9 int) binds: [B:6:0x0012, B:8:0x0018] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m10903() throws java.io.IOException {
        /*
            r6 = this;
            int r0 = r6.f15394
            if (r0 <= 0) goto Le
        ...
        L12:
            ...
            if (r3 <= r1) goto L66
        L1a:
            byte[] r2 = org.apache.commons.compress.archivers.zip.AbstractC5591.f15381
            r4 = r2[r0]
            if (r3 != r4) goto L6c
            int r3 = r6.m10907()
            r4 = 1
        ...
        L66:
            ...
            top.suzhelan.qstory.hook.item.C5919.m11246(r6)
            return
        L6c:
            r2 = r0
            goto L12
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.C5592.m10903():void");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public final void m10904() throws IOException {
    ...
    public final void m10905(int i, byte[] bArr, int i2) throws IOException {
        if (i < 0) {
    ...
    public final void m10906(byte[] bArr, int i) throws IOException {
        int i2;
        int i3;
        ...
        if (length == 0) {
            ...
            if (length < 0) {
                C5919.m11249(AbstractC6136.m11556(length, "Length must not be negative: "));
                return;
            }
            int i4 = length;
            while (i4 > 0) {
    ...
    public final int m10907() throws IOException {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean m10908() throws java.io.IOException {
        /*
            r9 = this;
            byte[] r0 = r9.f15392
            r1 = 30
        ...
        L38:
            ...
            byte[] r8 = org.apache.commons.compress.archivers.zip.AbstractC5591.f15381     // Catch: java.io.EOFException -> La4
            r7.<init>(r8)     // Catch: java.io.EOFException -> La4
            boolean r6 = r6.equals(r7)     // Catch: java.io.EOFException -> La4
            if (r6 == 0) goto L4a
            int r1 = r1 - r5
            r9.m10905(r5, r2, r1)     // Catch: java.io.EOFException -> La4
            return r3
        L4a:
            int r5 = r5 + 1
            int r4 = r4 + 1
        ...
        L4f:
            ...
            r9.m10906(r2, r4)     // Catch: java.io.EOFException -> La4
            java.lang.System.arraycopy(r2, r3, r0, r3, r1)     // Catch: java.io.EOFException -> La4
            r9.m10906(r0, r1)     // Catch: java.io.EOFException -> La4
        ...
        L8f:
            ...
            r9.m10906(r2, r6)     // Catch: java.io.EOFException -> La4
            goto L11
        L9c:
        ...
        La4:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.C5592.m10908():boolean");
    }
}
