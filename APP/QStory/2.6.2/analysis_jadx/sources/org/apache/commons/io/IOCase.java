...
public enum IOCase {
    ...
    public static IOCase forName(final String str) {
        return (IOCase) Stream.of((Object[]) values()).filter(new C5590(str, 5)).findFirst().orElseThrow(new Supplier() { // from class: 飘花落叶言苏子楪兰哲世.飘花落叶言子楪世兰哲苏
    ...
    public static /* synthetic */ IllegalArgumentException lambda$forName$1(String str) {
        return new IllegalArgumentException(AbstractC0053.m152("Illegal IOCase name: ", str));
    }
