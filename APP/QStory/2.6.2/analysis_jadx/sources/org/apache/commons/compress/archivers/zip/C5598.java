...
public final class C5598 implements InterfaceC5588, Cloneable {
    ...
    public final void parseFromLocalFileData(byte[] bArr, int i, int i2) throws ZipException {
        if (i2 < 14) {
            throw new ZipException(AbstractC0053.m161(i2, "The length is too short, only ", " bytes, expected at least 14"));
        }
        ...
        if (value4 < 0 || value4 > i2 - 14) {
            throw new ZipException(AbstractC0053.m161(value4, "Bad symbolic link name length ", " in ASI extra field"));
        }
        ...
        this.f15425 = m10911(this.f15425);
        this.f15425 = m10911(value3);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final int m10911(int i) {
