...
public final class NumberEncodeValueMatcherList extends ArrayList<C8946> {
    ...
    public final NumberEncodeValueMatcherList addByte(byte value) {
        ...
        c8946.f25153 = new C5706(value);
        c8946.f25152 = NumberEncodeValueType.ByteValue;
        add(c8946);
        return this;
    }
    ...
    public final NumberEncodeValueMatcherList addDouble(double value) {
        C8946 c8946 = new C8946();
        c8946.f25153 = new C5705(value);
        c8946.f25152 = NumberEncodeValueType.DoubleValue;
        add(c8946);
        return this;
    }
    ...
    public final NumberEncodeValueMatcherList addFloat(float value) {
        C8946 c8946 = new C8946();
        c8946.f25153 = new C5704(value);
        c8946.f25152 = NumberEncodeValueType.FloatValue;
        add(c8946);
        return this;
    }
    ...
    public final NumberEncodeValueMatcherList addInt(int value) {
        C8946 c8946 = new C8946();
        c8946.f25153 = new C5703(value);
        c8946.f25152 = NumberEncodeValueType.IntValue;
        add(c8946);
        return this;
    }
    ...
    public final NumberEncodeValueMatcherList addLong(long value) {
        C8946 c8946 = new C8946();
        c8946.f25153 = new C5712(value);
        c8946.f25152 = NumberEncodeValueType.LongValue;
        add(c8946);
        return this;
    }
    ...
    public final NumberEncodeValueMatcherList addShort(short value) {
        C8946 c8946 = new C8946();
        c8946.f25153 = new C5711(value);
        c8946.f25152 = NumberEncodeValueType.ShortValue;
        add(c8946);
        return this;
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof C8946) {
            return contains((C8946) obj);
        }
        return false;
    }
    ...
    public final /* bridge */ boolean remove(Object obj) {
        if (obj instanceof C8946) {
            return remove((C8946) obj);
        }
        return false;
    }

    public /* bridge */ C8946 removeAt(int i) {
        return remove(i);
    }
    ...
    public /* bridge */ boolean contains(C8946 c8946) {
        return super.contains((Object) c8946);
    }

    public /* bridge */ int indexOf(C8946 c8946) {
        return super.indexOf((Object) c8946);
    }

    public /* bridge */ int lastIndexOf(C8946 c8946) {
        return super.lastIndexOf((Object) c8946);
    }

    @Override // java.util.ArrayList, java.util.AbstractList, java.util.List
    public final /* bridge */ C8946 remove(int i) {
        return removeAt(i);
    }

    public /* bridge */ boolean remove(C8946 c8946) {
        return super.remove((Object) c8946);
    }

    public final NumberEncodeValueMatcherList add(InterfaceC6557 init) {
        init.getClass();
        C8946 c8946 = new C8946();
        init.invoke(c8946);
        add(c8946);
