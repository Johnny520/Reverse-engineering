...
public class QQSessionUtils {
    ...
    public static class LegacyQQ {
        public static Parcelable createSessionInfo(String str, int i) {
            ...
            try {
                try {
                    Constructor declaredConstructor = AbstractC6318.m11838(AbstractC3056.m6668(-3937591309427279271L)).getDeclaredConstructor(Parcel.class);
    ...
    public static QSContact AIOContactToQSContact(Object obj) {
        ...
        if (i >= 9898) {
            String str = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937586589258220967L), obj);
            int iIntValue = ((Integer) AbstractC6317.m11831(cls, AbstractC3056.m6668(-3937578832547284391L), obj)).intValue();
            return new QSContact(iIntValue, str);
        }
        if (i >= 8496) {
            String str2 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937596167035291047L), obj);
            int iIntValue2 = ((Integer) AbstractC6317.m11831(cls, AbstractC3056.m6668(-3937586589258220967L), obj)).intValue();
            return new QSContact(iIntValue2, str2);
        }
        String str3 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937596167035291047L), obj);
        int iIntValue3 = ((Integer) AbstractC6317.m11831(cls, AbstractC3056.m6668(-3937586589258220967L), obj)).intValue();
    ...
    public static Object getContactFromAIOContact(Object obj) {
        ...
        if (i >= 8496) {
            String str3 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937596167035291047L), obj);
            int iIntValue2 = ((Integer) AbstractC6317.m11831(cls, AbstractC3056.m6668(-3937586589258220967L), obj)).intValue();
            String str4 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937578823957349799L), obj);
            return QQNT.getContact(iIntValue2, str3, str4);
        }
        String str5 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937596167035291047L), obj);
        int iIntValue3 = ((Integer) AbstractC6317.m11831(cls, AbstractC3056.m6668(-3937586589258220967L), obj)).intValue();
        String str6 = (String) AbstractC6317.m11831(String.class, AbstractC3056.m6668(-3937664843562354087L), obj);
    ...
    public static class QQNT {
        ...
        public static String getFriendNickName(String str, String str2) {
            Class clsM11838 = AbstractC6318.m11838(AbstractC3056.m6668(-3937665135620130215L));
            Object qRouteApi = QQEnvTool.getQRouteApi(clsM11838);
            C6316 c6316M11826 = C6316.m11826(clsM11838);
            String strM6668 = AbstractC3056.m6668(-3937643123912738215L);
        ...
        public static /* synthetic */ Object lambda$prepareTroopMemberStrangerTempChat$0(Object obj, Method method, Object[] objArr) {
            ...
            AbstractC6157.m11573(str, AbstractC3056.m6668(-3937665096965424551L));
            return null;
        }
        ...
        public static void prepareTroopMemberStrangerTempChat(String str, String str2) {
            try {
                ...
                Class clsM11838 = AbstractC6318.m11838(AbstractC3056.m6668(-3937665788455159207L));
                AbstractC6314.m11819(msgServiceOfKernel, AbstractC3056.m6668(-3937665204339606951L), Void.TYPE, new Class[]{AbstractC6318.m11838(AbstractC3056.m6668(-3937665788455159207L)), AbstractC6318.m11838(AbstractC3056.m6668(-3937562726419924391L))}, AbstractC6087.m11389(new Object[]{100, str2, AbstractC3056.m6668(-3937561979095614887L), str, new byte[0], QQEnvTool.getUidFromUin(QQEnvTool.getCurrentUin()), AbstractC3056.m6668(-3937561979095614887L), AbstractC6318.m11838(AbstractC3056.m6668(-3937665462037644711L)).newInstance()}, new Class[]{Integer.TYPE, String.class, String.class, String.class, byte[].class, String.class, String.class, AbstractC6318.m11838(AbstractC3056.m6668(-3937665462037644711L))}, clsM11838), Proxy.newProxyInstance(AbstractC6318.f17411, new Class[]{AbstractC6318.m11838(AbstractC3056.m6668(-3937562726419924391L))}, new C5556(1)));
            } catch (Exception e) {
                C5919.m11252(e);
            }
        }
        ...
        public static Object getContact(int i, String str) {
            return getContact(i, str, AbstractC3056.m6668(-3937561979095614887L));
        }
    }
}
