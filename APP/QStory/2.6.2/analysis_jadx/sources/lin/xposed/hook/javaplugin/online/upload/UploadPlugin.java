...
public final class UploadPlugin {
    ...
    private final String TAG = AbstractC3056.m6668(-3937692842454156711L);
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements InterfaceC6553 {
        ...
        public static final class C55351 extends SuspendLambda implements InterfaceC6553 {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.$res.getStatus() == 200) {
                    final int i = 0;
                    C8207.m13712(this.$res.getMessage(), AbstractC3056.m6668(-3937693615548269991L)).mo13702(AbstractC3056.m6668(-3937640074485958055L), new InterfaceC3749() { // from class: lin.xposed.hook.javaplugin.online.upload.飘花落叶言子楪世苏哲兰
                    ...
                    final int i2 = 1;
                    C8207.m13712(this.$res.getMessage(), AbstractC3056.m6668(-3937693692857681319L)).mo13702(AbstractC3056.m6668(-3937640074485958055L), new InterfaceC3749() { // from class: lin.xposed.hook.javaplugin.online.upload.飘花落叶言子楪世苏哲兰
                        @Override // com.kongzue.dialogx.interfaces.InterfaceC3749
                        public final boolean onClick(AbstractC3737 abstractC3737, View view) {
                            C8207 c8207 = (C8207) abstractC3737;
                            switch (i2) {
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            AbstractC5184.m10206(obj);
            String strM8321 = AbstractC3932.m8321(AbstractC3056.m6668(-3937620394945807783L));
            AbstractC3056.m6668(-3937693293425722791L);
            strM8321.getClass();
            ...
            c8197.f22575 = AbstractC3056.m6668(-3937693061497488807L);
            c8197.m13694();
            PluginManager.stopPlugin(this.$plugin);
            if (!PluginManager.loadPlugin(null, this.$plugin)) {
                C8207.m13712(AbstractC3056.m6668(-3937693014252848551L), AbstractC3056.m6668(-3937693692857681319L));
                return c5175;
            }
            PluginManager.stopPlugin(this.$plugin);
            C8197 c81972 = UploadPlugin.this.waitDialog;
            c81972.f22575 = AbstractC3056.m6668(-3937692885403829671L);
            c81972.m13694();
            String pluginLocalPath = this.$plugin.getPluginLocalPath();
            File file = new File(AbstractC3932.m8321(AbstractC3056.m6668(-3937620394945807783L)), System.currentTimeMillis() + AbstractC3056.m6668(-3937640216219878823L));
            AbstractC3054.m6616(pluginLocalPath, file.getAbsolutePath());
            C8197 c81973 = UploadPlugin.this.waitDialog;
            c81973.f22575 = AbstractC3056.m6668(-3937692915468600743L);
            c81973.m13694();
    ...
    public UploadPlugin() {
        ...
        AbstractC3056.m6668(-3937692760849778087L);
    ...
    public final QSResult<String> uploadToNet(File pluginZipFile) {
        ...
        C6217 c6217M13679 = AbstractC8189.m13679(AbstractC3056.m6668(-3937557744257861031L));
        pluginZipFile.getClass();
        Object obj = apiService.uploadFile(AbstractC0455.m1169(AbstractC3056.m6668(-3937626734317536679L), pluginZipFile.getName(), new C6197(c6217M13679, pluginZipFile)), C8675.m14360(PluginSdkConfig.getUSER_UIN(), AbstractC8189.m13679(AbstractC3056.m6668(-3937627404332434855L))), C8675.m14360(PluginSdkConfig.getUSER_NICKNAME(), AbstractC8189.m13679(AbstractC3056.m6668(-3937627404332434855L)))).execute().f15756;
        obj.getClass();
        return (QSResult) obj;
    }

    public final InterfaceC5451 upload(PluginInfo plugin) {
        AbstractC3056.m6668(-3937640289234322855L);
        plugin.getClass();
