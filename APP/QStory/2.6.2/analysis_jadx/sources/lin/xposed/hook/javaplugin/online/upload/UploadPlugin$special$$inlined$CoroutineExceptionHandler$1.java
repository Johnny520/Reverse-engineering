    ...
    public void handleException(InterfaceC4359 context, final Throwable exception) {
        ...
        AbstractC6087.m11424(new Runnable() { // from class: lin.xposed.hook.javaplugin.online.upload.UploadPlugin$exceptionHandler$1$1
            ...
            public final void run() {
                ...
                C8207.m13712(Log.getStackTraceString(exception), AbstractC3056.m6668(-3937693692857681319L)).mo13702(AbstractC3056.m6668(-3937640074485958055L), new InterfaceC3749() { // from class: lin.xposed.hook.javaplugin.online.upload.UploadPlugin$exceptionHandler$1$1.1
        ...
        Log.e(this.this$0.TAG, AbstractC3056.m6668(-3937693679972779431L), exception);
    }
}
