...
public abstract class AbstractC5554 {
    ...
    public static void m10833(AbstractC6293 abstractC6293) {
        if (AbstractC6340.m11895()) {
            ...
            AbstractC0455.m1145(AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937637669304272295L)), InterfaceC2915.m6317(f15321), false);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static void m10834() {
        if (!new File(AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937637669304272295L))).exists()) {
            m10833(null);
            AbstractC6154.m11561(AbstractC3056.m6668(-3937637493210613159L));
        }
        try {
            Map map = (Map) InterfaceC2915.m6312(AbstractC0455.m1142(AbstractC3932.m8313().concat(AbstractC3056.m6668(-3937637669304272295L))), new C5555(), new JSONReader$Feature[0]);
            f15321 = map;
            if (map == null || map.isEmpty()) {
                throw new RuntimeException(AbstractC3056.m6668(-3937637527570351527L));
            }
            AbstractC6291.f17375.values().forEach(new C2604(1));
        } catch (Exception e) {
            m10833(null);
            AbstractC6157.m11575(e);
            AbstractC6154.m11561(AbstractC3056.m6668(-3937637467440809383L) + e);
        }
    }
