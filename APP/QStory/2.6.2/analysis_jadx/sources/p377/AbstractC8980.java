...
/* JADX INFO: renamed from: 飘花落叶言苏子楪兰哲世.飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
/* JADX INFO: compiled from: r8-map-id-cb39a6809a634dd4ad3d163e22b2e3b526599fa3253f8854b17de2b335a1a776 */
/* JADX INFO: loaded from: classes2.dex */
public abstract class AbstractC8980 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public static final char f25226;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final char f25227;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final String[] f25228 = new String[0];
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static boolean m14568(String str, String str2, IOCase iOCase) {
        ?? r16;
        String[] strArr;
        boolean z;
        boolean z2 = true;
        ...
        if (str != null && str2 != null) {
            ...
            if (str2.indexOf(63) == -1 && str2.indexOf(42) == -1) {
                ...
                strArr = (String[]) arrayList.toArray(f25228);
            }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static String m14569(String str) {
        int i;
        if (str == null) {
            return null;
        }
        ...
        if (c == '\\') {
            ...
            int iLastIndexOf2 = str.lastIndexOf(f25226);
            if (iLastIndexOf == -1) {
            ...
            if (str.indexOf(58, i) != -1) {
                C5919.m11249("NTFS ADS separator (':') in file name is forbidden.");
                return null;
            }
        }
