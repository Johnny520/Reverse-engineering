...
public final class C6433 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        boolean zContains = editable.toString().contains(AbstractC3056.m6668(-3937560690605426087L));
        DialogC6300 dialogC6300 = this.f17629;
        if (zContains && !editable.toString().equals(AbstractC3056.m6668(-3937561979095614887L))) {
            AbstractC3065.m6825(this.f17628, this.f17630.getText().toString().replace(AbstractC3056.m6668(-3937560690605426087L), AbstractC3056.m6668(-3937561979095614887L)));
            dialogC6300.dismiss();
        } else {
            this.f17627.setText(AbstractC3056.m6668(-3937590175555913127L));
            String strM6668 = AbstractC3056.m6668(-3937620991946261927L);
