...
public class C6957 implements InterfaceC4722, InterfaceC7972, InterfaceC8051, InterfaceC8063, InterfaceC8400, InterfaceC4360, InterfaceC3756, InterfaceC8390, InterfaceC5794, InterfaceC0335 {
    ...
    public static C8737 m12232(File file) {
        ?? arrayList;
        AbstractC3056.m6668(-3937817533944694183L);
        File file2 = new File(file, AbstractC3056.m6668(-3937817787347764647L));
        if (!file2.exists()) {
        ...
        try {
            ...
            try {
                ...
                String strOptString = jSONObject.optString(AbstractC3056.m6668(-3937597717518484903L), file.getName());
                AbstractC3056.m6668(-3937817516764824999L);
                strOptString.getClass();
                JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(AbstractC3056.m6668(-3937630114456798631L));
                ...
                ?? r7 = arrayList;
                String strOptString2 = jSONObject.optString(AbstractC3056.m6668(-3937808076426708391L), AbstractC3056.m6668(-3937561979095614887L));
                AbstractC3056.m6668(-3937817516764824999L);
                strOptString2.getClass();
                String strOptString3 = jSONObject.optString(AbstractC3056.m6668(-3937630200356144551L), AbstractC3056.m6668(-3937561979095614887L));
                AbstractC3056.m6668(-3937817516764824999L);
                strOptString3.getClass();
                int iOptInt = jSONObject.optInt(AbstractC3056.m6668(-3937630092981962151L), 1);
                String strOptString4 = jSONObject.optString(AbstractC3056.m6668(-3937817443750380967L), AbstractC3056.m6668(-3937561979095614887L));
                AbstractC3056.m6668(-3937817516764824999L);
    ...
    public static List m12233(File file) {
        ...
        if (fileArrListFiles != null) {
            ...
            for (File file2 : fileArrListFiles) {
                if (file2.isFile() && !AbstractC4394.m8917(file2.getName(), AbstractC3056.m6668(-3937817787347764647L))) {
                    String name = file2.getName();
                    AbstractC3056.m6668(-3937741817966232999L);
                    name.getClass();
                    if (!name.endsWith(AbstractC3056.m6668(-3937589758944085415L))) {
                        arrayList.add(file2);
                    }
                }
            }
            ...
            for (Object obj : arrayList) {
                ...
                if (set.contains(lowerCase)) {
                    ...
                    try {
                        zM10125 = AbstractC5138.m10125(AbstractC8174.m13614(file3.getAbsolutePath()), AbstractC3056.m6668(-3937562159484241319L), false);
                    } catch (Exception unused) {
                        zM10125 = false;
                    }
                }
    ...
    public static void m12234(File file, C8737 c8737) throws JSONException, IOException {
        AbstractC3056.m6668(-3937817533944694183L);
        file.getClass();
        AbstractC3056.m6668(-3937817332081231271L);
        JSONObject jSONObject = new JSONObject();
        jSONObject.put(AbstractC3056.m6668(-3937597717518484903L), c8737.f24637);
        jSONObject.put(AbstractC3056.m6668(-3937630114456798631L), new JSONArray((Collection) c8737.f24636));
        jSONObject.put(AbstractC3056.m6668(-3937808076426708391L), c8737.f24635);
        jSONObject.put(AbstractC3056.m6668(-3937630200356144551L), c8737.f24634);
        jSONObject.put(AbstractC3056.m6668(-3937630092981962151L), c8737.f24633);
        jSONObject.put(AbstractC3056.m6668(-3937817443750380967L), c8737.f24632);
        File file2 = new File(file, AbstractC3056.m6668(-3937817787347764647L));
    ...
    */
    ...
    public void onFailure(InterfaceC5777 interfaceC5777, Throwable th) {
        ...
        String strM6668 = AbstractC3056.m6668(-3937707166170088871L);
    ...
    public void m12237() {
        ...
        c8207.f22615 = AbstractC3056.m6668(-3937327104514065831L);
        c8207.mo13704();
