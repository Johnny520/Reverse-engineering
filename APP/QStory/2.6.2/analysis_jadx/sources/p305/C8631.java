...
public class C8631 implements InterfaceC4360, InterfaceC1982, InterfaceC1972, InterfaceC2440, InterfaceC7972, InterfaceC3022, InterfaceC6089, InterfaceC6315, InterfaceC6294, InterfaceC4722 {
    ...
    public void mo1469(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        while (true) {
            ...
            if ((childAt instanceof TextView) && ((TextView) childAt).getText().toString().equals(AbstractC3056.m6668(-3937580168282113447L))) {
                i2 = i;
            }
            if (childAt instanceof LinearLayout) {
                ...
                if (childAt2 instanceof RelativeLayout) {
                    ...
                    if ((childAt3 instanceof TextView) && ((TextView) childAt3).getText().toString().equals(AbstractC3056.m6668(-3937580155397211559L))) {
                        break;
                    }
                } else {
                    continue;
    ...
    public boolean mo8287(Method method) {
        ...
        switch (i) {
            case 26:
                if (method.getReturnType() != cls || method.getParameterTypes().length != 1 || !method.getParameterTypes()[0].equals(AbstractC6318.m11838(AbstractC3056.m6668(-3937553702693635495L)))) {
                }
                break;
            default:
                if (method.getReturnType() != cls || method.getParameterTypes().length != 1 || !method.getParameterTypes()[0].equals(AbstractC6318.m11838(AbstractC3056.m6668(-3937553702693635495L)))) {
