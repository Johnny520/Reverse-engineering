...
public final class C8604 {

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public static final int[] f24074;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public static final int f24075;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public int f24078;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public boolean f24079;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public int f24076 = 18;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public int f24077 = 37;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public long[] f24080 = new long[37];

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public int[] f24081 = new int[37];
    ...
    static {
        ...
        f24074 = iArr;
        Arrays.sort(iArr);
        f24075 = iArr[iArr.length - 1];
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("{");
        long[] jArr = this.f24080;
        int[] iArr = this.f24081;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final int m14212(int i, long j) {
        int i2;
        ...
        int i4 = this.f24078 + 1;
        this.f24078 = i4;
        int i5 = this.f24076;
        if (i4 <= i5 && this.f24077 != 0) {
            return i;
        }
        int length3 = this.f24080.length;
        if (i4 > i5) {
            int i6 = length3 << 1;
            int i7 = f24075;
            if (i6 >= i7) {
        ...
        long[] jArr3 = this.f24080;
        int length4 = jArr3.length;
        int[] iArr3 = this.f24081;
        this.f24080 = new long[length3];
        this.f24081 = new int[length3];
        while (true) {
            int i8 = length4 - 1;
            if (length4 <= 0) {
                int length5 = this.f24080.length;
                this.f24076 = Math.min(length5 - 1, (int) (length5 * 0.5f));
                this.f24077 = length5 - this.f24078;
                return i;
            }
            long j4 = jArr3[i8];
            if (j4 != 0) {
                this.f24081[m14214(j4)] = iArr3[i8];
            }
            length4 = i8;
        }
    }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final void m14213(int i, long j) {
        int i2;
        int i3 = ((int) ((j >>> 32) ^ j)) & Integer.MAX_VALUE;
        long[] jArr = this.f24080;
        int length = i3 % jArr.length;
        ...
        int i6 = this.f24078 + 1;
        this.f24078 = i6;
        int i7 = this.f24076;
        if (i6 <= i7 && this.f24077 != 0) {
            return;
        }
        int length3 = this.f24080.length;
        if (i6 > i7) {
        ...
        while (true) {
            ...
            if (length4 <= 0) {
                ...
                long j4 = jArr3[i10];
                if (j4 != 0) {
                    this.f24081[m14214(j4)] = iArr2[i10];
                }
                length4 = i10;
            }
        }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final int m14214(long j) {
        ...
        C5919.m11250("No free or removed slots available. Key set full?!!");
        return 0;
    }
}
