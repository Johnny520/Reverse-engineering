...
public class C8240 extends DialogInterfaceOnCancelListenerC2343 {

    /* JADX INFO: renamed from: 飘花落叶言子哲世楪苏兰, reason: contains not printable characters */
    public WeakReference f22777 = null;
    ...
    public final void mo4438() {
        Window window;
        super.mo4438();
        Activity activity = (Activity) this.f22777.get();
        ...
        attributes.format = -2;
        this.f22778.setOnTouchListener(new ViewOnTouchListenerC8241(this, activity));
