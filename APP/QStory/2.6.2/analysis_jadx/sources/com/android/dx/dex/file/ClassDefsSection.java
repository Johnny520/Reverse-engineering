...
public final class ClassDefsSection extends UniformItemSection {
    ...
    private int orderItems0(Type type, int i, int i2) {
        ...
        if (i2 < 0) {
            C3682.m7938(type, "class circularity with ");
            return 0;
        }
        int i3 = i2 - 1;
    ...
    public void add(ClassDefItem classDefItem) {
        try {
            ...
            if (this.classDefs.get(classType) == null) {
                ...
                C4210.m8614(classType, "already added: ");
            }
        } catch (NullPointerException unused) {
            C2632.m5298("clazz == null");
        }
    }
    ...
    public void writeHeaderPart(AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            AbstractC2442.m4552(fileOffset, new StringBuilder("class_defs_off:  "), annotatedOutput, 4);
        }
