...
public final class ValueEncoder {
    ...
    public ValueEncoder(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        if (dexFile == null) {
            C2632.m5298("file == null");
            throw null;
        }
        if (annotatedOutput == null) {
            C2632.m5298("out == null");
            throw null;
        }
        this.file = dexFile;
    ...
    public void writeConstant(Constant constant) {
        ...
        if (iConstantToValueType != 0 && iConstantToValueType != 6 && iConstantToValueType != 2) {
            if (iConstantToValueType == 3) {
                AbstractC3054.m6575(this.out, iConstantToValueType, ((CstLiteralBits) constant).getLongBits());
                return;
            }
            if (iConstantToValueType != 4) {
                if (iConstantToValueType == 16) {
                    AbstractC3054.m6573(this.out, iConstantToValueType, ((CstFloat) constant).getLongBits() << 32);
                    return;
                }
                if (iConstantToValueType == 17) {
                    AbstractC3054.m6573(this.out, iConstantToValueType, ((CstDouble) constant).getLongBits());
                    return;
                }
                switch (iConstantToValueType) {
                    case 21:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getProtoIds().indexOf(((CstProtoRef) constant).getPrototype()));
                        break;
                    case 22:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getMethodHandles().indexOf((CstMethodHandle) constant));
                        break;
                    case 23:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getStringIds().indexOf((CstString) constant));
                        break;
                    case 24:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getTypeIds().indexOf((CstType) constant));
                        break;
                    case 25:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getFieldIds().indexOf((CstFieldRef) constant));
                        break;
                    case 26:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getMethodIds().indexOf((CstMethodRef) constant));
                        break;
                    case 27:
                        AbstractC3054.m6575(this.out, iConstantToValueType, this.file.getFieldIds().indexOf(((CstEnumRef) constant).getFieldRef()));
                        break;
                    case 28:
        ...
        AbstractC3054.m6576(this.out, iConstantToValueType, ((CstLiteralBits) constant).getLongBits());
    }
