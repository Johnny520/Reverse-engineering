...
public class Main {
    ...
    private void dumpMethod(DexFile dexFile, String str, OutputStreamWriter outputStreamWriter) {
        ...
        if (zEndsWith) {
            strSubstring = AbstractC0053.m160(1, 0, strSubstring);
        }
    ...
    private byte[] mergeIncremental(byte[] bArr, File file) throws IOException {
        C8566 c8566 = bArr != null ? new C8566(bArr) : null;
        C8566 c85662 = file.exists() ? new C8566(file) : null;
        if (c8566 == null && c85662 == null) {
            return null;
        }
        if (c8566 == null) {
            c8566 = c85662;
        } else if (c85662 != null) {
            c8566 = new DexMerger(new C8566[]{c8566, c85662}, CollisionPolicy.KEEP_FIRST, this.context).merge();
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        c8566.m14117(byteArrayOutputStream);
    ...
    private byte[] mergeLibraryDexBuffers(byte[] bArr) {
        ...
        if (bArr != null) {
            arrayList.add(new C8566(bArr));
        }
        Iterator<byte[]> it = this.libraryDexBuffers.iterator();
        while (it.hasNext()) {
            arrayList.add(new C8566(it.next()));
        }
        if (arrayList.isEmpty()) {
            return null;
        }
        ByteBuffer byteBufferDuplicate = new DexMerger((C8566[]) arrayList.toArray(new C8566[arrayList.size()]), CollisionPolicy.FAIL, this.context).merge().f23899.duplicate();
    ...
    private boolean processAllFiles() {
        ...
        try {
            ...
            C0276.m847("Translation has been interrupted", e2);
            return false;
        } catch (Exception e3) {
            this.classTranslatorPool.shutdownNow();
            this.classDefItemConsumer.shutdownNow();
            e3.printStackTrace(this.context.out);
            C0276.m847("Unexpected exception in translator thread.", e3);
            return false;
        }
    }
    ...
    private boolean processClass(String str, byte[] bArr) {
        ...
        try {
            ...
            C0276.m847("Exception parsing classes", e2);
            return false;
        }
    }
    ...
    private int runMultiDex() throws Throwable {
        ...
        try {
            ...
            C2632.m5294("A dex writer thread has been interrupted.");
            return 0;
        } catch (Exception unused2) {
            this.dexOutPool.shutdownNow();
            C2632.m5294("Unexpected exception in dex writer thread");
            return 0;
        }
    }
