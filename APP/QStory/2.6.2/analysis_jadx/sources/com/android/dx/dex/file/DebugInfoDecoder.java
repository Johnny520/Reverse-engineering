...
public class DebugInfoDecoder {
    ...
    private void decode0() {
        C8381 c8381 = new C8381(this.encoded);
        this.line = AbstractC3065.m6852(c8381);
        int iM6852 = AbstractC3065.m6852(c8381);
        StdTypeList parameterTypes = this.desc.getParameterTypes();
        int paramBase = getParamBase();
        if (iM6852 != parameterTypes.size()) {
            C2632.m5294("Mismatch between parameters_size and prototype");
            return;
        }
        if (!this.isStatic) {
        ...
        for (int i = 0; i < iM6852; i++) {
            ...
            int stringIndex = readStringIndex(c8381);
        ...
        while (true) {
            int i2 = c8381.readByte() & DefaultClassResolver.NAME;
            switch (i2) {
                case 0:
                    return;
                case 1:
                    this.address = AbstractC3065.m6852(c8381) + this.address;
                    break;
                case 2:
                    this.line = AbstractC3065.m6856(c8381) + this.line;
                    break;
                case 3:
                    int iM68522 = AbstractC3065.m6852(c8381);
                    LocalEntry localEntry3 = new LocalEntry(this.address, true, iM68522, readStringIndex(c8381), readStringIndex(c8381), 0);
                    this.locals.add(localEntry3);
                    this.lastEntryForReg[iM68522] = localEntry3;
                    break;
                case 4:
                    int iM68523 = AbstractC3065.m6852(c8381);
                    LocalEntry localEntry4 = new LocalEntry(this.address, true, iM68523, readStringIndex(c8381), readStringIndex(c8381), readStringIndex(c8381));
                    this.locals.add(localEntry4);
                    this.lastEntryForReg[iM68523] = localEntry4;
                    break;
                case 5:
                    int iM68524 = AbstractC3065.m6852(c8381);
                    try {
                        LocalEntry localEntry5 = this.lastEntryForReg[iM68524];
                        if (!localEntry5.isStart) {
                            throw new RuntimeException("nonsensical END_LOCAL on dead register v" + iM68524);
                        }
                        LocalEntry localEntry6 = new LocalEntry(this.address, false, iM68524, localEntry5.nameIndex, localEntry5.typeIndex, localEntry5.signatureIndex);
                        this.locals.add(localEntry6);
                        this.lastEntryForReg[iM68524] = localEntry6;
                    } catch (NullPointerException unused) {
                        C2632.m5294(AbstractC6136.m11556(iM68524, "Encountered END_LOCAL on new v"));
                        return;
                    }
                    break;
                case 6:
                    int iM68525 = AbstractC3065.m6852(c8381);
                    try {
                        LocalEntry localEntry7 = this.lastEntryForReg[iM68525];
                        if (localEntry7.isStart) {
                            throw new RuntimeException("nonsensical RESTART_LOCAL on live register v" + iM68525);
                        }
                        LocalEntry localEntry8 = new LocalEntry(this.address, true, iM68525, localEntry7.nameIndex, localEntry7.typeIndex, 0);
                        this.locals.add(localEntry8);
                        this.lastEntryForReg[iM68525] = localEntry8;
                    } catch (NullPointerException unused2) {
                        C2632.m5294(AbstractC6136.m11556(iM68525, "Encountered RESTART_LOCAL on new v"));
                        return;
                    }
                    break;
                case 7:
                ...
                default:
                    if (i2 < 10) {
                        C2632.m5294(AbstractC6136.m11556(i2, "Invalid extended opcode encountered "));
                        return;
                    }
    ...
    private int readStringIndex(InterfaceC8385 interfaceC8385) {
        return AbstractC3065.m6852(interfaceC8385) - 1;
    }
    ...
    private static void validateEncode0(byte[] bArr, int i, int i2, boolean z, CstMethodRef cstMethodRef, DexFile dexFile, PositionList positionList, LocalList localList) {
        ...
        if (positionList2.size() != positionList.size()) {
            C2941.m6347("Decoded positions table not same size was ", positionList2.size(), " expected ", positionList.size());
            return;
        }
        for (PositionEntry positionEntry : positionList2) {
            ...
            C2941.m6347("Could not match position entry: ", positionEntry.address, ", ", positionEntry.line);
            return;
        }
        ...
        for (int i8 = 0; i8 < size3; i8++) {
            ...
            if (entry2.getDisposition() != LocalList.Disposition.END_REPLACED) {
                ...
                C2632.m5294("local table problem");
                return;
            }
        }
    }
