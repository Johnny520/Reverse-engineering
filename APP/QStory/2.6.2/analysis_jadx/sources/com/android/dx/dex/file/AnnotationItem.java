...
public final class AnnotationItem extends OffsettedItem {
    ...
    public void annotateTo(AnnotatedOutput annotatedOutput, String str) {
        StringBuilder sbM11553 = AbstractC6136.m11553(str, "visibility: ");
        sbM11553.append(this.annotation.getVisibility().toHuman());
        annotatedOutput.annotate(0, sbM11553.toString());
        ...
        for (NameValuePair nameValuePair : this.annotation.getNameValuePairs()) {
            ...
            sbM149.append(name.toHuman());
            sbM149.append(": ");
            sbM149.append(ValueEncoder.constantToHuman(value));
            annotatedOutput.annotate(0, sbM149.toString());
        }
    }
