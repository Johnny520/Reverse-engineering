...
public class StdAttributeFactory extends AttributeFactory {
    ...
    private Attribute bootstrapMethods(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("num_boostrap_methods: "), unsignedShort));
        }
    ...
    private Attribute code(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("max_stack: "), unsignedShort));
            parseObserver.parsed(bytes, i3, 2, AbstractC2442.m4550(new StringBuilder("max_locals: "), unsignedShort2));
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i8, 2, AbstractC2442.m4550(new StringBuilder("exception_table_length: "), unsignedShort3));
        }
        int i10 = i8 + 2;
        int i11 = i9 - 2;
    ...
    private Attribute exceptions(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("number_of_exceptions: "), unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute innerClasses(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("number_of_classes: "), unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute lineNumberTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("line_number_table_length: "), unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute localVariableTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("local_variable_table_length: "), unsignedShort));
        }
    ...
    private Attribute localVariableTypeTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC2442.m4550(new StringBuilder("local_variable_type_table_length: "), unsignedShort));
        }
    ...
    private BootstrapMethodsList parseBootstrapMethods(ByteArray byteArray, ConstantPool constantPool, CstType cstType, int i, int i2, int i3, ParseObserver parseObserver) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(byteArray, i4, 2, AbstractC2442.m4550(new StringBuilder("bootstrap_method_ref: "), unsignedShort));
                parseObserver.parsed(byteArray, i7, 2, AbstractC2442.m4550(new StringBuilder("num_bootstrap_arguments: "), unsignedShort2));
            }
            i4 += 4;
            i5 -= 4;
            ...
            while (i8 < unsignedShort2) {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i4, 2, AbstractC2442.m4550(AbstractC0053.m148(i8, "bootstrap_arguments[", "]"), unsignedShort3));
                }
    ...
    private LocalVariableList parseLocalVariables(ByteArray byteArray, ConstantPool constantPool, ParseObserver parseObserver, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            try {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i3 * 10, 10, Hex.u2(unsignedShort) + ".." + Hex.u2(unsignedShort + unsignedShort2) + " " + Hex.u2(unsignedShort5) + " " + cstString3.toHuman() + " " + cstString4.toHuman());
                }
            } catch (IOException e) {
                C0276.m847("shouldn't happen", e);
                return null;
            }
        }
    ...
    private Attribute sourceDebugExtension(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(byteArraySlice, i, i2, AbstractC0053.m152("sourceDebugExtension: ", cstString.getString()));
        }
