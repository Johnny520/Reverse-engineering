...
public final class ConstantPoolParser {
            ...
            switch (unsignedByte) {
                ...
                case 18:
                    try {
                        ...
                        e.addContext("...while preparsing cst " + Hex.u2(i2) + " at offset " + Hex.u4(unsignedShort));
                        throw e;
                    }
                    break;
                case 5:
    ...
    private static int getMethodHandleTypeForKind(int i) {
        switch (i) {
            ...
            case 9:
                return 8;
            default:
                C5919.m11249(AbstractC6136.m11556(i, "invalid kind: "));
                return 0;
        }
    }
    ...
    private void parse() {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(this.bytes, 8, 2, AbstractC2442.m4550(new StringBuilder("constant_pool_count: "), this.offsets.length));
