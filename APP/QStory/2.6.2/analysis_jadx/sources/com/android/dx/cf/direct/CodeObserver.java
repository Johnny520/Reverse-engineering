...
public class CodeObserver implements BytecodeArray.Visitor {
    ...
    private String header(int i) {
        ...
        if (unsignedByte == 196) {
            ...
            StringBuilder sbM11553 = AbstractC6136.m11553(strOpName, " ");
            sbM11553.append(ByteOps.opName(unsignedByte2));
            strOpName = sbM11553.toString();
        }
    ...
    public void visitConstant(int i, int i2, int i3, Constant constant, int i4) {
        ...
        if (i4 == 0) {
            ...
            strM4550 = AbstractC2442.m4550(new StringBuilder(", "), i4);
        }
        this.observer.parsed(this.bytes, i2, i3, header(i2) + " " + constant + strM4550);
    }
