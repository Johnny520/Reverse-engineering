...
final class ConfigLong extends ConfigNumber implements Serializable {
    ...
    public ConfigLong(InterfaceC8160 interfaceC8160, long j, String str) {
    ...
    public ConfigLong newCopy(InterfaceC8160 interfaceC8160) {
        return new ConfigLong(interfaceC8160, this.value, this.originalText);
    }
