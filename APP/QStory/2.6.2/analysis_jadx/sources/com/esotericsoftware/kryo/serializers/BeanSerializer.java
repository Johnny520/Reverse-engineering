    ...
    public T copy(Kryo kryo, T t) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                ...
                C3073.m6908(sb, t2.getClass().getName(), e2);
                return null;
            } catch (Throwable th) {
