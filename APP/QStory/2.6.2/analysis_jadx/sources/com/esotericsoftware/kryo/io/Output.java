...
public class Output extends OutputStream implements AutoCloseable, Pool.Poolable {
    ...
    public Output(int i, int i2) {
        ...
        if (i > i2 && i2 != -1) {
            C5919.m11249(AbstractC6136.m11559(i, i2, "bufferSize: ", " cannot be greater than maxBufferSize: "));
            throw null;
        }
        if (i2 < -1) {
    ...
    public boolean require(int i) {
        ...
        if (i > i5 - i4) {
            ...
            if (i > i5) {
                throw new KryoBufferOverflowException(AbstractC6136.m11559(i6, i, "Buffer overflow. Max capacity: ", ", required: "));
            }
    ...
    public void writeLong(long j, int i) {
        if (i < 0 || i > 8) {
            C5919.m11249(AbstractC6136.m11556(i, "count must be >= 0 and <= 8: "));
        } else {
            if (i <= 4) {
                writeInt((int) j, i);
                return;
