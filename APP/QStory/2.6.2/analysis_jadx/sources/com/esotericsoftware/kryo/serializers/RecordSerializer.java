...
public class RecordSerializer<T> extends ImmutableSerializer<T> {
    ...
    static {
        ...
        CONSTRUCTOR = new ClassValue<Constructor<?>>() { // from class: com.esotericsoftware.kryo.serializers.RecordSerializer.1
            ...
            public Constructor<?> computeValue2(Class<?> cls2) {
                return RecordSerializer.getCanonicalConstructor(cls2, RecordSerializer.recordComponents(cls2, Comparator.comparing(new C3072(1))));
            }
        ...
        RECORD_COMPONENTS = new ClassValue<RecordComponent[]>() { // from class: com.esotericsoftware.kryo.serializers.RecordSerializer.2
            ...
            public RecordComponent[] computeValue2(Class<?> cls2) {
                return RecordSerializer.recordComponents(cls2, Comparator.comparing(new C3072(2)));
            }
    ...
    public static <T> Constructor<T> getCanonicalConstructor(Class<T> cls, RecordComponent[] recordComponentArr) {
        try {
            return getCanonicalConstructor(cls, (Class<?>[]) Arrays.stream(recordComponentArr).map(new C3072(0)).toArray(new C3071()));
        } catch (Throwable th) {
    ...
    public T read(Kryo kryo, Input input, Class<? extends T> cls) {
        ...
        for (RecordComponent recordComponent : recordComponentArr) {
            ...
            try {
                ...
                StringBuilder sbM11553 = AbstractC6136.m11553(strName, " (");
                sbM11553.append(cls.getName());
                sbM11553.append(")");
                e.addTrace(sbM11553.toString());
                throw e;
            } catch (Throwable th) {
                KryoException kryoException = new KryoException(th);
                StringBuilder sbM115532 = AbstractC6136.m11553(strName, " (");
                sbM115532.append(cls.getName());
                sbM115532.append(")");
                kryoException.addTrace(sbM115532.toString());
                throw kryoException;
            }
        }
    ...
    public void write(Kryo kryo, Output output, T t) {
        for (RecordComponent recordComponent : (RecordComponent[]) RECORD_COMPONENTS.get(t.getClass())) {
            ...
            try {
                ...
                StringBuilder sbM11553 = AbstractC6136.m11553(strName, " (");
                sbM11553.append(clsType.getName());
                sbM11553.append(")");
                e.addTrace(sbM11553.toString());
                throw e;
            } catch (Throwable th) {
                KryoException kryoException = new KryoException(th);
                StringBuilder sbM115532 = AbstractC6136.m11553(strName, " (");
                sbM115532.append(clsType.getName());
                sbM115532.append(")");
                kryoException.addTrace(sbM115532.toString());
                throw kryoException;
            }
