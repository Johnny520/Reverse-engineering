...
public final class C2808 extends JSONSchema {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final JSONSchema[] f8717;

    public C2808(JSONObject jSONObject, JSONSchema jSONSchema) {
        super(jSONObject);
        JSONArray jSONArray = jSONObject.getJSONArray("oneOf");
        if (jSONArray == null || jSONArray.isEmpty()) {
            C0276.m849("oneOf not found");
            throw null;
        }
        this.f8717 = new JSONSchema[jSONArray.size()];
        for (int i = 0; i < this.f8717.length; i++) {
            Object obj = jSONArray.get(i);
            boolean z = obj instanceof Boolean;
            JSONSchema[] jSONSchemaArr = this.f8717;
            if (z) {
    ...
    public final C0748 mo5603(Object obj) {
        ...
        while (true) {
            if (i < length) {
                if (jSONSchemaArr[i].mo5603(obj).f2155 && (i2 = i2 + 1) > 1) {
                    break;
                }
                i++;
            } else if (i2 == 1) {
    ...
    public C2808(JSONSchema[] jSONSchemaArr) {
