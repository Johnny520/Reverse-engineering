...
public final class C2888 extends AbstractC2879 {

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public final JSONPathFilter$Operator f9126;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰, reason: contains not printable characters */
    public final long f9127;

    public C2888(String str, long j, String[] strArr, long[] jArr, Function function, JSONPathFilter$Operator jSONPathFilter$Operator, long j2) {
        super(str, j, strArr, jArr, function);
        this.f9126 = jSONPathFilter$Operator;
        this.f9127 = j2;
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("[?(");
        Object obj = this.f9105;
        if (obj == null) {
            obj = "@";
        }
        sb.append(obj);
        sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        sb.append(this.f9107);
        sb.append(' ');
        sb.append(this.f9126);
        sb.append(' ');
        sb.append(this.f9127);
        sb.append(")]");
        return sb.toString();
    }
    ...
    public final boolean mo5911() {
        return this.f9126 == JSONPathFilter$Operator.NE;
    }
    ...
    public final boolean mo5912(Object obj) {
        ...
        JSONPathFilter$Operator jSONPathFilter$Operator = this.f9126;
        long j = this.f9127;
