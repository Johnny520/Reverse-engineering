...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final ByteString EMPTY = new LiteralByteString(AbstractC3401.f11052);
    static final int MAX_READ_FROM_CHUNK_SIZE = 8192;
    static final int MIN_READ_FROM_CHUNK_SIZE = 256;
    private static final int UNSIGNED_BYTE_MASK = 255;
    private static final Comparator<ByteString> UNSIGNED_LEXICOGRAPHICAL_COMPARATOR;
    private static final InterfaceC3471 byteArrayCopier;
    private static final long serialVersionUID = 1;
    private int hash = 0;

    static {
        byteArrayCopier = AbstractC3546.m7799() ? new C3472(1) : new C3472(0);
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new C3536(0);
    }

    private static ByteString balancedConcat(Iterator<ByteString> it, int i) {
        if (i < 1) {
            Locale locale = Locale.ROOT;
            C5919.m11249(AbstractC0053.m161(i, "length (", ") must be >= 1"));
            return null;
        }
        if (i == 1) {
            return it.next();
    ...
    public static void checkIndex(int i, int i2) {
        if (((i2 - (i + 1)) | i) < 0) {
            if (i >= 0) {
                throw new ArrayIndexOutOfBoundsException(AbstractC6136.m11559(i, i2, "Index > length: ", ", "));
            }
            throw new ArrayIndexOutOfBoundsException(AbstractC6136.m11556(i, "Index < 0: "));
        }
    }
    ...
    public static int checkRange(int i, int i2, int i3) {
        ...
        if (i < 0) {
            C7546.m12743(AbstractC0053.m161(i, "Beginning index: ", " < 0"));
            return 0;
        }
        if (i2 < i) {
            C7546.m12743(AbstractC6136.m11559(i, i2, "Beginning index larger than ending index: ", ", "));
            return 0;
        }
        C7546.m12743(AbstractC6136.m11559(i2, i3, "End index: ", " >= "));
        return 0;
    }
    ...
    public static ByteString copyFromUtf8(String str) {
        return str.isEmpty() ? EMPTY : new LiteralByteString(str.getBytes(AbstractC3401.f11054));
    }
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder sbM11550 = AbstractC6136.m11550("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
        sbM11550.append(str.charAt(i));
        sbM11550.append(" at index ");
        sbM11550.append(i);
        throw new NumberFormatException(sbM11550.toString());
    }

    public static ByteString fromHex(String str) {
        if (str.length() % 2 != 0) {
            StringBuilder sbM11550 = AbstractC6136.m11550("Invalid hexString ", str, " of length ");
            sbM11550.append(str.length());
            sbM11550.append(" must be even.");
            throw new NumberFormatException(sbM11550.toString());
        }
    ...
    public static C3469 newCodedBuilder(int i) {
        return new C3469(i);
    }

    public static C3468 newOutput() {
        return new C3468(128);
    }
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? AbstractC3412.m7527(toByteArray()) : AbstractC3412.m7527(substring(0, 47).toByteArray()).concat("...");
    }
    ...
    public static ByteString wrap(ByteBuffer byteBuffer, boolean z) throws InvalidProtocolBufferException {
        ...
        if (z) {
            ...
            if (byteBuffer.hasArray()) {
                ...
                zM7539 = abstractC3412.mo7545(iPosition + iArrayOffset, byteBuffer.array(), iArrayOffset + iRemaining);
            } else if (byteBuffer.isDirect()) {
                zM7539 = abstractC3412.mo7544(byteBuffer, iPosition, iRemaining);
            } else {
                abstractC3412.getClass();
                zM7539 = AbstractC3412.m7539(byteBuffer, iPosition, iRemaining);
            }
            if (!zM7539) {
    ...
    public Iterator<Byte> iterator2() {
        return new C3539(this);
    }

    public abstract AbstractC3473 newCodedInput();
    ...
    public final String toString() {
        ...
        sb.append(size);
        sb.append(" contents=\"");
        return AbstractC0053.m146(sb, strTruncateAndEscapeForDisplay, "\">");
    }

    public abstract String toStringInternal(Charset charset);

    public final String toStringUtf8() {
        return toString(AbstractC3401.f11054);
    }

    public abstract void writeTo(AbstractC3538 abstractC3538);
    ...
    public abstract void writeToReverse(AbstractC3538 abstractC3538);

    /* JADX INFO: compiled from: r8-map-id-cb39a6809a634dd4ad3d163e22b2e3b526599fa3253f8854b17de2b335a1a776 */
    public static abstract class LeafByteString extends ByteString {
        private static final long serialVersionUID = 1;

        public /* synthetic */ LeafByteString(C3539 c3539) {
            this();
        }
    ...
    public static C3468 newOutput(int i) {
        return new C3468(i);
    }
    ...
    public static final class BoundedByteString extends LeafByteString {
        ...
        public boolean equalsRange(ByteString byteString, int i, int i2) {
            ...
            if (i3 > byteString.size()) {
                C7546.m12747(AbstractC0053.m151(i, i2, "Ran off end of other: ", ", ", ", "), byteString.size());
                return false;
            }
        ...
        public boolean isValidUtf8() {
            ...
            int i = this.offset;
            return AbstractC3723.f11538.mo7545(i, bArr, this.length + i);
        }

        @Override // com.google.protobuf.ByteString
        public AbstractC3473 newCodedInput() {
            return AbstractC3473.m7707(this.bytes, this.offset, this.length, true);
        }
        ...
        public int partialHash(int i, int i2, int i3) {
            return AbstractC3401.m7514(i, this.bytes, this.offset + i2, i3);
        }
        ...
        public void writeTo(AbstractC3538 abstractC3538) {
            abstractC3538.mo7699(this.offset, this.bytes, this.length);
        }
    ...
    public static final class LiteralByteString extends LeafByteString {
        ...
        public boolean isValidUtf8() {
            byte[] bArr = this.bytes;
            return AbstractC3723.f11538.mo7545(0, bArr, bArr.length);
        }

        @Override // com.google.protobuf.ByteString
        public AbstractC3473 newCodedInput() {
            return AbstractC3473.m7707(this.bytes, 0, size(), true);
        }
        ...
        @Override // com.google.protobuf.ByteString
        public int partialHash(int i, int i2, int i3) {
            return AbstractC3401.m7514(i, this.bytes, i2, i3);
        }
        ...
        @Override // com.google.protobuf.ByteString
        public void writeTo(AbstractC3538 abstractC3538) {
            abstractC3538.mo7699(0, this.bytes, size());
        }
    ...
    public static ByteString copyFrom(byte[] bArr, int i, int i2, boolean z) throws InvalidProtocolBufferException {
        ...
        if (z && !AbstractC3723.f11538.mo7545(i, bArr, i3)) {
            throw InvalidProtocolBufferException.invalidUtf8();
        }
        return new LiteralByteString(byteArrayCopier.mo7702(i, bArr, i2));
    }
    ...
    public static ByteString wrap(byte[] bArr, int i, int i2, boolean z) throws InvalidProtocolBufferException {
        if (z) {
            if (!AbstractC3723.f11538.mo7545(i, bArr, i + i2)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
        }
    ...
    public static ByteString wrap(byte[] bArr, boolean z) throws InvalidProtocolBufferException {
        ...
        if (z && !AbstractC3723.f11538.mo7545(0, bArr, bArr.length)) {
            throw InvalidProtocolBufferException.invalidUtf8();
        }
        return new LiteralByteString(bArr);
    }
