...
public abstract class AbstractC3161 extends ViewGroup {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i6 < getChildCount()) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.f10519 && measuredWidth2 > i9) {
                    measuredWidth2 = childAt.getMeasuredWidth() + paddingRight + marginStart;
                    i7 = paddingTop + this.f10520;
                    this.f10517++;
                    measuredWidth = paddingRight;
                }
                childAt.setTag(R.id.row_index_key, Integer.valueOf(this.f10517 - 1));
                ...
                measuredWidth += childAt.getMeasuredWidth() + marginStart + marginEnd + this.f10518;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i10 = i4;
                if (childAt.getMeasuredWidth() + paddingLeft + i5 > paddingRight && !((AbstractC8615) this).f10519) {
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i5 + i10 + this.f10518 + paddingLeft;
