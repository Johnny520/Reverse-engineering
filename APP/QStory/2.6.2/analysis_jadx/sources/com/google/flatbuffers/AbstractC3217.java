...
public abstract class AbstractC3217 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final C3219 f10846 = C3219.m7320();
    ...
    public ByteBuffer f10849;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public int f10850;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public final int m7298(int i) {
        int i2 = i + this.f10850;
        return this.f10849.getInt(this.f10849.getInt(i2) + i2);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final int m7299(int i) {
        int i2 = i + this.f10850;
        return this.f10849.getInt(i2) + i2 + 4;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final String m7300(int i) {
        ByteBuffer byteBuffer = this.f10849;
        int i2 = byteBuffer.getInt(i) + i;
        int i3 = byteBuffer.getInt(i2);
        int i4 = i2 + 4;
        this.f10846.getClass();
        if (!byteBuffer.hasArray()) {
            ...
            while (i4 < i5) {
                ...
                if (b2 >= 0) {
                    ...
                    i4 += 2;
                    AbstractC3065.m6821(b2, byteBuffer.get(i8), cArr, i7);
                    i7++;
                } else if (b2 < -16) {
                    if (i8 >= i5 - 1) {
                        C5919.m11249("Invalid UTF-8");
                    ...
                    int i10 = i4 + 2;
                    i4 += 3;
                    AbstractC3065.m6820(b2, byteBuffer.get(i8), byteBuffer.get(i10), cArr, i7);
                    i7++;
                } else {
                    if (i8 >= i5 - 2) {
                        C5919.m11249("Invalid UTF-8");
                    ...
                    i4 += 4;
                    AbstractC3065.m6826(b2, b4, b5, byteBuffer.get(i11), cArr, i7);
                    i7 += 2;
                }
            }
        ...
        while (iArrayOffset < i12) {
            ...
            if (b7 >= 0) {
                ...
                iArrayOffset += 2;
                AbstractC3065.m6821(b7, bArrArray[i15], cArr2, i14);
                i14++;
            } else if (b7 < -16) {
                if (i15 >= i12 - 1) {
                    C5919.m11249("Invalid UTF-8");
                ...
                iArrayOffset += 3;
                AbstractC3065.m6820(b7, bArrArray[i15], bArrArray[i17], cArr2, i14);
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                    C5919.m11249("Invalid UTF-8");
                ...
                iArrayOffset += 4;
                AbstractC3065.m6826(b7, b9, b10, bArrArray[i18], cArr2, i14);
                i14 += 2;
            }
        }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final void m7301(ByteBuffer byteBuffer, int i) {
        this.f10849 = byteBuffer;
        if (byteBuffer == null) {
            this.f10850 = 0;
            this.f10848 = 0;
            this.f10847 = 0;
            ...
            this.f10848 = i2;
            this.f10847 = this.f10849.getShort(i2);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final int m7302(int i) {
        if (i < this.f10847) {
            return this.f10849.getShort(this.f10848 + i);
        }
        return 0;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final int m7303(int i) {
        return this.f10849.getInt(i) + i;
    }
}
