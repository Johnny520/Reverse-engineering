...
public final /* data */ class OcrTextLineResult {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4394.m8917(this.points, ocrTextLineResult.points) && AbstractC4394.m8917(this.text, ocrTextLineResult.text) && Float.valueOf(this.confidence).equals(Float.valueOf(ocrTextLineResult.confidence)) && this.orientation == ocrTextLineResult.orientation && AbstractC4394.m8917(this.textList, ocrTextLineResult.textList);
    }
    ...
    public int hashCode() {
        return this.textList.hashCode() + AbstractC0053.m143(this.orientation, AbstractC0053.m144(AbstractC6136.m11539(this.points.hashCode() * 31, 31, this.text), this.confidence, 31), 31);
    }
