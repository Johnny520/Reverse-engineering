...
public final /* data */ class OcrTextResult {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4394.m8917(this.text, ocrTextResult.text) && this.id == ocrTextResult.id && Float.valueOf(this.confidence).equals(Float.valueOf(ocrTextResult.confidence));
    }
    ...
    public int hashCode() {
        return Float.hashCode(this.confidence) + AbstractC0053.m143(this.id, this.text.hashCode() * 31, 31);
    }
