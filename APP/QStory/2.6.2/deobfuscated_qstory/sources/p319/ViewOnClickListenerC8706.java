                ...
                if (string.length() != 0) {
                    ...
                    if (string.equals(str)) {
                        ...
                        if (C8738.m14411().contains(string)) {
                            C8211.m13720(string.concat(" \u6587\u4ef6\u5939\u5df2\u5b58\u5728")).m13724();
                        } else {
                            File file2 = new File(C8738.m14405(), string);
                            if (!file.renameTo(file2)) {
                                C8211.m13720("\u91cd\u547d\u540d\u5931\u8d25").m13724();
                            } else {
                                C8737.f24631.getClass();
                    ...
                    c8239.m13747();
                    C8211.m13720("\u4fdd\u5b58\u6210\u529f").m13723();
                    c8687.invoke();
                } else {
                    C8211.m13720("\u540d\u79f0\u4e0d\u80fd\u4e3a\u7a7a").m13724();
                }
                break;
            default:
                ...
                if (string2.length() != 0) {
                    ...
                    if (!string2.equals(str)) {
                        ...
                        if (C8738.m14411().contains(string2)) {
                            C8211.m13720(string2.concat(" \u6587\u4ef6\u5939\u5df2\u5b58\u5728")).m13724();
                        } else {
                    ...
                    if (file4.exists()) {
                        ...
                        C8211.m13720("\u76ee\u5f55\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u4e0a\u4f20").m13724();
                    }
                    c8687.invoke();
                } else {
                    C8211.m13720("\u540d\u79f0\u4e0d\u80fd\u4e3a\u7a7a\uff0c\u65e0\u6cd5\u4e0a\u4f20").m13724();
                }
                break;
        }
    }
