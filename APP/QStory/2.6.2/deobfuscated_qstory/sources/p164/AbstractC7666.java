...
public abstract class AbstractC7666 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final ThreadLocal f20816 = new ThreadLocal();

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public static int m12944(int i, int i2) {
        if (i2 >= 0 && i2 <= 255) {
            return (i & 16777215) | (i2 << 24);
        }
        C5919.m11249("alpha must be between 0 and 255.");
        return 0;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public static int m12945(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
        return AbstractC0053.m142(Opcodes.CONST_METHOD_TYPE, i2, i3 * i4, (i * Opcodes.CONST_METHOD_TYPE) * i2) / (i5 * Opcodes.CONST_METHOD_TYPE);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static int m12946(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / Opcodes.CONST_METHOD_TYPE);
        return Color.argb(i3, m12945(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m12945(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m12945(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static int m12947(double d, double d2, double d3) {
