...
public final class C0020 implements InterfaceC2380 {
    ...
    public C0020(InterfaceC2389 interfaceC2389) {
        ...
        C2392 c2392 = C2392.f7030;
        Class<?> cls = interfaceC2389.getClass();
        C2394 c2394 = (C2394) c2392.f7032.get(cls);
        this.f45 = c2394 == null ? c2392.m4498(cls, null) : c2394;
    }
        ...
        switch (i) {
            case 0:
                ...
                if (i2 == 1) {
                    ...
                    c0035.m12751();
                    ((AbstractC2402) obj2).mo4492(this);
                    break;
                }
                break;
            case 1:
                InterfaceC2409 interfaceC2409 = (InterfaceC2409) obj;
                switch (AbstractC2413.f7051[lifecycle$Event.ordinal()]) {
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        interfaceC2409.mo3527(interfaceC2388);
                        break;
                    case 4:
                        interfaceC2409.getClass();
                        break;
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        C5919.m11249("ON_ANY must not been send by anybody");
                        break;
                    default:
                        C4210.m8621();
                        break;
            ...
            case 2:
                ...
                break;
            default:
                HashMap map = ((C2394) obj2).f7036;
                C2394.m4499((List) map.get(lifecycle$Event), interfaceC2388, lifecycle$Event, obj);
                C2394.m4499((List) map.get(Lifecycle$Event.ON_ANY), interfaceC2388, lifecycle$Event, obj);
                break;
        }
    }
    ...
    public C0020(AbstractC2402 abstractC2402, C7538 c7538) {
