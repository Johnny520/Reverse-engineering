...
import p160.C7634;
import p162.AbstractC7658;
import p162.C7649;
import p162.C7655;
import p170.AbstractC7721;
import p171.AbstractC7726;
...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements InterfaceC7732, InterfaceC2421, InterfaceC2405, InterfaceC7536, InterfaceC0018, InterfaceC7548, InterfaceC2165 {
    private static final String ACTIVITY_RESULT_TAG = "android:support:activity-result";
    private static final C0059 Companion = new C0059();
    private C2423 _viewModelStore;
    private final AbstractC7728 activityResultRegistry;
    private int contentLayoutId;
    private final C7731 contextAwareHelper;

    /* JADX INFO: renamed from: defaultViewModelProviderFactory$delegate, reason: from kotlin metadata */
    private final InterfaceC5183 defaultViewModelProviderFactory;
    private boolean dispatchingOnMultiWindowModeChanged;
    private boolean dispatchingOnPictureInPictureModeChanged;

    /* JADX INFO: renamed from: fullyDrawnReporter$delegate, reason: from kotlin metadata */
    private final InterfaceC5183 fullyDrawnReporter;
    ...
    private final InterfaceC5183 onBackPressedDispatcher;

    /* JADX INFO: renamed from: onBackPressedInput$delegate, reason: from kotlin metadata */
    private final InterfaceC5183 onBackPressedInput;
    ...
    private final C7537 savedStateRegistryController;

    public ComponentActivity() {
        this.contextAwareHelper = new C7731();
        final int i = 1;
        this.menuHostHelper = new C2252(new RunnableC0039(this, i));
        int i2 = 4;
        C7537 c7537 = new C7537(new C7501(this, new C7341(this, i2)));
        this.savedStateRegistryController = c7537;
        this.reportFullyDrawnExecutor = createFullyDrawnExecutor();
        this.fullyDrawnReporter = AbstractC5186.m10210(new C0036(this, i));
        ...
        this.onBackPressedInput = AbstractC5186.m10210(new C0036(this, 2));
        if (getLifecycle() == null) {
            C5919.m11250("getLifecycle() returned null in ComponentActivity's constructor. Please make sure you are lazily constructing your Lifecycle in the first call to getLifecycle() rather than relying on field initialization.");
            throw null;
        }
        final int i3 = 0;
        getLifecycle().mo4493(new InterfaceC2380(this) { // from class: androidx.activity.飘花落叶言子楪苏世哲兰
        ...
        getLifecycle().mo4493(new C7541(this, i));
        c7537.m12730();
        AbstractC2435.m4520(this);
        getSavedStateRegistry().m12732(ACTIVITY_RESULT_TAG, new InterfaceC7539() { // from class: androidx.activity.飘花落叶言子楪苏世兰哲
        ...
        addOnContextAvailableListener(new InterfaceC7730() { // from class: androidx.activity.飘花落叶言子楪苏哲世兰
        ...
        this.defaultViewModelProviderFactory = AbstractC5186.m10210(new C0036(this, 3));
        this.onBackPressedDispatcher = AbstractC5186.m10210(new C0036(this, i2));
    }
    ...
    public static final void _init_$lambda$2(ComponentActivity componentActivity, InterfaceC2388 interfaceC2388, Lifecycle$Event lifecycle$Event) {
        ...
        if (lifecycle$Event == Lifecycle$Event.ON_DESTROY) {
            componentActivity.contextAwareHelper.f20995 = null;
            if (!componentActivity.isChangingConfigurations()) {
                componentActivity.getViewModelStore().m4509();
            }
    ...
    public static final Bundle _init_$lambda$3(ComponentActivity componentActivity) {
        ...
        AbstractC7728 abstractC7728 = componentActivity.activityResultRegistry;
        abstractC7728.getClass();
        LinkedHashMap linkedHashMap = abstractC7728.f20989;
        bundle.putIntegerArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_RCS", new ArrayList<>(linkedHashMap.values()));
        bundle.putStringArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_KEYS", new ArrayList<>(linkedHashMap.keySet()));
        bundle.putStringArrayList("KEY_COMPONENT_ACTIVITY_LAUNCHED_KEYS", new ArrayList<>(abstractC7728.f20987));
        bundle.putBundle("KEY_COMPONENT_ACTIVITY_PENDING_RESULT", new Bundle(abstractC7728.f20991));
        return bundle;
    }
    ...
    public static final void _init_$lambda$4(ComponentActivity componentActivity, Context context) {
        context.getClass();
        Bundle bundleM12734 = componentActivity.getSavedStateRegistry().m12734(ACTIVITY_RESULT_TAG);
        if (bundleM12734 != null) {
            AbstractC7728 abstractC7728 = componentActivity.activityResultRegistry;
            LinkedHashMap linkedHashMap = abstractC7728.f20989;
            LinkedHashMap linkedHashMap2 = abstractC7728.f20990;
            Bundle bundle = abstractC7728.f20991;
            ArrayList<Integer> integerArrayList = bundleM12734.getIntegerArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_RCS");
            ArrayList<String> stringArrayList = bundleM12734.getStringArrayList("KEY_COMPONENT_ACTIVITY_REGISTERED_KEYS");
            if (stringArrayList == null || integerArrayList == null) {
                return;
            }
            ArrayList<String> stringArrayList2 = bundleM12734.getStringArrayList("KEY_COMPONENT_ACTIVITY_LAUNCHED_KEYS");
            if (stringArrayList2 != null) {
                abstractC7728.f20987.addAll(stringArrayList2);
            }
            Bundle bundle2 = bundleM12734.getBundle("KEY_COMPONENT_ACTIVITY_PENDING_RESULT");
            if (bundle2 != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (linkedHashMap.containsKey(str)) {
                    ...
                    if (!bundle.containsKey(str)) {
                        AbstractC4387.m8900(linkedHashMap2).remove(num);
                    }
                }
                ...
                abstractC7728.f20989.put(str3, Integer.valueOf(iIntValue));
            }
        }
    }
    ...
    public final void addObserverForBackInvoker(final C0023 dispatcher) {
        getLifecycle().mo4493(new InterfaceC2380(this) { // from class: androidx.activity.飘花落叶言子楪世兰苏哲
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final C5175 fullyDrawnReporter_delegate$lambda$0$0(ComponentActivity componentActivity) {
        componentActivity.reportFullyDrawn();
        return C5175.f14739;
    }

    private final C7551 getOnBackPressedInput() {
        return (C7551) this.onBackPressedInput.getValue();
    }
    ...
    public static final C0023 onBackPressedDispatcher_delegate$lambda$0(final ComponentActivity componentActivity) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            if (!AbstractC4394.m8917(Looper.myLooper(), Looper.getMainLooper())) {
    ...
    public static final void onBackPressedDispatcher_delegate$lambda$0$0(ComponentActivity componentActivity) {
        try {
            ...
            if (!AbstractC4394.m8917(e.getMessage(), "Can not perform this action after onSaveInstanceState")) {
                throw e;
            }
        } catch (NullPointerException e2) {
            if (!AbstractC4394.m8917(e2.getMessage(), "Attempt to invoke virtual method 'android.os.Handler android.app.FragmentHostCallback.getHandler()' on a null object reference")) {
                throw e2;
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final C7551 onBackPressedInput_delegate$lambda$0(ComponentActivity componentActivity) {
        C7551 c7551 = new C7551();
        componentActivity.getNavigationEventDispatcher().m12757(c7551);
        return c7551;
    }
    ...
    public void addMenuProvider(final InterfaceC2253 provider, InterfaceC2388 owner) {
        ...
        c2252.f6558.add(provider);
        c2252.f6559.run();
        AbstractC2402 lifecycle = owner.getLifecycle();
        HashMap map = c2252.f6557;
    ...
    @Override // p172.InterfaceC7732
    public final void addOnContextAvailableListener(InterfaceC7730 listener) {
        listener.getClass();
    ...
    public final void enterPictureInPictureMode(AbstractC7658 params) {
        throw null;
    }

    public final AbstractC7728 getActivityResultRegistry() {
        return this.activityResultRegistry;
    }

    @Override // androidx.lifecycle.InterfaceC2405
    public AbstractC7635 getDefaultViewModelCreationExtras() {
        C7634 c7634 = new C7634(0);
        Application application = getApplication();
        LinkedHashMap linkedHashMap = c7634.f20729;
        if (application != null) {
            linkedHashMap.put(C2424.f7067, getApplication());
        }
        ...
        if (extras != null) {
            linkedHashMap.put(AbstractC2435.f7097, extras);
        }
        return c7634;
    }
    ...
    @Override // p144.InterfaceC7548
    public C7549 getNavigationEventDispatcher() {
    ...
    public final C7538 getSavedStateRegistry() {
        return this.savedStateRegistryController.f20423;
    }

    @Override // androidx.lifecycle.InterfaceC2421
    public C2423 getViewModelStore() {
        if (getApplication() == null) {
            C5919.m11250("Your activity is not yet attached to the Application instance. You can't request ViewModel before onCreate call.");
            return null;
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (this.activityResultRegistry.m13017(requestCode, resultCode, data)) {
            return;
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        this.savedStateRegistryController.m12729(savedInstanceState);
        C7731 c7731 = this.contextAwareHelper;
        c7731.getClass();
        c7731.f20995 = this;
        Iterator it = c7731.f20996.iterator();
        while (it.hasNext()) {
            ((InterfaceC7730) it.next()).mo165(this);
        }
        super.onCreate(savedInstanceState);
        int i = FragmentC2433.f7095;
        AbstractC2436.m4526(this);
    ...
    public boolean onCreatePanelMenu(int featureId, Menu menu) {
        ...
        getMenuInflater();
        Iterator it = c2252.f6558.iterator();
        while (it.hasNext()) {
            ((C2325) ((InterfaceC2253) it.next())).f6825.m4397();
        }
        return true;
    }
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        if (featureId == 0) {
            return this.menuHostHelper.m4201();
        }
        return false;
    }
    ...
    public void onMultiWindowModeChanged(boolean isInMultiWindowMode, Configuration newConfig) {
        ...
        try {
            ...
            it.getClass();
            while (it.hasNext()) {
                it.next().accept(new C7649(isInMultiWindowMode));
            }
        } catch (Throwable th) {
            this.dispatchingOnMultiWindowModeChanged = false;
            throw th;
    ...
    public void onPanelClosed(int featureId, Menu menu) {
        menu.getClass();
        Iterator it = this.menuHostHelper.f6558.iterator();
        while (it.hasNext()) {
            ((C2325) ((InterfaceC2253) it.next())).f6825.m4391();
        }
    ...
    public void onPictureInPictureModeChanged(boolean isInPictureInPictureMode, Configuration newConfig) {
        ...
        try {
            ...
            it.getClass();
            while (it.hasNext()) {
                it.next().accept(new C7655(isInPictureInPictureMode));
            }
        } catch (Throwable th) {
            this.dispatchingOnPictureInPictureModeChanged = false;
            throw th;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (this.activityResultRegistry.m13017(requestCode, -1, new Intent().putExtra("androidx.activity.result.contract.extra.PERMISSIONS", permissions).putExtra("androidx.activity.result.contract.extra.PERMISSION_GRANT_RESULTS", grantResults))) {
            return;
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (getLifecycle() instanceof C2386) {
            ...
            lifecycle.getClass();
            ((C2386) lifecycle).m4495(Lifecycle$State.CREATED);
        }
        super.onSaveInstanceState(outState);
        this.savedStateRegistryController.m12728(outState);
    }
    ...
    public Context peekAvailableContext() {
        return this.contextAwareHelper.f20995;
    }

    public final <I, O> AbstractC7726 registerForActivityResult(final AbstractC7721 contract, final AbstractC7728 registry, final InterfaceC7727 callback) {
        contract.getClass();
        registry.getClass();
        callback.getClass();
        final String str = "activity_rq#" + this.nextLocalRequestCode.getAndIncrement();
        LinkedHashMap linkedHashMap = registry.f20988;
        AbstractC2402 lifecycle = getLifecycle();
        if (((C2386) lifecycle).f7018.isAtLeast(Lifecycle$State.STARTED)) {
            StringBuilder sb = new StringBuilder("LifecycleOwner ");
            sb.append(this);
            Lifecycle$State lifecycle$State = ((C2386) lifecycle).f7018;
        ...
        registry.m13015(str);
        C7723 c7723 = (C7723) linkedHashMap.get(str);
        if (c7723 == null) {
            c7723 = new C7723(lifecycle);
        }
        InterfaceC2380 interfaceC2380 = new InterfaceC2380() { // from class: 飘花落叶言子楪世兰苏哲.飘花落叶言子楪世哲苏兰
            @Override // androidx.lifecycle.InterfaceC2380
            /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲 */
            public final void mo18(InterfaceC2388 interfaceC2388, Lifecycle$Event lifecycle$Event) {
                AbstractC7728 abstractC7728 = registry;
                LinkedHashMap linkedHashMap2 = abstractC7728.f20986;
                ...
                Bundle bundle = abstractC7728.f20991;
                LinkedHashMap linkedHashMap3 = abstractC7728.f20985;
                AbstractC7721 abstractC7721 = contract;
                InterfaceC7727 interfaceC7727 = callback;
                linkedHashMap2.put(str2, new C7724(abstractC7721, interfaceC7727));
                if (linkedHashMap3.containsKey(str2)) {
                    Object obj = linkedHashMap3.get(str2);
                    linkedHashMap3.remove(str2);
                    interfaceC7727.mo4414(obj);
                }
                ActivityResult activityResult = (ActivityResult) AbstractC4921.m9880(str2, bundle);
        ...
        c7723.f20978.mo4493(interfaceC2380);
        c7723.f20977.add(interfaceC2380);
        linkedHashMap.put(str, c7723);
        return new C7722();
    }

    public void removeMenuProvider(InterfaceC2253 provider) {
        provider.getClass();
        this.menuHostHelper.m4200(provider);
    }
    ...
    @Override // p172.InterfaceC7732
    public final void removeOnContextAvailableListener(InterfaceC7730 listener) {
        listener.getClass();
    ...
    public void reportFullyDrawn() {
        try {
            if (AbstractC6087.m11396()) {
                AbstractC6087.m11401("reportFullyDrawn() for ComponentActivity");
            }
    ...
    public final void setPictureInPictureParams(AbstractC7658 params) {
        throw null;
    }
    ...
    public final <I, O> AbstractC7726 registerForActivityResult(AbstractC7721 contract, InterfaceC7727 callback) {
        contract.getClass();
        callback.getClass();
