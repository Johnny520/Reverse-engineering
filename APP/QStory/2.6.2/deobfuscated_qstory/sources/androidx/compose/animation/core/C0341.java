...
public final class C0341 implements InterfaceC0335 {
    ...
    public C0341(float f, float f2, float f3, float f4) {
        ...
        if (!((Float.isNaN(f) || Float.isNaN(f2) || Float.isNaN(f3) || Float.isNaN(f4)) ? false : true)) {
            AbstractC0300.m928("Parameters to CubicBezierEasing cannot be NaN. Actual parameters are: " + f + ", " + f2 + ", " + f3 + ", " + f4 + TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        }
        ...
        double d5 = (d - d4) + d3;
        if (d5 == 0.0d) {
            iM2866 = d2 == d3 ? 0 : AbstractC1581.m2866((float) ((d4 - d3) / (d4 - (d3 * 2.0d))), fArr, 0);
        } else {
            double d6 = -Math.sqrt((d2 * d2) - (d3 * d));
            double d7 = (-d) + d2;
            int iM28662 = AbstractC1581.m2866((float) ((-(d6 + d7)) / d5), fArr, 0);
            int iM28663 = AbstractC1581.m2866((float) ((d6 - d7) / d5), fArr, iM28662) + iM28662;
            if (iM28663 > 1) {
                float f8 = fArr[0];
                float f9 = fArr[1];
                if (f8 > f9) {
        ...
        int iM28664 = AbstractC1581.m2866((-f10) / (((f7 - f6) * 2.0f) - f10), fArr, iM2866) + iM2866;
        float fMin = Math.min(0.0f, 1.0f);
        float fMax = Math.max(0.0f, 1.0f);
        for (int i = 0; i < iM28664; i++) {
            float f11 = fArr[i];
    ...
    public final int hashCode() {
        return Float.hashCode(this.f1151) + AbstractC0053.m144(AbstractC0053.m144(Float.hashCode(this.f1155) * 31, this.f1153, 31), this.f1154, 31);
    }
    ...
    public final String toString() {
        ...
        sb.append(", d=");
        return AbstractC0053.m157(sb, this.f1151, ')');
    }
  ...
  0x0162: PHI (r12v41 float) = (r12v25 float), (r12v36 float) binds: [B:68:0x0160, B:81:0x0191] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final float mo850(float r27) {
        /*
            Method dump skipped, instruction units count: 658
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.core.C0341.mo850(float):float");
    }
}
