...
public final class C0375 {
    ...
    public final boolean equals(Object obj) {
        ...
        return Float.compare(this.f1285, c0375.f1285) == 0 && C1615.m2975(this.f1284, c0375.f1284) && this.f1283.equals(c0375.f1283);
    }

    public final int hashCode() {
        int iHashCode = Float.hashCode(this.f1285) * 31;
        int i = C1615.f4725;
        return this.f1283.hashCode() + AbstractC0053.m141(iHashCode, 31, this.f1284);
    }

    public final String toString() {
        return "Scale(scale=" + this.f1285 + ", transformOrigin=" + ((Object) C1615.m2974(this.f1284)) + ", animationSpec=" + this.f1283 + ')';
    }
}
