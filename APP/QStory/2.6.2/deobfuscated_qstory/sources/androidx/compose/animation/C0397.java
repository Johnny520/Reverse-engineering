...
public final class C0397 extends AbstractC0381 {
    ...
    public final InterfaceC6557 f1326;
    ...
    public final InterfaceC6557 f1329;
    ...
    public C0397(C0364 c0364, C0354 c0354, C0354 c03542, C0354 c03543, AbstractC0396 abstractC0396, AbstractC0394 abstractC0394, InterfaceC6542 interfaceC6542, C0391 c0391) {
        this.f1331 = c0364;
        this.f1337 = c0354;
        this.f1336 = c03542;
        this.f1335 = c03543;
        ...
        this.f1332 = interfaceC6542;
        this.f1328 = c0391;
        AbstractC7896.m13296(0, 0, 0, 0, 15);
        this.f1329 = new InterfaceC6557() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$sizeTransitionSpec$1
            {
                super(1);
            }
            ...
            public final InterfaceC0311 invoke(InterfaceC0353 interfaceC0353) {
                ...
                } else if (interfaceC0353.m1057(enterExitState2, EnterExitState.PostExit)) {
        ...
        this.f1326 = new InterfaceC6557() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$slideSpec$1
            {
                super(1);
            }
    ...
    public final InterfaceC2118 m1099() {
        if (this.f1331.m1062().m1057(EnterExitState.PreEnter, EnterExitState.Visible)) {
    ...
    */
    public final androidx.compose.ui.layout.InterfaceC1657 mo1101(androidx.compose.ui.layout.InterfaceC1653 r23, androidx.compose.ui.layout.InterfaceC1655 r24, long r25) {
        /*
            Method dump skipped, instruction units count: 416
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.C0397.mo1101(androidx.compose.ui.layout.飘花落叶言子世兰哲楪苏, androidx.compose.ui.layout.飘花落叶言子世兰楪哲苏, long):androidx.compose.ui.layout.飘花落叶言子世兰苏哲楪");
    }
}
