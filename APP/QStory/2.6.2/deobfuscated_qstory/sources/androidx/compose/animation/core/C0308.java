...
public final class C0308 implements InterfaceC0310 {
    ...
    public C0308(float f, float f2, float f3) {
        ...
        c0296.f1025 = 1.0f;
        if (f < 0.0f) {
            AbstractC0300.m928("Damping ratio must be non-negative");
        }
        c0296.f1025 = f;
        double d = c0296.f1026;
        if (((float) (d * d)) <= 0.0f) {
            AbstractC0300.m928("Spring stiffness constant must be positive.");
        }
    ...
    public final float mo933(long j, float f, float f2, float f3) {
        ...
        c0296.f1027 = f2;
        return Float.intBitsToFloat((int) (c0296.m925(f, f3, j / 1000000) >> 32));
    }

    @Override // androidx.compose.animation.core.InterfaceC0310
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final float mo936(float f, float f2, float f3) {
        return 0.0f;
    }
    ...
    */
    public final long mo934(float r34, float r35, float r36) {
        /*
            Method dump skipped, instruction units count: 581
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.core.C0308.mo934(float, float, float):long");
    }
    ...
    public final float mo935(long j, float f, float f2, float f3) {
        C0296 c0296 = this.f1047;
        c0296.f1027 = f2;
        return Float.intBitsToFloat((int) (c0296.m925(f, f3, j / 1000000) & 4294967295L));
    }
}
