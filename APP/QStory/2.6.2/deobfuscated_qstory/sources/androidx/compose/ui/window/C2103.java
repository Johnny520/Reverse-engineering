...
public final class C2103 extends AbstractC1881 implements InterfaceC2205 {
    ...
    public final InterfaceC1395 f6231;

    /* JADX INFO: renamed from: 飘花落叶言子世楪苏哲兰, reason: contains not printable characters */
    public final Window f6232;

    public C2103(Context context, Window window) {
        super(context);
        this.f6232 = window;
        this.f6231 = AbstractC1367.m2465(AbstractC2112.f6250);
        WeakHashMap weakHashMap = AbstractC2270.f6593;
        AbstractC2193.m3994(this, this);
        AbstractC2270.m4232(this, new C2079(1, this));
    }
    ...
    public final void mo3489(InterfaceC1373 interfaceC1373, final int i) {
        ...
        if (c1324.m2333(i2 & 1, (i2 & 3) != 2)) {
            ((InterfaceC6553) ((AbstractC1347) this.f6231).getValue()).invoke(c1324, 0);
        } else {
            c1324.m2329();
        }
        C1389 c1389M2365 = c1324.m2365();
        if (c1389M2365 != null) {
            c1389M2365.f4033 = new InterfaceC6553() { // from class: androidx.compose.ui.window.DialogLayout$Content$4
    ...
    */
    public final void mo3490(int r13, int r14) {
        /*
            r12 = this;
            r0 = 0
            android.view.View r1 = r12.getChildAt(r0)
            if (r1 != 0) goto Lb
            super.mo3490(r13, r14)
            return
        Lb:
            ...
            r5 = -2
            android.view.Window r6 = r12.f6232
            ...
            int r8 = r8.height
            if (r8 != r5) goto L49
            boolean r8 = r12.f6229
            if (r8 == 0) goto L46
            int r8 = android.os.Build.VERSION.SDK_INT
            r9 = 30
            if (r8 >= r9) goto L3b
            androidx.compose.ui.window.飘花落叶言子楪苏世哲兰 r8 = androidx.compose.ui.window.C2110.f6249
            int r8 = r8.m3841(r6)
            goto L4a
        L3b:
            r9 = 32
            if (r8 >= r9) goto L49
            androidx.compose.ui.window.飘花落叶言子楪苏哲世兰 r8 = androidx.compose.ui.window.C2113.f6251
            int r8 = r8.m3846(r6)
            goto L4a
        L46:
            int r8 = r3 + 1
        ...
        Lc7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.window.C2103.mo3490(int, int):void");
    }
    ...
    public final C2225 mo302(View view, C2225 c2225) {
        if (!this.f6229) {
            ...
            if (iMax != 0 || iMax2 != 0 || iMax3 != 0 || iMax4 != 0) {
                return c2225.f6520.mo4039(iMax, iMax2, iMax3, iMax4);
            }
        }
        return c2225;
    }
