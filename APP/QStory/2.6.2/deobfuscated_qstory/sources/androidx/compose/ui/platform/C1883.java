...
public final class C1883 extends C5851 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final /* synthetic */ ViewOnAttachStateChangeListenerC1885 f5410;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1883(ViewOnAttachStateChangeListenerC1885 viewOnAttachStateChangeListenerC1885) {
        super(15);
        this.f5410 = viewOnAttachStateChangeListenerC1885;
    }

    @Override // top.suzhelan.qstory.hook.item.chat.C5851
    /* JADX INFO: renamed from: 飘花落叶言子世楪哲苏兰, reason: contains not printable characters */
    public final C7606 mo3495(int i) {
        ViewOnAttachStateChangeListenerC1885 viewOnAttachStateChangeListenerC1885 = this.f5410;
        if (i != 1) {
            if (i == 2) {
                return mo3496(viewOnAttachStateChangeListenerC1885.f5522);
            }
            C5919.m11249(AbstractC6136.m11556(i, "Unknown focus type: "));
            return null;
        }
        int i2 = viewOnAttachStateChangeListenerC1885.f5521;
    ...
    */
    public final p155.C7606 mo3496(int r48) {
        /*
            Method dump skipped, instruction units count: 3253
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C1883.mo3496(int):飘花落叶言子哲世苏楪兰.飘花落叶言子楪世兰哲苏");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean mo3497(int r25, int r26, android.os.Bundle r27) {
        /*
            Method dump skipped, instruction units count: 2150
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C1883.mo3497(int, int, android.os.Bundle):boolean");
    }

    @Override // top.suzhelan.qstory.hook.item.chat.C5851
    /* JADX INFO: renamed from: 飘花落叶言子楪兰哲苏世, reason: contains not printable characters */
    public final void mo3498(int i, C7606 c7606, String str, Bundle bundle) {
        this.f5410.m3579(i, c7606, str, bundle);
    }
}
