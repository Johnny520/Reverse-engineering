...
final class AndroidComposeView$requestFocusCurrent$1 extends Lambda implements InterfaceC6557 {
    final /* synthetic */ int $focusDirection;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidComposeView$requestFocusCurrent$1(int i) {
        super(1);
    ...
    public final Boolean invoke(C1452 c1452) {
        return Boolean.valueOf(c1452.m2586(this.$focusDirection));
    }
}
