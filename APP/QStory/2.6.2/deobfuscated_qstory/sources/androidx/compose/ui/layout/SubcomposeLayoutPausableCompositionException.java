...
final class SubcomposeLayoutPausableCompositionException extends IllegalStateException {
    ...
    private final List<String> operationsList() {
        ...
        for (int i = this.operations.f985 - 1; i >= 0; i += -1) {
            int iM855 = this.operations.m855(i);
            listBuilderM13685.add(i + ": " + (iM855 == 0 ? "CancelPausedPrecomposition" : iM855 == 1 ? "ReuseForceSyncDeactivation" : iM855 == 2 ? "ReuseScheduleOutOfFrameDeactivation" : iM855 == 3 ? "ReuseSyncDeactivation" : iM855 == 4 ? "ReuseDeactivationViaHost" : iM855 == 5 ? "TookFromPrecomposeMap" : iM855 == 6 ? "Subcompose" : iM855 == 7 ? "SubcomposeNew" : iM855 == 8 ? "SubcomposePausable" : iM855 == 9 ? "SubcomposeForceReuse" : iM855 == 10 ? "DeactivateOutOfFrame" : iM855 == 11 ? "DeactivateOutOfFrameCancelled" : iM855 == 12 ? "SlotToReusedFromOnDeactivate" : iM855 == 13 ? "SlotToReusedFromOnReuse" : iM855 == 14 ? "Reused" : iM855 == 15 ? "ResumePaused" : iM855 == 16 ? "PausePaused" : iM855 == 17 ? "ApplyPaused" : AbstractC6136.m11556(iM855, "Unexpected ")));
        }
