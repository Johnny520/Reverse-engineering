...
public final class C0736 implements InterfaceC0513 {
    ...
    public final InterfaceC1395 f2073;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final C0131 f2076;
    ...
    public final C0686 f2079;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲世苏兰, reason: contains not printable characters */
    public final InterfaceC1395 f2080;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public final C0703 f2081;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final InterfaceC1395 f2082;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰世哲, reason: contains not printable characters */
    public float f2083;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰哲世, reason: contains not printable characters */
    public final C0712 f2084;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰, reason: contains not printable characters */
    public final boolean f2085;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public final C0477 f2086;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final InterfaceC1395 f2075 = AbstractC1367.m2466(AbstractC0737.f2087, C1353.f3919);

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final C0137 f2074 = new C0137((byte) 0, 1);

    static {
        AbstractC7346.m12513(new C0753(3), new C0016(26));
    }

    public C0736(int[] iArr, int[] iArr2) {
        this.f2076 = new C0131(iArr, iArr2, new LazyStaggeredGridState$scrollPosition$1(this));
        Boolean bool = Boolean.FALSE;
        this.f2073 = AbstractC1367.m2465(bool);
        this.f2082 = AbstractC1367.m2465(bool);
        this.f2081 = new C0703();
        this.f2085 = true;
        new C0108(4);
        this.f2086 = new C0477(new C1067(this, 5));
        C0246 c0246 = AbstractC0273.f978;
        new C0246();
        AbstractC5321.m10329(1, BufferOverflow.DROP_OLDEST);
        new SnapshotStateList();
        this.f2084 = new C0712();
        this.f2080 = AbstractC0722.m1513();
        AbstractC0722.m1513();
        this.f2079 = new C0686();
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public final void m1533(float f, C0738 c0738) {
        if (!this.f2085 || c0738.f2097.isEmpty()) {
            return;
        }
        List list = c0738.f2097;
        if (f < 0.0f) {
            AbstractC4343.m8811(list).getClass();
            C2941.m6336();
        } else {
            AbstractC4343.m8827(list).getClass();
            C2941.m6336();
        }
    }
    ...
    public final float mo1238(float f) {
        return this.f2086.mo1238(f);
    }

    @Override // androidx.compose.foundation.gestures.InterfaceC0513
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏 */
    public final boolean mo1277() {
        return ((Boolean) ((AbstractC1347) this.f2073).getValue()).booleanValue();
    }

    @Override // androidx.compose.foundation.gestures.InterfaceC0513
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰 */
    public final boolean mo1278() {
        return ((Boolean) ((AbstractC1347) this.f2082).getValue()).booleanValue();
    }

    /* JADX WARN: Code restructure failed: missing block: B:22:0x0068, code lost:
    
        if (r6.f2086.mo1239(r7, r8, r0) == r1) goto L23;
     */
    ...
    */
    public final java.lang.Object mo1239(androidx.compose.foundation.MutatePriority r7, p052.InterfaceC6553 r8, kotlin.coroutines.jvm.internal.ContinuationImpl r9) {
        ...
        L3e:
            kotlin.AbstractC5184.m10206(r9)
            androidx.compose.runtime.飘花落叶言子苏楪兰世哲 r9 = r6.f2075
            androidx.compose.runtime.飘花落叶言子哲苏兰世楪 r9 = (androidx.compose.runtime.AbstractC1347) r9
            java.lang.Object r9 = r9.getValue()
            androidx.compose.foundation.lazy.staggeredgrid.飘花落叶言子楪世苏哲兰 r2 = androidx.compose.foundation.lazy.staggeredgrid.AbstractC0737.f2087
            if (r9 != r2) goto L5c
            r0.L$0 = r7
            r0.L$1 = r8
            r0.label = r5
            androidx.compose.foundation.lazy.layout.飘花落叶言子楪世兰苏哲 r9 = r6.f2081
        ...
        L5c:
            ...
            r0.L$1 = r3
            r0.label = r4
            androidx.compose.foundation.gestures.飘花落叶言子世楪苏兰哲 r6 = r6.f2086
        ...
        L6b:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.staggeredgrid.C0736.mo1239(androidx.compose.foundation.MutatePriority, 飘花落叶言世子哲楪兰苏.飘花落叶言子楪哲苏兰世, kotlin.coroutines.jvm.internal.ContinuationImpl):java.lang.Object");
    }

    @Override // androidx.compose.foundation.gestures.InterfaceC0513
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰 */
    public final boolean mo1240() {
        return this.f2086.mo1240();
    }

    /* JADX WARN: Type inference failed for: r5v10, types: [int[], java.io.Serializable] */
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final void m1534(int i, int i2) {
        C0131 c0131 = this.f2076;
        ...
        if (((AbstractC1346) interfaceC1398).m2422() != i || ((AbstractC1346) interfaceC13982).m2422() != i2) {
            C0712 c0712 = this.f2084;
            c0712.m1500();
            c0712.f2010 = null;
        }
        C0738 c0738 = (C0738) ((AbstractC1347) this.f2075).getValue();
        C0738 c07382 = AbstractC0737.f2087;
        if (!c0738.f2097.isEmpty()) {
            AbstractC4343.m8827(c0738.f2097).getClass();
            C2941.m6336();
            return;
        }
        ?? r5 = (int[]) ((InterfaceC6553) c0131.f576).invoke(Integer.valueOf(i), Integer.valueOf(((int[]) c0131.f578).length));
        ...
        c0131.f578 = r5;
        ((AbstractC1346) ((InterfaceC1398) c0131.f575)).m2423(C0131.m543(r5));
        c0131.f577 = iArr;
        ((AbstractC1346) interfaceC13982).m2423(C0131.m542(r5, iArr));
        ((C0690) c0131.f573).m1484(i);
    }
}
