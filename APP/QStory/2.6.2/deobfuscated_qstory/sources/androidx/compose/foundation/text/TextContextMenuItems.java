...
public final class TextContextMenuItems {
    ...
    public static final TextContextMenuItems Cut = new TextContextMenuItems("Cut", 0, AbstractC7385.f20034, R.string.cut, R.attr.actionModeCutDrawable);
    public static final TextContextMenuItems Copy = new TextContextMenuItems("Copy", 1, AbstractC7385.f20033, R.string.copy, R.attr.actionModeCopyDrawable);
    public static final TextContextMenuItems Paste = new TextContextMenuItems("Paste", 2, AbstractC7385.f20032, R.string.paste, R.attr.actionModePasteDrawable);
    public static final TextContextMenuItems SelectAll = new TextContextMenuItems("SelectAll", 3, AbstractC7385.f20031, R.string.selectAll, R.attr.actionModeSelectAllDrawable);
    public static final TextContextMenuItems Autofill = new TextContextMenuItems("Autofill", 4, AbstractC7385.f20030, R.string.autofill, 0);
    ...
    static {
        ...
        $ENTRIES = AbstractC4363.m8876(textContextMenuItemsArr$values);
    }
    ...
    public final String resolvedString(InterfaceC1373 interfaceC1373, int i) {
        return ((Resources) ((C1324) interfaceC1373).m2373(AbstractC1835.f5334)).getString(this.stringId);
    }
}
