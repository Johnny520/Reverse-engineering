...
public final class AlignmentLineKt$paddingFrom4j6BHR0$$inlined$debugInspectorInfo$1 extends Lambda implements InterfaceC6557 {
    final /* synthetic */ float $after$inlined;
    final /* synthetic */ AbstractC1689 $alignmentLine$inlined;
    final /* synthetic */ float $before$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AlignmentLineKt$paddingFrom4j6BHR0$$inlined$debugInspectorInfo$1(AbstractC1689 abstractC1689, float f, float f2) {
        super(1);
        this.$alignmentLine$inlined = abstractC1689;
