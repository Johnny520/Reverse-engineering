...
public abstract class AbstractC1092 {
    ...
    public static final C1358 f3220 = new C1358(new C1074(1));

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final InterfaceC2129 m1994(InterfaceC2129 interfaceC2129, InterfaceC0579 interfaceC0579, InterfaceC1016 interfaceC1016) {
        if (interfaceC1016 == null) {
            return interfaceC2129;
        }
        if (interfaceC1016 instanceof InterfaceC1095) {
            return interfaceC2129.mo3856(new C1097(interfaceC0579, (InterfaceC1095) interfaceC1016));
        }
        int i = AbstractC1909.f5627;
        return interfaceC2129.mo3856(new C2134(new C1093(interfaceC1016, 0, interfaceC0579)));
    }
}
