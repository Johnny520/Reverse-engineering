...
public final class ClickableKt$combinedClickablef5TDLPQ$$inlined$debugInspectorInfo$1 extends Lambda implements InterfaceC6557 {
    final /* synthetic */ boolean $enabled$inlined;
    final /* synthetic */ boolean $hapticFeedbackEnabled$inlined;
    final /* synthetic */ InterfaceC6542 $onClick$inlined;
    final /* synthetic */ String $onClickLabel$inlined;
    final /* synthetic */ InterfaceC6542 $onDoubleClick$inlined;
    final /* synthetic */ InterfaceC6542 $onLongClick$inlined;
    final /* synthetic */ String $onLongClickLabel$inlined;
    final /* synthetic */ C1954 $role$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ClickableKt$combinedClickablef5TDLPQ$$inlined$debugInspectorInfo$1(boolean z, String str, C1954 c1954, InterfaceC6542 interfaceC6542, InterfaceC6542 interfaceC65422, InterfaceC6542 interfaceC65423, String str2, boolean z2) {
        super(1);
        this.$enabled$inlined = z;
        this.$onClickLabel$inlined = str;
        this.$role$inlined = c1954;
        this.$onClick$inlined = interfaceC6542;
        this.$onDoubleClick$inlined = interfaceC65422;
        this.$onLongClick$inlined = interfaceC65423;
