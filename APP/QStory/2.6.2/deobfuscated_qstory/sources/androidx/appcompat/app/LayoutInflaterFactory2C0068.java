...
public final class LayoutInflaterFactory2C0068 extends AbstractC0094 implements InterfaceC7796, LayoutInflater.Factory2 {
    ...
    public static Configuration m212(Context context, int i, C2178 c2178, Configuration configuration, boolean z) {
        ...
        if (c2178 != null) {
            AbstractC0074.m248(configuration2, c2178);
        }
        return configuration2;
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public static C2178 m213(Context context) {
        C2178 c2178;
        C2178 c21782;
        ...
        C2178 c2178M250 = AbstractC0074.m250(context.getApplicationContext().getResources().getConfiguration());
        if (c2182.f6454.isEmpty()) {
            c21782 = C2178.f6451;
        } else {
            LinkedHashSet linkedHashSet = new LinkedHashSet();
            int i = 0;
            while (i < c2178M250.f6452.f6454.size() + c2182.f6454.size()) {
                Locale locale = i < c2182.f6454.size() ? c2182.f6454.get(i) : c2178M250.f6452.f6454.get(i - c2182.f6454.size());
                if (locale != null) {
        ...
        return c21782.f6452.f6454.isEmpty() ? c2178M250 : c21782;
    }
    ...
    public final View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        c0066.getClass();
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, AbstractC7772.f21096, 0, 0);
        int resourceId = typedArrayObtainStyledAttributes2.getResourceId(4, 0);
        if (resourceId != 0) {
            Log.i("AppCompatViewInflater", "app:theme is now deprecated. Please move to using android:theme instead.");
        }
        typedArrayObtainStyledAttributes2.recycle();
        c7807 = (resourceId == 0 || ((context instanceof C7807) && ((C7807) context).f21292 == resourceId)) ? context : new C7807(context, resourceId);
        str.getClass();
        switch (str) {
            case "RatingBar":
                c0123 = new C0123(c7807, attributeSet);
                break;
            case "CheckedTextView":
                c0123 = new C0193(c7807, attributeSet);
                break;
            case "MultiAutoCompleteTextView":
                c0123 = new C0135(c7807, attributeSet);
                break;
            case "TextView":
                c0123 = c0066.mo206(c7807, attributeSet);
                break;
            case "ImageButton":
                c0123 = new C0126(c7807, attributeSet, com.davemorrissey.labs.subscaleview.R.attr.imageButtonStyle);
                break;
            case "SeekBar":
                c0123 = new C0125(c7807, attributeSet);
                break;
            case "Spinner":
                c0123 = new C0227(c7807, attributeSet);
                break;
            case "RadioButton":
                c0123 = c0066.mo207(c7807, attributeSet);
                break;
            case "ToggleButton":
                c0123 = new C0223(c7807, attributeSet);
                break;
            case "ImageView":
                c0123 = new C0136(c7807, attributeSet, 0);
                break;
            case "AutoCompleteTextView":
                c0123 = c0066.mo210(c7807, attributeSet);
                break;
            case "CheckBox":
                c0123 = c0066.mo208(c7807, attributeSet);
                break;
            case "EditText":
                c0123 = new C0128(c7807, attributeSet);
                break;
            case "Button":
                c0123 = c0066.mo209(c7807, attributeSet);
                break;
            default:
                c0123 = null;
                break;
        }
        if (c0123 == null && context != c7807) {
            ...
            try {
                ...
                if (-1 == str.indexOf(46)) {
                    ...
                    while (true) {
                        ...
                        if (i2 < 3) {
                            View viewM205 = c0066.m205(c7807, str, strArr[i2]);
                            if (viewM205 != null) {
                                objArr[0] = null;
                                objArr[1] = null;
                                view2 = viewM205;
                    ...
                    View viewM2052 = c0066.m205(c7807, str, null);
                    objArr[0] = null;
                    objArr[1] = null;
                    view2 = viewM2052;
                }
        ...
        if (c0123 != null) {
            ...
            if (Build.VERSION.SDK_INT <= 28) {
                TypedArray typedArrayObtainStyledAttributes4 = c7807.obtainStyledAttributes(attributeSet, C0066.f144);
                if (typedArrayObtainStyledAttributes4.hasValue(0)) {
                    ...
                    new C2195(com.davemorrissey.labs.subscaleview.R.id.tag_accessibility_heading, Boolean.class, 0, 28, 2).m3993(Boolean.valueOf(z), c0123);
                }
                typedArrayObtainStyledAttributes4.recycle();
                TypedArray typedArrayObtainStyledAttributes5 = c7807.obtainStyledAttributes(attributeSet, C0066.f143);
                if (typedArrayObtainStyledAttributes5.hasValue(0)) {
                    AbstractC2270.m4231(c0123, typedArrayObtainStyledAttributes5.getString(0));
                }
                typedArrayObtainStyledAttributes5.recycle();
                TypedArray typedArrayObtainStyledAttributes6 = c7807.obtainStyledAttributes(attributeSet, C0066.f142);
                if (typedArrayObtainStyledAttributes6.hasValue(0)) {
                    ...
                    new C2195(com.davemorrissey.labs.subscaleview.R.id.tag_screen_reader_focusable, Boolean.class, 0, 28, 0).m3993(Boolean.valueOf(z2), c0123);
                }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子世楪兰哲苏, reason: contains not printable characters */
    public final int m214(Context context, int i) {
        if (i != -100) {
            if (i != -1) {
                if (i != 0) {
                    if (i != 1 && i != 2) {
                        if (i != 3) {
                            C5919.m11250("Unknown value set for night mode. Please use one of the MODE_NIGHT values from AppCompatDelegate.");
                            return 0;
                        }
                        if (this.f194 == null) {
                            this.f194 = new C0082(this, context);
                        }
                        return this.f194.mo311();
                    }
                } else if (((UiModeManager) context.getApplicationContext().getSystemService("uimode")).getNightMode() != 0) {
                    return m218(context).mo311();
                }
            }
            return i;
        }
    ...
    public final void m216() {
        ...
        if (this.f153 && this.f165 == null) {
            ...
            if (abstractC0088 != null) {
                abstractC0088.mo179(this.f186);
            }
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子世楪哲苏兰, reason: contains not printable characters */
    public final C0069 m217(int i) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子世楪苏兰哲, reason: contains not printable characters */
    public final AbstractC0080 m218(Context context) {
        if (this.f191 == null) {
            if (C0108.f317 == null) {
    ...
    public final void m219() {
        if (this.f168 == null) {
            Object obj = this.f170;
            if (obj instanceof Activity) {
                m238(((Activity) obj).getWindow());
            }
        }
        if (this.f168 != null) {
            return;
        }
        C5919.m11250("We have not been given a Window");
    }
    ...
    public final void m220() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            boolean z = false;
            if (this.f178 != null && (m217(0).f210 || this.f171 != null)) {
                z = true;
            }
            if (z && this.f177 == null) {
                this.f177 = AbstractC0072.m246(this.f178, this);
            } else {
                if (z || (onBackInvokedCallback = this.f177) == null) {
                    return;
                }
                AbstractC0072.m245(this.f178, onBackInvokedCallback);
                this.f177 = null;
            }
        }
    }
    ...
    */
    public final boolean m222(androidx.appcompat.app.C0069 r13, android.view.KeyEvent r14) {
        /*
            Method dump skipped, instruction units count: 361
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.m222(androidx.appcompat.app.飘花落叶言子世哲楪苏兰, android.view.KeyEvent):boolean");
    }

    /* JADX INFO: renamed from: 飘花落叶言子世苏哲楪兰, reason: contains not printable characters */
    public final boolean m223(C0069 c0069, int i, KeyEvent keyEvent) {
        MenuC7801 menuC7801;
        if (keyEvent.isSystem()) {
            return false;
        }
        if ((c0069.f215 || m222(c0069, keyEvent)) && (menuC7801 = c0069.f213) != null) {
            return menuC7801.performShortcut(i, keyEvent, 1);
        }
        return false;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:87:0x0176, code lost:
        ...
        if (r2.f21136.getCount() > 0) goto L88;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m224(androidx.appcompat.app.C0069 r18, android.view.KeyEvent r19) {
        /*
            Method dump skipped, instruction units count: 474
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.m224(androidx.appcompat.app.飘花落叶言子世哲楪苏兰, android.view.KeyEvent):void");
    }
    ...
    public final boolean m225() {
        boolean z = this.f184;
        this.f184 = false;
        C0069 c0069M217 = m217(0);
        if (!c0069M217.f210) {
            AbstractC7809 abstractC7809 = this.f171;
            if (abstractC7809 != null) {
                abstractC7809.mo410();
                return true;
            }
            m216();
            AbstractC0088 abstractC0088 = this.f165;
            if (abstractC0088 == null || !abstractC0088.mo171()) {
                return false;
            }
        } else if (!z) {
            m230(c0069M217, true);
    ...
    */
    public final void mo226() {
        /*
            ...
            monitor-enter(r0)
            androidx.appcompat.app.AbstractC0094.m325(r3)     // Catch: java.lang.Throwable -> Le
        ...
        L71:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.mo226():void");
    }
    ...
    public final void mo227() {
        ...
        if (obj instanceof Activity) {
            try {
                ...
                try {
                    strM12887 = AbstractC7652.m12887(activity, activity.getComponentName());
            ...
            if (strM12887 != null) {
                ...
                if (abstractC0088 == null) {
                    ...
                    abstractC0088.mo179(true);
                }
            }
            synchronized (AbstractC0094.f269) {
                AbstractC0094.m325(this);
    ...
    public final void m231(MenuC7801 menuC7801) {
        C0197 c0197;
        if (this.f202) {
            return;
        }
    ...
    public final void m232(int i) {
        C0069 c0069M217 = m217(i);
        if (c0069M217.f213 != null) {
            Bundle bundle = new Bundle();
            c0069M217.f213.m13129(bundle);
            if (bundle.size() > 0) {
                c0069M217.f212 = bundle;
            }
            c0069M217.f213.m13131();
            c0069M217.f213.clear();
        }
        c0069M217.f211 = true;
        c0069M217.f209 = true;
        if ((i == 108 || i == 0) && this.f174 != null) {
            C0069 c0069M2172 = m217(0);
            c0069M2172.f215 = false;
            m222(c0069M2172, null);
        }
    }
    ...
    public final void m233() {
        ...
        if (!typedArrayObtainStyledAttributes.hasValue(117)) {
            typedArrayObtainStyledAttributes.recycle();
            C5919.m11250("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
            return;
        }
        int i = 0;
        int i2 = 1;
        ...
        if (this.f201) {
            ...
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new C7807(context, typedValue.resourceId) : context).inflate(com.davemorrissey.labs.subscaleview.R.layout.abc_screen_toolbar, (ViewGroup) null);
        ...
        WeakHashMap weakHashMap = AbstractC2270.f6593;
        AbstractC2193.m3994(viewGroup, c0092);
        if (this.f174 == null) {
        ...
        this.f159 = true;
        C0069 c0069M217 = m217(0);
        if (this.f181 || c0069M217.f213 != null) {
            return;
        }
        m215(108);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean m234(android.view.KeyEvent r7) {
        /*
            Method dump skipped, instruction units count: 309
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.m234(android.view.KeyEvent):boolean");
    }

    /* JADX WARN: Code restructure failed: missing block: B:19:0x0044, code lost:
    
        if (r6.m701() != false) goto L20;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void mo203(p190.MenuC7801 r6) {
        /*
            Method dump skipped, instruction units count: 215
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.mo203(飘花落叶言子楪苏兰世哲.飘花落叶言子楪苏哲兰世):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final p192.AbstractC7809 mo235(p192.InterfaceC7810 r9) {
        /*
            Method dump skipped, instruction units count: 443
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.mo235(飘花落叶言子楪苏哲兰世.飘花落叶言子楪世苏哲兰):飘花落叶言子楪苏哲兰世.飘花落叶言子楪世苏兰哲");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final void m236(int i, C0069 c0069, MenuC7801 menuC7801) {
        if (menuC7801 == null) {
            if (c0069 == null && i >= 0) {
                C0069[] c0069Arr = this.f199;
        ...
        if ((c0069 == null || c0069.f210) && !this.f181) {
            ...
            try {
                ...
                callback.onPanelClosed(i, menuC7801);
            } finally {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean m237(boolean r17, boolean r18) {
        /*
            Method dump skipped, instruction units count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.m237(boolean, boolean):boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m238(android.view.Window r8) {
        /*
            r7 = this;
            ...
            if (r3 == 0) goto L3f
            androidx.appcompat.widget.飘花落叶言子世楪苏兰哲 r4 = androidx.appcompat.widget.C0130.m539()
            monitor-enter(r4)
            androidx.appcompat.widget.飘花落叶言子哲兰苏世楪 r5 = r4.f572     // Catch: java.lang.Throwable -> L3c
            r6 = 1
            android.graphics.drawable.Drawable r0 = r5.m632(r0, r3, r6)     // Catch: java.lang.Throwable -> L3c
            monitor-exit(r4)
            goto L40
        L3c:
            r7 = move-exception
        ...
        L45:
            ...
            if (r1 == 0) goto L61
            androidx.appcompat.app.AbstractC0072.m245(r8, r1)
            r7.f177 = r2
        L61:
            ...
            if (r8 == 0) goto L74
            android.window.OnBackInvokedDispatcher r8 = androidx.appcompat.app.AbstractC0072.m247(r0)
            r7.f178 = r8
            goto L76
        L74:
            r7.f178 = r2
        ...
        L7e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.LayoutInflaterFactory2C0068.m238(android.view.Window):void");
    }
    ...
    public final void mo239(int i) {
        ...
        this.f167.m320(this.f168.getCallback());
    }

    @Override // androidx.appcompat.app.AbstractC0094
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final boolean mo240(int i) {
        if (i == 8) {
    ...
    public final void mo241(View view, ViewGroup.LayoutParams layoutParams) {
        m233();
        ViewGroup viewGroup = (ViewGroup) this.f160.findViewById(R.id.content);
        viewGroup.removeAllViews();
    ...
    public final void mo242(CharSequence charSequence) {
        ...
        AbstractC0088 abstractC0088 = this.f165;
        if (abstractC0088 != null) {
            abstractC0088.mo173(charSequence);
            return;
        }
        TextView textView = this.f156;
        if (textView != null) {
    ...
    public final boolean mo204(MenuC7801 menuC7801, MenuItem menuItem) {
        ...
        if (callback != null && !this.f181) {
            ...
            while (true) {
                if (i < length) {
                    c0069 = c0069Arr[i];
                    if (c0069 != null && c0069.f213 == menuC7801Mo13103) {
                        break;
                    }
                    i++;
                } else {
