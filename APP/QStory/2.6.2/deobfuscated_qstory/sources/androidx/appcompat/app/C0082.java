...
public final class C0082 extends AbstractC0080 {
    ...
    public final IntentFilter mo304() {
        switch (this.f237) {
            case 0:
    ...
    public final int mo311() {
        ...
        switch (i) {
            case 0:
                if (!AbstractC0075.m253((PowerManager) obj)) {
                    break;
                }
                break;
            default:
                ...
                if (c0109.f322 > System.currentTimeMillis()) {
                    ...
                    if (AbstractC2167.m3938(context, "android.permission.ACCESS_COARSE_LOCATION") == 0) {
                        try {
                        } catch (Exception e) {
                    ...
                    if (AbstractC2167.m3938(context, "android.permission.ACCESS_FINE_LOCATION") == 0) {
                        try {
                    ...
                    if (location != null) {
                        ...
                        c0061.m184(location.getLatitude(), location.getLongitude(), jCurrentTimeMillis - 86400000);
                        c0061.m184(location.getLatitude(), location.getLongitude(), jCurrentTimeMillis);
                        z = c0061.f133 == 1;
                        long j2 = c0061.f131;
                        long j3 = c0061.f132;
                        c0061.m184(location.getLatitude(), location.getLongitude(), jCurrentTimeMillis + 86400000);
    ...
    public final void mo313() {
        ...
        switch (i) {
            case 0:
                layoutInflaterFactory2C0068.m237(true, true);
                break;
            default:
                layoutInflaterFactory2C0068.m237(true, true);
                break;
