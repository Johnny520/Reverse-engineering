...
public final class DialogInterfaceC0104 extends DialogC0043 implements DialogInterface, InterfaceC0096 {
    ...
    public DialogInterfaceC0104(ContextThemeWrapper contextThemeWrapper, int i) {
        int i2;
        int iM330 = m330(contextThemeWrapper, i);
        if (iM330 == 0) {
        ...
        this.f287 = new InterfaceC2256() { // from class: androidx.appcompat.app.飘花落叶言子世哲苏楪兰
            ...
            public final boolean superDispatchKeyEvent(KeyEvent keyEvent) {
                return this.f224.m333(keyEvent);
            }
        };
        AbstractC0094 abstractC0094M332 = m332();
        if (iM330 == 0) {
            TypedValue typedValue2 = new TypedValue();
            contextThemeWrapper.getTheme().resolveAttribute(R.attr.dialogTheme, typedValue2, true);
            iM330 = typedValue2.resourceId;
        }
        ((LayoutInflaterFactory2C0068) abstractC0094M332).f195 = iM330;
        abstractC0094M332.mo227();
        this.f288 = new C0106(getContext(), this, getWindow());
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰哲苏, reason: contains not printable characters */
    public static int m330(Context context, int i) {
    ...
    public final void addContentView(View view, ViewGroup.LayoutParams layoutParams) {
        m101();
        LayoutInflaterFactory2C0068 layoutInflaterFactory2C0068 = (LayoutInflaterFactory2C0068) m332();
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        return AbstractC2267.m4216(this.f287, getWindow().getDecorView(), this, keyEvent);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        ViewGroup viewGroupM335 = C0106.m335(viewFindViewById6, viewFindViewById3);
        ViewGroup viewGroupM3352 = C0106.m335(viewFindViewById7, viewFindViewById4);
        ViewGroup viewGroupM3353 = C0106.m335(viewFindViewById8, viewFindViewById5);
        NestedScrollView nestedScrollView = (NestedScrollView) window.findViewById(R.id.scrollView);
        c0106.f312 = nestedScrollView;
        nestedScrollView.setFocusable(false);
        c0106.f312.setNestedScrollingEnabled(false);
        TextView textView = (TextView) viewGroupM3352.findViewById(android.R.id.message);
        c0106.f303 = textView;
        if (textView != null) {
            ...
            if (c0106.f292 != null) {
                ...
                viewGroupM3352.setVisibility(8);
            }
        }
        Button button = (Button) viewGroupM3353.findViewById(android.R.id.button1);
        c0106.f291 = button;
        ...
        Button button3 = (Button) viewGroupM3353.findViewById(android.R.id.button2);
        c0106.f309 = button3;
        ...
        Button button5 = (Button) viewGroupM3353.findViewById(android.R.id.button3);
        c0106.f308 = button5;
        ...
        if (i == 0) {
            viewGroupM3353.setVisibility(8);
        }
        if (c0106.f302 != null) {
            viewGroupM335.addView(c0106.f302, 0, new ViewGroup.LayoutParams(-1, -2));
        ...
        int i2 = (viewGroupM335 == null || viewGroupM335.getVisibility() == 8) ? 0 : 1;
        boolean z2 = viewGroupM3353.getVisibility() != 8;
        if (!z2 && (viewFindViewById = viewGroupM3352.findViewById(R.id.textSpacerNoButtons)) != null) {
        ...
        if (i2 != 0) {
            ...
            View viewFindViewById9 = c0106.f292 != null ? viewGroupM335.findViewById(R.id.titleDividerNoCustom) : null;
            if (viewFindViewById9 != null) {
                viewFindViewById9.setVisibility(0);
            }
        } else {
            View viewFindViewById10 = viewGroupM3352.findViewById(R.id.textSpacerNoTitle);
        ...
        if (!z) {
            ...
            if (view != null) {
                ...
                if (viewFindViewById11 != null) {
                    viewGroupM3352.removeView(viewFindViewById11);
                }
                if (viewFindViewById12 != null) {
                    viewGroupM3352.removeView(viewFindViewById12);
                }
            }
        }
    ...
    public final boolean onKeyDown(int i, KeyEvent keyEvent) {
        ...
        if (nestedScrollView == null || !nestedScrollView.m4292(keyEvent)) {
    ...
    public final AbstractC7809 onWindowStartingSupportActionMode(InterfaceC7810 interfaceC7810) {
        return null;
    }
    ...
    public final void setTitle(int i) {
        super.setTitle(i);
        m332().mo242(getContext().getString(i));
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final void m331(Bundle bundle) {
        m332().mo229();
    ...
    public final AbstractC0094 m332() {
        if (this.f286 == null) {
    ...
    public final boolean m333(KeyEvent keyEvent) {
        return super.dispatchKeyEvent(keyEvent);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final void m334(CharSequence charSequence) {
        super.setTitle(charSequence);
        m332().mo242(charSequence);
    }
    ...
    @Override // androidx.appcompat.app.InterfaceC0096
    public final void onSupportActionModeFinished(AbstractC7809 abstractC7809) {
    }

    @Override // androidx.appcompat.app.InterfaceC0096
    public final void onSupportActionModeStarted(AbstractC7809 abstractC7809) {
    }
}
