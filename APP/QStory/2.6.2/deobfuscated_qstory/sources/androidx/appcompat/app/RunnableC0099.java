    ...
    public final void run() {
        ...
        switch (i) {
            ...
            case 6:
                ...
                try {
                    long j = Long.parseLong(String.valueOf(c5922.f16107.m11812(0, "replyDelay")));
                    if (j > 0) {
                        TimeUnit.MILLISECONDS.sleep(j);
                    }
                    String strSubstring = (String) c5922.f16107.m11812(null, "replyText");
            ...
            case 11:
                ...
                try {
                    String str2 = AbstractC3932.m8321("img") + "/" + c6329.f17442;
            ...
            case 15:
                ...
                try {
                    ...
                    AbstractC6154.m11561("\u6b63\u5728\u7b7e\u540d \u8bf7\u4e0d\u8981\u79bb\u5f00\u804a\u5929\u7a97\u53e3...");
                    String str6 = "https://api.lzlnb.cn/api/ark?url=" + URLEncoder.encode(str5) + "&yx=" + URLEncoder.encode(string);
                    String strM11902 = AbstractC6353.m11902(str6);
                    AbstractC6157.m11573(str6 + "->" + strM11902, "send ark");
                    QQNTSendMsgUtils.sendCard(QQSessionUtils.getCurrentContact(), strM11902);
                    return;
                } catch (Exception e2) {
                    AbstractC6154.m11561("\u7b7e\u540d\u5931\u8d25" + e2);
                    String strM6668 = "send ark";
            ...
            case 16:
                ...
                try {
                    ...
                    AbstractC6154.m11561("\u8bed\u97f3\u5df2\u4fdd\u5b58" + str8);
                    return;
                } catch (Exception e3) {
                    C5919.m11252(e3);
                    return;
            ...
            case 17:
                ...
                try {
                    String strM66682 = "msgRandom";
                    Class cls = Long.TYPE;
                    long jLongValue = ((Long) AbstractC6317.m11831(cls, strM66682, obj)).longValue();
                    long jLongValue2 = ((Long) AbstractC6317.m11831(cls, "clientSeq", obj)).longValue();
                    ...
                    Log.d("\u62a5\u9519\u53e3\u4ee4\u7ea2\u5305\u6253\u5f00", String.valueOf(e5));
                    return;
                }
            case 18:
            ...
            case 24:
                ...
                c9114.m14640(arrayList2, "CheckedTroopsToday");
                return;
            case 25:
                C9114 c91142 = ((C8710) obj2).f24569;
                ArrayList arrayListM14643 = c91142.m14643(String.class, "CheckedTroopsToday");
                ...
                c91142.m14640(arrayListM14643, "CheckedTroopsToday");
                return;
            case 26:
                C9114 c91143 = ((C8708) obj2).f24565;
                ArrayList arrayListM146432 = c91143.m14643(String.class, "CheckedTroopsToday");
                ...
                c91143.m14640(arrayListM146432, "CheckedTroopsToday");
                return;
            case 27:
