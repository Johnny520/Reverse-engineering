...
public class ActionBarOverlayLayout extends ViewGroup implements InterfaceC2251, InterfaceC2206 {
    ...
    static {
        ...
        c2220.mo4048(C7664.m12910(0, 1, 0, 1));
        f420 = c2220.mo4046();
        f419 = new Rect();
    }
    ...
    public static boolean m469(View view, Rect rect, boolean z) {
        boolean z2;
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        m477();
        C2225 c2225M4053 = C2225.m4053(this, windowInsets);
        boolean zM469 = m469(this.f441, new Rect(c2225M4053.m4057(), c2225M4053.m4055(), c2225M4053.m4056(), c2225M4053.m4058()), false);
        WeakHashMap weakHashMap = AbstractC2270.f6593;
        Rect rect = this.f430;
        AbstractC2193.m3995(this, c2225M4053, rect);
        int i = rect.left;
        int i2 = rect.top;
        int i3 = rect.right;
        int i4 = rect.bottom;
        C2238 c2238 = c2225M4053.f6520;
        C2225 c2225Mo4039 = c2238.mo4039(i, i2, i3, i4);
        this.f438 = c2225Mo4039;
        boolean z = true;
        if (!this.f437.equals(c2225Mo4039)) {
            this.f437 = this.f438;
            zM469 = true;
        }
        ...
        return c2238.mo4011().f6520.mo4007().f6520.mo4008().m4059();
    }
    ...
    */
    ...
    public final void onNestedScrollAccepted(View view, View view2, int i) {
        ...
        if (interfaceC0186 == null || (c7817 = (c0111 = (C0111) interfaceC0186).f338) == null) {
            return;
        }
        c7817.m13153();
        c0111.f338 = null;
    ...
    public void setIcon(int i) {
        ...
        c0146.f609 = i != 0 ? AbstractC3054.m6607(c0146.f612.getContext(), i) : null;
        c0146.m597();
    }
    ...
    public void setLogo(int i) {
        m477();
        C0146 c0146 = (C0146) this.f440;
        c0146.f608 = i != 0 ? AbstractC3054.m6607(c0146.f612.getContext(), i) : null;
        c0146.m597();
    }
        ...
        if (this.f447 == null) {
            ...
            if (callbackFindViewById instanceof InterfaceC0220) {
                ...
                if (!(callbackFindViewById instanceof Toolbar)) {
                    C5919.m11250("Can't make a decor toolbar out of ".concat(callbackFindViewById.getClass().getSimpleName()));
                    return;
                }
    ...
    public final void m478(Menu menu, InterfaceC7788 interfaceC7788) {
        m477();
        C0146 c0146 = (C0146) this.f440;
        Toolbar toolbar = c0146.f612;
        if (c0146.f614 == null) {
        ...
        c0197.f788 = interfaceC7788;
        MenuC7801 menuC7801 = (MenuC7801) menu;
        if (menuC7801 == null && toolbar.f511 == null) {
            return;
        }
        toolbar.m492();
        MenuC7801 menuC78012 = toolbar.f511.f461;
        if (menuC78012 == menuC7801) {
            return;
        }
        if (menuC78012 != null) {
            menuC78012.m13135(toolbar.f521);
            menuC78012.m13135(toolbar.f522);
        }
        ...
        if (menuC7801 != null) {
            menuC7801.m13127(c0197, context);
            menuC7801.m13127(toolbar.f522, toolbar.f496);
        } else {
            c0197.mo610(context, null);
            toolbar.f522.mo610(toolbar.f496, null);
            c0197.mo613();
            toolbar.f522.mo613();
        }
    ...
    public final void m479(Context context) {
