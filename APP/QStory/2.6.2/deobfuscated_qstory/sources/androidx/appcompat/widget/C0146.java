...
public final class C0146 implements InterfaceC0220 {
    ...
    public C0146(Toolbar toolbar, boolean z) {
        ...
        C0108 c0108M353 = C0108.m353(R.attr.actionBarStyle, 0, toolbar.getContext(), null, AbstractC7772.f21092);
        TypedArray typedArray = (TypedArray) c0108M353.f320;
        int i = 15;
        this.f615 = c0108M353.m389(15);
        if (z) {
            ...
            if (!TextUtils.isEmpty(text)) {
                ...
                if ((this.f611 & 8) != 0) {
                    ...
                    if (this.f617) {
                        AbstractC2270.m4231(toolbar.getRootView(), text);
                    }
                }
            }
            ...
            Drawable drawableM389 = c0108M353.m389(20);
            if (drawableM389 != null) {
                this.f608 = drawableM389;
                m597();
            }
            Drawable drawableM3892 = c0108M353.m389(17);
            if (drawableM3892 != null) {
                this.f609 = drawableM3892;
                m597();
            }
