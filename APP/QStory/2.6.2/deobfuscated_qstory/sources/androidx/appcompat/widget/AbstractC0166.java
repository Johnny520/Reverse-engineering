...
public abstract class AbstractC0166 extends ViewGroup {
    ...
    public AbstractC0166(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f671 = 0;
        this.f664 = 8388659;
        int[] iArr = AbstractC7772.f21099;
        C0108 c0108M353 = C0108.m353(0, 0, context, attributeSet, iArr);
        AbstractC2270.m4233(this, context, iArr, attributeSet, (TypedArray) c0108M353.f320, 0);
        ...
        setDividerDrawable(c0108M353.m389(5));
    ...
    public int getBaseline() {
        ...
        int i2 = this.f670;
        if (childCount <= i2) {
            C2632.m5294("mBaselineAlignedChildIndex of LinearLayout set to an index that is out of bounds.");
            return 0;
        }
        ...
        if (baseline == -1) {
            ...
            C2632.m5294("mBaselineAlignedChildIndex of LinearLayout points to a View that doesn't know how to get its baseline.");
            return 0;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f665 == 1) {
            ...
            while (i2 < virtualChildCount) {
                View childAt = getChildAt(i2);
                if (childAt != null && childAt.getVisibility() != 8 && m622(i2)) {
                    m621((childAt.getTop() - ((LinearLayout.LayoutParams) ((C0163) childAt.getLayoutParams())).topMargin) - this.f660, canvas);
                }
                i2++;
            }
            if (m622(virtualChildCount)) {
                View childAt2 = getChildAt(virtualChildCount - 1);
                m621(childAt2 == null ? (getHeight() - getPaddingBottom()) - this.f660 : childAt2.getBottom() + ((LinearLayout.LayoutParams) ((C0163) childAt2.getLayoutParams())).bottomMargin, canvas);
                return;
            }
            return;
        }
        ...
        while (i2 < virtualChildCount2) {
            ...
            if (childAt3 != null && childAt3.getVisibility() != 8 && m622(i2)) {
                C0163 c0163 = (C0163) childAt3.getLayoutParams();
                m620(z ? childAt3.getRight() + ((LinearLayout.LayoutParams) c0163).rightMargin : (childAt3.getLeft() - ((LinearLayout.LayoutParams) c0163).leftMargin) - this.f661, canvas);
            }
            i2++;
        }
        if (m622(virtualChildCount2)) {
    ...
    */
    ...
    public final void m620(int i, Canvas canvas) {
