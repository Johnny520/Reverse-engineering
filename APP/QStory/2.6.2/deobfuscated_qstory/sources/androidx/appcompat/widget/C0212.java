...
public final class C0212 {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public static C0140 m705(Context context, C0130 c0130, int i) {
    ...
    */
    public final void m706(android.util.AttributeSet r27, int r28) {
        /*
            Method dump skipped, instruction units count: 1170
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.C0212.m706(android.util.AttributeSet, int):void");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public final PorterDuff.Mode m707() {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final ColorStateList m708() {
        C0140 c0140 = this.f821;
        if (c0140 != null) {
    ...
    public final void m709() {
        ...
        if (c0140 != null || this.f817 != null || this.f816 != null || this.f815 != null) {
            ...
            m710(compoundDrawables[0], this.f818);
            m710(compoundDrawables[1], this.f817);
            m710(compoundDrawables[2], this.f816);
            m710(compoundDrawables[3], this.f815);
        }
        if (this.f814 == null && this.f822 == null) {
            return;
        }
        Drawable[] compoundDrawablesRelative = textView.getCompoundDrawablesRelative();
        m710(compoundDrawablesRelative[0], this.f814);
        m710(compoundDrawablesRelative[2], this.f822);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final void m710(Drawable drawable, C0140 c0140) {
        if (drawable == null || c0140 == null) {
            return;
        }
        C0130.m536(drawable, c0140, this.f819.getDrawableState());
    }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public final void m712(Context context, int i) {
        String string;
        ...
        if (typedArrayObtainStyledAttributes.hasValue(13) && (string = typedArrayObtainStyledAttributes.getString(13)) != null) {
            AbstractC0214.m716(textView, string);
        }
        c0108.m362();
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰, reason: contains not printable characters */
    public final void m713(PorterDuff.Mode mode) {
        if (this.f821 == null) {
            this.f821 = new C0140();
        }
        C0140 c0140 = this.f821;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public final void m714(Context context, C0108 c0108) {
        String string;
        int i = this.f826;
        ...
        if (!context.isRestricted()) {
            try {
                Typeface typefaceM387 = c0108.m387(i5, this.f826, new C0232(this, i6, i7, new WeakReference(this.f819)));
                if (typefaceM387 != null) {
                    if (i2 < 28 || this.f823 == -1) {
                        this.f824 = typefaceM387;
                    } else {
                        this.f824 = AbstractC0213.m715(Typeface.create(typefaceM387, 0), this.f823, (this.f826 & 2) != 0);
                    }
                }
        ...
        if (Build.VERSION.SDK_INT < 28 || this.f823 == -1) {
            ...
            this.f824 = AbstractC0213.m715(Typeface.create(string, 0), this.f823, (this.f826 & 2) != 0);
        }
    }
}
