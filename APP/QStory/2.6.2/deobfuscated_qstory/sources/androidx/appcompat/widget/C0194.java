...
public final class C0194 {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public void m695(AttributeSet attributeSet, int i) {
        int resourceId;
        int resourceId2;
        CompoundButton compoundButton = (CompoundButton) this.f761;
        Context context = compoundButton.getContext();
        int[] iArr = AbstractC7772.f21100;
        C0108 c0108M353 = C0108.m353(i, 0, context, attributeSet, iArr);
        TypedArray typedArray = (TypedArray) c0108M353.f320;
        AbstractC2270.m4233(compoundButton, compoundButton.getContext(), iArr, attributeSet, (TypedArray) c0108M353.f320, i);
        try {
            if (typedArray.hasValue(1) && (resourceId2 = typedArray.getResourceId(1, 0)) != 0) {
                try {
                    compoundButton.setButtonDrawable(AbstractC3054.m6607(compoundButton.getContext(), resourceId2));
                } catch (Resources.NotFoundException unused) {
                    if (typedArray.hasValue(0)) {
                        compoundButton.setButtonDrawable(AbstractC3054.m6607(compoundButton.getContext(), resourceId));
                    }
                }
            ...
            if (typedArray.hasValue(2)) {
                compoundButton.setButtonTintList(c0108M353.m384(2));
            }
            if (typedArray.hasValue(3)) {
                compoundButton.setButtonTintMode(AbstractC0216.m721(typedArray.getInt(3, -1), null));
            }
            c0108M353.m362();
        } catch (Throwable th) {
            c0108M353.m362();
    ...
    public Object m696() {
        ...
        AbstractC1374.m2496("Unexpected form of a provided value");
        C4210.m8612();
        return null;
    }
