...
public final class C0137 {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:111:0x021f, code lost:
        ...
        r11 = new android.graphics.SweepGradient(r8, r9, r0.f5293, r0.f5292);
     */
    ...
    */
    public static androidx.appcompat.widget.C0137 m559(android.content.res.Resources r30, int r31, android.content.res.Resources.Theme r32) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            Method dump skipped, instruction units count: 653
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.C0137.m559(android.content.res.Resources, int, android.content.res.Resources$Theme):androidx.appcompat.widget.飘花落叶言子世苏楪哲兰");
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰哲世, reason: contains not printable characters */
    public static int m561(String str) {
    ...
    public void m562(InterfaceC6551 interfaceC6551, int i) {
        int i2 = i & 33554431;
        ...
        for (int i4 = 0; i4 < jArr.length - 2 && i4 < i3; i4 += 3) {
            if ((((int) jArr[i4 + 2]) & 33554431) == i2) {
                long j = jArr[i4];
                long j2 = jArr[i4 + 1];
                interfaceC6551.invoke(Integer.valueOf((int) (j >> 32)), Integer.valueOf((int) j), Integer.valueOf((int) (j2 >> 32)), Integer.valueOf((int) j2));
                return;
            }
        }
    }
    ...
    public void m563(int i, int i2, long j) {
        int i3;
        char c;
        char c2;
        long[] jArr = (long[]) this.f595;
    ...
    public long m565(int i, int i2) {
        ...
        int i8 = i4 << 3;
        while (i5 < i8) {
            jM580 ^= (((long) ((byte[]) this.f594)[i6]) & 255) << i5;
            i5 += 8;
            i6++;
        }
        int i9 = (i & 7) << 3;
        return (jM580 << i9) | (jM580 >>> (64 - i9));
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public void m566(int i, int i2) {
        if (i > 131072) {
            AbstractC7740.m13069("Requested item capacity " + i + " is larger than max supported: 131072!");
        }
        ...
        if (iArr.length < i) {
            ...
            AbstractC4346.m8838(i2, 0, 12, (int[]) this.f595, iArr2);
            this.f595 = iArr2;
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public synchronized String m567(int i, byte[] bArr, int i2) {
        char[] cArr;
        int i3;
        int i4;
        try {
    ...
    public void m568() {
        ...
        if (drawable != null) {
            AbstractC0216.m722(drawable);
        }
        if (drawable == null || (c0140 = (C0140) this.f594) == null) {
            return;
        }
        C0130.m536(drawable, c0140, imageView.getDrawableState());
    }
    ...
    public void m572(int i, boolean z) {
        int i2 = i & 33554431;
        long[] jArr = (long[]) this.f595;
        int i3 = this.f596;
        for (int i4 = 0; i4 < jArr.length - 2 && i4 < i3; i4 += 3) {
    ...
    public void m575(int i, int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2, boolean z3, int i7) {
        long[] jArr = (long[]) this.f595;
        int i8 = this.f596;
        int i9 = i8 + 3;
        this.f596 = i9;
    ...
    public boolean m576(Object obj, InterfaceC5087 interfaceC5087) {
        interfaceC5087.getClass();
        C4511 c4511 = (C4511) this.f594;
        return ((((Number) ((InterfaceC5111) this.f595).get(obj)).intValue() >>> c4511.f13153) & ((1 << c4511.f13152) - 1)) == c4511.f13151;
    }
    ...
    public void m577(AttributeSet attributeSet, int i) {
        ...
        int[] iArr = AbstractC7772.f21087;
        C0108 c0108M353 = C0108.m353(i, 0, context, attributeSet, iArr);
        TypedArray typedArray = (TypedArray) c0108M353.f320;
        AbstractC2270.m4233(imageView, imageView.getContext(), iArr, attributeSet, (TypedArray) c0108M353.f320, i);
        try {
            Drawable drawable = imageView.getDrawable();
            if (drawable == null && (resourceId = typedArray.getResourceId(1, -1)) != -1 && (drawable = AbstractC3054.m6607(imageView.getContext(), resourceId)) != null) {
            ...
            if (typedArray.hasValue(2)) {
                imageView.setImageTintList(c0108M353.m384(2));
            }
            if (typedArray.hasValue(3)) {
                imageView.setImageTintMode(AbstractC0216.m721(typedArray.getInt(3, -1), null));
            }
            c0108M353.m362();
        } catch (Throwable th) {
            c0108M353.m362();
    ...
    public String m582(C4484 c4484, int i) {
        if (c4484 == null || i <= 0) {
            return m584(i);
        }
        byte[] bArr = (byte[]) this.f594;
        int i2 = this.f596;
        byte[] bArrM9067 = c4484.m9067(Arrays.copyOfRange(bArr, i2, i2 + i));
        String str = bArrM9067.length > 2048 ? new String(bArrM9067, StandardCharsets.UTF_8) : m567(0, bArrM9067, bArrM9067.length);
        this.f596 += i;
        return str;
    }
    ...
    public String m584(int i) {
        ...
        byte[] bArr = (byte[]) this.f594;
        String str = i > 2048 ? new String(bArr, this.f596, i, StandardCharsets.UTF_8) : m567(this.f596, bArr, i);
        this.f596 += i;
        return str;
    }
    ...
    public C0137(ArrayList arrayList, int i, MotionEvent motionEvent) {
        ...
        if (arrayList.isEmpty()) {
            C5919.m11249("changes cannot be empty");
            throw null;
        }
    }

    public C0137(MutablePropertyReference1Impl mutablePropertyReference1Impl, C4511 c4511) {
        this.f597 = 6;
        mutablePropertyReference1Impl.getClass();
        this.f595 = mutablePropertyReference1Impl;
        this.f594 = c4511;
        if (c4511.f13152 == 1 && c4511.f13151 == 1) {
            this.f596 = 1 << c4511.f13153;
        } else {
    ...
    public C0137(int i, C8378 c8378, C0137 c0137) {
        this.f597 = 11;
        this.f596 = i;
        this.f595 = c8378;
        this.f594 = c0137;
    ...
    public C0137(C3003 c3003) {
        this.f597 = 4;
        this.f594 = AbstractC7970.m13433(150, new C2242(this, 8));
        this.f595 = c3003;
    }
}
