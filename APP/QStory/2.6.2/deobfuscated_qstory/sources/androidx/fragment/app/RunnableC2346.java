        ...
        switch (this.f6949) {
            ...
            case 4:
                ...
                try {
                    ...
                    String string = jSONObjectM6316.getString("pre_grap_token");
                    c8809.f24793 = string;
                    if (string == null) {
                        return;
                    }
                    long j = Long.parseLong(String.valueOf(c5922.f16107.m11812(0, "expectAmount")));
                    if (j > 0) {
                    ...
                    TimeUnit.MILLISECONDS.sleep(Long.parseLong(String.valueOf(c5922.f16107.m11812(0, "delay"))));
            ...
            case 9:
                ...
                try {
                    AbstractC6317.m11835(obj, "I", Boolean.TYPE, Boolean.TRUE);
                    method.invoke(obj, null);
                    return;
                } catch (Exception e2) {
                    AbstractC6154.m11561("\u8df3\u5e7f\u544a\u9519\u8bef:" + e2);
            ...
            case 12:
                ...
                if (((ArrayList) ref$ObjectRef.element).isEmpty()) {
                    AbstractC8210.m13718("\u597d\u53cb\u5217\u8868\u4e3a\u7a7a", WaitDialog$TYPE.WARNING);
                    return;
                }
                ArrayList arrayList = (ArrayList) ref$ObjectRef.element;
                Map map = (Map) ref$ObjectRef2.element;
                C8207 c8207 = new C8207();
                c8207.f22615 = "\u6279\u91cf\u7ba1\u7406\u597d\u53cb (" + arrayList.size() + ')';
                c8207.mo13704();
                c8207.f22627 = "\u52fe\u9009\u9700\u8981\u5220\u9664\u7684\u597d\u53cb";
                c8207.mo13704();
                c8207.mo13703(true);
