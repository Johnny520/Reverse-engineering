...
public final class C0282 implements Cloneable {
    ...
    public final Object m856(int i) {
    ...
    public final void m857(int i, Object obj) {
        int iM13096 = AbstractC7771.m13096(this.f992, this.f991, i);
        if (iM13096 >= 0) {
            this.f990[iM13096] = obj;
            return;
        }
        int i2 = ~iM13096;
        int i3 = this.f991;
        ...
        if (i8 - i2 != 0) {
            int[] iArr = this.f992;
            int i9 = i2 + 1;
            AbstractC4346.m8842(i9, i2, i8, iArr, iArr);
            Object[] objArr2 = this.f990;
            AbstractC4346.m8839(i9, i2, objArr2, this.f991, objArr2);
        }
        this.f992[i2] = i;
        this.f990[i2] = obj;
        this.f991++;
    ...
    public final Object m858(int i) {
        Object obj;
        int iM13096 = AbstractC7771.m13096(this.f992, this.f991, i);
        if (iM13096 < 0 || (obj = this.f990[iM13096]) == AbstractC0267.f960) {
            return null;
        }
        return obj;
    }
    ...
    public final void m860(int i, ColorStateList colorStateList) {
        int i2 = this.f991;
        if (i2 != 0 && i <= this.f992[i2 - 1]) {
            m857(i, colorStateList);
            return;
        }
