...
public final class C0241 implements List, InterfaceC6564 {
    ...
    public final boolean contains(Object obj) {
        ...
        switch (i) {
            case 0:
                int i3 = this.f890;
                while (i2 < i3) {
                    if (!AbstractC4394.m8917(list.get(i2), obj)) {
                        i2++;
                    }
                    break;
                }
        ...
        switch (i) {
            case 0:
                ...
                for (int i4 = i2; i4 < i3; i4++) {
                    if (AbstractC4394.m8917(list.get(i4), obj)) {
                        return i4 - i2;
                    }
                }
                return -1;
            default:
                ...
                for (int i6 = i2; i6 < i5; i6++) {
                    if (AbstractC4394.m8917(list.get(i6), obj)) {
                        return i6 - i2;
                    }
                }
                return -1;
    ...
    public final int lastIndexOf(Object obj) {
        ...
        switch (i) {
            case 0:
                int i3 = this.f890 - 1;
                if (i2 <= i3) {
                    while (!AbstractC4394.m8917(list.get(i3), obj)) {
                        if (i3 != i2) {
                            i3--;
                        }
                    }
            ...
            default:
                int i4 = this.f890 - 1;
                if (i2 <= i4) {
                    while (!AbstractC4394.m8917(list.get(i4), obj)) {
                        if (i4 != i2) {
                            i4--;
                        }
                    }
