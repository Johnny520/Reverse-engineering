...
public final class Lifecycle$Event {
    ...
    static {
        ...
        $ENTRIES = AbstractC4363.m8876(lifecycle$EventArr$values);
        Companion = new C2397();
    }
    ...
    public static final Lifecycle$Event downFrom(Lifecycle$State lifecycle$State) {
        Companion.getClass();
        return C2397.m4502(lifecycle$State);
    }
    ...
    public final Lifecycle$State getTargetState() {
        switch (AbstractC2401.f7044[ordinal()]) {
            case 1:
            case 2:
            ...
            case 7:
                C0276.m837(this, " has no target state");
                return null;
            default:
                C4210.m8621();
                return null;
