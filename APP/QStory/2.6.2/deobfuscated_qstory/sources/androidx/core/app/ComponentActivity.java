...
public class ComponentActivity extends Activity implements InterfaceC2388, InterfaceC2256 {
    ...
    */
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        decorView.getClass();
        if (AbstractC2267.m4217(decorView, event)) {
            return true;
        }
        return AbstractC2267.m4216(this, decorView, this, event);
    }
    ...
    @InterfaceC5168
    public <T extends AbstractC7650> T getExtraData(Class<T> extraDataClass) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.getClass();
        this.lifecycleRegistry.m4495(Lifecycle$State.CREATED);
        super.onSaveInstanceState(outState);
    }

    @InterfaceC5168
    public void putExtraData(AbstractC7650 extraData) {
        throw null;
    }
