...
public class C6360 extends AbstractC6298 implements InterfaceC6152 {
    ...
    public final void mo11179(C3069 c3069) {
        f17485 = c3069.m6902("Menu_Item_Class");
    }

    @Override // p009.InterfaceC6152
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰 */
    public final void mo11180(C3069 c3069) {
        for (Method method : C3069.m6899("QQCustomMenuItem{title='")) {
            if (method.getDeclaringClass().getName().startsWith("com.tencent.qqnt.aio.menu.ui")) {
                c3069.m6900(method, "Menu_Item_Class");
                return;
            }
        }
    }
