...
public abstract class AbstractC6353 {
    ...
    public static String m11902(String str) {
        try {
            ...
            c1245.m2141(str);
            c1245.m2148("GET", null);
            c1245.m2156("User-Agent", "Mozilla/5.0 (Linux; Android 14; V2309) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36");
            c1245.m2156("Accept", "*/*");
            c1245.m2156("Connection", "keep-alive");
            C6204 c6204M11615 = new C6177(c6200, new C6198(c1245)).m11615();
            String strM11648 = c6204M11615.f17009.m11648();
    ...
    public static void m11903(String str, String str2) {
        ...
        C1245 c1245 = new C1245(6);
        c1245.m2141(str);
        c1245.m2156("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36");
        c1245.m2156("Accept", "*/*");
        c1245.m2156("Connection", "keep-alive");
        try {
            C6204 c6204M11615 = new C6177(c6200, new C6198(c1245)).m11615();
