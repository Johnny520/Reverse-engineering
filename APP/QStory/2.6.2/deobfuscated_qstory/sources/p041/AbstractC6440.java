...
public abstract class AbstractC6440 {
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static void m11938(final String str, final String str2, final String str3, final String str4, final String str5) {
        ...
        XposedHelpers.callMethod(intentM11863, "setObserver", new Class[]{AbstractC6318.m11838("mqq.observer.BusinessObserver")}, new Object[]{Proxy.newProxyInstance(AbstractC6318.f17411, new Class[]{AbstractC6318.m11838("mqq.observer.BusinessObserver")}, new InvocationHandler() { // from class: 飘花落叶言世哲苏子兰楪.飘花落叶言子楪世苏哲兰
            ...
            public final Object invoke(Object obj, Method method, Object[] objArr) throws JSONException {
                ...
                XposedHelpers.callMethod(objM113922, "mergeFrom", new Class[]{byte[].class}, new Object[]{byteArray});
                ...
                if (jSONObject.optString("retcode").equals("0") && jSONObject.has("pre_grap_token")) {
                    ...
                    sb2.append(0);
                    AbstractC6136.m11544(-3937612977537287591L, sb2, str4);
                    AbstractC6136.m11544(-3937612852983236007L, sb2, str2);
                    sb2.append("&pre_grap_token=");
                    sb2.append(URLEncoder.encode(string));
                    String str6 = str5;
                    AbstractC6136.m11544(-3937612694069446055L, sb2, str6);
                    ...
                    AbstractC6136.m11544(-3937602532176823719L, sb2, str7);
                    sb2.append("&uin=");
                    sb2.append(str8);
