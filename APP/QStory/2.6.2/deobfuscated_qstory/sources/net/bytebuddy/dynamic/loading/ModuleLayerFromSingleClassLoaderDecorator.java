    ...
    public enum Factory implements ClassLoaderDecorator.Factory {
        ...
        public ClassLoaderDecorator make(@MaybeNull ClassLoader classLoader, Map<String, byte[]> map) {
            ...
            try {
                ...
                C8796.m14449("Failed to create module layer", e);
                return null;
            }
        }
    }
    ...
    */
    public boolean equals(@net.bytebuddy.utility.nullability.MaybeNull java.lang.Object r5) {
        ...
        L32:
            ...
            return r1
        L3d:
            java.util.Set<java.lang.String> r4 = r4.packages
    ...
    public int hashCode() {
        ...
        return this.packages.hashCode() + AbstractC6136.m11539((this.moduleLayer.hashCode() + (iHashCode * 31)) * 31, 31, this.name);
    }
