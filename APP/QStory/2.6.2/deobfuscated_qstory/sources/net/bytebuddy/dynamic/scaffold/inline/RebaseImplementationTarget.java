...
public class RebaseImplementationTarget extends Implementation.Target.AbstractBase {
    ...
    public static class RebasedMethodInvocation extends Implementation.SpecialMethodInvocation.AbstractBase {
        ...
        public static Implementation.SpecialMethodInvocation of(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription, TypeList typeList) {
        ...
        public JavaConstant.MethodHandle toMethodHandle() {
            ...
            return zIsStatic ? JavaConstant.MethodHandle.of(inDefinedShape) : JavaConstant.MethodHandle.ofSpecial(inDefinedShape, this.instrumentedType);
        }
