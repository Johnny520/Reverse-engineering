...
public abstract class InvocationHandlerAdapter implements Implementation.Composable {
    ...
    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription, StackManipulation stackManipulation, FieldDescription fieldDescription) {
        if (methodDescription.isStatic() || methodDescription.isConstructor()) {
            C5919.m11250(AbstractC2442.m4562("It is not possible to apply an invocation handler onto the static method or constructor ", methodDescription));
            return null;
        }
    ...
    public int hashCode() {
        return this.assigner.hashCode() + ((((((AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.fieldName) + (this.cached ? 1 : 0)) * 31) + (this.privileged ? 1 : 0)) * 31) + (this.returning ? 1 : 0)) * 31);
    }
    ...
    public static class ForField extends InvocationHandlerAdapter implements WithoutPrivilegeConfiguration {
        ...
        public ByteCodeAppender appender(Implementation.Target target) {
            ...
            if (!resolutionLocate.isResolved()) {
                C0276.m846("Could not find a field named '", this.fieldName, "' for ", target.getInstrumentedType());
                return null;
            }
            ...
            C2308.m4344(resolutionLocate.getField(), "Field ", " does not declare a type that is assignable to invocation handler");
            return null;
        }
    ...
    public static class ForInstance extends InvocationHandlerAdapter implements WithoutPrivilegeConfiguration {
        ...
        public class Appender implements ByteCodeAppender {
            ...
            public int hashCode() {
                return ForInstance.this.hashCode() + AbstractC2442.m4574(this.instrumentedType, getClass().hashCode() * 31, 31);
            }
        }
        ...
        public InstrumentedType prepare(InstrumentedType instrumentedType) {
            ...
            C2308.m4342(AbstractC6136.m11550("Field with name ", str, " and type "), InvocationHandlerAdapter.INVOCATION_HANDLER_TYPE.asErasure(), " already declared by ", instrumentedType);
            return null;
        }
