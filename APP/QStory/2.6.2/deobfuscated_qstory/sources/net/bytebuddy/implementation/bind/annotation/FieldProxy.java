...
public @interface FieldProxy {
    ...
    public static class Binder extends TargetMethodAnnotationDrivenBinder.ParameterBinder.ForFieldBinding<FieldProxy> {
        ...
        public static class AccessorProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public int hashCode() {
                return AbstractC2442.m4579(this.assigner, (this.fieldResolver.hashCode() + AbstractC2442.m4574(this.instrumentedType, (this.fieldDescription.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31, 31) + (this.serializableProxy ? 1 : 0);
            }
        ...
        public interface FieldResolver {
            ...
            public interface Factory {
                ...
                public static class Duplex implements Factory {
                    ...
                    public int hashCode() {
                        return this.setterMethod.hashCode() + AbstractC2442.m4558(this.getterMethod, AbstractC2442.m4574(this.proxyType, getClass().hashCode() * 31, 31), 31);
                    }
                    ...
                    public FieldResolver resolve(TypeDescription typeDescription, FieldDescription fieldDescription) {
                        ...
                        C5919.m11250("Cannot use @FieldProxy on a non-installed type");
                        return null;
                    }
                }
                ...
                public static class Simplex implements Factory {
                    ...
                    public int hashCode() {
                        return this.setterMethod.hashCode() + AbstractC2442.m4558(this.getterMethod, getClass().hashCode() * 31, 31);
                    }
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(TypeDescription typeDescription) {
            ...
            if (!typeDescription.isPublic()) {
                C5919.m11249(AbstractC2442.m4554(typeDescription, " is not public"));
                return null;
            }
            ...
            if (methodListFilter.size() != 2) {
                C5919.m11249(AbstractC2442.m4554(typeDescription, " does not declare exactly two non-abstract methods"));
                return null;
            }
            ...
            if (methodListFilter2.size() != 1) {
                C5919.m11249(AbstractC2442.m4554(typeDescription, " does not declare a getter with an Object type"));
                return null;
            }
            ...
            C5919.m11249(AbstractC2442.m4554(typeDescription, " does not declare a setter with an Object type"));
            return null;
        }
        ...
        public static class FieldGetter implements Implementation {
            ...
            public class Appender implements ByteCodeAppender {
                ...
                public int hashCode() {
                    return FieldGetter.this.hashCode() + AbstractC2442.m4574(this.typeDescription, getClass().hashCode() * 31, 31);
                }
            }
            ...
            public int hashCode() {
                return this.methodAccessorFactory.hashCode() + AbstractC2442.m4579(this.assigner, (this.fieldDescription.hashCode() + (getClass().hashCode() * 31)) * 31, 31);
            }
        ...
        public static class FieldSetter implements Implementation {
            ...
            public class Appender implements ByteCodeAppender {
                ...
                public int hashCode() {
                    return FieldSetter.this.hashCode() + AbstractC2442.m4574(this.typeDescription, getClass().hashCode() * 31, 31);
                }
            }
            ...
            if (inDefinedShapeOnlyMethod.getReturnType().asErasure().represents(Object.class)) {
                if (inDefinedShapeOnlyMethod.getParameters().size() == 0) {
                    ...
                    if (inDefinedShapeOnlyMethod2.getReturnType().asErasure().represents(Void.TYPE)) {
                        ...
                        C0276.m837(inDefinedShapeOnlyMethod2, " must declare a single Object-typed parameters");
                        return null;
                    }
                    C0276.m837(inDefinedShapeOnlyMethod2, " must return void");
                    return null;
                }
                C0276.m837(inDefinedShapeOnlyMethod, " must not declare parameters");
                return null;
            }
            C0276.m837(inDefinedShapeOnlyMethod, " must take a single Object-typed parameter");
            return null;
        }
    }
}
