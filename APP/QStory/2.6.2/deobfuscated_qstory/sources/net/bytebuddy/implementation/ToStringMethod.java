...
public class ToStringMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            if (methodDescription.isStatic()) {
                C5919.m11250(AbstractC2442.m4562("toString method must not be static: ", methodDescription));
                return null;
            }
            if (!methodDescription.getReturnType().asErasure().isAssignableFrom(String.class)) {
                C5919.m11250(AbstractC2442.m4562("toString method does not return String-compatible type: ", methodDescription));
                return null;
            }
        ...
        public int hashCode() {
            return this.fieldDescriptions.hashCode() + AbstractC6136.m11539(AbstractC6136.m11539(AbstractC6136.m11539(AbstractC6136.m11539(AbstractC6136.m11539(getClass().hashCode() * 31, 31, this.prefix), 31, this.start), 31, this.end), 31, this.separator), 31, this.definer);
        }
    }
    ...
    public static ToStringMethod prefixedBy(String str) {
        ...
        C5919.m11249("Prefix cannot be null");
        return null;
    }
    ...
    public Appender appender(Implementation.Target target) {
        if (target.getInstrumentedType().isInterface()) {
            C4210.m8615(target.getInstrumentedType(), "Cannot implement meaningful toString method for ");
            return null;
        }
        ...
        C5919.m11250("Prefix for toString method cannot be null");
        return null;
    }
    ...
    public int hashCode() {
        return this.ignored.hashCode() + AbstractC6136.m11539(AbstractC6136.m11539(AbstractC6136.m11539(AbstractC6136.m11539((this.prefixResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31, this.start), 31, this.end), 31, this.separator), 31, this.definer);
    }
    ...
    public Implementation withTokens(String str, String str2, String str3, String str4) {
        ...
        C5919.m11249("Token values cannot be null");
        return null;
    }
