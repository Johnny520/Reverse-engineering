...
public interface JavaConstant extends ConstantValue {
    ...
    public static class MethodType implements JavaConstant {
        ...
        public static MethodType ofAsm(TypePool typePool, Type type) {
            ...
            if (type.getSort() != 11) {
                C4210.m8614(type, "Not a method type description: ");
                return null;
            }
        ...
        public static MethodType ofLoaded(Object obj) {
            ...
            C5919.m11249(AbstractC0053.m153(obj, "Expected method type object: "));
            return null;
        }
    ...
    public static class MethodHandle implements JavaConstant {
        ...
        public static MethodHandle ofLoaded(Object obj, Object obj2) {
            if (!JavaType.METHOD_HANDLE.isInstance(obj)) {
                C5919.m11249(AbstractC0053.m153(obj, "Expected method handle object: "));
                return null;
            }
            if (!JavaType.METHOD_HANDLES_LOOKUP.isInstance(obj2)) {
                C5919.m11249(AbstractC0053.m153(obj2, "Expected method handle lookup object: "));
                return null;
            }
        ...
        public static MethodHandle ofSpecial(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription) {
            ...
            C5553.m10817("Cannot specialize ", inDefinedShape, " for ", typeDescription);
            return null;
        }
        ...
        public int hashCode() {
            return this.parameterTypes.hashCode() + AbstractC2442.m4574(this.returnType, AbstractC6136.m11539(AbstractC2442.m4574(this.ownerType, this.handleType.hashCode() * 31, 31), 31, this.name), 31);
        }
        ...
        public enum HandleType {
            ...
            public static HandleType of(MethodDescription.InDefinedShape inDefinedShape) {
                ...
                C4210.m8614(inDefinedShape, "Cannot create handle of type initializer ");
                return null;
            }
            ...
            public static HandleType ofSpecial(MethodDescription.InDefinedShape inDefinedShape) {
                ...
                C8796.m14448(inDefinedShape, "Cannot invoke ", " via invokespecial");
                return null;
            }
            ...
            public static HandleType of(int i) {
                ...
                C5919.m11249(AbstractC6136.m11556(i, "Unknown handle type: "));
                return null;
            }
        }
    ...
    public static abstract class Simple<T> implements JavaConstant {
        ...
        public static JavaConstant of(TypeDescription typeDescription) {
            ...
            C5919.m11249(AbstractC2442.m4566("A primitive type cannot be represented as a type constant: ", typeDescription));
            return null;
        }
        ...
        public static JavaConstant ofAsm(TypePool typePool, Object obj) {
            ...
            if (!(obj instanceof Type)) {
                ...
                C5919.m11249(AbstractC0053.m153(obj, "Not an ASM constant: "));
                return null;
            }
            Type type = (Type) obj;
            if (type.getSort() == 11) {
            ...
            return of(typePool.describe(sb.toString()).resolve());
        }
        ...
        public static JavaConstant ofDescription(Object obj, TypePool typePool) {
            ...
            if (ofMethodTypeDesc.isInstance(obj)) {
                ...
                return MethodType.of(typePool.describe(type3.getSort() == 9 ? type3.getInternalName().replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH) : type3.getClassName()).resolve(), arrayList);
            }
            ...
            if (ofDirectMethodHandleDesc.isInstance(obj)) {
                ...
                return new MethodHandle(MethodHandle.HandleType.of(ofDirectMethodHandleDesc2.refKind(obj)), typePool.describe(Type.getType(ofClassDesc2.descriptorString(ofDirectMethodHandleDesc2.owner(obj))).getClassName()).resolve(), ofDirectMethodHandleDesc2.methodName(obj), ofDirectMethodHandleDesc2.refKind(obj) == 8 ? TypeDescription.ForLoadedType.of(Void.TYPE) : typePool.describe(type5.getSort() == 9 ? type5.getInternalName().replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH) : type5.getClassName()).resolve(), arrayList2);
            }
            Dispatcher.OfDynamicConstantDesc ofDynamicConstantDesc = DYNAMIC_CONSTANT_DESC;
            if (!ofDynamicConstantDesc.isInstance(obj)) {
                C5919.m11249(AbstractC0053.m153(obj, "Not a resolvable constant description or not expressible as a constant pool value: "));
                return null;
            }
        ...
        public static JavaConstant ofLoaded(Object obj) {
            ...
            C5919.m11249(AbstractC0053.m153(obj, "Not a constant: "));
            return null;
        }
    ...
    public static class Dynamic implements JavaConstant {
        ...
        public static Dynamic bootstrap(String str, MethodDescription.InDefinedShape inDefinedShape, List<?> list) {
            if (str.length() == 0 || str.contains(".")) {
                C5919.m11249("Not a valid field name: ".concat(str));
                return null;
            }
            ArrayList arrayList = new ArrayList(list.size());
            Iterator<?> it = list.iterator();
            ...
            C5553.m10817("Not a valid bootstrap method ", inDefinedShape, " for ", list);
            return null;
        }
        ...
        public static JavaConstant ofArrayVarHandle(TypeDescription typeDescription) {
            ...
            C5919.m11249(AbstractC2442.m4566("Not an array type: ", typeDescription));
            return null;
        }
        ...
        public static Dynamic ofField(FieldDescription.InDefinedShape inDefinedShape) {
            ...
            C4210.m8614(inDefinedShape, "Field must be static and final: ");
            return null;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:41:0x00cd, code lost:
            ...
            r6.add(net.bytebuddy.utility.JavaConstant.MethodHandle.of(r13));
            r7 = r14.iterator();
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:47:0x0104, code lost:
            ...
            lin.xposed.hook.javaplugin.C5553.m10817("Cannot assign ", r14, " to ", r13);
         */
        ...
        */
        ...
        public static JavaConstant ofPrimitiveType(TypeDescription typeDescription) {
            ...
            C5919.m11249(AbstractC2442.m4566("Not a primitive type: ", typeDescription));
            return null;
        }
        ...
        public int hashCode() {
            return this.arguments.hashCode() + ((this.bootstrap.hashCode() + AbstractC2442.m4574(this.typeDescription, this.name.hashCode() * 31, 31)) * 31);
        }
        ...
        public JavaConstant withType(TypeDescription typeDescription) {
            if (typeDescription.represents(Void.TYPE)) {
                C5919.m11249("Constant value cannot represent void");
                return null;
            }
            ...
            C5553.m10819(sb, " is not compatible with bootstrapped type ", getTypeDescription());
            return null;
        }
