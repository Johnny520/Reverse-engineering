...
public class ClassFileVersion implements Comparable<ClassFileVersion>, Serializable {
    ...
    public static ClassFileVersion ofClassFile(byte[] bArr) {
        ...
        C5919.m11249(AbstractC0053.m147(new StringBuilder("Supplied byte array is too short to be a class file with "), " byte", bArr.length));
        return null;
    }

    public static ClassFileVersion ofJavaVersion(int i) {
        if (i < 1) {
            C5919.m11249(AbstractC6136.m11556(i, "Java version must be positive: "));
            return null;
        }
        int i2 = i - 1;
    ...
    public static ClassFileVersion ofJavaVersionString(String str) {
        ...
        try {
            ...
            C8796.m14449("Failed to read Java version from: ".concat(str), e);
            return null;
        }
    }
    ...
    public static ClassFileVersion ofMinorMajor(int i) {
        ...
        C5919.m11249(AbstractC0053.m161(i, "Class version ", " is not valid"));
        return null;
    }
    ...
    public short getMajorVersion() {
        return (short) (this.versionNumber & com.android.dx.io.Opcodes.MAX_VALUE);
    }
