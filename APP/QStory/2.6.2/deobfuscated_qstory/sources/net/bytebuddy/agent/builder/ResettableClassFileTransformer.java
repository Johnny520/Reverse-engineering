                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public Substitutable make(ResettableClassFileTransformer resettableClassFileTransformer) {
                        try {
                            ...
                            C5553.m10828("Cannot access ", this.substitutable, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C5553.m10828("Cannot instantiate ", this.substitutable.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C8796.m14449("Cannot invoke " + this.substitutable, e3.getTargetException());
                            return null;
                        }
                    }
                }
                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public ResettableClassFileTransformer make(ResettableClassFileTransformer resettableClassFileTransformer, Callback<?> callback) {
                        try {
                            ...
                            C5553.m10828("Cannot access ", this.withCallback, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C5553.m10828("Cannot instantiate ", this.withCallback.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C8796.m14449("Cannot invoke " + this.withCallback, e3.getTargetException());
                            return null;
                        }
                    }
                }
