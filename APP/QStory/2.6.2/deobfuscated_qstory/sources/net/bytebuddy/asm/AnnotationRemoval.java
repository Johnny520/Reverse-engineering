...
public class AnnotationRemoval extends AsmVisitorWrapper.AbstractBase {
    ...
    public int hashCode() {
        return AbstractC2442.m4576(this.annotationMatcher, AbstractC2442.m4576(this.methodMatcher, AbstractC2442.m4576(this.fieldMatcher, ((getClass().hashCode() * 31) + (this.type ? 1 : 0)) * 31, 31), 31), 31) + this.parameters;
    }
    ...
    public AsmVisitorWrapper onInvokableParameter(ElementMatcher<? super MethodDescription> elementMatcher, int i) {
        ...
        C5919.m11249(AbstractC6136.m11556(i, "Parameter index cannot be negative: "));
        return null;
    }
