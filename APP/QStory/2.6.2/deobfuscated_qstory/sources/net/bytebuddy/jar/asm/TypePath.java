...
public final class TypePath {
    ...
    public int getStep(int i) {
        return this.typePathContainer[AbstractC6136.m11541(i, 2, this.typePathOffset, 1)];
    }

    public int getStepArgument(int i) {
        return this.typePathContainer[AbstractC6136.m11541(i, 2, this.typePathOffset, 2)];
    }
