...
public abstract class ClassVisitor {
    ...
    public void visit(int i, int i2, String str, String str2, String str3, String[] strArr) {
        if (this.api < 524288 && (65536 & i2) != 0) {
            C5919.m11247("Records requires ASM8");
            return;
        }
    ...
    public ModuleVisitor visitModule(String str, int i, String str2) {
        if (this.api < 393216) {
            C5919.m11247("Module requires ASM6");
            return null;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
    ...
    public void visitNestHost(String str) {
        if (this.api < 458752) {
            C5919.m11247("NestHost requires ASM7");
            return;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
    ...
    public void visitNestMember(String str) {
        if (this.api < 458752) {
            C5919.m11247("NestMember requires ASM7");
            return;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
    ...
    public void visitPermittedSubclass(String str) {
        if (this.api < 589824) {
            C5919.m11247("PermittedSubclasses requires ASM9");
            return;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
    ...
    public RecordComponentVisitor visitRecordComponent(String str, String str2, String str3) {
        if (this.api < 524288) {
            C5919.m11247("Record requires ASM8");
            return null;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
    ...
    public AnnotationVisitor visitTypeAnnotation(int i, TypePath typePath, String str, boolean z) {
        if (this.api < 327680) {
            C5919.m11247("TypeAnnotation requires ASM5");
            return null;
        }
        ClassVisitor classVisitor = this.cv;
        if (classVisitor != null) {
