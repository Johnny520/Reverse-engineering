...
public interface MethodDescription extends TypeVariableSource, ModifierReviewable.ForMethodDescription, DeclaredByType.WithMandatoryDeclaration, ByteCodeElement.Member, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class SignatureToken {
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                iM4574 = AbstractC2442.m4574(this.returnType, this.name.hashCode() * 31, 31) + this.parameterTypes.hashCode();
            }
            if (iM4574 == 0) {
                return this.hashCode;
            }
            this.hashCode = iM4574;
            return iM4574;
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                int iHashCode = (this.annotations.hashCode() + ((this.exceptionTypes.hashCode() + ((this.parameterTokens.hashCode() + AbstractC2442.m4575(this.returnType, (this.typeVariableTokens.hashCode() + (((this.name.hashCode() * 31) + this.modifiers) * 31)) * 31, 31)) * 31)) * 31)) * 31;
                AnnotationValue<?, ?> annotationValue = this.defaultValue;
