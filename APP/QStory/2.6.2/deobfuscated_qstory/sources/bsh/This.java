...
public final class This implements Serializable, Runnable {
    ...
    static final ThreadLocal<Map<String, Object[]>> CONTEXT_ARGS = ThreadLocal.withInitial(new C2631(1));
    ...
    public class Handler implements InvocationHandler, Serializable {
        ...
        public Object invokeImpl(Object obj, Method method, Object[] objArr) {
            ...
            BshMethod bshMethodM5405 = AbstractC2666.m5405(This.this.namespace, "equals", new Class[]{Object.class}, true);
            if (name.equals("equals") && bshMethodM5405 == null) {
                return Boolean.valueOf(obj == objArr[0]);
            }
            BshMethod bshMethodM54052 = AbstractC2666.m5405(This.this.namespace, "toString", new Class[0], true);
            if (!name.equals("toString") || bshMethodM54052 != null) {
    ...
    public static ConstructorArgs getConstructorArgs(Class<?> cls, This r17, Object[] objArr, int i) {
        if (r17 == null) {
            C2632.m5297("Unititialized class: no static");
            return null;
        }
        if (i == -1) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < objArr.length; i2++) {
                try {
                    ...
                    C2632.m5293("err setting local cons arg:", e);
                    return null;
                }
            }
            ...
            if (argsNode != null) {
                try {
                    ...
                    C2632.m5293("Error evaluating constructor args: ", e2);
                    return null;
                }
            }
            Class[] clsArrM5351 = AbstractC2661.m5351(constructorArgs);
            Object[] objArrUnwrap = Primitive.unwrap(constructorArgs);
            if (altConstructor.equals("super")) {
                int iM5395 = AbstractC2666.m5395(clsArrM5351, ((C2655) C2659.f7958.m13853(cls)).m5316(cls.getName()));
                if (iM5395 != -1) {
                    return new ConstructorArgs(iM5395, objArrUnwrap);
                }
                C2632.m5297("can't find super constructor for args!");
                return null;
            }
            int iM5396 = AbstractC2666.m5396(clsArrM5351, Arrays.asList(delayedEvalBshMethodArr));
            if (iM5396 == -1) {
                C2632.m5297("can't find this constructor for args!");
                return null;
            }
            int size = ((C2655) C2659.f7958.m13853(cls)).m5316(cls.getName()).size();
            int i3 = iM5396 + size;
            if (i3 != size + i) {
                return new ConstructorArgs(i3, objArrUnwrap);
            }
            C2632.m5297("Recursive constructor call.");
            return null;
        } catch (Exception e3) {
            C2632.m5293("Unable to get instance initializers: ", e3);
            return null;
        }
    }
    ...
    public static This initClassInstanceThis(Object obj, String str) {
        This thisM5393 = AbstractC2666.m5393(obj, str);
        if (thisM5393 != null) {
            return thisM5393;
        }
        This thisM5411 = AbstractC2666.m5411(obj.getClass(), str);
        NameSpace nameSpaceCopy = thisM5411.getNameSpace().copy();
        ...
        This r2 = threadLocal2.get() != null ? nameSpaceCopy.getThis(threadLocal2.get()) : nameSpaceCopy.getThis(thisM5411.declaringInterpreter);
        try {
            AbstractC2666.m5414(obj, Keys.BSHTHIS + str).assign(r2, false);
            nameSpaceCopy.setClassInstance(obj);
            try {
                BSHBlock bSHBlock = (BSHBlock) thisM5411.getNameSpace().getVariable(Keys.BSHINIT.toString());
                try {
                    CallStack callStack = new CallStack(nameSpaceCopy);
                    Interpreter interpreter = r2.declaringInterpreter;
                    Boolean bool = Boolean.TRUE;
                    bSHBlock.evalBlock(callStack, interpreter, bool, C2651.f7935);
                    bSHBlock.evalBlock(new CallStack(nameSpaceCopy), r2.declaringInterpreter, bool, C2651.f7936);
                    return r2;
                } catch (Exception e) {
                    C2632.m5293("Error in class instance This initialization: ", e);
                    return null;
                }
            } catch (Exception e2) {
                C2632.m5293("unable to get instance initializer: ", e2);
                return null;
            }
        } catch (Exception e3) {
            C2632.m5293("Error in class gen setup: ", e3);
            return null;
        }
    }
    ...
    public static void initInstance(GeneratedClass generatedClass, String str, Object[] objArr) {
        ...
        try {
            ...
            arrayList.forEach(new C2663(generatedClass, i));
            if (nameSpace.isEnum) {
            ...
            BshMethod method = nameSpace.getMethod(AbstractC2661.m5347(str), AbstractC2661.m5351(objArr), true);
            if (objArr.length > 0 && method == null) {
                throw new InterpreterError("Can't find constructor: " + AbstractC2628.m5289(str, AbstractC2661.m5351(objArr)));
            }
            if (method != null) {
                method.invoke(objArr, thisInitClassInstanceThis.declaringInterpreter);
            }
            for (Variable variable : AbstractC2666.m5403(AbstractC2666.m5399(generatedClass))) {
            ...
            C2632.m5293("Error in class instance initialization: ", e);
        }
    }
    ...
    public static void initStatic(Class<?> cls) throws UtilEvalError {
        ...
        try {
            This thisM5411 = AbstractC2666.m5411(cls, simpleName);
            NameSpace nameSpace = thisM5411.getNameSpace();
            Interpreter interpreter = thisM5411.declaringInterpreter;
            if (interpreter == null) {
            ...
            Boolean bool = Boolean.TRUE;
            bSHBlock.evalBlock(callStack, interpreter, bool, C2651.f7937);
            bSHBlock.evalBlock(callStack, interpreter, bool, C2651.f7938);
            for (Variable variable : AbstractC2666.m5403(nameSpace)) {
                variable.validateFinalIsSet(true);
            }
        } catch (Exception e) {
            StringBuilder sbM11550 = AbstractC6136.m11550("Exception in static init block <clinit> for class ", simpleName, ". With message: ");
    ...
    public Object cloneMethodImpl(InterfaceC2618 interfaceC2618, CallStack callStack, Object obj) throws EvalError {
        ...
        if (obj == null) {
            try {
                ...
                throw e.toEvalError("Unable to assign clone instance This: " + e.getMessage(), interfaceC2618, callStack);
            } catch (IllegalAccessException e2) {
                e = e2;
                throw new EvalError("Unable to clone from This reference: " + e.getMessage(), interfaceC2618, callStack);
        ...
        for (BshMethod bshMethod : this.namespace.getMethods()) {
            BshMethod bshMethodClone = bshMethod.m5074clone();
            bshMethodClone.declaringNameSpace = nameSpace2;
            nameSpace.setMethod(bshMethodClone);
        }
        AbstractC2666.m5414(obj, Keys.BSHTHIS + nameSpace.classStatic.getSimpleName()).assign(nameSpace.getThis(this.declaringInterpreter));
        return obj;
    }
    ...
    public Object[] enumValues() {
        ...
        return Stream.of((Object[]) cls.getFields()).filter(new C2643(cls, 1)).map(new C2640(14)).filter(new C2641(5)).toArray(new C2669(cls, 0));
    }
    ...
    public Object getInterface(Class<?>[] clsArr) {
        ...
        for (Class<?> cls : clsArr) {
            iM4559 = AbstractC2442.m4559(3, iM4559, cls);
        }
        Integer numValueOf = Integer.valueOf(iM4559);
    ...
    public Object invokeMethod(String str, Object[] objArr, Interpreter interpreter, CallStack callStack, InterfaceC2618 interfaceC2618, boolean z) throws EvalException {
        if (objArr == null) {
        ...
        if (interfaceC2618 == null) {
            interfaceC2618 = InterfaceC2618.f7849;
        }
        InterfaceC2618 interfaceC26182 = interfaceC2618;
        Class[] clsArrM5351 = AbstractC2661.m5351(objArr2);
        BshMethod bshMethodM5405 = AbstractC2666.m5405(this.namespace, str, clsArrM5351, z);
        if (bshMethodM5405 != null) {
            return bshMethodM5405.invoke(objArr2, interpreter2, callStack2, interfaceC26182);
        }
        ...
        if (str.equals("clone") && objArr2.length == 0) {
            return cloneMethodImpl(interfaceC26182, callStack2);
        }
        boolean[] zArr = new boolean[1];
        Object objInvokeDefaultInvokeMethod = this.namespace.invokeDefaultInvokeMethod(str, objArr2, interpreter2, callStack2, interfaceC26182, zArr);
        if (zArr[0]) {
            return objInvokeDefaultInvokeMethod;
        }
        try {
            return this.namespace.invokeCommand(str, objArr2, interpreter2, callStack2, interfaceC26182, true);
        } catch (EvalError e) {
            throw new EvalException("Method " + AbstractC2628.m5289(str, clsArrM5351) + " not found in bsh scripted object: " + this.namespace.getName(), interfaceC26182, callStack2, e);
        }
    }
    ...
    public void run() {
        try {
            invokeMethod("run", AbstractC2666.f8000);
        } catch (EvalError e) {
    ...
    public String toString() {
        BshMethod bshMethodM5405 = AbstractC2666.m5405(this.namespace, "toString", new Class[0], true);
        if (bshMethodM5405 != null) {
            try {
                return (String) bshMethodM5405.invoke(new Object[0], this.declaringInterpreter);
    ...
    public Object invokeMethod(String str, Object[] objArr, boolean z) throws EvalException {
        ...
        InterfaceC2618 node = this.namespace.getNode();
    ...
    public Object cloneMethodImpl(InterfaceC2618 interfaceC2618, CallStack callStack) {
        return cloneMethodImpl(interfaceC2618, callStack, null);
    }
}
