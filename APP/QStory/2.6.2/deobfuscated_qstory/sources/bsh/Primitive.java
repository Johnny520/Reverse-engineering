...
public final class Primitive implements Serializable {
    ...
    public static Class<?> boxType(Class<?> cls) {
        ...
        C2632.m5297(AbstractC9032.m14590(cls, "Not a primitive type: "));
        return null;
    }
    ...
    public static Object castNumber(Class<?> cls, Number number) {
        ...
        if (dDoubleValue == 0.0d) {
            ...
            if (cls == BigDecimal.class) {
                return number instanceof BigInteger ? new BigDecimal((BigInteger) number).setScale(1) : AbstractC2661.m5345(number) ? BigDecimal.valueOf(number.doubleValue()) : new BigDecimal(number.longValue()).setScale(1);
            }
            BigInteger bigInteger = number instanceof BigInteger ? (BigInteger) number : number instanceof BigDecimal ? ((BigDecimal) number).toBigInteger() : AbstractC2661.m5345(number) ? BigDecimal.valueOf(number.doubleValue()).toBigInteger() : BigInteger.valueOf(number.longValue());
    ...
    public static Primitive castPrimitive(Class<?> cls, Class<?> cls2, Primitive primitive, boolean z, int i) throws UtilEvalError {
        if (cls2 == Void.TYPE) {
            if (z) {
                return AbstractC2661.f7968;
            }
            throw AbstractC2661.m5330(AbstractC2628.m5280(cls), "void value", null, i);
        }
        if (!z && primitive.isNumber() && AbstractC2661.m5334(cls)) {
            return new Primitive(castNumber(cls, primitive.numberValue()));
        }
        if (cls.isPrimitive()) {
            if (cls2 == null && !VOID.equals(primitive)) {
                return z ? AbstractC2661.f7969 : getDefaultValue(cls);
            }
            Class<?> cls3 = Boolean.TYPE;
            return cls == cls3 ? z ? AbstractC2661.f7969 : new Primitive(castWrapper(cls, primitive)) : (z && cls2 == cls3) ? cls != cls3 ? AbstractC2661.f7968 : AbstractC2661.f7969 : (i != 1 || AbstractC2661.m5343(cls, cls2) || AbstractC2661.m5335(cls, cls2) || !z) ? z ? AbstractC2661.f7969 : new Primitive(castWrapper(cls, primitive)) : AbstractC2661.f7968;
        }
        if (cls2 == null) {
            return z ? AbstractC2661.f7969 : NULL;
        }
        if (z) {
            return AbstractC2661.f7968;
        }
        throw AbstractC2661.m5330("object type ".concat(cls.getName()), "primitive value", null, i);
    }
    ...
    public static Object castWrapper(Class<?> cls, Object obj) {
        ...
        if (!isWrapperType(cls) && !cls.isPrimitive()) {
            C2632.m5297(AbstractC9032.m14590(cls, "invalid type in castWrapper: "));
            return null;
        }
        ...
        C2632.m5297("bad type in cast ".concat(AbstractC2628.m5284(objUnwrap) + " :" + AbstractC2628.m5283(objUnwrap)));
        return null;
    }
    ...
    public static Primitive shrinkWrap(Object obj) {
        if (!(obj instanceof Number)) {
            C2632.m5297("Can only shrink wrap Number types");
            return null;
        }
        Number number = (Number) obj;
        if (AbstractC2661.m5345(obj)) {
    ...
    public static Class<?> unboxType(Class<?> cls) {
        ...
        C2632.m5297(AbstractC9032.m14590(cls, "Not a primitive wrapper type: "));
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (primitive.isNumber() && isNumber()) ? getType() == BigDecimal.class ? this.value.equals(castNumber(BigDecimal.class, primitive.numberValue())) : primitive.getType() == BigDecimal.class ? primitive.value.equals(castNumber(BigDecimal.class, numberValue())) : (AbstractC2661.m5345(this.value) || AbstractC2661.m5345(primitive.value)) ? numberValue().doubleValue() == primitive.numberValue().doubleValue() : getType() == BigInteger.class ? this.value.equals(castNumber(BigInteger.class, primitive.numberValue())) : primitive.getType() == BigInteger.class ? primitive.value.equals(castNumber(BigInteger.class, numberValue())) : numberValue().longValue() == primitive.numberValue().longValue() : this.value.equals(primitive.value);
    }
    ...
    public Object getValue() {
        ...
        C2632.m5297("attempt to unwrap void type");
        return null;
    }
    ...
    public boolean isNumber() {
        Object obj = this.value;
        return ((obj instanceof Boolean) || this == NULL || this == VOID || !AbstractC2661.m5338(obj)) ? false : true;
    }
    ...
    public Number numberValue() {
        ...
        C2632.m5297("Primitive not a number");
        return null;
    }
    ...
    private Primitive(Object obj) {
        if (obj != null) {
            ...
            C2632.m5297("Use Primitve.NULL instead of Primitive(null)");
            throw null;
        }
    }
