    ...
    public final void mo1469(XC_MethodHook.MethodHookParam methodHookParam) throws IllegalAccessException, InvocationTargetException {
        ...
        switch (i) {
            case 0:
                ...
                int iIntValue = ((Integer) AbstractC6317.m11831(Integer.TYPE, "chatType", objM11828)).intValue();
                ...
                for (Object obj : arrayList) {
                    ...
                    if (objM118282 != null) {
                        arrayList3.add(((String) AbstractC6317.m11831(String.class, "md5HexStr", objM118282)).toUpperCase());
                        arrayList2.add(QQMessageUtils.getPicElementUrl(iIntValue, objM118282));
                    }
                }
                ((List) methodHookParam.getResult()).add(0, C6360.m11913(objInvoke, "\u4fdd\u5b58\u5230QS", R.mipmap.ic_launcher_round, new CallableC6385(arrayList2, arrayList3, 1)));
                break;
            default:
                ...
                Object objM11913 = C6360.m11913(objInvoke2, "\u4fdd\u5b58\u5230QS", R.mipmap.ic_launcher_round, new CallableC8747(c6316M118263.m11828(objInvoke2, new Object[0]), i2));
