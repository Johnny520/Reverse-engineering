...
public final class ViewOnClickListenerC6375 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        c6301.m11808(this.f17511.getText().toString(), "prefix");
        c6301.m11808(this.f17509.getText().toString(), "suffix");
        c6301.m11808(this.f17510.getText().toString(), "time_format");
        c6301.mo11807();
        AbstractC6154.m11561("\u4fdd\u5b58\u6210\u529f");
        this.f17508.dismiss();
    }
}
