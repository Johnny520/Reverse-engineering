...
public class C6394 extends AbstractC6293 {
    ...
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        if (!zM12011) {
            m11803(AbstractC6314.m11822("com.tencent.mobileqq.app.QQAppInterface", "notifyMessageReceived", cls2, new Class[]{AbstractC6318.m11838("com.tencent.imcore.message.Message"), cls, cls}), new C6267(5));
            return;
        }
        Class<?> clsLoadClass = classLoader.loadClass("com.tencent.qqnt.notification.NotificationFacade");
        Class clsM11838 = AbstractC6318.m11838("mqq.app.AppRuntime");
        Class clsM118382 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.NotificationCommonInfo");
        Class clsM118383 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.RecentContactInfo");
