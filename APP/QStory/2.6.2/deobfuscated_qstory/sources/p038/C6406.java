...
public final class C6406 implements InterfaceC5808 {
    ...
    public final void mo11172(Object obj, View view) {
        Iterator it = ((ArrayList) AbstractC6317.m11831(ArrayList.class, "elements", obj)).iterator();
        while (it.hasNext()) {
            Object objCallMethod = XposedHelpers.callMethod(it.next(), "getArkElement", new Object[0]);
            if (objCallMethod != null) {
                ViewGroup viewGroup = (ViewGroup) view;
                String str = (String) AbstractC6317.m11831(String.class, "bytesData", objCallMethod);
