...
public class C6378 extends AbstractC6293 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        Class cls = Void.TYPE;
        if (zM12011) {
            Class clsM11838 = AbstractC6318.m11838("com.tencent.richframework.gallery.QQGalleryActivity");
            m11802(AbstractC6314.m11815(clsM11838, cls, "onCreate", new Class[]{Bundle.class}), new InterfaceC6294(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世苏哲兰楪
                    ...
                    switch (i3) {
                        ...
                        case 1:
                            ...
                            if (bundle != null && (i2 = bundle.getInt("forward_source_uin_type")) != 0) {
                                ...
                                if (i2 == 1) {
                                    c6378.f17516.getString("extra.GROUP_CODE");
                                    String string2 = c6378.f17516.getString("key_troop_group_name");
                                    j = -3937586675157566887L;
                                    String string3 = c6378.f17516.getString("extra.GROUP_UIN");
                                    ...
                                    j = -3937586675157566887L;
                                    if (i2 == 0) {
                                        String string4 = c6378.f17516.getString("uin");
                                ...
                                String string5 = c6378.f17516.getString(i2 == 1 ? "extra.GROUP_CODE" : AbstractC3056.m6668(j));
                            ...
                            break;
                        case 2:
                            c6378.f17516 = ((Intent) AbstractC6314.m11818(Intent.class, "getIntent", methodHookParam.thisObject)).getExtras();
                            break;
                        default:
                            if (c6378.f17516 == null) {
                                String strM6668 = "PicUI bundle==null";
                                ...
                                String string6 = c6378.f17516.getString("key_troop_group_name");
                                int i7 = c6378.f17516.getInt("uintype");
                                if (i7 == 1) {
                                    string = c6378.f17516.getString("extra.GROUP_UIN");
                                ...
                                Parcelable parcelable = c6378.f17516.getParcelable("extra.EXTRA_CURRENT_IMAGE");
            ...
            final int i2 = 1;
            m11802(AbstractC6314.m11815(clsM11838, cls, "onResume", new Class[0]), new InterfaceC6294(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世苏哲兰楪
                    ...
                    switch (i3) {
                        ...
                        case 1:
                            ...
                            if (bundle != null && (i22 = bundle.getInt("forward_source_uin_type")) != 0) {
                                ...
                                String string5 = c6378.f17516.getString(i22 == 1 ? "extra.GROUP_CODE" : AbstractC3056.m6668(j));
                                textView.setText("\u53d1\u9001\u8005 : " + string5);
                                textView.setOnClickListener(new ViewOnClickListenerC6388(string5, context, 2));
                                viewInflate.setOnClickListener(new View.OnClickListener() { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世苏兰哲楪
                                    @Override // android.view.View.OnClickListener
        ...
        Class clsM118382 = AbstractC6318.m11838("com.tencent.mobileqq.richmediabrowser.AIOGalleryActivity");
        final int i3 = 2;
        m11802(AbstractC6314.m11815(clsM118382, cls, "onCreate", new Class[]{Bundle.class}), new InterfaceC6294(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世苏哲兰楪
        ...
        final int i4 = 3;
        m11802(AbstractC6314.m11815(clsM118382, cls, "onResume", new Class[0]), new InterfaceC6294(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世苏哲兰楪
