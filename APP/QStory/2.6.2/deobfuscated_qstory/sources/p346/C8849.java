...
public final class C8849 {
    ...
    static {
        "TroopMemberUtils";
        f24955 = new C8849();
        f24954 = new C9114("PluginTroopCache", 0);
    ...
    public static final String m14477(String str, String str2) {
        if (str != null && str2 != null) {
            ...
            boolean zM8917 = AbstractC4394.m8917(new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date()), f24954.m14641(m14484(str).concat("_time"), "0"));
            if (zM8917 && strM14482 != null) {
                return strM14482;
            }
            if (!zM8917) {
                if (f24953.add(str)) {
                    new Thread(new RunnableC6155(str, 3), "TroopMemberNameCache-".concat(str)).start();
                }
                if (strM14482 != null) {
                    return strM14482;
                }
    ...
    public static String m14478(Object obj) {
        if (obj != null) {
            Class clsM14657 = AbstractC9121.m14657("com.tencent.mobileqq.data.troop.TroopMemberNickInfo");
            clsM14657.getClass();
            Object objM14649 = C9117.m14649(clsM14657, "nickInfo", obj);
            Object objM146492 = C9117.m14649(String.class, "troopNick", objM14649);
            String str = objM146492 instanceof String ? (String) objM146492 : null;
            if (str != null && str.length() != 0) {
                return str;
            }
            Object objM146493 = C9117.m14649(String.class, "colorNick", objM14649);
            String str2 = objM146493 instanceof String ? (String) objM146493 : null;
            if (str2 != null && str2.length() != 0) {
                return str2;
            }
            Object objM146494 = C9117.m14649(String.class, "friendNick", objM14649);
            String str3 = objM146494 instanceof String ? (String) objM146494 : null;
            if (str3 != null && str3.length() != 0) {
                return str3;
            }
            Object objM146495 = C9117.m14649(String.class, "uin", objM14649);
    ...
    public static Method m14479() {
        C9125 c9125M14680 = C9125.m14680(QQEnvTool.getQRouteApi(AbstractC6318.m11838("com.tencent.qqnt.troopmemberlist.ITroopMemberListRepoApi")).getClass());
        c9125M14680.f25504 = "fetchTroopMemberList";
        c9125M14680.f25506 = Void.TYPE;
        c9125M14680.m14683(String.class, AbstractC6318.m11838("androidx.lifecycle.LifecycleOwner"), Boolean.TYPE, String.class, AbstractC9124.class);
    ...
    */
    ...
    public static Object m14481(String str, String str2) {
        ...
        while (i < 4) {
            try {
                ...
                c9125M14680.f25504 = "fetchTroopMemberInfo";
                c9125M14680.f25506 = Void.TYPE;
                c9125M14680.m14683(String.class, String.class, Boolean.TYPE, AbstractC6318.m11838("androidx.lifecycle.LifecycleOwner"), String.class, AbstractC9124.class);
                Method method = (Method) c9125M14680.m14686();
                Class<?>[] parameterTypes = method.getParameterTypes();
                str3 = str;
                str4 = str2;
                try {
                    method.invoke(qRouteApi, str3, str4, Boolean.TRUE, null, "TroopMemberListActivity", Proxy.newProxyInstance(AbstractC6318.f17411, new Class[]{parameterTypes[parameterTypes.length - 1]}, new C5557(completableFuture, qRouteApi, 3)));
    ...
    public static final void m14483(String str, String str2) {
        ...
        c9119.f25494 = new Class[]{AbstractC6318.m11838("com.tencent.common.app.AppInterface")};
        c9119.f25493 = 1;
