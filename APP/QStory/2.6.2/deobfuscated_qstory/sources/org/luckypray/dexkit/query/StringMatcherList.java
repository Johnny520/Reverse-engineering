...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u001e\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u0012\u0012\u0004\u0012\u00020\u00020\u0001j\b\u0012\u0004\u0012\u00020\u0002`\u00032\u00020\u0004B\t\b\u0016¢\u0006\u0004\b\u0005\u0010\u0006B\u0011\b\u0016\u0012\u0006\u0010\b\u001a\u00020\u0007¢\u0006\u0004\b\u0005\u0010\tB\u0017\b\u0016\u0012\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00020\n¢\u0006\u0004\b\u0005\u0010\fJ+\u0010\u0013\u001a\u00020\u00002\u0006\u0010\u000e\u001a\u00020\r2\b\b\u0002\u0010\u0010\u001a\u00020\u000f2\b\b\u0002\u0010\u0012\u001a\u00020\u0011H\u0007¢\u0006\u0004\b\u0013\u0010\u0014J\u0015\u0010\u0016\u001a\u00020\u00002\u0006\u0010\u0015\u001a\u00020\u0002¢\u0006\u0004\b\u0016\u0010\u0017J+\u0010\u0016\u001a\u00020\u00002\u0006\u0010\u000e\u001a\u00020\r2\b\b\u0002\u0010\u0010\u001a\u00020\u000f2\b\b\u0002\u0010\u0012\u001a\u00020\u0011H\u0007¢\u0006\u0004\b\u0016\u0010\u0014J!\u0010\u0013\u001a\u00020\u00002\u0012\u0010\u001a\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00190\u0018¢\u0006\u0004\b\u0013\u0010\u001bJ!\u0010\u0016\u001a\u00020\u00002\u0012\u0010\u001a\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00190\u0018¢\u0006\u0004\b\u0016\u0010\u001b¨\u0006\u001c"}, d2 = {"Lorg/luckypray/dexkit/query/StringMatcherList;", "Ljava/util/ArrayList;", "L飘花落叶言苏子兰哲楪世/飘花落叶言子楪世哲兰苏;", "Lkotlin/collections/ArrayList;", "", MethodDescription.CONSTRUCTOR_INTERNAL_NAME, "()V", "", "initialCapacity", "(I)V", "", "elements", "(Ljava/util/Collection;)V", "", "usingString", "Lorg/luckypray/dexkit/query/enums/StringMatchType;", "matchType", "", "ignoreCase", "add", "(Ljava/lang/String;Lorg/luckypray/dexkit/query/enums/StringMatchType;Z)Lorg/luckypray/dexkit/query/StringMatcherList;", "matcher", "match", "(L飘花落叶言苏子兰哲楪世/飘花落叶言子楪世哲兰苏;)Lorg/luckypray/dexkit/query/StringMatcherList;", "Lkotlin/Function1;", "Lkotlin/飘花落叶言子楪兰苏哲世;", "init", "(L飘花落叶言世子哲楪兰苏/飘花落叶言子楪苏兰哲世;)Lorg/luckypray/dexkit/query/StringMatcherList;", "dexkit-android_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class StringMatcherList extends ArrayList<C8945> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StringMatcherList(Collection<C8945> collection) {
        super(collection);
        collection.getClass();
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof C8945) {
            return contains((C8945) obj);
        }
        return false;
    }
    ...
    public final /* bridge */ boolean remove(Object obj) {
        if (obj instanceof C8945) {
            return remove((C8945) obj);
        }
        return false;
    }

    public /* bridge */ C8945 removeAt(int i) {
        return remove(i);
    }
    ...
    public /* bridge */ boolean contains(C8945 c8945) {
        return super.contains((Object) c8945);
    }

    public /* bridge */ int indexOf(C8945 c8945) {
        return super.indexOf((Object) c8945);
    }

    public /* bridge */ int lastIndexOf(C8945 c8945) {
        return super.lastIndexOf((Object) c8945);
    }

    @Override // java.util.ArrayList, java.util.AbstractList, java.util.List
    public final /* bridge */ C8945 remove(int i) {
        return removeAt(i);
    }

    public /* bridge */ boolean remove(C8945 c8945) {
        return super.remove((Object) c8945);
    }
    ...
    public final StringMatcherList add(String usingString, StringMatchType matchType, boolean ignoreCase) {
        ...
        matchType.getClass();
        add(new C8945(usingString, matchType, ignoreCase));
        return this;
    }

    public final StringMatcherList match(C8945 matcher) {
        matcher.getClass();
        add(matcher);
        return this;
    }

    public final /* synthetic */ StringMatcherList add(InterfaceC6557 init) {
        init.getClass();
        C8945 c8945 = new C8945();
        init.invoke(c8945);
        add(c8945);
        return this;
    }
    ...
    public final /* synthetic */ StringMatcherList match(InterfaceC6557 init) {
        init.getClass();
        C8945 c8945 = new C8945();
        init.invoke(c8945);
        add(c8945);
