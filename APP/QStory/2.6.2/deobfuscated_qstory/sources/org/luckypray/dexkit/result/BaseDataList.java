...
public abstract class BaseDataList<T> extends ArrayList<T> {
    ...
    public final T first(InterfaceC6557 predicate) {
        predicate.getClass();
        for (T t : this) {
        ...
        C5919.m11250("No element matching predicate was found.");
        return null;
    }

    public final T firstOrNull(InterfaceC6557 predicate) {
        predicate.getClass();
        for (T t : this) {
            if (((Boolean) predicate.invoke(t)).booleanValue()) {
                return t;
    ...
    public final T firstOrThrow(InterfaceC6542 exceptionSupplier) throws Throwable {
    ...
    public final T single(InterfaceC6557 predicate) {
        predicate.getClass();
        if (size() == 0) {
    ...
    public final T singleOrNull(InterfaceC6557 predicate) {
        predicate.getClass();
        if (size() == 0) {
            return null;
        }
    ...
    public final T singleOrThrow(InterfaceC6542 exceptionSupplier) throws Throwable {
        exceptionSupplier.getClass();
    ...
    public final T singleOrNull() {
        ...
        for (int i = 1; i < size; i++) {
            if (!AbstractC4394.m8917(t, get(i))) {
                return null;
            }
        }
        return t;
