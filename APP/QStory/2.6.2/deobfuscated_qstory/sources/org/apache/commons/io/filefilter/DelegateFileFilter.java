...
public class DelegateFileFilter extends AbstractC8925 implements Serializable {
    ...
    public FileVisitResult accept(Path path, BasicFileAttributes basicFileAttributes) {
        return AbstractC8925.toDefaultFileVisitResult(path != null && accept(path.toFile()));
    }
