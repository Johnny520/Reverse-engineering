...
public final class C5607 implements InterfaceC5588 {
    ...
    public final void parseFromCentralDirectoryData(byte[] bArr, int i, int i2) throws ZipException {
        if (i2 < 2) {
            throw new ZipException(AbstractC6136.m11556(i2, "Too short content for ResourceAlignmentExtraField (0xa11e): "));
        }
