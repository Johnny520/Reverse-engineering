...
public class StrBuilder implements CharSequence, Appendable, Serializable {
    ...
    private StrBuilder replaceImpl(AbstractC5647 abstractC5647, String str, int i, int i2, int i3) {
        StrBuilder strBuilder;
        String str2;
        if (abstractC5647 != null && this.size != 0) {
            int iM11001 = AbstractC5694.m11001(str);
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int iMo10975 = abstractC5647.mo10975(i4, this.buffer);
                if (iMo10975 > 0) {
                    strBuilder = this;
                    str2 = str;
                    strBuilder.replaceImpl(i4, i4 + iMo10975, iMo10975, str2, iM11001);
                    i2 = (i2 - iMo10975) + iM11001;
                    i4 = (i4 + iM11001) - 1;
                    if (i3 > 0) {
                        i3--;
                    }
    ...
    public C5646 asTokenizer() {
        return new C5644(this);
    }

    public Writer asWriter() {
        return new C5643(this);
    }
    ...
    public int indexOf(AbstractC5647 abstractC5647, int i) {
        int i2;
        int iMax = Math.max(i, 0);
        if (abstractC5647 == null || iMax >= (i2 = this.size)) {
            return -1;
        }
        char[] cArr = this.buffer;
        while (iMax < i2) {
            if (abstractC5647.mo10975(iMax, cArr) > 0) {
                return iMax;
            }
            iMax++;
        }
    ...
    public StrBuilder replace(int i, int i2, String str) {
        int iValidateRange = validateRange(i, i2);
        replaceImpl(i, iValidateRange, iValidateRange - i, str, AbstractC5694.m11001(str));
        return this;
    }
    ...
    public StrBuilder replaceAll(String str, String str2) {
        int iM11001 = AbstractC5694.m11001(str);
        if (iM11001 > 0) {
            int iM110012 = AbstractC5694.m11001(str2);
            int iIndexOf = indexOf(str, 0);
            while (iIndexOf >= 0) {
                replaceImpl(iIndexOf, iIndexOf + iM11001, iM11001, str2, iM110012);
                iIndexOf = indexOf(str, iIndexOf + iM110012);
            }
        }
        return this;
    }
    ...
    public StrBuilder replaceFirst(String str, String str2) {
        int iIndexOf;
        int iM11001 = AbstractC5694.m11001(str);
        if (iM11001 <= 0 || (iIndexOf = indexOf(str, 0)) < 0) {
            return this;
        }
        replaceImpl(iIndexOf, iIndexOf + iM11001, iM11001, str2, AbstractC5694.m11001(str2));
        return this;
    }
    ...
    public StrBuilder replace(AbstractC5647 abstractC5647, String str, int i, int i2, int i3) {
        return replaceImpl(abstractC5647, str, i, validateRange(i, i2), i3);
    }
    ...
    public StrBuilder appendAll(Iterator<?> it) {
        if (it != null) {
            it.forEachRemaining(new C2663(this, 4));
        }
        return this;
    }
    ...
    public boolean contains(AbstractC5647 abstractC5647) {
        return indexOf(abstractC5647, 0) >= 0;
    }

    public StrBuilder appendAll(Iterable<?> iterable) {
        if (iterable != null) {
            iterable.forEach(new C2663(this, 4));
        }
        return this;
    }
    ...
    public StrBuilder deleteFirst(String str) {
        ...
        int iM11001 = AbstractC5694.m11001(str);
        if (iM11001 > 0 && (iIndexOf = indexOf(str, 0)) >= 0) {
            deleteImpl(iIndexOf, iIndexOf + iM11001, iM11001);
        }
        return this;
    }
    ...
    public StrBuilder deleteFirst(AbstractC5647 abstractC5647) {
        return replace(abstractC5647, null, 0, this.size, 1);
    }
    ...
    public StrBuilder replaceFirst(AbstractC5647 abstractC5647, String str) {
        return replace(abstractC5647, str, 0, this.size, 1);
    }
    ...
    public int indexOf(String str, int i) {
        return C5690.f15623.m10999(i, this, str);
    }
    ...
    public int indexOf(AbstractC5647 abstractC5647) {
        return indexOf(abstractC5647, 0);
    }
    ...
    public StrBuilder replaceAll(AbstractC5647 abstractC5647, String str) {
        return replace(abstractC5647, str, 0, this.size, -1);
    }

    public StrBuilder deleteAll(AbstractC5647 abstractC5647) {
        return replace(abstractC5647, null, 0, this.size, -1);
    }
    ...
    public int lastIndexOf(AbstractC5647 abstractC5647) {
        return lastIndexOf(abstractC5647, this.size);
    }

    public int lastIndexOf(AbstractC5647 abstractC5647, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (abstractC5647 == null || i < 0) {
            return -1;
        }
        char[] cArr = this.buffer;
        while (i >= 0) {
            if (abstractC5647.mo10975(i, cArr) > 0) {
                return i;
            }
            i--;
        }
    ...
    public StrBuilder append(char[] cArr, int i, int i2) {
        ...
        if (i >= 0 && i <= cArr.length) {
            if (i2 < 0 || i + i2 > cArr.length) {
                throw new StringIndexOutOfBoundsException(AbstractC6136.m11556(i2, "Invalid length: "));
            }
            if (i2 > 0) {
                int length = length();
        ...
        throw new StringIndexOutOfBoundsException(AbstractC6136.m11556(i2, "Invalid startIndex: "));
    }
    ...
    public StrBuilder insert(int i, char[] cArr, int i2, int i3) {
        ...
        if (i2 >= 0 && i2 <= cArr.length) {
            if (i3 < 0 || i2 + i3 > cArr.length) {
                throw new StringIndexOutOfBoundsException(AbstractC6136.m11556(i3, "Invalid length: "));
            }
            if (i3 > 0) {
        ...
        throw new StringIndexOutOfBoundsException(AbstractC6136.m11556(i2, "Invalid offset: "));
    }
