...
public class FastDatePrinter implements Serializable {
    ...
    private transient InterfaceC5652[] rules;
    private final TimeZone timeZone;
    private static final InterfaceC5652[] EMPTY_RULE_ARRAY = new InterfaceC5652[0];
    private static final ConcurrentMap<C5649, String> timeZoneDisplayCache = new ConcurrentHashMap(7);
    ...
    private <B extends Appendable> B applyRules(Calendar calendar, B b) {
        for (InterfaceC5652 interfaceC5652 : this.rules) {
            interfaceC5652.mo10985(calendar, b);
        }
        return b;
    }
    ...
    public static String getTimeZoneDisplay(final TimeZone timeZone, final boolean z, final int i, final Locale locale) {
        return timeZoneDisplayCache.computeIfAbsent(new C5649(timeZone, z, i, locale), new Function() { // from class: org.apache.commons.lang3.time.飘花落叶言子楪兰世哲苏
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return FastDatePrinter.lambda$getTimeZoneDisplay$0(timeZone, z, i, locale, (C5649) obj);
            }
        });
    }

    private void init() {
        InterfaceC5652[] interfaceC5652Arr = (InterfaceC5652[]) parsePattern().toArray(EMPTY_RULE_ARRAY);
        this.rules = interfaceC5652Arr;
        int length = interfaceC5652Arr.length;
        int iMo10986 = 0;
        while (true) {
            length--;
            if (length < 0) {
                this.maxLengthEstimate = iMo10986;
                return;
            }
            iMo10986 += this.rules[length].mo10986();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ String lambda$getTimeZoneDisplay$0(TimeZone timeZone, boolean z, int i, Locale locale, C5649 c5649) {
    ...
    */
    public java.util.List<org.apache.commons.lang3.time.InterfaceC5652> parsePattern() {
        /*
    ...
    public InterfaceC5669 selectNumberRule(int i, int i2) {
        return i2 != 1 ? i2 != 2 ? new C5653(i, i2) : new C5657(i, 0) : new C5657(i, 1);
    }
