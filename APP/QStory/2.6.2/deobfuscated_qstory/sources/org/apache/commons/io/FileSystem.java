...
public enum FileSystem {
    ...
    FileSystem(int i, boolean z, boolean z2, int i2, int i3, int[] iArr, String[] strArr, boolean z3, boolean z4, char c) {
        ...
        String[] strArr2 = AbstractC8980.f25228;
        char c2 = '\\';
        if (c != '/') {
            if (c != '\\') {
    ...
    public boolean isLegalFileName(CharSequence charSequence) {
        ...
        return charSequence.chars().noneMatch(new IntPredicate() { // from class: 飘花落叶言苏子楪兰哲世.飘花落叶言子楪世哲苏兰
            @Override // java.util.function.IntPredicate
            public final boolean test(int i) {
                return this.f25230.isIllegalFileNameChar(i);
            }
        });
    }
    ...
    public String toLegalFileName(String str, final char c) {
        ...
        int[] array = str.chars().map(new IntUnaryOperator() { // from class: 飘花落叶言苏子楪兰哲世.飘花落叶言子楪世苏兰哲
            @Override // java.util.function.IntUnaryOperator
            public final int applyAsInt(int i2) {
                return this.f25232.lambda$toLegalFileName$0(c, i2);
            }
        }).toArray();
