...
public class QQFriendTool {
    ...
    public static void deleteFriend(String str) {
        try {
            Object objCallMethod = XposedHelpers.callMethod(Hook_cookie.getRuntime(), "getBusinessHandler", new Class[]{String.class}, new Object[]{(String) AbstractC6317.m11829(AbstractC6318.m11838("com.tencent.mobileqq.app.BusinessHandlerFactory"), String.class, "FRIENDLIST_HANDLER")});
    ...
    public static ArrayList<FriendInfo> getAllFriend() {
        ...
        for (QZoneFriend.Friend friend : ((QZoneFriend) InterfaceC2915.m6316(AbstractC6353.m11901("https://h5.qzone.qq.com/proxy/domain/mobile.qzone.qq.com/friend/mfriend_list?g_tk=" + gtk + "&res_uin=" + QQEnvTool.getCurrentUin() + "&res_type=normal&format=json&uin=" + QQEnvTool.getCurrentUin(), sbM1493.toString())).getObject("data", QZoneFriend.class, new JSONReader$Feature[0])).getList()) {
    ...
    public static FriendListResult getAllFriendWithCategories() {
        ...
        try {
            long gtk = QQEnvTool.getGTK(Hook_cookie.getPskey("qzone.qq.com"));
            QZoneFriend qZoneFriend = (QZoneFriend) InterfaceC2915.m6316(AbstractC6353.m11901("https://h5.qzone.qq.com/proxy/domain/mobile.qzone.qq.com/friend/mfriend_list?g_tk=" + gtk + "&res_uin=" + QQEnvTool.getCurrentUin() + "&res_type=normal&format=json&uin=" + QQEnvTool.getCurrentUin(), ((("uin=o" + QQEnvTool.getCurrentUin()) + "; p_uin=o=" + QQEnvTool.getCurrentUin()) + "; skey=" + Hook_cookie.getSkey()) + "; p_skey=" + Hook_cookie.getPskey("qzone.qq.com"))).getObject("data", QZoneFriend.class, new JSONReader$Feature[0]);
            ...
            String strM6668 = "getAllFriendWithCategories";
    ...
    public static void sendLike(String str, int i) {
        try {
            ...
            Object objCallMethod = XposedHelpers.callMethod(Hook_cookie.getRuntime(), "getBusinessHandler", new Class[]{String.class}, new Object[]{AbstractC6317.m11829(AbstractC6318.m11838("com.tencent.mobileqq.app.BusinessHandlerFactory"), String.class, "CARD_HANLDER")});
            C6316 c6316M11825 = C6316.m11825("com.tencent.mobileqq.app.CardHandler");
            Class cls = Void.TYPE;
