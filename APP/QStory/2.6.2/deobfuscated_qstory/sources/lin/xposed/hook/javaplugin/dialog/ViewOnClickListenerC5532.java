    ...
    public final void onClick(View view) {
        switch (this.f15280) {
            ...
            case 9:
                ...
                ((TextView) viewFindViewById).setText("\u62a2\u7ea2\u5305\u53c2\u6570(\u65b0\u65b0)");
                ...
                editText2.setText(c9114.m14641("blacklistTroop", ""));
                editText3.setText(c9114.m14641("blacklistText", ""));
                editText4.setText(c9114.m14641("replyText", ""));
                editText5.setText(String.valueOf(Long.parseLong(String.valueOf(sharedPreferencesC8175.getInt("delayReply", 0)))));
                checkBox.setChecked(sharedPreferencesC8175.getBoolean("grabToast", true));
                checkBox2.setChecked(sharedPreferencesC8175.getBoolean("grabFailToast", false));
                checkBox3.setChecked(sharedPreferencesC8175.getBoolean("ordinary", true));
                checkBox4.setChecked(sharedPreferencesC8175.getBoolean("exclusiveRedEnvelopes", false));
                editText6.setText(String.valueOf(Long.parseLong(String.valueOf(sharedPreferencesC8175.getInt("expectAmount", 0)))));
            ...
            case 12:
                if (C8675.m14361(view.getContext(), AbstractC3932.m8313().concat("/Pic/"))) {
                    AbstractC6154.m11561("\u590d\u5236\u6210\u529f");
                    return;
                } else {
                    AbstractC6154.m11561("\u590d\u5236\u5931\u8d25");
            ...
            case 13:
                AbstractC6154.m11561("\u53ef\u80fd\u70b9\u65c1\u8fb9\u7684\u5b57\u4f1a\u6709\u4ec0\u4e48\u53cd\u5e94\u5462");
                return;
            case 14:
                AbstractC6154.m11561("\u53ef\u80fd\u70b9\u65c1\u8fb9\u7684\u5b57\u4f1a\u6709\u4ec0\u4e48\u53cd\u5e94\u5462");
                return;
            case 15:
                ...
                return;
            case 16:
                if (C8675.m14361(view.getContext(), AbstractC5061.m10021().concat("\u9700\u8981\u68c0\u6d4b\u7fa4.json"))) {
                    AbstractC6154.m11561("\u590d\u5236\u6210\u529f");
                    return;
                } else {
                    AbstractC6154.m11561("\u590d\u5236\u5931\u8d25");
            ...
            case 17:
                return;
            case 18:
                AbstractC6154.m11561("\u8bf7\u4f7f\u7528\u65b0\u7684\u7ea2\u5305\u529f\u80fd \u6b64\u529f\u80fd\u5df2\u88ab\u5f03\u7528");
                return;
            default:
