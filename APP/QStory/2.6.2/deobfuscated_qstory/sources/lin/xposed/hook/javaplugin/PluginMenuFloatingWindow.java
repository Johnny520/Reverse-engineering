...
public class PluginMenuFloatingWindow extends AbstractC6296 {
    ...
    public static final String TAG = "PluginMenuFloatingWindow";
    ...
    private WindowManager.LayoutParams getWindowManagerParams(Context context) {
        ...
        C6301 c6301 = new C6301("PluginMenuFloatingWindow");
        int iIntValue = ((Integer) c6301.m11812(0, "show x")).intValue();
        int iIntValue2 = ((Integer) c6301.m11812(0, "show y")).intValue();
    ...
    public synchronized void hidePluginFloatingWindow() {
        ...
        if (atomicBoolean.get()) {
            ...
            try {
                ...
                C6301 c6301 = new C6301("PluginMenuFloatingWindow");
                c6301.m11808(Integer.valueOf(layoutParams.x), "show x");
                c6301.m11808(Integer.valueOf(layoutParams.y), "show y");
                c6301.mo11807();
