...
public class AutoLoadPlugin extends AbstractC6296 {
    ...
    private static final C9114 configUtils = new C9114("AutoLoadPluginV2", 0);

    public static void addAutoLoadPlugin(PluginInfo pluginInfo) {
        C9114 c9114 = configUtils;
        ArrayList arrayListM14643 = c9114.m14643(String.class, "AutoLoadPluginV2");
        if (arrayListM14643.contains(pluginInfo.getPluginID())) {
            return;
        }
        arrayListM14643.add(pluginInfo.getPluginID());
        c9114.m14640(arrayListM14643, "AutoLoadPluginV2");
    }

    public static boolean isAutoLoading(PluginInfo pluginInfo) {
        return configUtils.m14643(String.class, "AutoLoadPluginV2").contains(pluginInfo.getPluginID());
    }
    ...
    public void loadHook(ClassLoader classLoader) {
        if (AbstractC6340.m11895() || AbstractC6340.f17464.equals("com.tencent.mobileqq:MSF")) {
            new Thread(new RunnableC1107(this, 8)).start();
        }
    }

    public void startAutoLoadPlugin() {
        ArrayList arrayListM14643 = configUtils.m14643(String.class, "AutoLoadPluginV2");
        ...
        configUtils.m14640(arrayList, "AutoLoadPluginV2");
    }
}
