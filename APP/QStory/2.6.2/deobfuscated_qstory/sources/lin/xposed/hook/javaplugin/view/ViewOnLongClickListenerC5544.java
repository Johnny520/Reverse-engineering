    ...
    public final boolean onLongClick(View view) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                new AlertDialog.Builder(c6327.getContext(), 3).setTitle("\u8f93\u5165\u540d\u5b57").setView(editText).setNeutralButton("\u6539\u540d", new DialogInterfaceOnClickListenerC6320(c6327, str, editText, i2)).show();
                return true;
            case 2:
                ...
                new AlertDialog.Builder(c63272.getContext(), AbstractC6333.m11886(c63272.getContext()) ? 2 : 3).setTitle("\u662f\u5426\u5220\u9664\u6b64\u56fe\u7247").setView(linearLayout).setNeutralButton("\u5220\u9664", new DialogInterfaceOnClickListenerC6322(c6331, c6329)).show();
                return true;
            case 3:
                C8675.m14361((Activity) obj2, (String) obj);
                AbstractC6154.m11561("\u5df2\u590d\u5236");
                return true;
            case 4:
