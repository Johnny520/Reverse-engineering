...
public final class SearchHelper$MatchType {
    ...
    public static final SearchHelper$MatchType FUNCTION = new SearchHelper$MatchType("FUNCTION", 0);
    public static final SearchHelper$MatchType DIRECTORY = new SearchHelper$MatchType("DIRECTORY", 1);
    public static final SearchHelper$MatchType GROUP = new SearchHelper$MatchType("GROUP", 2);
