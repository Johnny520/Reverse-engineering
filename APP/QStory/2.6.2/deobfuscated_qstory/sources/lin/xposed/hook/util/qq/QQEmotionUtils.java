...
public class QQEmotionUtils {
    ...
    private static String parseLocalSmallFace(int i) {
        ...
        try {
            ...
            if (iEmojiSpanService != null) {
                ...
                String strM6668 = "convertEmoServerIdToEmoCode";
            ...
            String strM66682 = "convertEmoServerIdToEmo";
            String str2 = AbstractC6157.f16779;
            AbstractC6157.m11574(strM66682, e.toString(), e, true);
        }
        try {
            return String.valueOf(new char[]{20, (char) ((Integer) AbstractC6314.m11815(AbstractC6318.m11838("com.tencent.mobileqq.emoticon.QQSysFaceUtil"), cls, "convertToLocal", new Class[]{cls}).invoke(null, Integer.valueOf(i))).intValue()});
        } catch (Exception e2) {
            String strM66683 = "convertToLocal";
    ...
    private static String parseMarketSmallFace(int i, int i2, int i3) {
        try {
            ...
            String strM66682 = "parseMarketSmallFaceElement";
    ...
    private static String parseMarketSmallFaceElement(Object obj) {
        try {
            String strM6668 = "faceIndex";
            Class cls = Integer.TYPE;
            int iIntValue = ((Integer) AbstractC6317.m11831(cls, strM6668, obj)).intValue();
            return parseMarketSmallFace((16711680 & iIntValue) >>> 16, iIntValue & (-16711681), ((Integer) AbstractC6317.m11831(cls, "imageType", obj)).intValue());
    ...
    public static String smallFaceElementToStrCode(Object obj) {
        try {
            int iIntValue = ((Integer) AbstractC6314.m11816(obj, "getFaceType")).intValue();
            if (iIntValue == 1 || iIntValue == 2) {
                return parseLocalSmallFace(((Integer) AbstractC6317.m11831(Integer.TYPE, "faceIndex", obj)).intValue());
            }
            return iIntValue == 4 ? parseMarketSmallFaceElement(obj) : "";
        } catch (Exception e) {
            String strM6668 = "emotion";
            String str = AbstractC6157.f16779;
