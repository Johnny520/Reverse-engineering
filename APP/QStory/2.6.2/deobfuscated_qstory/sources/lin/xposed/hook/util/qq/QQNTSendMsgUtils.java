...
public class QQNTSendMsgUtils {
    public static void forwardMsg(ArrayList<Long> arrayList, Object obj, ArrayList<Object> arrayList2) {
        ...
        Class clsM11838 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IForwardOperateCallback");
        C6316 c6316M11826 = C6316.m11826(objM11554.getClass());
        Class[] clsArr = {ArrayList.class, AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.Contact"), ArrayList.class, ArrayList.class, clsM11838};
        C1245 c1245 = c6316M11826.f17409;
        c1245.f3618 = clsArr;
        c1245.f3616 = Void.TYPE;
        c6316M11826.f17409.f3617 = "forwardMsg";
    ...
    */
    ...
    public static void sendMsg(Object obj, ArrayList arrayList) {
        if (obj == null) {
            AbstractC6154.m11561("contact==null");
            return;
        }
        if (arrayList == null) {
            AbstractC6154.m11561("elementList==null");
            return;
        }
        Object objM11554 = AbstractC6136.m11554(-3937654484101236135L);
        C6316 c6316M11826 = C6316.m11826(objM11554.getClass());
        Class[] clsArr = {AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.Contact"), ArrayList.class, AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")};
        C1245 c1245 = c6316M11826.f17409;
        c1245.f3618 = clsArr;
        c1245.f3616 = Void.TYPE;
        c6316M11826.f17409.f3617 = "sendMsg";
        c6316M11826.m11828(objM11554, obj, arrayList, Proxy.newProxyInstance(AbstractC6318.f17411, new Class[]{AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")}, new InvocationHandler() { // from class: lin.xposed.hook.util.qq.QQNTSendMsgUtils.2
            @Override // java.lang.reflect.InvocationHandler
            public Object invoke(Object obj2, Method method, Object[] objArr) {
                return null;
            }
    ...
    public static void sendMsg(Object obj, ArrayList arrayList, final IOperateCallback iOperateCallback) {
        ...
        c1245.f3616 = Void.TYPE;
        c6316M11826.f17409.f3617 = "sendMsg";
        c6316M11826.m11828(objM11554, obj, arrayList, Proxy.newProxyInstance(AbstractC6318.f17411, new Class[]{AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")}, new InvocationHandler() { // from class: lin.xposed.hook.util.qq.QQNTSendMsgUtils.3
            @Override // java.lang.reflect.InvocationHandler
            public Object invoke(Object obj2, Method method, Object[] objArr) {
