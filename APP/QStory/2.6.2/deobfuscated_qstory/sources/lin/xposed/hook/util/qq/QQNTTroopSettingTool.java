...
public class QQNTTroopSettingTool {
    public static void quitGroup(String str) {
        try {
            Object qRouteApi = QQEnvTool.getQRouteApi(AbstractC6318.m11838("com.tencent.qqnt.troop.ITroopOperationRepoApi"));
            C6316 c6316M11826 = C6316.m11826(qRouteApi.getClass());
            String strM6668 = "quitGroup";
            ...
            c6316M11826.m11828(qRouteApi, str, Boolean.FALSE, null, "TroopSettingViewModel", null);
        } catch (Exception e) {
            String strM66682 = "quitGroup";
