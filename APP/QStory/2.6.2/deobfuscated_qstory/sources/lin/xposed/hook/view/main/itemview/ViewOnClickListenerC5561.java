    ...
    public final void onClick(View view) {
        ...
        switch (this.f15333) {
            ...
            case 2:
                ...
                if (c0679 != null) {
                    ...
                    if (!str2.equals("\u5173\u95ed")) {
                        ...
                        c6418.f17581.m11808(Long.valueOf(calendar.getTimeInMillis()), "targetTime");
                        textView.setText("\u5269\u4f59 " + ((calendar.getTimeInMillis() - System.currentTimeMillis()) / 3600000) + "\u65f6");
                        StringBuilder sb = new StringBuilder();
                        sb.append("\u5c06\u5728 ");
                        Date date = new Date(((Long) c6418.f17581.m11811("targetTime")).longValue());
                        String strM6668 = "MM-dd hh:mm";
                        try {
                            strConcat = new SimpleDateFormat(strM6668).format(date);
                        } catch (Exception unused) {
                            strConcat = "\u65e5\u671f\u683c\u5f0f\u5316\u5931\u8d25 ".concat(strM6668);
                        }
                        sb.append(strConcat);
                        sb.append(" \u7ed3\u675f");
                        ...
                        AbstractC6154.m11561("\u5173\u95ed\u4e86\u514d\u6253\u6270");
                    }
                    c6418.f17581.m11808(str2, "TaskName");
            ...
            case 3:
                ...
                new AlertDialog.Builder(context, AbstractC6333.m11886(context) ? 2 : 3).setTitle("\u521b\u5efa\u65b0\u76ee\u5f55").setView(editText).setNeutralButton("\u786e\u5b9a\u521b\u5efa", new DialogInterfaceOnClickListenerC6320(editText, radioGroup, context, i)).show();
                return;
            case 4:
            ...
            case 6:
                ...
                c64182.f17581 = new C6301("doNotDisturbData");
                DialogC6311 dialogC63112 = new DialogC6311(activity, new String[]{"24\u5c0f\u65f6", "12\u5c0f\u65f6", "8\u5c0f\u65f6", "2\u5c0f\u65f6", "\u5173\u95ed"});
                TextView textView2 = dialogC63112.f17395;
                Long l = (Long) c64182.f17581.m11811("targetTime");
                Date date2 = new Date();
                if (l == null || date2.getTime() > l.longValue()) {
                    C6301 c63012 = c64182.f17581;
                    c63012.getClass();
                    c63012.f17382 = new JSONObject();
                    c64182.f17581.m11808("\u5173\u95ed", "TaskName");
                ...
                dialogC63112.f17394 = (String) c64182.f17581.m11811("TaskName");
            ...
            case 7:
                ...
                if (AbstractC6431.f17619.equals("/storage/emulated")) {
                    AbstractC6154.m11561("\u5df2\u662f\u6240\u80fd\u63a2\u7d22\u5230\u7684\u6781\u9650");
                    return;
                } else {
            ...
            case 13:
                ...
                C5868.m11212(c5868);
                AbstractC6154.m11561("MCP \u914d\u7f6e\u5df2\u4fdd\u5b58");
                if (c8232 != null) {
                    c8232.m13739();
                    return;
                }
            ...
            case 14:
                ...
                ((ClipboardManager) systemService).setPrimaryClip(ClipData.newPlainText("QStory MCP Config", str5));
                AbstractC6154.m11561("MCP \u914d\u7f6e JSON \u5df2\u590d\u5236");
                return;
            case 15:
