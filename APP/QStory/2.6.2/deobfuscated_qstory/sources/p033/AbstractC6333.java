...
public abstract class AbstractC6333 {
    ...
    public static void m11888(Context context, String str, String str2) {
        ...
        new AlertDialog.Builder(context, m11886(context) ? 2 : 3).setTitle("\u662f\u5426\u4fdd\u5b58").setView(linearLayout).setNeutralButton("\u4fdd\u5b58", new DialogInterfaceOnClickListenerC6322(c6329, str2)).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: 飘花落叶言世哲楪兰子苏.飘花落叶言子楪世兰苏哲
    ...
    public static void m11889(ArrayList arrayList, ArrayList arrayList2, Activity activity) {
        new AlertDialog.Builder(activity, m11886(activity) ? 2 : 3).setTitle("\u9009\u62e9\u9700\u8981\u4fdd\u5b58\u7684\u56fe\u7247").setItems((CharSequence[]) arrayList2.toArray(new String[0]), new DialogInterfaceOnClickListenerC6320(arrayList, arrayList2, activity, 0)).setOnDismissListener(new DialogInterfaceOnDismissListenerC6330(0)).show();
    }
}
