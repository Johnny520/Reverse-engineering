...
public final class C6158 {
    ...
    public final byte[] m11579() {
        ...
        try {
            for (Integer num : map.keySet()) {
                for (Object obj : (List) map.get(num)) {
                    if (obj instanceof Long) {
                        ...
                        AbstractC6157.m11574("FunProtoData.toBytes", "Unknown type: " + obj.getClass().getName(), new RuntimeException(), true);
                    }
                }
            }
            if (c3465.f11133 > 0) {
            ...
            String strM6668 = "FunProtoData-toBytes";
            ...
            if (i2 == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        m11580(i, "hex->" + m11578(bArrM7761));
                        break;
                    } catch (Exception unused2) {
                        m11580(i, "hex->".concat(m11578(bArrM7761)));
                    }
                }
            } else if (i2 != 5) {
                m11580(i, "Unknown wireType: " + i2);
            } else {
