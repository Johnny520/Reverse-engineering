...
public abstract class AbstractC3065 implements InterfaceC7186, InterfaceC7188 {
    ...
    public static void m6825(String str, String str2) {
        String str3 = C6397.f17549 + str2 + "(1)";
        while (new File(str3).exists()) {
            str3 = C6397.f17549 + str2 + "(" + (Integer.parseInt(str3.substring(str3.lastIndexOf("(") + 1, str3.lastIndexOf(")"))) + 1) + ")";
        }
        try {
            AbstractC0455.m1170(str, str3);
            AbstractC6154.m11561("\u5df2\u751f\u6210\u65b0\u7684\u8bed\u97f3\u6587\u4ef6" + str3);
        } catch (IOException e) {
            C5919.m11252(e);
        }
    }
    ...
    public static void m6835(Context context, String str) {
        ...
        try {
            ...
            String strM6668 = "\u521b\u5efa\u4fdd\u5b58\u8bed\u97f3\u9762\u677f \u5df2\u629b\u51fa\u5f02\u5e38";
    ...
    */
    ...
    public static void m6853(String str, String str2) {
        if (!new File(str).exists()) {
            AbstractC6154.m11561("\u8bed\u97f3\u53ef\u80fd\u5c1a\u672a\u52a0\u8f7d\u5b8c\u6bd5");
            return;
        }
        if (str2.trim().equals("")) {
            str2 = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());
        } else if (new File(AbstractC3932.m8313().concat("/Voice"), str2).exists()) {
            m6851(str, str2);
            return;
        }
