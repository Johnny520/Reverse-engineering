...
public final class C2815 extends JSONSchema {

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public final long f8765;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public final BigDecimal f8766;
    ...
    public final boolean f8769;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏哲世, reason: contains not printable characters */
    public final BigDecimal f8770;
    ...
    public final BigDecimal f8773;

    public C2815(JSONObject jSONObject) {
        super(jSONObject);
        this.f8768 = "number".equals(jSONObject.get("type"));
        Object obj = jSONObject.get("exclusiveMinimum");
        BigDecimal bigDecimal = jSONObject.getBigDecimal("minimum");
        Boolean bool = Boolean.TRUE;
        if (obj == bool) {
            this.f8773 = bigDecimal;
            this.f8772 = true;
        } else if (obj instanceof Number) {
            this.f8773 = jSONObject.getBigDecimal("exclusiveMinimum");
            this.f8772 = true;
        } else {
            this.f8773 = bigDecimal;
            this.f8772 = false;
        }
        BigDecimal bigDecimal2 = this.f8773;
        if (bigDecimal2 == null || bigDecimal2.compareTo(BigDecimal.valueOf(bigDecimal2.longValue())) != 0) {
            this.f8771 = Long.MIN_VALUE;
        } else {
            this.f8771 = this.f8773.longValue();
        }
        BigDecimal bigDecimal3 = jSONObject.getBigDecimal("maximum");
        Object obj2 = jSONObject.get("exclusiveMaximum");
        if (obj2 == bool) {
            this.f8766 = bigDecimal3;
            this.f8769 = true;
        } else if (obj2 instanceof Number) {
            this.f8766 = jSONObject.getBigDecimal("exclusiveMaximum");
            this.f8769 = true;
        } else {
            this.f8766 = bigDecimal3;
            this.f8769 = false;
        }
        BigDecimal bigDecimal4 = this.f8766;
        if (bigDecimal4 == null || bigDecimal4.compareTo(BigDecimal.valueOf(bigDecimal4.longValue())) != 0) {
            this.f8765 = Long.MIN_VALUE;
        } else {
            this.f8765 = this.f8766.longValue();
        }
        BigDecimal bigDecimal5 = jSONObject.getBigDecimal("multipleOf");
        this.f8770 = bigDecimal5;
        if (bigDecimal5 == null) {
    ...
    public final C0748 mo5601(Float f) {
        return f == null ? JSONSchema.f8681 : mo5606(f.doubleValue());
    }

    @Override // com.alibaba.fastjson2.schema.JSONSchema
    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲 */
    public final C0748 mo5602(Double d) {
        return d == null ? JSONSchema.f8681 : mo5606(d.doubleValue());
    }
    ...
    public final C0748 mo5603(Object obj) {
        ...
        if (obj == null) {
            ...
            if ((number instanceof Byte) || (number instanceof Short) || (number instanceof Integer) || (number instanceof Long)) {
                return mo5607(number.longValue());
            }
            if ((number instanceof Float) || (number instanceof Double)) {
                return mo5606(number.doubleValue());
            }
            ...
            BigDecimal bigDecimal2 = this.f8773;
            if (bigDecimal2 != null && (!(z2 = this.f8772) ? bigDecimal2.compareTo(bigDecimal) <= 0 : bigDecimal2.compareTo(bigDecimal) < 0)) {
            ...
            BigDecimal bigDecimal3 = this.f8766;
            if (bigDecimal3 != null && (!(z = this.f8769) ? bigDecimal3.compareTo(bigDecimal) >= 0 : bigDecimal3.compareTo(bigDecimal) > 0)) {
            ...
            BigDecimal bigDecimal4 = this.f8770;
    ...
    public final C0748 mo5604(Integer num) {
        return num == null ? JSONSchema.f8681 : mo5607(num.longValue());
    }

    @Override // com.alibaba.fastjson2.schema.JSONSchema
    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏哲世 */
    public final C0748 mo5605(Long l) {
        return l == null ? JSONSchema.f8681 : mo5607(l.longValue());
    }

    @Override // com.alibaba.fastjson2.schema.JSONSchema
    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏 */
    public final C0748 mo5606(double d) {
        BigDecimal bigDecimal = this.f8773;
        if (bigDecimal != null) {
            long j = this.f8771;
            boolean z = this.f8772;
            if (j != Long.MIN_VALUE) {
                double d2 = j;
                if (!z ? d < d2 : d <= d2) {
        ...
        BigDecimal bigDecimal2 = this.f8766;
        if (bigDecimal2 != null) {
            long j2 = this.f8765;
            boolean z2 = this.f8769;
        ...
        BigDecimal bigDecimal3 = this.f8770;
        if (bigDecimal3 != null) {
            long j3 = this.f8767;
    ...
    */
    public final androidx.compose.foundation.lazy.C0748 mo5607(long r12) {
        /*
            Method dump skipped, instruction units count: 234
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.fastjson2.schema.C2815.mo5607(long):androidx.compose.foundation.lazy.飘花落叶言子楪兰世哲苏");
    }
