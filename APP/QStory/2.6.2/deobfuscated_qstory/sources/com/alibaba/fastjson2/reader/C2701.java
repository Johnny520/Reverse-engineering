...
/* JADX INFO: renamed from: com.alibaba.fastjson2.reader.飘花落叶言子兰哲世苏楪, reason: contains not printable characters */
/* JADX INFO: compiled from: r8-map-id-cb39a6809a634dd4ad3d163e22b2e3b526599fa3253f8854b17de2b335a1a776 */
/* JADX INFO: loaded from: classes.dex */
public final class C2701 extends AbstractC8363 implements InterfaceC2787 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public static final C2701 f8200 = new C2701(null, null);
    ...
    public final Object mo5418(AbstractC2898 abstractC2898, Type type, Object obj, long j) {
        ...
        if (zMo6135) {
            ...
            return OffsetTime.of(LocalDateTime.ofInstant(instantOfEpochMilli, zoneIdM6351).toLocalTime(), zoneIdM6351.getRules().getOffset(instantOfEpochMilli));
        }
        if (abstractC2898.mo6073()) {
            return null;
        }
        if (this.f23071 == null) {
            return abstractC2898.mo6142();
        }
        ...
        if (this.f23069 || z) {
            ...
            return OffsetDateTime.of(LocalDateTime.ofInstant(instantOfEpochMilli2, zoneIdM63512), zoneIdM63512.getRules().getOffset(instantOfEpochMilli2)).toOffsetTime();
        }
        abstractC2898.m6061();
        ...
        if (!this.f23077) {
            ...
            return OffsetDateTime.of(localDateTimeOf, zoneIdM63512.getRules().getOffset(localDateTimeOf)).toOffsetTime();
        }
        if (!this.f23067) {
            return ZonedDateTime.of(LocalDate.of(1970, 1, 1), LocalTime.parse(strMo6139, dateTimeFormatterM13851), zoneIdM63512).toOffsetDateTime().toOffsetTime();
        }
        LocalDateTime localDateTime = LocalDateTime.parse(strMo6139, dateTimeFormatterM13851);
        return OffsetDateTime.of(localDateTime, zoneIdM63512.getRules().getOffset(localDateTime)).toOffsetTime();
    }
