...
public abstract class AbstractC3719 {
    ...
    public static final boolean f11537;

    static {
        Logger.getLogger(AbstractC3719.class.getName());
        f11537 = System.getenv().getOrDefault("SILENT_MARKER_INSERTION_ENABLED", "false").equals("true");
    ...
    public static ByteString m7993(String str) throws IOException {
        int i;
        int i2;
        int length;
        int i3;
            ...
            if (bByteAt3 == 92) {
                ...
                if (48 > bByteAt4 || bByteAt4 > 55) {
                        ...
                        if (bByteAt4 == 85) {
                            ...
                            while (true) {
                                ...
                                if (i8 < i9) {
                                    ...
                                    iM7996 = (iM7996 << 4) | m7996(bByteAt5);
                                    i8++;
                                } else {
                                    if (!Character.isValidCodePoint(iM7996)) {
                                    ...
                                    Character.UnicodeBlock unicodeBlockOf = Character.UnicodeBlock.of(iM7996);
                                    ...
                                    byte[] bytes = new String(new int[]{iM7996}, 0, 1).getBytes(AbstractC3401.f11054);
                            ...
                            int i10 = i4 + 2;
                            if (i10 >= byteStringCopyFromUtf8.size() || !m7995(byteStringCopyFromUtf8.byteAt(i10))) {
                            ...
                            int iM79962 = m7996(byteStringCopyFromUtf8.byteAt(i10));
                            i4 += 3;
                            if (i4 >= byteStringCopyFromUtf8.size() || !m7995(byteStringCopyFromUtf8.byteAt(i4))) {
                                i4 = i10;
                            } else {
                                iM79962 = (iM79962 * 16) + m7996(byteStringCopyFromUtf8.byteAt(i4));
                            }
                            i3 = i5 + 1;
                            bArr[i5] = (byte) iM79962;
                        } else if (bByteAt4 == 97) {
                            i = i5 + 1;
                            bArr[i5] = 7;
                        } else if (bByteAt4 != 98) {
                            switch (bByteAt4) {
                                ...
                                case 117:
                                    int i11 = i4 + 2;
                                    i2 = i4 + 5;
                                    if (i2 < byteStringCopyFromUtf8.size() && m7995(byteStringCopyFromUtf8.byteAt(i11))) {
                                        int i12 = i4 + 3;
                                        if (m7995(byteStringCopyFromUtf8.byteAt(i12))) {
                                            int i13 = i4 + 4;
                                            if (m7995(byteStringCopyFromUtf8.byteAt(i13)) && m7995(byteStringCopyFromUtf8.byteAt(i2))) {
                                                char cM7996 = (char) ((m7996(byteStringCopyFromUtf8.byteAt(i13)) << 4) | (m7996(byteStringCopyFromUtf8.byteAt(i11)) << 12) | (m7996(byteStringCopyFromUtf8.byteAt(i12)) << 8) | m7996(byteStringCopyFromUtf8.byteAt(i2)));
                                                if (cM7996 >= 55296 && cM7996 <= 57343) {
                                                ...
                                                byte[] bytes2 = Character.toString(cM7996).getBytes(AbstractC3401.f11054);
                    ...
                    if (i4 >= byteStringCopyFromUtf8.size() || 48 > (bByteAt = byteStringCopyFromUtf8.byteAt(i4)) || bByteAt > 55) {
                        ...
                        iM79963 = (iM79963 * 8) + m7996(byteStringCopyFromUtf8.byteAt(i4));
                    }
                    i3 = i5 + 1;
                    bArr[i5] = (byte) iM79963;
                }
                i5 = i3;
            } else {
                bArr[i5] = bByteAt3;
    ...
    public static long m7994(String str, boolean z, boolean z2) {
        int i;
        int i2 = 0;
        if (str.startsWith("-", 0)) {
            if (!z) {
    ...
    public static boolean m7995(byte b) {
        if (48 <= b && b <= 57) {
            return true;
        }
        if (97 > b || b > 102) {
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static int m7996(byte b) {
