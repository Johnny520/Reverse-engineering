...
public enum DescriptorProtos$Edition implements InterfaceC3380 {
    EDITION_UNKNOWN(0),
    ...
    static {
        AbstractC3345.m7413(RuntimeVersion$RuntimeDomain.PUBLIC, "Edition");
        internalValueMap = new C3472(3);
        VALUES = values();
    }
    ...
    public static C3665 getDescriptor() {
        return AbstractC3669.f11452.f11329[0];
    }
    ...
    public static DescriptorProtos$Edition valueOf(C3663 c3663) {
