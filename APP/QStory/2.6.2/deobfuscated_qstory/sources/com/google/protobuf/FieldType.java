...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = AbstractC3681.f11476[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }
    ...
    private static java.lang.reflect.Type getListParameter(Class<?> cls, java.lang.reflect.Type[] typeArr) {
        while (true) {
            ...
            if (cls == List.class) {
                ...
                C2632.m5294("Unable to identify parameter type for List<T>");
                return null;
            }
                ...
                for (int i2 = 0; i2 < actualTypeArguments.length; i2++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        if (typeArr.length != typeParameters.length) {
                            C2632.m5294("Type array mismatch");
                            return null;
                        }
                        ...
                        C3682.m7938(type, "Unable to find replacement for ");
                        return null;
                    }
                }
