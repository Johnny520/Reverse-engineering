...
public final /* synthetic */ class C3223 implements InterfaceC3237, InterfaceC6294 {
    ...
    public void mo1469(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        if (obj != null) {
            try {
                String strM6668 = "chatType";
                Class cls = Integer.TYPE;
                int iIntValue = ((Integer) AbstractC6317.m11831(cls, strM6668, obj)).intValue();
                int iIntValue2 = ((Integer) AbstractC6317.m11831(cls, "atType", obj)).intValue();
                if (iIntValue == 2 && iIntValue2 == 1) {
                    AbstractC6157.m11573("chatType=2 atType=1", "\u827e\u7279\u5168\u4f53");
        ...
        if (strValueOf.contains("content=[@\u5168\u4f53\u6210\u5458]")) {
            AbstractC6157.m11573(strValueOf, "\u827e\u7279\u5168\u4f53");
            methodHookParam.setResult((Object) null);
            return;
        }
        if (obj == null) {
        ...
        try {
            ArrayList arrayList = (ArrayList) AbstractC6317.m11831(ArrayList.class, "abstractContent", obj);
            if (arrayList == null) {
                return;
            }
            for (Object obj2 : arrayList) {
                if (obj2 != null && (str = (String) AbstractC6317.m11831(String.class, "content", obj2)) != null && str.contains("@\u5168\u4f53\u6210\u5458")) {
                    AbstractC6157.m11573("abstractContent=@\u5168\u4f53\u6210\u5458", "\u827e\u7279\u5168\u4f53");
                    methodHookParam.setResult((Object) null);
                    return;
                }
            }
