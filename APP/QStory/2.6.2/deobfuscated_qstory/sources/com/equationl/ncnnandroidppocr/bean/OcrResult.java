...
public final /* data */ class OcrResult {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC4394.m8917(this.text, ocrResult.text) && this.inferenceTime == ocrResult.inferenceTime && AbstractC4394.m8917(this.textLines, ocrResult.textLines) && AbstractC4394.m8917(this.drawBitmap, ocrResult.drawBitmap);
    }
    ...
    public int hashCode() {
        int iM159 = AbstractC0053.m159(this.textLines, AbstractC0053.m141(this.text.hashCode() * 31, 31, this.inferenceTime), 31);
        Bitmap bitmap = this.drawBitmap;
        return iM159 + (bitmap == null ? 0 : bitmap.hashCode());
    }
    ...
    public /* synthetic */ OcrResult(String str, long j, List list, Bitmap bitmap, int i, AbstractC4384 abstractC4384) {
