...
public final class ByteArrayAnnotatedOutput implements AnnotatedOutput, InterfaceC8384 {
    ...
    public void assertCursor(int i) {
        ...
        StringBuilder sbM148 = AbstractC0053.m148(i, "expected cursor ", "; actual value: ");
        sbM148.append(this.cursor);
        throw new ExceptionWithContext(sbM148.toString());
    }
    ...
    */
    public void enableAnnotations(int r4, boolean r5) {
        ...
        L2e:
            ...
            top.suzhelan.qstory.hook.item.C5919.m11249(r3)
            return
        L34:
    ...
    public void write(byte[] bArr, int i, int i2) {
        ...
        if ((i | i2 | i4) < 0 || i5 > bArr.length) {
            C2941.m6348("bytes.length ", bArr.length, "; ", i, "..!", i4);
            return;
        }
        if (this.stretchy) {
            ensureCapacity(i4);
    ...
    @Override // com.android.dx.util.Output, p284.InterfaceC8384
