...
public final class CatchStructs {
    ...
    private void annotateEntries(String str, PrintWriter printWriter, AnnotatedOutput annotatedOutput) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            StringBuilder sbM11553 = AbstractC6136.m11553(strM136, "try ");
            sbM11553.append(Hex.u2or4(entry.getStart()));
            sbM11553.append("..");
            sbM11553.append(Hex.u2or4(entry.getEnd()));
            String string = sbM11553.toString();
            String human = handlers.toHuman(strM136, "");
            if (z) {
        ...
        StringBuilder sbM115532 = AbstractC6136.m11553(strM136, "size: ");
        sbM115532.append(Hex.u2(this.handlerOffsets.size()));
        annotatedOutput.annotate(i4, sbM115532.toString());
        ...
        while (true) {
            ...
            if (!it.hasNext()) {
                annotateAndConsumeHandlers(catchHandlerList, i5, this.encodedHandlers.length - i5, strM136, printWriter, annotatedOutput);
                return;
            }
            ...
            if (catchHandlerList != null) {
                ...
                annotateAndConsumeHandlers(catchHandlerList, i5, iIntValue - i5, strM136, printWriter2, annotatedOutput2);
            } else {
                printWriter2 = printWriter;
                annotatedOutput2 = annotatedOutput;
            }
    ...
    public void encode(DexFile dexFile) {
        ...
        if (treeMap.size() > 65535) {
            C5919.m11247("too many catch handlers");
            return;
        }
