...
public class Simulator {
    ...
    public class SimVisitor implements BytecodeArray.Visitor {
        ...
        */
        public void visitLocal(int r7, int r8, int r9, int r10, com.android.dx.rop.type.Type r11, int r12) {
            ...
            L8f:
                com.android.dx.cf.code.Machine r9 = r6.machine
                com.android.dx.cf.code.Frame r6 = r6.frame
                r9.run(r6, r8, r7)
                return
            */
    ...
    public void fail(String str) {
        StringBuilder sbM11551 = AbstractC6136.m11551("ERROR in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM11551.append(str);
        throw new SimException(sbM11551.toString());
    }
    ...
    private void warn(String str) {
        StringBuilder sbM11551 = AbstractC6136.m11551("WARNING in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM11551.append(str);
        this.dexOptions.err.println(sbM11551.toString());
    }
