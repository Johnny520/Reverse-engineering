        ...
        if (result != null && !this.ssaMeth.isRegALocal(result) && opcode.getOpcode() != 5) {
            ...
            if (typeBearer.isConstant() && typeBearer.getBasicType() == 6) {
                ...
                if (opcode.getOpcode() == 56) {
                    replacePlainInsn((NormalSsaInsn) AbstractC6136.m11555(1, this.ssaMeth.getBlocks().get(normalSsaInsn.getBlock().getPredecessors().nextSetBit(0)).getInsns()), registerSpecList, 6, null);
                }
                return true;
            }
        }
