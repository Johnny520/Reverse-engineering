...
public final class ProtoIdsSection extends UniformItemSection {
    ...
    public IndexedItem get(Constant constant) {
        ...
        if (!(constant instanceof CstProtoRef)) {
            C5919.m11249("cst not instance of CstProtoRef");
            return null;
        }
        throwIfNotPrepared();
    ...
    public void writeHeaderPart(AnnotatedOutput annotatedOutput) {
        ...
        if (size > 65536) {
            C5919.m11247("too many proto ids");
            return;
        }
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(4, "proto_ids_size:  " + Hex.u4(size));
            AbstractC2442.m4552(fileOffset, new StringBuilder("proto_ids_off:   "), annotatedOutput, 4);
        }
