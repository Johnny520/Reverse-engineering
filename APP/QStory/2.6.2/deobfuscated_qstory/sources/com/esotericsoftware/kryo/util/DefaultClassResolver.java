...
public class DefaultClassResolver implements ClassResolver {
    ...
    public Registration readClass(Input input) {
        ...
        if (registration == null) {
            throw new KryoException(AbstractC6136.m11556(i, "Encountered unregistered class ID: "));
        }
        if (Log.TRACE) {
            StringBuilder sbM148 = AbstractC0053.m148(i, "Read class ", ": ");
            sbM148.append(Util.className(registration.getType()));
    ...
    public Registration readName(Input input) {
        ...
        if (cls == null) {
            ...
            if (typeByName == null) {
                try {
                    ...
                    try {
                        ...
                        throw new KryoException(AbstractC0053.m152("Unable to find class: ", string), e);
                    }
                }
            ...
            StringBuilder sbM148 = AbstractC0053.m148(varInt, "Read class name reference ", ": ");
    ...
    public Registration register(Registration registration) {
        ...
        if (registration == null) {
            C5919.m11249("registration cannot be null.");
            return null;
        }
    ...
    public void writeName(Output output, Class cls, Registration registration) {
        ...
        if (identityObjectIntMap != null && (i = identityObjectIntMap.get(cls, -1)) != -1) {
            if (Log.TRACE) {
                StringBuilder sbM148 = AbstractC0053.m148(i, "Write class name reference ", ": ");
                sbM148.append(Util.className(cls));
