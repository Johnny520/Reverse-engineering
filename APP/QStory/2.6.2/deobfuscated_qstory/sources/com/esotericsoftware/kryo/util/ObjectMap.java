...
public class ObjectMap<K, V> implements Iterable<Entry<K, V>> {
    ...
    public ObjectMap(int i, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            C3075.m6914("loadFactor must be > 0 and < 1: ", f);
            throw null;
        }
        this.loadFactor = f;
    ...
    public static int tableSize(int i, float f) {
        if (i < 0) {
            C5919.m11249(AbstractC6136.m11556(i, "capacity must be >= 0: "));
            return 0;
        }
        ...
        C5919.m11249(AbstractC6136.m11556(i, "The required capacity is too large: "));
        return 0;
    }
