...
public class IntArray {
    ...
    public int[] ensureCapacity(int i) {
        if (i < 0) {
            C5919.m11249(AbstractC6136.m11556(i, "additionalCapacity must be >= 0: "));
            return null;
        }
        int i2 = this.size + i;
    ...
    public int get(int i) {
        ...
        C4210.m8624(AbstractC0053.m148(i, "index can't be >= size: ", " >= "), this.size);
        return 0;
    }
    ...
    public void removeRange(int i, int i2) {
        int i3 = this.size;
        if (i2 >= i3) {
            C4210.m8624(AbstractC0053.m148(i2, "end can't be >= size: ", " >= "), this.size);
            return;
        }
        if (i > i2) {
            C7546.m12743(AbstractC6136.m11559(i, i2, "start can't be > end: ", " > "));
            return;
        }
        int i4 = (i2 - i) + 1;
        int i5 = i3 - i4;
    ...
    public int[] setSize(int i) {
        if (i < 0) {
            C5919.m11249(AbstractC6136.m11556(i, "newSize must be >= 0: "));
            return null;
        }
    ...
    public void swap(int i, int i2) {
        int i3 = this.size;
        if (i >= i3) {
            C4210.m8624(AbstractC0053.m148(i, "first can't be >= size: ", " >= "), this.size);
            return;
        }
        if (i2 >= i3) {
            C4210.m8624(AbstractC0053.m148(i2, "second can't be >= size: ", " >= "), this.size);
            return;
        }
        int[] iArr = this.items;
        int i4 = iArr[i];
    ...
    public void addAll(IntArray intArray, int i, int i2) {
        if (i + i2 <= intArray.size) {
            ...
            C7546.m12747(AbstractC0053.m151(i, i2, "offset + length must be <= size: ", " + ", " <= "), intArray.size);
        }
    }
