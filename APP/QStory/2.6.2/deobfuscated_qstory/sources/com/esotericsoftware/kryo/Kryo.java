...
public class Kryo {
    ...
    private InterfaceC9153 strategy;
    ...
    public Kryo(ClassResolver classResolver, ReferenceResolver referenceResolver) {
        ...
        if (classResolver == null) {
            C5919.m11249("classResolver cannot be null.");
            throw null;
        }
    ...
    public InterfaceC9153 getInstantiatorStrategy() {
        ...
        if (registration == null) {
            ...
            if (registration == null) {
                if (this.registrationRequired) {
                    C5919.m11249(unregisteredClassMessage(cls));
                    return null;
                }
    ...
    public <T> T newInstance(Class<T> cls) {
        ...
        InterfaceC9132 instantiator = registration.getInstantiator();
    ...
    public InterfaceC9132 newInstantiator(Class cls) {
        return this.strategy.newInstantiatorOf(cls);
    }

    public Registration readClass(Input input) {
        if (input == null) {
            C5919.m11249("input cannot be null.");
            return null;
        }
        try {
    ...
    public int readReferenceOrNull(Input input, Class cls, boolean z) {
        ...
        if (varInt == 1) {
            ...
            if (Log.TRACE) {
                StringBuilder sbM148 = AbstractC0053.m148(iNextReadId, "Read initial reference ", ": ");
                sbM148.append(Util.className(cls));
                sbM148.append(Util.pos(input.position()));
                Log.trace("kryo", sbM148.toString());
            }
        ...
        try {
            ...
            if (Log.DEBUG) {
                StringBuilder sbM1482 = AbstractC0053.m148(i, "Read reference ", ": ");
                sbM1482.append(Util.string(this.readObject));
                sbM1482.append(Util.pos(input.position()));
                Log.debug("kryo", sbM1482.toString());
            }
            return -1;
        } catch (Exception e) {
    ...
    public void reference(Object obj) {
        ...
        if (obj2 != null) {
            if (obj == null) {
                C5919.m11249("object cannot be null.");
            } else {
    ...
    public Registration register(Registration registration) {
        ...
        if (id < 0) {
            C5919.m11249(AbstractC6136.m11556(id, "id must be > 0: "));
            return null;
        }
    ...
    public void setClassLoader(ClassLoader classLoader) {
        if (classLoader != null) {
            ...
            C5919.m11249("classLoader cannot be null.");
        }
    }
    ...
    public void setInstantiatorStrategy(InterfaceC9153 interfaceC9153) {
        this.strategy = interfaceC9153;
    }
    ...
    public void setMaxDepth(int i) {
        if (i > 0) {
            ...
            C5919.m11249("maxDepth must be > 0.");
        }
    }
    ...
    public void setReferenceResolver(ReferenceResolver referenceResolver) {
        if (referenceResolver == null) {
            C5919.m11249("referenceResolver cannot be null.");
            return;
        }
        this.references = true;
        this.referenceResolver = referenceResolver;
    ...
    public Registration writeClass(Output output, Class cls) {
        if (output == null) {
            C5919.m11249("output cannot be null.");
            return null;
        }
        try {
    ...
    public boolean writeReferenceOrNull(Output output, Object obj, boolean z) {
        ...
        if (writtenId != -1) {
            if (Log.DEBUG) {
                StringBuilder sbM148 = AbstractC0053.m148(writtenId, "Write reference ", ": ");
                sbM148.append(Util.string(obj));
                sbM148.append(Util.pos(output.position()));
                Log.debug("kryo", sbM148.toString());
            }
        ...
        output.writeByte((byte) 1);
        if (Log.TRACE) {
            StringBuilder sbM1482 = AbstractC0053.m148(iAddWrittenObject, "Write initial reference ", ": ");
            sbM1482.append(Util.string(obj));
            sbM1482.append(Util.pos(output.position()));
            Log.trace("kryo", sbM1482.toString());
        }
        return false;
    }
    ...
    public void addDefaultSerializer(Class cls, SerializerFactory serializerFactory) {
        if (cls == null) {
            ...
            C5919.m11249("serializerFactory cannot be null.");
        }
    }
    ...
    private void addDefaultSerializer(String str, Class<? extends Serializer> cls) {
        try {
            ...
            throw new KryoException(AbstractC0053.m152("default serializer cannot be added: ", str));
        }
    }
    ...
    public void addDefaultSerializer(Class cls, Class<? extends Serializer> cls2) {
        if (cls == null) {
            ...
            C5919.m11249("serializerClass cannot be null.");
        }
    }
    ...
    public Registration register(Class cls, Serializer serializer, int i) {
        ...
        C5919.m11249(AbstractC6136.m11556(i, "id must be >= 0: "));
        return null;
    }
