                ...
                if (iA < bArr.length) {
                    ...
                    switch (ClassWriter.a[i13]) {
                        ...
                        case 15:
                            ...
                            int i16 = (iA + 4) - (iA & 3);
                            iA = AbstractC6136.m11541(a(bArr, i16 + 4), 8, 8, i16);
                            break;
                        case 17:
    ...
    */
    ...
    public final int a() {
        ...
        if (i <= 0) {
            ...
            if (i > 65535) {
                C2632.m5294("Method code too large!");
                return 0;
            }
            this.b.newUTF8(AttCode.ATTRIBUTE_NAME);
            iA = AbstractC6136.m11541(this.A, 8, this.r.b + 18, 8);
            if (this.E != null) {
        ...
        if (this.j > 0) {
            ...
            iA = AbstractC6136.m11541(this.j, 2, 8, iA);
        }
        int i2 = this.c;
        if ((i2 & 4096) != 0) {
            ClassWriter classWriter3 = this.b;
