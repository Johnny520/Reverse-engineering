...
public abstract class MethodAccess {
    ...
    public static MethodAccess get(Class cls) {
        ...
        if (!zIsInterface && cls.getSuperclass() == null && cls != Object.class) {
            C5919.m11249("The type must not be an interface, a primitive type, or void.");
            return null;
        }
        ...
        try {
            ...
            C0276.m847("Error constructing method access class: ".concat(strConcat), th2);
            return methodAccess;
        }
    }
    ...
    public int getIndex(String str, Class... clsArr) {
        ...
        C4210.m8613(Arrays.toString(clsArr), AbstractC6136.m11550("Unable to find non-private method: ", str, " "));
        return 0;
    }
    ...
    public int getIndex(String str) {
        ...
        C5919.m11249(AbstractC0053.m152("Unable to find non-private method: ", str));
        return 0;
    }
}
