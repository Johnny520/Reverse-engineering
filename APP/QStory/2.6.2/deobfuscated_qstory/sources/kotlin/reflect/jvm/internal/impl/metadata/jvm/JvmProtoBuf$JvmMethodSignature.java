...
public final class JvmProtoBuf$JvmMethodSignature extends GeneratedMessageLite implements InterfaceC4699 {
    public static InterfaceC4698 PARSER = new C6916(1);
    ...
    private JvmProtoBuf$JvmMethodSignature(C4708 c4708, C4725 c4725) {
    ...
    public static C6914 newBuilder(JvmProtoBuf$JvmMethodSignature jvmProtoBuf$JvmMethodSignature) {
        C6914 c6914NewBuilder = newBuilder();
        c6914NewBuilder.m12180(jvmProtoBuf$JvmMethodSignature);
    ...
    private JvmProtoBuf$JvmMethodSignature(AbstractC4728 abstractC4728) {
        super(abstractC4728);
        this.memoizedIsInitialized = (byte) -1;
        this.memoizedSerializedSize = -1;
