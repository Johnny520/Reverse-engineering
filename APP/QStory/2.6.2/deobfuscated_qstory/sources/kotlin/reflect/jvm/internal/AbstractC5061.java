...
public abstract class AbstractC5061 {
    ...
    */
    ...
    public static String m10021() {
        return AbstractC3932.m8313().concat("/data/list/");
    }
    ...
    public static final JSONObject m10039() {
        ...
        jSONObject.put("Time", AbstractC6157.m11576());
        jSONObject.put("QQVersion", AbstractC6340.f17462);
        jSONObject.put("QStoryVersion", "2.6.2");
        String strM66682 = "XPosedTag";
        try {
