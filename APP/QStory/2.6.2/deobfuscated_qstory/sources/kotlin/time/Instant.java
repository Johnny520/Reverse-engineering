...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public Instant(long j, int i) {
        ...
        if (-31557014167219200L > j || j >= 31556889864403200L) {
            C5919.m11249("Instant exceeds minimum or maximum instant");
            throw null;
        }
    }
    ...
    public int compareTo(Instant other) {
        other.getClass();
        int iM8914 = AbstractC4394.m8914(this.epochSeconds, other.epochSeconds);
        return iM8914 != 0 ? iM8914 : AbstractC4394.m8915(this.nanosecondsOfSecond, other.nanosecondsOfSecond);
    }
    ...
    public final Instant m10179minusLRDsOJo(long duration) {
        return m10181plusLRDsOJo(C5156.m10189(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m10180minusUwyO8pc(Instant other) {
        other.getClass();
        C8631 c8631 = C5156.f14712;
        return C5156.m10190(AbstractC5159.m10203(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS), AbstractC5159.m10202(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }

    /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
    public final Instant m10181plusLRDsOJo(long duration) {
        C8631 c8631 = C5156.f14712;
        long jM10192 = C5156.m10192(duration, DurationUnit.SECONDS);
        int iM10184 = C5156.m10184(duration);
        if (jM10192 == 0 && iM10184 == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM10192;
        if ((j ^ j2) < 0 && (jM10192 ^ j) >= 0) {
            return duration > 0 ? MAX : MIN;
        }
        int i = this.nanosecondsOfSecond + iM10184;
        Companion.getClass();
        return C5152.m10182(i, j2);
    }
    ...
    public String toString() {
        ...
        AbstractC5159.m10195(sb, sb, i4);
        sb.append(SignatureVisitor.SUPER);
        AbstractC5159.m10195(sb, sb, i5);
        sb.append('T');
        AbstractC5159.m10195(sb, sb, i7);
        sb.append(':');
        AbstractC5159.m10195(sb, sb, i9);
        sb.append(':');
        AbstractC5159.m10195(sb, sb, i10);
        if (nanosecondsOfSecond != 0) {
            sb.append(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
            while (true) {
                int i12 = i11 + 1;
                iArr = AbstractC5159.f14722;
