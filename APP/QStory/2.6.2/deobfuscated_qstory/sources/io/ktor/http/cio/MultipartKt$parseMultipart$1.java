...
@InterfaceC6861(c = "io.ktor.http.cio.MultipartKt$parseMultipart$1", f = "Multipart.kt", l = {184, 187, 190, 191, 196, 200, Opcodes.REM_DOUBLE_2ADDR, Opcodes.DIV_INT_LIT8, Opcodes.REM_INT_LIT8, 227, 227, 230, 232}, m = "invokeSuspend")
...
final class MultipartKt$parseMultipart$1 extends SuspendLambda implements InterfaceC6553 {
    final /* synthetic */ C7204 $boundaryPrefixed;
    ...
    public MultipartKt$parseMultipart$1(InterfaceC4251 interfaceC4251, C7204 c7204, long j, Long l, InterfaceC4356<? super MultipartKt$parseMultipart$1> interfaceC4356) {
        super(2, interfaceC4356);
        this.$input = interfaceC4251;
        this.$boundaryPrefixed = c7204;
        this.$maxPartSize = j;
        this.$totalLength = l;
    }
    ...
    public final InterfaceC4356<C5175> create(Object obj, InterfaceC4356<?> interfaceC4356) {
        MultipartKt$parseMultipart$1 multipartKt$parseMultipart$1 = new MultipartKt$parseMultipart$1(this.$input, this.$boundaryPrefixed, this.$maxPartSize, this.$totalLength, interfaceC4356);
    ...
    public final Object invoke(InterfaceC5195 interfaceC5195, InterfaceC4356<? super C5175> interfaceC4356) {
        return ((MultipartKt$parseMultipart$1) create(interfaceC5195, interfaceC4356)).invokeSuspend(C5175.f14739);
    }

    /* JADX WARN: Code restructure failed: missing block: B:113:0x02df, code lost:
    
        if (((kotlinx.coroutines.channels.AbstractC5210) r0).f14798.mo8443(r2, r20) != r7) goto L125;
     */
    /* JADX WARN: Code restructure failed: missing block: B:123:0x0312, code lost:
    
        if (((kotlinx.coroutines.channels.AbstractC5210) r0).f14798.mo8443(r2, r20) == r7) goto L124;
     */
