...
public final class MissingApplicationPluginException extends IllegalStateException implements InterfaceC5433 {
    private final C4208 key;

    public MissingApplicationPluginException(C4208 c4208) {
        c4208.getClass();
        this.key = c4208;
    }
    ...
    public String getMessage() {
        return AbstractC0053.m146(new StringBuilder("Application plugin "), this.key.f12695, " is not installed");
    }
}
