...
@InterfaceC6861(c = "io.ktor.server.application.hooks.CallSetup$install$1", f = "CommonHooks.kt", l = {26}, m = "invokeSuspend")
...
final class CallSetup$install$1 extends SuspendLambda implements InterfaceC6550 {
    final /* synthetic */ InterfaceC6553 $handler;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CallSetup$install$1(InterfaceC6553 interfaceC6553, InterfaceC4356<? super CallSetup$install$1> interfaceC4356) {
    ...
    public final Object invoke(AbstractC4193 abstractC4193, C5175 c5175, InterfaceC4356<? super C5175> interfaceC4356) {
        CallSetup$install$1 callSetup$install$1 = new CallSetup$install$1(this.$handler, interfaceC4356);
        callSetup$install$1.L$0 = abstractC4193;
        return callSetup$install$1.invokeSuspend(C5175.f14739);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (interfaceC6553.invoke(interfaceC4064, this) == coroutineSingletons) {
