...
public final class CannotTransformContentToTypeException extends ContentTransformationException implements InterfaceC5433 {
    private final InterfaceC5086 type;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CannotTransformContentToTypeException(InterfaceC5086 interfaceC5086) {
        super("Cannot transform this request's content to " + interfaceC5086);
        interfaceC5086.getClass();
        this.type = interfaceC5086;
    }
