...
@InterfaceC5168
public final /* synthetic */ class QQMessage$MessageHead$SenderInfo$$serializer implements InterfaceC7078 {
    ...
    static {
        ...
        C7128 c7128 = new C7128("top.suzhelan.qstory.entity.proto.QQMessage.MessageHead.SenderInfo", qQMessage$MessageHead$SenderInfo$$serializer, 3);
        AbstractC6136.m11545(-3937695247635842471L, c7128, true, 1);
        AbstractC6136.m11545(-3937709300768834983L, c7128, true, 2);
        AbstractC6136.m11545(-3937710782532552103L, c7128, true, 4);
        descriptor = c7128;
        $stable = 8;
    }
    ...
    public final QQMessage.MessageHead.SenderInfo deserialize(InterfaceC7186 decoder) {
        "decoder";
        decoder.getClass();
        ...
        return new QQMessage.MessageHead.SenderInfo(i, jMo6886, iMo6872, strMo6878, (AbstractC7136) null);
    }
    ...
    @Override // p089.InterfaceC7183
    public final void serialize(InterfaceC7185 encoder, QQMessage.MessageHead.SenderInfo value) {
        ...
        QQMessage.MessageHead.SenderInfo.write$Self$app_publishRelease(value, interfaceC7187Mo6800, interfaceC7190);
