...
public final class C5825 extends AbstractC6293 {
    ...
    public static final int m11181(C5825 c5825, Object obj) {
        ...
        try {
            Class clsM11838 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.MemberInfo");
            ...
            if (XposedHelpers.getBooleanField(obj2, "isRobot")) {
                return 3;
            }
            Object objectField = XposedHelpers.getObjectField(obj2, "role");
            if (objectField == null || (strM6668 = objectField.toString()) == null) {
                strM6668 = "";
            }
            if (AbstractC5143.m10171(strM6668, "OWNER", false)) {
                return 1;
            }
            if (AbstractC5143.m10171(strM6668, "ADMIN", false)) {
                return 2;
            }
            return AbstractC5143.m10171(strM6668, "MEMBER", false) ? 4 : 5;
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        try {
            XposedHelpers.findAndHookMethod(AbstractC6318.m11838("com.tencent.mobileqq.aio.input.at.common.SubmitListEvent"), "getItemList", new Object[]{new C5811(this, 18)});
        } catch (Exception unused) {
        }
    }
}
