...
public final class C5812 extends AbstractC6298 implements InterfaceC6292 {
    ...
    public final C6301 f15938 = new C6301("MsgViewIdAdapter");
    ...
    public static final void m11173(C5812 c5812, XC_MethodHook.MethodHookParam methodHookParam) {
        try {
            ...
            Class clsM14657 = AbstractC9121.m14657("com.tencent.mobileqq.aio.msg.AIOMsgItem");
            ...
            if (objM14653 != null && view != null) {
                ...
                Iterator it = ((ArrayList) C9117.m14649(ArrayList.class, "elements", c6316M11826.m11828(objM14653, new Object[0]))).iterator();
                "iterator(...)";
                it.getClass();
                while (it.hasNext()) {
                    Object next = it.next();
                    "next(...)";
                    next.getClass();
                    if (((Integer) C9117.m14649(Integer.TYPE, "elementType", next)).intValue() <= 2) {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (((Boolean) c6301.m11812(bool, strM6668)).booleanValue()) {
            Object objM11812 = c6301.m11812(0, "id");
            "get(...)";
            objM11812.getClass();
        ...
        Class cls = Void.TYPE;
        if (i >= 12290) {
            C9125 c9125M14681 = C9125.m14681("com.tencent.mobileqq.aio.msglist.holder.AIOBubbleMsgItemVB");
            c9125M14681.f25504 = "handleUIState";
            c9125M14681.m14683(AbstractC9121.m14657("com.tencent.mvi.base.mvi.MviUIState"));
            c9125M14681.f25506 = cls;
            XposedBridge.hookMethod((Method) c9125M14681.m14686(), new C5813(this, 1));
            return;
        }
        C9125 c9125M14680 = C9125.m14680(AbstractC9121.m14657("com.tencent.mobileqq.aio.msglist.holder.AIOBubbleMsgItemVB"));
    ...
    public final void m11174(ViewGroup viewGroup) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getClass().getName().equals("com.tencent.qqnt.aio.holder.template.BubbleLayoutCompatPress")) {
                ...
                AbstractC6154.m11561("[QStory]\u5df2\u5bf9MsgView\u8fdb\u884c\u9002\u914d,\u5efa\u8bae\u91cd\u542f\u4e00\u6b21QQ");
                return;
            }
        }
    }
