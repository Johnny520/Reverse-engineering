...
public final class C5816 extends AbstractC6298 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        String strM6668 = "com.tencent.qqnt.msg.MsgService$a";
        int i = AbstractC6340.f17461;
        if (i >= 12290) {
            strM6668 = "com.tencent.qqnt.msg.MsgService$d";
        } else if (i >= 11650) {
            strM6668 = "com.tencent.qqnt.kernel.api.impl.MsgService$b";
        } else if (i == 9048) {
            strM6668 = "com.tencent.qqnt.kernel.api.impl.MsgService$d";
        } else if (i >= 6458) {
            strM6668 = "com.tencent.qqnt.msg.MsgService$c";
        }
        Class clsM14657 = AbstractC9121.m14657(strM6668);
        C6316 c6316M11826 = C6316.m11826(clsM14657);
        String strM66682 = "onRecvMsg";
                ...
                switch (i3) {
                    case 0:
                        ...
                        if (System.currentTimeMillis() - c5816.f15948 >= 2000 && !arrayList.isEmpty()) {
                            ...
                            "get(...)";
                            obj2.getClass();
                            Long l = (Long) C9117.m14649(cls2, "msgId", obj2);
                    ...
                    default:
                        ...
                        if (System.currentTimeMillis() - c5816.f15948 >= 2000 && !arrayList3.isEmpty()) {
                            ...
                            "get(...)";
                            obj4.getClass();
                            Long l2 = (Long) C9117.m14649(cls2, "msgId", obj4);
                            ArrayList arrayList4 = C5816.f15944;
                            if (!arrayList4.contains(l2)) {
                                Integer num = (Integer) C9117.m14649(Integer.TYPE, "sendStatus", obj4);
                                if (num != null && num.intValue() == 2) {
                                    if (!((Boolean) C9117.m14649(Boolean.TYPE, "isOnlineMsg", obj4)).booleanValue() && String.valueOf((Long) C9117.m14649(cls2, "senderUin", obj4)).equals(QQEnvTool.getCurrentUin())) {
                                        l2.getClass();
        ...
        String strM66683 = "onMsgInfoListUpdate";
