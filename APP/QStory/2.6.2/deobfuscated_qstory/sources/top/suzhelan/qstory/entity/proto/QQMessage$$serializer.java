...
@InterfaceC5168
public final /* synthetic */ class QQMessage$$serializer implements InterfaceC7078 {
    ...
    static {
        ...
        C7128 c7128 = new C7128("top.suzhelan.qstory.entity.proto.QQMessage", qQMessage$$serializer, 3);
        AbstractC6136.m11545(-3937697085881845159L, c7128, true, 1);
        AbstractC6136.m11545(-3937697034342237607L, c7128, true, 2);
        AbstractC6136.m11545(-3937696944147924391L, c7128, true, 3);
        descriptor = c7128;
        $stable = 8;
    }
    ...
    public final InterfaceC7183[] childSerializers() {
        return new InterfaceC7183[]{C8675.m14355(QQMessage$MessageHead$$serializer.INSTANCE), QQMessage$MessageContentInfo$$serializer.INSTANCE, QQMessage$MessageBody$$serializer.INSTANCE};
    }

    @Override // p089.InterfaceC7183
    public final QQMessage deserialize(InterfaceC7186 decoder) {
        "decoder";
        decoder.getClass();
        ...
        while (z) {
            ...
            if (iMo10672 == -1) {
                ...
                messageHead = (QQMessage.MessageHead) interfaceC7188Mo6876.mo6875(interfaceC7190, 0, QQMessage$MessageHead$$serializer.INSTANCE, messageHead);
                i |= 1;
            } else if (iMo10672 == 1) {
                messageContentInfo = (QQMessage.MessageContentInfo) interfaceC7188Mo6876.mo6874(interfaceC7190, 1, QQMessage$MessageContentInfo$$serializer.INSTANCE, messageContentInfo);
                i |= 2;
            } else {
                if (iMo10672 != 2) {
                ...
                messageBody = (QQMessage.MessageBody) interfaceC7188Mo6876.mo6874(interfaceC7190, 2, QQMessage$MessageBody$$serializer.INSTANCE, messageBody);
                i |= 4;
            }
        }
        interfaceC7188Mo6876.mo6877(interfaceC7190);
        return new QQMessage(i, messageHead, messageContentInfo, messageBody, (AbstractC7136) null);
    }
    ...
    @Override // p089.InterfaceC7183
    public final void serialize(InterfaceC7185 encoder, QQMessage value) {
        ...
        QQMessage.write$Self$app_publishRelease(value, interfaceC7187Mo6800, interfaceC7190);
