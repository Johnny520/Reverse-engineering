...
@InterfaceC5168
public final /* synthetic */ class InfoSyncPush$SyncRecallOperateInfo$SyncInfoBody$$serializer implements InterfaceC7078 {
    ...
    static {
        ...
        C7128 c7128 = new C7128("top.suzhelan.qstory.entity.proto.InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody", infoSyncPush$SyncRecallOperateInfo$SyncInfoBody$$serializer, 4);
        c7128.m12382("senderPeerId", true);
        c7128.m12381(new MsgPush$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(1));
        c7128.m12382("senderUid", true);
        c7128.m12381(new MsgPush$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(2));
        c7128.m12382("eventTime", true);
        c7128.m12381(new MsgPush$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(5));
        c7128.m12382("msgList", true);
        c7128.m12381(new MsgPush$$serializer$annotationImpl$kotlinx_serialization_protobuf_ProtoNumber$0(8));
        descriptor = c7128;
        $stable = 8;
    }
    ...
    public final InterfaceC7183[] childSerializers() {
        InterfaceC5183[] interfaceC5183Arr = InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody.$childSerializers;
        C7071 c7071 = C7071.f18981;
        return new InterfaceC7183[]{c7071, C7134.f19094, c7071, interfaceC5183Arr[3].getValue()};
    }

    @Override // p089.InterfaceC7183
    public final InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody deserialize(InterfaceC7186 decoder) {
        "decoder";
        decoder.getClass();
        ...
        return new InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody(i, jMo6886, strMo6878, jMo68862, list, (AbstractC7136) null);
    }
    ...
    @Override // p089.InterfaceC7183
    public final void serialize(InterfaceC7185 encoder, InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody value) {
        ...
        InfoSyncPush.SyncRecallOperateInfo.SyncInfoBody.write$Self$app_publishRelease(value, interfaceC7187Mo6800, interfaceC7190);
