...
public final class C5882 extends AbstractC6293 {
    ...
    public final Map f16055 = AbstractC4338.m8777(new Pair("\u9ed8\u8ba4", 0), new Pair("\u6700\u5c0f", 1), new Pair("\u7565\u5c0f", 64), new Pair("\u7565\u5927", 512), new Pair("\u6700\u5927", 1024));

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final C9114 f16056 = new C9114("FakePicSize", 0);
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        try {
            clsM11838 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.Contact");
        } catch (Throwable unused) {
            clsM11838 = null;
        }
        if (clsM11838 == null) {
            try {
                clsM11838 = AbstractC6318.m11838("com.tencent.qqnt.kernelpublic.nativeinterface.Contact");
        ...
        try {
            clsM118382 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback");
        } catch (Throwable unused3) {
            clsM118382 = null;
        }
        if (clsM118382 == null) {
            try {
                clsM118382 = AbstractC6318.m11838("com.tencent.qqnt.kernelpublic.nativeinterface.IOperateCallback");
        ...
        try {
            clsM118383 = AbstractC6318.m11838("com.tencent.qqnt.kernel.nativeinterface.IKernelMsgService$CppProxy");
        } catch (Throwable unused5) {
            clsM118383 = null;
        }
        if (clsM118383 == null) {
            try {
                clsM118384 = AbstractC6318.m11838("com.tencent.qqnt.kernelpublic.nativeinterface.IKernelMsgService$CppProxy");
