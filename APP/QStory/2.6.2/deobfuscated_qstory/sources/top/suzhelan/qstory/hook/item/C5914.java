...
public final class C5914 extends AbstractC6293 {
    ...
    public static final String[] f16100 = {"/bubble_info", "/files/bubble_info", "/files/bubble_paster", "/files/vas_material_folder/bubble_dir"};

    /* JADX INFO: renamed from: 飘花落叶言子楪苏兰世哲, reason: contains not printable characters */
    public static void m11239(ClassLoader classLoader) {
        String[] strArr = {"com.tencent.mobileqq.aio.msg.AIOMsgItem", "com.tencent.mobileqq.activity.aio.AIOMsgItem", "com.tencent.mobileqq.data.ChatMessage", "com.tencent.mobileqq.data.MessageRecord"};
        String[] strArr2 = {"setBubbleInfo", "setBubbleId", "setSubBubbleId", "setMsgBubble", "getBubbleId"};
        for (int i = 0; i < 4; i++) {
            try {
                ...
                for (Method method : declaredMethods) {
                    ...
                    name.getClass();
                    if (AbstractC5138.m10125(name, "set", false) && AbstractC4346.m8843(name, strArr2)) {
                        XposedBridge.hookMethod(method, new C5909(8));
                    }
                    if (name.equals("getBubbleId")) {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (this.f17376.booleanValue()) {
            try {
                try {
                    Class.forName("com.tencent.qqnt.kernel.nativeinterface.VASMsgBubble", false, classLoader);
                    m11241(classLoader);
    ...
    public final void m11241(ClassLoader classLoader) throws ClassNotFoundException {
        Class<?> cls = Class.forName("com.tencent.qqnt.kernel.nativeinterface.VASMsgBubble", false, classLoader);
        cls.getClass();
        try {
            XposedBridge.hookMethod(cls.getDeclaredMethod("getBubbleId", null), new C5909(10));
        } catch (Exception unused) {
        }
        try {
            XposedBridge.hookMethod(cls.getDeclaredMethod("getSubBubbleId", null), new C5909(10));
        } catch (Exception unused2) {
        }
        try {
