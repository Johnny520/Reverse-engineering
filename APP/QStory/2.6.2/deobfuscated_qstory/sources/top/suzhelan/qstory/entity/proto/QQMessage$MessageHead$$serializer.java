...
public final /* synthetic */ class QQMessage$MessageHead$$serializer implements InterfaceC7078 {
    ...
    static {
        ...
        C7128 c7128 = new C7128("top.suzhelan.qstory.entity.proto.QQMessage.MessageHead", qQMessage$MessageHead$$serializer, 5);
        AbstractC6136.m11545(-3937700191143200167L, c7128, true, 1);
        AbstractC6136.m11545(-3937694487426631079L, c7128, true, 2);
        AbstractC6136.m11545(-3937708802552628647L, c7128, true, 5);
        AbstractC6136.m11545(-3937696033614857639L, c7128, true, 6);
        AbstractC6136.m11545(-3937708729538184615L, c7128, true, 8);
        descriptor = c7128;
        $stable = 8;
    }
    ...
    public final InterfaceC7183[] childSerializers() {
        ...
        InterfaceC7183 interfaceC7183M14355 = C8675.m14355(c7134);
        InterfaceC7183 interfaceC7183M143552 = C8675.m14355(QQMessage$MessageHead$SenderInfo$$serializer.INSTANCE);
        C7071 c7071 = C7071.f18981;
        return new InterfaceC7183[]{c7071, c7134, c7071, interfaceC7183M14355, interfaceC7183M143552};
    }

    @Override // p089.InterfaceC7183
    public final QQMessage.MessageHead deserialize(InterfaceC7186 decoder) {
        "decoder";
        decoder.getClass();
        ...
        while (z) {
            ...
            if (iMo10672 == -1) {
                ...
                str = (String) interfaceC7188Mo6876.mo6875(interfaceC7190, 3, C7134.f19094, str);
                i |= 8;
            } else {
                if (iMo10672 != 4) {
                ...
                senderInfo = (QQMessage.MessageHead.SenderInfo) interfaceC7188Mo6876.mo6875(interfaceC7190, 4, QQMessage$MessageHead$SenderInfo$$serializer.INSTANCE, senderInfo);
                i |= 16;
            }
        }
        interfaceC7188Mo6876.mo6877(interfaceC7190);
        return new QQMessage.MessageHead(i, jMo6886, strMo6878, jMo68862, str, senderInfo, (AbstractC7136) null);
    }
    ...
    @Override // p089.InterfaceC7183
    public final void serialize(InterfaceC7185 encoder, QQMessage.MessageHead value) {
        ...
        QQMessage.MessageHead.write$Self$app_publishRelease(value, interfaceC7187Mo6800, interfaceC7190);
