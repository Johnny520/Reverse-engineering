...
public final class StickerDirAdapter$SpecialAction {
    ...
    public static final StickerDirAdapter$SpecialAction SORT_CONFIG = new StickerDirAdapter$SpecialAction("SORT_CONFIG", 0);
    public static final StickerDirAdapter$SpecialAction ONLINE_STICKER = new StickerDirAdapter$SpecialAction("ONLINE_STICKER", 1);
