...
public final class C9605 implements InterfaceC9598 {
    ...
    public static final String f25072 = "get_group_list";

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public static final String f25071 = "获取群聊列表";

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public static final String f25070 = "读取当前账号的群聊列表并返回群号、群名、群主与管理员信息";
