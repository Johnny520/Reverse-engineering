...
public abstract class MethodAccess {
    ...
    public static MethodAccess get(Class cls) {
        ...
        if (!zIsInterface && cls.getSuperclass() == null && cls != Object.class) {
            C6755.m11869("The type must not be an interface, a primitive type, or void.");
            return null;
        }
        ...
        try {
            ...
            C1123.m1408("Error constructing method access class: ".concat(strConcat), th2);
            return methodAccess;
        }
    }
    ...
    public int getIndex(String str, Class... clsArr) {
        ...
        C5043.m9162(Arrays.toString(clsArr), AbstractC7012.m12144("Unable to find non-private method: ", str, " "));
        return 0;
    }
    ...
    public int getIndex(String str) {
        ...
        C6755.m11869(AbstractC0900.m717("Unable to find non-private method: ", str));
        return 0;
    }
}
