...
public class Kryo {
    ...
    private InterfaceC9939 strategy;
    ...
    public Kryo(ClassResolver classResolver, ReferenceResolver referenceResolver) {
        ...
        if (classResolver == null) {
            C6755.m11869("classResolver cannot be null.");
            throw null;
        }
    ...
    public InterfaceC9939 getInstantiatorStrategy() {
        ...
        if (registration == null) {
            ...
            if (registration == null) {
                if (this.registrationRequired) {
                    C6755.m11869(unregisteredClassMessage(cls));
                    return null;
                }
    ...
    public <T> T newInstance(Class<T> cls) {
        ...
        InterfaceC9940 instantiator = registration.getInstantiator();
    ...
    public InterfaceC9940 newInstantiator(Class cls) {
        return this.strategy.newInstantiatorOf(cls);
    }

    public Registration readClass(Input input) {
        if (input == null) {
            C6755.m11869("input cannot be null.");
            return null;
        }
        try {
    ...
    public int readReferenceOrNull(Input input, Class cls, boolean z) {
        ...
        if (varInt == 1) {
            ...
            if (Log.TRACE) {
                StringBuilder sbM710 = AbstractC0900.m710(iNextReadId, "Read initial reference ", ": ");
        ...
        try {
            ...
            if (Log.DEBUG) {
                StringBuilder sbM7102 = AbstractC0900.m710(i, "Read reference ", ": ");
                sbM7102.append(Util.string(this.readObject));
                sbM7102.append(Util.pos(input.position()));
                Log.debug("kryo", sbM7102.toString());
            }
            return -1;
        } catch (Exception e) {
    ...
    public void reference(Object obj) {
        ...
        if (obj2 != null) {
            if (obj == null) {
                C6755.m11869("object cannot be null.");
            } else {
    ...
    public Registration register(Registration registration) {
        ...
        if (id < 0) {
            C6755.m11869(AbstractC7012.m12147(id, "id must be > 0: "));
            return null;
        }
    ...
    public void setClassLoader(ClassLoader classLoader) {
        if (classLoader != null) {
            ...
            C6755.m11869("classLoader cannot be null.");
        }
    }
    ...
    public void setInstantiatorStrategy(InterfaceC9939 interfaceC9939) {
        this.strategy = interfaceC9939;
    }
    ...
    public void setMaxDepth(int i) {
        if (i > 0) {
            ...
            C6755.m11869("maxDepth must be > 0.");
        }
    }
    ...
    public void setReferenceResolver(ReferenceResolver referenceResolver) {
        if (referenceResolver == null) {
            C6755.m11869("referenceResolver cannot be null.");
            return;
        }
        this.references = true;
        this.referenceResolver = referenceResolver;
    ...
    public Registration writeClass(Output output, Class cls) {
        if (output == null) {
            C6755.m11869("output cannot be null.");
            return null;
        }
        try {
    ...
    public boolean writeReferenceOrNull(Output output, Object obj, boolean z) {
        ...
        if (writtenId != -1) {
            if (Log.DEBUG) {
                StringBuilder sbM710 = AbstractC0900.m710(writtenId, "Write reference ", ": ");
                sbM710.append(Util.string(obj));
                sbM710.append(Util.pos(output.position()));
                Log.debug("kryo", sbM710.toString());
            }
        ...
        output.writeByte((byte) 1);
        if (Log.TRACE) {
            StringBuilder sbM7102 = AbstractC0900.m710(iAddWrittenObject, "Write initial reference ", ": ");
            sbM7102.append(Util.string(obj));
            sbM7102.append(Util.pos(output.position()));
            Log.trace("kryo", sbM7102.toString());
        }
        return false;
    }
    ...
    public void addDefaultSerializer(Class cls, SerializerFactory serializerFactory) {
        if (cls == null) {
            ...
            C6755.m11869("serializerFactory cannot be null.");
        }
    }
    ...
    private void addDefaultSerializer(String str, Class<? extends Serializer> cls) {
        try {
            ...
            throw new KryoException(AbstractC0900.m717("default serializer cannot be added: ", str));
        }
    }
    ...
    public void addDefaultSerializer(Class cls, Class<? extends Serializer> cls2) {
        if (cls == null) {
            ...
            C6755.m11869("serializerClass cannot be null.");
        }
    }
    ...
    public Registration register(Class cls, Serializer serializer, int i) {
        ...
        C6755.m11869(AbstractC7012.m12147(i, "id must be >= 0: "));
        return null;
    }
