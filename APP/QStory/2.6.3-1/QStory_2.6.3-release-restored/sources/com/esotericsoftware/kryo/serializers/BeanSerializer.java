    ...
    public T copy(Kryo kryo, T t) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                ...
                C3906.m7454(sb, t2.getClass().getName(), e2);
                return null;
            } catch (Throwable th) {
