...
public abstract class MethodVisitor {
    ...
    protected MethodVisitor f229mv;
    ...
    public MethodVisitor(int i, MethodVisitor methodVisitor) {
        ...
        this.api = i;
        this.f229mv = methodVisitor;
    }

    public AnnotationVisitor visitAnnotation(String str, boolean z) {
        MethodVisitor methodVisitor = this.f229mv;
    ...
    public void visitMethodInsn(int i, String str, String str2, String str3, boolean z) {
        if (this.api < 327680) {
            if (z == (i == 185)) {
                ...
                C6755.m11869("INVOKESPECIAL/STATIC on interfaces require ASM 5");
                return;
            }
        }
        MethodVisitor methodVisitor = this.f229mv;
