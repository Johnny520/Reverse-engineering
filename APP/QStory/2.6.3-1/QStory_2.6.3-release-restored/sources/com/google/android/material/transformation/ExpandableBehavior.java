...
@Deprecated
public abstract class ExpandableBehavior extends AbstractC8705 {
    ...
    public abstract void mo7557(View view);

    @Override // p217.AbstractC8705
    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰 */
    public final boolean mo7552(CoordinatorLayout coordinatorLayout, View view, int i) {
        if (!view.isLaidOut()) {
            ArrayList arrayListM4505 = coordinatorLayout.m4505(view);
            int size = arrayListM4505.size();
