...
public abstract class AbstractC4178 {
    ...
    public static final RuntimeVersion$RuntimeDomain f11326 = RuntimeVersion$RuntimeDomain.PUBLIC;

    static {
        Locale locale = Locale.US;
        Logger.getLogger(AbstractC4178.class.getName());
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static void m7959(RuntimeVersion$RuntimeDomain runtimeVersion$RuntimeDomain, String str) {
        ...
        if ((str2 == null || !str2.equals("true")) && runtimeVersion$RuntimeDomain != (runtimeVersion$RuntimeDomain2 = f11326)) {
