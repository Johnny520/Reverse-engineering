...
public final /* data */ class OcrResult {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC5227.m9466(this.text, ocrResult.text) && this.inferenceTime == ocrResult.inferenceTime && AbstractC5227.m9466(this.textLines, ocrResult.textLines) && AbstractC5227.m9466(this.drawBitmap, ocrResult.drawBitmap);
    }
    ...
    public int hashCode() {
        int iM720 = AbstractC0900.m720(this.textLines, AbstractC0900.m702(this.text.hashCode() * 31, 31, this.inferenceTime), 31);
        Bitmap bitmap = this.drawBitmap;
        return iM720 + (bitmap == null ? 0 : bitmap.hashCode());
    }
    ...
    public /* synthetic */ OcrResult(String str, long j, List list, Bitmap bitmap, int i, AbstractC5217 abstractC5217) {
