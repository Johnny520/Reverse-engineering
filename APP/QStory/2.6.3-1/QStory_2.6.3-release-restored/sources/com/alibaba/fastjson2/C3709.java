...
public final class C3709 extends AbstractC3711 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲兰苏, reason: contains not printable characters */
    public final AbstractC3785 f9440;

    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final JSONPathFilter$Operator f9441;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final AbstractC3785 f9442;

    public C3709(AbstractC3785 abstractC3785, JSONPathFilter$Operator jSONPathFilter$Operator, AbstractC3785 abstractC37852) {
        this.f9442 = abstractC3785;
        this.f9441 = jSONPathFilter$Operator;
        this.f9440 = abstractC37852;
    }
    ...
    */
    public final boolean mo6515(C3759 c3759, Object obj) {
        if (obj != null) {
            AbstractC3785 abstractC3785 = this.f9442;
            C3759 c37592 = new C3759(null, null, abstractC3785, null);
            c37592.f9615 = obj;
            abstractC3785.mo6513(c37592);
            Object obj2 = c37592.f9614;
            AbstractC3785 abstractC37852 = this.f9440;
            C3759 c37593 = new C3759(null, null, abstractC37852, null);
            c37593.f9615 = obj;
            abstractC37852.mo6513(c37593);
            int iM6483 = AbstractC3700.m6483(obj2, c37593.f9614);
            int iOrdinal = this.f9441.ordinal();
            if (iOrdinal != 0) {
                if (iOrdinal != 1) {
                    if (iOrdinal != 2) {
                        if (iOrdinal != 3) {
    ...
    public final void mo6514(AbstractC3732 abstractC3732, C3759 c3759) {
        throw new JSONException(AbstractC0900.m714(C3709.class, "UnsupportedOperation "));
    }
}
