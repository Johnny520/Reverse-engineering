...
public final class C3716 extends AbstractC3713 {

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public final /* synthetic */ int f9460;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲世兰, reason: contains not printable characters */
    public final JSONPathFilter$Operator f9461;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏哲兰世, reason: contains not printable characters */
    public final Serializable f9462;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3716(String str, long j, JSONPathFilter$Operator jSONPathFilter$Operator, BigDecimal bigDecimal) {
        super(str, j);
        this.f9460 = 1;
        this.f9461 = jSONPathFilter$Operator;
        this.f9462 = bigDecimal;
    }
    ...
    public boolean mo6516() {
        int i = this.f9460;
        JSONPathFilter$Operator jSONPathFilter$Operator = this.f9461;
        switch (i) {
            case 1:
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ C3716(String str, long j, String[] strArr, long[] jArr, Function function, JSONPathFilter$Operator jSONPathFilter$Operator, Serializable serializable, int i) {
        super(str, j, strArr, jArr, function);
        this.f9460 = i;
        this.f9461 = jSONPathFilter$Operator;
        this.f9462 = serializable;
    }
}
