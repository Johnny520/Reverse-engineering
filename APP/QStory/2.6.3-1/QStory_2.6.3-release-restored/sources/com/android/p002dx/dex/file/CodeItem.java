...
public final class CodeItem extends OffsettedItem {
    ...
    public void debugPrint(PrintWriter printWriter, String str, boolean z) {
        ...
        printWriter.println("regs: " + Hex.m28u2(getRegistersSize()) + "; ins: " + Hex.m28u2(getInsSize()) + "; outs: " + Hex.m28u2(getOutsSize()));
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            sb.append(Hex.m28u2(registersSize));
            annotatedOutput.annotate(2, sb.toString());
            annotatedOutput.annotate(2, "  ins_size:       " + Hex.m28u2(insSize));
            annotatedOutput.annotate(2, "  outs_size:      " + Hex.m28u2(outsSize));
            annotatedOutput.annotate(2, "  tries_size:     " + Hex.m28u2(iTriesSize));
            annotatedOutput.annotate(4, "  debug_off:      " + Hex.m30u4(absoluteOffset));
            AbstractC3275.m5123(iCodeSize, new StringBuilder("  insns_size:     "), annotatedOutput, 4);
