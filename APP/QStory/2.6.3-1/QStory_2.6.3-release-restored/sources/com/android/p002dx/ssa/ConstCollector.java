            ...
            if (definitionForRegister != null && definitionForRegister.getOpcode() != null) {
                ...
                if (typeBearer.isConstant()) {
                    ...
                    if (definitionForRegister.getOpcode().getOpcode() == 56) {
                        definitionForRegister = (SsaInsn) AbstractC7012.m12145(1, this.ssaMeth.getBlocks().get(definitionForRegister.getBlock().getPredecessors().nextSetBit(0)).getInsns());
                    }
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (definitionForRegister != null) {
                ...
                if (typeBearer.isConstant() && (registerSpec = map.get((TypedConstant) typeBearer)) != null && !this.ssaMeth.isRegALocal(result)) {
                    RegisterMapper registerMapper = new RegisterMapper(this) { // from class: com.android.dx.ssa.ConstCollector.2
                        final /* synthetic */ ConstCollector this$0;
