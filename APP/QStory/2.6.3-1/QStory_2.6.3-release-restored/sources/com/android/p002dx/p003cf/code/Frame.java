...
public final class Frame {
    ...
    private Frame(LocalsArray localsArray, ExecutionStack executionStack, IntList intList) {
        if (localsArray == null) {
            C3466.m5903("locals == null");
            throw null;
        }
        if (executionStack == null) {
            C3466.m5903("stack == null");
            throw null;
        }
        ...
        if (!zEquals) {
            ...
            for (int i3 = size4 - 1; i3 >= 0; i3--) {
                if (intList2.get(i3) != intListMutableCopy.get((size3 - size4) + i3)) {
                    C3466.m5899("Incompatible merged subroutines");
                    return null;
                }
            }
    ...
    public Frame subFrameForLabel(int i, int i2) {
        ...
        try {
            ...
            C3466.m5899("returning from invalid subroutine");
            return null;
        } catch (NullPointerException unused2) {
            C3466.m5903("can't return from non-subroutine");
            return null;
        }
    }
