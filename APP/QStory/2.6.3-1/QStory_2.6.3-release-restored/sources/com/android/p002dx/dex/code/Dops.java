...
import com.android.p002dx.dex.code.form.Form10t;
import com.android.p002dx.dex.code.form.Form10x;
import com.android.p002dx.dex.code.form.Form11n;
import com.android.p002dx.dex.code.form.Form11x;
import com.android.p002dx.dex.code.form.Form12x;
import com.android.p002dx.dex.code.form.Form20t;
import com.android.p002dx.dex.code.form.Form21c;
import com.android.p002dx.dex.code.form.Form21h;
import com.android.p002dx.dex.code.form.Form21s;
import com.android.p002dx.dex.code.form.Form21t;
import com.android.p002dx.dex.code.form.Form22b;
import com.android.p002dx.dex.code.form.Form22c;
import com.android.p002dx.dex.code.form.Form22s;
import com.android.p002dx.dex.code.form.Form22t;
import com.android.p002dx.dex.code.form.Form22x;
import com.android.p002dx.dex.code.form.Form23x;
import com.android.p002dx.dex.code.form.Form30t;
import com.android.p002dx.dex.code.form.Form31c;
import com.android.p002dx.dex.code.form.Form31i;
import com.android.p002dx.dex.code.form.Form31t;
import com.android.p002dx.dex.code.form.Form32x;
import com.android.p002dx.dex.code.form.Form35c;
import com.android.p002dx.dex.code.form.Form3rc;
import com.android.p002dx.dex.code.form.Form45cc;
import com.android.p002dx.dex.code.form.Form4rcc;
import com.android.p002dx.dex.code.form.Form51l;
import com.android.p002dx.dex.code.form.SpecialFormat;
...
public final class Dops {
    ...
    static {
        ...
        Dop dop195 = new Dop(Opcodes.REM_FLOAT_2ADDR, 170, 170, insnFormat2, true);
        REM_FLOAT_2ADDR = dop195;
        Dop dop196 = new Dop(Opcodes.ADD_DOUBLE_2ADDR, 171, 171, insnFormat2, true);
        ADD_DOUBLE_2ADDR = dop196;
        Dop dop197 = new Dop(Opcodes.SUB_DOUBLE_2ADDR, 172, 172, insnFormat2, true);
        SUB_DOUBLE_2ADDR = dop197;
        Dop dop198 = new Dop(Opcodes.MUL_DOUBLE_2ADDR, 173, 173, insnFormat2, true);
        MUL_DOUBLE_2ADDR = dop198;
        Dop dop199 = new Dop(Opcodes.DIV_DOUBLE_2ADDR, 174, 174, insnFormat2, true);
        DIV_DOUBLE_2ADDR = dop199;
        Dop dop200 = new Dop(Opcodes.REM_DOUBLE_2ADDR, 175, 175, insnFormat2, true);
        ...
        Dop dop206 = new Dop(Opcodes.AND_INT_LIT16, 149, -1, insnFormat17, true);
        ...
        REM_INT_LIT8 = dop213;
        Dop dop214 = new Dop(Opcodes.AND_INT_LIT8, 149, Opcodes.AND_INT_LIT16, insnFormat18, true);
        AND_INT_LIT8 = dop214;
        Dop dop215 = new Dop(Opcodes.OR_INT_LIT8, 150, Opcodes.OR_INT_LIT16, insnFormat18, true);
        OR_INT_LIT8 = dop215;
        ...
        Dop dop220 = new Dop(Opcodes.INVOKE_POLYMORPHIC, Opcodes.INVOKE_POLYMORPHIC, Opcodes.INVOKE_POLYMORPHIC_RANGE, Form45cc.THE_ONE, false);
        INVOKE_POLYMORPHIC = dop220;
        Dop dop221 = new Dop(Opcodes.INVOKE_POLYMORPHIC_RANGE, Opcodes.INVOKE_POLYMORPHIC, -1, Form4rcc.THE_ONE, false);
        INVOKE_POLYMORPHIC_RANGE = dop221;
        Dop dop222 = new Dop(Opcodes.INVOKE_CUSTOM, Opcodes.INVOKE_CUSTOM, Opcodes.INVOKE_CUSTOM_RANGE, insnFormat11, false);
        INVOKE_CUSTOM = dop222;
        Dop dop223 = new Dop(Opcodes.INVOKE_CUSTOM_RANGE, Opcodes.INVOKE_CUSTOM, -1, insnFormat12, false);
        INVOKE_CUSTOM_RANGE = dop223;
        Dop dop224 = new Dop(Opcodes.CONST_METHOD_HANDLE, Opcodes.CONST_METHOD_HANDLE, -1, insnFormat9, true);
        CONST_METHOD_HANDLE = dop224;
        Dop dop225 = new Dop(Opcodes.CONST_METHOD_TYPE, Opcodes.CONST_METHOD_TYPE, -1, insnFormat9, true);
