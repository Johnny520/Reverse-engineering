...
public final class Type implements TypeBearer, Comparable<Type> {
    ...
    private Type(String str, int i, int i2) {
        ...
        if (i < 0 || i >= 11) {
            C6755.m11869("bad basicType");
            throw null;
        }
        if (i2 < -1) {
            C6755.m11869("newAt < -1");
            throw null;
        }
        this.descriptor = str;
        this.basicType = i;
    ...
    public static Type intern(String str) {
        ...
        try {
                        ...
                        if (cCharAt2 != '(' && cCharAt2 != ')' && cCharAt2 != '.') {
                            if (cCharAt2 == '/') {
                                if (i2 == 1 || i2 == i || str.charAt(i2 - 1) == '/') {
                                    C6755.m11869("bad descriptor: ".concat(str));
                                    return null;
                                }
            ...
            C6755.m11869("descriptor is empty");
            return null;
    ...
    public Type asUninitialized(int i) {
        if (i < 0) {
            C6755.m11869("newAt < 0");
            return null;
        }
        if (!isReference()) {
            C8376.m13323(this.descriptor, "not a reference type: ");
            return null;
        }
        if (isUninitialized()) {
            C8376.m13323(this.descriptor, "already uninitialized: ");
            return null;
        }
        Type type = new Type("N" + Hex.m28u2(i) + this.descriptor, 9, i);
    ...
    public String getClassName() {
        if (this.className == null) {
            ...
            if (!zIsReference) {
                C6755.m11869(AbstractC0900.m717("not an object type: ", str));
                return null;
            }
            char cCharAt = str.charAt(0);
            ...
            if (cCharAt == '[') {
                ...
                this.className = AbstractC0900.m721(1, 1, str2);
            }
        }
    ...
    public Type getComponentType() {
        if (this.componentType == null) {
            ...
            String str = this.descriptor;
            if (cCharAt != '[') {
                C6755.m11869(AbstractC0900.m717("not an array type: ", str));
                return null;
            }
    ...
    public Type getInitializedType() {
        ...
        C8376.m13323(this.descriptor, "initialized type: ");
        return null;
    }
