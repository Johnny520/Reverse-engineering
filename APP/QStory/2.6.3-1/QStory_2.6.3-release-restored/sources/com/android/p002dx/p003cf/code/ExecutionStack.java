...
public final class ExecutionStack extends MutabilityControl {
    ...
    private static TypeBearer throwSimException(String str) {
        throw new SimException(AbstractC0900.m717("stack: ", str));
    }
    ...
    public void annotate(ExceptionWithContext exceptionWithContext) {
        ...
        int i2 = 0;
        while (i2 <= i) {
            StringBuilder sbM12144 = AbstractC7012.m12144("stack[", i2 == i ? "top0" : Hex.m28u2(i - i2), "]: ");
            sbM12144.append(stackElementString(this.stack[i2]));
            exceptionWithContext.addContext(sbM12144.toString());
            i2++;
        }
    }
