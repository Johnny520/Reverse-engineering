...
import com.android.p002dx.p005io.instructions.InstructionCodec;
...
public final class OpcodeInfo {
    ...
    static {
        ...
        Info info198 = new Info(Opcodes.REM_FLOAT_2ADDR, "rem-float/2addr", instructionCodec3, indexType);
        REM_FLOAT_2ADDR = info198;
        Info info199 = new Info(Opcodes.ADD_DOUBLE_2ADDR, "add-double/2addr", instructionCodec3, indexType);
        ADD_DOUBLE_2ADDR = info199;
        Info info200 = new Info(Opcodes.SUB_DOUBLE_2ADDR, "sub-double/2addr", instructionCodec3, indexType);
        SUB_DOUBLE_2ADDR = info200;
        Info info201 = new Info(Opcodes.MUL_DOUBLE_2ADDR, "mul-double/2addr", instructionCodec3, indexType);
        MUL_DOUBLE_2ADDR = info201;
        Info info202 = new Info(Opcodes.DIV_DOUBLE_2ADDR, "div-double/2addr", instructionCodec3, indexType);
        DIV_DOUBLE_2ADDR = info202;
        Info info203 = new Info(Opcodes.REM_DOUBLE_2ADDR, "rem-double/2addr", instructionCodec3, indexType);
        ...
        Info info217 = new Info(Opcodes.AND_INT_LIT8, "and-int/lit8", instructionCodec19, indexType);
        AND_INT_LIT8 = info217;
        Info info218 = new Info(Opcodes.OR_INT_LIT8, "or-int/lit8", instructionCodec19, indexType);
        OR_INT_LIT8 = info218;
        ...
        Info info223 = new Info(Opcodes.INVOKE_POLYMORPHIC, "invoke-polymorphic", instructionCodec20, indexType6);
        ...
        Info info227 = new Info(Opcodes.CONST_METHOD_HANDLE, "const-method-handle", instructionCodec10, IndexType.METHOD_HANDLE_REF);
        CONST_METHOD_HANDLE = info227;
        Info info228 = new Info(Opcodes.CONST_METHOD_TYPE, "const-method-type", instructionCodec10, IndexType.PROTO_REF);
    ...
    public static Info get(int i) {
        ...
        C8376.m13323(Hex.u2or4(i), "bogus opcode: ");
        return null;
    }
