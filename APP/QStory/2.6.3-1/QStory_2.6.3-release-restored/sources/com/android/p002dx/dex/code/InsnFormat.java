...
import com.android.p002dx.rop.cst.CstLiteral64;
...
public abstract class InsnFormat {
    ...
    public static int argIndex(DalvInsn dalvInsn) {
        ...
        C6755.m11869("bogus insn");
        return 0;
    }

    public static String branchComment(DalvInsn dalvInsn) {
        int targetOffset = ((TargetInsn) dalvInsn).getTargetOffset();
        return targetOffset == ((short) targetOffset) ? Hex.m24s2(targetOffset) : Hex.m25s4(targetOffset);
    }

    public static String branchString(DalvInsn dalvInsn) {
        int targetAddress = ((TargetInsn) dalvInsn).getTargetAddress();
        return targetAddress == ((char) targetAddress) ? Hex.m28u2(targetAddress) : Hex.m30u4(targetAddress);
    }

    public static short codeUnit(int i, int i2, int i3, int i4) {
        if ((i & 15) != i) {
            C6755.m11869("n0 out of range 0..15");
            return (short) 0;
        }
        if ((i2 & 15) != i2) {
            C6755.m11869("n1 out of range 0..15");
            return (short) 0;
        }
        if ((i3 & 15) != i3) {
            C6755.m11869("n2 out of range 0..15");
            return (short) 0;
        }
        if ((i4 & 15) == i4) {
            return (short) (i | (i2 << 4) | (i3 << 8) | (i4 << 12));
        }
        C6755.m11869("n3 out of range 0..15");
        return (short) 0;
    }
    ...
    public static String literalBitsComment(CstLiteralBits cstLiteralBits, int i) {
        ...
        if (i == 4) {
            ...
            sb.append(Hex.m27u1((int) longBits));
        } else if (i == 16) {
            sb.append(Hex.m28u2((int) longBits));
        } else if (i == 32) {
            sb.append(Hex.m30u4((int) longBits));
        } else {
            if (i != 64) {
                C3466.m5899("shouldn't happen");
                return null;
            }
            sb.append(Hex.m31u8(longBits));
        }
        return sb.toString();
    }
    ...
    public static int makeByte(int i, int i2) {
        if ((i & 15) != i) {
            C6755.m11869("low out of range 0..15");
            return 0;
        }
        if ((i2 & 15) == i2) {
            return i | (i2 << 4);
        }
        C6755.m11869("high out of range 0..15");
        return 0;
    }

    public static short opcodeUnit(DalvInsn dalvInsn, int i) {
        if ((i & Opcodes.CONST_METHOD_TYPE) != i) {
            C6755.m11869("arg out of range 0..255");
            return (short) 0;
        }
        ...
        C6755.m11869("opcode out of range 0..255");
        return (short) 0;
    }
    ...
    public static short opcodeUnit(DalvInsn dalvInsn) {
        ...
        C6755.m11869("opcode out of range 0..65535");
        return (short) 0;
    }
    ...
    public static short codeUnit(int i, int i2) {
        if ((i & Opcodes.CONST_METHOD_TYPE) != i) {
            C6755.m11869("low out of range 0..255");
            return (short) 0;
        }
        if ((i2 & Opcodes.CONST_METHOD_TYPE) == i2) {
            return (short) (i | (i2 << 8));
        }
        C6755.m11869("high out of range 0..255");
        return (short) 0;
    }
}
