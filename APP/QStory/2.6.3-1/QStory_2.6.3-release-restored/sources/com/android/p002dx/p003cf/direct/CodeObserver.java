...
import bsh.C3466;
import com.android.p002dx.p003cf.code.ByteOps;
import com.android.p002dx.p003cf.code.BytecodeArray;
import com.android.p002dx.p003cf.code.SwitchList;
...
public class CodeObserver implements BytecodeArray.Visitor {
    ...
    private String header(int i) {
        ...
        if (unsignedByte == 196) {
            ...
            StringBuilder sbM12143 = AbstractC7012.m12143(strOpName, " ");
            sbM12143.append(ByteOps.opName(unsignedByte2));
            strOpName = sbM12143.toString();
        }
        return Hex.m28u2(i) + ": " + strOpName;
    }
    ...
    private void visitLiteralLong(int i, int i2, int i3, long j) {
        String str = i3 == 1 ? " // " : " #";
        String strM23s1 = i3 == 1 ? Hex.m23s1((int) j) : Hex.m26s8(j);
        this.observer.parsed(this.bytes, i2, i3, header(i2) + str + strM23s1);
    }
    ...
    public void visitBranch(int i, int i2, int i3, int i4) {
        String strM28u2 = i3 <= 3 ? Hex.m28u2(i4) : Hex.m30u4(i4);
        this.observer.parsed(this.bytes, i2, i3, header(i2) + " " + strM28u2);
    }
    ...
    public void visitConstant(int i, int i2, int i3, Constant constant, int i4) {
        ...
        if (i4 == 0) {
            ...
            strM5120 = ", " + Hex.m27u1(i4);
        } else {
            strM5120 = AbstractC3275.m5120(new StringBuilder(", "), i4);
        }
        this.observer.parsed(this.bytes, i2, i3, header(i2) + " " + constant + strM5120);
    }
    ...
    public void visitLocal(int i, int i2, int i3, int i4, Type type, int i5) {
        String string;
        String strM27u1 = i3 <= 3 ? Hex.m27u1(i4) : Hex.m28u2(i4);
        boolean z = i3 == 1;
        String strConcat = "";
        if (i == 132) {
            StringBuilder sb = new StringBuilder(", #");
            sb.append(i3 <= 3 ? Hex.m23s1(i5) : Hex.m24s2(i5));
            string = sb.toString();
        } else {
            string = "";
        }
    ...
    public void visitSwitch(int i, int i2, int i3, SwitchList switchList, int i4) {
        ...
        sb.append(header(i2));
        if (i4 != 0) {
            sb.append(" // padding: " + Hex.m30u4(i4));
        }
        sb.append('\n');
        for (int i5 = 0; i5 < size; i5++) {
            sb.append("  ");
            sb.append(Hex.m25s4(switchList.getValue(i5)));
            sb.append(": ");
            sb.append(Hex.m28u2(switchList.getTarget(i5)));
            sb.append('\n');
        }
        sb.append("  default: ");
        sb.append(Hex.m28u2(switchList.getDefaultTarget()));
