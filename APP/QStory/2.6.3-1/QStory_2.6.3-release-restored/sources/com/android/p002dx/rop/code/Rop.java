...
public final class Rop {
    ...
    public Rop(int i, Type type, TypeList typeList, TypeList typeList2, int i2, boolean z, String str) {
        ...
        if (i2 < 1 || i2 > 6) {
            C6755.m11869(AbstractC7012.m12147(i2, "invalid branchingness: "));
            throw null;
        }
        if (typeList2.size() != 0 && i2 != 6) {
            C6755.m11869("exceptions / branchingness mismatch");
            throw null;
        }
        this.opcode = i;
        this.result = type;
    ...
    public String toString() {
        ...
        if (size2 != 0) {
            ...
            if (i3 == 1) {
                ...
                sb.append(" " + Hex.m27u1(this.branchingness));
            } else {
                sb.append(" switches");
            }
        }
