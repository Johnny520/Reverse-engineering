...
public final class StringIdsSection extends UniformItemSection {
    ...
    public void writeHeaderPart(AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(4, "string_ids_size: " + Hex.m30u4(size));
            AbstractC3275.m5123(fileOffset, new StringBuilder("string_ids_off:  "), annotatedOutput, 4);
        }
