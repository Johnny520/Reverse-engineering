...
import com.android.p002dx.p003cf.attrib.InnerClassList;
import com.android.p002dx.p003cf.code.BootstrapMethodArgumentsList;
...
public class StdAttributeFactory extends AttributeFactory {
    ...
    private Attribute bootstrapMethods(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("num_boostrap_methods: "), unsignedShort));
        }
    ...
    private Attribute code(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("max_stack: "), unsignedShort));
            parseObserver.parsed(bytes, i3, 2, AbstractC3275.m5120(new StringBuilder("max_locals: "), unsignedShort2));
            parseObserver.parsed(bytes, i4, 4, "code_length: " + Hex.m30u4(i5));
        }
        int i6 = i + 8;
        int i7 = i2 - 8;
        if (i7 < i5 + 4) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i8, 2, AbstractC3275.m5120(new StringBuilder("exception_table_length: "), unsignedShort3));
        }
        int i10 = i8 + 2;
        int i11 = i9 - 2;
        ...
        for (int i12 = 0; i12 < unsignedShort3; i12++) {
            ...
            if (parseObserver != null) {
                ...
                sb.append(Hex.m28u2(unsignedShort4));
                sb.append("..");
                sb.append(Hex.m28u2(unsignedShort5));
                sb.append(" -> ");
                sb.append(Hex.m28u2(unsignedShort6));
                sb.append(" ");
    ...
    private Attribute exceptions(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("number_of_exceptions: "), unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute innerClasses(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("number_of_classes: "), unsignedShort));
        }
        int i3 = i + 2;
    ...
    private Attribute lineNumberTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("line_number_table_length: "), unsignedShort));
        }
        int i3 = i + 2;
        ...
        for (int i5 = 0; i5 < unsignedShort; i5++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(bytes, i3, 4, Hex.m28u2(unsignedShort2) + " " + unsignedShort3);
            }
            i3 += 4;
        }
    ...
    private Attribute localVariableTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("local_variable_table_length: "), unsignedShort));
        }
    ...
    private Attribute localVariableTypeTable(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        int unsignedShort = bytes.getUnsignedShort(i);
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i, 2, AbstractC3275.m5120(new StringBuilder("local_variable_type_table_length: "), unsignedShort));
        }
    ...
    private BootstrapMethodsList parseBootstrapMethods(ByteArray byteArray, ConstantPool constantPool, CstType cstType, int i, int i2, int i3, ParseObserver parseObserver) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(byteArray, i4, 2, AbstractC3275.m5120(new StringBuilder("bootstrap_method_ref: "), unsignedShort));
                parseObserver.parsed(byteArray, i7, 2, AbstractC3275.m5120(new StringBuilder("num_bootstrap_arguments: "), unsignedShort2));
            }
            i4 += 4;
            i5 -= 4;
            ...
            while (i8 < unsignedShort2) {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i4, 2, AbstractC3275.m5120(AbstractC0900.m710(i8, "bootstrap_arguments[", "]"), unsignedShort3));
                }
    ...
    private LocalVariableList parseLocalVariables(ByteArray byteArray, ConstantPool constantPool, ParseObserver parseObserver, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            try {
                ...
                CstString cstString3 = (CstString) constantPool.get(unsignedShort3);
                CstString cstString4 = (CstString) constantPool.get(unsignedShort4);
                if (z) {
                    cstString2 = null;
                ...
                localVariableList.set(i3, unsignedShort, unsignedShort2, cstString3, cstString2, cstString, unsignedShort5);
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i3 * 10, 10, Hex.m28u2(unsignedShort) + ".." + Hex.m28u2(unsignedShort + unsignedShort2) + " " + Hex.m28u2(unsignedShort5) + " " + cstString3.toHuman() + " " + cstString4.toHuman());
                }
            } catch (IOException e) {
    ...
    private Attribute sourceDebugExtension(DirectClassFile directClassFile, int i, int i2, ParseObserver parseObserver) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(byteArraySlice, i, i2, AbstractC0900.m717("sourceDebugExtension: ", cstString.getString()));
        }
    ...
    private static Attribute throwBadLength(int i) {
        throw new ParseException("bad attribute length; expected length " + Hex.m30u4(i));
    }
    ...
    @Override // com.android.p002dx.p003cf.direct.AttributeFactory
