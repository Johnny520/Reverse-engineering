...
import com.android.p002dx.ssa.PhiInsn;
...
public final class SsaBasicBlock {
    ...
    public void addMoveToEnd(RegisterSpec registerSpec, RegisterSpec registerSpec2) {
        if (this.successors.cardinality() > 1) {
            C6755.m11870("Inserting a move to a block with multiple successors");
            return;
        }
        if (registerSpec.getReg() == registerSpec2.getReg()) {
            return;
        }
        NormalSsaInsn normalSsaInsn = (NormalSsaInsn) AbstractC7012.m12145(1, this.insns);
    ...
    public String getRopLabelString() {
        return Hex.m28u2(this.ropLabel);
    }
    ...
    public SsaBasicBlock insertNewSuccessor(SsaBasicBlock ssaBasicBlock) {
        ...
        if (!this.successors.get(ssaBasicBlock.index)) {
            C4515.m8483("Block ", ssaBasicBlock.getRopLabelString(), " not successor of ", getRopLabelString());
            return null;
        }
    ...
    public void replaceLastInsn(Insn insn) {
        if (insn.getOpcode().getBranchingness() == 1) {
            C6755.m11869("last insn must branch");
            return;
        }
        SsaInsn ssaInsn = (SsaInsn) AbstractC7012.m12145(1, this.insns);
        SsaInsn ssaInsnMakeFromRop = SsaInsn.makeFromRop(insn, this);
        ArrayList<SsaInsn> arrayList = this.insns;
    ...
    public void scheduleMovesFromPhis() {
        ...
        if (i > 1) {
            ...
            if (this.insns.get(this.movesFromPhisAtBeginning).isMoveException()) {
                C3466.m5899("Unexpected: moves from phis before move-exception");
                return;
            }
        }
    ...
    public String toString() {
        return "{" + this.index + ":" + Hex.m28u2(this.ropLabel) + '}';
    }
