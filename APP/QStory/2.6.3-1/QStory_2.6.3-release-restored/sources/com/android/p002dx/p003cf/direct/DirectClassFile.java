...
import com.android.p002dx.p003cf.cst.ConstantPoolParser;
import com.android.p002dx.p003cf.iface.Attribute;
import com.android.p002dx.p003cf.iface.AttributeList;
import com.android.p002dx.p003cf.iface.ClassFile;
import com.android.p002dx.p003cf.iface.FieldList;
...
import com.android.p002dx.rop.cst.StdConstantPool;
...
public class DirectClassFile implements ClassFile {
        ...
        public DcfTypeList(ByteArray byteArray, int i, int i2, StdConstantPool stdConstantPool, ParseObserver parseObserver) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                try {
                    ...
                    C1123.m1408("bogus class cpi", e);
                    throw null;
                }
            }
        }

        @Override // com.android.p002dx.rop.type.TypeList
    ...
    public DirectClassFile(ByteArray byteArray, String str, boolean z) {
        if (byteArray == null) {
            C3466.m5903("bytes == null");
            throw null;
        }
        if (str == null) {
            C3466.m5903("filePath == null");
            throw null;
        }
        this.filePath = str;
    ...
    private void parse0() {
        ...
        if (parseObserver != null) {
            ...
            this.observer.parsed(this.bytes, 0, 4, "magic: " + Hex.m30u4(getMagic0()));
            this.observer.parsed(this.bytes, 4, 2, "minor_version: " + Hex.m28u2(getMinorVersion0()));
            this.observer.parsed(this.bytes, 6, 2, "major_version: " + Hex.m28u2(getMajorVersion0()));
        }
        if (this.strictParse) {
            if (!isGoodMagic(getMagic0())) {
                throw new ParseException("bad class file magic (" + Hex.m30u4(getMagic0()) + ")");
            }
        ...
        if (parseObserver2 != null) {
            ...
            this.observer.parsed(this.bytes, i3, 2, AbstractC3275.m5120(new StringBuilder("interfaces_count: "), unsignedShort2));
            if (unsignedShort2 != 0) {
        ...
        if (this.strictParse) {
            ...
            if (!this.filePath.endsWith(ClassFileLocator.CLASS_FILE_EXTENSION) || !this.filePath.startsWith(className) || this.filePath.length() != className.length() + 6) {
                throw new ParseException(AbstractC0900.m711(AbstractC7012.m12144("class name (", className, ") does not match path ("), this.filePath, ")"));
            }
        }
        ...
        if (endOffset2 != this.bytes.size()) {
            throw new ParseException("extra bytes at end of class file, at offset " + Hex.m30u4(endOffset2));
        }
    ...
    @Override // com.android.p002dx.p003cf.iface.ClassFile
    public int getAccessFlags() {
        parseToInterfacesIfNecessary();
        return this.accessFlags;
    }

    @Override // com.android.p002dx.p003cf.iface.ClassFile, com.android.p002dx.p003cf.iface.HasAttribute
    ...
    public TypeList makeTypeList(int i, int i2) {
        ...
        C6755.m11870("pool not yet initialized");
        return null;
    }
