package com.android.p002dx.command.dexer;

import androidx.activity.AbstractC0900;
import androidx.collection.C1123;
import bsh.C3466;
import com.android.dex.DexException;
import com.android.p002dx.command.UsageException;
import com.android.p002dx.dex.DexOptions;
import com.android.p002dx.dex.file.ClassDefItem;
import com.android.p002dx.dex.file.DexFile;
import com.android.p002dx.dex.file.EncodedMethod;
import com.android.p002dx.dex.p004cf.CfOptions;
import com.android.p002dx.dex.p004cf.CfTranslator;
import com.android.p002dx.merge.CollisionPolicy;
import com.android.p002dx.merge.DexMerger;
import com.android.p002dx.p003cf.code.SimException;
import com.android.p002dx.p003cf.direct.ClassPathOpener;
...
public class Main {
    ...
    public class FileBytesConsumer implements ClassPathOpener.Consumer {
        ...
        public void onException(Exception exc) {
            ...
            if (exc instanceof SimException) {
                ...
                Main main = Main.this;
                if (z) {
                    main.context.err.println("\nPARSE ERROR:");
                    ParseException parseException = (ParseException) exc;
                    boolean z2 = Main.this.args.debug;
                    Main main2 = Main.this;
                    if (z2) {
                        parseException.printStackTrace(main2.context.err);
                    } else {
                        parseException.printContext(main2.context.err);
                    }
                } else {
    ...
    public static /* synthetic */ int access$1912(Main main, int i) {
        int i2 = main.maxMethodIdsInProcess + i;
        main.maxMethodIdsInProcess = i2;
        return i2;
    }

    public static /* synthetic */ int access$1920(Main main, int i) {
        int i2 = main.maxMethodIdsInProcess - i;
        main.maxMethodIdsInProcess = i2;
        return i2;
    }

    public static /* synthetic */ int access$2012(Main main, int i) {
        int i2 = main.maxFieldIdsInProcess + i;
        main.maxFieldIdsInProcess = i2;
        return i2;
    }

    public static /* synthetic */ int access$2020(Main main, int i) {
        int i2 = main.maxFieldIdsInProcess - i;
        main.maxFieldIdsInProcess = i2;
        return i2;
    }
    ...
    private void dumpMethod(DexFile dexFile, String str, OutputStreamWriter outputStreamWriter) {
        ...
        String strReplace = str.substring(0, iLastIndexOf).replace(TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH, '/');
        ...
        if (zEndsWith) {
            strSubstring = AbstractC0900.m721(1, 0, strSubstring);
        }
    ...
    private Manifest makeManifest() {
        ...
        if (bArr == null) {
            ...
            mainAttributes.put(Attributes.Name.MANIFEST_VERSION, BuildConfig.VERSION_NAME);
        } else {
        ...
        mainAttributes.put(name, (value == null ? "" : value.concat(" + ")).concat("dx 1.16"));
        mainAttributes.putValue("Dex-Location", "classes.dex");
        return manifest;
    }

    private byte[] mergeIncremental(byte[] bArr, File file) throws IOException {
        C9387 c9387 = bArr != null ? new C9387(bArr) : null;
        C9387 c93872 = file.exists() ? new C9387(file) : null;
        if (c9387 == null && c93872 == null) {
            return null;
        }
        if (c9387 == null) {
            c9387 = c93872;
        } else if (c93872 != null) {
            c9387 = new DexMerger(new C9387[]{c9387, c93872}, CollisionPolicy.KEEP_FIRST, this.context).merge();
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        c9387.m14695(byteArrayOutputStream);
    ...
    private byte[] mergeLibraryDexBuffers(byte[] bArr) {
        ...
        if (bArr != null) {
            arrayList.add(new C9387(bArr));
        }
        Iterator<byte[]> it = this.libraryDexBuffers.iterator();
        while (it.hasNext()) {
            arrayList.add(new C9387(it.next()));
        }
        if (arrayList.isEmpty()) {
            return null;
        }
        ByteBuffer byteBufferDuplicate = new DexMerger((C9387[]) arrayList.toArray(new C9387[arrayList.size()]), CollisionPolicy.FAIL, this.context).merge().f24235.duplicate();
        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    DxContext dxContext = this.context;
                    if (z) {
                        dxContext.err.println("Uncaught translation error:");
                        e.getCause().printStackTrace(this.context.err);
                    } else {
                        dxContext.err.println("Uncaught translation error: " + e.getCause());
                    }
                }
            }
            ...
            if (arguments2.optimize && arguments2.statistics) {
                DxContext dxContext2 = this.context;
                dxContext2.codeStatistics.dumpStatistics(dxContext2.out);
            }
            return true;
        } catch (InterruptedException e2) {
            this.classTranslatorPool.shutdownNow();
            this.classDefItemConsumer.shutdownNow();
            C1123.m1408("Translation has been interrupted", e2);
            return false;
        } catch (Exception e3) {
            this.classTranslatorPool.shutdownNow();
            this.classDefItemConsumer.shutdownNow();
            e3.printStackTrace(this.context.out);
            C1123.m1408("Unexpected exception in translator thread.", e3);
            return false;
        }
    }
    ...
    private boolean processClass(String str, byte[] bArr) {
        ...
        try {
            ...
            C1123.m1408("Exception parsing classes", e2);
            return false;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean processFileBytes(String str, long j, byte[] bArr) {
        boolean zEndsWith = str.endsWith(ClassFileLocator.CLASS_FILE_EXTENSION);
    ...
    private int runMultiDex() throws Throwable {
        ...
        try {
            ...
            C3466.m5899("A dex writer thread has been interrupted.");
            return 0;
        } catch (Exception unused2) {
            this.dexOutPool.shutdownNow();
            C3466.m5899("Unexpected exception in dex writer thread");
            return 0;
        }
    }
    ...
    public static class Arguments {
            ...
            public boolean isArg(String str) {
                ...
                if (length > 0) {
                    ...
                    if (str.charAt(i) == '=') {
                        ...
                        System.err.println("Missing value after parameter ".concat(strSubstring));
        ...
        public void parse(String[] strArr) throws Throwable {
            ...
            if (!z2 || !this.outputIsDirectDex) {
                if (this.outputIsDirectory && !z2) {
        ...
        public void makeOptionsObjects() {
            ...
            DxContext dxContext = this.context;
            if (z) {
                cfOptions.warn = dxContext.err;
            } else {
                cfOptions.warn = dxContext.noop;
            }
    ...
    public class DirectClassFileConsumer implements Callable<Boolean> {
        ...
        public Boolean call(DirectClassFile directClassFile) {
            ...
            if (Main.this.args.multiDex) {
                ...
                synchronized (Main.this.dexRotationLock) {
                    try {
                        ...
                        Main.access$1912(Main.this, size4);
                        Main.access$2012(Main.this, size5);
                    } catch (Throwable th) {
                        throw th;
                    }
                }
            ...
            Main.this.addToDexFutures.add(Main.this.classDefItemConsumer.submit(new ClassDefItemConsumer(this.name, Main.this.classTranslatorPool.submit(new ClassTranslatorTask(this.name, this.bytes, directClassFile)), i, i2)));
            return Boolean.TRUE;
        }
