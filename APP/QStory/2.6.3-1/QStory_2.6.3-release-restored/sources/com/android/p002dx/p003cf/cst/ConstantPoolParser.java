package com.android.p002dx.p003cf.cst;
...
public final class ConstantPoolParser {
    ...
    private void determineOffsets() {
        ...
        while (true) {
            ...
            switch (unsignedByte) {
                ...
                case 17:
                default:
                    throw new ParseException("unknown tag byte: " + Hex.m27u1(unsignedByte));
                case 3:
                case 4:
                case 9:
                case 10:
                ...
                case 18:
                    try {
                        ...
                        e.addContext("...while preparsing cst " + Hex.m28u2(i2) + " at offset " + Hex.m30u4(unsignedShort));
                        throw e;
                    }
                    break;
                case 5:
    ...
    private static int getMethodHandleTypeForKind(int i) {
        switch (i) {
            ...
            case 9:
                return 8;
            default:
                C6755.m11869(AbstractC7012.m12147(i, "invalid kind: "));
                return 0;
        }
    }
    ...
    private void parse() {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(this.bytes, 8, 2, AbstractC3275.m5120(new StringBuilder("constant_pool_count: "), this.offsets.length));
        ...
        if (this.observer != null) {
            for (int i2 = 1; i2 < this.offsets.length; i2++) {
                ...
                if (orNull != null) {
                    ...
                    this.observer.parsed(this.bytes, i3, i4 - i3, bitSet.get(i2) ? Hex.m28u2(i2) + ": utf8{\"" + orNull.toHuman() + "\"}" : Hex.m28u2(i2) + ": " + orNull.toString());
                }
            }
            this.observer.changeIndent(-1);
    ...
    private Constant parse0(int i, BitSet bitSet) {
        ...
        try {
            ...
            e.addContext("...while parsing cst " + Hex.m28u2(i) + " at offset " + Hex.m30u4(i2));
            throw e;
        } catch (RuntimeException e2) {
            ParseException parseException = new ParseException(e2);
            parseException.addContext("...while parsing cst " + Hex.m28u2(i) + " at offset " + Hex.m30u4(i2));
