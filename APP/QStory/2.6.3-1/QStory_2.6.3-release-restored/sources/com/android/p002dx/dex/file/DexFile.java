...
import com.android.p002dx.dex.file.MixedItemSection;
...
public final class DexFile {
    ...
    /* JADX WARN: Removed duplicated region for block: B:53:0x00f1 A[Catch: RuntimeException -> 0x00e4, TryCatch #0 {RuntimeException -> 0x00e4, blocks: (B:43:0x00d7, B:45:0x00df, B:53:0x00f1, B:55:0x00fc, B:56:0x0102, B:57:0x0105, B:58:0x011c, B:50:0x00e6), top: B:73:0x00d7 }] */
    /*
    ...
    */
    private ByteArrayAnnotatedOutput toDex0(boolean z, boolean z2, Storage storage) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if ((section != this.callSiteIds && section != this.methodHandles) || !section.items().isEmpty()) {
                int fileOffset = section.setFileOffset(iWriteSize);
                if (fileOffset < iWriteSize) {
                    C3466.m5899(AbstractC7012.m12147(i, "bogus placement for section "));
                    return null;
                }
                try {
                    ...
                    iWriteSize = section.writeSize() + fileOffset;
        ...
        if (byteArrayAnnotatedOutput.getCursor() != this.fileSize) {
            C3466.m5899("foreshortened write");
            return null;
        }
    ...
    public int getFileSize() {
        ...
        C3466.m5899("file size not yet known");
        return 0;
    }
