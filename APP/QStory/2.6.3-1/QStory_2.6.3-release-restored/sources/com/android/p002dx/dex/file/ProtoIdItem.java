...
public final class ProtoIdItem extends IndexedItem {
    ...
    public ProtoIdItem(Prototype prototype) {
        ...
        this.parameterTypes = parameterTypes.size() != 0 ? new TypeListItem(parameterTypes) : null;
    }
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            annotatedOutput.annotate(4, "  shorty_idx:      " + Hex.m30u4(iIndexOf) + " // " + this.shortForm.toQuoted());
            annotatedOutput.annotate(4, "  return_type_idx: " + Hex.m30u4(iIndexOf2) + " // " + this.prototype.getReturnType().toHuman());
            AbstractC3275.m5123(absoluteOffsetOr0, new StringBuilder("  parameters_off:  "), annotatedOutput, 4);
        }
