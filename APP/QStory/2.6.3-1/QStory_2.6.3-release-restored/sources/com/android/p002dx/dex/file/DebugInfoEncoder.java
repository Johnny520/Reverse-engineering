...
public final class DebugInfoEncoder {
    ...
    private void annotate(int i, String str) {
        if (this.prefix != null) {
            str = AbstractC0900.m711(new StringBuilder(), this.prefix, str);
        }
    ...
    private static int computeOpcode(int i, int i2) {
        if (i >= -4 && i <= 10) {
            return AbstractC7012.m12133(i2, 15, i - (-4), 10);
        }
        C3466.m5899("Parameter out of range");
        return 0;
    }
    ...
    private void emitPosition(PositionList.Entry entry) {
        ...
        if (i2 < 0) {
            C3466.m5899("Position entries must be in ascending address order");
            return;
        }
        int i3 = 0;
        if (i < -4 || i > 10) {
    ...
    private void emitUnsignedLeb128(int i) {
        if (i >= 0) {
            ...
            C3466.m5899(AbstractC7012.m12147(i, "Signed value where unsigned required: "));
        }
    }
