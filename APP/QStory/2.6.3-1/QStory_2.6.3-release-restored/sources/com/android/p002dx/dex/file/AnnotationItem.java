...
public final class AnnotationItem extends OffsettedItem {
    ...
    public void annotateTo(AnnotatedOutput annotatedOutput, String str) {
        StringBuilder sbM12143 = AbstractC7012.m12143(str, "visibility: ");
        sbM12143.append(this.annotation.getVisibility().toHuman());
        annotatedOutput.annotate(0, sbM12143.toString());
        ...
        for (NameValuePair nameValuePair : this.annotation.getNameValuePairs()) {
            ...
            sbM700.append(name.toHuman());
            sbM700.append(": ");
            sbM700.append(ValueEncoder.constantToHuman(value));
            annotatedOutput.annotate(0, sbM700.toString());
        }
    }
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        int i = C02541.$SwitchMap$com$android$dx$rop$annotation$AnnotationVisibility[visibility.ordinal()];
        if (i == 1) {
    ...
    public static class TypeIdSorter implements Comparator<AnnotationItem> {
        ...
        public /* synthetic */ TypeIdSorter(C02541 c02541) {
            this();
        }
    }
}
