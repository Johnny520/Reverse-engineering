...
import com.android.p002dx.p003cf.code.BasicBlocker;
import com.android.p002dx.p003cf.code.ByteBlock;
import com.android.p002dx.p003cf.code.ByteBlockList;
import com.android.p002dx.p003cf.code.ByteCatchList;
import com.android.p002dx.p003cf.code.BytecodeArray;
import com.android.p002dx.p003cf.code.ConcreteMethod;
import com.android.p002dx.p003cf.code.Ropper;
import com.android.p002dx.p003cf.direct.CodeObserver;
...
import com.android.p002dx.rop.code.BasicBlock;
import com.android.p002dx.rop.code.BasicBlockList;
import com.android.p002dx.rop.code.DexTranslationAdvice;
import com.android.p002dx.rop.code.InsnList;
import com.android.p002dx.rop.code.RopMethod;
import com.android.p002dx.rop.cst.CstType;
import com.android.p002dx.ssa.Optimizer;
...
public class BlockDumper extends BaseDumper {
    ...
    private void regularDump(ConcreteMethod concreteMethod) {
        ...
        while (i < size) {
            ...
            if (i2 < start) {
                parsed(bytes, i2, start - i2, "dead code " + Hex.m28u2(i2) + ".." + Hex.m28u2(start));
            }
            StringBuilder sb = new StringBuilder("block ");
            sb.append(Hex.m28u2(byteBlock.getLabel()));
            sb.append(": ");
            sb.append(Hex.m28u2(start));
            sb.append("..");
            parsed(bytes, start, 0, AbstractC3275.m5120(sb, end));
            changeIndent(1);
            while (start < end) {
            ...
            if (size2 == 0) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    parsed(bytes, end, 0, AbstractC3275.m5120(new StringBuilder("next "), successors.get(i3)));
                }
            }
            ...
            for (int i4 = 0; i4 < size3; i4++) {
                ...
                sb2.append(" -> ");
                sb2.append(Hex.m28u2(item.getHandlerPc()));
        ...
        if (i2 < size4) {
            parsed(bytes, i2, size4 - i2, "dead code " + Hex.m28u2(i2) + ".." + Hex.m28u2(size4));
        }
        this.suppressDump = true;
    }
    ...
    private void ropDump(ConcreteMethod concreteMethod) {
        ...
        sb.append("first " + Hex.m28u2(ropMethodConvert.getFirstLabel()) + "\n");
        for (int i : labelsInOrder) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                sb.append("  pred ");
                sb.append(Hex.m28u2(intListLabelToPredecessors.get(i2)));
                sb.append("\n");
            }
    ...
    @Override // com.android.p002dx.command.dump.BaseDumper, com.android.p002dx.p003cf.iface.ParseObserver
    ...
    public void startParsingMember(ByteArray byteArray, int i, String str, String str2) {
        if (str2.indexOf(40) >= 0 && shouldDumpMethod(str)) {
            ...
            parsed(byteArray, i, 0, AbstractC7012.m12140("method ", str, " ", str2));
            this.suppressDump = true;
        }
    }
