        ...
        while (i3 < length) {
            ...
            if (iIndexOf4 != -1 && ((iIndexOf = strSubstring.indexOf(34)) == -1 || iIndexOf >= iIndexOf4)) {
                ...
                if (Integer.parseInt(strTrim, 16) != i4) {
                    C3466.m5899(AbstractC0900.m717("bogus offset marker: ", strTrim));
                    return null;
                }
            }
            ...
            while (i6 < length2) {
                ...
                if (i7 != 0) {
                    ...
                    if (i8 != -1) {
                        C3775.m6962(Hex.m30u4(i4), "spare digit around offset ");
                        return null;
                    }
                    i7 = 1;
                    c = 16;
            ...
            if (i7 != 0) {
                C3775.m6962(Hex.m30u4(i4), "unterminated quote around offset ");
                return null;
            }
            i3 = i5;
            i2 = 0;
