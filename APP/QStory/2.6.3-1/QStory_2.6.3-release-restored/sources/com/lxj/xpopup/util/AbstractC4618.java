...
public abstract class AbstractC4618 {
    ...
    public static final SparseArray f12167 = new SparseArray();

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static int f12166 = 0;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static void m8659(View view) {
        ...
        keyboardUtils$SoftInputReceiver.f12160 = context;
        inputMethodManager.showSoftInput(view, 0, keyboardUtils$SoftInputReceiver);
        inputMethodManager.toggleSoftInput(2, 1);
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static int m8660(Window window) {
