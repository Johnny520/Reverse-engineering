...
public final class ListBuilder<E> extends AbstractC5180 implements List<E>, RandomAccess, Serializable {
    ...
    public ListBuilder(int i) {
        if (i >= 0) {
            ...
            C6755.m11869("capacity must be non-negative.");
            throw null;
        }
    }
    ...
    private final boolean contentEquals(List<?> other) {
        ...
        if (i == other.size()) {
            for (int i2 = 0; i2 < i; i2++) {
                if (AbstractC5227.m9466(eArr[i2], other.get(i2))) {
                }
            }
            return true;
        }
    ...
    private final void ensureCapacityInternal(int minCapacity) {
        ...
        if (minCapacity > eArr.length) {
            ...
            c5165.getClass();
            int iM9320 = C5165.m9320(length, minCapacity);
            E[] eArr2 = this.backing;
            eArr2.getClass();
            this.backing = (E[]) Arrays.copyOf(eArr2, iM9320);
        }
    }
    ...
    private final void insertAtInternal(int i, int n) {
        ...
        E[] eArr = this.backing;
        AbstractC5179.m9394(i + n, i, eArr, this.length, eArr);
        this.length += n;
    }
    ...
    public final E removeAtInternal(int i) {
        ...
        E[] eArr = this.backing;
        E e = eArr[i];
        AbstractC5179.m9394(i, i + 1, eArr, this.length, eArr);
        E[] eArr2 = this.backing;
    ...
    public final void removeRangeInternal(int rangeOffset, int rangeLength) {
        ...
        E[] eArr = this.backing;
        AbstractC5179.m9394(rangeOffset, rangeOffset + rangeLength, eArr, this.length, eArr);
        E[] eArr2 = this.backing;
        int i = this.length;
        AbstractC9004.m14187(eArr2, i - rangeLength, i);
    ...
    public final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        AbstractC5179.m9394(rangeOffset + i2, rangeLength + rangeOffset, eArr, this.length, eArr);
        E[] eArr3 = this.backing;
        int i5 = this.length;
        AbstractC9004.m14187(eArr3, i5 - i4, i5);
        if (i4 > 0) {
            registerModification();
        }
        this.length -= i4;
    ...
    public int indexOf(Object element) {
        for (int i = 0; i < this.length; i++) {
            if (AbstractC5227.m9466(this.backing[i], element)) {
                return i;
            }
        }
        return -1;
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        int i = this.length;
        c5165.getClass();
        C5165.m9321(fromIndex, toIndex, i);
    ...
    public <T> T[] toArray(T[] array) {
        ...
        AbstractC5179.m9394(0, 0, eArr, i, array);
        int i2 = this.length;
        if (i2 < array.length) {
            array[i2] = null;
        }
    ...
    public String toString() {
        return AbstractC9004.m14206(this.backing, 0, this.length, this);
    }
    ...
    public /* synthetic */ ListBuilder(int i, int i2, AbstractC5217 abstractC5217) {
        this((i2 & 1) != 0 ? 10 : i);
    }
    ...
    /* JADX INFO: compiled from: r8-map-id-447c03deab370cabd87f71de7ff996ccc1a6dc9764ce389c731d875d052048e4 */
    @Metadata(m150d1 = {"\u0000z\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u000b\n\u0002\u0010)\n\u0002\b\u0002\n\u0002\u0010+\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u001e\n\u0002\b\u0012\n\u0002\u0010\u0000\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0
VX\u0096\u0004¢\u0006\u0006\u001a\u0004\bb\u0010AR\u0014\u0010d\u001a\u00020\u00128BX\u0082\u0004¢\u0006\u0006\u001a\u0004\bd\u0010\u0014¨\u0006f"}, m151d2 = {"Lkotlin/collections/builders/ListBuilder$BuilderSubList;", "E", "", "Ljava/util/RandomAccess;", "Lkotlin/collections/RandomAccess;", "Lkotlin/collections/飘花落叶言子楪苏世兰哲;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "", "backing", "", "offset", "length", "parent", "Lkotlin/collections/builders/ListBuilder;", "root", MethodDescription.CONSTRUCTOR_INTERNAL_NAME, "([Ljava/lang/Object;IILkotlin/collections/builders/ListBuilder$BuilderSubList;Lkotlin/collections/builders/ListBuilder;)V", "", "isEmpty", "()Z", "index", "get", "(I)Ljava/lang/Object;", "element", "set", "(ILjava/lang/Object;)Ljava/lang/Object;", "indexOf", "(Ljava/lang/Object;)I", "lastIndexOf", "", "iterator", "()Ljava/util/Iterator;", "", "listIterator", "()Ljava/util/ListIterator;", "(I)Ljava/util/ListIterator;", "add", "(Ljava/lang/Object;)Z", "Lkotlin/飘花落叶言子楪兰苏哲世;", "(ILjava/lang/Object;)V", "", "elements", "addAll", "(Ljava/util/Collection;)Z", "(ILjava/util/Collection;)Z", "clear", "()V", "removeAt", "remove", "removeAll", "retainAll", "fromIndex", "toIndex", "subList", "(II)Ljava/util/List;", "T", "array", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", "", "()[Ljava/lang/Object;", "other", "equals", "hashCode", "()I", "", "toString", "()Ljava/lang/String;", "writeReplace", "()Ljava/lang/Object;", "Ljava/io/ObjectInputStream;", "input", "readObject", "(Ljava/io/ObjectInputStream;)V", "registerModification", "checkForComodification", "checkIsMutable", "", "contentEquals", "(Ljava/util/List;)Z", "i", "addAtInternal", "n", "addAllInternal", "(ILjava/util/Collection;I)V", "removeAtInternal", "rangeOffset", "rangeLength", "removeRangeInternal", "(II)V", "retain", "retainOrRemoveAllInternal", "(IILjava/util/Collection;Z)I", "[Ljava/lang/Object;", "I", "Lkotlin/collections/builders/ListBuilder$BuilderSubList;", "Lkotlin/collections/builders/ListBuilder;", "getSize", "size", "isReadOnly", "kotlin/collections/builders/飘花落叶言子楪世苏哲兰", "kotlin-stdlib"}, m152k = 1, m153mv = {2, 3, 0}, m155xi = 48)
    public static final class BuilderSubList<E> extends AbstractC5180 implements List<E>, RandomAccess, Serializable {
        private E[] backing;
        private int length;
        ...
        private final boolean contentEquals(List<?> other) {
            ...
            if (i2 == other.size()) {
                for (int i3 = 0; i3 < i2; i3++) {
                    if (AbstractC5227.m9466(eArr[i + i3], other.get(i3))) {
                    }
                }
                return true;
            }
        ...
        public int indexOf(Object element) {
            checkForComodification();
            for (int i = 0; i < this.length; i++) {
                if (AbstractC5227.m9466(this.backing[this.offset + i], element)) {
                    return i;
                }
            }
            return -1;
        ...
        public <T> T[] toArray(T[] array) {
            ...
            AbstractC5179.m9394(0, i2, eArr, i + i2, array);
            int i3 = this.length;
            if (i3 < array.length) {
                array[i3] = null;
            }
        ...
        public String toString() {
            checkForComodification();
            return AbstractC9004.m14206(this.backing, this.offset, this.length, this);
        }
        ...
        public Object[] toArray() {
            ...
            E[] eArr = this.backing;
            int i = this.offset;
            return AbstractC5179.m9390(eArr, i, this.length + i);
        }
    }
    ...
    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public Object[] toArray() {
        return AbstractC5179.m9390(this.backing, 0, this.length);
    }
}
