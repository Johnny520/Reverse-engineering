...
public final class C5317 implements InterfaceC8536, InterfaceC8989 {
    ...
    public void m9608() {
        ...
        str2.getClass();
        String strM14531 = "https://qstory.suzhelan.top/user/info";
        ...
        try {
            c6973M7271 = AbstractC3888.m7271("application/json");
        ...
        try {
            ...
            if (object.getIntValue("code") == 200) {
                ...
                if (AbstractC5227.m9466(jSONObject.getString("uin"), AbstractC3888.m7268().f25087) && ((num = AbstractC3888.m7268().f25085) == null || intValue != num.intValue())) {
