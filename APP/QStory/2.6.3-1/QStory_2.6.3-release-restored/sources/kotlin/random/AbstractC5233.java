...
public abstract class AbstractC5233 {
    public static final Random$Default Default = new Random$Default(null);
    private static final AbstractC5233 defaultRandom;

    static {
        Integer num = AbstractC7687.f18644;
        defaultRandom = num == null || num.intValue() >= 34 ? new C7366() : new C5236();
    }

    public static /* synthetic */ byte[] nextBytes$default(AbstractC5233 abstractC5233, byte[] bArr, int i, int i2, int i3, Object obj) {
        if (obj != null) {
            C6755.m11867("Super calls with default arguments not supported in this target, function: nextBytes");
            return null;
        }
        if ((i3 & 2) != 0) {
            i = 0;
        ...
        return abstractC5233.nextBytes(bArr, i, i2);
    }
    ...
    public byte[] nextBytes(byte[] bArr, int i, int i2) {
        ...
        if (i < 0 || i > bArr.length || i2 < 0 || i2 > bArr.length) {
            C6755.m11873(AbstractC0900.m716(AbstractC0900.m709(i, i2, "fromIndex (", ") or toIndex (", ") are out of range: 0.."), bArr.length, TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH));
            return null;
        }
        if (i > i2) {
    ...
    public double nextDouble(double d, double d2) {
        double dNextDouble;
        if (d2 <= d) {
            C6755.m11873(AbstractC3898.m7409(Double.valueOf(d), Double.valueOf(d2)));
            return 0.0d;
        }
        double d3 = d2 - d;
    ...
    public int nextInt(int i, int i2) {
        ...
        int iNextBits;
        if (i2 <= i) {
            C6755.m11873(AbstractC3898.m7409(Integer.valueOf(i), Integer.valueOf(i2)));
            return 0;
        }
        int i4 = i2 - i;
    ...
    public long nextLong(long j, long j2) {
        ...
        int iNextInt;
        if (j2 <= j) {
            C6755.m11873(AbstractC3898.m7409(Long.valueOf(j), Long.valueOf(j2)));
            return 0L;
        }
        long j4 = j2 - j;
        if (j4 > 0) {
