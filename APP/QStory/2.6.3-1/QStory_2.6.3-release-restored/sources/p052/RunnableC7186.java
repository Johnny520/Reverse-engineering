        ...
        switch (i) {
            case 0:
                ...
                if (!AbstractC7137.f17767.getAndSet(true)) {
                    ...
                    dialogC7161.f17800.setText("开始初始化");
            ...
            case 1:
                ...
                c7164M12413.f17803.f3963 = "getActivity";
                ...
                while (i3 < length) {
                    ...
                    if (type.getName().startsWith("com.tencent.mobileqq.activity")) {
                        try {
