...
public abstract /* synthetic */ class AbstractC9030 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final /* synthetic */ int[] f22938;
    ...
    static {
        ...
        try {
            f22938[WaitDialog$TYPE.SUCCESS.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            f22938[WaitDialog$TYPE.ERROR.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            f22938[WaitDialog$TYPE.NONE.ordinal()] = 4;
