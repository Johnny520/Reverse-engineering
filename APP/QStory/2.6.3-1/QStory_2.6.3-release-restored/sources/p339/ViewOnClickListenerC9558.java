                ...
                if (string.length() != 0) {
                    ...
                    if (string.equals(str)) {
                        ...
                        if (C9517.m14975().contains(string)) {
                            C9041.m14296(string.concat(" 文件夹已存在")).m14300();
                        } else {
                            File file2 = new File(C9517.m14969(), string);
                            if (!file.renameTo(file2)) {
                                C9041.m14296("重命名失败").m14300();
                            } else {
                                C9516.f24843.getClass();
                    ...
                    c9069.m14323();
                    C9041.m14296("保存成功").m14299();
                    c9539.invoke();
                } else {
                    C9041.m14296("名称不能为空").m14300();
                }
                break;
            default:
                ...
                if (string2.length() != 0) {
                    ...
                    if (!string2.equals(str)) {
                        ...
                        if (C9517.m14975().contains(string2)) {
                            C9041.m14296(string2.concat(" 文件夹已存在")).m14300();
                        } else {
                    ...
                    if (file4.exists()) {
                        ...
                        if (listM12829.isEmpty()) {
                            C9041.m14296("目录为空，无法上传").m14300();
                        } else {
                            C9516 c9516M12831 = C7790.m12831(file4);
                            C9069 c9069M14318 = C9069.m14318();
                            c9069M14318.f23106 = "上传表情包";
                            c9069M14318.m14322();
                            c9069M14318.f23105 = "确认将 \"" + name + "\" 上传到在线表情库？";
                            c9069M14318.m14322();
                        ...
                        C9041.m14296("目录不存在，无法上传").m14300();
                    }
                    c9539.invoke();
                } else {
                    C9041.m14296("名称不能为空，无法上传").m14300();
                }
                break;
        }
    }
