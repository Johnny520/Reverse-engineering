...
public final class C9496 {
    ...
    public static void m14921(String str, String str2) {
        if (!new File(str).exists()) {
            AbstractC7014.m12151("语音可能尚未加载完毕");
            return;
        }
        if (str2.trim().equals("")) {
            str2 = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());
        } else if (new File(AbstractC4765.m8874().concat("/Voice"), str2).exists()) {
            m14923(str, str2);
            return;
        }
    ...
    public static void m14923(final String str, final String str2) {
        ...
        textView.setText("文件名重复 目录已存在 " + str2);
  ...
  0x005e: PHI (r6v29 int) = (r6v5 int), (r6v18 int), (r6v18 int), (r6v21 int), (r6v28 int), (r6v37 int), (r6v38 int) binds: [B:90:0x0149, B:65:0x00da, B:67:0x00e0, B:54:0x00b8, B:40:0x0083, B:28:0x0058, B:27:0x0053] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static final JSONObject m14935() {
        ...
        jSONObject.put("Time", AbstractC7017.m12166());
        jSONObject.put("QQVersion", AbstractC7187.f17854);
        jSONObject.put("QStoryVersion", "2.6.3");
        String strM14531 = "XPosedTag";
        try {
        ...
        jSONObject.put("AndroidSDK", Integer.valueOf(Build.VERSION.SDK_INT));
    ...
    public static void m14941(String str, String str2) {
        String str3 = C7243.f17939 + str2 + "(1)";
        while (new File(str3).exists()) {
            str3 = C7243.f17939 + str2 + "(" + (Integer.parseInt(str3.substring(str3.lastIndexOf("(") + 1, str3.lastIndexOf(")"))) + 1) + ")";
        }
        try {
            AbstractC5894.m10609(str, str3);
            AbstractC7014.m12151("已生成新的语音文件" + str3);
        } catch (IOException e) {
            C6755.m11872(e);
        }
    }
    ...
    public static void m14943(Context context, String str) {
        ...
        try {
            ...
            String strM14531 = "创建保存语音面板 已抛出异常";
