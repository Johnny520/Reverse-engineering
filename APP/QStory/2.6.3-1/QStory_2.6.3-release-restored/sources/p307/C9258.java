...
public final class C9258 extends AbstractC9262 {

    /* JADX INFO: renamed from: 飘花落叶言子世兰苏哲楪, reason: contains not printable characters */
    public final Object f23682;

    /* JADX INFO: renamed from: 飘花落叶言子世兰苏楪哲, reason: contains not printable characters */
    public final /* synthetic */ int f23683 = 0;

    public C9258(String str, int i, long j, String str2, String str3, Field field, Method method, Function function) {
        super(str, i, j, str2, str3, Long.class, field, method);
        this.f23682 = function;
    }
    ...
    public void mo14557(AbstractC3730 abstractC3730, Object obj) {
        switch (this.f23683) {
            case 1:
                abstractC3730.mo6523(((ToLongFunction) this.f23682).applyAsLong(obj));
                break;
            default:
    ...
    public boolean mo14558(AbstractC3730 abstractC3730, Object obj) {
        switch (this.f23683) {
            case 1:
                try {
                    m14567(abstractC3730, ((ToLongFunction) this.f23682).applyAsLong(obj));
                    return true;
    ...
    public C9258(String str, int i, long j, String str2, String str3, Field field, Method method, ToLongFunction toLongFunction) {
        super(str, i, j, str2, str3, Long.TYPE, field, method);
        this.f23682 = toLongFunction;
    }
}
