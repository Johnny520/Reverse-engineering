    ...
    public void mo5044(List list) {
        ...
        switch (i) {
            case 23:
                ...
                c9508.f24830.m15236(list, "TroopUinList");
                AbstractC7014.m12151("已保存 " + list.size() + " 个群聊");
                c9508.f24829.execute(new RunnableC0946(c9508, 24, list));
                break;
            case 24:
                C9506 c9506 = (C9506) obj;
                c9506.f24824.m15236(list, "TroopUinList");
                AbstractC7014.m12151("已保存 " + list.size() + " 个群聊");
                new Thread(new RunnableC0946(c9506, 25, list)).start();
                break;
            default:
                C9504 c9504 = (C9504) obj;
                c9504.f24820.m15236(list, "TroopUinList");
                AbstractC7014.m12151("已保存 " + list.size() + " 个群聊");
        ...
        switch (i) {
            case 7:
                ...
                try {
                    ...
                    obj4.getClass();
                    byte[] bArr = (byte[]) obj4;
                    if (str2.equals("trpc.msg.register_proxy.RegisterProxy.InfoSyncPush")) {
                        AbstractC3887.m7201(bArr, methodHookParam);
                    } else if (str2.equals("trpc.msg.olpush.OlPushService.MsgPush")) {
                    ...
                    "getItemPath(...)";
                    itemPath2.getClass();
                    String strSubstring = itemPath.substring(AbstractC5976.m10728(0, 6, itemPath2, "/") + 1);
                    "substring(...)";
                    Log.e("[QStory]", strSubstring, e);
                    ...
                    AbstractC7017.m12163(((String) obj5) + "->" + c7018 + "->\n" + AbstractC7017.m12161(e), strSubstring);
                    return;
                }
            case 8:
                        ...
                        if (List.class.isAssignableFrom(field.getType())) {
                            try {
                                ...
                                if (list == null && (objM9374 = AbstractC5176.m9374(list)) != null) {
                                    String strM14531 = "com.tencent.mobileqq.aio.msg.AIOMsgItem";
                                    ...
                                    try {
                                        objM723 = Result.m9304constructorimpl(XposedHelpers.callMethod(obj, "getMsgRecord", new Object[0]));
                                        break;
                                    } catch (Throwable th2) {
                                    ...
                                    if (objM723 == null || (lM11807 = C6666.m11807(objM723, "msgId")) == null) {
                                        return;
                                    }
                                    final long jLongValue2 = lM11807.longValue();
                                    Object objM11808 = C6666.m11808(objM723, "elements");
                                    ...
                                    if (list3 != null) {
                                        ...
                                        while (true) {
                                            if (it.hasNext()) {
                                                ...
                                                Object objM118082 = C6666.m11808(next2, "elementType");
                                                if (objM118082 != null) {
                                                    ...
                                                    if (numValueOf2 != null && numValueOf2.intValue() == 1) {
                                                        try {
                                                            objM7232 = Result.m9304constructorimpl(XposedHelpers.callMethod(next2, "getTextElement", new Object[0]));
                                                        } catch (Throwable th3) {
                                                        ...
                                                        if (objM7232 != null) {
                                                            try {
                                                                Object objCallMethod3 = XposedHelpers.callMethod(objM7232, "getContent", new Object[0]);
                                    ...
                                    Object objM12520 = C7206.m12520(obj, "修改消息", C0328R.mipmap.ic_launcher_round, new Callable(c6666, str5, jLongValue2) { // from class: top.suzhelan.qstory.hook.item.chat.飘花落叶言子世楪苏兰哲
                                        ...
                                        public final Object call() {
                                            ...
                                            ((Button) viewInflate.findViewById(C0328R.id.change_message_save)).setOnClickListener(new View.OnClickListener() { // from class: top.suzhelan.qstory.hook.item.chat.飘花落叶言子世楪哲苏兰
                                                ...
                                                public final void onClick(View view) {
                                                    ...
                                                    dialogC7148.dismiss();
                                                    AbstractC7014.m12151("已修改，滑动或重新打开会话后生效");
                                                }
                                            });
                ...
                String strM145312 = "com.tencent.mobileqq.aio.msg.AIOMsgItem";
                superclass = objM9374.getClass();
                while (true) {
                    if (superclass == null) {
                    }
            ...
            case 9:
                ...
                "getName(...)";
                if (!AbstractC5976.m10735(name2, "MultiForwardActivity", false) && imageView.getVisibility() == 0) {
            ...
            case 10:
                ...
                try {
                    int intField3 = XposedHelpers.getIntField(tag, "emoId");
                    if (intField3 == 0 || (service = QQServiceTool.getService(AbstractC7166.m12425("com.tencent.mobileqq.emosm.api.IFavroamingDBManagerService"))) == null) {
                        return;
                    }
                    try {
                        objCallMethod = XposedHelpers.callMethod(service, "getEmoticonDataList", new Object[0]);
                    } catch (Exception unused) {
                        try {
                            Object objectField2 = XposedHelpers.getObjectField(service, "emoticonDataList");
                    ...
                    while (true) {
                        if (it2.hasNext()) {
                            next = it2.next();
                            if (XposedHelpers.getIntField(next, "emoId") == intField3) {
                            }
                        } else {
                            next = null;
                        }
                    ...
                    if (it3.hasNext()) {
                        try {
                            intField = XposedHelpers.getIntField(it3.next(), "emoId");
                        ...
                        while (it3.hasNext()) {
                            try {
                                intField2 = XposedHelpers.getIntField(it3.next(), "emoId");
                    ...
                    try {
                        objectField = XposedHelpers.getObjectField(next, "resid");
                    ...
                    if (str != null) {
                        try {
                            objCallMethod2 = XposedHelpers.callMethod(QQServiceTool.getRuntime(), "getBusinessHandler", new Object[]{"com.tencent.mobileqq.app.FavEmoRoamingHandler"});
                            break;
                    ...
                    XposedHelpers.callMethod(service, "deleteCustomEmotion", new Object[]{next});
                    Object objCallMethod4 = XposedHelpers.callMethod(next, "cloneEmotionData", new Object[]{next});
                    XposedHelpers.setIntField(objCallMethod4, "emoId", iIntValue + 1);
                    XposedHelpers.callMethod(service, "insertCustomEmotion", new Object[]{objCallMethod4});
                    XposedHelpers.callMethod(service, "trimCache", new Object[0]);
                    Object objectField3 = XposedHelpers.getObjectField(obj11, "mInteractionListener");
                    Object objM12146 = AbstractC7012.m12146(2259);
                    if (objM12146 != null) {
                        XposedHelpers.callMethod(XposedHelpers.callMethod(objM12146, "tryGetEmoticonMainPanel", new Object[]{objectField3}), "updateFavEmoticonPanel", new Object[0]);
                        return;
                    }
                    return;
            ...
            case 12:
                ...
                Class clsM12425 = AbstractC7166.m12425("com.tencent.qphone.base.util.QLog");
                if (clsM12425 != null) {
            ...
            case 13:
                ...
                Object objM12417 = AbstractC7165.m12417(AbstractC7166.m12425("com.tencent.mobileqq.aio.msg.AIOMsgItem"), list4.get(0));
                List<String> msgRecordPicUrlList = QQMessageUtils.getMsgRecordPicUrlList(XposedHelpers.callMethod(objM12417, "getMsgRecord", new Object[0]));
                if (msgRecordPicUrlList.isEmpty()) {
                    return;
                }
                list4.add(0, C7206.m12520(objM12417, "复制图链", C0328R.mipmap.ic_launcher_round, new CallableC7262(c6686, msgRecordPicUrlList, i3)));
                return;
            case 14:
            ...
            case 16:
                ...
                for (int i7 = 0; i7 < arrayList.size(); i7++) {
                    ...
                    c7164M124133.f17803.f3963 = "getTextElement";
                ...
                String strReplace = (String) c7149.m12398("prefix");
                String strReplace2 = (String) c7149.m12398("suffix");
                String str6 = (String) c7149.m12398("time_format");
                if (!TextUtils.isEmpty(str6)) {
                    String str7 = new SimpleDateFormat(str6, Locale.CHINA).format(new Date());
                    strReplace = strReplace.replace("{time}", str7);
                    strReplace2 = strReplace2.replace("{time}", str7);
                }
            ...
            case 18:
                ...
                Object objM124172 = AbstractC7165.m12417(AbstractC7166.m12425("com.tencent.mobileqq.aio.msg.AIOMsgItem"), list5.get(0));
                List<String> msgRecordPicUrlList2 = QQMessageUtils.getMsgRecordPicUrlList(XposedHelpers.callMethod(objM124172, "getMsgRecord", new Object[0]));
                if (msgRecordPicUrlList2.isEmpty()) {
                    return;
                }
                list5.add(0, C7206.m12520(objM124172, "转卡片", C0328R.mipmap.ic_launcher_round, new CallableC7219(c66862, msgRecordPicUrlList2, i3)));
                return;
            case 19:
                C7266 c7266 = (C7266) obj2;
                for (Object obj15 : (ArrayList) methodHookParam.args[2]) {
                    C7164 c7164M124134 = C7164.m12413(obj15.getClass());
                    c7164M124134.f17803.f3963 = "getTextElement";
                    Object objM124152 = c7164M124134.m12415(obj15, new Object[0]);
                    if (objM124152 != null && ((Integer) AbstractC7165.m12418(cls2, "atType", objM124152)).intValue() == 2) {
                        String str8 = (String) c7266.f17979.m12398("summary");
                        if (TextUtils.isEmpty(str8)) {
                            return;
                        }
                        C7164 c7164M124135 = C7164.m12413(objM124152.getClass());
                        String strM145314 = "setContent";
            ...
            case 20:
                ...
                String str9 = (String) AbstractC7165.m12418(String.class, "urlStr", methodHookParam.args[1]);
                ...
                if (map.containsKey(str9)) {
                    ...
                    String strM12110 = c6960M12193.f17114.m12110("Content-Length");
                    if (strM12110 == null) {
                        strM12110 = null;
                    }
                    c6960M12193.close();
                ...
                if (jLongValue > 104857600 || map.containsKey(str9)) {
                    if (System.currentTimeMillis() > c7265.f17977 + 60000) {
                        AbstractC7014.m12151("当前下载的图片可能过大,已停止加载");
            ...
            default:
                ...
                Long l = (Long) AbstractC7165.m12418(Long.TYPE, "msgId", objM124153);
                l.getClass();
                if (((C9621) obj2).f25103.contains(l)) {
                    return;
                }
                for (Object obj18 : (ArrayList) AbstractC7165.m12418(ArrayList.class, "elements", objM124153)) {
                    C7164 c7164M124137 = C7164.m12413(obj18.getClass());
                    c7164M124137.f17803.f3963 = "getPicElement";
                    c7164M124137.f17803.f3962 = AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.PicElement");
                    Object objM124154 = c7164M124137.m12415(obj18, new Object[0]);
                    if (objM124154 != null) {
                        int iIntValue2 = ((Integer) AbstractC7165.m12418(cls2, "picHeight", objM124154)).intValue();
                        if (((Integer) AbstractC7165.m12418(cls2, "picWidth", objM124154)).intValue() > 6000 && iIntValue2 > 6000) {
                            methodHookParam.setResult((Object) null);
                            return;
                        }
                    }
            ...
            case 28:
                ...
                if (hashSet2 == null) {
                    AbstractC5227.m9467("mPathPrefixList");
                    throw null;
                }
