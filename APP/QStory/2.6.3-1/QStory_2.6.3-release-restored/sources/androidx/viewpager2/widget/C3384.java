...
public final class C3384 implements Parcelable.ClassLoaderCreator {
    @Override // android.os.Parcelable.Creator
    public final Object createFromParcel(Parcel parcel) {
        ViewPager2$SavedState viewPager2$SavedState = new ViewPager2$SavedState(parcel, null);
        viewPager2$SavedState.f7994 = parcel.readInt();
        viewPager2$SavedState.f7992 = parcel.readInt();
        viewPager2$SavedState.f7993 = parcel.readParcelable(null);
    ...
    public final Object createFromParcel(Parcel parcel, ClassLoader classLoader) {
        ...
        viewPager2$SavedState.f7994 = parcel.readInt();
        viewPager2$SavedState.f7992 = parcel.readInt();
        viewPager2$SavedState.f7993 = parcel.readParcelable(classLoader);
        return viewPager2$SavedState;
    }
}
