...
@InterfaceC7691(m555c = "androidx.compose.foundation.gestures.TransformableStateKt$animateRotateBy$3", m556f = "TransformableState.kt", m557l = {288}, m558m = "invokeSuspend", m559v = 1)
...
final class TransformableStateKt$animateRotateBy$3 extends SuspendLambda implements InterfaceC7383 {
    ...
    public TransformableStateKt$animateRotateBy$3(Ref$FloatRef ref$FloatRef, float f, InterfaceC1195 interfaceC1195, long j, InterfaceC5189<? super TransformableStateKt$animateRotateBy$3> interfaceC5189) {
    ...
    public final InterfaceC5189<C6008> create(Object obj, InterfaceC5189<?> interfaceC5189) {
        TransformableStateKt$animateRotateBy$3 transformableStateKt$animateRotateBy$3 = new TransformableStateKt$animateRotateBy$3(this.$previous, this.$degrees, this.$animationSpec, this.$centroid, interfaceC5189);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C1327 c1327 = new C1327(this.$previous, this.$centroid, 0);
            this.label = 1;
    ...
    public final Object invoke(InterfaceC1334 interfaceC1334, InterfaceC5189<? super C6008> interfaceC5189) {
        return ((TransformableStateKt$animateRotateBy$3) create(interfaceC1334, interfaceC5189)).invokeSuspend(C6008.f15084);
    }
}
