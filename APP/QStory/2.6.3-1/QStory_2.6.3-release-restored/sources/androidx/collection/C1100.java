...
public final class C1100 {
    ...
    public long[] f1268 = AbstractC1137.f1352;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public long[] f1267 = AbstractC1111.f1297;

    public C1100(int i) {
        if (i >= 0) {
            m1369(AbstractC1137.m1443(i));
        } else {
    ...
    */
    public final boolean equals(Object obj) {
        ...
        if (c1100.f1265 != this.f1265) {
            return false;
        }
        long[] jArr = this.f1267;
        long[] jArr2 = this.f1268;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !c1100.m1371(jArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
  ...
  0x005b: PHI (r5v2 int) = (r5v1 int), (r5v3 int) binds: [B:6:0x0024, B:18:0x0059] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final void m1369(int i) {
        ...
        long j = 255 << ((iMax & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1264 = AbstractC1137.m1446(this.f1266) - this.f1265;
        this.f1267 = new long[iMax];
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final int m1370(int i) {
        int i2 = this.f1266;
        int i3 = i & i2;
        int i4 = 0;
        while (true) {
            long[] jArr = this.f1268;
            int i5 = i3 >> 3;
            int i6 = (i3 & 7) << 3;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m1371(long j) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (this.f1267[iNumberOfTrailingZeros] == j) {
                    break loop0;
                }
                j4 &= j4 - 1;
            }
