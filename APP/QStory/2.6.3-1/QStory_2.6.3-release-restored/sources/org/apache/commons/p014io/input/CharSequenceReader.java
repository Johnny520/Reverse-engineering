...
public class CharSequenceReader extends Reader implements Serializable {
    ...
    public CharSequenceReader(String str, int i, int i2) {
        if (i < 0) {
            C6755.m11869(AbstractC7012.m12147(i, "Start index is less than zero: "));
            throw null;
        }
        if (i2 < i) {
            C6755.m11869(AbstractC7012.m12150(i, i2, "End index is less than start ", ": "));
            throw null;
        }
    ...
    public int read(char[] cArr, int i, int i2) {
        ...
        if (i2 < 0 || i < 0 || i + i2 > cArr.length) {
            C3775.m6966("Array Size=", cArr.length, ", offset=", i, ", length=", i2);
            return 0;
        }
    ...
    public long skip(long j) {
        if (j < 0) {
            C6755.m11869(AbstractC3275.m5143(j, "Number of characters to skip is less than zero: "));
            return 0L;
        }
        if (this.idx >= end()) {
            return 0L;
