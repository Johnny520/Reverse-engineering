...
public class X5455_ExtendedTimestamp implements InterfaceC6419, Cloneable, Serializable {
    ...
    private static ZipLong unixTimeToZipLong(long j) {
        ...
        C6755.m11869(AbstractC3275.m5143(j, "X5455 timestamps must fit in a signed 32 bit integer: "));
        return null;
    }
    ...
    public void parseFromLocalFileData(byte[] bArr, int i, int i2) throws ZipException {
        ...
        reset();
        if (i2 < 1) {
            throw new ZipException(AbstractC0900.m722(i2, "X5455_ExtendedTimestamp too short, only ", " bytes"));
        }
        int i5 = i2 + i;
        int i6 = i + 1;
        setFlags(bArr[i]);
    ...
    public String toString() {
        ...
        sb.append(Integer.toBinaryString(AbstractC6411.m11500(this.flags)));
        sb.append(" ");
