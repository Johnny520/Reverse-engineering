...
public class AndFileFilter extends AbstractC9744 implements Serializable {
    private static final long serialVersionUID = 7215974688563965257L;
    private final List<InterfaceC9740> fileFilters;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AndFileFilter(InterfaceC9740... interfaceC9740Arr) {
    ...
    public FileVisitResult accept(Path path, BasicFileAttributes basicFileAttributes) {
        return isEmpty() ? FileVisitResult.TERMINATE : AbstractC9744.toDefaultFileVisitResult(this.fileFilters.stream().allMatch(new C9743(path, basicFileAttributes, 0)));
    }

    public void addFileFilter(InterfaceC9740... interfaceC9740Arr) {
        Objects.requireNonNull(interfaceC9740Arr, "fileFilters");
        Stream.of((Object[]) interfaceC9740Arr).forEach(new C3497(this, 5));
    }
    ...
    public InterfaceC9740 m507or(InterfaceC9740 interfaceC9740) {
    ...
    private AndFileFilter(ArrayList<InterfaceC9740> arrayList) {
    ...
    public AndFileFilter(InterfaceC9740 interfaceC9740, InterfaceC9740 interfaceC97402) {
        this(2);
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AndFileFilter(List<InterfaceC9740> list) {
    ...
    public boolean accept(File file, String str) {
        return !isEmpty() && this.fileFilters.stream().allMatch(new C9741(str, file, 0));
    }

    @Override // p375.AbstractC9744, p375.InterfaceC9740, java.io.FileFilter
    public boolean accept(File file) {
        return !isEmpty() && this.fileFilters.stream().allMatch(new C9742(file, 0));
    }
}
