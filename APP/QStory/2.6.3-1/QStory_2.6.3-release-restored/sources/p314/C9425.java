...
public final class C9425 {

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世兰哲, reason: contains not printable characters */
    public static final int[] f24410;

    /* JADX INFO: renamed from: 飘花落叶言子楪苏世哲兰, reason: contains not printable characters */
    public static final int f24411;
    ...
    public int f24412 = 18;

    /* JADX INFO: renamed from: 飘花落叶言子楪世兰苏哲, reason: contains not printable characters */
    public int f24413 = 37;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public long[] f24416 = new long[37];

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public int[] f24417 = new int[37];
    ...
    static {
        ...
        f24410 = iArr;
        Arrays.sort(iArr);
        f24411 = iArr[iArr.length - 1];
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("{");
        long[] jArr = this.f24416;
        int[] iArr = this.f24417;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世哲苏兰, reason: contains not printable characters */
    public final int m14790(int i, long j) {
        int i2;
        ...
        int i4 = this.f24414 + 1;
        this.f24414 = i4;
        int i5 = this.f24412;
        if (i4 <= i5 && this.f24413 != 0) {
            return i;
        }
        int length3 = this.f24416.length;
        if (i4 > i5) {
            int i6 = length3 << 1;
            int i7 = f24411;
            if (i6 >= i7) {
        ...
        long[] jArr3 = this.f24416;
        int length4 = jArr3.length;
        int[] iArr3 = this.f24417;
        this.f24416 = new long[length3];
        this.f24417 = new int[length3];
        while (true) {
            int i8 = length4 - 1;
            if (length4 <= 0) {
                int length5 = this.f24416.length;
                this.f24412 = Math.min(length5 - 1, (int) (length5 * 0.5f));
                this.f24413 = length5 - this.f24414;
                return i;
            }
            long j4 = jArr3[i8];
            if (j4 != 0) {
                this.f24417[m14792(j4)] = iArr3[i8];
            }
            length4 = i8;
        }
    }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final void m14791(int i, long j) {
        int i2;
        int i3 = ((int) ((j >>> 32) ^ j)) & Integer.MAX_VALUE;
        long[] jArr = this.f24416;
        int length = i3 % jArr.length;
        ...
        int i6 = this.f24414 + 1;
        this.f24414 = i6;
        int i7 = this.f24412;
        if (i6 <= i7 && this.f24413 != 0) {
            return;
        }
        int length3 = this.f24416.length;
        if (i6 > i7) {
        ...
        while (true) {
            ...
            if (length4 <= 0) {
                ...
                long j4 = jArr3[i10];
                if (j4 != 0) {
                    this.f24417[m14792(j4)] = iArr2[i10];
                }
                length4 = i10;
            }
        }
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public final int m14792(long j) {
        ...
        C6755.m11870("No free or removed slots available. Key set full?!!");
        return 0;
    }
}
