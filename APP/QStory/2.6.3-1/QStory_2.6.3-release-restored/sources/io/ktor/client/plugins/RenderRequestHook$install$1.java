...
@InterfaceC7691(m555c = "io.ktor.client.plugins.RenderRequestHook$install$1", m556f = "HttpPlainText.kt", m557l = {145, 146}, m558m = "invokeSuspend")
...
final class RenderRequestHook$install$1 extends SuspendLambda implements InterfaceC7380 {
    ...
    public RenderRequestHook$install$1(InterfaceC7380 interfaceC7380, InterfaceC5189<? super RenderRequestHook$install$1> interfaceC5189) {
    ...
    public final Object invoke(AbstractC5026 abstractC5026, Object obj, InterfaceC5189<? super C6008> interfaceC5189) {
        RenderRequestHook$install$1 renderRequestHook$install$1 = new RenderRequestHook$install$1(this.$handler, interfaceC5189);
        renderRequestHook$install$1.L$0 = abstractC5026;
        renderRequestHook$install$1.L$1 = obj;
        return renderRequestHook$install$1.invokeSuspend(C6008.f15084);
    }

    /* JADX WARN: Code restructure failed: missing block: B:16:0x0044, code lost:
    
        if (r1.mo9129(r8, r7) == r0) goto L17;
     */
