...
public abstract class AbstractC9744 implements InterfaceC9740, FileVisitor {
    private final FileVisitResult onAccept;
    private final FileVisitResult onReject;

    public AbstractC9744() {
    ...
    public FileVisitResult get(InterfaceC9734 interfaceC9734) {
        try {
            return (FileVisitResult) interfaceC9734.get();
        } catch (IOException e) {
            return handle(e);
        }
    }
    ...
    public AbstractC9744(FileVisitResult fileVisitResult, FileVisitResult fileVisitResult2) {
