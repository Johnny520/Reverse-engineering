...
public final class C9527 extends AbstractC7140 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (AbstractC3888.m7256()) {
            ...
            if (method == null) {
                C3466.m5899("StickerPanelInject: PanelIconLinearLayout method not found");
                return;
            }
                ...
                public final void mo2039(XC_MethodHook.MethodHookParam methodHookParam) {
                    ...
                    switch (i4) {
                        case 0:
                            ...
                            imageView.setContentDescription("自定义表情面板");
                        ...
                        default:
                            ...
                            ImageButton imageButton = (ImageButton) AbstractC7165.m12418(ImageButton.class, "m", methodHookParam.thisObject);
                            if (imageButton != null) {
    ...
    public final String mo11794() {
        String strM14531 = "表情面板#2，表情以文件夹组保存在";
    ...
    public final void m14979() {
        ...
        if (this.f24867 == null || this.f24868 != z) {
            File file = new File(AbstractC4765.m8874(), "滑稽.png");
            if (!file.exists()) {
            ...
            File file2 = new File(AbstractC4765.m8874(), "暗黑滑稽.webp");
            if (!file2.exists()) {
