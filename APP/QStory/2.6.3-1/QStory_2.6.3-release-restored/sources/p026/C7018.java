...
public final class C7018 {
    ...
    public final byte[] m12169() {
        ...
        try {
            for (Integer num : map.keySet()) {
                for (Object obj : (List) map.get(num)) {
                    if (obj instanceof Long) {
                        ...
                        AbstractC7017.m12164("FunProtoData.toBytes", "Unknown type: " + obj.getClass().getName(), new RuntimeException(), true);
                    }
                }
            }
            if (c4298.f11483 > 0) {
            ...
            String strM14531 = "FunProtoData-toBytes";
            ...
            if (i2 == 0) {
                ...
                try {
                    try {
                        ...
                        m12170(i, "hex->" + m12168(bArrM8307));
                        break;
                    }
                } catch (Exception unused2) {
                    m12170(i, "hex->".concat(m12168(bArrM8307)));
                }
            } else if (i2 != 5) {
                m12170(i, "Unknown wireType: " + i2);
            } else {
