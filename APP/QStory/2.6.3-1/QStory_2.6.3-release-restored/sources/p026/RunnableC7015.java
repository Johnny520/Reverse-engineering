        ...
        switch (i) {
            ...
            case 1:
                try {
                    ...
                    jSONObjectM14935.put("Uin", QQEnvTool.getCurrentUin());
                    jSONObjectM14935.put("Nickname", QQEnvTool.getCurrentAccountNickName());
                    Pair pairM14265 = AbstractC9019.m14265();
                    if (pairM14265 != null) {
                        jSONObjectM14935.put("Ip", pairM14265.first);
                        jSONObjectM14935.put("ClientCity", pairM14265.second);
                    }
                    if (str.length() > 0) {
                        jSONObjectM14935.put("Location", str);
                        jSONObjectM14935.put("Lt", "regularly");
                    }
                    C9663.m15047().m15070(jSONObjectM14935).execute();
                    return;
                } catch (Exception e) {
                    AbstractC7017.m12164("commitInfo", e.toString(), e, true);
                    return;
                }
            case 2:
                C9665.m15054(str);
            ...
            default:
                ...
                try {
                    try {
                        ...
                        String strConcat = C9665.m15058(str).concat("_time");
