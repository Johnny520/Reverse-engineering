...
public final /* synthetic */ class C8376 implements InterfaceC7021, InterfaceC7019, InterfaceC7141, InterfaceC8792 {
    ...
    public boolean mo13336(AbstractC8798 abstractC8798, View view, int i) {
        ...
        C9037 c9037M14288 = C9037.m14288("确定要删除该表情吗?这将无法还原", "删除表情");
        c9037M14288.f22961 = new C9548(imageView, 0);
        c9037M14288.mo14280();
        c9037M14288.mo14278("删除", new C6378(c9523, i2, c1754));
    ...
    public void mo9180(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        switch (this.f20772) {
            ...
            case 21:
            default:
                if ("exp_QQ_aio_photo_choose_B".equals((String) methodHookParam.args[0])) {
                    methodHookParam.setResult(Boolean.FALSE);
                }
                break;
            case 16:
                ...
                Object objM124172 = AbstractC7165.m12417(AbstractC7166.m12425("com.tencent.mobileqq.aio.msg.AIOMsgItem"), listM9450.get(0));
                "getFirstField(...)";
                objM124172.getClass();
                Object objM12520 = C7206.m12520(objM124172, "保存到QS", C0328R.mipmap.ic_launcher_round, new CallableC9526(objM124172, i));
                objM12520.getClass();
            ...
            case 19:
                ...
                if (obj2 != null) {
                    String[] strArr = {"advimageUrl", "videoUrl", "videoReportUrl", "negativeFeedbackUrl", "clickUrl", "advLogoUrl"};
            ...
            case 27:
                ...
                break;
            case 28:
                if ("AIOShortcutBarVM".equals(methodHookParam.args[0]) && ((Integer) methodHookParam.args[1]).intValue() == 2333) {
