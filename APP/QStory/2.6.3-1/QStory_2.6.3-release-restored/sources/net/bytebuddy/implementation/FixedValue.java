...
public abstract class FixedValue implements Implementation {
    ...
    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription, TypeDescription.Generic generic, StackManipulation stackManipulation) {
        ...
        if (stackManipulationAssign.isValid()) {
            return new ByteCodeAppender.Size(new StackManipulation.Compound(stackManipulation, stackManipulationAssign, MethodReturn.m448of(methodDescription.getReturnType())).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
        }
        C6385.m11433("Cannot return value of type ", generic, " for ", methodDescription);
        return null;
    }
    ...
    public int hashCode() {
        return this.typing.hashCode() + AbstractC3275.m5149(this.assigner, getClass().hashCode() * 31, 31);
    }
    ...
    public static class ForArgument extends FixedValue implements AssignerConfigurable, ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            StackManipulation.Compound compound = new StackManipulation.Compound(MethodVariableAccess.load(parameterDescription), this.assigner.assign(parameterDescription.getType(), methodDescription.getReturnType(), this.typing), MethodReturn.m448of(methodDescription.getReturnType()));
            if (compound.isValid()) {
                return new ByteCodeAppender.Size(compound.apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
            }
            C1123.m1407("Cannot assign ", methodDescription.getReturnType(), " to ", parameterDescription);
            return null;
        }
    ...
    public static class ForConstantValue extends FixedValue implements AssignerConfigurable, ByteCodeAppender {
        ...
        public ForConstantValue(StackManipulation stackManipulation, Class<?> cls) {
            this(stackManipulation, TypeDescription.ForLoadedType.m289of(cls));
        }
        ...
        @Override // net.bytebuddy.implementation.FixedValue
        public int hashCode() {
            return this.loadedType.hashCode() + AbstractC3275.m5148(this.valueLoadInstruction, super.hashCode() * 31, 31);
        }
    ...
    public static class ForOriginType extends FixedValue implements AssignerConfigurable {
        ...
        public class Appender implements ByteCodeAppender {
            ...
            @Override // net.bytebuddy.implementation.bytecode.ByteCodeAppender
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                return ForOriginType.this.apply(methodVisitor, context, methodDescription, TypeDescription.ForLoadedType.m289of(Class.class).asGenericType(), ClassConstant.m442of(this.originType));
            }
            ...
            public int hashCode() {
                return ForOriginType.this.hashCode() + AbstractC3275.m5144(this.originType, getClass().hashCode() * 31, 31);
            }
        }
    ...
    public static class ForThisValue extends FixedValue implements AssignerConfigurable {
        ...
        public static class Appender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                C6755.m11870(AbstractC3275.m5133("Cannot return 'this' from ", methodDescription));
                return null;
            }
    ...
    public static class ForValue extends FixedValue implements AssignerConfigurable {
        ...
        public class StaticFieldByteCodeAppender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                ...
                return forValue.apply(methodVisitor, context, methodDescription, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(forValue.value.getClass()), this.fieldGetAccess);
            }
        ...
        @Override // net.bytebuddy.implementation.FixedValue
        public int hashCode() {
            return this.value.hashCode() + AbstractC7012.m12131(super.hashCode() * 31, 31, this.name);
        }

        @Override // net.bytebuddy.dynamic.scaffold.InstrumentedType.Prepareable
        public InstrumentedType prepare(InstrumentedType instrumentedType) {
            return instrumentedType.withAuxiliaryField(new FieldDescription.Token(this.name, 4169, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(this.value.getClass())), this.value);
        }
    ...
    public static AssignerConfigurable value(TypeDescription typeDescription) {
        return new ForConstantValue(ClassConstant.m442of(typeDescription), TypeDescription.ForLoadedType.m289of(Class.class));
    }
    ...
    public enum ForNullValue implements Implementation, ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            C6755.m11870(AbstractC3275.m5133("Cannot return null from ", methodDescription));
            return null;
        }
