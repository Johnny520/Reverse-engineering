...
public final class MethodVariableAccess {
    ...
    public static class MethodLoading extends StackManipulation.AbstractBase {
        ...
        public interface TypeCastingHandler {
            ...
            public static class ForBridgeTarget implements TypeCastingHandler {
                ...
                public StackManipulation ofIndex(TypeDescription typeDescription, int i) {
                    ...
                    return typeDescription.equals(typeDescriptionAsErasure) ? StackManipulation.Trivial.INSTANCE : TypeCasting.m440to(typeDescriptionAsErasure);
                }
            }
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            while (it.hasNext()) {
                ...
                arrayList.add(MethodVariableAccess.m449of(typeDescriptionAsErasure).loadFrom(parameterDescription.getOffset()));
        ...
        public int hashCode() {
            return this.typeCastingHandler.hashCode() + AbstractC3275.m5127(this.methodDescription, getClass().hashCode() * 31, 31);
        }
    ...
    public static StackManipulation load(ParameterDescription parameterDescription) {
        return m449of(parameterDescription.getType()).loadFrom(parameterDescription.getOffset());
    }
    ...
    public static MethodVariableAccess m449of(TypeDefinition typeDefinition) {
        ...
        C6755.m11869("Variable type cannot be void");
        return null;
    }

    public static StackManipulation store(ParameterDescription parameterDescription) {
        return m449of(parameterDescription.getType()).storeAt(parameterDescription.getOffset());
    }
    ...
    public StackManipulation increment(int i, int i2) {
        ...
        C8376.m13333(this, "Cannot increment type: ");
        return null;
    }
    ...
    public static StackManipulation increment(ParameterDescription parameterDescription, int i) {
        return m449of(parameterDescription.getType()).increment(parameterDescription.getOffset(), i);
    }
}
