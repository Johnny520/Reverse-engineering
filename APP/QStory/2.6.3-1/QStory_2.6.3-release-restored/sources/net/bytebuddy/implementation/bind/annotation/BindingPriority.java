...
public @interface BindingPriority {
    ...
    public enum Resolver implements MethodDelegationBinder.AmbiguityResolver {
        ...
        private static final MethodDescription.InDefinedShape VALUE = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(BindingPriority.class).getDeclaredMethods().filter(ElementMatchers.named("value")).getOnly();
