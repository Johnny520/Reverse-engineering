...
public enum FieldAccess {
    ...
    public static class OfGenericField implements Defined {
        ...
        public static Defined m446of(FieldDescription fieldDescription, Defined defined) {
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.FieldAccess.Defined
        public StackManipulation read() {
            return new StackManipulation.Compound(this.defined.read(), TypeCasting.m440to(this.targetType));
        }
    ...
    public static Defined forField(FieldDescription fieldDescription) {
        ...
        return fieldDescription.getType().asErasure().equals(inDefinedShapeAsDefined.getType().asErasure()) ? forField(inDefinedShapeAsDefined) : OfGenericField.m446of(fieldDescription, forField(inDefinedShapeAsDefined));
    }
