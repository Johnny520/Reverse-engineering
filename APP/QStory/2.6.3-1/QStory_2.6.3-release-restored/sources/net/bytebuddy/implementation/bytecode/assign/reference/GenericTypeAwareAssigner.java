...
public enum GenericTypeAwareAssigner implements Assigner {
    ...
    public static class IsAssignableToVisitor implements TypeDescription.Generic.Visitor<Boolean> {
        ...
        public static abstract class OfManifestType implements TypeDescription.Generic.Visitor<Boolean> {
            ...
            public int hashCode() {
                return AbstractC3275.m5145(this.typeDescription, getClass().hashCode() * 31, 31) + (this.polymorphic ? 1 : 0);
            }
            ...
            public Boolean onTypeVariable(TypeDescription.Generic generic) {
                ...
                C6755.m11867("Assignability checks for type variables declared by methods arel not currently supported");
                return null;
            }
        ...
        public static class OfNonGenericType extends OfSimpleType {
            ...
            public Boolean onGenericArray(TypeDescription.Generic generic) {
                boolean z = this.polymorphic;
                TypeDescription.Generic generic2 = this.typeDescription;
                return Boolean.valueOf(z ? generic2.asErasure().isAssignableTo(generic.asErasure()) : generic2.asErasure().equals(generic.asErasure()));
            }
        }
        ...
        public Boolean onTypeVariable(TypeDescription.Generic generic) {
            if (generic.getTypeVariableSource().isInferrable()) {
                C6755.m11867("Assignability checks for type variables declared by methods are not currently supported");
                return null;
            }
