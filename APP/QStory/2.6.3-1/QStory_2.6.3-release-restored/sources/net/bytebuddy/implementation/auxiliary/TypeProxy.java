...
public class TypeProxy implements AuxiliaryType {
    ...
    public enum AbstractMethodErrorThrow implements StackManipulation {
        ...
        AbstractMethodErrorThrow() {
            TypeDescription typeDescriptionM289of = TypeDescription.ForLoadedType.m289of(AbstractMethodError.class);
            this.implementation = new StackManipulation.Compound(TypeCreation.m437of(typeDescriptionM289of), Duplication.SINGLE, MethodInvocation.invoke((MethodDescription) typeDescriptionM289of.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments(0))).getOnly()), Throw.INSTANCE);
        }
    ...
    public static class ForDefaultMethod extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            StackManipulation stackManipulationM437of = TypeCreation.m437of(typeDescriptionRegister);
            ...
            StackManipulation stackManipulationWrite = FieldAccess.forField((FieldDescription.InDefinedShape) typeDescriptionRegister.getDeclaredFields().filter(ElementMatchers.named(TypeProxy.INSTANCE_FIELD)).getOnly()).write();
            Duplication duplication = Duplication.SINGLE;
            return new StackManipulation.Compound(stackManipulationM437of, duplication, withImplicitInvocationTargetTypeInvoke, duplication, stackManipulationLoadThis, stackManipulationWrite).apply(methodVisitor, context);
        }
        ...
        public int hashCode() {
            return ((this.implementationTarget.hashCode() + AbstractC3275.m5144(this.proxiedType, getClass().hashCode() * 31, 31)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
    ...
    public static class ForSuperMethodByConstructor extends StackManipulation.AbstractBase {
        ...
        public ForSuperMethodByConstructor(TypeDescription typeDescription, MethodDescription.InDefinedShape inDefinedShape, Implementation.Target target, boolean z, boolean z2) {
            this.proxiedType = typeDescription;
            this.constructor = inDefinedShape;
            this.implementationTarget = target;
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            StackManipulation[] stackManipulationArr = new StackManipulation[this.constructor.getParameters().size()];
            Iterator<TypeDescription> it = this.constructor.getParameters().asTypeList().asErasures().iterator();
            int i = 0;
            while (it.hasNext()) {
                stackManipulationArr[i] = DefaultValue.m443of(it.next());
                i++;
            }
            StackManipulation stackManipulationM437of = TypeCreation.m437of(typeDescriptionRegister);
            StackManipulation.Compound compound = new StackManipulation.Compound(stackManipulationArr);
            MethodInvocation.WithImplicitInvocationTargetType withImplicitInvocationTargetTypeInvoke = MethodInvocation.invoke((MethodDescription.InDefinedShape) typeDescriptionRegister.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments(this.constructor.getParameters().asTypeList().asErasures()))).getOnly());
            StackManipulation stackManipulationLoadThis = MethodVariableAccess.loadThis();
            StackManipulation stackManipulationWrite = FieldAccess.forField((FieldDescription.InDefinedShape) typeDescriptionRegister.getDeclaredFields().filter(ElementMatchers.named(TypeProxy.INSTANCE_FIELD)).getOnly()).write();
            Duplication duplication = Duplication.SINGLE;
            return new StackManipulation.Compound(stackManipulationM437of, duplication, compound, withImplicitInvocationTargetTypeInvoke, duplication, stackManipulationLoadThis, stackManipulationWrite).apply(methodVisitor, context);
        }
        ...
        public boolean equals(@MaybeNull Object obj) {
            ...
            return this.ignoreFinalizer == forSuperMethodByConstructor.ignoreFinalizer && this.serializableProxy == forSuperMethodByConstructor.serializableProxy && this.proxiedType.equals(forSuperMethodByConstructor.proxiedType) && this.constructor.equals(forSuperMethodByConstructor.constructor) && this.implementationTarget.equals(forSuperMethodByConstructor.implementationTarget);
        }

        public int hashCode() {
            return ((((this.implementationTarget.hashCode() + AbstractC3275.m5128(this.constructor, AbstractC3275.m5144(this.proxiedType, getClass().hashCode() * 31, 31), 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
    ...
    public static class ForSuperMethodByReflectionFactory extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return ((((this.implementationTarget.hashCode() + AbstractC3275.m5144(this.proxiedType, getClass().hashCode() * 31, 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
        }
    }
        ...
        public class Appender implements ByteCodeAppender {
            ...
            public class AccessorMethodInvocation implements StackManipulation {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    return new StackManipulation.Compound(MethodVariableAccess.loadThis(), Appender.this.fieldLoadingInstruction, MethodVariableAccess.allArgumentsOf(this.instrumentedMethod).asBridgeOf(inDefinedShapeRegisterAccessorFor), MethodInvocation.invoke(inDefinedShapeRegisterAccessorFor), MethodReturn.m448of(this.instrumentedMethod.getReturnType())).apply(methodVisitor, context);
                }
                ...
                public int hashCode() {
                    return Appender.this.hashCode() + ((this.specialMethodInvocation.hashCode() + AbstractC3275.m5127(this.instrumentedMethod, getClass().hashCode() * 31, 31)) * 31);
                }
            ...
            public int hashCode() {
                return MethodCall.this.hashCode() + AbstractC3275.m5148(this.fieldLoadingInstruction, getClass().hashCode() * 31, 31);
            }
        }
    ...
    public int hashCode() {
        return ((((this.invocationFactory.hashCode() + ((this.implementationTarget.hashCode() + AbstractC3275.m5144(this.proxiedType, getClass().hashCode() * 31, 31)) * 31)) * 31) + (this.ignoreFinalizer ? 1 : 0)) * 31) + (this.serializableProxy ? 1 : 0);
    }
