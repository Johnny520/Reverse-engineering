...
public class InvokeDynamic implements Implementation.Composable {
    ...
    public class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return InvokeDynamic.this.hashCode() + AbstractC3275.m5144(this.instrumentedType, getClass().hashCode() * 31, 31);
        }
    }
    ...
    public enum TerminationHandler {
        RETURNING { // from class: net.bytebuddy.implementation.InvokeDynamic.TerminationHandler.1
            ...
            public StackManipulation resolve(MethodDescription methodDescription, TypeDescription typeDescription, Assigner assigner, Assigner.Typing typing) {
                ...
                if (stackManipulationAssign.isValid()) {
                    return new StackManipulation.Compound(stackManipulationAssign, MethodReturn.m448of(methodDescription.getReturnType()));
                }
                C6385.m11446("Cannot return ", typeDescription, " from ", methodDescription);
                return null;
            }
        },
        DROPPING { // from class: net.bytebuddy.implementation.InvokeDynamic.TerminationHandler.2
            @Override // net.bytebuddy.implementation.InvokeDynamic.TerminationHandler
            public StackManipulation resolve(MethodDescription methodDescription, TypeDescription typeDescription, Assigner assigner, Assigner.Typing typing) {
                return Removal.m432of(typeDescription);
            }
        };
    ...
    public static WithImplicitArguments lambda(MethodDescription.InDefinedShape inDefinedShape, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
        if (!typeDefinition.isInterface()) {
            C1123.m1398(typeDefinition, " is not an interface type");
            return null;
        }
        ...
        if (methodListFilter.size() != 1) {
            C6385.m11424(typeDefinition, " does not define exactly one abstract method: ", methodListFilter);
            return null;
        }
    ...
    public int hashCode() {
        return this.typing.hashCode() + AbstractC3275.m5149(this.assigner, (this.terminationHandler.hashCode() + ((this.invocationProvider.hashCode() + AbstractC0900.m720(this.arguments, AbstractC3275.m5128(this.bootstrap, getClass().hashCode() * 31, 31), 31)) * 31)) * 31, 31);
    }
    ...
    public InvokeDynamic withArgument(int... iArr) {
        ...
        for (int i : iArr) {
            if (i < 0) {
                C6755.m11869(AbstractC7012.m12147(i, "Method parameter indices cannot be negative: "));
                return null;
            }
    ...
    public InvokeDynamic withNullValue(TypeDescription... typeDescriptionArr) {
        ...
        for (TypeDescription typeDescription : typeDescriptionArr) {
            if (typeDescription.isPrimitive()) {
                C6755.m11869(AbstractC3275.m5132("Cannot assign null to primitive type: ", typeDescription));
                return null;
            }
    ...
    public InvokeDynamic withReference(Object... objArr) {
        ...
        for (Object obj : objArr) {
            arrayList.add(InvocationProvider.ArgumentProvider.ForInstance.m377of(obj));
        }
        return new InvokeDynamic(this.bootstrap, this.arguments, this.invocationProvider.appendArguments(arrayList), this.terminationHandler, this.assigner, this.typing);
    }
    ...
    public InvokeDynamic withValue(Object... objArr) {
        ArrayList arrayList = new ArrayList(objArr.length);
        for (Object obj : objArr) {
            arrayList.add(InvocationProvider.ArgumentProvider.ConstantPoolWrapper.m376of(obj));
        }
        return new InvokeDynamic(this.bootstrap, this.arguments, this.invocationProvider.appendArguments(arrayList), this.terminationHandler, this.assigner, this.typing);
    }
    ...
    public interface InvocationProvider {
        ...
        public interface Target {
            ...
            public interface Resolved {
                ...
                public static class Simple implements Resolved {
                    ...
                    public int hashCode() {
                        return this.parameterTypes.hashCode() + AbstractC3275.m5144(this.returnType, AbstractC7012.m12131(AbstractC3275.m5148(this.stackManipulation, getClass().hashCode() * 31, 31), 31, this.internalName), 31);
                    }
                }
        ...
        public interface ArgumentProvider {
            ...
            public static class ForInstance implements ArgumentProvider {
                ...
                public static ArgumentProvider m377of(Object obj) {
                    return new ForInstance(obj, TypeDescription.ForLoadedType.m289of(obj.getClass()));
                }
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    C6385.m11440(sb, " to ", this.fieldType);
                    return null;
                }
            }
            ...
            public interface Resolved {
                ...
                public static class Simple implements Resolved {
                    ...
                    public int hashCode() {
                        return this.loadedTypes.hashCode() + AbstractC3275.m5148(this.stackManipulation, getClass().hashCode() * 31, 31);
                    }
            ...
            public enum ConstantPoolWrapper {
                ...
                public class WrappingArgumentProvider implements ArgumentProvider {
                    ...
                    public int hashCode() {
                        return ConstantPoolWrapper.this.hashCode() + AbstractC3275.m5148(this.stackManipulation, getClass().hashCode() * 31, 31);
                    }
            ...
            public static class ForBooleanConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(IntegerConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Boolean.TYPE));
                }
            ...
            public static class ForByteConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(IntegerConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Byte.TYPE));
                }
            ...
            public static class ForCharacterConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(IntegerConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Character.TYPE));
                }
            ...
            public static class ForClassConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(ClassConstant.m442of(this.typeDescription), TypeDescription.ForLoadedType.m289of(Class.class));
                }
            ...
            public static class ForDoubleConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(DoubleConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Double.TYPE));
                }
            ...
            public static class ForField implements ArgumentProvider {
                ...
                public static class WithExplicitType extends ForField {
                    ...
                    public Resolved doResolve(StackManipulation stackManipulation, TypeDescription.Generic generic, Assigner assigner, Assigner.Typing typing) {
                        ...
                        StringBuilder sb = new StringBuilder("Cannot assign ");
                        sb.append(generic);
                        C6385.m11440(sb, " to ", this.typeDescription);
                        return null;
                    }
                ...
                public int hashCode() {
                    return this.fieldLocatorFactory.hashCode() + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.fieldName);
                }
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    if (!resolutionLocate.isResolved()) {
                        C1123.m1407("Cannot find a field ", this.fieldName, " for ", typeDescription);
                        return null;
                    }
                    ...
                    C1123.m1407("Cannot access non-static ", resolutionLocate.getField(), " from ", methodDescription);
                    return null;
                }
            ...
            public static class ForFloatConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(FloatConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Float.TYPE));
                }
            ...
            public static class ForIntegerConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(IntegerConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Integer.TYPE));
                }
            ...
            public static class ForJavaConstant implements ArgumentProvider {
                ...
                public ForJavaConstant(ConstantValue constantValue) {
            ...
            public static class ForLongConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(LongConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Long.TYPE));
                }
            ...
            public static class ForMethodParameter implements ArgumentProvider {
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    ...
                    int i2 = this.index;
                    if (i < size) {
                        return doResolve(MethodVariableAccess.load((ParameterDescription) parameters.get(i2)), ((ParameterDescription) parameters.get(this.index)).getType(), assigner, typing);
                    }
                    throw new IllegalStateException("No parameter " + i2 + " for " + methodDescription);
                }
            ...
            public static class ForShortConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(IntegerConstant.forValue(this.value), TypeDescription.ForLoadedType.m289of(Short.TYPE));
                }
            ...
            public static class ForStringConstant implements ArgumentProvider {
                ...
                @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider.ArgumentProvider
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    return new Resolved.Simple(new TextConstant(this.value), TypeDescription.ForLoadedType.m289of(String.class));
                }
            ...
            public static class ForThisInstance implements ArgumentProvider {
                ...
                public Resolved resolve(TypeDescription typeDescription, MethodDescription methodDescription, Assigner assigner, Assigner.Typing typing) {
                    if (methodDescription.isStatic()) {
                        C6755.m11870(AbstractC3275.m5133("Cannot get this instance from static method: ", methodDescription));
                        return null;
                    }
        ...
        public static class Default implements InvocationProvider {
            ...
            public static class Target implements Target {
                ...
                public int hashCode() {
                    return this.instrumentedMethod.hashCode() + AbstractC0900.m720(this.argumentProviders, AbstractC3275.m5144(this.returnType, AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.internalName), 31), 31);
                }
            ...
            public InvocationProvider appendArgument(ArgumentProvider argumentProvider) {
                return new Default(this.nameProvider, this.returnTypeProvider, CompoundList.m476of(this.argumentProviders, argumentProvider));
            }

            @Override // net.bytebuddy.implementation.InvokeDynamic.InvocationProvider
            public InvocationProvider appendArguments(List<ArgumentProvider> list) {
                return new Default(this.nameProvider, this.returnTypeProvider, CompoundList.m477of((List) this.argumentProviders, (List) list));
            }
    ...
    public static abstract class WithImplicitType extends AbstractDelegator {
        ...
        public static class OfArgument extends WithImplicitType {
            ...
            public InvokeDynamic mo379as(TypeDescription typeDescription) {
        ...
        public static class OfInstance extends WithImplicitType {
            ...
            public OfInstance(MethodDescription.InDefinedShape inDefinedShape, List<? extends JavaConstant> list, InvocationProvider invocationProvider, TerminationHandler terminationHandler, Assigner assigner, Assigner.Typing typing, Object obj) {
                super(inDefinedShape, list, invocationProvider, terminationHandler, assigner, typing);
                this.value = obj;
                this.argumentProvider = InvocationProvider.ArgumentProvider.ForInstance.m377of(obj);
            }
            ...
            public InvokeDynamic mo379as(TypeDescription typeDescription) {
                ...
                C3141.m4915(this.value, " is not of type ", typeDescription);
                return null;
            }
        ...
        /* JADX INFO: renamed from: as */
        public InvokeDynamic m378as(Class<?> cls) {
            return mo379as(TypeDescription.ForLoadedType.m289of(cls));
        }

        /* JADX INFO: renamed from: as */
        public abstract InvokeDynamic mo379as(TypeDescription typeDescription);
    ...
    public static class WithImplicitTarget extends WithImplicitArguments {
        ...
        public WithImplicitArguments invoke(String str, Class<?> cls) {
            return invoke(str, TypeDescription.ForLoadedType.m289of(cls));
        }

        public WithImplicitArguments invoke(Class<?> cls) {
            return invoke(TypeDescription.ForLoadedType.m289of(cls));
        }
    }
