...
public @interface Morph {
    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Morph> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m289of(Morph.class).getDeclaredMethods();
        ...
        private static MethodDescription onlyMethod(TypeDescription typeDescription) {
            ...
            C1123.m1398(methodDescription, " does not take a single argument of type Object[]");
            return null;
        }
        ...
        public static class RedirectionProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public int hashCode() {
                return AbstractC3275.m5149(this.assigner, (this.specialMethodInvocation.hashCode() + AbstractC3275.m5144(this.instrumentedType, AbstractC3275.m5144(this.morphingType, getClass().hashCode() * 31, 31), 31)) * 31, 31) + (this.serializableProxy ? 1 : 0);
            }
                ...
                public class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                        ...
                        for (TypeDescription.Generic generic : MethodCall.this.accessorMethod.getParameters().asTypeList()) {
                            ...
                            char c2 = c;
                            StackManipulation stackManipulationAssign = MethodCall.this.assigner.assign(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Object.class), generic, Assigner.Typing.DYNAMIC);
                    ...
                    public int hashCode() {
                        return MethodCall.this.hashCode() + AbstractC3275.m5144(this.typeDescription, getClass().hashCode() * 31, 31);
                    }
                }
