...
public interface Implementation extends InstrumentedType.Prepareable {
    ...
    public interface Context extends MethodAccessorFactory {
        ...
        public interface ExtractableView extends Context {
            ...
            public static abstract class AbstractBase implements ExtractableView {
                ...
                public int hashCode() {
                    return this.frameGeneration.hashCode() + ((this.classFileVersion.hashCode() + AbstractC3275.m5144(this.instrumentedType, getClass().hashCode() * 31, 31)) * 31);
                }
            }
        ...
        public enum FrameGeneration {
            ...
            public void append(MethodVisitor methodVisitor, List<? extends TypeDefinition> list, List<? extends TypeDefinition> list2) {
                Object[] objArr = EMPTY;
                generate(methodVisitor, 1, objArr.length, objArr, list.size(), toStackMapFrames(list), list.size() + list2.size(), toStackMapFrames(CompoundList.m477of((List) list2, (List) list)));
            }
        ...
        public static class Default extends ExtractableView.AbstractBase {
            ...
            public static abstract class AbstractPropertyAccessorMethod extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                public int getModifiers() {
                    return (getDeclaringType().isInterface() ? 1 : 16) | getBaseModifiers() | 4096;
                }
            }
            ...
            public FieldDescription.InDefinedShape cache(StackManipulation stackManipulation, TypeDescription typeDescription) {
                ...
                if (!this.fieldCacheCanAppendEntries) {
                    C5043.m9164(this.instrumentedType, "Cached values cannot be registered after defining the type initializer for ");
                    return null;
                }
            ...
            public static class CacheValueField extends FieldDescription.InDefinedShape.AbstractBase {
                ...
                public CacheValueField(TypeDescription typeDescription, TypeDescription.Generic generic, String str, int i) {
                    ...
                    StringBuilder sbM12144 = AbstractC7012.m12144("cachedValue$", str, "$");
                    sbM12144.append(RandomString.hashOf(i));
                    this.name = sbM12144.toString();
                }
            ...
            public static abstract class DelegationRecord extends TypeWriter.MethodPool.Record.ForDefinedMethod implements ByteCodeAppender {
                ...
                public int hashCode() {
                    return this.visibility.hashCode() + AbstractC3275.m5128(this.methodDescription, getClass().hashCode() * 31, 31);
                }
            ...
            public static class FieldGetterDelegation extends DelegationRecord {
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context context, MethodDescription methodDescription) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(this.fieldDescription.isStatic() ? StackManipulation.Trivial.INSTANCE : MethodVariableAccess.loadThis(), FieldAccess.forField(this.fieldDescription).read(), MethodReturn.m448of(this.fieldDescription.getType())).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
                }
            ...
            public static class AccessorMethodDelegation extends DelegationRecord {
                ...
                @Override // net.bytebuddy.implementation.bytecode.ByteCodeAppender
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context context, MethodDescription methodDescription) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.allArgumentsOf(methodDescription).prependThisReference(), this.accessorMethodInvocation, MethodReturn.m448of(methodDescription.getReturnType())).apply(methodVisitor, context).getMaximalSize(), methodDescription.getStackSize());
                }
        ...
        public static class Disabled extends ExtractableView.AbstractBase {
            ...
            @Override // net.bytebuddy.implementation.Implementation.Context
            public FieldDescription.InDefinedShape cache(StackManipulation stackManipulation, TypeDescription typeDescription) {
                throw new IllegalStateException(AbstractC3275.m5132("Field values caching was disabled: ", typeDescription));
            }
            ...
            public enum Factory implements Factory {
                ...
                public ExtractableView make(TypeDescription typeDescription, AuxiliaryType.NamingStrategy namingStrategy, TypeInitializer typeInitializer, ClassFileVersion classFileVersion, ClassFileVersion classFileVersion2, FrameGeneration frameGeneration) {
                    ...
                    C8376.m13333(typeInitializer, "Cannot define type initializer which was explicitly disabled: ");
                    return null;
                }
            }
        }
    ...
    public static class Simple implements Implementation {
        ...
        public static Implementation m371of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable, int i) {
            if (i >= 0) {
                return new ForDispatcher(dispatcher, prepareable, i);
            }
            C6755.m11869(AbstractC7012.m12147(i, "Additional variable length cannot be negative: "));
            return null;
        }
        ...
        /* JADX INFO: renamed from: of */
        public static Implementation m369of(Dispatcher dispatcher, int i) {
            return m371of(dispatcher, InstrumentedType.Prepareable.NoOp.INSTANCE, i);
        }

        /* JADX INFO: renamed from: of */
        public static Implementation m370of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable) {
            return m371of(dispatcher, prepareable, 0);
        }

        /* JADX INFO: renamed from: of */
        public static Implementation m368of(Dispatcher dispatcher) {
            return m369of(dispatcher, 0);
        }
    ...
    public static class Compound implements Implementation {
        ...
        public Compound(List<? extends Implementation> list) {
            ...
            for (Implementation implementation : list) {
                if (implementation instanceof Composable) {
                    ...
                    boolean z = implementation instanceof Compound;
                    List<Implementation> list2 = this.implementations;
                    if (z) {
                        list2.addAll(((Compound) implementation).implementations);
                    } else {
        ...
        public static class Composable implements Composable {
            ...
            public Implementation andThen(Implementation implementation) {
                return new Compound((List<? extends Implementation>) CompoundList.m476of(this.implementations, this.composable.andThen(implementation)));
            }
    ...
    public interface SpecialMethodInvocation extends StackManipulation {
        ...
        public static class Simple extends AbstractBase {
            ...
            /* JADX INFO: renamed from: of */
            public static SpecialMethodInvocation m372of(MethodDescription methodDescription, TypeDescription typeDescription) {
    ...
    public interface Target {
        ...
        public static abstract class AbstractBase implements Target {
            ...
            public enum DefaultMethodInvocation {
                ENABLED { // from class: net.bytebuddy.implementation.Implementation.Target.AbstractBase.DefaultMethodInvocation.1
                    ...
                    public SpecialMethodInvocation apply(MethodGraph.Node node, TypeDescription typeDescription) {
                        return node.getSort().isUnique() ? SpecialMethodInvocation.Simple.m372of(node.getRepresentative(), typeDescription) : SpecialMethodInvocation.Illegal.INSTANCE;
                    }
                },
                ...
                /* JADX INFO: renamed from: of */
                public static DefaultMethodInvocation m373of(ClassFileVersion classFileVersion) {
            ...
            public int hashCode() {
                return this.defaultMethodInvocation.hashCode() + ((this.methodGraph.hashCode() + AbstractC3275.m5144(this.instrumentedType, getClass().hashCode() * 31, 31)) * 31);
            }
