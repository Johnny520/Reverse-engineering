...
public enum MethodInvocation {
    ...
    public static class HandleInvocation extends StackManipulation.AbstractBase {
        ...
        public int hashCode() {
            return this.type.hashCode() + AbstractC3275.m5128(this.methodDescription, getClass().hashCode() * 31, 31);
        }
    }
    ...
    public static class OfGenericMethod implements WithImplicitInvocationTargetType {
        ...
        public static WithImplicitInvocationTargetType m447of(MethodDescription methodDescription, WithImplicitInvocationTargetType withImplicitInvocationTargetType) {
            return new OfGenericMethod(methodDescription.getReturnType().asErasure(), withImplicitInvocationTargetType);
        }

        @Override // net.bytebuddy.implementation.bytecode.StackManipulation
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            return new StackManipulation.Compound(this.invocation, TypeCasting.m440to(this.targetType)).apply(methodVisitor, context);
        }
        ...
        public int hashCode() {
            return this.invocation.hashCode() + AbstractC3275.m5144(this.targetType, getClass().hashCode() * 31, 31);
        }
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation onHandle(HandleType handleType) {
            return new StackManipulation.Compound(this.invocation.onHandle(handleType), TypeCasting.m440to(this.targetType));
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation special(TypeDescription typeDescription) {
            return new StackManipulation.Compound(this.invocation.special(typeDescription), TypeCasting.m440to(this.targetType));
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation virtual(TypeDescription typeDescription) {
            return new StackManipulation.Compound(this.invocation.virtual(typeDescription), TypeCasting.m440to(this.targetType));
        }
    }
    ...
    public class Invocation extends StackManipulation.AbstractBase implements WithImplicitInvocationTargetType {
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation dynamic(String str, TypeDescription typeDescription, List<? extends TypeDescription> list, List<? extends JavaConstant> list2) {
            return this.methodDescription.isInvokeBootstrap(TypeList.Explicit.m306of(list2)) ? new Invokedynamic(str, JavaConstant.MethodType.m488of(typeDescription, list), JavaConstant.MethodHandle.m481of(this.methodDescription), list2) : StackManipulation.Illegal.INSTANCE;
        }
        ...
        public int hashCode() {
            return MethodInvocation.this.hashCode() + AbstractC3275.m5128(this.methodDescription, AbstractC3275.m5144(this.typeDescription, getClass().hashCode() * 31, 31), 31);
        }
    ...
    public static WithImplicitInvocationTargetType invoke(MethodDescription methodDescription) {
        ...
        return OfGenericMethod.m447of(methodDescription, invoke(inDefinedShapeAsDefined));
    }
}
