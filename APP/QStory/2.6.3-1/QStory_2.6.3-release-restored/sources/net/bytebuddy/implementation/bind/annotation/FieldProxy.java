    ...
    public static class Binder extends TargetMethodAnnotationDrivenBinder.ParameterBinder.ForFieldBinding<FieldProxy> {
        ...
        public static class AccessorProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                ...
                return new StackManipulation.Compound(TypeCreation.m437of(typeDescriptionRegister), Duplication.SINGLE, this.fieldDescription.isStatic() ? StackManipulation.Trivial.INSTANCE : MethodVariableAccess.loadThis(), MethodInvocation.invoke((MethodDescription.InDefinedShape) typeDescriptionRegister.getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly())).apply(methodVisitor, context);
            }
            ...
            public int hashCode() {
                return AbstractC3275.m5149(this.assigner, (this.fieldResolver.hashCode() + AbstractC3275.m5144(this.instrumentedType, (this.fieldDescription.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31, 31) + (this.serializableProxy ? 1 : 0);
            }
        ...
        public interface FieldResolver {
            ...
            public interface Factory {
                ...
                public static class Duplex implements Factory {
                    ...
                    public int hashCode() {
                        return this.setterMethod.hashCode() + AbstractC3275.m5128(this.getterMethod, AbstractC3275.m5144(this.proxyType, getClass().hashCode() * 31, 31), 31);
                    }
                    ...
                    public FieldResolver resolve(TypeDescription typeDescription, FieldDescription fieldDescription) {
                        ...
                        C6755.m11870("Cannot use @FieldProxy on a non-installed type");
                        return null;
                    }
                }
                ...
                public static class Simplex implements Factory {
                    ...
                    public int hashCode() {
                        return this.setterMethod.hashCode() + AbstractC3275.m5128(this.getterMethod, getClass().hashCode() * 31, 31);
                    }
            ...
            public static class ForGetter implements FieldResolver {
                ...
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    return builder.method(ElementMatchers.definedMethod(ElementMatchers.m459is(this.getterMethod))).intercept(new FieldGetter(fieldDescription, assigner, methodAccessorFactory));
                }
            ...
            public static class ForGetterSetterPair implements FieldResolver {
                ...
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    ...
                    DynamicType.Builder.MethodDefinition.ImplementationDefinition<?> implementationDefinitionMethod = builder.method(ElementMatchers.m459is(this.getterMethod)).intercept(new FieldGetter(fieldDescription, assigner, methodAccessorFactory)).method(ElementMatchers.m459is(this.setterMethod));
            ...
            public static class ForSetter implements FieldResolver {
                ...
                @Override // net.bytebuddy.implementation.bind.annotation.FieldProxy.Binder.FieldResolver
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    return builder.method(ElementMatchers.m459is(this.setterMethod)).intercept(new FieldSetter(fieldDescription, assigner, methodAccessorFactory));
                }
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m289of(FieldProxy.class).getDeclaredMethods();
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(TypeDescription typeDescription) {
            ...
            if (!typeDescription.isPublic()) {
                C6755.m11869(AbstractC3275.m5125(typeDescription, " is not public"));
                return null;
            }
            ...
            if (methodListFilter.size() != 2) {
                C6755.m11869(AbstractC3275.m5125(typeDescription, " does not declare exactly two non-abstract methods"));
                return null;
            }
            ...
            if (methodListFilter2.size() != 1) {
                C6755.m11869(AbstractC3275.m5125(typeDescription, " does not declare a getter with an Object type"));
                return null;
            }
            ...
            C6755.m11869(AbstractC3275.m5125(typeDescription, " does not declare a setter with an Object type"));
            return null;
        }
        ...
        public static class FieldGetter implements Implementation {
            ...
            public class Appender implements ByteCodeAppender {
                ...
                public int hashCode() {
                    return FieldGetter.this.hashCode() + AbstractC3275.m5144(this.typeDescription, getClass().hashCode() * 31, 31);
                }
            }
            ...
            public int hashCode() {
                return this.methodAccessorFactory.hashCode() + AbstractC3275.m5149(this.assigner, (this.fieldDescription.hashCode() + (getClass().hashCode() * 31)) * 31, 31);
            }
        ...
        public static class FieldSetter implements Implementation {
            ...
            public class Appender implements ByteCodeAppender {
                ...
                public int hashCode() {
                    return FieldSetter.this.hashCode() + AbstractC3275.m5144(this.typeDescription, getClass().hashCode() * 31, 31);
                }
            }
        ...
        public enum StaticFieldConstructor implements Implementation {
            ...
            private final MethodDescription objectTypeDefaultConstructor = (MethodDescription) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly();
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(Class<?> cls, Class<?> cls2) {
            return install(TypeDescription.ForLoadedType.m289of(cls), TypeDescription.ForLoadedType.m289of(cls2));
        }
            ...
            if (inDefinedShapeOnlyMethod.getReturnType().asErasure().represents(Object.class)) {
                if (inDefinedShapeOnlyMethod.getParameters().size() == 0) {
                    ...
                    if (inDefinedShapeOnlyMethod2.getReturnType().asErasure().represents(Void.TYPE)) {
                        ...
                        C1123.m1398(inDefinedShapeOnlyMethod2, " must declare a single Object-typed parameters");
                        return null;
                    }
                    C1123.m1398(inDefinedShapeOnlyMethod2, " must return void");
                    return null;
                }
                C1123.m1398(inDefinedShapeOnlyMethod, " must not declare parameters");
                return null;
            }
            C1123.m1398(inDefinedShapeOnlyMethod, " must take a single Object-typed parameter");
            return null;
        }
    }
}
