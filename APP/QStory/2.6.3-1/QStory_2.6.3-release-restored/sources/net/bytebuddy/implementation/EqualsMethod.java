...
public class EqualsMethod implements Implementation {
    private static final MethodDescription.InDefinedShape EQUALS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.isEquals()).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public Appender(TypeDescription typeDescription, StackManipulation stackManipulation, List<FieldDescription.InDefinedShape> list, ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher, ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher2) {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            if (methodDescription.isStatic()) {
                C6755.m11870(AbstractC3275.m5133("Hash code method must not be static: ", methodDescription));
                return null;
            }
            ...
            if (!methodDescription.getReturnType().represents(Boolean.TYPE)) {
                C6755.m11870(AbstractC3275.m5133("Hash code method does not return primitive boolean: ", methodDescription));
                return null;
            }
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                arrayList.add(TypeCasting.m440to(this.instrumentedType));
                arrayList.add(FieldAccess.forField(inDefinedShape).read());
                if (inDefinedShape.getType().isPrimitive() || !this.identity.matches(inDefinedShape)) {
                    ...
                    arrayList.add(ValueComparator.m358of(inDefinedShape.getType()));
                    arrayList.add(usingJump.after());
                    iMax = Math.max(iMax, usingJump.getRequiredVariablePadding());
                } else {
                    arrayList.add(ConditionalReturn.onNonIdentity());
                }
            }
        ...
        public boolean equals(@MaybeNull Object obj) {
            ...
            return this.instrumentedType.equals(appender.instrumentedType) && this.baseline.equals(appender.baseline) && this.fieldDescriptions.equals(appender.fieldDescriptions) && this.nonNullable.equals(appender.nonNullable) && this.identity.equals(appender.identity);
        }

        public int hashCode() {
            return this.identity.hashCode() + AbstractC3275.m5146(this.nonNullable, AbstractC0900.m720(this.fieldDescriptions, AbstractC3275.m5148(this.baseline, AbstractC3275.m5144(this.instrumentedType, getClass().hashCode() * 31, 31), 31), 31), 31);
        }
    }
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public class AfterInstruction extends StackManipulation.AbstractBase {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    context.getFrameGeneration().same1(methodVisitor, TypeDescription.ForLoadedType.m289of(Object.class), Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m289of(Object.class)));
                    methodVisitor.visitJumpInsn(198, UsingJump.this.endOfBlock);
                    methodVisitor.visitLabel(UsingJump.this.firstValueNull);
                    context.getFrameGeneration().same(methodVisitor, Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m289of(Object.class)));
            ...
            public int hashCode() {
                return this.endOfBlock.hashCode() + ((this.secondValueNull.hashCode() + ((this.firstValueNull.hashCode() + AbstractC3275.m5127(this.instrumentedMethod, getClass().hashCode() * 31, 31)) * 31)) * 31);
            }
        }
    ...
    public enum SuperClassCheck {
        ...
        ENABLED { // from class: net.bytebuddy.implementation.EqualsMethod.SuperClassCheck.2
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                ...
                C6755.m11870(AbstractC3275.m5125(typeDescription, " does not declare a super class"));
                return null;
            }
        };
    ...
    public enum TypeCompatibilityCheck {
        ...
        SUBCLASS { // from class: net.bytebuddy.implementation.EqualsMethod.TypeCompatibilityCheck.2
            @Override // net.bytebuddy.implementation.EqualsMethod.TypeCompatibilityCheck
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(MethodVariableAccess.REFERENCE.loadFrom(1), InstanceCheck.m439of(typeDescription), ConditionalReturn.onZeroInteger());
            }
        };

        protected static final MethodDescription.InDefinedShape GET_CLASS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.named("getClass")).getOnly();
    ...
    public enum ValueComparator implements StackManipulation {
        ...
        public static StackManipulation m358of(TypeDefinition typeDefinition) {
    ...
    public EqualsMethod(SuperClassCheck superClassCheck) {
        this(superClassCheck, TypeCompatibilityCheck.EXACT, ElementMatchers.none(), ElementMatchers.none(), ElementMatchers.none(), NaturalOrderComparator.INSTANCE);
    }
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (target.getInstrumentedType().isInterface()) {
            C5043.m9164(target.getInstrumentedType(), "Cannot implement meaningful equals method for ");
            return null;
        }
        ArrayList arrayList = new ArrayList(target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo451or(this.ignored))));
        Collections.sort(arrayList, this.comparator);
        return new Appender(target.getInstrumentedType(), new StackManipulation.Compound(this.superClassCheck.resolve(target.getInstrumentedType()), MethodVariableAccess.loadThis(), MethodVariableAccess.REFERENCE.loadFrom(1), ConditionalReturn.onIdentity().returningTrue(), this.typeCompatibilityCheck.resolve(target.getInstrumentedType())), arrayList, this.nonNullable, this.identity);
    }
    ...
    public boolean equals(@MaybeNull Object obj) {
        ...
        return this.superClassCheck.equals(equalsMethod.superClassCheck) && this.typeCompatibilityCheck.equals(equalsMethod.typeCompatibilityCheck) && this.ignored.equals(equalsMethod.ignored) && this.nonNullable.equals(equalsMethod.nonNullable) && this.identity.equals(equalsMethod.identity) && this.comparator.equals(equalsMethod.comparator);
    }

    public int hashCode() {
        return this.comparator.hashCode() + ((this.identity.hashCode() + ((this.nonNullable.hashCode() + ((this.ignored.hashCode() + ((this.typeCompatibilityCheck.hashCode() + ((this.superClassCheck.hashCode() + (getClass().hashCode() * 31)) * 31)) * 31)) * 31)) * 31)) * 31);
    }
    ...
    public EqualsMethod withFieldOrder(Comparator<? super FieldDescription.InDefinedShape> comparator) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable, this.identity, new CompoundComparator((Comparator<? super FieldDescription.InDefinedShape>[]) new Comparator[]{this.comparator, comparator}));
    }

    public EqualsMethod withIdentityFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable, this.identity.mo451or(elementMatcher), this.comparator);
    }

    public EqualsMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored.mo451or(elementMatcher), this.nonNullable, this.identity, this.comparator);
    }

    public EqualsMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable.mo451or(elementMatcher), this.identity, this.comparator);
    }
    ...
    private EqualsMethod(SuperClassCheck superClassCheck, TypeCompatibilityCheck typeCompatibilityCheck, ElementMatcher.Junction<? super FieldDescription.InDefinedShape> junction, ElementMatcher.Junction<? super FieldDescription.InDefinedShape> junction2, ElementMatcher.Junction<? super FieldDescription.InDefinedShape> junction3, Comparator<? super FieldDescription.InDefinedShape> comparator) {
