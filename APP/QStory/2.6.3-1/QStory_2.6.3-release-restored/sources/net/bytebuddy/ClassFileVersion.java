...
public class ClassFileVersion implements Comparable<ClassFileVersion>, Serializable {
    ...
    public static ClassFileVersion m160of(TypeDescription typeDescription, ClassFileLocator classFileLocator) {
    ...
    public static ClassFileVersion ofClassFile(byte[] bArr) {
        ...
        C6755.m11869(AbstractC0900.m707(new StringBuilder("Supplied byte array is too short to be a class file with "), " byte", bArr.length));
        return null;
    }

    public static ClassFileVersion ofJavaVersion(int i) {
        if (i < 1) {
            C6755.m11869(AbstractC7012.m12147(i, "Java version must be positive: "));
            return null;
        }
        int i2 = i - 1;
    ...
    public static ClassFileVersion ofJavaVersionString(String str) {
        ...
        try {
            ...
            C9620.m15032("Failed to read Java version from: ".concat(str), e);
            return null;
        }
    }
    ...
    public static ClassFileVersion ofMinorMajor(int i) {
        ...
        C6755.m11869(AbstractC0900.m722(i, "Class version ", " is not valid"));
        return null;
    }
    ...
    public short getMajorVersion() {
        return (short) (this.versionNumber & com.android.p002dx.p005io.Opcodes.MAX_VALUE);
    }
    ...
    /* JADX INFO: renamed from: of */
    public static ClassFileVersion m159of(Class<?> cls, ClassFileLocator classFileLocator) {
        return m160of(TypeDescription.ForLoadedType.m289of(cls), classFileLocator);
    }

    /* JADX INFO: renamed from: of */
    public static ClassFileVersion m158of(Class<?> cls) {
        return m159of(cls, ClassFileLocator.ForClassLoader.m309of(cls.getClassLoader()));
    }
}
