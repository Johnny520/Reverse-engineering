...
public class HasSuperClassMatcher<T extends TypeDescription> extends ElementMatcher.Junction.ForNonNullValues<T> {
    ...
    public boolean doMatch(T t) {
        if (t.isInterface()) {
            return this.matcher.matches(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Object.class));
        }
    ...
    public String toString() {
        return AbstractC3275.m5134(new StringBuilder("hasSuperClass("), this.matcher, ")");
    }
}
