...
public class RepeatedAnnotationPlugin extends Plugin.ForElementMatcher implements Plugin.Factory {
    private static final MethodDescription.InDefinedShape VALUE = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Enhance.class).getDeclaredMethods().filter(ElementMatchers.named("value")).getOnly();
    ...
    public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        ...
        if (!typeDescription2.isAnnotation()) {
            C6385.m11442(typeDescription2, "Expected ", " to be an annotation type");
            return null;
        }
        ...
        C6385.m11442(typeDescription2, "Expected ", " to declare exactly one property named value of an array type");
        return null;
    }
