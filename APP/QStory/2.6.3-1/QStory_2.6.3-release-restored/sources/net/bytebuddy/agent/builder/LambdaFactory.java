...
public class LambdaFactory {
    ...
    private byte[] invoke(Object obj, String str, Object obj2, Object obj3, Object obj4, Object obj5, boolean z, List<Class<?>> list, List<?> list2, Collection<ClassFileTransformer> collection) {
        try {
            ...
            C9620.m15032("Cannot create class for lambda expression", e2);
            return null;
        }
    }
    ...
    public static boolean register(ClassFileTransformer classFileTransformer, Object obj) {
        boolean zIsEmpty;
        try {
            TypeDescription typeDescriptionM289of = TypeDescription.ForLoadedType.m289of(LambdaFactory.class);
            Class<?> cls = ClassInjector.UsingReflection.ofSystemClassLoader().inject(Collections.singletonMap(typeDescriptionM289of, ClassFileLocator.ForClassLoader.read((Class<?>) LambdaFactory.class))).get(typeDescriptionM289of);
            ...
            C9620.m15032("Could not register class file transformer", e2);
            return false;
        }
    }
    ...
    public static boolean release(ClassFileTransformer classFileTransformer) {
        ...
        try {
            ...
            C9620.m15032("Could not release class file transformer", e2);
            return false;
        }
    }
