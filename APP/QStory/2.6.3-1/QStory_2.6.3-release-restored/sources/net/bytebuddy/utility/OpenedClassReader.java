...
public class OpenedClassReader implements AsmClassReader.Factory {
    ...
    public static ClassReader m495of(byte[] bArr, boolean z) {
    ...
    public AsmClassReader make(byte[] bArr) {
        return new AsmClassReader.ForAsm(m494of(bArr));
    }

    @Override // net.bytebuddy.utility.AsmClassReader.Factory
    public AsmClassReader make(byte[] bArr, boolean z) {
        return new AsmClassReader.ForAsm(m495of(bArr, z));
    }

    /* JADX INFO: renamed from: of */
    public static ClassReader m494of(byte[] bArr) {
        return m495of(bArr, EXPERIMENTAL);
    }
}
