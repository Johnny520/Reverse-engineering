...
public class JavaModule implements NamedElement.WithOptionalName, AnnotationSource {
    ...
    static {
        ...
        UNSUPPORTED = null;
        RESOLVER = (Resolver) doPrivileged(JavaDispatcher.m496of(Resolver.class));
    ...
    public static JavaModule m493of(Object obj) {
    ...
    public ModuleDescription toDescription() {
        return ModuleDescription.ForLoadedModule.m285of(this.module);
    }
