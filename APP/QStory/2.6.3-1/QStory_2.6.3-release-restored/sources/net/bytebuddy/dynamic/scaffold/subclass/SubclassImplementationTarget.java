...
public class SubclassImplementationTarget extends Implementation.Target.AbstractBase {
    ...
    public enum Factory implements Implementation.Target.Factory {
        ...
        public Implementation.Target make(TypeDescription typeDescription, MethodGraph.Linked linked, ClassFileVersion classFileVersion) {
            return new SubclassImplementationTarget(typeDescription, linked, Implementation.Target.AbstractBase.DefaultMethodInvocation.m373of(classFileVersion), this.originTypeResolver);
        }
    }
    ...
    private Implementation.SpecialMethodInvocation invokeConstructor(MethodDescription.SignatureToken signatureToken) {
        ...
        return empty.size() == 1 ? Implementation.SpecialMethodInvocation.Simple.m372of((MethodDescription) empty.getOnly(), superClass.asErasure()) : Implementation.SpecialMethodInvocation.Illegal.INSTANCE;
    }
    ...
    private Implementation.SpecialMethodInvocation invokeMethod(MethodDescription.SignatureToken signatureToken) {
        ...
        return nodeLocate.getSort().isUnique() ? Implementation.SpecialMethodInvocation.Simple.m372of(nodeLocate.getRepresentative(), this.instrumentedType.getSuperClass().asErasure()) : Implementation.SpecialMethodInvocation.Illegal.INSTANCE;
    }
