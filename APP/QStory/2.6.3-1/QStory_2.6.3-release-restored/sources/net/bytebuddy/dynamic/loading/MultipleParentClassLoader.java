...
public class MultipleParentClassLoader extends InjectionClassLoader {
    ...
    public static class Builder {
        ...
        public ClassLoader build(ClassLoader classLoader) {
            return (this.classLoaders.isEmpty() || (this.classLoaders.size() == 1 && this.classLoaders.contains(classLoader))) ? classLoader : filter(ElementMatchers.not(ElementMatchers.m452is(classLoader))).doBuild(classLoader);
        }
