...
public interface ConstructorStrategy {
    ...
    public static class ForDefaultConstructor implements ConstructorStrategy {
        ...
        public List<MethodDescription.Token> extractConstructors(TypeDescription typeDescription) {
            ...
            if (superClass == null) {
                C6755.m11869(AbstractC3275.m5132("Cannot extract constructors for ", typeDescription));
                return null;
            }
            ...
            C6755.m11870("Cannot define default constructor for class without super class constructor");
            return null;
        }

        public int hashCode() {
            return this.methodAttributeAppenderFactory.hashCode() + AbstractC3275.m5146(this.elementMatcher, getClass().hashCode() * 31, 31);
        }
        ...
        public MethodRegistry inject(TypeDescription typeDescription, MethodRegistry methodRegistry) {
            TypeDescription.Generic superClass = typeDescription.getSuperClass();
            if (superClass == null) {
                C6755.m11869(AbstractC3275.m5132("Cannot inject constructors for ", typeDescription));
                return null;
            }
            ...
            if (methodListFilter.isEmpty()) {
                C8376.m13333(superClass, "No possible candidate for super constructor invocation in ");
                return null;
            }
            if (!methodListFilter.filter(ElementMatchers.takesArguments(0)).isEmpty()) {
                ...
                C8376.m13333(methodListFilter, "More than one possible super constructor for constructor delegation: ");
                return null;
            }
    ...
    public enum Default implements ConstructorStrategy {
        ...
        DEFAULT_CONSTRUCTOR { // from class: net.bytebuddy.dynamic.scaffold.subclass.ConstructorStrategy.Default.2
            ...
            public List<MethodDescription.Token> doExtractConstructors(TypeDescription typeDescription) {
                ...
                C3141.m4915(typeDescription.getSuperClass(), " declares no constructor that is visible to ", typeDescription);
                return null;
            }
        ...
        IMITATE_SUPER_CLASS { // from class: net.bytebuddy.dynamic.scaffold.subclass.ConstructorStrategy.Default.3
            ...
            public List<MethodDescription.Token> doExtractConstructors(TypeDescription typeDescription) {
                TypeDescription.Generic superClass = typeDescription.getSuperClass();
                return (superClass == null ? new MethodList.Empty() : superClass.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.isVisibleTo(typeDescription)))).asTokenList(ElementMatchers.m452is(typeDescription));
            }
        ...
        IMITATE_SUPER_CLASS_PUBLIC { // from class: net.bytebuddy.dynamic.scaffold.subclass.ConstructorStrategy.Default.4
            ...
            public List<MethodDescription.Token> doExtractConstructors(TypeDescription typeDescription) {
                TypeDescription.Generic superClass = typeDescription.getSuperClass();
                return (superClass == null ? new MethodList.Empty() : superClass.getDeclaredMethods().filter(ElementMatchers.isPublic().and(ElementMatchers.isConstructor()))).asTokenList(ElementMatchers.m452is(typeDescription));
            }
