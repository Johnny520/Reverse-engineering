...
public class ModuleLayerFromSingleClassLoaderDecorator implements ClassLoaderDecorator {
    ...
    public static abstract class AbstractModuleFinder {
        ...
        public Object doFind(String str) {
            return str.equals(this.name) ? ModuleLayerFromSingleClassLoaderDecorator.OPTIONAL.m336of(this.moduleReference) : ModuleLayerFromSingleClassLoaderDecorator.OPTIONAL.empty();
        }
    ...
    public interface ModuleFinder {
        ...
        Object m335of(@JavaDispatcher.Proxied("java.nio.file.Path") Object[] objArr);
    }
    ...
    static {
        ...
        MODULE_FINDER = (ModuleFinder) doPrivileged(JavaDispatcher.m496of(ModuleFinder.class));
        MODULE_DESCRIPTOR = (ModuleDescriptor) doPrivileged(JavaDispatcher.m496of(ModuleDescriptor.class));
        MODULE_LAYER = (ModuleLayer) doPrivileged(JavaDispatcher.m496of(ModuleLayer.class));
        MODULE_LAYER_CONTROLLER = (ModuleLayerController) doPrivileged(JavaDispatcher.m496of(ModuleLayerController.class));
        CONFIGURATION = (Configuration) doPrivileged(JavaDispatcher.m496of(Configuration.class));
        OPTIONAL = (Optional) doPrivileged(JavaDispatcher.m496of(Optional.class));
        STREAM = (Stream) doPrivileged(JavaDispatcher.m496of(Stream.class));
        PATH = (Path) doPrivileged(JavaDispatcher.m496of(Path.class));
        SIMPLE_MODULE_REFERENCE = (SimpleModuleReference) doPrivileged(JavaDispatcher.m497of(SimpleModuleReference.class, (ClassLoader) doPrivileged(SimpleModuleReference.CreationAction.INSTANCE)));
        SIMPLE_MODULE_FINDER = (SimpleModuleFinder) doPrivileged(JavaDispatcher.m497of(SimpleModuleFinder.class, (ClassLoader) doPrivileged(SimpleModuleFinder.CreationAction.INSTANCE)));
    }
    ...
    */
    public boolean equals(@MaybeNull Object obj) {
        ...
        ModuleLayerFromSingleClassLoaderDecorator moduleLayerFromSingleClassLoaderDecorator = (ModuleLayerFromSingleClassLoaderDecorator) obj;
        if (!this.name.equals(moduleLayerFromSingleClassLoaderDecorator.name)) {
            return false;
        }
        ClassLoader classLoader = this.classLoader;
        ClassLoader classLoader2 = moduleLayerFromSingleClassLoaderDecorator.classLoader;
        if (classLoader2 != null) {
            if (classLoader == null || !classLoader.equals(classLoader2)) {
                return false;
            }
            return this.moduleLayer.equals(moduleLayerFromSingleClassLoaderDecorator.moduleLayer) && this.packages.equals(moduleLayerFromSingleClassLoaderDecorator.packages);
        }
    }
    ...
    public int hashCode() {
        ...
        return this.packages.hashCode() + AbstractC7012.m12131((this.moduleLayer.hashCode() + (iHashCode * 31)) * 31, 31, this.name);
    }
    ...
    public static abstract class AbstractModuleReader implements Closeable {
        ...
        public Object doFind(String str) {
            if (str.endsWith(ClassFileLocator.CLASS_FILE_EXTENSION)) {
                if (this.types.get(str.substring(0, str.length() - 6).replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH)) != null) {
                    return ModuleLayerFromSingleClassLoaderDecorator.OPTIONAL.m336of(URI.create("bytebuddy://".concat(str)));
                }
            }
        ...
        public Object doOpen(String str) {
            if (str.endsWith(ClassFileLocator.CLASS_FILE_EXTENSION)) {
                ...
                if (bArr != null) {
                    return ModuleLayerFromSingleClassLoaderDecorator.OPTIONAL.m336of(new ByteArrayInputStream(bArr));
                }
            }
            return ModuleLayerFromSingleClassLoaderDecorator.OPTIONAL.empty();
        }
