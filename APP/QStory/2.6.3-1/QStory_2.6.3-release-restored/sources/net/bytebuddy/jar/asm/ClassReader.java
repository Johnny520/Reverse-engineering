  ...
  0x0054: PHI (r8v3 int) = (r8v0 int), (r8v1 int), (r8v4 int) binds: [B:12:0x0044, B:22:0x0060, B:18:0x0053] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public ClassReader(byte[] bArr, int i, boolean z) {
        ...
        if (z) {
            int i2 = i + 6;
            if (readShort(i2) > 70) {
                C6755.m11869(stringConcat$0(readShort(i2)));
                throw null;
            }
        }
    ...
    */
    private void readCode(MethodVisitor methodVisitor, Context context, int i) {
        ...
        int i25 = classReader2.readInt(i + 4);
        int i26 = i + 8;
        if (i25 > classReader2.classFileBuffer.length - i26) {
            C6755.m11865();
            return;
        }
        int i27 = i26 + i25;
        Label[] labelArr3 = new Label[i25 + 1];
        context.currentMethodLabels = labelArr3;
        int i28 = i26;
        while (i28 < i27) {
            int i29 = i28 - i26;
            switch (bArr2[i28] & DefaultClassResolver.NAME) {
                case 0:
                case 1:
                case 2:
                case 3:
                ...
                case 170:
                    ...
                    int i31 = (classReader2.readInt(i30 + 8) - classReader2.readInt(i30 + 4)) + 1;
                    i24 = i30 + 12;
                    while (true) {
                        int i32 = i31 - 1;
                        if (i31 <= 0) {
                            ...
                            classReader2.createLabel(classReader2.readInt(i24) + i29, labelArr3);
                            i24 += 4;
                            i31 = i32;
                        }
                        break;
                ...
                case 171:
                    int i33 = (4 - (i29 & 3)) + i28;
                    classReader2.createLabel(classReader2.readInt(i33) + i29, labelArr3);
                    int i34 = classReader2.readInt(i33 + 4);
                    i24 = i33 + 8;
                    while (true) {
                        int i35 = i34 - 1;
                        if (i34 <= 0) {
                            ...
                            classReader2.createLabel(classReader2.readInt(i24 + 4) + i29, labelArr3);
                            i24 += 8;
                            i34 = i35;
                        }
                        break;
                ...
                case 186:
                    ...
                    break;
                case 196:
                    int i36 = bArr2[i28 + 1] & DefaultClassResolver.NAME;
                    if (i36 != 132) {
                        if (i36 != 169) {
                            switch (i36) {
                                default:
                ...
                case 200:
                case 201:
                case com.android.p002dx.p005io.Opcodes.REM_INT_LIT8 /* 220 */:
                    classReader2.createLabel(classReader2.readInt(i28 + 1) + i29, labelArr3);
                    i28 += 5;
                    break;
                case com.android.p002dx.p005io.Opcodes.REM_FLOAT_2ADDR /* 202 */:
                case com.android.p002dx.p005io.Opcodes.ADD_DOUBLE_2ADDR /* 203 */:
                case com.android.p002dx.p005io.Opcodes.SUB_DOUBLE_2ADDR /* 204 */:
                case com.android.p002dx.p005io.Opcodes.MUL_DOUBLE_2ADDR /* 205 */:
                case com.android.p002dx.p005io.Opcodes.DIV_DOUBLE_2ADDR /* 206 */:
                case com.android.p002dx.p005io.Opcodes.REM_DOUBLE_2ADDR /* 207 */:
                case com.android.p002dx.p005io.Opcodes.ADD_INT_LIT16 /* 208 */:
                case com.android.p002dx.p005io.Opcodes.RSUB_INT /* 209 */:
                case com.android.p002dx.p005io.Opcodes.MUL_INT_LIT16 /* 210 */:
                case com.android.p002dx.p005io.Opcodes.DIV_INT_LIT16 /* 211 */:
                case com.android.p002dx.p005io.Opcodes.REM_INT_LIT16 /* 212 */:
                case com.android.p002dx.p005io.Opcodes.AND_INT_LIT16 /* 213 */:
                case com.android.p002dx.p005io.Opcodes.OR_INT_LIT16 /* 214 */:
                case com.android.p002dx.p005io.Opcodes.XOR_INT_LIT16 /* 215 */:
                case com.android.p002dx.p005io.Opcodes.ADD_INT_LIT8 /* 216 */:
                case com.android.p002dx.p005io.Opcodes.RSUB_INT_LIT8 /* 217 */:
                case com.android.p002dx.p005io.Opcodes.MUL_INT_LIT8 /* 218 */:
                case com.android.p002dx.p005io.Opcodes.DIV_INT_LIT8 /* 219 */:
        ...
        byte b3 = 8;
        int unsignedShort4 = classReader2.readUnsignedShort(i28);
        int i37 = i28 + 2;
        while (true) {
            int i38 = unsignedShort4 - 1;
            if (unsignedShort4 > 0) {
                Label labelCreateLabel = classReader2.createLabel(classReader2.readUnsignedShort(i37), labelArr3);
                Label labelCreateLabel2 = classReader2.createLabel(classReader2.readUnsignedShort(i37 + 2), labelArr3);
                Label labelCreateLabel3 = classReader2.createLabel(classReader2.readUnsignedShort(i37 + 4), labelArr3);
                String utf82 = classReader2.readUTF8(classReader2.cpInfoOffsets[classReader2.readUnsignedShort(i37 + 6)], cArr2);
                i37 += 8;
                methodVisitor3.visitTryCatchBlock(labelCreateLabel, labelCreateLabel2, labelCreateLabel3, utf82);
                unsignedShort4 = i38;
            } else {
                int unsignedShort5 = classReader2.readUnsignedShort(i37);
                int i39 = i37 + 2;
                int[] iArr5 = null;
                int i40 = 0;
                ...
                while (true) {
                    ...
                    if (unsignedShort5 <= 0) {
                        ...
                        if (i40 != 0) {
                            ...
                            while (true) {
                                i2 = i41;
                                if (i45 < i2 - 2) {
                                    if (bArr2[i45] != b4 || (unsignedShort = classReader3.readUnsignedShort(i45 + 1)) < 0 || unsignedShort >= i25) {
                                        i23 = i45;
                                        b = b4;
                                    } else {
                                        b = b4;
                                        i23 = i45;
                                        if ((bArr2[i26 + unsignedShort] & DefaultClassResolver.NAME) == 187) {
                        ...
                        int i46 = (context.parsingOptions & 256) == 0 ? 33 : 0;
                        int i47 = i40;
                        int i48 = typeAnnotationBytecodeOffset2;
                        int stackMapFrame = i47;
                        int i49 = i26;
                        int i50 = typeAnnotationBytecodeOffset3;
                        boolean z10 = false;
                        int i51 = 0;
                        int i52 = 0;
                        while (i49 < i27) {
                            int i53 = i49;
                            int i54 = i53 - i26;
                            classReader3.readBytecodeInstructionOffset(i54);
                            int[] iArr9 = iArr7;
                            Label label = labelArr[i54];
                            int i55 = i3;
                            if (label != null) {
                                label.accept(methodVisitor2, (context.parsingOptions & 2) == 0 ? z8 : false);
                            }
                            while (stackMapFrame != 0) {
                                int i56 = context.currentFrameOffset;
                                if (i56 != i54 && i56 != -1) {
                                    int[] iArr10 = iArr8;
                                    int i57 = i26;
                                    boolean z11 = z7;
                                    int i58 = i27;
                                    int[] iArr11 = iArr9;
                                    int i59 = unsignedShort2;
                                    int i60 = stackMapFrame;
                                    if (z10) {
                                        methodVisitor2 = methodVisitor;
                                        z2 = z10;
                                    } else {
                                    ...
                                    i8 = bArr[i53] & DefaultClassResolver.NAME;
                                    switch (i8) {
                                        case 0:
                                        case 1:
                                        case 2:
                                        ...
                                        case 195:
                                            ...
                                            i10 = i53 + 1;
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null && i11 < iArr11.length && typeAnnotationBytecodeOffset <= i54) {
                                                if (typeAnnotationBytecodeOffset != i54) {
                                            ...
                                            int i61 = i10;
                                            int i62 = i52;
                                            int typeAnnotationBytecodeOffset4 = i50;
                                            while (iArr10 != null) {
                                                iArr2 = iArr10;
                                                if (i62 >= iArr2.length || typeAnnotationBytecodeOffset4 > i54) {
                                                    i12 = i62;
                                                    i13 = typeAnnotationBytecodeOffset;
                                                    i14 = i60;
                                                    i5 = i9;
                                                    i50 = typeAnnotationBytecodeOffset4;
                                                    iArr8 = iArr2;
                                                    iArr7 = iArr11;
                                                    i49 = i61;
                                                    i27 = i58;
                                                    ...
                                                    if (typeAnnotationBytecodeOffset4 == i54) {
                                                        int typeAnnotationTarget2 = classReader3.readTypeAnnotationTarget(context, iArr2[i62]);
                                                        i15 = i62;
                                                    ...
                                                    i62 = i15 + 1;
                                                    typeAnnotationBytecodeOffset4 = classReader3.getTypeAnnotationBytecodeOffset(iArr2, i62);
                                                    iArr10 = iArr2;
                                        ...
                                        case 188:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitIntInsn(i8, bArr[i53 + 1]);
                                            i10 = i53 + 2;
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            ...
                                            int i612 = i10;
                                            int i622 = i52;
                                            int typeAnnotationBytecodeOffset42 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612;
                                            i27 = i58;
                                        ...
                                        case 17:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitIntInsn(i8, classReader3.readShort(i53 + 1));
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            ...
                                            int i6122 = i10;
                                            int i6222 = i52;
                                            int typeAnnotationBytecodeOffset422 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122;
                                            i27 = i58;
                                        ...
                                        case 18:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitLdcInsn(classReader3.readConst(bArr[i53 + 1] & DefaultClassResolver.NAME, cArr));
                                            i10 = i53 + 2;
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            ...
                                            int i61222 = i10;
                                            int i62222 = i52;
                                            int typeAnnotationBytecodeOffset4222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222;
                                            i27 = i58;
                                        ...
                                        case 20:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitLdcInsn(classReader3.readConst(classReader3.readUnsignedShort(i53 + 1), cArr));
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            ...
                                            int i612222 = i10;
                                            int i622222 = i52;
                                            int typeAnnotationBytecodeOffset42222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222;
                                            i27 = i58;
                                        ...
                                        case 169:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitVarInsn(i8, bArr[i53 + 1] & DefaultClassResolver.NAME);
                                            i10 = i53 + 2;
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            ...
                                            int i6122222 = i10;
                                            int i6222222 = i52;
                                            int typeAnnotationBytecodeOffset422222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122222;
                                            i27 = i58;
                                        ...
                                        case 45:
                                            ...
                                            int i61222222 = i10;
                                            int i62222222 = i52;
                                            int typeAnnotationBytecodeOffset4222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222222;
                                            i27 = i58;
                                        ...
                                        case 78:
                                            ...
                                            int i612222222 = i10;
                                            int i622222222 = i52;
                                            int typeAnnotationBytecodeOffset42222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222222;
                                            i27 = i58;
                                        ...
                                        case 132:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitIincInsn(bArr[i53 + 1] & DefaultClassResolver.NAME, bArr[i53 + 2]);
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            ...
                                            int i6122222222 = i10;
                                            int i6222222222 = i52;
                                            int typeAnnotationBytecodeOffset422222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122222222;
                                            i27 = i58;
                                        ...
                                        case 199:
                                            i9 = i5;
                                            z3 = z;
                                            methodVisitor2.visitJumpInsn(i8, labelArr[classReader3.readShort(i53 + 1) + i54]);
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            }
                                            int i61222222222 = i10;
                                            int i62222222222 = i52;
                                            int typeAnnotationBytecodeOffset4222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222222222;
                                            i27 = i58;
                                        ...
                                        case 170:
                                            ...
                                            z3 = z;
                                            int i65 = (4 - (i54 & 3)) + i53;
                                            Label label2 = labelArr[classReader3.readInt(i65) + i54];
                                            int i66 = classReader3.readInt(i65 + 4);
                                            int i67 = classReader3.readInt(i65 + 8);
                                            i10 = i65 + 12;
                                            int i68 = (i67 - i66) + 1;
                                            Label[] labelArr5 = new Label[i68];
                                            for (int i69 = 0; i69 < i68; i69++) {
                                                labelArr5[i69] = labelArr[classReader3.readInt(i10) + i54];
                                                i10 += 4;
                                            }
                                            methodVisitor2.visitTableSwitchInsn(i66, i67, label2, labelArr5);
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            }
                                            int i612222222222 = i10;
                                            int i622222222222 = i52;
                                            int typeAnnotationBytecodeOffset42222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222222222;
                                            i27 = i58;
                                        ...
                                        case 171:
                                            ...
                                            z3 = z;
                                            int i70 = (4 - (i54 & 3)) + i53;
                                            Label label3 = labelArr[classReader3.readInt(i70) + i54];
                                            int i71 = classReader3.readInt(i70 + 4);
                                            i10 = i70 + 8;
                                            int[] iArr12 = new int[i71];
                                            Label[] labelArr6 = new Label[i71];
                                            for (int i72 = 0; i72 < i71; i72++) {
                                                iArr12[i72] = classReader3.readInt(i10);
                                                labelArr6[i72] = labelArr[classReader3.readInt(i10 + 4) + i54];
                                                i10 += 8;
                                            }
                                            ...
                                            int i6122222222222 = i10;
                                            int i6222222222222 = i52;
                                            int typeAnnotationBytecodeOffset422222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122222222222;
                                            i27 = i58;
                                        ...
                                        case 185:
                                            i9 = i5;
                                            z3 = z;
                                            int i73 = classReader3.cpInfoOffsets[classReader3.readUnsignedShort(i53 + 1)];
                                            int i74 = classReader3.cpInfoOffsets[classReader3.readUnsignedShort(i73 + 2)];
                                            String str2 = classReader3.readClass(i73, cArr);
                                            String utf83 = classReader3.readUTF8(i74, cArr);
                                            String utf84 = classReader3.readUTF8(i74 + 2, cArr);
                                            if (i8 < 182) {
                                                methodVisitor2.visitFieldInsn(i8, str2, utf83, utf84);
                                            } else {
                                                if (bArr[i73 - 1] == 11) {
                                                    str = utf84;
                                                    z4 = z8;
                                                ...
                                                methodVisitor2.visitMethodInsn(i8, str2, utf83, str, z4);
                                            }
                                            i10 = i8 == 185 ? i53 + 5 : i53 + 3;
                                            typeAnnotationBytecodeOffset = i48;
                                            i11 = i51;
                                            z10 = z2;
                                            while (iArr11 != null) {
                                            }
                                            int i61222222222222 = i10;
                                            int i62222222222222 = i52;
                                            int typeAnnotationBytecodeOffset4222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222222222222;
                                            i27 = i58;
                                            ...
                                            break;
                                        case 186:
                                            int i75 = classReader3.cpInfoOffsets[classReader3.readUnsignedShort(i53 + 1)];
                                            int i76 = classReader3.cpInfoOffsets[classReader3.readUnsignedShort(i75 + 2)];
                                            String utf85 = classReader3.readUTF8(i76, cArr);
                                            String utf86 = classReader3.readUTF8(i76 + 2, cArr);
                                            int i77 = classReader3.bootstrapMethodOffsets[classReader3.readUnsignedShort(i75)];
                                            Handle handle = (Handle) classReader3.readConst(classReader3.readUnsignedShort(i77), cArr);
                                            int unsignedShort6 = classReader3.readUnsignedShort(i77 + 2);
                                            Object[] objArr = new Object[unsignedShort6];
                                            z3 = z;
                                            int i78 = i77 + 4;
                                            i9 = i5;
                                            int i79 = 0;
                                            while (i79 < unsignedShort6) {
                                                objArr[i79] = classReader3.readConst(classReader3.readUnsignedShort(i78), cArr);
                                                i78 += 2;
                                                i79++;
                                                unsignedShort6 = unsignedShort6;
                                            }
                                            ...
                                            int i612222222222222 = i10;
                                            int i622222222222222 = i52;
                                            int typeAnnotationBytecodeOffset42222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            ...
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                        ...
                                        case 193:
                                            c = 132;
                                            methodVisitor2.visitTypeInsn(i8, classReader3.readClass(i53 + 1, cArr));
                                            i10 = i53 + 3;
                                            i9 = i5;
                                            z3 = z;
                                            typeAnnotationBytecodeOffset = i48;
                                            ...
                                            int i6122222222222222 = i10;
                                            int i6222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset422222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                            ...
                                            break;
                                        case 196:
                                            int i80 = bArr[i53 + 1] & DefaultClassResolver.NAME;
                                            c = 132;
                                            if (i80 == 132) {
                                                methodVisitor2.visitIincInsn(classReader3.readUnsignedShort(i53 + 2), classReader3.readShort(i53 + 4));
                                                i10 = i53 + 6;
                                            } else {
                                                methodVisitor2.visitVarInsn(i80, classReader3.readUnsignedShort(i53 + 2));
                                                i10 = i53 + 4;
                                            }
                                            i9 = i5;
                                            z3 = z;
                                            ...
                                            int i61222222222222222 = i10;
                                            int i62222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset4222222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                            ...
                                            break;
                                        case 197:
                                            methodVisitor2.visitMultiANewArrayInsn(classReader3.readClass(i53 + 1, cArr), bArr[i53 + 3] & DefaultClassResolver.NAME);
                                            i10 = i53 + 4;
                                            i9 = i5;
                                            z3 = z;
                                            typeAnnotationBytecodeOffset = i48;
                                            ...
                                            int i612222222222222222 = i10;
                                            int i622222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset42222222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                        ...
                                        case 200:
                                        case 201:
                                            methodVisitor2.visitJumpInsn(i8 - i46, labelArr[classReader3.readInt(i53 + 1) + i54]);
                                            i10 = i53 + 5;
                                            i9 = i5;
                                            z3 = z;
                                            typeAnnotationBytecodeOffset = i48;
                                            ...
                                            int i6122222222222222222 = i10;
                                            int i6222222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset422222222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i6222222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset422222222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i6122222222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                        ...
                                        case com.android.p002dx.p005io.Opcodes.MUL_INT_LIT8 /* 218 */:
                                        case com.android.p002dx.p005io.Opcodes.DIV_INT_LIT8 /* 219 */:
                                            int i81 = i8 < 218 ? i8 - 49 : i8 - 20;
                                            Label label4 = labelArr[classReader3.readUnsignedShort(i53 + 1) + i54];
                                            if (i81 == 167 || i81 == 168) {
                                                methodVisitor2.visitJumpInsn(i81 + 33, label4);
                                                z5 = z2;
                                            } else {
                                                methodVisitor2.visitJumpInsn(i81 < 167 ? ((i81 + 1) ^ 1) - 1 : i81 ^ 1, classReader3.createLabel(i54 + 3, labelArr));
                                            ...
                                            int i61222222222222222222 = i10;
                                            int i62222222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset4222222222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i62222222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset4222222222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i61222222222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                                            ...
                                            break;
                                        case com.android.p002dx.p005io.Opcodes.REM_INT_LIT8 /* 220 */:
                                            methodVisitor2.visitJumpInsn(200, labelArr[classReader3.readInt(i53 + 1) + i54]);
                                            i10 = i53 + 5;
                                            i9 = i5;
                                            z3 = z;
                                            typeAnnotationBytecodeOffset = i48;
                                            ...
                                            int i612222222222222222222 = i10;
                                            int i622222222222222222222 = i52;
                                            int typeAnnotationBytecodeOffset42222222222222222222 = i50;
                                            while (iArr10 != null) {
                                            }
                                            i12 = i622222222222222222222;
                                            i13 = typeAnnotationBytecodeOffset;
                                            i14 = i60;
                                            iArr2 = iArr10;
                                            i5 = i9;
                                            i50 = typeAnnotationBytecodeOffset42222222222222222222;
                                            iArr8 = iArr2;
                                            iArr7 = iArr11;
                                            i49 = i612222222222222222222;
                                            i27 = i58;
                                            i48 = i13;
                                            unsignedShort2 = i59;
                                            i3 = i55;
                            ...
                            int i582 = i27;
                            int[] iArr112 = iArr9;
                            int i592 = unsignedShort2;
                            int i602 = stackMapFrame;
                            if (z10) {
                            }
                            i8 = bArr[i53] & DefaultClassResolver.NAME;
                            switch (i8) {
                        ...
                        if (i85 != 0 && (context.parsingOptions & 2) == 0) {
                            ...
                            while (true) {
                                ...
                                if (unsignedShort8 > 0) {
                                    ...
                                    int i90 = i88 + 10;
                                    if (iArr != null) {
                                        for (int i91 = i84; i91 < iArr.length; i91 += 3) {
                                            if (iArr[i91] == unsignedShort9 && iArr[i91 + 1] == unsignedShort11) {
                        ...
                        if (iArr13 != null) {
                            ...
                            while (i94 < length) {
                                ...
                                if (i96 == 64 || i96 == i92) {
                                    int typeAnnotationTarget3 = classReader4.readTypeAnnotationTarget(context, i95);
                                    i6 = i94;
                        ...
                        if (iArr14 != null) {
                            ...
                            while (i97 < length2) {
                                ...
                                if (i99 == i93 || i99 == 65) {
                                    int typeAnnotationTarget4 = classReader4.readTypeAnnotationTarget(context, i98);
                    ...
                    String utf89 = classReader2.readUTF8(i39, cArr2);
                    int i100 = classReader2.readInt(i39 + 2);
                    int i101 = i39 + 6;
                    if (AttLocalVariableTable.ATTRIBUTE_NAME.equals(utf89)) {
                        if ((context.parsingOptions & 2) == 0) {
                            ...
                            while (true) {
                                ...
                                if (unsignedShort12 > 0) {
                                    ...
                                    classReader2.createDebugLabel(unsignedShort13, labelArr3);
                                    int i104 = i102;
                                    classReader2.createDebugLabel(classReader2.readUnsignedShort(i104 + 2) + unsignedShort13, labelArr3);
                                    i102 = i104 + 10;
                        ...
                        if ("RuntimeVisibleTypeAnnotations".equals(utf89)) {
                            ...
                            typeAnnotations = iArr5;
                            b2 = b3;
                            Attribute attribute6 = classReader2.readAttribute(context.attributePrototypes, utf89, i101, i100, cArr2, i, labelArr3);
                            classReader = classReader2;
                            labelArr2 = labelArr3;
                        ...
                        while (true) {
                            ...
                            if (unsignedShort14 > 0) {
                                ...
                                classReader2.createDebugLabel(unsignedShort15, labelArr3);
                                labelArr3[unsignedShort15].addLineNumber(unsignedShort16);
    ...
    */
    private int[] readTypeAnnotations(MethodVisitor methodVisitor, Context context, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < unsignedShort; i3++) {
            ...
            if (i5 == 66) {
                ...
                int iM12133 = AbstractC7012.m12133(i7, 2, 1, i2);
                elementValues = readElementValues(methodVisitor.visitTryCatchAnnotation(i4 & (-256), typePath, readUTF8(iM12133, cArr), z), iM12133 + 2, true, cArr);
            } else {
                elementValues = readElementValues(null, AbstractC7012.m12133(i7, 2, 3, i2), true, cArr);
            }
        }
        return iArr;
    }
    ...
    private static /* synthetic */ String stringConcat$0(short s) {
        return AbstractC7012.m12147(s, "Unsupported class file major version ");
    }

    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0900.m696(str, ClassFileLocator.CLASS_FILE_EXTENSION);
    }
