...
public final class Type {
    ...
    private static Type getTypeInternal(String str, int i, int i2) {
        ...
        switch (cCharAt) {
            ...
            case 'D':
                return DOUBLE_TYPE;
            default:
                C6755.m11869(stringConcat$0(str));
                return null;
        }
    }
    ...
    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0900.m718("L", str, ";");
    }
    ...
    public String getDescriptor() {
        ...
        return i == 12 ? stringConcat$1(str.substring(this.valueBegin, this.valueEnd)) : str.substring(this.valueBegin, this.valueEnd);
    }
