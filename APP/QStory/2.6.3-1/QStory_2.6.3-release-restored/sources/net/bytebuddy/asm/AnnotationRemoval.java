...
public class AnnotationRemoval extends AsmVisitorWrapper.AbstractBase {
    ...
    public int hashCode() {
        return AbstractC3275.m5146(this.annotationMatcher, AbstractC3275.m5146(this.methodMatcher, AbstractC3275.m5146(this.fieldMatcher, ((getClass().hashCode() * 31) + (this.type ? 1 : 0)) * 31, 31), 31), 31) + this.parameters;
    }
