    ...
    public static class ForField extends MemberAttributeExtension<FieldAttributeAppender.Factory> implements AsmVisitorWrapper.ForDeclaredFields.FieldVisitorWrapper {
        ...
        public static class FieldAttributeVisitor extends FieldVisitor {
            ...
            public void visitEnd() {
                this.fieldAttributeAppender.apply(this.f321fv, this.fieldDescription, this.annotationValueFilter);
                super.visitEnd();
            }
        }
        ...
        public AsmVisitorWrapper m222on(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        ...
        public FieldVisitor wrap(TypeDescription typeDescription, FieldDescription.InDefinedShape inDefinedShape, FieldVisitor fieldVisitor) {
            return new FieldAttributeVisitor(fieldVisitor, inDefinedShape, ((FieldAttributeAppender.Factory) this.attributeAppenderFactory).make(typeDescription), this.annotationValueFilterFactory.mo418on(inDefinedShape));
        }
    ...
    public static class ForMethod extends MemberAttributeExtension<MethodAttributeAppender.Factory> implements AsmVisitorWrapper.ForDeclaredMethods.MethodVisitorWrapper {
        ...
        public static class AttributeAppendingMethodVisitor extends MethodVisitor {
            ...
            public void visitCode() {
                if (this.applicable) {
                    this.methodAttributeAppender.apply(this.f322mv, this.methodDescription, this.annotationValueFilter);
        ...
        public ForMethod annotateParameter(int i, Collection<? extends AnnotationDescription> collection) {
            ...
            C6755.m11869(AbstractC7012.m12147(i, "Parameter index cannot be negative: "));
            return null;
        }
        ...
        /* JADX INFO: renamed from: on */
        public AsmVisitorWrapper m223on(ElementMatcher<? super MethodDescription> elementMatcher) {
        ...
        public MethodVisitor wrap(TypeDescription typeDescription, MethodDescription methodDescription, MethodVisitor methodVisitor, Implementation.Context context, TypePool typePool, int i, int i2) {
            return new AttributeAppendingMethodVisitor(methodVisitor, methodDescription, ((MethodAttributeAppender.Factory) this.attributeAppenderFactory).make(typeDescription), this.annotationValueFilterFactory.mo419on(methodDescription));
        }
