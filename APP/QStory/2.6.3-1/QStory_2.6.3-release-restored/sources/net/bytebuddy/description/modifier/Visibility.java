...
public enum Visibility implements ModifierContributor.ForType, ModifierContributor.ForMethod, ModifierContributor.ForField {
    ...
    /* JADX INFO: renamed from: net.bytebuddy.description.modifier.Visibility$1 */
    /* JADX INFO: compiled from: r8-map-id-447c03deab370cabd87f71de7ff996ccc1a6dc9764ce389c731d875d052048e4 */
    public static /* synthetic */ class C05661 {
    ...
    public Visibility expandTo(Visibility visibility) {
        int i = C05661.$SwitchMap$net$bytebuddy$description$modifier$Visibility[visibility.ordinal()];
        if (i == 1) {
            return PUBLIC;
        }
        if (i == 2) {
        ...
        C8376.m13333(visibility, "Unexpected visibility: ");
        return null;
    }
