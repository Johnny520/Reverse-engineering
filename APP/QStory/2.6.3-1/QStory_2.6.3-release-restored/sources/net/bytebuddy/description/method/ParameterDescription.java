...
public interface ParameterDescription extends AnnotationSource, NamedElement.WithRuntimeName, NamedElement.WithOptionalName, ModifierReviewable.ForParameterDescription, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static abstract class ForLoadedParameter<T extends AccessibleObject> extends InDefinedShape.AbstractBase {
        ...
        public static class OfConstructor extends ForLoadedParameter<Constructor<?>> {
            ...
            public TypeDescription.Generic getType() {
                ...
                T t = this.executable;
                return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(((Constructor) t).getParameterTypes()[this.index]) : new TypeDescription.Generic.LazyProjection.OfConstructorParameter((Constructor) t, this.index, ((Constructor) t).getParameterTypes());
            }
        }
        ...
        public static class OfLegacyVmConstructor extends InDefinedShape.AbstractBase {
            ...
            @Override // net.bytebuddy.description.method.ParameterDescription
            public TypeDescription.Generic getType() {
                return TypeDescription.AbstractBase.RAW_TYPES ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(this.parameterType[this.index]) : new TypeDescription.Generic.LazyProjection.OfConstructorParameter(this.constructor, this.index, this.parameterType);
            }
        ...
        public static class OfLegacyVmMethod extends InDefinedShape.AbstractBase {
            ...
            @Override // net.bytebuddy.description.method.ParameterDescription
            public TypeDescription.Generic getType() {
                return TypeDescription.AbstractBase.RAW_TYPES ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(this.parameterType[this.index]) : new TypeDescription.Generic.LazyProjection.OfMethodParameter(this.method, this.index, this.parameterType);
            }
        ...
        public static class OfMethod extends ForLoadedParameter<Method> {
            ...
            public TypeDescription.Generic getType() {
                boolean z = TypeDescription.AbstractBase.RAW_TYPES;
                T t = this.executable;
                return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(((Method) t).getParameterTypes()[this.index]) : new TypeDescription.Generic.LazyProjection.OfMethodParameter((Method) t, this.index, ((Method) t).getParameterTypes());
            }
        }
        ...
        static {
            ...
            PARAMETER = (Parameter) doPrivileged(JavaDispatcher.m496of(Parameter.class));
        }
        ...
        public int getModifiers() {
            try {
                ...
                if (e.getClass().getName().equals(MALFORMED_PARAMETERS_EXCEPTION)) {
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        @Override // net.bytebuddy.description.method.ParameterDescription
        public TypeDescription.Generic getType() {
            return (TypeDescription.Generic) this.parameterType.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m301of(this));
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public boolean equals(@MaybeNull Object obj) {
            ...
            if (this.type.equals(token.type) && this.annotations.equals(token.annotations)) {
                String str = this.name;
                String str2 = token.name;
                if (str == null ? str2 == null : str.equals(str2)) {
                    Integer num = this.modifiers;
                    Integer num2 = token.modifiers;
