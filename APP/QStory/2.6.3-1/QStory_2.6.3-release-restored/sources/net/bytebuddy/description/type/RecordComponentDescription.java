...
public interface RecordComponentDescription extends DeclaredByType.WithMandatoryDeclaration, NamedElement.WithDescriptor, AnnotationSource, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class ForLoadedRecordComponent extends InDefinedShape.AbstractBase {
        ...
        static {
            ...
            RECORD_COMPONENT = (RecordComponent) doPrivileged(JavaDispatcher.m496of(RecordComponent.class));
        }
        ...
        public static RecordComponentDescription m286of(Object obj) {
            if (RECORD_COMPONENT.isInstance(obj)) {
                return new ForLoadedRecordComponent((AnnotatedElement) obj);
            }
            C6755.m11869(AbstractC0900.m713(obj, "Not a record component: "));
            return null;
        }
        ...
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m289of(RECORD_COMPONENT.getDeclaringRecord(this.recordComponent));
        }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        @Override // net.bytebuddy.description.type.RecordComponentDescription
        public TypeDescription.Generic getType() {
            return (TypeDescription.Generic) this.type.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m302of(this));
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                iM5145 = AbstractC3275.m5145(this.type, this.name.hashCode() * 31, 31) + this.annotations.hashCode();
            }
            if (iM5145 == 0) {
                return this.hashCode;
            }
            this.hashCode = iM5145;
            return iM5145;
        }
