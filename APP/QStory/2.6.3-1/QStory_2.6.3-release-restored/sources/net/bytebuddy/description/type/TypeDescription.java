...
import net.bytebuddy.utility.TypeComparator;
...
public interface TypeDescription extends TypeDefinition, ByteCodeElement, TypeVariableSource {
    ...
    @Deprecated
    public static final TypeDescription OBJECT = LazyProxy.m305of(Object.class);

    @Deprecated
    public static final TypeDescription STRING = LazyProxy.m305of(String.class);

    @Deprecated
    public static final TypeDescription CLASS = LazyProxy.m305of(Class.class);

    @Deprecated
    public static final TypeDescription THROWABLE = LazyProxy.m305of(Throwable.class);

    @Deprecated
    public static final TypeDescription VOID = LazyProxy.m305of(Void.TYPE);
    ...
    public interface Generic extends TypeDefinition, AnnotationSource {
        ...
        @Deprecated
        public static final Generic OBJECT = LazyProxy.m295of(Object.class);

        @Deprecated
        public static final Generic CLASS = LazyProxy.m295of(Class.class);

        @Deprecated
        public static final Generic VOID = LazyProxy.m295of(Void.TYPE);

        @Deprecated
        public static final Generic ANNOTATION = LazyProxy.m295of(Annotation.class);
        ...
        public static class LazyProxy implements InvocationHandler {
            ...
            public static Generic m295of(Class<?> cls) {
            ...
            public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) throws Throwable {
                try {
                    return method.invoke(OfNonGenericType.ForLoadedType.m296of(this.type), objArr);
        ...
        public interface Visitor<T> {
            ...
            public static class ForSignatureVisitor implements Visitor<SignatureVisitor> {
                ...
                public SignatureVisitor onNonGenericType(Generic generic) {
                    if (generic.isArray()) {
                        ...
                        boolean zIsPrimitive = generic.isPrimitive();
                        SignatureVisitor signatureVisitor = this.signatureVisitor;
                        if (zIsPrimitive) {
                            signatureVisitor.visitBaseType(generic.asErasure().getDescriptor().charAt(0));
                        } else {
                            signatureVisitor.visitClassType(generic.asErasure().getInternalName());
            ...
            public enum Generalizing implements Visitor<Generic> {
                ...
                public Generic onGenericArray(Generic generic) {
                    ...
                    do {
                        i++;
                        generic = generic.getComponentType();
                    } while (generic.isArray());
                    return ArrayProjection.m288of(ForLoadedType.m289of(Object.class), i).asGenericType();
                }
                ...
                public Generic onNonGenericType(Generic generic) {
                    ...
                    return componentType.isPrimitive() ? generic : ArrayProjection.m288of(ForLoadedType.m289of(Object.class), i).asGenericType();
                }

                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Visitor
                public Generic onParameterizedType(Generic generic) {
                    return ForLoadedType.m289of(Object.class).asGenericType();
                }
                    ...
                    public static class ForParameterizedType extends AbstractBase {
                        ...
                        public Boolean onParameterizedType(Generic generic) {
                            ...
                            if (typeArguments.size() != typeArguments2.size()) {
                                StringBuilder sb = new StringBuilder("Incompatible generic types: ");
                                sb.append(generic);
                                C6385.m11435(sb, " and ", this.parameterizedType);
                                return null;
                            }
            ...
            public static abstract class Substitutor implements Visitor<Generic> {
                ...
                public static class ForDetachment extends Substitutor {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static Visitor<Generic> m304of(TypeDefinition typeDefinition) {
                        return new ForDetachment(ElementMatchers.m452is(typeDefinition));
                    }
                ...
                public static class ForTypeVariableBinding extends WithoutTypeSubstitution {
                    ...
                    public class TypeVariableSubstitutor implements TypeVariableSource.Visitor<Generic> {
                        ...
                        public int hashCode() {
                            return ForTypeVariableBinding.this.hashCode() + AbstractC3275.m5145(this.typeVariable, getClass().hashCode() * 31, 31);
                        }
                ...
                public Generic onParameterizedType(Generic generic) {
                    ...
                    if (AbstractBase.RAW_TYPES) {
                        ...
                        arrayList = new ArrayList(generic.getTypeArguments().size());
                        Iterator<Generic> it = generic.getTypeArguments().iterator();
                        while (it.hasNext()) {
                ...
                public static class ForAttachment extends Substitutor {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m299of(FieldDescription fieldDescription) {
                    ...
                    public int hashCode() {
                        return this.typeVariableSource.hashCode() + AbstractC3275.m5144(this.declaringType, getClass().hashCode() * 31, 31);
                    }
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m303of(TypeDescription typeDescription) {
                        return new ForAttachment(typeDescription, (TypeVariableSource) typeDescription);
                    }

                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m300of(MethodDescription methodDescription) {
                        return new ForAttachment(methodDescription.getDeclaringType(), methodDescription);
                    }

                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m301of(ParameterDescription parameterDescription) {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static ForAttachment m302of(RecordComponentDescription recordComponentDescription) {
            ...
            public static class Reducing implements Visitor<TypeDescription> {
                ...
                public int hashCode() {
                    return this.typeVariableTokens.hashCode() + AbstractC3275.m5144(this.declaringType, getClass().hashCode() * 31, 31);
                }
                ...
                public TypeDescription onGenericArray(Generic generic) {
                    ...
                    for (TypeVariableToken typeVariableToken : this.typeVariableTokens) {
                        if (componentType.getSymbol().equals(typeVariableToken.getSymbol())) {
                            return ArrayProjection.m288of((TypeDescription) typeVariableToken.getBounds().get(0).accept(this), i);
                        }
                    }
                    return TargetType.resolve(ArrayProjection.m288of(this.declaringType.findExpectedVariable(componentType.getSymbol()).asErasure(), i), this.declaringType);
                }
        ...
        public static abstract class OfGenericArray extends AbstractBase {
            ...
            public TypeDescription asErasure() {
                return ArrayProjection.m288of(getComponentType().asErasure(), 1);
            }
            ...
            public Generic getSuperClass() {
                return OfNonGenericType.ForLoadedType.m296of(Object.class);
            }
        ...
        public static abstract class Builder {
            ...
            /* JADX INFO: renamed from: of */
            public static Builder m290of(Type type) {
                return m291of(TypeDefinition.Sort.describe(type));
            }
            ...
            public static Builder parameterizedType(TypeDescription typeDescription, @MaybeNull Generic generic, Collection<? extends TypeDefinition> collection) {
                ...
                if (!typeDescription.represents(TargetType.class)) {
                    if (!typeDescription.isGenerified()) {
                        C6755.m11869(AbstractC3275.m5125(typeDescription, " is not a parameterized type"));
                        return null;
                    }
                    if (generic == null && declaringType != null && !typeDescription.isStatic()) {
                        C6755.m11869(AbstractC3275.m5125(typeDescription, " requires an owner type"));
                        return null;
                    }
                    if (generic != null && !generic.asErasure().equals(declaringType)) {
                        C6385.m11424(generic, " does not represent required owner for ", typeDescription);
                        return null;
                    }
                    if (generic != null && (typeDescription.isStatic() ^ generic.getSort().isNonGeneric())) {
                        C6385.m11424(generic, " does not define the correct parameters for owning ", typeDescription);
                        return null;
                    }
                    if (typeDescription.getTypeVariables().size() != collection.size()) {
                        C6385.m11424(collection, " does not contain number of required parameters for ", typeDescription);
                        return null;
                    }
                }
            ...
            public static Builder rawType(TypeDescription typeDescription, @MaybeNull Generic generic) {
                ...
                if (declaringType == null && generic != null) {
                    C6385.m11424(typeDescription, " does not have a declaring type: ", generic);
                    return null;
                }
                ...
                C6385.m11424(generic, " is not the declaring type of ", typeDescription);
                return null;
            }
            ...
            public Builder asArray(int i) {
                if (i < 1) {
                    C6755.m11869(AbstractC7012.m12147(i, "Cannot define an array of a non-positive arity: "));
                    return null;
                }
            ...
            public static class OfGenericArrayType extends Builder {
                ...
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfGenericArrayType(this.componentType, CompoundList.m477of((List) this.annotations, (List) list));
                }
            ...
            public static class OfTypeVariable extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfTypeVariable(this.symbol, CompoundList.m477of((List) this.annotations, (List) list));
                }
            ...
            public static class OfParameterizedType extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfParameterizedType(this.rawType, this.ownerType, this.parameterTypes, CompoundList.m477of((List) this.annotations, (List) list));
                }
                ...
                */
                public boolean equals(@MaybeNull Object obj) {
                    ...
                    Generic generic2 = ofParameterizedType.ownerType;
                    if (generic2 != null) {
                        if (generic == null || !generic.equals(generic2)) {
                            return false;
                        }
                        return this.parameterTypes.equals(ofParameterizedType.parameterTypes);
                    }
                }

                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iM5144 = AbstractC3275.m5144(this.rawType, super.hashCode() * 31, 31);
                    Generic generic = this.ownerType;
                    if (generic != null) {
                        iM5144 += generic.hashCode();
                    }
                    return this.parameterTypes.hashCode() + (iM5144 * 31);
                }
            ...
            /* JADX INFO: renamed from: of */
            public static Builder m291of(Generic generic) {
            ...
            public static class OfNonGenericType extends Builder {
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public Builder doAnnotate(List<? extends AnnotationDescription> list) {
                    return new OfNonGenericType(this.typeDescription, this.ownerType, CompoundList.m477of((List) this.annotations, (List) list));
                }
                ...
                public Generic doBuild() {
                    ...
                    C6755.m11869("The void non-type cannot be annotated");
                    return null;
                }
                ...
                */
                ...
                @Override // net.bytebuddy.description.type.TypeDescription.Generic.Builder
                public int hashCode() {
                    int iM5144 = AbstractC3275.m5144(this.typeDescription, super.hashCode() * 31, 31);
                    Generic generic = this.ownerType;
                    return generic != null ? generic.hashCode() + iM5144 : iM5144;
                }
            ...
            public static Builder rawType(Class<?> cls, @MaybeNull Generic generic) {
                return rawType(ForLoadedType.m289of(cls), generic);
            }

            public static Builder rawType(Class<?> cls) {
                return rawType(ForLoadedType.m289of(cls));
            }
            ...
            public static Builder parameterizedType(Class<?> cls, @MaybeNull Type type, List<? extends Type> list) {
                return parameterizedType(ForLoadedType.m289of(cls), type == null ? null : TypeDefinition.Sort.describe(type), new TypeList.Generic.ForLoadedTypes(list));
            }
        ...
        public static abstract class OfNonGenericType extends AbstractBase {
            ...
            public static class ForReifiedErasure extends OfNonGenericType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m297of(TypeDescription typeDescription) {
                ...
                public Generic getComponentType() {
                    TypeDescription componentType = this.typeDescription.getComponentType();
                    return componentType == null ? Generic.UNDEFINED : m297of(componentType);
                }
                ...
                public Generic getOwnerType() {
                    TypeDescription declaringType = this.typeDescription.getDeclaringType();
                    return declaringType == null ? Generic.UNDEFINED : m297of(declaringType);
                }
            ...
            public static class ForLoadedType extends OfNonGenericType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m296of(Class<?> cls) {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(this.type);
                }
        ...
        public static abstract class OfParameterizedType extends AbstractBase {
            ...
            public static class ForGenerifiedErasure extends OfParameterizedType {
                ...
                /* JADX INFO: renamed from: of */
                public static Generic m298of(TypeDescription typeDescription) {
                ...
                public Generic getOwnerType() {
                    TypeDescription declaringType = this.typeDescription.getDeclaringType();
                    return declaringType == null ? Generic.UNDEFINED : m298of(declaringType);
                }
            ...
            /* JADX WARN: Type inference failed for: r5v1, types: [net.bytebuddy.description.type.TypeDefinition, net.bytebuddy.description.type.TypeDescription$Generic] */
            /* JADX WARN: Type inference failed for: r5v2, types: [net.bytebuddy.description.type.TypeDefinition, net.bytebuddy.description.type.TypeDescription$Generic] */
            @Override // net.bytebuddy.description.type.TypeDescription.Generic
            @MaybeNull
            public Generic findBindingOf(Generic generic) {
                do {
            ...
            public static class ForLoadedType extends OfParameterizedType {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of((Class) this.parameterizedType.getRawType());
                }
        ...
        public static abstract class OfTypeVariable extends AbstractBase {
            ...
            public TypeDescription asErasure() {
                ...
                return upperBounds.isEmpty() ? ForLoadedType.m289of(Object.class) : upperBounds.get(0).asErasure();
            }
            ...
            public static class ForLoadedType extends OfTypeVariable {
                ...
                public TypeVariableSource getTypeVariableSource() {
                    ...
                    if (genericDeclaration instanceof Class) {
                        return ForLoadedType.m289of((Class) genericDeclaration);
                    }
                    ...
                    C8376.m13333(genericDeclaration, "Unknown declaration: ");
                    return null;
                }
        ...
        public static abstract class OfWildcardType extends AbstractBase {
            ...
            public static class Latent extends OfWildcardType {
                ...
                public static Generic boundedBelow(Generic generic, AnnotationSource annotationSource) {
                    return new Latent(Collections.singletonList(OfNonGenericType.ForLoadedType.m296of(Object.class)), Collections.singletonList(generic), annotationSource);
                }

                public static Generic unbounded(AnnotationSource annotationSource) {
                    return new Latent(Collections.singletonList(OfNonGenericType.ForLoadedType.m296of(Object.class)), Collections.EMPTY_LIST, annotationSource);
                }
            ...
            public String toString() {
                ...
                if (lowerBounds.isEmpty()) {
                    ...
                    if (lowerBounds.getOnly().equals(OfNonGenericType.ForLoadedType.m296of(Object.class))) {
                        return SYMBOL;
                    }
                    sb.append(" extends ");
                } else {
        ...
        public static abstract class LazyProjection extends AbstractBase {
            ...
            public static class ForLoadedFieldType extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(this.field.getType());
                }
            ...
            public static class ForLoadedReturnType extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(this.method.getReturnType());
                }
            ...
            public static class ForLoadedSuperClass extends WithLazyNavigation.OfAnnotatedElement {
                ...
                @MaybeNull
                /* JADX INFO: renamed from: of */
                public static Generic m292of(Class<?> cls) {
                    return cls.getSuperclass() == null ? Generic.UNDEFINED : new ForLoadedSuperClass(cls);
                }

                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(this.type.getSuperclass());
                }
            ...
            public static class OfConstructorParameter extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(this.erasure[this.index]);
                }
                ...
                public Generic resolve() {
                    ...
                    if (this.delegate != null) {
                        ...
                        int i = this.index;
                        genericDescribeOrNull = length == length2 ? TypeDefinition.Sort.describeOrNull(genericParameterTypes[i], getAnnotationReader()) : OfNonGenericType.ForLoadedType.m296of(clsArr[i]);
                    }
                    if (genericDescribeOrNull == null) {
                        return this.delegate;
                    }
                    this.delegate = genericDescribeOrNull;
                    return genericDescribeOrNull;
                }
            }
            ...
            public static class OfRecordComponent extends WithEagerNavigation.OfAnnotatedElement {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeDescription asErasure() {
                    return ForLoadedType.m289of(RecordComponentDescription.ForLoadedRecordComponent.RECORD_COMPONENT.getType(this.recordComponent));
                }
            ...
            public static abstract class WithLazyNavigation extends LazyProjection {
                ...
                public static class LazyInterfaceList extends TypeList.Generic.AbstractBase {
                    ...
                    /* JADX INFO: renamed from: of */
                    public static TypeList.Generic m293of(LazyProjection lazyProjection) {
                ...
                public static class LazySuperClass extends WithLazyNavigation {
                    ...
                    @MaybeNull
                    /* JADX INFO: renamed from: of */
                    public static Generic m294of(LazyProjection lazyProjection) {
                ...
                @Override // net.bytebuddy.description.type.TypeDefinition
                public TypeList.Generic getInterfaces() {
                    return LazyInterfaceList.m293of((LazyProjection) this);
                }

                @Override // net.bytebuddy.description.type.TypeDefinition
                @MaybeNull
                public Generic getSuperClass() {
                    return LazySuperClass.m294of(this);
                }
        ...
        public interface AnnotationReader {
            ...
            public static abstract class Delegator implements AnnotationReader {
                ...
                public static class ForLoadedExecutableExceptionType extends Delegator {
                    protected static final Dispatcher DISPATCHER = (Dispatcher) Delegator.doPrivileged(JavaDispatcher.m496of(Dispatcher.class));
                ...
                public static class ForLoadedInterface extends Delegator {
                    ...
                    public int hashCode() {
                        return AbstractC3275.m5129(getClass().hashCode() * 31, 31, this.type) + this.index;
                    }
                ...
                public static class ForLoadedTypeVariable extends Delegator {
                    ...
                    /* JADX WARN: Type inference failed for: r1v1, types: [java.lang.reflect.AnnotatedElement, java.lang.reflect.TypeVariable<?>] */
                    @Override // net.bytebuddy.description.type.TypeDescription.Generic.AnnotationReader
                    public AnnotatedElement resolve() {
                        ?? r1 = this.typeVariable;
                        return r1 instanceof AnnotatedElement ? r1 : NoOp.INSTANCE;
                    }
                }
            ...
            public static class ForOwnerType extends Delegator.Chained {
                private static final AnnotatedType ANNOTATED_TYPE = (AnnotatedType) Delegator.doPrivileged(JavaDispatcher.m496of(AnnotatedType.class));
            ...
            public static class ForComponentType extends Delegator.Chained {
                private static final AnnotatedParameterizedType ANNOTATED_PARAMETERIZED_TYPE = (AnnotatedParameterizedType) Delegator.doPrivileged(JavaDispatcher.m496of(AnnotatedParameterizedType.class));
            ...
            public static class ForTypeVariableBoundType extends Delegator.Chained {
                private static final AnnotatedTypeVariable ANNOTATED_TYPE_VARIABLE = (AnnotatedTypeVariable) Delegator.doPrivileged(JavaDispatcher.m496of(AnnotatedTypeVariable.class));
                private final int index;
                ...
                public static class OfFormalTypeVariable extends Delegator {
                    private static final FormalTypeVariable TYPE_VARIABLE = (FormalTypeVariable) Delegator.doPrivileged(JavaDispatcher.m496of(FormalTypeVariable.class));
                    private final int index;
                    private final TypeVariable<?> typeVariable;
            ...
            public static class ForWildcardLowerBoundType extends Delegator.Chained {
                private static final AnnotatedWildcardType ANNOTATED_WILDCARD_TYPE = (AnnotatedWildcardType) Delegator.doPrivileged(JavaDispatcher.m496of(AnnotatedWildcardType.class));
                private final int index;
    ...
    public static class LazyProxy implements InvocationHandler {
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m305of(Class<?> cls) {
        ...
        public Object invoke(Object obj, Method method, @MaybeNull Object[] objArr) throws Throwable {
            try {
                return method.invoke(ForLoadedType.m289of(this.type), objArr);
            } catch (InvocationTargetException e) {
                throw e.getTargetException();
            }
        }
    ...
    public static abstract class AbstractBase extends TypeVariableSource.AbstractBase implements TypeDescription {
        ...
        public TypeDescription asBoxed() {
            return represents(Boolean.TYPE) ? ForLoadedType.m289of(Boolean.class) : represents(Byte.TYPE) ? ForLoadedType.m289of(Byte.class) : represents(Short.TYPE) ? ForLoadedType.m289of(Short.class) : represents(Character.TYPE) ? ForLoadedType.m289of(Character.class) : represents(Integer.TYPE) ? ForLoadedType.m289of(Integer.class) : represents(Long.TYPE) ? ForLoadedType.m289of(Long.class) : represents(Float.TYPE) ? ForLoadedType.m289of(Float.class) : represents(Double.TYPE) ? ForLoadedType.m289of(Double.class) : this;
        }
        ...
        public TypeDescription asUnboxed() {
            return represents(Boolean.class) ? ForLoadedType.m289of(Boolean.TYPE) : represents(Byte.class) ? ForLoadedType.m289of(Byte.TYPE) : represents(Short.class) ? ForLoadedType.m289of(Short.TYPE) : represents(Character.class) ? ForLoadedType.m289of(Character.TYPE) : represents(Integer.class) ? ForLoadedType.m289of(Integer.TYPE) : represents(Long.class) ? ForLoadedType.m289of(Long.TYPE) : represents(Float.class) ? ForLoadedType.m289of(Float.TYPE) : represents(Double.class) ? ForLoadedType.m289of(Double.TYPE) : this;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r3v0, types: [net.bytebuddy.description.NamedElement$WithRuntimeName, net.bytebuddy.description.type.TypeDefinition, net.bytebuddy.description.type.TypeDescription$AbstractBase] */
        /* JADX WARN: Type inference failed for: r3v2, types: [net.bytebuddy.description.type.TypeDescription] */
        /* JADX WARN: Type inference failed for: r3v3, types: [net.bytebuddy.description.NamedElement, net.bytebuddy.description.type.TypeDefinition, net.bytebuddy.description.type.TypeDescription] */
        @Override // net.bytebuddy.description.NamedElement
        public String getActualName() {
            if (!isArray()) {
                return getName();
        ...
        public String getGenericSignature() {
            try {
                ...
                if (superClass == null) {
                    superClass = Generic.OfNonGenericType.ForLoadedType.m296of(Object.class);
                }
                ...
                return z2 ? signatureWriter.toString() : NamedElement.WithDescriptor.NON_GENERIC_SIGNATURE;
        ...
        public AnnotationList getInheritedAnnotations() {
            ...
            return new AnnotationList.Explicit((List<? extends AnnotationDescription>) CompoundList.m477of((List) declaredAnnotations, (List) superClass.asErasure().getInheritedAnnotations().inherited(hashSet)));
        }
        ...
        public boolean isAssignableFrom(Class<?> cls) {
            return isAssignableFrom(ForLoadedType.m289of(cls));
        }

        @Override // net.bytebuddy.description.type.TypeDescription
        public boolean isAssignableTo(Class<?> cls) {
            return isAssignableTo(ForLoadedType.m289of(cls));
        }
        ...
        public static abstract class OfSimpleType extends AbstractBase {
            ...
            */
            public String getSimpleName() {
                ...
                iLastIndexOf = internalName.lastIndexOf(47);
                if (iLastIndexOf == -1) {
                    return internalName;
                }
                if (iLastIndexOf < internalName.length()) {
        ...
        public boolean isNestMateOf(Class<?> cls) {
            return isNestMateOf(ForLoadedType.m289of(cls));
        }
    ...
    public static class ArrayProjection extends AbstractBase {
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m288of(TypeDescription typeDescription, int i) {
            if (i < 0) {
                C6755.m11869("Arrays cannot have a negative arity");
                return null;
            }
        ...
        public TypeDescription getComponentType() {
            int i = this.arity;
            TypeDescription typeDescription = this.componentType;
        ...
        public String getName() {
            ...
            for (int i2 = 0; i2 < descriptor.length(); i2++) {
                char cCharAt = descriptor.charAt(i2);
                if (cCharAt == '/') {
        ...
        @MaybeNull
        public Generic getSuperClass() {
            return Generic.OfNonGenericType.ForLoadedType.m296of(Object.class);
        }
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m287of(TypeDescription typeDescription) {
            return m288of(typeDescription, 1);
        }
    }
        ...
        public static class ClassLoadingTypeProjection extends Generic.LazyProjection {
            ...
            public TypeDescription asErasure() {
                ...
                if (this.erasure != null) {
                    ...
                    try {
                        typeDescriptionAsErasure = ForLoadedType.m289of(this.classLoadingDelegate.load(this.delegate.asErasure().getName(), this.classLoader));
                    } catch (ClassNotFoundException unused) {
    ...
    public static class ForLoadedType extends AbstractBase implements Serializable {
        ...
        /* JADX INFO: renamed from: of */
        public static TypeDescription m289of(Class<?> cls) {
        ...
        public Generic asGenericType() {
            return Generic.OfNonGenericType.ForLoadedType.m296of(this.type);
        }
        ...
        @MaybeNull
        public ClassFileVersion getClassFileVersion() {
            ClassFileVersion classFileVersionM158of = null;
            if (this.classFileVersion == null) {
                try {
                    classFileVersionM158of = ClassFileVersion.m158of(this.type);
                } catch (Throwable unused) {
                }
            }
            if (classFileVersionM158of == null) {
                return this.classFileVersion;
            }
            this.classFileVersion = classFileVersionM158of;
            return classFileVersionM158of;
        }
        ...
        public TypeDescription getComponentType() {
            Class<?> componentType = this.type.getComponentType();
            return componentType == null ? TypeDescription.UNDEFINED : m289of(componentType);
        }
        ...
        @Override // net.bytebuddy.description.type.TypeDescription
        public TypeList getDeclaredTypes() {
            return new TypeList.ForLoadedTypes((Class<?>[]) GraalImageCode.getCurrent().sorted(this.type.getDeclaredClasses(), TypeComparator.INSTANCE));
        }
        ...
        public TypeDescription getDeclaringType() {
            Class<?> declaringClass = this.type.getDeclaringClass();
            return declaringClass == null ? TypeDescription.UNDEFINED : m289of(declaringClass);
        }
        ...
        public TypeDescription getEnclosingType() {
            ...
            return enclosingClass == null ? TypeDescription.UNDEFINED : m289of(enclosingClass);
        }
        ...
        public TypeDescription getNestHost() {
            ...
            return nestHost == null ? this : m289of(nestHost);
        }
        ...
        @Override // net.bytebuddy.description.type.TypeDefinition
        public StackSize getStackSize() {
            return StackSize.m436of(this.type);
        }

        @Override // net.bytebuddy.description.type.TypeDefinition
        @MaybeNull
        public Generic getSuperClass() {
            boolean z = AbstractBase.RAW_TYPES;
            Class<?> cls = this.type;
            return z ? cls.getSuperclass() == null ? Generic.UNDEFINED : Generic.OfNonGenericType.ForLoadedType.m296of(this.type.getSuperclass()) : Generic.LazyProjection.ForLoadedSuperClass.m292of(cls);
        }

        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return AbstractBase.RAW_TYPES ? new TypeList.Generic.Empty() : TypeList.Generic.ForLoadedTypes.OfTypeVariables.m307of((GenericDeclaration) this.type);
        }
        ...
        @Override // net.bytebuddy.description.type.TypeDescription.AbstractBase, net.bytebuddy.description.type.TypeDescription
        public boolean isNestMateOf(Class<?> cls) {
            return DISPATCHER.isNestmateOf(this.type, cls) || super.isNestMateOf(m289of(cls));
        }
