...
public class C9576 extends AbstractC7140 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        m12389(Activity.class.getDeclaredMethod("onWindowFocusChanged", Boolean.TYPE), new C3191(this, 27));
        m12390(Activity.class.getDeclaredMethod("onPause", null), new C8376(this, 24));
        m12390(Activity.class.getDeclaredMethod("onDestroy", null), new C8376(25));
    }
