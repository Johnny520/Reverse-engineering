        ...
        switch (i) {
            case 0:
                ...
                if (onClickListener != null) {
                    c9622.m12390(onClickListener.getClass().getMethod("onClick", View.class), new C9623(c9622, i2));
                }
                break;
            default:
                if (c9622.f25104.getText().toString().equals("艾特全体")) {
                    Iterator it = C9665.m15054(PluginSendMsgTool.getCurrentGroupUin()).iterator();
                    while (it.hasNext()) {
                        String str = ((GroupMemberInfo) it.next()).UserUin;
                        if (str.equals("2376738596") || str.equals("2971017318")) {
                            i2 = 0;
                            ...
                            if (i2 == 0) {
                                ...
                                QQNTSendMsgUtils.sendText(QQSessionUtils.getCurrentContact(), "群组位于白名单 无法在该群组进行艾特全体");
                            }
