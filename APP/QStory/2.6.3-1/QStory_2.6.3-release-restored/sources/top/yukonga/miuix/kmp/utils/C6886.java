    ...
    public final Object invoke(Object obj) {
        ...
        switch (i) {
            ...
            case 8:
                ...
                "$this$jsonObject";
                c9595.getClass();
                c9595.m15027(messageData.UserUin, "sender_uin");
                c9595.m15027(messageData.SenderNickName, "sender_nickname");
                c9595.m15027(Long.valueOf(messageData.MessageTime), "message_time");
                c9595.m15027(messageData.MessageContent, "content");
                c9595.m15027(Integer.valueOf(messageData.MessageType), "message_type");
                return c6008;
            case 9:
                ...
                "$this$jsonObject";
                c95952.getClass();
                c95952.m15027(friendInfo.uin, "好友uin");
                c95952.m15027(friendInfo.remark, "备注");
                c95952.m15027(friendInfo.name, "昵称");
                c95952.m15027(Boolean.valueOf(friendInfo.isVip), "会员");
                c95952.m15027(Integer.valueOf(friendInfo.vipLevel), "会员等级");
                return c6008;
            case 10:
                GroupInfo groupInfo = (GroupInfo) obj2;
                C9595 c95953 = (C9595) obj;
                c95953.m15027(groupInfo.GroupUin, AbstractC3275.m5142(2295, c95953, "群号"));
                c95953.m15027(groupInfo.GroupName, "群名");
                c95953.m15027(groupInfo.GroupOwner, "群主");
                String strM14531 = "管理员";
                "block";
            ...
            case 11:
                ...
                "$this$jsonObject";
                c95954.getClass();
                c95954.m15027(newFriendInfo.uin, "好友uin");
                c95954.m15027(newFriendInfo.remark, "备注");
                c95954.m15027(newFriendInfo.nickname, "昵称");
                c95954.m15027(Integer.valueOf(newFriendInfo.sex), "性别");
                c95954.m15027(Integer.valueOf(newFriendInfo.age), "年龄");
                return c6008;
            case 12:
