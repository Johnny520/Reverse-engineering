        ...
        switch (i) {
            case 0:
                ...
                try {
                    ...
                    AbstractC7014.m12151("[QStory] 已切换QQ账号 请重新开启脚本 防止脚本开启状态混乱");
            ...
            case 2:
                ...
                obj.getClass();
                C6750.m11860(c6750, obj, "bubbleId");
                C6750.m11860(c6750, obj, "subBubbleId");
                return;
            case 7:
                "param";
                methodHookParam.getClass();
            ...
            case 16:
                ...
                try {
                    ...
                    "getName(...)";
                    if (!AbstractC5976.m10735(name, "MultiForwardActivity", false) && (bitmapM11803 = C6664.m11803(c6664)) != null) {
                        int iM12313 = c6664.f16321;
                        if (iM12313 == 0) {
                            Context context = AbstractC7187.f17852;
                            C7149 c7149 = c6664.f16320;
                            c7149.getClass();
                            Object objM12399 = c7149.m12399(50, "size");
                            "null cannot be cast to non-null type kotlin.Int";
                            objM12399.getClass();
                            ...
                            imageViewM11805.setOnClickListener(new View.OnClickListener() { // from class: top.suzhelan.qstory.hook.item.chat.飘花落叶言子世哲楪兰苏
                                ...
                                */
                                public final void onClick(View view2) {
                                    ...
                                    if (c71492 != null) {
                                        Boolean bool2 = (Boolean) c71492.m12399(Boolean.FALSE, "doubleClick");
                                    ...
                                    try {
                                        try {
                                            try {
                                                objM12418 = obj8.getClass().getMethod("getMsgRecord", null).invoke(obj8, null);
                                            } catch (Exception unused2) {
                                                objM12418 = AbstractC7165.m12418(Object.class, "msgRecord", obj8);
                                            }
                                        } catch (Exception unused3) {
                                        }
                                        if (objM12418 != null) {
                                            Integer num = (Integer) AbstractC7165.m12418(Integer.TYPE, "msgType", objM12418);
                                            if ((num != null ? num.intValue() : 0) != 1) {
                                                C6664.m11804(c66642, obj8);
                                            }
                                        }
                                        AbstractC7014.m12151("该消息不支持复读");
                                    } catch (Exception e2) {
                                        e2.printStackTrace();
                                    }
                                }
            ...
            case 19:
                ...
                while (it.hasNext()) {
                    ...
                    if (list == null || list.isEmpty()) {
                        ...
                        ((Method) arrayList.get(i3)).invoke(objM6845, Proxy.newProxyInstance(AbstractC7166.f17805, new Class[]{AbstractC7166.m12425("kotlin.jvm.functions.Function0")}, new C7196(context2)));
            ...
            case 21:
                ...
                try {
                    ...
                    c7164M12413.f17803.f3963 = "getHostView";
                    ...
                    if (obj9 != null && view2 != null) {
                        ...
                        Iterator it2 = ((ArrayList) AbstractC7165.m12418(ArrayList.class, "elements", c7164M124132.m12415(obj9, new Object[0]))).iterator();
                        while (it2.hasNext()) {
                            if (((Integer) AbstractC7165.m12418(cls, "elementType", it2.next())).intValue() <= 2) {
            ...
            case 23:
                ...
                while (i3 < length2) {
                    if (interfaces[i3] == SensorEventListener.class) {
                        ((C9626) abstractC7143).f25110.add(XposedBridge.hookMethod(AbstractC7162.m12408(cls4, "onSensorChanged", new Class[]{SensorEvent.class}), new C7202(16)));
                    }
                    i3++;
                }
                return;
    ...
    public void beforeHookedMethod(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (c6711.f17770.booleanValue() && !intent.getBooleanExtra(c6711.f16401, false) && (stringExtra = intent.getStringExtra("url")) != null && !AbstractC5976.m10731(stringExtra)) {
                    ...
                    if (patternCompile.matcher(lowerCase).matches()) {
                        if (AbstractC5976.m10735(stringExtra, "://", false)) {
                            strSubstring = stringExtra.substring(AbstractC5976.m10729(stringExtra, "://", 0, false, 6) + 3);
                            "substring(...)";
                        } else {
                        ...
                        if (AbstractC5976.m10735(strSubstring2, "/", false)) {
                            strSubstring2 = strSubstring2.substring(0, AbstractC5976.m10729(strSubstring2, "/", 0, false, 6));
                            "substring(...)";
                        }
                        String lowerCase2 = strSubstring2.toLowerCase(Locale.ROOT);
                        "toLowerCase(...)";
                        lowerCase2.getClass();
                        if (!lowerCase2.endsWith("qq.com") && !lowerCase2.endsWith("tenpay.com") && !lowerCase2.endsWith("meeting.tencent.com") && !lowerCase2.equals("qq-web.cdn-go.cn") && (component = intent.getComponent()) != null && (shortClassName = component.getShortClassName()) != null && AbstractC5976.m10735(shortClassName, "QQBrowserActivity", false)) {
                            if (!AbstractC5971.m10698(stringExtra, "http://", false) && !AbstractC5971.m10698(stringExtra, "https://", false)) {
            ...
            case 7:
                ...
                if (((C6774) abstractC7143).f17770.booleanValue()) {
                    try {
                        ...
                        while (true) {
                            if (i4 < length2) {
                                if (AbstractC5227.m9466(declaredFields[i4].getName(), "o")) {
                                    i2 = 1;
                                } else {
                                    i4++;
                                }
            ...
            case 20:
                ...
                if ("trpc.msg.olpush.OlPushService.MsgPush".equals((String) AbstractC7165.m12418(String.class, "serviceCmd", obj7))) {
                    C7018 c7018 = new C7018();
                    c7018.m12172(C7018.m12167((byte[]) AbstractC7165.m12418(byte[].class, "wupBuffer", obj7)));
                    JSONObject jSONObjectM12173 = c7018.m12173();
                    int intValue = jSONObjectM12173.getJSONObject("1").getJSONObject("2").getIntValue("1");
                    JSONObject jSONObject = jSONObjectM12173.getJSONObject("1").getJSONObject("3");
                    if (intValue == 33 && jSONObject.containsKey("2")) {
                        ...
                        if (jSONObject2.containsKey("3") && (jSONObject2.get("5") instanceof String)) {
                            ...
                            if (intValue2 == 130 || intValue2 == 131) {
                                ((C7204) abstractC7143).f17875.execute(new RunnableC3179(jSONObject2.getString("3"), jSONObject2.getString("5"), String.valueOf(jSONObject2.getLong("1")), 7));
                            }
                            break;
                        }
                    }
