            ...
            case 10:
                ...
                while (it.hasNext()) {
                    ...
                    if (((Number) objM15222).intValue() == 1) {
                        ...
                        c9921M15231.f25826 = "getTextElement";
                        Object objM15233 = c9921M15231.m15233(next, new Object[i]);
                        Integer num = (Integer) C9915.m15222(cls, "atType", objM15233);
                        if (num == null || num.intValue() != 2) {
                            C9921 c9921M152312 = C9921.m15231(objM15233.getClass());
                            c9921M152312.f25826 = "getContent";
                            ...
                            c9921M152313.f25826 = "setContent";
                            string.getClass();
                            if (string.length() != 0) {
                                ...
                                "toString(...)";
                                string = AbstractC5976.m10714(new Regex("(?<=[({\\[/#])\\s|\\s(?=[)}\\]:;])|(?<=\\n)\\s").replace(new Regex("[^\\n\\S]+").replace(string2, " "), "")).toString();
                            }
