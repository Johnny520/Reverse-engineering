...
public final class C6703 {
    ...
    public static void m11831(ArrayList arrayList) {
        ...
        for (C6702 c6702 : arrayList2) {
            C6701.f16380.m15236(Boolean.valueOf(c6702.f16387), "tool_enabled_" + c6702.f16390);
        }
        ...
        for (String str2 : arrayList6) {
            C6701.f16380.m15236(Boolean.TRUE, "tool_enabled_" + str2);
        }
    ...
    public static ArrayList m11835() {
        ArrayList arrayListM15239 = C6701.f16380.m15239(String.class, "tool_order");
