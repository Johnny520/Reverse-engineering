...
public final class C6712 extends AbstractC7140 implements InterfaceC7146 {
    ...
    public final String f16403 = "sendLocalFileMethod";
    ...
    public static boolean m11843(String str, String str2) {
        if (!new Regex("^base(\\([0-9]+\\))?.apk$").matches(str)) {
            int iM10728 = AbstractC5976.m10728(0, 6, str, ".");
            if (iM10728 != -1) {
    ...
    public static String m11844(String str) {
        try {
            ...
            String strM10696 = AbstractC5971.m10696("%n_%v.APK", "%n", applicationInfo.loadLabel(packageManager).toString());
            String strM14532 = "%p";
            ...
            return AbstractC5971.m10696(AbstractC5971.m10696(strM106962, strM145322, str3), "%c", String.valueOf(packageArchiveInfo.versionCode));
        } catch (Exception unused) {
            return "base.APK";
        }
    }
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (method == null) {
            C3466.m5899("sendLocalFileMethod is null");
            return;
        }
        XposedBridge.hookMethod(method, new C7142(this, 25, new C6755(this, 2)));
        Class clsM12425 = AbstractC7166.m12425(AbstractC7187.f17853 >= 13350 ? "com.tencent.mobileqq.troop.utils.Item" : "com.tencent.mobileqq.troop.utils.TroopFileTransferManager$Item");
        C7164 c7164M12412 = C7164.m12412("com.tencent.mobileqq.troop.filemanager.TroopFileTransferMgr");
    ...
    public final void mo11796(C3902 c3902) {
        "finder";
        c3902.m7447(C3902.m7446("sendLocalFileToNt strFilePath:")[0], this.f16403);
    }
}
