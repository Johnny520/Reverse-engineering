...
public final class InjectHook implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    private static final Set<String> ALLOWED_PROCESS = AbstractC5179.m9404(new String[]{"com.tencent.mobileqq", "com.tencent.mobileqq:MSF"});
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) {
        ...
        try {
            ...
            if (loadPackageParam.isFirstApplication) {
                ...
                String strM14531 = "com.tencent.mobileqq|com.tencent.tim";
                ...
                if (new Regex(strM14531).matches(str)) {
                    ...
                    if (ALLOWED_PROCESS.contains(str2)) {
                        ...
                        XposedHelpers.findAndHookMethod(loadPackageParam.classLoader.loadClass("com.tencent.common.app.BaseApplicationImpl"), "onCreate", new Object[]{new C9611(this, i)});
                    }
                }
            }
        } catch (Throwable th) {
            String strM14532 = "init";
