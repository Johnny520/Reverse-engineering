...
public final class C6780 extends AbstractC7140 {
    ...
    public final List f16491 = AbstractC7176.m12490(new C6765("中国核心区", 20.0d, 45.0d, 80.0d, 120.0d), new C6765("日本/韩国", 33.0d, 43.0d, 126.0d, 145.0d), new C6765("东南亚(新马泰/印尼)", -8.0d, 20.0d, 95.0d, 120.0d), new C6765("中东(迪拜/土耳其)", 15.0d, 40.0d, 35.0d, 60.0d), new C6765("欧洲大陆", 36.0d, 65.0d, -10.0d, 35.0d), new C6765("北美热门区", 25.0d, 50.0d, -125.0d, -75.0d), new C6765("澳洲/新西兰", -45.0d, -12.0d, 113.0d, 175.0d), new C6765("南美洲", -55.0d, 12.0d, -80.0d, -35.0d), new C6765("非洲大陆", -30.0d, 30.0d, -15.0d, 40.0d));
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        m11883();
        try {
            Class clsFindClassIfExists = XposedHelpers.findClassIfExists("com.tencent.map.geolocation.internal.TencentLocationImpl", classLoader);
        ...
        try {
            Class clsFindClassIfExists2 = XposedHelpers.findClassIfExists("com.tencent.map.geolocation.TencentLocationManager", classLoader);
            if (clsFindClassIfExists2 != null) {
                ...
                for (Method method : declaredMethods) {
                    ...
                    while (true) {
                        ...
                        if (parameterTypes[i].getName().equals("com.tencent.map.geolocation.TencentLocationListener")) {
        ...
        try {
            Class clsFindClassIfExists3 = XposedHelpers.findClassIfExists("com.tencent.mobileqq.location.net.LocationShareLocationManager$a", classLoader);
            if (clsFindClassIfExists3 == null) {
                return;
            }
            XposedHelpers.findAndHookMethod(clsFindClassIfExists3, "onLocationChanged", new Object[]{"com.tencent.map.geolocation.TencentLocation", Integer.TYPE, String.class, new C6764(this, 4)});
    ...
    public final void m11882(Class cls) {
        ...
        if (copyOnWriteArraySet.add(name)) {
            try {
                XposedHelpers.findAndHookMethod(cls, "getLongitude", new Object[]{new C6764(this, 2)});
                XposedHelpers.findAndHookMethod(cls, "getLatitude", new Object[]{new C6764(this, 3)});
            } catch (Exception unused) {
