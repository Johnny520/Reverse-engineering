...
public final class C6666 extends AbstractC9632 {
    ...
    static {
        ...
        "com.tencent.qqnt.aio.widget.AIOMsgTextView";
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        if (AbstractC3888.m7256()) {
            ...
            if (thM9307exceptionOrNullimpl != null) {
                AbstractC7017.m12164("QuickEditResendMessage", "hook message menu failed", thM9307exceptionOrNullimpl, true);
            }
    ...
    public final String mo11794() {
        return "长按文本消息显示修改内容按钮，仅修改本地聊天界面显示内容。";
    }
