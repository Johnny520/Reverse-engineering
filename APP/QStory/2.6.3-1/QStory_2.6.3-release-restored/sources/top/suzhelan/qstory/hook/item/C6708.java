...
public final class C6708 extends AbstractC7140 {
    ...
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        if (AbstractC7187.f17853 >= 5626) {
            m12389(classLoader.loadClass("com.tencent.mobileqq.aio.msg.AIOMsgItem").getDeclaredMethod("getMsgRecord", null), new InterfaceC7141(this) { // from class: top.suzhelan.qstory.hook.item.飘花落叶言子世哲兰苏楪
                ...
                public final void mo2039(XC_MethodHook.MethodHookParam methodHookParam) {
                    ...
                    switch (i2) {
                        case 0:
                            ...
                            Integer num = (Integer) AbstractC7165.m12418(Integer.TYPE, "subMsgType", result);
                            if (num != null && num.intValue() == 8194) {
                                AbstractC7165.m12424(result, "subMsgType", 2);
                                c6708.f16397.add((Long) AbstractC7165.m12418(cls, "msgId", result));
                            }
                            break;
                        default:
                            ...
                            if (((Integer) result2).intValue() == 8194) {
                                ...
                                c6708.f16397.add((Long) AbstractC7165.m12418(cls, "msgId", methodHookParam.thisObject));
                            }
                            break;
                    }
                }
            ...
            final int i2 = 1;
            m12389(clsLoadClass.getDeclaredMethod("getSubMsgType", null), new InterfaceC7141(this) { // from class: top.suzhelan.qstory.hook.item.飘花落叶言子世哲兰苏楪
