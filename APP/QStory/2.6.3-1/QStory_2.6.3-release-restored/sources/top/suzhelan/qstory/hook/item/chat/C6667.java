    ...
    public final void mo11788(Object obj, View view) {
        ...
        switch (this.f16325) {
            case 0:
                ...
                Long lM11807 = C6666.m11807(obj, "msgId");
                if (lM11807 != null && (str = (String) C6666.f16324.get(lM11807)) != null) {
                    ...
                    if (viewGroup != null && QQAIOTool.hasContentMessage(viewGroup) && (contentView = QQAIOTool.getContentView(viewGroup)) != null) {
                        ...
                        for (View view2 : arrayListM7210) {
                            if ((view2 instanceof TextView) && view2.getClass().getName().equals("com.tencent.qqnt.aio.widget.AIOMsgTextView")) {
                ...
                break;
            default:
                Iterator it = ((ArrayList) AbstractC7165.m12418(ArrayList.class, "elements", obj)).iterator();
                while (it.hasNext()) {
                    Object objCallMethod = XposedHelpers.callMethod(it.next(), "getArkElement", new Object[0]);
                    if (objCallMethod != null) {
                        ViewGroup viewGroup2 = (ViewGroup) view;
                        String str2 = (String) AbstractC7165.m12418(String.class, "bytesData", objCallMethod);
