...
public final class C6736 extends AbstractC7140 implements InterfaceC7146 {
    ...
    public final String f16425 = "NewTarget";
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        XposedHelpers.findAndHookMethod(clsFindClassIfExists, "getView", new Object[]{Integer.TYPE, View.class, ViewGroup.class, new C6642(this, 10)});
        Method method = this.f16424;
        if (method != null) {
            m12389(method, new C6755(13));
        } else {
            AbstractC5227.m9467("newTargetMethod");
            throw null;
        }
    }
