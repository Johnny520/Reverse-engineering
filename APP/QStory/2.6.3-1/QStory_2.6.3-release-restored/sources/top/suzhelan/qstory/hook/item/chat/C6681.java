...
public final class C6681 extends AbstractC7140 implements InterfaceC6639 {
    ...
    public final void mo11788(Object obj, View view) {
        ...
        while (it.hasNext()) {
            ...
            "next(...)";
            next.getClass();
            String strM14531 = "elementType";
            Class cls = Integer.TYPE;
            Integer num = (Integer) C9915.m15222(cls, strM14531, next);
            if (num != null && num.intValue() == 1) {
                Object objM7397 = AbstractC3897.m7397(next, "getTextElement", new Object[0]);
                Integer num2 = (Integer) C9915.m15222(cls, "atType", objM7397);
                if (num2 != null && num2.intValue() == 2) {
                    linkedHashMap.put((String) AbstractC3897.m7397(objM7397, "getContent", new Object[0]), (String) C9915.m15222(String.class, "atNtUid", objM7397));
                }
            }
        }
        ...
        String str = (String) C9915.m15222(String.class, "peerUid", obj);
        Class clsM15228 = AbstractC9919.m15228("com.tencent.qqnt.aio.widget.AIOMsgTextView");
        clsM15228.getClass();
