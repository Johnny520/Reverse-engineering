                ...
                if (c6780.f17770.booleanValue()) {
                    ...
                    if (obj != null) {
                        ...
                        if (!copyOnWriteArraySet.contains(cls2.getName())) {
                            ...
                            try {
                                XposedHelpers.findAndHookMethod(cls2, "onLocationChanged", new Object[]{"com.tencent.map.geolocation.TencentLocation", Integer.TYPE, String.class, new C6764(c6780, 1)});
