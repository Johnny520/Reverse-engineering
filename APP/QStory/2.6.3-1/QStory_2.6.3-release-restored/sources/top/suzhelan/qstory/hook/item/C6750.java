...
public final class C6750 extends AbstractC7140 {
    ...
    public static final String[] f16454 = {"/bubble_info", "/files/bubble_info", "/files/bubble_paster", "/files/vas_material_folder/bubble_dir"};
        ...
        for (int i = 0; i < 4; i++) {
            try {
                ...
                for (Method method : declaredMethods) {
                    ...
                    name.getClass();
                    if (AbstractC5971.m10698(name, "set", false) && AbstractC5179.m9396(name, strArr2)) {
    ...
    public final void m11861(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        cls.getClass();
        try {
            XposedBridge.hookMethod(cls.getDeclaredMethod("getBubbleId", null), new C6745(10));
        } catch (Exception unused) {
        }
        try {
            XposedBridge.hookMethod(cls.getDeclaredMethod("getSubBubbleId", null), new C6745(10));
        } catch (Exception unused2) {
        }
        try {
