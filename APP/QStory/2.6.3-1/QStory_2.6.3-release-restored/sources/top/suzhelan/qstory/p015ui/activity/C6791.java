    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (i3) {
            case 0:
                ...
                if (zM2920 || objM2905 == c2188) {
                    ...
                    for (Object obj6 : ItemUiInfoManager.rootContainer) {
                        if (obj6 instanceof ItemUiInfoGroupWrapper) {
                            ...
                            for (BaseItemUiInfo baseItemUiInfo : directoryUIInfoList) {
                                ...
                                AbstractC9004.m14205(arrayList, baseItemUiInfo, "root");
                            }
                        } else {
                            i2 = i4;
                            if (obj6 instanceof BaseItemUiInfo) {
                                AbstractC9004.m14205(arrayList, (BaseItemUiInfo) obj6, "root");
                            }
                        }
                        i4 = i2;
                    }
                    ...
                    for (Object obj7 : list) {
                        ...
                        try {
                            ...
                            String str = "root-other-" + i5 + SignatureVisitor.SUPER + cls.getSimpleName();
                ...
                AbstractC1247.m1673(directoryUiInfo, c1496, (InterfaceC7387) obj12, null, "setting_page_transition", null, AbstractC2089.m2749(1740757747, new InterfaceC7381() { // from class: top.suzhelan.qstory.ui.activity.飘花落叶言子楪世兰哲苏
                        ...
                        if (zM29204 || objM29059 == c21882) {
                            if (directoryUiInfo3 != null) {
                                ...
                                for (ItemUiInfoGroupWrapper itemUiInfoGroupWrapper2 : list3) {
                                    arrayList2.add(new C9685("directory-group-" + arrayList2.size() + SignatureVisitor.SUPER + itemName + SignatureVisitor.SUPER + itemUiInfoGroupWrapper2.getGroupName(), itemUiInfoGroupWrapper2));
                                    ...
                                    for (BaseItemUiInfo baseItemUiInfo2 : directoryUIInfoList2) {
                                        ...
                                        AbstractC9004.m14205(arrayList2, baseItemUiInfo2, "directory-" + itemName);
                                    }
                                }
                                ...
                                for (BaseItemUiInfo baseItemUiInfo3 : list4) {
                                    ...
                                    AbstractC9004.m14205(arrayList2, baseItemUiInfo3, "directory-" + itemName);
                                }
                            }
