...
@Metadata(m150d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0012\u0010\u0004\u001a\u00020\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0007¨\u0006\u0007"}, m151d2 = {"Ltop/suzhelan/sticker/sdk/net/StickerUrlResolver;", "", MethodDescription.CONSTRUCTOR_INTERNAL_NAME, "()V", "resolveAssetUrl", "", "path", "online-sticker-sdk_release"}, m152k = 1, m153mv = {2, 3, 0}, m155xi = 48)
public final class StickerUrlResolver {
    ...
    public static final String resolveAssetUrl(String path) {
        ...
        if (path == null || AbstractC5976.m10731(path)) {
            return StickerSdkConfig.BASE_URL;
        }
        if (AbstractC5971.m10698(path, "http://", false) || AbstractC5971.m10698(path, "https://", false)) {
            return path;
        }
        ...
        if (!AbstractC5971.m10698(path, "/", false)) {
            path = "/".concat(path);
        }
        return AbstractC0900.m696(string2, path);
    }
}
