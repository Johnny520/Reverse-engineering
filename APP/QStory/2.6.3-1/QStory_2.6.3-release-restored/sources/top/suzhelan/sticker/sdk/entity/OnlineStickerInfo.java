...
public final /* data */ class OnlineStickerInfo {
    ...
    @InterfaceC9094("stickerCount")
    private final int stickerCount;

    @InterfaceC9094("tags")
    private final List<String> tags;

    @InterfaceC9094("thumbnails")
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC5227.m9466(this.id, onlineStickerInfo.id) && AbstractC5227.m9466(this.title, onlineStickerInfo.title) && AbstractC5227.m9466(this.description, onlineStickerInfo.description) && AbstractC5227.m9466(this.uin, onlineStickerInfo.uin) && AbstractC5227.m9466(this.nickname, onlineStickerInfo.nickname) && AbstractC5227.m9466(this.author, onlineStickerInfo.author) && AbstractC5227.m9466(this.archiveFileName, onlineStickerInfo.archiveFileName) && AbstractC5227.m9466(this.archiveFileFormat, onlineStickerInfo.archiveFileFormat) && this.archiveFileSize == onlineStickerInfo.archiveFileSize && this.stickerCount == onlineStickerInfo.stickerCount && AbstractC5227.m9466(this.coverFileName, onlineStickerInfo.coverFileName) && AbstractC5227.m9466(this.coverFileFormat, onlineStickerInfo.coverFileFormat) && this.coverFileSize == onlineStickerInfo.coverFileSize && AbstractC5227.m9466(this.coverWidth, onlineStickerInfo.coverWidth) && AbstractC5227.m9466(this.coverHeight, onlineStickerInfo.coverHeight) && AbstractC5227.m9466(this.archiveUrl, onlineStickerInfo.archiveUrl) && AbstractC5227.m9466(this.coverUrl, onlineStickerInfo.coverUrl) && AbstractC5227.m9466(this.thumbnails, onlineStickerInfo.thumbnails) && AbstractC5227.m9466(this.tags, onlineStickerInfo.tags) && this.downloadCount == onlineStickerInfo.downloadCount && AbstractC5227.m9466(this.createdAt, onlineStickerInfo.createdAt);
    }
    ...
    public int hashCode() {
        int iM12131 = AbstractC7012.m12131(this.id.hashCode() * 31, 31, this.title);
        ...
        int iM704 = AbstractC0900.m704(this.coverFileSize, AbstractC7012.m12131(AbstractC7012.m12131(AbstractC0900.m704(this.stickerCount, AbstractC0900.m704(this.archiveFileSize, AbstractC7012.m12131(AbstractC7012.m12131((iHashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31, 31, this.archiveFileName), 31, this.archiveFileFormat), 31), 31), 31, this.coverFileName), 31, this.coverFileFormat), 31);
        Integer num = this.coverWidth;
        int iHashCode4 = (iM704 + (num == null ? 0 : num.hashCode())) * 31;
        Integer num2 = this.coverHeight;
        return this.createdAt.hashCode() + AbstractC0900.m704(this.downloadCount, AbstractC0900.m720(this.tags, AbstractC0900.m720(this.thumbnails, AbstractC7012.m12131(AbstractC7012.m12131((iHashCode4 + (num2 != null ? num2.hashCode() : 0)) * 31, 31, this.archiveUrl), 31, this.coverUrl), 31), 31), 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbM12141 = AbstractC7012.m12141("OnlineStickerInfo(id=", str, ", title=", str2, ", description=");
        AbstractC7012.m12136(sbM12141, str3, ", uin=", str4, ", nickname=");
        AbstractC7012.m12136(sbM12141, str5, ", author=", str6, ", archiveFileName=");
        AbstractC7012.m12136(sbM12141, str7, ", archiveFileFormat=", str8, ", archiveFileSize=");
        sbM12141.append(i);
        sbM12141.append(", stickerCount=");
        sbM12141.append(i2);
        sbM12141.append(", coverFileName=");
        AbstractC7012.m12136(sbM12141, str9, ", coverFileFormat=", str10, ", coverFileSize=");
        sbM12141.append(i3);
        sbM12141.append(", coverWidth=");
        sbM12141.append(num);
        sbM12141.append(", coverHeight=");
        sbM12141.append(num2);
        sbM12141.append(", archiveUrl=");
        sbM12141.append(str11);
        sbM12141.append(", coverUrl=");
        sbM12141.append(str12);
        sbM12141.append(", thumbnails=");
        sbM12141.append(list);
        sbM12141.append(", tags=");
        sbM12141.append(list2);
        sbM12141.append(", downloadCount=");
        sbM12141.append(i4);
        sbM12141.append(", createdAt=");
        return AbstractC0900.m711(sbM12141, str13, ")");
    }
}
