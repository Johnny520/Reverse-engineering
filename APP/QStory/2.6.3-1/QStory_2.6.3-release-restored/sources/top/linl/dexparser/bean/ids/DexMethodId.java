...
public class DexMethodId extends BaseId {
    ...
    public DexTypeId[] getMethodParams(DexParser dexParser) {
        ...
        for (int i2 = 0; i2 < iByteToUnsignedInt; i2++) {
            dexTypeIdArr[i2] = dexParser.dexTypeIdsList[ConversionUtils.bytesToUnsignedShort(Utils.copyArrays(dexParser.dexData, AbstractC7012.m12133(i2, 2, dexProtoId.parameters_off, 4), 2))];
        }
        return dexTypeIdArr;
    }
