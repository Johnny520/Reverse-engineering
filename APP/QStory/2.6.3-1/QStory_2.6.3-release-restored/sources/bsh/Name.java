...
class Name implements Serializable {
    ...
    public static void clearParts() {
        WeakHashMap weakHashMap = C3454.f8202;
    ...
    private Object completeRound(String str, String str2, Object obj) {
        if (obj == null) {
            C3466.m5902(AbstractC0900.m717("lastEvalName = ", str));
            return null;
        }
    ...
    private Object consumeNextObjectField(CallStack callStack, Interpreter interpreter, boolean z, boolean z2) throws UtilEvalError {
        ...
        if (name.evalBaseObject == null) {
            ...
            if (cls != null) {
                return name.completeRound(strPrefix2, suffix(str, countParts(str) - i), new C3479(cls));
            }
        ...
        if ((obj2 == null || (obj2 instanceof This)) && !z && z2) {
            ...
            This r9 = new NameSpace(nameSpace, AbstractC0900.m717("auto: ", strPrefix)).getThis(interpreter2);
        ...
        if (!(obj2 instanceof C3479)) {
            if (z) {
                throw new UtilEvalError(AbstractC0900.m711(new StringBuilder(), name.value, " does not resolve to a class name."));
            }
            ...
            try {
                return name.completeRound(strPrefix3, suffix(name.evalName), AbstractC3500.m6015(name.evalBaseObject, strPrefix3));
            } catch (ReflectError unused) {
                return name.completeRound(strPrefix3, suffix(name.evalName), AbstractC3500.m6013(name.evalBaseObject, strPrefix3));
            }
        }
        Class<?> cls2 = ((C3479) obj2).f8264;
        ...
        if (strPrefix4.equals("this")) {
            ...
            throw new UtilEvalError(AbstractC0900.m714(cls2, "Can't find enclosing 'this' instance of class: "));
        }
        Interpreter.mainSecurityGuard.m14433(cls2, strPrefix4);
        try {
            Interpreter.debug("Name call to getStaticFieldValue, class: ", cls2, ", field:", strPrefix4);
            objM6013 = AbstractC3500.m6018(strPrefix4, cls2, null, true);
        } catch (ReflectError e) {
            Interpreter.debug("field reflect error: ", e);
        }
        if (objM6013 == null) {
            Class<?> cls3 = name.namespace.getClass(cls2.getName() + "$" + strPrefix4);
            if (name.namespace.classInstance == null && AbstractC3500.m5992(cls3) && !AbstractC3500.m6017(cls3).hasModifier("static")) {
                throw new UtilEvalError("an enclosing instance that contains " + cls2.getName() + "." + strPrefix4 + " is required");
            }
            if (cls3 != null) {
                objM6013 = new C3479(cls3);
            }
        }
        if (objM6013 == null) {
            objM6013 = AbstractC3500.m6013(cls2, strPrefix4);
        }
        return name.completeRound(strPrefix4, suffix(name.evalName), objM6013);
    }
    ...
    private Object invokeLocalMethod(Interpreter interpreter, Object[] objArr, CallStack callStack, InterfaceC3452 interfaceC3452) throws EvalError {
        CallStack callStack2;
        ...
        if (interpreter == null) {
            C3466.m5902("invokeLocalMethod: interpreter = null");
            return null;
        }
        ...
        try {
            ...
            Iterator it = c9201.f23462.iterator();
            while (it.hasNext()) {
                try {
                    ...
                    throw utilEvalError.toEvalError(interfaceC34522, callStack2);
                }
            }
            try {
                name = this;
            ...
            if (obj != null) {
                try {
                    if (obj != Primitive.NULL && obj != Primitive.VOID) {
                        extensionMethod = name.namespace.getExtensionMethod(AbstractC3495.m5955(obj, false), str, clsArrM5956);
                    }
                } catch (UtilEvalError e2) {
                    throw e2.toEvalError("Local method invocation", interfaceC3452, callStack3);
                }
            }
            if (extensionMethod == null) {
                extensionMethod = name.namespace.getMethod(str, clsArrM5956, false, false);
            }
            NameSpace nameSpace = name.namespace;
            if (extensionMethod == null) {
                return nameSpace.invokeCommand(str, objArr, interpreter2, callStack3, interfaceC3452);
            }
            ...
            return extensionMethod.invoke(objArr, interpreter2, callStack3, interfaceC3452, z, obj);
    ...
    public static String prefix(String str, int i) {
        ...
        C3454 c3454M5858 = C3454.m5858(str);
        String[] strArr = c3454M5858.f8206;
        if (1 > i || c3454M5858.f8203 < i) {
            return null;
        }
        if (strArr[i] == null) {
            strArr[i] = String.join(".", c3454M5858.f8204.subList(0, i));
        }
        return strArr[i];
    }
    ...
    public static String suffix(String str, int i) {
        ...
        C3454 c3454M5858 = C3454.m5858(str);
        String[] strArr = c3454M5858.f8205;
        if (1 > i || (i2 = c3454M5858.f8203) < i) {
            return null;
        }
        if (strArr[i] == null) {
            strArr[i] = String.join(".", c3454M5858.f8204.subList(i2 - i, i2));
        }
        return strArr[i];
    }

    public Object invokeMethod(Interpreter interpreter, Object[] objArr, CallStack callStack, InterfaceC3452 interfaceC3452) throws UtilEvalError {
        NameSpace nameSpaceM6004;
        BshMethod method;
        ...
        if (cls != null) {
            Interpreter.mainSecurityGuard.m14431(cls, strSuffix, objArr);
            return AbstractC3500.m5993(classManager, this.classOfStaticMethod, strSuffix, objArr, interfaceC3452);
        }
        if (!isCompound(this.value)) {
            return invokeLocalMethod(interpreter, objArr, callStack, interfaceC3452);
        }
        ...
        if (strPrefix.equals("super") && countParts(this.value) == 2) {
            ...
            nameSpace.setNode(interfaceC3452);
            ...
            if (classNameSpace != null) {
                ...
                Interpreter.mainSecurityGuard.m14432(classInstance, strSuffix, objArr);
                if (C3486.f8289 == null) {
                    C3486.f8289 = new C3486();
                }
                C3486.f8289.getClass();
                Class<? super Object> superclass = cls2.getSuperclass();
                AbstractC3458 abstractC3458M5997 = AbstractC3500.m5997(classInstance.getClass(), This.Keys.BSHSUPER + superclass.getSimpleName() + strSuffix, AbstractC3495.m5956(objArr), false);
                return abstractC3458M5997 != null ? abstractC3458M5997.mo5877(classInstance, objArr) : AbstractC3500.m5988(classManager, superclass, classInstance, strSuffix, objArr, false).mo5877(classInstance, objArr);
            }
        }
        ...
        if (object instanceof C3479) {
            ...
            Class<?> cls3 = ((C3479) object).f8264;
            this.classOfStaticMethod = cls3;
            Interpreter.mainSecurityGuard.m14431(cls3, strSuffix, objArr);
            return AbstractC3500.m5993(classManager, cls3, strSuffix, objArr, interfaceC3452);
        }
        ...
        if (object.getClass().isEnum() && (nameSpaceM6004 = AbstractC3500.m6004(object)) != null && (method = nameSpaceM6004.getMethod(strSuffix, AbstractC3495.m5956(objArr), true)) != null) {
            return method.invoke(objArr, interpreter, callStack, interfaceC3452);
        }
        Interpreter.mainSecurityGuard.m14432(object, strSuffix, objArr);
        return AbstractC3500.m6007(object, strSuffix, objArr, interpreter, callStack, interfaceC3452);
    }
    ...
    public synchronized LHS toLHS(CallStack callStack, Interpreter interpreter) {
        try {
            ...
            if (str2 == null && (objConsumeNextObjectField instanceof C3479)) {
            ...
            if (!(objConsumeNextObjectField instanceof This)) {
                ...
                try {
                    if (objConsumeNextObjectField instanceof C3479) {
                        return AbstractC3500.m6011(((C3479) objConsumeNextObjectField).f8264, str2);
                    }
                    return AbstractC3500.m6019(objConsumeNextObjectField, str2);
                } catch (ReflectError unused) {
