...
public final class Primitive implements Serializable {
    ...
    public static Class<?> boxType(Class<?> cls) {
        ...
        C3466.m5902(AbstractC0900.m714(cls, "Not a primitive type: "));
        return null;
    }
    ...
    public static Object castNumber(Class<?> cls, Number number) {
        ...
        if (dDoubleValue == 0.0d) {
            ...
            if (cls == BigDecimal.class) {
                return number instanceof BigInteger ? new BigDecimal((BigInteger) number).setScale(1) : AbstractC3495.m5950(number) ? BigDecimal.valueOf(number.doubleValue()) : new BigDecimal(number.longValue()).setScale(1);
            }
            BigInteger bigInteger = number instanceof BigInteger ? (BigInteger) number : number instanceof BigDecimal ? ((BigDecimal) number).toBigInteger() : AbstractC3495.m5950(number) ? BigDecimal.valueOf(number.doubleValue()).toBigInteger() : BigInteger.valueOf(number.longValue());
    ...
    public static Primitive castPrimitive(Class<?> cls, Class<?> cls2, Primitive primitive, boolean z, int i) throws UtilEvalError {
        if (cls2 == Void.TYPE) {
            if (z) {
                return AbstractC3495.f8315;
            }
            throw AbstractC3495.m5935(AbstractC3462.m5885(cls), "void value", null, i);
        }
        if (!z && primitive.isNumber() && AbstractC3495.m5939(cls)) {
            return new Primitive(castNumber(cls, primitive.numberValue()));
        }
        if (cls.isPrimitive()) {
            if (cls2 == null && !VOID.equals(primitive)) {
                return z ? AbstractC3495.f8316 : getDefaultValue(cls);
            }
            Class<?> cls3 = Boolean.TYPE;
            return cls == cls3 ? z ? AbstractC3495.f8316 : new Primitive(castWrapper(cls, primitive)) : (z && cls2 == cls3) ? cls != cls3 ? AbstractC3495.f8315 : AbstractC3495.f8316 : (i != 1 || AbstractC3495.m5948(cls, cls2) || AbstractC3495.m5940(cls, cls2) || !z) ? z ? AbstractC3495.f8316 : new Primitive(castWrapper(cls, primitive)) : AbstractC3495.f8315;
        }
        if (cls2 == null) {
            return z ? AbstractC3495.f8316 : NULL;
        }
        if (z) {
            return AbstractC3495.f8315;
        }
        throw AbstractC3495.m5935("object type ".concat(cls.getName()), "primitive value", null, i);
    }
    ...
    public static Object castWrapper(Class<?> cls, Object obj) {
        ...
        if (!isWrapperType(cls) && !cls.isPrimitive()) {
            C3466.m5902(AbstractC0900.m714(cls, "invalid type in castWrapper: "));
            return null;
        }
        ...
        C3466.m5902("bad type in cast ".concat(AbstractC3462.m5889(objUnwrap) + " :" + AbstractC3462.m5888(objUnwrap)));
        return null;
    }
    ...
    public static Primitive shrinkWrap(Object obj) {
        if (!(obj instanceof Number)) {
            C3466.m5902("Can only shrink wrap Number types");
            return null;
        }
        Number number = (Number) obj;
        if (AbstractC3495.m5950(obj)) {
    ...
    public static Class<?> unboxType(Class<?> cls) {
        ...
        C3466.m5902(AbstractC0900.m714(cls, "Not a primitive wrapper type: "));
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (primitive.isNumber() && isNumber()) ? getType() == BigDecimal.class ? this.value.equals(castNumber(BigDecimal.class, primitive.numberValue())) : primitive.getType() == BigDecimal.class ? primitive.value.equals(castNumber(BigDecimal.class, numberValue())) : (AbstractC3495.m5950(this.value) || AbstractC3495.m5950(primitive.value)) ? numberValue().doubleValue() == primitive.numberValue().doubleValue() : getType() == BigInteger.class ? this.value.equals(castNumber(BigInteger.class, primitive.numberValue())) : primitive.getType() == BigInteger.class ? primitive.value.equals(castNumber(BigInteger.class, numberValue())) : numberValue().longValue() == primitive.numberValue().longValue() : this.value.equals(primitive.value);
    }
    ...
    public Object getValue() {
        ...
        C3466.m5902("attempt to unwrap void type");
        return null;
    }
    ...
    public boolean isNumber() {
        Object obj = this.value;
        return ((obj instanceof Boolean) || this == NULL || this == VOID || !AbstractC3495.m5943(obj)) ? false : true;
    }
    ...
    public Number numberValue() {
        ...
        C3466.m5902("Primitive not a number");
        return null;
    }
    ...
    private Primitive(Object obj) {
        if (obj != null) {
            ...
            C3466.m5902("Use Primitve.NULL instead of Primitive(null)");
            throw null;
        }
    }
