...
public class Modifiers implements Serializable, Cloneable {
    ...
    public void addModifier(int i) {
        if ((this.valid & i) == 0) {
            ...
            C6755.m11870(AbstractC0900.m711(sb, toModifier(i), "'"));
            return;
        }
        if (i < 7) {
            int i2 = this.modifiers;
            if ((i2 & 7) > 0 && (i2 | i) != i2) {
                C6755.m11870("public/private/protected cannot be used in combination.");
                return;
            }
        }
    ...
    private int toModifier(String str) {
        ...
        C6755.m11870(AbstractC0900.m718("Unknown modifier: '", str, "'"));
        return 0;
    }
