    ...
    public final boolean onClick(AbstractC4570 abstractC4570, View view) {
        ...
        switch (i) {
            case 0:
                break;
            case 1:
                ((C7188) obj2).f17858.m15236(Integer.valueOf(((Notice) obj).getVersion()), "lastNotice");
                break;
            case 2:
                C1754 c1754 = (C1754) obj;
                File file = new File(((C9523) obj2).f24861);
                if (file.exists() && file.delete()) {
                    AbstractC7014.m12151("删除成功");
                    c1754.invoke();
                }
                break;
            case 3:
                ...
                C9027 c9027M14267 = C9027.m14267("正在删除好友 (0/" + list.size() + ")...", 0.0f);
            ...
            default:
                ...
                C9027 c9027M142672 = C9027.m14267("正在退出群 (0/" + list2.size() + ")...", 0.0f);
