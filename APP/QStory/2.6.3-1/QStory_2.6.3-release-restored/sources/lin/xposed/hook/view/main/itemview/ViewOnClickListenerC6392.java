    ...
    public final void onClick(View view) {
        ...
        switch (this.f15678) {
            ...
            case 2:
                ...
                if (AbstractC7135.f17758.equals("/storage/emulated")) {
                    AbstractC7014.m12151("已是所能探索到的极限");
                    return;
                } else {
            ...
            case 4:
                ...
                if (c1520 != null) {
                    ...
                    if (!str2.equals("关闭")) {
                        ...
                        calendar.add(10, Integer.parseInt(str2.substring(0, str2.indexOf("小时"))));
                        c7217.f17897.m12395(Long.valueOf(calendar.getTimeInMillis()), "targetTime");
                        textView.setText("剩余 " + ((calendar.getTimeInMillis() - System.currentTimeMillis()) / 3600000) + "时");
                        StringBuilder sb = new StringBuilder();
                        sb.append("将在 ");
                        Date date = new Date(((Long) c7217.f17897.m12398("targetTime")).longValue());
                        String strM14531 = "MM-dd hh:mm";
                        try {
                            strConcat = new SimpleDateFormat(strM14531).format(date);
                        } catch (Exception unused) {
                            strConcat = "日期格式化失败 ".concat(strM14531);
                        }
                        sb.append(strConcat);
                        sb.append(" 结束");
                        ...
                        textView.setText("需要屏蔽通知的时长");
                        AbstractC7014.m12151("关闭了免打扰");
                    }
                    c7217.f17897.m12395(str2, "TaskName");
            ...
            case 5:
                ...
                new AlertDialog.Builder(context2, AbstractC7176.m12458(context2) ? 2 : 3).setTitle("创建新目录").setView(editText).setNeutralButton("确定创建", new DialogInterfaceOnClickListenerC7168(editText, radioGroup, context2, i)).show();
                return;
            case 6:
            ...
            case 7:
                ...
                if (AbstractC3888.m7256()) {
                    ...
                    try {
                        Object objM12418 = AbstractC7165.m12418(AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.PicElement"), "picElement", objCreateEmojiElement);
                        AbstractC7165.m12424(objM12418, "summary", "[动画表情]");
                        AbstractC7165.m12424(objM12418, "emojiFrom", 0);
                    ...
                    LegacyQQSendTool.setPicText(objBuilderPic, "[动画表情]");
            ...
            case 8:
                ...
                c72172.f17897 = new C7149("doNotDisturbData");
                DialogC7159 dialogC71592 = new DialogC7159(activity, new String[]{"24小时", "12小时", "8小时", "2小时", "关闭"});
                TextView textView2 = dialogC71592.f17789;
                Long l = (Long) c72172.f17897.m12398("targetTime");
                Date date2 = new Date();
                if (l == null || date2.getTime() > l.longValue()) {
                    C7149 c71492 = c72172.f17897;
                    c71492.getClass();
                    c71492.f17776 = new JSONObject();
                    c72172.f17897.m12395("关闭", "TaskName");
                    textView2.setText("需要屏蔽通知的时长");
                } else {
                    long jLongValue = l.longValue() - date2.getTime();
                    long j = jLongValue / 3600000;
                    textView2.setText("剩余 " + j + "时" + ((jLongValue - (3600000 * j)) / 60000) + "分");
                }
                dialogC71592.f17788 = (String) c72172.f17897.m12398("TaskName");
            ...
            case 13:
                ...
                C6703.m11833(c6703);
                AbstractC7014.m12151("MCP 配置已保存");
                if (c9062 != null) {
                    c9062.m14314();
                    return;
                }
            ...
            case 14:
                ...
                ((ClipboardManager) systemService).setPrimaryClip(ClipData.newPlainText("QStory MCP Config", str4));
                AbstractC7014.m12151("MCP 配置 JSON 已复制");
                return;
            case 15:
