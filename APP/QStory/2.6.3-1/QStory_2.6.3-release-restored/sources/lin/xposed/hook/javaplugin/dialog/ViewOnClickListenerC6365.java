    ...
    public final void onClick(View view) {
        switch (this.f15625) {
            ...
            case 9:
                ...
                editText2.setText(c9924.m15237("blacklistTroop", ""));
                editText3.setText(c9924.m15237("blacklistText", ""));
                editText4.setText(c9924.m15237("replyText", ""));
                editText5.setText(String.valueOf(Long.parseLong(String.valueOf(sharedPreferencesC9005.getInt("delayReply", 0)))));
                checkBox.setChecked(sharedPreferencesC9005.getBoolean("grabToast", true));
                checkBox2.setChecked(sharedPreferencesC9005.getBoolean("grabFailToast", false));
                checkBox3.setChecked(sharedPreferencesC9005.getBoolean("ordinary", true));
                checkBox4.setChecked(sharedPreferencesC9005.getBoolean("exclusiveRedEnvelopes", false));
                editText6.setText(String.valueOf(Long.parseLong(String.valueOf(sharedPreferencesC9005.getInt("expectAmount", 0)))));
            ...
            case 13:
                if (AbstractC5754.m10449(view.getContext(), AbstractC4765.m8874().concat("/Pic/"))) {
                    AbstractC7014.m12151("复制成功");
                    return;
                } else {
                    AbstractC7014.m12151("复制失败");
            ...
            case 14:
                AbstractC7014.m12151("可能点旁边的字会有什么反应呢");
                return;
            case 15:
                AbstractC7014.m12151("可能点旁边的字会有什么反应呢");
                return;
            case 16:
                if (AbstractC5754.m10449(view.getContext(), AbstractC1298.m1726().concat("需要检测群.json"))) {
                    AbstractC7014.m12151("复制成功");
                    return;
                } else {
                    AbstractC7014.m12151("复制失败");
            ...
            case 18:
                ...
                return;
            default:
                AbstractC7014.m12151("请使用新的红包功能 此功能已被弃用");
                return;
        }
    }
