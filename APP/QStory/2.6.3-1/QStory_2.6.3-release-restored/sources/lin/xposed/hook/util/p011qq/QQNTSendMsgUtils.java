...
public class QQNTSendMsgUtils {
    public static void forwardMsg(ArrayList<Long> arrayList, Object obj, ArrayList<Object> arrayList2) {
        ...
        Class clsM12425 = AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.IForwardOperateCallback");
        C7164 c7164M12413 = C7164.m12413(objM12146.getClass());
        Class[] clsArr = {ArrayList.class, AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.Contact"), ArrayList.class, ArrayList.class, clsM12425};
        C2080 c2080 = c7164M12413.f17803;
        c2080.f3964 = clsArr;
        c2080.f3962 = Void.TYPE;
        c7164M12413.f17803.f3963 = "forwardMsg";
    ...
    */
    ...
    public static void sendMsg(Object obj, ArrayList arrayList) {
        if (obj == null) {
            AbstractC7014.m12151("contact==null");
            return;
        }
        if (arrayList == null) {
            AbstractC7014.m12151("elementList==null");
            return;
        }
        Object objM12146 = AbstractC7012.m12146(965);
        C7164 c7164M12413 = C7164.m12413(objM12146.getClass());
        Class[] clsArr = {AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.Contact"), ArrayList.class, AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")};
        C2080 c2080 = c7164M12413.f17803;
        c2080.f3964 = clsArr;
        c2080.f3962 = Void.TYPE;
        c7164M12413.f17803.f3963 = "sendMsg";
        c7164M12413.m12415(objM12146, obj, arrayList, Proxy.newProxyInstance(AbstractC7166.f17805, new Class[]{AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")}, new InvocationHandler() { // from class: lin.xposed.hook.util.qq.QQNTSendMsgUtils.2
            @Override // java.lang.reflect.InvocationHandler
            public Object invoke(Object obj2, Method method, Object[] objArr) {
                return null;
            }
    ...
    public static void sendMsg(Object obj, ArrayList arrayList, final IOperateCallback iOperateCallback) {
        ...
        c2080.f3962 = Void.TYPE;
        c7164M12413.f17803.f3963 = "sendMsg";
        c7164M12413.m12415(objM12146, obj, arrayList, Proxy.newProxyInstance(AbstractC7166.f17805, new Class[]{AbstractC7166.m12425("com.tencent.qqnt.kernel.nativeinterface.IOperateCallback")}, new InvocationHandler() { // from class: lin.xposed.hook.util.qq.QQNTSendMsgUtils.3
            @Override // java.lang.reflect.InvocationHandler
            public Object invoke(Object obj2, Method method, Object[] objArr) {
