...
public final class CheckCommonGroup extends OtherViewItemInfo {
    ...
    private final void openCommonGroupPage(Context context, long uin) {
        try {
            Intent intent = new Intent(context, (Class<?>) AbstractC9919.f25822.loadClass("com.tencent.mobileqq.activity.QQBrowserDelegationActivity"));
            ...
            AbstractC7014.m12151("打开失败: " + e.getMessage());
        }
    }
