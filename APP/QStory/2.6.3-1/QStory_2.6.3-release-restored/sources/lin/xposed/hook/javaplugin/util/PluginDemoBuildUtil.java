...
public class PluginDemoBuildUtil {
    private final C7149 config = new C7149("DemoPlugin");
    ...
    private boolean compareFileMD5() {
        File file = new File(new File(AbstractC4765.m8874().concat("/Plugin"), "QS示例"), "main.java");
        if (file.exists()) {
    ...
    public void createDemoPlugin(Context context) {
        ...
        File file = new File(AbstractC4765.m8874().concat("/Plugin"), "QS示例");
        if (!file.exists()) {
            file.mkdirs();
        }
