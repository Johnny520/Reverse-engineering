...
public abstract class AbstractC6386 {
    ...
    public static void m11449(AbstractC7140 abstractC7140) {
        if (AbstractC7187.m12502()) {
            ...
            AbstractC5894.m10615(AbstractC4765.m8874().concat("/data/item_config.json"), InterfaceC3749.m6935(f15666), false);
        }
    }

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static void m11450() {
        if (!new File(AbstractC4765.m8874().concat("/data/item_config.json")).exists()) {
            m11449(null);
            AbstractC7014.m12151("配置文件已生成");
        }
        try {
            Map map = (Map) InterfaceC3749.m6930(AbstractC5894.m10587(AbstractC4765.m8874().concat("/data/item_config.json")), new C6387(), new JSONReader$Feature[0]);
            f15666 = map;
            ...
            AbstractC7014.m12151("[QStory]加载设置失败qwq " + e);
        }
    }
