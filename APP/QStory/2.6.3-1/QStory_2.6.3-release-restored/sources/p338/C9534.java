...
public final class C9534 extends AbstractC7140 {
    ...
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        while (true) {
            ...
            if (AbstractC5227.m9466(method.getName(), "needShowQzoneFrame") && method.getParameterCount() == 2 && AbstractC5227.m9466(method.getParameterTypes()[0], Context.class) && AbstractC5227.m9466(method.getParameterTypes()[1], clsLoadClass2)) {
                break;
            } else {
                i++;
            }
