...
public abstract class AbstractC9633 extends AbstractC7140 {
    ...
    public final Method f25121 = AbstractC3897.m7362("Lcom/tencent/mobileqq/pluginsdk/PluginStatic;->getOrCreateClassLoader(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/ClassLoader;");

    @Override // p042.AbstractC7143
    public final void startLoadHook() throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (AbstractC3897.m7362("Lcom/tencent/mobileqq/pluginsdk/IPluginAdapterProxy;->getProxy()Lcom/tencent/mobileqq/pluginsdk/IPluginAdapterProxy;").invoke(null, null) == null) {
            C9931 c9931 = new C9931();
            c9931.f25866.addAll(Arrays.asList("cooperation.plugin"));
            c9931.f25867.addAll(Arrays.asList("com.tencent.mobileqq.pluginsdk.IPluginAdapter"));
            Constructor<?>[] declaredConstructors = c9931.m15255().getDeclaredConstructors();
            "getDeclaredConstructors(...)";
            declaredConstructors.getClass();
            AbstractC3897.m7362("Lcom/tencent/mobileqq/pluginsdk/IPluginAdapterProxy;->setProxy(Lcom/tencent/mobileqq/pluginsdk/IPluginAdapter;)V").invoke(null, ((Constructor) AbstractC5179.m9384(declaredConstructors)).newInstance(null));
        }
