    ...
    public final void run() {
        ...
        switch (i) {
            case 0:
                ...
                try {
                    if (((AbstractC8482.m13479(context, "android.permission.ACCESS_FINE_LOCATION") == 0 || AbstractC8482.m13479(context, "android.permission.ACCESS_COARSE_LOCATION") == 0) ? 1 : 0) == 0) {
                        return;
                    }
                ...
                for (final String str : list) {
                    ...
                    handler3.post(new Runnable() { // from class: 飘花落叶言苏哲楪子兰世.飘花落叶言子楪世苏兰哲
                        ...
                        public final void run() {
                            ...
                            switch (i6) {
                                case 0:
                                    C9027.m14267("正在删除好友 (" + (i7 + 1) + '/' + list2.size() + ")\nQQ号: " + str2, f);
                                    break;
                                default:
                                    C9027.m14267("正在退出群 (" + (i7 + 1) + '/' + list2.size() + ")\n群号: " + str2, f);
                                    break;
                            }
                        }
                    });
            ...
            case 5:
                ...
                if (arrayList.isEmpty()) {
                    AbstractC9040.m14294("群列表为空", WaitDialog$TYPE.WARNING);
                    return;
                }
                C9037 c9037 = new C9037();
                c9037.f22959 = "批量管理群 (" + arrayList.size() + ')';
                c9037.mo14280();
                c9037.f22971 = "勾选需要退出的群（我创建的群不可勾选）";
                c9037.mo14280();
                c9037.mo14279(true);
                ...
                while (true) {
                    ...
                    handler4.post(new Runnable() { // from class: 飘花落叶言苏哲楪子兰世.飘花落叶言子楪世苏兰哲
                        ...
                        public final void run() {
                            ...
                            switch (i62) {
                                case 0:
                                    C9027.m14267("正在删除好友 (" + (i72 + 1) + '/' + list22.size() + ")\nQQ号: " + str22, f);
                                    break;
                                default:
                                    C9027.m14267("正在退出群 (" + (i72 + 1) + '/' + list22.size() + ")\n群号: " + str22, f);
                                    break;
                            }
                        }
                    });
