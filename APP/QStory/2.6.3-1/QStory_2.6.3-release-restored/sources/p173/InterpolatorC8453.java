...
public final class InterpolatorC8453 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = this.f21005;
        int iMin = Math.min((int) ((fArr.length - 1) * f), fArr.length - 2);
        float f2 = this.f21004;
        float f3 = (f - (iMin * f2)) / f2;
        float f4 = fArr[iMin];
        return AbstractC0900.m706(fArr[iMin + 1], f4, f3, f4);
    }

    public InterpolatorC8453(float[] fArr) {
        this.f21005 = fArr;
        this.f21004 = 1.0f / (fArr.length - 1);
    }
}
