...
public class C7226 extends AbstractC7140 implements InterfaceC7146 {
    ...
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        Class<?> clsLoadClass = classLoader.loadClass("com.tencent.mobileqq.springhb.entry.module.SpringTabBannerModule");
        Class<?> clsLoadClass2 = classLoader.loadClass("com.tencent.mobileqq.springhb.entry.model.MsgTabBannerData");
    ...
    public final void mo11795(C3902 c3902) {
        this.f17905 = c3902.m7449("onMsgTabBannerHide");
    }

    @Override // p043.InterfaceC7146
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰 */
    public final void mo11796(C3902 c3902) {
        for (Method method : C3902.m7446("onMsgTabBannerHide")) {
            if (method.getDeclaringClass().getName().equals("com.tencent.mobileqq.springhb.entry.module.SpringTabBannerModule")) {
                this.f17905 = method;
                c3902.m7447(this.f17905, "onMsgTabBannerHide");
                return;
            }
        }
    }
