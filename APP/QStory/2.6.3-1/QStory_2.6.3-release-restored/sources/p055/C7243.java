...
public class C7243 extends AbstractC7140 {
    ...
    public static final String f17939 = AbstractC4765.m8874().concat("/Voice/");

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public static final String f17938 = AbstractC4765.m8874().concat("/voice_icon.png");
    ...
    public static Drawable m12529() {
        ...
        if (new File(str).exists()) {
            ...
            f17937 = AbstractC4765.m8862(AbstractC7187.f17852, str);
            AbstractC7014.m12151("语音图标初始化完成");
        }
        return f17937;
    }
