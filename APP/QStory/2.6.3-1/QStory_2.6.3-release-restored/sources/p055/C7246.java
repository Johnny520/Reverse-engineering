    ...
    public final void mo2039(XC_MethodHook.MethodHookParam methodHookParam) throws IllegalAccessException, InvocationTargetException {
        ...
        switch (i) {
            case 0:
                ...
                int iIntValue = ((Integer) AbstractC7165.m12418(Integer.TYPE, "chatType", objM12415)).intValue();
                ArrayList arrayList = (ArrayList) AbstractC7165.m12418(ArrayList.class, "elements", objM12415);
                ...
                for (Object obj : arrayList) {
                    ...
                    if (objM124152 != null) {
                        arrayList3.add(((String) AbstractC7165.m12418(String.class, "md5HexStr", objM124152)).toUpperCase());
                        arrayList2.add(QQMessageUtils.getPicElementUrl(iIntValue, objM124152));
                    }
                }
                ((List) methodHookParam.getResult()).add(0, C7206.m12520(objInvoke, "保存到QS", C0328R.mipmap.ic_launcher_round, new CallableC7249(arrayList2, arrayList3, 1)));
                break;
            default:
                ...
                Object objM12520 = C7206.m12520(objInvoke2, "保存到QS", C0328R.mipmap.ic_launcher_round, new CallableC9526(c7164M124133.m12415(objInvoke2, new Object[0]), i2));
