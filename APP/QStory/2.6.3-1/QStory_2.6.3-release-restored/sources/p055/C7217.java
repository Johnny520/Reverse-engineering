...
public class C7217 extends AbstractC7140 {
    ...
    */
    public final void loadHook(ClassLoader classLoader) throws ClassNotFoundException {
        ...
        try {
            try {
                C7164 c7164M12412 = C7164.m12412("com.tencent.mobileqq.activity.home.Conversation");
                String strM14532 = "initUI";
                ...
                m12389(c7164M12412.m12414(), new InterfaceC7141(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世兰楪苏哲
                    ...
                    public final void mo2039(XC_MethodHook.MethodHookParam methodHookParam) {
                        ...
                        switch (i2) {
                            case 0:
                                c7217.m12523((ImageView) AbstractC7165.m12418(ImageView.class, "openSession", methodHookParam.thisObject));
                                break;
                            case 1:
                            ...
                            default:
                                if (c7217.f17897 == null) {
                                    c7217.f17897 = new C7149("doNotDisturbData");
                                }
                                Long l = (Long) c7217.f17897.m12398("targetTime");
                ...
                m12390(NotificationManager.class.getMethod("notify", cls3, Notification.class), new InterfaceC7141(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世兰楪苏哲
            ...
            C7164 c7164M124122 = C7164.m12412("com.tencent.mobileqq.activity.home.Conversation");
            String strM14531 = "onResume";
            ...
            m12390(NotificationManager.class.getMethod("notify", cls32, Notification.class), new InterfaceC7141(this) { // from class: 飘花落叶言世哲楪苏子兰.飘花落叶言子世兰楪苏哲
