...
public final /* synthetic */ class C9679 implements InterfaceC7908 {
    ...
    static {
        ...
        f25297 = c9679;
        C7958 c7958 = new C7958("top.suzhelan.qstory.hook.service.proto.OIDBSSOPkg", c9679, 5);
        c7958.m12968("command", true);
        c7958.m12967(new C9680(1, 0));
        c7958.m12968("serviceType", true);
        c7958.m12967(new C9680(2, 0));
        c7958.m12968("result", true);
        c7958.m12967(new C9680(3, 0));
        c7958.m12968("bodybuffer", true);
        c7958.m12967(new C9680(4, 0));
        c7958.m12968("errorCode", true);
