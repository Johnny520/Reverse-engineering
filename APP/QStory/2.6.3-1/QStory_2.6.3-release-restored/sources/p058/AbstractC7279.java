...
public abstract class AbstractC7279 {
    ...
    public static void m12541(final String str, final String str2, final String str3, final String str4, final String str5) {
        ...
        XposedHelpers.callMethod(intentM7313, "setObserver", new Class[]{AbstractC7166.m12425("mqq.observer.BusinessObserver")}, new Object[]{Proxy.newProxyInstance(AbstractC7166.f17805, new Class[]{AbstractC7166.m12425("mqq.observer.BusinessObserver")}, new InvocationHandler() { // from class: 飘花落叶言世哲苏子兰楪.飘花落叶言子楪世苏哲兰
            ...
            public final Object invoke(Object obj, Method method, Object[] objArr) throws JSONException {
                ...
                XposedHelpers.callMethod(objM68462, "mergeFrom", new Class[]{byte[].class}, new Object[]{byteArray});
