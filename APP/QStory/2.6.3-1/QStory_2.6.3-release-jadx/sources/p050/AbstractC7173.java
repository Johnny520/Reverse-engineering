...
public abstract class AbstractC7173 {
    ...
    */
    ...
    public static String m12445(String str) throws CertificateEncodingException {
        ...
        JarEntry jarEntry = jarFile.getJarEntry(AbstractC9234.m14531(49));
        ...
        try {
            byte[] bArrDigest = MessageDigest.getInstance(AbstractC9234.m14532("喵喵呜呜呜呜呜喵~喵喵呜呜喵喵喵呜~喵呜喵喵呜呜呜呜")).digest(encoded);
            StringBuilder sb = new StringBuilder();
