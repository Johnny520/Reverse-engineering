...
@InterfaceC7691(m555c = "top.yukonga.miuix.kmp.basic.SliderKt$Slider$6$1", m556f = "Slider.kt", m557l = {}, m558m = "invokeSuspend", m559v = 2)
...
final class SliderKt$Slider$6$1 extends SuspendLambda implements InterfaceC7380 {
    final /* synthetic */ InterfaceC2232 $dragOffset$delegate;
    final /* synthetic */ boolean $effectiveReverseDirection;
    final /* synthetic */ InterfaceC7387 $fractionToValue;
    ...
    public SliderKt$Slider$6$1(boolean z, InterfaceC7387 interfaceC7387, AbstractC6827 abstractC6827, InterfaceC2230 interfaceC2230, InterfaceC2232 interfaceC2232, InterfaceC2233 interfaceC2233, InterfaceC2233 interfaceC22332, InterfaceC2168 interfaceC2168, InterfaceC5189<? super SliderKt$Slider$6$1> interfaceC5189) {
        super(3, interfaceC5189);
        this.$effectiveReverseDirection = z;
        this.$fractionToValue = interfaceC7387;
        this.$isDragging$delegate = interfaceC2230;
        this.$dragOffset$delegate = interfaceC2232;
        this.$layoutWidth$delegate = interfaceC2233;
        this.$layoutHeight$delegate = interfaceC22332;
        this.$onValueChangeState$delegate = interfaceC2168;
    }

    @Override // p068.InterfaceC7380
    public /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
        return m11936invoked4ec7I((InterfaceC6233) obj, ((C8158) obj2).f19886, (InterfaceC5189) obj3);
    }

    /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
    public final Object m11936invoked4ec7I(InterfaceC6233 interfaceC6233, long j, InterfaceC5189<? super C6008> interfaceC5189) {
        SliderKt$Slider$6$1 sliderKt$Slider$6$1 = new SliderKt$Slider$6$1(this.$effectiveReverseDirection, this.$fractionToValue, null, this.$isDragging$delegate, this.$dragOffset$delegate, this.$layoutWidth$delegate, this.$layoutHeight$delegate, this.$onValueChangeState$delegate, interfaceC5189);
        sliderKt$Slider$6$1.J$0 = j;
        return sliderKt$Slider$6$1.invokeSuspend(C6008.f15084);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ((InterfaceC7387) this.$onValueChangeState$delegate.getValue()).invoke(new Float(((Number) this.$fractionToValue.invoke(new Float(fM5631))).floatValue()));
        throw null;
    }
}
