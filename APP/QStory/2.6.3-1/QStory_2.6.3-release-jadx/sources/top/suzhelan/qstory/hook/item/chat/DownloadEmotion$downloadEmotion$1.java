    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                next.getClass();
                String str = next;
                File file = new File(externalStoragePublicDirectory + AbstractC9234.m14532("喵呜喵呜呜呜喵喵~喵喵呜喵喵呜喵喵~喵喵呜喵呜喵呜呜"), arrayList2.get(arrayList.indexOf(str)) + AbstractC3898.m7414(str));
                if (file.exists()) {
                    file.delete();
                }
        ...
        if (Result.m9307exceptionOrNullimpl(objM723) != null) {
            AbstractC9040.m14294(AbstractC9234.m14531(2164), WaitDialog$TYPE.ERROR);
        }
        if (Result.m9311isSuccessimpl(objM723)) {
            AbstractC9040.m14295(AbstractC9234.m14531(2165), WaitDialog$TYPE.SUCCESS, 500L);
        }
        return c6008;
    }
