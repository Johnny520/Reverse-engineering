        ...
        switch (i) {
            case 0:
                if (this.f16487.f17770.booleanValue() && (result = methodHookParam.getResult()) != null) {
                    try {
                        try {
                            XposedHelpers.setIntField(result, AbstractC9234.m14531(2049), 0);
                        } catch (NoSuchFieldError unused) {
                            XposedHelpers.setLongField(result, AbstractC9234.m14531(2049), 0L);
                        }
            ...
            default:
                if (this.f16487.f17770.booleanValue()) {
                    ...
                    if (AbstractC5227.m9466(str, AbstractC9234.m14531(1888)) && classLoader != null && !this.f16487.f16486) {
                        this.f16487.f16486 = true;
                        C6778 c6778 = this.f16487;
                        try {
                            Class clsFindClassIfExists = XposedHelpers.findClassIfExists(AbstractC9234.m14531(2052), classLoader);
                            if (clsFindClassIfExists != null) {
                                ...
                                for (Method method : declaredMethods) {
                                    ...
                                    if (method.getReturnType().getName().equals(AbstractC9234.m14531(2053)) && parameterTypes.length == 2) {
