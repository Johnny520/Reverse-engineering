...
public final class C6678 extends AbstractC7140 {
    ...
    public final void loadHook(ClassLoader classLoader) {
        ...
        try {
            Method[] declaredMethods = AbstractC7166.m12425(AbstractC9234.m14531(Opcodes.REM_INT_LIT16)).getDeclaredMethods();
            ...
            for (Method method2 : declaredMethods) {
                ...
                if (AbstractC5227.m9466(returnType, cls) && Arrays.equals(method2.getParameterTypes(), new Class[]{cls})) {
                    if (z) {
                        throw new IllegalArgumentException(AbstractC9234.m14531(2141));
                    }
                    z = true;
                    method = method2;
                }
            ...
            if (!z) {
                throw new NoSuchElementException(AbstractC9234.m14531(2142));
            }
