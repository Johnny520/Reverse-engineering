...
public final class C6707 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        switch (this.f16396) {
            case 0:
                if (((C6783) this.f16394).f17770.booleanValue() && String.valueOf(editable).equals(AbstractC9234.m14531(1939))) {
    ...
    public final void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        switch (i4) {
            ...
            case 1:
                ...
                c9706.getClass();
                AbstractC9234.m14532("喵喵喵喵喵喵呜喵~喵喵喵喵喵喵喵喵~喵喵喵呜呜呜呜呜~喵喵喵呜呜喵呜喵~喵喵喵呜呜呜喵喵");
