    ...
    public final boolean mo8621(AbstractC4570 abstractC4570, View view, String str) {
        ...
        switch (i) {
            case 0:
                ...
                if (length != 0) {
                    c9924.m15236(string, AbstractC9234.m14531(2153));
                    AbstractC7014.m12151(AbstractC9234.m14531(2159).concat(string));
                } else {
                    c9924.m15236(AbstractC9234.m14531(2154), AbstractC9234.m14531(2153));
                    AbstractC7014.m12151(AbstractC9234.m14531(2158));
                }
                break;
            default:
                ...
                if (str.length() != 0) {
                    ...
                    if (file.exists()) {
                        C9041.m14296(AbstractC9234.m14531(2746)).m14300();
                    } else if (file.mkdirs()) {
                        C9041.m14296(AbstractC9234.m14531(2747).concat(str)).m14299();
                        c7897.invoke(str);
                    }
                } else {
                    C9041.m14296(AbstractC9234.m14531(2745)).m14300();
                }
                break;
        }
        return false;
