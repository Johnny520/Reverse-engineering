...
public final /* data */ class StickerListResponse {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC5227.m9466(this.list, stickerListResponse.list) && this.total == stickerListResponse.total && this.page == stickerListResponse.page && this.pageSize == stickerListResponse.pageSize;
    }
    ...
    public int hashCode() {
        return Integer.hashCode(this.pageSize) + AbstractC0900.m704(this.page, AbstractC0900.m704(this.total, this.list.hashCode() * 31, 31), 31);
    }
