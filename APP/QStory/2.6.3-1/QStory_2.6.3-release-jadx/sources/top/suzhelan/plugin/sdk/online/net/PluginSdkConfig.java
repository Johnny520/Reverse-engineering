...
public final class PluginSdkConfig {
    ...
    private static String DOWNLOAD_DIR = AbstractC0900.m696(Environment.getExternalStorageDirectory().getAbsolutePath(), "/Download");
    private static String INSTALL_DIR = AbstractC0900.m696(Environment.getExternalStorageDirectory().getAbsolutePath(), "/Download");
