            ...
            case 16:
                ...
                try {
                    ...
                    if (obj instanceof Activity) {
                        ...
                        Method declaredMethod = obj.getClass().getDeclaredMethod(AbstractC9234.m14531(82), null);
                        declaredMethod.setAccessible(true);
                        activity = (Activity) declaredMethod.invoke(methodHookParam.thisObject, null);
                    }
                    Class<?> clsM12425 = AbstractC7166.m12425(AbstractC9234.m14531(83));
                        ...
                        if (field.getType() == clsM12425) {
                            try {
                                ...
                                if (viewGroup instanceof LinearLayout) {
                                    if (viewGroup != null) {
                                        throw new RuntimeException(AbstractC9234.m14531(85));
                                    }
                                    View view2 = (View) clsM12425.getConstructor(Context.class).newInstance(activity);
                                    clsM12425.getDeclaredMethod(AbstractC9234.m14531(86), CharSequence.class).invoke(view2, activity.getString(C0328R.string.app_name));
                                    clsM12425.getDeclaredMethod(AbstractC9234.m14531(87), CharSequence.class).invoke(view2, AbstractC9234.m14532("喵呜喵喵呜呜喵呜"));
                                    view2.setOnClickListener(new ViewOnClickListenerC7127(activity, i2));
                                    viewGroup.addView(view2, 0);
                                    return;
                                }
                            } catch (Exception e2) {
                                throw new RuntimeException(AbstractC9234.m14531(84) + e2);
                            }
                        }
                    }
                    if (viewGroup != null) {
                    ...
                    C3466.m5899(AbstractC9234.m14531(88).concat(AbstractC7017.m12161(e3)));
                    return;
                }
                break;
            case 17:
