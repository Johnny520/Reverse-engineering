...
public final class C1187 implements InterfaceC1181 {

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public final float f1495;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世苏哲, reason: contains not printable characters */
    public final float f1496;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏世哲, reason: contains not printable characters */
    public final float f1497;
    ...
    public final float f1500;

    public C1187(float f, float f2, float f3, float f4) {
        int iM3436;
        this.f1500 = f;
        this.f1498 = f2;
        this.f1499 = f3;
        ...
        if (!((Float.isNaN(f) || Float.isNaN(f2) || Float.isNaN(f3) || Float.isNaN(f4)) ? false : true)) {
            AbstractC1146.m1489("Parameters to CubicBezierEasing cannot be NaN. Actual parameters are: " + f + ", " + f2 + ", " + f3 + ", " + f4 + TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
        }
        ...
        double d5 = (d - d4) + d3;
        if (d5 == 0.0d) {
            iM3436 = d2 == d3 ? 0 : AbstractC2416.m3436((float) ((d4 - d3) / (d4 - (d3 * 2.0d))), fArr, 0);
        } else {
            double d6 = -Math.sqrt((d2 * d2) - (d3 * d));
            double d7 = (-d) + d2;
            int iM34362 = AbstractC2416.m3436((float) ((-(d6 + d7)) / d5), fArr, 0);
            int iM34363 = AbstractC2416.m3436((float) ((d6 - d7) / d5), fArr, iM34362) + iM34362;
            if (iM34363 > 1) {
                float f8 = fArr[0];
                float f9 = fArr[1];
                if (f8 > f9) {
        ...
        int iM34364 = AbstractC2416.m3436((-f10) / (((f7 - f6) * 2.0f) - f10), fArr, iM3436) + iM3436;
        float fMin = Math.min(0.0f, 1.0f);
        float fMax = Math.max(0.0f, 1.0f);
        for (int i = 0; i < iM34364; i++) {
            float f11 = fArr[i];
        ...
        this.f1495 = Float.intBitsToFloat((int) (jFloatToRawIntBits >> 32));
        this.f1497 = Float.intBitsToFloat((int) (jFloatToRawIntBits & 4294967295L));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f1500 == c1187.f1500 && this.f1498 == c1187.f1498 && this.f1499 == c1187.f1499 && this.f1496 == c1187.f1496;
    }

    public final int hashCode() {
        return Float.hashCode(this.f1496) + AbstractC0900.m705(AbstractC0900.m705(Float.hashCode(this.f1500) * 31, this.f1498, 31), this.f1499, 31);
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("CubicBezierEasing(a=");
        sb.append(this.f1500);
        sb.append(", b=");
        sb.append(this.f1498);
        sb.append(", c=");
        sb.append(this.f1499);
        sb.append(", d=");
        return AbstractC0900.m715(sb, this.f1496, ')');
    }
  ...
  0x0162: PHI (r12v41 float) = (r12v25 float), (r12v36 float) binds: [B:68:0x0160, B:81:0x0191] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final float mo1411(float f) {
        float f2;
        if (f <= 0.0f || f >= 1.0f) {
            return f;
        }
        ...
        if (Math.abs(d4 - 0.0d) >= 1.0E-7d) {
            ...
            if (d11 < 0.0d) {
                ...
                double dM7280 = AbstractC3888.m7280((float) dSqrt) * 2.0f;
                float fCos = (float) ((Math.cos(dAcos / 3.0d) * dM7280) - d12);
                ...
                if (Float.isNaN(f10)) {
                    float fCos2 = (float) ((Math.cos((6.283185307179586d + dAcos) / 3.0d) * dM7280) - d12);
                    ...
                    if (Float.isNaN(f10)) {
                        float fCos3 = (float) ((Math.cos((dAcos + 12.566370614359172d) / 3.0d) * dM7280) - d12);
                        if (fCos3 >= 0.0f) {
                            f8 = fCos3;
                        }
                        f2 = f8 > 1.0f ? 1.0f : f8;
                ...
                float f11 = -AbstractC3888.m7280((float) d9);
                float f12 = (float) d12;
                ...
                float fM7280 = (float) (((double) (AbstractC3888.m7280((float) ((-d9) + dSqrt2)) - AbstractC3888.m7280((float) (d9 + dSqrt2)))) - d12);
                if (fM7280 >= 0.0f) {
                    f8 = fM7280;
                }
                f2 = f8 > 1.0f ? 1.0f : f8;
                if (Math.abs(f2 - fM7280) <= 1.05E-6f) {
                }
            }
        ...
        float f20 = this.f1496;
        float f21 = this.f1498;
        if (!zIsNaN) {
            float f22 = ((((((f21 - f20) + 0.33333334f) * f9) + (f20 - (2.0f * f21))) * f9) + f21) * 3.0f * f9;
            float f23 = this.f1495;
            if (f22 < f23) {
                f22 = f23;
            }
            float f24 = this.f1497;
