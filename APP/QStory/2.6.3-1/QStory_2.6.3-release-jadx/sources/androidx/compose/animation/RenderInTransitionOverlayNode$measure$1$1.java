...
final class RenderInTransitionOverlayNode$measure$1$1 extends Lambda implements InterfaceC7387 {
    final /* synthetic */ InterfaceC2488 $this_measure;
    final /* synthetic */ AbstractC2559 $this_run;
    final /* synthetic */ AbstractC1225 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RenderInTransitionOverlayNode$measure$1$1(InterfaceC2488 interfaceC2488, AbstractC1225 abstractC1225, AbstractC2559 abstractC2559) {
        super(1);
        this.$this_measure = interfaceC2488;
        this.$this_run = abstractC2559;
    }

    public final void invoke(AbstractC2543 abstractC2543) {
        if (!this.$this_measure.mo2057()) {
            throw null;
        }
        abstractC2543.m3695(this.$this_run, 0, 0, 0.0f);
    }
