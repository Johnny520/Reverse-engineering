        ...
        switch (this.f7295) {
            ...
            case 4:
                ...
                try {
                    ...
                    String string = jSONObjectM6934.getString(AbstractC9234.m14531(477));
                    c9636.f25136 = string;
                    if (string == null) {
                        return;
                    }
                    long j = Long.parseLong(String.valueOf(c6758.f16461.m12399(0, AbstractC9234.m14531(1060))));
                    if (j > 0) {
                        JSONObject jSONObject = jSONObjectM6934.getJSONObject(AbstractC9234.m14531(478));
                        if (Integer.parseInt(jSONObject.getString(AbstractC9234.m14531(1079))) / Integer.parseInt(jSONObject.getString(AbstractC9234.m14531(1078))) < j) {
                            return;
                        }
                    }
                    TimeUnit.MILLISECONDS.sleep(Long.parseLong(String.valueOf(c6758.f16461.m12399(0, AbstractC9234.m14532("喵喵喵呜喵呜呜呜~喵喵喵呜喵喵喵喵~喵喵喵呜喵呜呜喵~喵喵喵喵呜喵喵呜~喵喵喵呜呜呜喵喵")))));
            ...
            case 9:
                ...
                try {
                    AbstractC7165.m12422(obj, AbstractC9234.m14532("喵喵呜呜呜喵呜喵"), Boolean.TYPE, Boolean.TRUE);
                    method.invoke(obj, null);
                    return;
                } catch (Exception e2) {
                    AbstractC7014.m12151(AbstractC9234.m14531(260) + e2);
            ...
            case 12:
                ...
                if (((ArrayList) ref$ObjectRef.element).isEmpty()) {
                    AbstractC9040.m14294(AbstractC9234.m14531(3110), WaitDialog$TYPE.WARNING);
                    return;
                }
                ArrayList arrayList = (ArrayList) ref$ObjectRef.element;
                Map map = (Map) ref$ObjectRef2.element;
                C9037 c9037 = new C9037();
                c9037.f22959 = AbstractC9234.m14531(3102) + arrayList.size() + ')';
                c9037.mo14280();
                c9037.f22971 = AbstractC9234.m14531(3103);
                c9037.mo14280();
                c9037.mo14279(true);
