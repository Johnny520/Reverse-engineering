...
public final class JvmProtoBuf$JvmMethodSignature extends GeneratedMessageLite implements InterfaceC5532 {
    public static InterfaceC5531 PARSER = new C7746(1);
    ...
    private JvmProtoBuf$JvmMethodSignature(C5541 c5541, C5558 c5558) {
    ...
    public static C7744 newBuilder(JvmProtoBuf$JvmMethodSignature jvmProtoBuf$JvmMethodSignature) {
        C7744 c7744NewBuilder = newBuilder();
        c7744NewBuilder.m12767(jvmProtoBuf$JvmMethodSignature);
        return c7744NewBuilder;
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite, kotlin.reflect.jvm.internal.impl.protobuf.InterfaceC5533
    public C7744 newBuilderForType() {
        return newBuilder();
    }

    @Override // kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite, kotlin.reflect.jvm.internal.impl.protobuf.InterfaceC5533
    public C7744 toBuilder() {
        return newBuilder(this);
    }

    public static C7744 newBuilder() {
        return new C7744();
    }

    private JvmProtoBuf$JvmMethodSignature(AbstractC5561 abstractC5561) {
        super(abstractC5561);
        this.memoizedIsInitialized = (byte) -1;
        this.memoizedSerializedSize = -1;
