...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, InterfaceC7392 {
    ...
    private final void compact(boolean updateHashArray) {
        ...
        AbstractC9004.m14187(this.keysArray, i3, i);
        if (vArr != null) {
            AbstractC9004.m14187(vArr, i3, this.length);
        }
        this.length = i3;
    }
    ...
    private final void ensureCapacity(int minCapacity) {
        ...
        if (minCapacity > getCapacity$kotlin_stdlib()) {
            ...
            int capacity$kotlin_stdlib = getCapacity$kotlin_stdlib();
            c5165.getClass();
            int iM9320 = C5165.m9320(capacity$kotlin_stdlib, minCapacity);
            K[] kArr = this.keysArray;
            kArr.getClass();
            this.keysArray = (K[]) Arrays.copyOf(kArr, iM9320);
            V[] vArr = this.valuesArray;
            this.valuesArray = vArr != null ? (V[]) Arrays.copyOf(vArr, iM9320) : null;
            this.presenceArray = Arrays.copyOf(this.presenceArray, iM9320);
            Companion.getClass();
            if (iM9320 < 1) {
                iM9320 = 1;
            }
            int iHighestOneBit = Integer.highestOneBit(iM9320 * 3);
    ...
    private final int findKey(K key) {
        ...
        while (true) {
            ...
            int i3 = i2 - 1;
            if (AbstractC5227.m9466(this.keysArray[i3], key)) {
                return i3;
            }
            i--;
            if (i < 0) {
    ...
    private final int findValue(V value) {
        ...
        while (true) {
            ...
            if (this.presenceArray[i] >= 0) {
                V[] vArr = this.valuesArray;
                vArr.getClass();
                if (AbstractC5227.m9466(vArr[i], value)) {
                    return i;
                }
            }
        }
    ...
    private final boolean putEntry(Map.Entry<? extends K, ? extends V> entry) {
        ...
        if (AbstractC5227.m9466(entry.getValue(), vArrAllocateValuesArray[i])) {
            return false;
        }
    ...
    private final void rehash(int newHashSize) {
        ...
        while (i < this.length) {
            int i2 = i + 1;
            if (!putRehash(i)) {
                C6755.m11870("This cannot happen with fixed magic multiplier and grow-only hash array. Have object hashCodes changed?");
                return;
            }
            i = i2;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i3 == 0) {
                    ...
                    if (AbstractC5227.m9466(this.keysArray[i3 - 1], key)) {
                        return -i3;
                    }
                    i2++;
                    if (i2 > i) {
    ...
    public void clear() {
        ...
        AbstractC9004.m14187(this.keysArray, 0, this.length);
        V[] vArr = this.valuesArray;
        if (vArr != null) {
            AbstractC9004.m14187(vArr, 0, this.length);
        }
        this.size = 0;
        this.length = 0;
        registerModification();
    ...
    public final boolean containsEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        ...
        V[] vArr = this.valuesArray;
        vArr.getClass();
        return AbstractC5227.m9466(vArr[iFindKey], entry.getValue());
    }
    ...
    public final C5147 entriesIterator$kotlin_stdlib() {
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        C5152 c5152 = this.entriesView;
        if (c5152 != null) {
            return c5152;
        }
        C5152 c51522 = new C5152(this);
        this.entriesView = c51522;
        return c51522;
    }

    public Set<K> getKeys() {
        C5156 c5156 = this.keysView;
        if (c5156 != null) {
            return c5156;
        }
        C5156 c51562 = new C5156(this);
        this.keysView = c51562;
        return c51562;
    }
    ...
    public Collection<V> getValues() {
        C5157 c5157 = this.valuesView;
        if (c5157 != null) {
            return c5157;
        }
        C5157 c51572 = new C5157(this);
        this.valuesView = c51572;
        return c51572;
    }

    @Override // java.util.Map
    public int hashCode() {
        C5147 c5147EntriesIterator$kotlin_stdlib = entriesIterator$kotlin_stdlib();
        int i = 0;
        while (c5147EntriesIterator$kotlin_stdlib.hasNext()) {
            int i2 = c5147EntriesIterator$kotlin_stdlib.f6812;
            MapBuilder mapBuilder = (MapBuilder) c5147EntriesIterator$kotlin_stdlib.f6809;
            if (i2 >= mapBuilder.length) {
                C3466.m5896();
                return 0;
            }
            int i3 = c5147EntriesIterator$kotlin_stdlib.f6812;
            c5147EntriesIterator$kotlin_stdlib.f6812 = i3 + 1;
            c5147EntriesIterator$kotlin_stdlib.f6810 = i3;
            Object obj = mapBuilder.keysArray[c5147EntriesIterator$kotlin_stdlib.f6810];
            int iHashCode = obj != null ? obj.hashCode() : 0;
            Object[] objArr = mapBuilder.valuesArray;
            objArr.getClass();
            Object obj2 = objArr[c5147EntriesIterator$kotlin_stdlib.f6810];
            int iHashCode2 = obj2 != null ? obj2.hashCode() : 0;
            c5147EntriesIterator$kotlin_stdlib.m4557();
    ...
    public final C5145 keysIterator$kotlin_stdlib() {
        return new C5145(this);
    }
    ...
    public final boolean removeEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        ...
        V[] vArr = this.valuesArray;
        vArr.getClass();
        if (!AbstractC5227.m9466(vArr[iFindKey], entry.getValue())) {
            return false;
        }
        removeEntryAt(iFindKey);
        return true;
    ...
    public final C5153 valuesIterator$kotlin_stdlib() {
