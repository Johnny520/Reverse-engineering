...
public final class C3535 extends AbstractC9193 implements InterfaceC3621 {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public static final C3535 f8547 = new C3535(null, null);
    ...
    public final Object mo6023(AbstractC3732 abstractC3732, Type type, Object obj, long j) {
        ...
        if (zMo6741) {
            ...
            return OffsetTime.of(LocalDateTime.ofInstant(instantOfEpochMilli, zoneIdM6969).toLocalTime(), zoneIdM6969.getRules().getOffset(instantOfEpochMilli));
        }
        if (abstractC3732.mo6679()) {
            return null;
        }
        if (this.f23415 == null) {
            return abstractC3732.mo6747();
        }
        ...
        if (this.f23413 || z) {
            ...
            return OffsetDateTime.of(LocalDateTime.ofInstant(instantOfEpochMilli2, zoneIdM69692), zoneIdM69692.getRules().getOffset(instantOfEpochMilli2)).toOffsetTime();
        }
        abstractC3732.m6667();
        ...
        if (!this.f23421) {
            ...
            return OffsetDateTime.of(localDateTimeOf, zoneIdM69692.getRules().getOffset(localDateTimeOf)).toOffsetTime();
        }
        if (!this.f23411) {
            return ZonedDateTime.of(LocalDate.of(1970, 1, 1), LocalTime.parse(strMo6744, dateTimeFormatterM14427), zoneIdM69692).toOffsetDateTime().toOffsetTime();
        }
        LocalDateTime localDateTime = LocalDateTime.parse(strMo6744, dateTimeFormatterM14427);
        return OffsetDateTime.of(localDateTime, zoneIdM69692.getRules().getOffset(localDateTime)).toOffsetTime();
    }
