...
public final /* synthetic */ class C3604 implements Consumer {

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰世苏, reason: contains not printable characters */
    public final /* synthetic */ Annotation f8788;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲兰苏世, reason: contains not printable characters */
    public final /* synthetic */ C9194 f8789;

    /* JADX INFO: renamed from: 飘花落叶言子楪哲苏兰世, reason: contains not printable characters */
    public final /* synthetic */ int f8790;

    public /* synthetic */ C3604(C8878 c8878, Annotation annotation, C9194 c9194) {
        this.f8790 = 11;
        this.f8788 = annotation;
        this.f8789 = c9194;
    }
    ...
    public final void accept(Object obj) {
        ...
        int i = this.f8790;
        final int i2 = 0;
        final C9194 c9194 = this.f8789;
        Annotation annotation = this.f8788;
        ...
        switch (i) {
            ...
            case 3:
                ...
                try {
                    ...
                    if ("value".equals(name)) {
                        ...
                        if (objArr.length != 0) {
                            c9194.f23432 = new Class[objArr.length];
                            c9194.f23451 = new String[objArr.length];
                            while (i2 < objArr.length) {
                                final Annotation annotation2 = (Annotation) objArr[i2];
                                Type[] typeArr = AbstractC3698.f9362;
                                AbstractC3698.m6371(annotation2.getClass(), new Consumer() { // from class: com.alibaba.fastjson2.util.飘花落叶言子楪世兰苏哲
                                    @Override // java.util.function.Consumer
                                        ...
                                        try {
                                            ...
                                            if (iHashCode == 3373707) {
                                                if (name2.equals("name")) {
                                                    c91942.f23451[i3] = (String) objInvoke2;
                                                    return;
                                                }
                                                return;
                                            }
                                            if (iHashCode == 111972721 && name2.equals("value")) {
                                                c91942.f23432[i3] = (Class) objInvoke2;
                                            }
                    ...
                    if ("value".equals(name4)) {
                        ...
                        if (iHashCode != -7755493) {
                            if (iHashCode != 10566287) {
                                ...
                                c9194.f23444 |= JSONWriter$Feature.NotWriteDefaultValue.mask;
                            }
                        } else if (strName.equals("NON_EMPTY")) {
                            c9194.f23444 |= JSONWriter$Feature.NotWriteEmptyArray.mask;
                        }
                    }
            ...
            case 8:
                ...
                try {
                    ...
                    if (iHashCode2 != -1097462182) {
                        ...
                        if (!str5.isEmpty() && !"##default".equals(str5)) {
                            c9194.f23430 = Locale.forLanguageTag(str5);
                        }
                    }
                ...
                break;
            case 9:
                AbstractC3698.m6352(c9194, annotation, method);
                break;
            case 10:
                AbstractC3698.m6352(c9194, annotation, method);
                break;
            case 11:
                ...
                try {
                    ...
                    if (iHashCode3 != 111582340) {
                        if (iHashCode3 == 491860325 && name7.equals("keyUsing") && (clsM140872 = C8878.m14087((Class) objInvoke7)) != null) {
                            c9194.f23442 = clsM140872;
                        }
                    } else if (name7.equals("using") && (clsM14087 = C8878.m14087((Class) objInvoke7)) != null) {
                        c9194.f23442 = clsM14087;
                    }
                ...
                try {
                    ...
                    if ("value".equals(name9)) {
                        ...
                        if (annotationArr.length != 0) {
                            c9194.f23432 = new Class[annotationArr.length];
                            c9194.f23451 = new String[annotationArr.length];
                            while (i2 < annotationArr.length) {
                                final Annotation annotation3 = annotationArr[i2];
                                Type[] typeArr2 = AbstractC3698.f9362;
                                AbstractC3698.m6371(annotation3.getClass(), new Consumer() { // from class: com.alibaba.fastjson2.util.飘花落叶言子楪世兰苏哲
                                    @Override // java.util.function.Consumer
                                    public final void accept(Object obj2) {
                                        ...
                                        try {
                                            ...
                                            if (iHashCode4 == 3373707) {
                                                if (name22.equals("name")) {
                                                    c91942.f23451[i3] = (String) objInvoke22;
                                                    return;
                                                }
                                                return;
                                            }
                                            if (iHashCode4 == 111972721 && name22.equals("value")) {
                                                c91942.f23432[i3] = (Class) objInvoke22;
                                            }
    ...
    public /* synthetic */ C3604(Annotation annotation, C9194 c9194, int i) {
        this.f8790 = i;
        this.f8788 = annotation;
        this.f8789 = c9194;
    }

    public /* synthetic */ C3604(C9194 c9194, Annotation annotation, int i) {
        this.f8790 = i;
        this.f8789 = c9194;
        this.f8788 = annotation;
    }
