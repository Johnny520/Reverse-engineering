...
public class Output extends OutputStream implements AutoCloseable, Pool.Poolable {
    ...
    public Output(int i, int i2) {
        ...
        if (i > i2 && i2 != -1) {
            C6755.m11869(AbstractC7012.m12150(i, i2, "bufferSize: ", " cannot be greater than maxBufferSize: "));
            throw null;
        }
        if (i2 < -1) {
    ...
    public boolean require(int i) {
        ...
        if (i > i5 - i4) {
            ...
            if (i > i5) {
                throw new KryoBufferOverflowException(AbstractC7012.m12150(i6, i, "Buffer overflow. Max capacity: ", ", required: "));
            }
    ...
    public void writeLong(long j, int i) {
        if (i < 0 || i > 8) {
            C6755.m11869(AbstractC7012.m12147(i, "count must be >= 0 and <= 8: "));
        } else {
            if (i <= 4) {
                writeInt((int) j, i);
                return;
