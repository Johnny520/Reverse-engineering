...
public class FieldSerializer<T> extends Serializer<T> {
    ...
    public static class FieldSerializerConfig implements Cloneable {
        ...
        public FieldSerializerConfig mo7452clone() {
            try {
    ...
    public FieldSerializer(Kryo kryo, Class cls, FieldSerializerConfig fieldSerializerConfig) {
        ...
        if (cls.isPrimitive()) {
            C6755.m11869(AbstractC0900.m714(cls, "type cannot be a primitive class: "));
            throw null;
        }
        if (fieldSerializerConfig == null) {
            C6755.m11869("config cannot be null.");
            throw null;
        }
        this.kryo = kryo;
        this.type = cls;
    ...
    public CachedField getField(String str) {
        ...
        C6755.m11869(AbstractC7012.m12148(this.type, AbstractC7012.m12144("Field \"", str, "\" not found on class: ")));
        return null;
    }
