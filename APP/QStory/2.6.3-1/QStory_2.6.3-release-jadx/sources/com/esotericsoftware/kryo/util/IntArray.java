...
public class IntArray {
    ...
    public int[] ensureCapacity(int i) {
        if (i < 0) {
            C6755.m11869(AbstractC7012.m12147(i, "additionalCapacity must be >= 0: "));
            return null;
        }
        int i2 = this.size + i;
    ...
    public int get(int i) {
        ...
        C5043.m9173(AbstractC0900.m710(i, "index can't be >= size: ", " >= "), this.size);
        return 0;
    }
    ...
    public void removeRange(int i, int i2) {
        int i3 = this.size;
        if (i2 >= i3) {
            C5043.m9173(AbstractC0900.m710(i2, "end can't be >= size: ", " >= "), this.size);
            return;
        }
        if (i > i2) {
            C8376.m13331(AbstractC7012.m12150(i, i2, "start can't be > end: ", " > "));
            return;
        }
        int i4 = (i2 - i) + 1;
        int i5 = i3 - i4;
    ...
    public int[] setSize(int i) {
        if (i < 0) {
            C6755.m11869(AbstractC7012.m12147(i, "newSize must be >= 0: "));
            return null;
        }
    ...
    public void swap(int i, int i2) {
        int i3 = this.size;
        if (i >= i3) {
            C5043.m9173(AbstractC0900.m710(i, "first can't be >= size: ", " >= "), this.size);
            return;
        }
        if (i2 >= i3) {
            C5043.m9173(AbstractC0900.m710(i2, "second can't be >= size: ", " >= "), this.size);
            return;
        }
        int[] iArr = this.items;
        int i4 = iArr[i];
    ...
    public void addAll(IntArray intArray, int i, int i2) {
        if (i + i2 <= intArray.size) {
            ...
            C8376.m13335(AbstractC0900.m709(i, i2, "offset + length must be <= size: ", " + ", " <= "), intArray.size);
        }
    }
