...
public class Util {
    ...
    private static Class<?> getPrimitiveWrapper(Class<?> cls) {
        ...
        C6755.m11869("Argument has to be primitive type");
        return null;
    }
    ...
    public static void log(String str, Object obj, int i) {
        if (obj == null) {
            if (Log.TRACE) {
                StringBuilder sbM12143 = AbstractC7012.m12143(str, ": null");
                sbM12143.append(pos(i));
                Log.trace("kryo", sbM12143.toString());
                return;
            }
            return;
        }
        ...
        if (!cls.isPrimitive() && !isWrapperClass(cls) && cls != String.class) {
            StringBuilder sbM121432 = AbstractC7012.m12143(str, ": ");
            sbM121432.append(string(obj));
            sbM121432.append(pos(i));
            Log.debug("kryo", sbM121432.toString());
            return;
        }
        if (Log.TRACE) {
            StringBuilder sbM121433 = AbstractC7012.m12143(str, ": ");
            sbM121433.append(string(obj));
            sbM121433.append(pos(i));
            Log.trace("kryo", sbM121433.toString());
        }
    }
    ...
    public static <T extends SerializerFactory> T newFactory(Class<T> cls, Class<? extends Serializer> cls2) {
        if (cls2 != null) {
            try {
                ...
                C3908.m7459("Unable to create serializer factory \"", cls.getName(), "\" for serializer class: ", className(cls2), e);
                return null;
            }
        }
        return cls.newInstance();
    ...
    public static String pos(int i) {
        return i == -1 ? "" : AbstractC0900.m722(i, " [", "]");
    }
