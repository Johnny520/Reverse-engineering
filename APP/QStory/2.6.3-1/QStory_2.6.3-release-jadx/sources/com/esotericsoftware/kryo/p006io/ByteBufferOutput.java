...
public class ByteBufferOutput extends Output {
    ...
    public ByteBufferOutput(int i, int i2) {
        if (i2 < -1) {
            C6755.m11869(AbstractC7012.m12147(i2, "maxBufferSize cannot be < -1: "));
            throw null;
        }
        this.capacity = i;
    ...
    @Override // com.esotericsoftware.kryo.p006io.Output, java.io.OutputStream, java.io.Closeable, java.lang.AutoCloseable
    public void close() {
        flush();
    ...
    @Override // com.esotericsoftware.kryo.p006io.Output, java.io.OutputStream, java.io.Flushable
    public void flush() {
    ...
    @Override // com.esotericsoftware.kryo.p006io.Output
    ...
    public boolean require(int i) {
        ...
        if (i > i4 - i3) {
            ...
            if (i > i4) {
                throw new KryoBufferOverflowException(AbstractC7012.m12150(i5, i, "Buffer overflow. Max capacity: ", ", required: "));
            }
    ...
    @Override // com.esotericsoftware.kryo.p006io.Output, com.esotericsoftware.kryo.util.Pool.Poolable
    public void reset() {
        super.reset();
        setBufferPosition(this.byteBuffer, 0);
    }
    ...
    public void setBuffer(ByteBuffer byteBuffer, int i) {
        ...
        if (i < -1) {
            C6755.m11869(AbstractC7012.m12147(i, "maxBufferSize cannot be < -1: "));
            return;
        }
    ...
    @Override // com.esotericsoftware.kryo.p006io.Output, java.io.OutputStream
    ...
    public void writeInt(int i, int i2) {
        if (i2 < 0 || i2 > 4) {
            C6755.m11869(AbstractC7012.m12147(i2, "count must be >= 0 and <= 4: "));
            return;
        }
        require(i2);
        this.position += i2;
    ...
    public ByteBufferOutput(OutputStream outputStream) {
        ...
        if (outputStream != null) {
            ...
            C6755.m11869("outputStream cannot be null.");
            throw null;
        }
    }
