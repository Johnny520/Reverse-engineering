...
import com.esotericsoftware.kryo.p006io.ByteBufferInput;
...
public class UnsafeByteBufferInput extends ByteBufferInput {
    ...
    @Override // com.esotericsoftware.kryo.p006io.ByteBufferInput, com.esotericsoftware.kryo.p006io.Input, java.io.InputStream
    public int read() {
        if (optional(1) <= 0) {
            return -1;
        }
    ...
    @Override // com.esotericsoftware.kryo.p006io.ByteBufferInput, com.esotericsoftware.kryo.p006io.Input
    ...
    @Override // com.esotericsoftware.kryo.p006io.ByteBufferInput
