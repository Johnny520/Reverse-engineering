...
public final class ImmutableCollectionsSerializers {
    ...
    public static final class JdkImmutableSetSerializer extends CollectionSerializer<Set<Object>> {
        ...
        public static void addDefaultSerializers(Kryo kryo) {
            ...
            Objects.requireNonNull(obj);
            if (!hashSet.add(obj)) {
                C6755.m11869(AbstractC0900.m713(obj, "duplicate element: "));
                return;
            }
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (!hashSet2.add(obj2)) {
                    C6755.m11869(AbstractC0900.m713(obj2, "duplicate element: "));
                    return;
                }
            }
    ...
    public static final class JdkImmutableMapSerializer extends MapSerializer<Map<Object, Object>> {
        ...
        public static void addDefaultSerializers(Kryo kryo) {
            ...
            if (map.put(key, value) != null) {
                C6755.m11869(AbstractC0900.m713(key, "duplicate key: "));
                return;
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if (map2.put(key2, value2) != null) {
                    C6755.m11869(AbstractC0900.m713(key2, "duplicate key: "));
                    return;
                }
            }
