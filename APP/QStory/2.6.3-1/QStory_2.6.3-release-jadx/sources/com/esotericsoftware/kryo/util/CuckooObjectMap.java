...
public class CuckooObjectMap<K, V> {
    ...
    public CuckooObjectMap(int i, float f) {
        if (i < 0) {
            C6755.m11869(AbstractC7012.m12147(i, "initialCapacity must be >= 0: "));
            throw null;
        }
        if (i > 1073741824) {
            C6755.m11869(AbstractC7012.m12147(i, "initialCapacity is too large: "));
            throw null;
        }
        int iNextPowerOfTwo = nextPowerOfTwo(i);
        this.capacity = iNextPowerOfTwo;
        if (f <= 0.0f) {
            C3908.m7460("loadFactor must be > 0: ", f);
            throw null;
        }
        this.loadFactor = f;
