...
public class TypePath {
    ...
    public static TypePath fromString(String str) {
        ...
        while (i < length) {
            ...
            if (cCharAt == '[') {
                ...
                byteVector.m41a(3, i3);
            }
            i = i2;
        }
        byte[] bArr = byteVector.f107a;
        bArr[0] = (byte) (byteVector.f108b / 2);
    ...
    public int getStep(int i) {
        return this.f285a[AbstractC7012.m12133(i, 2, this.f286b, 1)];
    }

    public int getStepArgument(int i) {
        return this.f285a[AbstractC7012.m12133(i, 2, this.f286b, 2)];
    }
