package com.android.p002dx.command.annotool;

import com.android.p002dx.command.annotool.Main;
...
import com.android.p002dx.p003cf.attrib.BaseAnnotations;
...
class AnnotationLister {
    ...
    /* JADX INFO: compiled from: r8-map-id-447c03deab370cabd87f71de7ff996ccc1a6dc9764ce389c731d875d052048e4 */
    public static /* synthetic */ class C02462 {
    ...
    public void printMatch(DirectClassFile directClassFile) {
        ...
        while (it.hasNext()) {
            int i = C02462.$SwitchMap$com$android$dx$command$annotool$Main$PrintType[it.next().ordinal()];
            if (i == 1) {
                System.out.println(directClassFile.getThisClass().getClassType().getClassName().replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH));
            } else if (i == 2) {
