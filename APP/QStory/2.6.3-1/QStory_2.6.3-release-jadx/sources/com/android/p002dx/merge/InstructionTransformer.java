...
import com.android.p002dx.p005io.instructions.ShortArrayCodeOutput;
...
final class InstructionTransformer {
    ...
    public static void jumboCheck(boolean z, int i) {
        if (!z && i > 65535) {
            throw new DexIndexOverflowException(AbstractC0900.m722(i, "Cannot merge new index ", " into a non-jumbo instruction!"));
        }
    }
