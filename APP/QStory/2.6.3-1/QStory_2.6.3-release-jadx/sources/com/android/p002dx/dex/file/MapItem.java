...
public final class MapItem extends OffsettedItem {
    ...
    private MapItem(ItemType itemType, Section section, Item item, Item item2, int i) {
        ...
        if (section == null) {
            C3466.m5903("section == null");
            throw null;
        }
        if (item == null) {
            C3466.m5903("firstItem == null");
            throw null;
        }
        if (item2 == null) {
            C3466.m5903("lastItem == null");
            throw null;
        }
        if (i <= 0) {
            C6755.m11869("itemCount <= 0");
            throw null;
        }
        this.type = itemType;
    ...
    public static void addMap(Section[] sectionArr, MixedItemSection mixedItemSection) {
        if (sectionArr == null) {
            C3466.m5903("sections == null");
            return;
        }
        if (mixedItemSection.items().size() != 0) {
            C6755.m11869("mapSection.items().size() != 0");
            return;
        }
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (annotatedOutput.annotates()) {
            ...
            sb.append(Hex.m28u2(mapValue));
            sb.append(" // ");
            sb.append(this.type.toString());
            annotatedOutput.annotate(2, sb.toString());
            annotatedOutput.annotate(2, "  unused: 0");
            annotatedOutput.annotate(4, "  size:   " + Hex.m30u4(this.itemCount));
            AbstractC3275.m5123(fileOffset, new StringBuilder("  offset: "), annotatedOutput, 4);
        }
