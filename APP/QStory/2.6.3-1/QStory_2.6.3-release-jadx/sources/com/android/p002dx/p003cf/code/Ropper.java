...
import com.android.p002dx.util.Bits;
...
public final class Ropper {
    ...
    public class SubroutineInliner {
            ...
            if (Ropper.this.isSubroutineCaller(basicBlockLabelToBlock)) {
                ...
                if (subroutineSubroutineFromRetBlock == null) {
                    ...
                    if (subroutineSubroutineFromRetBlock.startBlock != this.subroutineStart) {
                        ...
                        sb.append(Hex.m28u2(subroutineSubroutineFromRetBlock.startBlock));
                        sb.append(" expected: ");
                        C3466.m5899(AbstractC3275.m5120(sb, this.subroutineStart));
                        return;
                    }
        ...
        private int mapOrAllocateLabel(int i) {
            ...
            while (true) {
                int size = this.labelToSubroutines.size();
    ...
    private void addReturnBlock() {
        ...
        int specialLabel = getSpecialLabel(RETURN);
        if (isSynchronized()) {
            ...
            insnList.setImmutable();
            int specialLabel2 = getSpecialLabel(SYNCH_RETURN);
    ...
    private void deleteUnreachableBlocks() {
        ...
        forEachNonSubBlockDepthFirst(getSpecialLabel(-1), new BasicBlock.Visitor(this) { // from class: com.android.dx.cf.code.Ropper.2
    ...
    private void doit() {
        ...
        while (true) {
            ...
            try {
                ...
                e.addContext("...while working on block " + Hex.m28u2(iFindFirst));
                throw e;
            }
        }
        addReturnBlock();
    ...
    private void inlineSubroutines() {
        ...
        forEachNonSubBlockDepthFirst(0, new BasicBlock.Visitor(this) { // from class: com.android.dx.cf.code.Ropper.1
            final /* synthetic */ Ropper this$0;
            ...
            @Override // com.android.dx.rop.code.BasicBlock.Visitor
            public void visitBlock(BasicBlock basicBlock) {
                if (this.this$0.isSubroutineCaller(basicBlock)) {
                    intList.add(basicBlock.getLabel());
                }
            }
        });
    ...
    private void processBlock(ByteBlock byteBlock, Frame frame, int[] iArr) {
        ...
        if (this.machine.hasJsr()) {
            ...
            boolean zHasRet = this.machine.hasRet();
            ...
            if (zHasRet) {
                ...
                iArr2 = iArr;
                if (ropperMachine.wereCatchesUsed()) {
                    intList = successors;
                    size = size3;
                } else {
                    intList = successors;
        ...
        while (size < size4) {
            ...
            try {
                ...
                e.addContext("...while merging to block " + Hex.m28u2(i5));
                throw e;
            }
        }
        int i7 = size4;
        ...
        if (i7 == 0 && this.machine.returns()) {
            intList = IntList.makeImmutable(getSpecialLabel(RETURN));
            i = 1;
        } else {
            i = i7;
        }
            ...
            while (i9 < size3) {
                ...
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        e.addContext("...while merging exception to block " + Hex.m28u2(i2));
                        throw e;
                    }
    ...
    private void removeBlockAndSpecialSuccessors(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (i3 >= minimumUnreservedLabel) {
                ...
                if (iLabelToResultIndex < 0) {
                    C3466.m5899(AbstractC3275.m5120(new StringBuilder("Invalid label "), i3));
                    return;
                }
                removeBlockAndSpecialSuccessors(iLabelToResultIndex);
            }
