...
public final class CstType extends TypedConstant {
    ...
    private static final ConcurrentMap<Type, CstType> interns = new ConcurrentHashMap(DescriptorProtos$Edition.EDITION_2023_VALUE, 0.75f);
    ...
    public CstType(Type type) {
        ...
        if (type == Type.KNOWN_NULL) {
            C6755.m11867("KNOWN_NULL is not representable");
            throw null;
        }
        this.type = type;
    ...
    public static CstType forBoxedPrimitiveType(Type type) {
        switch (type.getBasicType()) {
            ...
            case 8:
                return SHORT;
            default:
                C5043.m9163(type, "not primitive: ");
                return null;
        }
    }
    ...
    private static void internInitial(CstType cstType) {
        ...
        C8376.m13333(cstType, "Attempted re-init of ");
    }
    ...
    public String getPackageName() {
        ...
        return iLastIndexOf == -1 ? "default" : string.substring(string.lastIndexOf(91) + 2, iLastIndexOf).replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH);
    }
