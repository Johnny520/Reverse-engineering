...
public class Simulator {
    ...
    public class SimVisitor implements BytecodeArray.Visitor {
        ...
        */
        ...
        public void visitInvalid(int i, int i2, int i3) {
            throw new SimException("invalid opcode " + Hex.m27u1(i));
        }
    ...
    public void fail(String str) {
        StringBuilder sbM12141 = AbstractC7012.m12141("ERROR in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM12141.append(str);
        throw new SimException(sbM12141.toString());
    }
    ...
    private void warn(String str) {
        StringBuilder sbM12141 = AbstractC7012.m12141("WARNING in ", this.method.getDefiningClass().toHuman(), ".", this.method.getNat().toHuman(), ": ");
        sbM12141.append(str);
        this.dexOptions.err.println(sbM12141.toString());
    }
