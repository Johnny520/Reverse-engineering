...
public final class BytecodeArray {
    ...
    private int parseLookupswitch(int i, Visitor visitor) {
        ...
        while (true) {
            ...
            unsignedByte = (unsignedByte << 8) | byteArray.getUnsignedByte(i3);
            i3++;
        }
        int i4 = byteArray.getInt(i2) + i;
    ...
    private int parseNewarray(int i, Visitor visitor) {
        ...
        switch (unsignedByte) {
            ...
            case 11:
                ...
                break;
            default:
                throw new SimException("bad newarray code " + Hex.m27u1(unsignedByte));
        }
            ...
            try {
                try {
                    switch (unsignedByte) {
                        ...
                        case 198:
                        case 199:
                            visitor2.visitBranch(unsignedByte, i, 3, i + this.bytes.getShort(i + 1));
                            return 3;
                        case 169:
                        ...
                        case 193:
                            ...
                            try {
                                ...
                                e = e;
                                simException = e;
                                simException.addContext("...at bytecode offset " + Hex.m30u4(i2));
                                throw simException;
                            } catch (RuntimeException e2) {
                                e = e2;
                                runtimeException = e;
                                SimException simException2 = new SimException(runtimeException);
                                simException2.addContext("...at bytecode offset " + Hex.m30u4(i2));
                                throw simException2;
                            }
                        case 185:
                    ...
                    simException22.addContext("...at bytecode offset " + Hex.m30u4(i2));
