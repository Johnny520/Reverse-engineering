...
import com.android.p002dx.util.IndentingWriter;
import com.android.p002dx.util.TwoColumnOutput;
    ...
    */
    ...
    public void changeIndent(int i) {
        ...
        for (int i2 = 0; i2 < this.indent; i2++) {
            this.separator = AbstractC0900.m711(new StringBuilder(), this.separator, "  ");
        }
    }
