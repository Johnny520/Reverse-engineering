...
public enum InstructionCodec {
    FORMAT_00X { // from class: com.android.dx.io.instructions.InstructionCodec.1
        @Override // com.android.p002dx.p005io.instructions.InstructionCodec
    ...
    FORMAT_45CC { // from class: com.android.dx.io.instructions.InstructionCodec.32
        ...
        public DecodedInstruction decode(int i, CodeInput codeInput) {
            int iByte0 = InstructionCodec.byte0(i);
            if (iByte0 != 250) {
                C6755.m11867(String.valueOf(iByte0));
                return null;
            }
            ...
            C8376.m13329(Hex.uNibble(iNibble3), "bogus registerCount: ");
            return null;
        }
        ...
        public DecodedInstruction decode(int i, CodeInput codeInput) {
            ...
            if (i2 == 1) {
                ...
                while (i4 < i3) {
                    ...
                    bArr[i4] = (byte) (i5 & Opcodes.CONST_METHOD_TYPE);
                    i5 >>= 8;
                    i4++;
                    z = !z;
                }
            ...
            if (i2 != 8) {
                throw new DexException(AbstractC3275.m5120(new StringBuilder("bogus element_width: "), i2));
            }
        ...
        public void encode(DecodedInstruction decodedInstruction, CodeOutput codeOutput) {
            ...
            if (elementWidthUnit == 2) {
                ...
                if (elementWidthUnit != 8) {
                    throw new DexException(AbstractC3275.m5120(new StringBuilder("bogus element_width: "), elementWidthUnit));
                }
    ...
    public static short asUnsignedUnit(int i) {
        ...
        C6755.m11869("bogus unsigned code unit");
        return (short) 0;
    }
    ...
    public static short codeUnit(int i, int i2, int i3, int i4) {
        if ((i & (-16)) != 0) {
            C6755.m11869("bogus nibble0");
            return (short) 0;
        }
        if ((i2 & (-16)) != 0) {
            C6755.m11869("bogus nibble1");
            return (short) 0;
        }
        if ((i3 & (-16)) != 0) {
            C6755.m11869("bogus nibble2");
            return (short) 0;
        }
        if ((i4 & (-16)) == 0) {
            return (short) (i | (i2 << 4) | (i3 << 8) | (i4 << 12));
        }
        C6755.m11869("bogus nibble3");
        return (short) 0;
    }
    ...
    public static int makeByte(int i, int i2) {
        if ((i & (-16)) != 0) {
            C6755.m11869("bogus lowNibble");
            return 0;
        }
        if ((i2 & (-16)) == 0) {
            return i | (i2 << 4);
        }
        C6755.m11869("bogus highNibble");
        return 0;
    }
    ...
    public static short codeUnit(int i, int i2) {
        if ((i & (-256)) != 0) {
            C6755.m11869("bogus lowByte");
            return (short) 0;
        }
        if ((i2 & (-256)) == 0) {
            return (short) (i | (i2 << 8));
        }
        C6755.m11869("bogus highByte");
        return (short) 0;
    }
}
