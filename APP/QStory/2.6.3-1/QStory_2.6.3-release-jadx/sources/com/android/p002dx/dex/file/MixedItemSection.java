...
public final class MixedItemSection extends Section {
    ...
    public void writeHeaderPart(AnnotatedOutput annotatedOutput) {
        ...
        if (i == -1) {
            C3466.m5899("write size not yet set");
            return;
        }
        ...
        if (annotatedOutput.annotates()) {
            annotatedOutput.annotate(4, name + "_size:" + str + Hex.m30u4(i));
            annotatedOutput.annotate(4, name + "_off: " + str + Hex.m30u4(fileOffset));
        }
    ...
    public void writeTo0(AnnotatedOutput annotatedOutput) {
        ...
        C3466.m5899("output size mismatch");
    }
}
