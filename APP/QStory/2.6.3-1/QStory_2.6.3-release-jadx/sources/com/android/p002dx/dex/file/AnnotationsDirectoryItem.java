...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    public int compareTo0(OffsettedItem offsettedItem) {
        ...
        C6755.m11867("uninternable instance");
        return 0;
    }
    ...
    public void setClassAnnotations(Annotations annotations, DexFile dexFile) {
        if (annotations == null) {
            ...
            C6755.m11867("class annotations already set");
        }
    }
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            sb.append(Hex.m30u4(absoluteOffsetOr0));
            annotatedOutput.annotate(4, sb.toString());
            annotatedOutput.annotate(4, "  fields_size:           " + Hex.m30u4(iListSize));
            annotatedOutput.annotate(4, "  methods_size:          " + Hex.m30u4(iListSize2));
            AbstractC3275.m5123(iListSize3, new StringBuilder("  parameters_size:       "), annotatedOutput, 4);
        }
