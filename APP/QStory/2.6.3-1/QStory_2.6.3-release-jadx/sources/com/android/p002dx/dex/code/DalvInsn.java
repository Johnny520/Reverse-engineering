...
public abstract class DalvInsn {
    ...
    public final int getAddress() {
        ...
        C3466.m5899("address not yet known");
        return 0;
    }
    ...
    public final String identifierString() {
        int i = this.address;
        return i != -1 ? String.format("%04x", Integer.valueOf(i)) : Hex.m30u4(System.identityHashCode(this));
    }
    ...
    public final String listingString(String str, int i, boolean z) {
        ...
        sbM700.append(identifierString());
        sbM700.append(": ");
