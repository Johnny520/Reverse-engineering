...
public class OneLocalsArray extends LocalsArray {
    ...
    private static TypeBearer throwSimException(int i, String str) {
        throw new SimException("local " + Hex.m28u2(i) + ": " + str);
    }
    ...
    public void annotate(ExceptionWithContext exceptionWithContext) {
        ...
        while (true) {
            ...
            exceptionWithContext.addContext("locals[" + Hex.m28u2(i) + "]: " + (typeBearer == null ? "<invalid>" : typeBearer.toString()));
            i++;
        }
    }
    ...
    public String toHuman() {
        ...
        while (true) {
            ...
            TypeBearer typeBearer = typeBearerArr[i];
            sb.append("locals[" + Hex.m28u2(i) + "]: " + (typeBearer == null ? "<invalid>" : typeBearer.toString()) + "\n");
            i++;
        }
    }
