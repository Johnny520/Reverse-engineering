...
public class SsaDumper extends BlockDumper {
    ...
    @Override // com.android.p002dx.command.dump.BlockDumper, com.android.p002dx.command.dump.BaseDumper, com.android.p002dx.p003cf.iface.ParseObserver
    public void endParsingMember(ByteArray byteArray, int i, String str, String str2, Member member) {
        ...
        sb.append("first ");
        sb.append(Hex.m28u2(ssaMethodDebugNoRegisterAllocation.blockIndexToRopLabel(ssaMethodDebugNoRegisterAllocation.getEntryBlockIndex())));
        sb.append('\n');
        ...
        while (true) {
            ...
            sb.append("block ");
            sb.append(Hex.m28u2(ssaBasicBlock.getRopLabel()));
            sb.append('\n');
            ...
            for (int iNextSetBit = predecessors.nextSetBit(0); iNextSetBit >= 0; iNextSetBit = predecessors.nextSetBit(iNextSetBit + 1)) {
                sb.append("  pred ");
                sb.append(Hex.m28u2(ssaMethodDebugNoRegisterAllocation.blockIndexToRopLabel(iNextSetBit)));
                sb.append('\n');
            }
            ...
            if (ssaBasicBlock.getSuccessors().cardinality() == 0) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    sb.append("  next ");
                    sb.append(Hex.m28u2(ropLabelSuccessorList.get(i2)));
