...
public final class GlideException extends Exception {
    ...
    private void printStackTrace(Appendable appendable) {
        ...
        appendCauses(getCauses(), new C3835(appendable));
    }
    ...
    public void setLoggingDetails(InterfaceC9222 interfaceC9222, DataSource dataSource, Class<?> cls) {
        this.key = interfaceC9222;
    ...
    public void setLoggingDetails(InterfaceC9222 interfaceC9222, DataSource dataSource) {
        setLoggingDetails(interfaceC9222, dataSource, null);
    }
