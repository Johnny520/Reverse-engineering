...
public abstract class AbstractC7200 {
    ...
    public static byte[] m12513(String str, byte[] bArr) {
        try {
            ...
            Cipher cipher = Cipher.getInstance(AbstractC9234.m14531(9));
    ...
    public static SecretKeySpec m12517(String str) {
        ...
        return new SecretKeySpec(sb.toString().getBytes(f17872), AbstractC9234.m14532("喵喵呜呜喵喵呜喵~喵喵呜呜喵喵喵喵~喵喵呜喵呜喵喵呜"));
    }
}
