...
public final class C7134 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        String strReplace = editText.getText().toString().replace(AbstractC9234.m14532("喵呜呜呜呜喵喵呜"), "");
        ...
        if (file.renameTo(new File(file.getParentFile() + AbstractC9234.m14532("喵呜喵呜呜呜喵喵") + strReplace))) {
            dialogC7148.dismiss();
        } else {
            editText.setText(strReplace);
            AbstractC7014.m12151(AbstractC9234.m14531(558));
        }
    }
