...
public final class RunnableC7255 implements Runnable {
    ...
    public static Method m12533(Object obj) {
        ...
        if (clsM12534 == null) {
            C3466.m5899(AbstractC9234.m14531(111));
            return null;
        }
        C7164 c7164M12413 = C7164.m12413(clsM12534);
        Class clsM12425 = AbstractC7166.m12425(AbstractC9234.m14531(114));
    ...
    public static Class m12534(Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                if (obj2 != null && obj2.getClass().getName().startsWith(AbstractC9234.m14531(167))) {
                    break;
                }
                i++;
    ...
    */
    public static Object m12535(Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                if (obj2 != null && obj2.toString().contains(AbstractC9234.m14531(115))) {
                    break;
                }
                i++;
            } catch (IllegalAccessException e) {
    ...
    public final void run() {
        ...
        AbstractC7014.m12151(AbstractC9234.m14531(168));
            ...
            if (concurrentHashMap.size() == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        num.getClass();
                        m12533(key).invoke(objM12417, num, m12535(key), AbstractC7165.m12420(key.getClass(), AbstractC7166.m12425(AbstractC9234.m14531(114))).get(key), Integer.valueOf(c7256.f17962));
        ...
        AbstractC7014.m12151(AbstractC9234.m14531(169));
    }
}
