...
public class ViewOnClickListenerC7239 extends AbstractC7140 implements View.OnClickListener {
    ...
    public ViewOnClickListenerC7239() {
        AbstractC9234.m14531(132);
        this.f17930 = new String[]{AbstractC9234.m14532("喵喵呜呜呜喵喵呜"), AbstractC9234.m14531(133), AbstractC9234.m14531(134), AbstractC9234.m14531(135), AbstractC9234.m14531(136)};
    }
    ...
    public final void onClick(View view) {
        if (this.f17929 == null) {
            this.f17929 = new C7149(AbstractC9234.m14531(132));
        }
        String string = this.f17928.getText().toString();
        AbstractC7014.m12151(AbstractC9234.m14531(139) + string);
        this.f17929.m12395(string, AbstractC9234.m14532("喵喵喵喵喵喵喵喵~喵喵喵喵喵喵喵喵~喵喵喵呜喵呜呜呜~喵喵喵喵喵呜喵呜~喵喵喵喵喵呜喵喵~喵喵喵呜呜呜呜喵~喵喵喵呜呜喵喵喵"));
        this.f17929.mo12394();
        this.f17931.dismiss();
    }
    ...
    public final String mo11794() {
        return AbstractC9234.m14531(138);
    }
    ...
    public final String m12526() {
        ...
        if (!(c6746 == null ? false : c6746.f17770.booleanValue())) {
            ...
            return (String) this.f17929.m12398(AbstractC9234.m14532("喵喵喵喵喵喵喵喵~喵喵喵喵喵喵喵喵~喵喵喵呜喵呜呜呜~喵喵喵喵喵呜喵呜~喵喵喵喵喵呜喵喵~喵喵喵呜呜呜呜喵~喵喵喵呜呜喵喵喵"));
        }
        C6746 c67462 = (C6746) linkedHashMap.get(C6746.class);
        if (c67462 == null) {
            return AbstractC9234.m14532("喵喵喵喵喵喵呜喵~喵喵喵喵喵喵呜喵~喵喵喵喵呜喵呜呜");
        }
        try {
        ...
        if (arrayList.isEmpty() || !c67462.m11857()) {
            AbstractC7199.m12510(AbstractC9234.m14531(1092), c67462.f16450);
            try {
        ...
        while (true) {
            ...
            if (!str.isEmpty() && !str.startsWith(AbstractC9234.m14532("喵呜喵呜呜呜喵喵~喵呜喵呜呜喵呜喵"))) {
                return str;
            }
