...
public interface ResettableClassFileTransformer extends ClassFileTransformer {
    ...
    public static abstract class WithDelegation extends AbstractBase {
        ...
        public static class Substitutable extends AbstractBase implements Substitutable {
                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public Substitutable make(ResettableClassFileTransformer resettableClassFileTransformer) {
                        try {
                            ...
                            C6385.m11444("Cannot access ", this.substitutable, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C6385.m11444("Cannot instantiate ", this.substitutable.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C9620.m15032("Cannot invoke " + this.substitutable, e3.getTargetException());
                            return null;
                        }
                    }
                }
            ...
            public static Substitutable m181of(ResettableClassFileTransformer resettableClassFileTransformer) {
        ...
        /* JADX INFO: renamed from: of */
        public static ResettableClassFileTransformer m180of(ResettableClassFileTransformer resettableClassFileTransformer, Callback<?> callback) {
        ...
        public static class WithCallback<T> extends WithDelegation {
                ...
                public static class ForJava9CapableVm implements Factory {
                    ...
                    public ResettableClassFileTransformer make(ResettableClassFileTransformer resettableClassFileTransformer, Callback<?> callback) {
                        try {
                            ...
                            C6385.m11444("Cannot access ", this.withCallback, e);
                            return null;
                        } catch (InstantiationException e2) {
                            C6385.m11444("Cannot instantiate ", this.withCallback.getDeclaringClass(), e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C9620.m15032("Cannot invoke " + this.withCallback, e3.getTargetException());
                            return null;
                        }
                    }
                }
            ...
            public byte[] transform(Object obj, @MaybeNull ClassLoader classLoader, @MaybeNull String str, @MaybeNull Class<?> cls, @MaybeNull ProtectionDomain protectionDomain, byte[] bArr) {
                JavaModule javaModuleM493of = JavaModule.m493of(obj);
                T tOnBeforeTransform = this.callback.onBeforeTransform(javaModuleM493of, classLoader, str, cls, protectionDomain, bArr);
                try {
                    return doTransform(obj, classLoader, str, cls, protectionDomain, bArr);
                } finally {
                    this.callback.onAfterTransform(tOnBeforeTransform, javaModuleM493of, classLoader, str, cls, protectionDomain, bArr);
                }
            }
        }
    }
