...
public class DispatcherAnnotationPlugin extends Plugin.ForElementMatcher implements Plugin.Factory, MethodAttributeAppender.Factory, MethodAttributeAppender {
    ...
    public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        return builder.visit(new MemberAttributeExtension.ForMethod().attribute(this).m223on(ElementMatchers.not(ElementMatchers.isAnnotatedWith((Class<? extends Annotation>) JavaDispatcher.Proxied.class)).and(ElementMatchers.isAbstract())));
    }
