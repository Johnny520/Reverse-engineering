...
public class SafeVarargsPlugin extends Plugin.ForElementMatcher implements Plugin.Factory {
    ...
    public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        return builder.visit(new MemberAttributeExtension.ForMethod().attribute(SafeVarargsAppender.INSTANCE).m223on(ElementMatchers.isAnnotatedWith((Class<? extends Annotation>) Enhance.class)));
    }
    ...
    public enum SafeVarargsAppender implements MethodAttributeAppender, MethodAttributeAppender.Factory {
        ...
        public void apply(MethodVisitor methodVisitor, MethodDescription methodDescription, AnnotationValueFilter annotationValueFilter) {
            if (!methodDescription.isVarArgs()) {
                C6385.m11438(methodDescription, " does not have variable arguments");
                return;
            }
            if (!methodDescription.isConstructor() && !methodDescription.isStatic() && !methodDescription.isFinal()) {
                C6385.m11438(methodDescription, " is neither a constructor or final and cannot declare safe varargs");
                return;
            }
