...
public class DecoratingDynamicTypeBuilder<T> extends DynamicType.Builder.AbstractBase.UsingTypeWriter<T> {
    ...
    public DecoratingDynamicTypeBuilder(TypeDescription typeDescription, ClassFileVersion classFileVersion, AuxiliaryType.NamingStrategy namingStrategy, AnnotationValueFilter.Factory factory, AnnotationRetention annotationRetention, Implementation.Context.Factory factory2, MethodGraph.Compiler compiler, TypeValidation typeValidation, AsmClassReader.Factory factory3, AsmClassWriter.Factory factory4, LatentMatcher<? super MethodDescription> latentMatcher, ClassFileLocator classFileLocator) {
        ...
        this(typeDescription2, differentiating, AsmVisitorWrapper.NoOp.INSTANCE, classFileVersion, namingStrategy, factory, annotationRetention, factory2, compiler, typeValidation, factory3, factory4, latentMatcher, Collections.EMPTY_LIST, classFileLocator);
    }

    @Override // net.bytebuddy.dynamic.DynamicType.Builder
    public DynamicType.Builder.ModuleDefinition<T> adjustModule(Collection<? extends ModifierContributor.ForModule> collection) {
        throw new UnsupportedOperationException("Cannot change module information of decorated type: " + this.instrumentedType);
    }
    ...
    public int hashCode() {
        return this.classFileLocator.hashCode() + AbstractC0900.m720(this.auxiliaryTypes, (this.ignoredMethods.hashCode() + ((this.classWriterFactory.hashCode() + ((this.classReaderFactory.hashCode() + ((this.typeValidation.hashCode() + ((this.methodGraphCompiler.hashCode() + ((this.implementationContextFactory.hashCode() + ((this.annotationRetention.hashCode() + ((this.annotationValueFilterFactory.hashCode() + ((this.auxiliaryTypeNamingStrategy.hashCode() + ((this.classFileVersion.hashCode() + ((this.asmVisitorWrapper.hashCode() + ((this.typeAttributeAppender.hashCode() + AbstractC3275.m5144(this.instrumentedType, getClass().hashCode() * 31, 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31, 31);
    }

    @Override // net.bytebuddy.dynamic.DynamicType.Builder
    public DynamicType.Builder<T> ignoreAlso(LatentMatcher<? super MethodDescription> latentMatcher) {
        return new DecoratingDynamicTypeBuilder(this.instrumentedType, this.typeAttributeAppender, this.asmVisitorWrapper, this.classFileVersion, this.auxiliaryTypeNamingStrategy, this.annotationValueFilterFactory, this.annotationRetention, this.implementationContextFactory, this.methodGraphCompiler, this.typeValidation, this.classReaderFactory, this.classWriterFactory, new LatentMatcher.Disjunction(this.ignoredMethods, latentMatcher), this.auxiliaryTypes, this.classFileLocator);
    }
    ...
    @Override // net.bytebuddy.dynamic.DynamicType.Builder
    public DynamicType.Builder.ModuleDefinition<T> module(String str, int i) {
        throw new UnsupportedOperationException("Cannot change module information of decorated type: " + this.instrumentedType);
    }
    ...
    public DynamicType.Builder<T> require(Collection<DynamicType> collection) {
        return new DecoratingDynamicTypeBuilder(this.instrumentedType, this.typeAttributeAppender, this.asmVisitorWrapper, this.classFileVersion, this.auxiliaryTypeNamingStrategy, this.annotationValueFilterFactory, this.annotationRetention, this.implementationContextFactory, this.methodGraphCompiler, this.typeValidation, this.classReaderFactory, this.classWriterFactory, this.ignoredMethods, CompoundList.m477of((List) this.auxiliaryTypes, (List) new ArrayList(collection)), this.classFileLocator);
    }
    ...
    public TypeWriter<T> toTypeWriter(TypePool typePool) {
        ...
        return TypeWriter.Default.forDecoration(typeDescription, this.classFileVersion, this.auxiliaryTypes, CompoundList.m477of((List) this.methodGraphCompiler.compile((TypeDefinition) typeDescription).listNodes().asMethodList().filter(ElementMatchers.not(this.ignoredMethods.resolve(this.instrumentedType))), (List) this.instrumentedType.getDeclaredMethods().filter(ElementMatchers.not(ElementMatchers.isVirtual()))), this.typeAttributeAppender, this.asmVisitorWrapper, this.annotationValueFilterFactory, this.annotationRetention, this.auxiliaryTypeNamingStrategy, this.implementationContextFactory, this.typeValidation, this.classReaderFactory, this.classWriterFactory, TypePool.Explicit.wrap(this.instrumentedType, this.auxiliaryTypes, typePool), this.classFileLocator);
    }
