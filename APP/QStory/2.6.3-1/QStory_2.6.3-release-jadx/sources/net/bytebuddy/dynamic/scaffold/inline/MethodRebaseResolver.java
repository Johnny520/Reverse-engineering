...
public interface MethodRebaseResolver {
    ...
    public static class Default implements MethodRebaseResolver {
            ...
            for (MethodDescription.InDefinedShape inDefinedShape : typeDescription.getDeclaredMethods()) {
                if (set.contains(inDefinedShape.asSignatureToken())) {
                    if (inDefinedShape.isConstructor()) {
                        ...
                        resolutionM355of = Resolution.ForRebasedConstructor.m354of(inDefinedShape, dynamicTypeMake.getTypeDescription());
                    } else {
                        resolutionM355of = Resolution.ForRebasedMethod.m355of(typeDescription, inDefinedShape, methodNameTransformer);
                    }
                    map.put(inDefinedShape, resolutionM355of);
                }
            }
        ...
        public int hashCode() {
            return this.dynamicTypes.hashCode() + AbstractC7012.m12130(this.resolutions, getClass().hashCode() * 31, 31);
        }
    ...
    public interface Resolution {
        ...
        public static class ForRebasedConstructor implements Resolution {
            ...
            public static class RebasedConstructor extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                public int getModifiers() {
                    return DexMap.TYPE_ANNOTATION_SET_REF_LIST;
                }

                @Override // net.bytebuddy.description.method.MethodDescription, net.bytebuddy.description.method.MethodDescription.InDefinedShape
                public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
                    return new ParameterList.Explicit.ForTypes(this, (List<? extends TypeDefinition>) CompoundList.m476of(this.methodDescription.getParameters().asTypeList().asErasures(), this.placeholderType));
                }
            ...
            public static Resolution m354of(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription) {
            ...
            public int hashCode() {
                return this.placeholderType.hashCode() + AbstractC3275.m5128(this.methodDescription, getClass().hashCode() * 31, 31);
            }
        ...
        public static class ForRebasedMethod implements Resolution {
            ...
            public static class RebasedMethod extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                @Override // net.bytebuddy.description.ModifierReviewable
                public int getModifiers() {
                    return ((!this.instrumentedType.isInterface() || this.methodDescription.isNative()) ? 2 : 1) | (this.methodDescription.isStatic() ? 8 : 0) | 4096 | (this.methodDescription.isNative() ? 272 : 0);
                }
            ...
            /* JADX INFO: renamed from: of */
            public static Resolution m355of(TypeDescription typeDescription, MethodDescription.InDefinedShape inDefinedShape, MethodNameTransformer methodNameTransformer) {
