...
public class ByteArrayClassLoader extends InjectionClassLoader {
    ...
    public class ClassDefinitionAction implements PrivilegedAction<Class<?>> {
        ...
        public int hashCode() {
            return ByteArrayClassLoader.this.hashCode() + ((Arrays.hashCode(this.binaryRepresentation) + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.name)) * 31);
        }
            ...
            if (iLastIndexOf != -1) {
                ...
                if (definitionDefine.isDefined()) {
                    ...
                    if (packageApply == null) {
                        ...
                        throw new SecurityException("Sealing violation for package ".concat(strSubstring));
                    }
                }
            }
    ...
    public enum PersistenceHandler {
        ...
        public static class UrlDefinitionAction implements PrivilegedAction<URL> {
            ...
            public interface Dispatcher {
                ...
                URL m329of(URI uri, URLStreamHandler uRLStreamHandler);
            }
            ...
            public int hashCode() {
                return Arrays.hashCode(this.binaryRepresentation) + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.typeName);
            }
            ...
            public URL run() {
                try {
                    ...
                    URL urlM329of = dispatcher.m329of(URI.create("bytebuddy://" + strEncode), byteArrayUrlStreamHandler);
                    return urlM329of == null ? dispatcher.make(ByteArrayClassLoader.URL_SCHEMA, strEncode, -1, "", byteArrayUrlStreamHandler) : urlM329of;
                } catch (UnsupportedEncodingException e) {
                    C9620.m15032("Could not find encoding: UTF-8", e);
                    return null;
                } catch (MalformedURLException e2) {
                    C6385.m11444("Cannot create URL for ", this.typeName, e2);
                    return null;
                }
            }
        }
        ...
        for (TypeDescription typeDescription : map.keySet()) {
            if (!classLoaderDecoratorMake.isSkipped(typeDescription)) {
                try {
                    ...
                    C9620.m15032(AbstractC3275.m5132("Cannot load class ", typeDescription), e);
                    return null;
                }
            }
        }
