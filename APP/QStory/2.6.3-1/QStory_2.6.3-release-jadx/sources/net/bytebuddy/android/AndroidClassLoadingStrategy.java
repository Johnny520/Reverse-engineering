...
public abstract class AndroidClassLoadingStrategy implements ClassLoadingStrategy<ClassLoader> {
    ...
    public AndroidClassLoadingStrategy(File file, DexProcessor dexProcessor) {
        if (!file.isDirectory()) {
            C5043.m9163(file, "Not a directory ");
            throw null;
        }
    ...
    public static class Injecting extends AndroidClassLoadingStrategy {
            ...
            public static class ForAndroidPVm implements Dispatcher {
                ...
                public Class<?> loadClass(@MaybeNull DexFile dexFile, @MaybeNull ClassLoader classLoader, TypeDescription typeDescription) {
                    try {
                        ...
                        C9620.m15032(AbstractC3275.m5132("Could not locate ", typeDescription), e);
                        return null;
                    }
                }
                ...
                public DexFile loadDex(File file, File file2, @MaybeNull ClassLoader classLoader, RandomString randomString) throws IOException {
                    if (!(classLoader instanceof BaseDexClassLoader)) {
                        C5043.m9163(classLoader, "On Android P, a class injection can only be applied to BaseDexClassLoader: ");
                        return null;
                    }
                    try {
                        ...
                        C9620.m15032("Cannot access BaseDexClassLoader#addDexPath(String, boolean)", e);
                        return null;
                        ...
                        C9620.m15032("Cannot invoke BaseDexClassLoader#addDexPath(String, boolean)", targetException);
                        return null;
                    }
                }
            }
        ...
        public Map<TypeDescription, Class<?>> load(@MaybeNull ClassLoader classLoader, Map<TypeDescription, byte[]> map) {
            ...
            C6755.m11869("Cannot inject classes into the bootstrap class loader on Android");
            return null;
        }
        ...
        public Map<TypeDescription, Class<?>> doLoad(@MaybeNull ClassLoader classLoader, Set<TypeDescription> set, File file) {
            ...
            for (TypeDescription typeDescription : set) {
                try {
                    ...
                    C9620.m15032(AbstractC3275.m5132("Cannot load ", typeDescription), e);
                    return null;
                }
            }
            return map;
        ...
        public static class ForReadOnlyClassFile implements FileProcessor {
            ...
            public void accept(File file) {
                try {
                    ...
                    C9620.m15032("Cannot access file system permissions", e);
                } catch (InvocationTargetException e2) {
                    if (e2.getTargetException() instanceof UnsupportedOperationException) {
                        return;
                    }
                    C9620.m15032("Cannot invoke file system permissions method", e2.getTargetException());
                }
            }
        }
    ...
    public interface DexProcessor {
        ...
        public static class ForSdkCompiler implements DexProcessor {
            ...
            public class Conversion implements Conversion {
                ...
                private final com.android.p002dx.dex.file.DexFile dexFile;

                public Conversion(com.android.p002dx.dex.file.DexFile dexFile) {
                ...
                public void register(String str, byte[] bArr) {
                    ...
                    this.dexFile.add(ForSdkCompiler.DISPATCHER.translate(directClassFile, bArr, ForSdkCompiler.this.dexCompilerOptions, ForSdkCompiler.this.dexFileOptions, new com.android.p002dx.dex.file.DexFile(ForSdkCompiler.this.dexFileOptions)));
                }
            }
            ...
            static {
                ...
                try {
                    try {
                        try {
                            unavailable = new Dispatcher.ForApi26LevelCompatibleVm(CfTranslator.class.getMethod("translate", DxContext.class, DirectClassFile.class, byte[].class, CfOptions.class, DexOptions.class, com.android.p002dx.dex.file.DexFile.class), DxContext.class.getConstructor(null));
                        } catch (Throwable unused) {
                            unavailable = new Dispatcher.ForLegacyVm(CfTranslator.class.getMethod("translate", DirectClassFile.class, byte[].class, CfOptions.class, DexOptions.class, com.android.p002dx.dex.file.DexFile.class), DexOptions.class.getField("targetApiLevel"));
                        }
                    } catch (Throwable th) {
                        unavailable = new Dispatcher.Unavailable(th.getMessage());
                    }
                } catch (Throwable unused2) {
                    unavailable = new Dispatcher.ForLegacyVm(CfTranslator.class.getMethod("translate", DirectClassFile.class, byte[].class, CfOptions.class, DexOptions.class, com.android.p002dx.dex.file.DexFile.class), DexOptions.class.getField("minSdkVersion"));
                }
                DISPATCHER = unavailable;
            ...
            public Conversion create() {
                return new Conversion(new com.android.p002dx.dex.file.DexFile(this.dexFileOptions));
            }
            ...
            public interface Dispatcher {
                ...
                public static class ForLegacyVm implements Dispatcher {
                    ...
                    public void setTargetApi(DexOptions dexOptions, int i) {
                        try {
                            ...
                            C9620.m15032("Cannot access an Android dex file translation method", e);
                        }
                    }

                    @Override // net.bytebuddy.android.AndroidClassLoadingStrategy.DexProcessor.ForSdkCompiler.Dispatcher
                    public ClassDefItem translate(DirectClassFile directClassFile, byte[] bArr, CfOptions cfOptions, DexOptions dexOptions, com.android.p002dx.dex.file.DexFile dexFile) {
                        try {
                            ...
                            C9620.m15032("Cannot invoke Android dex file translation method", e2.getTargetException());
                            return null;
                        }
                    }
                }
                ...
                ClassDefItem translate(DirectClassFile directClassFile, byte[] bArr, CfOptions cfOptions, DexOptions dexOptions, com.android.p002dx.dex.file.DexFile dexFile);
                ...
                public static class ForApi26LevelCompatibleVm implements Dispatcher {
                    ...
                    public ClassDefItem translate(DirectClassFile directClassFile, byte[] bArr, CfOptions cfOptions, DexOptions dexOptions, com.android.p002dx.dex.file.DexFile dexFile) {
                        try {
                            ...
                            C9620.m15032("Cannot instantiate dex context", e2);
                            return null;
                        } catch (InvocationTargetException e3) {
                            C9620.m15032("Cannot invoke Android dex file translation method", e3.getTargetException());
                            return null;
                        }
                    }
