...
public interface ParameterList<T extends ParameterDescription> extends FilterableList<T, ParameterList<T>> {
    ...
    public static class Explicit<S extends ParameterDescription> extends AbstractBase<S> {
        ...
        public static class ForTypes extends AbstractBase<ParameterDescription.InDefinedShape> {
            ...
            @Override // java.util.AbstractList, java.util.List
            public ParameterDescription.InDefinedShape get(int i) {
                int iM5126 = !this.methodDescription.isStatic() ? 1 : 0;
                for (int i2 = 0; i2 < i; i2++) {
                    iM5126 = AbstractC3275.m5126(this.typeDefinitions.get(i2), iM5126);
                }
                return new ParameterDescription.Latent(this.methodDescription, this.typeDefinitions.get(i).asGenericType(), i, iM5126);
            }
    ...
    public static abstract class ForLoadedExecutable<T> extends AbstractBase<ParameterDescription.InDefinedShape> {
        ...
        public static ParameterList<ParameterDescription.InDefinedShape> m273of(Constructor<?> constructor, ParameterDescription.ForLoadedParameter.ParameterAnnotationSource parameterAnnotationSource) {
        ...
        /* JADX INFO: renamed from: of */
        public static ParameterList<ParameterDescription.InDefinedShape> m272of(Constructor<?> constructor) {
            return m273of(constructor, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) new ParameterDescription.ForLoadedParameter.ParameterAnnotationSource.ForLoadedConstructor(constructor));
        }

        /* JADX INFO: renamed from: of */
        public static ParameterList<ParameterDescription.InDefinedShape> m274of(Method method) {
            return m275of(method, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) new ParameterDescription.ForLoadedParameter.ParameterAnnotationSource.ForLoadedMethod(method));
        }

        /* JADX INFO: renamed from: of */
        public static ParameterList<ParameterDescription.InDefinedShape> m275of(Method method, ParameterDescription.ForLoadedParameter.ParameterAnnotationSource parameterAnnotationSource) {
