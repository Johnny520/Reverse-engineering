...
public interface TypeDefinition extends NamedElement, ModifierReviewable.ForTypeDefinition, Iterable<TypeDefinition> {
    ...
    public static class SuperClassIterator implements Iterator<TypeDefinition> {
        ...
        public TypeDefinition next() {
            if (!hasNext()) {
                C5043.m9176("End of type hierarchy");
                return null;
            }
            try {
    ...
    public static final class Sort {
        ...
        static {
            ...
            ANNOTATED_TYPE = (AnnotatedType) doPrivileged(JavaDispatcher.m496of(AnnotatedType.class));
        }
        ...
        public static TypeDescription.Generic describeAnnotated(AnnotatedElement annotatedElement) {
            ...
            C5043.m9163(annotatedElement, "Not an instance of AnnotatedType: ");
            return null;
        }

        public static TypeDescription.Generic describeOrNull(@MaybeNull Type type, TypeDescription.Generic.AnnotationReader annotationReader) {
            if (type != null) {
