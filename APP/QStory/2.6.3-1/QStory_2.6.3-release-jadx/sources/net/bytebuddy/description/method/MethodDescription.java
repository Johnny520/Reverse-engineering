...
public interface MethodDescription extends TypeVariableSource, ModifierReviewable.ForMethodDescription, DeclaredByType.WithMandatoryDeclaration, ByteCodeElement.Member, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
        ...
        public static abstract class AbstractBase extends AbstractBase implements InDefinedShape {
            ...
            public static abstract class ForLoadedExecutable<T extends AnnotatedElement> extends AbstractBase {
                ...
                static {
                    ...
                    EXECUTABLE = (Executable) doPrivileged(JavaDispatcher.m496of(Executable.class));
                }
            ...
            public TypeDescription.Generic getReceiverType() {
                ...
                if (!isConstructor()) {
                    return TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m298of(getDeclaringType());
                }
                TypeDescription declaringType = getDeclaringType();
                TypeDescription enclosingType = getDeclaringType().getEnclosingType();
                return enclosingType == null ? TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m298of(declaringType) : declaringType.isStatic() ? enclosingType.asGenericType() : TypeDescription.Generic.OfParameterizedType.ForGenerifiedErasure.m298of(enclosingType);
            }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        public TypeDescription.Generic getReceiverType() {
            ...
            return generic == null ? super.getReceiverType() : (TypeDescription.Generic) generic.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m300of(this));
        }

        @Override // net.bytebuddy.description.method.MethodDescription
        public TypeDescription.Generic getReturnType() {
            return (TypeDescription.Generic) this.returnType.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m300of(this));
        }
        ...
        public static class TypeInitializer extends InDefinedShape.AbstractBase {
            ...
            @Override // net.bytebuddy.description.method.MethodDescription
            public TypeDescription.Generic getReturnType() {
                return TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Void.TYPE);
            }
    ...
    public static abstract class AbstractBase extends TypeVariableSource.AbstractBase implements MethodDescription {
        ...
        public int getActualModifiers(boolean z, Visibility visibility) {
            return ModifierContributor.Resolver.m276of(Collections.singleton(getVisibility().expandTo(visibility))).resolve(getActualModifiers(z));
        }
        ...
        public boolean isConstantBootstrap() {
            return isBootstrap(TypeDescription.ForLoadedType.m289of(Class.class));
        }

        @Override // net.bytebuddy.description.method.MethodDescription
        public int getActualModifiers(boolean z) {
            int actualModifiers = getActualModifiers();
            return z ? actualModifiers & (-1281) : (actualModifiers & 1280) == 0 ? actualModifiers | 1024 : actualModifiers;
        }
    ...
    public static class SignatureToken {
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                iM5144 = AbstractC3275.m5144(this.returnType, this.name.hashCode() * 31, 31) + this.parameterTypes.hashCode();
            }
            if (iM5144 == 0) {
                return this.hashCode;
            }
            this.hashCode = iM5144;
            return iM5144;
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public boolean equals(@MaybeNull Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                if (this.modifiers == token.modifiers && this.name.equals(token.name) && this.typeVariableTokens.equals(token.typeVariableTokens) && this.returnType.equals(token.returnType) && this.parameterTokens.equals(token.parameterTokens) && this.exceptionTypes.equals(token.exceptionTypes) && this.annotations.equals(token.annotations)) {
                    AnnotationValue<?, ?> annotationValue = this.defaultValue;
                    AnnotationValue<?, ?> annotationValue2 = token.defaultValue;
                    if (annotationValue == null ? annotationValue2 == null : annotationValue.equals(annotationValue2)) {
                        TypeDescription.Generic generic = this.receiverType;
                        TypeDescription.Generic generic2 = token.receiverType;
                        if (generic == null ? generic2 == null : generic.equals(generic2)) {
                            return true;
                        }
                    }
                }
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                int iHashCode = (this.annotations.hashCode() + ((this.exceptionTypes.hashCode() + ((this.parameterTokens.hashCode() + AbstractC3275.m5145(this.returnType, (this.typeVariableTokens.hashCode() + (((this.name.hashCode() * 31) + this.modifiers) * 31)) * 31, 31)) * 31)) * 31)) * 31;
                AnnotationValue<?, ?> annotationValue = this.defaultValue;
        ...
        public Token(int i) {
            this(MethodDescription.CONSTRUCTOR_INTERNAL_NAME, i, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Void.TYPE));
        }
    ...
    public static class ForLoadedConstructor extends InDefinedShape.AbstractBase.ForLoadedExecutable<Constructor<?>> implements ParameterDescription.ForLoadedParameter.ParameterAnnotationSource {
        ...
        @Nonnull
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m289of(((Constructor) this.executable).getDeclaringClass());
        }
        ...
        public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
            ParameterList<ParameterDescription.InDefinedShape> parameterListM273of = this.parameters != null ? null : ParameterList.ForLoadedExecutable.m273of((Constructor<?>) this.executable, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) this);
            if (parameterListM273of == null) {
                return this.parameters;
            }
            this.parameters = parameterListM273of;
            return parameterListM273of;
        }
        ...
        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return TypeList.Generic.ForLoadedTypes.OfTypeVariables.m307of((GenericDeclaration) this.executable);
        }
    ...
    public static class ForLoadedMethod extends InDefinedShape.AbstractBase.ForLoadedExecutable<Method> implements ParameterDescription.ForLoadedParameter.ParameterAnnotationSource {
        ...
        @Nonnull
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m289of(((Method) this.executable).getDeclaringClass());
        }
        ...
        @CachedReturnPlugin.Enhance("parameters")
        public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
            ParameterList<ParameterDescription.InDefinedShape> parameterListM275of = this.parameters != null ? null : ParameterList.ForLoadedExecutable.m275of((Method) this.executable, (ParameterDescription.ForLoadedParameter.ParameterAnnotationSource) this);
            if (parameterListM275of == null) {
                return this.parameters;
            }
            this.parameters = parameterListM275of;
            return parameterListM275of;
        }
        ...
        @Override // net.bytebuddy.description.method.MethodDescription
        public TypeDescription.Generic getReturnType() {
            boolean z = TypeDescription.AbstractBase.RAW_TYPES;
            T t = this.executable;
            return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(((Method) t).getReturnType()) : new TypeDescription.Generic.LazyProjection.ForLoadedReturnType((Method) t);
        }

        @Override // net.bytebuddy.description.TypeVariableSource
        public TypeList.Generic getTypeVariables() {
            return TypeDescription.AbstractBase.RAW_TYPES ? new TypeList.Generic.Empty() : TypeList.Generic.ForLoadedTypes.OfTypeVariables.m307of((GenericDeclaration) this.executable);
        }
