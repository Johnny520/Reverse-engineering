...
public interface FieldDescription extends ModifierReviewable.ForFieldDescription, DeclaredByType.WithMandatoryDeclaration, ByteCodeElement.Member, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class ForLoadedField extends InDefinedShape.AbstractBase {
        ...
        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.m289of(this.field.getDeclaringClass());
        }
        ...
        public TypeDescription.Generic getType() {
            ...
            return z ? TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(field.getType()) : new TypeDescription.Generic.LazyProjection.ForLoadedFieldType(field);
        }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        @Override // net.bytebuddy.description.field.FieldDescription
        public TypeDescription.Generic getType() {
            return (TypeDescription.Generic) this.fieldType.accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m299of(this));
        }
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                iM5145 = AbstractC3275.m5145(this.type, ((this.name.hashCode() * 31) + this.modifiers) * 31, 31) + this.annotations.hashCode();
            }
            if (iM5145 == 0) {
                return this.hashCode;
            }
