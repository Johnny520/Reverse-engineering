...
public interface NamingStrategy {
    ...
    public static class Suffixing extends AbstractBase {
        ...
        public interface BaseNameResolver {
            ...
            public static class WithCallerSuffix implements BaseNameResolver {
                ...
                public String resolve(TypeDescription typeDescription) {
                    ...
                    if (str == null) {
                        C6755.m11870(AbstractC0900.m714(ByteBuddy.class, "Base name resolver not invoked via "));
                        return null;
                    }
        ...
        public int hashCode() {
            return this.baseNameResolver.hashCode() + AbstractC7012.m12131(AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.suffix), 31, this.javaLangPackagePrefix);
        }
        ...
        public String name(TypeDescription typeDescription) {
            ...
            StringBuilder sbM12143 = AbstractC7012.m12143(strResolve, "$");
            sbM12143.append(this.suffix);
