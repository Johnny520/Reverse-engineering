...
final class Constants {
    ...
    public static void checkAsmExperimental(Object obj) {
        ...
        checkIsPreview(cls.getClassLoader().getResourceAsStream(stringConcat$0(strReplace)));
    }

    public static void checkIsPreview(InputStream inputStream) {
        if (inputStream == null) {
            C6755.m11870("Bytecode not available, can't check class version");
            return;
        }
        try {
            ...
            try {
                ...
                C6755.m11870("ASM10_EXPERIMENTAL can only be used by classes compiled with --enable-preview");
            } catch (Throwable th) {
                try {
                    dataInputStream.close();
            ...
            C9620.m15032("I/O error, can't check class version", e);
        }
    }

    public static boolean isWhitelisted(String str) {
        if (str.startsWith("net/bytebuddy/jar/asm/")) {
            return str.contains("Test$") || Pattern.matches(stringConcat$1("(Annotation|Class|Field|Method|Module|RecordComponent|Signature)"), str) || Pattern.matches(stringConcat$2("(Annotation|Class|Field|Method|Module|RecordComponent|Signature)"), str);
        }
        return false;
    }
    ...
    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0900.m718("net/bytebuddy/jar/asm/util/Trace", str, "Visitor(\\$.*)?");
    }

    private static /* synthetic */ String stringConcat$2(String str) {
        return AbstractC0900.m718("net/bytebuddy/jar/asm/util/Check", str, "Adapter(\\$.*)?");
    }
}
