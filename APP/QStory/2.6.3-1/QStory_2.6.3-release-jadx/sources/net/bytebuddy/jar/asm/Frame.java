...
class Frame {
    ...
    public static int getAbstractTypeFromApiFormat(SymbolTable symbolTable, Object obj) {
        ...
        return (label.flags & 4) != 0 ? symbolTable.addUninitializedType("", label.bytecodeOffset) | UNINITIALIZED_KIND : symbolTable.addForwardUninitializedType("", label) | FORWARD_UNINITIALIZED_KIND;
    }
    ...
    private static int getAbstractTypeFromDescriptor(SymbolTable symbolTable, String str, int i) {
        ...
        if (cCharAt == 'L') {
            return symbolTable.addType(AbstractC0900.m721(1, i + 1, str)) | REFERENCE_KIND;
        }
        if (cCharAt != 'S') {
            if (cCharAt == 'V') {
                return 0;
                ...
                if (cCharAt != 'Z') {
                    if (cCharAt == '[') {
                        ...
                        if (cCharAt2 == 'F') {
                            ...
                            iAddType = symbolTable.addType(AbstractC0900.m721(1, i2 + 1, str)) | REFERENCE_KIND;
                        } else if (cCharAt2 == 'S') {
                            iAddType = SHORT;
                        } else if (cCharAt2 == 'Z') {
                            iAddType = BOOLEAN;
                            ...
                            switch (cCharAt2) {
                                ...
                                case 'D':
                                    ...
                                    break;
                                default:
                                    C6755.m11869(stringConcat$0(str.substring(i2)));
                                    return 0;
                            }
                        } else {
                            iAddType = LONG;
                    ...
                    switch (cCharAt) {
                        ...
                        case 'D':
                            return DOUBLE;
                        default:
                            C6755.m11869(stringConcat$1(str.substring(i)));
                            return 0;
                    }
                }
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0055 A[LOOP:0: B:9:0x0011->B:25:0x0055, LOOP_END] */
    ...
    */
    private int getInitializedType(SymbolTable symbolTable, int i) {
        int i2;
        int i3;
        if (i == UNINITIALIZED_THIS || (i3 = (-4194304) & i) == UNINITIALIZED_KIND || i3 == FORWARD_UNINITIALIZED_KIND) {
            for (int i4 = 0; i4 < this.initializationCount; i4++) {
                ...
                if (i7 == LOCAL_KIND) {
                    ...
                    if (i != i5) {
                        return REFERENCE_KIND | (i == UNINITIALIZED_THIS ? symbolTable.addType(symbolTable.getClassName()) : symbolTable.addType(symbolTable.getType(i & VALUE_MASK).value));
                    }
                }
                i5 = i2 + i6;
                if (i != i5) {
    ...
    public static void putAbstractType(SymbolTable symbolTable, int i, ByteVector byteVector) {
        ...
        if (i2 == 0) {
            ...
            if (i4 == UNINITIALIZED_KIND) {
                ...
                return;
            } else if (i4 != FORWARD_UNINITIALIZED_KIND) {
                C6385.m11429();
                return;
            } else {
    ...
    private static /* synthetic */ String stringConcat$0(String str) {
        return AbstractC0900.m717("Invalid descriptor fragment: ", str);
    }

    private static /* synthetic */ String stringConcat$1(String str) {
        return AbstractC0900.m717("Invalid descriptor: ", str);
    }

    private static /* synthetic */ String stringConcat$2(String str) {
        return AbstractC0900.m717("[", str);
    }
