...
public class ClassWriter extends ClassVisitor {
    ...
    private Attribute[] getAttributePrototypes() {
        ...
        for (FieldWriter fieldWriter = this.firstField; fieldWriter != null; fieldWriter = (FieldWriter) fieldWriter.f321fv) {
            fieldWriter.collectAttributePrototypes(set);
        }
        for (MethodWriter methodWriter = this.firstMethod; methodWriter != null; methodWriter = (MethodWriter) methodWriter.f322mv) {
    ...
    public byte[] toByteArray() {
        ...
        if ((this.accessFlags & 4096) != 0 && (this.version & com.android.p002dx.p005io.Opcodes.MAX_VALUE) < 49) {
            attributeCount++;
        ...
        if ((this.accessFlags & 65536) == 0 && this.firstRecordComponent == null) {
            ...
            int i11 = iComputeRecordComponentInfoSize + 8 + i9;
            i = attributeCount + 1;
        ...
        if (attribute != null) {
            ...
            iComputeAttributesSize = this.firstAttribute.computeAttributesSize(this.symbolTable) + i3;
        } else {
            i4 = i2;
            attributeCount2 = i;
        ...
        byteVector5.putShort((~((this.version & com.android.p002dx.p005io.Opcodes.MAX_VALUE) < 49 ? 4096 : 0)) & this.accessFlags).putShort(this.thisClass).putShort(this.superClass);
        ...
        for (FieldWriter fieldWriter2 = this.firstField; fieldWriter2 != null; fieldWriter2 = (FieldWriter) fieldWriter2.f321fv) {
            fieldWriter2.putFieldInfo(byteVector5);
        }
        byteVector5.putShort(i8);
        boolean zHasFrames = false;
        boolean zHasAsmInstructions = false;
        for (MethodWriter methodWriter2 = this.firstMethod; methodWriter2 != null; methodWriter2 = (MethodWriter) methodWriter2.f322mv) {
        ...
        if (this.sourceFileIndex != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceFile.ATTRIBUTE_NAME)).putInt(i5).putShort(this.sourceFileIndex);
        }
        ByteVector byteVector7 = this.debugExtension;
        if (byteVector7 != null) {
            int i13 = byteVector7.length;
            i6 = 0;
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceDebugExtension.ATTRIBUTE_NAME)).putInt(i13).putByteArray(this.debugExtension.data, 0, i13);
        } else {
            i6 = 0;
        }
        if ((this.accessFlags & 131072) != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttDeprecated.ATTRIBUTE_NAME)).putInt(i6);
        }
    ...
    public final void visit(int i, int i2, String str, String str2, String str3, String[] strArr) {
        ...
        int i3 = i & com.android.p002dx.p005io.Opcodes.MAX_VALUE;
    ...
    public final FieldVisitor visitField(int i, String str, String str2, String str3, Object obj) {
        ...
        if (this.firstField == null) {
            ...
            this.lastField.f321fv = fieldWriter;
        }
    ...
    public final MethodVisitor visitMethod(int i, String str, String str2, String str3, String[] strArr) {
        ...
        if (this.firstMethod == null) {
            ...
            this.lastMethod.f322mv = methodWriter;
        }
