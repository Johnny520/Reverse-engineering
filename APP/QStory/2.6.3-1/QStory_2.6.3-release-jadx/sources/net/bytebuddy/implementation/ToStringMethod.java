...
public class ToStringMethod implements Implementation {
    private static final MethodDescription.InDefinedShape STRING_BUILDER_CONSTRUCTOR = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(StringBuilder.class).getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments((Class<?>[]) new Class[]{String.class}))).getOnly();
    private static final MethodDescription.InDefinedShape TO_STRING = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(StringBuilder.class).getDeclaredMethods().filter(ElementMatchers.isToString()).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            if (methodDescription.isStatic()) {
                C6755.m11870(AbstractC3275.m5133("toString method must not be static: ", methodDescription));
                return null;
            }
            if (!methodDescription.getReturnType().asErasure().isAssignableFrom(String.class)) {
                C6755.m11870(AbstractC3275.m5133("toString method does not return String-compatible type: ", methodDescription));
                return null;
            }
            ArrayList arrayList = new ArrayList(Math.max(0, (this.fieldDescriptions.size() * 7) - 2) + 10);
            arrayList.add(TypeCreation.m437of(TypeDescription.ForLoadedType.m289of(StringBuilder.class)));
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                arrayList.add(ValueConsumer.m416of(inDefinedShape.getType().asErasure()));
            }
        ...
        public int hashCode() {
            return this.fieldDescriptions.hashCode() + AbstractC7012.m12131(AbstractC7012.m12131(AbstractC7012.m12131(AbstractC7012.m12131(AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.prefix), 31, this.start), 31, this.end), 31, this.separator), 31, this.definer);
        }
    }
    ...
    public enum ValueConsumer implements StackManipulation {
        ...
        public static StackManipulation m416of(TypeDescription typeDescription) {
    ...
    public static ToStringMethod prefixedBy(String str) {
        ...
        C6755.m11869("Prefix cannot be null");
        return null;
    }
    ...
    public Appender appender(Implementation.Target target) {
        if (target.getInstrumentedType().isInterface()) {
            C5043.m9164(target.getInstrumentedType(), "Cannot implement meaningful toString method for ");
            return null;
        }
        String strResolve = this.prefixResolver.resolve(target.getInstrumentedType());
        if (strResolve != null) {
            return new Appender(strResolve, this.start, this.end, this.separator, this.definer, target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo451or(this.ignored))));
        }
        C6755.m11870("Prefix for toString method cannot be null");
        return null;
    }
    ...
    public int hashCode() {
        return this.ignored.hashCode() + AbstractC7012.m12131(AbstractC7012.m12131(AbstractC7012.m12131(AbstractC7012.m12131((this.prefixResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31, this.start), 31, this.end), 31, this.separator), 31, this.definer);
    }

    public ToStringMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new ToStringMethod(this.prefixResolver, this.start, this.end, this.separator, this.definer, this.ignored.mo451or(elementMatcher));
    }
    ...
    public Implementation withTokens(String str, String str2, String str3, String str4) {
        ...
        C6755.m11869("Token values cannot be null");
        return null;
    }
