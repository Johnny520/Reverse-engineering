...
public interface MethodDelegationBinder {
    ...
    public static /* synthetic */ class C07051 {
        ...
        static {
            ...
            try {
                f317x3870fe4c[AmbiguityResolver.Resolution.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f317x3870fe4c[AmbiguityResolver.Resolution.AMBIGUOUS.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f317x3870fe4c[AmbiguityResolver.Resolution.UNKNOWN.ordinal()] = 4;
        ...
        public static class Builder {
            ...
            public static class Build implements MethodBinding {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    return new StackManipulation.Compound((List<? extends StackManipulation>) CompoundList.m477of((List) this.parameterStackManipulations, Arrays.asList(this.methodInvocation, this.terminatingStackManipulation))).apply(methodVisitor, context);
                }
                ...
                public int hashCode() {
                    return this.terminatingStackManipulation.hashCode() + AbstractC0900.m720(this.parameterStackManipulations, AbstractC3275.m5148(this.methodInvocation, AbstractC7012.m12130(this.registeredTargetIndices, AbstractC3275.m5127(this.target, getClass().hashCode() * 31, 31), 31), 31), 31);
                }
            ...
            public MethodBinding build(StackManipulation stackManipulation) {
                ...
                C6755.m11870("The number of parameters bound does not equal the target's number of parameters");
                return null;
            }
        }
    ...
    public interface ParameterBinding<T> extends StackManipulation {
        ...
        public static class Unique<T> implements ParameterBinding<T> {
            ...
            public static <S> Unique<S> m424of(StackManipulation stackManipulation, S s) {
    ...
    public static class Processor implements Record {
        ...
        public MethodBinding bind(Implementation.Target target, MethodDescription methodDescription, TerminationHandler terminationHandler, MethodInvoker methodInvoker, Assigner assigner) {
            ...
            C6385.m11430("None of ", this.records, " allows for delegation from ", methodDescription3);
            return null;
        }
        ...
        public int hashCode() {
            return this.bindingResolver.hashCode() + ((this.ambiguityResolver.hashCode() + AbstractC0900.m720(this.records, getClass().hashCode() * 31, 31)) * 31);
        }
    }
        ...
        public enum Default implements TerminationHandler {
            RETURNING { // from class: net.bytebuddy.implementation.bind.MethodDelegationBinder.TerminationHandler.Default.1
                ...
                public StackManipulation resolve(Assigner assigner, Assigner.Typing typing, MethodDescription methodDescription, MethodDescription methodDescription2) {
                    return new StackManipulation.Compound(assigner.assign(methodDescription2.isConstructor() ? methodDescription2.getDeclaringType().asGenericType() : methodDescription2.getReturnType(), methodDescription.getReturnType(), typing), MethodReturn.m448of(methodDescription.getReturnType()));
                }
            },
            DROPPING { // from class: net.bytebuddy.implementation.bind.MethodDelegationBinder.TerminationHandler.Default.2
                @Override // net.bytebuddy.implementation.bind.MethodDelegationBinder.TerminationHandler
                public StackManipulation resolve(Assigner assigner, Assigner.Typing typing, MethodDescription methodDescription, MethodDescription methodDescription2) {
                    return Removal.m432of(methodDescription2.isConstructor() ? methodDescription2.getDeclaringType() : methodDescription2.getReturnType());
                }
            };

            /* synthetic */ Default(C07051 c07051) {
                this();
            }
        }
    }
    ...
    public interface BindingResolver {
        ...
        public enum Default implements BindingResolver {
            ...
            private MethodBinding doResolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                if (size == 2) {
                    ...
                    int i = C07051.f317x3870fe4c[ambiguityResolver.resolve(methodDescription, methodBinding, methodBinding2).ordinal()];
                    if (i == 1) {
                    ...
                    StringBuilder sb = new StringBuilder("Cannot resolve ambiguous delegation of ");
                    sb.append(methodDescription);
                    sb.append(" to ");
                    sb.append(methodBinding.getTarget());
                    C6385.m11435(sb, " or ", methodBinding2.getTarget());
                    return null;
                }
                MethodBinding methodBinding3 = list.get(0);
                MethodBinding methodBinding4 = list.get(1);
                int[] iArr = C07051.f317x3870fe4c;
                ...
                if (i2 != 3 && i2 != 4) {
                    C6755.m11864(list.size(), "Unexpected amount of targets: ");
                    return null;
                }
                list.remove(1);
                list.remove(0);
                ...
                StringBuilder sb2 = new StringBuilder("Cannot resolve ambiguous delegation of ");
                sb2.append(methodDescription);
                sb2.append(" to ");
                sb2.append(methodBinding3.getTarget());
                C6385.m11435(sb2, " or ", methodBinding4.getTarget());
                return null;
            }
        ...
        public enum Unique implements BindingResolver {
            ...
            public MethodBinding resolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                C6385.m11432(methodDescription, " allowed for more than one binding: ", list);
                return null;
            }
        }
    ...
    public interface AmbiguityResolver {
        ...
        public enum Resolution {
            ...
            public Resolution merge(Resolution resolution) {
                int i = C07051.f317x3870fe4c[ordinal()];
                if (i == 1 || i == 2) {
