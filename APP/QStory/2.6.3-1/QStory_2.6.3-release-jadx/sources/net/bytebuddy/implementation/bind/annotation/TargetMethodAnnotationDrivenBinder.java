...
public class TargetMethodAnnotationDrivenBinder implements MethodDelegationBinder {
    ...
    public static class DelegationProcessor {
        ...
        public interface Handler {
            ...
            public static class Bound<T extends Annotation> implements Handler {
                ...
                public static Handler m429of(ParameterDescription parameterDescription, ParameterBinder<?> parameterBinder, AnnotationDescription annotationDescription, Assigner.Typing typing) {
            ...
            public static class Unbound implements Handler {
                ...
                public static class DefaultArgument implements Argument {
                    ...
                    public String toString() {
                        ...
                        sb.append(", value=");
                        return AbstractC0900.m707(sb, ")", this.parameterIndex);
                    }
                ...
                @Override // net.bytebuddy.implementation.bind.annotation.TargetMethodAnnotationDrivenBinder.DelegationProcessor.Handler
                public MethodDelegationBinder.ParameterBinding<?> bind(MethodDescription methodDescription, Implementation.Target target, Assigner assigner) {
                    return Argument.Binder.INSTANCE.bind(AnnotationDescription.ForLoadedAnnotation.m245of(new DefaultArgument(this.target.getIndex())), methodDescription, this.target, target, assigner, this.typing);
                }
        ...
        /* JADX INFO: renamed from: of */
        public static DelegationProcessor m428of(List<? extends ParameterBinder<?>> list) {
            HashMap map = new HashMap();
            for (ParameterBinder<?> parameterBinder : list) {
                if (map.put(TypeDescription.ForLoadedType.m289of(parameterBinder.getHandledType()), parameterBinder) != null) {
                    C8376.m13323(parameterBinder.getHandledType(), "Attempt to bind two handlers to ");
                    return null;
                }
            }
        ...
        public Handler prepare(ParameterDescription parameterDescription) {
            ...
            for (AnnotationDescription annotationDescription : parameterDescription.getDeclaredAnnotations()) {
                ...
                if (parameterBinder != null && unbound.isBound()) {
                    C6755.m11870("Ambiguous binding for parameter annotated with two handled annotation types");
                    return null;
                }
                if (parameterBinder != null) {
                    unbound = Handler.Bound.m429of(parameterDescription, parameterBinder, annotationDescription, typingCheck);
                }
            }
            return unbound;
        }
    ...
    public interface ParameterBinder<T extends Annotation> {
            ...
            public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<S> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
                ...
                if (!typeDescriptionDeclaringType.represents(cls)) {
                    if (declaringType(loadable).isPrimitive() || declaringType(loadable).isArray()) {
                        C6755.m11870(AbstractC3275.m5133("A primitive type or array type cannot declare a field: ", methodDescription));
                        return null;
                    }
        ...
        public static abstract class ForFixedValue<S extends Annotation> implements ParameterBinder<S> {
            ...
            public static class OfConstant<U extends Annotation> extends ForFixedValue<U> {
                ...
                /* JADX INFO: renamed from: of */
                public static <V extends Annotation> ParameterBinder<V> m430of(Class<V> cls, @MaybeNull Object obj) {
                ...
                */
                ...
                public int hashCode() {
                    int iM5129 = AbstractC3275.m5129(getClass().hashCode() * 31, 31, this.type);
                    Object obj = this.value;
                    return obj != null ? obj.hashCode() + iM5129 : iM5129;
                }
            }
            ...
            public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<S> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
                ...
                if (objBind == null) {
                    return new MethodDelegationBinder.ParameterBinding.Anonymous(DefaultValue.m443of(parameterDescription.getType()));
                }
    ...
    public static class Record implements MethodDelegationBinder.Record {
        ...
        public int hashCode() {
            return this.typing.hashCode() + AbstractC0900.m720(this.handlers, AbstractC3275.m5127(this.candidate, getClass().hashCode() * 31, 31), 31);
        }
    ...
    /* JADX INFO: renamed from: of */
    public static MethodDelegationBinder m427of(List<? extends ParameterBinder<?>> list) {
        return new TargetMethodAnnotationDrivenBinder(DelegationProcessor.m428of(list));
    }
