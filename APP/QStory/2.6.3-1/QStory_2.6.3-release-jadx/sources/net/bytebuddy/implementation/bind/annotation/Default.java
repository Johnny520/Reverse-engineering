    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Default> {
        ...
        public interface TypeLocator {
            ...
            public static class ForType implements TypeLocator {
                ...
                public static TypeLocator m425of(TypeDescription typeDescription) {
                ...
                public TypeDescription resolve(TypeDescription.Generic generic) {
                    ...
                    C6385.m11446("Impossible to assign ", typeDescription, " to parameter of type ", generic);
                    return null;
                }
            }
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m289of(Default.class).getDeclaredMethods();
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Default> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
            TypeDescription typeDescriptionResolve = TypeLocator.ForType.m425of((TypeDescription) loadable.getValue(PROXY_TYPE).resolve(TypeDescription.class)).resolve(parameterDescription.getType());
            ...
            C6385.m11438(parameterDescription, " uses the @Default annotation on an invalid type");
            return null;
        }
