...
public abstract class MethodConstant extends StackManipulation.AbstractBase {
    ...
    public static class CachedConstructor implements StackManipulation {
        private static final TypeDescription CONSTRUCTOR_TYPE = TypeDescription.ForLoadedType.m289of(Constructor.class);
    ...
    public static class CachedMethod implements StackManipulation {
        private static final TypeDescription METHOD_TYPE = TypeDescription.ForLoadedType.m289of(Method.class);
    ...
    public static class ForConstructor extends MethodConstant implements CanCache {
        ...
        static {
            try {
                ...
                C9620.m15032("Could not locate Class::getDeclaredConstructor", e);
            }
        }
    ...
    public static class ForMethod extends MethodConstant implements CanCache {
        ...
        static {
            try {
                ...
                C9620.m15032("Could not locate method lookup", e);
            }
        }
    ...
    public static class PrivilegedLookup implements StackManipulation, CanCache {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            if (inDefinedShape != null) {
                TypeDescription typeDescriptionRegister = context.register(PrivilegedMemberLookupAction.m423of(this.methodDescription));
                return new StackManipulation.Compound(TypeCreation.m437of(typeDescriptionRegister), Duplication.SINGLE, ClassConstant.m442of(this.methodDescription.getDeclaringType()), this.methodName, ArrayFactory.forType(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Class.class)).withValues(MethodConstant.typeConstantsFor(this.methodDescription.getParameters().asTypeList().asErasures())), MethodInvocation.invoke((MethodDescription.InDefinedShape) typeDescriptionRegister.getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly()), MethodInvocation.invoke(inDefinedShape), TypeCasting.m440to(TypeDescription.ForLoadedType.m289of(this.methodDescription.isConstructor() ? Constructor.class : Method.class))).apply(methodVisitor, context);
            }
            C6755.m11870("Privileged method invocation is not supported on the current VM");
            return null;
        }
    ...
    public static CanCache m444of(MethodDescription.InDefinedShape inDefinedShape) {
    ...
    public static CanCache ofPrivileged(MethodDescription.InDefinedShape inDefinedShape) {
        return DO_PRIVILEGED == null ? m444of(inDefinedShape) : inDefinedShape.isTypeInitializer() ? CanCacheIllegal.INSTANCE : inDefinedShape.isConstructor() ? new ForConstructor(inDefinedShape).withPrivilegedLookup() : new ForMethod(inDefinedShape).withPrivilegedLookup();
    }
    ...
    public static List<StackManipulation> typeConstantsFor(List<TypeDescription> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(ClassConstant.m442of(it.next()));
        }
        return arrayList;
    }
    ...
    @Override // net.bytebuddy.implementation.bytecode.StackManipulation
    public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
        return new StackManipulation.Compound(ClassConstant.m442of(this.methodDescription.getDeclaringType()), methodName(), ArrayFactory.forType(TypeDescription.Generic.OfNonGenericType.ForLoadedType.m296of(Class.class)).withValues(typeConstantsFor(this.methodDescription.getParameters().asTypeList().asErasures())), MethodInvocation.invoke(accessorMethod())).apply(methodVisitor, context);
    }
