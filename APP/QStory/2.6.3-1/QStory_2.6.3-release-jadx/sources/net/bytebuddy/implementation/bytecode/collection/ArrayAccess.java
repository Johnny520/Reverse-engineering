...
public final class ArrayAccess {
    ...
    private ArrayAccess(String str, int i, int i2, int i3, StackSize stackSize) {
        this.loadOpcode = i2;
        this.storeOpcode = i3;
    ...
    public static ArrayAccess m441of(TypeDefinition typeDefinition) {
        ...
        C5043.m9163(typeDefinition, "Not a legal array type: ");
        return null;
    }
