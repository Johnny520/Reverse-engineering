...
public abstract class Duplication implements StackManipulation {
    ...
    /* JADX INFO: renamed from: net.bytebuddy.implementation.bytecode.Duplication$4 */
    /* JADX INFO: compiled from: r8-map-id-447c03deab370cabd87f71de7ff996ccc1a6dc9764ce389c731d875d052048e4 */
    public static /* synthetic */ class C07184 {
    ...
    static {
        ...
        Duplication duplication2 = new Duplication("SINGLE", 1, StackSize.SINGLE, 89) { // from class: net.bytebuddy.implementation.bytecode.Duplication.2
            @Override // net.bytebuddy.implementation.bytecode.Duplication
            public StackManipulation flipOver(TypeDefinition typeDefinition) {
                int i2 = C07184.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
                if (i2 == 1) {
                ...
                C5043.m9163(typeDefinition, "Cannot flip: ");
                return null;
            }
        };
        SINGLE = duplication2;
    ...
    public static Duplication m431of(TypeDefinition typeDefinition) {
        int i = C07184.$SwitchMap$net$bytebuddy$implementation$bytecode$StackSize[typeDefinition.getStackSize().ordinal()];
        if (i == 1) {
            return SINGLE;
        }
        if (i == 2) {
        ...
        C6385.m11443(typeDefinition, "Unexpected type: ");
        return null;
    }
