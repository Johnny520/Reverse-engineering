    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<DefaultMethod> {
        ...
        public static class DelegationMethod implements StackManipulation {
            ...
            public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                ...
                StackManipulation stackManipulationOfPrivileged = z ? MethodConstant.ofPrivileged(context.registerAccessorFor(specialMethodInvocation, MethodAccessorFactory.AccessType.PUBLIC)) : MethodConstant.m444of(context.registerAccessorFor(specialMethodInvocation, MethodAccessorFactory.AccessType.PUBLIC));
                if (this.cached) {
                    stackManipulationOfPrivileged = FieldAccess.forField(context.cache(stackManipulationOfPrivileged, TypeDescription.ForLoadedType.m289of(Method.class))).read();
                }
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m289of(DefaultMethod.class).getDeclaredMethods();
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<DefaultMethod> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
            if (!parameterDescription.getType().asErasure().isAssignableFrom(Method.class)) {
                C8376.m13333(parameterDescription, "Cannot assign Method type to ");
                return null;
            }
