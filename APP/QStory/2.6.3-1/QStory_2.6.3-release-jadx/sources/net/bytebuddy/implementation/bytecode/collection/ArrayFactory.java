...
public class ArrayFactory implements CollectionFactory {
    ...
    public class ArrayStackManipulation implements StackManipulation {
        ...
        public int hashCode() {
            return ArrayFactory.this.hashCode() + AbstractC0900.m720(this.stackManipulations, getClass().hashCode() * 31, 31);
        }
    ...
    private static ArrayCreator makeArrayCreatorFor(TypeDefinition typeDefinition) {
        ...
        C5043.m9163(typeDefinition, "Cannot create array of type ");
        return null;
    }
    ...
    public int hashCode() {
        return this.arrayCreator.hashCode() + AbstractC3275.m5145(this.componentType, getClass().hashCode() * 31, 31);
    }
