...
public interface LoadedTypeInitializer {
    ...
    public static class ForStaticField implements LoadedTypeInitializer, Serializable {
        ...
        public int hashCode() {
            return this.value.hashCode() + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.fieldName);
        }
        ...
        public void onLoad(Class<?> cls) {
            try {
                ...
                if (!Modifier.isPublic(declaredField.getModifiers()) || !Modifier.isPublic(declaredField.getDeclaringClass().getModifiers()) || (JavaModule.isSupported() && !JavaModule.ofType(cls).isExported(TypeDescription.ForLoadedType.m289of(cls).getPackage(), JavaModule.ofType(ForStaticField.class)))) {
                    doPrivileged(new SetAccessibleAction(declaredField), this.accessControlContext);
                }
                declaredField.set(null, this.value);
            } catch (IllegalAccessException e) {
                C3908.m7459("Cannot access ", this.fieldName, " from ", cls, e);
