...
public @interface Super {
        ...
        public static class Default implements ConstructorResolver {
            ...
            public MethodDescription.InDefinedShape resolve(TypeDescription typeDescription, List<TypeDescription> list) {
                if (typeDescription.isInterface()) {
                    return (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly();
                }
                ...
                C6385.m11446("Did not discover exactly one constructor on ", typeDescription, " with parameters ", list);
                return null;
            }
        }
    ...
    public enum Instantiation {
        CONSTRUCTOR { // from class: net.bytebuddy.implementation.bind.annotation.Super.Instantiation.1
            ...
            public StackManipulation proxyFor(TypeDescription typeDescription, Implementation.Target target, AnnotationDescription.Loadable<Super> loadable) {
                try {
                    ...
                    C6385.m11444("No default constructor specified by ", ((TypeDescription) loadable.getValue(Instantiation.CONSTRUCTOR_RESOLVER).resolve(TypeDescription.class)).getName(), e);
                    return null;
                } catch (InvocationTargetException e2) {
                    C9620.m15032("Failed to resolve constructor specified by " + loadable, e2.getTargetException());
                    return null;
                } catch (Exception e3) {
                    C6385.m11434("Failed to resolve constructor specified by ", loadable, e3);
                    return null;
                }
            }
        },
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> declaredMethods = TypeDescription.ForLoadedType.m289of(Super.class).getDeclaredMethods();
    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Super> {
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Super> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
            if (parameterDescription.getType().isPrimitive() || parameterDescription.getType().isArray()) {
                C6385.m11438(parameterDescription, " uses the @Super annotation on an invalid type");
                return null;
            }
            TypeDescription typeDescriptionResolve = TypeLocator.ForType.m426of((TypeDescription) loadable.getValue(PROXY_TYPE).resolve(TypeDescription.class)).resolve(target.getInstrumentedType(), parameterDescription.getType());
            ...
            C6755.m11870(AbstractC3275.m5132("Cannot extend final type as @Super proxy: ", typeDescriptionResolve));
            return null;
        }
        ...
        public interface TypeLocator {
            ...
            public static class ForType implements TypeLocator {
                ...
                public static TypeLocator m426of(TypeDescription typeDescription) {
                    ...
                    C6755.m11870(AbstractC3275.m5132("Cannot assign proxy to ", typeDescription));
                    return null;
                }
                ...
                public TypeDescription resolve(TypeDescription typeDescription, TypeDescription.Generic generic) {
                    ...
                    C6385.m11446("Impossible to assign ", typeDescription2, " to parameter of type ", generic);
                    return null;
                }
            }
