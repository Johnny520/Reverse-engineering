...
public class MethodDelegation implements Implementation.Composable {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public int hashCode() {
            return this.compiled.hashCode() + AbstractC3275.m5149(this.assigner, (this.terminationHandler.hashCode() + ((this.processor.hashCode() + ((this.implementationTarget.hashCode() + (getClass().hashCode() * 31)) * 31)) * 31)) * 31, 31);
        }
    }
    ...
    public static MethodDelegation m385to(Class<?> cls) {
        return withDefaultConfiguration().m401to(cls);
    }
    ...
    public int hashCode() {
        return this.assigner.hashCode() + ((this.bindingResolver.hashCode() + ((this.terminationHandler.hashCode() + ((this.ambiguityResolver.hashCode() + AbstractC0900.m720(this.parameterBinders, (this.implementationDelegate.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31)) * 31)) * 31);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m398to(TypeDescription typeDescription) {
        return withDefaultConfiguration().m414to(typeDescription);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m386to(Object obj) {
        return withDefaultConfiguration().m402to(obj);
    }
    ...
    public static class WithCustomProperties {
        ...
        public int hashCode() {
            return this.matcher.hashCode() + ((this.bindingResolver.hashCode() + AbstractC0900.m720(this.parameterBinders, (this.ambiguityResolver.hashCode() + (getClass().hashCode() * 31)) * 31, 31)) * 31);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m414to(TypeDescription typeDescription) {
            if (typeDescription.isArray()) {
                C6755.m11869(AbstractC3275.m5132("Cannot delegate to array ", typeDescription));
                return null;
            }
            if (!typeDescription.isPrimitive()) {
                return new MethodDelegation(ImplementationDelegate.ForStaticMethod.m400of(typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().and(this.matcher)), TargetMethodAnnotationDrivenBinder.m427of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
            }
            C6755.m11869(AbstractC3275.m5132("Cannot delegate to primitive ", typeDescription));
            return null;
        }

        public MethodDelegation toConstructor(TypeDescription typeDescription) {
            return new MethodDelegation(ImplementationDelegate.ForConstruction.m399of(typeDescription, typeDescription.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(this.matcher)), TargetMethodAnnotationDrivenBinder.m427of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
        }
        ...
        public WithCustomProperties withBinders(List<? extends TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> list) {
            return new WithCustomProperties(this.ambiguityResolver, CompoundList.m477of((List) this.parameterBinders, (List) list), this.bindingResolver, this.matcher);
        }
        ...
        public WithCustomProperties withResolvers(List<? extends MethodDelegationBinder.AmbiguityResolver> list) {
            return new WithCustomProperties(new MethodDelegationBinder.AmbiguityResolver.Compound((List<? extends MethodDelegationBinder.AmbiguityResolver>) CompoundList.m475of(this.ambiguityResolver, list)), this.parameterBinders, this.bindingResolver, this.matcher);
        }
        ...
        public MethodDelegation toConstructor(Class<?> cls) {
            return toConstructor(TypeDescription.ForLoadedType.m289of(cls));
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m401to(Class<?> cls) {
            return m414to(TypeDescription.ForLoadedType.m289of(cls));
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m402to(Object obj) {
            return m413to(obj, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m413to(Object obj, MethodGraph.Compiler compiler) {
            return m408to(obj, obj.getClass(), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m403to(Object obj, String str) {
            return m404to(obj, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m404to(Object obj, String str, MethodGraph.Compiler compiler) {
            return m407to(obj, obj.getClass(), str, compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m405to(Object obj, Type type) {
            return m408to(obj, type, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m408to(Object obj, Type type, MethodGraph.Compiler compiler) {
            return m407to(obj, type, "delegate$" + RandomString.hashOf(obj), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m406to(Object obj, Type type, String str) {
            return m407to(obj, type, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m407to(Object obj, Type type, String str, MethodGraph.Compiler compiler) {
            return m411to(obj, TypeDefinition.Sort.describe(type), str, compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m409to(Object obj, TypeDefinition typeDefinition) {
            return m412to(obj, typeDefinition, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m412to(Object obj, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
            return m411to(obj, typeDefinition, "delegate$" + RandomString.hashOf(obj), compiler);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m410to(Object obj, TypeDefinition typeDefinition, String str) {
            return m411to(obj, typeDefinition, str, MethodGraph.Compiler.DEFAULT);
        }

        /* JADX INFO: renamed from: to */
        public MethodDelegation m411to(Object obj, TypeDefinition typeDefinition, String str, MethodGraph.Compiler compiler) {
            ...
            C6385.m11424(obj, " is not an instance of ", typeDefinition);
            return null;
        }
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m397to(Object obj, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m413to(obj, compiler);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m387to(Object obj, String str) {
        return withDefaultConfiguration().m403to(obj, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m388to(Object obj, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m404to(obj, str, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m389to(Object obj, Type type) {
        return withDefaultConfiguration().m405to(obj, type);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m392to(Object obj, Type type, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m408to(obj, type, compiler);
    }
    ...
    /* JADX INFO: renamed from: to */
    public static MethodDelegation m390to(Object obj, Type type, String str) {
        return withDefaultConfiguration().m406to(obj, type, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m391to(Object obj, Type type, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m407to(obj, type, str, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m393to(Object obj, TypeDefinition typeDefinition) {
        return withDefaultConfiguration().m409to(obj, typeDefinition);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m396to(Object obj, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m412to(obj, typeDefinition, compiler);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m394to(Object obj, TypeDefinition typeDefinition, String str) {
        return withDefaultConfiguration().m410to(obj, typeDefinition, str);
    }

    /* JADX INFO: renamed from: to */
    public static MethodDelegation m395to(Object obj, TypeDefinition typeDefinition, String str, MethodGraph.Compiler compiler) {
        return withDefaultConfiguration().m411to(obj, typeDefinition, str, compiler);
    }
    ...
    public interface ImplementationDelegate extends InstrumentedType.Prepareable {
        ...
        public interface Compiled {
            ...
            public static class ForConstruction implements Compiled {
                ...
                public int hashCode() {
                    return this.records.hashCode() + AbstractC3275.m5144(this.typeDescription, getClass().hashCode() * 31, 31);
                }
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    return new StackManipulation.Compound(TypeCreation.m437of(this.typeDescription), Duplication.SINGLE);
                }
            }
            ...
            public static class ForField implements Compiled {
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    ...
                    C1123.m1407("Cannot read ", this.fieldDescription, " from ", methodDescription);
                    return null;
                }
            }
            ...
            public static class ForMethodReturn implements Compiled {
                ...
                public int hashCode() {
                    return this.records.hashCode() + AbstractC3275.m5127(this.methodDescription, getClass().hashCode() * 31, 31);
                }
                ...
                public StackManipulation prepare(MethodDescription methodDescription) {
                    ...
                    C1123.m1407("Cannot invoke ", this.methodDescription, " from ", methodDescription);
                    return null;
                }
            }
        ...
        public static abstract class ForField implements ImplementationDelegate {
            ...
            public static class WithInstance extends ForField {
                ...
                public FieldDescription resolve(TypeDescription typeDescription) {
                    ...
                    C6385.m11425(this.fieldType, " is not visible to ", typeDescription);
                    return null;
                }
            }
            ...
            public Compiled compile(TypeDescription typeDescription) {
                ...
                if (!fieldDescriptionResolve.getType().asErasure().isVisibleTo(typeDescription)) {
                    C6385.m11432(fieldDescriptionResolve, " is not visible to ", typeDescription);
                    return null;
                }
                ...
                MethodDelegationBinder methodDelegationBinderM427of = TargetMethodAnnotationDrivenBinder.m427of(this.parameterBinders);
                Iterator<T> it = methodListFilter.iterator();
                while (it.hasNext()) {
                    arrayList.add(methodDelegationBinderM427of.compile((MethodDescription) it.next()));
                }
            ...
            public int hashCode() {
                return this.matcher.hashCode() + AbstractC0900.m720(this.parameterBinders, (this.methodGraphCompiler.hashCode() + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.fieldName)) * 31, 31);
            }
            ...
            public static class WithLookup extends ForField {
                ...
                public FieldDescription resolve(TypeDescription typeDescription) {
                    ...
                    C1123.m1407("Could not locate ", this.fieldName, " on ", typeDescription);
                    return null;
                }
        ...
        public static class ForConstruction implements ImplementationDelegate {
            ...
            public static ImplementationDelegate m399of(TypeDescription typeDescription, MethodList<?> methodList, MethodDelegationBinder methodDelegationBinder) {
        ...
        public static class ForMethodReturn implements ImplementationDelegate {
            ...
            @Override // net.bytebuddy.implementation.MethodDelegation.ImplementationDelegate
            public Compiled compile(TypeDescription typeDescription) {
                MethodList methodListFilter = new MethodList.Explicit(CompoundList.m477of(typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().mo451or(ElementMatchers.isPrivate())), (List) this.methodGraphCompiler.compile((TypeDefinition) typeDescription).listNodes().asMethodList())).filter(ElementMatchers.named(this.name).and(ElementMatchers.takesArguments(0)).and(ElementMatchers.not(ElementMatchers.returns(ElementMatchers.isPrimitive().mo451or(ElementMatchers.isArray())))));
                if (methodListFilter.size() != 1) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(typeDescription);
                    String str = this.name;
                    sb.append(" does not define method without arguments with name ");
                    sb.append(str);
                    sb.append(": ");
                    sb.append(methodListFilter);
                    throw new IllegalStateException(sb.toString());
                }
                if (!((MethodDescription) methodListFilter.getOnly()).getReturnType().asErasure().isVisibleTo(typeDescription)) {
                    C6385.m11425(methodListFilter.getOnly(), " is not visible to ", typeDescription);
                    return null;
                }
            ...
            public int hashCode() {
                return this.matcher.hashCode() + AbstractC0900.m720(this.parameterBinders, (this.methodGraphCompiler.hashCode() + AbstractC7012.m12131(getClass().hashCode() * 31, 31, this.name)) * 31, 31);
            }
        ...
        public static class ForStaticMethod implements ImplementationDelegate {
            ...
            /* JADX INFO: renamed from: of */
            public static ImplementationDelegate m400of(MethodList<?> methodList, MethodDelegationBinder methodDelegationBinder) {
                ArrayList arrayList = new ArrayList(methodList.size());
                Iterator<?> it = methodList.iterator();
                while (it.hasNext()) {
                    arrayList.add(methodDelegationBinder.compile((MethodDescription) it.next()));
