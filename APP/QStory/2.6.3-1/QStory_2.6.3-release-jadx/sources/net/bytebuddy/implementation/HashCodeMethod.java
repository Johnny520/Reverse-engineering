...
public class HashCodeMethod implements Implementation {
    ...
    private static final MethodDescription.InDefinedShape HASH_CODE = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.isHashCode()).getOnly();
    private static final MethodDescription.InDefinedShape GET_CLASS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m289of(Object.class).getDeclaredMethods().filter(ElementMatchers.named("getClass").and(ElementMatchers.takesArguments(0))).getOnly();
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            ...
            if (!methodDescription.getReturnType().represents(Integer.TYPE)) {
                C6755.m11870(AbstractC3275.m5133("Hash code method does not return primitive integer: ", methodDescription));
                return null;
            }
            ...
            for (FieldDescription.InDefinedShape inDefinedShape : this.fieldDescriptions) {
                ...
                if (inDefinedShape.getType().isPrimitive() || !this.identity.matches(inDefinedShape)) {
                    ...
                    arrayList.add(ValueTransformer.m367of(inDefinedShape.getType()));
        ...
        public int hashCode() {
            return this.identity.hashCode() + AbstractC3275.m5146(this.nonNullable, AbstractC0900.m720(this.fieldDescriptions, (AbstractC3275.m5148(this.initialValue, getClass().hashCode() * 31, 31) + this.multiplier) * 31, 31), 31);
        }
    }
        ...
        public static class UsingJump implements NullValueGuard {
            ...
            public class AfterInstruction extends StackManipulation.AbstractBase {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
                    ...
                    context.getFrameGeneration().same1(methodVisitor, TypeDescription.ForLoadedType.m289of(Integer.TYPE), Arrays.asList(context.getInstrumentedType(), TypeDescription.ForLoadedType.m289of(Object.class)));
            ...
            public int hashCode() {
                return this.label.hashCode() + AbstractC3275.m5127(this.instrumentedMethod, getClass().hashCode() * 31, 31);
            }
        }
    ...
    public interface OffsetProvider {
        ...
        public enum ForDynamicTypeHash implements OffsetProvider {
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(MethodVariableAccess.loadThis(), MethodInvocation.invoke(HashCodeMethod.GET_CLASS).virtual(typeDescription), MethodInvocation.invoke(HashCodeMethod.HASH_CODE).virtual(TypeDescription.ForLoadedType.m289of(Class.class)));
            }
        }
        ...
        public enum ForStaticTypeHash implements OffsetProvider {
            ...
            @Override // net.bytebuddy.implementation.HashCodeMethod.OffsetProvider
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(ClassConstant.m442of(typeDescription), MethodInvocation.invoke(HashCodeMethod.HASH_CODE).virtual(TypeDescription.ForLoadedType.m289of(Class.class)));
            }
        }
    ...
    public enum ValueTransformer implements StackManipulation {
        ...
        public static StackManipulation m367of(TypeDefinition typeDefinition) {
    ...
    public ByteCodeAppender appender(Implementation.Target target) {
        if (!target.getInstrumentedType().isInterface()) {
            return new Appender(this.offsetProvider.resolve(target.getInstrumentedType()), this.multiplier, target.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo451or(this.ignored))), this.nonNullable, this.identity);
        }
        C5043.m9164(target.getInstrumentedType(), "Cannot implement meaningful hash code method for ");
        return null;
    }
    ...
    public HashCodeMethod withIdentityFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new HashCodeMethod(this.offsetProvider, this.multiplier, this.ignored, this.nonNullable, this.identity.mo451or(elementMatcher));
    }

    public HashCodeMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new HashCodeMethod(this.offsetProvider, this.multiplier, this.ignored.mo451or(elementMatcher), this.nonNullable, this.identity);
    }
    ...
    public HashCodeMethod withMultiplier(int i) {
        ...
        C6755.m11869("Hash code multiplier must not be zero");
        return null;
    }

    public HashCodeMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
        return new HashCodeMethod(this.offsetProvider, this.multiplier, this.ignored, this.nonNullable.mo451or(elementMatcher), this.identity);
    }
