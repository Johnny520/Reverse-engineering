...
public class ExceptionMethod implements Implementation, ByteCodeAppender {
    ...
    public interface ConstructionDelegate {
        ...
        public static class ForDefaultConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.targetConstructor.hashCode() + AbstractC3275.m5144(this.throwableType, getClass().hashCode() * 31, 31);
            }

            @Override // net.bytebuddy.implementation.ExceptionMethod.ConstructionDelegate
            public StackManipulation make() {
                return new StackManipulation.Compound(TypeCreation.m437of(this.throwableType), Duplication.SINGLE, MethodInvocation.invoke(this.targetConstructor));
            }
        }
        ...
        public static class ForStringConstructor implements ConstructionDelegate {
            ...
            public int hashCode() {
                return this.message.hashCode() + AbstractC3275.m5127(this.targetConstructor, AbstractC3275.m5144(this.throwableType, getClass().hashCode() * 31, 31), 31);
            }

            @Override // net.bytebuddy.implementation.ExceptionMethod.ConstructionDelegate
            public StackManipulation make() {
                return new StackManipulation.Compound(TypeCreation.m437of(this.throwableType), Duplication.SINGLE, new TextConstant(this.message), MethodInvocation.invoke(this.targetConstructor));
            }
        }
    ...
    public static Implementation throwing(TypeDescription typeDescription) {
        ...
        C6755.m11869(AbstractC3275.m5125(typeDescription, " does not extend throwable"));
        return null;
    }
    ...
    public static Implementation throwing(Class<? extends Throwable> cls) {
        return throwing(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static Implementation throwing(Class<? extends Throwable> cls, String str) {
        return throwing(TypeDescription.ForLoadedType.m289of(cls), str);
    }
