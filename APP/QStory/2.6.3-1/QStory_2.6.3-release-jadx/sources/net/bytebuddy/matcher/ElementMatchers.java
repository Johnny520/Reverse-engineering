...
public final class ElementMatchers {
    ...
    public static <T extends AnnotationDescription> ElementMatcher.Junction<T> annotationType(Class<? extends Annotation> cls) {
        return annotationType(TypeDescription.ForLoadedType.m289of(cls));
    }

    public static <T> ElementMatcher.Junction<T> any() {
        return BooleanMatcher.m450of(true);
    }

    public static <T> ElementMatcher.Junction<T> anyOf(Iterable<?> iterable) {
        ElementMatcher.Junction<T> junctionM452is = null;
        for (Object obj : iterable) {
            junctionM452is = junctionM452is == null ? m452is(obj) : junctionM452is.mo451or(m452is(obj));
        }
        return junctionM452is == null ? none() : junctionM452is;
    }
    ...
    public static <T> ElementMatcher.Junction<T> cached(ElementMatcher<? super T> elementMatcher, int i) {
        ...
        C6755.m11869(AbstractC7012.m12147(i, "Eviction size must be a positive number: "));
        return null;
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> canThrow(TypeDescription typeDescription) {
        return (typeDescription.isAssignableTo(RuntimeException.class) || typeDescription.isAssignableTo(Error.class)) ? BooleanMatcher.m450of(true) : declaresGenericException(new CollectionItemMatcher(erasure(isSuperTypeOf(typeDescription))));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> declaresException(TypeDescription typeDescription) {
        return typeDescription.isAssignableTo(Throwable.class) ? declaresGenericException(new CollectionItemMatcher(erasure(typeDescription))) : BooleanMatcher.m450of(false);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> declaresGenericException(TypeDescription.Generic generic) {
        return (generic.getSort().isWildcard() || !generic.asErasure().isAssignableTo(Throwable.class)) ? BooleanMatcher.m450of(false) : declaresGenericException(new CollectionItemMatcher(m452is(generic)));
    }
    ...
    public static <T extends TypeDescription.Generic> ElementMatcher.Junction<T> erasure(Class<?> cls) {
        return erasure(m457is((Type) cls));
    }
    ...
    public static <T extends FieldDescription> ElementMatcher.Junction<T> fieldType(Class<?> cls) {
        return fieldType(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> hasSignature(MethodDescription.SignatureToken signatureToken) {
        return new SignatureTokenMatcher(m452is(signatureToken));
    }
    ...
    public static <T extends TypeDescription> ElementMatcher.Junction<T> inheritsAnnotation(Class<?> cls) {
        return inheritsAnnotation(TypeDescription.ForLoadedType.m289of(cls));
    }

    /* JADX INFO: renamed from: is */
    public static <T> ElementMatcher.Junction<T> m452is(@MaybeNull Object obj) {
    ...
    public static <T extends ModifierReviewable.ForMethodDescription> ElementMatcher.Junction<T> isBridge() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.BRIDGE);
    }

    public static <T extends ClassLoader> ElementMatcher.Junction<T> isChildOf(@MaybeNull ClassLoader classLoader) {
        return classLoader == ClassLoadingStrategy.BOOTSTRAP_LOADER ? BooleanMatcher.m450of(true) : hasChild(m452is(classLoader));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isConstructor() {
        return MethodSortMatcher.m461of(MethodSortMatcher.Sort.CONSTRUCTOR);
    }

    public static <T extends ByteCodeElement> ElementMatcher.Junction<T> isDeclaredBy(Class<?> cls) {
        return isDeclaredBy(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isDefaultFinalizer() {
        return isFinalizer().and(isDeclaredBy(TypeDescription.ForLoadedType.m289of(Object.class)));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isDefaultMethod() {
        return MethodSortMatcher.m461of(MethodSortMatcher.Sort.DEFAULT_METHOD);
    }

    public static <T extends ModifierReviewable.OfEnumeration> ElementMatcher.Junction<T> isEnum() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.ENUMERATION);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isEquals() {
        return named("equals").and(takesArguments(TypeDescription.ForLoadedType.m289of(Object.class))).and(returns((Class<?>) Boolean.TYPE));
    }
    ...
    public static <T extends ModifierReviewable> ElementMatcher.Junction<T> isFinal() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.FINAL);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isFinalizer() {
        return named("finalize").and(takesNoArguments()).and(returns(TypeDescription.ForLoadedType.m289of(Void.TYPE)));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter(String str) {
        ElementMatcher.Junction junctionMo451or;
        ElementMatcher.Junction junctionIsGetter = isGetter();
        if (str.length() == 0) {
            junctionMo451or = named("get").mo451or(named("is"));
        } else {
            junctionMo451or = named("get" + Character.toUpperCase(str.charAt(0)) + str.substring(1)).mo451or(named("is" + Character.toUpperCase(str.charAt(0)) + str.substring(1)));
        }
        return junctionIsGetter.and(junctionMo451or);
    }
    ...
    public static <T extends TypeDescription> ElementMatcher.Junction<T> isInterface() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.INTERFACE);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isMain(boolean z) {
        Class cls = Void.TYPE;
        return z ? named("main").and(takesArguments((Class<?>[]) new Class[]{String[].class}).mo451or(takesArguments(0))).and(returns(TypeDescription.ForLoadedType.m289of(cls))).and(not(isPrivate())) : named("main").and(takesArguments((Class<?>[]) new Class[]{String[].class})).and(returns(TypeDescription.ForLoadedType.m289of(cls))).and(isStatic()).and(isPublic());
    }

    public static <T extends ParameterDescription> ElementMatcher.Junction<T> isMandated() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.MANDATED);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isMethod() {
        return MethodSortMatcher.m461of(MethodSortMatcher.Sort.METHOD);
    }
    ...
    public static <T extends ModifierReviewable.ForMethodDescription> ElementMatcher.Junction<T> isNative() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.NATIVE);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isOverriddenFrom(Class<?> cls) {
        return isOverriddenFrom(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends ModifierReviewable.OfByteCodeElement> ElementMatcher.Junction<T> isPackagePrivate() {
        return not(isPublic().mo451or(isProtected()).mo451or(isPrivate()));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isToString() {
        return named("toString").and(takesNoArguments()).and(returns(TypeDescription.ForLoadedType.m289of(String.class)));
    }

    public static <T extends FieldDescription> ElementMatcher.Junction<T> isTransient() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.TRANSIENT);
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isTypeInitializer() {
        return MethodSortMatcher.m461of(MethodSortMatcher.Sort.TYPE_INITIALIZER);
    }

    public static <T extends ModifierReviewable.ForMethodDescription> ElementMatcher.Junction<T> isVarArgs() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.VAR_ARGS);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isVirtual() {
        return MethodSortMatcher.m461of(MethodSortMatcher.Sort.VIRTUAL);
    }

    public static <T extends ByteCodeElement> ElementMatcher.Junction<T> isVisibleTo(Class<?> cls) {
        return isVisibleTo(TypeDescription.ForLoadedType.m289of(cls));
    }

    public static <T extends FieldDescription> ElementMatcher.Junction<T> isVolatile() {
        return ModifierMatcher.m462of(ModifierMatcher.Mode.VOLATILE);
    }
    ...
    public static <T> ElementMatcher.Junction<T> none() {
        return BooleanMatcher.m450of(false);
    }

    public static <T> ElementMatcher.Junction<T> noneOf(Iterable<?> iterable) {
        ElementMatcher.Junction<T> junctionNot = null;
        for (Object obj : iterable) {
            junctionNot = junctionNot == null ? not(m452is(obj)) : junctionNot.and(not(m452is(obj)));
        }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i, Class<?> cls) {
        return takesArgument(i, TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isOverriddenFromGeneric(TypeDescription.Generic generic) {
        return isOverriddenFromGeneric(m452is(generic));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i, TypeDescription.Generic generic) {
        return takesGenericArgument(i, m452is(generic));
    }
    ...
    /* JADX INFO: renamed from: is */
    public static <T extends FieldDescription> ElementMatcher.Junction<T> m455is(Field field) {
        return m458is((FieldDescription.InDefinedShape) new FieldDescription.ForLoadedField(field));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGenericGetter(TypeDescription.Generic generic) {
        return isGenericGetter(m452is(generic));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends FieldDescription> ElementMatcher.Junction<T> m458is(FieldDescription.InDefinedShape inDefinedShape) {
    ...
    /* JADX INFO: renamed from: is */
    public static <T extends MethodDescription> ElementMatcher.Junction<T> m456is(Method method) {
        return m459is((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(method));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends MethodDescription> ElementMatcher.Junction<T> m454is(Constructor<?> constructor) {
        return m459is((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedConstructor(constructor));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends MethodDescription> ElementMatcher.Junction<T> m459is(MethodDescription.InDefinedShape inDefinedShape) {
        return definedMethod(new EqualityMatcher(inDefinedShape));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends ParameterDescription> ElementMatcher.Junction<T> m460is(ParameterDescription.InDefinedShape inDefinedShape) {
        return definedParameter(new EqualityMatcher(inDefinedShape));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends TypeDefinition> ElementMatcher.Junction<T> m457is(Type type) {
        return m452is(TypeDefinition.Sort.describe(type));
    }

    /* JADX INFO: renamed from: is */
    public static <T extends AnnotationDescription> ElementMatcher.Junction<T> m453is(Annotation annotation) {
        return m452is(AnnotationDescription.ForLoadedAnnotation.m245of(annotation));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGenericSetter(TypeDescription.Generic generic) {
        return isGenericSetter(m452is(generic));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> declaresException(Class<? extends Throwable> cls) {
        return declaresException(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> canThrow(Class<? extends Throwable> cls) {
        return canThrow(TypeDescription.ForLoadedType.m289of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isSetter() {
        return nameStartsWith("set").and(takesArguments(1)).and(returns(TypeDescription.ForLoadedType.m289of(Void.TYPE)));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isSetter(Class<?> cls) {
        return isSetter(TypeDescription.ForLoadedType.m289of(cls));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isSetter(TypeDescription typeDescription) {
        return isSetter(m452is(typeDescription));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter() {
        return takesNoArguments().and(not(returns(TypeDescription.ForLoadedType.m289of(Void.TYPE)))).and(nameStartsWith("get").mo451or(nameStartsWith("is").and(returnsGeneric(anyOf(Boolean.TYPE, Boolean.class)))));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter(Class<?> cls) {
        return isGetter(TypeDescription.ForLoadedType.m289of(cls));
    }

    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter(TypeDescription typeDescription) {
        return isGetter(m452is(typeDescription));
    }
