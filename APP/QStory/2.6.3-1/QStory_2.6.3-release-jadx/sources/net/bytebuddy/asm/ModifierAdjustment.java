...
public class ModifierAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public static class Adjustment<T> implements ElementMatcher<T> {
        ...
        public int hashCode() {
            return this.resolver.hashCode() + AbstractC3275.m5146(this.matcher, getClass().hashCode() * 31, 31);
        }
    ...
    public int hashCode() {
        return this.methodAdjustments.hashCode() + AbstractC0900.m720(this.fieldAdjustments, AbstractC0900.m720(this.typeAdjustments, getClass().hashCode() * 31, 31), 31);
    }
    ...
    public ModifierAdjustment withFieldModifiers(ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher, List<? extends ModifierContributor.ForField> list) {
        return new ModifierAdjustment(this.typeAdjustments, CompoundList.m475of(new Adjustment(elementMatcher, ModifierContributor.Resolver.m276of(list)), this.fieldAdjustments), this.methodAdjustments);
    }
    ...
    public ModifierAdjustment withInvokableModifiers(ElementMatcher<? super MethodDescription> elementMatcher, List<? extends ModifierContributor.ForMethod> list) {
        return new ModifierAdjustment(this.typeAdjustments, this.fieldAdjustments, CompoundList.m475of(new Adjustment(elementMatcher, ModifierContributor.Resolver.m276of(list)), this.methodAdjustments));
    }
    ...
    public ModifierAdjustment withTypeModifiers(ElementMatcher<? super TypeDescription> elementMatcher, List<? extends ModifierContributor.ForType> list) {
        return new ModifierAdjustment(CompoundList.m475of(new Adjustment(elementMatcher, ModifierContributor.Resolver.m276of(list)), this.typeAdjustments), this.fieldAdjustments, this.methodAdjustments);
    }
