...
public class TypeReferenceAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public TypeReferenceAdjustment filter(ElementMatcher<? super TypeDescription> elementMatcher) {
        return new TypeReferenceAdjustment(this.strict, this.filter.mo451or(elementMatcher));
    }
    ...
    public static class TypeReferenceClassVisitor extends ClassVisitor {
        ...
        public class TypeReferenceFieldVisitor extends FieldVisitor {
            ...
            public AnnotationVisitor visitAnnotation(String str, boolean z) {
                ...
                AnnotationVisitor annotationVisitorVisitAnnotation = super.visitAnnotation(str, z);
                return annotationVisitorVisitAnnotation != null ? TypeReferenceClassVisitor.this.new TypeReferenceAnnotationVisitor(annotationVisitorVisitAnnotation) : TypeReferenceClassVisitor.IGNORE_ANNOTATION;
            }
        }
        ...
        public class TypeReferenceMethodVisitor extends MethodVisitor {
            ...
            public AnnotationVisitor visitInsnAnnotation(int i, @MaybeNull TypePath typePath, String str, boolean z) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(str).getInternalName());
                AnnotationVisitor annotationVisitorVisitInsnAnnotation = super.visitInsnAnnotation(i, typePath, str, z);
            ...
            public AnnotationVisitor visitLocalVariableAnnotation(int i, @MaybeNull TypePath typePath, Label[] labelArr, Label[] labelArr2, int[] iArr, String str, boolean z) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(str).getInternalName());
                AnnotationVisitor annotationVisitorVisitLocalVariableAnnotation = super.visitLocalVariableAnnotation(i, typePath, labelArr, labelArr2, iArr, str, z);
            ...
            public AnnotationVisitor visitParameterAnnotation(int i, String str, boolean z) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(str).getInternalName());
                AnnotationVisitor annotationVisitorVisitParameterAnnotation = super.visitParameterAnnotation(i, str, z);
            ...
            public AnnotationVisitor visitTryCatchAnnotation(int i, @MaybeNull TypePath typePath, String str, boolean z) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(str).getInternalName());
                AnnotationVisitor annotationVisitorVisitTryCatchAnnotation = super.visitTryCatchAnnotation(i, typePath, str, z);
            ...
            public AnnotationVisitor visitTypeAnnotation(int i, @MaybeNull TypePath typePath, String str, boolean z) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(str).getInternalName());
                AnnotationVisitor annotationVisitorVisitTypeAnnotation = super.visitTypeAnnotation(i, typePath, str, z);
        ...
        public void observeInternalName(String str) {
            ...
            if (iLastIndexOf != -1) {
                str = AbstractC0900.m721(1, iLastIndexOf + 2, str);
            }
            ...
            for (String str : this.observedTypes) {
                if (this.visitedInnerTypes.add(str)) {
                    ...
                    if (resolutionDescribe.isResolved()) {
                        ...
                        C5043.m9164(str.replace('/', TypePool.Default.LazyTypeDescription.GenericTypeToken.INNER_CLASS_PATH), "Could not locate type for: ");
                        return;
                    }
                }
            }
