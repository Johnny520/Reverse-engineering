...
public final class C9358 extends C9353 {

    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏, reason: contains not printable characters */
    public final AbstractC9323 f24104;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰哲世苏, reason: contains not printable characters */
    public final AbstractC9323 f24105;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏世哲, reason: contains not printable characters */
    public final AbstractC9323 f24106;

    /* JADX INFO: renamed from: 飘花落叶言子楪兰苏哲世, reason: contains not printable characters */
    public final AbstractC9323 f24107;

    public C9358(Class cls, String str, String str2, long j, List list) {
        super(cls, str, str2, j, list);
        this.f24104 = (AbstractC9323) list.get(0);
        this.f24106 = (AbstractC9323) list.get(1);
        this.f24107 = (AbstractC9323) list.get(2);
        this.f24105 = (AbstractC9323) list.get(3);
    }

    @Override // p307.C9353, p307.InterfaceC9352
    /* JADX INFO: renamed from: 飘花落叶言子楪兰世哲苏 */
    public final AbstractC9323 mo14650(long j) {
        AbstractC9323 abstractC9323 = this.f24104;
        if (j == abstractC9323.f23945) {
            return abstractC9323;
        }
        AbstractC9323 abstractC93232 = this.f24106;
        if (j == abstractC93232.f23945) {
            return abstractC93232;
        }
        AbstractC9323 abstractC93233 = this.f24107;
        if (j == abstractC93233.f23945) {
            return abstractC93233;
        }
        AbstractC9323 abstractC93234 = this.f24105;
    ...
    public final void mo6239(AbstractC3730 abstractC3730, Object obj, Object obj2, Type type, long j) {
        ...
        this.f24104.mo14558(abstractC3730, obj);
        this.f24106.mo14558(abstractC3730, obj);
        this.f24107.mo14558(abstractC3730, obj);
        this.f24105.mo14558(abstractC3730, obj);
