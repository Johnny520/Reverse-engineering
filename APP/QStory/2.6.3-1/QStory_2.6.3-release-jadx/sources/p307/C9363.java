...
public final class C9363 extends AbstractC9247 {

    /* JADX INFO: renamed from: 飘花落叶言子苏楪兰哲世, reason: contains not printable characters */
    public final Function f24119;

    public C9363(int i, long j, Class cls, String str, String str2, String str3, Field field, Method method, Type type, Function function) {
        super(str, i, j, str2, str3, type, cls, field, method);
        this.f24119 = function;
    }
    ...
    public final boolean mo14558(AbstractC3730 abstractC3730, Object obj) {
        UUID uuid = (UUID) this.f24119.apply(obj);
        if (uuid == null) {
        ...
        m14637(abstractC3730);
        if (this.f23669 == null) {
            this.f23669 = mo14553(abstractC3730, UUID.class);
        }
        if (this.f23669 != C9317.f23917) {
            this.f23669.mo6239(abstractC3730, uuid, this.f23963, this.f23668, this.f23956);
            return true;
        }
        abstractC3730.mo6562(uuid);
        return true;
    }
}
