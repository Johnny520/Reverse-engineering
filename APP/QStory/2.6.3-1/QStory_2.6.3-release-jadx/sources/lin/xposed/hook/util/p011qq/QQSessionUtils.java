...
public class QQSessionUtils {
    ...
    public static class LegacyQQ {
        public static Parcelable createSessionInfo(String str, int i) {
            ...
            try {
                try {
                    Constructor declaredConstructor = AbstractC7166.m12425(AbstractC9234.m14531(346)).getDeclaredConstructor(Parcel.class);
    ...
    public static QSContact AIOContactToQSContact(Object obj) {
        ...
        if (i >= 9898) {
            String str = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜呜喵"), obj);
            int iIntValue = ((Integer) AbstractC7165.m12418(cls, AbstractC9234.m14532("喵喵喵呜喵呜呜呜"), obj)).intValue();
            return new QSContact(iIntValue, str);
        }
        if (i >= 8496) {
            String str2 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜喵呜"), obj);
            int iIntValue2 = ((Integer) AbstractC7165.m12418(cls, AbstractC9234.m14532("喵喵喵呜喵呜呜喵"), obj)).intValue();
            return new QSContact(iIntValue2, str2);
        }
        String str3 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜喵呜"), obj);
        int iIntValue3 = ((Integer) AbstractC7165.m12418(cls, AbstractC9234.m14532("喵喵喵呜喵呜呜喵"), obj)).intValue();
    ...
    public static Object getContactFromAIOContact(Object obj) {
        ...
        if (i >= 8496) {
            String str3 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜喵呜"), obj);
            int iIntValue2 = ((Integer) AbstractC7165.m12418(cls, AbstractC9234.m14532("喵喵喵呜喵呜呜喵"), obj)).intValue();
            String str4 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜呜喵呜喵"), obj);
            return QQNT.getContact(iIntValue2, str3, str4);
        }
        String str5 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜喵呜"), obj);
        int iIntValue3 = ((Integer) AbstractC7165.m12418(cls, AbstractC9234.m14532("喵喵喵呜喵呜呜喵"), obj)).intValue();
        String str6 = (String) AbstractC7165.m12418(String.class, AbstractC9234.m14532("喵喵喵呜喵呜喵喵"), obj);
    ...
    public static class QQNT {
        ...
        public static Object getContact(int i, String str, String str2) {
            Class clsM12425 = AbstractC7166.m12425(AbstractC9234.m14531(133));
            if (i != 2 && i != 4) {
                try {
                    if (isNumericUin(str)) {
                        str = QQEnvTool.getUidFromUin(str);
        ...
        public static String getFriendNickName(String str, String str2) {
            Class clsM12425 = AbstractC7166.m12425(AbstractC9234.m14531(1018));
            Object qRouteApi = QQEnvTool.getQRouteApi(clsM12425);
            C7164 c7164M12413 = C7164.m12413(clsM12425);
            String strM14531 = AbstractC9234.m14531(903);
        ...
        public static /* synthetic */ Object lambda$prepareTroopMemberStrangerTempChat$0(Object obj, Method method, Object[] objArr) {
            ...
            AbstractC7017.m12163(str, AbstractC9234.m14531(1019));
            return null;
        }
        ...
        public static void prepareTroopMemberStrangerTempChat(String str, String str2) {
            try {
                ...
                Class clsM12425 = AbstractC7166.m12425(AbstractC9234.m14531(1015));
                AbstractC7162.m12406(msgServiceOfKernel, AbstractC9234.m14531(1017), Void.TYPE, new Class[]{AbstractC7166.m12425(AbstractC9234.m14531(1015)), AbstractC7166.m12425(AbstractC9234.m14531(136))}, AbstractC3738.m6845(new Object[]{100, str2, "", str, new byte[0], QQEnvTool.getUidFromUin(QQEnvTool.getCurrentUin()), "", AbstractC7166.m12425(AbstractC9234.m14531(1016)).newInstance()}, new Class[]{Integer.TYPE, String.class, String.class, String.class, byte[].class, String.class, String.class, AbstractC7166.m12425(AbstractC9234.m14531(1016))}, clsM12425), Proxy.newProxyInstance(AbstractC7166.f17805, new Class[]{AbstractC7166.m12425(AbstractC9234.m14531(136))}, new C6388(1)));
            } catch (Exception e) {
                C6755.m11872(e);
            }
        }
