...
public class PluginCallback {
    ...
    public static void onCallbackOnRawMsg(Object obj) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(579), obj);
    }

    public static void onClickFloatingWindow() {
        int chatType = PluginSendMsgTool.getChatType();
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(577), Integer.valueOf(chatType), (chatType == 1 || chatType == 100) ? PluginSendMsgTool.getCurrentFriendUin() : PluginSendMsgTool.getCurrentGroupUin());
    }

    public static void onCreateMenu(PluginLoader pluginLoader, MessageData messageData) {
        PluginManager.invokeToPluginMethodAndGetInvokeResult(pluginLoader, AbstractC9234.m14531(581), messageData);
    }

    public static void onJoinTroop(String str, String str2, String str3) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(578), str, str2, 2);
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(578), str, str2, str3, 2);
    }
    ...
    public static void onMessage(MessageData messageData) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14532("喵喵喵呜呜呜喵喵~喵喵喵呜呜喵呜呜~喵喵呜呜喵呜呜呜~喵喵喵呜呜喵呜呜~喵喵喵喵喵喵呜喵"), messageData);
    }
    ...
    public static void onMsgRetract(MessageData messageData) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(582), messageData);
    }
    ...
    public static String onSendMsg(String str, String str2, int i) {
        ...
        while (it.hasNext()) {
            String str3 = (String) PluginManager.invokeToPluginMethodAndGetInvokeResult(it.next(), AbstractC9234.m14532("喵喵喵呜喵呜喵喵~喵喵喵呜喵喵喵喵~喵喵喵喵呜呜呜喵~喵喵呜喵喵呜喵呜~喵喵喵呜喵呜呜喵~喵喵喵喵呜喵呜呜"), str, str2, Integer.valueOf(i));
            if (str3 != null) {
                str = str3;
            }
        }
    ...
    public static void onTroopBanInfo(String str, String str2, String str3, long j) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(580), str, str2, str3, Long.valueOf(j));
    }

    public static void onTroopQuit(String str, String str2) {
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(578), str, str2, 1);
        PluginManager.invokeInAllScriptCallbackMethod(AbstractC9234.m14531(578), str, str2, "", 1);
    }
}
