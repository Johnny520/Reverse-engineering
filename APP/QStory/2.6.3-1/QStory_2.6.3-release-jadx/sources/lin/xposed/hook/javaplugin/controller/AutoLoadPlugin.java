...
public class AutoLoadPlugin extends AbstractC7143 {
    private static final String CONFIG_FILE_NAME = AbstractC9234.m14531(612);
    private static final C9924 configUtils = new C9924(AbstractC9234.m14531(612), 0);

    public static void addAutoLoadPlugin(PluginInfo pluginInfo) {
        C9924 c9924 = configUtils;
        ArrayList arrayListM15239 = c9924.m15239(String.class, AbstractC9234.m14531(612));
        if (arrayListM15239.contains(pluginInfo.getPluginID())) {
            return;
        }
        arrayListM15239.add(pluginInfo.getPluginID());
        c9924.m15236(arrayListM15239, AbstractC9234.m14531(612));
    }

    public static boolean isAutoLoading(PluginInfo pluginInfo) {
        return configUtils.m15239(String.class, AbstractC9234.m14531(612)).contains(pluginInfo.getPluginID());
    }
    ...
    public void loadHook(ClassLoader classLoader) {
        if (AbstractC7187.m12502() || AbstractC7187.f17856.equals(AbstractC9234.m14531(61))) {
            new Thread(new RunnableC1945(this, 8)).start();
        }
    }

    public void startAutoLoadPlugin() {
        ArrayList arrayListM15239 = configUtils.m15239(String.class, AbstractC9234.m14531(612));
        ...
        configUtils.m15236(arrayList, AbstractC9234.m14531(612));
    }
}
