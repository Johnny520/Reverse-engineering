...
public class OnMsgMenuCreateAPI extends AbstractC7145 {
    ...
    public static /* synthetic */ void lambda$loadHook$2(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        final MessageData message = ((PluginMessageCallbackAPI) AbstractC7138.f17769.get(PluginMessageCallbackAPI.class)).parseMessage(XposedHelpers.callMethod(objM12417, AbstractC9234.m14531(164), new Object[0]));
    ...
    public void loadHook(ClassLoader classLoader) {
        Method methodM12414;
        C9921 c9921M15232 = C9921.m15232(AbstractC9234.m14531(158));
        c9921M15232.m15234(classLoader.loadClass(AbstractC9234.m14531(158)));
