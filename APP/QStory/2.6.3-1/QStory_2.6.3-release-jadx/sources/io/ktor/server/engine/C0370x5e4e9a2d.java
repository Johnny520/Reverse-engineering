...
/* JADX INFO: renamed from: io.ktor.server.engine.DefaultEnginePipelineKt$defaultEnginePipeline$1$invokeSuspend$$inlined$execute$1 */
...
public final class C0370x5e4e9a2d extends SuspendLambda implements InterfaceC7387 {
    final /* synthetic */ Object $context;
    final /* synthetic */ AbstractC5027 $this_execute;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0370x5e4e9a2d(AbstractC5027 abstractC5027, Object obj, InterfaceC5189 interfaceC5189) {
    ...
    public final InterfaceC5189<C6008> create(InterfaceC5189<?> interfaceC5189) {
        return new C0370x5e4e9a2d(this.$this_execute, this.$context, interfaceC5189);
    }

    @Override // p068.InterfaceC7387
    public final Object invoke(InterfaceC5189<? super C6008> interfaceC5189) {
        return ((C0370x5e4e9a2d) create(interfaceC5189)).invokeSuspend(C6008.f15084);
    }
