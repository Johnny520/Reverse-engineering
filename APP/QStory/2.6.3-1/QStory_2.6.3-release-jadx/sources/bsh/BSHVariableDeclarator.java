...
class BSHVariableDeclarator extends SimpleNode {
    ...
    public Object eval(BSHType bSHType, Modifiers modifiers, CallStack callStack, Interpreter interpreter) {
        ...
        if (jjtGetNumChildren() > 0) {
            ...
            objEval = interfaceC3452JjtGetChild instanceof BSHArrayInitializer ? ((BSHArrayInitializer) interfaceC3452JjtGetChild).eval(bSHType.getBaseType(), getArrayDims(bSHType), callStack, interpreter) : interfaceC3452JjtGetChild.eval(callStack, interpreter);
        }
