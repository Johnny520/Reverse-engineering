...
public class Variable implements Serializable, InterfaceC3490, Cloneable {
    ...
    public void classLoaderChanged() {
        if (AbstractC3500.m5992(this.type)) {
            try {
                this.type = AbstractC3500.m6005(this.type).getClass(this.type.getName());
    ...
    public Variable m5692clone() {
        try {
            Variable variable = (Variable) super.clone();
            Modifiers modifiers = variable.modifiers;
            variable.modifiers = modifiers != null ? modifiers.m5682clone() : null;
            return variable;
    ...
    public void setConstant() {
        if (hasModifier("private") || hasModifier("protected")) {
            C3466.m5900(getName(), "Illegal modifier for interface field ", ". Only public static & final are permitted.");
        } else {
    ...
    public void setValue(Object obj, int i) {
        if (hasModifier("final")) {
            if (this.value != null) {
                throw new UtilEvalError(AbstractC0900.m711(new StringBuilder("Cannot re-assign final variable "), this.name, "."));
            }
            if (obj == null) {
                return;
            }
        ...
        if (cls != null && cls != Object.class && obj != null) {
            obj = AbstractC3495.m5933(obj, cls, i == 0 ? 0 : 1);
            this.value = obj;
        }
        this.value = obj;
        if (obj == null && i != 0) {
    ...
    public String toString() {
        return "Variable: " + AbstractC3462.m5887(this) + ", value:" + this.value + ", lhs = " + this.lhs;
    }
    ...
    public void validateFinalIsSet(boolean z) {
        if (hasModifier("final") && this.value == null && z == hasModifier("static")) {
            ...
            throw new RuntimeException(AbstractC0900.m711(sb, this.name, " is not initialized."));
        }
    }
