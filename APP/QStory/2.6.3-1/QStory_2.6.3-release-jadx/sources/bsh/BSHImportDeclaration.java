            ...
            if (!this.staticImport) {
                ...
                if (!this.importPackage) {
                    ...
                    try {
                        ...
                        try {
                            object = AbstractC3500.m5995(cls, strSuffix);
                    ...
                    if (cls != null && object == null) {
                        try {
                            object = AbstractC3500.m6011(cls, strSuffix);
                    ...
                    throw new EvalException(AbstractC0900.m711(new StringBuilder(), bSHAmbiguousName.text, " is not a static member of a class"), this, callStack);
                }
