...
public abstract class AbstractC6487 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static final Pattern f15903 = Pattern.compile("^(?:(?i)GMT)?([+-])?(\\d\\d?)?(:?(\\d\\d?))?$");

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static final TimeZone f15902 = new GmtTimeZone(false, 0, 0);

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static TimeZone m11604(String str) {
        if (!"Z".equals(str) && !"UTC".equals(str)) {
            Matcher matcher = f15903.matcher(str);
            if (!matcher.matches()) {
                return null;
            }
