...
import org.apache.commons.lang3.C6521;
...
public class StrBuilder implements CharSequence, Appendable, Serializable {
    ...
    private StrBuilder replaceImpl(AbstractC6478 abstractC6478, String str, int i, int i2, int i3) {
        StrBuilder strBuilder;
        String str2;
        if (abstractC6478 != null && this.size != 0) {
            int iM11617 = AbstractC6525.m11617(str);
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int iMo11591 = abstractC6478.mo11591(i4, this.buffer);
                if (iMo11591 > 0) {
                    strBuilder = this;
                    str2 = str;
                    strBuilder.replaceImpl(i4, i4 + iMo11591, iMo11591, str2, iM11617);
                    i2 = (i2 - iMo11591) + iM11617;
                    i4 = (i4 + iM11617) - 1;
                    if (i3 > 0) {
                        i3--;
                    }
    ...
    public Reader asReader() {
        return new C6476(this);
    }

    public C6477 asTokenizer() {
        return new C6475(this);
    }

    public Writer asWriter() {
        return new C6474(this);
    }
    ...
    public int indexOf(AbstractC6478 abstractC6478, int i) {
        int i2;
        int iMax = Math.max(i, 0);
        if (abstractC6478 == null || iMax >= (i2 = this.size)) {
            return -1;
        }
        char[] cArr = this.buffer;
        while (iMax < i2) {
            if (abstractC6478.mo11591(iMax, cArr) > 0) {
                return iMax;
            }
            iMax++;
        }
    ...
    public StrBuilder replace(int i, int i2, String str) {
        int iValidateRange = validateRange(i, i2);
        replaceImpl(i, iValidateRange, iValidateRange - i, str, AbstractC6525.m11617(str));
        return this;
    }
    ...
    public StrBuilder replaceAll(String str, String str2) {
        int iM11617 = AbstractC6525.m11617(str);
        if (iM11617 > 0) {
            int iM116172 = AbstractC6525.m11617(str2);
            int iIndexOf = indexOf(str, 0);
            while (iIndexOf >= 0) {
                replaceImpl(iIndexOf, iIndexOf + iM11617, iM11617, str2, iM116172);
                iIndexOf = indexOf(str, iIndexOf + iM116172);
            }
        }
        return this;
    }
    ...
    public StrBuilder replaceFirst(String str, String str2) {
        int iIndexOf;
        int iM11617 = AbstractC6525.m11617(str);
        if (iM11617 <= 0 || (iIndexOf = indexOf(str, 0)) < 0) {
            return this;
        }
        replaceImpl(iIndexOf, iIndexOf + iM11617, iM11617, str2, AbstractC6525.m11617(str2));
        return this;
    }
    ...
    public StrBuilder replace(AbstractC6478 abstractC6478, String str, int i, int i2, int i3) {
        return replaceImpl(abstractC6478, str, i, validateRange(i, i2), i3);
    }
    ...
    public StrBuilder appendAll(Iterator<?> it) {
        if (it != null) {
            it.forEachRemaining(new C3497(this, 4));
        }
        return this;
    }
    ...
    public boolean contains(AbstractC6478 abstractC6478) {
        return indexOf(abstractC6478, 0) >= 0;
    }

    public StrBuilder appendAll(Iterable<?> iterable) {
        if (iterable != null) {
            iterable.forEach(new C3497(this, 4));
        }
        return this;
    }
    ...
    public StrBuilder deleteFirst(String str) {
        ...
        int iM11617 = AbstractC6525.m11617(str);
        if (iM11617 > 0 && (iIndexOf = indexOf(str, 0)) >= 0) {
            deleteImpl(iIndexOf, iIndexOf + iM11617, iM11617);
        }
        return this;
    }
    ...
    public StrBuilder deleteFirst(AbstractC6478 abstractC6478) {
        return replace(abstractC6478, null, 0, this.size, 1);
    }
    ...
    public StrBuilder replaceFirst(AbstractC6478 abstractC6478, String str) {
        return replace(abstractC6478, str, 0, this.size, 1);
    }
    ...
    public int indexOf(String str, int i) {
        return C6521.f15968.m11615(i, this, str);
    }
    ...
    public int indexOf(AbstractC6478 abstractC6478) {
        return indexOf(abstractC6478, 0);
    }
    ...
    public StrBuilder replaceAll(AbstractC6478 abstractC6478, String str) {
        return replace(abstractC6478, str, 0, this.size, -1);
    }

    public StrBuilder deleteAll(AbstractC6478 abstractC6478) {
        return replace(abstractC6478, null, 0, this.size, -1);
    }
    ...
    public int lastIndexOf(AbstractC6478 abstractC6478) {
        return lastIndexOf(abstractC6478, this.size);
    }

    public int lastIndexOf(AbstractC6478 abstractC6478, int i) {
        int i2 = this.size;
        if (i >= i2) {
            i = i2 - 1;
        }
        if (abstractC6478 == null || i < 0) {
            return -1;
        }
        char[] cArr = this.buffer;
        while (i >= 0) {
            if (abstractC6478.mo11591(i, cArr) > 0) {
                return i;
            }
            i--;
        }
    ...
    public StrBuilder append(char[] cArr, int i, int i2) {
        ...
        if (i >= 0 && i <= cArr.length) {
            if (i2 < 0 || i + i2 > cArr.length) {
                throw new StringIndexOutOfBoundsException(AbstractC7012.m12147(i2, "Invalid length: "));
            }
            if (i2 > 0) {
                int length = length();
        ...
        throw new StringIndexOutOfBoundsException(AbstractC7012.m12147(i2, "Invalid startIndex: "));
    }
    ...
    public StrBuilder insert(int i, char[] cArr, int i2, int i3) {
        ...
        if (i2 >= 0 && i2 <= cArr.length) {
            if (i3 < 0 || i2 + i3 > cArr.length) {
                throw new StringIndexOutOfBoundsException(AbstractC7012.m12147(i3, "Invalid length: "));
            }
            if (i3 > 0) {
        ...
        throw new StringIndexOutOfBoundsException(AbstractC7012.m12147(i2, "Invalid offset: "));
    }
