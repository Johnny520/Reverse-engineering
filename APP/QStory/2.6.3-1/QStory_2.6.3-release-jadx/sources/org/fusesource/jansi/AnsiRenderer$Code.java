...
public final class AnsiRenderer$Code {
    ...
    public Ansi$Attribute getAttribute() {
        return (Ansi$Attribute) this.f335n;
    }

    public Ansi$Color getColor() {
        return (Ansi$Color) this.f335n;
    }

    public boolean isAttribute() {
        return this.f335n instanceof Ansi$Attribute;
    }
    ...
    public boolean isColor() {
        return this.f335n instanceof Ansi$Color;
    }
