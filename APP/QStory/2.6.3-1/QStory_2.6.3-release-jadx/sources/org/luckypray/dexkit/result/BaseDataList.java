...
public abstract class BaseDataList<T> extends ArrayList<T> {
    ...
    public final T first(InterfaceC7387 predicate) {
        predicate.getClass();
        for (T t : this) {
        ...
        C6755.m11870("No element matching predicate was found.");
        return null;
    }

    public final T firstOrNull(InterfaceC7387 predicate) {
        predicate.getClass();
        for (T t : this) {
            if (((Boolean) predicate.invoke(t)).booleanValue()) {
                return t;
    ...
    public final T firstOrThrow(InterfaceC7372 exceptionSupplier) throws Throwable {
    ...
    public final T single(InterfaceC7387 predicate) {
        predicate.getClass();
        if (size() == 0) {
    ...
    public final T singleOrNull(InterfaceC7387 predicate) {
        predicate.getClass();
        if (size() == 0) {
            return null;
        }
    ...
    public final T singleOrThrow(InterfaceC7372 exceptionSupplier) throws Throwable {
        exceptionSupplier.getClass();
    ...
    public final T singleOrNull() {
        ...
        for (int i = 1; i < size; i++) {
            if (!AbstractC5227.m9466(t, get(i))) {
                return null;
            }
        }
        return t;
