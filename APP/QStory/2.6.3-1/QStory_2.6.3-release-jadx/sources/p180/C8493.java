...
public final class C8493 {

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public final float[] f21149;

    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public char f21150;

    public C8493(C8493 c8493) {
        this.f21150 = c8493.f21150;
        float[] fArr = c8493.f21149;
        this.f21149 = AbstractC7176.m12467(fArr, fArr.length);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏兰哲, reason: contains not printable characters */
    public static void m13495(C8493[] c8493Arr, Path path) {
        int i;
        float[] fArr;
        int i2;
        C8493 c8493;
        ...
        float f9;
        float f10;
        C8493[] c8493Arr2 = c8493Arr;
        Path path2 = path;
        float[] fArr2 = new float[6];
        int length = c8493Arr2.length;
        int i4 = 0;
        int i5 = 0;
        char c2 = Advice.OffsetMapping.ForOrigin.Renderer.ForMethodName.SYMBOL;
        while (i5 < length) {
            C8493 c84933 = c8493Arr2[i5];
            char c3 = c84933.f21150;
            float[] fArr3 = c84933.f21149;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];
            ...
            while (i7 < fArr3.length) {
                if (c3 == 'A') {
                    ...
                    int i8 = i2 + 5;
                    int i9 = i2 + 6;
                    m13496(path, f21, f22, fArr[i8], fArr[i9], fArr[i2], fArr[i2 + 1], fArr[i2 + 2], fArr[i2 + 3] != 0.0f ? 1 : i6, fArr[i2 + 4] != 0.0f ? 1 : i6);
                    f13 = fArr[i8];
                    f = fArr[i9];
                    f14 = f;
                    f2 = f13;
                    ...
                    float f44 = f20;
                    i3 = i5;
                    m13496(path, f43, f44, f38, f39, f40, f41, f42, z, fArr[i2 + 4] != 0.0f ? 1 : i6);
                    f2 = f43 + fArr[i35];
                    f = f44 + fArr[i36];
                    f13 = f2;
                    f14 = f;
    ...
    /* JADX INFO: renamed from: 飘花落叶言子楪世苏哲兰, reason: contains not printable characters */
    public static void m13496(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d17 < 0.0d) {
            ...
            m13496(path, f, f2, f3, f4, f5 * fSqrt, fSqrt * f6, f7, z, z2);
            return;
        }
    ...
    public C8493(char c, float[] fArr) {
        this.f21150 = c;
        this.f21149 = fArr;
    }
}
