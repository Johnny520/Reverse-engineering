...
public final class C9566 extends AbstractC8798 {
    ...
    static {
        AbstractC9234.m14531(2718);
    }

    /* JADX INFO: renamed from: 飘花落叶言子世楪哲苏兰, reason: contains not printable characters */
    public final void m14995(List list) {
        AbstractC9234.m14532("喵喵喵呜喵呜呜呜~喵喵喵呜呜呜喵喵~喵喵喵喵呜喵喵喵~喵喵呜喵喵呜喵喵~喵喵喵喵呜呜喵喵~喵喵喵呜呜呜呜呜~喵喵喵呜喵呜喵呜");
        list.getClass();
    ...
    public final void mo14013(AbstractC3317 abstractC3317, int i, Object obj, List list) {
        ...
        AbstractC9234.m14531(2717);
        list.getClass();
        if (obj2 == null) {
            return;
        }
        if ((obj2 instanceof C9561) && list.contains(AbstractC9234.m14531(2718))) {
