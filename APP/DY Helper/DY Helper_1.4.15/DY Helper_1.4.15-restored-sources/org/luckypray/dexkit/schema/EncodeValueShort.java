...
public final class EncodeValueShort extends p000.p22 {
    ...
    public static final class Companion {
        ...
        public final int createEncodeValueShort(p000.b40 r2, short r3) {
                r1 = this;
                r2.getClass()
                r0 = 1
                r2.m737(r0)
                r1.addValue(r2, r3)
                int r1 = r1.endEncodeValueShort(r2)
                return r1
        }

        public final int endEncodeValueShort(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                int r0 = r1.m731()
                return r0
        ...
        public final org.luckypray.dexkit.schema.EncodeValueShort getRootAsEncodeValueShort(java.nio.ByteBuffer r2) {
                ...
                r0.<init>()
                org.luckypray.dexkit.schema.-EncodeValueShort r1 = r1.getRootAsEncodeValueShort(r2, r0)
                return r1
        }

        public final org.luckypray.dexkit.schema.EncodeValueShort getRootAsEncodeValueShort(java.nio.ByteBuffer r2, org.luckypray.dexkit.schema.EncodeValueShort r3) {
                r1 = this;
                r2.getClass()
                r3.getClass()
                ...
                int r0 = r2.position()
                int r0 = r0 + r1
                org.luckypray.dexkit.schema.-EncodeValueShort r1 = r3.__assign(r0, r2)
                return r1
        }

        public final void startEncodeValueShort(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                r0 = 1
                r1.m737(r0)
    ...
    public final org.luckypray.dexkit.schema.EncodeValueShort __assign(int r1, java.nio.ByteBuffer r2) {
            r0 = this;
            r2.getClass()
            r0.__init(r1, r2)
            return r0
