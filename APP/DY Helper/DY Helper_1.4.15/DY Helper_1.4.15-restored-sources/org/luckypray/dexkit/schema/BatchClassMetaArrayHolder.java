...
public final class BatchClassMetaArrayHolder extends p000.p22 {
    ...
    public static final class Companion {
        ...
        public final int createBatchClassMetaArrayHolder(p000.b40 r2, int r3) {
                r1 = this;
                r2.getClass()
                r0 = 1
                r2.m737(r0)
                r1.addItems(r2, r3)
                int r1 = r1.endBatchClassMetaArrayHolder(r2)
                return r1
        }
        ...
        public final int endBatchClassMetaArrayHolder(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                int r0 = r1.m731()
                return r0
        ...
        public final org.luckypray.dexkit.schema.BatchClassMetaArrayHolder getRootAsBatchClassMetaArrayHolder(java.nio.ByteBuffer r2) {
                ...
                r0.<init>()
                org.luckypray.dexkit.schema.-BatchClassMetaArrayHolder r1 = r1.getRootAsBatchClassMetaArrayHolder(r2, r0)
                return r1
        }

        public final org.luckypray.dexkit.schema.BatchClassMetaArrayHolder getRootAsBatchClassMetaArrayHolder(java.nio.ByteBuffer r2, org.luckypray.dexkit.schema.BatchClassMetaArrayHolder r3) {
                r1 = this;
                r2.getClass()
                r3.getClass()
                ...
                int r0 = r2.position()
                int r0 = r0 + r1
                org.luckypray.dexkit.schema.-BatchClassMetaArrayHolder r1 = r3.__assign(r0, r2)
                return r1
        }

        public final void startBatchClassMetaArrayHolder(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                r0 = 1
                r1.m737(r0)
    ...
    public final org.luckypray.dexkit.schema.BatchClassMetaArrayHolder __assign(int r1, java.nio.ByteBuffer r2) {
            r0 = this;
            r2.getClass()
            r0.__init(r1, r2)
            return r0
    ...
    public final org.luckypray.dexkit.schema.BatchClassMeta items(int r2) {
            ...
            r0.<init>()
            org.luckypray.dexkit.schema.-BatchClassMeta r1 = r1.items(r0, r2)
            return r1
    }

    public final org.luckypray.dexkit.schema.BatchClassMeta items(org.luckypray.dexkit.schema.BatchClassMeta r3, int r4) {
            r2 = this;
            r3.getClass()
            r0 = 4
            ...
            r2.getClass()
            org.luckypray.dexkit.schema.-BatchClassMeta r2 = r3.__assign(r4, r2)
            return r2
        L1e:
            r2 = 0
            return r2
