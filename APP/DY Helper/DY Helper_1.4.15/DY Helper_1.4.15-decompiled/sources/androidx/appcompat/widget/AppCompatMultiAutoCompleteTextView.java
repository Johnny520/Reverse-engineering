...
public class AppCompatMultiAutoCompleteTextView extends android.widget.MultiAutoCompleteTextView {
    ...
    public static final int[] f567 = null;

    /* JADX INFO: renamed from: ε */
    public final p000.C0610o4 f568;

    /* JADX INFO: renamed from: ζ */
    public final p000.C0201d6 f569;

    /* JADX INFO: renamed from: η */
    public final p000.C0574n5 f570;

    static {
            r0 = 16843126(0x1010176, float:2.3694606E-38)
            int[] r0 = new int[]{r0}
            androidx.appcompat.widget.AppCompatMultiAutoCompleteTextView.f567 = r0
            return
    }

    public AppCompatMultiAutoCompleteTextView(android.content.Context r3) {
            r2 = this;
            r0 = 0
    ...
    public AppCompatMultiAutoCompleteTextView(android.content.Context r4, android.util.AttributeSet r5, int r6) {
            ...
            p000.b42.m739(r3, r4)
            android.content.Context r4 = r3.getContext()
            int[] r0 = androidx.appcompat.widget.AppCompatMultiAutoCompleteTextView.f567
