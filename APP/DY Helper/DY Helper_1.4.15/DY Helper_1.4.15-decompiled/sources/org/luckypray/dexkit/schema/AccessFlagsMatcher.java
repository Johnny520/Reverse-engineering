...
public final class AccessFlagsMatcher extends p000.p22 {
    ...
    public static final class Companion {
        ...
        public final void m7401addFlagsQn1smSk(p000.b40 r1, int r2) {
                r0 = this;
                r1.getClass()
                r0 = 0
                r1.m724(r0, r2)
        ...
        public final int m7402createAccessFlagsMatcherOsBMiQA(p000.b40 r2, int r3, byte r4) {
                r1 = this;
                r2.getClass()
                r0 = 2
                r2.m737(r0)
                r1.m7401addFlagsQn1smSk(r2, r3)
                r1.addMatchType(r2, r4)
                int r1 = r1.endAccessFlagsMatcher(r2)
                return r1
        }

        public final int endAccessFlagsMatcher(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                int r0 = r1.m731()
                return r0
        ...
        public final org.luckypray.dexkit.schema.AccessFlagsMatcher getRootAsAccessFlagsMatcher(java.nio.ByteBuffer r2) {
                ...
                r0.<init>()
                org.luckypray.dexkit.schema.-AccessFlagsMatcher r1 = r1.getRootAsAccessFlagsMatcher(r2, r0)
                return r1
        }

        public final org.luckypray.dexkit.schema.AccessFlagsMatcher getRootAsAccessFlagsMatcher(java.nio.ByteBuffer r2, org.luckypray.dexkit.schema.AccessFlagsMatcher r3) {
                r1 = this;
                r2.getClass()
                r3.getClass()
                ...
                int r0 = r2.position()
                int r0 = r0 + r1
                org.luckypray.dexkit.schema.-AccessFlagsMatcher r1 = r3.__assign(r0, r2)
                return r1
        }

        public final void startAccessFlagsMatcher(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                r0 = 2
                r1.m737(r0)
    ...
    public final org.luckypray.dexkit.schema.AccessFlagsMatcher __assign(int r1, java.nio.ByteBuffer r2) {
            r0 = this;
            r2.getClass()
            r0.__init(r1, r2)
            return r0
    ...
    public final int m7399getFlagspVg5ArA() {
            r2 = this;
            r0 = 4
    ...
    public final boolean m7400mutateFlagsWZ4Q5Ns(int r3) {
            r2 = this;
            r0 = 4
            int r0 = r2.__offset(r0)
            if (r0 == 0) goto L11
