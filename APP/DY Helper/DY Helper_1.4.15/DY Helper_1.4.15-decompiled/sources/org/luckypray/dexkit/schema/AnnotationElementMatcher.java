...
public final class AnnotationElementMatcher extends p000.p22 {
    ...
    public static final class Companion {
        ...
        public final void m7405addValueTypeEK6454(p000.b40 r1, byte r2) {
                r0 = this;
                r1.getClass()
                r0 = 1
                r1.m722(r0, r2)
        ...
        public final int m7406createAnnotationElementMatcherSpDDLgk(p000.b40 r2, int r3, byte r4, int r5) {
                r1 = this;
                r2.getClass()
                r0 = 3
                r2.m737(r0)
                r1.addValue(r2, r5)
                r1.addName(r2, r3)
                r1.m7405addValueTypeEK6454(r2, r4)
                int r1 = r1.endAnnotationElementMatcher(r2)
                return r1
        }

        public final int endAnnotationElementMatcher(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                int r0 = r1.m731()
                return r0
        ...
        public final org.luckypray.dexkit.schema.AnnotationElementMatcher getRootAsAnnotationElementMatcher(java.nio.ByteBuffer r2) {
                ...
                r0.<init>()
                org.luckypray.dexkit.schema.-AnnotationElementMatcher r1 = r1.getRootAsAnnotationElementMatcher(r2, r0)
                return r1
        }

        public final org.luckypray.dexkit.schema.AnnotationElementMatcher getRootAsAnnotationElementMatcher(java.nio.ByteBuffer r2, org.luckypray.dexkit.schema.AnnotationElementMatcher r3) {
                r1 = this;
                r2.getClass()
                r3.getClass()
                ...
                int r0 = r2.position()
                int r0 = r0 + r1
                org.luckypray.dexkit.schema.-AnnotationElementMatcher r1 = r3.__assign(r0, r2)
                return r1
        }

        public final void startAnnotationElementMatcher(p000.b40 r1) {
                r0 = this;
                r1.getClass()
                r0 = 3
                r1.m737(r0)
    ...
    public final org.luckypray.dexkit.schema.AnnotationElementMatcher __assign(int r1, java.nio.ByteBuffer r2) {
            r0 = this;
            r2.getClass()
            r0.__init(r1, r2)
            return r0
    ...
    public final org.luckypray.dexkit.schema.StringMatcher getName() {
            ...
            r0.<init>()
            org.luckypray.dexkit.schema.-StringMatcher r1 = r1.name(r0)
            return r1
    }

    /* JADX INFO: renamed from: getValueType-w2LRezQ, reason: not valid java name */
    public final byte m7403getValueTypew2LRezQ() {
            r2 = this;
            r0 = 6
    ...
    public final boolean m7404mutateValueType7apg3OU(byte r3) {
            r2 = this;
            r0 = 6
            int r0 = r2.__offset(r0)
            if (r0 == 0) goto L11
    ...
    public final org.luckypray.dexkit.schema.StringMatcher name(org.luckypray.dexkit.schema.StringMatcher r3) {
            r2 = this;
            r3.getClass()
            r0 = 4
            int r0 = r2.__offset(r0)
    ...
    public final p000.p22 value(p000.p22 r3) {
            r2 = this;
            r3.getClass()
            r0 = 8
            int r0 = r2.__offset(r0)
