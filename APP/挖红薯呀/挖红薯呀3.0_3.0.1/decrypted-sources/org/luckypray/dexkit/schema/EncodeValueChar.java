...
public final class EncodeValueChar extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueChar(C0938xt c0938xt, short s) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addValue(c0938xt, s);
            return endEncodeValueChar(c0938xt);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueChar(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final EncodeValueChar getRootAsEncodeValueChar(ByteBuffer byteBuffer, EncodeValueChar encodeValueChar) {
            ...
            return encodeValueChar.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueChar(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
