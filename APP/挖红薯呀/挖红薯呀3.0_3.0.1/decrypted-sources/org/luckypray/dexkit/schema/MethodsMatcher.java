...
public final class MethodsMatcher extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addMethodCount(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5159h(2, i);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createMethodsMatcher(C0938xt c0938xt, int i, byte b, int i2) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
            addMethodCount(c0938xt, i2);
            addMethods(c0938xt, i);
            addMatchType(c0938xt, b);
            return endMethodsMatcher(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endMethodsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final MethodsMatcher getRootAsMethodsMatcher(ByteBuffer byteBuffer, MethodsMatcher methodsMatcher) {
            ...
            return methodsMatcher.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startMethodsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
        }
