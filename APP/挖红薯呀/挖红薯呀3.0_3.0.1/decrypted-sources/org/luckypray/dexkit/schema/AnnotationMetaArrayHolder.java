...
public final class AnnotationMetaArrayHolder extends c61 {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationMetaArrayHolder __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationMeta annotations(AnnotationMeta annotationMeta, int i) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createAnnotationMetaArrayHolder(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addAnnotations(c0938xt, i);
            return endAnnotationMetaArrayHolder(c0938xt);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Move duplicate insns, count: 1 to block B:3:0x000e */
        public final int createAnnotationsVector(C0938xt c0938xt, int[] iArr) {
            c0938xt.getClass();
            iArr.getClass();
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAnnotationMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final AnnotationMetaArrayHolder getRootAsAnnotationMetaArrayHolder(ByteBuffer byteBuffer, AnnotationMetaArrayHolder annotationMetaArrayHolder) {
            ...
            return annotationMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationsVector(C0938xt c0938xt, int i) {
            c0938xt.getClass();
    ...
    public final AnnotationMeta annotations(int i) {
        return annotations(new AnnotationMeta(), i);
    }
}
