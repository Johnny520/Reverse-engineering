...
public final class MethodMetaArrayHolder extends c61 {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final MethodMetaArrayHolder __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createMethodMetaArrayHolder(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addMethods(c0938xt, i);
            return endMethodMetaArrayHolder(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endMethodMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final MethodMetaArrayHolder getRootAsMethodMetaArrayHolder(ByteBuffer byteBuffer, MethodMetaArrayHolder methodMetaArrayHolder) {
            byteBuffer.getClass();
            methodMetaArrayHolder.getClass();
            return methodMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startMethodMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
