...
public final class UsingFieldMatcher extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createUsingFieldMatcher(C0938xt c0938xt, int i, byte b) {
            c0938xt.getClass();
            c0938xt.m5169r(2);
            addField(c0938xt, i);
            addUsingType(c0938xt, b);
            return endUsingFieldMatcher(c0938xt);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endUsingFieldMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final UsingFieldMatcher getRootAsUsingFieldMatcher(ByteBuffer byteBuffer, UsingFieldMatcher usingFieldMatcher) {
            ...
            return usingFieldMatcher.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startUsingFieldMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(2);
        }
