...
public final class BatchMethodMetaArrayHolder extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createBatchMethodMetaArrayHolder(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addItems(c0938xt, i);
            return endBatchMethodMetaArrayHolder(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endBatchMethodMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final BatchMethodMetaArrayHolder getRootAsBatchMethodMetaArrayHolder(ByteBuffer byteBuffer, BatchMethodMetaArrayHolder batchMethodMetaArrayHolder) {
            ...
            return batchMethodMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startBatchMethodMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
