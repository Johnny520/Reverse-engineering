...
public final class EncodeValueByte extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueByte(C0938xt c0938xt, byte b) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addValue(c0938xt, b);
            return endEncodeValueByte(c0938xt);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueByte(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final EncodeValueByte getRootAsEncodeValueByte(ByteBuffer byteBuffer, EncodeValueByte encodeValueByte) {
            ...
            return encodeValueByte.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueByte(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
