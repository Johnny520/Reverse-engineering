...
public final class AnnotationEncodeArrayMatcher extends BaseMatcher implements IAnnotationEncodeValue {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationEncodeArrayMatcher count(z20 z20Var) {
        z20Var.getClass();
    ...
    public int innerBuild(C0938xt c0938xt) {
        int iM5675createValuesTypeVectorVUfvBY;
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                type.getClass();
                arrayList.add(new ia1(type.m5662getValuew2LRezQ()));
            }
            iM5675createValuesTypeVectorVUfvBY = org.luckypray.dexkit.schema.AnnotationEncodeArrayMatcher.Companion.m5675createValuesTypeVectorVUfvBY(c0938xt, v50.m4415u(arrayList));
        } else {
            iM5675createValuesTypeVectorVUfvBY = 0;
        }
        ...
        if (list2 != null) {
            ...
            while (it2.hasNext()) {
                ...
                value.getClass();
                arrayList2.add(Integer.valueOf(((BaseMatcher) value).build$dexkit_android_release(c0938xt)));
            }
            iCreateValuesVector = org.luckypray.dexkit.schema.AnnotationEncodeArrayMatcher.Companion.createValuesVector(c0938xt, AbstractC0960ye.m5252V(arrayList2));
        } else {
            iCreateValuesVector = 0;
        }
        byte value2 = this.matchType.getValue();
        IntRange intRange = this.rangeMatcher;
        int iCreateAnnotationEncodeArrayMatcher = companion.createAnnotationEncodeArrayMatcher(c0938xt, iM5675createValuesTypeVectorVUfvBY, iCreateValuesVector, value2, intRange != null ? intRange.build$dexkit_android_release(c0938xt) : 0);
        c0938xt.m5165n(iCreateAnnotationEncodeArrayMatcher);
    ...
    public final /* synthetic */ AnnotationEncodeArrayMatcher addAnnotation(InterfaceC0742sw interfaceC0742sw) {
    ...
    public final /* synthetic */ AnnotationEncodeArrayMatcher addEnum(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ AnnotationEncodeArrayMatcher addMethod(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ AnnotationEncodeArrayMatcher add(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        AnnotationEncodeValueMatcher annotationEncodeValueMatcher = new AnnotationEncodeValueMatcher();
    ...
    public final /* synthetic */ AnnotationEncodeArrayMatcher addClass(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
