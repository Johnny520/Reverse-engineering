...
public final class ParametersMatcher extends BaseMatcher {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final ParametersMatcher count(z20 z20Var) {
        z20Var.getClass();
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        if (list != null) {
            ...
            for (ParameterMatcher parameterMatcher : list) {
                ...
                arrayList.add(Integer.valueOf(parameterMatcher.build$dexkit_android_release(c0938xt)));
            }
        ...
        int iCreateParametersMatcher = companion.createParametersMatcher(c0938xt, iM5162k, intRange != null ? intRange.build$dexkit_android_release(c0938xt) : 0);
        c0938xt.m5165n(iCreateParametersMatcher);
    ...
    public final /* synthetic */ ParametersMatcher add(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        ParameterMatcher parameterMatcher = new ParameterMatcher();
        interfaceC0742sw.invoke(parameterMatcher);
