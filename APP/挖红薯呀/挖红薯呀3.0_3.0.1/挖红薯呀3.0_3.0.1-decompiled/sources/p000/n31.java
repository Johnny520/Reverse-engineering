...
public final class n31 {
    ...
    /* JADX INFO: renamed from: a */
    public final long m2632a(float f, float f2, long j) {
        double dSin;
        double dCos;
        double dExp;
        double dExp2;
        float f3 = f - this.f4173a;
        double d = j / 1000.0d;
        float f4 = this.f4175c;
        ...
        if (f4 > 1.0f) {
            ...
            if (f4 != 1.0f) {
                ...
                return (((long) Float.floatToRawIntBits((float) dCos)) & 4294967295L) | (Float.floatToRawIntBits((float) (dSin + ((double) this.f4173a))) << 32);
            }
            double d16 = f3;
            ...
            dExp = Math.exp(d18) * d19 * (-this.f4174b);
