...
public final class eh0 {
    ...
    public long[] f1448a = dy0.f1212a;

    /* JADX INFO: renamed from: b */
    public Object[] f1449b = o30.f4434d;

    /* JADX INFO: renamed from: c */
    public long[] f1450c = o30.f4445o;

    /* JADX INFO: renamed from: d */
    public int f1451d = Integer.MAX_VALUE;

    /* JADX INFO: renamed from: e */
    public int f1452e = Integer.MAX_VALUE;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX INFO: renamed from: a */
    public final boolean m929a(Object obj) {
        int i = this.f1454g;
        int iM932d = m932d(obj);
        this.f1449b[iM932d] = obj;
        long[] jArr = this.f1450c;
        int i2 = this.f1451d;
        ...
        this.f1451d = iM932d;
        if (this.f1452e == Integer.MAX_VALUE) {
            this.f1452e = iM932d;
        }
        return this.f1454g != i;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX INFO: renamed from: b */
    public final void m930b() {
        this.f1454g = 0;
        long[] jArr = this.f1448a;
        if (jArr != dy0.f1212a) {
            AbstractC0201f9.m1062h0(-9187201950435737472L, jArr);
            long[] jArr2 = this.f1448a;
            int i = this.f1453f;
            int i2 = i >> 3;
            long j = 255 << ((i & 7) << 3);
            jArr2[i2] = (jArr2[i2] & (~j)) | j;
        }
        AbstractC0201f9.m1061g0(this.f1449b, 0, this.f1453f);
        AbstractC0201f9.m1062h0(4611686018427387903L, this.f1450c);
        this.f1451d = Integer.MAX_VALUE;
        this.f1452e = Integer.MAX_VALUE;
        this.f1455h = dy0.m738a(this.f1453f) - this.f1454g;
    }
    ...
    */
    public final boolean m931c(Object obj) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (p30.m3002l(this.f1449b[iNumberOfTrailingZeros], obj)) {
                    break loop0;
                }
                j3 &= j3 - 1;
            }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX INFO: renamed from: d */
    public final int m932d(Object obj) {
        int i;
        long j;
        long j2;
        long j3;
        ...
        while (true) {
            ...
            if ((j5 & ((~j5) << 6) & (-9187201950435737472L)) != 0) {
                int iM933e = m933e(i4);
                long j9 = 255;
                if (this.f1455h != 0 || ((this.f1448a[iM933e >> 3] >> ((iM933e & 7) << 3)) & 255) == 254) {
                    i = 0;
                    j = j6;
                    j2 = 255;
                    j3 = 128;
                    ...
                    if (i13 > 8) {
                        c = 31;
                        j3 = 128;
                        if (Long.compareUnsigned(((long) this.f1454g) * 32, ((long) i13) * 25) <= 0) {
                            long[] jArr4 = this.f1448a;
                            if (jArr4 == null) {
                                i = 0;
                                j = j6;
                                j2 = 255;
                                ...
                                int i14 = this.f1453f;
                                Object[] objArr = this.f1449b;
                                long[] jArr5 = this.f1450c;
                                ...
                                while (i20 != i14) {
                                    ...
                                    if (j12 != 128 && j12 == 254) {
                                        ...
                                        int i24 = i23 >>> 7;
                                        int iM933e2 = m933e(i24);
                                        int i25 = i24 & i14;
                                        if (((iM933e2 - i25) & i14) / 8 == ((i20 - i25) & i14) / 8) {
                                            int i26 = i14;
                                            ...
                                            if (((j14 >> i29) & j2) == 128) {
                                                ...
                                                objArr3[iM933e2] = objArr3[i20];
                                                objArr3[i20] = null;
                                                jArr5[iM933e2] = jArr5[i20];
                                                jArr5[i20] = 4611686018427387903L;
                                                int i30 = (int) ((jArr6[i20] >> 32) & 4294967295L);
                                                if (i30 != Integer.MAX_VALUE) {
                                                    j4 = j6;
                                                    jArr6[i30] = ((long) iM933e2) | (jArr6[i30] & (-4294967296L));
                                                    jArr6[i20] = (jArr6[i20] & 4294967295L) | (-4294967296L);
                                                } else {
                                                    j4 = j6;
                                                    jArr6[i20] = 9223372032559808512L | ((long) iM933e2);
                                                }
                                                jArr6[iM933e2] = (((long) i20) << 32) | 2147483647L;
                                            } else {
                                                j4 = j6;
                                                jArr4[i28] = (((long) (i23 & 127)) << i29) | (j14 & (~(j2 << i29)));
                                                Object obj3 = objArr3[iM933e2];
                                                objArr3[iM933e2] = objArr3[i20];
                                                objArr3[i20] = obj3;
                                                long j15 = jArr5[iM933e2];
                                                jArr5[iM933e2] = jArr5[i20];
                                                jArr5[i20] = j15;
                                                ...
                                                jArr6[iM933e2] = (((long) i31) << 32) | ((long) i20);
                                                i20--;
                                            }
                                            jArr4[jArr4.length - 1] = jArr4[0];
                                            i20++;
                                ...
                                if (i35 != Integer.MAX_VALUE) {
                                    this.f1451d = (int) (jArr6[i35] & 4294967295L);
                                }
                                int i36 = this.f1452e;
                                if (i36 != Integer.MAX_VALUE) {
                                    this.f1452e = (int) (jArr6[i36] & 4294967295L);
                                }
                            }
                        }
                        iM933e = m933e(i4);
                    ...
                    j = j6;
                    j2 = 255;
                    int iM739b = dy0.m739b(this.f1453f);
                    long[] jArr8 = this.f1448a;
                    Object[] objArr4 = this.f1449b;
                    long[] jArr9 = this.f1450c;
                    int i37 = this.f1453f;
                    int[] iArr = new int[i37];
                    m934f(iM739b);
                    long[] jArr10 = this.f1448a;
                    Object[] objArr5 = this.f1449b;
                    long[] jArr11 = this.f1450c;
                    int i38 = this.f1453f;
                    int i39 = 0;
                    while (i39 < i37) {
                        if (((jArr8[i39 >> 3] >> ((i39 & 7) << 3)) & 255) < j3) {
                            ...
                            jArr[i41] = j20;
                            jArr[(((iM933e3 - 7) & i38) + (i38 & 7)) >> 3] = j20;
                            objArr5[iM933e3] = obj4;
                            jArr11[iM933e3] = jArr9[i39];
                            iArr[i39] = iM933e3;
                        } else {
                            jArr = jArr10;
                            jArr2 = jArr8;
                    ...
                    if (i46 != Integer.MAX_VALUE) {
                        this.f1451d = iArr[i46];
                    }
                    int i47 = this.f1452e;
                    if (i47 != Integer.MAX_VALUE) {
                        this.f1452e = iArr[i47];
                    }
                    iM933e = m933e(i4);
                }
                this.f1454g++;
                int i48 = this.f1455h;
                long[] jArr13 = this.f1448a;
                int i49 = iM933e >> 3;
                long j22 = jArr13[i49];
                int i50 = (iM933e & 7) << 3;
                if (((j22 >> i50) & j2) == j3) {
                ...
                jArr13[i49] = j23;
                jArr13[(((iM933e - 7) & i51) + (i51 & 7)) >> 3] = j23;
                return iM933e;
            }
            i8 += 8;
            i7 = (i7 + i8) & i6;
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !eh0Var.m931c(objArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
    ...
    public final void m934f(int i) {
        ...
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1455h = dy0.m738a(this.f1453f) - this.f1454g;
        this.f1449b = iMax == 0 ? o30.f4434d : new Object[iMax];
        if (iMax == 0) {
            jArr2 = o30.f4445o;
        } else {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m935g(Object obj) {
        int iNumberOfTrailingZeros;
        int iHashCode = (obj != null ? obj.hashCode() : 0) * (-862048943);
        int i = iHashCode ^ (iHashCode << 16);
        int i2 = i & 127;
    ...
    public final int hashCode() {
        int iHashCode = (this.f1453f * 31) + this.f1454g;
        Object[] objArr = this.f1449b;
        long[] jArr = this.f1448a;
        int length = jArr.length - 2;
        if (length >= 0) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m937i(Collection collection) {
        collection.getClass();
        Object[] objArr = this.f1449b;
        int i = this.f1454g;
        long[] jArr = this.f1448a;
        ...
        return i != this.f1454g;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final String toString() {
        C0711s2 c0711s2 = new C0711s2(17, this);
