...
public final class b50 extends AbstractC0549of {
    ...
    public /* synthetic */ b50(int i, int i2, long j, String str) {
        super(str, j, i);
        this.f381d = i2;
    }
    ...
    public final float mo256e(float f, float f2, float f3) {
        switch (this.f381d) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * rd0.f5371j[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
    ...
    public final long mo257f(float f, float f2, float f3, float f4, AbstractC0549of abstractC0549of) {
        switch (this.f381d) {
            case 0:
                ...
                return p30.m2991a(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, abstractC0549of);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return p30.m2991a(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, abstractC0549of);
        }
    }
}
