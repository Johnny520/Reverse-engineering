...
public final class DexKitCacheBridge$RecyclableBridge$getInternalList$loader$1$1 extends c50 implements InterfaceC0298hw {
    ...
    public DexKitCacheBridge$RecyclableBridge$getInternalList$loader$1$1(DexKitCacheBridge.RecyclableBridge recyclableBridge, InterfaceC0904ww interfaceC0904ww, BaseFinder baseFinder, InterfaceC0742sw interfaceC0742sw) {
        super(0);
    ...
    public final List<R> invoke() {
        ...
        try {
            ...
            Iterable iterable = (Iterable) interfaceC0904ww.invoke(dexKitBridge, baseFinder);
