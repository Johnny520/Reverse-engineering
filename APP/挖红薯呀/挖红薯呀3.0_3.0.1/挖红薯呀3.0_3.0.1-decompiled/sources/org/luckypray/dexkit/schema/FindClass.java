...
public final class FindClass extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createFindClass(C0938xt c0938xt, int i, int i2, boolean z, int i3, boolean z2, int i4) {
            c0938xt.getClass();
            c0938xt.m5169r(6);
            addMatcher(c0938xt, i4);
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endFindClass(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final FindClass getRootAsFindClass(ByteBuffer byteBuffer, FindClass findClass) {
            byteBuffer.getClass();
            findClass.getClass();
            return findClass.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startFindClass(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(6);
        }
