...
public final class EncodeValueBoolean extends EncodeValue implements IAnnotationEncodeValue {
    ...
    public int innerBuild(C0938xt c0938xt) {
        c0938xt.getClass();
        int iCreateEncodeValueBoolean = org.luckypray.dexkit.schema.EncodeValueBoolean.Companion.createEncodeValueBoolean(c0938xt, this.value);
        c0938xt.m5165n(iCreateEncodeValueBoolean);
