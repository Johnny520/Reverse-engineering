...
public final class UsingFieldMatcher extends BaseMatcher {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ UsingFieldMatcher field(InterfaceC0742sw interfaceC0742sw) {
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        FieldMatcher fieldMatcher = this.matcher;
        if (fieldMatcher == null) {
            C0921xc.m5131l("UsingFieldMatcher matcher not set");
            return 0;
        }
        UsingFieldMatcher.Companion companion = org.luckypray.dexkit.schema.UsingFieldMatcher.Companion;
        fieldMatcher.getClass();
        int iCreateUsingFieldMatcher = companion.createUsingFieldMatcher(c0938xt, fieldMatcher.build$dexkit_android_release(c0938xt), this.usingType.getValue());
        c0938xt.m5165n(iCreateUsingFieldMatcher);
    ...
    public final /* synthetic */ UsingFieldMatcher addAnnotation(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ UsingFieldMatcher annotations(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ UsingFieldMatcher readMethods(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ UsingFieldMatcher writeMethods(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        MethodsMatcher methodsMatcher = new MethodsMatcher();
        interfaceC0742sw.invoke(methodsMatcher);
    ...
    public final UsingFieldMatcher annotationCount(z20 z20Var) {
        z20Var.getClass();
        FieldMatcher fieldMatcher = this.matcher;
        if (fieldMatcher == null) {
            fieldMatcher = new FieldMatcher();
        ...
        this.matcher = fieldMatcher;
        fieldMatcher.annotationCount(z20Var);
        return this;
    }
 ...
 A[MD:(java.lang.reflect.Field, org.luckypray.dexkit.query.enums.UsingType):void (m)] (LINE:26) call: org.luckypray.dexkit.query.matchers.UsingFieldMatcher.<init>(java.lang.reflect.Field, org.luckypray.dexkit.query.enums.UsingType):void type: THIS */
    public /* synthetic */ UsingFieldMatcher(Field field, UsingType usingType, int i, AbstractC0619pl abstractC0619pl) {
        this(field, (i & 2) != 0 ? UsingType.Any : usingType);
    }

    public final /* synthetic */ UsingFieldMatcher addReadMethods(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ UsingFieldMatcher addWriteMethod(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0742sw.invoke(methodMatcher);
    ...
    public final /* synthetic */ UsingFieldMatcher declaredClass(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ UsingFieldMatcher type(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        ClassMatcher classMatcher = new ClassMatcher();
        interfaceC0742sw.invoke(classMatcher);
        type(classMatcher);
 ...
 A[MD:(java.lang.String, org.luckypray.dexkit.query.enums.UsingType):void (m)] (LINE:31) call: org.luckypray.dexkit.query.matchers.UsingFieldMatcher.<init>(java.lang.String, org.luckypray.dexkit.query.enums.UsingType):void type: THIS */
    public /* synthetic */ UsingFieldMatcher(String str, UsingType usingType, int i, AbstractC0619pl abstractC0619pl) {
