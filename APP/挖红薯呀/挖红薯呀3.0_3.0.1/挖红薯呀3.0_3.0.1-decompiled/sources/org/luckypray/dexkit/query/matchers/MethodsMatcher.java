...
public final class MethodsMatcher extends BaseMatcher {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final MethodsMatcher count(z20 z20Var) {
        z20Var.getClass();
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                arrayList.add(Integer.valueOf(((MethodMatcher) it.next()).build$dexkit_android_release(c0938xt)));
            }
        ...
        int iCreateMethodsMatcher = companion.createMethodsMatcher(c0938xt, iM5162k, value, intRange != null ? intRange.build$dexkit_android_release(c0938xt) : 0);
        c0938xt.m5165n(iCreateMethodsMatcher);
    ...
    public final /* synthetic */ MethodsMatcher add(InterfaceC0742sw interfaceC0742sw) {
