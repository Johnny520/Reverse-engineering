...
public final class EncodeValueString extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createEncodeValueString(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addValue(c0938xt, i);
            return endEncodeValueString(c0938xt);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endEncodeValueString(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final EncodeValueString getRootAsEncodeValueString(ByteBuffer byteBuffer, EncodeValueString encodeValueString) {
            ...
            return encodeValueString.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startEncodeValueString(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
