...
public final class StringMatcher extends BaseMatcher implements IAnnotationEncodeValue {
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        if (str == null) {
            C0921xc.m5131l("value must be specified");
            return 0;
        }
        str.getClass();
        if (str.length() == 0) {
        ...
        str2.getClass();
        int iCreateStringMatcher = companion.createStringMatcher(c0938xt, c0938xt.m5161j(str2), this.matchType.getValue(), this.ignoreCase);
        c0938xt.m5165n(iCreateStringMatcher);
 ...
 A[MD:(java.lang.String, org.luckypray.dexkit.query.enums.StringMatchType, boolean):void (m)] (LINE:23) call: org.luckypray.dexkit.query.matchers.base.StringMatcher.<init>(java.lang.String, org.luckypray.dexkit.query.enums.StringMatchType, boolean):void type: THIS */
    public /* synthetic */ StringMatcher(String str, StringMatchType stringMatchType, boolean z, int i, AbstractC0619pl abstractC0619pl) {
