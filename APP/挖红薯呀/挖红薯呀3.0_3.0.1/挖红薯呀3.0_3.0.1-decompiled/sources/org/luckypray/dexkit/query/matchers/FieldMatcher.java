...
public final class FieldMatcher extends BaseMatcher implements IAnnotationEncodeValue {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FieldMatcher annotations(InterfaceC0742sw interfaceC0742sw) {
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        AnnotationsMatcher annotationsMatcher = this.annotationsMatcher;
        int iBuild$dexkit_android_release5 = annotationsMatcher != null ? annotationsMatcher.build$dexkit_android_release(c0938xt) : 0;
        MethodsMatcher methodsMatcher = this.getMethodsMatcher;
        int iBuild$dexkit_android_release6 = methodsMatcher != null ? methodsMatcher.build$dexkit_android_release(c0938xt) : 0;
        MethodsMatcher methodsMatcher2 = this.putMethodsMatcher;
        int iBuild$dexkit_android_release7 = methodsMatcher2 != null ? methodsMatcher2.build$dexkit_android_release(c0938xt) : 0;
        ...
        if (list2 != null) {
            ...
            while (it2.hasNext()) {
                arrayList2.add(Integer.valueOf(((FieldMatcher) it2.next()).build$dexkit_android_release(c0938xt)));
            }
        ...
        if (list3 != null) {
            ...
            while (it3.hasNext()) {
                arrayList3.add(Integer.valueOf(((FieldMatcher) it3.next()).build$dexkit_android_release(c0938xt)));
            }
            iM5162k3 = c0938xt.m5162k(AbstractC0960ye.m5252V(arrayList3));
        }
        int iCreateFieldMatcher = companion.createFieldMatcher(c0938xt, iBuild$dexkit_android_release, iBuild$dexkit_android_release2, iBuild$dexkit_android_release3, iBuild$dexkit_android_release4, iBuild$dexkit_android_release5, iBuild$dexkit_android_release6, iBuild$dexkit_android_release7, iM5162k, iM5162k2, iM5162k3);
        c0938xt.m5165n(iCreateFieldMatcher);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FieldMatcher not(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FieldMatcher readMethods(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FieldMatcher writeMethods(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        MethodsMatcher methodsMatcher = new MethodsMatcher();
        interfaceC0742sw.invoke(methodsMatcher);
    ...
    public final /* synthetic */ FieldMatcher addAllOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcher fieldMatcher = new FieldMatcher();
        interfaceC0742sw.invoke(fieldMatcher);
    ...
    public final /* synthetic */ FieldMatcher addAnnotation(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ FieldMatcher addAnyOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcher fieldMatcher = new FieldMatcher();
        interfaceC0742sw.invoke(fieldMatcher);
    ...
    public final /* synthetic */ FieldMatcher addNoneOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcher fieldMatcher = new FieldMatcher();
        interfaceC0742sw.invoke(fieldMatcher);
        addNoneOf(fieldMatcher);
    ...
    public final FieldMatcher annotationCount(z20 z20Var) {
        z20Var.getClass();
        AnnotationsMatcher annotationsMatcher = this.annotationsMatcher;
        if (annotationsMatcher == null) {
            annotationsMatcher = new AnnotationsMatcher();
    ...
    public final /* synthetic */ FieldMatcher addReadMethod(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ FieldMatcher addWriteMethod(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        MethodMatcher methodMatcher = new MethodMatcher();
        interfaceC0742sw.invoke(methodMatcher);
    ...
    public final /* synthetic */ FieldMatcher allOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcherList fieldMatcherList = new FieldMatcherList();
        interfaceC0742sw.invoke(fieldMatcherList);
        allOf(fieldMatcherList);
        return this;
    }

    public final /* synthetic */ FieldMatcher anyOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcherList fieldMatcherList = new FieldMatcherList();
        interfaceC0742sw.invoke(fieldMatcherList);
    ...
    public final /* synthetic */ FieldMatcher noneOf(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        FieldMatcherList fieldMatcherList = new FieldMatcherList();
        interfaceC0742sw.invoke(fieldMatcherList);
    ...
    public final /* synthetic */ FieldMatcher declaredClass(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
    ...
    public final /* synthetic */ FieldMatcher type(InterfaceC0742sw interfaceC0742sw) {
        interfaceC0742sw.getClass();
        ClassMatcher classMatcher = new ClassMatcher();
        interfaceC0742sw.invoke(classMatcher);
        type(classMatcher);
