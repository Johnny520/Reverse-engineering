...
public final class EncodeValueByte extends EncodeValue implements IAnnotationEncodeValue, INumberEncodeValue {
    ...
    public int innerBuild(C0938xt c0938xt) {
        c0938xt.getClass();
        int iCreateEncodeValueByte = org.luckypray.dexkit.schema.EncodeValueByte.Companion.createEncodeValueByte(c0938xt, this.value);
        c0938xt.m5165n(iCreateEncodeValueByte);
