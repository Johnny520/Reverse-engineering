...
public final class FindMethod extends BaseFinder {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final FindMethod ignorePackagesCase(boolean z) {
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        if (collection5 != null) {
            ...
            iCreateInClassesVector = org.luckypray.dexkit.schema.FindMethod.Companion.createInClassesVector(c0938xt, AbstractC0960ye.m5254X(arrayList3));
        } else {
        ...
        if (collection7 != null) {
            ...
            ArrayList arrayList4 = new ArrayList(AbstractC1001ze.m5585E(collection8));
            Iterator<T> it4 = collection8.iterator();
            while (it4.hasNext()) {
                arrayList4.add(Long.valueOf(((MethodData) it4.next()).getEncodeId()));
            }
            iCreateInMethodsVector = org.luckypray.dexkit.schema.FindMethod.Companion.createInMethodsVector(c0938xt, AbstractC0960ye.m5254X(arrayList4));
        } else {
            iCreateInMethodsVector = 0;
        }
        boolean z2 = this.findFirst;
        MethodMatcher methodMatcher = this.matcher;
        int iCreateFindMethod = companion.createFindMethod(c0938xt, iM5162k, iM5162k2, z, iCreateInClassesVector, iCreateInMethodsVector, z2, methodMatcher != null ? methodMatcher.build$dexkit_android_release(c0938xt) : 0);
        c0938xt.m5165n(iCreateFindMethod);
        return iCreateFindMethod;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FindMethod matcher(InterfaceC0742sw interfaceC0742sw) {
