...
public final class AnnotationEncodeArray extends c61 {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationEncodeArray __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationEncodeValueMeta values(AnnotationEncodeValueMeta annotationEncodeValueMeta, int i) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createAnnotationEncodeArray(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addValues(c0938xt, i);
            return endAnnotationEncodeArray(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAnnotationEncodeArray(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final AnnotationEncodeArray getRootAsAnnotationEncodeArray(ByteBuffer byteBuffer, AnnotationEncodeArray annotationEncodeArray) {
            ...
            return annotationEncodeArray.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationEncodeArray(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
    ...
    public final AnnotationEncodeValueMeta values(int i) {
        return values(new AnnotationEncodeValueMeta(), i);
    }
}
