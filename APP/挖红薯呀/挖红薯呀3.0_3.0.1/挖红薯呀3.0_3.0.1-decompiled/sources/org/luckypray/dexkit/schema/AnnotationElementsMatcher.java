...
public final class AnnotationElementsMatcher extends c61 {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationElementsMatcher __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final AnnotationElementMatcher elements(AnnotationElementMatcher annotationElementMatcher, int i) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addElementCount(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5159h(2, i);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createAnnotationElementsMatcher(C0938xt c0938xt, int i, byte b, int i2) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
            addElementCount(c0938xt, i2);
            addElements(c0938xt, i);
            addMatchType(c0938xt, b);
            return endAnnotationElementsMatcher(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAnnotationElementsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final AnnotationElementsMatcher getRootAsAnnotationElementsMatcher(ByteBuffer byteBuffer, AnnotationElementsMatcher annotationElementsMatcher) {
            ...
            return annotationElementsMatcher.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationElementsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
        }
    ...
    public final AnnotationElementMatcher elements(int i) {
        return elements(new AnnotationElementMatcher(), i);
    }
}
