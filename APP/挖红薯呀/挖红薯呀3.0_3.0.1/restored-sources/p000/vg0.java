...
public final class vg0 {
    ...
    public vg0(int i) {
        this.f6713a = dy0.f1212a;
        this.f6714b = c30.f649a;
        if (i >= 0) {
            m4747d(dy0.m741d(i));
        } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0089, code lost:
        ...
        if (r37.f6717e != 0) goto L16;
     */
    /* JADX WARN: Code restructure failed: missing block: B:15:0x009d, code lost:
    
        if (((r37.f6713a[r3 >> 3] >> ((r3 & 7) << 3)) & 255) != 254) goto L17;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00bf, code lost:
        ...
        if (java.lang.Long.compareUnsigned(((long) r37.f6716d) * 32, ((long) r3) * 25) > 0) goto L42;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00ec, code lost:
        ...
        r25 = r12;
        r7 = p000.AbstractC0201f9.m1064j0(r3);
        r8 = r7 - 1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x01cc, code lost:
        ...
        r29 = r15;
        r37.f6717e = p000.dy0.m738a(r37.f6715c) - r37.f6716d;
     */
    ...
    */
    public final boolean m4744a(int i) {
        int i2;
        boolean z;
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                int i14 = i4;
                if (this.f6714b[iNumberOfTrailingZeros] == i) {
                    z = true;
                    break loop0;
                }
                j4 &= j4 - 1;
        ...
        this.f6714b[iNumberOfTrailingZeros] = i;
        if (this.f6716d != i3) {
            return z;
        }
        return false;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m4745b(int i) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(i) * (-862048943);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX INFO: renamed from: d */
    public final void m4747d(int i) {
        long[] jArr;
        ...
        long j = 255 << ((iMax & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f6717e = dy0.m738a(this.f6715c) - this.f6716d;
        this.f6714b = new int[iMax];
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m4748e(int i) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(i) * (-862048943);
        int i2 = iHashCode ^ (iHashCode << 16);
        int i3 = i2 & 127;
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !vg0Var.m4745b(iArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
    ...
    public final void m4749f(int i) {
        this.f6716d--;
        long[] jArr = this.f6713a;
        int i2 = this.f6715c;
        int i3 = i >> 3;
  ...
  0x005b: PHI (r5v2 int) = (r5v1 int), (r5v3 int) binds: [B:6:0x0024, B:18:0x0059] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0001: CONSTRUCTOR (6 int) A[MD:(int):void (m)] (LINE:34) call: vg0.<init>(int):void type: THIS */
