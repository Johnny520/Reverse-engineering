...
public abstract class c61 {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static String __string(int i, ByteBuffer byteBuffer, ya1 ya1Var) {
        ...
        if (!byteBuffer.hasArray()) {
            ...
            while (i4 < i5) {
                ...
                if (b2 >= 0) {
                    ...
                    i4 += 2;
                    z60.m5415B(b2, byteBuffer.get(i8), cArr, i7);
                    i7++;
                } else if (b2 < -16) {
                    if (i8 >= i5 - 1) {
                        C0921xc.m5131l("Invalid UTF-8");
                    ...
                    int i10 = i4 + 2;
                    i4 += 3;
                    z60.m5414A(b2, byteBuffer.get(i8), byteBuffer.get(i10), cArr, i7);
                    i7++;
                } else {
                    if (i8 >= i5 - 2) {
                        C0921xc.m5131l("Invalid UTF-8");
                    ...
                    i4 += 4;
                    z60.m5456z(b2, b4, b5, byteBuffer.get(i11), cArr, i7);
                    i7 += 2;
                }
            }
        ...
        while (iArrayOffset < i12) {
            ...
            if (b7 >= 0) {
                ...
                iArrayOffset += 2;
                z60.m5415B(b7, bArrArray[i15], cArr2, i14);
                i14++;
            } else if (b7 < -16) {
                if (i15 >= i12 - 1) {
                    C0921xc.m5131l("Invalid UTF-8");
                ...
                iArrayOffset += 3;
                z60.m5414A(b7, bArrArray[i15], bArrArray[i17], cArr2, i14);
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                    C0921xc.m5131l("Invalid UTF-8");
                ...
                iArrayOffset += 4;
                z60.m5456z(b7, b9, b10, bArrArray[i18], cArr2, i14);
                i14 += 2;
            }
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static c61 __union(c61 c61Var, int i, ByteBuffer byteBuffer) {
        c61Var.__reset(__indirect(i, byteBuffer), byteBuffer);
        return c61Var;
    }
    ...
    public int __indirect(int i) {
        return this.f715bb.getInt(i) + i;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public void __reset(int i, ByteBuffer byteBuffer) {
        this.f715bb = byteBuffer;
        if (byteBuffer == null) {
            this.bb_pos = 0;
            this.vtable_start = 0;
            this.vtable_size = 0;
            ...
            this.vtable_size = this.f715bb.getShort(i2);
        }
    }
    ...
    public int __vector(int i) {
        ...
        return this.f715bb.getInt(i2) + i2 + 4;
    }
    ...
    public ByteBuffer __vector_as_bytebuffer(int i, int i2) {
        ...
        ByteBuffer byteBufferOrder = this.f715bb.duplicate().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int __vector_len(int i) {
        int i2 = i + this.bb_pos;
        return this.f715bb.getInt(this.f715bb.getInt(i2) + i2);
    }
    ...
    public void sortTables(int[] iArr, ByteBuffer byteBuffer) {
        ...
        Arrays.sort(numArr, new b61(this, byteBuffer));
    ...
    public c61 __union(c61 c61Var, int i) {
        return __union(c61Var, i, this.f715bb);
    }

    public int __offset(int i) {
        if (i < this.vtable_size) {
            return this.f715bb.getShort(this.vtable_start + i);
        }
        return 0;
    }
    ...
    public String __string(int i) {
        return __string(i, this.f715bb, this.utf8);
    }
}
