...
public final class AnnotationEncodeValue {
    ...
    public static final Companion f8067Companion = new Companion(null);
    ...
    public final AnnotationData annotationValue() {
        if (this.type != AnnotationEncodeValueType.AnnotationValue) {
            C0921xc.m5134o("type is not AnnotationValue");
            return null;
        }
    ...
    public final AnnotationEncodeArrayData arrayValue() {
        if (this.type != AnnotationEncodeValueType.ArrayValue) {
            C0921xc.m5134o("type is not ArrayValue");
            return null;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final boolean boolValue() {
        if (this.type != AnnotationEncodeValueType.BoolValue) {
            C0921xc.m5134o("type is not BoolValue");
            return false;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final byte byteValue() {
        if (this.type != AnnotationEncodeValueType.ByteValue) {
            C0921xc.m5134o("type is not ByteValue");
            return (byte) 0;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final char charValue() {
        if (this.type != AnnotationEncodeValueType.CharValue) {
            C0921xc.m5134o("type is not CharValue");
            return (char) 0;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final double doubleValue() {
        if (this.type != AnnotationEncodeValueType.DoubleValue) {
            C0921xc.m5134o("type is not DoubleValue");
            return 0.0d;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final FieldData enumValue() {
        if (this.type != AnnotationEncodeValueType.EnumValue) {
            C0921xc.m5134o("type is not EnumValue");
            return null;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final float floatValue() {
        if (this.type != AnnotationEncodeValueType.FloatValue) {
            C0921xc.m5134o("type is not FloatValue");
            return 0.0f;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final int intValue() {
        if (this.type != AnnotationEncodeValueType.IntValue) {
            C0921xc.m5134o("type is not IntValue");
            return 0;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final long longValue() {
        if (this.type != AnnotationEncodeValueType.LongValue) {
            C0921xc.m5134o("type is not LongValue");
            return 0L;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final MethodData methodValue() {
        if (this.type != AnnotationEncodeValueType.MethodValue) {
            C0921xc.m5134o("type is not MethodValue");
            return null;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final Number numberValue() {
        switch (WhenMappings.$EnumSwitchMapping$0[this.type.ordinal()]) {
            ...
            default:
                C0921xc.m5134o("type is not number");
                return null;
        }
    }
    ...
    public final short shortValue() {
        if (this.type != AnnotationEncodeValueType.ShortValue) {
            C0921xc.m5134o("type is not ShortValue");
            return (short) 0;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public final String stringValue() {
        if (this.type != AnnotationEncodeValueType.StringValue) {
            C0921xc.m5134o("type is not StringValue");
            return null;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public String toString() {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.type.ordinal()]) {
            ...
            case 8:
                ...
                sb.append("(");
                sb.append(AbstractC0960ye.m5245O(methodData.getParamTypeNames(), ", ", null, null, null, 62));
                sb.append(")");
                break;
            case 9:
            ...
            case 10:
                ...
                obj4.getClass();
                sb.append(AbstractC0960ye.m5245O(((AnnotationEncodeArrayData) obj4).getValues(), ", ", null, null, null, 62));
                sb.append("}");
                break;
            case 11:
    ...
    public final ClassData typeValue() {
        if (this.type != AnnotationEncodeValueType.TypeValue) {
            C0921xc.m5134o("type is not TypeValue");
            return null;
        }
        Object obj = this.value;
        obj.getClass();
    ...
    public static final class Companion {
        ...
        public final AnnotationEncodeValue from(DexKitBridge dexKitBridge, AnnotationEncodeValueMeta annotationEncodeValueMeta) {
            ...
            AnnotationEncodeValueType annotationEncodeValueTypeM5663from7apg3OU = AnnotationEncodeValueType.Companion.m5663from7apg3OU(annotationEncodeValueMeta.m5676getValueTypew2LRezQ());
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[annotationEncodeValueTypeM5663from7apg3OU.ordinal()]) {
                case 1:
                    c61 c61VarValue = annotationEncodeValueMeta.value(new EncodeValueByte());
                    c61VarValue.getClass();
                    objValueOf = Byte.valueOf(((EncodeValueByte) c61VarValue).getValue());
                    break;
                case 2:
                    c61 c61VarValue2 = annotationEncodeValueMeta.value(new EncodeValueShort());
                    c61VarValue2.getClass();
                    objValueOf = Short.valueOf(((EncodeValueShort) c61VarValue2).getValue());
                    break;
                case 3:
                    c61 c61VarValue3 = annotationEncodeValueMeta.value(new EncodeValueChar());
                    c61VarValue3.getClass();
                    objValueOf = Short.valueOf(((EncodeValueChar) c61VarValue3).getValue());
                    break;
                case 4:
                    c61 c61VarValue4 = annotationEncodeValueMeta.value(new EncodeValueInt());
                    c61VarValue4.getClass();
                    objValueOf = Integer.valueOf(((EncodeValueInt) c61VarValue4).getValue());
                    break;
                case 5:
                    c61 c61VarValue5 = annotationEncodeValueMeta.value(new EncodeValueLong());
                    c61VarValue5.getClass();
                    objValueOf = Long.valueOf(((EncodeValueLong) c61VarValue5).getValue());
                    break;
                case 6:
                    c61 c61VarValue6 = annotationEncodeValueMeta.value(new EncodeValueFloat());
                    c61VarValue6.getClass();
                    objValueOf = Float.valueOf(((EncodeValueFloat) c61VarValue6).getValue());
                    break;
                case 7:
                    c61 c61VarValue7 = annotationEncodeValueMeta.value(new EncodeValueDouble());
                    c61VarValue7.getClass();
                    objValueOf = Double.valueOf(((EncodeValueDouble) c61VarValue7).getValue());
                    break;
                case 8:
                    c61 c61VarValue8 = annotationEncodeValueMeta.value(new EncodeValueString());
                    c61VarValue8.getClass();
                    objValueOf = ((EncodeValueString) c61VarValue8).getValue();
                    objValueOf.getClass();
                    break;
                case 9:
                    ClassData.Companion companion = ClassData.f8068Companion;
                    c61 c61VarValue9 = annotationEncodeValueMeta.value(new ClassMeta());
                ...
                case 10:
                    ...
                    c61 c61VarValue10 = annotationEncodeValueMeta.value(new MethodMeta());
                ...
                case 11:
                    ...
                    c61 c61VarValue11 = annotationEncodeValueMeta.value(new FieldMeta());
                    c61VarValue11.getClass();
                    objValueOf = companion3.from(dexKitBridge, (FieldMeta) c61VarValue11);
                    break;
                case 12:
                    AnnotationEncodeArrayData.Companion companion4 = AnnotationEncodeArrayData.f8066Companion;
                    c61 c61VarValue12 = annotationEncodeValueMeta.value(new AnnotationEncodeArray());
                ...
                case 13:
                    ...
                    c61 c61VarValue13 = annotationEncodeValueMeta.value(new AnnotationMeta());
                    c61VarValue13.getClass();
                    objValueOf = companion5.from(dexKitBridge, (AnnotationMeta) c61VarValue13);
                    break;
                case 14:
                    c61 c61VarValue14 = annotationEncodeValueMeta.value(new EncodeValueNull());
                    c61VarValue14.getClass();
                    objValueOf = (EncodeValueNull) c61VarValue14;
                    break;
                case j50.f2734e /* 15 */:
                    c61 c61VarValue15 = annotationEncodeValueMeta.value(new EncodeValueBoolean());
            ...
            return new AnnotationEncodeValue(objValueOf, annotationEncodeValueTypeM5663from7apg3OU, abstractC0619pl);
        }
    ...
    public /* synthetic */ AnnotationEncodeValue(Object obj, AnnotationEncodeValueType annotationEncodeValueType, AbstractC0619pl abstractC0619pl) {
