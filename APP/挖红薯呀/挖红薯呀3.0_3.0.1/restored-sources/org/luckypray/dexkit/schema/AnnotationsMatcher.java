...
public final class AnnotationsMatcher extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void addAnnotationCount(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5159h(2, i);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createAnnotationsMatcher(C0938xt c0938xt, int i, byte b, int i2) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
            addAnnotationCount(c0938xt, i2);
            addAnnotations(c0938xt, i);
            addMatchType(c0938xt, b);
            return endAnnotationsMatcher(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endAnnotationsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final AnnotationsMatcher getRootAsAnnotationsMatcher(ByteBuffer byteBuffer, AnnotationsMatcher annotationsMatcher) {
            ...
            return annotationsMatcher.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startAnnotationsMatcher(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(3);
        }
