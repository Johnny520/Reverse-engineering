...
public final class ClassMetaArrayHolder extends c61 {
    public static final Companion Companion = new Companion(null);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final ClassMetaArrayHolder __assign(int i, ByteBuffer byteBuffer) {
        byteBuffer.getClass();
        __init(i, byteBuffer);
        return this;
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createClassMetaArrayHolder(C0938xt c0938xt, int i) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
            addClasses(c0938xt, i);
            return endClassMetaArrayHolder(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endClassMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final ClassMetaArrayHolder getRootAsClassMetaArrayHolder(ByteBuffer byteBuffer, ClassMetaArrayHolder classMetaArrayHolder) {
            byteBuffer.getClass();
            classMetaArrayHolder.getClass();
            return classMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startClassMetaArrayHolder(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(1);
        }
