...
public final class BatchMethodMeta extends c61 {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int createBatchMethodMeta(C0938xt c0938xt, int i, int i2) {
            c0938xt.getClass();
            c0938xt.m5169r(2);
            addMethods(c0938xt, i2);
            addUnionKey(c0938xt, i);
            return endBatchMethodMeta(c0938xt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final int endBatchMethodMeta(C0938xt c0938xt) {
            c0938xt.getClass();
        ...
        public final BatchMethodMeta getRootAsBatchMethodMeta(ByteBuffer byteBuffer, BatchMethodMeta batchMethodMeta) {
            ...
            return batchMethodMeta.__assign(byteBuffer.position() + AbstractC0748t1.m4148f(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        public final void startBatchMethodMeta(C0938xt c0938xt) {
            c0938xt.getClass();
            c0938xt.m5169r(2);
        }
