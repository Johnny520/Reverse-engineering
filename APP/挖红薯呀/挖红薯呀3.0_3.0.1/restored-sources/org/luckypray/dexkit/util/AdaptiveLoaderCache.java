...
public final class AdaptiveLoaderCache<K, V> {
    ...
    public final V get(ClassLoader classLoader, K k, InterfaceC0298hw interfaceC0298hw) {
        Ref<V> ref;
        V v;
        Map<K, Ref<V>> map;
        V v2;
        ...
        try {
            ...
            try {
                ...
                V v4 = (V) interfaceC0298hw.invoke();
                map.put(k, wrap(v4));
                writeLock.unlock();
                return v4;
            } catch (Throwable th) {
 ...
 A[MD:(boolean):void (m)] (LINE:22) call: org.luckypray.dexkit.util.AdaptiveLoaderCache.<init>(boolean):void type: THIS */
    public /* synthetic */ AdaptiveLoaderCache(boolean z, int i, AbstractC0619pl abstractC0619pl) {
        this((i & 1) != 0 ? true : z);
    }
