...
public final class FindField extends BaseFinder {
    ...
    public int innerBuild(C0938xt c0938xt) {
        ...
        if (collection5 != null) {
            ...
            iCreateInClassesVector = org.luckypray.dexkit.schema.FindField.Companion.createInClassesVector(c0938xt, AbstractC0960ye.m5254X(arrayList3));
        } else {
            iCreateInClassesVector = 0;
        }
        Collection<FieldData> collection7 = this.searchFields;
        if (collection7 != null) {
            Collection<FieldData> collection8 = collection7;
            ...
            iCreateInFieldsVector = org.luckypray.dexkit.schema.FindField.Companion.createInFieldsVector(c0938xt, AbstractC0960ye.m5254X(arrayList4));
        } else {
            iCreateInFieldsVector = 0;
        }
        boolean z2 = this.findFirst;
        FieldMatcher fieldMatcher = this.matcher;
        int iCreateFindField = companion.createFindField(c0938xt, iM5162k, iM5162k2, z, iCreateInClassesVector, iCreateInFieldsVector, z2, fieldMatcher != null ? fieldMatcher.build$dexkit_android_release(c0938xt) : 0);
        c0938xt.m5165n(iCreateFindField);
        return iCreateFindField;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final /* synthetic */ FindField matcher(InterfaceC0742sw interfaceC0742sw) {
