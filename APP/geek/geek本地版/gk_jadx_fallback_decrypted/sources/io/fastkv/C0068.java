...
/* JADX INFO: renamed from: io.fastkv.ۦۣ۠ۨ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0068 {

    /* JADX INFO: renamed from: ۣۧ۠ۦ, reason: not valid java name and contains not printable characters */
    public static int f68 = -821;

    /* JADX INFO: renamed from: ۟ۡۥۥ, reason: not valid java name and contains not printable characters */
    public static int m272(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }

    /* JADX INFO: renamed from: ۠ۡۨۧ, reason: not valid java name and contains not printable characters */
    ...
    public static java.lang.String m274(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
    ...
    public static java.lang.String m275(java.lang.String r8) {
            r1 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r0 = r1
