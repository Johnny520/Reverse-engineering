...
public abstract class r60 {
    ...
    public static int b(android.content.Context r4, int r5) {
            ...
            if (r1 == 0) goto L17
            int[] r4 = defpackage.r60.b
            int r5 = r0.getDefaultColor()
            int r4 = r0.getColorForState(r4, r5)
            return r4
        L17:
            java.lang.ThreadLocal r0 = defpackage.r60.a
    ...
    public static android.content.res.ColorStateList d(android.content.Context r2, int r3) {
            ...
            if (r0 == 0) goto L1d
            android.content.res.ColorStateList r2 = defpackage.ip.v(r2, r0)     // Catch: java.lang.Throwable -> L25
            if (r2 == 0) goto L1d
            goto L21
        L1d:
