...
public final class z3 {
    ...
    public z3(ImageView r2) {
        this.a = 0;
        this.b = r2;
    }

    public static z3 b(Resources r30, int r31, Resources.Theme r32) {
    ...
    L7:
        ...
        TypedArray r44 = zt.H(r30, r32, r3, ty.d);
    ...
    L92:
        ...
        d4 r0 = new d4(r133, r7);
    L95:
        if (r0 != null) goto L100;
        if (r20 == false) goto L99;
        r0 = new d4(r6, r5, r122);
        goto L100
    L99:
        r0 = new d4(r6, r122);
    L100:
    ...
    L109:
        ...
        goto L110
    L111:
        r112 = new SweepGradient(r8, r9, (int[]) r0.b, (float[]) r0.c);
        goto L124
    L113:
        if (r25 <= 0.0f) goto L126;
        int[] r202 = (int[]) r0.b;
        float[] r212 = (float[]) r0.c;
        if (r10 != 1) goto L117;
    ...
    L78:
        ...
        TypedArray r24 = zt.H(r30, r32, r3, ty.e);
    ...
    L11:
        ...
        ColorStateList r04 = hb.b(r30, r2, r3, r32);
        return new z3(null, r04, r04.getDefaultColor());
    L15:
    ...
    public boolean c() {
        if (((Shader) this.b) != null) goto L10;
        ColorStateList r0 = (ColorStateList) this.c;
        if (r0 != null) goto L7;
        return false;
    L7:
    ...
    public void d(AttributeSet r9, int r10) {
        ...
        if (r2 == (-1)) goto L12;
        r92 = ff.r(r1.getContext(), r2);     // Catch: Throwable -> L10
        if (r92 == null) goto L12;
        r1.setImageDrawable(r92);     // Catch: Throwable -> L10
    L12:
        if (r92 == null) goto L15;
        eh.a(r92);     // Catch: Throwable -> L10
    L15:
        if (r02.hasValue(2) == false) goto L18;
        to.c(r1, r7.l(2));     // Catch: Throwable -> L10
    L18:
        if (r02.hasValue(3) == false) goto L20;
        to.d(r1, eh.b(r02.getInt(3, -1), null));     // Catch: Throwable -> L10
    L20:
        r7.z();
        return;
    L10:
    ...
    public z3(Shader r1, ColorStateList r2, int r3) {
        this.b = r1;
        this.c = r2;
        this.a = r3;
    }
