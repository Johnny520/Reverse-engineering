...
public final /* synthetic */ class v9 implements View.OnClickListener {
    ...
    L4:
        ...
        String r6 = "key_dice_on";     // Catch: Throwable -> L8
        r52.getClass();     // Catch: Throwable -> L8
        gn.f(r6, false);     // Catch: Throwable -> L8
        gn.f("key_rps_on", false);     // Catch: Throwable -> L8
    L6:
        gn r53 = gn.a;
        String r62 = "\u2705 \u5df2\u6062\u590d\u968f\u673a";
        r53.getClass();
    ...
    L18:
        ...
        r21.setBackgroundColor(Color.parseColor("#66000000"));
        ...
        r55.setTextColor(Color.parseColor("#333333"));
    ...
    L23:
        ...
        r211.setColor(Color.parseColor("#F5F5F5"));
        float r16 = 8.0f * r14;
        r211.setCornerRadius(r16);
        r211.setStroke((int) (1.0f * r14), Color.parseColor("#DDDDDD"));
        ...
        r214.setText("\u9009\u62e9\u6807\u9898\u989c\u8272 (\u5de6\u4e00\u4e3a\u9ed8\u8ba4)");
        r214.setTextSize(13.0f);
        r214.setTextColor(Color.parseColor("#666666"));
        int r0 = (int) r16;
        ...
        int[] r02 = {0, Color.parseColor("#E57373"), Color.parseColor("#64B5F6"), Color.parseColor("#81C784"), Color.parseColor("#FFB300"), Color.parseColor("#BA68C8")};
    ...
    L24:
        ...
        r20.setShape(1);
        if (r57 != 0) goto L40;
        int r218 = Color.parseColor("#E0E0E0");
    L29:
        r20.setColor(r218);
        ...
        r220.setShape(1);
        r220.setColor(0);
        r220.setStroke((int) (1.5f * r14), Color.parseColor("#999999"));
    ...
    L32:
        ...
        r73.setShape(1);
        r73.setColor(0);
        r73.setStroke((int) (2.0f * r14), Color.parseColor("#333333"));
    ...
    L42:
        ...
        r36.setTextColor(Color.parseColor("#666666"));
        r36.setGravity(17);
        r36.setTypeface(null, 1);
        GradientDrawable r58 = new GradientDrawable();
        r58.setColor(Color.parseColor("#F0F0F0"));
        ...
        r74.setColor(Color.parseColor("#66B3FF"));
    ...
    L175:
        ...
        String r317 = "key_ui_theme";     // Catch: Throwable -> L165
        r236.getClass();     // Catch: Throwable -> L165
        int r272 = gn.b(r317, 0);     // Catch: Throwable -> L165
    L113:
        pv r237 = new pv(Color.parseColor("#F7F7F7"), Color.parseColor("#E5E5EA"), Color.parseColor("#1C1C1E"), Color.parseColor("#8E8E93"), Color.parseColor("#007AFF"), Color.parseColor("#0056B3"), Color.parseColor("#C6C6C8"), Color.parseColor("#1A000000"));
        pv r318 = new pv(Color.parseColor("#FFF0F5"), Color.parseColor("#FFE4E1"), Color.parseColor("#5D4037"), Color.parseColor("#A1887F"), Color.parseColor("#FF85A2"), Color.parseColor("#FF69B4"), Color.parseColor("#E0CBCB"), Color.parseColor("#33FFB6C1"));
        pv r410 = new pv(Color.parseColor("#1C1C1E"), Color.parseColor("#2C2C2E"), Color.parseColor("#F5F5F5"), Color.parseColor("#8E8E93"), Color.parseColor("#0A84FF"), Color.parseColor("#0056B3"), Color.parseColor("#48484A"), Color.parseColor("#33FFFFFF"));
        pv r514 = new pv(Color.parseColor("#FFFFFF"), Color.parseColor("#F2F2F2"), Color.parseColor("#333333"), Color.parseColor("#666666"), Color.parseColor("#009688"), Color.parseColor("#00796B"), Color.parseColor("#CCCCCC"), Color.parseColor("#1A000000"));
        pv r69 = new pv(Color.parseColor("#1C1C1E"), Color.parseColor("#2C2C2E"), Color.parseColor("#F5F5F5"), Color.parseColor("#8E8E93"), Color.parseColor("#0A84FF"), Color.parseColor("#0056B3"), Color.parseColor("#48484A"), Color.parseColor("#33FFFFFF"));
        final pv r76 = new pv(Color.parseColor("#121212"), Color.parseColor("#1E1E1E"), Color.parseColor("#E0E0E0"), Color.parseColor("#9E9E9E"), Color.parseColor("#80CBC4"), Color.parseColor("#009688"), Color.parseColor("#424242"), Color.parseColor("#33FFFFFF"));
        if (r272 != 1) goto L116;
        r76 = r318;
    L121:
