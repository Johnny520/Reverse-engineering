...
public class vh implements fe, cv {
    ...
    L28:
        ...
        String r32 = "\u627e\u4e0d\u5230\u8f93\u5165\u6846";     // Catch: Throwable -> L39
    ...
    L223:
        ...
        ip.n("getMethods(...)", r102);     // Catch: Throwable -> L53
    ...
    L44:
        ...
        int r222 = r7;
        Method[] r242 = r102;
        ip.n("getParameterTypes(...)", r13);     // Catch: Throwable -> L53
    ...
    L53:
        ...
        ip.o("tag", "QuoteAction_Exec_Failed targetMethod: " + r14);     // Catch: Throwable -> L39
        "e";     // Catch: Throwable -> L39
    L39:
        th = move-exception;
        gn r34 = gn.a;
        ...
        r34.getClass();
        gn.k(r62, r05);
        String r06 = "QuoteAction_Find_Failed";
    L71:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", r06, "Fg==\n", "c8HJlSTQVfc=\n");
        goto L156
    L27:
    ...
    L134:
        ...
        String r39 = "\u56fe\u7247/\u89c6\u9891\u590d\u8bfb\u5e95\u5c42\u7c7b\u6682\u672a\u63d0\u53d6";     // Catch: Throwable -> L95
    ...
    L129:
        ...
        if (ip.i(r012, "SUCCESS") == true) goto L156;
        gn.a.getClass();     // Catch: Throwable -> L95
        gn.k(r46, "语音复读中断: " + r012);     // Catch: Throwable -> L95
        goto L156
    L133:
        gn r013 = gn.a;     // Catch: Throwable -> L95
        String r310 = "\u590d\u8bfb\u5931\u8d25: \u65e0\u6cd5\u83b7\u53d6\u8bed\u97f3\u8def\u5f84";     // Catch: Throwable -> L95
    ...
    L93:
        ...
        String r311 = "\u6682\u4e0d\u652f\u6301\u590d\u8bfb\u6b64\u7c7b\u578b\u6d88\u606f";     // Catch: Throwable -> L95
    ...
    L11:
        ...
        ip.m("null cannot be cast to non-null type kotlin.ByteArray", r63);     // Catch: Throwable -> L13
        return (byte[]) r63;
    L9:
    ...
    public static TextView l(Activity r8, FrameLayout r9, LinearLayout r10, String r11, String r12, String r13) {
        ...
        r0.setTextColor(Color.parseColor("#07C160"));
