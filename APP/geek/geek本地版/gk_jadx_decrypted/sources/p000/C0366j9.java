    ...
    public final Object mo10a() {
        ...
        switch (i2) {
                    ...
                    if (iIntValue != -1) {
                        if (C0340in.f2447i == null) {
                            try {
                                ...
                                AbstractC0514n9.m1922a("ChatUIHook_Reflect", th);
                            }
                        }
                        try {
                            method = C0340in.f2447i;
                        } catch (Throwable th2) {
                            AbstractC0514n9.m1922a("ChatUIHook_Invoke", th2);
                        }
                            ...
                            if (i3 == 34 && i4 == 0) {
                                ...
                                if (j != 0) {
                                    ...
                                    try {
                                        ...
                                        th = th4;
                                        AbstractC0514n9.m1922a("ChatUIHook_VoiceState", th);
                                        intField = 0;
                                    }
                                    if (intField >= 3) {
                                        ...
                                        if (!C0267gn.m1281a(str3, false) && !z) {
                                            ...
                                            if (!AbstractC0346ip.m1497i(obj3, bool)) {
                                                ...
                                                try {
                                                        ...
                                                        if (objCallMethod != null) {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    AbstractC0514n9.m1922a("ChatUIHook_Transform", th6);
                                                                }
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    AbstractC0514n9.m1922a("ChatUIHook_VoiceTrigger", th7);
                                                }
                                            }
                                        }
                                    }
            ...
            default:
                ...
                AbstractC0346ip.m1502n("thisObject", obj4);
                "db";
                ...
                if (!AbstractC0346ip.f2494w) {
                    if (z30.m2772q("ZnbnFvMUn0hSdfEl8BSIUFJ88A==\n", "DROeSZRx+iM=\n", C0267gn.f2144a)) {
                        try {
                            ...
                            String strM1284d = C0267gn.m1284d("key_geek_folder_ids", "");
                            if (!b50.m522H(strM1284d)) {
                                List listM527M = b50.m527M(strM1284d, new String[]{","});
                                ...
                                while (i < size) {
                                    ...
                                    if (strM1284d3.length() > 0) {
                                        List listM527M2 = b50.m527M(strM1284d3, new String[]{","});
                                        ...
                                        String strM83j0 = AbstractC0012ab.m83j0(arrayList2, ",", new C0740tc(1), 30);
