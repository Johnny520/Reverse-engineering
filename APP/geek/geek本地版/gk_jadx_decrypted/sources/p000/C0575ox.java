...
public final class C0575ox {
    ...
    /* JADX INFO: renamed from: a */
    public static void m2026a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d17 < 0.0d) {
            ...
            m2026a(path, f, f2, f3, f4, f5 * fSqrt, fSqrt * f6, f7, z, z2);
            return;
        }
    ...
    /* JADX INFO: renamed from: b */
    public static void m2027b(C0575ox[] c0575oxArr, Path path) {
        int i;
        int i2;
        float[] fArr;
        int i3;
        ...
        char c2 = 'm';
        int i6 = 0;
        while (i6 < c0575oxArr.length) {
            C0575ox c0575ox = c0575oxArr[i6];
            char c3 = c0575ox.f3615a;
            float[] fArr4 = c0575ox.f3616b;
            float f12 = fArr3[i5];
            float f13 = fArr3[1];
            float f14 = fArr3[2];
            float f15 = fArr3[3];
            ...
            while (i7 < fArr4.length) {
                if (c3 == 'A') {
                    ...
                    int i8 = i2 + 5;
                    int i9 = i2 + 6;
                    m2026a(path, f21, f22, fArr[i8], fArr[i9], fArr[i2], fArr[i2 + 1], fArr[i2 + 2], fArr[i2 + 3] != 0.0f ? 1 : i3, fArr[i2 + 4] != 0.0f ? 1 : i3);
                    f14 = fArr[i8];
                    f21 = f14;
                    f = fArr[i9];
                    f15 = f;
                    ...
                    if (c3 != 'Q') {
                        ...
                        if (c3 == 'V') {
                            ...
                            float f40 = f18;
                            c = c3;
                            m2026a(path, f39, f40, f33, f34, f35, f36, f37, z, z2);
                            f21 = f39 + fArr[i31];
                            f = fArr[i32] + f40;
                            f15 = f;
                            f14 = f21;
