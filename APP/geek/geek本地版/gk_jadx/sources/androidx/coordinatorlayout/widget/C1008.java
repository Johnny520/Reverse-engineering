...
public class C1008 {
    ...
    public static String m2937(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m2935(short[] sArr, int i, int i2, int i3) {
