...
public class AlertDialogLayout extends AbstractC0754tq {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* JADX INFO: renamed from: j */
    public static int m166j(View view) {
        WeakHashMap weakHashMap = ja0.f2600a;
        int iM2312d = s90.m2312d(view);
        if (iM2312d > 0) {
            return iM2312d;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m166j(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            sq r6 = (p000.C0717sq) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
            java.util.WeakHashMap r8 = p000.ja0.f2600a
            int r8 = p000.t90.m2367d(r9)
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM166j = m166j(view2);
            measuredHeight = view2.getMeasuredHeight() - iM166j;
            paddingBottom += iM166j;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM166j;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM166j += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM166j, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0717sq).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c0717sq).height;
                        ((LinearLayout.LayoutParams) c0717sq).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c0717sq).height = i9;
                    }
                }
                i8++;
