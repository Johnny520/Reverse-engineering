...
public final class C0319i1 extends C0005a4 implements InterfaceC0395k1 {
    ...
    public final /* synthetic */ C0358j1 f2327d;
    ...
    public C0319i1(C0358j1 c0358j1, Context context) {
        ...
        setVisibility(0);
        setEnabled(true);
        l70.m1753a(this, getContentDescription());
    ...
    public final boolean setFrame(int i, int i2, int i3, int i4) {
        ...
        if (drawable != null && background != null) {
            ...
            AbstractC0104ch.m686f(background, paddingLeft - iMax, paddingTop - iMax, paddingLeft + iMax, paddingTop + iMax);
        }
        return frame;
    }
}
