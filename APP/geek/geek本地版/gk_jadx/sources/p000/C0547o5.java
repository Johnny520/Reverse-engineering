...
public final class C0547o5 extends ToggleButton {
    ...
    public final C0804v2 f3493a;

    /* JADX INFO: renamed from: b */
    public final C0139d5 f3494b;

    /* JADX INFO: renamed from: c */
    public C0879x3 f3495c;
    ...
    public C0547o5(Context context, AttributeSet attributeSet) {
        ...
        this.f3493a = c0804v2;
        c0804v2.m2482d(attributeSet, R.attr.buttonStyleToggle);
        C0139d5 c0139d5 = new C0139d5(this);
        this.f3494b = c0139d5;
        c0139d5.m916f(attributeSet, R.attr.buttonStyleToggle);
        getEmojiTextViewHelper().m2605a(attributeSet, R.attr.buttonStyleToggle);
    }

    private C0879x3 getEmojiTextViewHelper() {
        if (this.f3495c == null) {
            this.f3495c = new C0879x3(this);
        }
        return this.f3495c;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C0804v2 c0804v2 = this.f3493a;
        if (c0804v2 != null) {
            c0804v2.m2479a();
        }
        C0139d5 c0139d5 = this.f3494b;
        if (c0139d5 != null) {
            c0139d5.m913b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f3494b.m914d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f3494b.m915e();
    }
