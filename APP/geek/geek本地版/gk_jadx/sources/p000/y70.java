...
public final class y70 {
    ...
    /* JADX INFO: renamed from: a */
    public final void m2653a(double d, double d2, long j) {
        ...
        if (dSin3 >= 1.0d) {
            ...
            this.f5287a = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f5288b = jRound;
            if (jRound >= j || this.f5287a <= j) {
                this.f5289c = 1;
            } else {
                this.f5289c = 0;
            }
