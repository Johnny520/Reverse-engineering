...
public abstract class AbstractC0329ib {

    /* JADX INFO: renamed from: a */
    public static final ThreadLocal f2405a = new ThreadLocal();

    /* JADX INFO: renamed from: a */
    public static int m1425a(double d, double d2, double d3) {
    ...
    public static int m1426b(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / 255);
        return Color.argb(i3, m1427c(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m1427c(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m1427c(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: c */
    public static int m1427c(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int m1428d(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
