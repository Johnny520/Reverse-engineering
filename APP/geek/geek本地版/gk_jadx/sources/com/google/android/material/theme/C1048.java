...
public class C1048 {
    ...
    public static String m3096(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m3095(short[] sArr, int i, int i2, int i3) {
