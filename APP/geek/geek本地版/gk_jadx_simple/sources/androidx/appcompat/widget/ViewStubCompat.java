...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context r4, AttributeSet r5) {
        super(r4, r5, 0);
        this.a = 0;
        TypedArray r42 = r4.obtainStyledAttributes(r5, xy.A, 0, 0);
        this.b = r42.getResourceId(2, -1);
        this.a = r42.getResourceId(1, 0);
    ...
    L10:
        View r12 = r1.inflate(this.a, r02, false);
        int r2 = this.b;
        if (r2 == (-1)) goto L13;
        r12.setId(r2);
    L13:
    ...
    public void setOnInflateListener(za0 r1) {
    }
}
