...
public final class y30 extends m50 implements wm {
    ...
    L7:
        ...
        ip.o(u40.a("xwGO\n", "s2Dpd1+FjZU=\n"), u40.a("zDTyeNPI0w72MeQ=\n", "n1qBOaa8vEI=\n"));     // Catch: Throwable -> L87
        ip.o(u40.a("53vj\n", "igiEy7e+YPk=\n"), "❤️ 发包成功 -> " + r7 + " (SnsId: " + r8 + ")");     // Catch: Throwable -> L87
        int r23 = ((r4 + 16) + 1) - 16;
    ...
    L12:
        ...
        Object r6 = r53.next();
        ip.n(u40.a("laav7JxaepTS\n", "+8PXmLR0VLo=\n"), r6);
        r8 = XposedHelpers.getLongField(r6, pb0.s1);     // Catch: Throwable -> L78
        Object r24 = XposedHelpers.getObjectField(r6, u40.a("NhLAJ4g/I1s=\n", "Y2GlVeZeTj4=\n"));     // Catch: Throwable -> L78
    ...
    L17:
        ...
        String r32 = u40.a("QENyXI2niidHT2BmoauVGUhNZ2qNvQ==\n", "KyYLA/7J+Xg=\n");     // Catch: Throwable -> L78
        r25.getClass();     // Catch: Throwable -> L78
        List r26 = b50.M(gn.d(r32, ""), new String[]{u40.a("LA==\n", "AImwIJJ0btg=\n")});     // Catch: Throwable -> L29
    ...
    L37:
        ...
        Object r27 = XposedHelpers.getObjectField(r6, u40.a("hV4MptK20tiFXhS3\n", "yTdnw4fFt6o=\n"));     // Catch: Throwable -> L53
    ...
    L41:
        ...
        ip.n(u40.a("iCIbWonN1pvJeFAGwQ==\n", "4VZ+KOi5uek=\n"), r34);     // Catch: Throwable -> L53
    L44:
    ...
    L55:
        ...
        XposedHelpers.setObjectField(r211, u40.a("6w==\n", "j+C4NN4jKsc=\n"), r12);     // Catch: Throwable -> L29
        XposedHelpers.setObjectField(r211, u40.a("tA==\n", "0ZbDOTdlRlI=\n"), r7);     // Catch: Throwable -> L29
        XposedHelpers.setIntField(r211, pb0.w1, 1);     // Catch: Throwable -> L78
        XposedHelpers.setIntField(r211, u40.a("qw==\n", "xaiFo6vYnks=\n"), 0);     // Catch: Throwable -> L83
    L61:
        Object r35 = XposedHelpers.findClass(pb0.v1, r11).newInstance();     // Catch: Throwable -> L29
        XposedHelpers.setLongField(r35, u40.a("+A==\n", "nL5P9sLJlBE=\n"), r8);     // Catch: Throwable -> L29
        XposedHelpers.setObjectField(r35, u40.a("JA==\n", "QsQrb15FgDE=\n"), r211);     // Catch: Throwable -> L29
    ...
    L51:
        ...
        goto L41
    L54:
        ip.o(u40.a("Nwje\n", "Q2m5jaPP2Zc=\n"), u40.a("Wair/tZP2Rpjrb3g4FPTNWGKsczX\n", "CsbYv6M7tlY=\n"));     // Catch: Throwable -> L29
        u40.a("Fg==\n", "c8HJlSTQVfc=\n");     // Catch: Throwable -> L29
    L29:
        th = th;
        r23 = r4;
    ...
    L87:
        ...
        goto L31
    L33:
        throw new IllegalStateException(u40.a("Cuo8TztaxypO+TVQbkPNLUnpNUV0XM0qTuI+VXRFzS1J/DlXcw7LZRvkJVdyQM0=\n", "aYtQIxsuqAo=\n"));
    L34:
        ct.y(r17);
        Iterator r217 = ((LinkedList) this.k.b).iterator();
        ip.n(u40.a("LPPU3X19SHZtqZ+BNQ==\n", "RYexrxwJJwQ=\n"), r217);
        r4 = 0;
        r53 = r217;
        goto L12
    }
