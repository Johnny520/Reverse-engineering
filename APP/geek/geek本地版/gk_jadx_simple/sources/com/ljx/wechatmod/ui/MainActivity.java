...
public final class MainActivity extends Activity {
    ...
    private final void extractFontToStealthDir() {
        File r1 = new File(u40.a("jRJdVddhpvWNBERPyWG19cZOGRXkbqXizQhNFchlpfnDTkpVyC619cwCTFTRLqz9jU9aQ9ZfovHB\nCUwV1m6y\n", "omEpOqUAwZA=\n"));     // Catch: Exception -> L6
        if (r1.exists() == true) goto L8;
        r1.mkdirs();     // Catch: Exception -> L6
    L8:
        File r2 = new File(r1, u40.a("3ZEEhRPLRlLB2h2YDQ==\n", "r/Rp7GuiJT0=\n"));     // Catch: Exception -> L6
        if (r2.exists() == true) goto L53;
        String[] r12 = getAssets().list("");     // Catch: Exception -> L6
        if (r12 == null) goto L32;
        String r4 = u40.a("4FsMB1XAb1j8EBUaSw==\n", "kj5hbi2pDDc=\n");     // Catch: Exception -> L6
        if (r4 != null) goto L20;
    ...
    L33:
        ...
        showCapsuleToast(u40.a("gOVLroo9+DTioUns0gKqZML0HPevWIwrgMxNrr0O9zrioUj90BOHZdvWFsew\n", "ZkXzSzW+EIE=\n"), true);     // Catch: Exception -> L6
        return;
    L36:
        InputStream r15 = getAssets().open(u40.a("EaDg3ZGtOzsN6/nAjw==\n", "Y8WNtOnEWFQ=\n"));     // Catch: Exception -> L6
        ...
        showCapsuleToast(u40.a("/gbW9nWzpDqcQtS0L4f+aZA2i5lV1v8n/SPL9G2xqhORQNyKLave\n", "GKZuE8owTI8=\n"), false);     // Catch: Exception -> L6
        return;
    L44:
        th = move-exception;
    ...
    L32:
        ...
        goto L33
    L53:
        showCapsuleToast(u40.a("Afu4UJ8rrFVyvZM7yB3NDV385QKSTflYAOCq\n", "51sAtSCoSek=\n"), false);     // Catch: Exception -> L6
        return;
    L6:
        e = move-exception;
        showCapsuleToast("资产注入被系统拒绝: " + e.getMessage(), true);
        Log.e(u40.a("GnFjw1f3Sg==\n", "XRQGqBqYLpQ=\n"), u40.a("z2hX8vhjwa2xC2CHiXmV6JJK\n", "Ju/dFGzdJAA=\n"), e);
    }
    ...
    L32:
        ...
        r14.setText(u40.a("L8UDwS/9OiDhKw==\n", "aKBmqsp3k8Y=\n"));
        ...
        r15.setTypeface(Typeface.create(u40.a("QXL14KEvPQlbdbb+6TgxDl8=\n", "MhObk4xcWHs=\n"), 0));
        ...
        String r142 = u40.a("ktkHE+HcHw+I\n", "sehGINWfKDo=\n");
    L42:
        ...
        String r132 = u40.a("ZnckwHyBiKl8\n", "RUQX80jCv5w=\n");
    L52:
    ...
    L67:
        ...
        r53.setTypeface(Typeface.create(u40.a("xUe9d/Obw1ffQP5pu4zPUNs=\n", "tibTBN7opiU=\n"), 0), 1);
    ...
    L85:
        ...
        c0.r(r34, Color.parseColor(u40.a("GNFZpB8cYAAL\n", "O+BslC8sUDA=\n")));
        c0.A(r34, Color.parseColor(u40.a("aqlqcKbqUV15\n", "SZkrQJbaYW0=\n")));
    L88:
        ...
        r34.addView(r44);
        Iterator r45 = bb.f0(new kx[]{new kx(u40.a("xJ/5UVvqHK2Iwe4aGvJjwKyuhB1cqFiuyKvwUHXP2QtKQQTS\n", "LSRhufVO+Sg=\n"), Integer.valueOf(r13)), new kx(u40.a("xQfDp5oZ2iSuaf7v4w20RL8mps+Zd6c+A9sKYeItoEaQNaf5q3WdLcUG0w==\n", "I45DQQaQM6E=\n"), Integer.valueOf(r113)), new kx(u40.a("+tb/JZrBQ0C3ivZ209Q5OKfArFm1ighG+tPrKYvOQ0yRiMp90NA7OqvW\n", "H21FzTRvptw=\n"), Integer.valueOf(r113)), new kx(u40.a("OgmP9J72QHF0VrCqxcMtLFsa7qiuOO0ufibtuZaJGXY5JqI=\n", "3rIKECBtpMk=\n"), Integer.valueOf(r113))}).iterator();
    L90:
    ...
    L102:
        ...
        goto L103
    L98:
        r46 = Color.parseColor(u40.a("WvdE56BhYw==\n", "ebN1o5ElVVI=\n"));
        goto L99
    L94:
        r136 = r6;
        goto L95
    L107:
        ...
        r17.setText(u40.a("gZ9yEWuXjrLn\n", "aSjB+dwkZis=\n"));
    ...
    L41:
        ...
        goto L37
    L31:
        r13 = zt.j(this, com.ljx.wechatmod.R.attr.colorPrimary, Color.parseColor(u40.a("QQ2XeR5L/A==\n", "Yj2nTl8NugE=\n")));
        goto L32
    L27:
        r112 = "DBEO1PtRRQ==\n";
        r12 = "LylL7L5odqs=\n";
    ...
    private static final void initSukiStyleUI$lambda$24$lambda$23(TextView r8, int r9) {
        LinearGradient r0 = new LinearGradient(0.0f, 0.0f, r8.getPaint().measureText(r8.getText().toString()), r8.getTextSize() * 1.5f, new int[]{r9, Color.parseColor(u40.a("845Ji0lbfw==\n", "0Mp8s3odOY4=\n"))}, null, Shader.TileMode.CLAMP);
    ...
    private static final void initSukiStyleUI$lambda$46$lambda$45(MainActivity r4, View r5) {
        ...
        r52.setComponent(new ComponentName(u40.a("XE6suMqUK1NaT7W405w=\n", "PyHBlr7xRTA=\n"), u40.a("E9cue7CRM4AV1jd7qZlzlhmWDzSxmj6LFcoWHA==\n", "cLhDVcT0XeM=\n")));     // Catch: Exception -> L4
        r52.setFlags(335544320);     // Catch: Exception -> L4
        r4.startActivity(r52);     // Catch: Exception -> L4
        return;
    L4:
        r4.showCapsuleToast(u40.a("9e1wunuhOUqYlFLsPZ9xG6zQMuNIyX5z9P91uXqi\n", "E3HaXNgh3/8=\n"), true);
    }
    ...
    L27:
        ...
        if (r14 < 28) goto L35;
        c0.r(r5, Color.parseColor(u40.a("EFWG6ZcU2A==\n", "M2W22ack6Cc=\n")));
    ...
    L45:
        ...
        r133.setTypeface(Typeface.create(u40.a("fwW/pIX0BcFlAvy6zeMJxmE=\n", "DGTR16iHYLM=\n"), 0), 1);
    ...
    L6:
        ...
        showCapsuleToast(u40.a("10bIXiNUZPm+PNQ/Y0MFlIVsoBg6PBXe2EfLXxxFZsubM888Y0E8lYJPriULPTf02GDY\n", "PtpItoXVgnA=\n"), true);     // Catch: Throwable -> L8
        Intent r42 = new Intent(u40.a("6jTh4Cmt4fL4P/HmL6rir6UXxNwHg8CDygrVzQeIyYPNE8nXFZvEn8gf1sEZlMCOxhPWwQ+Lyw==\n", "i1qFkkbEhdw=\n"));     // Catch: Throwable -> L8
    ...
    L8:
        ...
        r1.setText("App 启动异常：\n\n".concat(ip.W(th)));
        r1.setTextColor(Color.parseColor(u40.a("XL04w48VaQ==\n", "f/t+9r0gWxk=\n")));
