...
class FastBuffer {
    ...
    public byte[] getBytes(int i) {
        ...
        System.arraycopy(this.f2461hb, this.position, bArr, 0, i);
        this.position += i;
        return bArr;
    }
    ...
    public void putBytes(byte[] bArr) {
        ...
        if (length > 0) {
            System.arraycopy(bArr, 0, this.f2461hb, this.position, length);
    ...
    public int putVarint32(int i, int i2) {
        while ((i2 & (-128)) != 0) {
            this.f2461hb[i] = (byte) ((i2 & 127) | 128);
            i2 >>>= 7;
            i++;
        }
        int i3 = i + 1;
        this.f2461hb[i] = (byte) i2;
        return i3;
    }
    ...
    public String getString(int i) {
        ...
        String str = i > MAX_CHAR_LEN ? new String(this.f2461hb, this.position, i, StandardCharsets.UTF_8) : decodeStr(this.f2461hb, this.position, i);
        this.position += i;
        return str;
    }
