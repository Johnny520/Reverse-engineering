...
public final class ti implements TransformationMethod {
    public final TransformationMethod a;

    public ti(TransformationMethod r1) {
        this.a = r1;
    }
    ...
    public final CharSequence getTransformation(CharSequence r3, View r4) {
        ...
        return r3;
    L5:
        TransformationMethod r0 = this.a;
        if (r0 == null) goto L8;
    ...
    L8:
        ...
        return r3;
    L10:
        if (ei.a().b() != 1) goto L15;
        ei r42 = ei.a();
        r42.getClass();
        return r42.e(r3, 0, r3.length());
    L15:
        return r3;
    }
