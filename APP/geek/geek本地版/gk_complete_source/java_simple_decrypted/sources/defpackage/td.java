...
public final class td extends XC_MethodHook {
    ...
    L18:
        ...
        goto L3
    L20:
        if (b50.N(r11, "geek_fold_", false) == false) goto L83;
    ...
    L71:
        ...
        goto L70
    L72:
        r4 = XposedHelpers.getObjectField(r9, "field_username");
    ...
    L78:
        ip.o("param", r30);
        r6 = r30.args[0];
        ip.m("null cannot be cast to non-null type kotlin.Int", r6);
        r37 = "ۦۦۦ";
        goto L48
    L79:
        r7 = r27;
    ...
    L4:
        ...
        ip.m("null cannot be cast to non-null type android.app.Application", r4);
        ...
        gn.b = r42;
        gn.d = r7;
        if (r7.equals("com.tencent.mm") == true) goto L199;
    L46:
        r42.registerActivityLifecycleCallbacks(new en());
        if (ip.i(r5.processName, "com.tencent.mm") == false) goto L178;
    ...
    L203:
        long r10 = r42.getPackageManager().getPackageInfo("com.ljx.wechatmod", 0).lastUpdateTime;     // Catch: Throwable -> L129
        gn r53 = gn.a;     // Catch: Throwable -> L129
        String r63 = "key_last_install_time";     // Catch: Throwable -> L129
        String r72 = "0";     // Catch: Throwable -> L129
    ...
    L57:
        if (r10 == r64) goto L60;
        String r55 = "UpdateManager";     // Catch: Throwable -> L129
        String r65 = "\u68c0\u6d4b\u5230\u6a21\u5757\u53d1\u751f\u5b89\u88c5\u884c\u4e3a\uff0c\u5f3a\u5236\u91cd\u7f6e\u6697\u53f7\u4e3a #geek";     // Catch: Throwable -> L129
        ip.o("tag", r55);     // Catch: Throwable -> L129
        ip.o("msg", r65);     // Catch: Throwable -> L129
        gn.h("key_secret_entry_code", "#geek");     // Catch: Throwable -> L129
        gn.h("key_last_install_time", String.valueOf(r10));     // Catch: Throwable -> L129
        Toast.makeText(r42, "Geek\u6a21\u5757\u5df2\u91cd\u88c5\uff0c\u5165\u53e3\u6697\u53f7\u91cd\u7f6e\u4e3a #geek", 1).show();     // Catch: Throwable -> L190
    L60:
        String r56 = pb0.a;
        "context";
        PackageInfo r57 = r42.getPackageManager().getPackageInfo("com.tencent.mm", 0);     // Catch: Throwable -> L134
    ...
    L67:
        ...
        r58 = "unknown";
    L70:
        if (b50.N(r58, "8.0.71", false) == false) goto L144;
        dd0 r59 = i90.a;
    L72:
        r59.getClass();
        String r66 = r59.G1;
        ...
        pb0.d1 = r59.B1;
        pb0.e1 = r66;
        ip.n("getBytes(...)", r66.getBytes(c9.a));
        pb0.f1 = r59.H1;
        pb0.g1 = r59.I1;
        pb0.h1 = r59.J1;
        pb0.i1 = r59.K1;
        ...
        kx r67 = new kx("netSceneOpenLuckyMoney", pb0.n);
        kx r9 = new kx("netSceneReceiveLuckyMoney", pb0.m);
        kx r102 = new kx("netSceneConfirmTransferClass", pb0.l);
        kx r11 = new kx("msgClass", pb0.o);
        kx r12 = new kx("appMsgContentClass", pb0.e0);
        kx r13 = new kx("snsObjectClass", pb0.j1);
        kx r14 = new kx("timeLineObjectClass", pb0.a1);
        kx r15 = new kx("networkCoreClass", pb0.b);
        kx r16 = new kx("kernelClass", pb0.p);
        kx r17 = new kx("voiceLogicClass", pb0.c);
        kx r18 = new kx("vfsVoiceClass", pb0.T);
        kx r19 = new kx("emojiServiceClass", pb0.g);
        kx r20 = new kx("appMsgLogicClass", pb0.d0);
        kx r21 = new kx("chattingAdapterClass", pb0.m0);
        kx r22 = new kx("netSceneMsgClass", pb0.a);
        kx r23 = new kx("netSceneSnsCommentClass", pb0.u1);
        kx r24 = new kx("snsCommentReqClass", pb0.v1);
    ...
    L161:
        ...
        int r513 = gn.b("key_entry_mode", 2);
        if (r513 != 1) goto L164;
    L183:
        final int r82 = 0;
        gn.j("SecretEntryHook", new ns(r42, r82));
    L165:
        if (r513 != 0) goto L167;
    L184:
        final int r74 = 12;
        gn.j("MenuEntryHook", new ns(r42, r74));
    L168:
        ConcurrentHashMap r514 = xa.a;
        String r515 = t6.a;     // Catch: Exception -> L188
        if (r515.length() <= 0) goto L174;
        if (r515.equals("UNKNOWN_WXID") == true) goto L174;
        ConcurrentHashMap r69 = xa.a;     // Catch: Exception -> L188
        r69.clear();     // Catch: Exception -> L188
        r69.put(r515, new wa("Geek Pro", Color.parseColor("#E8F5E9"), Color.parseColor("#4CAF50")));     // Catch: Exception -> L188
    L174:
        final int r75 = 13;
        gn.j("SystemHook", new ns(r42, r75));
        final int r76 = 14;
        gn.j("PrivacyHook", new ns(r42, r76));
        z30.o("ddas\n", "AbfL95mQedY=\n", "UIHook", "ITa66yE=\n", "Q1rViEo8ya8=\n");
        XposedBridge.hookAllMethods(Activity.class, "onResume", new p50(6));     // Catch: Throwable -> L185
    L176:
        final int r77 = 1;
        gn.j("SnsNetwork", new ns(r42, r77));
        final int r78 = 2;
        gn.j("Notification", new ns(r42, r78));
        final int r79 = 3;
        gn.j("SnsHook", new ns(r42, r79));
        final int r710 = 4;
        gn.j("ChatHook", new ns(r42, r710));
        final int r711 = 5;
        gn.j("MessageDB", new ns(r42, r711));
        final int r712 = 6;
        gn.j("LuckyMoney", new ns(r42, r712));
        final int r713 = 7;
        gn.j("MainUIHook", new ns(r42, r713));
        final int r714 = 8;
        gn.j("RealNameHook", new ns(r42, r714));
        final int r715 = 9;
        gn.j("ConversationHook", new ns(r42, r715));
        final int r716 = 10;
        gn.j("ConversationUIHook", new ns(r42, r716));
        final int r717 = 11;
        gn.j("AvatarHook", new ns(r42, r717));
        ip.o(z30.k("xwGO\n", "s2Dpd1+FjZU=\n", "AuthEngine", "53vj\n", "igiEy7e+YPk=\n"), "Authentication bypassed, hooks deployed smoothly for everyone.");
    L186:
        "tag";
        "e";
        goto L176
    ...
    L181:
        ...
        goto L161
    L144:
        if (b50.N(r58, "8.0.70", false) == false) goto L147;
        r59 = h90.a;
        goto L72
    L147:
        if (b50.N(r58, "8.0.69", false) == false) goto L182;
        r59 = g90.a;
        goto L72
    L182:
    ...
    L193:
        ...
        r58 = "";
    L141:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "WeChatVersionMapper_GetVersion", "Fg==\n", "c8HJlSTQVfc=\n");
        r58 = "";
        goto L67
    L128:
        r64 = 0;
    L130:
        gn r517 = gn.a;
        String r610 = "key_secret_entry_code";
        r517.getClass();
        if (gn.d(r610, "").length() != 0) goto L133;
        gn.h("key_secret_entry_code", "#geek");
    L133:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "UpdateManager", "Fg==\n", "c8HJlSTQVfc=\n");
        goto L60
    L124:
    ...
    L127:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "GeekConfig_RegisterReceiver", "Fg==\n", "c8HJlSTQVfc=\n");
    L123:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "AuthManager_Init", "Fg==\n", "c8HJlSTQVfc=\n");
    L178:
    ...
    L199:
        ...
        ip.n("getExternalMediaDirs(...)", r611);     // Catch: Throwable -> L43
        if (r611.length != 0) goto L77;
        File r612 = null;
    L9:
        if (r612 != null) goto L11;
        r612 = new File("/storage/emulated/0/Android/media/com.tencent.mm");     // Catch: Throwable -> L43
    L11:
        File r718 = new File(r612, ".sys_cache/sns");     // Catch: Throwable -> L43
        if (r718.exists() == true) goto L15;
        r718.mkdirs();     // Catch: Throwable -> L43
    L15:
        if (r718.exists() == false) goto L78;
        gn.c = new FastKV.Builder(r718.getAbsolutePath(), "sns_micro_video_cache").build();     // Catch: Throwable -> L43
    L17:
        File r93 = new File(r42.getFilesDir(), "xlog");     // Catch: Throwable -> L43
        if (new File(r93, "xlog_appender_metrics.kv").exists() == true) goto L209;
    L30:
        SharedPreferences r94 = r42.getSharedPreferences("geek_helper_prefs", 0);     // Catch: Throwable -> L43
        FastKV r613 = gn.c;     // Catch: Throwable -> L43
        if (r613 == null) goto L46;
        if (r613.getBoolean("is_migrated_to_media_stealth", false) == true) goto L46;
        Map<String, ?> r614 = r94.getAll();     // Catch: Throwable -> L43
        ip.n("getAll(...)", r614);     // Catch: Throwable -> L43
    ...
    L115:
        ...
        r617.putBoolean("is_migrated_to_media_stealth", true);     // Catch: Throwable -> L43
    L118:
        r94.edit().clear().apply();     // Catch: Throwable -> L43
    L209:
        Map r618 = new FastKV.Builder(r93.getAbsolutePath(), "xlog_appender_metrics").build().getAll();     // Catch: Throwable -> L28
        ip.n("getAll(...)", r618);     // Catch: Throwable -> L28
    ...
    L103:
        String r622 = "ConfigMigration";     // Catch: Throwable -> L28
        String r722 = "Media metrics synced and internal cache cleaned.";     // Catch: Throwable -> L28
        ip.o("tag", r622);     // Catch: Throwable -> L28
        ip.o("msg", r722);     // Catch: Throwable -> L28
    L29:
        ip.o("tag", "GeekConfig_CleanInternal");     // Catch: Throwable -> L43
        "e";     // Catch: Throwable -> L43
        goto L30
    L78:
        File r623 = new File(r42.getFilesDir(), "geek_fallback_cache");     // Catch: Throwable -> L43
        if (r623.exists() == true) goto L81;
        r623.mkdirs();     // Catch: Throwable -> L43
    L81:
        gn.c = new FastKV.Builder(r623.getAbsolutePath(), "sns_micro_video_cache").build();     // Catch: Throwable -> L43
        String r624 = "ConfigEngine";     // Catch: Throwable -> L43
        String r723 = "\u26a0\ufe0f \u5916\u90e8\u76ee\u5f55\u521b\u5efa\u5931\u8d25\uff0c\u5df2\u964d\u7ea7\u81f3\u5185\u90e8\u6c99\u76d2\u5b58\u50a8";     // Catch: Throwable -> L43
        ip.o("tag", r624);     // Catch: Throwable -> L43
        ip.o("msg", r723);     // Catch: Throwable -> L43
        goto L17
    L77:
        r612 = r611[0];     // Catch: Throwable -> L43
    L44:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "FastKV_Init_Crash", "Fg==\n", "c8HJlSTQVfc=\n");
        File r625 = new File(r42.getFilesDir(), "geek_ultimate_fallback");     // Catch: Throwable -> L120
        r625.mkdirs();     // Catch: Throwable -> L120
        gn.c = new FastKV.Builder(r625.getAbsolutePath(), "sns_micro_video_cache").build();     // Catch: Throwable -> L120
    L121:
        z30.o("Nwje\n", "Q2m5jaPP2Zc=\n", "GeekConfig_UltimateFallback", "Fg==\n", "c8HJlSTQVfc=\n");
        goto L46
    L187:
        a(r29);
    }
