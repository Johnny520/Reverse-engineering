...
public final class fs extends XC_MethodHook {
    ...
    L712:
        r10 = XposedHelpers.callMethod(r75.thisObject, "getType", new Object[0]);     // Catch: Throwable -> L587
    ...
    L106:
        ...
        goto L3
    L718:
        int r411 = gn.b("key_lucky_delay", 0);     // Catch: Throwable -> L372
    ...
    L710:
        ...
        String r12 = "key_lucky_delay";     // Catch: Throwable -> L455
        String r16 = "0";     // Catch: Throwable -> L455
    ...
    L98:
        ...
        goto L3
    L99:
        ip.o("tag", r47);     // Catch: Throwable -> L626
    ...
    L152:
        ...
        goto L3
    L154:
        r64 = "key_lucky";     // Catch: Throwable -> L92
        r70 = C0000.m2("ۣۨۨ");
        goto L3
    L155:
        ip.o("msg", r57);     // Catch: Throwable -> L626
    ...
    L353:
        ...
        goto L3
    L354:
        ip.o("msg", r62);     // Catch: Throwable -> L626
    ...
    L414:
        ...
        goto L413
    L415:
        String r1218 = "SnsAutoLike";     // Catch: Throwable -> L626
    ...
    L451:
        ...
        goto L3
    L453:
        r6 = XposedHelpers.callMethod(r75.thisObject, "getUserName", new Object[0]);     // Catch: Throwable -> L603
        r447 = r39;
        goto L443
    L457:
    ...
    L474:
        ...
        goto L417
    L478:
        if (gn.b("key_lucky_mode", 0) == 1) goto L161;
    L480:
        ip.o("tag", r48);     // Catch: Throwable -> L626
    ...
    L500:
        ...
        goto L162
    L502:
        r1220 = "SnsAutoLike";     // Catch: Throwable -> L626
        r446 = "ۨۡ۠";
        goto L438
    L505:
    ...
    L640:
        ...
        goto L3
    L642:
        ip.m("null cannot be cast to non-null type kotlin.Int", r10);     // Catch: Throwable -> L587
    ...
    L668:
        ...
        goto L3
    L670:
        ip.m("null cannot be cast to non-null type kotlin.String", r6);     // Catch: Throwable -> L603
    ...
    L30:
        ...
        Integer r06 = r4.getAsInteger("type");
        if (r06 == null) goto L93;
        int r07 = r06.intValue();
    L35:
        Integer r3 = r4.getAsInteger("sourceType");
        Integer r8 = r4.getAsInteger("localFlag");
    ...
    L45:
        ...
        r4.remove("sourceType");
        r4.remove("type");
        r4.put("localFlag", 99);
        byte[] r32 = r4.getAsByteArray("content");
        if (r32 != null) goto L211;
        Object r82 = XposedHelpers.callMethod(r14.thisObject, "rawQuery", new Object[]{"SELECT content FROM " + r5 + " WHERE " + r1, r22});
        if (r82 == null) goto L211;
        Object r010 = XposedHelpers.callMethod(r82, "moveToFirst", new Object[0]);     // Catch: Throwable -> L96
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r010);     // Catch: Throwable -> L96
        if (((Boolean) r010).booleanValue() == false) goto L210;
        Object r011 = XposedHelpers.callMethod(r82, "getBlob", new Object[]{0});     // Catch: Throwable -> L96
        if ((r011 instanceof byte[]) == false) goto L95;
        byte[] r012 = (byte[]) r011;     // Catch: Throwable -> L96
    L231:
        XposedHelpers.callMethod(r82, "close", new Object[0]);     // Catch: Throwable -> L207
    L56:
        if (r012 == null) goto L58;
        r4.put("content", vh.k(r012, r7));
        goto L58
    L95:
        r012 = null;
        goto L231
    ...
    L96:
        th = move-exception;
        XposedHelpers.callMethod(r82, "close", new Object[0]);     // Catch: Throwable -> L205
    L98:
        throw th;
    L211:
        r012 = r32;
    L58:
        ...
        ip.n("thisObject", r013);
        byte[] r33 = r4.getAsByteArray("attrBuf");
        if (r33 == null) goto L255;
        Object r12 = XposedHelpers.callMethod(r013, "rawQuery", new Object[]{"SELECT attrBuf FROM " + r5 + " WHERE " + r1, r22});     // Catch: Throwable -> L103
    ...
    L118:
        ...
        ip.m("null cannot be cast to non-null type kotlin.ByteArray", r020);     // Catch: Throwable -> L103
        r4.put("attrBuf", (byte[]) r020);     // Catch: Throwable -> L103
        return;
    L259:
        return;
    L107:
    ...
    L256:
        return;
    L215:
        Object r021 = XposedHelpers.callMethod(r12, "moveToFirst", new Object[0]);     // Catch: Throwable -> L100
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r021);     // Catch: Throwable -> L100
        if (((Boolean) r021).booleanValue() == false) goto L99;
        Object r022 = XposedHelpers.callMethod(r12, "getBlob", new Object[]{0});     // Catch: Throwable -> L100
        if ((r022 instanceof byte[]) == false) goto L99;
        r014 = (byte[]) r022;     // Catch: Throwable -> L100
    L225:
        XposedHelpers.callMethod(r12, "close", new Object[0]);     // Catch: Throwable -> L203
    L99:
        r014 = null;
    L100:
        th = move-exception;
        XposedHelpers.callMethod(r12, "close", new Object[0]);     // Catch: Throwable -> L201
    L102:
    ...
    L121:
        ...
        Integer r023 = r4.getAsInteger("commentflag");
        if (r023 != null) goto L125;
        return;
    L125:
        if (r023.intValue() != 1) goto L263;
        r4.put("commentflag", 0);
        byte[] r024 = r4.getAsByteArray("curActionBuf");
        if (r024 == null) goto L264;
        r4.put("curActionBuf", vh.e(r024, r7));
        return;
    L264:
        return;
    L263:
    ...
    L147:
        ...
        Object r17 = XposedHelpers.callMethod(r53, "rawQuery", new Object[]{"SELECT rowid, content FROM " + r26 + " WHERE " + r16, r029});
        if (r17 == null) goto L160;
        Object r030 = XposedHelpers.callMethod(r17, "moveToFirst", new Object[0]);     // Catch: Throwable -> L165
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r030);     // Catch: Throwable -> L165
        if (((Boolean) r030).booleanValue() == false) goto L159;
    L154:
        Object r031 = XposedHelpers.callMethod(r17, "getLong", new Object[]{0});     // Catch: Throwable -> L165
        ip.m("null cannot be cast to non-null type kotlin.Long", r031);     // Catch: Throwable -> L165
        long r83 = ((Long) r031).longValue();     // Catch: Throwable -> L165
        Object r032 = XposedHelpers.callMethod(r17, "getBlob", new Object[]{1});     // Catch: Throwable -> L165
    ...
    L157:
        ...
        r64.put("content", vh.k(r033, r73));     // Catch: Throwable -> L165
        r64.put("localFlag", 99);     // Catch: Throwable -> L165
        XposedHelpers.callMethod(r53, "update", new Object[]{r26, r64, "rowid=?", new String[]{String.valueOf(r83)}});     // Catch: Throwable -> L165
        Object r034 = XposedHelpers.callMethod(r17, "moveToNext", new Object[0]);     // Catch: Throwable -> L165
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r034);     // Catch: Throwable -> L165
        if (((Boolean) r034).booleanValue() == true) goto L154;
    L164:
        r033 = null;
        goto L157
    L159:
        XposedHelpers.callMethod(r17, "close", new Object[0]);     // Catch: Throwable -> L169
    L213:
        ip.o("tag", "SnsDeleteInfoHook");     // Catch: Throwable -> L171
        "e";     // Catch: Throwable -> L171
        XposedHelpers.callMethod(r17, "close", new Object[0]);     // Catch: Throwable -> L169
    L171:
        th = move-exception;
        XposedHelpers.callMethod(r17, "close", new Object[0]);     // Catch: Throwable -> L199
    L173:
        throw th;
    L160:
        r14.setResult(1);
    ...
    L175:
        ...
        Object r18 = XposedHelpers.callMethod(r53, "rawQuery", new Object[]{"SELECT rowid, curActionBuf FROM " + r26 + " WHERE " + r16, r029});
        if (r18 != null) goto L221;
    L186:
        r14.setResult(1);
        return;
    L221:
        Object r035 = XposedHelpers.callMethod(r18, "moveToFirst", new Object[0]);     // Catch: Throwable -> L188
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r035);     // Catch: Throwable -> L188
        if (((Boolean) r035).booleanValue() == false) goto L185;
    L180:
        Object r036 = XposedHelpers.callMethod(r18, "getLong", new Object[]{0});     // Catch: Throwable -> L188
        ip.m("null cannot be cast to non-null type kotlin.Long", r036);     // Catch: Throwable -> L188
        long r84 = ((Long) r036).longValue();     // Catch: Throwable -> L188
        Object r037 = XposedHelpers.callMethod(r18, "getBlob", new Object[]{1});     // Catch: Throwable -> L188
    ...
    L183:
        ...
        r65.put("curActionBuf", vh.e(r038, r73));     // Catch: Throwable -> L188
        r65.put("commentflag", 0);     // Catch: Throwable -> L188
        XposedHelpers.callMethod(r53, "update", new Object[]{r26, r65, "rowid=?", new String[]{String.valueOf(r84)}});     // Catch: Throwable -> L188
        Object r039 = XposedHelpers.callMethod(r18, "moveToNext", new Object[0]);     // Catch: Throwable -> L188
        ip.m("null cannot be cast to non-null type kotlin.Boolean", r039);     // Catch: Throwable -> L188
        if (((Boolean) r039).booleanValue() == true) goto L180;
    L187:
        r038 = null;
        goto L183
    L185:
        XposedHelpers.callMethod(r18, "close", new Object[0]);     // Catch: Throwable -> L192
    L234:
        ip.o("tag", "SnsDeleteCommentHook");     // Catch: Throwable -> L194
        "e";     // Catch: Throwable -> L194
        XposedHelpers.callMethod(r18, "close", new Object[0]);     // Catch: Throwable -> L192
    L194:
        th = move-exception;
        XposedHelpers.callMethod(r18, "close", new Object[0]);     // Catch: Throwable -> L197
    L196:
        throw th;
    L271:
        return;
