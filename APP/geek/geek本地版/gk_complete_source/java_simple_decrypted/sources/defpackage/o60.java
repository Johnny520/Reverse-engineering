...
public final class o60 implements ActionMode.Callback {
    ...
    public o60(ActionMode.Callback r1, TextView r2) {
        this.a = r1;
        this.b = r2;
        this.f = false;
    }
    ...
    public final boolean onPrepareActionMode(ActionMode r14, Menu r15) {
        ...
        this.c = r32;     // Catch: Throwable -> L7
        this.d = r32.getDeclaredMethod("removeItemAt", new Class[]{r4});     // Catch: Throwable -> L7
        this.e = true;     // Catch: Throwable -> L7
    L7:
        this.c = null;
        this.d = null;
        this.e = false;
    L56:
        if (this.e == true) goto L11;
    L13:
    ...
    L47:
        ...
        goto L52
    L11:
        if (this.c.isInstance(r15) == false) goto L13;
        r33 = this.d;     // Catch: Throwable -> L55
    L54:
        return this.a.onPrepareActionMode(r14, r15);
    }
}
