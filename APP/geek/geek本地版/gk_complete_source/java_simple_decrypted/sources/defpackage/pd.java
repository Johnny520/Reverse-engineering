...
public final /* synthetic */ class pd implements Runnable {
    ...
    L129:
        ...
        goto L28
    L130:
        r64 = r24.getName().equals("java.lang.Object");     // Catch: Throwable -> L142
    ...
    L133:
        ...
        goto L35
    L135:
        ip.n("getDeclaredFields(...)", r14);     // Catch: Throwable -> L331
    ...
    L173:
        ...
        goto L3
    L175:
        ip.n("getParameterTypes(...)", r22);     // Catch: Throwable -> L142
    ...
    L265:
        ...
        goto L3
    L267:
        XposedHelpers.callMethod(r8, "notifyDataSetChanged", new Object[0]);     // Catch: Throwable -> L142
        r231 = "ۣۧ۠";
        goto L243
    L269:
    ...
    L303:
        ...
        goto L3
    L305:
        ip.n("getMethods(...)", r20);     // Catch: Throwable -> L142
