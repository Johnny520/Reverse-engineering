...
public final /* synthetic */ class j9 implements hm {
    ...
    L367:
        ...
        if (b50.B((CharSequence) r123.b, "<", false) == true) goto L117;
        r42.setTag(2115108897, r123.b);
        o9 r15 = new o9(r42, 0, r123);
        gn r254 = gn.a;
        String r314 = "key_show_real_name";
        r254.getClass();
        if (gn.a(r314, false) == false) goto L410;
        if (r8 != 0) goto L410;
        if (b50.C(r5, "@chatroom") == false) goto L410;
    ...
    L410:
        ...
        goto L117
    L383:
        if (b50.C(r5, "@chatroom") == false) goto L367;
        Object r256 = XposedHelpers.getObjectField(r33, "field_content");     // Catch: Throwable -> L393
    ...
    L389:
        ...
        goto L367
    L405:
        if (b50.B(r257, ":", false) == false) goto L367;
        int r316 = b50.G(r257, ":", 0, false, 6);
        if (r316 <= 0) goto L367;
    ...
    L345:
        ...
        r133.setColor(Color.parseColor("#40000000"));
    ...
    L334:
        ...
        goto L332
    L324:
        if (b50.C(r5, "@chatroom") == true) goto L327;
    ...
    L258:
        int r134 = ac.p;
        gn r274 = gn.a;
        String r115 = "key_friend_bubble_theme";
        r274.getClass();
    ...
    L288:
        ...
        int r284 = -16777216;
    L490:
        XposedHelpers.callMethod(r10.e, "setTextColor", new Object[]{Integer.valueOf(r284)});     // Catch: Throwable -> L473
    L292:
        View r285 = r10.e;
    ...
    L214:
        ...
        String r1115 = "chatting_user_tv";
    L217:
        ViewGroup r913 = (ViewGroup) r220;
        String r136 = r913.getContext().getPackageName();
        int r128 = r913.getContext().getResources().getIdentifier(r1115, "id", r136);
        if (r128 == 0) goto L484;
        int r914 = r128;
    L220:
        if (r914 == 0) goto L222;
    ...
    L230:
        ...
        r129.setTextColor(-1);
        r129.setShadowLayer(3.0f, 0.0f, 1.0f, Color.parseColor("#80000000"));
    ...
    L198:
        ...
        in.k = true;
        Field r294 = XposedHelpers.findFieldIfExists(r9.getClass(), "itemView");     // Catch: Throwable -> L195
    ...
    L492:
        ...
        ip.m("null cannot be cast to non-null type kotlin.Long", r296);     // Catch: Throwable -> L188
    ...
    L147:
        ...
        String r22 = gn.d("key_geek_folder_ids", "");     // Catch: Throwable -> L22
        if (b50.H(r22) == false) goto L15;
    L13:
        ip.w = true;
        goto L7
    L15:
        List r23 = b50.M(r22, new String[]{","});     // Catch: Throwable -> L22
    ...
    L25:
        ...
        String r10 = "\u672a\u547d\u540d\u6587\u4ef6\u5939";     // Catch: Throwable -> L22
        ...
        List r25 = b50.M(r112, new String[]{","});     // Catch: Throwable -> L22
    ...
    L30:
        ...
        goto L30
    L34:
        String r26 = ab.j0(r12, ",", new tc(1), 30);     // Catch: Throwable -> L22
    ...
    L113:
        ...
        n9.a("ChatUIHook_VoiceTrigger", th);
        goto L165
    L92:
    ...
    L110:
        th = move-exception;
        n9.a("ChatUIHook_Transform", th);     // Catch: Throwable -> L113
        goto L165
    L135:
        r220 = null;
        goto L101
