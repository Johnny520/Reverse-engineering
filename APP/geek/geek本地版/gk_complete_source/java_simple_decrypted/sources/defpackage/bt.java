...
public final class bt extends WebViewClient {
    ...
    L55:
        ...
        goto L3
    L56:
        gn.h("key_mock_lng", r0);     // Catch: Exception -> L53
    ...
    L73:
        ...
        goto L67
    L75:
        r2 = r6.getQueryParameter("lat");     // Catch: Exception -> L53
    ...
    L79:
        ...
        goto L23
    L80:
        r5 = "key_mock_lat";     // Catch: Exception -> L53
    ...
    L89:
        ...
        goto L3
    L92:
        if (ip.i(r6.getQueryParameter("action"), "cancel") == false) goto L55;
    ...
    L124:
        ...
        goto L3
    L126:
        r0 = r6.getQueryParameter("lng");     // Catch: Exception -> L53
        if (C0031.m124() <= 0) goto L129;
        r112 = "ۣۤ";
        goto L67
    L132:
        if (b50.N(r13, "http://geek.callback", false) == false) goto L25;
