...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context r8, AttributeSet r9) {
        ...
        ja0.k(this, r8, r3, r9, r5, 0);
        this.a = r5.getBoolean(0, true);
        r5.recycle();
    ...
    public final void onMeasure(int r7, int r8) {
        ...
        if (r0 > this.c) goto L7;
    L9:
        this.c = r0;
        goto L11
    L7:
        if (this.b == false) goto L9;
        setStacked(false);
    L11:
        if (this.b == false) goto L13;
    L15:
        int r02 = r7;
        boolean r1 = false;
    L16:
        super.onMeasure(r02, r8);
        if (this.a == true) goto L19;
    L23:
    ...
    L46:
        WeakHashMap r06 = ja0.a;
        if (s90.d(this) == r2) goto L56;
        setMinimumHeight(r2);
        if (r8 != 0) goto L57;
        super.onMeasure(r7, r8);
        return;
