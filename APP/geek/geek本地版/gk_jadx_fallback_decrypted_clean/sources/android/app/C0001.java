...
/* JADX INFO: renamed from: android.app.۠ۨۥۨ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0001 {

    /* JADX INFO: renamed from: ۟ۦۣۢۡ, reason: not valid java name and contains not printable characters */
    public static int f1 = -185;
    ...
    /* JADX INFO: renamed from: ۣۢ۟ۤ, reason: not valid java name and contains not printable characters */
    public static int m5(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }

    /* JADX INFO: renamed from: ۣۢۤ, reason: not valid java name and contains not printable characters */
    public static java.lang.String m6(java.lang.String r8) {
            r1 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r0 = r1
    ...
    public static java.lang.String m7(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
