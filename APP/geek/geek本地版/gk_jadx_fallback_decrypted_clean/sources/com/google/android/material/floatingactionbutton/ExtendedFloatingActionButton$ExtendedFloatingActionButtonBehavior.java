...
public class ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior<T> extends defpackage.wd {
    ...
    public ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior(android.content.Context r2, android.util.AttributeSet r3) {
            r1 = this;
            r1.<init>()
            int[] r0 = defpackage.wy.f
    ...
    public final /* synthetic */ boolean a(android.view.View r1) {
            r0 = this;
