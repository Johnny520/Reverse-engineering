...
/* JADX INFO: renamed from: com.github.megatronking.stringfog.xor.۟ۨۦ۠, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0046 {

    /* JADX INFO: renamed from: ۡۢۢۨ, reason: not valid java name and contains not printable characters */
    public static int f46 = 380;

    /* JADX INFO: renamed from: ۟۟ۦۣۥ, reason: not valid java name and contains not printable characters */
    public static java.lang.String m184(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
    ...
    public static int m185() {
            r0 = -277(0xfffffffffffffeeb, float:NaN)
    ...
    public static int m186(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }

    /* JADX INFO: renamed from: ۧۨۧ۟, reason: not valid java name and contains not printable characters */
    public static java.lang.String m187(java.lang.String r8) {
            r1 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r0 = r1
