...
/* JADX INFO: renamed from: androidx.activity.ۣ۟۠ۤۢ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0010 {

    /* JADX INFO: renamed from: ۣ۟ۢۤ, reason: not valid java name and contains not printable characters */
    public static int f10 = -693;

    /* JADX INFO: renamed from: ۟۠۠ۤۥ, reason: not valid java name and contains not printable characters */
    public static int m40() {
            r0 = -769(0xfffffffffffffcff, float:NaN)
            int r1 = com.google.android.material.carousel.C0054.f54
            r0 = r0 ^ r1
            return r0
    }

    /* JADX INFO: renamed from: ۣ۟ۧۡ۠, reason: not valid java name and contains not printable characters */
    public static java.lang.String m41(java.lang.String r8) {
            r1 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r0 = r1
    ...
    public static java.lang.String m42(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
    ...
    public static int m43(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }
}
