...
/* JADX INFO: renamed from: androidx.appcompat.widget.۟ۥۥۤۦ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0014 {

    /* JADX INFO: renamed from: ۨۥ۟۟, reason: not valid java name and contains not printable characters */
    public static int f14 = -703;

    /* JADX INFO: renamed from: ۣ۟۟ۥ۠, reason: not valid java name and contains not printable characters */
    public static java.lang.String m56(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
    ...
    public static int m57(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }
    ...
    public static int m58() {
            r0 = -480(0xfffffffffffffe20, float:NaN)
    ...
    public static java.lang.String m59(java.lang.String r8) {
            r1 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r0 = r1
