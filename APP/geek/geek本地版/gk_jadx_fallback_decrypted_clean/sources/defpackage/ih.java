...
public final class ih extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    public android.graphics.drawable.Drawable a;
    public boolean b;

    public final void a(android.graphics.Canvas r2) {
            r1 = this;
    ...
    public final void c(int r2, int r3, int r4, int r5) {
            r1 = this;
            android.graphics.drawable.Drawable r0 = r1.a
            defpackage.ch.f(r0, r2, r3, r4, r5)
            return
    }
