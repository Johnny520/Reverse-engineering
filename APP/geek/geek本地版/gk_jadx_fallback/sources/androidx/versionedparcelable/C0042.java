...
public class C0042 {
    ...
    public static int m169() {
            r0 = -846(0xfffffffffffffcb2, float:NaN)
    ...
    public static int m170(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }

    /* JADX INFO: renamed from: ۣ۟۟ۦ, reason: not valid java name and contains not printable characters */
    public static java.lang.String m171(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
