...
/* JADX INFO: renamed from: androidx.versionedparcelable.۟۟۠ۥ۠, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0038 {

    /* JADX INFO: renamed from: ۡۥۤۢ, reason: not valid java name and contains not printable characters */
    public static int f38 = -367;

    /* JADX INFO: renamed from: ۟۟۠ۨۦ, reason: not valid java name and contains not printable characters */
    public static java.lang.String m152(short[] r3, int r4, int r5, int r6) {
            char[] r1 = new char[r5]
            r0 = 0
        L3:
            if (r0 >= r5) goto L10
    ...
    public static int m153(java.lang.Object r1) {
            int r0 = r1.hashCode()
            return r0
    }

    /* JADX INFO: renamed from: ۟ۦۦ۟ۡ, reason: not valid java name and contains not printable characters */
    public static java.lang.String m154(java.lang.String r8) {
            r0 = 0
            java.lang.String r3 = ""
            java.lang.String r2 = ""
            r1 = r0
