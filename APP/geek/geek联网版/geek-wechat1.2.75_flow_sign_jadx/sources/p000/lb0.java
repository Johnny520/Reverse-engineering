...
public final class lb0 {
    ...
    public static final lb0 f2979k;
    ...
    static {
        float[] fArr = AbstractC0259gf.f1964i;
        float fM1247e0 = (float) ((((double) AbstractC0259gf.m1247e0()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC0259gf.f1962g;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float fExp = (1.0f - (((float) Math.exp(((-fM1247e0) - 42.0f) / 92.0f)) * 0.2777778f)) * 1.0f;
        double d = fExp;
        if (d > 1.0d) {
            fExp = 1.0f;
        } else if (d < 0.0d) {
        ...
        float f10 = 1.0f / ((5.0f * fM1247e0) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) fM1247e0) * 5.0d))) + (f11 * fM1247e0);
        float fM1247e02 = AbstractC0259gf.m1247e0() / fArr[1];
        double d2 = fM1247e02;
        ...
        f2979k = new lb0(fM1247e02, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public lb0(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f2985f = f;
        this.f2980a = f2;
        this.f2981b = f3;
        this.f2982c = f4;
