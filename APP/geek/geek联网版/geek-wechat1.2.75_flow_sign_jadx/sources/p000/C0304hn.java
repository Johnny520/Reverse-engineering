...
public final class C0304hn implements Application.ActivityLifecycleCallbacks {
    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        while (true) {
            switch (iM2975) {
                case 1748765:
                    AbstractC0493mp.m1857g(b50.m492a("I/X/\n", "QpaLzcS1lRI=\n"), activity);
    ...
    public final void onActivityDestroyed(Activity activity) {
        ...
        while (true) {
            switch (iM3057) {
                case 1746813:
                    AbstractC0493mp.m1857g(b50.m492a("vi4o\n", "301cFZZ89FU=\n"), activity);
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        while (true) {
            switch (iM2981) {
                case 1746781:
                    AbstractC0493mp.m1857g(b50.m492a("vEhe\n", "3SsqG2nUei8=\n"), activity);
                    if (C1037.f5684 > 0) {
    ...
    */
    ...
    public final void onActivityStarted(Activity activity) {
        ...
        while (true) {
            switch (iM2993) {
                case 1751653:
                    AbstractC0493mp.m1857g(b50.m492a("rbWt\n", "zNbZpY2oCMw=\n"), activity);
                    str = "ۦۢۢ";
        ...
        while (true) {
            switch (iM2856) {
                ...
                case 1751713:
                    ...
                    break;
                case 1752485:
                    AbstractC0493mp.m1857g(b50.m492a("vSL2\n", "3EGCxKw0OyY=\n"), activity);
                    if (C1054.m3124() < 0) {
