...
public class C0766u2 extends AutoCompleteTextView {

    /* JADX INFO: renamed from: d */
    public static final int[] f4604d = {R.attr.popupBackground};

    /* JADX INFO: renamed from: a */
    public final C0803v2 f4605a;

    /* JADX INFO: renamed from: b */
    public final C0139d5 f4606b;

    /* JADX INFO: renamed from: c */
    public final C0138d4 f4607c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0766u2(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, com.ljx.wechatmod.R.attr.autoCompleteTextViewStyle);
        d70.m881a(context);
        x60.m2635a(this, getContext());
        C0658r5 c0658r5M2226y = C0658r5.m2226y(getContext(), attributeSet, f4604d, com.ljx.wechatmod.R.attr.autoCompleteTextViewStyle);
    ...
    public final void drawableStateChanged() {
        ...
        C0803v2 c0803v2 = this.f4605a;
        if (c0803v2 != null) {
            c0803v2.m2533a();
        }
        C0139d5 c0139d5 = this.f4606b;
        if (c0139d5 != null) {
            c0139d5.m870b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f4606b.m871d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f4606b.m872e();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f4607c.m831C(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f4607c.m860u(keyListener));
    }
