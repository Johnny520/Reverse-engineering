...
public final class z20 {
        ...
        while (true) {
            switch (iM3002) {
                ...
                case 56444:
                    ...
                    break;
                case 1749818:
                    b50.m492a("mf1yIYbAH5yt/mcRlNwZhZXHbhCB2hGFkf0=\n", "8pgLfvWocOs=\n");
    ...
    public static void m2784a(final Activity activity) {
        ...
        String str15;
        String str16;
        AbstractC0493mp.m1857g(b50.m492a("RarX\n", "JMmjVY0KLbg=\n"), activity);
        C0417kn c0417kn = C0417kn.f2847a;
        String strM492a = b50.m492a("+rIrdSA2FV3Ouj1OIQ==\n", "kddSKkRXZzY=\n");
        c0417kn.getClass();
        ...
        char c = C0417kn.m1691b(b50.m492a("jpiQRT213euEhIZvPIPx85yRjA==\n", "5f3pGkjcgoc=\n"), 0) >= 1 ? (char) 1 : (char) 0;
        String[] strArr = AbstractC0750tn.f4567a;
        b50.m492a("3DY02aJ5zA==\n", "v1larccBuOo=\n");
        int i3 = c >= 1 ? 1 : 0;
        try {
            color = Color.parseColor(C0417kn.m1693d(b50.m492a("cLkC6zE3H/x0sSTVMSEJ5m+DGNs+LR4=\n", "G9x7tFJCbIg=\n"), b50.m492a("7A5kHnUBmw==\n", "zz5UX0FH3U8=\n")));
        } catch (Exception e) {
            g40.m1152o("06ke\n", "p8h5VTpLcuY=\n", b50.m492a("R0lmOhXS4GFrX3A6BNXqUH1sTyk=\n", "EgAgW3amjxM=\n"), "tw==\n", "0vI8ySRxU5w=\n");
            color = Color.parseColor(b50.m492a("k9sxLQjeHA==\n", "sOsBbDyYWps=\n"));
        }
        if (!g40.m1154q("HB9w6Fkoe+MaE2roXj557QU=\n", "d3oJtz1RFYI=\n", C0417kn.f2847a) || Build.VERSION.SDK_INT < 31) {
            ...
            try {
                ...
                g40.m1152o("06ke\n", "p8h5VTpLcuY=\n", b50.m492a("3Ja7OYjfMlXwgK4hmOgyS+at\n", "id/9WOurXSc=\n"), "tw==\n", "0vI8ySRxU5w=\n");
                color2 = color;
            }
        }
        C0417kn c0417kn2 = C0417kn.f2847a;
        String strM492a2 = b50.m492a("kFDg8Uksgh6kXPrBVDc=\n", "+zWZrjpE7Wk=\n");
        c0417kn2.getClass();
        boolean zM1690a = C0417kn.m1690a(strM492a2, true);
        boolean zM1690a2 = C0417kn.m1690a(b50.m492a("0nEBglDppvzmYBGzTdWo8dpxFqk=\n", "uRR43TmKyZI=\n"), false);
        ...
        if (c0713sn2 != null) {
            ...
            if (i3 == 1) {
                ...
                iArgb = z ? Color.argb(160, 255, 255, 255) : Color.parseColor(b50.m492a("JNiKHWJ1Lg==\n", "B+DPJSdMHSg=\n"));
                i = color7;
            }
        ...
        b50.m492a("hhksm6l/\n", "4nBN98YYP68=\n");
        b50.m492a("U945KWo=\n", "J7ZcRA8QIiI=\n");
        b50.m492a("NljZKikEp/M0XsUqGA==\n", "VTerT2pryYc=\n");
        b50.m492a("mgoRdVzAP/2YCx5kbQ==\n", "+WJwAR+vUYk=\n");
        b50.m492a("QWinu50xLPFDfZSxkjcs9k59pQ==\n", "IBjX3vxDTZ8=\n");
        b50.m492a("QUu+0JJn1pNeV6PHmmrKog==\n", "MTnXpvMEr9A=\n");
        final int i13 = 0;
        C0075bo.m524a(activity, linearLayoutM1144g2, g80.m1193h(b50.m492a("xEHZ/n5fa5bFFdyoel5vksJB3a97CWyT\n", "piK/zBg9CfA=\n")), c0713sn, new InterfaceC0786um(activity, c0713sn, dialog, i13) { // from class: a30
        ...
        final int i14 = 1;
        C0075bo.m524a(activity, linearLayoutM1144g2, g80.m1193h(b50.m492a("zL78h3fph5nL6P7fcL2ByMro+NR074PL\n", "rt2a5hLb5f8=\n")), c0713sn, new InterfaceC0786um(activity, c0713sn, i14) { // from class: f30
        ...
        final int i15 = 4;
        C0075bo.m524a(activity, linearLayoutM1144g2, g80.m1193h(b50.m492a("3vejFuowgo3Y9aAR7DOF2djxpEToYoPf3qOlQ+ph\n", "vMXGIo5W4Os=\n")), c0713sn, new InterfaceC0786um
