...
/* JADX INFO: renamed from: ۤۤۥۤ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1058 {

    /* JADX INFO: renamed from: ۣ۟۠ۧۢ, reason: not valid java name and contains not printable characters */
    public static int f5705 = -200;

    /* JADX INFO: renamed from: ۣ۟ۡۢۦ, reason: not valid java name and contains not printable characters */
    public static int m3140(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۟ۤ۠, reason: not valid java name and contains not printable characters */
    public static int m3141() {
        return 900 ^ C1041.f5688;
    }

    /* JADX INFO: renamed from: ۥۧۤۡ, reason: contains not printable characters */
    public static String m3143(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m3142(short[] sArr, int i, int i2, int i3) {
