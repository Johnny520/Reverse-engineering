...
import p000.RunnableC0746tj;
import p000.RunnableC0783uj;
import p000.g40;
...
public final class FastKV extends AbsFastKV {
    ...
    public FastKV(String str, String str2, FastEncoder[] fastEncoderArr, FastCipher fastCipher, int i) {
        ...
        synchronized (this.data) {
            FastKVConfig.getExecutor().execute(new RunnableC0783uj(this, 1));
    ...
    private void clearDeletedFiles() {
        ...
        while (it.hasNext()) {
            FastKVConfig.getExecutor().execute(new RunnableC0746tj(this, it.next(), 2));
        }
    ...
    private boolean commitToCFile() {
        ...
        if (i == 1) {
            this.applyExecutor.execute(new RunnableC0783uj(this, 0));
            return true;
        }
        if (i == 2) {
            return writeToCFile();
    ...
    private boolean isABFileEqual() {
        ...
        this.bBuffer.rewind();
        this.bBuffer.get(fastBuffer.f2561hb, 0, this.dataEnd);
        byte[] bArr = this.fastBuffer.f2561hb;
        byte[] bArr2 = fastBuffer.f2561hb;
    ...
    private void loadFromABFile() {
        File file = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".kva"));
        File file2 = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".kvb"));
        try {
            if (Utils.makeFileIfNotExist(file) && Utils.makeFileIfNotExist(file2)) {
                ...
                try {
                    ...
                    if (iUnpackSize >= 0 && iUnpackSize <= length - 12) {
                        ...
                        this.aBuffer.rewind();
                        this.aBuffer.get(this.fastBuffer.f2561hb, 0, this.dataEnd);
                    ...
                    if (iUnpackSize2 >= 0 && iUnpackSize2 <= length2 - 12) {
                        ...
                        if (this.fastBuffer.f2561hb.length != this.bBuffer.capacity()) {
                            this.fastBuffer = new FastBuffer(this.bBuffer.capacity());
                        }
                        this.bBuffer.rewind();
                        this.bBuffer.get(this.fastBuffer.f2561hb, 0, this.dataEnd);
    ...
    private boolean loadFromCFile() {
        File file = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".kvc"));
        File file2 = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".tmp"));
        boolean z = false;
        try {
            if (!file.exists()) {
    ...
    private void syncToABBuffer(MappedByteBuffer mappedByteBuffer) {
        ...
        if (i != 0) {
            mappedByteBuffer.put(i, this.fastBuffer.f2561hb[i]);
        }
        if (this.updateSize != 0) {
            mappedByteBuffer.position(this.updateStart);
            mappedByteBuffer.put(this.fastBuffer.f2561hb, this.updateStart, this.updateSize);
        }
    }
    ...
    private boolean writeToABFile(FastBuffer fastBuffer) {
        int length = fastBuffer.f2561hb.length;
        File file = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".kva"));
        File file2 = new File(this.path, g40.m1149l(new StringBuilder(), this.name, ".kvb"));
        try {
            if (!Utils.makeFileIfNotExist(file) || !Utils.makeFileIfNotExist(file2)) {
            ...
            ByteOrder byteOrder = ByteOrder.LITTLE_ENDIAN;
            map.order(byteOrder);
            this.aBuffer.put(fastBuffer.f2561hb, 0, this.dataEnd);
            RandomAccessFile randomAccessFile2 = new RandomAccessFile(file2, "rw");
            ...
            this.bBuffer = map2;
            map2.order(byteOrder);
            this.bBuffer.put(fastBuffer.f2561hb, 0, this.dataEnd);
            return true;
        } catch (Exception e) {
            error(e);
            return false;
    ...
    public synchronized boolean writeToCFile() {
        try {
            ...
            if (Utils.saveBytes(file, this.fastBuffer.f2561hb, this.dataEnd)) {
    ...
    */
    ...
    public void ensureSize(int i) {
        int length = this.fastBuffer.f2561hb.length;
        ...
        if (i2 >= length) {
            ...
            System.arraycopy(this.fastBuffer.f2561hb, 0, bArr, 0, this.dataEnd);
            this.fastBuffer.f2561hb = bArr;
            if (this.writingMode == 0) {
                try {
                    FileChannel fileChannel = this.aChannel;
                    FileChannel.MapMode mapMode = FileChannel.MapMode.READ_WRITE;
    ...
    public synchronized SharedPreferences.Editor remove(String str) {
        try {
            ...
            if (baseContainer != null) {
                ...
                if (str2 != null) {
                    if (this.writingMode == 0) {
                        FastKVConfig.getExecutor().execute(new RunnableC0746tj(this, str2, 1));
                    } else {
    ...
    public void removeOldFile(String str) {
        if (this.writingMode == 0) {
            FastKVConfig.getExecutor().execute(new RunnableC0746tj(this, str, 0));
        } else {
    ...
    public void syncCompatBuffer(int i, int i2, int i3) {
        ...
        if (this.writingMode == 0) {
            ...
            this.aBuffer.put(this.fastBuffer.f2561hb, i, i3);
            this.aBuffer.putInt(0, iPackSize);
            this.bBuffer.putInt(0, iPackSize);
            this.bBuffer.putLong(4, this.checksum);
            this.bBuffer.position(i);
            this.bBuffer.put(this.fastBuffer.f2561hb, i, i3);
        } else {
            this.fastBuffer.putInt(0, iPackSize);
            this.fastBuffer.putLong(4, this.checksum);
        }
        int i4 = this.dataEnd + i2;
        if (this.fastBuffer.f2561hb.length - i4 > AbsFastKV.TRUNCATE_THRESHOLD) {
            truncate(i4);
        }
    }
