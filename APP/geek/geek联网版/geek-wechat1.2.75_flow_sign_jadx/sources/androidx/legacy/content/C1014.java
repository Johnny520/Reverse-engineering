...
/* JADX INFO: renamed from: androidx.legacy.content.ۨ۠ۦۥ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1014 {

    /* JADX INFO: renamed from: ۟۠ۥۢۡ, reason: not valid java name and contains not printable characters */
    public static int f5661 = 182;
    ...
    public static int m2968() {
        return (-468) ^ C1041.f5688;
    }

    /* JADX INFO: renamed from: ۦۥۡۨ, reason: contains not printable characters */
    ...
    public static String m2966(short[] sArr, int i, int i2, int i3) {
