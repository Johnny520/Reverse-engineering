...
public class AlertDialogLayout extends AbstractC0902xq {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* JADX INFO: renamed from: j */
    public static int m151j(View view) {
        WeakHashMap weakHashMap = oa0.f3426a;
        int iM2656d = x90.m2656d(view);
        if (iM2656d > 0) {
            return iM2656d;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m151j(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            wq r6 = (p000.C0865wq) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
            java.util.WeakHashMap r8 = p000.oa0.f3426a
            int r8 = p000.y90.m2732d(r9)
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM151j = m151j(view2);
            measuredHeight = view2.getMeasuredHeight() - iM151j;
            paddingBottom += iM151j;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM151j;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM151j += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM151j, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0865wq).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c0865wq).height;
                        ((LinearLayout.LayoutParams) c0865wq).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c0865wq).height = i9;
                    }
                }
                i8++;
