...
/* JADX INFO: renamed from: androidx.core.app.ۡۤۡ۠, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1005 {

    /* JADX INFO: renamed from: ۡ۟ۦ, reason: not valid java name and contains not printable characters */
    public static int f5652 = -590;

    /* JADX INFO: renamed from: ۣ۟ۡۧ۟, reason: not valid java name and contains not printable characters */
    public static String m2930(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
