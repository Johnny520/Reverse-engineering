...
public final class MainActivity extends Activity {
    ...
    */
    ...
    public static final void initSukiStyleUI$lambda$24$lambda$23(TextView textView, int i) {
        textView.getPaint().setShader(new LinearGradient(0.0f, 0.0f, textView.getPaint().measureText(textView.getText().toString()), textView.getTextSize() * 1.5f, new int[]{i, Color.parseColor(b50.m492a("lk21D2k+iQ==\n", "tQmAN1p4z04=\n"))}, (float[]) null, Shader.TileMode.CLAMP));
        textView.invalidate();
    }
    ...
    public static final void initSukiStyleUI$lambda$46$lambda$45(MainActivity mainActivity, View view) {
        try {
            ...
            intent.setComponent(new ComponentName(b50.m492a("sEjTqyhxUlC2ScqrMXk=\n", "0ye+hVwUPDM=\n"), b50.m492a("wTVBVaAPGSbHNFhVuQdZMMt0YBqhBBQtxyh5Mg==\n", "olose9Rqd0U=\n")));
            intent.setFlags(335544320);
            mainActivity.startActivity(intent);
        } catch (Exception unused) {
            mainActivity.showCapsuleToast(b50.m492a("wE3m8sHhhOKtNMSkh9/Ms5lwpKvyicPbwV/j8cDi\n", "JtFMFGJhYlc=\n"), true);
        }
    }
    ...
    private final void showCapsuleToast(String str, boolean z) {
        ...
        if (i >= 28) {
            linearLayout.setOutlineAmbientShadowColor(Color.parseColor(b50.m492a("+iMcmzRW1w==\n", "2RMsqwRm580=\n")));
            if (z) {
                str10 = "/hXCwWPdU+Dt\n";
                str11 = "3SbxhyXuEdM=\n";
            } else {
        ...
        textView.setTypeface(Typeface.create(b50.m492a("JQl2TKQhr2I/DjVS7DajZTs=\n", "VmgYP4lSyhA=\n"), 0), 1);
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 30 && !Environment.isExternalStorageManager()) {
                showCapsuleToast(b50.m492a("UOp1cyRF/8M5kGkSZFKergLAHTU9LY7kX+t2chtU/fEcn3IRZFCnrwXjEwgMLKzOX8xl\n", "uXb1m4LEGUo=\n"), true);
                Intent intent = new Intent(b50.m492a("6NTZIhQ4Wf3638kkEj9aoKf3/B46FniMyOrtDzodcYzP8/EVKA58kMr/7gMkAXiBxPPuAzIecw==\n", "ibq9UHtRPdM=\n"));
            ...
            textView.setTextColor(Color.parseColor(b50.m492a("2xJi/FXCbQ==\n", "+FQkyWf3X6Q=\n")));
