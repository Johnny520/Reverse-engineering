...
/* JADX INFO: renamed from: com.ljx.wechatmod.hook.۟ۥ۠۟ۥ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1048 {

    /* JADX INFO: renamed from: ۣ۠ۤۥ, reason: not valid java name and contains not printable characters */
    public static int f5695 = -30;

    /* JADX INFO: renamed from: ۟۠ۢۥۥ, reason: not valid java name and contains not printable characters */
    public static int m3101(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۟ۧ۠ۧۢ, reason: not valid java name and contains not printable characters */
    public static int m3102() {
        return (-1019) ^ C1041.f5688;
    }
    ...
    public static String m3100(short[] sArr, int i, int i2, int i3) {
