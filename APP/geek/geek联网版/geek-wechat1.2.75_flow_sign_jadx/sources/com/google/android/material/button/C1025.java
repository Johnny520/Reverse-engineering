...
/* JADX INFO: renamed from: com.google.android.material.button.ۥۤ۠, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1025 {

    /* JADX INFO: renamed from: ۣ۠ۤۤ, reason: not valid java name and contains not printable characters */
    public static int f5672 = -583;

    /* JADX INFO: renamed from: ۠۠ۨۢ, reason: not valid java name and contains not printable characters */
    public static int m3010() {
        return 637 ^ C1047.f5694;
    }

    /* JADX INFO: renamed from: ۢۥۥۢ, reason: not valid java name and contains not printable characters */
    public static int m3011(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۧ۠۠ۦ, reason: not valid java name and contains not printable characters */
    public static String m3012(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m3013(short[] sArr, int i, int i2, int i3) {
