...
public class C1046 {
    ...
    public static int m3094() {
        return (-330) ^ C1047.f5694;
    }
    ...
    public static String m3093(short[] sArr, int i, int i2, int i3) {
