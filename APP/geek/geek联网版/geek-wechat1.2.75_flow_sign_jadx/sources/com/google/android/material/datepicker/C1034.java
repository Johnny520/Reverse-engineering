...
public class C1034 {
    ...
    public static int m3049() {
        return (-298) ^ C1027.f5674;
    }

    /* JADX INFO: renamed from: ۟ۢۧۡ, reason: not valid java name and contains not printable characters */
    public static String m3048(short[] sArr, int i, int i2, int i3) {
