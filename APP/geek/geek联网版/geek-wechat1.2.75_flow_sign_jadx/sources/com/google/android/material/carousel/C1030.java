...
/* JADX INFO: renamed from: com.google.android.material.carousel.ۦۥۥۨ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1030 {

    /* JADX INFO: renamed from: ۟ۦ۟ۨۢ, reason: not valid java name and contains not printable characters */
    public static int f5677 = 413;

    /* JADX INFO: renamed from: ۟۟ۡ۟ۡ, reason: not valid java name and contains not printable characters */
    public static String m3030(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
