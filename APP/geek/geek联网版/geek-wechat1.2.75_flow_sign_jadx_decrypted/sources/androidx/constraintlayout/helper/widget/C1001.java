...
public class C1001 {
    ...
    public static int m2916() {
        return 312 ^ C1053.f5700;
    }

    /* JADX INFO: renamed from: ۣۣۥۤ, reason: not valid java name and contains not printable characters */
    public static String m2917(short[] sArr, int i, int i2, int i3) {
