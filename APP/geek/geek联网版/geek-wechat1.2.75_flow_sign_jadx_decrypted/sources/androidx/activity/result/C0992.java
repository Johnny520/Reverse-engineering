...
/* JADX INFO: renamed from: androidx.activity.result.۟۠۟۠ۦ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0992 {

    /* JADX INFO: renamed from: ۡۧ۠ۦ, reason: not valid java name and contains not printable characters */
    public static int f5639 = -788;

    /* JADX INFO: renamed from: ۟ۢۡ۠, reason: not valid java name and contains not printable characters */
    public static int m2879() {
        return 545 ^ C1035.f5682;
    }

    /* JADX INFO: renamed from: ۢۡۥۧ, reason: not valid java name and contains not printable characters */
    public static String m2880(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m2878(short[] sArr, int i, int i2, int i3) {
