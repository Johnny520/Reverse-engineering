...
public abstract class AbstractC0387ju implements db0 {
    ...
    public static String m1622j(String str) {
        "base64Str";
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(m1625n(), "AES");
            Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
            cipher.init(2, secretKeySpec);
            byte[] bArrDoFinal = cipher.doFinal(Base64.decode(str, 2));
            AbstractC0493mp.m1856f("doFinal(...)", bArrDoFinal);
    ...
    public static String m1623k(String str) {
        AbstractC0493mp.m1857g("content", str);
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(m1625n(), "AES");
            Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
            cipher.init(1, secretKeySpec);
            byte[] bytes = str.getBytes(AbstractC0514n9.f3251a);
            AbstractC0493mp.m1856f("getBytes(...)", bytes);
    ...
    public static boolean m1624m(String str) {
        AbstractC0493mp.m1857g("key", str);
        try {
    ...
    public static byte[] m1625n() {
        ...
        byte[] bytes = (strM2441c.length() == 8 ? g40.m1146i("G3eK_m0D", strM2441c) : "0000000000000000").getBytes(AbstractC0514n9.f3251a);
        AbstractC0493mp.m1856f("getBytes(...)", bytes);
        return bytes;
    }
    ...
    public static void m1629t(Activity activity, Object obj, String str) {
        ...
        try {
            ...
            for (String str4 : ub0.f4697I0) {
                ...
                if (clsFindClassIfExists2 != null) {
                    try {
                        ...
                        AbstractC0493mp.m1857g("tag", "EmojiRepeat_Locate_Failed for class: " + str4);
                        "e";
                    }
                }
            }
            if (objCallStaticMethod2 == null) {
                ...
                String strM492a2 = "\u8868\u60c5\u4e2d\u65ad: \u65e0\u6cd5\u83b7\u53d6\u8868\u60c5\u5206\u53d1 API";
                c0417kn2.getClass();
            ...
            try {
                ...
                AbstractC0493mp.m1857g("tag", "EmojiRepeat_Inst_Failed for method: " + str5);
                "e";
            }
            if (objCallStaticMethod == null) {
                C0417kn c0417kn3 = C0417kn.f2847a;
                String strM492a3 = "\u8868\u60c5\u4e2d\u65ad: \u65e0\u6cd5\u83b7\u53d6 EmojiStorage \u670d\u52a1";
                c0417kn3.getClass();
            ...
            try {
                ...
                AbstractC0493mp.m1857g("tag", "EmojiRepeat_Invoke_Failed for targetNh: " + str6 + ", md5: " + strGroup);
                "e";
            }
        } catch (Throwable th) {
