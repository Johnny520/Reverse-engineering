...
public final class e80 {
    ...
    /* JADX INFO: renamed from: a */
    public final void m971a(double d, double d2, long j) {
        ...
        if (dSin3 >= 1.0d) {
            ...
            this.f1532a = Math.round((dSin2 + dAcos) * 8.64E7d) + 946728000000L;
            long jRound = Math.round((dSin2 - dAcos) * 8.64E7d) + 946728000000L;
            this.f1533b = jRound;
            if (jRound >= j || this.f1532a <= j) {
                this.f1534c = 1;
            } else {
                this.f1534c = 0;
            }
