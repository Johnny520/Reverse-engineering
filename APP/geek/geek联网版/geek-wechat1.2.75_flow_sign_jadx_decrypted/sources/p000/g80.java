...
public abstract class g80 {
    ...
    */
    ...
    public static void m1179J(Activity activity, Dialog dialog, C0713sn c0713sn) {
        ...
        AbstractC0493mp.m1857g("theme", c0713sn);
        ...
        C0075bo.m524a(activity, linearLayout, "\u7ed3\u6784\u4e0e\u5f62\u6001", c0713sn, new C0488mk(activity, c0713sn, dialog2, dialog, 2));
        C0075bo.m524a(activity, linearLayout, "\u72ec\u7acb\u8272\u5f69\u6307\u6d3e", c0713sn, new C0488mk(activity, c0713sn, dialog2, dialog, 3));
        C0075bo.m524a(activity, linearLayout, "\u89c6\u89c9\u7cbe\u4fee", c0713sn, new C0488mk(activity, c0713sn, dialog2, dialog, 4));
    ...
    public static final void m1180K(C0713sn c0713sn, p00 p00Var, View view, TextView textView, TextView textView2, String str, ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            AbstractC0493mp.m1855e("null cannot be cast to non-null type kotlin.String", tag);
            String strM492a = (String) tag;
            boolean zEquals = strM492a.equals(p00Var.f3560b);
            View childAt = linearLayout.getChildAt(0);
            AbstractC0493mp.m1855e("null cannot be cast to non-null type android.widget.FrameLayout", childAt);
            FrameLayout frameLayout = (FrameLayout) childAt;
            View childAt2 = frameLayout.getChildAt(0);
            AbstractC0493mp.m1855e("null cannot be cast to non-null type com.ljx.wechatmod.ui.dialog.FloatingBarSettingsDialog.showVisualColorPicker.MiniSwatchView", childAt2);
            C0673rk c0673rk = (C0673rk) childAt2;
            View childAt3 = linearLayout.getChildAt(1);
            AbstractC0493mp.m1855e("null cannot be cast to non-null type android.widget.TextView", childAt3);
            TextView textView3 = (TextView) childAt3;
            c0673rk.setSelectedTheme(zEquals);
            c0673rk.invalidate();
            Drawable background = frameLayout.getBackground();
            AbstractC0493mp.m1855e("null cannot be cast to non-null type android.graphics.drawable.GradientDrawable", background);
            ...
            if (zEquals) {
                if (strM492a.equals("#FFFFFF") && !c0713sn.f4355p) {
                    strM492a = "#000000";
                }
    ...
    */
    ...
    public static String m1193h(String str) {
        AbstractC0493mp.m1857g("hexStr", str);
        if (str.length() == 0) {
            return "";
        }
    ...
    public static int m1201p(Activity activity) {
        ...
        String strM492a = "key_custom_accent_color";
        c0417kn.getClass();
