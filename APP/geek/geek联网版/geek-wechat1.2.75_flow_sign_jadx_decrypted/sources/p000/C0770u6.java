        ...
        while (true) {
            switch (iM2911) {
                ...
                case 1748857:
                    ...
                    break;
                case 1749796:
                    f4643f = "";
        ...
        while (true) {
            switch (iM3025) {
                ...
                case 1746909:
                    ...
                    break;
                case 1747684:
                    publicKeyGeneratePublic = KeyFactory.getInstance("RSA").generatePublic(x509EncodedKeySpec);
                ...
                case 1750756:
                    ...
                    break;
                case 1750813:
                    AbstractC0493mp.m1856f("getBytes(...)", bArr3);
    ...
    */
    ...
    public static void m2442d(Application application) {
        ...
        while (true) {
            switch (iM3101) {
                case 56512:
                    f4639b = application.getSharedPreferences("mod_auth_engine_v5", 0);
                ...
                case 1752547:
                    try {
                        string = application.getSharedPreferences("com.tencent.mm_preferences", 0).getString("login_weixin_username", "");
                        str5 = "ۥ۠ۧ";
                        iM3101 = C1018.m2984(str5);
                    } catch (Throwable th) {
                        strM492a2 = "UNKNOWN_WXID";
