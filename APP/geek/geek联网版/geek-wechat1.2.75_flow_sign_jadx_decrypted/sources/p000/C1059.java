...
/* JADX INFO: renamed from: ۤۨۤۨ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C1059 {

    /* JADX INFO: renamed from: ۟۠ۤۦۨ, reason: not valid java name and contains not printable characters */
    public static int f5706 = -232;

    /* JADX INFO: renamed from: ۟ۢۦۣۢ, reason: not valid java name and contains not printable characters */
    public static int m3144() {
        return (-313) ^ C0989.f5636;
    }
    ...
    public static String m3146(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static String m3147(short[] sArr, int i, int i2, int i3) {
