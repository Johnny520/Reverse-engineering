...
public abstract class AbstractC0133d implements Parcelable {
    ...
    public final Parcelable f1274a;

    /* JADX INFO: renamed from: b */
    public static final C0050b f1273b = new C0050b();
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeParcelable(this.f1274a, i);
    }

    public AbstractC0133d(Parcelable parcelable) {
        if (parcelable != null) {
            this.f1274a = parcelable == f1273b ? null : parcelable;
            return;
        }
    ...
    public AbstractC0133d(Parcel parcel, ClassLoader classLoader) {
        ...
        this.f1274a = parcelable == null ? f1273b : parcelable;
    }
}
