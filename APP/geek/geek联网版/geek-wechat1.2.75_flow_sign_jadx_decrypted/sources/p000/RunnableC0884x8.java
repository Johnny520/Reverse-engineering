    ...
    public final void run() {
        ...
        switch (this.f5222a) {
            ...
            case 7:
                ...
                p00 p00Var = new p00();
                View viewFindViewWithTag = viewGroup.findViewWithTag("geek_lucky_toast");
                p00Var.f3560b = viewFindViewWithTag;
                if (viewFindViewWithTag == null) {
                    LinearLayout linearLayout = new LinearLayout(activity2);
                    linearLayout.setTag("geek_lucky_toast");
                    ...
                    gradientDrawable.setColor(Color.parseColor("#E6111111"));
                    gradientDrawable.setCornerRadius(AbstractC0493mp.m1866p(100.0f));
                    gradientDrawable.setStroke(AbstractC0493mp.m1867q(1), Color.parseColor("#33FF3B30"));
                    ...
                    if (i4 >= 28) {
                        ...
                        linearLayout.setOutlineSpotShadowColor(Color.parseColor("#66FF3B30"));
                    }
                    ...
                    textView2.setTag("lucky_toast_text_view");
                    textView2.setTextSize(13.5f);
                    textView2.setTextColor(Color.parseColor("#FFFFFF"));
                    textView2.setTypeface(Typeface.create("sans-serif-medium", 0), 1);
                ...
                TextView textView3 = (TextView) ((LinearLayout) p00Var.f3560b).findViewWithTag("lucky_toast_text_view");
                if (textView3 != null) {
