    ...
    public void afterHookedMethod(XC_MethodHook.MethodHookParam methodHookParam) {
        ...
        switch (this.f5061a) {
            case Base64.NO_PADDING /* 1 */:
                ...
                AbstractC0493mp.m1857g("p", methodHookParam);
                Object obj = methodHookParam.thisObject;
                AbstractC0493mp.m1855e("null cannot be cast to non-null type android.app.Activity", obj);
                ...
                if (viewGroup != null) {
                    ...
                    if (g40.m1154q("tUlKKr5TQBuqc0Yc\n", "3iwzdd07JXo=\n", c0417kn) && (i50.m1475z(name, "LauncherUI", false) || i50.m1475z(name, "ChattingUI", false))) {
                    ...
                    if (i50.m1475z(name, "LauncherUI", false)) {
                        if (C0417kn.m1694e("key_floating_settings")) {
                            g40.m1152o("bdYc\n", "Gbd7MCENE9g=\n", "SetBtn", "MI5Od4o=\n", "UuIhFOEuZWs=\n");
                            try {
                                C0893xh.m2684d(viewGroup, activity, "geek_settings_btn", "\u2699\ufe0f", 300, new p80(activity, 0));
                            } catch (Throwable th2) {
                                "tag";
                                "e";
                            }
                    ...
                    if (i50.m1475z(name, "LauncherUI", false) || i50.m1475z(name, "ChattingUI", false)) {
                        String strM492a = "key_cheat_mode";
                        AbstractC0493mp.m1857g("key", strM492a);
                        try {
                            c0417kn.getClass();
                        ...
                        if (C0417kn.m1694e("key_cheat_ui") && iIntValue == 0) {
                            C0417kn.m1699j("CheatBtn", new C0610pv(viewGroup, 2, activity));
                        } else {
                    ...
                    if (i50.m1475z(name, "ChattingUI", false)) {
                ...
                if (dialog != null) {
                    ...
                    if (!(i != 0)) {
                        ...
                        if (window2 != null && (decorView = window2.getDecorView()) != null) {
                            ...
                            AbstractC0493mp.m1856f("toLowerCase(...)", lowerCase3);
                            if (decorView.getId() != -1) {
                                String resourceEntryName = decorView.getContext().getResources().getResourceEntryName(decorView.getId());
                                AbstractC0493mp.m1856f("getResourceEntryName(...)", resourceEntryName);
                                lowerCase = resourceEntryName.toLowerCase(locale);
                                AbstractC0493mp.m1856f("toLowerCase(...)", lowerCase);
                            } else {
                                lowerCase = "";
                            }
                            if (!i50.m1475z(lowerCase3, "voice", false) && !i50.m1475z(lowerCase3, "mic", false) && !i50.m1475z(lowerCase3, "record", false) && !i50.m1475z(lowerCase, "voice", false) && !i50.m1475z(lowerCase, "mic", false) && !i50.m1475z(lowerCase, "record", false) && !i50.m1475z(lowerCase, "rcd", false)) {
                        ...
                        if (g40.m1154q("aDQvRdg0x9RzDjR23Snozm0=\n", "A1FWGqhbt6E=\n", C0417kn.f2847a) && Build.VERSION.SDK_INT >= 31) {
                            try {
                                ...
                                if (window3 != null && (iM1691b = C0417kn.m1691b("key_popup_blur_intensity", 100)) > 0) {
            ...
            case 3:
                ...
                if (popupWindow != null && (contentView = popupWindow.getContentView()) != null) {
                    if (popupWindow.isFocusable() || popupWindow.isOutsideTouchable()) {
                        ...
                        AbstractC0493mp.m1856f("toLowerCase(...)", lowerCase4);
                        if (contentView.getId() != -1) {
                            ...
                            AbstractC0493mp.m1856f("getResourceEntryName(...)", resourceEntryName2);
                            lowerCase2 = resourceEntryName2.toLowerCase(locale2);
                            AbstractC0493mp.m1856f("toLowerCase(...)", lowerCase2);
                        } else {
                            lowerCase2 = "";
                        }
                        if (!i50.m1475z(lowerCase4, "voice", false) && !i50.m1475z(lowerCase4, "mic", false) && !i50.m1475z(lowerCase4, "record", false) && !i50.m1475z(lowerCase2, "voice", false) && !i50.m1475z(lowerCase2, "mic", false) && !i50.m1475z(lowerCase2, "record", false) && !i50.m1475z(lowerCase2, "rcd", false)) {
