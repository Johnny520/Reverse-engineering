...
public final class Base64 {
    ...
    public static class Decoder extends Coder {
        ...
        public /* synthetic */ Decoder(byte[] bArr, int i, int i2) {
            this(i, bArr);
        }
            ...
            while (i9 < i4) {
                ...
                if (i8 != 0) {
                    if (i8 == 1) {
                        ...
                        int i13 = i12 | (i7 << 6);
                        bArr2[i6 + 2] = (byte) i13;
                        bArr2[i6 + 1] = (byte) (i13 >> Base64.URL_SAFE);
    ...
    public static class Encoder extends Coder {
        ...
        public /* synthetic */ Encoder(int i) {
            this(i, null);
        }
    ...
    private static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        Decoder decoder = new Decoder(new byte[(i2 * 3) / CRLF], i3, 0);
        if (decoder.process(bArr, i, i2, true)) {
            int i4 = decoder.f910op;
    ...
    private static byte[] encode(byte[] bArr, int i, int i2, int i3) {
        Encoder encoder = new Encoder(i3);
        int i4 = (i2 / 3) * CRLF;
