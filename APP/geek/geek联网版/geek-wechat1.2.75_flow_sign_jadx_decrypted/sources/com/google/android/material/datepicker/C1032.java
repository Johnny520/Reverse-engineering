...
public class C1032 {
    ...
    public static int m3039(Object obj) {
        return obj.hashCode();
    }

    /* JADX INFO: renamed from: ۥۥۢۧ, reason: contains not printable characters */
    public static int m3040() {
        return (-321) ^ C1001.f5648;
    }

    /* JADX INFO: renamed from: ۥۣۨۤ, reason: contains not printable characters */
    public static String m3041(short[] sArr, int i, int i2, int i3) {
