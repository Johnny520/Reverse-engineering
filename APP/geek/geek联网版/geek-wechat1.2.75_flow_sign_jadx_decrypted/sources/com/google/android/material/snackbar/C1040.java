...
public class C1040 {
    ...
    public static String m3073(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    /* JADX INFO: renamed from: ۡ۠۠ۨ, reason: not valid java name and contains not printable characters */
    public static String m3071(short[] sArr, int i, int i2, int i3) {
