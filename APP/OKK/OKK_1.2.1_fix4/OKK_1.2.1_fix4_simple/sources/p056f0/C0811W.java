...
import p050c0.C0589G0;
import p050c0.C0590G1;
import p050c0.C0593H1;
import p050c0.C0594I;
import p050c0.C0595I0;
import p050c0.C0596I1;
import p050c0.C0599J1;
import p050c0.C0645c0;
import p050c0.C0646c1;
import p050c0.C0648d0;
import p050c0.C0649d1;
import p050c0.C0651e0;
import p050c0.C0655f1;
import p050c0.C0661h1;
import p050c0.C0665j;
import p050c0.C0674m;
import p050c0.C0684p0;
import p050c0.C0687q0;
import p050c0.C0689r;
import p050c0.C0692s;
import p050c0.C0693s0;
import p050c0.C0695t;
import p050c0.C0698u;
import p050c0.C0704w;
import p050c0.C0707x;
import p050c0.C0710y;
import p050c0.RunnableC0713z;
import p054e0.C0769c;

/* JADX INFO: renamed from: f0.W */
/* JADX INFO: loaded from: classes.dex */
public final /* synthetic */ class C0811W implements InterfaceC0275a {
    ...
    public /* synthetic */ C0811W(Context r1, ClassLoader r2, int r3) {
        this.f2948a = r3;
        this.f2949b = r1;
        this.f2950c = r2;
    }
    ...
    private final Object m2107a() {
        ...
        C0651e0 r02 = C0651e0.f2022a;
        C0146l r6 = C0146l.f339a;
        if (C0651e0.f2023b.compareAndSet(false, true) == false) goto L87;
        C0651e0.m1636e("installing...");
    ...
    L35:
        ...
        C0651e0.m1636e("ScopedStorageUtil.c not found");     // Catch: Throwable -> L15
    L90:
    ...
    L58:
        ...
        C0651e0.m1636e("hooked ExportFileUtil.m");     // Catch: Throwable -> L54
    L60:
        Object r04 = r6;
    L62:
        Throwable r05 = AbstractC0141g.m465a(r04);
        if (r05 == null) goto L88;
        C0651e0.m1636e("locate ExportFileUtil fail: " + r05.getMessage());
    L88:
    ...
    L79:
        ...
        goto L79
    L81:
        C0651e0.m1636e("hooked Toast.makeText");     // Catch: Throwable -> L74
        Object r08 = r6;
    L84:
        Throwable r09 = AbstractC0141g.m465a(r08);
        if (r09 == null) goto L87;
        C0651e0.m1636e("locate Toast.makeText fail: " + r09.getMessage());
    L74:
        th = move-exception;
    ...
    L37:
        ...
        C0651e0.m1636e("hooked ScopedStorageUtil.c " + r10.getName() + "." + r14.getName());     // Catch: Throwable -> L15
        Object r010 = r6;
    L40:
        Throwable r011 = AbstractC0141g.m465a(r010);
        if (r011 == null) goto L90;
        C0651e0.m1636e("locate ScopedStorageUtil fail: " + r011.getMessage());
        goto L90
    L29:
        r99 = null;
        goto L31
    ...
    private final Object m2108c() {
        ...
        C0594I.m1472d("install hideTitle=" + C0710y.m1809d());
    ...
    L17:
        ...
        AbstractC0762d.m1952b(r62, new C0665j(13));     // Catch: Throwable -> L22
    L24:
        r3 = r3 + 1;
    L22:
        th = move-exception;
        ...
        goto L24
    L38:
        Object r02 = AbstractC0358S.m904q(r13, "onAttachedToWindow", new Object[]{new C0665j(14)});     // Catch: Throwable -> L27
    L30:
    ...
    L35:
        ...
        goto L37
    L44:
        AbstractC0358S.m904q(View.class, "onAttachedToWindow", new Object[]{new C0665j(15)});     // Catch: Throwable -> L33
    L33:
        th = move-exception;
        AbstractC0040p.m116u(th);
    L27:
    ...
    private final Object m2109d() {
        ...
        Object r9 = C0590G1.f1792a;
        C0575B1.f1702b.addIfAbsent(new C0581D1(0));
        C0575B1 r92 = C0575B1.f1701a;
        C0575B1.m1390g(true);
        boolean r10 = r92.m1393e();
        float r93 = r92.m1391a();
        C0575B1.m1390g(false);
        C0599J1.m1485c("install wekit-style en=" + r10 + " a=" + r93 + " path=" + C0575B1.f1706f);
    ...
    L6:
        C0595I0.f1824g = r2;
        if (C0595I0.f1819b.compareAndSet(false, true) == true) goto L66;
    L61:
        return r5;
    L66:
    ...
    L10:
        ...
        goto L10
    L14:
        C0595I0.m1482j("hooked ChatFooter constructors: " + r22.getDeclaredConstructors().length);     // Catch: Throwable -> L12
        Object r23 = r5;
    L17:
        Throwable r24 = AbstractC0141g.m465a(r23);
        C0595I0 r63 = C0595I0.f1818a;
        if (r24 == null) goto L62;
        C0595I0.m1482j("ChatFooter hook skipped: " + r24.getMessage());
    L62:
    ...
    L21:
        ...
        goto L21
    L25:
        C0595I0.m1482j("hooked MMFlexEditText constructors: " + r25.getDeclaredConstructors().length);     // Catch: Throwable -> L23
        Object r03 = r5;
    L28:
        Throwable r04 = AbstractC0141g.m465a(r03);
        if (r04 == null) goto L68;
        C0595I0.m1482j("MMFlexEditText hook skipped: " + r04.getMessage());
    L68:
        AbstractC0358S.m904q(TextView.class, "setHint", new Object[]{CharSequence.class, new C0589G0(2)});     // Catch: Throwable -> L33
        C0595I0.m1482j("hooked TextView.setHint(CharSequence)");     // Catch: Throwable -> L33
        Object r05 = r5;
    L35:
        Throwable r06 = AbstractC0141g.m465a(r05);
        if (r06 == null) goto L38;
        C0595I0.m1482j("TextView.setHint hook skipped: " + r06.getMessage());
    L38:
        AtomicBoolean r07 = C0595I0.f1820c;
    ...
    L55:
        ...
        C0595I0.m1482j("database class not ready");
        goto L60
    L57:
        int r44 = C0595I0.m1477e(r65, "insert", new Class[]{String.class, String.class, ContentValues.class}) + C0595I0.m1477e(r65, "insertOrThrow", new Class[]{String.class, String.class, ContentValues.class});
        Class r73 = Integer.TYPE;
        AbstractC0307g.m700b(r73);
        int r45 = r44 + C0595I0.m1477e(r65, "insertWithOnConflict", new Class[]{String.class, String.class, ContentValues.class, r73});
        if (r45 <= 0) goto L60;
        r07.set(true);
        C0595I0.m1482j("hooked " + r45 + " DB insert methods on " + r65.getName());
    L60:
        C0595I0.m1482j("installed");
    L33:
        th = move-exception;
    ...
    private final Object m2111f() {
        ...
        C0649d1 r3 = C0649d1.f2016a;
        boolean r32 = C0649d1.f2017b.compareAndSet(false, true);
        C0146l r4 = C0146l.f339a;
        if (r32 == false) goto L31;
        C0649d1.m1631b("install enabled=" + C0649d1.m1630a());
    ...
    L24:
        ...
        goto L14
    L25:
        C0649d1.m1631b("hooked ADInfo paths count=" + r5);     // Catch: Throwable -> L10
        Object r02 = r4;
    L28:
        Throwable r03 = AbstractC0141g.m465a(r02);
        if (r03 == null) goto L31;
        C0649d1 r1 = C0649d1.f2016a;
        C0649d1.m1631b("ADInfo hook fail: " + r03.getMessage());
    L10:
        th = move-exception;
        r02 = AbstractC0040p.m116u(th);
    L31:
    ...
    private final Object m2112g() {
        ...
        ClassLoader r3 = this.f2950c;
        AbstractC0307g.m703e(r3, "$cl");
        C0645c0 r4 = C0645c0.f2005a;
        C0146l r42 = C0146l.f339a;
        if (C0645c0.f2007c.compareAndSet(false, true) == false) goto L76;
        C0645c0.m1629b("install enabled=" + C0645c0.m1628a());
    ...
    L18:
        AbstractC0762d.m1952b(r9, new C0674m(2));     // Catch: Throwable -> L16
        r8 = r8 + 1;     // Catch: Throwable -> L16
        C0645c0.m1629b("hooked " + r9.getName());     // Catch: Throwable -> L16
        goto L8
    L19:
        C0645c0.m1629b("ShareTinkerInternals hooks=" + r8);     // Catch: Throwable -> L16
        Object r72 = r42;
    L22:
        Throwable r73 = AbstractC0141g.m465a(r72);
        C0645c0 r82 = C0645c0.f2005a;
        if (r73 == null) goto L83;
        C0645c0.m1629b("TinkerInternals fail: " + r73.getMessage());
    L83:
    ...
    L35:
        if (C0645c0.m1628a() == false) goto L76;
    ...
    L58:
        C0645c0.m1629b("wiped " + r5.getAbsolutePath());     // Catch: Throwable -> L60
    L60:
        th = move-exception;
        AbstractC0040p.m116u(th);
        goto L43
    L62:
        ...
        Iterator r52 = C0645c0.f2006b.iterator();
    L67:
        ...
        C0645c0.m1629b("component " + r79 + " enabled=false");     // Catch: Throwable -> L71
        Object r85 = r42;
    L73:
        Throwable r86 = AbstractC0141g.m465a(r85);
        if (r86 == null) goto L67;
        C0645c0.m1629b("component " + r79 + " fail: " + r86.getMessage());
    L71:
        th = move-exception;
    ...
    private final Object m2113h() {
        ...
        boolean r03 = C0826f0.f2993b.compareAndSet(false, true);
    ...
    L10:
        ...
        r04 = null;
    L12:
        C0569s r05 = (C0569s) r04;
        if (r05 == null) goto L16;
        String r06 = r05.m1383a();
        if (r06 == null) goto L16;
    L17:
        C0826f0.m2146l("install begin ver=".concat(r06));
        boolean r07 = C0826f0.f2994c.compareAndSet(false, true);
        C0826f0 r11 = C0826f0.f2992a;
        if (r07 == true) goto L345;
    L19:
        int r42 = 0;
    L74:
        C0826f0.m2146l("legacy settings list injection disabled");
        AtomicBoolean r08 = AbstractC0553c.f1646a;
        List r17 = AbstractC0553c.m1363b(r9, r8, AbstractC0805P.f2920a, new String[]{"MicroMsg.PlusSubMenuHelper"});
    ...
    L103:
        ...
        C0826f0.m2146l("plus helper resolved via DexKit: ".concat(r112.getName()));
    L120:
        if (r112 != null) goto L122;
        C0826f0.m2146l("plus helper class not resolved (DexKit + fallback both failed)");
    L293:
        int r43 = r42 + r5;
        if (r5 <= 0) goto L296;
        String r010 = "OK";
    L297:
        C0826f0.m2146l("settings entry hooks installed count=" + r43 + " plusMenu=" + r010);
        if (r5 != 0) goto L304;
        C0826f0.m2146l("FATAL: plus menu entry unavailable on this build; OKK has no visible entry");
        ModuleLog.INSTANCE.m1813i("严重：加号菜单入口注入失败，模块将没有可见入口");     // Catch: Throwable -> L302
    L302:
        th = move-exception;
        AbstractC0040p.m116u(th);
    L304:
        ConcurrentHashMap r011 = C0769c.f2728a;
        if (r5 > 0) goto L308;
        r7 = false;
    L308:
        if (r5 <= 0) goto L310;
    ...
    L311:
        C0769c.m1967g("SettingsEntry", r012, r7);
        goto L312
    L310:
    ...
    L296:
        ...
        goto L297
    L122:
        C0826f0.m2146l("plus helper class resolved=".concat(r112.getName()));
    ...
    L124:
        ...
        C0826f0.m2146l(r1.toString());     // Catch: Throwable -> L130
        Object r014 = r10;
    L135:
        Throwable r015 = AbstractC0141g.m465a(r014);
        if (r015 == null) goto L138;
        C0826f0.m2146l("plus display hook fail " + r52.getDeclaringClass().getName() + "." + r52.getName() + ": " + r015.getMessage());
    L138:
        r23 = r212;
        r7 = true;
    L130:
    ...
    L141:
        ...
        C0826f0.m2146l("plus adapter factory hooked " + r016.getDeclaringClass().getName() + "." + r016.getName());     // Catch: Throwable -> L145
        Object r017 = r10;
    L147:
        Throwable r018 = AbstractC0141g.m465a(r017);
        if (r018 == null) goto L150;
        C0826f0.m2146l("plus adapter factory hook fail: " + r018.getMessage());
    L150:
        r53 = 1;
    L145:
        th = move-exception;
    ...
    L153:
        ...
        AbstractC0762d.m1952b(r019, new C0674m(9));     // Catch: Throwable -> L165
        int r73 = r3 + 1;
    ...
    L167:
        ...
        C0826f0.m2146l("plus click hook fail: " + r021.getMessage());
    L163:
        th = th;
        r3 = r73;
    L166:
    ...
    L170:
        if (r3 <= 0) goto L172;
        C0826f0.m2146l("home plus menu hooked count=" + r3);
    L172:
    ...
    L197:
        ...
        C0826f0.m2146l("plus adapter class not resolved");
    L226:
        int r32 = r3 + r74;
        AtomicBoolean r025 = AbstractC0553c.f1646a;     // Catch: Throwable -> L244
        Iterator r026 = AbstractC0553c.m1363b(r9, r8, AbstractC0805P.f2920a, new String[]{"MicroMsg.PlusMenaDataManager"}).iterator();     // Catch: Throwable -> L244
    L229:
    ...
    L291:
        ...
        goto L292
    L275:
        C0826f0.m2146l("plus data manager resolved=".concat(r26.getName()));
        r7 = true;
    ...
    L277:
        ...
        C0826f0.m2146l("plus data manager rebuild hooked " + r59.getDeclaringClass().getName() + "." + r59.getName());     // Catch: Throwable -> L281
        Object r030 = r10;
    L283:
        Throwable r031 = AbstractC0141g.m465a(r030);
        if (r031 == null) goto L277;
        C0826f0.m2146l("plus data manager hook fail " + r59.getDeclaringClass().getName() + "." + r59.getName() + ": " + r031.getMessage());
    L281:
        th = move-exception;
    ...
    L286:
        if (r28 <= 0) goto L289;
        C0826f0.m2146l("plus data manager hooked count=" + r28);
        goto L289
    L249:
        r25 = null;
    L244:
        ...
        goto L254
    L199:
        C0826f0.m2146l("plus adapter class resolved=".concat(r15.getName()));
        boolean r133 = true;
    ...
    L201:
        ...
        C0826f0.m2146l("plus adapter count hooked " + r032.getDeclaringClass().getName());     // Catch: Throwable -> L205
        Object r033 = r10;
    L207:
        Throwable r034 = AbstractC0141g.m465a(r033);
        if (r034 == null) goto L210;
        C0826f0.m2146l("plus adapter count hook fail: " + r034.getMessage());
    L210:
        r133 = true;
    L205:
        th = move-exception;
    ...
    L213:
        ...
        C0826f0.m2146l("plus adapter view hooked " + r035.getDeclaringClass().getName());     // Catch: Throwable -> L217
        Object r036 = r10;
    L219:
        Throwable r037 = AbstractC0141g.m465a(r036);
        if (r037 == null) goto L222;
        C0826f0.m2146l("plus adapter view hook fail: " + r037.getMessage());
    L222:
        r78 = 1;
    L217:
        th = move-exception;
    ...
    L223:
        if (r510 <= 0) goto L225;
        C0826f0.m2146l("home plus adapter hooked count=" + r510);
    L225:
        r74 = r510;
    L188:
        r74 = 0;
    ...
    L109:
        ...
        C0826f0.m2146l("plus helper DexKit candidates rejected: ".concat(AbstractC0181l.m546r0(r17, null, null, null, new C0813Y(23), 31)));
    L337:
    ...
    L37:
        ...
        C0826f0.m2146l("modern settings list injection disabled; dataSource missing");
        goto L19
    L323:
    ...
    L47:
        ...
        C0826f0.m2146l("modern cleanup onCreate hook fail: " + r043.getMessage());
    L50:
    ...
    L66:
        ...
        goto L52
    L69:
        C0826f0.m2146l("modern settings list injection disabled; cleanup hooks=" + r134 + " dataSource=" + r115.getName());
        if (r134 <= 0) goto L72;
        int r045 = 1;
    L73:
        r42 = r045;
    ...
    L44:
        ...
        goto L46
    L31:
        AtomicBoolean r046 = AbstractC0553c.f1646a;
        r041 = AbstractC0553c.m1362a(r9, r8, AbstractC0805P.f2920a, new String[]{"MicroMsg.SettingDataSource", "get data, size : "});
        if (r041 != null) goto L34;
        r041 = AbstractC0553c.m1362a(r9, r8, AbstractC0805P.f2920a, new String[]{"MicroMsg.SettingDataSource"});
    L34:
    ...
    L4:
        ...
        C0830i r3 = C0830i.f3000a;
        boolean r32 = C0830i.f3002c.compareAndSet(false, true);
    ...
    L7:
        ...
        C0830i.f3003d.set(false);
        C0830i.f3004e.set(false);
    L10:
        C0830i.m2157g("install first=" + r32 + " interactive=" + AbstractC0358S.f729i + " pendingDialog=" + AbstractC0358S.f728h);
        if (r32 == true) goto L350;
    L36:
        C0830i.f3005f.set(0);
        RunnableC0488m r03 = new RunnableC0488m(1);
        Handler r22 = C0830i.f3001b;
    ...
    L29:
        ...
        r04 = r7;
    L346:
        C0830i r33 = C0830i.f3000a;     // Catch: Throwable -> L34
    ...
    L145:
        ...
        C0687q0 r016 = C0687q0.f2154a;
        C0146l r15 = C0146l.f339a;
        if (C0687q0.f2155b.compareAndSet(false, true) == false) goto L252;
        C0687q0.m1763j(true);
        C0687q0.m1765l("install enabled=" + C0687q0.f2156c + " (HIDE sticky overlay, keep list item)");
        ...
        C0687q0.m1765l("hooked ConversationListView.setFoldBanner");     // Catch: Throwable -> L151
        Object r017 = r15;
    L153:
        Throwable r018 = AbstractC0141g.m465a(r017);
        C0687q0 r93 = C0687q0.f2154a;
        if (r018 == null) goto L354;
        C0687q0.m1765l("setFoldBanner: " + r018.getMessage());
    L354:
        AbstractC0358S.m904q(View.class, "setVisibility", new Object[]{Integer.TYPE, new C0665j(21)});     // Catch: Throwable -> L158
        C0687q0.m1765l("hooked View.setVisibility");     // Catch: Throwable -> L158
        Object r019 = r15;
    L160:
        Throwable r020 = AbstractC0141g.m465a(r019);
        if (r020 == null) goto L378;
        C0687q0.m1765l("setVisibility: " + r020.getMessage());
    L378:
        AbstractC0358S.m904q(View.class, "setTranslationY", new Object[]{Float.TYPE, new C0684p0(4)});     // Catch: Throwable -> L165
        C0687q0.m1765l("hooked View.setTranslationY");     // Catch: Throwable -> L165
        Object r021 = r15;
    L167:
        Throwable r022 = AbstractC0141g.m465a(r021);
        if (r022 == null) goto L372;
        C0687q0.m1765l("setTranslationY: " + r022.getMessage());
    L372:
        AbstractC0358S.m904q(View.class, "setAlpha", new Object[]{Float.TYPE, new C0665j(22)});     // Catch: Throwable -> L172
        C0687q0.m1765l("hooked View.setAlpha");     // Catch: Throwable -> L172
        Object r023 = r15;
    L174:
        Throwable r024 = AbstractC0141g.m465a(r023);
        if (r024 == null) goto L348;
        C0687q0.m1765l("setAlpha: " + r024.getMessage());
    L348:
        ...
        AbstractC0358S.m904q(r025, "onScroll", new Object[]{AbsListView.class, r64, r64, r64, new C0665j(23)});     // Catch: Throwable -> L179
        AbstractC0358S.m904q(r025, "layoutChildren", new Object[]{new C0665j(24)});     // Catch: Throwable -> L179
        C0687q0.m1765l("hooked ConversationListView.onScroll/layoutChildren");     // Catch: Throwable -> L179
        Object r026 = r15;
    L181:
        Throwable r027 = AbstractC0141g.m465a(r026);
        if (r027 == null) goto L358;
        C0687q0.m1765l("list hooks: " + r027.getMessage());
    L358:
    ...
    L186:
        ...
        C0687q0.m1765l("hooked FolderHelper." + r65.getName() + "(int,boolean)");     // Catch: Throwable -> L194
        goto L186
    L196:
    ...
    L214:
        if (C0687q0.f2160g != null) goto L198;
        C0687q0.f2160g = r66;     // Catch: Throwable -> L194
        C0687q0.m1765l("pre-resolve banner field=" + r66 + " type=" + r310.getType().getSimpleName());     // Catch: Throwable -> L194
        goto L198
    L216:
        if (r48 != 0) goto L218;
        C0687q0.m1765l("FolderHelper: no g(int,boolean) found");     // Catch: Throwable -> L194
    L218:
        Object r030 = r15;
    L220:
        Throwable r031 = AbstractC0141g.m465a(r030);
        if (r031 == null) goto L380;
        C0687q0.m1765l("FolderHelper g: " + r031.getMessage());
    L380:
    ...
    L237:
        ...
        goto L237
    L239:
        C0687q0.m1765l("hooked MainUI lifecycle for lt5");     // Catch: Throwable -> L232
        Object r033 = r15;
    L242:
        Throwable r034 = AbstractC0141g.m465a(r033);
        if (r034 == null) goto L382;
        C0687q0.m1765l("MainUI: " + r034.getMessage());
    L382:
        ...
        C0687q0.m1765l("hooked ViewGroup.addView for lt5");     // Catch: Throwable -> L247
        Object r035 = r15;
    L249:
        Throwable r036 = AbstractC0141g.m465a(r035);
        if (r036 == null) goto L252;
        C0687q0.m1765l("addView: " + r036.getMessage());
    L247:
        th = move-exception;
    ...
    L345:
        return r12;
    L366:
        C0661h1 r039 = C0661h1.f2048a;     // Catch: Throwable -> L258
        Object r040 = Boolean.valueOf(C0661h1.m1661c("hide_home_divider", false));     // Catch: Throwable -> L258
    L260:
    ...
    L335:
        ...
        AbstractC0358S.m904q(AbstractC0358S.m906r(r68, "com.tencent.mm.ui.conversation.MainUI"), "onResume", new Object[]{new C0674m(3)});     // Catch: Throwable -> L340
    ...
    public /* synthetic */ C0811W(Context r1, ClassLoader r2, String r3, int r4) {
        this.f2948a = r4;
        this.f2949b = r1;
        this.f2950c = r2;
    }

    public /* synthetic */ C0811W(ClassLoader r2, Context r3) {
        this.f2948a = 10;
        this.f2950c = r2;
        this.f2949b = r3;
    }
