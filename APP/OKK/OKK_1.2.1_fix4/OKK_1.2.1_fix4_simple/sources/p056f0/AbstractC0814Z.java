...
import p054e0.EnumC0768b;

/* JADX INFO: renamed from: f0.Z */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC0814Z {
    ...
    L12:
        ...
        m2124b("HideHomeDivider", new C0811W(r8, r11, r12, r9));
        m2124b("FoldBannerPin", new C0811W(r8, r11, r12, r10));
        m2124b("BottomTabIcon", new C0811W(r8, r11, r12, r7));
        ...
        m2124b("ThemeWallpaper", new C0811W(r8, r11, r12, r4));
        ...
        m2124b("InputStats", new C0811W(r8, r11, r3));
        m2124b("AntiMomentsDelete", new C0812X(r8, r11, r12, r1));
        m2124b("AntiMomentsComment", new C0812X(r8, r11, r12, r02));
        m2124b("MomentsAdBlock", new C0811W(r8, r11, r12, r2));
        m2124b("ProfileId", new C0811W(r8, r11, r12, r1));
        final int r13 = 10;
        m2124b("RealNameTail", new C0812X(r8, r11, r12, r13));
        final int r15 = 11;
        m2124b("MemberTitle", new C0812X(r8, r11, r12, r15));
        m2124b("DisableHotUpdate", new C0811W(r8, r11, r12, r02));
        m2124b("VirtualLocation", new C0812X(r8, r11, r12, r9));
        m2124b("AutoLoginWin", new C0811W(r8, r11, r12, r6));
        m2124b("MapPickBridge", new C0840s(r10, r11));
        m2124b("DownloadRedirect", new C0811W(r8, r11, r12, r5));
        ConcurrentHashMap r142 = C0769c.f2728a;
        C0769c.m1966f();
        m2125c("features done " + C0769c.m1969i());
    }

    /* JADX INFO: renamed from: b */
    public static void m2124b(String r6, InterfaceC0275a r7) {
        C0551a r02 = AbstractC0358S.f727g;
        if (r02 == null) goto L24;
        C0564n r03 = r02.m1357a(r6);
        if (r03 == null) goto L24;
        if (r03.f1670c != EnumC0563m.f1666c) goto L24;
        C0551a r72 = AbstractC0358S.f727g;
        if (r72 == null) goto L16;
        C0564n r73 = r72.m1357a(r6);
        if (r73 == null) goto L16;
        String r74 = r73.f1671d;
        if (r74 == null) goto L16;
    L17:
        ConcurrentHashMap r04 = C0769c.f2728a;
        String r05 = "不适配: ".concat(r74);
        AbstractC0307g.m703e(r05, "reason");
        C0769c.f2728a.put(r6, new C0767a(r6, EnumC0768b.f2725c, r05));
        C0769c.m1970j("SKIP " + r6 + " (" + r05 + ")");
    ...
    L16:
        r74 = "compat FAIL";
    L24:
        ConcurrentHashMap r06 = C0769c.f2728a;
        C0769c.m1962b(r6, r7);
    }
