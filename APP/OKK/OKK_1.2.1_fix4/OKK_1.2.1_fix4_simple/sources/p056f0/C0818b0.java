...
public final class C0818b0 extends AbstractC0761c {
    ...
    L7:
        if (r2 == null) goto L25;
        AtomicBoolean r54 = C0820c0.f2976a;
        C0820c0.m2127a(r2, r02, "Tinker.onBaseContextAttached(" + r1 + ")");
        return;
    L25:
        return;
    L11:
    ...
    L17:
        ...
        AtomicBoolean r56 = C0820c0.f2976a;
        ClassLoader r57 = r2.getClassLoader();
        if (r57 == null) goto L23;
        r02 = r57;
    L23:
        C0820c0.m2127a(r2, r02, r1 + ".onCreate");
        return;
    }
}
