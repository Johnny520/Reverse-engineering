...
public final /* synthetic */ class C0843v implements InterfaceC0275a {
    ...
    L21:
        ...
        C0661h1 r8 = C0661h1.f2048a;
        if (C0661h1.m1661c(r63.f2894c, r63.f2895d) == false) goto L21;
        r02 = r02 + 1;
        if (r02 >= 0) goto L21;
    ...
    L38:
        ...
        C0139e r13 = C0605L1.f1854a.m1495b(r04);
    ...
    L48:
        C0605L1.m1494i(true, r65, r14, r04, false);
        C0810V r15 = C0810V.f2933a;
        C0810V.m2105z(r04, "已保存坐标并激活");
        return r4;
    L47:
    ...
    L50:
        ...
        C0139e r17 = C0605L1.f1854a.m1495b(r122);
    ...
    L58:
        C0605L1.m1494i(true, r67, r82, r122, false);
        ...
        C0810V.m2105z(r122, "请在地图上选择位置");     // Catch: Throwable -> L64
    ...
    L81:
        C0810V.m2105z(r122, "已发送选点请求，请在微信中确认");
    L79:
        th = move-exception;
    ...
    L83:
        ...
        C0605L1 r07 = C0605L1.f1854a;
        C0139e r08 = C0605L1.m1493h(r73);
        C0810V r19 = C0810V.f2933a;
        if (r08 != null) goto L86;
        C0810V.m2105z(r73, "无法获取当前位置，请开启系统定位权限");
    L87:
        return r4;
    L86:
        r68.f2899b.setText(C0605L1.m1488c(((Number) r08.f328a).doubleValue()));
        r56.f2899b.setText(C0605L1.m1488c(((Number) r08.f329b).doubleValue()));
        C0810V.m2105z(r73, "已自动填入");
        goto L87
    }
}
