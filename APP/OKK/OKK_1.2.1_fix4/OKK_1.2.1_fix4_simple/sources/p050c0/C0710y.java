...
public final class C0710y {
    ...
    L7:
        ...
        List r53 = f2234a;
        String r1 = C0661h1.m1662d("bottom_tab_title_chats", (String) r53.get(0));
        if (AbstractC0425j.m1013R0(r1) == false) goto L10;
        r1 = (String) r53.get(0);
    L10:
        String r6 = C0661h1.m1662d("bottom_tab_title_contacts", (String) r53.get(1));
        if (AbstractC0425j.m1013R0(r6) == false) goto L13;
        r6 = (String) r53.get(1);
    L13:
        String r2 = C0661h1.m1662d("bottom_tab_title_discover", (String) r53.get(2));
        if (AbstractC0425j.m1013R0(r2) == false) goto L16;
        r2 = (String) r53.get(2);
    L16:
        String r3 = C0661h1.m1662d("bottom_tab_title_me", (String) r53.get(3));
