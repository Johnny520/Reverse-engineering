...
public final class C0647d extends AbstractC0761c {
    ...
    L22:
        ...
        r7.getClass();
        if (C0706w1.m1801f(r9) == true) goto L28;
        r3 = r3 + 1;
    L28:
        if (r9 == null) goto L30;
    ...
    L140:
        ...
        C0706w1.m1798b((C0706w1) this.f2011c, (String) this.f2013e, r02.f2231b);     // Catch: Throwable -> L35
        return;
    L35:
        th = move-exception;
        C0706w1 r03 = (C0706w1) this.f2011c;
    ...
    L38:
        ...
        if (C0678n0.m1725p() == false) goto L152;
    ...
    L56:
        ...
        WeakReference r05 = C0678n0.f2131p;
        if (r05 == null) goto L151;
        TextView r06 = (TextView) r05.get();
        if (r06 == null) goto L155;
        ((C0678n0) this.f2012d).getClass();
        if (C0678n0.m1723n(r06) == false) goto L156;
        C0666j0 r16 = C0678n0.f2130o;
        ((C0678n0) this.f2012d).getClass();
        if (C0678n0.m1724o(r16) == false) goto L157;
        C0678n0.f2131p = new WeakReference(r06);
        C0678n0 r22 = (C0678n0) this.f2012d;
    ...
    L74:
        ...
        ((C0678n0) this.f2012d).getClass();
        C0678n0.m1709A(r06);
        C0678n0 r07 = (C0678n0) this.f2012d;
    ...
    L76:
        ((C0678n0) this.f2012d).getClass();
        if (C0678n0.m1725p() == false) goto L159;
    ...
    L86:
        ...
        WeakReference r010 = C0678n0.f2131p;
        if (r010 == null) goto L158;
        TextView r011 = (TextView) r010.get();
        if (r011 == null) goto L162;
        ((C0678n0) this.f2012d).getClass();
        if (C0678n0.m1723n(r011) == false) goto L163;
        ((C0678n0) this.f2012d).getClass();
        C0678n0.m1709A(r011);
        r12.m1946c(Boolean.TRUE);
        C0678n0 r123 = (C0678n0) this.f2012d;
    ...
    L98:
        ...
        if (C0656g.m1649j() == false) goto L165;
    ...
    public C0647d(C0678n0 r2, Method r3, String r4) {
        this.f2010b = 2;
        this.f2012d = r2;
        this.f2011c = r3;
        this.f2013e = r4;
