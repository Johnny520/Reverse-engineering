...
public final /* synthetic */ class RunnableC0673l1 implements Runnable {
    ...
    L4:
        ...
        CopyOnWriteArrayList r1 = (CopyOnWriteArrayList) C0688q1.f2172j.get(r02);
        if (r1 == null) goto L15;
    ...
    L8:
        ...
        C0688q1 r4 = C0688q1.f2163a;
        C0688q1.m1766a(r3, r02, ((C0679n1) r2).f2136a);
        goto L8
    L27:
        return;
    L15:
    ...
    L16:
        ...
        CopyOnWriteArrayList r14 = (CopyOnWriteArrayList) C0688q1.f2172j.get(r02);
