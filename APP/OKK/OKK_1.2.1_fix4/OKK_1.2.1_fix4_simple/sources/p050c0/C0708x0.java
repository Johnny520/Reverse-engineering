...
public final /* synthetic */ class C0708x0 implements InterfaceC0275a {
    ...
    L4:
        ...
        C0810V r8 = C0810V.f2933a;
        int r72 = r7.getProgress();
        C0709x1 r82 = C0703v1.f2212b;
        float r1 = AbstractC0040p.m110o((AbstractC0040p.m111p(r72, 0, 45) / 100.0f) + 0.05f, 0.05f, 0.5f);
        C0661h1.f2048a.m1666f("round_avatar_radius", String.format(Locale.US, "%.2f", Arrays.copyOf(new Object[]{Float.valueOf(r1)}, 1)), false);
        C0810V.m2105z(r6, "已保存圆度 " + r1);
        return C0146l.f339a;
    L6:
    ...
    L14:
        ...
        Object r13 = AbstractC0567q.m1381d(C0580D0.f1727e, r12, r2);     // Catch: Throwable -> L17
    L20:
