...
public final class BatchUsingStringsMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createBatchUsingStringsMatcher(C0733b r2, int r3, int r4) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
            addUsingStrings(r2, r4);
            addUnionKey(r2, r3);
            return endBatchUsingStringsMatcher(r2);
        }
        ...
        public final int endBatchUsingStringsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final BatchUsingStringsMatcher getRootAsBatchUsingStringsMatcher(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsBatchUsingStringsMatcher(r2, new BatchUsingStringsMatcher());
        }

        public final void startBatchUsingStringsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
        }
        ...
        public final BatchUsingStringsMatcher getRootAsBatchUsingStringsMatcher(ByteBuffer r3, BatchUsingStringsMatcher r4) {
    ...
    public final BatchUsingStringsMatcher __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
