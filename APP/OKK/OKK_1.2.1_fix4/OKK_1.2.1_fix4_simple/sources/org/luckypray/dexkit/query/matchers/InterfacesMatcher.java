...
public final class InterfacesMatcher extends BaseQuery {
    ...
    public static /* synthetic */ InterfacesMatcher add$default(InterfacesMatcher r02, String r1, StringMatchType r2, boolean r3, int r4, Object r5) {
        if ((r4 & 2) == 0) goto L6;
    ...
    public static /* synthetic */ InterfacesMatcher count$default(InterfacesMatcher r02, int r1, int r2, int r3, Object r4) {
        if ((r3 & 1) == 0) goto L6;
        r1 = 0;
    L6:
        if ((r3 & 2) == 0) goto L9;
    ...
    public final InterfacesMatcher add(String r8) {
        AbstractC0307g.m703e(r8, "className");
        return add$default(this, r8, null, false, 6, null);
    }

    public final InterfacesMatcher count(int r2) {
        this.rangeMatcher = new IntRange(r2);
        return this;
    }

    public final InterfacesMatcher countMax(int r3) {
        this.rangeMatcher = new IntRange(0, r3);
        return this;
    }

    public final InterfacesMatcher countMin(int r3) {
    ...
    public int innerBuild(C0733b r6) {
        ...
        InterfacesMatcher.Companion r02 = org.luckypray.dexkit.schema.InterfacesMatcher.Companion;
        List<ClassMatcher> r1 = this.interfacesMatcher;
        int r2 = 0;
        if (r1 == null) goto L9;
    ...
    L6:
        ...
        r3.add(Integer.valueOf(BaseQuery.access$innerBuild((ClassMatcher) r12.next(), r6)));
        goto L6
    L8:
    ...
    L13:
        int r03 = r02.createInterfacesMatcher(r6, r13, r32, r2);
        r6.m1931n(r03);
        return r03;
    L9:
        r13 = 0;
    ...
    public final InterfacesMatcher interfaces(Collection<ClassMatcher> r2) {
        AbstractC0307g.m703e(r2, "interfaces");
        this.interfacesMatcher = AbstractC0181l.m541A0(r2);
        return this;
    }

    public final InterfacesMatcher matchType(MatchType r2) {
    ...
    public final InterfacesMatcher add(String r8, StringMatchType r9) {
        AbstractC0307g.m703e(r8, "className");
        AbstractC0307g.m703e(r9, "matchType");
        return add$default(this, r8, r9, false, 4, null);
    }

    public final InterfacesMatcher count(IntRange r2) {
        AbstractC0307g.m703e(r2, "range");
        this.rangeMatcher = r2;
        return this;
    }

    public final InterfacesMatcher add(ClassMatcher r2) {
        AbstractC0307g.m703e(r2, "interfaceMatcher");
        List<ClassMatcher> r02 = this.interfacesMatcher;
        if (r02 != null) goto L5;
        r02 = new ArrayList();
    L5:
    ...
    public final InterfacesMatcher count(C0340c r2) {
        AbstractC0307g.m703e(r2, "range");
        this.rangeMatcher = new IntRange(r2);
        return this;
    }

    public final InterfacesMatcher count(int r2, int r3) {
        this.rangeMatcher = new IntRange(r2, r3);
        return this;
    }

    public final InterfacesMatcher add(String r2, StringMatchType r3, boolean r4) {
        AbstractC0307g.m703e(r2, "className");
        AbstractC0307g.m703e(r3, "matchType");
        ClassMatcher r02 = new ClassMatcher();
        r02.className(r2, r3, r4);
        add(r02);
        return this;
    }

    private final InterfacesMatcher add(InterfaceC0286l r2) {
