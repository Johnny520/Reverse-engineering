...
public final class ClassData$interfaces$2 extends AbstractC0308h implements InterfaceC0275a {
    final /* synthetic */ DexKitBridge $bridge;
    final /* synthetic */ int $dexId;
    final /* synthetic */ ClassData this$0;

    public ClassData$interfaces$2(DexKitBridge r1, ClassData r2, int r3) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        super(0);
    ...
    public final ClassDataList invoke() {
        ...
        List r1 = ClassData.access$getInterfaceIds$p(this.this$0);
