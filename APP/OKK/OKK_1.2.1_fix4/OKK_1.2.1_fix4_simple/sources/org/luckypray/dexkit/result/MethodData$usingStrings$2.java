...
public final class MethodData$usingStrings$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$usingStrings$2(DexKitBridge r1, MethodData r2, int r3, int r4) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        this.$id = r4;
    ...
    public final List<String> invoke() {
        ...
        return AbstractC0179j.m540q0(DexKitBridge.Companion.access$nativeGetMethodUsingStrings(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), r1));
    }
}
