...
public final class InterfacesMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addInterfaceCount(C0733b r2, int r3) {
        ...
        public final int createInterfacesMatcher(C0733b r2, int r3, byte r4, int r5) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
            addInterfaceCount(r2, r5);
            addInterfaces(r2, r3);
            addMatchType(r2, r4);
            return endInterfacesMatcher(r2);
        }
        ...
        public final int endInterfacesMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final InterfacesMatcher getRootAsInterfacesMatcher(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsInterfacesMatcher(r2, new InterfacesMatcher());
        }

        public final void startInterfacesMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
        }
        ...
        public final InterfacesMatcher getRootAsInterfacesMatcher(ByteBuffer r3, InterfacesMatcher r4) {
    ...
    public final InterfacesMatcher __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final IntRange interfaceCount(IntRange r4) {
        AbstractC0307g.m703e(r4, "obj");
        int r02 = __offset(8);
        if (r02 == 0) goto L5;
    ...
    public final ClassMatcher interfaces(int r2) {
        return interfaces(new ClassMatcher(), r2);
    }
    ...
    public final ClassMatcher interfaces(ClassMatcher r3, int r4) {
