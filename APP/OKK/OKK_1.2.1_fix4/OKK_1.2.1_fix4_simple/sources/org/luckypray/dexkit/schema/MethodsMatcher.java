...
public final class MethodsMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addMethodCount(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1925h(2, r3);
        }
        ...
        public final int createMethodsMatcher(C0733b r2, int r3, byte r4, int r5) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
            addMethodCount(r2, r5);
            addMethods(r2, r3);
            addMatchType(r2, r4);
            return endMethodsMatcher(r2);
        }
        ...
        public final int endMethodsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final MethodsMatcher getRootAsMethodsMatcher(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsMethodsMatcher(r2, new MethodsMatcher());
        }

        public final void startMethodsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
        }
        ...
        public final MethodsMatcher getRootAsMethodsMatcher(ByteBuffer r3, MethodsMatcher r4) {
    ...
    public final MethodsMatcher __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final IntRange methodCount(IntRange r4) {
        AbstractC0307g.m703e(r4, "obj");
        int r02 = __offset(8);
        if (r02 == 0) goto L5;
    ...
    public final MethodMatcher methods(int r2) {
        return methods(new MethodMatcher(), r2);
    }
    ...
    public final MethodMatcher methods(MethodMatcher r3, int r4) {
