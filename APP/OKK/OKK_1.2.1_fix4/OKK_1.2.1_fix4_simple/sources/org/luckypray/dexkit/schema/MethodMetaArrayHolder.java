...
/* JADX INFO: renamed from: org.luckypray.dexkit.schema.-MethodMetaArrayHolder */
...
public final class MethodMetaArrayHolder extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createMethodMetaArrayHolder(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(1);
            addMethods(r2, r3);
            return endMethodMetaArrayHolder(r2);
        }
        ...
        public final int endMethodMetaArrayHolder(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final MethodMetaArrayHolder getRootAsMethodMetaArrayHolder(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsMethodMetaArrayHolder(r2, new MethodMetaArrayHolder());
        }

        public final void startMethodMetaArrayHolder(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(1);
        }
        ...
        public final MethodMetaArrayHolder getRootAsMethodMetaArrayHolder(ByteBuffer r3, MethodMetaArrayHolder r4) {
    ...
    public final MethodMetaArrayHolder __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final MethodMeta methods(int r2) {
        return methods(new MethodMeta(), r2);
    }

    public final MethodMeta methods(MethodMeta r3, int r4) {
