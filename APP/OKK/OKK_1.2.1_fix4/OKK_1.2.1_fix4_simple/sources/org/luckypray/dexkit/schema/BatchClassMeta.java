...
public final class BatchClassMeta extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addUnionKey(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1925h(0, r3);
        }

        public final int createBatchClassMeta(C0733b r2, int r3, int r4) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
            addClasses(r2, r4);
            addUnionKey(r2, r3);
            return endBatchClassMeta(r2);
        }
        ...
        public final int endBatchClassMeta(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final BatchClassMeta getRootAsBatchClassMeta(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsBatchClassMeta(r2, new BatchClassMeta());
        }

        public final void startBatchClassMeta(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
        }
        ...
        public final BatchClassMeta getRootAsBatchClassMeta(ByteBuffer r3, BatchClassMeta r4) {
    ...
    public final BatchClassMeta __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final ByteBuffer unionKeyInByteBuffer(ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
