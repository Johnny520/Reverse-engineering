...
public final class BatchMethodMeta extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createBatchMethodMeta(C0733b r2, int r3, int r4) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
            addMethods(r2, r4);
            addUnionKey(r2, r3);
            return endBatchMethodMeta(r2);
        }
        ...
        public final int endBatchMethodMeta(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final BatchMethodMeta getRootAsBatchMethodMeta(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsBatchMethodMeta(r2, new BatchMethodMeta());
        }

        public final void startBatchMethodMeta(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
        }
        ...
        public final BatchMethodMeta getRootAsBatchMethodMeta(ByteBuffer r3, BatchMethodMeta r4) {
    ...
    public final BatchMethodMeta __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
