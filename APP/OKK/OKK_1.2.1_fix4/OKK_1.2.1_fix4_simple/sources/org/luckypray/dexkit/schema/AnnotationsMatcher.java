...
/* JADX INFO: renamed from: org.luckypray.dexkit.schema.-AnnotationsMatcher */
/* JADX INFO: loaded from: classes.dex */
public final class AnnotationsMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addAnnotationCount(C0733b r2, int r3) {
        ...
        public final int createAnnotationsMatcher(C0733b r2, int r3, byte r4, int r5) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
            addAnnotationCount(r2, r5);
            addAnnotations(r2, r3);
            addMatchType(r2, r4);
            return endAnnotationsMatcher(r2);
        }

        public final int createAnnotationsVector(C0733b r3, int[] r4) {
        ...
        public final int endAnnotationsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final AnnotationsMatcher getRootAsAnnotationsMatcher(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsAnnotationsMatcher(r2, new AnnotationsMatcher());
        }

        public final void startAnnotationsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
        }

        public final void startAnnotationsVector(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1937t(4, r3, 4);
        }
        ...
        public final AnnotationsMatcher getRootAsAnnotationsMatcher(ByteBuffer r3, AnnotationsMatcher r4) {
    ...
    public final AnnotationsMatcher __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final IntRange annotationCount(IntRange r4) {
        AbstractC0307g.m703e(r4, "obj");
        int r02 = __offset(8);
        if (r02 == 0) goto L5;
    ...
    public final AnnotationMatcher annotations(int r2) {
        return annotations(new AnnotationMatcher(), r2);
    }
    ...
    public final AnnotationMatcher annotations(AnnotationMatcher r3, int r4) {
