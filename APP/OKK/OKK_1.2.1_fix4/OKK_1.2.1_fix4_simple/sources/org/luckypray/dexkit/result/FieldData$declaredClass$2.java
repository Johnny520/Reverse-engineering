...
public final class FieldData$declaredClass$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public FieldData$declaredClass$2(DexKitBridge r1, FieldData r2, int r3) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        super(0);
    ...
    public final ClassData invoke() {
        ...
        int r5 = 0;
        byte[] r12 = DexKitBridge.Companion.access$nativeGetClassByIds(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), new long[]{FieldData.access$getEncodeId(r1, this.$dexId, FieldData.access$getClassId$p(r1))});
