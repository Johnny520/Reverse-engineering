...
/* JADX INFO: renamed from: org.luckypray.dexkit.schema.-IntRange */
...
public final class IntRange extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addMax(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1922e(1, r3);
        }

        public final void addMin(C0733b r2, int r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1922e(0, r3);
        }

        public final int createIntRange(C0733b r2, int r3, int r4) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
            addMax(r2, r4);
            addMin(r2, r3);
            return endIntRange(r2);
        }

        public final int endIntRange(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final IntRange getRootAsIntRange(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsIntRange(r2, new IntRange());
        }

        public final void startIntRange(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(2);
        }
        ...
        public final IntRange getRootAsIntRange(ByteBuffer r3, IntRange r4) {
    ...
    public final IntRange __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
