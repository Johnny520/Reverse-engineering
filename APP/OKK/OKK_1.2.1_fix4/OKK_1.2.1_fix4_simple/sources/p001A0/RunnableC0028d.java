...
public final /* synthetic */ class RunnableC0028d implements Runnable {
    ...
    L30:
        ...
        String r33 = C0580D0.m1409p(r06);
        if (AbstractC0425j.m1013R0(r33) == false) goto L33;
        C0580D0.m1412s("prefetch: username empty");
        return;
    L33:
        C0580D0.f1736n = r33;
        Bitmap r07 = C0580D0.m1403j(r06, r33);
        if (r07 != null) goto L36;
    L39:
        if (r07 == null) goto L41;
        r2 = true;
    L41:
        C0580D0.m1412s("prefetch: user=" + r33 + " bmp=" + r2);
        ImageView r08 = C0580D0.f1730h;
        if (r08 == null) goto L143;
        C0580D0.f1725c.post(new RunnableC0705w0(r08, 1));
        return;
    L143:
        return;
    L36:
