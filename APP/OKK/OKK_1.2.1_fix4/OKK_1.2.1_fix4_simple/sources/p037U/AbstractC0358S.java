...
public abstract class AbstractC0358S {
    ...
    L9:
        ...
        EnumC0563m r7 = EnumC0563m.valueOf(r13);     // Catch: Throwable -> L11
        String r6 = r9.optString("detail", "");     // Catch: Throwable -> L11
        AbstractC0307g.m702d(r6, "optString(...)");     // Catch: Throwable -> L11
        r8.add(new C0564n(r11, r122, r7, r6));     // Catch: Throwable -> L11
    ...
    L13:
        ...
        C0551a r14 = new C0551a(r42, r62, r2.optLong("atMs", 0), r8, false);     // Catch: Throwable -> L11
    ...
    public static List m863M() {
        Object r1 = "";
        C0661h1 r2 = C0661h1.f2048a;     // Catch: Throwable -> L5
        Object r22 = C0661h1.m1662d("home_drawer_shortcuts", "");     // Catch: Throwable -> L5
    L8:
    ...
    L24:
        r1 = C0564n.m1375a(r1, null, r6, r23, 3);
        goto L34
    L23:
    ...
    L70:
        ...
        C0661h1 r017 = C0661h1.f2048a;     // Catch: Throwable -> L73
        Object r018 = Boolean.valueOf(C0661h1.m1661c("home_drawer_signature_tip_shown", false));     // Catch: Throwable -> L73
    L75:
    ...
    L78:
        ...
        Object r019 = C0661h1.m1662d("home_drawer_signature", "OKK 快捷面板");     // Catch: Throwable -> L81
    L84:
    ...
    L109:
        ...
        C0661h1 r029 = C0661h1.f2048a;     // Catch: Throwable -> L112
        Object r030 = Boolean.valueOf(C0661h1.m1661c("virtual_location_enabled", false));     // Catch: Throwable -> L112
    L114:
    ...
    L117:
        ...
        C0661h1 r031 = C0661h1.f2048a;     // Catch: Throwable -> L120
        Object r032 = Boolean.valueOf(C0661h1.m1661c("bottom_tab_floating", false));     // Catch: Throwable -> L120
    L122:
    ...
    L125:
        ...
        C0752m r213 = new C0752m("⚙", "模块设置", "全部功能开关 · 配置", new C0742c(r32, 0));
        C0752m r35 = new C0752m("🎨", "主题", "主界面壁纸 · 实时透明度", new C0742c(r32, 1));
        if (r111 == false) goto L128;
        String r112 = "已开启 · 点进配置";
    L129:
        C0752m r48 = new C0752m("📍", "虚拟定位", r112, new C0742c(r32, 2));
        if (r033 == false) goto L132;
        String r53 = "已开启 · 点进配置";
    L133:
        m866P(r62, r32, r21, r09, r011, r8, AbstractC0182m.m556h0(new C0752m[]{r213, r35, r48, new C0752m("▢", "悬浮底栏", r53, new C0742c(r32, 3))}));
        m889h0(r62, r32, "其它", r011, r8);
        m866P(r62, r32, r21, r09, r011, r8, AbstractC0182m.m556h0(new C0752m[]{new C0752m("💬", "帮助与反馈", "Telegram 群", new C0742c(r32, 11)), new C0752m("ℹ", "关于", "模块设置 · 关于页", new C0742c(r32, 12))}));
    ...
    public static C0569s m882d0(Context r13) {
        AbstractC0307g.m703e(r13, "context");
        C0569s r02 = C0569s.f1683h;
        if (r02 == null) goto L5;
        return r02;
    L5:
    ...
    L71:
        EnumC0568r r9 = r2;
    L73:
        C0569s r134 = new C0569s(r6, r11, r9, r10);
        C0569s.f1683h = r134;
    ...
    public static C0551a m884e0(final Context r9, final C0817b r10, final ClassLoader r11, final String r12) {
        AbstractC0307g.m703e(r9, "context");
        AbstractC0307g.m703e(r11, "classLoader");
        C0569s r02 = m882d0(r9);
        String r2 = m912u(r9, r02, r12);
        List r1 = AbstractC0561k.f1659b;
        int r3 = r1.size();
        ...
        List r13 = (List) AbstractC0553c.m1367f(r9, r11, r12, new C0554d(r9, r10, r11, r12));
        if (r13 != null) goto L7;
        m919x0("DexKit unavailable, class-only probes");
        r13 = m886f0(new C0562l(r11, null, r9, r12), r10);
    L7:
        C0551a r92 = new C0551a(r2, r02.m1383a(), System.currentTimeMillis(), m870T(r02, r13), true);
        m888g0(r92);
        f730j = true;
    ...
    L13:
        ...
        int r14 = r112 + 1;
        if (r112 < 0) goto L19;
        r10.m2126a(Integer.valueOf(r14), Integer.valueOf(r3), AbstractC0561k.m1371a((C0556f) r122, r112));
    ...
    L19:
        ...
        throw null;
    L21:
        C0551a r94 = new C0551a(r2, r02.m1383a(), System.currentTimeMillis(), r42.f1641d, true);
        m888g0(r94);
    ...
    L28:
        ...
        r95 = r102;
    L31:
        C0551a r96 = new C0551a(r2, r02.m1383a(), System.currentTimeMillis(), m870T(r02, (List) r95), true);
        m888g0(r96);
        return r96;
    L26:
        th = move-exception;
    ...
    public static ArrayList m886f0(C0562l r10, C0817b r11) {
        List r02 = AbstractC0561k.f1659b;
        int r1 = r02.size();
    ...
    L4:
        ...
        String r32 = AbstractC0561k.m1371a(r42, r3);
    ...
    L12:
        ...
        if (r7 == null) goto L19;
        EnumC0563m r9 = EnumC0563m.f1666c;
        String r72 = r7.getMessage();
        if (r72 != null) goto L18;
        r72 = "error";
    L18:
        r43 = new C0564n("?", r32, r9, r72);
    L19:
        C0564n r44 = (C0564n) r43;
        String r73 = r44.f1669b;
        if (AbstractC0425j.m1013R0(r73) == false) goto L22;
    L23:
        r44 = C0564n.m1375a(r44, r32, null, null, 13);
    L24:
    ...
    public static void m888g0(C0551a r7) {
        f727g = r7;
    ...
    L12:
        ...
        C0564n r3 = (C0564n) r2.next();     // Catch: Throwable -> L14
    ...
    /* JADX INFO: renamed from: u */
    public static String m912u(Context r8, C0569s r9, String r10) {
