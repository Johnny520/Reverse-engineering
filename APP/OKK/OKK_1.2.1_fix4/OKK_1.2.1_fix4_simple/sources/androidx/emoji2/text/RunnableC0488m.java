...
public final class RunnableC0488m implements Runnable {
    ...
    L24:
        ...
        throw th;
    L5:
        if (C0830i.f3003d.get() == false) goto L8;
        return;
    L8:
        ...
        return;
    L13:
        if (C0830i.f3005f.incrementAndGet() > 40) goto L34;
        C0830i r02 = C0830i.f3000a;
        Activity r03 = C0830i.m2152b();
        if (r03 == null) goto L18;
        C0830i.m2151a(r03, "poll");
    L18:
        C0830i.f3001b.postDelayed(this, 500);
        return;
    }
}
