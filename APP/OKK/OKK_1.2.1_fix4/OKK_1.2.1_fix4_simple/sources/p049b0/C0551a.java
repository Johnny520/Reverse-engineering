...
public final class C0551a {
    ...
    public C0551a(String r2, String r3, long r4, List r6, boolean r7) {
    ...
    /* JADX INFO: renamed from: a */
    public final C0564n m1357a(String r4) {
        Iterator r02 = this.f1641d.iterator();
    L4:
        if (r02.hasNext() == false) goto L8;
        Object r1 = r02.next();
        if (AbstractC0307g.m699a(((C0564n) r1).f1668a, r4) == false) goto L4;
    L10:
        return (C0564n) r1;
    L8:
        r1 = null;
    ...
    L9:
        ...
        if (((C0564n) r03.next()).f1670c != EnumC0563m.f1666c) goto L9;
        r2 = r2 + 1;
        if (r2 >= 0) goto L9;
    ...
    L9:
        if (r03.hasNext() == false) goto L17;
        if (((C0564n) r03.next()).f1670c != EnumC0563m.f1664a) goto L9;
        r2 = r2 + 1;
        if (r2 >= 0) goto L9;
        AbstractC0182m.m557i0();
        throw null;
    ...
    L9:
        if (r03.hasNext() == false) goto L17;
        if (((C0564n) r03.next()).f1670c != EnumC0563m.f1665b) goto L9;
        r2 = r2 + 1;
        if (r2 >= 0) goto L9;
        AbstractC0182m.m557i0();
        throw null;
    ...
    public final boolean equals(Object r8) {
        ...
        return true;
    L6:
        if ((r8 instanceof C0551a) == true) goto L8;
        return false;
    L8:
        C0551a r82 = (C0551a) r8;
