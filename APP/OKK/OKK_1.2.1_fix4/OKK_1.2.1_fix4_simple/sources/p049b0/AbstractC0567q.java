...
public abstract class AbstractC0567q {
    ...
    L17:
        if (r4 == null) goto L24;
        Class r2 = AbstractC0553c.m1362a(r4, r5, r6, new String[]{"MicroMsg.ConfigStorageLogic", "get userinfo fail"});
        if (r2 != null) goto L21;
        r2 = AbstractC0553c.m1362a(r4, r5, r6, new String[]{"MicroMsg.ConfigStorageLogic"});
    L21:
        if (r2 == null) goto L24;
        r02.set(r2);
