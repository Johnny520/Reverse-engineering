...
public abstract class AbstractC0567q {
    ...
    public static Class m1378a(Context context, ClassLoader classLoader, String str) {
        ...
        if (context != null) {
            Class clsM1362a = AbstractC0553c.m1362a(context, classLoader, str, "MicroMsg.ConfigStorageLogic", "get userinfo fail");
            if (clsM1362a == null) {
                clsM1362a = AbstractC0553c.m1362a(context, classLoader, str, "MicroMsg.ConfigStorageLogic");
            }
            if (clsM1362a != null) {
