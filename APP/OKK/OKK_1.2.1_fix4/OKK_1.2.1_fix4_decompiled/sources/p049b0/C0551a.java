...
public final class C0551a {
    ...
    public C0551a(String str, String str2, long j2, List list, boolean z2) {
    ...
    /* JADX INFO: renamed from: a */
    public final C0564n m1357a(String str) {
        Object next;
        ...
        while (true) {
            ...
            next = it.next();
            if (AbstractC0307g.m699a(((C0564n) next).f1668a, str)) {
                break;
            }
        }
        return (C0564n) next;
    ...
    public final int m1358b() {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (((C0564n) it.next()).f1670c == EnumC0563m.f1666c && (i2 = i2 + 1) < 0) {
    ...
    public final int m1359c() {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                if (((C0564n) it.next()).f1670c == EnumC0563m.f1664a && (i2 = i2 + 1) < 0) {
                    AbstractC0182m.m557i0();
                    throw null;
                }
            }
    ...
    public final int m1360d() {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                if (((C0564n) it.next()).f1670c == EnumC0563m.f1665b && (i2 = i2 + 1) < 0) {
                    AbstractC0182m.m557i0();
                    throw null;
                }
            }
    ...
    public final boolean equals(Object obj) {
        ...
        return AbstractC0307g.m699a(this.f1638a, c0551a.f1638a) && AbstractC0307g.m699a(this.f1639b, c0551a.f1639b) && this.f1640c == c0551a.f1640c && AbstractC0307g.m699a(this.f1641d, c0551a.f1641d) && this.f1642e == c0551a.f1642e;
    }
