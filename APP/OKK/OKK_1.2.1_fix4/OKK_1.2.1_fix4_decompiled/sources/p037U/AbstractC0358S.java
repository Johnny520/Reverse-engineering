...
import p049b0.C0556f;
import p049b0.C0562l;
import p049b0.C0564n;
import p049b0.C0569s;
import p049b0.EnumC0563m;
import p049b0.EnumC0568r;
import p050c0.C0571A0;
import p050c0.C0591H;
import p050c0.C0601K0;
import p050c0.C0661h1;
import p050c0.EnumC0583E0;
import p052d0.C0741b;
import p052d0.C0742c;
import p052d0.C0752m;
import p052d0.C0753n;
import p052d0.C0754o;
import p052d0.C0755p;
import p052d0.ViewOnClickListenerC0740a;
import p052d0.ViewOnClickListenerC0745f;
import p052d0.ViewOnKeyListenerC0747h;
...
public abstract class AbstractC0358S {
    ...
    public static volatile C0551a f727g;
    ...
    */
    ...
    public static C0551a m862L() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                EnumC0563m enumC0563mValueOf = EnumC0563m.valueOf(string3);
                String strOptString = jSONObject2.optString("detail", "");
                AbstractC0307g.m702d(strOptString, "optString(...)");
                arrayList.add(new C0564n(string, string2, enumC0563mValueOf, strOptString));
            }
            ...
            C0551a c0551a = new C0551a(string4, strOptString2, jSONObject.optLong("atMs", 0L), arrayList, false);
            f727g = c0551a;
            objM116u = c0551a;
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
        return (C0551a) (objM116u instanceof C0140f ? null : objM116u);
    }
    ...
    public static List m863M() {
        ...
        try {
            ...
            objM116u = C0661h1.m1662d("home_drawer_shortcuts", "");
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
    ...
    */
    ...
    /* JADX INFO: renamed from: T */
    public static ArrayList m870T(C0569s c0569s, List list) {
        int i2;
        ArrayList arrayList = new ArrayList(AbstractC0183n.m559k0(list, 10));
        Iterator it = list.iterator();
        while (it.hasNext()) {
            C0564n c0564nM1375a = (C0564n) it.next();
            EnumC0563m enumC0563m = c0564nM1375a.f1670c;
            if (enumC0563m != EnumC0563m.f1666c) {
                boolean z2 = c0569s.f1688e == 8 && c0569s.f1689f == 0 && 69 <= (i2 = c0569s.f1690g) && i2 < 77;
                EnumC0563m enumC0563m2 = EnumC0563m.f1665b;
                String str = c0564nM1375a.f1671d;
                if (!z2) {
                    c0564nM1375a = C0564n.m1375a(c0564nM1375a, null, enumC0563m2, AbstractC0425j.m1013R0(str) ? "超出主适配范围，按静态特征估计" : "超出主适配范围，按静态特征估计 · ".concat(str), 3);
                } else if (c0569s.f1686c == EnumC0568r.f1681c && enumC0563m == EnumC0563m.f1664a) {
                    c0564nM1375a = C0564n.m1375a(c0564nM1375a, null, enumC0563m2, AbstractC0425j.m1013R0(str) ? "渠道未识别，需运行时验证" : "渠道未识别，需运行时验证 · ".concat(str), 3);
                }
            }
    ...
    */
    ...
    public static C0753n m881d(final Activity activity) {
        ...
        try {
            C0661h1 c0661h1 = C0661h1.f2048a;
            objM116u = Boolean.valueOf(C0661h1.m1661c("home_drawer_signature_tip_shown", false));
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
        ...
        try {
            objM116u2 = C0661h1.m1662d("home_drawer_signature", "OKK 快捷面板");
        } catch (Throwable th2) {
            objM116u2 = AbstractC0040p.m116u(th2);
        }
        if (objM116u2 instanceof C0140f) {
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: d0.j
            ...
            public final void onClick(View view3) {
                ...
                try {
                    ...
                    objM116u5 = C0661h1.m1662d("home_drawer_signature", "OKK 快捷面板");
                } catch (Throwable th3) {
                ...
                TextView textViewM907r0 = AbstractC0358S.m907r0(activity2, i4, f3, i5, z4, "保存", true, new C0744e(editText, textView3, activity2, dialog));
        ...
        InterfaceC0275a interfaceC0275a2 = new InterfaceC0275a() { // from class: d0.l
            ...
            public final Object invoke() {
                ...
                AbstractC0307g.m703e(activity2, "$activity");
                C0742c c0742c = new C0742c(activity2, 6);
                                ...
                                while (it3.hasNext()) {
                                    if (((EnumC0583E0) it3.next()) == enumC0583E02) {
                                        if (list.size() <= 1) {
                                            ...
                                            AbstractC0188s.m562n0(list, new C0591H(4, enumC0583E02));
                ...
                linearLayout11.addView(AbstractC0358S.m901o0(activity2, i13, f3, i8, z5, "保存", true, new C0744e(arrayListM541A0, activity2, (Dialog) r32, c0742c)));
        ...
        try {
            C0661h1 c0661h12 = C0661h1.f2048a;
            objM116u3 = Boolean.valueOf(C0661h1.m1661c("virtual_location_enabled", false));
        } catch (Throwable th3) {
        ...
        try {
            ...
            objM116u4 = Boolean.valueOf(C0661h1.m1661c("bottom_tab_floating", false));
        } catch (Throwable th4) {
        ...
        m866P(linearLayout4, activity, color4, color2, color3, f2, AbstractC0182m.m556h0(new C0752m("⚙", "模块设置", "全部功能开关 · 配置", new C0742c(activity, 0)), new C0752m("🎨", "主题", "主界面壁纸 · 实时透明度", new C0742c(activity, 1)), new C0752m("📍", "虚拟定位", zBooleanValue2 ? "已开启 · 点进配置" : "未开启 · 点进配置", new C0742c(activity, 2)), new C0752m("▢", "悬浮底栏", ((Boolean) objM116u4).booleanValue() ? "已开启 · 点进配置" : "未开启 · 点进配置", new C0742c(activity, 3))));
        m889h0(linearLayout4, activity, "其它", color3, f2);
        m866P(linearLayout4, activity, color4, color2, color3, f2, AbstractC0182m.m556h0(new C0752m("💬", "帮助与反馈", "Telegram 群", new C0742c(activity, 11)), new C0752m("ℹ", "关于", "模块设置 · 关于页", new C0742c(activity, 12))));
    ...
    public static C0569s m882d0(Context context) {
        Object objM116u;
        Object objM116u2;
        EnumC0568r enumC0568r;
        String str;
        AbstractC0307g.m703e(context, "context");
        C0569s c0569s = C0569s.f1683h;
        if (c0569s != null) {
            return c0569s;
        }
        PackageManager packageManager = context.getPackageManager();
        ...
        C0569s c0569s2 = new C0569s(str3, longVersionCode, enumC0568r, str2);
        C0569s.f1683h = c0569s2;
        try {
            AbstractC0762d.m1954d("[OKK-WxVer] " + AbstractC0324d.m725h("resolved ", c0569s2.m1383a()));
        } catch (Throwable th3) {
    ...
    public static C0551a m884e0(final Context context, final C0817b c0817b, final ClassLoader classLoader, final String str) {
        Object objM116u;
        AbstractC0307g.m703e(context, "context");
        AbstractC0307g.m703e(classLoader, "classLoader");
        C0569s c0569sM882d0 = m882d0(context);
        String strM912u = m912u(context, c0569sM882d0, str);
        List list = AbstractC0561k.f1659b;
        int size = list.size();
        ...
        if (!f730j) {
            List listM886f0 = (List) AbstractC0553c.m1367f(context, classLoader, str, new InterfaceC0286l() { // from class: b0.d
            ...
            C0551a c0551a = new C0551a(strM912u, c0569sM882d0.m1383a(), System.currentTimeMillis(), m870T(c0569sM882d0, listM886f0), true);
            m888g0(c0551a);
            f730j = true;
            m919x0("probe done " + c0551a.m1361e());
            moduleLog.m1813i("适配检查完成 · " + c0551a.m1361e());
            return c0551a;
        }
        ...
        if (c0551aM862L == null) {
            ...
            C0551a c0551a2 = new C0551a(strM912u, c0569sM882d0.m1383a(), System.currentTimeMillis(), m870T(c0569sM882d0, (List) objM116u), true);
            m888g0(c0551a2);
            return c0551a2;
        }
        int i2 = 0;
        for (Object obj2 : list) {
            ...
            c0817b.m2126a(Integer.valueOf(i3), Integer.valueOf(size), AbstractC0561k.m1371a((C0556f) obj2, i2));
            try {
                Thread.sleep(15L);
        ...
        C0551a c0551a3 = new C0551a(strM912u, c0569sM882d0.m1383a(), System.currentTimeMillis(), c0551aM862L.f1641d, true);
        m888g0(c0551a3);
        m919x0("re-scan done (cached) " + c0551a3.m1361e());
        ModuleLog.INSTANCE.m1813i("适配复检完成（复用缓存） · " + c0551a3.m1361e());
        return c0551a3;
    }
    ...
    */
    ...
    public static ArrayList m886f0(C0562l c0562l, C0817b c0817b) {
        ...
        for (Object obj : list) {
            ...
            String strM1371a = AbstractC0561k.m1371a(c0556f, i2);
            ...
            if (thM465a != null) {
                ...
                objM116u = new C0564n("?", strM1371a, enumC0563m, message);
            }
            C0564n c0564nM1375a = (C0564n) objM116u;
            String str = c0564nM1375a.f1669b;
            if (AbstractC0425j.m1013R0(str) || str.equals("?")) {
                c0564nM1375a = C0564n.m1375a(c0564nM1375a, strM1371a, null, null, 13);
            }
    ...
    public static void m888g0(C0551a c0551a) {
        Object objM116u;
        f727g = c0551a;
        f728h = c0551a.f1642e || m869S(c0551a.f1638a);
        try {
            new File("/sdcard/Android/media/com.tencent.mm/OKK").mkdirs();
            JSONArray jSONArray = new JSONArray();
            for (C0564n c0564n : c0551a.f1641d) {
                jSONArray.put(new JSONObject().put("id", c0564n.f1668a).put("title", c0564n.f1669b).put("level", c0564n.f1670c.name()).put("detail", c0564n.f1671d));
            }
            JSONObject jSONObjectPut = new JSONObject().put("fingerprint", c0551a.f1638a).put("wechat", c0551a.f1639b).put("atMs", c0551a.f1640c).put("summary", c0551a.m1361e()).put("results", jSONArray).put("pendingDialog", f728h);
            File file = new File(new File("/sdcard/Android/media/com.tencent.mm/OKK"), "compat_report.json");
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static String m912u(Context context, C0569s c0569s, String str) {
        Object objM116u;
        AbstractC0307g.m703e(context, "context");
        ...
        return c0569s.f1685b + "|" + c0569s.f1684a + "|1.2.1|wx=" + strM872X + "|mod=" + strM872X2;
    }
