...
public final class C0651e0 {
    ...
    public static final C0651e0 f2022a = new C0651e0();
    ...
    public static boolean m1633b() {
        ...
        try {
            ...
            objM116u = Boolean.valueOf(C0661h1.m1661c("download_redirect_enabled", false));
        } catch (Throwable th) {
    ...
    public static String m1634c() {
        ...
        try {
            C0661h1 c0661h1 = C0661h1.f2048a;
            objM116u = C0661h1.m1662d("download_redirect_dir", "/storage/emulated/0/Android/media/com.tencent.mm/OKK/download");
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
        if (objM116u instanceof C0140f) {
    ...
    public static void m1635d(String str) {
        ...
        C0661h1 c0661h1 = C0661h1.f2048a;
        C0661h1.m1664h("download_redirect_dir", string);
    }
