...
public final class C0590G1 {
    ...
    public static void m1440C(ImageView imageView) {
        float fM1387c = C0575B1.m1387c(C0575B1.f1701a.m1391a());
    ...
    public static boolean m1443a(Activity activity) {
        ...
        Bitmap bitmapM1392b = c0575b1.m1392b();
        ...
        try {
            C0575B1.m1390g(false);
            String str = C0575B1.f1706f + ":" + C0575B1.f1707g;
            m1445c(activity);
            m1444b(activity);
            m1446d(activity);
            ...
            imageView.setAlpha(C0575B1.m1387c(C0575B1.f1701a.m1391a()));
            m1440C(imageView);
            return true;
        } catch (Throwable th) {
    ...
    */
        ...
        try {
            ...
            if (!zM1393e) {
                ...
                if (activityM1468z == null && weakHashMap.isEmpty()) {
                    ...
                    m1441D("forceApply n=" + i2 + " elev=50000.0 a=" + c0575b12.m1391a());
                    objM116u = "已应用 " + i2 + " 处 · 不透明度" + ((int) (c0575b12.m1391a() * 100)) + "%（顶层遮罩）";
                }
            }
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
    ...
    public static boolean m1456n(ViewGroup viewGroup, Bitmap bitmap, String str) {
        ...
        float fM1387c = C0575B1.m1387c(C0575B1.f1701a.m1391a());
        String str2 = str + ":" + C0575B1.m1388d(fM1387c);
        int i2 = 0;
