    ...
    public final void run() {
        ...
        switch (this.f1850a) {
            case 0:
                ...
                Object objM1587i0 = C0639a0.m1587i0(view, obj);
                if (!C0639a0.m1562S(objM1587i0) && !C0639a0.m1561R(objM1587i0)) {
                    C0639a0.m1601p0("left swipe quote retry failed for ".concat(objM1587i0.getClass().getName()));
                }
                break;
            default:
                AbstractC0307g.m703e(obj, "$currentMsg");
                C0639a0 c0639a02 = C0639a0.f1967a;
                if (!C0639a0.m1562S(C0639a0.m1587i0(view, obj)) && !C0639a0.m1561R(obj)) {
                    C0639a0.m1601p0("left swipe quote retry after clear failed for ".concat(obj.getClass().getName()));
                }
                break;
        }
    }
