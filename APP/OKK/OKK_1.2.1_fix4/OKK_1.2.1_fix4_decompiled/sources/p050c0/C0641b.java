    ...
    public final Object invoke(Object obj) {
        ...
        switch (this.f1996a) {
            case 0:
                ...
                AbstractC0307g.m703e((C0656g) obj3, "$this_runCatching");
            ...
            case 1:
                ...
                if (atomicBoolean.compareAndSet(false, true)) {
                    C0688q1.f2169g.post(new RunnableC0328h(activity, str2, 2));
                }
                return c0146l;
            default:
                ...
                if (z3) {
                    ConcurrentHashMap concurrentHashMap = C0688q1.f2170h;
                    String str4 = ((C0679n1) abstractC0685p1).f2136a;
                    concurrentHashMap.put(str3, str4);
                    C0688q1.m1780q();
                    String strM1767b = C0688q1.m1767b(str4);
                    ...
                    C0688q1.m1782s("got " + str3 + " => " + str4 + " tail=" + str);
                    InterfaceC0286l interfaceC0286l = (InterfaceC0286l) obj2;
                    if (interfaceC0286l != null) {
                        interfaceC0286l.invoke(str4);
                    }
                    C0688q1.f2169g.post(new RunnableC0673l1(str3, abstractC0685p1, zBooleanValue ? 1 : 0));
                } else if (abstractC0685p1.equals(C0682o1.f2140a)) {
                    C0688q1.m1782s("no real name ".concat(str3));
                } else {
                    if (!(abstractC0685p1 instanceof C0676m1)) {
                        throw new C0137c();
                    }
                    C0688q1.f2171i.remove(str3);
                    C0688q1.m1782s("fetch fail " + str3 + ": " + ((C0676m1) abstractC0685p1).f2104a);
                }
                return c0146l;
        }
    }
