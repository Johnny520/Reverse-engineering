...
public abstract class AbstractC0626U {
    ...
    public static C0618Q m1532e(Context context, String str, boolean z2) {
        ...
        ConcurrentHashMap concurrentHashMap = f1936a;
        if (fileM1533f != null) {
            c0622s = (C0622S) concurrentHashMap.computeIfAbsent("file:" + fileM1533f.getAbsolutePath() + ":" + fileM1533f.lastModified(), new C0612O(new C0591H(1, fileM1533f), 0));
        } else {
            if (str == null) {
                return null;
            }
    ...
    public static File m1533f(boolean z2) {
        ...
        String strM1662d = C0661h1.m1662d(z2 ? "bubble_path_right" : "bubble_path_left", "");
