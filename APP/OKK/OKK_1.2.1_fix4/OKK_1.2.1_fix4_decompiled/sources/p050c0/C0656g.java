...
public final class C0656g {
    ...
    public static final C0656g f2040a = new C0656g();
    ...
    /* JADX INFO: renamed from: a */
    public static final void m1641a(C0656g c0656g, C0760b c0760b, boolean z2) {
        String[] strArr;
        String str;
        Object objM116u;
        Object objM116u2;
    ...
    public static boolean m1649j() {
        ...
        try {
            ...
            objM116u = Boolean.valueOf(C0661h1.m1661c("anti_moments_comment_revoke", true));
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
    ...
    public static void m1650k(Context context, String str) {
        String str2;
