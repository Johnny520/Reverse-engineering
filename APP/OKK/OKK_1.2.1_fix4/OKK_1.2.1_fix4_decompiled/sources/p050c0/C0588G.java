...
public final class C0588G {
    ...
    public static final String m1415b(String str) {
        List listM1808c = C0710y.m1808c();
        List list = C0710y.f2234a;
    ...
    public static void m1416c() {
        C0758s c0758s = f1770c;
        if (c0758s == null) {
            return;
        }
        c0758s.setMainUnread(f1778k);
        c0758s.setContactUnread(f1779l);
        boolean z2 = false;
        c0758s.setContactDot(false);
        c0758s.setFriendUnread(f1780m);
        if (f1780m <= 0 && (f1781n || f1782o)) {
            z2 = true;
        }
        c0758s.setFriendDot(z2);
    }
    ...
    public static void m1417d(int i2) {
        ...
        if (C0710y.m1807b()) {
            ...
            if (weakReference == null || (activity = (Activity) weakReference.get()) == null) {
                C0758s c0758s = f1770c;
                Context context = c0758s != null ? c0758s.getContext() : null;
    ...
    /* JADX INFO: renamed from: f */
    public static final void m1419f(C0758s c0758s, ViewGroup viewGroup, int i2) {
        if (c0758s.isAttachedToWindow()) {
            m1423j(viewGroup);
            c0758s.bringToFront();
            if (viewGroup.getWidth() > 0) {
                c0758s.setMinimumWidth(viewGroup.getWidth());
                c0758s.requestLayout();
                c0758s.invalidate();
            } else if (i2 > 0) {
                c0758s.postDelayed(new RunnableC0321a(i2, c0758s, viewGroup, 1), 50L);
            }
            m1436w("layout try parentW=" + viewGroup.getWidth() + " bar=" + c0758s.getWidth() + "x" + c0758s.getHeight() + " vis=" + c0758s.getVisibility() + " children=" + viewGroup.getChildCount());
        }
    }
    ...
    public static final Method m1427n(Context context, ClassLoader classLoader, String str, Class cls, String... strArr) {
        ...
        Method method = (Method) AbstractC0553c.m1367f(context, classLoader, str, new C0552b(classLoader, strArr2, 2));
        if (method == null) {
            return null;
        }
    ...
    */
    ...
    public static final void m1435v(final int i2, final ViewGroup viewGroup, final ViewGroup viewGroup2, final Object obj, final Object obj2) {
        ...
        if (C0710y.m1807b()) {
            ...
            boolean z2 = C0710y.f2238e;
            C0710y.m1806a(System.currentTimeMillis());
            C0758s c0758s2 = new C0758s(context2, listM1808c, z2, C0710y.f2239f, new C0570A(1), new C0570A(2));
            f1770c = c0758s2;
            c0758s2.setTag(2114916353, Boolean.TRUE);
            if (viewGroup3 != null) {
                try {
            ...
            try {
                viewGroup.addView(c0758s2, viewGroup instanceof FrameLayout ? new FrameLayout.LayoutParams(-1, -2, 80) : new FrameLayout.LayoutParams(-1, -2, 80));
                c0758s2.bringToFront();
                c0758s2.post(new RunnableC0328h(c0758s2, viewGroup, 1));
                m1418e(viewGroup2.getRootView());
                c0758s2.post(new RunnableC0579D(viewGroup2, 0));
                c0758s2.postDelayed(new RunnableC0579D(viewGroup2, 1), 200L);
                c0758s2.postDelayed(new RunnableC0579D(viewGroup2, 2), 800L);
