...
public final class C0575B1 {
    ...
    public static final C0575B1 f1701a = new C0575B1();
    ...
    public static void m1390g(boolean z2) {
        ...
        if (z2 || jUptimeMillis - f1703c >= 800 || f1703c <= 0) {
            ...
            Float fM1025z0 = AbstractC0431p.m1025z0(C0661h1.m1662d("theme_wallpaper_alpha", "0.28"));
            f1705e = m1387c(fM1025z0 != null ? fM1025z0.floatValue() : 0.28f);
            String absolutePath = "";
            String string = AbstractC0425j.m1022a1(C0661h1.m1662d("theme_wallpaper_path", "")).toString();
