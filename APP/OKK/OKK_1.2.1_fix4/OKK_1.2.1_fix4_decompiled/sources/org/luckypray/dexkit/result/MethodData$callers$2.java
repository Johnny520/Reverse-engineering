...
public final class MethodData$callers$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$callers$2(DexKitBridge dexKitBridge, MethodData methodData, int i2, int i3) {
        super(0);
    ...
    public final MethodDataList invoke() {
        ...
        byte[] bArrNativeGetCallMethods = DexKitBridge.Companion.nativeGetCallMethods(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id));
