...
public final class FieldData$annotations$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public FieldData$annotations$2(DexKitBridge dexKitBridge, FieldData fieldData, int i2, int i3) {
        super(0);
    ...
    public final List<AnnotationData> invoke() {
        ...
        byte[] bArrNativeGetFieldAnnotations = DexKitBridge.Companion.nativeGetFieldAnnotations(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id));
