...
public final class FindMethod extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createFindMethod(C0733b c0733b, int i2, int i3, boolean z2, int i4, int i5, boolean z3, int i6) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(7);
        ...
        public final int endFindMethod(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
        ...
        public final void startFindMethod(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(7);
        }
        ...
        public final FindMethod getRootAsFindMethod(ByteBuffer byteBuffer, FindMethod findMethod) {
            AbstractC0307g.m703e(byteBuffer, "_bb");
            AbstractC0307g.m703e(findMethod, "obj");
            return findMethod.__assign(byteBuffer.position() + AbstractC0324d.m719b(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
    }

    public final FindMethod __assign(int i2, ByteBuffer byteBuffer) {
        AbstractC0307g.m703e(byteBuffer, "_bb");
