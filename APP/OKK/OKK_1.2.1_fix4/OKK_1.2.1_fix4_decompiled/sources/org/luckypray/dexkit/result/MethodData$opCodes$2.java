...
public final class MethodData$opCodes$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$opCodes$2(DexKitBridge dexKitBridge, MethodData methodData, int i2, int i3) {
        super(0);
    ...
    public final List<Integer> invoke() {
        ...
        return AbstractC0179j.m539p0(DexKitBridge.Companion.nativeGetMethodOpCodes(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id)));
    }
}
