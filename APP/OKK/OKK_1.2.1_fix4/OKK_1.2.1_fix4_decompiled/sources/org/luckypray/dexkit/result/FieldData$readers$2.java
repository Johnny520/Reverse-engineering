...
public final class FieldData$readers$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public FieldData$readers$2(DexKitBridge dexKitBridge, FieldData fieldData, int i2, int i3) {
        super(0);
    ...
    public final MethodDataList invoke() {
        ...
        byte[] bArrNativeFieldGetMethods = DexKitBridge.Companion.nativeFieldGetMethods(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id));
