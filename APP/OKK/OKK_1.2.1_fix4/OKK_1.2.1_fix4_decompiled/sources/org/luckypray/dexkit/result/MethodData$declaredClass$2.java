...
public final class MethodData$declaredClass$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$declaredClass$2(DexKitBridge dexKitBridge, MethodData methodData, int i2) {
        super(0);
    ...
    public final ClassData invoke() {
        ...
        byte[] bArrNativeGetClassByIds = DexKitBridge.Companion.nativeGetClassByIds(dexKitBridge.getSafeToken(), new long[]{methodData.getEncodeId(this.$dexId, methodData.classId)});
