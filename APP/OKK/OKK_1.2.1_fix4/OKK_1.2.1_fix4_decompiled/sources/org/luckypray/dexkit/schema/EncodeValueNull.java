...
public final class EncodeValueNull extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createEncodeValueNull(C0733b c0733b, byte b2) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(1);
            addValue(c0733b, b2);
            return endEncodeValueNull(c0733b);
        }

        public final int endEncodeValueNull(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
        ...
        public final void startEncodeValueNull(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(1);
        }
        ...
        public final EncodeValueNull getRootAsEncodeValueNull(ByteBuffer byteBuffer, EncodeValueNull encodeValueNull) {
            AbstractC0307g.m703e(byteBuffer, "_bb");
            AbstractC0307g.m703e(encodeValueNull, "obj");
            return encodeValueNull.__assign(byteBuffer.position() + AbstractC0324d.m719b(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
    }

    public final EncodeValueNull __assign(int i2, ByteBuffer byteBuffer) {
        AbstractC0307g.m703e(byteBuffer, "_bb");
