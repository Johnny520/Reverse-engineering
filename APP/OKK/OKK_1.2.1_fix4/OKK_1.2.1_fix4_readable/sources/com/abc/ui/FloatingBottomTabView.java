...
public final class FloatingBottomTabView extends FrameLayout {
    ...
    */
    public FloatingBottomTabView(Context context, List list, boolean z2, boolean z3, C0570A c0570a, C0570A c0570a2) {
        Object obj;
        super(context);
        ...
        while (i2 < 4) {
            ...
            frameLayout.setOnClickListener(new View.OnClickListener() { // from class: d0.r
                ...
                public final void onClick(View view) {
                    FloatingBottomTabView floatingBottomTabView = this.f2632a;
                    AbstractC0307g.m703e(floatingBottomTabView, "this$0");
                    SystemClock.uptimeMillis();
                    int i3 = floatingBottomTabView.f2635A;
                    int i4 = i2;
                    if (i4 != i3) {
                        floatingBottomTabView.f2635A = i4;
                        floatingBottomTabView.m1938a(i4);
                        floatingBottomTabView.f2645d.invoke(Integer.valueOf(i4));
                        return;
                    }
                    TextView textView = floatingBottomTabView.f2661t[i4];
                    if (textView != null) {
                        textView.animate().cancel();
                        textView.animate().scaleX(0.92f).scaleY(0.92f).setDuration(90L).withEndAction(new RunnableC0328h(textView, floatingBottomTabView, 6)).start();
                    }
                    floatingBottomTabView.f2646e.invoke(Integer.valueOf(i4));
                }
            });
