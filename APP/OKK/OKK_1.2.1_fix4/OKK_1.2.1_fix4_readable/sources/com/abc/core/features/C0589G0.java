...
public final class C0589G0 extends AbstractC0761c {
    ...
    public final /* synthetic */ InputStatsDatabase f1791c;

    public C0589G0(int i2) {
        this.f1790b = i2;
        switch (i2) {
            case 1:
                this.f1791c = InputStatsDatabase.f1818a;
                break;
            case 2:
                this.f1791c = InputStatsDatabase.f1818a;
                break;
    ...
    public final void mo1385a(C0760b c0760b) {
        switch (this.f1790b) {
            case 0:
                ...
                InputStatsDatabase.f1825h = obj instanceof View ? (View) obj : null;
            ...
            case 1:
                ...
                editText.post(new Runnable(editText, i2) { // from class: c0.H0
                    ...
                    /* JADX INFO: renamed from: b */
                    public final /* synthetic */ InputStatsDatabase f1808b;
...

                    {
                        ...
                        switch (i2) {
                            case 1:
                                this.f1808b = InputStatsDatabase.f1818a;
                    ...
                    public final void run() {
                        switch (this.f1807a) {
                            case 0:
                                ...
                                InputStatsDatabase.m1473a(editText2);
                                break;
                            default:
                                AbstractC0307g.m703e(this.f1808b, "$this_runCatching");
                                EditText editText3 = this.f1809c;
                                AbstractC0307g.m703e(editText3, "$input");
                                InputStatsDatabase.m1473a(editText3);
                                break;
                        }
                    }
                });
            ...
            default:
                ...
                if (editText2 == null || InputStatsDatabase.f1821d.get()) {
                    return;
                }
                this.f1791c.getClass();
                if (InputStatsDatabase.m1478f(editText2)) {
                    final int i3 = 1;
                        ...
                        public final void run() {
                            switch (this.f1807a) {
                                case 0:
                                    ...
                                    InputStatsDatabase.m1473a(editText22);
                                    break;
                                default:
                                    AbstractC0307g.m703e(this.f1808b, "$this_runCatching");
                                    EditText editText3 = this.f1809c;
