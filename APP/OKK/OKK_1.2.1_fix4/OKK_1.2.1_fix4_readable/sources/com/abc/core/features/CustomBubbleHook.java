...
public final class CustomBubbleHook extends AbstractC0761c {

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ int f1951b;

    /* JADX INFO: renamed from: c */
    public final /* synthetic */ MessageDetailHook f1952c;

    public CustomBubbleHook() {
        this.f1951b = 0;
        this.f1952c = MessageDetailHook.f1967a;
    }
    ...
    public void mo1385a(C0760b c0760b) {
        ...
        switch (this.f1951b) {
            case 0:
                MessageDetailHook messageDetailHook = this.f1952c;
                    ...
                    if (iIntValue == 658452 || iIntValue == 658453) {
                        ...
                        if (num2 != null && num2.intValue() == -1) {
                            ...
                            try {
                                ...
                                configStore.m1666f(str, absolutePath, false);
                                configStore.m1667g("bubble_enabled", true, false);
                                ...
                                messageDetailHook.getClass();
                                MessageDetailHook.m1601p0(str2);
                            ...
                            if (thM465a != null) {
                                ...
                                messageDetailHook.getClass();
                                MessageDetailHook.m1601p0(str3);
    ...
    */
                ...
                if (c0686qM1753a.f2151g) {
                    ...
                    if (actionMasked == 1) {
                        ...
                        if (motionEvent.getActionMasked() == 1) {
                            ...
                            int iOrdinal = ((rawX >= ((float) (-MessageDetailHook.m1607u(context, 32))) || !c0686qM1753a.f2151g) ? EnumC0640a1.f1993a : EnumC0640a1.f1994b).ordinal();
                            if (iOrdinal != 0) {
                                if (iOrdinal == 1) {
                                    MessageDetailHook.m1601p0("left swipe quote delta=" + ((int) rawX));
                                    Object objM1587i0 = MessageDetailHook.m1587i0(view, tag);
                                    Object obj2 = MessageDetailHook.f1961A;
                                    ...
                                    } else if (!MessageDetailHook.m1562S(objM1587i0) && !MessageDetailHook.m1561R(objM1587i0)) {
                                        if (view2 != null) {
                                            view2.post(new RunnableC0603L(i3, view, objM1587i0));
                                        } else {
                                            MessageDetailHook.m1601p0("left swipe quote target not ready for ".concat(objM1587i0.getClass().getName()));
                                        }
                                    }
                                } else {
                                    if (iOrdinal != 2) {
                                    ...
                                    MessageDetailHook.m1601p0("right swipe repeat delta=" + ((int) rawX));
                                    if (!MessageDetailHook.m1563T(MessageDetailHook.f1961A, tag, "ChatFooter") && !MessageDetailHook.m1563T(MessageDetailHook.f1962B, tag, "quoteComponent")) {
                                        if (MessageDetailHook.m1562S(tag) || MessageDetailHook.m1561R(tag)) {
                                            MessageDetailHook.m1601p0("right swipe fallback to quote for ".concat(tag.getClass().getName()));
                                        } else {
                                            MessageDetailHook.m1601p0("right swipe repeat not ready for ".concat(tag.getClass().getName()));
                                        }
                                    }
                                }
                            }
                        ...
                        float fM1607u = MessageDetailHook.m1607u(context2, 120);
    ...
    public CustomBubbleHook(MessageDetailHook messageDetailHook) {
        this.f1951b = 1;
        this.f1952c = messageDetailHook;
    }
}
