    ...
    public final void run() {
        ...
        switch (this.f2097a) {
            case 0:
                ...
                CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) RealNameTailHook.f2172j.get(str);
            ...
            default:
                AbstractC0307g.m703e(abstractC0685p1, "$result");
                CopyOnWriteArrayList copyOnWriteArrayList2 = (CopyOnWriteArrayList) RealNameTailHook.f2172j.get(str);
                if (copyOnWriteArrayList2 != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (textView != null && AbstractC0307g.m699a(textView.getTag(2113929217), str)) {
                            ...
                            RealNameTailHook.m1766a(textView, str, ((C0679n1) abstractC0685p1).f2136a);
                        }
                    }
                }
                break;
