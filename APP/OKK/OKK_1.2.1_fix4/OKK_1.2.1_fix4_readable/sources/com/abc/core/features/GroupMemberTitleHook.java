...
public abstract class GroupMemberTitleHook {
    ...
    public static void m1496a(TextView textView, int i2) {
        ...
        if (i2 == 1) {
            ...
            c0143i = new C0143i(ConfigStore.m1662d("member_title_owner", "群主"), "#FFC107", "#FFFFFF");
        } else if (i2 != 2) {
            ConfigStore configStore2 = ConfigStore.f2048a;
            c0143i = new C0143i(ConfigStore.m1662d("member_title_member", "成员"), "#9E9E9E", "#FFFFFF");
        } else {
            ConfigStore configStore3 = ConfigStore.f2048a;
            c0143i = new C0143i(ConfigStore.m1662d("member_title_admin", "管理员"), "#2196F3", "#FFFFFF");
        }
        ...
        ConfigStore configStore4 = ConfigStore.f2048a;
        Iterator it = AbstractC0182m.m556h0(ConfigStore.m1662d("member_title_owner", "群主"), ConfigStore.m1662d("member_title_admin", "管理员"), ConfigStore.m1662d("member_title_member", "成员")).iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
    ...
    */
    ...
    public static boolean m1500e() {
        ...
        try {
            ConfigStore configStore = ConfigStore.f2048a;
            objM116u = Boolean.valueOf(ConfigStore.m1661c("member_title", false));
        } catch (Throwable th) {
                    ...
                    if (num4 != null) {
                        ...
                        if (f1881h == null && (classLoader2 = f1882i) != null) {
                            ...
                            if (i2 == i3) {
                                try {
                                    ConfigStore configStore = ConfigStore.f2048a;
                                    objM116u7 = Boolean.valueOf(ConfigStore.m1661c("member_title_show_member", true));
                                } catch (Throwable th3) {
                        ...
                        if (method3 == null || obj7 == null) {
                            ...
                            if (classLoader != null) {
                                ...
                                if (obj3 != null) {
                                    ...
                                    if (AntiRevokeProcessor.m1744g(str) && !AbstractC0425j.m1013R0(str2)) {
