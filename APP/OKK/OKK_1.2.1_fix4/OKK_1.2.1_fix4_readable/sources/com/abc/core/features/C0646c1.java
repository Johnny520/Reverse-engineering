    ...
    public void mo1385a(C0760b c0760b) {
        ...
        switch (this.f2008b) {
            case 0:
                ...
                if (MomentsAdsBlocker.m1630a() && (obj = c0760b.f2669b) != null) {
                    try {
                    ...
                    int iIncrementAndGet = MomentsAdsBlocker.f2018c.incrementAndGet();
                    if (iIncrementAndGet <= 5 || iIncrementAndGet % 50 == 0) {
                        MomentsAdsBlocker.m1631b("neutralized ADInfo #" + iIncrementAndGet);
                    }
                }
                break;
        }
