...
public final class MessageActionDispatcher extends AbstractC0761c {
    ...
    public /* synthetic */ MessageActionDispatcher(int i2, Object obj) {
        this.f2100b = i2;
        this.f2101c = obj;
    }
    ...
    public void mo1385a(C0760b c0760b) {
        ...
        switch (this.f2100b) {
            ...
            case 3:
                ...
                break;
            case 8:
                SettingsUiBuilder settingsUiBuilder = (SettingsUiBuilder) this.f2101c;
                    ...
                    if (num2 != null && num2.intValue() == -1) {
                        ...
                        if (intent != null) {
                            ...
                            if (activity != null && (data = intent.getData()) != null) {
                                try {
                                    strM2081a = SettingsUiBuilder.m2081a(settingsUiBuilder, data);
                                } catch (Throwable th) {
                                    objM116u = AbstractC0040p.m116u(th);
                                }
                                if (strM2081a != null && !AbstractC0425j.m1013R0(strM2081a)) {
                                    DownloadRedirector downloadRedirector = DownloadRedirector.f2022a;
                                    DownloadRedirector.m1635d(strM2081a);
                                    String string = data.toString();
                                    AbstractC0307g.m702d(string, "toString(...)");
                                    ConfigStore configStore = ConfigStore.f2048a;
                                    ConfigStore.m1664h("download_redirect_tree_uri", string);
                                    try {
                                        activity.getContentResolver().takePersistableUriPermission(data, 3);
                                    } catch (Throwable th2) {
                                        AbstractC0040p.m116u(th2);
                                    }
                                    ConfigStore.f2048a.m1667g("download_redirect_enabled", true, false);
                                    SettingsUiBuilder.m2105z(activity, "下载目录已设置：".concat(strM2081a));
                                    objM116u = C0146l.f339a;
                                    Throwable thM465a = AbstractC0141g.m465a(objM116u);
                                    if (thM465a != null) {
                                        String str = "设置目录失败：" + thM465a.getMessage();
                                        settingsUiBuilder.getClass();
                                        SettingsUiBuilder.m2105z(activity, str);
                                    }
                                }
                                SettingsUiBuilder.m2105z(activity, "无法解析所选目录，请重试");
                            }
                            break;
                        }
                    }
    ...
    */
    public void mo1386b(C0760b c0760b) {
        ...
        switch (this.f2100b) {
                ...
                if (str2 != null) {
                            ...
                            while (it.hasNext()) {
                                if (AbstractC0425j.m1005J0(str2, (String) it.next(), true)) {
                                    ...
                                    if (zEquals) {
                                        ...
                                        MessageDatabaseHook.m1708q("BLOCKED media table " + str3 + " on " + str2);
                                    }
                                    break;
                                }
                            }
                    ...
                    if (!str2.equalsIgnoreCase("rcontact")) {
                        if (str2.equals("message") && c0686qM1753a.f2145a) {
                            ...
                            if (contentValues != null && MessageDatabaseHook.m1692a(str3, contentValues, c0686qM1753a)) {
                                c0760b.m1946c(1);
                            }
                        }
                        break;
                        ...
                        if (contentValues2 != null) {
                            ...
                            if (string.length() != 0 && !AntiRevokeProcessor.m1744g(string)) {
                                ...
                                String strM1739b = AntiRevokeProcessor.m1739b(asString2);
                                if (strM1739b == null && (strM1739b = AntiRevokeProcessor.m1739b(asString3)) == null) {
                                    strM1739b = AntiRevokeProcessor.m1739b(asString4);
                                }
                                if (strM1739b != null) {
            ...
            case 1:
                ...
                break;
            case 2:
                ((HotUpdateBlocker) obj6).getClass();
            ...
            case 4:
                ...
                break;
            case 5:
                RealNameTailHook realNameTailHook = (RealNameTailHook) obj6;
                realNameTailHook.getClass();
                if (RealNameTailHook.m1771g()) {
                    ...
                    if (objM537n02 != null) {
                        ...
                        if (str5 != null && str5.equals("achat_real_name_tail")) {
                            ...
                            if (activity2 != null) {
                                String strM1778o = RealNameTailHook.m1778o(activity2);
                                if (strM1778o == null || AbstractC0425j.m1013R0(strM1778o)) {
                                    Toast.makeText(activity2, "无法获取微信 ID", 0).show();
                                } else {
                                    String str6 = (String) RealNameTailHook.f2170h.get(strM1778o);
                                    if (str6 != null) {
                                        ...
                                        RealNameTailHook.f2171i.remove(strM1778o);
                                        AtomicBoolean atomicBoolean2 = new AtomicBoolean(false);
                                        realNameTailHook.m1783c(strM1778o, str, new C0641b(atomicBoolean2, activity2, i4));
                                        RealNameTailHook.f2169g.postDelayed(new RunnableC0486k(atomicBoolean2, strM1778o, activity2, i2), 13000L);
                                    }
                                }
                                c0760b.m1946c(Boolean.TRUE);
                                break;
            ...
            case 6:
                ...
                if (c0709x1M1792a.f2230a) {
                    AvatarHook.m1797a((AvatarHook) obj6, c0760b.f2669b, c0709x1M1792a.f2231b);
                    break;
                }
                break;
            case 7:
                if (((Boolean) VirtualLocationHook.m1490e(VirtualLocationHook.f1854a).f334a).booleanValue()) {
            ...
            case 9:
                ...
                ((SettingsEntryInjector) obj6).getClass();
                try {
                    Number number = objM537n03 instanceof Number ? (Number) objM537n03 : null;
                    if (number != null) {
                        int iIntValue = number.intValue();
                        SparseArray sparseArrayM2143i = SettingsEntryInjector.m2143i(obj12);
                        boolean z5 = (sparseArrayM2143i == null || (obj5 = sparseArrayM2143i.get(iIntValue)) == null || (objM2144j = SettingsEntryInjector.m2144j(obj5)) == null || SettingsEntryInjector.m2145k(objM2144j) != 168566822) ? false : true;
                ...
                if (((Boolean) obj13).booleanValue()) {
                    ...
                    try {
                        Field fieldM2138d = SettingsEntryInjector.m2138d(obj14.getClass(), new C0813Y(22));
                        if (fieldM2138d != null) {
                    ...
                    if (context != null) {
                        ...
                        if (activity3 == null || activity3.isFinishing()) {
                            ...
                            try {
                                SettingsUiBuilder.f2933a.m2106w(activity3, C0802M.f2917b);
                                SettingsEntryInjector.m2146l("embedded ui shown");
                            ...
                            if (thM465a != null) {
                                ...
                                SettingsEntryInjector.m2146l("open fail: " + thM465a.getMessage());
                            }
                        }
                        c0760b.m1946c(null);
                        break;
    ...
    public MessageActionDispatcher(int i2) {
        this.f2100b = i2;
        switch (i2) {
            case 2:
