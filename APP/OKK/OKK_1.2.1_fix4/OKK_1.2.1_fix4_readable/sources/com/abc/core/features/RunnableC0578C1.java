...
public final /* synthetic */ class RunnableC0578C1 implements Runnable {
    ...
    public final void run() {
        ImageView imageView;
        Set setKeySet = WallpaperOverlayHook.f1799h.keySet();
        ...
        while (true) {
            ...
            if (!activity.isFinishing() && AbstractC0425j.m1005J0(activity.getClass().getName(), "LauncherUI", false)) {
                if (WallpaperOverlayHook.m1458p(activity)) {
                    WallpaperOverlayHook.m1453k(activity);
                } else {
                    WallpaperOverlayHook.m1443a(activity);
                }
            }
        }
        Set setEntrySet = WallpaperOverlayHook.f1797f.entrySet();
        ...
        for (Object obj2 : AbstractC0181l.m553y0(setEntrySet)) {
            ...
            if (!activity2.isFinishing() && (imageView = (ImageView) weakReference.get()) != null) {
                if (AbstractC0425j.m1005J0(activity2.getClass().getName(), "LauncherUI", false) && WallpaperOverlayHook.m1458p(activity2)) {
                    WallpaperOverlayHook.m1453k(activity2);
                } else {
