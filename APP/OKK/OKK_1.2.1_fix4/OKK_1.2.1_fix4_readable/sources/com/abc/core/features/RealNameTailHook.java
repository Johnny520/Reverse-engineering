...
public final class RealNameTailHook {

    /* JADX INFO: renamed from: a */
    public static final RealNameTailHook f2163a = new RealNameTailHook();
    ...
    public static void m1766a(TextView textView, String str, String str2) {
        ...
        if (z2 || !AbstractC0433r.m1028C0(string, strM723f)) {
            try {
                ...
                objM116u = Integer.valueOf(Color.parseColor(ConfigStore.m1662d("real_name_tail_color", "#9E9E9E")));
            } catch (Throwable th) {
    ...
    public static void m1769e(Class cls) {
        Object objM116u;
        InputStatsMessageHook inputStatsMessageHook = new InputStatsMessageHook(27, false);
                    ...
                    if (m1772h(cls2)) {
                        ...
                        if (m1772h(cls3)) {
                            ...
                            if (m1772h(cls4) && AbstractC0307g.m699a(parameterTypes[3], String.class)) {
                                method.setAccessible(true);
                                AbstractC0762d.m1952b(method, inputStatsMessageHook);
                                i2++;
                        ...
                        if (m1772h(cls5)) {
                            ...
                            if (m1772h(cls6)) {
                                ...
                                if (m1772h(cls7)) {
                                    try {
                                        method2.setAccessible(true);
                                        AbstractC0762d.m1952b(method2, inputStatsMessageHook);
                                        i2++;
    ...
    public static boolean m1771g() {
        ...
        try {
            ConfigStore configStore = ConfigStore.f2048a;
            objM116u = Boolean.valueOf(ConfigStore.m1661c("real_name_tail", false));
        } catch (Throwable th) {
            objM116u = AbstractC0040p.m116u(th);
        }
        ...
        for (superclass = obj2.getClass(); superclass != null && !superclass.equals(Object.class); superclass = superclass.getSuperclass()) {
            try {
                ...
                if (obj3 instanceof Number) {
                    ...
                    if (str4 == null) {
                        m1783c(str22, str3, new SettingsEntryHook(i2, c0613o0M1524f));
                        return;
                    } else {
