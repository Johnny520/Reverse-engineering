    ...
    public final Object invoke() {
        ...
        switch (this.f3045a) {
            case 0:
                ...
                C0139e c0139eM1493h = VirtualLocationHook.m1493h(activity);
                SettingsUiBuilder settingsUiBuilder = SettingsUiBuilder.f2933a;
                if (c0139eM1493h == null) {
                    SettingsUiBuilder.m2105z(activity, "无法获取当前位置，请开启系统定位权限");
                } else {
                    c0798i.f2899b.setText(VirtualLocationHook.m1488c(((Number) c0139eM1493h.f328a).doubleValue()));
                    c0798i2.f2899b.setText(VirtualLocationHook.m1488c(((Number) c0139eM1493h.f329b).doubleValue()));
                    SettingsUiBuilder.m2105z(activity, "已自动填入");
                }
                return c0146l;
            case 1:
                ...
                C0139e c0139eM1495b = VirtualLocationHook.f1854a.m1495b(activity2);
                ...
                VirtualLocationHook.m1494i(true, dDoubleValue, dM1024y02 != null ? dM1024y02.doubleValue() : ((Number) c0139eM1495b.f329b).doubleValue(), activity2, false);
                try {
                    ...
                    SettingsUiBuilder.m2105z(activity2, "请在地图上选择位置");
                ...
                if (AbstractC0141g.m465a(objM116u) != null) {
                    ...
                    SettingsUiBuilder.m2105z(activity2, "已发送选点请求，请在微信中确认");
                    break;
                }
                return c0146l;
            case 2:
                ...
                C0139e c0139eM1495b2 = VirtualLocationHook.f1854a.m1495b(activity3);
                ...
                VirtualLocationHook.m1494i(true, dDoubleValue2, dM1024y04 != null ? dM1024y04.doubleValue() : ((Number) c0139eM1495b2.f329b).doubleValue(), activity3, false);
                SettingsUiBuilder settingsUiBuilder3 = SettingsUiBuilder.f2933a;
                SettingsUiBuilder.m2105z(activity3, "已保存坐标并激活");
                return c0146l;
            default:
                ...
                if (c0139e != null && (list = (List) c0139e.f329b) != null) {
                    if (!list.isEmpty()) {
                        for (C0797H c0797h : list) {
                            ...
                            if (ConfigStore.m1661c(c0797h.f2894c, c0797h.f2895d) && (i2 = i2 + 1) < 0) {
                    ...
                    if (textView != null) {
                        ...
                        textView.setTextColor(i2 > 0 ? SettingsUiBuilder.f2942j : SettingsUiBuilder.f2940h);
                    }
                }
                return c0146l;
        }
