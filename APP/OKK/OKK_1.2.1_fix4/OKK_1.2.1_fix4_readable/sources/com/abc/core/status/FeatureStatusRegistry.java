...
public final class FeatureStatusRegistry {
    ...
    public static List m1961a() {
        ...
        for (Object obj : collectionValues) {
            if (((FeatureInstallResult) obj).f2720b == FeatureInstallStatus.f2724b) {
                arrayList.add(obj);
            }
        }
        ...
        while (it.hasNext()) {
            arrayList2.add(((FeatureInstallResult) it.next()).f2719a);
        }
    ...
    public static void m1963c(String str, Throwable th) {
        ...
        f2728a.put(str, new FeatureInstallResult(str, FeatureInstallStatus.f2724b, str2));
    ...
    public static void m1964d(String str, String str2) {
        f2728a.put(str, new FeatureInstallResult(str, FeatureInstallStatus.f2723a, str2));
    ...
    public static void m1965e(String str, String str2) {
        ...
        f2728a.put(str, new FeatureInstallResult(str, FeatureInstallStatus.f2726d, str2));
    ...
    public static void m1966f() {
        ...
        try {
            ...
            sb.append("---");
            sb.append('\n');
            for (FeatureInstallResult featureInstallResult : m1968h()) {
                sb.append(featureInstallResult.f2720b + "\t" + featureInstallResult.f2719a + "\t" + featureInstallResult.f2721c);
                sb.append('\n');
            }
    ...
    public static String m1969i() {
        ...
        if (collectionValues.isEmpty()) {
            ...
            i2 = 0;
            while (it.hasNext()) {
                if (((FeatureInstallResult) it.next()).f2720b == FeatureInstallStatus.f2723a && (i2 = i2 + 1) < 0) {
        ...
        if (collectionValues2.isEmpty()) {
            ...
            i3 = 0;
            while (it2.hasNext()) {
                if (((FeatureInstallResult) it2.next()).f2720b == FeatureInstallStatus.f2724b && (i3 = i3 + 1) < 0) {
                    AbstractC0182m.m557i0();
                    throw null;
                }
            }
        ...
        if (collectionValues3.isEmpty()) {
            ...
            i4 = 0;
            while (it3.hasNext()) {
                if (((FeatureInstallResult) it3.next()).f2720b == FeatureInstallStatus.f2725c && (i4 = i4 + 1) < 0) {
                    AbstractC0182m.m557i0();
                    throw null;
                }
            }
        ...
        if (!collectionValues4.isEmpty()) {
            ...
            while (it4.hasNext()) {
                if (((FeatureInstallResult) it4.next()).f2720b == FeatureInstallStatus.f2726d && (i5 = i5 + 1) < 0) {
                    AbstractC0182m.m557i0();
                    throw null;
                }
            }
