...
public final class ViewTreeObserverOnPreDrawListenerC0587F1 implements ViewTreeObserver.OnPreDrawListener, ViewGroup.OnHierarchyChangeListener {
    ...
    public final void onChildViewAdded(View view, View view2) {
        Activity activity;
        if (view2 == this.f1766c || (activity = (Activity) this.f1764a.get()) == null || !ThemeWallpaperConfig.f1701a.m1393e()) {
            return;
        }
        WallpaperOverlayHook.f1796e.post(new RunnableC0328h(activity, this, 4));
    }
    ...
    public final boolean onPreDraw() {
        ...
        if (activity != null && !activity.isFinishing() && ThemeWallpaperConfig.f1701a.m1393e()) {
            ...
            if (zM1005J0) {
                ...
                Long l2 = (Long) WallpaperOverlayHook.f1801j.get(activity);
                if (l2 != null && l2.longValue() > SystemClock.uptimeMillis()) {
                    if (imageView.getParent() != viewGroup) {
                        return true;
                    }
                    WallpaperOverlayHook.m1440C(imageView);
                    return true;
                }
            }
            if (AbstractC0425j.m1005J0(activity.getClass().getName(), "LauncherUI", false)) {
                ...
                if (WallpaperOverlayHook.m1458p(activity)) {
                    WallpaperOverlayHook.m1454l(activity);
                    return true;
                }
            }
            if (imageView.getParent() != viewGroup) {
            ...
            if (childCount >= 0 && viewGroup.getChildAt(childCount) != imageView) {
                WallpaperOverlayHook.m1460r(imageView);
            }
        }
        return true;
    }
