    ...
    public void mo1385a(C0760b c0760b) {
        ...
        switch (this.f2199b) {
            ...
            case 1:
                ...
                if (activity2 != null) {
                    C0707x c0707xM1785a2 = PcAutoLoginConfig.m1785a();
                    ...
                    if (objM537n0 != null) {
                        ...
                        if (number != null) {
                            ...
                            if (classLoader != null || (classLoader = objM537n0.getClass().getClassLoader()) != null) {
                                ...
                                MessageDetailHook.m1572b(c0760b.f2669b, objM537n0, iIntValue, classLoader);
                            }
                        }
                    }
                } catch (Throwable th) {
                    if (MessageDetailHook.f1974h.compareAndSet(false, true)) {
            ...
            case 3:
                ...
                if (charSequence != null && charSequence.length() <= 80 && AbstractC0358S.m859I(charSequence.toString())) {
                    ...
                    if (view != null) {
                        MessageDetailHook.m1570a(view);
                        MessageDetailHook.m1574c(AbstractC0324d.m725h("MMNeat.", method.getName()), view.getClass().getName());
                        break;
                    }
                }
                break;
            case 4:
                ...
                if (string != null && AbstractC0358S.m859I(string)) {
                    ...
                    if (view2 != null) {
                        MessageDetailHook.m1570a(view2);
                        MessageDetailHook.m1574c(AbstractC0324d.m725h("X2CTextView.", method.getName()), view2.getClass().getName());
                        break;
                    }
                }
                break;
                ...
                try {
                    ...
                    if (objM537n0 != null) {
                        ...
                        if (number != null) {
                            ...
                            if (classLoader != null || (classLoader = objM537n0.getClass().getClassLoader()) != null) {
                                MessageDetailHook messageDetailHook = MessageDetailHook.f1967a;
                                View viewM1553I = MessageDetailHook.m1553I(objM537n0);
                                if (viewM1553I != null) {
                                    ...
                                    if (objM1537c != null) {
                                        ...
                                        MessageDetailHook.m1591k0(viewM1553I, objM1537c, classLoader);
                                    }
                                }
                            }
                        }
                        ...
                        if (number2 != null) {
                            ...
                            if (fMin > 1.0f) {
                                ...
                                if (((0.03f <= f4 && f4 <= 0.6f) || fFloatValue <= fMin * 0.6f) && Math.abs(f3 - fFloatValue) > 0.01f) {
                                    ...
                                    AvatarHook.m1798b(AvatarHook.f2217a, "BitmapUtil." + method.getName() + " " + fFloatValue + "→" + f3, f2);
                                    break;
                                }
                            }
                        }
