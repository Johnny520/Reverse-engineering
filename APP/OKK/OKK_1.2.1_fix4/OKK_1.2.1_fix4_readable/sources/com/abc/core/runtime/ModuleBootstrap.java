...
public final class ModuleBootstrap {
    ...
    public static final void m2127a(Context context, ClassLoader classLoader, String str) {
        ...
        FeatureStatusRegistry.f2728a.clear();
        FeatureStatusRegistry.f2731d.clear();
        FeatureStatusRegistry.f2729b.set(0);
        FeatureStatusRegistry.f2730c.set(0);
        try {
        ...
        AtomicBoolean atomicBoolean = FeatureInstaller.f2956a;
        AbstractC0307g.m703e(classLoader, "cl");
        Context applicationContext2 = context.getApplicationContext();
        if (applicationContext2 == null) {
            applicationContext2 = context;
        }
        FeatureInstaller.f2957b = applicationContext2;
        FeatureInstaller.f2958c = classLoader;
        FeatureInstaller.f2959d = str3;
        ConcurrentHashMap concurrentHashMap = FeatureStatusRegistry.f2728a;
        FeatureStatusRegistry.m1962b("WeChatVersion", new C0840s(2, context));
        FeatureStatusRegistry.m1962b("SettingsEntry", new FeatureInstallTask(classLoader, context));
        FeatureStatusRegistry.m1962b("CompatCheckUi", new FeatureInstallTask(context, classLoader, 11));
        CompatibilityReport compatibilityReportM882d0 = CompatibilityReport.f1683h;
        if (compatibilityReportM882d0 == null) {
            compatibilityReportM882d0 = AbstractC0358S.m882d0(context);
        }
        String strM912u = AbstractC0358S.m912u(context, compatibilityReportM882d0, str3);
        AppFingerprint appFingerprintM862L = AbstractC0358S.m862L();
        ...
        if (zM869S || appFingerprintM862L == null || !AbstractC0307g.m699a(appFingerprintM862L.f1638a, strM912u)) {
            if (appFingerprintM862L != null) {
                m2130d("install stale cache before interactive scan " + appFingerprintM862L.m1361e());
                FeatureInstaller.m2123a("stale-cache");
            ...
            m2130d("silent install from cache " + appFingerprintM862L.m1361e());
            AbstractC0358S.f729i = false;
            AbstractC0358S.f728h = false;
            FeatureInstaller.m2123a("cache");
        }
        FeatureStatusRegistry.m1966f();
        m2130d("bootstrap finished " + FeatureStatusRegistry.m1969i());
    }
