...
public final class BottomTabConfig {
    ...
    public static void m1806a(long j2) {
        if (j2 - f2235b >= 800 || f2235b <= 0) {
            ...
            List list = f2234a;
            String strM1662d = ConfigStore.m1662d("bottom_tab_title_chats", (String) list.get(0));
            if (AbstractC0425j.m1013R0(strM1662d)) {
                strM1662d = (String) list.get(0);
            }
            String strM1662d2 = ConfigStore.m1662d("bottom_tab_title_contacts", (String) list.get(1));
            if (AbstractC0425j.m1013R0(strM1662d2)) {
                strM1662d2 = (String) list.get(1);
            }
            String strM1662d3 = ConfigStore.m1662d("bottom_tab_title_discover", (String) list.get(2));
            if (AbstractC0425j.m1013R0(strM1662d3)) {
                strM1662d3 = (String) list.get(2);
            }
            String strM1662d4 = ConfigStore.m1662d("bottom_tab_title_me", (String) list.get(3));
