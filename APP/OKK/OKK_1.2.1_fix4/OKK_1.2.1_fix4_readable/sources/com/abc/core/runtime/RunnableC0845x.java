...
public final /* synthetic */ class RunnableC0845x implements Runnable {
    ...
    public final void run() {
        ...
        editText.setText(VirtualLocationHook.m1488c(dDoubleValue3));
        editText2.setText(VirtualLocationHook.m1488c(dDoubleValue4));
        VirtualLocationHook.m1494i(true, dDoubleValue3, dDoubleValue4, activity, false);
        SettingsUiBuilder.m2105z(activity, "选点成功");
    }
}
