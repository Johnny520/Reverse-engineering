...
public final class C0648d0 extends AbstractC0761c {
    ...
    public final void mo1386b(C0760b c0760b) {
        ...
        String string;
        String strM1632a2;
        DownloadRedirector downloadRedirector = this.f2015c;
        switch (this.f2014b) {
            case 0:
                try {
                    downloadRedirector.getClass();
                } catch (Throwable th) {
                    objM116u = AbstractC0040p.m116u(th);
                }
                if (DownloadRedirector.m1633b()) {
                    ...
                    try {
                        ...
                        objM116u2 = ConfigStore.m1662d("download_redirect_tree_uri", "");
                        break;
                    } catch (Throwable th2) {
                    ...
                    if (AbstractC0425j.m1013R0(str3)) {
                        DownloadRedirector.m1636e("No tree URI configured, falling back to original logic.");
                        return;
                    }
                    Uri uri = Uri.parse(str3);
                    String name = new File(str2).getName();
                    DownloadRedirector.m1636e("Attempting SAF copy: " + str + " -> " + uri + " / " + name);
                    File file = new File(str);
                    if (!file.exists()) {
                        DownloadRedirector.m1636e("Source file does not exist: ".concat(str));
                        return;
                    }
                    ...
                    if (uriCreateDocument == null) {
                        DownloadRedirector.m1636e("Failed to create document in SAF directory");
                        return;
                    }
                    ...
                    DownloadRedirector.m1636e("SAF copy successful! Saved to " + uriCreateDocument);
                    ...
                    if (thM465a != null) {
                        ...
                        downloadRedirector.getClass();
                        DownloadRedirector.m1636e(strConcat);
                        return;
                    }
                    return;
                }
            ...
            case 1:
                try {
                    ...
                    if (DownloadRedirector.m1633b()) {
                        ...
                        if (str4 == null || (strM1632a = DownloadRedirector.m1632a(str4)) == null) {
                            return;
                        }
                        c0760b.f2670c[1] = strM1632a;
                        DownloadRedirector.m1636e("ExportFileUtil toast rewritten: ".concat(strM1632a));
                        return;
                    }
                    return;
                } catch (Throwable th3) {
            ...
            default:
                try {
                    ...
                    if (DownloadRedirector.m1633b()) {
                        ...
                        if (objM537n05 == null || (string = objM537n05.toString()) == null || (strM1632a2 = DownloadRedirector.m1632a(string)) == null) {
                            return;
                        }
                        c0760b.f2670c[1] = strM1632a2;
                        DownloadRedirector.m1636e("Toast.makeText rewritten: ".concat(strM1632a2));
                        return;
                    }
                    return;
                } catch (Throwable th4) {
