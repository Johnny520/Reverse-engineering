...
public final class C0653f extends AbstractC0761c {
        ...
        switch (this.f2030b) {
            case 2:
                ...
                if (MessageEditHook.m1725p()) {
                    ...
                    if (menu != null) {
                        ...
                        if (view != null && (textViewM1712a = MessageEditHook.m1712a((MessageEditHook) this.f2031c, view)) != null) {
                            ((MessageEditHook) this.f2031c).getClass();
                            C0666j0 c0666j0M1730u = MessageEditHook.m1730u(view, textViewM1712a);
                            if (c0666j0M1730u != null) {
                                MessageEditHook.f2130o = c0666j0M1730u;
                                MessageEditHook.f2131p = new WeakReference(textViewM1712a);
                                MessageEditHook.f2132q = c0666j0M1730u.f2068b;
                                MessageEditHook.f2133r = System.currentTimeMillis();
                                MessageEditHook.m1713b((MessageEditHook) this.f2031c, menu);
                                MessageEditHook messageEditHook = (MessageEditHook) this.f2031c;
                                long j2 = c0666j0M1730u.f2067a;
                                String str = c0666j0M1730u.f2068b;
                                messageEditHook.getClass();
                                MessageEditHook.m1711C("create menu bind msgId=" + j2 + " text=" + AbstractC0425j.m1021Z0(AbstractC0433r.m1032G0(str, '\n', ' '), 32) + " method=" + ((String) this.f2032d));
                                break;
                            }
                        }
                    }
            ...
            case 4:
                ...
                if (RealNameTailHook.m1771g()) {
                    ...
                    if (activity2 != null) {
                        RealNameTailHook.m1770f(activity2, (ClassLoader) this.f2032d);
                        break;
                    }
                }
                break;
            case 5:
                ...
                if (c0709x1M1792a.f2230a) {
                    ...
                    if (imageView != null) {
                        AvatarHook.m1797a((AvatarHook) this.f2031c, imageView.getDrawable(), c0709x1M1792a.f2231b);
    ...
    public void mo1386b(C0760b c0760b) {
        ...
        switch (this.f2030b) {
            case 0:
                ((MomentsCommentProtectHook) obj3).getClass();
                if (MomentsCommentProtectHook.m1649j()) {
                    ...
                    try {
                        ...
                        objM1652m = MomentsCommentProtectHook.m1652m(clsM906r, bArr3);
                    } catch (Throwable th2) {
                        objM116u2 = AbstractC0040p.m116u(th2);
                    }
                    if (objM1652m != null && (objM1652m2 = MomentsCommentProtectHook.m1652m(clsM906r, bArr2)) != null && (listM1653n = MomentsCommentProtectHook.m1653n(objM1652m)) != null && (listM1653n2 = MomentsCommentProtectHook.m1653n(objM1652m2)) != null && !listM1653n.isEmpty()) {
                        ArrayList arrayList = new ArrayList();
                        for (Object obj5 : listM1653n2) {
                            if (obj5 == null) {
                                obj5 = null;
                            }
                            String strM1644d2 = obj5 != null ? MomentsCommentProtectHook.m1644d(obj5) : null;
                            if (strM1644d2 != null) {
                        ...
                        for (Object obj6 : listM1653n) {
                            ...
                            if (obj6 != null && (strM1644d = MomentsCommentProtectHook.m1644d(obj6)) != null && !hashSet.contains(strM1644d)) {
                                MomentsCommentProtectHook.m1651l(obj6);
                                MomentsCommentProtectHook.m1643c(obj6);
                        ...
                        if (i3 != 0) {
                            ...
                            objM116u2 = MomentsCommentProtectHook.m1654o(objM1652m2);
                            break;
                        }
                        Throwable thM465a = AbstractC0141g.m465a(objM116u2);
                        if (thM465a != null) {
                            MomentsCommentProtectHook momentsCommentProtectHook = MomentsCommentProtectHook.f2040a;
                            MomentsCommentProtectHook.m1657r("mergeAttrBufComments: " + thM465a.getMessage());
                        }
            ...
            case 1:
                ...
                if (c0686qM1753a.f2145a) {
                    ...
                    if (MessageDatabaseHook.m1692a(AbstractC0425j.m1020Y0((String) obj3) + "." + ((Method) obj2).getName(), contentValues, c0686qM1753a)) {
                        c0760b.m1946c(1);
                        return;
                    }
                    return;
            ...
            case 5:
                ...
                if (c0709x1M1792a.f2230a) {
                    ...
                    if (objArr3.length >= 3) {
                        ...
                        AvatarHook.m1798b((AvatarHook) obj3, (String) obj2, f2);
                        return;
                    }
                    return;
                }
