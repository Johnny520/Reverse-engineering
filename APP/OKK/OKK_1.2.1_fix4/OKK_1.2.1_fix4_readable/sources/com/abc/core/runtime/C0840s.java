        ...
        switch (this.f3032a) {
            ...
            case 1:
                ...
                if (C0617P1.f1904b.compareAndSet(false, true)) {
                    try {
                        objM116u = AbstractC0358S.m904q(Activity.class, "onResume", new MapPickerResultHandler(1));
                    } catch (Throwable th) {
                    ...
                    try {
                        ...
                        objM116u2 = AbstractC0358S.m904q(Activity.class, "onActivityResult", cls, cls, Intent.class, new MapPickerResultHandler(0));
                    } catch (Throwable th2) {
            ...
            default:
                ...
                CompatibilityReport compatibilityReportM882d0 = AbstractC0358S.m882d0(context);
                AtomicBoolean atomicBoolean = ModuleBootstrap.f2976a;
                ModuleBootstrap.m2130d("wechat " + compatibilityReportM882d0.m1383a() + " range=微信 8.0.69–8.0.76（国服 / Play）");
                ModuleLog.INSTANCE.m1813i("当前微信: " + compatibilityReportM882d0.m1383a());
                break;
        }
        return c0146l;
    }
