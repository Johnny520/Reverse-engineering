...
public final class DialogC0827g extends Dialog {
    ...
    public DialogC0827g(Activity activity, AppFingerprint appFingerprint) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        AppFingerprint appFingerprint = this.f2999b;
        linearLayout.addView(m2150d(appFingerprint.f1639b, 12, false, Color.parseColor("#666666")));
        List list = appFingerprint.f1641d;
        ArrayList<DiagnosticItem> arrayList = new ArrayList();
        for (Object obj : list) {
            if (((DiagnosticItem) obj).f1670c != DiagnosticLevel.f1664a) {
                arrayList.add(obj);
            }
        }
        linearLayout.addView(m2150d("正常 " + appFingerprint.m1359c() + " · 需关注 " + appFingerprint.m1360d() + " · 不适配 " + appFingerprint.m1358b(), 13, true, Color.parseColor("#336940")));
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (DiagnosticItem diagnosticItem : arrayList) {
                int iOrdinal = diagnosticItem.f1670c.ordinal();
                if (iOrdinal == 0) {
                    str = "✓";
                } else if (iOrdinal == 1) {
                    str = "!";
                ...
                int iOrdinal2 = diagnosticItem.f1670c.ordinal();
                if (iOrdinal2 == 0) {
                ...
                TextView textViewM2150d = m2150d(str + "  " + diagnosticItem.f1669b + "  ·  " + diagnosticItem.f1671d, 12, false, color);
            ...
            public final Object invoke() {
                switch (i2) {
                    case 0:
                        ...
                        AppFingerprint appFingerprint2 = dialogC0827g.f2999b;
                        sb.append(appFingerprint2.f1639b);
                        sb.append('\n');
                        sb.append(appFingerprint2.m1361e());
                        sb.append('\n');
                        for (DiagnosticItem diagnosticItem2 : appFingerprint2.f1641d) {
                            sb.append(diagnosticItem2.f1670c + "\t" + diagnosticItem2.f1669b + "\t" + diagnosticItem2.f1671d);
                            sb.append('\n');
                        }
