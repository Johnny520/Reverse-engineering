    ...
    public void mo1385a(C0760b c0760b) {
        ...
        switch (this.f1810b) {
                                        ...
                                        if (i2 <= 1440 && i3 <= 1440) {
                                            ...
                                            if (bitmapDecodeByteArray == null) {
                                                ...
                                                try {
                                                    ...
                                                    if (bitmapDecodeByteArray != ThemeWallpaperConfig.f1708h) {
                                                        ThemeWallpaperConfig.f1708h = bitmapDecodeByteArray;
                                                        ThemeWallpaperConfig.f1709i = file2.getAbsolutePath();
                                                    }
                                                    AbstractC0040p.m108m(inputStreamOpenInputStream, null);
                                                    ...
                                                    configStore.m1666f("theme_wallpaper_path", absolutePath, false);
                                                    configStore.m1667g("theme_wallpaper_enabled", true, false);
                                                    configStore.m1666f("theme_wallpaper_updated", strValueOf, false);
                                                    ThemeWallpaperConfig.f1704d = true;
                                                    ThemeWallpaperConfig.f1706f = file2.getAbsolutePath();
                                                    ThemeWallpaperConfig.f1707g = strValueOf;
                                                    ThemeWallpaperConfig.f1710j = strValueOf;
            ...
            case 1:
                ...
                if (activity2 != null && ThemeWallpaperConfig.f1701a.m1393e()) {
                    Object obj4 = WallpaperOverlayHook.f1792a;
                    if (WallpaperOverlayHook.m1459q(activity2)) {
                        try {
                            if (WallpaperOverlayHook.m1459q(activity2)) {
                                WallpaperOverlayHook.m1466x(activity2);
                                WallpaperOverlayHook.m1443a(activity2);
                            } else {
                                WallpaperOverlayHook.m1454l(activity2);
                            }
                ...
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    if (num3 != null && num3.intValue() == 0) {
                        ...
                        if (activityM1484b == null) {
                            Object obj6 = WallpaperOverlayHook.f1792a;
                            activityM1484b = WallpaperOverlayHook.m1468z();
                            if (activityM1484b == null) {
                                return;
                            }
                        }
                        Object obj7 = WallpaperOverlayHook.f1792a;
                        WallpaperOverlayHook.m1464v(activityM1484b);
                ...
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    if (bool2 != null ? bool2.booleanValue() : false) {
                        ...
                        if (activityM1484b2 == null) {
                            Object obj11 = WallpaperOverlayHook.f1792a;
                            activityM1484b2 = WallpaperOverlayHook.m1468z();
                            if (activityM1484b2 == null) {
                                return;
                            }
                        }
                        Object obj12 = WallpaperOverlayHook.f1792a;
                        WallpaperOverlayHook.m1439B(activityM1484b2);
        ...
        switch (this.f1810b) {
            case 2:
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    if (activity != null) {
                        ...
                        WallpaperOverlayHook.m1463u(activity);
            ...
            case 3:
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    Object obj5 = WallpaperOverlayHook.f1792a;
                    WallpaperOverlayHook.m1463u(activityM1484b);
                    c0760b.f2670c[2] = Boolean.FALSE;
            ...
            case 4:
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    if (num != null && num.intValue() == 0) {
                        ...
                        Object obj8 = WallpaperOverlayHook.f1792a;
                        WallpaperOverlayHook.m1464v(activityM1484b2);
            ...
            case 5:
                if (ThemeWallpaperConfig.f1701a.m1393e()) {
                    ...
                    if (activityM1484b3 == null) {
                        Object obj11 = WallpaperOverlayHook.f1792a;
                        activityM1484b3 = WallpaperOverlayHook.m1468z();
                    }
                    if (activityM1484b3 != null) {
                        Object obj12 = WallpaperOverlayHook.f1792a;
                        WallpaperOverlayHook.m1462t(activityM1484b3);
                    }
                    Object obj13 = c0760b.f2669b;
                    AbstractC0307g.m702d(obj13, "thisObject");
                    C0599J1.m1483a(obj13);
