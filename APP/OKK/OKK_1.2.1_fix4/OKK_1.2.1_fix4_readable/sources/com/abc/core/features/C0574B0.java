...
public final class C0574B0 extends AbstractC0761c {
    ...
    public final /* synthetic */ HomeAvatarHook f1700c;

    public C0574B0(int i2) {
        this.f1699b = i2;
        switch (i2) {
            case 1:
                this.f1700c = HomeAvatarHook.f1723a;
                break;
            case 2:
                this.f1700c = HomeAvatarHook.f1723a;
                break;
        ...
        switch (this.f1699b) {
            case 2:
                ...
                if (num != null && num.intValue() == 0) {
                    ...
                    Activity activityM1394a = HomeAvatarHook.m1394a(c0760b.f2669b);
                    if (activityM1394a == null) {
                        WeakReference weakReference = HomeAvatarHook.f1729g;
                    ...
                    HomeAvatarHook.m1410q(activityM1394a);
                }
                break;
            case 3:
                HomeAvatarHook.f1748z = false;
                HomeAvatarHook.f1720A = SystemClock.uptimeMillis();
                Activity activityM1394a2 = HomeAvatarHook.m1394a(c0760b.f2669b);
                if (activityM1394a2 == null) {
                    WeakReference weakReference2 = HomeAvatarHook.f1729g;
                ...
                this.f1700c.getClass();
                HomeAvatarHook.m1410q(activityM1394a2);
                break;
            case 4:
                if (!AbstractC0425j.m1005J0(HomeAvatarHook.f1722C, "LauncherUI", false) && !AbstractC0425j.m1005J0(HomeAvatarHook.f1722C, "MainTabUI", false)) {
                    this.f1700c.getClass();
                    HomeAvatarHook.m1412s("dialog show on non-home -> hide avatar");
                    this.f1700c.getClass();
                ...
                break;
            case 5:
                WeakReference weakReference3 = HomeAvatarHook.f1729g;
            ...
            case 6:
                ...
                if (bool != null) {
                    ...
                    if (activity6 != null) {
                        HomeAvatarHook homeAvatarHook = this.f1700c;
                        if (!zBooleanValue) {
                            homeAvatarHook.getClass();
                            HomeAvatarHook.m1412s("launcher focus lost (keep avatar)");
                        } else {
                            homeAvatarHook.getClass();
                            HomeAvatarHook.m1412s("launcher focus gained -> tick");
                            HomeAvatarHook.m1404k(activity6);
                        }
                        break;
                    }
                }
            ...
            case 7:
                ...
                if (activity7 != null) {
                    ...
                    HomeAvatarHook.f1720A = SystemClock.uptimeMillis();
                    this.f1700c.getClass();
                    HomeAvatarHook.m1410q(activity7);
                    break;
                }
                break;
            case 8:
                ...
                HomeAvatarHook.f1735m = num2 != null ? num2.intValue() : 0;
                WeakReference weakReference4 = HomeAvatarHook.f1729g;
                if (weakReference4 != null && (activity2 = (Activity) weakReference4.get()) != null) {
                    this.f1700c.getClass();
                    HomeAvatarHook.m1404k(activity2);
                    break;
                }
                break;
            case 9:
                HomeAvatarHook homeAvatarHook2 = this.f1700c;
                Object obj3 = c0760b.f2669b;
                homeAvatarHook2.getClass();
                if (obj3 != null && !HomeAvatarHook.f1721B) {
                    try {
                        objM116u = HomeAvatarHook.m1400g(obj3);
                    } catch (Throwable th) {
                    ...
                    if (view != null) {
                        ...
                        try {
                            ...
                            HomeAvatarHook.f1721B = true;
                            HomeAvatarHook.m1412s("hooked tab ViewPager " + cls + " edge intercept+touch");
                        ...
                        if (thM465a != null) {
                            HomeAvatarHook homeAvatarHook3 = HomeAvatarHook.f1723a;
                            HomeAvatarHook.m1412s("hookTabViewPagerSwipe fail: " + thM465a.getMessage());
                        }
                    }
                }
                ...
                HomeAvatarHook.f1735m = num3 != null ? num3.intValue() : HomeAvatarHook.f1735m;
                WeakReference weakReference5 = HomeAvatarHook.f1729g;
                if (weakReference5 != null && (activity3 = (Activity) weakReference5.get()) != null) {
                    this.f1700c.getClass();
                    HomeAvatarHook.m1404k(activity3);
                    break;
                }
                break;
        }
            ...
            case 10:
                ...
                if (view != null) {
                    ...
                    if (motionEvent != null) {
                        ...
                        homeAvatarHook.getClass();
                        Activity activityM1399f = HomeAvatarHook.m1399f(context);
            ...
            case 11:
                ...
                if (view2 != null) {
                    ...
                    if (motionEvent2 != null) {
                        ...
                        homeAvatarHook2.getClass();
                        Activity activityM1399f2 = HomeAvatarHook.m1399f(context2);
