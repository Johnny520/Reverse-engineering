...
import com.abc.internal.probe.C0566p;
import java.io.File;
...
public final /* synthetic */ class SettingsEntryHook implements InterfaceC0286l {
    ...
    public /* synthetic */ SettingsEntryHook() {
        this.f1805a = 5;
        this.f1806b = SettingsEntryInjector.f2992a;
    }
    ...
    */
    public final Object invoke(Object obj) {
        ...
        switch (this.f1805a) {
            ...
            case 2:
                ...
                String strM1409p = HomeAvatarHook.m1409p(classLoader);
                if (AbstractC0425j.m1013R0(strM1409p)) {
                    strM1409p = HomeAvatarHook.f1736n;
                }
                if (true ^ AbstractC0425j.m1013R0(strM1409p)) {
                    try {
                        Method methodM1408o = HomeAvatarHook.f1742t;
                        if (methodM1408o == null) {
                            methodM1408o = HomeAvatarHook.m1408o(classLoader);
                        }
                        if (methodM1408o != null) {
            ...
            case 3:
                ...
                RealNameTailHook.f2169g.post(new RunnableC0328h(c0613o0, str3, 3));
                return C0146l.f339a;
            case 4:
            ...
            default:
                AbstractC0307g.m703e((SettingsEntryInjector) this.f1806b, "$this_runCatching");
                if (obj != null) {
                    Object objM1376a = C0566p.m1376a(obj, new String[]{"j"});
                    if (objM1376a == null) {
                        objM1376a = obj;
                    }
                    Set set3 = SettingsEntryInjector.f2995d;
                    ...
                    if (z2) {
                        ...
                        if (string == null && (string = SettingsEntryInjector.m2141g(obj)) == null) {
                            Object objM1376a3 = C0566p.m1376a(obj, new String[]{"j"});
                            if (objM1376a3 != null) {
                                obj = objM1376a3;
                            }
                            string = SettingsEntryInjector.m2141g(obj);
                        }
    ...
    public /* synthetic */ SettingsEntryHook(int i2, Object obj) {
        this.f1805a = i2;
        this.f1806b = obj;
    }
}
