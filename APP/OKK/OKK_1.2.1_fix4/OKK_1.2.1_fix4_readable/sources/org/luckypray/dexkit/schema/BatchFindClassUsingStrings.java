...
/* JADX INFO: renamed from: org.luckypray.dexkit.schema.-BatchFindClassUsingStrings */
/* JADX INFO: loaded from: classes.dex */
public final class BatchFindClassUsingStrings extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createBatchFindClassUsingStrings(C0733b c0733b, int i2, int i3, boolean z2, int i4, int i5) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(5);
            addMatchers(c0733b, i5);
            addInClasses(c0733b, i4);
            addExcludePackages(c0733b, i3);
            addSearchPackages(c0733b, i2);
            addIgnorePackagesCase(c0733b, z2);
            return endBatchFindClassUsingStrings(c0733b);
        }
        ...
        public final int endBatchFindClassUsingStrings(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
        ...
        public final void startBatchFindClassUsingStrings(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(5);
        }
        ...
        public final BatchFindClassUsingStrings getRootAsBatchFindClassUsingStrings(ByteBuffer byteBuffer, BatchFindClassUsingStrings batchFindClassUsingStrings) {
            AbstractC0307g.m703e(byteBuffer, "_bb");
            AbstractC0307g.m703e(batchFindClassUsingStrings, "obj");
            return batchFindClassUsingStrings.__assign(byteBuffer.position() + AbstractC0324d.m719b(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
    }

    public final BatchFindClassUsingStrings __assign(int i2, ByteBuffer byteBuffer) {
        AbstractC0307g.m703e(byteBuffer, "_bb");
