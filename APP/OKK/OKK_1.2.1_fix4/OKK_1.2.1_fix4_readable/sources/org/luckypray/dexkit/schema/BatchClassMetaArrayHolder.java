...
public final class BatchClassMetaArrayHolder extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createBatchClassMetaArrayHolder(C0733b c0733b, int i2) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(1);
            addItems(c0733b, i2);
            return endBatchClassMetaArrayHolder(c0733b);
        }
        ...
        public final int endBatchClassMetaArrayHolder(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
        ...
        public final void startBatchClassMetaArrayHolder(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(1);
        }
        ...
        public final BatchClassMetaArrayHolder getRootAsBatchClassMetaArrayHolder(ByteBuffer byteBuffer, BatchClassMetaArrayHolder batchClassMetaArrayHolder) {
            AbstractC0307g.m703e(byteBuffer, "_bb");
            AbstractC0307g.m703e(batchClassMetaArrayHolder, "obj");
            return batchClassMetaArrayHolder.__assign(byteBuffer.position() + AbstractC0324d.m719b(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
    }

    public final BatchClassMetaArrayHolder __assign(int i2, ByteBuffer byteBuffer) {
        AbstractC0307g.m703e(byteBuffer, "_bb");
    ...
    public final BatchClassMeta items(int i2) {
        return items(new BatchClassMeta(), i2);
    }

    public final BatchClassMeta items(BatchClassMeta batchClassMeta, int i2) {
