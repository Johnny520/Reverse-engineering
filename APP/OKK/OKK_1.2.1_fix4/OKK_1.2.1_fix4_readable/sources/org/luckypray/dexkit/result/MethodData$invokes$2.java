...
public final class MethodData$invokes$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$invokes$2(DexKitBridge dexKitBridge, MethodData methodData, int i2, int i3) {
        super(0);
    ...
    public final MethodDataList invoke() {
        ...
        byte[] bArrNativeGetInvokeMethods = DexKitBridge.Companion.nativeGetInvokeMethods(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id));
