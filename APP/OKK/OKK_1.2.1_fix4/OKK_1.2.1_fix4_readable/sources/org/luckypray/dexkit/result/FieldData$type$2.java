...
public final class FieldData$type$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public FieldData$type$2(DexKitBridge dexKitBridge, FieldData fieldData, int i2) {
        super(0);
    ...
    public final ClassData invoke() {
        ...
        byte[] bArrNativeGetClassByIds = DexKitBridge.Companion.nativeGetClassByIds(dexKitBridge.getSafeToken(), new long[]{fieldData.getEncodeId(this.$dexId, fieldData.typeId)});
