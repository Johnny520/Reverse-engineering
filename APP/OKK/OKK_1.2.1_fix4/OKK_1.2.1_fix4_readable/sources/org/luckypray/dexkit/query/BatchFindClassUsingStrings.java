...
public final class BatchFindClassUsingStrings extends BaseQuery {
    ...
    public static /* synthetic */ BatchFindClassUsingStrings addSearchGroup$default(BatchFindClassUsingStrings batchFindClassUsingStrings, String str, Collection collection, StringMatchType stringMatchType, boolean z2, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        return batchFindClassUsingStrings.addSearchGroup(str, collection, stringMatchType, z2);
    }
    ...
    public static /* synthetic */ BatchFindClassUsingStrings groups$default(BatchFindClassUsingStrings batchFindClassUsingStrings, Map map, StringMatchType stringMatchType, boolean z2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            stringMatchType = StringMatchType.Contains;
        }
        if ((i2 & 4) != 0) {
        ...
        return batchFindClassUsingStrings.groups(map, stringMatchType, z2);
    }
    ...
    public final BatchFindClassUsingStrings ignorePackagesCase(boolean z2) {
    ...
    public int innerBuild(C0733b c0733b) throws IllegalAccessException {
        ...
        if (collection3 != null) {
            ...
            iCreateInClassesVector = org.luckypray.dexkit.schema.BatchFindClassUsingStrings.Companion.createInClassesVector(c0733b, AbstractC0181l.m554z0(arrayList4));
        } else {
            iCreateInClassesVector = 0;
        }
        List<StringMatchersGroup> list3 = this.searchGroups;
        AbstractC0307g.m700b(list3);
        ArrayList arrayList5 = new ArrayList(AbstractC0183n.m559k0(list3, 10));
        Iterator<T> it5 = list3.iterator();
        while (it5.hasNext()) {
            arrayList5.add(Integer.valueOf(((StringMatchersGroup) it5.next()).innerBuild(c0733b)));
        }
        int iCreateBatchFindClassUsingStrings = companion.createBatchFindClassUsingStrings(c0733b, iM1928k, iM1928k2, z2, iCreateInClassesVector, c0733b.m1928k(AbstractC0181l.m552x0(arrayList5)));
        c0733b.m1931n(iCreateBatchFindClassUsingStrings);
    ...
    private final BatchFindClassUsingStrings groups(InterfaceC0286l interfaceC0286l) {
    ...
    private final BatchFindClassUsingStrings addSearchGroup(InterfaceC0286l interfaceC0286l) {
        AbstractC0307g.m703e(interfaceC0286l, "init");
    ...
    public final BatchFindClassUsingStrings groups(Map<String, ? extends Collection<String>> map, StringMatchType stringMatchType, boolean z2) {
        AbstractC0307g.m703e(map, "keywordsMap");
        AbstractC0307g.m703e(stringMatchType, "matchType");
    ...
    private final BatchFindClassUsingStrings addSearchGroup(String str, InterfaceC0286l interfaceC0286l) {
        AbstractC0307g.m703e(str, "groupName");
        AbstractC0307g.m703e(interfaceC0286l, "init");
    ...
    public final BatchFindClassUsingStrings addSearchGroup(String str, Collection<String> collection, StringMatchType stringMatchType, boolean z2) {
        AbstractC0307g.m703e(str, "groupName");
        AbstractC0307g.m703e(collection, "usingStrings");
        AbstractC0307g.m703e(stringMatchType, "matchType");
