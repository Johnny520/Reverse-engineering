...
public final class InstanceUtil$getFieldInstance$declaredFields$1 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public InstanceUtil$getFieldInstance$declaredFields$1(C0313m c0313m) {
        super(0);
        this.$clz = c0313m;
    }
    ...
    public final Field[] invoke() {
        Field[] declaredFields = ((Class) this.$clz.f595a).getDeclaredFields();
        AbstractC0307g.m702d(declaredFields, "clz.declaredFields");
