...
public final class ClassData$annotations$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public ClassData$annotations$2(DexKitBridge dexKitBridge, ClassData classData, int i2, int i3) {
        super(0);
    ...
    public final List<AnnotationData> invoke() {
        ...
        byte[] bArrNativeGetClassAnnotations = DexKitBridge.Companion.nativeGetClassAnnotations(dexKitBridge.getSafeToken(), this.this$0.getEncodeId(this.$dexId, this.$id));
