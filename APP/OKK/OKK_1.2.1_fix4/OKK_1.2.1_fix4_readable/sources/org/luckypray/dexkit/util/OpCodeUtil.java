...
public final class OpCodeUtil {
    ...
    private static final InterfaceC0136b opFormatMap$delegate = AbstractC0040p.m81E(OpCodeUtil$opFormatMap$2.INSTANCE);

    private OpCodeUtil() {
    }

    public static final int getOpCode(String str) {
        AbstractC0307g.m703e(str, "opFormat");
        Integer num = INSTANCE.getOpFormatMap().get(str);
        if (num != null) {
            return num.intValue();
        }
        throw new IllegalArgumentException(AbstractC0324d.m723f("opFormat: ", str, " is not found"));
    }

    public static final String getOpFormat(int i2) {
        if (i2 >= 0) {
        ...
        AbstractC0307g.m702d(string, "java.lang.Integer.toStri…(this, checkRadix(radix))");
