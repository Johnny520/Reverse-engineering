...
public final class AnnotationsMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addAnnotationCount(C0733b c0733b, int i2) {
        ...
        public final int createAnnotationsMatcher(C0733b c0733b, int i2, byte b2, int i3) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(3);
            addAnnotationCount(c0733b, i3);
            addAnnotations(c0733b, i2);
            addMatchType(c0733b, b2);
            return endAnnotationsMatcher(c0733b);
        }
        ...
        public final int endAnnotationsMatcher(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
        ...
        public final void startAnnotationsMatcher(C0733b c0733b) {
            AbstractC0307g.m703e(c0733b, "builder");
            c0733b.m1936s(3);
        }
        ...
        public final AnnotationsMatcher getRootAsAnnotationsMatcher(ByteBuffer byteBuffer, AnnotationsMatcher annotationsMatcher) {
            ...
            return annotationsMatcher.__assign(byteBuffer.position() + AbstractC0324d.m719b(byteBuffer, ByteOrder.LITTLE_ENDIAN), byteBuffer);
        }
    }

    public final AnnotationsMatcher __assign(int i2, ByteBuffer byteBuffer) {
        AbstractC0307g.m703e(byteBuffer, "_bb");
    ...
    public final AnnotationMatcher annotations(int i2) {
        return annotations(new AnnotationMatcher(), i2);
    }
    ...
    public final AnnotationMatcher annotations(AnnotationMatcher annotationMatcher, int i2) {
