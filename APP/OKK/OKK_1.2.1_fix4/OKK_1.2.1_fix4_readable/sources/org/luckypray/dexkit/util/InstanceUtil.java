...
public final class InstanceUtil {
    ...
    public static final class C10341 extends AbstractC0308h implements InterfaceC0275a {
        ...
        public C10341(Constructor<?> constructor) {
            super(0);
        ...
        try {
            ...
            do {
                ...
                for (Constructor<?> constructor : weakCache.get((Class<?>) obj, new InstanceUtil$getConstructorInstance$declaredConstructors$1(c0313m))) {
                    if (AbstractC0307g.m699a(dexMethod.getMethodSign(), signCache.get(constructor, new C10341(constructor)))) {
        ...
        try {
            ...
            do {
                ...
                for (Field field : weakCache.get((Class<?>) obj, new InstanceUtil$getFieldInstance$declaredFields$1(c0313m))) {
                    if (AbstractC0307g.m699a(dexField.getName(), field.getName()) && AbstractC0307g.m699a(dexField.getTypeSign(), signCache.get(field, new C13021(field)))) {
        ...
        try {
            ...
            do {
                ...
                for (Method method : weakCache.get((Class<?>) obj, new InstanceUtil$getMethodInstance$declaredMethods$1(c0313m))) {
                    if (AbstractC0307g.m699a(method.getName(), dexMethod.getName()) && AbstractC0307g.m699a(dexMethod.getMethodSign(), signCache.get(method, new C13031(method)))) {
