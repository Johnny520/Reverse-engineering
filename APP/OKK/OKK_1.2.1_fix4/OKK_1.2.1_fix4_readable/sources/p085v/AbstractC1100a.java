...
public abstract class AbstractC1100a {
    ...
    /* JADX INFO: renamed from: a */
    public static int m2592a(double d2, double d3, double d4) {
    ...
    public static int m2593b(int i2, int i3) {
        int iAlpha = Color.alpha(i3);
        int iAlpha2 = Color.alpha(i2);
        int i4 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / 255);
        return Color.argb(i4, m2594c(Color.red(i2), iAlpha2, Color.red(i3), iAlpha, i4), m2594c(Color.green(i2), iAlpha2, Color.green(i3), iAlpha, i4), m2594c(Color.blue(i2), iAlpha2, Color.blue(i3), iAlpha, i4));
    }

    /* JADX INFO: renamed from: c */
    public static int m2594c(int i2, int i3, int i4, int i5, int i6) {
        if (i6 == 0) {
            return 0;
        }
    ...
    public static int m2595d(int i2, int i3) {
        if (i3 < 0 || i3 > 255) {
