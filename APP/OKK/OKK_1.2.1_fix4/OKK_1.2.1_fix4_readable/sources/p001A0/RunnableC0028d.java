    ...
    public final void run() {
        ...
        switch (this.f70a) {
            ...
            case 4:
                ...
                return;
            case 5:
                FloatingBottomTabView floatingBottomTabView = (FloatingBottomTabView) this.f71b;
                AbstractC0307g.m703e(floatingBottomTabView, "$bar");
                if (floatingBottomTabView.isAttachedToWindow()) {
                    floatingBottomTabView.m1943f();
                    return;
                }
                return;
            case 6:
                ...
                HomeAvatarHook.f1736n = strM1409p;
                Bitmap bitmapM1403j = HomeAvatarHook.m1403j(classLoader, strM1409p);
                if (bitmapM1403j != null && !bitmapM1403j.isRecycled()) {
                    HomeAvatarHook.f1740r = bitmapM1403j;
                    HomeAvatarHook.f1741s = true;
                }
                HomeAvatarHook.m1412s("prefetch: user=" + strM1409p + " bmp=" + (bitmapM1403j != null));
                ImageView imageView = HomeAvatarHook.f1730h;
                if (imageView != null) {
                    HomeAvatarHook.f1725c.post(new RunnableC0705w0(imageView, 1));
                    return;
                }
                return;
            case 7:
            ...
            case 9:
                ...
                try {
                    dialogC0823e.show();
                    HookDiagnostics.m2157g("progress shown async");
                ...
                if (thM465a != null) {
                    HookDiagnostics.m2157g("progress show fail: " + thM465a.getMessage());
                    return;
                }
                return;
            case 10:
