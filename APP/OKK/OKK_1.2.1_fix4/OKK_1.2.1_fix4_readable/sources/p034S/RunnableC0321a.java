    ...
    public final void run() {
        switch (this.f609a) {
            case 0:
                ...
                return;
            case 1:
                FloatingBottomTabView floatingBottomTabView = (FloatingBottomTabView) this.f611c;
                ...
                C0588G.m1419f(floatingBottomTabView, viewGroup, this.f610b - 1);
                return;
            case 2:
                int i2 = this.f610b;
                ...
                synchronized (ConfigStore.f2052e) {
                    if (i2 != ConfigStore.f2051d.get()) {
                        return;
                    }
                    for (File file : list) {
