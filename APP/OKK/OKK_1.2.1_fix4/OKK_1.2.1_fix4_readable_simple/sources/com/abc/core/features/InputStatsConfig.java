...
public final class InputStatsConfig {
    ...
    public static C0598J0 m1413a() {
        ...
        boolean r12 = ConfigStore.m1661c("input_stats_enabled", true);
        boolean r2 = ConfigStore.m1661c("input_stats_count_send", true);
        f1763b = new C0598J0(ConfigStore.m1662d("input_stats_template", "今日已发${totalMsg}条"), r12, r2);
        return f1763b;
    L7:
        return f1763b;
    }
