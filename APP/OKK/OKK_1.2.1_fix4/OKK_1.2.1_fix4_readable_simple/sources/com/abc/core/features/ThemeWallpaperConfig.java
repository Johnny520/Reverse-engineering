...
public final class ThemeWallpaperConfig {
    ...
    public static final ThemeWallpaperConfig f1701a = null;
    ...
    static {
        f1701a = new ThemeWallpaperConfig();
    ...
    public static void m1390g(boolean r6) {
        ...
        if (r6 == false) goto L5;
    L9:
        ConfigStore r62 = ConfigStore.f2048a;
        f1704d = ConfigStore.m1661c("theme_wallpaper_enabled", false);
        Float r63 = AbstractC0431p.m1025z0(ConfigStore.m1662d("theme_wallpaper_alpha", "0.28"));
        if (r63 == null) goto L12;
        float r64 = r63.floatValue();
    L13:
        f1705e = m1387c(r64);
        String r2 = "";
        String r65 = AbstractC0425j.m1022a1(ConfigStore.m1662d("theme_wallpaper_path", "")).toString();
