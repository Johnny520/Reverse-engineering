...
import com.abc.core.runtime.C0802M;
import com.abc.core.runtime.C0813Y;
...
public final class MessageActionDispatcher extends AbstractC0761c {
    ...
    public /* synthetic */ MessageActionDispatcher(int r1, Object r2) {
        this.f2100b = r1;
        this.f2101c = r2;
    }
    ...
    L4:
        return;
    L5:
        SettingsUiBuilder r5 = (SettingsUiBuilder) this.f2101c;
    ...
    L31:
        ...
        String r14 = SettingsUiBuilder.m2081a(r5, r113);     // Catch: Throwable -> L47
        if (r14 != null) goto L39;
    L49:
        SettingsUiBuilder.m2105z(r32, "无法解析所选目录，请重试");     // Catch: Throwable -> L47
        return;
    L39:
        if (AbstractC0425j.m1013R0(r14) == true) goto L49;
        DownloadRedirector r78 = DownloadRedirector.f2022a;     // Catch: Throwable -> L47
        DownloadRedirector.m1635d(r14);     // Catch: Throwable -> L47
        String r79 = r113.toString();     // Catch: Throwable -> L47
        AbstractC0307g.m702d(r79, "toString(...)");     // Catch: Throwable -> L47
        ConfigStore r8 = ConfigStore.f2048a;     // Catch: Throwable -> L47
        ConfigStore.m1664h("download_redirect_tree_uri", r79);     // Catch: Throwable -> L47
        r32.getContentResolver().takePersistableUriPermission(r113, 3);     // Catch: Throwable -> L44
    L46:
        ConfigStore.f2048a.m1667g("download_redirect_enabled", true, false);     // Catch: Throwable -> L47
        SettingsUiBuilder.m2105z(r32, "下载目录已设置：".concat(r14));     // Catch: Throwable -> L47
    ...
    L52:
        ...
        r5.getClass();
        SettingsUiBuilder.m2105z(r32, r116);
        return;
    L76:
        return;
    L44:
    ...
    L84:
        return;
    L65:
        if (BottomTabConfig.m1807b() == false) goto L86;
    ...
    L5:
        ...
        ((SettingsEntryInjector) r5).getClass();
    L9:
        th = move-exception;
    ...
    L31:
        ...
        Field r14 = SettingsEntryInjector.m2138d(r05.getClass(), new C0813Y(22));     // Catch: Throwable -> L37
        if (r14 == null) goto L39;
    ...
    L70:
        ...
        SettingsUiBuilder.f2933a.m2106w(r16, C0802M.f2917b);     // Catch: Throwable -> L73
        SettingsEntryInjector.m2146l("embedded ui shown");     // Catch: Throwable -> L73
    ...
    L75:
        ...
        SettingsEntryInjector r010 = SettingsEntryInjector.f2992a;
        SettingsEntryInjector.m2146l("open fail: " + r18.getMessage());
    L73:
        th = move-exception;
    ...
    L12:
        ...
        SparseArray r011 = SettingsEntryInjector.m2143i(r02);     // Catch: Throwable -> L9
        if (r011 == null) goto L15;
        Object r012 = r011.get(r112);     // Catch: Throwable -> L9
        if (r012 == null) goto L15;
        Object r013 = SettingsEntryInjector.m2144j(r012);     // Catch: Throwable -> L9
        if (r013 == null) goto L15;
        if (SettingsEntryInjector.m2145k(r013) != 168566822) goto L15;
        boolean r014 = true;
    L24:
    ...
    L11:
        ...
        goto L12
    L89:
        C0709x1 r015 = RoundAvatarHook.m1792a();
        if (r015.f2230a == false) goto L325;
        AvatarHook.m1797a((AvatarHook) r5, r11.f2669b, r015.f2231b);
        return;
    L325:
        return;
    L94:
        RealNameTailHook r52 = (RealNameTailHook) r5;
        r52.getClass();
        if (RealNameTailHook.m1771g() == false) goto L326;
        Object[] r7 = r11.f2670c;
        AbstractC0307g.m702d(r7, "args");
    ...
    L121:
        ...
        String r44 = RealNameTailHook.m1778o(r021);
    ...
    L126:
        ...
        String r72 = (String) RealNameTailHook.f2170h.get(r44);
    ...
    L136:
        r22 = r74;
    L144:
        RealNameTailHook.f2171i.remove(r44);
        AtomicBoolean r75 = new AtomicBoolean(false);
        r52.m1783c(r44, r22, new C0641b(r75, r021, r6));
        RealNameTailHook.f2169g.postDelayed(new RunnableC0486k(r75, r44, r021, r1), 13000);
    L137:
    ...
    L331:
        return;
    L198:
        ((HotUpdateBlocker) r5).getClass();
        if (HotUpdateBlocker.m1628a() == false) goto L336;
    ...
    L232:
        ...
        AtomicBoolean r034 = MessageDatabaseHook.f2105a;
        if (r53.equals("delete") == false) goto L236;
    L239:
        Object r035 = 1;
    L240:
        r11.m1946c(r035);
        MessageDatabaseHook.m1708q("BLOCKED media table " + r53 + " on " + r83);
        return;
    L236:
    ...
    L263:
        ...
        return;
    L266:
        if (AntiRevokeProcessor.m1744g(r24) == true) goto L343;
        String r1113 = r123.getAsString("conRemark");
        String r037 = r123.getAsString("nickname");
        String r124 = r123.getAsString("alias");
        String r1114 = AntiRevokeProcessor.m1739b(r1113);
        if (r1114 != null) goto L273;
        r1114 = AntiRevokeProcessor.m1739b(r037);
        if (r1114 != null) goto L273;
        r1114 = AntiRevokeProcessor.m1739b(r124);
    L273:
    ...
    L292:
        ...
        return;
    L295:
        if (MessageDatabaseHook.m1692a(r53, r2, r033) == false) goto L339;
        r11.m1946c(1);
        return;
    L339:
        return;
    ...
    L211:
        ...
        goto L213
    L82:
        if (((Boolean) VirtualLocationHook.m1490e(VirtualLocationHook.f1854a).f334a).booleanValue() == false) goto L323;
    ...
    public MessageActionDispatcher(int r1) {
        this.f2100b = r1;
        switch(r1) {
            case 2: goto L14;
            case 3: goto L12;
    ...
    L4:
        ...
        return;
    L6:
        this.f2101c = SettingsEntryInjector.f2992a;
        return;
    L8:
        this.f2101c = AvatarHook.f2217a;
        return;
    L10:
        this.f2101c = RealNameTailHook.f2163a;
        return;
    L12:
        this.f2101c = C0693s0.f2187a;
        return;
    L14:
        this.f2101c = HotUpdateBlocker.f2005a;
    }
}
