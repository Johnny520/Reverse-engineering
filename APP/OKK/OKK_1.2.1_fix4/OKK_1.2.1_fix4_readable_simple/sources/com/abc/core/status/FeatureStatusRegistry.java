...
public final class FeatureStatusRegistry {
    ...
    L4:
        ...
        Object r2 = r03.next();
        if (((FeatureInstallResult) r2).f2720b != FeatureInstallStatus.f2724b) goto L4;
        r1.add(r2);
        goto L4
    L8:
    ...
    L10:
        ...
        r04.add(((FeatureInstallResult) r12.next()).f2719a);
        goto L10
    L13:
    ...
    public static void m1963c(String r4, Throwable r5) {
        ...
        f2728a.put(r4, new FeatureInstallResult(r4, FeatureInstallStatus.f2724b, r52));
    ...
    public static void m1964d(String r5, String r6) {
        f2728a.put(r5, new FeatureInstallResult(r5, FeatureInstallStatus.f2723a, r6));
    ...
    public static void m1965e(String r4, String r5) {
        ...
        f2728a.put(r4, new FeatureInstallResult(r4, FeatureInstallStatus.f2726d, r5));
    ...
    L5:
        ...
        FeatureInstallResult r5 = (FeatureInstallResult) r4.next();     // Catch: Throwable -> L7
    ...
    L46:
        ...
        if (((FeatureInstallResult) r15.next()).f2720b != FeatureInstallStatus.f2726d) goto L46;
        r5 = r5 + 1;
        if (r5 >= 0) goto L46;
    ...
    L33:
        ...
        if (((FeatureInstallResult) r16.next()).f2720b != FeatureInstallStatus.f2725c) goto L33;
        r7 = r7 + 1;
        if (r7 >= 0) goto L33;
        AbstractC0182m.m557i0();
        throw null;
    ...
    L20:
        ...
        if (((FeatureInstallResult) r17.next()).f2720b != FeatureInstallStatus.f2724b) goto L20;
        r6 = r6 + 1;
        if (r6 >= 0) goto L20;
        AbstractC0182m.m557i0();
        throw null;
    ...
    L7:
        ...
        if (((FeatureInstallResult) r18.next()).f2720b != FeatureInstallStatus.f2723a) goto L7;
        r3 = r3 + 1;
        if (r3 >= 0) goto L7;
        AbstractC0182m.m557i0();
        throw null;
