...
public final class C0653f extends AbstractC0761c {
    ...
    L4:
        return;
    L5:
        C0709x1 r1 = RoundAvatarHook.m1792a();
    ...
    L11:
        ...
        AvatarHook.m1797a((AvatarHook) this.f2031c, r32.getDrawable(), r1.f2231b);
        r32.postInvalidate();
        return;
    L137:
        return;
    L136:
        return;
    L15:
        ((RealNameTailHook) this.f2031c).getClass();
        if (RealNameTailHook.m1771g() == false) goto L138;
        Object r144 = r14.f2669b;
        if ((r144 instanceof Activity) == false) goto L21;
        r33 = (Activity) r144;
    L21:
        if (r33 == null) goto L139;
        RealNameTailHook.m1770f(r33, (ClassLoader) this.f2032d);
        return;
    L139:
        return;
    L138:
    ...
    L142:
        return;
    L86:
        ((MessageEditHook) this.f2031c).getClass();
        if (MessageEditHook.m1725p() == false) goto L147;
    ...
    L112:
        ...
        TextView r1411 = MessageEditHook.m1712a((MessageEditHook) this.f2031c, r3);
        if (r1411 == null) goto L150;
        ((MessageEditHook) this.f2031c).getClass();
        C0666j0 r06 = MessageEditHook.m1730u(r3, r1411);
        if (r06 == null) goto L151;
        MessageEditHook.f2130o = r06;
        MessageEditHook.f2131p = new WeakReference(r1411);
        MessageEditHook.f2132q = r06.f2068b;
        MessageEditHook.f2133r = System.currentTimeMillis();
        MessageEditHook.m1713b((MessageEditHook) this.f2031c, r73);
        MessageEditHook r1412 = (MessageEditHook) this.f2031c;
        long r12 = r06.f2067a;
        String r07 = r06.f2068b;
        r1412.getClass();
        MessageEditHook.m1711C("create menu bind msgId=" + r12 + " text=" + AbstractC0425j.m1021Z0(AbstractC0433r.m1032G0(r07, '\n', ' '), 32) + " method=" + ((String) this.f2032d));
        return;
    L151:
        return;
    L150:
    ...
    L4:
        return;
    L5:
        C0709x1 r05 = RoundAvatarHook.m1792a();
        ...
        AvatarHook.m1798b((AvatarHook) r5, (String) r4, r06);
        return;
    L160:
        return;
    L161:
    ...
    L25:
        ...
        AtomicBoolean r12 = MessageDatabaseHook.f2105a;
        if (MessageDatabaseHook.m1692a(AbstractC0425j.m1020Y0((String) r5) + "." + ((Method) r4).getName(), r03, r6) == false) goto L162;
        r13.m1946c(1);
        return;
    L162:
        return;
    ...
    L163:
        return;
    L31:
        ((MomentsCommentProtectHook) r5).getClass();
        if (MomentsCommentProtectHook.m1649j() == false) goto L168;
    ...
    L136:
        ...
        Object r56 = MomentsCommentProtectHook.m1652m(r42, r55);     // Catch: Throwable -> L82
        if (r56 == null) goto L127;
        Object r43 = MomentsCommentProtectHook.m1652m(r42, r23);     // Catch: Throwable -> L82
        if (r43 == null) goto L127;
        List r57 = MomentsCommentProtectHook.m1653n(r56);     // Catch: Throwable -> L82
        if (r57 == null) goto L127;
        List r63 = MomentsCommentProtectHook.m1653n(r43);     // Catch: Throwable -> L82
    ...
    L77:
        if (r9 == null) goto L79;
        String r92 = MomentsCommentProtectHook.m1644d(r9);     // Catch: Throwable -> L82
    L80:
    ...
    L90:
        ...
        String r10 = MomentsCommentProtectHook.m1644d(r93);     // Catch: Throwable -> L82
        if (r10 == null) goto L86;
        if (r83.contains(r10) == true) goto L86;
        MomentsCommentProtectHook.m1651l(r93);     // Catch: Throwable -> L82
        MomentsCommentProtectHook.m1643c(r93);     // Catch: Throwable -> L82
    ...
    L116:
        Object r32 = MomentsCommentProtectHook.m1654o(r43);     // Catch: Throwable -> L82
    L119:
        Throwable r44 = AbstractC0141g.m465a(r32);
        if (r44 == null) goto L123;
        MomentsCommentProtectHook r59 = MomentsCommentProtectHook.f2040a;
        MomentsCommentProtectHook.m1657r("mergeAttrBufComments: " + r44.getMessage());
    L123:
    ...
    L131:
        ...
        r13.f2670c[0] = r04;
        MomentsCommentProtectHook.m1657r("merged CommentUserList into setAttrBuf");
    ...
    L4:
        this.f2031c = MomentsCommentProtectHook.f2040a;
        this.f2032d = r1;
        return;
    L6:
        this.f2031c = RealNameTailHook.f2163a;
        this.f2032d = r1;
    }

    public C0653f(String r2, Method r3) {
        this.f2030b = 1;
        AtomicBoolean r02 = MessageDatabaseHook.f2105a;
        this.f2031c = r2;
        this.f2032d = r3;
    }
}
