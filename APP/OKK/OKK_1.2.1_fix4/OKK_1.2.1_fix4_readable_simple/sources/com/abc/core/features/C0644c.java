...
public final class C0644c extends AbstractC0761c {
    ...
    L5:
        ...
        if (MomentsCommentProtectHook.m1649j() == false) goto L31;
        Object r62 = r6.f2669b;
        if (r62 == null) goto L32;
        Field r02 = MomentsCommentProtectHook.m1647g(r62.getClass(), "field_commentflag");
    ...
    L18:
        ...
        Field r03 = MomentsCommentProtectHook.m1647g(r62.getClass(), "field_curActionBuf");
    ...
    L27:
        MomentsCommentProtectHook.m1657r("rescued convertFrom flag=" + r23);
        return;
    L30:
        return;
    L29:
    ...
    L5:
        this.f2004c.getClass();
        if (MomentsCommentProtectHook.m1649j() == false) goto L56;
        r7.m1946c(null);
        Object r72 = r7.f2669b;     // Catch: Throwable -> L11
        AbstractC0307g.m702d(r72, "thisObject");     // Catch: Throwable -> L11
        MomentsCommentProtectHook.m1642b(r72);     // Catch: Throwable -> L11
    L13:
    ...
    L15:
        this.f2004c.getClass();
        if (MomentsCommentProtectHook.m1649j() == false) goto L57;
    ...
    L20:
        this.f2004c.getClass();
        if (MomentsCommentProtectHook.m1649j() == false) goto L61;
    ...
    L52:
        MomentsCommentProtectHook.m1657r("rewrote SnsComment update flag=" + r22);
