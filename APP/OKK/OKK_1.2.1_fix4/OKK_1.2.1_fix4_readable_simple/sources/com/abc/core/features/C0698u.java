...
public final class C0698u extends AbstractC0761c {
    ...
    L25:
        ...
        MessageDetailHook.m1570a(r42);
        MessageDetailHook.m1574c(AbstractC0324d.m725h("X2CTextView.", r1.getName()), r42.getClass().getName());
        return;
    L117:
        return;
    L116:
    ...
    L52:
        ...
        MessageDetailHook.m1570a(r43);
        MessageDetailHook.m1574c(AbstractC0324d.m725h("MMNeat.", r1.getName()), r43.getClass().getName());
        return;
    L121:
        return;
    L120:
    ...
    L79:
        ...
        C0707x r95 = PcAutoLoginConfig.m1785a();
    ...
    L100:
        ...
        C0707x r911 = PcAutoLoginConfig.m1785a();
    ...
    L64:
        ...
        return;
    L70:
        MessageDetailHook r46 = MessageDetailHook.f1967a;     // Catch: Throwable -> L62
        MessageDetailHook.m1572b(r9.f2669b, r54, r05, r12);     // Catch: Throwable -> L62
        return;
    L123:
        return;
    L122:
    ...
    L62:
        th = move-exception;
        if (MessageDetailHook.f1974h.compareAndSet(false, true) == false) goto L125;
        MessageDetailHook r06 = MessageDetailHook.f1967a;
        MessageDetailHook.m1601p0("bind after err: " + Log.getStackTraceString(th));
        return;
    }
    ...
    L4:
        return;
    L5:
        C0709x1 r5 = RoundAvatarHook.m1792a();
    ...
    L33:
        ...
        AvatarHook.m1798b(AvatarHook.f2217a, "BitmapUtil." + r2.getName() + " " + r34 + "→" + r52, r42);
        return;
    L85:
        return;
    L30:
    ...
    L69:
        if (r3 == null) goto L98;
        C0707x r103 = PcAutoLoginConfig.m1785a();
    ...
    L45:
        ...
        return;
    L51:
        MessageDetailHook r35 = MessageDetailHook.f1967a;     // Catch: Throwable -> L43
        View r36 = MessageDetailHook.m1553I(r57);     // Catch: Throwable -> L43
    ...
    L60:
        MessageDetailHook.m1591k0(r36, r17, r22);     // Catch: Throwable -> L43
        return;
    L95:
        return;
    L94:
    ...
    L43:
        th = move-exception;
        if (MessageDetailHook.f1974h.compareAndSet(false, true) == false) goto L96;
        MessageDetailHook r02 = MessageDetailHook.f1967a;
        MessageDetailHook.m1601p0("bind before err: " + Log.getStackTraceString(th));
        return;
    }
