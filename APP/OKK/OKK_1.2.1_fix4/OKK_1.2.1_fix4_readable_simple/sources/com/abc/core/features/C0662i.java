...
public final class C0662i extends AbstractC0761c {
    ...
    public /* synthetic */ C0662i(MomentsHook r1, String r2, int r3) {
        this.f2056b = r3;
        this.f2057c = r1;
        this.f2058d = r2;
    }
    ...
    L81:
        MomentsHook.m1675k("BLOCKED sns delete-update via " + r02);
        return;
    L36:
        ...
        Method r125 = MomentsHook.m1669b(r124);     // Catch: Throwable -> L50
    ...
    L66:
        ...
        Method r129 = MomentsHook.m1670c(r10.getClass());     // Catch: Throwable -> L50
    ...
    L72:
        ...
        MomentsHook.m1675k("marked ContentDesc deleted prefix");     // Catch: Throwable -> L50
        goto L75
    L63:
    ...
    L78:
        ...
        MomentsHook r13 = MomentsHook.f2076a;
        MomentsHook.m1675k("ContentDesc mark skipped: " + r1212.getMessage());
    L50:
        th = move-exception;
    ...
    L105:
        ...
        r1.getClass();
        MomentsHook.m1675k("BLOCKED sns clear-visible-bit execSQL via " + r02);
        return;
    L102:
    ...
    L113:
        ...
        r12.m1946c(0);
        r1.getClass();
        MomentsHook.m1675k("BLOCKED sns physical delete via " + r02);
        return;
    L131:
        return;
    }
