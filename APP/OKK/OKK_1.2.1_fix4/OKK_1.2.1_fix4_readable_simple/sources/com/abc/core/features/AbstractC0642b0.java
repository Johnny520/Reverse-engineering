...
public abstract class AbstractC0642b0 {
    ...
    L6:
        ...
        r92 = "";
    L8:
        String r102 = AntiRevokeProcessor.m1741d(r10);
    ...
    L20:
        ...
        return "对方";
    L22:
        if (AntiRevokeProcessor.m1744g(r92) == true) goto L66;
    ...
    L20:
        String r23 = AntiRevokeProcessor.m1739b(r22);     // Catch: Throwable -> L12
        if (r23 != null) goto L25;
        r23 = AntiRevokeProcessor.m1739b(r32);     // Catch: Throwable -> L12
        if (r23 != null) goto L25;
        r23 = AntiRevokeProcessor.m1739b(r02);     // Catch: Throwable -> L12
    L25:
        m1616c(r12);
        return r23;
    }
