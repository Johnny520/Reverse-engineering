...
public final class C0574B0 extends AbstractC0761c {
    ...
    L4:
        return;
    L5:
        HomeAvatarHook r12 = this.f1700c;
        Object r3 = r8.f2669b;
        r12.getClass();
        if (r3 != null) goto L8;
    L28:
    ...
    L118:
        return;
    L33:
        r84 = HomeAvatarHook.f1735m;
        goto L34
    L8:
        if (HomeAvatarHook.f1721B == true) goto L28;
        Object r32 = HomeAvatarHook.m1400g(r3);     // Catch: Throwable -> L12
    L14:
    ...
    L17:
        ...
        HomeAvatarHook.f1721B = true;     // Catch: Throwable -> L23
        HomeAvatarHook.m1412s("hooked tab ViewPager " + r35 + " edge intercept+touch");     // Catch: Throwable -> L23
        Object r13 = C0146l.f339a;     // Catch: Throwable -> L23
    L25:
        Throwable r14 = AbstractC0141g.m465a(r13);
        if (r14 == null) goto L28;
        HomeAvatarHook r36 = HomeAvatarHook.f1723a;
        HomeAvatarHook.m1412s("hookTabViewPagerSwipe fail: " + r14.getMessage());
    L23:
        th = move-exception;
    ...
    L43:
        ...
        r1 = r23.intValue();
    L45:
        HomeAvatarHook.f1735m = r1;
        WeakReference r89 = HomeAvatarHook.f1729g;
        if (r89 == null) goto L120;
        Activity r810 = (Activity) r89.get();
        if (r810 == null) goto L121;
        this.f1700c.getClass();
        HomeAvatarHook.m1404k(r810);
        return;
    L121:
        return;
    L120:
    ...
    L85:
        HomeAvatarHook.f1748z = false;
        HomeAvatarHook.f1720A = SystemClock.uptimeMillis();
        Activity r816 = HomeAvatarHook.m1394a(r8.f2669b);
        if (r816 != null) goto L93;
        WeakReference r817 = HomeAvatarHook.f1729g;
    ...
    L102:
        ...
        HomeAvatarHook.f1748z = false;
        HomeAvatarHook.f1720A = SystemClock.uptimeMillis();
        Activity r818 = HomeAvatarHook.m1394a(r8.f2669b);
        if (r818 != null) goto L112;
        WeakReference r819 = HomeAvatarHook.f1729g;
    ...
    L98:
        ...
        goto L99
    L80:
        if (AbstractC0425j.m1005J0(HomeAvatarHook.f1722C, "LauncherUI", false) == false) goto L82;
        return;
    L82:
        if (AbstractC0425j.m1005J0(HomeAvatarHook.f1722C, "MainTabUI", false) == true) goto L129;
        this.f1700c.getClass();
    ...
    L14:
        ...
        r12.getClass();
        Activity r14 = HomeAvatarHook.m1399f(r63);
    ...
    L58:
        ...
        HomeAvatarHook r73 = this.f1700c;
        Context r68 = r67.getContext();
        r73.getClass();
        Activity r69 = HomeAvatarHook.m1399f(r68);
