...
public final class CustomBubbleHook extends AbstractC0761c {
    ...
    L4:
        return;
    L5:
        MessageDetailHook r1 = this.f1952c;
    ...
    L68:
        ConfigStore r45 = ConfigStore.f2048a;     // Catch: Throwable -> L43
    ...
    L72:
        ...
        MessageDetailHook.m1601p0(r02);     // Catch: Throwable -> L43
    ...
    L51:
        ...
        float r04 = MessageDetailHook.m1607u(r03, 120);
    ...
    L68:
        ...
        int r37 = MessageDetailHook.m1607u(r36, 32);
    ...
    L77:
        ...
        if (r39 == 1) goto L96;
        if (r39 != 2) goto L95;
        MessageDetailHook.m1601p0("right swipe repeat delta=" + ((int) r72));
        if (MessageDetailHook.m1563T(MessageDetailHook.f1961A, r5, "ChatFooter") == true) goto L112;
        if (MessageDetailHook.m1563T(MessageDetailHook.f1962B, r5, "quoteComponent") == true) goto L112;
        if (MessageDetailHook.m1562S(r5) == false) goto L90;
    L93:
        MessageDetailHook.m1601p0("right swipe fallback to quote for ".concat(r5.getClass().getName()));
        goto L112
    L90:
        if (MessageDetailHook.m1561R(r5) == true) goto L93;
        MessageDetailHook.m1601p0("right swipe repeat not ready for ".concat(r5.getClass().getName()));
        goto L112
    L95:
        throw new C0137c();
    L96:
        MessageDetailHook.m1601p0("left swipe quote delta=" + ((int) r72));
        Object r310 = MessageDetailHook.m1587i0(r22, r5);
        Object r53 = MessageDetailHook.f1961A;
    ...
    L104:
        if (MessageDetailHook.m1562S(r310) == true) goto L112;
        if (MessageDetailHook.m1561R(r310) == true) goto L112;
        if (r4 == null) goto L111;
        r4.post(new RunnableC0603L(r1, r22, r310));
        goto L112
    L111:
        MessageDetailHook.m1601p0("left swipe quote target not ready for ".concat(r310.getClass().getName()));
    L76:
    ...
    public CustomBubbleHook(MessageDetailHook r2) {
        this.f1951b = 1;
        this.f1952c = r2;
    }
}
