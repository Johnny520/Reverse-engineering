...
public final /* synthetic */ class SettingsEntryHook implements InterfaceC0286l {
    ...
    L4:
        ...
        r02 = r9;
    L10:
        Set r4 = SettingsEntryInjector.f2995d;
    ...
    L27:
        if (r2 != null) goto L36;
        r2 = SettingsEntryInjector.m2141g(r9);
        if (r2 != null) goto L36;
    ...
    L49:
        ...
        RealNameTailHook.f2169g.post(new RunnableC0328h(r12, r93, 3));
        return C0146l.f339a;
    L51:
        ...
        HomeAvatarHook r13 = HomeAvatarHook.f1723a;
        String r14 = HomeAvatarHook.m1409p(r06);
        if (AbstractC0425j.m1013R0(r14) == false) goto L55;
        r14 = HomeAvatarHook.f1736n;
    L55:
        if ((true ^ AbstractC0425j.m1013R0(r14)) == false) goto L65;
        Method r3 = HomeAvatarHook.f1742t;     // Catch: Throwable -> L62
        if (r3 != null) goto L59;
        r3 = HomeAvatarHook.m1408o(r06);     // Catch: Throwable -> L62
    L59:
        if (r3 == null) goto L65;
    ...
    public /* synthetic */ SettingsEntryHook(int r1, Object r2) {
        this.f1805a = r1;
        this.f1806b = r2;
    }
}
