...
public final class MessageDetailHook {
    ...
    /* JADX INFO: renamed from: a */
    public static final MessageDetailHook f1967a = null;
    ...
    L3:
        ...
        AbstractC0762d.m1952b(r2, new InputStatsMessageHook(18, false));
    L7:
        r1 = r1 + 1;
        goto L3
    L8:
    ...
    L63:
        ...
        String r15 = "";
    L475:
        GroupMemberTitleHook.m1502g(r46, r92, r11);     // Catch: Throwable -> L69
        Object r09 = r2;
    L71:
    ...
    L469:
        RealNameTailHook.f2163a.m1784k(r46, r92, r11);     // Catch: Throwable -> L79
        Object r22 = r2;
    L81:
    ...
    L174:
        ...
        ConfigStore r316 = ConfigStore.f2048a;
        Integer r317 = AbstractC0432q.m1026A0(ConfigStore.m1662d("detail_horizontal_margin", "0"));
        if (r317 == null) goto L177;
        int r382 = r317.intValue();
    L178:
        Integer r318 = AbstractC0432q.m1026A0(ConfigStore.m1662d("detail_left_margin", String.valueOf(r382)));
        if (r318 == null) goto L181;
        int r392 = r318.intValue();
    L182:
        Integer r319 = AbstractC0432q.m1026A0(ConfigStore.m1662d("detail_right_margin", String.valueOf(r382)));
        if (r319 == null) goto L185;
        int r40 = r319.intValue();
    L186:
        r82 = r32;
        int r422 = AbstractC0358S.m873Y(ConfigStore.m1662d("detail_text_color_light", r82), AbstractC0358S.m873Y(ConfigStore.m1662d("detail_text_color", "#E6000000"), -436207616));
        int r432 = AbstractC0358S.m873Y(ConfigStore.m1662d("detail_text_color_dark", r82), AbstractC0358S.m873Y(ConfigStore.m1662d("detail_text_color", "#CCFFFFFF"), -855638017));
        boolean r342 = ConfigStore.m1661c("detail_enabled", true);
        String r352 = ConfigStore.m1662d("detail_template", "${time} ${relativeTime}");
        String r362 = ConfigStore.m1662d("detail_time_pattern", "MM-dd HH:mm:ss");
        Float r1211 = AbstractC0431p.m1025z0(ConfigStore.m1662d("detail_text_size", "12"));
        if (r1211 == null) goto L190;
        float r1212 = r1211.floatValue();
    L191:
        AbstractC0623S0.f1922b = new C0625T0(r342, r352, r362, r1212, r382, r392, r40, r422, r422, r432, ConfigStore.m1661c("detail_click_show", false));
    ...
    L39:
        ...
        AbstractC0358S.m904q(r13, "dispatchTouchEvent", new Object[]{MotionEvent.class, new CustomBubbleHook(this)});     // Catch: Throwable -> L44
