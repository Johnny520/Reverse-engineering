...
public final class MomentsCommentProtectHook {
    ...
    public static final MomentsCommentProtectHook f2040a = null;
    ...
    static {
        f2040a = new MomentsCommentProtectHook();
        f2041b = new AtomicBoolean(false);
        f2042c = new AtomicBoolean(false);
    }

    /* JADX INFO: renamed from: a */
    public static final void m1641a(MomentsCommentProtectHook r10, C0760b r11, boolean r12) {
        r10.getClass();
    ...
    public static boolean m1649j() {
        ...
        Object r03 = Boolean.valueOf(ConfigStore.m1661c("anti_moments_comment_revoke", true));     // Catch: Throwable -> L4
    L6:
