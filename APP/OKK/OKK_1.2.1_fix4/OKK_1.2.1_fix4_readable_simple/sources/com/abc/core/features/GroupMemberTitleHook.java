...
public abstract class GroupMemberTitleHook {
    ...
    L6:
        if (r19 != 1) goto L8;
        ConfigStore r12 = ConfigStore.f2048a;
        C0143i r11 = new C0143i(ConfigStore.m1662d("member_title_owner", "群主"), "#FFC107", "#FFFFFF");
    L12:
    ...
    L35:
        ThreadLocal r17 = r2;
    L44:
        ConfigStore r04 = ConfigStore.f2048a;
        Iterator r05 = AbstractC0182m.m556h0(new String[]{ConfigStore.m1662d("member_title_owner", "群主"), ConfigStore.m1662d("member_title_admin", "管理员"), ConfigStore.m1662d("member_title_member", "成员")}).iterator();
    L46:
    ...
    L8:
        if (r19 == 2) goto L10;
        ConfigStore r123 = ConfigStore.f2048a;
        r11 = new C0143i(ConfigStore.m1662d("member_title_member", "成员"), "#9E9E9E", "#FFFFFF");
        goto L12
    L10:
        ConfigStore r124 = ConfigStore.f2048a;
        r11 = new C0143i(ConfigStore.m1662d("member_title_admin", "管理员"), "#2196F3", "#FFFFFF");
        goto L12
    }
    ...
    public static boolean m1500e() {
        ...
        Object r03 = Boolean.valueOf(ConfigStore.m1661c("member_title", false));     // Catch: Throwable -> L4
    L6:
    ...
    L345:
        return;
    L295:
        ConfigStore r08 = ConfigStore.f2048a;     // Catch: Throwable -> L283
        Object r09 = Boolean.valueOf(ConfigStore.m1661c("member_title_show_member", true));     // Catch: Throwable -> L283
    L285:
    ...
    L191:
        ...
        if (AntiRevokeProcessor.m1744g(r1) == true) goto L233;
    L277:
