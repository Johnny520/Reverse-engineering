...
public final class C0692s implements Comparator {
    ...
    L8:
        ...
        MessageDetailHook r3 = MessageDetailHook.f1967a;
        Integer r63 = Integer.valueOf(AbstractC0358S.m876a0(r02, r2, MessageDetailHook.m1564U(r62)));
        Method r52 = (Method) r5;
        String r03 = r52.getName();
        AbstractC0307g.m702d(r03, "getName(...)");
        return AbstractC0040p.m112q(r63, Integer.valueOf(AbstractC0358S.m876a0(r03, r52.getParameterTypes().length, MessageDetailHook.m1564U(r52))));
    L5:
