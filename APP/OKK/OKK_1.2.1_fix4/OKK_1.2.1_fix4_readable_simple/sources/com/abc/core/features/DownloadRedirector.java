...
public final class DownloadRedirector {
    ...
    public static final DownloadRedirector f2022a = null;

    /* JADX INFO: renamed from: b */
    public static final AtomicBoolean f2023b = null;

    static {
        f2022a = new DownloadRedirector();
    ...
    public static boolean m1633b() {
        ...
        Object r03 = Boolean.valueOf(ConfigStore.m1661c("download_redirect_enabled", false));     // Catch: Throwable -> L4
    L6:
    ...
    public static String m1634c() {
        ...
        ConfigStore r1 = ConfigStore.f2048a;     // Catch: Throwable -> L5
        Object r12 = ConfigStore.m1662d("download_redirect_dir", "/storage/emulated/0/Android/media/com.tencent.mm/OKK/download");     // Catch: Throwable -> L5
    L8:
    ...
    L14:
        ...
        ConfigStore.m1664h("download_redirect_dir", r64);
        return;
    L10:
        r63 = "";
        goto L11
