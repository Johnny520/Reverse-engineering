...
public final class ModuleBootstrap {
    ...
    L26:
        ...
        AtomicBoolean r32 = FeatureInstaller.f2956a;
        AbstractC0307g.m703e(r8, "cl");
        Context r33 = r7.getApplicationContext();
        if (r33 != null) goto L29;
        r33 = r7;
    L29:
        FeatureInstaller.f2957b = r33;
        FeatureInstaller.f2958c = r8;
        FeatureInstaller.f2959d = r92;
        ConcurrentHashMap r34 = FeatureStatusRegistry.f2728a;
        FeatureStatusRegistry.m1962b("WeChatVersion", new C0840s(2, r7));
        FeatureStatusRegistry.m1962b("SettingsEntry", new FeatureInstallTask(r8, r7));
        FeatureStatusRegistry.m1962b("CompatCheckUi", new FeatureInstallTask(r7, r8, 11));
        CompatibilityReport r82 = CompatibilityReport.f1683h;
        if (r82 != null) goto L32;
        r82 = AbstractC0358S.m882d0(r7);
    L32:
        String r72 = AbstractC0358S.m912u(r7, r82, r92);
        AppFingerprint r83 = AbstractC0358S.m862L();
