...
public final class C0675m0 extends AbstractC0761c {
    ...
    L4:
        return;
    L5:
        MessageEditHook r02 = this.f2103c;
        r02.getClass();
        if (MessageEditHook.m1725p() == false) goto L16;
        Object r32 = r3.f2669b;
        if ((r32 instanceof Menu) == false) goto L11;
        Menu r33 = (Menu) r32;
    L12:
        if (r33 == null) goto L17;
        MessageEditHook.m1713b(r02, r33);
        return;
    L17:
        return;
    L11:
    ...
    L63:
        ...
        if (MessageEditHook.m1725p() == false) goto L127;
    ...
    L72:
        ...
        WeakReference r03 = MessageEditHook.f2131p;
        if (r03 == null) goto L126;
        TextView r04 = (TextView) r03.get();
        if (r04 == null) goto L130;
        this.f2103c.getClass();
        if (MessageEditHook.m1723n(r04) == false) goto L131;
        this.f2103c.getClass();
        MessageEditHook.m1709A(r04);
    ...
    L84:
        this.f2103c.getClass();
        if (MessageEditHook.m1725p() == false) goto L132;
    ...
    L91:
        ...
        return;
    L94:
        if (MessageEditHook.m1714c(r123) == false) goto L134;
        TextView r2 = MessageEditHook.m1712a(this.f2103c, r123);
        if (r2 == null) goto L135;
        this.f2103c.getClass();
        MessageEditHook.f2130o = MessageEditHook.m1730u(r123, r2);
        MessageEditHook.f2131p = new WeakReference(r2);
        C0666j0 r124 = MessageEditHook.f2130o;
        if (r124 == null) goto L103;
        String r125 = r124.f2068b;
        if (r125 == null) goto L103;
    L104:
        MessageEditHook.f2132q = r125;
        MessageEditHook.f2133r = System.currentTimeMillis();
        MessageEditHook r126 = this.f2103c;
        String r3 = r2.getClass().getName();
        MessageEditHook r4 = this.f2103c;
    ...
    L109:
        ...
        r126.getClass();
        MessageEditHook.m1711C(r05);
        return;
    L103:
        this.f2103c.getClass();
        r125 = MessageEditHook.m1734y(r2);
        goto L104
    L135:
        return;
    L134:
    ...
    L132:
        return;
    L6:
        if (MessageEditHook.f2129n == true) goto L114;
        this.f2103c.getClass();
        if (MessageEditHook.m1725p() == false) goto L116;
        ConcurrentHashMap r23 = MessageEditHook.f2122g;
    ...
    L22:
        ...
        return;
    L25:
        if (MessageEditHook.m1714c(r33) == false) goto L120;
        ...
        String r6 = (String) MessageEditHook.f2121f.get(r44);
        long r7 = 0;
        if (r6 != null) goto L53;
        MessageEditHook r62 = this.f2103c;
    ...
    L43:
        ...
        MessageEditHook r9 = MessageEditHook.f2116a;
        C0666j0 r92 = MessageEditHook.m1730u(r64, r33);
    ...
    L50:
        if (r93 <= 0) goto L52;
        r13 = (String) MessageEditHook.f2122g.get(Long.valueOf(r93));
    L52:
        r6 = r13;
        r7 = r93;
        goto L53
    ...
    L53:
        ...
        this.f2103c.getClass();
        if (MessageEditHook.m1726q(r33) == true) goto L59;
        return;
    L59:
        if (r6.equals(r44) == true) goto L125;
        r12.f2670c[0] = r6;
        MessageEditHook r127 = this.f2103c;
        String r06 = "rebind edited text msgId=" + r7 + " len=" + r44.length() + "->" + r6.length();
        r127.getClass();
        MessageEditHook.m1711C(r06);
        return;
    L125:
        return;
    L123:
    ...
    L18:
        ...
        goto L19
    L13:
        if (MessageEditHook.f2121f.isEmpty() == false) goto L15;
        return;
    L116:
        return;
    }
