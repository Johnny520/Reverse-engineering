...
public final class C0596I1 extends AbstractC0761c {
    ...
    L13:
        if (r1 == null) goto L63;
        HookDiagnostics r04 = HookDiagnostics.f3000a;
        HookDiagnostics.m2151a(r1, "hook:" + r5.f2668a.getName());
        return;
    L63:
        return;
    L17:
    ...
    L23:
        if (r1 == null) goto L65;
        HookDiagnostics.m2151a(r1, "focus");
        return;
    L65:
        return;
    L64:
    ...
    L30:
        ...
        return;
    L33:
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L67;
        Object r57 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1439B(r1);
        return;
    L67:
        return;
    L37:
    ...
    L40:
        if (r1 == null) goto L70;
        Object r59 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1466x(r1);
    ...
    L4:
        HookDiagnostics r12 = HookDiagnostics.f3000a;
        return;
    L6:
        SettingsEntryInjector r13 = SettingsEntryInjector.f2992a;
        return;
    L8:
        SettingsEntryInjector r14 = SettingsEntryInjector.f2992a;
    }

    public C0596I1(ClassLoader r1) {
        this.f1826b = 6;
        SettingsEntryInjector r12 = SettingsEntryInjector.f2992a;
    }
}
