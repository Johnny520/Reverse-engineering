...
public final class C0648d0 extends AbstractC0761c {
    ...
    public final /* synthetic */ DownloadRedirector f2015c;
    ...
    L4:
        this.f2015c = DownloadRedirector.f2022a;
        return;
    L6:
        this.f2015c = DownloadRedirector.f2022a;
        return;
    ...
    public final void mo1386b(C0760b r12) {
        String r02 = null;
        DownloadRedirector r3 = this.f2015c;
        switch(this.f2014b) {
            case 0: goto L112;
            case 1: goto L117;
            default: goto L115;
    ...
    L115:
        ...
        if (DownloadRedirector.m1633b() == false) goto L119;
        ...
        String r23 = DownloadRedirector.m1632a(r22);     // Catch: Throwable -> L17
        if (r23 == null) goto L122;
        r12.f2670c[1] = r23;     // Catch: Throwable -> L17
        DownloadRedirector.m1636e("Toast.makeText rewritten: ".concat(r23));     // Catch: Throwable -> L17
        return;
    L122:
        return;
    L121:
    ...
    L117:
        ...
        if (DownloadRedirector.m1633b() == false) goto L124;
    ...
    L29:
        ...
        String r03 = DownloadRedirector.m1632a(r02);     // Catch: Throwable -> L27
        if (r03 == null) goto L126;
        r12.f2670c[1] = r03;     // Catch: Throwable -> L27
        DownloadRedirector.m1636e("ExportFileUtil toast rewritten: ".concat(r03));     // Catch: Throwable -> L27
        return;
    L126:
        return;
    L125:
    ...
    L112:
        ...
        if (DownloadRedirector.m1633b() == false) goto L128;
    ...
    L59:
        ...
        Object r83 = "";
        ConfigStore r9 = ConfigStore.f2048a;     // Catch: Throwable -> L64
        Object r92 = ConfigStore.m1662d("download_redirect_tree_uri", "");     // Catch: Throwable -> L64
    L67:
    ...
    L70:
        ...
        DownloadRedirector.m1636e("No tree URI configured, falling back to original logic.");     // Catch: Throwable -> L44
        return;
    L73:
        Uri r85 = Uri.parse(r84);     // Catch: Throwable -> L44
        String r27 = new File(r26).getName();     // Catch: Throwable -> L44
        DownloadRedirector.m1636e("Attempting SAF copy: " + r13 + " -> " + r85 + " / " + r27);     // Catch: Throwable -> L44
        File r6 = new File(r13);     // Catch: Throwable -> L44
        if (r6.exists() == true) goto L76;
        DownloadRedirector.m1636e("Source file does not exist: ".concat(r13));     // Catch: Throwable -> L44
        return;
    L76:
        ...
        DownloadRedirector.m1636e("Failed to create document in SAF directory");     // Catch: Throwable -> L44
        return;
    L79:
        OutputStream r28 = r73.getContentResolver().openOutputStream(r14);     // Catch: Throwable -> L44
        if (r28 != null) goto L107;
    L98:
        DownloadRedirector.m1636e("SAF copy successful! Saved to " + r14);     // Catch: Throwable -> L44
    ...
    L101:
        ...
        r3.getClass();
        DownloadRedirector.m1636e(r125);
        return;
    L135:
        return;
    L107:
