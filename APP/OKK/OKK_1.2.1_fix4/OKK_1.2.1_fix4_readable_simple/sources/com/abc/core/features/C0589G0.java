...
public final class C0589G0 extends AbstractC0761c {
    ...
    L8:
        ...
        return;
    L11:
        if (InputStatsDatabase.f1821d.get() == true) goto L45;
        this.f1791c.getClass();
        if (InputStatsDatabase.m1478f(r33) == false) goto L46;
        final int r1 = 1;
    ...
    L22:
        ...
        this.f1791c.getClass();
        Set r02 = InputStatsDatabase.f1823f;
        monitor-enter(r02);
    ...
    L33:
        ...
        View r37 = (View) r36;
    L37:
        InputStatsDatabase.f1825h = r37;
        this.f1791c.getClass();
        View r38 = InputStatsDatabase.f1825h;
