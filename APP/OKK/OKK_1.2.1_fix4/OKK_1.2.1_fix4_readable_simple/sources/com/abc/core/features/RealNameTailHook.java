...
public final class RealNameTailHook {
    ...
    public static final RealNameTailHook f2163a = null;
    ...
    L62:
        ConfigStore r133 = ConfigStore.f2048a;     // Catch: Throwable -> L44
        Object r134 = Integer.valueOf(Color.parseColor(ConfigStore.m1662d("real_name_tail_color", "#9E9E9E")));     // Catch: Throwable -> L44
    L47:
    ...
    public static void m1769e(Class r14) {
        InputStatsMessageHook r1 = new InputStatsMessageHook(27, false);
    ...
    public static boolean m1771g() {
        ...
        Object r03 = Boolean.valueOf(ConfigStore.m1661c("real_name_tail", false));     // Catch: Throwable -> L4
    L6:
    ...
    L98:
        ...
        return;
    L101:
        m1783c(r10, r92, new SettingsEntryHook(r3, r5));
        return;
    L91:
