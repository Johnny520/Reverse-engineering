...
public final class ViewTreeObserverOnPreDrawListenerC0587F1 implements ViewTreeObserver.OnPreDrawListener, ViewGroup.OnHierarchyChangeListener {
    ...
    L5:
        ...
        return;
    L9:
        if (ThemeWallpaperConfig.f1701a.m1393e() == true) goto L11;
        return;
    L11:
        WallpaperOverlayHook.f1796e.post(new RunnableC0328h(r32, this, 4));
    }
    ...
    L5:
        ...
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L34;
