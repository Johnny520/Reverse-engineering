...
public final class C0684p0 extends AbstractC0761c {
    ...
    L18:
        ...
        if (FoldBannerPinHook.f2156c == false) goto L117;
        FoldBannerPinHook r02 = this.f2144c;
    ...
    L35:
        View r2 = FoldBannerPinHook.m1761h(r12);     // Catch: Throwable -> L33
        if (r2 == null) goto L39;
        FoldBannerPinHook.m1762i(r2);     // Catch: Throwable -> L33
        FoldBannerPinHook.m1759f(r2);     // Catch: Throwable -> L33
    L39:
        if ((r12 instanceof View) == false) goto L44;
        if (FoldBannerPinHook.m1760g((View) r12) == false) goto L44;
        FoldBannerPinHook.m1762i((View) r12);     // Catch: Throwable -> L33
        FoldBannerPinHook.m1759f((View) r12);     // Catch: Throwable -> L33
    L44:
        if ((r12 instanceof ViewGroup) == false) goto L23;
        View r13 = FoldBannerPinHook.m1758e((ViewGroup) r12);     // Catch: Throwable -> L33
        if (r13 == null) goto L23;
        FoldBannerPinHook.m1762i(r13);     // Catch: Throwable -> L33
        FoldBannerPinHook.m1759f(r13);     // Catch: Throwable -> L33
        goto L23
    L31:
    ...
    L73:
        ...
        View r56 = FoldBannerPinHook.m1758e(r14);     // Catch: Throwable -> L53
        if (r56 == null) goto L116;
        FoldBannerPinHook.m1762i(r56);     // Catch: Throwable -> L53
        FoldBannerPinHook.m1759f(r56);     // Catch: Throwable -> L53
        FoldBannerPinHook.m1765l("decor lt5 hidden");     // Catch: Throwable -> L53
        return;
    L116:
        return;
    L115:
    ...
    L80:
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L119;
        FoldBannerPinHook r06 = this.f2144c;
        Object r58 = r5.f2669b;
        AbstractC0307g.m702d(r58, "thisObject");
        r06.getClass();
        View r59 = FoldBannerPinHook.m1761h(r58);
        if (r59 == null) goto L120;
        this.f2144c.getClass();
        FoldBannerPinHook.m1762i(r59);
        this.f2144c.getClass();
        FoldBannerPinHook.m1759f(r59);
        return;
    L120:
        return;
    L119:
    ...
    L88:
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L121;
    ...
    L95:
        ...
        this.f2144c.getClass();
        FoldBannerPinHook.m1762i(r512);
        this.f2144c.getClass();
        FoldBannerPinHook.m1759f(r512);
        FoldBannerPinHook r07 = this.f2144c;
        String r15 = r512.getClass().getSimpleName();
        this.f2144c.getClass();
        String r513 = "setFoldBanner hide " + r15 + " id=" + FoldBannerPinHook.m1764k(r512);
        r07.getClass();
        FoldBannerPinHook.m1765l(r513);
        return;
    L122:
        return;
    L94:
    ...
    L121:
        return;
    L6:
        if (FoldBannerPinHook.f2156c == false) goto L113;
    ...
    L12:
        ...
        this.f2144c.getClass();
        if (FoldBannerPinHook.m1760g(r516) == false) goto L112;
        this.f2144c.getClass();
        FoldBannerPinHook.m1762i(r516);
        this.f2144c.getClass();
        FoldBannerPinHook.m1759f(r516);
        this.f2144c.getClass();
        FoldBannerPinHook.m1765l("addView hide fold banner id=" + FoldBannerPinHook.m1764k(r516));
        return;
    L112:
        return;
    L114:
    ...
    L5:
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L32;
    ...
    L12:
        ...
        return;
    L15:
        if (FoldBannerPinHook.m1754a(r03) == false) goto L34;
        r4.f2670c[0] = Float.valueOf(0.0f);
        this.f2144c.getClass();
        FoldBannerPinHook.m1759f(r03);
        return;
    L34:
        return;
    L11:
    ...
    L19:
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L36;
