...
public final /* synthetic */ class RunnableC0573B implements Runnable {
    ...
    L13:
        ...
        AppFingerprint r23 = AbstractC0358S.m884e0(r52, new C0817b(r13, 1), r33, (String) r2);
        HookDiagnostics r34 = HookDiagnostics.f3000a;
        HookDiagnostics.f3001b.post(new RunnableC0819c(r13, HookDiagnostics.m2155e(r23), r44, r02));
        return;
    L15:
        String r45 = (String) r4;
        AbstractC0307g.m703e(r45, "$sender");
        AbstractC0307g.m703e((RealNameTailHook) r3, "$this_runCatching");
        InterfaceC0286l r14 = (InterfaceC0286l) r1;
        AbstractC0307g.m703e(r14, "$onResult");
        if (RealNameTailHook.f2174l.remove(r2) == null) goto L26;
        RealNameTailHook.f2173k.remove(r2);
        RealNameTailHook.f2171i.remove(r45);
        RealNameTailHook.m1782s("timeout ".concat(r45));
    ...
    public /* synthetic */ RunnableC0573B(Object r2, String r3, RealNameTailHook r4, C0641b r5) {
        this.f1694a = 1;
        this.f1695b = r2;
        this.f1696c = r3;
        this.f1697d = r4;
