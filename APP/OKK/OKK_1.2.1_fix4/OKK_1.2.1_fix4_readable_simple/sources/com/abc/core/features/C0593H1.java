...
public final class C0593H1 extends AbstractC0761c {
    ...
    L43:
        ...
        return;
    L46:
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L171;
        Object r133 = WallpaperOverlayHook.f1792a;
        if (WallpaperOverlayHook.m1459q(r4) == false) goto L172;
    L57:
        th = move-exception;
    ...
    L169:
        return;
    L52:
        if (WallpaperOverlayHook.m1459q(r4) == true) goto L54;
        WallpaperOverlayHook.m1454l(r4);     // Catch: Throwable -> L57
    L55:
        r134 = C0146l.f339a;     // Catch: Throwable -> L57
        goto L59
    L54:
        WallpaperOverlayHook.m1466x(r4);     // Catch: Throwable -> L57
        WallpaperOverlayHook.m1443a(r4);     // Catch: Throwable -> L57
        goto L55
    L172:
        return;
    L171:
    ...
    L93:
        ...
        ThemeWallpaperConfig r68 = ThemeWallpaperConfig.f1701a;
    ...
    L141:
        ...
        ThemeWallpaperConfig r09 = ThemeWallpaperConfig.f1701a;
        ConfigStore.f2048a.m1667g("theme_wallpaper_enabled", true, true);
        ThemeWallpaperConfig.f1704d = true;
    ...
    L114:
        ...
        if (r33 == ThemeWallpaperConfig.f1708h) goto L122;
        ThemeWallpaperConfig.f1708h = r33;     // Catch: Throwable -> L120
        ThemeWallpaperConfig.f1709i = r610.getAbsolutePath();     // Catch: Throwable -> L120
    L122:
        AbstractC0040p.m108m(r05, null);     // Catch: Throwable -> L99
        String r010 = String.valueOf(System.currentTimeMillis());     // Catch: Throwable -> L99
        ConfigStore r34 = ConfigStore.f2048a;     // Catch: Throwable -> L99
        ...
        ThemeWallpaperConfig.f1704d = true;     // Catch: Throwable -> L99
        ThemeWallpaperConfig.f1706f = r610.getAbsolutePath();     // Catch: Throwable -> L99
        ThemeWallpaperConfig.f1707g = r010;     // Catch: Throwable -> L99
        ThemeWallpaperConfig.f1710j = r010;     // Catch: Throwable -> L99
        ThemeWallpaperConfig.f1703c = SystemClock.uptimeMillis();     // Catch: Throwable -> L99
        ThemeWallpaperConfig.m1389f();     // Catch: Throwable -> L99
        r2 = true;
        goto L135
    L124:
        th = move-exception;
    ...
    L66:
        ...
        goto L67
    L6:
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L162;
    ...
    L13:
        ...
        Object r014 = WallpaperOverlayHook.f1792a;
        r013 = WallpaperOverlayHook.m1468z();
        if (r013 != null) goto L20;
        return;
    L20:
        Object r23 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1439B(r013);
    ...
    L162:
        return;
    L23:
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L165;
    ...
    L31:
        ...
        Object r018 = WallpaperOverlayHook.f1792a;
        r017 = WallpaperOverlayHook.m1468z();
        if (r017 != null) goto L38;
        return;
    L38:
        Object r24 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1464v(r017);
    ...
    L6:
        ...
        r03 = WallpaperOverlayHook.m1468z();
    L10:
        if (r03 == null) goto L12;
        Object r13 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1462t(r03);
    L12:
    ...
    L23:
        ...
        Object r010 = WallpaperOverlayHook.f1792a;
        r09 = WallpaperOverlayHook.m1468z();
        if (r09 != null) goto L30;
        return;
    L30:
        Object r14 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1464v(r09);
    ...
    L33:
        ...
        Object r17 = WallpaperOverlayHook.f1792a;
        r16 = WallpaperOverlayHook.m1468z();
        if (r16 != null) goto L40;
        return;
    L40:
        Object r2 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1463u(r16);
    ...
    L57:
        return;
    L43:
        if (ThemeWallpaperConfig.f1701a.m1393e() == false) goto L59;
    ...
    L48:
        if (r1 == null) goto L60;
        Object r23 = WallpaperOverlayHook.f1792a;
        WallpaperOverlayHook.m1463u(r1);
        r7.f2670c[2] = Boolean.FALSE;
        r4.getClass();
