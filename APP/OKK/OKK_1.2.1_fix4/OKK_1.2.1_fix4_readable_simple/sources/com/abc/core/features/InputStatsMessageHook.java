...
public final class InputStatsMessageHook extends AbstractC0761c {
    ...
    public /* synthetic */ InputStatsMessageHook(int r1, boolean r2) {
        this.f2066b = r1;
    }
    ...
    L4:
        return;
    L5:
        C0709x1 r12 = RoundAvatarHook.m1792a();
        if (r12.f2230a == false) goto L381;
        AvatarHook.m1797a(AvatarHook.f2217a, r20.f2669b, r12.f2231b);
        return;
    L381:
        return;
    L10:
        ...
        C0139e r14 = (C0139e) RealNameTailHook.f2173k.remove(r02);
        InterfaceC0286l r2 = (InterfaceC0286l) RealNameTailHook.f2174l.remove(r02);
    ...
    L20:
        Object r4 = RealNameTailHook.m1776m(r02, "r");
        if (r4 != null) goto L26;
        r4 = RealNameTailHook.m1776m(r02, "f150798r");
        if (r4 != null) goto L26;
        r4 = RealNameTailHook.m1776m(r02, "f150798R");
    L26:
        if (r4 == null) goto L48;
        String r11 = RealNameTailHook.m1777n(r4, "f231704f");
        if (r11 != null) goto L30;
    L37:
        r11 = RealNameTailHook.m1777n(r4, "f");
        if (r11 != null) goto L40;
    L45:
        r11 = RealNameTailHook.m1775l(r4);
    ...
    L363:
        Object r3 = RealNameTailHook.m1776m(r02, "r");     // Catch: Throwable -> L90
        if (r3 != null) goto L87;
        r3 = RealNameTailHook.m1776m(r02, "f150798r");     // Catch: Throwable -> L90
    L87:
        if (r3 == null) goto L92;
    ...
    L95:
        ...
        r82 = r03;
    L98:
        RealNameTailHook.m1782s("cgi cb sender=" + r15 + " name=" + r11 + " result=" + r42.getClass().getSimpleName() + " resp=" + ((String) r82));
        boolean r04 = r42 instanceof C0679n1;
        if (r04 == false) goto L102;
        if (r15 == null) goto L102;
        RealNameTailHook.f2170h.put(r15, ((C0679n1) r42).f2136a);
        RealNameTailHook.m1780q();
    L102:
        if (r2 != null) goto L359;
        if (r04 == false) goto L383;
        if (r15 == null) goto L384;
        RealNameTailHook.f2169g.post(new RunnableC0673l1(r15, r42, r7));
        return;
    L384:
        return;
    L383:
    ...
    L80:
        ...
        goto L363
    L40:
        if (RealNameTailHook.m1774j(r11) == true) goto L43;
        r11 = null;
    L43:
    ...
    L48:
        Object r43 = RealNameTailHook.m1776m(r02, "f206693n");
        if (r43 != null) goto L51;
        r43 = RealNameTailHook.m1776m(r02, "n");
    L51:
        if (r43 == null) goto L74;
        Object r112 = RealNameTailHook.m1776m(r43, "f66769b");
        if (r112 != null) goto L57;
        r112 = RealNameTailHook.m1776m(r43, "b");
        if (r112 != null) goto L57;
        Object r44 = null;
    L60:
        if (r44 == null) goto L74;
        String r10 = RealNameTailHook.m1777n(r44, "f231704f");
        if (r10 != null) goto L64;
    L71:
        r11 = RealNameTailHook.m1775l(r44);
    ...
    L66:
        ...
        r11 = r10;
    L57:
        r44 = RealNameTailHook.m1776m(r112, "f66756a");
        if (r44 != null) goto L60;
        r44 = RealNameTailHook.m1776m(r112, "a");
    L74:
        r11 = RealNameTailHook.m1775l(r02);
    ...
    L154:
        ...
        InputStatsDatabase r06 = InputStatsDatabase.f1818a;
        C0598J0 r07 = InputStatsConfig.m1413a();     // Catch: Throwable -> L165
    ...
    L175:
        ...
        r1 = r22;
    L187:
        if (InputStatsDatabase.f1822e.m1788c(InputStatsDatabase.m1480h(r63, r011, r1)) == false) goto L393;
        Context r23 = InputStatsDatabase.f1824g;     // Catch: Throwable -> L165
    ...
    L192:
        ...
        InputStatsDatabase.m1481i(r83, AbstractC0358S.m877b(InputStatsDatabase.m1479g(r83, r24), r011, r1));     // Catch: Throwable -> L165
        View r012 = InputStatsDatabase.f1825h;     // Catch: Throwable -> L165
    ...
    L203:
        ...
        if (FoldBannerPinHook.f2156c == false) goto L399;
        FoldBannerPinHook.m1756c(r20.f2669b);
        return;
    L399:
        return;
    L208:
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L400;
        FoldBannerPinHook.m1756c(r20.f2669b);
        return;
    L400:
        return;
    L213:
        MessageEditHook r18 = MessageEditHook.f2116a;
        if (MessageEditHook.m1725p() == false) goto L401;
        Object r014 = r20.f2669b;
        if ((r014 instanceof Menu) == false) goto L219;
        r84 = (Menu) r014;
    L219:
        if (r84 == null) goto L402;
        MessageEditHook.m1713b(r18, r84);
        return;
    L402:
        return;
    L401:
        return;
    L223:
        MessageDetailHook r19 = MessageDetailHook.f1967a;
        MessageDetailHook.f1962B = r20.f2669b;
        return;
    L225:
        MessageDetailHook.f1961A = r20.f2669b;
        return;
    L227:
    ...
    L301:
        ...
        AtomicBoolean r73 = MessageDatabaseHook.f2105a;
        MessageDatabaseHook.f2114j = r20.f2669b;
        AtomicBoolean r020 = MessageDatabaseHook.f2105a;
        Object r021 = MessageDatabaseHook.m1694c(r46, "field_type");
    ...
    L311:
        ...
        Object r024 = MessageDatabaseHook.m1694c(r46, "field_content");
    ...
    L316:
        ...
        String r124 = "";
    L319:
        Object r026 = MessageDatabaseHook.m1694c(r46, "field_talker");
        if ((r026 instanceof String) == false) goto L322;
        String r027 = (String) r026;
    L323:
        Long r110 = MessageDatabaseHook.m1701j(r46, "field_msgSvrId");
        if (r110 == null) goto L326;
    L325:
        long r111 = r110.longValue();
    L330:
        String r33 = AntiRevokeProcessor.m1740c(r124);
        if (r33 != null) goto L339;
        if (r027 != null) goto L334;
    L338:
        String r162 = null;
    L340:
        Long r74 = MessageDatabaseHook.m1701j(r46, "field_createTime");
        if (r74 == null) goto L343;
        long r142 = r74.longValue();
    L344:
        C0652e1 r34 = new C0652e1(r114, r124, r027, r142, r162, r111);
        Long r75 = MessageDatabaseHook.m1701j(r46, "field_msgId");
        if (r75 == null) goto L347;
        long r76 = r75.longValue();
    L348:
        MessageDatabaseHook.m1704m(r34, r76, r111, r027);
    ...
    L356:
        ...
        MessageDatabaseHook.f2112h.put(Long.valueOf(((Number) r030.next()).longValue()), r46);
        goto L356
    L412:
        return;
    L347:
    ...
    L343:
        ...
        goto L344
    L334:
        if (AntiRevokeProcessor.m1745h(r027) == false) goto L338;
        if (AntiRevokeProcessor.m1744g(r027) == true) goto L338;
        r162 = r027;
        goto L340
    L339:
        r162 = r33;
        goto L340
    L326:
        r110 = MessageDatabaseHook.m1701j(r46, "field_newMsgId");
    ...
    L411:
        return;
    L258:
        if (BottomTabConfig.m1807b() == false) goto L410;
    ...
    L287:
        ...
        return;
    L290:
        FloatingBottomTabView r036 = C0588G.f1770c;
    ...
    L5:
        ...
        AvatarHook.m1798b(AvatarHook.f2217a, "drawable.<init>", r03);
        return;
    L425:
        return;
    L10:
        C0709x1 r04 = RoundAvatarHook.m1792a();
    ...
    L427:
        return;
    L67:
        MessageEditHook r25 = MessageEditHook.f2116a;
        Object r12 = r23.f2669b;
        if (r12 != null) goto L71;
        return;
    L71:
        if (MessageEditHook.f2128m == true) goto L443;
        Set r26 = MessageEditHook.f2127l;
    ...
    L88:
        ...
        throw th;
    L76:
        if (MessageEditHook.f2128m == false) goto L80;
        monitor-exit(r26);
        return;
    L80:
        ...
        return;
    L83:
        CopyOnWriteArrayList r611 = MessageEditHook.f2125j;     // Catch: Throwable -> L88
    ...
    L92:
        ...
        MessageEditHook.f2127l.add(r12);     // Catch: Throwable -> L88
        monitor-exit(r26);
        return;
    L99:
        if (AbstractC0307g.m699a(MessageEditHook.f2126k.computeIfAbsent(r12.getClass(), new C0612O(new C0570A(7), 3)), Boolean.TRUE) == true) goto L102;
        monitor-exit(r26);
        return;
    L102:
        MessageEditHook.f2127l.add(r12);     // Catch: Throwable -> L88
        CopyOnWriteArrayList r4 = MessageEditHook.f2125j;     // Catch: Throwable -> L88
        if (r4.size() < 4) goto L107;
        MessageEditHook.f2128m = true;     // Catch: Throwable -> L88
        monitor-exit(r26);
        return;
    L107:
        monitor-exit(r26);
    ...
    L112:
        ...
        MessageEditHook.m1711C("remember db=" + r12.getClass().getName() + " total=" + r4.size());
        return;
    L441:
        return;
    L86:
    ...
    L197:
        ...
        return;
    L200:
        if (BottomTabConfig.m1807b() == true) goto L202;
        return;
    L202:
    ...
    L314:
        ...
        r9 = r36;
    L317:
        boolean r37 = AntiRevokeProcessor.m1746i(r9);
        if (r37 == false) goto L322;
        C0572A1.m1384a(new long[]{r13});
        AtomicBoolean r42 = MessageDatabaseHook.f2105a;
        MessageDatabaseHook.m1708q("MARKED self revoke source serverId=" + r13);
        if (r05.f2147c == true) goto L322;
        return;
    L322:
        boolean r43 = r05.f2146b;
        if (r43 == false) goto L365;
        AtomicBoolean r52 = MessageDatabaseHook.f2105a;
        if (r13 <= 0) goto L365;
        if (r43 == false) goto L365;
        Object r44 = MessageDatabaseHook.f2114j;
        if (r44 == null) goto L365;
        Method r7 = MessageDatabaseHook.f2113i;
        if (r7 == null) goto L365;
        Object r105 = MessageDatabaseHook.f2112h.get(Long.valueOf(r13));
        if (r105 == null) goto L365;
        C0652e1 r15 = MessageDatabaseHook.m1705n(r13, r13, r29);
        if (AbstractC0425j.m1013R0(r9) == false) goto L340;
        r9 = "recalled a message";
    L340:
        AbstractC0358S r06 = AntiRevokeProcessor.m1738a(new C0700u1(r13, 10000, r9), r15, r05.f2147c, r05.f2148d, true, AbstractC0642b0.m1620g(AntiRevokeProcessor.m1752o(AntiRevokeProcessor.m1746i(r9), r15, r29, r9), r9));
        ...
        MessageDatabaseHook.m1706o(r105, 10000, "field_type");     // Catch: Throwable -> L358
        MessageDatabaseHook.m1706o(r105, r07, "field_content");     // Catch: Throwable -> L358
        if (r15 == null) goto L351;
        long r11 = r15.f2027d;     // Catch: Throwable -> L358
    L352:
        MessageDatabaseHook.m1706o(r105, Long.valueOf(r11 + 1), "field_createTime");     // Catch: Throwable -> L358
        MessageDatabaseHook.m1706o(r105, r07, "x0");     // Catch: Throwable -> L358
        Boolean r92 = Boolean.FALSE;     // Catch: Throwable -> L355
        r7.invoke(r44, new Object[]{r105, r92, r92});     // Catch: Throwable -> L355
    L356:
        MessageDatabaseHook.m1708q("inserted source revoke notice serverId=" + r13 + " notice=" + AbstractC0425j.m1021Z0(r07, 48));     // Catch: Throwable -> L358
        Object r08 = C0146l.f339a;     // Catch: Throwable -> L358
    L360:
        Throwable r09 = AbstractC0141g.m465a(r08);
        if (r09 == null) goto L365;
        AtomicBoolean r45 = MessageDatabaseHook.f2105a;
        MessageDatabaseHook.m1708q("source revoke notice failed serverId=" + r13 + ": " + r09.getMessage());
        goto L365
    L355:
    ...
    L365:
        r23.m1946c(null);
        AtomicBoolean r010 = MessageDatabaseHook.f2105a;
        MessageDatabaseHook.m1708q("BLOCKED source revoke serverId=" + r13 + " talker=" + r29 + " self=" + r37);
        return;
    L313:
        r36 = null;
        goto L314
    ...
    L367:
        ...
        return;
    L29:
        if (AbstractC0307g.m699a(FoldBannerPinHook.f2162i.get(), Boolean.TRUE) == true) goto L431;
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L432;
    ...
    L37:
        ...
        return;
    L40:
        if (FoldBannerPinHook.m1754a(r63) == false) goto L434;
    ...
    L431:
        return;
    L45:
        if (AbstractC0307g.m699a(FoldBannerPinHook.f2162i.get(), Boolean.TRUE) == true) goto L437;
        FoldBannerPinHook.m1755b();
        if (FoldBannerPinHook.f2156c == false) goto L438;
    ...
    L54:
        ...
        return;
    L57:
        if (FoldBannerPinHook.m1754a(r014) == false) goto L440;
    ...
    L150:
        ...
        String r47 = AbstractC0626U.m1534g(MessageDetailHook.f1965E, r313);
    ...
    L156:
        ...
        C0618Q r314 = AbstractC0626U.m1532e(r55, MessageDetailHook.f1965E, r313);
    ...
    L453:
        return;
    L161:
        if (BottomTabConfig.m1807b() == true) goto L163;
        return;
    L163:
    ...
    L457:
        return;
    L179:
        if (BottomTabConfig.m1807b() == true) goto L181;
        return;
    L181:
    ...
    L461:
        return;
    L217:
        if (BottomTabConfig.m1807b() == true) goto L219;
        return;
    L219:
    ...
    L243:
        ...
        String r217 = (String) AbstractC0181l.m545q0(BottomTabConfig.m1808c(), C0588G.f1784q);
    ...
    L473:
        return;
    L265:
        if (BottomTabConfig.m1807b() == true) goto L267;
        return;
    L267:
    ...
    L484:
        return;
    L282:
        if (BottomTabConfig.m1807b() == false) goto L489;
    ...
    public InputStatsMessageHook(int r1) {
        this.f2066b = r1;
        switch(r1) {
            case 8: goto L34;
            case 9: goto L32;
    ...
    L4:
        ...
        return;
    L6:
        AvatarHook r13 = AvatarHook.f2217a;
        return;
    L8:
        C0670k1 r14 = C0670k1.f2084a;
        return;
    L10:
        FoldBannerPinHook r15 = FoldBannerPinHook.f2154a;
        return;
    L12:
        FoldBannerPinHook r16 = FoldBannerPinHook.f2154a;
        return;
    L14:
        FoldBannerPinHook r17 = FoldBannerPinHook.f2154a;
        return;
    L16:
        FoldBannerPinHook r18 = FoldBannerPinHook.f2154a;
        return;
    L18:
        MessageEditHook r19 = MessageEditHook.f2116a;
        return;
    L20:
        MessageEditHook r110 = MessageEditHook.f2116a;
        return;
    L22:
        MessageDetailHook r111 = MessageDetailHook.f1967a;
        return;
    L24:
