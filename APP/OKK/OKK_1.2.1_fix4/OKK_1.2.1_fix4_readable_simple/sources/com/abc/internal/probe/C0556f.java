...
public final /* synthetic */ class C0556f {
    ...
    /* JADX INFO: renamed from: a */
    public final DiagnosticItem m1369a(C0562l r5) {
    ...
    L7:
        ...
        DiagnosticLevel r3 = DiagnosticLevel.f1666c;
        if (r22 != null) goto L20;
        AbstractC0560j r53 = (AbstractC0560j) r52;
        if ((r53 instanceof C0558h) == false) goto L13;
        r3 = DiagnosticLevel.f1664a;
    L27:
        return new DiagnosticItem(r02, r1, r3, r53.mo1370a());
    L13:
        if ((r53 instanceof C0559i) == false) goto L16;
        r3 = DiagnosticLevel.f1665b;
        goto L27
    L16:
    ...
    L20:
        ...
        r23 = "error";
    L24:
        return new DiagnosticItem(r02, r1, r3, r23);
    L5:
        th = move-exception;
