...
public final /* synthetic */ class RunnableC0486k implements Runnable {
    ...
    L6:
        ...
        RealNameTailHook r12 = RealNameTailHook.f2163a;
        RealNameTailHook.m1766a((TextView) this.f1365b, r02.f1892b, (String) this.f1367d);
        return;
    L8:
        ...
        return;
    L11:
        if (RealNameTailHook.f2170h.containsKey((String) this.f1366c) == true) goto L44;
    ...
    L14:
        ...
        if (MessageDetailHook.m1562S(r03) == false) goto L18;
        return;
    L18:
        if (MessageDetailHook.m1561R(r03) == true) goto L46;
