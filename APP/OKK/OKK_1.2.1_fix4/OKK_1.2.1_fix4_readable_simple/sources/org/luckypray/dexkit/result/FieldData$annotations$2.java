...
public final class FieldData$annotations$2 extends AbstractC0308h implements InterfaceC0275a {
    final /* synthetic */ DexKitBridge $bridge;
    final /* synthetic */ int $dexId;
    final /* synthetic */ int $id;
    final /* synthetic */ FieldData this$0;

    public FieldData$annotations$2(DexKitBridge r1, FieldData r2, int r3, int r4) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        this.$id = r4;
    ...
    public final List<AnnotationData> invoke() {
        ...
        long r1 = FieldData.access$getEncodeId(this.this$0, this.$dexId, this.$id);
        byte[] r12 = DexKitBridge.Companion.access$nativeGetFieldAnnotations(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), r1);
