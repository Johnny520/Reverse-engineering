...
public final class FieldData$writers$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public FieldData$writers$2(DexKitBridge r1, FieldData r2, int r3, int r4) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        this.$id = r4;
    ...
    public final MethodDataList invoke() {
        ...
        byte[] r12 = DexKitBridge.Companion.access$nativeFieldPutMethods(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), r1);
