...
public final class MethodData$paramTypes$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public MethodData$paramTypes$2(DexKitBridge r1, MethodData r2, int r3) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        super(0);
    ...
    public final ClassDataList invoke() {
        ...
        List r1 = MethodData.access$getParamTypeIds$p(this.this$0);
        MethodData r2 = this.this$0;
        int r3 = this.$dexId;
        ArrayList r4 = new ArrayList(AbstractC0183n.m559k0(r1, 10));
        Iterator r12 = r1.iterator();
    L4:
        if (r12.hasNext() == false) goto L6;
        r4.add(Long.valueOf(MethodData.access$getEncodeId(r2, r3, ((Number) r12.next()).intValue())));
        goto L4
    L6:
        long[] r13 = AbstractC0181l.m554z0(r4);
        byte[] r14 = DexKitBridge.Companion.access$nativeGetClassByIds(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), r13);
        ClassMetaArrayHolder.Companion r22 = ClassMetaArrayHolder.Companion;
        ByteBuffer r15 = ByteBuffer.wrap(r14);
        AbstractC0307g.m702d(r15, "wrap(res)");
        ClassMetaArrayHolder r16 = r22.getRootAsClassMetaArrayHolder(r15);
        ClassDataList r23 = new ClassDataList();
        int r32 = r16.getClassesLength();
        int r42 = 0;
    L7:
        if (r42 >= r32) goto L9;
        ClassData.Companion r5 = ClassData.f4419Companion;
        ClassMeta r6 = r16.classes(r42);
