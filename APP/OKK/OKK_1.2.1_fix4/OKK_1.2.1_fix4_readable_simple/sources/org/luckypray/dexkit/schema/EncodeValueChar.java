...
public final class EncodeValueChar extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createEncodeValueChar(C0733b r2, short r3) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(1);
            addValue(r2, r3);
            return endEncodeValueChar(r2);
        }

        public final int endEncodeValueChar(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final EncodeValueChar getRootAsEncodeValueChar(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsEncodeValueChar(r2, new EncodeValueChar());
        }

        public final void startEncodeValueChar(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(1);
        }
        ...
        public final EncodeValueChar getRootAsEncodeValueChar(ByteBuffer r3, EncodeValueChar r4) {
    ...
    public final EncodeValueChar __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
