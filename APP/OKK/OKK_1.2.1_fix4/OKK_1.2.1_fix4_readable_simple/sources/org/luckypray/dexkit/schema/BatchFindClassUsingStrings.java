...
public final class BatchFindClassUsingStrings extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final int createBatchFindClassUsingStrings(C0733b r2, int r3, int r4, boolean r5, int r6, int r7) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(5);
            addMatchers(r2, r7);
            addInClasses(r2, r6);
            ...
            return endBatchFindClassUsingStrings(r2);
        }
        ...
        public final int endBatchFindClassUsingStrings(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final BatchFindClassUsingStrings getRootAsBatchFindClassUsingStrings(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsBatchFindClassUsingStrings(r2, new BatchFindClassUsingStrings());
        }

        public final void startBatchFindClassUsingStrings(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(5);
        }
        ...
        public final BatchFindClassUsingStrings getRootAsBatchFindClassUsingStrings(ByteBuffer r3, BatchFindClassUsingStrings r4) {
    ...
    public final BatchFindClassUsingStrings __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
