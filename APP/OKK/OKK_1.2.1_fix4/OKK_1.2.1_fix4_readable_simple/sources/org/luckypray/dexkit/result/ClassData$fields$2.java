...
public final class ClassData$fields$2 extends AbstractC0308h implements InterfaceC0275a {
    ...
    public ClassData$fields$2(DexKitBridge r1, ClassData r2, int r3) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        super(0);
    ...
    public final FieldDataList invoke() {
        ...
        List r1 = ClassData.access$getFieldIds$p(this.this$0);
    ...
    L6:
        ...
        byte[] r14 = DexKitBridge.Companion.access$nativeGetFieldByIds(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), r13);
        FieldMetaArrayHolder.Companion r22 = FieldMetaArrayHolder.Companion;
        ByteBuffer r15 = ByteBuffer.wrap(r14);
        AbstractC0307g.m702d(r15, "wrap(res)");
        FieldMetaArrayHolder r16 = r22.getRootAsFieldMetaArrayHolder(r15);
        FieldDataList r23 = new FieldDataList();
        int r32 = r16.getFieldsLength();
        int r42 = 0;
    L7:
        if (r42 >= r32) goto L9;
        FieldData.Companion r5 = FieldData.f4420Companion;
        FieldMeta r6 = r16.fields(r42);
