...
/* JADX INFO: renamed from: org.luckypray.dexkit.schema.-FieldsMatcher */
...
public final class FieldsMatcher extends AbstractC0735d {
    ...
    public static final class Companion {
        ...
        public final void addFieldCount(C0733b r2, int r3) {
        ...
        public final int createFieldsMatcher(C0733b r2, int r3, byte r4, int r5) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
            addFieldCount(r2, r5);
            addFields(r2, r3);
            addMatchType(r2, r4);
            return endFieldsMatcher(r2);
        }
        ...
        public final int endFieldsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            return r2.m1929l();
        }

        public final FieldsMatcher getRootAsFieldsMatcher(ByteBuffer r2) {
            AbstractC0307g.m703e(r2, "_bb");
            return getRootAsFieldsMatcher(r2, new FieldsMatcher());
        }

        public final void startFieldsMatcher(C0733b r2) {
            AbstractC0307g.m703e(r2, "builder");
            r2.m1936s(3);
        }
        ...
        public final FieldsMatcher getRootAsFieldsMatcher(ByteBuffer r3, FieldsMatcher r4) {
    ...
    public final FieldsMatcher __assign(int r2, ByteBuffer r3) {
        AbstractC0307g.m703e(r3, "_bb");
        __init(r2, r3);
        return this;
    }
    ...
    public final IntRange fieldCount(IntRange r4) {
        AbstractC0307g.m703e(r4, "obj");
        int r02 = __offset(8);
        if (r02 == 0) goto L5;
    ...
    public final FieldMatcher fields(int r2) {
        return fields(new FieldMatcher(), r2);
    }
    ...
    public final FieldMatcher fields(FieldMatcher r3, int r4) {
