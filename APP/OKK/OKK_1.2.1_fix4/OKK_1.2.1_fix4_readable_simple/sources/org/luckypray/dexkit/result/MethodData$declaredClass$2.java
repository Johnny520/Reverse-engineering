...
public final class MethodData$declaredClass$2 extends AbstractC0308h implements InterfaceC0275a {
    final /* synthetic */ DexKitBridge $bridge;
    final /* synthetic */ int $dexId;
    final /* synthetic */ MethodData this$0;

    public MethodData$declaredClass$2(DexKitBridge r1, MethodData r2, int r3) {
        this.$bridge = r1;
        this.this$0 = r2;
        this.$dexId = r3;
        super(0);
    ...
    public final ClassData invoke() {
        ...
        MethodData r1 = this.this$0;
        int r5 = 0;
        byte[] r12 = DexKitBridge.Companion.access$nativeGetClassByIds(DexKitBridge.Companion, DexKitBridge.access$getSafeToken(r02), new long[]{MethodData.access$getEncodeId(r1, this.$dexId, MethodData.access$getClassId$p(r1))});
