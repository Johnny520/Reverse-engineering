...
public final class FindField extends BaseQuery {
    ...
    public final FindField excludePackages(String... r2) {
    ...
    public final FindField ignorePackagesCase(boolean r1) {
    ...
    public int innerBuild(C0733b r12) {
        ...
        FindField.Companion r1 = org.luckypray.dexkit.schema.FindField.Companion;
    ...
    L22:
        ...
        goto L22
    L24:
        int r63 = org.luckypray.dexkit.schema.FindField.Companion.createInClassesVector(r12, AbstractC0181l.m554z0(r7));
    L26:
        Collection<FieldData> r72 = this.searchFields;
    ...
    L30:
        ...
        r8.add(Long.valueOf(((FieldData) r2.next()).getEncodeId()));
        goto L30
    L32:
        int r73 = org.luckypray.dexkit.schema.FindField.Companion.createInFieldsVector(r12, AbstractC0181l.m554z0(r8));
    L34:
        boolean r82 = this.findFirst;
        FieldMatcher r22 = this.matcher;
        if (r22 == null) goto L37;
        int r9 = BaseQuery.access$innerBuild(r22, r12);
    L38:
        int r05 = r1.createFindField(r12, r04, r44, r52, r63, r73, r82, r9);
        r12.m1931n(r05);
        return r05;
    L37:
        r9 = 0;
    ...
    public final FindField matcher(FieldMatcher r2) {
        AbstractC0307g.m703e(r2, "matcher");
        this.matcher = r2;
        return this;
    }

    public final FindField searchInClass(Collection<ClassData> r2) {
        AbstractC0307g.m703e(r2, "classes");
        this.searchClasses = r2;
        return this;
    }

    public final FindField searchInField(Collection<FieldData> r2) {
        AbstractC0307g.m703e(r2, "fields");
        this.searchFields = r2;
        return this;
    }

    public final FindField searchPackages(String... r2) {
    ...
    public final /* synthetic */ void setSearchFields(Collection r1) {
        this.searchFields = r1;
    }
    ...
    private final FindField matcher(InterfaceC0286l r2) {
    ...
    public final FindField excludePackages(Collection<String> r2) {
        AbstractC0307g.m703e(r2, "excludePackages");
        this.excludePackages = r2;
        return this;
    }

    public final FindField searchPackages(Collection<String> r2) {
        AbstractC0307g.m703e(r2, "searchPackages");
