...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v6, v7}, LB0/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1, p2}, Lg/o;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v9, Lg0/a;->i:[I

    new-array v5, p1, [I

    const v10, 0x7f10041e

    invoke-static {v8, p2, v6, v10}, Ls0/k;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static/range {v0 .. v5}, Ls0/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V

    invoke-virtual {v8, p2, v9, v6, v10}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-static {v1, v3}, Ls0/k;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v1, v0, v4}, Lf0/P;->r(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v0, v4}, Lf0/P;->t(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, p2, v6, v7}, Lx0/k;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Lx0/j;
    ...
    invoke-direct {v1, p0, p2}, Lm0/c;-><init>(Lcom/google/android/material/button/MaterialButton;Lx0/k;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lm0/c;

    invoke-virtual {v0, v4, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p2

    iput p2, v1, Lm0/c;->c:I
    ...
    iput p2, v1, Lm0/c;->g:I

    iget-object v5, v1, Lm0/c;->b:Lx0/k;

    int-to-float p2, p2

    invoke-virtual {v5}, Lx0/k;->d()Lx0/j;

    move-result-object v5

    new-instance v6, Lx0/a;

    invoke-direct {v6, p2}, Lx0/a;-><init>(F)V

    iput-object v6, v5, Lx0/j;->e:Lx0/c;

    new-instance v6, Lx0/a;

    invoke-direct {v6, p2}, Lx0/a;-><init>(F)V

    iput-object v6, v5, Lx0/j;->f:Lx0/c;

    new-instance v6, Lx0/a;

    invoke-direct {v6, p2}, Lx0/a;-><init>(F)V

    iput-object v6, v5, Lx0/j;->g:Lx0/c;

    new-instance v6, Lx0/a;

    invoke-direct {v6, p2}, Lx0/a;-><init>(F)V

    iput-object v6, v5, Lx0/j;->h:Lx0/c;

    invoke-virtual {v5}, Lx0/j;->a()Lx0/k;

    move-result-object p2

    invoke-virtual {v1, p2}, Lm0/c;->c(Lx0/k;)V

    iput-boolean v4, v1, Lm0/c;->p:Z
    ...
    invoke-static {p2, v3}, Ls0/k;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v1, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p2, v0, v2}, Lf0/P;->r(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, Lm0/c;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v1, Lm0/c;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v1, Lm0/c;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v4, v1, Lm0/c;->o:Z

    iget-object v6, v1, Lm0/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v1, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_0
    iget v6, v1, Lm0/c;->c:I

    add-int/2addr p2, v6

    iget v6, v1, Lm0/c;->e:I

    add-int/2addr v2, v6

    iget v6, v1, Lm0/c;->d:I

    add-int/2addr v3, v6

    iget v1, v1, Lm0/c;->f:I
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lm0/c;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lm0/c;->q:Z
...
.method public final d(Z)V
    ...
    invoke-static {v0, v2}, Lw/a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, Lw/a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lm0/c;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lx0/k;
    ...
    iget-object v0, v0, Lm0/c;->b:Lx0/k;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lm0/c;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lm0/c;->j:Landroid/content/res/ColorStateList;

    return-object v0

    :cond_0
    invoke-super {p0}, Lg/o;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    :cond_0
    invoke-super {p0}, Lg/o;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lm0/c;

    invoke-virtual {v1, v0}, Lm0/c;->b(Z)Lx0/g;
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Lg/o;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, Lg/o;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Lg/o;->onLayout(ZIIII)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lg/o;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, v1}, Lm0/c;->b(Z)Lx0/g;
    ...
    invoke-virtual {v0, p1}, Lx0/g;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, Lm0/c;->o:Z

    iget-object v0, v1, Lm0/c;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, Lm0/c;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-super {p0, p1}, Lg/o;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setCornerRadius(I)V
    ...
    iget-boolean v1, v0, Lm0/c;->p:Z

    if-eqz v1, :cond_0

    iget v1, v0, Lm0/c;->g:I

    if-eq v1, p1, :cond_1

    :cond_0
    iput p1, v0, Lm0/c;->g:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Lm0/c;->p:Z

    iget-object v1, v0, Lm0/c;->b:Lx0/k;

    int-to-float p1, p1

    invoke-virtual {v1}, Lx0/k;->d()Lx0/j;
    ...
    iput-object v2, v1, Lx0/j;->e:Lx0/c;

    new-instance v2, Lx0/a;

    invoke-direct {v2, p1}, Lx0/a;-><init>(F)V

    iput-object v2, v1, Lx0/j;->f:Lx0/c;

    new-instance v2, Lx0/a;

    invoke-direct {v2, p1}, Lx0/a;-><init>(F)V

    iput-object v2, v1, Lx0/j;->g:Lx0/c;

    new-instance v2, Lx0/a;

    invoke-direct {v2, p1}, Lx0/a;-><init>(F)V

    iput-object v2, v1, Lx0/j;->h:Lx0/c;

    invoke-virtual {v1}, Lx0/j;->a()Lx0/k;

    move-result-object p1

    invoke-virtual {v0, p1}, Lm0/c;->c(Lx0/k;)V
...
.method public setIconTintResource(I)V
    ...
    invoke-static {v0, p1}, Lf0/P;->p(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lm0/c;->d(II)V
...
.method public setInsetTop(I)V
    ...
    iget v1, v0, Lm0/c;->f:I

    invoke-virtual {v0, p1, v1}, Lm0/c;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lm0/a;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:Lm0/a;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:Lm0/a;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lm0/c;->l:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lm0/c;->l:Landroid/content/res/ColorStateList;

    iget-object v0, v0, Lm0/c;->a:Lcom/google/android/material/button/MaterialButton;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, v0, Lm0/c;->n:Z

    invoke-virtual {v0}, Lm0/c;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lm0/c;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lm0/c;->k:Landroid/content/res/ColorStateList;
...
.method public setStrokeWidth(I)V
    ...
    iget v1, v0, Lm0/c;->h:I

    if-eq v1, p1, :cond_0

    iput p1, v0, Lm0/c;->h:I
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lm0/c;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lm0/c;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lm0/c;->b(Z)Lx0/g;
    ...
    :cond_0
    invoke-super {p0, p1}, Lg/o;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lm0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v0}, Lw/a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    goto :goto_0

    :cond_0
    invoke-super {p0, p1}, Lg/o;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
