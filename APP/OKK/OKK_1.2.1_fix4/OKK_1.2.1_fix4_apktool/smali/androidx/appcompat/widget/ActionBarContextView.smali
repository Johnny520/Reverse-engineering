...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, v0}, LU/S;->w(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final a()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->h:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->i:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;
    ...
    :cond_2
    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/view/View;
...
.method public final onMeasure(II)V
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;

    const/4 v7, 0x0

    if-eqz v6, :cond_5

    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/view/View;

    if-nez v8, :cond_5

    iget-boolean v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->l:Z
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;

    invoke-virtual {v8, v6, v5}, Landroid/view/View;->measure(II)V

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroid/widget/LinearLayout;
    ...
    :cond_5
    :goto_3
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/view/View;
    ...
    :cond_9
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/view/View;
...
.method public setCustomView(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/view/View;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, LD/Q;->k(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setTitleOptional(Z)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->l:Z
    ...
    :cond_0
    iput-boolean p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->l:Z
