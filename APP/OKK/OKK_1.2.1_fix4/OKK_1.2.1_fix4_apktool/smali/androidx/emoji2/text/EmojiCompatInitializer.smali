...
.method public final c(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1}, LD/d;-><init>(Landroid/content/Context;)V

    invoke-direct {v0, v1}, Landroidx/emoji2/text/r;-><init>(Landroidx/emoji2/text/i;)V

    const/4 v1, 0x1

    iput v1, v0, Landroidx/emoji2/text/r;->b:I
    ...
    :cond_1
    :goto_2
    invoke-static {p1}, LW/a;->c(Landroid/content/Context;)LW/a;
    ...
    sget-object v1, LW/a;->e:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, p1, LW/a;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {p1, v0, v2}, LW/a;->b(Ljava/lang/Class;Ljava/util/HashSet;)Ljava/lang/Object;
