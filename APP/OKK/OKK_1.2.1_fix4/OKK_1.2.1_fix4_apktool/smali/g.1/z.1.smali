...
.method public static a(Landroid/view/DragEvent;Landroid/widget/TextView;Landroid/app/Activity;)Z
    ...
    invoke-direct {p2, p0, v1}, LD/d;-><init>(Landroid/content/ClipData;I)V
    ...
    invoke-direct {p2}, LD/f;-><init>()V

    iput-object p0, p2, LD/f;->b:Ljava/lang/Object;

    iput v1, p2, LD/f;->c:I

    :goto_0
    invoke-interface {p2}, LD/e;->m()LD/h;

    move-result-object p0

    invoke-static {p1, p0}, LD/Q;->f(Landroid/view/View;LD/h;)LD/h;
    :try_end_0
