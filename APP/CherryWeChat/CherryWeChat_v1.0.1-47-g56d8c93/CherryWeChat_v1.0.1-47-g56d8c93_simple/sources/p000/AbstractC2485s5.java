...
public abstract class AbstractC2485s5 {
    ...
    public static final Charset f8743a = null;

    static {
        f8743a = Charset.forName("UTF-8");
    }

    /* JADX INFO: renamed from: a */
    public static byte[] m4969a(String r15) {
        byte[] r152 = r15.getBytes(f8743a);
        int r0 = r152.length;
        int r1 = (r0 * 3) / 4;
        byte[] r3 = new byte[r1];
        int[] r4 = AbstractC2442r5.f8557f;
        int r6 = 0;
        int r7 = 0;
        int r8 = 0;
        int r9 = 0;
    ...
    public static byte[] m4970b(byte[] r11) {
        int r0 = r11.length;
        byte[] r1 = AbstractC2442r5.f8558g;
        int r2 = (r0 / 3) * 4;
        if ((r0 % 3) <= 0) goto L5;
        r2 = r2 + 4;
    L5:
