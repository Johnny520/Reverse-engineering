...
public final class C0918VF extends AbstractC1523i1 {
    ...
    public static C0918VF m1766N(C2610v1 r3, C1017Xm r4, Integer r5) {
        C2787z6 r42 = (C2787z6) r4.f3226b;
        C2610v1 r0 = C2610v1.f9001G;
        if (r3 == r0) goto L8;
        if (r5 != null) goto L8;
    ...
    L29:
        throw new GeneralSecurityException("XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not " + r42.f9452a.length);
    }
}
