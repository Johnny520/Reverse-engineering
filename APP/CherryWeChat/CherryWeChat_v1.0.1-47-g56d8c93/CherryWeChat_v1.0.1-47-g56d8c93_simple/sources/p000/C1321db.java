...
public final class C1321db {
    ...
    public C1321db(C1321db r2, Object r3) {
        this.f4783a = false;
        r2.getClass();
        this.f4784b = r2.f4784b;
        m2571b(r3);
    }

    /* JADX INFO: renamed from: a */
    public static void m2570a(Context r16, XmlResourceParser r17, HashMap r18) {
        TypedArray r0 = r16.obtainStyledAttributes(Xml.asAttributeSet(r17), AbstractC0639Ou.f2037d);
    ...
    /* JADX INFO: renamed from: b */
    public final void m2571b(Object r2) {
    ...
    L4:
        return;
    L5:
        this.f4786d = ((Float) r2).floatValue();
        return;
    L7:
        this.f4788f = ((Boolean) r2).booleanValue();
        return;
    L9:
        this.f4787e = (String) r2;
        return;
    L11:
        this.f4789g = ((Integer) r2).intValue();
        return;
    L13:
        this.f4786d = ((Float) r2).floatValue();
        return;
    L15:
        this.f4785c = ((Integer) r2).intValue();
    }
}
