...
public final class C2104ji extends AbstractC0828TB implements InterfaceC2752yE, InterfaceC1061Yn, InterfaceC2075ix, InterfaceC0197Ei {
    ...
    public C2104ji(AbstractActivityC1244c3 r3) {
        this.f7404p = r3;
    ...
    public final void mo390a(AbstractComponentCallbacksC1503hi r2) {
        this.f7404p.onAttachFragment(r2);
    }
    ...
    public final View mo852y(int r2) {
        return this.f7404p.findViewById(r2);
    }

    @Override // p000.AbstractC0828TB
    /* JADX INFO: renamed from: z */
    public final boolean mo853z() {
        Window r0 = this.f7404p.getWindow();
        if (r0 != null) goto L5;
        return false;
    L5:
