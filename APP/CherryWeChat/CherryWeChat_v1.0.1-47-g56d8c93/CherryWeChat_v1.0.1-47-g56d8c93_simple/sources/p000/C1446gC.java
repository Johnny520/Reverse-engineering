...
public final class C1446gC implements Collection, InterfaceC0545Mm {
    ...
    public /* synthetic */ C1446gC(int[] r1) {
        this.f5055a = r1;
    }
    ...
    public final boolean contains(Object r6) {
        if ((r6 instanceof C1402fC) == true) goto L5;
        return false;
    L5:
        int r62 = ((C1402fC) r6).f4976a;
        int[] r0 = this.f5055a;
        int r2 = r0.length;
        int r3 = 0;
    L6:
    ...
    L7:
        ...
        Object r0 = r82.next();
        if ((r0 instanceof C1402fC) == false) goto L22;
        int r02 = ((C1402fC) r0).f4976a;
        int[] r2 = this.f5055a;
        int r4 = r2.length;
        int r5 = 0;
    L11:
    ...
    public final boolean equals(Object r2) {
        if ((r2 instanceof C1446gC) == false) goto L11;
        int[] r22 = ((C1446gC) r2).f5055a;
        if (AbstractC0585Nj.m1134a(this.f5055a, r22) == true) goto L9;
        return false;
    L9:
        return true;
    L11:
    ...
    public final boolean isEmpty() {
        if (this.f5055a.length != 0) goto L6;
        return true;
    L6:
        return false;
    }
