...
public final class C0917VE {
    ...
    public static final C0917VE f2864k = null;
    ...
    static {
        float[] r0 = AbstractC0628Oj.f2009c;
        float r1 = (float) ((((double) AbstractC0628Oj.m1236Y()) * 63.66197723675813d) / 100.0d);
        float[][] r2 = AbstractC0628Oj.f2007a;
        float r6 = r0[0];
        float[] r7 = r2[0];
        float r8 = r7[0] * r6;
        float r10 = r0[1];
    ...
    L13:
        ...
        float r142 = AbstractC0628Oj.m1236Y() / r0[1];
        double r02 = r142;
        ...
        f2864k = new C0917VE(r142, ((r06[2] * 0.05f) + ((r06[0] * 2.0f) + r06[1])) * r16, r16, r16, r18, 1.0f, r23, r133, (float) Math.pow(r133, 0.25d), r232);
        return;
    L11:
    ...
    public C0917VE(float r1, float r2, float r3, float r4, float r5, float r6, float[] r7, float r8, float r9, float r10) {
        this.f2870f = r1;
        this.f2865a = r2;
        this.f2866b = r3;
        this.f2867c = r4;
