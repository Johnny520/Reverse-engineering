...
public final class C2619vA extends C0645P {
    ...
    public C2619vA(TextInputLayout r1) {
        this.f9095d = r1;
    }

    @Override // p000.C0645P
    /* JADX INFO: renamed from: d */
    public final void mo319d(View r18, C1118a0 r19) {
        AccessibilityNodeInfo r2 = r19.f3530a;
        this.f2082a.onInitializeAccessibilityNodeInfo(r18, r2);
        TextInputLayout r3 = this.f9095d;
    ...
    L16:
        C1072Yy r112 = r3.f4619b;
        C2304o4 r15 = r112.f3385b;
    ...
    L43:
        r2.setError(r6);
    L44:
        C2304o4 r43 = r3.f4637k.f7919y;
        if (r43 == null) goto L47;
        r2.setLabelFor(r43);
    L47:
        r3.f4621c.m2059b().mo955m(r19);
        return;
    L35:
    ...
    L28:
        ...
        goto L31
    L19:
        r2.setTraversalAfter(r112.f3387d);
        goto L20
    L15:
        r52 = "";
        goto L16
    ...
    public final void mo320e(View r1, AccessibilityEvent r2) {
        super.mo320e(r1, r2);
        this.f9095d.f4621c.m2059b().mo956n(r2);
    }
}
