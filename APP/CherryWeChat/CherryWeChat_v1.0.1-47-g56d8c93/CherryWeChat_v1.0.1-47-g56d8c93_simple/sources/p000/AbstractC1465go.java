...
public abstract class AbstractC1465go extends ViewGroup {
    ...
    public AbstractC1465go(Context r10, AttributeSet r11, int r12) {
        super(r10, r11, 0);
        this.f5182a = true;
        this.f5183b = -1;
        this.f5184c = 0;
        this.f5186e = 8388659;
        int[] r2 = AbstractC0982Wu.f3079n;
        C2656w4 r8 = C2656w4.m5186A(r10, r11, r2, 0);
        AbstractC2185lE.m4398k(this, r10, r2, r11, (TypedArray) r8.f9196b, 0);
        TypedArray r102 = (TypedArray) r8.f9196b;
    ...
    L11:
        this.f5188g = r102.getFloat(4, -1.0f);
        this.f5183b = r102.getInt(3, -1);
        this.f5189h = r102.getBoolean(7, false);
        setDividerDrawable(r8.m5210q(5));
        this.f5195n = r102.getInt(8, 0);
        this.f5196o = r102.getDimensionPixelSize(6, 0);
        r8.m5195E();
    }

    @Override // android.view.ViewGroup
    public boolean checkLayoutParams(ViewGroup.LayoutParams r1) {
        return r1 instanceof C1421fo;
    }

    /* JADX INFO: renamed from: d */
    public final void m2816d(Canvas r5, int r6) {
        this.f5192k.setBounds(getPaddingLeft() + this.f5196o, r6, (getWidth() - getPaddingRight()) - this.f5196o, this.f5194m + r6);
        this.f5192k.draw(r5);
    }

    /* JADX INFO: renamed from: e */
    public final void m2817e(Canvas r6, int r7) {
        this.f5192k.setBounds(r7, getPaddingTop() + this.f5196o, this.f5193l + r7, (getHeight() - getPaddingBottom()) - this.f5196o);
        this.f5192k.draw(r6);
    }

    /* JADX INFO: renamed from: f */
    public C1421fo mo2092f() {
        int r0 = this.f5185d;
        if (r0 != 0) goto L7;
    ...
    /* JADX INFO: renamed from: g */
    public C1421fo mo2093g(AttributeSet r3) {
        return new C1421fo(getContext(), r3);
    }
    ...
    public int getBaseline() {
        ...
        if (r12 == (-1)) goto L11;
        int r2 = this.f5184c;
        if (this.f5185d != 1) goto L27;
        int r3 = this.f5186e & 112;
        if (r3 == 48) goto L27;
        if (r3 != 16) goto L22;
        r2 = r2 + (((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f5187f) / 2);
        goto L27
    L22:
        if (r3 != 80) goto L27;
        r2 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f5187f;
    L27:
        return (r2 + ((LinearLayout.LayoutParams) ((C1421fo) r02.getLayoutParams())).topMargin) + r12;
    L11:
        if (this.f5183b != 0) goto L14;
        return -1;
    L14:
    ...
    /* JADX INFO: renamed from: h */
    public C1421fo mo2094h(ViewGroup.LayoutParams r2) {
        if ((r2 instanceof C1421fo) == false) goto L7;
        return new C1421fo((C1421fo) r2);
    L7:
        if ((r2 instanceof ViewGroup.MarginLayoutParams) == false) goto L11;
        return new C1421fo((ViewGroup.MarginLayoutParams) r2);
    L11:
        return new C1421fo(r2);
    }

    /* JADX INFO: renamed from: i */
    public final boolean m2818i(int r5) {
        if (r5 != 0) goto L9;
        if ((this.f5195n & 1) == 0) goto L7;
        return true;
    L7:
        return false;
    L9:
        if (r5 != getChildCount()) goto L15;
        if ((this.f5195n & 4) == 0) goto L13;
        return true;
    L13:
        return false;
    L15:
        if ((this.f5195n & 2) == 0) goto L22;
        int r52 = r5 - 1;
    L17:
        if (r52 < 0) goto L22;
    ...
    public final void onDraw(Canvas r8) {
        if (this.f5192k == null) goto L69;
        int r2 = 0;
        if (this.f5185d != 1) goto L25;
    ...
    L8:
        ...
        if (m2818i(r2) == false) goto L16;
        m2816d(r8, (r4.getTop() - ((LinearLayout.LayoutParams) ((C1421fo) r4.getLayoutParams())).topMargin) - this.f5194m);
    L16:
        r2 = r2 + 1;
        goto L8
    L18:
        if (m2818i(r0) == false) goto L67;
        View r02 = getChildAt(r0 - 1);
        if (r02 != null) goto L22;
        int r03 = (getHeight() - getPaddingBottom()) - this.f5194m;
    L23:
        m2816d(r8, r03);
        return;
    L22:
        r03 = r02.getBottom() + ((LinearLayout.LayoutParams) ((C1421fo) r02.getLayoutParams())).bottomMargin;
        goto L23
    L67:
        return;
    L25:
    ...
    L29:
        ...
        if (m2818i(r2) == false) goto L41;
        C1421fo r6 = (C1421fo) r5.getLayoutParams();
    ...
    L40:
        ...
        goto L41
    L39:
        r52 = (r5.getLeft() - ((LinearLayout.LayoutParams) r6).leftMargin) - this.f5193l;
    L41:
        r2 = r2 + 1;
        goto L29
    L43:
        if (m2818i(r04) == false) goto L68;
        View r05 = getChildAt(r04 - 1);
        if (r05 != null) goto L50;
        if (r42 == false) goto L48;
    ...
    L49:
        ...
        goto L54
    L50:
        C1421fo r12 = (C1421fo) r05.getLayoutParams();
        if (r42 == false) goto L53;
    ...
    L16:
        ...
        C1421fo r15 = (C1421fo) r6.getLayoutParams();
        r232 = r8;
    ...
    L85:
        return;
    L8:
        r5 = ((getPaddingTop() + r27) - r25) - this.f5187f;
        goto L10
    L9:
        r5 = getPaddingTop() + (((r27 - r25) - this.f5187f) / 2);
        goto L10
    L33:
    ...
    L36:
        ...
        int r122 = this.f5186e;
        int r72 = 8388615 & r122;
        int r123 = r122 & 112;
        boolean r133 = this.f5182a;
        int[] r143 = this.f5190i;
        int[] r152 = this.f5191j;
    ...
    L51:
        ...
        C1421fo r18 = (C1421fo) r62.getLayoutParams();
        int r272 = r2;
        if (r133 == false) goto L58;
        r19 = r35;
        if (((LinearLayout.LayoutParams) r18).height == (-1)) goto L59;
        int r36 = r62.getBaseline();
    L60:
        int r22 = ((LinearLayout.LayoutParams) r18).gravity;
        if (r22 >= 0) goto L63;
        r22 = r123;
    L63:
        int r28 = r22 & 112;
        if (r28 != 16) goto L66;
        int r29 = (((r85 - r162) / 2) + r19) + ((LinearLayout.LayoutParams) r18).topMargin;
        int r37 = ((LinearLayout.LayoutParams) r18).bottomMargin;
    L73:
        r29 = r29 - r37;
    L79:
        if (m2818i(r53) == false) goto L81;
        int r38 = r272 + this.f5193l;
    L82:
        int r39 = r38 + ((LinearLayout.LayoutParams) r18).leftMargin;
        r62.layout(r39, r29, r39 + r43, r29 + r162);
        r2 = (r43 + ((LinearLayout.LayoutParams) r18).rightMargin) + r39;
        goto L84
    L81:
        r38 = r272;
        goto L82
    L66:
        if (r28 != 48) goto L68;
        r29 = r19 + ((LinearLayout.LayoutParams) r18).topMargin;
        if (r36 == (-1)) goto L79;
        r29 = (r143[1] - r36) + r29;
        goto L79
    L68:
        ...
        goto L79
    L70:
        r29 = (r103 - r162) - ((LinearLayout.LayoutParams) r18).bottomMargin;
        if (r36 == (-1)) goto L79;
    ...
    L44:
        ...
        goto L45
    L40:
        r2 = ((getPaddingLeft() + r26) - r24) - this.f5187f;
        goto L42
    L41:
        r2 = getPaddingLeft() + (((r26 - r24) - this.f5187f) / 2);
        goto L42
    L35:
        r16 = false;
        goto L36
    ...
    L11:
        ...
        if (r0.m2818i(r5) == false) goto L16;
        r0.f5187f += r0.f5194m;
    L16:
        C1421fo r112 = (C1421fo) r12.getLayoutParams();
        ...
        int r102 = r0.f5187f;
        r0.f5187f = Math.max(r102, (((LinearLayout.LayoutParams) r112).topMargin + r102) + ((LinearLayout.LayoutParams) r112).bottomMargin);
        View r30 = r12;
        r29 = r2;
        r72 = r3;
        r28 = r4;
    ...
    L37:
        ...
        int r54 = r0.f5187f;
        r30 = r12;
        r0.f5187f = Math.max(r54, ((r54 + r33) + ((LinearLayout.LayoutParams) r112).topMargin) + ((LinearLayout.LayoutParams) r112).bottomMargin);
    ...
    L74:
        ...
        int r111 = r22;
        int r42 = r40;
        if (r0.f5187f <= 0) goto L80;
        if (r0.m2818i(r15) == false) goto L80;
        r0.f5187f += r0.f5194m;
    L80:
        if (r282 == true) goto L82;
    L94:
        int r105 = (r0.getPaddingBottom() + r0.getPaddingTop()) + r0.f5187f;
        r0.f5187f = r105;
        int r55 = View.resolveSizeAndState(Math.max(r105, r0.getSuggestedMinimumHeight()), r42, 0);
        int r73 = (r55 & 16777215) - r0.f5187f;
    ...
    L164:
        ...
        C1421fo r62 = (C1421fo) r113.getLayoutParams();
    ...
    L105:
        ...
        if (((LinearLayout.LayoutParams) ((C1421fo) r75.getLayoutParams())).weight <= 0.0f) goto L114;
    ...
    L154:
        ...
        goto L119
    L123:
        C1421fo r115 = (C1421fo) r106.getLayoutParams();
    ...
    L153:
        int r135 = r0.f5187f;
        r0.f5187f = Math.max(r135, ((r106.getMeasuredHeight() + r135) + ((LinearLayout.LayoutParams) r115).topMargin) + ((LinearLayout.LayoutParams) r115).bottomMargin);
        r24 = r119;
        goto L154
    L150:
    ...
    L140:
        ...
        goto L141
    L155:
        r0.f5187f = (r0.getPaddingBottom() + r0.getPaddingTop()) + r0.f5187f;
        r111 = r83;
        goto L156
    L82:
    ...
    L90:
        ...
        C1421fo r77 = (C1421fo) r76.getLayoutParams();
        int r107 = r0.f5187f;
        r0.f5187f = Math.max(r107, ((r107 + r14) + ((LinearLayout.LayoutParams) r77).topMargin) + ((LinearLayout.LayoutParams) r77).bottomMargin);
        goto L93
    L171:
        int r27 = r39;
        r0.f5187f = 0;
    ...
    L176:
        ...
        r1110[1] = -1;
        r1110[0] = -1;
        boolean r144 = r0.f5182a;
        boolean r152 = r0.f5189h;
    ...
    L185:
        ...
        goto L255
    L189:
        if (r0.m2818i(r120) == false) goto L191;
        r0.f5187f += r0.f5193l;
    L191:
        C1421fo r210 = (C1421fo) r137.getLayoutParams();
        ...
        r0.f5187f = (((LinearLayout.LayoutParams) r210).leftMargin + ((LinearLayout.LayoutParams) r210).rightMargin) + r0.f5187f;
    L200:
    ...
    L199:
        int r140 = r0.f5187f;
        r0.f5187f = Math.max(r140, (((LinearLayout.LayoutParams) r210).leftMargin + r140) + ((LinearLayout.LayoutParams) r210).rightMargin);
    L204:
    ...
    L217:
        ...
        r362 = r137;
        r0.f5187f = ((((LinearLayout.LayoutParams) r145).leftMargin + r313) + ((LinearLayout.LayoutParams) r145).rightMargin) + r0.f5187f;
    L221:
    ...
    L220:
        r362 = r137;
        int r146 = r0.f5187f;
        r0.f5187f = Math.max(r146, ((r146 + r313) + ((LinearLayout.LayoutParams) r145).leftMargin) + ((LinearLayout.LayoutParams) r145).rightMargin);
        goto L221
    L213:
        r311 = 0;
        goto L214
    ...
    L289:
        int r1311 = (r0.getPaddingRight() + r0.getPaddingLeft()) + r0.f5187f;
        r0.f5187f = r1311;
        int r148 = View.resolveSizeAndState(Math.max(r1311, r0.getSuggestedMinimumWidth()), r27, 0);
        int r59 = (r148 & 16777215) - r0.f5187f;
    ...
    L388:
        ...
        C1421fo r79 = (C1421fo) r149.getLayoutParams();
    ...
    L300:
        ...
        if (((LinearLayout.LayoutParams) ((C1421fo) r1011.getLayoutParams())).weight <= 0.0f) goto L309;
    ...
    L319:
        ...
        C1421fo r1410 = (C1421fo) r1113.getLayoutParams();
    ...
    L339:
        ...
        r0.f5187f = ((r1113.getMeasuredWidth() + ((LinearLayout.LayoutParams) r1410).leftMargin) + ((LinearLayout.LayoutParams) r1410).rightMargin) + r0.f5187f;
    L343:
    ...
    L342:
        int r159 = r0.f5187f;
        r0.f5187f = Math.max(r159, ((r1113.getMeasuredWidth() + r159) + ((LinearLayout.LayoutParams) r1410).leftMargin) + ((LinearLayout.LayoutParams) r1410).rightMargin);
    L333:
    ...
    L369:
        r223 = r148;
        r173 = -16777216;
        r0.f5187f = (r0.getPaddingRight() + r0.getPaddingLeft()) + r0.f5187f;
        int r160 = r314[1];
        if (r160 == (-1)) goto L372;
    L379:
        r21 = 0;
    ...
    L282:
        ...
        C1421fo r512 = (C1421fo) r511.getLayoutParams();
        if (r162 == false) goto L287;
        r0.f5187f = ((((LinearLayout.LayoutParams) r512).leftMargin + r93) + ((LinearLayout.LayoutParams) r512).rightMargin) + r0.f5187f;
        goto L288
    L287:
        int r1318 = r0.f5187f;
        r0.f5187f = Math.max(r1318, ((r1318 + r93) + ((LinearLayout.LayoutParams) r512).leftMargin) + ((LinearLayout.LayoutParams) r512).rightMargin);
        goto L288
    L264:
        ...
        goto L272
    L259:
        if (r0.m2818i(r63) == false) goto L261;
        r0.f5187f += r0.f5193l;
        goto L261
    L179:
        r162 = false;
    ...
    public void setDividerDrawable(Drawable r3) {
        if (r3 != this.f5192k) goto L5;
        return;
    L5:
        this.f5192k = r3;
        boolean r0 = false;
        if (r3 == null) goto L8;
        this.f5193l = r3.getIntrinsicWidth();
        this.f5194m = r3.getIntrinsicHeight();
    L9:
        if (r3 != null) goto L11;
        r0 = true;
    L11:
    ...
    public void setVerticalGravity(int r3) {
        ...
        this.f5186e = r32 | (r0 & (-113));
        requestLayout();
        return;
    }

    public void setWeightSum(float r2) {
        this.f5188g = Math.max(0.0f, r2);
    }
