...
public final class C2406qC implements Collection, InterfaceC0545Mm {
    ...
    public /* synthetic */ C2406qC(short[] r1) {
        this.f8440a = r1;
    }
    ...
    public final boolean contains(Object r6) {
        if ((r6 instanceof C2355pC) == true) goto L5;
        return false;
    L5:
        short r62 = ((C2355pC) r6).f8240a;
        short[] r0 = this.f8440a;
        int r2 = r0.length;
        int r3 = 0;
    L6:
        if (r3 >= r2) goto L11;
    ...
    L7:
        ...
        Object r0 = r82.next();
        if ((r0 instanceof C2355pC) == false) goto L22;
        short r02 = ((C2355pC) r0).f8240a;
        short[] r2 = this.f8440a;
        int r4 = r2.length;
        int r5 = 0;
    L11:
        if (r5 >= r4) goto L16;
    ...
    public final boolean equals(Object r2) {
        if ((r2 instanceof C2406qC) == false) goto L11;
        short[] r22 = ((C2406qC) r2).f8440a;
        if (AbstractC0585Nj.m1134a(this.f8440a, r22) == true) goto L9;
        return false;
    L9:
        return true;
    L11:
    ...
    public final boolean isEmpty() {
        if (this.f8440a.length != 0) goto L6;
        return true;
    L6:
        return false;
    }
