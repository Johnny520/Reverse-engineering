...
public final class C2124k1 implements InterfaceC1435g1 {
    ...
    /* JADX INFO: renamed from: a */
    public final byte[] mo1002a(byte[] r5, byte[] r6) {
        C0668Pg r0 = this.f7454b;
        C2516su r1 = (C2516su) this.f7453a.f9197c;
        byte[] r2 = r1.f8809c;     // Catch: GeneralSecurityException -> L9
        if (r2 != null) goto L6;
        byte[] r22 = null;
    L7:
        byte[] r62 = AbstractC0295Gu.m612e(new byte[][]{r22, ((InterfaceC1435g1) r1.f8808b).mo1002a(r5, r6)});     // Catch: GeneralSecurityException -> L9
        int r12 = r1.f8812f;     // Catch: GeneralSecurityException -> L9
        int r52 = r5.length;     // Catch: GeneralSecurityException -> L9
    ...
    public final byte[] mo1003b(byte[] r9, byte[] r10) {
        int r0 = r9.length;
        C2656w4 r1 = this.f7453a;
        C0668Pg r2 = this.f7455c;
        if (r0 <= 5) goto L12;
    ...
    L6:
        ...
        byte[] r4 = ((InterfaceC1435g1) ((C2516su) r03.next()).f8808b).mo1003b(r3, r10);     // Catch: GeneralSecurityException -> L10
    ...
    L14:
        ...
        byte[] r12 = ((InterfaceC1435g1) ((C2516su) r04.next()).f8808b).mo1003b(r9, r10);     // Catch: GeneralSecurityException -> L20
