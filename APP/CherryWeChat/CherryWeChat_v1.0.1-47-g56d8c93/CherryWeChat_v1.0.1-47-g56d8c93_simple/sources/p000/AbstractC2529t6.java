...
public abstract class AbstractC2529t6 {
    ...
    public static final AtomicReference f8828a = null;

    static {
        f8828a = new AtomicReference();
    }

    /* JADX INFO: renamed from: a */
    public static MappedByteBuffer m5009a(File r9) {
        FileChannel r1 = null;
    ...
    public static ByteBuffer m5010b(InputStream r5) {
        ByteArrayOutputStream r0 = new ByteArrayOutputStream(16384);
        AtomicReference r3 = f8828a;
    ...
    L8:
        ...
        return m5011c(ByteBuffer.allocateDirect(r52.length).put(r52));
    }

    /* JADX INFO: renamed from: c */
    public static ByteBuffer m5011c(ByteBuffer r1) {
        return (ByteBuffer) r1.position(0);
    }

    /* JADX INFO: renamed from: d */
    public static void m5012d(ByteBuffer r3, File r4) {
        m5011c(r3);
        FileChannel r0 = null;
