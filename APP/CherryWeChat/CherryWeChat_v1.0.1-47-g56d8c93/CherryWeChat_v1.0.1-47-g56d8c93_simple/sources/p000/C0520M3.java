...
public class C0520M3 extends ImageView {

    /* JADX INFO: renamed from: a */
    public final C1349e3 f1697a;

    /* JADX INFO: renamed from: b */
    public final C0477L3 f1698b;

    /* JADX INFO: renamed from: c */
    public boolean f1699c;

    public C0520M3(Context r1, AttributeSet r2, int r3) {
    ...
    public final void drawableStateChanged() {
        ...
        C1349e3 r0 = this.f1697a;
        if (r0 == null) goto L5;
        r0.m2600a();
    L5:
        C0477L3 r02 = this.f1698b;
        if (r02 == null) goto L9;
        r02.m933a();
        return;
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((((ImageView) this.f1698b.f1575c).getBackground() instanceof RippleDrawable) == false) goto L5;
        return false;
    L5:
    ...
    public void setImageDrawable(Drawable r3) {
        C0477L3 r0 = this.f1698b;
        if (r0 == null) goto L8;
        if (r3 == null) goto L8;
        if (this.f1699c == true) goto L8;
        r0.f1574b = r3.getLevel();
    L8:
        super.setImageDrawable(r3);
        if (r0 == null) goto L16;
        r0.m933a();
        if (this.f1699c == true) goto L17;
