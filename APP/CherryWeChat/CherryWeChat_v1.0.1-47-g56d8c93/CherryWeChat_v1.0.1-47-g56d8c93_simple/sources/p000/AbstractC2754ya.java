...
public abstract class AbstractC2754ya {
    ...
    public static final ThreadLocal f9383a = null;

    static {
        f9383a = new ThreadLocal();
    }

    /* JADX INFO: renamed from: a */
    public static ColorStateList m5334a(Resources r4, XmlResourceParser r5, Resources.Theme r6) {
    ...
    public static ColorStateList m5335b(Resources r36, XmlPullParser r37, AttributeSet r38, Resources.Theme r39) {
        ?? r0 = r36;
        AttributeSet r1 = r38;
    ...
    L26:
        ...
        if (r103 <= 31) goto L33;
    L149:
        int r104 = m5334a(r0, r0.getXml(r13), r2).getDefaultColor();     // Catch: Exception -> L32
    L35:
    ...
    L134:
        r19 = r8 * 2;
    L73:
        int r112 = AbstractC0585Nj.m1137e((int) ((Color.alpha(r104) * r11) + 0.5f), 0, 255);
        if (r95 == false) goto L127;
        C0351I6 r96 = C0351I6.m752a(r104);
        float r105 = r96.f1178a;
        float r97 = r96.f1179b;
        C0917VE r133 = C0917VE.f2864k;
        if (r97 >= 1.0d) goto L78;
    L81:
        r31 = r02;
        r34 = r32;
        int r04 = AbstractC0628Oj.m1224D(r42);
    L116:
        r104 = r04;
    L128:
    ...
    L91:
        ...
        r31 = r02;
        int r05 = C0351I6.m753b(r124, r152, r106).m754c(C0917VE.f2864k);
        float r142 = AbstractC0628Oj.m1229L(Color.red(r05));
        float r322 = AbstractC0628Oj.m1229L(Color.green(r05));
        float r33 = AbstractC0628Oj.m1229L(Color.blue(r05));
        float[] r342 = AbstractC0628Oj.f2010d[r162 == true ? 1 : 0];
    ...
    L96:
        ...
        C0351I6 r111 = C0351I6.m752a(r323);
        C0351I6 r07 = C0351I6.m753b(r111.f1180c, r111.f1179b, r106);
        float r28 = r111.f1181d - r07.f1181d;
        float r29 = r111.f1182e - r07.f1182e;
        float r210 = r111.f1183f - r07.f1183f;
    ...
    L122:
        ...
        r04 = AbstractC0628Oj.m1224D(r42);
        goto L116
    L125:
        r04 = r73.m754c(r133);
        goto L116
