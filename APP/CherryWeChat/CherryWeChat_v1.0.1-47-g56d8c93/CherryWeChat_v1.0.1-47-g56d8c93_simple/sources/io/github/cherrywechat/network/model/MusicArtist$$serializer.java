...
public final /* synthetic */ class MusicArtist$$serializer implements InterfaceC2677wj {
    public static final MusicArtist$$serializer INSTANCE = null;
    private static final InterfaceC0126Cx descriptor = null;

    static {
        MusicArtist$$serializer r0 = new MusicArtist$$serializer();
        INSTANCE = r0;
        C0809St r1 = new C0809St("io.github.cherrywechat.network.model.MusicArtist", r0, 1);
        r1.m1614l("name");
        descriptor = r1;
    }
    ...
    public final MusicArtist deserialize(InterfaceC0406Jc r10) {
    ...
    L11:
        r102.mo1777r(r0);
        return new MusicArtist(r5, r6, null);
    }
    ...
    public final void serialize(InterfaceC0624Of r2, MusicArtist r3) {
        InterfaceC0126Cx r0 = descriptor;
        r2.m1213c();
        MusicArtist.write$Self$app_release(r3, null, r0);
        throw null;
    }
