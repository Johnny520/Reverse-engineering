...
public final /* synthetic */ class Feature$$serializer implements InterfaceC2677wj {
    public static final Feature$$serializer INSTANCE = null;
    private static final InterfaceC0126Cx descriptor = null;

    static {
        Feature$$serializer r0 = new Feature$$serializer();
        INSTANCE = r0;
        C0809St r1 = new C0809St("io.github.cherrywechat.network.model.Feature", r0, 2);
        r1.m1614l("title");
    ...
    public final Feature deserialize(InterfaceC0406Jc r11) {
    ...
    L13:
        r112.mo1777r(r0);
        return new Feature(r5, r6, r7, null);
    }
    ...
    public final void serialize(InterfaceC0624Of r2, Feature r3) {
        InterfaceC0126Cx r0 = descriptor;
        r2.m1213c();
        Feature.write$Self$app_release(r3, null, r0);
        throw null;
    }
