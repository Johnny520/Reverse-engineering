...
public final /* synthetic */ class AppInfo$$serializer implements InterfaceC2677wj {
    public static final AppInfo$$serializer INSTANCE = null;
    private static final InterfaceC0126Cx descriptor = null;

    static {
        AppInfo$$serializer r0 = new AppInfo$$serializer();
        INSTANCE = r0;
        C0809St r1 = new C0809St("io.github.cherrywechat.network.model.AppInfo", r0, 3);
        r1.m1614l("appName");
        r1.m1614l("appSubtitle");
        r1.m1614l("logoUrl");
        descriptor = r1;
    }
    ...
    public final AppInfo deserialize(InterfaceC0406Jc r11) {
    ...
    L16:
        r112.mo1777r(r0);
        return new AppInfo(r5, r6, r7, r8, null);
    }
    ...
    public final void serialize(InterfaceC0624Of r2, AppInfo r3) {
        InterfaceC0126Cx r0 = descriptor;
        r2.m1213c();
        AppInfo.write$Self$app_release(r3, null, r0);
        throw null;
    }
