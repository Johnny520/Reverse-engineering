...
public final /* synthetic */ class Change$$serializer implements InterfaceC2677wj {
    public static final Change$$serializer INSTANCE = null;
    private static final InterfaceC0126Cx descriptor = null;

    static {
        Change$$serializer r0 = new Change$$serializer();
        INSTANCE = r0;
        C0809St r1 = new C0809St("io.github.cherrywechat.network.model.Change", r0, 2);
        r1.m1614l("type");
    ...
    public final Change deserialize(InterfaceC0406Jc r11) {
    ...
    L6:
        if (r8 != 0) goto L7;
        r6 = (ChangeType) r112.mo1779v(r0, 0, ChangeType$$serializer.INSTANCE, r6);
        r5 = r5 | 1;
        goto L3
    L7:
        if (r8 != 1) goto L10;
    ...
    L13:
        r112.mo1777r(r0);
        return new Change(r5, r6, r7, null);
    }
    ...
    public final void serialize(InterfaceC0624Of r2, Change r3) {
        InterfaceC0126Cx r0 = descriptor;
        r2.m1213c();
        Change.write$Self$app_release(r3, null, r0);
        throw null;
    }
