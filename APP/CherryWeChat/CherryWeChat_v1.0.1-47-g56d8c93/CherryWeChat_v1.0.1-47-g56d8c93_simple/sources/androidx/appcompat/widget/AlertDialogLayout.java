...
public class AlertDialogLayout extends AbstractC1465go {
    ...
    public static int m2096j(View r3) {
        WeakHashMap r0 = AbstractC2185lE.f7617a;
        int r02 = r3.getMinimumHeight();
        if (r02 <= 0) goto L6;
        return r02;
    L6:
        ...
        return m2096j(r32.getChildAt(0));
    L11:
        return 0;
    }
    ...
    L13:
        ...
        C1421fo r6 = (C1421fo) r32.getLayoutParams();
    ...
    L54:
        ...
        C1421fo r94 = (C1421fo) r15.getLayoutParams();
