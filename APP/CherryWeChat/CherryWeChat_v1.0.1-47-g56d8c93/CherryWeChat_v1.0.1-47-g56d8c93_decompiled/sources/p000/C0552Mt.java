...
public final class C0552Mt {
    ...
    public C0552Mt(char c, float[] fArr) {
        this.f1820a = c;
        this.f1821b = fArr;
    }

    /* JADX INFO: renamed from: a */
    public static void m1094a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d17 < 0.0d) {
            ...
            m1094a(path, f, f2, f3, f4, f5 * fSqrt, fSqrt * f6, f7, z, z2);
            return;
        }
    ...
    /* JADX INFO: renamed from: b */
    public static void m1095b(C0552Mt[] c0552MtArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        C0552Mt c0552Mt;
        ...
        float f9;
        float f10;
        C0552Mt[] c0552MtArr2 = c0552MtArr;
        Path path2 = path;
        float[] fArr2 = new float[6];
        int length = c0552MtArr2.length;
        int i4 = 0;
        int i5 = 0;
        char c2 = 'm';
        while (i5 < length) {
            C0552Mt c0552Mt3 = c0552MtArr2[i5];
            char c3 = c0552Mt3.f1820a;
            float[] fArr3 = c0552Mt3.f1821b;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];
            ...
            while (i7 < fArr3.length) {
                if (c3 == 'A') {
                    ...
                    int i8 = i2 + 5;
                    int i9 = i2 + 6;
                    m1094a(path, f21, f22, fArr[i8], fArr[i9], fArr[i2], fArr[i2 + 1], fArr[i2 + 2], fArr[i2 + 3] != 0.0f ? 1 : i6, fArr[i2 + 4] != 0.0f ? 1 : i6);
                    f13 = fArr[i8];
                    f = fArr[i9];
                    f14 = f;
                    f2 = f13;
                    ...
                    float f44 = f20;
                    i3 = i5;
                    m1094a(path, f43, f44, f38, f39, f40, f41, f42, z, fArr[i2 + 4] != 0.0f ? 1 : i6);
                    f2 = f43 + fArr[i35];
                    f = f44 + fArr[i36];
                    f13 = f2;
                    f14 = f;
            ...
            c2 = c0552Mt3.f1820a;
            i5++;
            c0552MtArr2 = c0552MtArr;
            path2 = path;
            i4 = i6;
        }
    }

    public C0552Mt(C0552Mt c0552Mt) {
        this.f1820a = c0552Mt.f1820a;
        float[] fArr = c0552Mt.f1821b;
        this.f1821b = AbstractC1406fG.m2684I(fArr, fArr.length);
    }
}
