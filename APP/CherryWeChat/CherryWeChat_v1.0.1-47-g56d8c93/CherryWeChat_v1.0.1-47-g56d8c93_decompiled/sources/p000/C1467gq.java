...
public final class C1467gq extends BannerImageAdapter {
    ...
    public C1467gq(Banner banner, List list) {
        super(list);
        this.f5202a = banner;
    }
    ...
    public final void onBindView(Object obj, Object obj2, int i, int i2) {
        ...
        ((C1193aw) ComponentCallbacks2C1273a.m2414c(this.f5202a.getContext()).m2833n(((C1304d1) obj2).f4746b).m5309b()).m2298A(((BannerImageHolder) obj).imageView);
    }
}
