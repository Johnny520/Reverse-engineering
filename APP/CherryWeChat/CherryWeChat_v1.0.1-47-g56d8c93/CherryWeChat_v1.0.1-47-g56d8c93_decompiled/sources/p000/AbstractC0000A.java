...
public abstract class AbstractC0000A implements List, Collection, InterfaceC0545Mm {
    ...
    public boolean contains(Object obj) {
        ...
        while (it.hasNext()) {
            if (AbstractC0585Nj.m1134a(it.next(), obj)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equals(Object obj) {
        ...
        if (size() == collection.size()) {
            ...
            while (it2.hasNext()) {
                if (!AbstractC0585Nj.m1134a(it2.next(), it.next())) {
                }
            }
            return true;
        }
    ...
    public int lastIndexOf(Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (AbstractC0585Nj.m1134a(listIterator.previous(), obj)) {
