...
public abstract class AbstractC0100CD {
    ...
    public static void m146a(int i) throws InvalidAlgorithmParameterException {
        if (i != 16 && i != 32) {
    ...
    public static String m147b(String str) {
    ...
    public static void m148c(int i) throws GeneralSecurityException {
        if (i < 0 || i > 0) {
