...
public class C2201lo extends AbstractC1164m {
    ...
    public C2201lo(Context context) {
    ...
    public int calculateDxToMakeVisible(View view, int i) {
        AbstractC1160i layoutManager = getLayoutManager();
        if (layoutManager == null || !layoutManager.canScrollHorizontally()) {
            return 0;
        }
        C2431qv c2431qv = (C2431qv) view.getLayoutParams();
        return calculateDtToFit(layoutManager.getDecoratedLeft(view) - ((ViewGroup.MarginLayoutParams) c2431qv).leftMargin, layoutManager.getDecoratedRight(view) + ((ViewGroup.MarginLayoutParams) c2431qv).rightMargin, layoutManager.getPaddingLeft(), layoutManager.getWidth() - layoutManager.getPaddingRight(), i);
    }
    ...
    public int calculateDyToMakeVisible(View view, int i) {
        ...
        C2431qv c2431qv = (C2431qv) view.getLayoutParams();
        return calculateDtToFit(layoutManager.getDecoratedTop(view) - ((ViewGroup.MarginLayoutParams) c2431qv).topMargin, layoutManager.getDecoratedBottom(view) + ((ViewGroup.MarginLayoutParams) c2431qv).bottomMargin, layoutManager.getPaddingTop(), layoutManager.getHeight() - layoutManager.getPaddingBottom(), i);
    }
    ...
    @SuppressLint({"UnknownNullness"})
    public void onSeekTargetStep(int i, int i2, C0038Av c0038Av, C1163l c1163l) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        ...
        if (i4 == 0 && i7 == 0) {
            updateActionForInterimTarget(c1163l);
        }
    }
    ...
    @Override // androidx.recyclerview.widget.AbstractC1164m
    @SuppressLint({"UnknownNullness"})
    public void onTargetFound(View view, C0038Av c0038Av, C1163l c1163l) {
        ...
        if (iCalculateTimeForDeceleration > 0) {
            ...
            c1163l.f4048a = -iCalculateDxToMakeVisible;
            c1163l.f4049b = -iCalculateDyToMakeVisible;
    ...
    @SuppressLint({"UnknownNullness"})
    public void updateActionForInterimTarget(C1163l c1163l) {
        ...
        if (pointFComputeScrollVectorForPosition == null || (pointFComputeScrollVectorForPosition.x == 0.0f && pointFComputeScrollVectorForPosition.y == 0.0f)) {
            c1163l.f4051d = getTargetPosition();
            stop();
            return;
        }
        ...
        c1163l.f4049b = i2;
        c1163l.f4050c = i3;
        c1163l.f4052e = linearInterpolator;
        c1163l.f4053f = true;
    }
}
