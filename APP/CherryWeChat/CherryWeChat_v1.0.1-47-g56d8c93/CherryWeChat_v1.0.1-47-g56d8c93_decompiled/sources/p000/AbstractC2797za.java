...
public abstract class AbstractC2797za {
    ...
    public static final ThreadLocal f9466a = new ThreadLocal();

    /* JADX INFO: renamed from: a */
    public static int m5363a(double d, double d2, double d3) {
    ...
    public static int m5364b(int i, int i2, float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i2) * f) + (Color.alpha(i) * f2)), (int) ((Color.red(i2) * f) + (Color.red(i) * f2)), (int) ((Color.green(i2) * f) + (Color.green(i) * f2)), (int) ((Color.blue(i2) * f) + (Color.blue(i) * f2)));
    }

    /* JADX INFO: renamed from: c */
    public static int m5365c(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / 255);
        return Color.argb(i3, m5366d(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m5366d(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m5366d(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: d */
    public static int m5366d(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int m5367e(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
