...
public final /* synthetic */ class MusicLrc$$serializer implements InterfaceC2677wj {
    public static final MusicLrc$$serializer INSTANCE;
    private static final InterfaceC0126Cx descriptor;

    static {
        MusicLrc$$serializer musicLrc$$serializer = new MusicLrc$$serializer();
        INSTANCE = musicLrc$$serializer;
        C0809St c0809St = new C0809St("io.github.cherrywechat.network.model.MusicLrc", musicLrc$$serializer, 1);
        c0809St.m1614l("lyric");
        descriptor = c0809St;
    }
    ...
    public final MusicLrc deserialize(InterfaceC0406Jc interfaceC0406Jc) {
        ...
        return new MusicLrc(i, str, (AbstractC0298Gx) null);
    }
    ...
    @Override // p000.InterfaceC0717Qm
    public final void serialize(InterfaceC0624Of interfaceC0624Of, MusicLrc musicLrc) {
        InterfaceC0126Cx interfaceC0126Cx = descriptor;
        interfaceC0624Of.m1213c();
        MusicLrc.write$Self$app_release(musicLrc, null, interfaceC0126Cx);
        throw null;
    }
