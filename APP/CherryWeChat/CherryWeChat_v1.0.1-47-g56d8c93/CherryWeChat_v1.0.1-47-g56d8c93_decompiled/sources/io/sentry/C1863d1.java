...
public final class C1863d1 {
    ...
    public C1863d1(C1970t c1970t, C1970t c1970t2, Map map, File file, AbstractC1588H1 abstractC1588H1) {
        this.f6682a = c1970t;
        this.f6683b = c1970t2;
        this.f6684c = new ConcurrentHashMap(map);
        this.f6685d = file;
        this.f6686e = abstractC1588H1.mo3672d() / 1.0E9d;
    }
}
