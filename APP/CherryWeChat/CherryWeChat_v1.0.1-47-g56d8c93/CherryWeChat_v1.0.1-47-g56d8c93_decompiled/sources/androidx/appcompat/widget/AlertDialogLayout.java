...
public class AlertDialogLayout extends AbstractC1465go {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* JADX INFO: renamed from: j */
    public static int m2096j(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2096j(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i12 = ((LinearLayout.LayoutParams) c1421fo).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                int absoluteGravity = Gravity.getAbsoluteGravity(i12, getLayoutDirection()) & 7;
                if (absoluteGravity == 1) {
                    i5 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + ((LinearLayout.LayoutParams) c1421fo).leftMargin;
                    i6 = ((LinearLayout.LayoutParams) c1421fo).rightMargin;
                } else if (absoluteGravity != 5) {
                    i7 = ((LinearLayout.LayoutParams) c1421fo).leftMargin + paddingLeft;
                    if (m2818i(i11)) {
                        paddingTop += intrinsicHeight;
                    }
                    int i13 = paddingTop + ((LinearLayout.LayoutParams) c1421fo).topMargin;
                    childAt.layout(i7, i13, measuredWidth + i7, i13 + measuredHeight2);
                    paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c1421fo).bottomMargin + i13;
                } else {
                ...
                int i132 = paddingTop + ((LinearLayout.LayoutParams) c1421fo).topMargin;
                childAt.layout(i7, i132, measuredWidth + i7, i132 + measuredHeight2);
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c1421fo).bottomMargin + i132;
            }
        }
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM2096j = m2096j(view2);
            measuredHeight = view2.getMeasuredHeight() - iM2096j;
            paddingBottom += iM2096j;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM2096j;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM2096j += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM2096j, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c1421fo).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c1421fo).height;
                        ((LinearLayout.LayoutParams) c1421fo).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c1421fo).height = i9;
                    }
                }
                i8++;
