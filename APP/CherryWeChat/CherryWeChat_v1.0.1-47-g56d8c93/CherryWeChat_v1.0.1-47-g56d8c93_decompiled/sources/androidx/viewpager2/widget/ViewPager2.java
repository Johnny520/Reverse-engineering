...
public final class ViewPager2 extends ViewGroup {
    ...
    public abstract class AccessibilityProvider {
        ...
        public void onAttachAdapter(AbstractC1158g abstractC1158g) {
        }

        public void onDetachAdapter(AbstractC1158g abstractC1158g) {
        }
        ...
        public void onLmInitializeAccessibilityNodeInfo(C1118a0 c1118a0) {
        }

        public void onLmInitializeAccessibilityNodeInfoForItem(View view, C1118a0 c1118a0) {
        }
    ...
    public class BasicAccessibilityProvider extends AccessibilityProvider {
        ...
        public void onLmInitializeAccessibilityNodeInfo(C1118a0 c1118a0) {
            ...
            c1118a0.f3530a.removeAction((AccessibilityNodeInfo.AccessibilityAction) C0902V.f2804g.f2810a);
            c1118a0.f3530a.removeAction((AccessibilityNodeInfo.AccessibilityAction) C0902V.f2803f.f2810a);
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public void calculateExtraLayoutSpace(C0038Av c0038Av, int[] iArr) {
            ...
            if (offscreenPageLimit == -1) {
                super.calculateExtraLayoutSpace(c0038Av, iArr);
                return;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(C1161j c1161j, C0038Av c0038Av, C1118a0 c1118a0) {
            ...
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(c1118a0);
        }

        @Override // androidx.recyclerview.widget.AbstractC1160i
        public void onInitializeAccessibilityNodeInfoForItem(C1161j c1161j, C0038Av c0038Av, View view, C1118a0 c1118a0) {
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfoForItem(view, c1118a0);
        }

        @Override // androidx.recyclerview.widget.AbstractC1160i
        public boolean performAccessibilityAction(C1161j c1161j, C0038Av c0038Av, int i, Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i) : super.performAccessibilityAction(c1161j, c0038Av, i, bundle);
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public PageAwareAccessibilityProvider() {
            super();
            this.mActionPageForward = new InterfaceC2123k0() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.1
            ...
            this.mActionPageBackward = new InterfaceC2123k0() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.2
                @Override // p000.InterfaceC2123k0
                public boolean perform(View view, AbstractC1241c0 abstractC1241c0) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() - 1);
                    return true;
        ...
        private void addCollectionInfo(C1118a0 c1118a0) {
            int itemCount;
            int itemCount2;
            ...
            c1118a0.f3530a.setCollectionInfo(AccessibilityNodeInfo.CollectionInfo.obtain(itemCount2, itemCount, false, 0));
        }

        private void addCollectionItemInfo(View view, C1118a0 c1118a0) {
            c1118a0.f3530a.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(ViewPager2.this.getOrientation() == 1 ? ViewPager2.this.mLayoutManager.getPosition(view) : 0, 1, ViewPager2.this.getOrientation() == 0 ? ViewPager2.this.mLayoutManager.getPosition(view) : 0, 1, false, false));
        }

        private void addScrollActions(C1118a0 c1118a0) {
            int itemCount;
            AbstractC1158g adapter = ViewPager2.this.getAdapter();
        ...
        public void onAttachAdapter(AbstractC1158g abstractC1158g) {
            ...
            if (abstractC1158g != null) {
                abstractC1158g.registerAdapterDataObserver(this.mAdapterDataObserver);
            }
        }
        ...
        public void onDetachAdapter(AbstractC1158g abstractC1158g) {
            if (abstractC1158g != null) {
                abstractC1158g.unregisterAdapterDataObserver(this.mAdapterDataObserver);
            }
        }
        ...
        public void onInitialize(CompositeOnPageChangeCallback compositeOnPageChangeCallback, RecyclerView recyclerView) {
            ...
            this.mAdapterDataObserver = new DataSetChangeObserver() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.3
                @Override // androidx.viewpager2.widget.ViewPager2.DataSetChangeObserver, p000.AbstractC1516hv
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            addCollectionInfo(c1118a0);
            addScrollActions(c1118a0);
        }

        @Override // androidx.viewpager2.widget.ViewPager2.AccessibilityProvider
        public void onLmInitializeAccessibilityNodeInfoForItem(View view, C1118a0 c1118a0) {
            addCollectionItemInfo(view, c1118a0);
        }
        ...
        public void updatePageAccessibilityActions() {
            ...
            AbstractC2185lE.m4396i(viewPager2, R.id.accessibilityActionPageLeft);
            AbstractC2185lE.m4393f(viewPager2, 0);
            AbstractC2185lE.m4396i(viewPager2, R.id.accessibilityActionPageRight);
            AbstractC2185lE.m4393f(viewPager2, 0);
            AbstractC2185lE.m4396i(viewPager2, R.id.accessibilityActionPageUp);
            AbstractC2185lE.m4393f(viewPager2, 0);
            AbstractC2185lE.m4396i(viewPager2, R.id.accessibilityActionPageDown);
            AbstractC2185lE.m4393f(viewPager2, 0);
            ...
            if (ViewPager2.this.getOrientation() != 0) {
                if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                    AbstractC2185lE.m4397j(viewPager2, new C0902V(R.id.accessibilityActionPageDown, (String) null), this.mActionPageForward);
                }
                if (ViewPager2.this.mCurrentItem > 0) {
                    AbstractC2185lE.m4397j(viewPager2, new C0902V(R.id.accessibilityActionPageUp, (String) null), this.mActionPageBackward);
                    return;
                }
                return;
            }
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                AbstractC2185lE.m4397j(viewPager2, new C0902V(i2, (String) null), this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                AbstractC2185lE.m4397j(viewPager2, new C0902V(i, (String) null), this.mActionPageBackward);
            }
        }
    }
    ...
    public class PagerSnapHelperImpl extends C0122Ct {
        ...
        public View findSnapView(AbstractC1160i abstractC1160i) {
            ...
            return super.findSnapView(abstractC1160i);
        }
    }
    ...
    private InterfaceC2474rv enforceChildFillListener() {
        return new InterfaceC2474rv() { // from class: androidx.viewpager2.widget.ViewPager2.4
            @Override // p000.InterfaceC2474rv
            public void onChildViewAttachedToWindow(View view) {
                C2431qv c2431qv = (C2431qv) view.getLayoutParams();
                if (((ViewGroup.MarginLayoutParams) c2431qv).width != -1 || ((ViewGroup.MarginLayoutParams) c2431qv).height != -1) {
    ...
    private void registerCurrentItemDataSetTracker(AbstractC1158g abstractC1158g) {
        if (abstractC1158g != null) {
            abstractC1158g.registerAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1167R.styleable.ViewPager2);
        AbstractC2185lE.m4398k(this, context, C1167R.styleable.ViewPager2, attributeSet, typedArrayObtainStyledAttributes, 0);
        try {
            setOrientation(typedArrayObtainStyledAttributes.getInt(C1167R.styleable.ViewPager2_android_orientation, 0));
        } finally {
            typedArrayObtainStyledAttributes.recycle();
        }
    }

    private void unregisterCurrentItemDataSetTracker(AbstractC1158g abstractC1158g) {
        if (abstractC1158g != null) {
            abstractC1158g.unregisterAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    public void addItemDecoration(AbstractC2251mv abstractC2251mv) {
        this.mRecyclerView.addItemDecoration(abstractC2251mv);
    }
    ...
    public void removeItemDecoration(AbstractC2251mv abstractC2251mv) {
        this.mRecyclerView.removeItemDecoration(abstractC2251mv);
    }
    ...
    public void setAdapter(AbstractC1158g abstractC1158g) {
        AbstractC1158g adapter = this.mRecyclerView.getAdapter();
        this.mAccessibilityProvider.onDetachAdapter(adapter);
        unregisterCurrentItemDataSetTracker(adapter);
        this.mRecyclerView.setAdapter(abstractC1158g);
        this.mCurrentItem = 0;
        restorePendingState();
        this.mAccessibilityProvider.onAttachAdapter(abstractC1158g);
        registerCurrentItemDataSetTracker(abstractC1158g);
    }
    ...
    public void setCurrentItemInternal(int i, boolean z) {
        AbstractC1158g adapter = getAdapter();
        if (adapter == null) {
    ...
    public void updateCurrentItem() {
        C0122Ct c0122Ct = this.mPagerSnapHelper;
        if (c0122Ct == null) {
            throw new IllegalStateException("Design assumption violated.");
        }
        View viewFindSnapView = c0122Ct.findSnapView(this.mLayoutManager);
        if (viewFindSnapView == null) {
            return;
        }
    ...
    public void addItemDecoration(AbstractC2251mv abstractC2251mv, int i) {
        this.mRecyclerView.addItemDecoration(abstractC2251mv, i);
    }
