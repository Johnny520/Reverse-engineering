...
public class OSUtils {
    ...
    public static boolean isFlymeOS4Later() {
        ...
        if (!flymeOSVersion.isEmpty()) {
            try {
                if ((flymeOSVersion.toLowerCase().contains("os") ? Integer.parseInt(flymeOSVersion.substring(9, 10)) : Integer.parseInt(flymeOSVersion.substring(6, 7))) >= 4) {
                    return true;
                }
    ...
    public static boolean isFlymeOS5() {
        ...
        if (!flymeOSVersion.isEmpty()) {
            try {
                if ((flymeOSVersion.toLowerCase().contains("os") ? Integer.parseInt(flymeOSVersion.substring(9, 10)) : Integer.parseInt(flymeOSVersion.substring(6, 7))) == 5) {
                    return true;
                }
            } catch (NumberFormatException unused) {
            }
