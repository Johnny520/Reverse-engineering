...
public final class C1276b extends AbstractC1166o {
    ...
    public C1276b(LinearLayout linearLayout, boolean z) {
        super(linearLayout);
        TextView textView = (TextView) linearLayout.findViewById(R.id.month_title);
        this.f4532a = textView;
        WeakHashMap weakHashMap = AbstractC2185lE.f7617a;
        new C1132aE(R.id.tag_accessibility_heading, Boolean.class, 0, 28, 3).m4627f(textView, Boolean.TRUE);
        this.f4533b = (MaterialCalendarGridView) linearLayout.findViewById(R.id.month_grid);
        if (z) {
            return;
        }
