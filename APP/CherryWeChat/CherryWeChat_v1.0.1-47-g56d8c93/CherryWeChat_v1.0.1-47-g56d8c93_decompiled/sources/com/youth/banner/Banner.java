...
public class Banner<T, BA extends BannerAdapter<T, ? extends AbstractC1166o>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private void initTypedArray(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1288R.styleable.Banner);
            this.mBannerRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_radius, 0);
            this.mLoopTime = typedArrayObtainStyledAttributes.getInt(C1288R.styleable.Banner_banner_loop_time, BannerConfig.LOOP_TIME);
            this.mIsAutoLoop = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_auto_loop, true);
            this.mIsInfiniteLoop = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_infinite_loop, true);
            this.normalWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_normal_width, BannerConfig.INDICATOR_NORMAL_WIDTH);
            this.selectedWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_selected_width, BannerConfig.INDICATOR_SELECTED_WIDTH);
            this.normalColor = typedArrayObtainStyledAttributes.getColor(C1288R.styleable.Banner_banner_indicator_normal_color, BannerConfig.INDICATOR_NORMAL_COLOR);
            this.selectedColor = typedArrayObtainStyledAttributes.getColor(C1288R.styleable.Banner_banner_indicator_selected_color, BannerConfig.INDICATOR_SELECTED_COLOR);
            this.indicatorGravity = typedArrayObtainStyledAttributes.getInt(C1288R.styleable.Banner_banner_indicator_gravity, 1);
            this.indicatorSpace = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_space, 0);
            this.indicatorMargin = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_margin, 0);
            this.indicatorMarginLeft = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_marginLeft, 0);
            this.indicatorMarginTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_marginTop, 0);
            this.indicatorMarginRight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_marginRight, 0);
            this.indicatorMarginBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_marginBottom, 0);
            this.indicatorHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_height, BannerConfig.INDICATOR_HEIGHT);
            this.indicatorRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1288R.styleable.Banner_banner_indicator_radius, BannerConfig.INDICATOR_RADIUS);
            this.mOrientation = typedArrayObtainStyledAttributes.getInt(C1288R.styleable.Banner_banner_orientation, 0);
            this.mRoundTopLeft = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_round_top_left, false);
            this.mRoundTopRight = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_round_top_right, false);
            this.mRoundBottomLeft = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_round_bottom_left, false);
            this.mRoundBottomRight = typedArrayObtainStyledAttributes.getBoolean(C1288R.styleable.Banner_banner_round_bottom_right, false);
    ...
    public Banner addBannerLifecycleObserver(InterfaceC1061Yn interfaceC1061Yn) {
        if (interfaceC1061Yn != null) {
            interfaceC1061Yn.getLifecycle().mo1555a(new BannerLifecycleObserverAdapter(interfaceC1061Yn, this));
        }
        return this;
    }

    public Banner addItemDecoration(AbstractC2251mv abstractC2251mv) {
        getViewPager2().addItemDecoration(abstractC2251mv);
        return this;
    }
    ...
    */
    ...
    public Banner setIndicatorNormalColorRes(int i) {
        setIndicatorNormalColor(getContext().getColor(i));
        return this;
    }
    ...
    public Banner setIndicatorSelectedColorRes(int i) {
        setIndicatorSelectedColor(getContext().getColor(i));
        return this;
    }
    ...
    public Banner addItemDecoration(AbstractC2251mv abstractC2251mv, int i) {
        getViewPager2().addItemDecoration(abstractC2251mv, i);
        return this;
    }
    ...
    public Banner(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAdapterDataObserver = new AbstractC1516hv() { // from class: com.youth.banner.Banner.1
