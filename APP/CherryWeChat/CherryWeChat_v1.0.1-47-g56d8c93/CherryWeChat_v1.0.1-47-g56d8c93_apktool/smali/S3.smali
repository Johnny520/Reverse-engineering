...
.method public static a(Landroid/view/DragEvent;Landroid/widget/TextView;Landroid/app/Activity;)Z
    ...
    invoke-direct {p2}, Lxb;-><init>()V

    iput-object p0, p2, Lxb;->b:Ljava/lang/Object;

    iput v1, p2, Lxb;->c:I

    :goto_0
    invoke-interface {p2}, Lwb;->build()Lzb;

    move-result-object p0

    invoke-static {p1, p0}, LlE;->h(Landroid/view/View;Lzb;)Lzb;
    :try_end_0
