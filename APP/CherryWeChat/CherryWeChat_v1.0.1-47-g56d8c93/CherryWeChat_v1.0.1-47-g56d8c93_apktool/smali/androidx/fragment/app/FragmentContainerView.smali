...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lzi;)V
    .locals 4
    ...
    .line 28
    invoke-virtual {p3, p2}, Lzi;->B(I)Lhi;
    ...
    .line 32
    invoke-static {p3, v1, p1}, Lph;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 34
    :cond_2
    invoke-virtual {p3}, Lzi;->E()Lti;

    move-result-object p2

    invoke-virtual {p1}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;

    invoke-virtual {p2, v1}, Lti;->a(Ljava/lang/String;)Lhi;

    move-result-object p1

    .line 35
    iput-boolean v0, p1, Lhi;->C:Z

    .line 36
    iget-object p2, p1, Lhi;->s:Lji;
    ...
    invoke-direct {p2, p3}, Lh5;-><init>(Lzi;)V

    .line 40
    iput-boolean v0, p2, Lh5;->o:Z

    .line 41
    iput-object p0, p1, Lhi;->D:Landroid/view/ViewGroup;
    ...
    .line 43
    invoke-virtual {p2, v1, p1, v2, v0}, Lh5;->e(ILhi;Ljava/lang/String;I)V

    .line 44
    iget-boolean p1, p2, Lh5;->g:Z

    if-nez p1, :cond_5

    .line 45
    iget-object p1, p2, Lh5;->p:Lzi;

    invoke-virtual {p1, p2, v0}, Lzi;->z(Lh5;Z)V
    ...
    :cond_6
    :goto_2
    iget-object p1, p3, Lzi;->c:Lqs;

    invoke-virtual {p1}, Lqs;->q()Ljava/util/ArrayList;
    ...
    iget-object v0, p3, Lhi;->E:Landroid/view/View;
    ...
    .line 51
    iput-object p0, p3, Lhi;->D:Landroid/view/ViewGroup;

    .line 52
    invoke-virtual {p2}, LHi;->b()V
...
.method public final dispatchApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {v0, p1}, LLF;->h(Landroid/view/View;Landroid/view/WindowInsets;)LLF;
    ...
    invoke-static {v0, v1}, LLF;->h(Landroid/view/View;Landroid/view/WindowInsets;)LLF;
    ...
    :cond_0
    invoke-static {p0, v1}, LlE;->g(Landroid/view/View;LLF;)LLF;
    ...
    invoke-static {v3, v0}, LlE;->b(Landroid/view/View;LLF;)LLF;
...
.method public final getFragment()Lhi;
    .locals 4
    ...
    invoke-virtual {v2}, Lhi;->i()Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {v2}, Lhi;->c()Lzi;
    ...
    invoke-virtual {v0, v1}, Lzi;->B(I)Lhi;
