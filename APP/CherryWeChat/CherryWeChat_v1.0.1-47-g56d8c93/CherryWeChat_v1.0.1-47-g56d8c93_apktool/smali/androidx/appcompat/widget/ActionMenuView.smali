...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lgo;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    invoke-virtual {p0, v0}, Lgo;->setBaselineAligned(Z)V
...
.method public static k(Landroid/view/ViewGroup$LayoutParams;)LF0;
    .locals 1
    ...
    iget-boolean p0, p0, LF0;->a:Z

    iput-boolean p0, v0, LF0;->a:Z
...
# virtual methods
.method public final a(Lqr;)Z
    .locals 3

    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;

    const/4 v1, 0x0

    const/4 v2, 0x0

    invoke-virtual {v0, p1, v2, v1}, Llr;->q(Landroid/view/MenuItem;LDr;I)Z
...
.method public final b(Llr;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;
...
.method public final bridge synthetic f()Lfo;
    .locals 1
...
.method public final g(Landroid/util/AttributeSet;)Lfo;
    .locals 2
...
.method public getMenu()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Llr;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;
    ...
    iput-object v2, v1, Llr;->e:Ljr;

    new-instance v1, LD0;

    invoke-direct {v1, v0}, LD0;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->t:LD0;

    const/4 v0, 0x1

    iput-boolean v0, v1, LD0;->l:Z

    iput-boolean v0, v1, LD0;->m:Z

    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->u:LY5;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->t:LD0;

    iput-object p0, v0, LD0;->h:LGr;

    iget-object v0, v0, LD0;->c:Llr;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v1, v0, LD0;->k:Z

    if-eqz v1, :cond_1

    iget-object v0, v0, LD0;->j:Landroid/graphics/drawable/Drawable;
...
.method public final bridge synthetic h(Landroid/view/ViewGroup$LayoutParams;)Lfo;
    .locals 0
...
.method public final l(I)Z
    ...
    instance-of v3, v1, LE0;

    if-eqz v3, :cond_1

    check-cast v1, LE0;

    invoke-interface {v1}, LE0;->a()Z
    ...
    instance-of p1, v2, LE0;

    if-eqz p1, :cond_2

    check-cast v2, LE0;

    invoke-interface {v2}, LE0;->b()Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->t:LD0;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Lgo;->onLayout(ZIIII)V
    ...
    invoke-virtual {v0}, Lgo;->getDividerWidth()I
...
.method public final onMeasure(II)V
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;
    ...
    invoke-virtual {v2, v3}, Llr;->p(Z)V
    ...
    iput-boolean v9, v5, LF0;->f:Z

    iput v9, v5, LF0;->c:I

    iput v9, v5, LF0;->b:I

    iput-boolean v9, v5, LF0;->d:Z
    ...
    invoke-virtual {v9}, Lo4;->getText()Ljava/lang/CharSequence;
    ...
    :goto_2
    iput-boolean v9, v5, LF0;->e:Z

    iget-boolean v9, v5, LF0;->a:Z
    ...
    invoke-virtual {v11}, Lo4;->getText()Ljava/lang/CharSequence;
    ...
    iput-boolean v4, v6, LF0;->f:Z

    if-nez v3, :cond_25

    iget-boolean v4, v6, LF0;->e:Z
    ...
    :cond_30
    invoke-super/range {p0 .. p2}, Lgo;->onMeasure(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    iput-boolean p1, v0, LD0;->q:Z

    return-void
.end method

.method public setOnMenuItemClickListener(LG0;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->A:LG0;
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, p1}, LM3;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v1, v0, LD0;->k:Z

    iput-object p1, v0, LD0;->j:Landroid/graphics/drawable/Drawable;
...
.method public setPresenter(LD0;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->t:LD0;

    iput-object p0, p1, LD0;->h:LGr;

    iget-object p1, p1, LD0;->c:Llr;
