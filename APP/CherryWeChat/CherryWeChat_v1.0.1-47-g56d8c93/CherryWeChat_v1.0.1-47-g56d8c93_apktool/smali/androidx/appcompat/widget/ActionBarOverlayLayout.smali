...
.field public final x:Lr0;

.field public final y:Ls0;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v2, v1, v2}, Lyl;->b(IIII)Lyl;

    move-result-object v1

    invoke-virtual {v0, v1}, LzF;->g(Lyl;)V

    invoke-virtual {v0}, LzF;->b()LLF;

    move-result-object v0

    sput-object v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:LLF;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, LLF;->b:LLF;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:LLF;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LLF;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:LLF;

    new-instance p2, Lr0;

    const/4 v0, 0x0

    invoke-direct {p2, v0, p0}, Lr0;-><init>(ILjava/lang/Object;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lr0;

    new-instance p2, Ls0;

    invoke-direct {p2, p0, v0}, Ls0;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;I)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Ls0;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Ls0;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:LJs;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lv0;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:LJs;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:LLc;
...
.method public final h()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Ls0;

    invoke-virtual {p0, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Ls0;
...
.method public final j(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:LLc;
...
.method public final k()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/Toolbar;->getWrapper()LLc;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:LLc;
...
.method public final l(Landroid/view/Menu;LCr;)V
    .locals 4
    ...
    invoke-direct {v2, v3}, LD0;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, LwB;->m:LD0;

    :cond_0
    iget-object v0, v0, LwB;->m:LD0;

    iput-object p2, v0, LD0;->e:LCr;
    ...
    iget-object p2, p2, Landroidx/appcompat/widget/ActionMenuView;->p:Llr;
    ...
    iget-object v2, v1, Landroidx/appcompat/widget/Toolbar;->L:LD0;

    invoke-virtual {p2, v2}, Llr;->r(LDr;)V

    iget-object v2, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    invoke-virtual {p2, v2}, Llr;->r(LDr;)V

    :cond_3
    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    if-nez p2, :cond_4

    new-instance p2, LpB;

    invoke-direct {p2, v1}, LpB;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object p2, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    :cond_4
    const/4 p2, 0x1

    iput-boolean p2, v0, LD0;->q:Z

    if-eqz p1, :cond_5

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v0, p2}, Llr;->b(LDr;Landroid/content/Context;)V

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    iget-object v2, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p2, v2}, Llr;->b(LDr;Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1, p2}, LD0;->i(Landroid/content/Context;Llr;)V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    iget-object v2, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v2, p2}, LpB;->i(Landroid/content/Context;Llr;)V

    invoke-virtual {v0}, LD0;->g()V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->M:LpB;

    invoke-virtual {p1}, LpB;->g()V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(LD0;)V

    iput-object v0, v1, Landroidx/appcompat/widget/Toolbar;->L:LD0;
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1}, LLF;->h(Landroid/view/View;Landroid/view/WindowInsets;)LLF;
    ...
    invoke-static {p0, p1, v1}, LeE;->b(Landroid/view/View;LLF;Landroid/graphics/Rect;)LLF;
    ...
    invoke-virtual {p1, v2, v3, v4, v5}, LHF;->m(IIII)LLF;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:LLF;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LLF;

    invoke-virtual {v3, v2}, LLF;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:LLF;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LLF;
...
.method public final onMeasure(II)V
    ...
    iget-object v8, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:LLF;

    iput-object v8, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lv0;

    sget-object v8, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:LLF;

    iget-object v10, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->p:Landroid/graphics/Rect;

    invoke-static {v5, v8, v10}, LeE;->b(Landroid/view/View;LLF;Landroid/graphics/Rect;)LLF;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    iget-object v5, v5, LLF;->a:LHF;

    invoke-virtual {v5, v1, v7, v1, v1}, LHF;->m(IIII)LLF;

    move-result-object v1

    iput-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    goto :goto_3

    :cond_4
    iget-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;
    ...
    invoke-virtual {v5}, LLF;->d()I

    move-result v5

    add-int/2addr v5, v7

    iget-object v7, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    invoke-virtual {v7}, LLF;->c()I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    invoke-virtual {v8}, LLF;->a()I

    move-result v8

    invoke-static {v1, v5, v7, v8}, Lyl;->b(IIII)Lyl;
    ...
    invoke-direct {v7, v5}, LyF;-><init>(LLF;)V
    ...
    invoke-direct {v7, v5}, LxF;-><init>(LLF;)V
    ...
    invoke-direct {v7, v5}, LwF;-><init>(LLF;)V
    ...
    invoke-direct {v7, v5}, LvF;-><init>(LLF;)V
    ...
    invoke-direct {v7, v5}, LuF;-><init>(LLF;)V

    :goto_2
    invoke-virtual {v7, v1}, LzF;->g(Lyl;)V

    invoke-virtual {v7}, LzF;->b()LLF;
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:LLF;

    iget-object v5, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:LLF;

    invoke-virtual {v1, v5}, LLF;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v1, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:LLF;

    iget-object v5, v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v5, v1}, LlE;->b(Landroid/view/View;LLF;)LLF;
...
.method public final onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Ls0;

    invoke-virtual {p1}, Ls0;->run()V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Ls0;
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:LJs;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt0;

    if-eqz p1, :cond_0

    check-cast p1, LmF;

    iget-object p2, p1, LmF;->t:LHE;

    if-eqz p2, :cond_0

    invoke-virtual {p2}, LHE;->a()V

    const/4 p2, 0x0

    iput-object p2, p1, LmF;->t:LHE;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_1
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt0;
    ...
    :cond_2
    iget-boolean p1, v4, LmF;->q:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, LmF;->q:Z

    invoke-virtual {v4, v3}, LmF;->t(Z)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt0;
...
.method public setActionBarVisibilityCallback(Lt0;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt0;
...
.method public setIcon(I)V
    ...
    .line 6
    :goto_0
    iput-object p1, v0, LwB;->d:Landroid/graphics/drawable/Drawable;
...
.method public setLogo(I)V
    ...
    :goto_0
    iput-object p1, v0, LwB;->e:Landroid/graphics/drawable/Drawable;
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iput-object p1, v0, LwB;->k:Landroid/view/Window$Callback;
