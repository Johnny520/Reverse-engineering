...
.method public final a()Z
    ...
    invoke-virtual {p0}, Lo4;->getText()Ljava/lang/CharSequence;
...
.method public final b()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lqr;

    invoke-virtual {v0}, Lqr;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final c(Lqr;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lqr;

    invoke-virtual {p1}, Lqr;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setIcon(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p1}, Lqr;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lqr;->isVisible()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lx0;

    if-nez p1, :cond_1

    new-instance p1, Lx0;

    invoke-direct {p1, p0}, Lx0;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lx0;
...
.method public final h()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lqr;
    ...
    iget-object v2, v2, Lqr;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lqr;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lqr;->r:Ljava/lang/CharSequence;
    ...
    iget-object v1, v0, Lqr;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, LxB;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, LxB;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lkr;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lqr;

    invoke-interface {p1, v0}, Lkr;->a(Lqr;)Z
...
.method public final onMeasure(II)V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lo4;->onMeasure(II)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lx0;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lqr;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, Lo4;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Lkr;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lkr;
...
.method public setPopupCallback(Ly0;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Ly0;
