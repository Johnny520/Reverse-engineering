...
# direct methods
.method public constructor <init>(LBq;Landroid/content/Context;I[Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, LAq;->c:LBq;
...
.method public final a()V
    ...
    iget-object v0, p0, LAq;->c:LBq;

    iget-object v1, v0, LBq;->l:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v5, p0, LAq;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v0, LBq;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v2, v3}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v4

    iget-object v5, v0, LBq;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v4, v6}, Lza;->c(II)I

    move-result v4

    iget v6, v0, LBq;->k:I

    invoke-static {v5, v6}, Lza;->c(II)I
    ...
    :cond_1
    iput-object v2, p0, LAq;->a:Landroid/content/res/ColorStateList;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, LAq;->b:Landroid/content/res/ColorStateList;

    if-eqz p3, :cond_0

    iget-object p3, p0, LAq;->a:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, p3}, Landroid/graphics/drawable/Drawable;->setTintList(Landroid/content/res/ColorStateList;)V

    new-instance p3, Landroid/graphics/drawable/RippleDrawable;

    iget-object v2, p0, LAq;->b:Landroid/content/res/ColorStateList;
