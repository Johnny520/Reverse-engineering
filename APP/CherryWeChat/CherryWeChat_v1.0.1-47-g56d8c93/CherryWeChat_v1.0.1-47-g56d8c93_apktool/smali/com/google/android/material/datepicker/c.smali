...
# direct methods
.method public constructor <init>(Landroid/view/ContextThemeWrapper;LD6;LXm;)V
    .locals 4

    invoke-direct {p0}, Landroidx/recyclerview/widget/g;-><init>()V

    iget-object v0, p2, LD6;->a:Lgs;

    iget-object v1, p2, LD6;->b:Lgs;

    iget-object v2, p2, LD6;->d:Lgs;

    iget-object v0, v0, Lgs;->a:Ljava/util/Calendar;

    iget-object v3, v2, Lgs;->a:Ljava/util/Calendar;
    ...
    iget-object v0, v2, Lgs;->a:Ljava/util/Calendar;
    ...
    invoke-static {p1, v0}, LSq;->F(Landroid/content/Context;I)Z
    ...
    iput-object p2, p0, Lcom/google/android/material/datepicker/c;->a:LD6;

    iput-object p3, p0, Lcom/google/android/material/datepicker/c;->b:LXm;

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/g;->setHasStableIds(Z)V
...
.method public final getItemCount()I
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/c;->a:LD6;
...
.method public final onBindViewHolder(Landroidx/recyclerview/widget/o;I)V
    ...
    invoke-direct {p2, v1}, Lgs;-><init>(Ljava/util/Calendar;)V

    iget-object v1, p1, Lcom/google/android/material/datepicker/b;->a:Landroid/widget/TextView;

    invoke-virtual {p2}, Lgs;->c()Ljava/lang/String;
    ...
    iget-object v1, v1, Lhs;->a:Lgs;

    invoke-virtual {p2, v1}, Lgs;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p1, p2, v0}, Lhs;-><init>(Lgs;LD6;)V
...
.method public final onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/o;
    ...
    invoke-direct {p1, v0, v1}, Lqv;-><init>(II)V
