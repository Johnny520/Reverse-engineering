...
.method public static X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, LWB;->a0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, LWB;->a0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
# virtual methods
.method public final Y([LZh;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 9
    ...
    iget-object v5, v4, LZh;->a:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v4}, LWB;->Z(LZh;)Landroid/graphics/fonts/Font;
    ...
    iget-object v6, v4, LZh;->e:Ljava/lang/String;
...
.method public Z(LZh;)Landroid/graphics/fonts/Font;
    .locals 1
...
.method public final q(Landroid/content/Context;LVh;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget-object v3, v3, LWh;->d:Ljava/lang/String;
    ...
    invoke-static {p2, p4}, LWB;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final r(Landroid/content/Context;[LZh;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-virtual {p0, p2, p1}, LWB;->Y([LZh;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, LWB;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final s(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p0, v0, p1}, LWB;->Y([LZh;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, v3, p1}, LWB;->Y([LZh;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, LWB;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final w([LZh;I)LZh;
    .locals 0
