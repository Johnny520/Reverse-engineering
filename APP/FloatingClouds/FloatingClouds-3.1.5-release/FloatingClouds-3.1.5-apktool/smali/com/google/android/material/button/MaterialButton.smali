...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v3}, La/H0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2, v6}, La/Rg;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, p2, v7}, La/Sa;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, p2, v7}, La/Sa;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1, v3, v4}, La/Vd;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)La/Vd$a;
    ...
    new-instance v1, La/Da;

    invoke-direct {v1, p0, v0}, La/Da;-><init>(Lcom/google/android/material/button/MaterialButton;La/Vd;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:La/Da;
    ...
    iput v0, v1, La/Da;->g:I

    iget-object v2, v1, La/Da;->b:La/Vd;
    ...
    iput-object v3, v2, La/Vd$a;->e:La/w4;

    new-instance v3, La/s;

    invoke-direct {v3, v0}, La/s;-><init>(F)V

    iput-object v3, v2, La/Vd$a;->f:La/w4;

    new-instance v3, La/s;

    invoke-direct {v3, v0}, La/s;-><init>(F)V

    iput-object v3, v2, La/Vd$a;->g:La/w4;

    new-instance v3, La/s;

    invoke-direct {v3, v0}, La/s;-><init>(F)V

    iput-object v3, v2, La/Vd$a;->h:La/w4;

    invoke-virtual {v2}, La/Vd$a;->a()La/Vd;

    move-result-object v0

    invoke-virtual {v1, v0}, La/Da;->c(La/Vd;)V

    iput-boolean v7, v1, La/Da;->p:Z
    ...
    invoke-static {v0, v6}, La/Rg;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, La/Da;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, p2, v2}, La/Sa;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, La/Da;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, La/Da;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, La/Da;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v7, v1, La/Da;->o:Z

    iget-object v5, v1, La/Da;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, La/Da;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:La/Da;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, La/Da;->o:Z
...
.method public final c(Z)V
    ...
    invoke-static {v0, v2}, La/w5$a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, La/w5$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, La/Da;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()La/Vd;
    ...
    iget-object v0, v0, La/Da;->b:La/Vd;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, La/Da;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, La/Da;->j:Landroid/content/res/ColorStateList;

    return-object v0

    :cond_0
    invoke-super {p0}, La/H0;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, La/Da;->i:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    :cond_0
    invoke-super {p0}, La/H0;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:La/Da;

    invoke-virtual {v1, v0}, La/Da;->b(Z)La/Ta;
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, La/H0;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, La/H0;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, La/H0;->onLayout(ZIIII)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, La/H0;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, v1}, La/Da;->b(Z)La/Ta;
    ...
    invoke-virtual {v0, p1}, La/Ta;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, La/Da;->o:Z

    iget-object v0, v1, La/Da;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, La/Da;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, La/Da;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-super {p0, p1}, La/H0;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setCornerRadius(I)V
    ...
    iget-boolean v1, v0, La/Da;->p:Z

    if-eqz v1, :cond_0

    iget v1, v0, La/Da;->g:I

    if-eq v1, p1, :cond_1

    :cond_0
    iput p1, v0, La/Da;->g:I

    const/4 v1, 0x1

    iput-boolean v1, v0, La/Da;->p:Z

    iget-object v1, v0, La/Da;->b:La/Vd;

    int-to-float p1, p1

    invoke-virtual {v1}, La/Vd;->e()La/Vd$a;
    ...
    iput-object v2, v1, La/Vd$a;->e:La/w4;

    new-instance v2, La/s;

    invoke-direct {v2, p1}, La/s;-><init>(F)V

    iput-object v2, v1, La/Vd$a;->f:La/w4;

    new-instance v2, La/s;

    invoke-direct {v2, p1}, La/s;-><init>(F)V

    iput-object v2, v1, La/Vd$a;->g:La/w4;

    new-instance v2, La/s;

    invoke-direct {v2, p1}, La/s;-><init>(F)V

    iput-object v2, v1, La/Vd$a;->h:La/w4;

    invoke-virtual {v1}, La/Vd$a;->a()La/Vd;

    move-result-object p1

    invoke-virtual {v0, p1}, La/Da;->c(La/Vd;)V
...
.method public setIconTintResource(I)V
    ...
    invoke-static {v0, p1}, La/Y3;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public setInsetBottom(I)V
    ...
    iget v1, v0, La/Da;->e:I

    invoke-virtual {v0, v1, p1}, La/Da;->d(II)V
...
.method public setInsetTop(I)V
    ...
    iget v1, v0, La/Da;->f:I

    invoke-virtual {v0, p1, v1}, La/Da;->d(II)V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, La/Da;->l:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, La/Da;->l:Landroid/content/res/ColorStateList;

    iget-object v0, v0, La/Da;->a:Lcom/google/android/material/button/MaterialButton;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, v0, La/Da;->n:Z

    invoke-virtual {v0}, La/Da;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, La/Da;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, La/Da;->k:Landroid/content/res/ColorStateList;
...
.method public setStrokeWidth(I)V
    ...
    iget v1, v0, La/Da;->h:I

    if-eq v1, p1, :cond_0

    iput p1, v0, La/Da;->h:I
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, La/Da;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, La/Da;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, La/Da;->b(Z)La/Ta;
    ...
    :cond_1
    invoke-super {p0, p1}, La/H0;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, La/Da;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, La/Da;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v0}, La/w5$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    return-void

    :cond_1
    invoke-super {p0, p1}, La/H0;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
