...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, v6, v7}, La/Sa;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 37
    invoke-static {p1, p2, v7, v8}, La/Vd;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)La/Vd$a;

    move-result-object p2

    .line 38
    invoke-virtual {p2}, La/Vd$a;->a()La/Vd;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->y:La/Vd;

    .line 39
    :cond_1
    iget-object p2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->y:La/Vd;
    ...
    .line 40
    :cond_2
    new-instance v7, La/Ta;

    invoke-direct {v7, p2}, La/Ta;-><init>(La/Vd;)V

    iput-object v7, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:La/Ta;

    .line 41
    invoke-virtual {v7, p1}, La/Ta;->i(Landroid/content/Context;)V
    ...
    .line 43
    iget-object v7, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:La/Ta;

    invoke-virtual {v7, p2}, La/Ta;->k(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v7, p2}, La/Ta;->setTint(I)V
    ...
    new-instance v8, La/u2;

    invoke-direct {v8, p0}, La/u2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;)V
...
.method public static w(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p0}, La/ug$d;->p(Landroid/view/View;)Z
...
.method public final C(I)V
    ...
    invoke-static {v2, p1, v0}, La/z;->h(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final F(Landroid/view/View;IZ)V
    ...
    iget-object v1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
    ...
    invoke-virtual {v1, p1, v0}, La/zg;->o(II)Z
    ...
    iput-object p1, v1, La/zg;->r:Landroid/view/View;

    const/4 p1, -0x1

    iput p1, v1, La/zg;->c:I

    const/4 p1, 0x0

    invoke-virtual {v1, p3, v0, p1, p1}, La/zg;->h(IIII)Z

    move-result p1

    if-nez p1, :cond_1

    iget p3, v1, La/zg;->a:I

    if-nez p3, :cond_1

    iget-object p3, v1, La/zg;->r:Landroid/view/View;

    if-eqz p3, :cond_1

    const/4 p3, 0x0

    iput-object p3, v1, La/zg;->r:Landroid/view/View;
...
.method public final G()V
    ...
    invoke-static {v0, v1}, La/ug;->g(Landroid/view/View;I)V

    const/4 v1, 0x0

    invoke-static {v0, v1}, La/ug;->e(Landroid/view/View;I)V

    const/high16 v2, 0x40000

    invoke-static {v0, v2}, La/ug;->g(Landroid/view/View;I)V
    ...
    invoke-static {v0, v4}, La/ug;->g(Landroid/view/View;I)V
    ...
    new-instance v11, La/w2;

    invoke-direct {v11, p0, v5}, La/w2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0}, La/ug;->c(Landroid/view/View;)Ljava/util/ArrayList;
    ...
    check-cast v7, La/I$a;

    iget-object v7, v7, La/I$a;->a:Ljava/lang/Object;
    ...
    check-cast v4, La/I$a;

    invoke-virtual {v4}, La/I$a;->a()I
    ...
    check-cast v14, La/I$a;

    invoke-virtual {v14}, La/I$a;->a()I
    ...
    new-instance v7, La/I$a;

    const/4 v8, 0x0

    const/4 v12, 0x0

    invoke-direct/range {v7 .. v12}, La/I$a;-><init>(Ljava/lang/Object;ILjava/lang/String;La/K;Ljava/lang/Class;)V

    invoke-static {v0}, La/ug;->b(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    :cond_8
    instance-of v4, v3, La/C$a;

    if-eqz v4, :cond_9

    check-cast v3, La/C$a;

    iget-object v3, v3, La/C$a;->a:La/C;
    ...
    invoke-direct {v4, v3}, La/C;-><init>(Landroid/view/View$AccessibilityDelegate;)V
    ...
    :cond_a
    invoke-static {v0, v3}, La/ug;->j(Landroid/view/View;La/C;)V

    invoke-virtual {v7}, La/I$a;->a()I

    move-result v3

    invoke-static {v0, v3}, La/ug;->g(Landroid/view/View;I)V
    ...
    sget-object v1, La/I$a;->j:La/I$a;

    new-instance v3, La/w2;

    invoke-direct {v3, p0, v2}, La/w2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v3}, La/ug;->h(Landroid/view/View;La/I$a;La/K;)V
    ...
    :cond_e
    sget-object v1, La/I$a;->i:La/I$a;

    new-instance v4, La/w2;

    invoke-direct {v4, p0, v2}, La/w2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v4}, La/ug;->h(Landroid/view/View;La/I$a;La/K;)V

    sget-object v1, La/I$a;->h:La/I$a;

    new-instance v2, La/w2;

    invoke-direct {v2, p0, v3}, La/w2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V

    invoke-static {v0, v1, v2}, La/ug;->h(Landroid/view/View;La/I$a;La/K;)V
    ...
    invoke-direct {v2, p0, v5}, La/w2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;I)V
...
.method public final H(IZ)V
    ...
    iget-object v2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:La/Ta;
    ...
    :cond_4
    iget-object p2, v2, La/Ta;->a:La/Ta$b;

    iget p2, p2, La/Ta$b;->i:F
    ...
    :cond_8
    iget-object p1, v2, La/Ta;->a:La/Ta$b;

    iget p2, p1, La/Ta$b;->i:F

    cmpl-float p2, p2, v5

    if-eqz p2, :cond_9

    iput v5, p1, La/Ta$b;->i:F

    iput-boolean v1, v2, La/Ta;->e:Z
...
.method public final c(Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
...
.method public final f()V
    ...
    iput-object v0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
...
.method public final g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;

    if-eqz p2, :cond_9

    invoke-virtual {p2, p3}, La/zg;->p(Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:La/Ta;
    ...
    :cond_2
    new-instance v7, La/v2;

    invoke-direct {v7, p0, v6}, La/v2;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;Z)V

    new-instance v6, La/Rg$a;
    ...
    iput v8, v6, La/Rg$a;->a:I

    iput v9, v6, La/Rg$a;->b:I

    iput v10, v6, La/Rg$a;->c:I

    new-instance v8, La/Ng;

    invoke-direct {v8, v7, v6}, La/Ng;-><init>(La/v2;La/Rg$a;)V

    invoke-static {p2, v8}, La/ug$d;->u(Landroid/view/View;La/Tb;)V
    ...
    invoke-static {p2}, La/ug$c;->c(Landroid/view/View;)V

    goto :goto_1

    :cond_3
    new-instance v6, La/Og;
    ...
    :goto_1
    new-instance v6, La/b9;

    invoke-direct {v6, p2}, La/b9;-><init>(Landroid/view/View;)V

    const/16 v7, 0x1e

    if-lt v3, v7, :cond_4

    new-instance v3, La/mh$d$a;

    invoke-direct {v3, v6}, La/mh$d$a;-><init>(La/b9;)V

    invoke-static {p2, v3}, La/F;->o(Landroid/view/View;La/mh$d$a;)V

    goto :goto_2

    :cond_4
    sget-object v3, La/mh$c;->e:Landroid/view/animation/PathInterpolator;
    ...
    new-instance v7, La/mh$c$a;

    invoke-direct {v7, p2, v6}, La/mh$c$a;-><init>(Landroid/view/View;La/b9;)V

    sget v6, Landroidx/core/R$id;->tag_window_insets_animation_callback:I
    ...
    sget v6, Lcom/google/android/material/R$attr;->motionEasingStandardDecelerateInterpolator:I

    const/4 v7, 0x0

    invoke-static {v7, v7, v7, v4}, La/rc;->b(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v7

    invoke-static {v3, v6, v7}, La/wb;->d(Landroid/content/Context;ILandroid/view/animation/Interpolator;)Landroid/animation/TimeInterpolator;

    sget v6, Lcom/google/android/material/R$attr;->motionDurationMedium2:I

    const/16 v7, 0x12c

    invoke-static {v3, v6, v7}, La/wb;->c(Landroid/content/Context;II)I
    ...
    sget v6, Lcom/google/android/material/R$dimen;->m3_back_progress_bottom_container_max_scale_x_distance:I

    invoke-virtual {v3, v6}, Landroid/content/res/Resources;->getDimension(I)F

    sget v6, Lcom/google/android/material/R$dimen;->m3_back_progress_bottom_container_max_scale_y_distance:I
    ...
    invoke-static {p2}, La/ug$d;->i(Landroid/view/View;)F

    move-result v3

    :cond_6
    invoke-virtual {v1, v3}, La/Ta;->j(F)V
    ...
    invoke-static {p2, v1}, La/ug$d;->q(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-direct {v1, v3, p1, v6}, La/zg;-><init>(Landroid/content/Context;Landroidx/coordinatorlayout/widget/CoordinatorLayout;La/zg$c;)V

    iput-object v1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
...
.method public final k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    sget-object p3, La/ug;->a:Ljava/util/WeakHashMap;
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    :cond_1
    iget v4, p2, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;->d:I
    ...
    :cond_3
    iget-boolean v4, p2, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;->e:Z
    ...
    :cond_5
    iget-boolean v4, p2, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;->f:Z
    ...
    :cond_7
    iget-boolean p1, p2, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;->g:Z

    iput-boolean p1, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->J:Z

    :cond_8
    :goto_0
    iget p1, p2, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;->c:I
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-direct {p1, p0}, Lcom/google/android/material/bottomsheet/BottomSheetBehavior$d;-><init>(Lcom/google/android/material/bottomsheet/BottomSheetBehavior;)V
...
.method public final r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v2, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
    ...
    :cond_2
    invoke-virtual {v2, p3}, La/zg;->j(Landroid/view/MotionEvent;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->M:La/zg;
    ...
    invoke-virtual {v0, p2, p1}, La/zg;->b(Landroid/view/View;I)V
...
.method public final t()F
    ...
    iget-object v0, p0, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->i:La/Ta;
    ...
    iget-object v3, v3, La/Ta$b;->a:La/Vd;

    iget-object v3, v3, La/Vd;->e:La/w4;

    invoke-virtual {v2}, La/Ta;->g()Landroid/graphics/RectF;

    move-result-object v2

    invoke-interface {v3, v2}, La/w4;->a(Landroid/graphics/RectF;)F

    move-result v2

    invoke-static {v0}, La/t2;->h(Landroid/view/WindowInsets;)Landroid/view/RoundedCorner;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-static {v3}, La/t2;->c(Landroid/view/RoundedCorner;)I
    ...
    iget-object v4, v2, La/Ta;->a:La/Ta$b;

    iget-object v4, v4, La/Ta$b;->a:La/Vd;

    iget-object v4, v4, La/Vd;->f:La/w4;

    invoke-virtual {v2}, La/Ta;->g()Landroid/graphics/RectF;

    move-result-object v2

    invoke-interface {v4, v2}, La/w4;->a(Landroid/graphics/RectF;)F

    move-result v2

    invoke-static {v0}, La/t2;->m(Landroid/view/WindowInsets;)Landroid/view/RoundedCorner;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-static {v0}, La/t2;->c(Landroid/view/RoundedCorner;)I
