...
.method public static c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$A;
    .locals 5
    ...
    iget v4, v3, Landroidx/recyclerview/widget/RecyclerView$A;->c:I

    if-ne v4, p1, :cond_0

    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/recyclerview/widget/RecyclerView$r;->k(JI)Landroidx/recyclerview/widget/RecyclerView$A;
    ...
    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView$r;->h(Landroid/view/View;)V
    ...
    :cond_2
    invoke-virtual {v0, p1, v1}, Landroidx/recyclerview/widget/RecyclerView$r;->a(Landroidx/recyclerview/widget/RecyclerView$A;Z)V
    :try_end_0
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_2
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
...
.method public final b(J)V
    ...
    iget-object v8, v7, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
    ...
    :cond_2
    iget-object v9, v8, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
    ...
    invoke-static {v6, v9, v7, v8}, Landroidx/recyclerview/widget/m;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$A;

    move-result-object v6

    if-eqz v6, :cond_9

    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView$A;->b:Ljava/lang/ref/WeakReference;

    if-eqz v7, :cond_9

    invoke-virtual {v6}, Landroidx/recyclerview/widget/RecyclerView$A;->e()Z

    move-result v7

    if-eqz v7, :cond_9

    invoke-virtual {v6}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z

    move-result v7

    if-nez v7, :cond_9

    iget-object v6, v6, Landroidx/recyclerview/widget/RecyclerView$A;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$i;

    if-eqz v7, :cond_b

    invoke-virtual {v7}, Landroidx/recyclerview/widget/RecyclerView$i;->e()V

    :cond_b
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->m:Landroidx/recyclerview/widget/RecyclerView$l;

    iget-object v8, v6, Landroidx/recyclerview/widget/RecyclerView;->c:Landroidx/recyclerview/widget/RecyclerView$r;

    if-eqz v7, :cond_c

    invoke-virtual {v7, v8}, Landroidx/recyclerview/widget/RecyclerView$l;->i0(Landroidx/recyclerview/widget/RecyclerView$r;)V

    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->m:Landroidx/recyclerview/widget/RecyclerView$l;

    invoke-virtual {v7, v8}, Landroidx/recyclerview/widget/RecyclerView$l;->j0(Landroidx/recyclerview/widget/RecyclerView$r;)V

    :cond_c
    iget-object v7, v8, Landroidx/recyclerview/widget/RecyclerView$r;->a:Ljava/util/ArrayList;

    invoke-virtual {v7}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {v8}, Landroidx/recyclerview/widget/RecyclerView$r;->f()V

    :cond_d
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
    ...
    iget-object v8, v6, Landroidx/recyclerview/widget/RecyclerView;->f0:Landroidx/recyclerview/widget/RecyclerView$w;

    iget-object v9, v6, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;

    iput v0, v8, Landroidx/recyclerview/widget/RecyclerView$w;->d:I
    ...
    iput-boolean v4, v8, Landroidx/recyclerview/widget/RecyclerView$w;->g:Z

    iput-boolean v4, v8, Landroidx/recyclerview/widget/RecyclerView$w;->h:Z

    iput-boolean v4, v8, Landroidx/recyclerview/widget/RecyclerView$w;->i:Z
    ...
    invoke-static {v6, v9, v10, v11}, Landroidx/recyclerview/widget/m;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$A;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
