...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->F0:Landroidx/recyclerview/widget/RecyclerView$b;
...
.method public final a(II)V
    ...
    iput v1, p0, Landroidx/recyclerview/widget/RecyclerView$z;->b:I

    iput v1, p0, Landroidx/recyclerview/widget/RecyclerView$z;->a:I

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$z;->d:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->F0:Landroidx/recyclerview/widget/RecyclerView$b;

    if-eq v1, v2, :cond_0

    iput-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$z;->d:Landroid/view/animation/Interpolator;
...
.method public final c(IIILandroid/view/animation/BaseInterpolator;)V
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->F0:Landroidx/recyclerview/widget/RecyclerView$b;
...
.method public final run()V
    ...
    iput-boolean v8, p0, Landroidx/recyclerview/widget/RecyclerView$z;->f:Z

    const/4 v9, 0x1

    iput-boolean v9, p0, Landroidx/recyclerview/widget/RecyclerView$z;->e:Z

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->p()V

    iget-object v10, p0, Landroidx/recyclerview/widget/RecyclerView$z;->c:Landroid/widget/OverScroller;
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView;->I:Landroid/widget/EdgeEffect;
    ...
    invoke-virtual {v0, v1, v2, v11}, Landroidx/recyclerview/widget/RecyclerView;->d0(II[I)V
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->m:Landroidx/recyclerview/widget/RecyclerView$l;

    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView$l;->e:Landroidx/recyclerview/widget/o;

    if-eqz v5, :cond_5

    iget-boolean v6, v5, Landroidx/recyclerview/widget/RecyclerView$v;->d:Z

    if-nez v6, :cond_5

    iget-boolean v6, v5, Landroidx/recyclerview/widget/RecyclerView$v;->e:Z

    if-eqz v6, :cond_5

    iget-object v6, v0, Landroidx/recyclerview/widget/RecyclerView;->f0:Landroidx/recyclerview/widget/RecyclerView$w;

    invoke-virtual {v6}, Landroidx/recyclerview/widget/RecyclerView$w;->b()I

    move-result v6

    if-nez v6, :cond_3

    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$v;->d()V

    goto :goto_0

    :cond_3
    iget v7, v5, Landroidx/recyclerview/widget/RecyclerView$v;->a:I

    if-lt v7, v6, :cond_4

    sub-int/2addr v6, v9

    iput v6, v5, Landroidx/recyclerview/widget/RecyclerView$v;->a:I

    invoke-virtual {v5, v3, v4}, Landroidx/recyclerview/widget/RecyclerView$v;->b(II)V
    ...
    iget-object v6, v6, Landroidx/recyclerview/widget/RecyclerView$l;->e:Landroidx/recyclerview/widget/o;

    if-eqz v6, :cond_10

    iget-boolean v6, v6, Landroidx/recyclerview/widget/RecyclerView$v;->d:Z
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->d0:Landroidx/recyclerview/widget/m;
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView$l;->e:Landroidx/recyclerview/widget/o;

    if-eqz v1, :cond_1e

    iget-boolean v2, v1, Landroidx/recyclerview/widget/RecyclerView$v;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v8, v8}, Landroidx/recyclerview/widget/RecyclerView$v;->b(II)V

    :cond_1e
    iput-boolean v8, p0, Landroidx/recyclerview/widget/RecyclerView$z;->e:Z
