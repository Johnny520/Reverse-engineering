...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$A;Z)V
    ...
    invoke-static {p1}, Landroidx/recyclerview/widget/RecyclerView;->l(Landroidx/recyclerview/widget/RecyclerView$A;)V

    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$r;->h:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->m0:Landroidx/recyclerview/widget/x;
    ...
    :goto_0
    invoke-static {v3, v1}, La/ug;->j(Landroid/view/View;La/C;)V

    :cond_1
    if-eqz p2, :cond_5

    iget-object p2, v0, Landroidx/recyclerview/widget/RecyclerView;->n:Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    iget-object p2, v0, Landroidx/recyclerview/widget/RecyclerView;->g:Landroidx/recyclerview/widget/C;

    invoke-virtual {p2, p1}, Landroidx/recyclerview/widget/C;->d(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    :cond_5
    iput-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$A;->s:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    :cond_8
    :goto_2
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$A;->m()V
...
.method public final b(I)I
    ...
    iget-object p1, v0, Landroidx/recyclerview/widget/RecyclerView;->f0:Landroidx/recyclerview/widget/RecyclerView$w;
...
.method public final f()V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
...
.method public final g(I)V
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/recyclerview/widget/RecyclerView$r;->a(Landroidx/recyclerview/widget/RecyclerView$A;Z)V
...
.method public final h(Landroid/view/View;)V
    ...
    iget-object p1, v0, Landroidx/recyclerview/widget/RecyclerView$A;->n:Landroidx/recyclerview/widget/RecyclerView$r;

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$r;->l(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$r;->i(Landroidx/recyclerview/widget/RecyclerView$A;)V

    iget-object p1, v2, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$i;

    if-eqz p1, :cond_3

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$A;->g()Z
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$i;->d(Landroidx/recyclerview/widget/RecyclerView$A;)V

    :cond_3
    return-void
.end method

.method public final i(Landroidx/recyclerview/widget/RecyclerView$A;)V
    .locals 12
    ...
    :goto_0
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    invoke-static {v3, v1}, La/z;->d(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$A;->g()Z
    ...
    iget v5, p1, Landroidx/recyclerview/widget/RecyclerView$A;->j:I
    ...
    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;

    iget v8, p1, Landroidx/recyclerview/widget/RecyclerView$A;->c:I
    ...
    iget v7, v7, Landroidx/recyclerview/widget/RecyclerView$A;->c:I

    iget-object v8, v3, Landroidx/recyclerview/widget/RecyclerView;->e0:Landroidx/recyclerview/widget/m$b;
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/recyclerview/widget/RecyclerView$r;->a(Landroidx/recyclerview/widget/RecyclerView$A;Z)V
    ...
    :goto_9
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->g:Landroidx/recyclerview/widget/C;

    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/C;->d(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    invoke-static {v4}, La/zc;->a(Landroid/view/View;)V

    const/4 v0, 0x0

    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$A;->s:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    invoke-static {v3, v0}, La/z;->d(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final j(Landroid/view/View;)V
    ...
    iget-object v0, v3, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$i;

    if-eqz v0, :cond_3

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$A;->c()Ljava/util/List;
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z
    ...
    :cond_2
    iput-object p0, p1, Landroidx/recyclerview/widget/RecyclerView$A;->n:Landroidx/recyclerview/widget/RecyclerView$r;

    iput-boolean v2, p1, Landroidx/recyclerview/widget/RecyclerView$A;->o:Z
    ...
    iget-object v0, v3, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    iput-boolean v1, p1, Landroidx/recyclerview/widget/RecyclerView$A;->o:Z
...
.method public final k(JI)Landroidx/recyclerview/widget/RecyclerView$A;
    .locals 27
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->f0:Landroidx/recyclerview/widget/RecyclerView$w;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$w;->b()I
    ...
    iget-boolean v6, v5, Landroidx/recyclerview/widget/RecyclerView$w;->g:Z
    ...
    iget-object v6, v1, Landroidx/recyclerview/widget/RecyclerView$r;->b:Ljava/util/ArrayList;
    ...
    iget-object v11, v1, Landroidx/recyclerview/widget/RecyclerView$r;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->p()Z
    ...
    :cond_2
    iget-object v10, v4, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;

    iget-boolean v10, v10, Landroidx/recyclerview/widget/RecyclerView$d;->b:Z

    if-eqz v10, :cond_4

    iget-object v10, v4, Landroidx/recyclerview/widget/RecyclerView;->e:Landroidx/recyclerview/widget/a;

    invoke-virtual {v10, v0, v8}, Landroidx/recyclerview/widget/a;->e(II)I

    move-result v10

    if-lez v10, :cond_4

    iget-object v11, v4, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    invoke-virtual {v11, v10}, Landroidx/recyclerview/widget/RecyclerView$d;->b(I)J
    ...
    iget-object v13, v1, Landroidx/recyclerview/widget/RecyclerView$r;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v13}, Landroidx/recyclerview/widget/RecyclerView$A;->p()Z
    ...
    :goto_4
    iget-object v10, v1, Landroidx/recyclerview/widget/RecyclerView$r;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v15}, Landroidx/recyclerview/widget/RecyclerView$A;->p()Z
    ...
    invoke-virtual {v15}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z

    move-result v3

    if-nez v3, :cond_9

    iget-boolean v3, v5, Landroidx/recyclerview/widget/RecyclerView$w;->g:Z
    ...
    :cond_7
    invoke-virtual {v15, v9}, Landroidx/recyclerview/widget/RecyclerView$A;->a(I)V
    ...
    invoke-static {v15}, Landroidx/recyclerview/widget/RecyclerView;->L(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$A;

    move-result-object v17

    invoke-virtual/range {v17 .. v17}, Landroidx/recyclerview/widget/RecyclerView$A;->b()I

    move-result v7

    if-ne v7, v0, :cond_b

    invoke-virtual/range {v17 .. v17}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z

    move-result v7

    if-nez v7, :cond_b

    invoke-virtual/range {v17 .. v17}, Landroidx/recyclerview/widget/RecyclerView$A;->h()Z
    ...
    iget-object v11, v7, Landroidx/recyclerview/widget/b;->a:Landroidx/recyclerview/widget/v;
    ...
    invoke-virtual {v3, v7}, Landroidx/recyclerview/widget/RecyclerView$A;->a(I)V
    ...
    invoke-static {v4, v2}, La/z;->d(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->f()Z
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->d()Z
    ...
    :cond_18
    iget v3, v11, Landroidx/recyclerview/widget/RecyclerView$A;->c:I
    ...
    iget-object v3, v4, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;

    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$A;->c:I

    invoke-virtual {v3, v7}, Landroidx/recyclerview/widget/RecyclerView$d;->c(I)I
    ...
    iget-boolean v7, v3, Landroidx/recyclerview/widget/RecyclerView$d;->b:Z

    if-eqz v7, :cond_1b

    iget-wide v14, v11, Landroidx/recyclerview/widget/RecyclerView$A;->e:J

    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$A;->c:I

    invoke-virtual {v3, v7}, Landroidx/recyclerview/widget/RecyclerView$d;->b(I)J
    ...
    invoke-virtual {v11, v3}, Landroidx/recyclerview/widget/RecyclerView$A;->a(I)V

    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->i()Z
    ...
    iget-object v3, v11, Landroidx/recyclerview/widget/RecyclerView$A;->n:Landroidx/recyclerview/widget/RecyclerView$r;

    invoke-virtual {v3, v11}, Landroidx/recyclerview/widget/RecyclerView$r;->l(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    iget v3, v11, Landroidx/recyclerview/widget/RecyclerView$A;->j:I

    and-int/lit8 v3, v3, -0x21

    iput v3, v11, Landroidx/recyclerview/widget/RecyclerView$A;->j:I

    :cond_1d
    :goto_e
    invoke-virtual {v1, v11}, Landroidx/recyclerview/widget/RecyclerView$r;->i(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    invoke-virtual {v3, v0, v8}, Landroidx/recyclerview/widget/a;->e(II)I
    ...
    invoke-virtual {v7, v3}, Landroidx/recyclerview/widget/RecyclerView$d;->c(I)I

    move-result v7

    move/from16 v17, v2

    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;

    const-wide/16 v25, 0x3

    iget-boolean v14, v2, Landroidx/recyclerview/widget/RecyclerView$d;->b:Z

    if-eqz v14, :cond_29

    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView$d;->b(I)J
    ...
    iget-wide v8, v11, Landroidx/recyclerview/widget/RecyclerView$A;->e:J
    ...
    iget v8, v11, Landroidx/recyclerview/widget/RecyclerView$A;->f:I

    if-ne v7, v8, :cond_22

    const/16 v8, 0x20

    invoke-virtual {v11, v8}, Landroidx/recyclerview/widget/RecyclerView$A;->a(I)V
    ...
    iget-boolean v2, v5, Landroidx/recyclerview/widget/RecyclerView$w;->g:Z
    ...
    iget-object v9, v11, Landroidx/recyclerview/widget/RecyclerView$A;->a:Landroid/view/View;

    const/4 v11, 0x0

    invoke-virtual {v4, v9, v11}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-static {v9}, Landroidx/recyclerview/widget/RecyclerView;->L(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$A;

    move-result-object v9

    const/4 v8, 0x0

    iput-object v8, v9, Landroidx/recyclerview/widget/RecyclerView$A;->n:Landroidx/recyclerview/widget/RecyclerView$r;

    iput-boolean v11, v9, Landroidx/recyclerview/widget/RecyclerView$A;->o:Z

    iget v8, v9, Landroidx/recyclerview/widget/RecyclerView$A;->j:I

    and-int/lit8 v8, v8, -0x21

    iput v8, v9, Landroidx/recyclerview/widget/RecyclerView$A;->j:I

    invoke-virtual {v1, v9}, Landroidx/recyclerview/widget/RecyclerView$r;->i(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    invoke-virtual {v8}, Landroidx/recyclerview/widget/RecyclerView$A;->d()Z
    ...
    iput v3, v11, Landroidx/recyclerview/widget/RecyclerView$A;->c:I
    ...
    :cond_2a
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$r;->c()Landroidx/recyclerview/widget/RecyclerView$q;
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$A;->m()V
    ...
    iget-object v8, v1, Landroidx/recyclerview/widget/RecyclerView$r;->g:Landroidx/recyclerview/widget/RecyclerView$q;

    invoke-virtual {v8, v7}, Landroidx/recyclerview/widget/RecyclerView$q;->a(I)Landroidx/recyclerview/widget/RecyclerView$q$a;

    move-result-object v8

    iget-wide v8, v8, Landroidx/recyclerview/widget/RecyclerView$q$a;->c:J
    ...
    :cond_31
    iget-object v8, v4, Landroidx/recyclerview/widget/RecyclerView;->l:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    invoke-virtual {v8, v4, v7}, Landroidx/recyclerview/widget/RecyclerView$d;->e(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$A;
    ...
    iput v7, v11, Landroidx/recyclerview/widget/RecyclerView$A;->f:I
    :try_end_1
    ...
    invoke-virtual {v10, v7}, Landroidx/recyclerview/widget/RecyclerView$q;->a(I)Landroidx/recyclerview/widget/RecyclerView$q$a;

    move-result-object v2

    iget-wide v14, v2, Landroidx/recyclerview/widget/RecyclerView$q$a;->c:J
    ...
    :goto_17
    iput-wide v8, v2, Landroidx/recyclerview/widget/RecyclerView$q$a;->c:J
    ...
    iget-boolean v2, v5, Landroidx/recyclerview/widget/RecyclerView$w;->j:Z

    if-eqz v2, :cond_39

    invoke-static {v11}, Landroidx/recyclerview/widget/RecyclerView$i;->b(Landroidx/recyclerview/widget/RecyclerView$A;)V

    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$i;

    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->c()Ljava/util/List;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Landroidx/recyclerview/widget/RecyclerView$i$b;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v2, v11}, Landroidx/recyclerview/widget/RecyclerView$i$b;->a(Landroidx/recyclerview/widget/RecyclerView$A;)V

    invoke-virtual {v4, v11, v2}, Landroidx/recyclerview/widget/RecyclerView;->X(Landroidx/recyclerview/widget/RecyclerView$A;Landroidx/recyclerview/widget/RecyclerView$i$b;)V
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$A;->e()Z
    ...
    invoke-virtual {v2, v0, v7}, Landroidx/recyclerview/widget/a;->e(II)I

    move-result v2

    const/4 v8, 0x0

    iput-object v8, v11, Landroidx/recyclerview/widget/RecyclerView$A;->s:Landroidx/recyclerview/widget/RecyclerView$d;

    iput-object v4, v11, Landroidx/recyclerview/widget/RecyclerView$A;->r:Landroidx/recyclerview/widget/RecyclerView;

    iget v9, v11, Landroidx/recyclerview/widget/RecyclerView$A;->f:I
    ...
    iget-object v14, v11, Landroidx/recyclerview/widget/RecyclerView$A;->s:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    iget-boolean v15, v10, Landroidx/recyclerview/widget/RecyclerView$d;->b:Z

    if-eqz v15, :cond_44

    invoke-virtual {v10, v2}, Landroidx/recyclerview/widget/RecyclerView$d;->b(I)J

    move-result-wide v7

    iput-wide v7, v11, Landroidx/recyclerview/widget/RecyclerView$A;->e:J
    ...
    :cond_45
    iput-object v10, v11, Landroidx/recyclerview/widget/RecyclerView$A;->s:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    sget-object v7, La/ug;->a:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v10, v11, v2}, Landroidx/recyclerview/widget/RecyclerView$d;->d(Landroidx/recyclerview/widget/RecyclerView$A;I)V
    ...
    instance-of v7, v2, Landroidx/recyclerview/widget/RecyclerView$m;
    ...
    iput-boolean v7, v2, Landroidx/recyclerview/widget/RecyclerView$m;->c:Z
    ...
    invoke-virtual {v2, v9}, Landroidx/recyclerview/widget/RecyclerView$q;->a(I)Landroidx/recyclerview/widget/RecyclerView$q$a;

    move-result-object v2

    iget-wide v9, v2, Landroidx/recyclerview/widget/RecyclerView$q$a;->d:J
    ...
    :goto_24
    iput-wide v7, v2, Landroidx/recyclerview/widget/RecyclerView$q$a;->d:J

    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->A:Landroid/view/accessibility/AccessibilityManager;
    ...
    :cond_50
    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->m0:Landroidx/recyclerview/widget/x;
    ...
    :cond_51
    iget-object v2, v2, Landroidx/recyclerview/widget/x;->e:Landroidx/recyclerview/widget/x$a;

    if-eqz v2, :cond_54

    invoke-static {v3}, La/ug;->b(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    :cond_52
    instance-of v9, v8, La/C$a;

    if-eqz v9, :cond_53

    check-cast v8, La/C$a;

    iget-object v8, v8, La/C$a;->a:La/C;
    ...
    invoke-direct {v9, v8}, La/C;-><init>(Landroid/view/View$AccessibilityDelegate;)V
    ...
    iget-object v9, v2, Landroidx/recyclerview/widget/x$a;->e:Ljava/util/WeakHashMap;

    invoke-virtual {v9, v3, v8}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_54
    invoke-static {v3, v2}, La/ug;->j(Landroid/view/View;La/C;)V
    ...
    :goto_29
    iput-object v11, v2, Landroidx/recyclerview/widget/RecyclerView$m;->a:Landroidx/recyclerview/widget/RecyclerView$A;
    ...
    iget-object v0, v4, Landroidx/recyclerview/widget/RecyclerView;->f0:Landroidx/recyclerview/widget/RecyclerView$w;
...
.method public final l(Landroidx/recyclerview/widget/RecyclerView$A;)V
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$A;->n:Landroidx/recyclerview/widget/RecyclerView$r;
