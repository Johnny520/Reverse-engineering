...
.field public static final x:La/Dc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, La/Dc;-><init>()V

    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x:La/Dc;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v6}, La/A2;-><init>(I)V

    iput-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:La/A2;
    ...
    iput-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->s:La/Mb;
    ...
    sget v4, Landroidx/coordinatorlayout/R$style;->Widget_Support_CoordinatorLayout:I
    ...
    invoke-static/range {v0 .. v5}, La/E;->o(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;I)V
    ...
    invoke-static/range {v0 .. v5}, La/E;->v(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;I)V

    :cond_2
    :goto_2
    sget v1, Landroidx/coordinatorlayout/R$styleable;->CoordinatorLayout_keylines:I
    ...
    :cond_3
    sget v1, Landroidx/coordinatorlayout/R$styleable;->CoordinatorLayout_statusBarBackground:I
...
.method public static a()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x:La/Dc;

    invoke-virtual {v0}, La/Dc;->a()Ljava/lang/Object;
...
.method public final c(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->s:La/Mb;

    if-ne p4, p1, :cond_0

    iput p3, v0, La/Mb;->b:I

    goto :goto_0

    :cond_0
    iput p3, v0, La/Mb;->a:I
...
.method public final e(Landroid/view/View;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:La/A2;
    ...
    invoke-virtual {v0, v3}, La/ge;->j(I)Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {v0, v3}, La/ge;->h(I)Ljava/lang/Object;
...
.method public final f(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    sget-object v0, La/Bg;->a:Ljava/lang/ThreadLocal;
    ...
    :goto_0
    invoke-static {p0, p1, v1}, La/Bg;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Matrix;)V

    sget-object p1, La/Bg;->b:Ljava/lang/ThreadLocal;
...
.method public final getLastWindowInsets()La/nh;
    .locals 1

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:La/nh;
...
.method public final i(Landroid/view/View;I)V
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->s:La/Mb;

    if-ne p2, v1, :cond_0

    iput v0, v2, La/Mb;->b:I

    goto :goto_0

    :cond_0
    iput v0, v2, La/Mb;->a:I
...
.method public final l(Landroid/view/View;II)Z
    ...
    invoke-virtual {v0, v1}, La/Dc;->c(Ljava/lang/Object;)Z
...
.method public final onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->i(Landroid/view/View;I)V
...
.method public final onMeasure(II)V
    ...
    iget-object v4, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:La/A2;

    iget-object v4, v4, La/A2;->b:Ljava/lang/Object;

    check-cast v4, La/ge;

    iget v5, v4, La/ge;->c:I
    ...
    invoke-virtual {v4, v8}, La/ge;->j(I)Ljava/lang/Object;
    ...
    iget-object v3, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:La/nh;
    ...
    invoke-virtual {v0, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h(I)I
    ...
    iget-object v2, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:La/nh;
...
.method public final p(I)V
    ...
    :goto_0
    sget-object v13, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x:La/Dc;
    ...
    invoke-virtual {v0, v4, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f(Landroid/view/View;Landroid/graphics/Rect;)V

    const/4 v4, 0x0

    invoke-virtual {v0, v2, v11, v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->d(Landroid/view/View;Landroid/graphics/Rect;Z)V
    ...
    sget-object v14, La/ug;->a:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v4, v9}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v7}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v4, v7}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v10}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v4, v10}, La/Dc;->c(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v2, v6, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->d(Landroid/view/View;Landroid/graphics/Rect;Z)V
    ...
    invoke-static {v2, v13}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v(Landroid/view/View;I)V
    ...
    invoke-static {v2, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v(Landroid/view/View;I)V
    ...
    invoke-virtual {v4, v15}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v6}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v4, v6}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v5}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v4, v5}, La/Dc;->c(Ljava/lang/Object;)Z
...
.method public final q(Landroid/view/View;I)V
    ...
    :cond_1
    :goto_0
    sget-object v2, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x:La/Dc;
    ...
    :try_start_0
    invoke-virtual {p0, v1, v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v4}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v5}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v2, v5}, La/Dc;->c(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-virtual {p0, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h(I)I
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:La/nh;
    ...
    invoke-virtual {v2, v9}, La/Dc;->c(Ljava/lang/Object;)Z

    invoke-virtual {v10}, Landroid/graphics/Rect;->setEmpty()V

    invoke-virtual {v2, v10}, La/Dc;->c(Ljava/lang/Object;)Z
...
.method public setStatusBarBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, La/Y3$a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final t()V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:La/A2;

    iget-object v2, v1, La/A2;->b:Ljava/lang/Object;

    check-cast v2, La/ge;

    iget v3, v2, La/ge;->c:I
    ...
    :goto_0
    iget-object v6, v1, La/A2;->a:Ljava/lang/Object;

    check-cast v6, La/Cc;

    if-ge v5, v3, :cond_1

    invoke-virtual {v2, v5}, La/ge;->j(I)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v7}, La/Cc;->c(Ljava/lang/Object;)Z
    ...
    :cond_1
    invoke-virtual {v2}, La/ge;->clear()V
    ...
    :goto_1
    iget-object v5, v1, La/A2;->b:Ljava/lang/Object;
    ...
    invoke-static {v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->k(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    ...
    :goto_6
    invoke-virtual {v5, v7}, La/ge;->containsKey(Ljava/lang/Object;)Z

    move-result v9

    if-nez v9, :cond_10

    invoke-virtual {v5, v7, v10}, La/ge;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_13
    :goto_8
    invoke-virtual {v5, v11}, La/ge;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v5, v11, v10}, La/ge;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v11, v10}, La/ge;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v6}, La/Cc;->a()Ljava/lang/Object;
    ...
    :cond_15
    invoke-virtual {v5, v11, v12}, La/ge;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1b
    iget-object v2, v1, La/A2;->c:Ljava/lang/Object;
    ...
    iget v6, v5, La/ge;->c:I

    :goto_a
    if-ge v4, v6, :cond_1c

    invoke-virtual {v5, v4}, La/ge;->h(I)Ljava/lang/Object;

    move-result-object v7

    invoke-virtual {v1, v7, v2, v3}, La/A2;->b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
...
.method public final x()V
    ...
    invoke-static {p0, v0}, La/ug$d;->u(Landroid/view/View;La/Tb;)V
