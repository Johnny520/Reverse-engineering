...
.method public static b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0}, La/df;->c(Landroid/content/Context;I)I

    move-result v0

    sget v1, Landroidx/appcompat/R$attr;->colorButtonNormal:I

    invoke-static {p0, v1}, La/df;->b(Landroid/content/Context;I)I

    move-result p0

    sget-object v1, La/df;->b:[I

    sget-object v2, La/df;->d:[I

    invoke-static {v0, p1}, La/v3;->b(II)I

    move-result v3

    sget-object v4, La/df;->c:[I

    invoke-static {v0, p1}, La/v3;->b(II)I

    move-result v0

    sget-object v5, La/df;->f:[I
...
.method public static c(La/pd;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 6
    ...
    invoke-virtual {p0, p1, v2}, La/pd;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    sget-object p2, La/Y0;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_0
    invoke-static {p1, p2}, La/Y0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, La/Y3;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, La/df;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v1, La/df;->e:[I

    aput-object v1, v0, v4

    sget v1, Landroidx/appcompat/R$attr;->colorControlActivated:I

    invoke-static {p1, v1}, La/df;->c(Landroid/content/Context;I)I

    move-result p1

    aput p1, p2, v4

    sget-object p1, La/df;->f:[I
    ...
    :cond_2
    sget-object v2, La/df;->b:[I

    aput-object v2, v0, v1

    sget v2, Landroidx/appcompat/R$attr;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, La/df;->b(Landroid/content/Context;I)I
    ...
    invoke-static {p1, p2}, La/Y0$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v1}, La/Y0$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, La/df;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
