...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;La/of;)V
    ...
    iput-object p1, p0, La/se;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v1, p0, La/se;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-direct {v4, v5, v6}, La/r1;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v4, p0, La/se;->b:La/r1;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, La/Sa;->d(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v5, p0, La/se;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v1, v5}, La/M8;->d(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v6, p0, La/se;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v1, v6}, La/M8;->d(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    sget v5, Lcom/google/android/material/R$styleable;->TextInputLayout_startIconTint:I

    iget-object v7, p2, La/of;->b:Landroid/content/res/TypedArray;
    ...
    invoke-static {v5, p2, v8}, La/Sa;->a(Landroid/content/Context;La/of;I)Landroid/content/res/ColorStateList;

    move-result-object v5

    iput-object v5, p0, La/se;->e:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v5, v6}, La/Rg;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    iput-object v5, p0, La/se;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p2, v5}, La/of;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    invoke-virtual {p0, v5}, La/se;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v9, p0, La/se;->g:I

    if-eq v5, v9, :cond_5

    iput v5, p0, La/se;->g:I
    ...
    invoke-static {v3}, La/M8;->b(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v3

    iput-object v3, p0, La/se;->h:Landroid/widget/ImageView$ScaleType;
    ...
    invoke-virtual {p2, p1}, La/of;->a(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v6, p0, La/se;->c:Ljava/lang/CharSequence;

    invoke-virtual {v4, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {p0}, La/se;->e()V
...
.method public final a()I
    ...
    iget-object v0, p0, La/se;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v2, p0, La/se;->b:La/r1;
...
.method public final b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, La/se;->e:Landroid/content/res/ColorStateList;

    iget-object v1, p0, La/se;->f:Landroid/graphics/PorterDuff$Mode;

    iget-object v2, p0, La/se;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-virtual {p0, p1}, La/se;->c(Z)V

    iget-object p1, p0, La/se;->e:Landroid/content/res/ColorStateList;

    invoke-static {v2, v0, p1}, La/M8;->c(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    ...
    iget-object p1, p0, La/se;->i:Landroid/view/View$OnLongClickListener;
    ...
    iput-object v1, p0, La/se;->i:Landroid/view/View$OnLongClickListener;
...
.method public final d()V
    ...
    iget-object v0, p0, La/se;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    :cond_0
    iget-object v1, p0, La/se;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v4, p0, La/se;->b:La/r1;
...
.method public final e()V
    ...
    iget-object v0, p0, La/se;->c:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v3, p0, La/se;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, La/se;->b:La/r1;
