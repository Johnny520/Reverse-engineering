...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v3, v6}, La/Wa;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1, p2, v3}, La/F0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, La/Ba;->g:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1}, La/F0;->setKeyListener(Landroid/text/method/KeyListener;)V
    ...
    iput-object p2, p0, La/Ba;->j:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, p2}, La/Sa;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, La/Ba;->l:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, p0, La/Ba;->f:Landroid/view/accessibility/AccessibilityManager;

    new-instance p2, La/F9;

    sget v2, Landroidx/appcompat/R$attr;->listPopupWindowStyle:I

    invoke-direct {p2, v0, v1, v2}, La/F9;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object p2, p0, La/Ba;->e:La/F9;

    const/4 v0, 0x1

    iput-boolean v0, p2, La/F9;->y:Z

    iget-object v1, p2, La/F9;->z:La/g1;

    invoke-virtual {v1, v0}, Landroid/widget/PopupWindow;->setFocusable(Z)V

    iput-object p0, p2, La/F9;->o:Landroid/view/View;
    ...
    invoke-virtual {p2, v0}, La/F9;->o(Landroid/widget/ListAdapter;)V

    new-instance v0, La/Aa;

    invoke-direct {v0, p0}, La/Aa;-><init>(La/Ba;)V

    iput-object v0, p2, La/F9;->p:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    invoke-virtual {p0, p2}, La/Ba;->setSimpleItems(I)V
...
.method public static a(La/Ba;Ljava/lang/Object;)V
    .locals 1
...
.method public final c()Z
    ...
    iget-object v0, p0, La/Ba;->f:Landroid/view/accessibility/AccessibilityManager;
...
.method public final dismissDropDown()V
    ...
    invoke-virtual {p0}, La/Ba;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, La/Ba;->e:La/F9;
...
.method public getDropDownBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, La/Ba;->j:Landroid/content/res/ColorStateList;
...
.method public getHint()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, La/Ba;->b()Lcom/google/android/material/textfield/TextInputLayout;
...
.method public getSimpleItemSelectedRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, La/Ba;->l:Landroid/content/res/ColorStateList;
...
.method public final onMeasure(II)V
    ...
    iget-object v5, p0, La/Ba;->e:La/F9;

    iget-object v6, v5, La/F9;->z:La/g1;
    ...
    :cond_1
    iget-object v6, v5, La/F9;->c:La/A5;
    ...
    :cond_4
    iget-object v0, v5, La/F9;->z:La/g1;
    ...
    iget-object v2, p0, La/Ba;->g:Landroid/graphics/Rect;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, La/Ba;->e:La/F9;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, La/F9;->o(Landroid/widget/ListAdapter;)V
...
.method public setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, La/F9;->m(Landroid/graphics/drawable/Drawable;)V
...
.method public setDropDownBackgroundTint(I)V
    ...
    invoke-virtual {p0, p1}, La/Ba;->setDropDownBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setDropDownBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v0}, La/Ta;->k(Landroid/content/res/ColorStateList;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    iput-object v0, p1, La/F9;->q:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public setSimpleItemSelectedColor(I)V
    ...
    iput p1, p0, La/Ba;->k:I

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    instance-of p1, p1, La/Ba$a;
    ...
    check-cast p1, La/Ba$a;

    invoke-virtual {p1}, La/Ba$a;->b()V
...
.method public setSimpleItemSelectedRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, La/Ba;->l:Landroid/content/res/ColorStateList;
...
.method public setSimpleItems(I)V
    ...
    invoke-virtual {p0, p1}, La/Ba;->setSimpleItems([Ljava/lang/String;)V
...
.method public setSimpleItems([Ljava/lang/String;)V
    ...
    .line 2
    new-instance v0, La/Ba$a;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    iget v2, p0, La/Ba;->h:I

    invoke-direct {v0, p0, v1, v2, p1}, La/Ba$a;-><init>(La/Ba;Landroid/content/Context;I[Ljava/lang/String;)V

    invoke-virtual {p0, v0}, La/Ba;->setAdapter(Landroid/widget/ListAdapter;)V
