...
.method static constructor <clinit>()V
    ...
    sput-object v0, La/Ie;->e:[Ljava/lang/Class;

    sput-object v0, La/Ie;->f:[Ljava/lang/Class;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, La/Ie;->c:Landroid/content/Context;

    filled-new-array {p1}, [Ljava/lang/Object;

    move-result-object p1

    iput-object p1, p0, La/Ie;->a:[Ljava/lang/Object;

    iput-object p1, p0, La/Ie;->b:[Ljava/lang/Object;
...
.method public static a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, La/Ie;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final b(Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    new-instance v2, La/Ie$b;

    move-object/from16 v3, p3

    invoke-direct {v2, v0, v3}, La/Ie$b;-><init>(La/Ie;Landroid/view/Menu;)V
    ...
    iput v7, v2, La/Ie$b;->b:I

    iput v7, v2, La/Ie$b;->c:I

    iput v7, v2, La/Ie$b;->d:I

    iput v7, v2, La/Ie$b;->e:I

    iput-boolean v4, v2, La/Ie$b;->f:Z

    iput-boolean v4, v2, La/Ie$b;->g:Z
    ...
    iget-boolean v3, v2, La/Ie$b;->h:Z

    if-nez v3, :cond_2

    iget-object v3, v2, La/Ie$b;->z:La/Q;

    if-eqz v3, :cond_6

    invoke-virtual {v3}, La/Q;->a()Z

    move-result v3

    if-eqz v3, :cond_6

    iput-boolean v4, v2, La/Ie$b;->h:Z

    iget v3, v2, La/Ie$b;->b:I

    iget v12, v2, La/Ie$b;->i:I

    iget v13, v2, La/Ie$b;->j:I

    iget-object v14, v2, La/Ie$b;->k:Ljava/lang/CharSequence;

    iget-object v15, v2, La/Ie$b;->a:Landroid/view/Menu;
    ...
    invoke-virtual {v2, v3}, La/Ie$b;->b(Landroid/view/MenuItem;)V
    ...
    iget-object v14, v2, La/Ie$b;->E:La/Ie;

    if-eqz v13, :cond_a

    iget-object v3, v14, La/Ie;->c:Landroid/content/Context;
    ...
    iput-boolean v12, v2, La/Ie$b;->f:Z
    ...
    iput-boolean v12, v2, La/Ie$b;->g:Z
    ...
    iput-object v5, v2, La/Ie$b;->k:Ljava/lang/CharSequence;
    ...
    iput-object v5, v2, La/Ie$b;->l:Ljava/lang/CharSequence;
    ...
    iput v5, v2, La/Ie$b;->r:I

    goto :goto_6

    :cond_d
    iget v5, v2, La/Ie$b;->e:I
    ...
    iput-object v5, v2, La/Ie$b;->y:Ljava/lang/String;
    ...
    iput-object v5, v2, La/Ie$b;->x:Ljava/lang/String;
    ...
    iget v4, v2, La/Ie$b;->w:I

    if-nez v4, :cond_f

    iget-object v4, v2, La/Ie$b;->x:Ljava/lang/String;

    if-nez v4, :cond_f

    sget-object v4, La/Ie;->f:[Ljava/lang/Class;

    iget-object v14, v14, La/Ie;->b:[Ljava/lang/Object;

    invoke-virtual {v2, v5, v4, v14}, La/Ie$b;->a(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, La/Q;

    iput-object v4, v2, La/Ie$b;->z:La/Q;
    ...
    :cond_10
    iput-object v8, v2, La/Ie$b;->z:La/Q;
    ...
    iput-object v4, v2, La/Ie$b;->A:Ljava/lang/CharSequence;
    ...
    iput-object v4, v2, La/Ie$b;->B:Ljava/lang/CharSequence;
    ...
    iget-object v5, v2, La/Ie$b;->D:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v4, v5}, La/x5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iput-object v4, v2, La/Ie$b;->D:Landroid/graphics/PorterDuff$Mode;

    goto :goto_9

    :cond_11
    iput-object v8, v2, La/Ie$b;->D:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v3, v5}, La/Y3;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_a
    iput-object v3, v2, La/Ie$b;->C:Landroid/content/res/ColorStateList;

    goto :goto_b

    :cond_13
    iput-object v8, v2, La/Ie$b;->C:Landroid/content/res/ColorStateList;

    :goto_b
    invoke-virtual {v12}, Landroid/content/res/TypedArray;->recycle()V

    iput-boolean v7, v2, La/Ie$b;->h:Z
    ...
    iget v5, v2, La/Ie$b;->i:I

    iget v12, v2, La/Ie$b;->j:I

    iget-object v13, v2, La/Ie$b;->k:Ljava/lang/CharSequence;

    iget-object v14, v2, La/Ie$b;->a:Landroid/view/Menu;
    ...
    invoke-virtual {v2, v5}, La/Ie$b;->b(Landroid/view/MenuItem;)V

    move-object/from16 v5, p1

    invoke-virtual {v0, v5, v1, v3}, La/Ie;->b(Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
...
.method public final inflate(ILandroid/view/Menu;)V
    ...
    :try_start_0
    iget-object v3, p0, La/Ie;->c:Landroid/content/Context;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v1, p1, p2}, La/Ie;->b(Landroid/content/res/XmlResourceParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    :try_end_0
