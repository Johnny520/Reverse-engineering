...
.field public static final e:La/pg;

.field public static final f:La/ug$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, La/ug;->d:[I

    new-instance v0, La/pg;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, La/ug;->e:La/pg;

    new-instance v0, La/ug$a;

    invoke-direct {v0}, La/ug$a;-><init>()V

    sput-object v0, La/ug;->f:La/ug$a;

    return-void
.end method

.method public static a(Landroid/view/View;)La/Jg;
    .locals 2
    ...
    sput-object v0, La/ug;->a:Ljava/util/WeakHashMap;
    ...
    invoke-direct {v0, p0}, La/Jg;-><init>(Landroid/view/View;)V
...
.method public static b(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-static {p0}, La/ug$h;->a(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    :cond_1
    sget-object v0, La/ug;->b:Ljava/lang/reflect/Field;
    ...
    sput-object v0, La/ug;->b:Ljava/lang/reflect/Field;
...
.method public static d(La/Z0;)[Ljava/lang/String;
    .locals 2
    ...
    invoke-static {p0}, La/ug$j;->a(Landroid/view/View;)[Ljava/lang/String;
...
.method public static e(Landroid/view/View;I)V
    ...
    :cond_0
    invoke-static {p0}, La/ug$g;->b(Landroid/view/View;)Ljava/lang/CharSequence;
...
.method public static f(Landroid/view/View;La/W3;)La/W3;
    .locals 3
    ...
    invoke-static {p0, p1}, La/ug$j;->b(Landroid/view/View;La/W3;)La/W3;
    ...
    sget-object v1, La/ug;->e:La/pg;

    if-eqz v0, :cond_4

    invoke-interface {v0, p0, p1}, La/dc;->a(Landroid/view/View;La/W3;)La/W3;
    ...
    :cond_3
    invoke-interface {v1, p1}, La/ec;->a(La/W3;)La/W3;
...
.method public static g(Landroid/view/View;I)V
    ...
    invoke-static {p0}, La/ug;->c(Landroid/view/View;)Ljava/util/ArrayList;
    ...
    check-cast v1, La/I$a;

    invoke-virtual {v1}, La/I$a;->a()I
...
.method public static h(Landroid/view/View;La/I$a;La/K;)V
    .locals 6

    new-instance v0, La/I$a;

    iget v2, p1, La/I$a;->b:I

    iget-object v5, p1, La/I$a;->c:Ljava/lang/Class;
    ...
    invoke-static {p0}, La/ug;->b(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    :cond_0
    instance-of p2, p1, La/C$a;

    if-eqz p2, :cond_1

    check-cast p1, La/C$a;

    iget-object p1, p1, La/C$a;->a:La/C;
    ...
    invoke-direct {p2, p1}, La/C;-><init>(Landroid/view/View$AccessibilityDelegate;)V
    ...
    invoke-virtual {v0}, La/I$a;->a()I

    move-result p1

    invoke-static {p0, p1}, La/ug;->g(Landroid/view/View;I)V
    ...
    invoke-static {p0, p1}, La/ug;->e(Landroid/view/View;I)V
...
.method public static i(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;I)V
    ...
    invoke-static/range {v2 .. v8}, La/ug$h;->d(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    :cond_0
    return-void
.end method

.method public static j(Landroid/view/View;La/C;)V
    .locals 1
    ...
    :cond_2
    iget-object p1, p1, La/C;->b:La/C$a;
...
.method public static k(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, v1, v3, v4, v2}, La/ug$b;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v0, p0, p1}, La/ug$b;->c(Landroid/view/View;Ljava/lang/Object;)V

    sget-object v0, La/ug;->f:La/ug$a;

    if-eqz p1, :cond_2

    iget-object p1, v0, La/ug$a;->a:Ljava/util/WeakHashMap;
