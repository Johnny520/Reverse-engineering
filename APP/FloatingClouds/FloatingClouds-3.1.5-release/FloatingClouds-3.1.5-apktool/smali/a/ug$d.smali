...
.method public static b(Landroid/view/View;La/nh;Landroid/graphics/Rect;)La/nh;
    .locals 1
...
.method public static j(Landroid/view/View;)La/nh;
    .locals 6

    sget-boolean v0, La/nh$a;->d:Z
    ...
    :try_start_0
    sget-object v1, La/nh$a;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v1, La/nh$a;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v2, La/nh$a;->c:Ljava/lang/reflect/Field;
    ...
    new-instance v2, La/nh$d;

    invoke-direct {v2}, La/nh$d;-><init>()V
    ...
    new-instance v2, La/nh$c;

    invoke-direct {v2}, La/nh$c;-><init>()V

    goto :goto_0

    :cond_2
    new-instance v2, La/nh$b;

    invoke-direct {v2}, La/nh$b;-><init>()V
    ...
    invoke-static {v3, v4, v5, v1}, La/a9;->b(IIII)La/a9;

    move-result-object v1

    invoke-virtual {v2, v1}, La/nh$e;->e(La/a9;)V
    ...
    invoke-static {v1, v3, v4, v0}, La/a9;->b(IIII)La/a9;

    move-result-object v0

    invoke-virtual {v2, v0}, La/nh$e;->g(La/a9;)V

    invoke-virtual {v2}, La/nh$e;->b()La/nh;

    move-result-object v0

    iget-object v1, v0, La/nh;->a:La/nh$k;

    invoke-virtual {v1, v0}, La/nh$k;->p(La/nh;)V
...
.method public static u(Landroid/view/View;La/Tb;)V
    .locals 2
    ...
    :cond_1
    new-instance v0, La/ug$d$a;

    invoke-direct {v0, p0, p1}, La/ug$d$a;-><init>(Landroid/view/View;La/Tb;)V
