...
public final class C1213r extends AbstractC1214s {
    ...
    public final int mo2979b(View view) {
        ...
        return view.getBottom() + ((RecyclerView.C1176m) view.getLayoutParams()).f4948b.bottom + ((ViewGroup.MarginLayoutParams) c1176m).bottomMargin;
    }
    ...
    public final int mo2982e(View view) {
        RecyclerView.C1176m c1176m = (RecyclerView.C1176m) view.getLayoutParams();
        this.f5191a.getClass();
        return (view.getTop() - ((RecyclerView.C1176m) view.getLayoutParams()).f4948b.top) - ((ViewGroup.MarginLayoutParams) c1176m).topMargin;
    }

    @Override // androidx.recyclerview.widget.AbstractC1214s
    /* JADX INFO: renamed from: f */
    public final int mo2983f() {
        return this.f5191a.f4940o;
    }
    ...
    public final int mo2989l() {
        RecyclerView.AbstractC1175l abstractC1175l = this.f5191a;
        return (abstractC1175l.f4940o - abstractC1175l.m2840G()) - abstractC1175l.m2837D();
    }
