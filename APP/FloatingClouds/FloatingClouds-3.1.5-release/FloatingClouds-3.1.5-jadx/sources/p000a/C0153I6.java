...
public class C0153I6 extends ViewGroup {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(C1247R.id.row_index_key, -1);
            } else {
                ...
                if (!this.f529c && measuredWidth2 > i5) {
                    i6 = this.f527a + paddingTop;
                    this.f530d++;
                    measuredWidth = paddingRight;
                }
                childAt.setTag(C1247R.id.row_index_key, Integer.valueOf(this.f530d - 1));
                ...
                measuredWidth += childAt.getMeasuredWidth() + marginStart + marginEnd + this.f528b;
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i10 = i4;
                if (childAt.getMeasuredWidth() + paddingLeft + i5 > paddingRight && !mo434a()) {
                    paddingLeft = getPaddingLeft();
                    i7 = paddingTop + this.f527a;
                }
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i5 + i10 + this.f528b + paddingLeft;
