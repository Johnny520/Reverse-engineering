...
public final class C0872v3 {

    /* JADX INFO: renamed from: a */
    public static final ThreadLocal<double[]> f3417a = new ThreadLocal<>();

    /* JADX INFO: renamed from: a */
    public static int m2083a(double d, double d2, double d3) {
    ...
    public static int m2084b(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / 255);
        return Color.argb(i3, m2085c(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m2085c(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m2085c(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: c */
    public static int m2085c(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int m2086d(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
