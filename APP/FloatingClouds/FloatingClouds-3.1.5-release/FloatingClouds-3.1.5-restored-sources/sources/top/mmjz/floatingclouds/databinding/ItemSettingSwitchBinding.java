...
public final class ItemSettingSwitchBinding {
    ...
    private ItemSettingSwitchBinding(LinearLayout linearLayout, SwitchCompat switchCompat, TextView textView, TextView textView2) {
    ...
    public static ItemSettingSwitchBinding bind(View view) {
        int i = C1329R.id.switchCompat;
        SwitchCompat switchCompat = (SwitchCompat) C0726n9.m1673p(view, i);
        if (switchCompat != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    return new ItemSettingSwitchBinding((LinearLayout) view, switchCompat, textView, textView2);
                }
            }
        }
    ...
    public static ItemSettingSwitchBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C1329R.layout.item_setting_switch, viewGroup, false);
        if (z) {
