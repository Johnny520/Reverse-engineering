...
public class DialogTitle extends C0794r1 {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        setSingleLine(false);
        setMaxLines(2);
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0983R.styleable.TextAppearance, R.attr.textAppearanceMedium, R.style.TextAppearance.Medium);
